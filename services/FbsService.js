...
* */
const addHiddenOffers = ({ campaignId, addHiddenOffersRequest }) => new Promise(
...
* */
const addOffersToArchive = ({ businessId, addOffersToArchiveRequest }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        businessId,
...
* returns EmptyApiResponse
* */
const confirmShipment = ({ campaignId, shipmentId, confirmShipmentRequest }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        campaignId,
...
* */
const deleteCampaignOffers = ({ campaignId, deleteCampaignOffersRequest }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        campaignId,
...
* returns EmptyApiResponse
* */
const deleteHiddenOffers = ({ campaignId, deleteHiddenOffersRequest }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        campaignId,
...
* */
const deleteOffers = ({ businessId, deleteOffersRequest }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        businessId,
...
* */
const deleteOffersFromArchive = ({ businessId, deleteOffersFromArchiveRequest }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        businessId,
...
* returns File
* */
const downloadShipmentAct = ({ campaignId, shipmentId }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        campaignId,
...
* returns File
* */
const downloadShipmentDiscrepancyAct = ({ campaignId, shipmentId }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        campaignId,
...
* returns File
* */
const downloadShipmentInboundAct = ({ campaignId, shipmentId }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        campaignId,
...
* returns File
* */
const downloadShipmentPalletLabels = ({ campaignId, shipmentId, format }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        campaignId,
...
*
* campaignId Long Идентификатор кампании в API и магазина в кабинете. Каждая кампания в API соответствует магазину в кабинете.  Чтобы узнать идентификаторы своих магазинов, воспользуйтесь запросом [GET campaigns](../../reference/campaigns/getCampaigns.md).  ℹ️ [Что такое кабинет и магазин на Маркете](https://yandex.ru/support/marketplace/account/introduction.html) 
* warehouseUnderscoreid Integer Идентификатор склада. (optional)
* returns File
* */
const downloadShipmentReceptionTransferAct = ({ campaignId, warehouseUnderscoreid }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        campaignId,
...
* returns File
* */
const downloadShipmentTransportationWaybill = ({ campaignId, shipmentId }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        campaignId,
...
* */
const getAllOffers = ({ campaignId, feedId, chunk }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        campaignId,
...
* */
const getBusinessSettings = ({ businessId }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        businessId,
...
* */
const getCampaign = ({ campaignId }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        campaignId,
...
* */
const getCampaignLogins = ({ campaignId }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        campaignId,
...
* */
const getCampaignOffers = ({ campaignId, getCampaignOffersRequest, pageUnderscoretoken, limit }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        campaignId,
...
* */
const getCampaignRegion = ({ campaignId }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        campaignId,
...
* */
const getCampaignSettings = ({ campaignId }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        campaignId,
...
* */
const getCampaigns = ({ page, pageSize }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        page,
...
* returns GetCampaignsResponse
* */
const getCampaignsByLogin = ({ login, page, pageSize }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        login,
...
* */
const getCategoryContentParameters = ({ categoryId }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        categoryId,
...
* */
const getFeed = ({ campaignId, feedId }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        campaignId,
...
* */
const getFeedIndexLogs = ({ campaignId, feedId, limit, publishedUnderscoretimeUnderscorefrom, publishedUnderscoretimeUnderscoreto, status }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        campaignId,
        feedId,
        limit,
        publishedUnderscoretimeUnderscorefrom,
        publishedUnderscoretimeUnderscoreto,
        status,
      }));
    } catch (e) {
      reject(Service.rejectResponse(
...
* pageUnderscoretoken String Идентификатор страницы c результатами.  Если параметр не указан, возвращается первая страница.  Рекомендуется передавать значение выходного параметра `nextPageToken`, полученное при последнем запросе.  Если задан `page_token` и в запросе есть параметры `offset`, `page_number` и `page_size`, они игнорируются.  (optional)
* limit Integer Количество значений на одной странице.  (optional)
* fromUnderscoredate date Начальная дата обновления отзывов.  Если параметр указан, возвращаются отзывы, которые были написаны или обновлены с этой даты.  Формат даты: `ГГГГ-ММ-ДД`.  (optional)
* returns GetFeedbackListResponse
* */
const getFeedbackAndCommentUpdates = ({ campaignId, pageUnderscoretoken, limit, fromUnderscoredate }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        campaignId,
...
* */
const getFeeds = ({ campaignId }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        campaignId,
...
* */
const getGoodsStats = ({ campaignId, getGoodsStatsRequest }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        campaignId,
...
*
* campaignId Long Идентификатор кампании в API и магазина в кабинете. Каждая кампания в API соответствует магазину в кабинете.  Чтобы узнать идентификаторы своих магазинов, воспользуйтесь запросом [GET campaigns](../../reference/campaigns/getCampaigns.md).  ℹ️ [Что такое кабинет и магазин на Маркете](https://yandex.ru/support/marketplace/account/introduction.html) 
* offerUnderscoreid List Идентификатор скрытого предложения.  (optional)
* pageUnderscoretoken String Идентификатор страницы c результатами.  Если параметр не указан, возвращается первая страница.  Рекомендуется передавать значение выходного параметра `nextPageToken`, полученное при последнем запросе.  Если задан `page_token` и в запросе есть параметры `offset`, `page_number` и `page_size`, они игнорируются.  (optional)
* limit Integer Количество значений на одной странице.  (optional)
...
* */
const getHiddenOffers = ({ campaignId, offerUnderscoreid, pageUnderscoretoken, limit, offset, page, pageSize }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        campaignId,
...
* */
const getOfferCardsContentStatus = ({ businessId, pageUnderscoretoken, limit, getOfferCardsContentStatusRequest }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        businessId,
...
*
* campaignId Long Идентификатор кампании в API и магазина в кабинете. Каждая кампания в API соответствует магазину в кабинете.  Чтобы узнать идентификаторы своих магазинов, воспользуйтесь запросом [GET campaigns](../../reference/campaigns/getCampaigns.md).  ℹ️ [Что такое кабинет и магазин на Маркете](https://yandex.ru/support/marketplace/account/introduction.html) 
* offerUnderscoreid List Идентификатор товара в каталоге. (optional)
* shopUnderscoresku List Ваш SKU товара.  Параметр может быть указан несколько раз, например:  ``` ...shop_sku=123&shop_sku=129&shop_sku=141... ```  В запросе можно указать либо параметр `shopSku`, либо любые параметры для фильтрации товаров. Совместное использование параметра `shopSku` и параметров для фильтрации приведет к ошибке.  (optional)
* mappingUnderscorekind OfferMappingKindType Тип маппинга. (optional)
* status List Фильтрация по статусу публикации товара:  * `READY` — товар прошел модерацию. * `IN_WORK` — товар проходит модерацию. * `NEED_CONTENT` — для товара без SKU на Маркете marketSku нужно найти карточку самостоятельно или создать ее. * `NEED_INFO` — товар не прошел модерацию из-за ошибок или недостающих сведений в описании товара. * `REJECTED` — товар не прошел модерацию, так как Маркет не планирует размещать подобные товары. * `SUSPENDED` — товар не прошел модерацию, так как Маркет пока не размещает подобные товары. * `OTHER` — товар не прошел модерацию по другой причине.  Можно указать несколько статусов в одном параметре, через запятую, или в нескольких одинаковых параметрах. Например:  ``` ...status=READY,IN_WORK... ...status=READY&status=IN_WORK... ```  В запросе можно указать либо параметр shopSku, либо любые параметры для фильтрации товаров. Совместное использование параметра shopSku и параметров для фильтрации приведет к ошибке.  (optional)
* availability List Фильтрация по планам поставок товара:  * `ACTIVE` — поставки будут. * `INACTIVE` — поставок не будет: товар есть на складе, но вы больше не планируете его поставлять. * `DELISTED` — архив: товар закончился на складе, и его поставок больше не будет.  Можно указать несколько значений в одном параметре, через запятую, или в нескольких одинаковых параметрах. Например:  ``` ...availability=INACTIVE,DELISTED... ...availability=INACTIVE&availability=DELISTED... ```  В запросе можно указать либо параметр `shopSku`, либо любые параметры для фильтрации товаров. Совместное использование параметра `shopSku` и параметров для фильтрации приведет к ошибке.  (optional)
* categoryUnderscoreid List Фильтрация по идентификатору категории на Маркете.  Чтобы узнать идентификатор категории, к которой относится товар, воспользуйтесь запросом [POST categories/tree](../../reference/categories/getCategoriesTree.md).  Можно указать несколько идентификаторов в одном параметре, через запятую, или в нескольких одинаковых параметрах. Например:  ``` ...category_id=14727164,14382343... ...category_id=14727164&category_id=14382343... ```  В запросе можно указать либо параметр `shopSku`, либо любые параметры для фильтрации товаров. Совместное использование параметра `shopSku` и параметров для фильтрации приведет к ошибке.  (optional)
* vendor List Фильтрация по бренду товара.  Можно указать несколько брендов в одном параметре, через запятую, или в нескольких одинаковых параметрах. Например:  ``` ...vendor=Aqua%20Minerale,Borjomi... ...vendor=Aqua%20Minerale&vendor=Borjomi... ```  Чтобы товар попал в результаты фильтрации, его бренд должен точно совпадать с одним из указанных в запросе. Например, если указан бренд Schwarzkopf, то в результатах не будет товаров Schwarzkopf Professional.  Если в названии бренда есть символы, которые не входят в таблицу ASCII (в том числе кириллические символы), используйте для них URL-кодирование. Например, пробел — %20, апостроф «'» — %27 и т. д. Подробнее см. в разделе [Кодирование URL русскоязычной Википедии](https://ru.wikipedia.org/wiki/URL#Кодирование_URL).  В запросе можно указать либо параметр shopSku, либо любые параметры для фильтрации товаров. Совместное использование параметра shopSku и параметров для фильтрации приведет к ошибке.  (optional)
* pageUnderscoretoken String Идентификатор страницы c результатами.  Если параметр не указан, возвращается первая страница.  Рекомендуется передавать значение выходного параметра `nextPageToken`, полученное при последнем запросе.  Если задан `page_token` и в запросе есть параметры `offset`, `page_number` и `page_size`, они игнорируются.  (optional)
* limit Integer Количество значений на одной странице.  (optional)
* returns GetOfferMappingEntriesResponse
* */
const getOfferMappingEntries = ({ campaignId, offerUnderscoreid, shopUnderscoresku, mappingUnderscorekind, status, availability, categoryUnderscoreid, vendor, pageUnderscoretoken, limit }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        campaignId,
...
* */
const getOfferMappings = ({ businessId, pageUnderscoretoken, limit, getOfferMappingsRequest }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        businessId,
...
* */
const getOfferRecommendations = ({ businessId, getOfferRecommendationsRequest, pageUnderscoretoken, limit }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        businessId,
...
* */
const getOffers = ({ campaignId, query, feedId, shopCategoryId, currency, matched, page, pageSize }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        campaignId,
...
* */
const getOrder = ({ campaignId, orderId }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        campaignId,
...
* */
const getOrderBusinessBuyerInfo = ({ campaignId, orderId }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        campaignId,
...
* */
const getOrderBusinessDocumentsInfo = ({ campaignId, orderId }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        campaignId,
...
* dispatchType OrderDeliveryDispatchType Способ отгрузки (optional)
...
* buyerType OrderBuyerType Фильтрация заказов по типу покупателя.  (optional)
* page Integer Номер страницы результатов.  Значение по умолчанию: 1.  Используется вместе с параметром `page_size`.  `page_number` игнорируется, если задан `page_token`, `limit` или `offset`.  (optional)
* pageSize Integer Размер страницы.  Используется вместе с параметром `page_number`.  `page_size` игнорируется, если задан `page_token`, `limit` или `offset`.  (optional)
* pageUnderscoretoken String Идентификатор страницы c результатами.  Если параметр не указан, возвращается первая страница.  Рекомендуется передавать значение выходного параметра `nextPageToken`, полученное при последнем запросе.  Если задан `page_token` и в запросе есть параметры `offset`, `page_number` и `page_size`, они игнорируются.  (optional)
* limit Integer Количество значений на одной странице.  (optional)
...
* */
const getOrders = ({ campaignId, orderIds, status, substatus, fromDate, toDate, supplierShipmentDateFrom, supplierShipmentDateTo, updatedAtFrom, updatedAtTo, dispatchType, fake, hasCis, onlyWaitingForCancellationApprove, onlyEstimatedDelivery, buyerType, page, pageSize, pageUnderscoretoken, limit }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        campaignId,
...
* */
const getOrdersStats = ({ campaignId, pageUnderscoretoken, limit, getOrdersStatsRequest }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        campaignId,
...
* */
const getPrices = ({ campaignId, pageUnderscoretoken, limit, archived }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        campaignId,
...
* */
const getPricesByOfferIds = ({ campaignId, pageUnderscoretoken, limit, getPricesByOfferIdsRequest }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        campaignId,
...
* */
const getQualityRatingDetails = ({ campaignId }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        campaignId,
...
* */
const getQualityRatings = ({ businessId, getQualityRatingRequest }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        businessId,
...
* */
const getShipment = ({ campaignId, shipmentId, cancelledOrders }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        campaignId,
...
* */
const getShipmentOrdersInfo = ({ campaignId, shipmentId }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        campaignId,
...
* */
const getStocks = ({ campaignId, pageUnderscoretoken, limit, getWarehouseStocksRequest }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        campaignId,
...
* */
const getSuggestedOfferMappingEntries = ({ campaignId, getSuggestedOfferMappingEntriesRequest }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        campaignId,
...
* */
const getSuggestedOfferMappings = ({ businessId, getSuggestedOfferMappingsRequest }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        businessId,
...
* */
const getSuggestedPrices = ({ campaignId, suggestPricesRequest }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        campaignId,
...
* */
const provideOrderItemIdentifiers = ({ campaignId, orderId, provideOrderItemIdentifiersRequest }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        campaignId,
...
* returns EmptyApiResponse
* */
const refreshFeed = ({ campaignId, feedId }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        campaignId,
...
* */
const searchRegionChildren = ({ regionId, page, pageSize }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        regionId,
...
* */
const searchRegionsById = ({ regionId }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        regionId,
...
* returns GetRegionsResponse
* */
const searchRegionsByName = ({ name, pageUnderscoretoken, limit }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        name,
...
* */
const searchShipments = ({ campaignId, searchShipmentsRequest, pageUnderscoretoken, limit }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        campaignId,
...
* returns EmptyApiResponse
* */
const setFeedParams = ({ campaignId, feedId, setFeedParamsRequest }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        campaignId,
...
* */
const setOrderBoxLayout = ({ campaignId, orderId, setOrderBoxLayoutRequest }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        campaignId,
...
* */
const setOrderShipmentBoxes = ({ campaignId, orderId, shipmentId, setOrderShipmentBoxesRequest }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        campaignId,
...
* returns EmptyApiResponse
* */
const setShipmentPalletsCount = ({ campaignId, shipmentId, setShipmentPalletsCountRequest }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        campaignId,
...
* returns EmptyApiResponse
* */
const transferOrdersFromShipment = ({ campaignId, shipmentId, transferOrdersFromShipmentRequest }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        campaignId,
...
* returns EmptyApiResponse
* */
const updateBusinessPrices = ({ businessId, updateBusinessPricesRequest }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        businessId,
...
* returns EmptyApiResponse
* */
const updateCampaignOffers = ({ campaignId, updateCampaignOffersRequest }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        campaignId,
...
* */
const updateOfferContent = ({ businessId, updateOfferContentRequest }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        businessId,
...
* returns EmptyApiResponse
* */
const updateOfferMappingEntries = ({ campaignId, updateOfferMappingEntryRequest }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        campaignId,
...
* */
const updateOfferMappings = ({ businessId, updateOfferMappingsRequest }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        businessId,
...
* */
const updateOrderItems = ({ campaignId, orderId, updateOrderItemRequest }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        campaignId,
...
* */
const updateOrderStatus = ({ campaignId, orderId, updateOrderStatusRequest }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        campaignId,
...
* */
const updateOrderStatuses = ({ campaignId, updateOrderStatusesRequest }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        campaignId,
...
* returns EmptyApiResponse
* */
const updatePrices = ({ campaignId, updatePricesRequest }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        campaignId,
...
* returns EmptyApiResponse
* */
const updateStocks = ({ campaignId, updateStocksRequest }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        campaignId,
