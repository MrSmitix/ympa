...
* */
const getOrderBuyerInfo = ({ campaignId, orderId }) => new Promise(
...
* */
const setOrderDeliveryDate = ({ campaignId, orderId, setOrderDeliveryDateRequest }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        campaignId,
...
* returns EmptyApiResponse
* */
const setOrderDeliveryTrackCode = ({ campaignId, orderId, setOrderDeliveryTrackCodeRequest }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        campaignId,
...
* returns EmptyApiResponse
* */
const updateOrderStorageLimit = ({ campaignId, orderId, updateOrderStorageLimitRequest }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        campaignId,
