...
case class GetBusinessBuyerInfoResponse(
  ...
  def asData : GetBusinessBuyerInfoResponseData = {
    GetBusinessBuyerInfoResponseData(
...
object GetBusinessBuyerInfoResponse{
    ...
    given RW[GetBusinessBuyerInfoResponse] = GetBusinessBuyerInfoResponseData.readWriter.bimap[GetBusinessBuyerInfoResponse](_.asData, _.asModel)
