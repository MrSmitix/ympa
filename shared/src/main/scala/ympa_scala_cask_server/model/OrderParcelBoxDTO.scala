...
/* Идентификатор грузоместа. */
  ...
  def asData : OrderParcelBoxDTOData = {
    OrderParcelBoxDTOData(
            id = id.getOrElse(0),
...
object OrderParcelBoxDTO{
    ...
    given RW[OrderParcelBoxDTO] = OrderParcelBoxDTOData.readWriter.bimap[OrderParcelBoxDTO](_.asData, _.asModel)
