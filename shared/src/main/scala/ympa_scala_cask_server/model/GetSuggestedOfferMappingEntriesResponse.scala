...
case class GetSuggestedOfferMappingEntriesResponse(
  ...
  def asData : GetSuggestedOfferMappingEntriesResponseData = {
    GetSuggestedOfferMappingEntriesResponseData(
...
object GetSuggestedOfferMappingEntriesResponse{
    ...
    given RW[GetSuggestedOfferMappingEntriesResponse] = GetSuggestedOfferMappingEntriesResponseData.readWriter.bimap[GetSuggestedOfferMappingEntriesResponse](_.asData, _.asModel)
