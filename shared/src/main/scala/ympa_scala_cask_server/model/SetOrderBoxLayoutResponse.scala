...
case class SetOrderBoxLayoutResponse(
  ...
  def asData : SetOrderBoxLayoutResponseData = {
    SetOrderBoxLayoutResponseData(
...
object SetOrderBoxLayoutResponse{
    ...
    given RW[SetOrderBoxLayoutResponse] = SetOrderBoxLayoutResponseData.readWriter.bimap[SetOrderBoxLayoutResponse](_.asData, _.asModel)
