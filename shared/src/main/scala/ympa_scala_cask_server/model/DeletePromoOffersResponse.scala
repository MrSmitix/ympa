...
case class DeletePromoOffersResponse(
  ...
  def asData : DeletePromoOffersResponseData = {
    DeletePromoOffersResponseData(
...
object DeletePromoOffersResponse{
    ...
    given RW[DeletePromoOffersResponse] = DeletePromoOffersResponseData.readWriter.bimap[DeletePromoOffersResponse](_.asData, _.asModel)
