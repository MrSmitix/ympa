...
/* Список грузовых мест. Маркет определил количество мест по длине этого списка.  */
  ...
  def asData : ShipmentBoxesDTOData = {
    ShipmentBoxesDTOData(
...
object ShipmentBoxesDTO{
    ...
    given RW[ShipmentBoxesDTO] = ShipmentBoxesDTOData.readWriter.bimap[ShipmentBoxesDTO](_.asData, _.asModel)
