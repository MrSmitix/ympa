...
case class GetPricesResponse(
  ...
  def asData : GetPricesResponseData = {
    GetPricesResponseData(
...
object GetPricesResponse{
    ...
    given RW[GetPricesResponse] = GetPricesResponseData.readWriter.bimap[GetPricesResponse](_.asData, _.asModel)
