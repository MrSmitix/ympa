...
case class GetOfferCardsContentStatusResponse(
  ...
  def asData : GetOfferCardsContentStatusResponseData = {
    GetOfferCardsContentStatusResponseData(
...
object GetOfferCardsContentStatusResponse{
    ...
    given RW[GetOfferCardsContentStatusResponse] = GetOfferCardsContentStatusResponseData.readWriter.bimap[GetOfferCardsContentStatusResponse](_.asData, _.asModel)
