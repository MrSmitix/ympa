...
case class GetFeedbackListResponse(
  ...
  def asData : GetFeedbackListResponseData = {
    GetFeedbackListResponseData(
...
object GetFeedbackListResponse{
    ...
    given RW[GetFeedbackListResponse] = GetFeedbackListResponseData.readWriter.bimap[GetFeedbackListResponse](_.asData, _.asModel)
