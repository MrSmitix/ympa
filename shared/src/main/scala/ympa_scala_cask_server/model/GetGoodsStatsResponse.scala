...
case class GetGoodsStatsResponse(
  ...
  def asData : GetGoodsStatsResponseData = {
    GetGoodsStatsResponseData(
...
object GetGoodsStatsResponse{
    ...
    given RW[GetGoodsStatsResponse] = GetGoodsStatsResponseData.readWriter.bimap[GetGoodsStatsResponse](_.asData, _.asModel)
