...
/* HTTP-код ошибки индексации прайс-листа.  Выводится, если `type=DOWNLOAD_HTTP_ERROR`.  */
  ...
  def asData : FeedIndexLogsErrorDTOData = {
    FeedIndexLogsErrorDTOData(
...
object FeedIndexLogsErrorDTO{
    ...
    given RW[FeedIndexLogsErrorDTO] = FeedIndexLogsErrorDTOData.readWriter.bimap[FeedIndexLogsErrorDTO](_.asData, _.asModel)
