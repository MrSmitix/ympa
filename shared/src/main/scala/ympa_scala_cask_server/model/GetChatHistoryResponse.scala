...
case class GetChatHistoryResponse(
  ...
  def asData : GetChatHistoryResponseData = {
...
object GetChatHistoryResponse{
    ...
    given RW[GetChatHistoryResponse] = GetChatHistoryResponseData.readWriter.bimap[GetChatHistoryResponse](_.asData, _.asModel)
