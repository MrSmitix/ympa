...
/* Имя автора отзыва. */
  ...
  def asData : FeedbackAuthorDTOData = {
    FeedbackAuthorDTOData(
            name = name.getOrElse(""),
...
object FeedbackAuthorDTO{
    ...
    given RW[FeedbackAuthorDTO] = FeedbackAuthorDTOData.readWriter.bimap[FeedbackAuthorDTO](_.asData, _.asModel)
