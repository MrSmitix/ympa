...
case class GetCategoryContentParametersResponse(
  ...
  def asData : GetCategoryContentParametersResponseData = {
    GetCategoryContentParametersResponseData(
...
object GetCategoryContentParametersResponse{
    ...
    given RW[GetCategoryContentParametersResponse] = GetCategoryContentParametersResponseData.readWriter.bimap[GetCategoryContentParametersResponse](_.asData, _.asModel)
