...
case class GetShipmentOrdersInfoResponse(
  ...
  def asData : GetShipmentOrdersInfoResponseData = {
    GetShipmentOrdersInfoResponseData(
...
object GetShipmentOrdersInfoResponse{
    ...
    given RW[GetShipmentOrdersInfoResponse] = GetShipmentOrdersInfoResponseData.readWriter.bimap[GetShipmentOrdersInfoResponse](_.asData, _.asModel)
