...
case class GetShipmentResponse(
  ...
  def asData : GetShipmentResponseData = {
    GetShipmentResponseData(
...
object GetShipmentResponse{
    ...
    given RW[GetShipmentResponse] = GetShipmentResponseData.readWriter.bimap[GetShipmentResponse](_.asData, _.asModel)
