...
case class GetBusinessSettingsResponse(
  ...
  def asData : GetBusinessSettingsResponseData = {
    GetBusinessSettingsResponseData(
...
object GetBusinessSettingsResponse{
    ...
    given RW[GetBusinessSettingsResponse] = GetBusinessSettingsResponseData.readWriter.bimap[GetBusinessSettingsResponse](_.asData, _.asModel)
