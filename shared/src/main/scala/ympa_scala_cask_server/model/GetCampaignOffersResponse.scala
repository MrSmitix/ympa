...
case class GetCampaignOffersResponse(
  ...
  def asData : GetCampaignOffersResponseData = {
    GetCampaignOffersResponseData(
...
object GetCampaignOffersResponse{
    ...
    given RW[GetCampaignOffersResponse] = GetCampaignOffersResponseData.readWriter.bimap[GetCampaignOffersResponse](_.asData, _.asModel)
