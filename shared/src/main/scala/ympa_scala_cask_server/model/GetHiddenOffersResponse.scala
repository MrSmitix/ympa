...
case class GetHiddenOffersResponse(
  ...
  def asData : GetHiddenOffersResponseData = {
    GetHiddenOffersResponseData(
...
object GetHiddenOffersResponse{
    ...
    given RW[GetHiddenOffersResponse] = GetHiddenOffersResponseData.readWriter.bimap[GetHiddenOffersResponse](_.asData, _.asModel)
