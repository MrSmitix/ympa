...
case class ExtensionShipmentDTO(
  ...
  def asData : ExtensionShipmentDTOData = {
    ExtensionShipmentDTOData(
...
object ExtensionShipmentDTO{
    ...
    given RW[ExtensionShipmentDTO] = ExtensionShipmentDTOData.readWriter.bimap[ExtensionShipmentDTO](_.asData, _.asModel)
