...
case class ApiUnauthorizedErrorResponse(
  ...
  def asData : ApiUnauthorizedErrorResponseData = {
    ApiUnauthorizedErrorResponseData(
...
object ApiUnauthorizedErrorResponse{
    ...
    given RW[ApiUnauthorizedErrorResponse] = ApiUnauthorizedErrorResponseData.readWriter.bimap[ApiUnauthorizedErrorResponse](_.asData, _.asModel)
