...
case class GetWarehouseStocksResponse(
  ...
  def asData : GetWarehouseStocksResponseData = {
    GetWarehouseStocksResponseData(
...
object GetWarehouseStocksResponse{
    ...
    given RW[GetWarehouseStocksResponse] = GetWarehouseStocksResponseData.readWriter.bimap[GetWarehouseStocksResponse](_.asData, _.asModel)
