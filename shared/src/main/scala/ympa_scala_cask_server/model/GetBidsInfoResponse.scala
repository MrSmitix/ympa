...
case class GetBidsInfoResponse(
  ...
  def asData : GetBidsInfoResponseData = {
    GetBidsInfoResponseData(
...
object GetBidsInfoResponse{
    ...
    given RW[GetBidsInfoResponse] = GetBidsInfoResponseData.readWriter.bimap[GetBidsInfoResponse](_.asData, _.asModel)
