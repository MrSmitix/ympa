...
case class ApiClientDataErrorResponse(
  ...
  def asData : ApiClientDataErrorResponseData = {
    ApiClientDataErrorResponseData(
...
object ApiClientDataErrorResponse{
    ...
    given RW[ApiClientDataErrorResponse] = ApiClientDataErrorResponseData.readWriter.bimap[ApiClientDataErrorResponse](_.asData, _.asModel)
