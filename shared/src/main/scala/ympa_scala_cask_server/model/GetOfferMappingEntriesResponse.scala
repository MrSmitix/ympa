...
case class GetOfferMappingEntriesResponse(
  ...
  def asData : GetOfferMappingEntriesResponseData = {
    GetOfferMappingEntriesResponseData(
...
object GetOfferMappingEntriesResponse{
    ...
    given RW[GetOfferMappingEntriesResponse] = GetOfferMappingEntriesResponseData.readWriter.bimap[GetOfferMappingEntriesResponse](_.asData, _.asModel)
