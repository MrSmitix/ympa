...
case class GetCategoriesMaxSaleQuantumResponse(
  ...
  def asData : GetCategoriesMaxSaleQuantumResponseData = {
    GetCategoriesMaxSaleQuantumResponseData(
...
object GetCategoriesMaxSaleQuantumResponse{
    ...
    given RW[GetCategoriesMaxSaleQuantumResponse] = GetCategoriesMaxSaleQuantumResponseData.readWriter.bimap[GetCategoriesMaxSaleQuantumResponse](_.asData, _.asModel)
