...
case class GetReturnResponse(
  ...
  def asData : GetReturnResponseData = {
    GetReturnResponseData(
...
object GetReturnResponse{
    ...
    given RW[GetReturnResponse] = GetReturnResponseData.readWriter.bimap[GetReturnResponse](_.asData, _.asModel)
