...
/* Дата и время, которые магазин указал в прайс-листе.  Формат даты: ISO 8601 со смещением относительно UTC. Например, `2017-11-21T00:42:42+03:00`.  */
  ...
  def asData : FeedPublicationFullDTOData = {
    FeedPublicationFullDTOData(
...
object FeedPublicationFullDTO{
    ...
    given RW[FeedPublicationFullDTO] = FeedPublicationFullDTOData.readWriter.bimap[FeedPublicationFullDTO](_.asData, _.asModel)
