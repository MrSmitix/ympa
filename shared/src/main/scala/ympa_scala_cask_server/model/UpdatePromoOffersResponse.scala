...
case class UpdatePromoOffersResponse(
  ...
  def asData : UpdatePromoOffersResponseData = {
    UpdatePromoOffersResponseData(
...
object UpdatePromoOffersResponse{
    ...
    given RW[UpdatePromoOffersResponse] = UpdatePromoOffersResponseData.readWriter.bimap[UpdatePromoOffersResponse](_.asData, _.asModel)
