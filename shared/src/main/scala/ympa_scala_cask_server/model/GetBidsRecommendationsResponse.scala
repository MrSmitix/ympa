...
case class GetBidsRecommendationsResponse(
  ...
  def asData : GetBidsRecommendationsResponseData = {
    GetBidsRecommendationsResponseData(
...
object GetBidsRecommendationsResponse{
    ...
    given RW[GetBidsRecommendationsResponse] = GetBidsRecommendationsResponseData.readWriter.bimap[GetBidsRecommendationsResponse](_.asData, _.asModel)
