...
case class GetOrdersStatsResponse(
  ...
  def asData : GetOrdersStatsResponseData = {
    GetOrdersStatsResponseData(
...
object GetOrdersStatsResponse{
    ...
    given RW[GetOrdersStatsResponse] = GetOrdersStatsResponseData.readWriter.bimap[GetOrdersStatsResponse](_.asData, _.asModel)
