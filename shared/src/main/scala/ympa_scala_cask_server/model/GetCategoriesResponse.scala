...
case class GetCategoriesResponse(
  ...
  def asData : GetCategoriesResponseData = {
...
object GetCategoriesResponse{
    ...
    given RW[GetCategoriesResponse] = GetCategoriesResponseData.readWriter.bimap[GetCategoriesResponse](_.asData, _.asModel)
