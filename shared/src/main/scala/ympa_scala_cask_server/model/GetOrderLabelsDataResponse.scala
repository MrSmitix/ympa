...
case class GetOrderLabelsDataResponse(
  ...
  def asData : GetOrderLabelsDataResponseData = {
    GetOrderLabelsDataResponseData(
...
object GetOrderLabelsDataResponse{
    ...
    given RW[GetOrderLabelsDataResponse] = GetOrderLabelsDataResponseData.readWriter.bimap[GetOrderLabelsDataResponse](_.asData, _.asModel)
