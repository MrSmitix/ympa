...
case class SearchShipmentsResponse(
  ...
  def asData : SearchShipmentsResponseData = {
    SearchShipmentsResponseData(
...
object SearchShipmentsResponse{
    ...
    given RW[SearchShipmentsResponse] = SearchShipmentsResponseData.readWriter.bimap[SearchShipmentsResponse](_.asData, _.asModel)
