...
case class GetOrderBuyerInfoResponse(
  ...
  def asData : GetOrderBuyerInfoResponseData = {
    GetOrderBuyerInfoResponseData(
...
object GetOrderBuyerInfoResponse{
    ...
    given RW[GetOrderBuyerInfoResponse] = GetOrderBuyerInfoResponseData.readWriter.bimap[GetOrderBuyerInfoResponse](_.asData, _.asModel)
