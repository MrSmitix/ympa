...
case class GetOfferRecommendationsResponse(
  ...
  def asData : GetOfferRecommendationsResponseData = {
    GetOfferRecommendationsResponseData(
...
object GetOfferRecommendationsResponse{
    ...
    given RW[GetOfferRecommendationsResponse] = GetOfferRecommendationsResponseData.readWriter.bimap[GetOfferRecommendationsResponse](_.asData, _.asModel)
