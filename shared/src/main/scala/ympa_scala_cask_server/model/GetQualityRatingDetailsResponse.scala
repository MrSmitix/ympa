...
case class GetQualityRatingDetailsResponse(
  ...
  def asData : GetQualityRatingDetailsResponseData = {
    GetQualityRatingDetailsResponseData(
...
object GetQualityRatingDetailsResponse{
    ...
    given RW[GetQualityRatingDetailsResponse] = GetQualityRatingDetailsResponseData.readWriter.bimap[GetQualityRatingDetailsResponse](_.asData, _.asModel)
