...
case class CalculateTariffsResponse(
  ...
  def asData : CalculateTariffsResponseData = {
    CalculateTariffsResponseData(
...
object CalculateTariffsResponse{
    ...
    given RW[CalculateTariffsResponse] = CalculateTariffsResponseData.readWriter.bimap[CalculateTariffsResponse](_.asData, _.asModel)
