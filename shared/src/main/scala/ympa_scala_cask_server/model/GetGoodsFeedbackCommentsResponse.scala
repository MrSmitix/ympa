...
case class GetGoodsFeedbackCommentsResponse(
  ...
  def asData : GetGoodsFeedbackCommentsResponseData = {
    GetGoodsFeedbackCommentsResponseData(
...
object GetGoodsFeedbackCommentsResponse{
    ...
    given RW[GetGoodsFeedbackCommentsResponse] = GetGoodsFeedbackCommentsResponseData.readWriter.bimap[GetGoodsFeedbackCommentsResponse](_.asData, _.asModel)
