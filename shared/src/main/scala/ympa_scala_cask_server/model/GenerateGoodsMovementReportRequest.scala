...
/* Идентификатор кампании. */
  ...
  def asData : GenerateGoodsMovementReportRequestData = {
    GenerateGoodsMovementReportRequestData(
...
object GenerateGoodsMovementReportRequest{
    ...
    given RW[GenerateGoodsMovementReportRequest] = GenerateGoodsMovementReportRequestData.readWriter.bimap[GenerateGoodsMovementReportRequest](_.asData, _.asModel)
