...
case class GetReturnsResponse(
  ...
  def asData : GetReturnsResponseData = {
    GetReturnsResponseData(
...
object GetReturnsResponse{
    ...
    given RW[GetReturnsResponse] = GetReturnsResponseData.readWriter.bimap[GetReturnsResponse](_.asData, _.asModel)
