...
/* Список товаров в коробке.  Если в коробке едет часть большого товара, в списке может быть только один пункт.  */
  ...
  def asData : OrderBoxLayoutDTOData = {
    OrderBoxLayoutDTOData(
...
object OrderBoxLayoutDTO{
    ...
    given RW[OrderBoxLayoutDTO] = OrderBoxLayoutDTOData.readWriter.bimap[OrderBoxLayoutDTO](_.asData, _.asModel)
