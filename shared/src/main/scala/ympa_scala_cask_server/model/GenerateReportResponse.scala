...
case class GenerateReportResponse(
  ...
  def asData : GenerateReportResponseData = {
...
object GenerateReportResponse{
    ...
    given RW[GenerateReportResponse] = GenerateReportResponseData.readWriter.bimap[GenerateReportResponse](_.asData, _.asModel)
