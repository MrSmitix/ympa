...
case class GetOutletLicensesResponse(
  ...
  def asData : GetOutletLicensesResponseData = {
    GetOutletLicensesResponseData(
...
object GetOutletLicensesResponse{
    ...
    given RW[GetOutletLicensesResponse] = GetOutletLicensesResponseData.readWriter.bimap[GetOutletLicensesResponse](_.asData, _.asModel)
