...
case class SuggestedOfferMappingDTO(
  ...
  def asData : SuggestedOfferMappingDTOData = {
    SuggestedOfferMappingDTOData(
...
object SuggestedOfferMappingDTO{
    ...
    given RW[SuggestedOfferMappingDTO] = SuggestedOfferMappingDTOData.readWriter.bimap[SuggestedOfferMappingDTO](_.asData, _.asModel)
