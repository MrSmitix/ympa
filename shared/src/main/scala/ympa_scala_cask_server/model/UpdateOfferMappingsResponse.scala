...
case class UpdateOfferMappingsResponse(
  ...
  results: Seq[UpdateOfferMappingResultDTO] = Nil 

  ) {

  def asJson: String = asData.asJson

  def asData : UpdateOfferMappingsResponseData = {
    UpdateOfferMappingsResponseData(
...
object UpdateOfferMappingsResponse{
    ...
    given RW[UpdateOfferMappingsResponse] = UpdateOfferMappingsResponseData.readWriter.bimap[UpdateOfferMappingsResponse](_.asData, _.asModel)
