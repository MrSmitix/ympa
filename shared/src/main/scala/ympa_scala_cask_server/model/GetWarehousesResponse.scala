...
case class GetWarehousesResponse(
  ...
  def asData : GetWarehousesResponseData = {
    GetWarehousesResponseData(
...
object GetWarehousesResponse{
    ...
    given RW[GetWarehousesResponse] = GetWarehousesResponseData.readWriter.bimap[GetWarehousesResponse](_.asData, _.asModel)
