...
case class GetQualityRatingResponse(
  ...
  def asData : GetQualityRatingResponseData = {
    GetQualityRatingResponseData(
...
object GetQualityRatingResponse{
    ...
    given RW[GetQualityRatingResponse] = GetQualityRatingResponseData.readWriter.bimap[GetQualityRatingResponse](_.asData, _.asModel)
