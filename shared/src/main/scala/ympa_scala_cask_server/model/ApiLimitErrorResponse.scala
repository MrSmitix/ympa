...
case class ApiLimitErrorResponse(
  ...
  def asData : ApiLimitErrorResponseData = {
    ApiLimitErrorResponseData(
...
object ApiLimitErrorResponse{
    ...
    given RW[ApiLimitErrorResponse] = ApiLimitErrorResponseData.readWriter.bimap[ApiLimitErrorResponse](_.asData, _.asModel)
