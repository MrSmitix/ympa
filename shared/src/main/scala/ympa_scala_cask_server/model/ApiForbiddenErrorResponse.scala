...
case class ApiForbiddenErrorResponse(
  ...
  def asData : ApiForbiddenErrorResponseData = {
    ApiForbiddenErrorResponseData(
...
object ApiForbiddenErrorResponse{
    ...
    given RW[ApiForbiddenErrorResponse] = ApiForbiddenErrorResponseData.readWriter.bimap[ApiForbiddenErrorResponse](_.asData, _.asModel)
