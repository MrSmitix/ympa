...
case class UpdateOrderStatusesResponse(
  ...
  def asData : UpdateOrderStatusesResponseData = {
    UpdateOrderStatusesResponseData(
...
object UpdateOrderStatusesResponse{
    ...
    given RW[UpdateOrderStatusesResponse] = UpdateOrderStatusesResponseData.readWriter.bimap[UpdateOrderStatusesResponse](_.asData, _.asModel)
