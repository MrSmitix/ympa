...
case class ApiLockedErrorResponse(
  ...
  def asData : ApiLockedErrorResponseData = {
    ApiLockedErrorResponseData(
...
object ApiLockedErrorResponse{
    ...
    given RW[ApiLockedErrorResponse] = ApiLockedErrorResponseData.readWriter.bimap[ApiLockedErrorResponse](_.asData, _.asModel)
