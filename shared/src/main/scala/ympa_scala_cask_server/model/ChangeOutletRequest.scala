...
/* Название точки продаж.  */
  ...
  def asData : ChangeOutletRequestData = {
    ChangeOutletRequestData(
            name = name,
            `type` = `type`,
...
object ChangeOutletRequest{
    ...
    given RW[ChangeOutletRequest] = ChangeOutletRequestData.readWriter.bimap[ChangeOutletRequest](_.asData, _.asModel)
