...
case class AddOffersToArchiveResponse(
  ...
  def asData : AddOffersToArchiveResponseData = {
    AddOffersToArchiveResponseData(
...
object AddOffersToArchiveResponse{
    ...
    given RW[AddOffersToArchiveResponse] = AddOffersToArchiveResponseData.readWriter.bimap[AddOffersToArchiveResponse](_.asData, _.asModel)
