...
case class DeleteOffersFromArchiveResponse(
  ...
  def asData : DeleteOffersFromArchiveResponseData = {
    DeleteOffersFromArchiveResponseData(
...
object DeleteOffersFromArchiveResponse{
    ...
    given RW[DeleteOffersFromArchiveResponse] = DeleteOffersFromArchiveResponseData.readWriter.bimap[DeleteOffersFromArchiveResponse](_.asData, _.asModel)
