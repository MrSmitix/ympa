...
case class GetBusinessDocumentsInfoResponse(
  ...
  def asData : GetBusinessDocumentsInfoResponseData = {
    GetBusinessDocumentsInfoResponseData(
...
object GetBusinessDocumentsInfoResponse{
    ...
    given RW[GetBusinessDocumentsInfoResponse] = GetBusinessDocumentsInfoResponseData.readWriter.bimap[GetBusinessDocumentsInfoResponse](_.asData, _.asModel)
