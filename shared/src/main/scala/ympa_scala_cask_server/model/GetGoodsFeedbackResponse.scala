...
case class GetGoodsFeedbackResponse(
  ...
  def asData : GetGoodsFeedbackResponseData = {
    GetGoodsFeedbackResponseData(
...
object GetGoodsFeedbackResponse{
    ...
    given RW[GetGoodsFeedbackResponse] = GetGoodsFeedbackResponseData.readWriter.bimap[GetGoodsFeedbackResponse](_.asData, _.asModel)
