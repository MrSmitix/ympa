...
case class DeleteOffersResponse(
  ...
  def asData : DeleteOffersResponseData = {
    DeleteOffersResponseData(
...
object DeleteOffersResponse{
    ...
    given RW[DeleteOffersResponse] = DeleteOffersResponseData.readWriter.bimap[DeleteOffersResponse](_.asData, _.asModel)
