...
case class GetPromosResponse(
  ...
  def asData : GetPromosResponseData = {
    GetPromosResponseData(
...
object GetPromosResponse{
    ...
    given RW[GetPromosResponse] = GetPromosResponseData.readWriter.bimap[GetPromosResponse](_.asData, _.asModel)
