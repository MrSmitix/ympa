...
case class GetPricesByOfferIdsResponse(
  ...
  def asData : GetPricesByOfferIdsResponseData = {
    GetPricesByOfferIdsResponseData(
...
object GetPricesByOfferIdsResponse{
    ...
    given RW[GetPricesByOfferIdsResponse] = GetPricesByOfferIdsResponseData.readWriter.bimap[GetPricesByOfferIdsResponse](_.asData, _.asModel)
