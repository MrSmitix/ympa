goog.provide('API.Client.PromoOfferAutoParticipatingDetailsDTO');
 ...
 * @record
 */
API.Client.PromoOfferAutoParticipatingDetailsDTO = function() {}
 ...
 * @export
 */
API.Client.PromoOfferAutoParticipatingDetailsDTO.prototype.campaignIds;
