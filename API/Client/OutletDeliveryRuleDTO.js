goog.provide('API.Client.OutletDeliveryRuleDTO');

/**
 * Информация об условиях доставки для данной точки продаж.
 * @record
 */
API.Client.OutletDeliveryRuleDTO = function() {}
 ...
 * @export
 */
API.Client.OutletDeliveryRuleDTO.prototype.minDeliveryDays;
 ...
 * @export
 */
API.Client.OutletDeliveryRuleDTO.prototype.maxDeliveryDays;
 ...
 * @export
 */
API.Client.OutletDeliveryRuleDTO.prototype.deliveryServiceId;
 ...
 * @export
 */
API.Client.OutletDeliveryRuleDTO.prototype.orderBefore;
 ...
 * @export
 */
API.Client.OutletDeliveryRuleDTO.prototype.priceFreePickup;
 ...
 * @export
 */
API.Client.OutletDeliveryRuleDTO.prototype.unspecifiedDeliveryInterval;
