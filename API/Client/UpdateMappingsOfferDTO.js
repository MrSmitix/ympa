goog.provide('API.Client.UpdateMappingsOfferDTO');

/**
 * Информация о товарах в каталоге.
 * @record
 */
API.Client.UpdateMappingsOfferDTO = function() {}
 ...
 * @export
 */
API.Client.UpdateMappingsOfferDTO.prototype.name;
 ...
 * @export
 */
API.Client.UpdateMappingsOfferDTO.prototype.shopSku;
 ...
 * @export
 */
API.Client.UpdateMappingsOfferDTO.prototype.category;
 ...
 * @export
 */
API.Client.UpdateMappingsOfferDTO.prototype.vendor;
 ...
 * @export
 */
API.Client.UpdateMappingsOfferDTO.prototype.vendorCode;
 ...
 * @export
 */
API.Client.UpdateMappingsOfferDTO.prototype.description;
 ...
 * @export
 */
API.Client.UpdateMappingsOfferDTO.prototype.id;
 ...
 * @export
 */
API.Client.UpdateMappingsOfferDTO.prototype.feedId;
 ...
 * @export
 */
API.Client.UpdateMappingsOfferDTO.prototype.barcodes;
 ...
 * @export
 */
API.Client.UpdateMappingsOfferDTO.prototype.urls;
 ...
 * @export
 */
API.Client.UpdateMappingsOfferDTO.prototype.pictures;
 ...
 * @export
 */
API.Client.UpdateMappingsOfferDTO.prototype.manufacturer;
 ...
 * @export
 */
API.Client.UpdateMappingsOfferDTO.prototype.manufacturerCountries;
 ...
 * @export
 */
API.Client.UpdateMappingsOfferDTO.prototype.minShipment;
 ...
 * @export
 */
API.Client.UpdateMappingsOfferDTO.prototype.transportUnitSize;
 ...
 * @export
 */
API.Client.UpdateMappingsOfferDTO.prototype.quantumOfSupply;
 ...
 * @export
 */
API.Client.UpdateMappingsOfferDTO.prototype.deliveryDurationDays;
 ...
 * @export
 */
API.Client.UpdateMappingsOfferDTO.prototype.boxCount;
 ...
 * @export
 */
API.Client.UpdateMappingsOfferDTO.prototype.customsCommodityCodes;

/**
 * @type {!API.Client.OfferWeightDimensionsDTO}
 * @export
 */
API.Client.UpdateMappingsOfferDTO.prototype.weightDimensions;
 ...
 * @export
 */
API.Client.UpdateMappingsOfferDTO.prototype.supplyScheduleDays;
 ...
 * @export
 */
API.Client.UpdateMappingsOfferDTO.prototype.shelfLifeDays;
 ...
 * @export
 */
API.Client.UpdateMappingsOfferDTO.prototype.lifeTimeDays;
 ...
 * @export
 */
API.Client.UpdateMappingsOfferDTO.prototype.guaranteePeriodDays;

/**
 * @type {!API.Client.OfferProcessingStateDTO}
 * @export
 */
API.Client.UpdateMappingsOfferDTO.prototype.processingState;

/**
 * @type {!API.Client.OfferAvailabilityStatusType}
 * @export
 */
API.Client.UpdateMappingsOfferDTO.prototype.availability;

/**
 * @type {!API.Client.TimePeriodDTO}
 * @export
 */
API.Client.UpdateMappingsOfferDTO.prototype.shelfLife;

/**
 * @type {!API.Client.TimePeriodDTO}
 * @export
 */
API.Client.UpdateMappingsOfferDTO.prototype.lifeTime;

/**
 * @type {!API.Client.TimePeriodDTO}
 * @export
 */
API.Client.UpdateMappingsOfferDTO.prototype.guaranteePeriod;
 ...
 * @export
 */
API.Client.UpdateMappingsOfferDTO.prototype.certificate;
