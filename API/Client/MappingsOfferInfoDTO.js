goog.provide('API.Client.MappingsOfferInfoDTO');

/**
 * Базовая информация о товарах в каталоге.
 * @record
 */
API.Client.MappingsOfferInfoDTO = function() {}
 ...
 * @export
 */
API.Client.MappingsOfferInfoDTO.prototype.name;
 ...
 * @export
 */
API.Client.MappingsOfferInfoDTO.prototype.shopSku;
 ...
 * @export
 */
API.Client.MappingsOfferInfoDTO.prototype.category;
 ...
 * @export
 */
API.Client.MappingsOfferInfoDTO.prototype.vendor;
 ...
 * @export
 */
API.Client.MappingsOfferInfoDTO.prototype.vendorCode;
 ...
 * @export
 */
API.Client.MappingsOfferInfoDTO.prototype.description;
 ...
 * @export
 */
API.Client.MappingsOfferInfoDTO.prototype.id;
 ...
 * @export
 */
API.Client.MappingsOfferInfoDTO.prototype.feedId;
 ...
 * @export
 */
API.Client.MappingsOfferInfoDTO.prototype.barcodes;
 ...
 * @export
 */
API.Client.MappingsOfferInfoDTO.prototype.urls;
 ...
 * @export
 */
API.Client.MappingsOfferInfoDTO.prototype.pictures;
 ...
 * @export
 */
API.Client.MappingsOfferInfoDTO.prototype.manufacturer;
 ...
 * @export
 */
API.Client.MappingsOfferInfoDTO.prototype.manufacturerCountries;
 ...
 * @export
 */
API.Client.MappingsOfferInfoDTO.prototype.minShipment;
 ...
 * @export
 */
API.Client.MappingsOfferInfoDTO.prototype.transportUnitSize;
 ...
 * @export
 */
API.Client.MappingsOfferInfoDTO.prototype.quantumOfSupply;
 ...
 * @export
 */
API.Client.MappingsOfferInfoDTO.prototype.deliveryDurationDays;
 ...
 * @export
 */
API.Client.MappingsOfferInfoDTO.prototype.boxCount;
 ...
 * @export
 */
API.Client.MappingsOfferInfoDTO.prototype.customsCommodityCodes;

/**
 * @type {!API.Client.OfferWeightDimensionsDTO}
 * @export
 */
API.Client.MappingsOfferInfoDTO.prototype.weightDimensions;
 ...
 * @export
 */
API.Client.MappingsOfferInfoDTO.prototype.supplyScheduleDays;
 ...
 * @export
 */
API.Client.MappingsOfferInfoDTO.prototype.shelfLifeDays;
 ...
 * @export
 */
API.Client.MappingsOfferInfoDTO.prototype.lifeTimeDays;
 ...
 * @export
 */
API.Client.MappingsOfferInfoDTO.prototype.guaranteePeriodDays;

/**
 * @type {!API.Client.OfferProcessingStateDTO}
 * @export
 */
API.Client.MappingsOfferInfoDTO.prototype.processingState;

/**
 * @type {!API.Client.OfferAvailabilityStatusType}
 * @export
 */
API.Client.MappingsOfferInfoDTO.prototype.availability;

/**
 * @type {!API.Client.TimePeriodDTO}
 * @export
 */
API.Client.MappingsOfferInfoDTO.prototype.shelfLife;

/**
 * @type {!API.Client.TimePeriodDTO}
 * @export
 */
API.Client.MappingsOfferInfoDTO.prototype.lifeTime;

/**
 * @type {!API.Client.TimePeriodDTO}
 * @export
 */
API.Client.MappingsOfferInfoDTO.prototype.guaranteePeriod;
 ...
 * @export
 */
API.Client.MappingsOfferInfoDTO.prototype.certificate;
