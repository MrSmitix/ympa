goog.provide('API.Client.QuantumDTO');
 ...
 * @record
 */
API.Client.QuantumDTO = function() {}
 ...
 * @export
 */
API.Client.QuantumDTO.prototype.minQuantity;
 ...
 * @export
 */
API.Client.QuantumDTO.prototype.stepQuantity;
