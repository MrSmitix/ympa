goog.provide('API.Client.EnrichedMappingsOfferDTO');

/**
 * Информация о рекомендованных карточках товаров.
 * @record
 */
API.Client.EnrichedMappingsOfferDTO = function() {}
 ...
 * @export
 */
API.Client.EnrichedMappingsOfferDTO.prototype.name;
 ...
 * @export
 */
API.Client.EnrichedMappingsOfferDTO.prototype.shopSku;
 ...
 * @export
 */
API.Client.EnrichedMappingsOfferDTO.prototype.category;
 ...
 * @export
 */
API.Client.EnrichedMappingsOfferDTO.prototype.vendor;
 ...
 * @export
 */
API.Client.EnrichedMappingsOfferDTO.prototype.vendorCode;
 ...
 * @export
 */
API.Client.EnrichedMappingsOfferDTO.prototype.description;
 ...
 * @export
 */
API.Client.EnrichedMappingsOfferDTO.prototype.id;
 ...
 * @export
 */
API.Client.EnrichedMappingsOfferDTO.prototype.feedId;
 ...
 * @export
 */
API.Client.EnrichedMappingsOfferDTO.prototype.barcodes;
 ...
 * @export
 */
API.Client.EnrichedMappingsOfferDTO.prototype.urls;
 ...
 * @export
 */
API.Client.EnrichedMappingsOfferDTO.prototype.pictures;
 ...
 * @export
 */
API.Client.EnrichedMappingsOfferDTO.prototype.manufacturer;
 ...
 * @export
 */
API.Client.EnrichedMappingsOfferDTO.prototype.manufacturerCountries;
 ...
 * @export
 */
API.Client.EnrichedMappingsOfferDTO.prototype.minShipment;
 ...
 * @export
 */
API.Client.EnrichedMappingsOfferDTO.prototype.transportUnitSize;
 ...
 * @export
 */
API.Client.EnrichedMappingsOfferDTO.prototype.quantumOfSupply;
 ...
 * @export
 */
API.Client.EnrichedMappingsOfferDTO.prototype.deliveryDurationDays;
 ...
 * @export
 */
API.Client.EnrichedMappingsOfferDTO.prototype.boxCount;
 ...
 * @export
 */
API.Client.EnrichedMappingsOfferDTO.prototype.customsCommodityCodes;

/**
 * @type {!API.Client.OfferWeightDimensionsDTO}
 * @export
 */
API.Client.EnrichedMappingsOfferDTO.prototype.weightDimensions;
 ...
 * @export
 */
API.Client.EnrichedMappingsOfferDTO.prototype.supplyScheduleDays;
 ...
 * @export
 */
API.Client.EnrichedMappingsOfferDTO.prototype.shelfLifeDays;
 ...
 * @export
 */
API.Client.EnrichedMappingsOfferDTO.prototype.lifeTimeDays;
 ...
 * @export
 */
API.Client.EnrichedMappingsOfferDTO.prototype.guaranteePeriodDays;

/**
 * @type {!API.Client.OfferProcessingStateDTO}
 * @export
 */
API.Client.EnrichedMappingsOfferDTO.prototype.processingState;

/**
 * @type {!API.Client.OfferAvailabilityStatusType}
 * @export
 */
API.Client.EnrichedMappingsOfferDTO.prototype.availability;

/**
 * @type {!API.Client.TimePeriodDTO}
 * @export
 */
API.Client.EnrichedMappingsOfferDTO.prototype.shelfLife;

/**
 * @type {!API.Client.TimePeriodDTO}
 * @export
 */
API.Client.EnrichedMappingsOfferDTO.prototype.lifeTime;

/**
 * @type {!API.Client.TimePeriodDTO}
 * @export
 */
API.Client.EnrichedMappingsOfferDTO.prototype.guaranteePeriod;
 ...
 * @export
 */
API.Client.EnrichedMappingsOfferDTO.prototype.certificate;
 ...
 * @export
 */
API.Client.EnrichedMappingsOfferDTO.prototype.price;
 ...
 * @export
 */
API.Client.EnrichedMappingsOfferDTO.prototype.marketCategoryId;
 ...
 * @export
 */
API.Client.EnrichedMappingsOfferDTO.prototype.marketCategoryName;
 ...
 * @export
 */
API.Client.EnrichedMappingsOfferDTO.prototype.marketModelId;
 ...
 * @export
 */
API.Client.EnrichedMappingsOfferDTO.prototype.marketModelName;
 ...
 * @export
 */
API.Client.EnrichedMappingsOfferDTO.prototype.marketSku;
 ...
 * @export
 */
API.Client.EnrichedMappingsOfferDTO.prototype.marketSkuName;
