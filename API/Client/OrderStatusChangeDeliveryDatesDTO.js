goog.provide('API.Client.OrderStatusChangeDeliveryDatesDTO');

/**
 * Диапазон дат доставки.
 * @record
 */
API.Client.OrderStatusChangeDeliveryDatesDTO = function() {}
 ...
 * @export
 */
API.Client.OrderStatusChangeDeliveryDatesDTO.prototype.realDeliveryDate;
