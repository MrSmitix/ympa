 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\OrderSubstatusType
 */
class OrderSubstatusTypeTest extends TestCase
{
    protected OrderSubstatusType|MockObject $object;
    ...
    {
        $this->assertTrue(enum_exists(OrderSubstatusType::class));
    }
}
