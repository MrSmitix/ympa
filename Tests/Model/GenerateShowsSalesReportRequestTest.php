 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\GenerateShowsSalesReportRequest
 */
class GenerateShowsSalesReportRequestTest extends TestCase
{
    protected GenerateShowsSalesReportRequest|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(GenerateShowsSalesReportRequest::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(GenerateShowsSalesReportRequest::class));
        $this->assertInstanceOf(GenerateShowsSalesReportRequest::class, $this->object);
    }
     ...
     * @small
     */
    public function testPropertyGrouping(): void
    {
        $this->markTestSkipped('Test for property grouping not implemented');
    }
}
