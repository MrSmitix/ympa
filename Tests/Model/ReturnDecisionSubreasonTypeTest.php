...
use OpenAPI\Server\Model\ReturnDecisionSubreasonType;
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\ReturnDecisionSubreasonType
 */
class ReturnDecisionSubreasonTypeTest extends TestCase
{
    protected ReturnDecisionSubreasonType|MockObject $object;
    ...
    {
        $this->assertTrue(enum_exists(ReturnDecisionSubreasonType::class));
    }
}
