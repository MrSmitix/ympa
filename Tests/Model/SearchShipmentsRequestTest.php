 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\SearchShipmentsRequest
 */
class SearchShipmentsRequestTest extends TestCase
{
    protected SearchShipmentsRequest|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(SearchShipmentsRequest::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(SearchShipmentsRequest::class));
        $this->assertInstanceOf(SearchShipmentsRequest::class, $this->object);
    }
     ...
     * @small
     */
    public function testPropertyCancelledOrders(): void
    {
        $this->markTestSkipped('Test for property cancelledOrders not implemented');
    }
}
