...
use OpenAPI\Server\Model\OrderDeliveryDateReasonType;
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\OrderDeliveryDateReasonType
 */
class OrderDeliveryDateReasonTypeTest extends TestCase
{
    protected OrderDeliveryDateReasonType|MockObject $object;
    ...
    {
        $this->assertTrue(enum_exists(OrderDeliveryDateReasonType::class));
    }
}
