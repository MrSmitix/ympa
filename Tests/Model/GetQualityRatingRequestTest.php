 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\GetQualityRatingRequest
 */
class GetQualityRatingRequestTest extends TestCase
{
    protected GetQualityRatingRequest|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(GetQualityRatingRequest::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(GetQualityRatingRequest::class));
        $this->assertInstanceOf(GetQualityRatingRequest::class, $this->object);
    }
