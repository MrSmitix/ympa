...
use OpenAPI\Server\Model\RegionType;
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\RegionType
 */
class RegionTypeTest extends TestCase
{
    protected RegionType|MockObject $object;
    ...
    {
        $this->assertTrue(enum_exists(RegionType::class));
    }
}
