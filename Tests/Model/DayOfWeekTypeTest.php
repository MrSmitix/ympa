...
use OpenAPI\Server\Model\DayOfWeekType;
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\DayOfWeekType
 */
class DayOfWeekTypeTest extends TestCase
{
    protected DayOfWeekType|MockObject $object;
    ...
    {
        $this->assertTrue(enum_exists(DayOfWeekType::class));
    }
}
