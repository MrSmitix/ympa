...
use OpenAPI\Server\Model\PromoOfferUpdateWarningCodeType;
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\PromoOfferUpdateWarningCodeType
 */
class PromoOfferUpdateWarningCodeTypeTest extends TestCase
{
    protected PromoOfferUpdateWarningCodeType|MockObject $object;
    ...
    {
        $this->assertTrue(enum_exists(PromoOfferUpdateWarningCodeType::class));
    }
}
