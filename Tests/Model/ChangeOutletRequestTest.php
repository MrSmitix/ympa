 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\ChangeOutletRequest
 */
class ChangeOutletRequestTest extends TestCase
{
    protected ChangeOutletRequest|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(ChangeOutletRequest::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(ChangeOutletRequest::class));
        $this->assertInstanceOf(ChangeOutletRequest::class, $this->object);
    }
