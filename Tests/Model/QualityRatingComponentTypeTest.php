...
use OpenAPI\Server\Model\QualityRatingComponentType;
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\QualityRatingComponentType
 */
class QualityRatingComponentTypeTest extends TestCase
{
    protected QualityRatingComponentType|MockObject $object;
    ...
    {
        $this->assertTrue(enum_exists(QualityRatingComponentType::class));
    }
}
