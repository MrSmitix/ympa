...
use OpenAPI\Server\Model\BriefOrderItemDTO;
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\BriefOrderItemDTO
 */
class BriefOrderItemDTOTest extends TestCase
{
    protected BriefOrderItemDTO|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(BriefOrderItemDTO::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(BriefOrderItemDTO::class));
        $this->assertInstanceOf(BriefOrderItemDTO::class, $this->object);
    }
