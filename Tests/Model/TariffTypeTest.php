...
use OpenAPI\Server\Model\TariffType;
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\TariffType
 */
class TariffTypeTest extends TestCase
{
    protected TariffType|MockObject $object;
    ...
    {
        $this->assertTrue(enum_exists(TariffType::class));
    }
}
