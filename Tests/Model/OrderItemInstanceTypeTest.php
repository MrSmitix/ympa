...
use OpenAPI\Server\Model\OrderItemInstanceType;
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\OrderItemInstanceType
 */
class OrderItemInstanceTypeTest extends TestCase
{
    protected OrderItemInstanceType|MockObject $object;
    ...
    {
        $this->assertTrue(enum_exists(OrderItemInstanceType::class));
    }
}
