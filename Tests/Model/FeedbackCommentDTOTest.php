...
use OpenAPI\Server\Model\FeedbackCommentDTO;
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\FeedbackCommentDTO
 */
class FeedbackCommentDTOTest extends TestCase
{
    protected FeedbackCommentDTO|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(FeedbackCommentDTO::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(FeedbackCommentDTO::class));
        $this->assertInstanceOf(FeedbackCommentDTO::class, $this->object);
    }
