...
use OpenAPI\Server\Model\TariffDTO;
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\TariffDTO
 */
class TariffDTOTest extends TestCase
{
    protected TariffDTO|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(TariffDTO::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(TariffDTO::class));
        $this->assertInstanceOf(TariffDTO::class, $this->object);
    }
