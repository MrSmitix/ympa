...
use OpenAPI\Server\Model\ShipmentType;
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\ShipmentType
 */
class ShipmentTypeTest extends TestCase
{
    protected ShipmentType|MockObject $object;
    ...
    {
        $this->assertTrue(enum_exists(ShipmentType::class));
    }
}
