...
use OpenAPI\Server\Model\OutletDTO;
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\OutletDTO
 */
class OutletDTOTest extends TestCase
{
    protected OutletDTO|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(OutletDTO::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(OutletDTO::class));
        $this->assertInstanceOf(OutletDTO::class, $this->object);
    }
