...
use OpenAPI\Server\Model\DocumentDTO;
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\DocumentDTO
 */
class DocumentDTOTest extends TestCase
{
    protected DocumentDTO|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(DocumentDTO::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(DocumentDTO::class));
        $this->assertInstanceOf(DocumentDTO::class, $this->object);
    }
