...
use OpenAPI\Server\Model\OrderLiftType;
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\OrderLiftType
 */
class OrderLiftTypeTest extends TestCase
{
    protected OrderLiftType|MockObject $object;
    ...
    {
        $this->assertTrue(enum_exists(OrderLiftType::class));
    }
}
