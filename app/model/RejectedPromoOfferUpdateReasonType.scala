...
object RejectedPromoOfferUpdateReasonType {
  implicit lazy val rejectedPromoOfferUpdateReasonTypeJsonFormat: Format[RejectedPromoOfferUpdateReasonType] = Json.format[RejectedPromoOfferUpdateReasonType]
}
