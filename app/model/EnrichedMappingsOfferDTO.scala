...
object EnrichedMappingsOfferDTO {
  implicit lazy val enrichedMappingsOfferDTOJsonFormat: Format[EnrichedMappingsOfferDTO] = {
    val realJsonFormat = Json.format[EnrichedMappingsOfferDTO]
    ...
    Format(
      ...
      Writes { enrichedMappingsOfferDTO =>
        val jsObj = realJsonFormat.writes(enrichedMappingsOfferDTO)
