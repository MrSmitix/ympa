...
case class GetOfferDTO(
  ...
  manuals: Option[List[OfferManualDTO]],
  ...
  `type`: Option[OfferType],
  downloadable: Option[Boolean],
  adult: Option[Boolean],
  age: Option[AgeDTO],
  params: Option[List[OfferParamDTO]],
  ...
  campaigns: Option[List[OfferCampaignStatusDTO]],
  sellingPrograms: Option[List[OfferSellingProgramDTO]],
  archived: Option[Boolean]
  additionalProperties: 
)

object GetOfferDTO {
  implicit lazy val getOfferDTOJsonFormat: Format[GetOfferDTO] = {
    val realJsonFormat = Json.format[GetOfferDTO]
    val declaredPropNames = Set("offerId", "name", "marketCategoryId", "category", "pictures", "videos", "manuals", "vendor", "barcodes", "description", "manufacturerCountries", "weightDimensions", "vendorCode", "tags", "shelfLife", "lifeTime", "guaranteePeriod", "customsCommodityCode", "certificates", "boxCount", "condition", "`type`", "downloadable", "adult", "age", "params", "basicPrice", "purchasePrice", "additionalExpenses", "cofinancePrice", "cardStatus", "campaigns", "sellingPrograms", "archived")
    ...
    Format(
      ...
      Writes { getOfferDTO =>
        val jsObj = realJsonFormat.writes(getOfferDTO)
