...
object UpdateOfferDTO {
  implicit lazy val updateOfferDTOJsonFormat: Format[UpdateOfferDTO] = {
    val realJsonFormat = Json.format[UpdateOfferDTO]
    ...
    Format(
      ...
      Writes { updateOfferDTO =>
        val jsObj = realJsonFormat.writes(updateOfferDTO)
