...
object UpdateMappingsOfferDTO {
  implicit lazy val updateMappingsOfferDTOJsonFormat: Format[UpdateMappingsOfferDTO] = {
    val realJsonFormat = Json.format[UpdateMappingsOfferDTO]
    ...
    Format(
      ...
      Writes { updateMappingsOfferDTO =>
        val jsObj = realJsonFormat.writes(updateMappingsOfferDTO)
