...
class TestFbyController(BaseTestCase):
    """FbyController integration test stubs"""
    ...
    def test_get_feed_index_logs(self):
        ...
        query_string = [('limit', 20),
                        ...
                        ('status', ympa_python_blueplanet_server.FeedIndexLogsStatusType())]
        response = self.client.open(
    ...
    def test_get_offer_mapping_entries(self):
        ...
        query_string = [('offer_id', ['offer_id_example']),
                        ...
                        ('mapping_kind', ympa_python_blueplanet_server.OfferMappingKindType()),
                        ('status', [ympa_python_blueplanet_server.OfferProcessingStatusType()]),
                        ('availability', [ympa_python_blueplanet_server.OfferAvailabilityStatusType()]),
                        ('category_id', [56]),
