...
from app.ympa_python_blueplanet_server.models.age_unit_type import AgeUnitType  # noqa: F401,E501
...
class AgeDTO(Model):
    ...
    def __init__(self, value: float=None, age_unit: AgeUnitType=None):  # noqa: E501
        """AgeDTO - a model defined in Swagger
