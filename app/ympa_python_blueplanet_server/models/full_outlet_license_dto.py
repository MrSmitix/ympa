...
from app.ympa_python_blueplanet_server.models.license_check_status_type import LicenseCheckStatusType  # noqa: F401,E501
...
class FullOutletLicenseDTO(Model):
    ...
    def __init__(self, id: int=None, outlet_id: int=None, license_type: LicenseType=None, number: str=None, date_of_issue: datetime=None, date_of_expiry: datetime=None, check_status: LicenseCheckStatusType=None, check_comment: str=None):  # noqa: E501
        """FullOutletLicenseDTO - a model defined in Swagger
