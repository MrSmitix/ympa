...
from app.ympa_python_blueplanet_server.models.return_decision_reason_type import ReturnDecisionReasonType  # noqa: F401,E501
from app.ympa_python_blueplanet_server.models.return_decision_subreason_type import ReturnDecisionSubreasonType  # noqa: F401,E501
from app.ympa_python_blueplanet_server.models.return_decision_type import ReturnDecisionType  # noqa: F401,E501
...
class ReturnDecisionDTO(Model):
    ...
    def __init__(self, return_item_id: int=None, count: int=None, comment: str=None, reason_type: ReturnDecisionReasonType=None, subreason_type: ReturnDecisionSubreasonType=None, decision_type: ReturnDecisionType=None, refund_amount: int=None, partner_compensation: int=None, images: List[str]=None):  # noqa: E501
        """ReturnDecisionDTO - a model defined in Swagger
