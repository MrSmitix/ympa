...
from app.ympa_python_blueplanet_server.models.return_request_decision_type import ReturnRequestDecisionType  # noqa: F401,E501
...
class SetReturnDecisionRequest(Model):
    ...
    def __init__(self, return_item_id: int=None, decision_type: ReturnRequestDecisionType=None, comment: str=None):  # noqa: E501
        """SetReturnDecisionRequest - a model defined in Swagger
