...
from app.ympa_python_blueplanet_server.models.update_offer_mapping_result_dto import UpdateOfferMappingResultDTO  # noqa: F401,E501
...
class UpdateOfferMappingsResponse(Model):
    ...
    def __init__(self, status: ApiResponseStatusType=None, results: List[UpdateOfferMappingResultDTO]=None):  # noqa: E501
        """UpdateOfferMappingsResponse - a model defined in Swagger
