...
from app.ympa_python_blueplanet_server.models.get_promo_promocode_info_dto import GetPromoPromocodeInfoDTO  # noqa: F401,E501
...
class GetPromoMechanicsInfoDTO(Model):
    ...
    def __init__(self, type: MechanicsType=None, promocode_info: GetPromoPromocodeInfoDTO=None):  # noqa: E501
        """GetPromoMechanicsInfoDTO - a model defined in Swagger
