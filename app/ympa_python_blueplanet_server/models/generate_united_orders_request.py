...
class GenerateUnitedOrdersRequest(Model):
    ...
    def __init__(self, business_id: int=None, date_from: date=None, date_to: date=None, campaign_ids: List[int]=None, promo_id: str=None):  # noqa: E501
        """GenerateUnitedOrdersRequest - a model defined in Swagger
