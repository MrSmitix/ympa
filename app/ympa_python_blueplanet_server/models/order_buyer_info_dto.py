...
class OrderBuyerInfoDTO(Model):
    ...
    def __init__(self, id: str=None, last_name: str=None, first_name: str=None, middle_name: str=None, type: OrderBuyerType=None, phone: str=None):  # noqa: E501
        """OrderBuyerInfoDTO - a model defined in Swagger
