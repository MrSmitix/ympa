...
class WarehouseGroupDTO(Model):
    ...
    def __init__(self, name: str=None, main_warehouse: WarehouseDTO=None, warehouses: List[WarehouseDTO]=None):  # noqa: E501
        """WarehouseGroupDTO - a model defined in Swagger
