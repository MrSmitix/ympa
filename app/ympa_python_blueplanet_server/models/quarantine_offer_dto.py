...
from app.ympa_python_blueplanet_server.models.price_quarantine_verdict_dto import PriceQuarantineVerdictDTO  # noqa: F401,E501
...
class QuarantineOfferDTO(Model):
    ...
    def __init__(self, offer_id: str=None, current_price: BasePriceDTO=None, last_valid_price: BasePriceDTO=None, verdicts: List[PriceQuarantineVerdictDTO]=None):  # noqa: E501
        """QuarantineOfferDTO - a model defined in Swagger
