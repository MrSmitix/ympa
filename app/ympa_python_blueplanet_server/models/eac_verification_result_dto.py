...
from app.ympa_python_blueplanet_server.models.eac_verification_status_type import EacVerificationStatusType  # noqa: F401,E501
...
class EacVerificationResultDTO(Model):
    ...
    def __init__(self, verification_result: EacVerificationStatusType=None, attempts_left: int=None):  # noqa: E501
        """EacVerificationResultDTO - a model defined in Swagger
