...
from app.ympa_python_blueplanet_server.models.order_document_status_type import OrderDocumentStatusType  # noqa: F401,E501
...
class DocumentDTO(Model):
    ...
    def __init__(self, status: OrderDocumentStatusType=None, number: str=None, _date: date=None):  # noqa: E501
        """DocumentDTO - a model defined in Swagger
