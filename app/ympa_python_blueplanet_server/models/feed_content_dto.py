...
from app.ympa_python_blueplanet_server.models.feed_content_error_dto import FeedContentErrorDTO  # noqa: F401,E501
...
class FeedContentDTO(Model):
    ...
    def __init__(self, rejected_offers_count: int=None, status: FeedStatusType=None, total_offers_count: int=None, error: FeedContentErrorDTO=None):  # noqa: E501
        """FeedContentDTO - a model defined in Swagger
