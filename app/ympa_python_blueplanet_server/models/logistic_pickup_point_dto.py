...
from app.ympa_python_blueplanet_server.models.logistic_point_type import LogisticPointType  # noqa: F401,E501
from app.ympa_python_blueplanet_server.models.pickup_address_dto import PickupAddressDTO  # noqa: F401,E501
...
class LogisticPickupPointDTO(Model):
    ...
    def __init__(self, id: int=None, name: str=None, address: PickupAddressDTO=None, instruction: str=None, type: LogisticPointType=None, logistic_partner_id: int=None):  # noqa: E501
        """LogisticPickupPointDTO - a model defined in Swagger
