...
from app.ympa_python_blueplanet_server.models.time_unit_type import TimeUnitType  # noqa: F401,E501
...
class TimePeriodDTO(Model):
    ...
    def __init__(self, time_period: int=None, time_unit: TimeUnitType=None, comment: str=None):  # noqa: E501
        """TimePeriodDTO - a model defined in Swagger
