...
from app.ympa_python_blueplanet_server.models.price_quarantine_verdict_parameter_dto import PriceQuarantineVerdictParameterDTO  # noqa: F401,E501
from app.ympa_python_blueplanet_server.models.price_quarantine_verdict_type import PriceQuarantineVerdictType  # noqa: F401,E501
...
class PriceQuarantineVerdictDTO(Model):
    ...
    def __init__(self, type: PriceQuarantineVerdictType=None, params: List[PriceQuarantineVerdictParameterDTO]=None):  # noqa: E501
        """PriceQuarantineVerdictDTO - a model defined in Swagger
