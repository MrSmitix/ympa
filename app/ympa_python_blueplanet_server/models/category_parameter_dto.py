...
from app.ympa_python_blueplanet_server.models.category_parameter_unit_dto import CategoryParameterUnitDTO  # noqa: F401,E501
from app.ympa_python_blueplanet_server.models.offer_card_recommendation_type import OfferCardRecommendationType  # noqa: F401,E501
from app.ympa_python_blueplanet_server.models.parameter_type import ParameterType  # noqa: F401,E501
from app.ympa_python_blueplanet_server.models.parameter_value_constraints_dto import ParameterValueConstraintsDTO  # noqa: F401,E501
from app.ympa_python_blueplanet_server.models.parameter_value_option_dto import ParameterValueOptionDTO  # noqa: F401,E501
from app.ympa_python_blueplanet_server.models.value_restriction_dto import ValueRestrictionDTO  # noqa: F401,E501
...
class CategoryParameterDTO(Model):
    ...
    def __init__(self, id: int=None, name: str=None, type: ParameterType=None, unit: CategoryParameterUnitDTO=None, description: str=None, recommendation_types: List[OfferCardRecommendationType]=None, required: bool=None, filtering: bool=None, distinctive: bool=None, multivalue: bool=None, allow_custom_values: bool=None, values: List[ParameterValueOptionDTO]=None, constraints: ParameterValueConstraintsDTO=None, value_restrictions: List[ValueRestrictionDTO]=None):  # noqa: E501
        """CategoryParameterDTO - a model defined in Swagger
