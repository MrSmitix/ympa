...
from app.ympa_python_blueplanet_server.models.order_promo_type import OrderPromoType  # noqa: F401,E501
...
class OrderItemPromoDTO(Model):
    ...
    def __init__(self, type: OrderPromoType=None, discount: float=None, subsidy: float=None, shop_promo_id: str=None, market_promo_id: str=None):  # noqa: E501
        """OrderItemPromoDTO - a model defined in Swagger
