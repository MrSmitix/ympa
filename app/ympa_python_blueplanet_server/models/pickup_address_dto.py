...
class PickupAddressDTO(Model):
    ...
    def __init__(self, country: str=None, city: str=None, street: str=None, house: str=None, postcode: str=None):  # noqa: E501
        """PickupAddressDTO - a model defined in Swagger
