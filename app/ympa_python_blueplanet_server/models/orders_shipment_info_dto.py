...
class OrdersShipmentInfoDTO(Model):
    ...
    def __init__(self, order_ids_with_labels: list[int]=None, order_ids_without_labels: list[int]=None):  # noqa: E501
        """OrdersShipmentInfoDTO - a model defined in Swagger
