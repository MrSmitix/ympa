...
class GetOfferCardsContentStatusRequest(Model):
    ...
    def __init__(self, offer_ids: list[str]=None, card_statuses: list[OfferCardStatusType]=None, category_ids: list[int]=None):  # noqa: E501
        """GetOfferCardsContentStatusRequest - a model defined in Swagger
