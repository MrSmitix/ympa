...
class FlippingPagerDTO(Model):
    ...
    def __init__(self, total: int=None, _from: int=None, to: int=None, current_page: int=None, pages_count: int=None, page_size: int=None):  # noqa: E501
        """FlippingPagerDTO - a model defined in Swagger
