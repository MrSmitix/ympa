...
from app.ympa_python_blueplanet_server.models.quality_rating_component_type import QualityRatingComponentType  # noqa: F401,E501
...
class QualityRatingComponentDTO(Model):
    ...
    def __init__(self, value: float=None, component_type: QualityRatingComponentType=None):  # noqa: E501
        """QualityRatingComponentDTO - a model defined in Swagger
