...
from app.ympa_python_blueplanet_server.models.offer_card_recommendation_dto import OfferCardRecommendationDTO  # noqa: F401,E501
...
class OfferCardDTO(Model):
    ...
    def __init__(self, offer_id: str=None, mapping: GetMappingDTO=None, parameter_values: List[ParameterValueDTO]=None, card_status: OfferCardStatusType=None, content_rating: int=None, recommendations: List[OfferCardRecommendationDTO]=None, errors: List[OfferErrorDTO]=None, warnings: List[OfferErrorDTO]=None):  # noqa: E501
        """OfferCardDTO - a model defined in Swagger
