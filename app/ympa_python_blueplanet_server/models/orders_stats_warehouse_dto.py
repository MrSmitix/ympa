...
class OrdersStatsWarehouseDTO(Model):
    ...
    def __init__(self, id: int=None, name: str=None):  # noqa: E501
        """OrdersStatsWarehouseDTO - a model defined in Swagger

        :param id: The id of this OrdersStatsWarehouseDTO.  # noqa: E501
        :type id: int
        :param name: The name of this OrdersStatsWarehouseDTO.  # noqa: E501
        :type name: str
        """
        self.swagger_types = {
            'id': int,
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'OrdersStatsWarehouseDTO':
        """Returns the dict as a model

        :param dikt: A dict.
        :type: dict
        :return: The OrdersStatsWarehouseDTO of this OrdersStatsWarehouseDTO.  # noqa: E501
