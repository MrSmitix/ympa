...
from app.ympa_python_blueplanet_server.models.suggested_offer_mapping_dto import SuggestedOfferMappingDTO  # noqa: F401,E501
...
class GetSuggestedOfferMappingsResultDTO(Model):
    ...
    def __init__(self, offers: List[SuggestedOfferMappingDTO]=None):  # noqa: E501
        """GetSuggestedOfferMappingsResultDTO - a model defined in Swagger
