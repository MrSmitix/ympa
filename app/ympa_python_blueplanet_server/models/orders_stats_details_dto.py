...
from app.ympa_python_blueplanet_server.models.orders_stats_item_status_type import OrdersStatsItemStatusType  # noqa: F401,E501
from app.ympa_python_blueplanet_server.models.orders_stats_stock_type import OrdersStatsStockType  # noqa: F401,E501
...
class OrdersStatsDetailsDTO(Model):
    ...
    def __init__(self, item_status: OrdersStatsItemStatusType=None, item_count: int=None, update_date: date=None, stock_type: OrdersStatsStockType=None):  # noqa: E501
        """OrdersStatsDetailsDTO - a model defined in Swagger
