...
from app.ympa_python_blueplanet_server.models.feedback_comment_author_dto import FeedbackCommentAuthorDTO  # noqa: F401,E501
...
class FeedbackCommentDTO(Model):
    ...
    def __init__(self, id: int=None, parent_id: int=None, body: str=None, created_at: datetime=None, updated_at: datetime=None, author: FeedbackCommentAuthorDTO=None, children: List[FeedbackCommentDTO]=None):  # noqa: E501
        """FeedbackCommentDTO - a model defined in Swagger
