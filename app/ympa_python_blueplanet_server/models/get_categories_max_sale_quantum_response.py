...
class GetCategoriesMaxSaleQuantumResponse(Model):
    ...
    def __init__(self, status: ApiResponseStatusType=None, results: List[MaxSaleQuantumDTO]=None, errors: List[CategoryErrorDTO]=None):  # noqa: E501
        """GetCategoriesMaxSaleQuantumResponse - a model defined in Swagger
