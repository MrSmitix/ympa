...
from app.ympa_python_blueplanet_server.models.feed_download_error_type import FeedDownloadErrorType  # noqa: F401,E501
...
class FeedDownloadErrorDTO(Model):
    ...
    def __init__(self, http_status_code: int=None, type: FeedDownloadErrorType=None, description: str=None):  # noqa: E501
        """FeedDownloadErrorDTO - a model defined in Swagger
