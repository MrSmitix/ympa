...
class CalculateTariffsOfferDTO(Model):
    ...
    def __init__(self, category_id: int=None, price: float=None, length: float=None, width: float=None, height: float=None, weight: float=None, quantity: int=1):  # noqa: E501
        """CalculateTariffsOfferDTO - a model defined in Swagger
