...
from app.ympa_python_blueplanet_server.models.payment_frequency_type import PaymentFrequencyType  # noqa: F401,E501
...
class CalculateTariffsParametersDTO(Model):
    ...
    def __init__(self, campaign_id: int=None, selling_program: SellingProgramType=None, frequency: PaymentFrequencyType=None):  # noqa: E501
        """CalculateTariffsParametersDTO - a model defined in Swagger
