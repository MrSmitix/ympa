...
class GetModelsOffersResponse(Model):
    ...
    def __init__(self, models: List[EnrichedModelDTO]=None, currency: CurrencyType=None, region_id: int=None):  # noqa: E501
        """GetModelsOffersResponse - a model defined in Swagger
