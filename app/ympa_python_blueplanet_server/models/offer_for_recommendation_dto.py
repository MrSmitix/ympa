...
class OfferForRecommendationDTO(Model):
    ...
    def __init__(self, offer_id: str=None, price: BasePriceDTO=None, cofinance_price: GetPriceDTO=None, competitiveness: PriceCompetitivenessType=None, shows: int=None):  # noqa: E501
        """OfferForRecommendationDTO - a model defined in Swagger
