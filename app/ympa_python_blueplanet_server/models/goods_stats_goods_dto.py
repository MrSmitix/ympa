...
from app.ympa_python_blueplanet_server.models.goods_stats_warehouse_dto import GoodsStatsWarehouseDTO  # noqa: F401,E501
from app.ympa_python_blueplanet_server.models.goods_stats_weight_dimensions_dto import GoodsStatsWeightDimensionsDTO  # noqa: F401,E501
from app.ympa_python_blueplanet_server.models.tariff_dto import TariffDTO  # noqa: F401,E501
...
class GoodsStatsGoodsDTO(Model):
    ...
    def __init__(self, shop_sku: str=None, market_sku: int=None, name: str=None, price: float=None, category_id: int=None, category_name: str=None, weight_dimensions: GoodsStatsWeightDimensionsDTO=None, warehouses: List[GoodsStatsWarehouseDTO]=None, tariffs: List[TariffDTO]=None, pictures: List[str]=None):  # noqa: E501
        """GoodsStatsGoodsDTO - a model defined in Swagger
