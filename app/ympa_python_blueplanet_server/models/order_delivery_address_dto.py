...
class OrderDeliveryAddressDTO(Model):
    ...
    def __init__(self, country: str=None, postcode: str=None, city: str=None, district: str=None, subway: str=None, street: str=None, house: str=None, block: str=None, entrance: str=None, entryphone: str=None, floor: str=None, apartment: str=None, phone: str=None, recipient: str=None, gps: GpsDTO=None):  # noqa: E501
        """OrderDeliveryAddressDTO - a model defined in Swagger
