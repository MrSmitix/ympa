...
from app.ympa_python_blueplanet_server.models.return_decision_dto import ReturnDecisionDTO  # noqa: F401,E501
from app.ympa_python_blueplanet_server.models.return_instance_dto import ReturnInstanceDTO  # noqa: F401,E501
from app.ympa_python_blueplanet_server.models.track_dto import TrackDTO  # noqa: F401,E501
...
class ReturnItemDTO(Model):
    ...
    def __init__(self, market_sku: int=None, shop_sku: str=None, count: int=None, decisions: List[ReturnDecisionDTO]=None, instances: List[ReturnInstanceDTO]=None, tracks: List[TrackDTO]=None):  # noqa: E501
        """ReturnItemDTO - a model defined in Swagger
