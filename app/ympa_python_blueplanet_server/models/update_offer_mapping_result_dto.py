...
from app.ympa_python_blueplanet_server.models.offer_mapping_error_dto import OfferMappingErrorDTO  # noqa: F401,E501
...
class UpdateOfferMappingResultDTO(Model):
    ...
    def __init__(self, offer_id: str=None, errors: List[OfferMappingErrorDTO]=None, warnings: List[OfferMappingErrorDTO]=None):  # noqa: E501
        """UpdateOfferMappingResultDTO - a model defined in Swagger
