...
class GeneratePricesReportRequest(Model):
    ...
    def __init__(self, business_id: int=None, campaign_id: int=None, category_ids: List[int]=None, creation_date_from: date=None, creation_date_to: date=None):  # noqa: E501
        """GeneratePricesReportRequest - a model defined in Swagger
