...
class GoodsFeedbackStatisticsDTO(Model):
    ...
    def __init__(self, rating: int=None, comments_count: int=None, recommended: bool=None, paid_amount: int=None):  # noqa: E501
        """GoodsFeedbackStatisticsDTO - a model defined in Swagger
