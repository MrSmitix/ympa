...
from app.ympa_python_blueplanet_server.models.offer_content_error_type import OfferContentErrorType  # noqa: F401,E501
...
class OfferContentErrorDTO(Model):
    ...
    def __init__(self, type: OfferContentErrorType=None, parameter_id: int=None, message: str=None):  # noqa: E501
        """OfferContentErrorDTO - a model defined in Swagger
