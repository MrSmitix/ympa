...
class GetOrdersStatsRequest(Model):
    ...
    def __init__(self, date_from: date=None, date_to: date=None, update_from: date=None, update_to: date=None, orders: List[int]=None, statuses: List[OrderStatsStatusType]=None, has_cis: bool=None):  # noqa: E501
        """GetOrdersStatsRequest - a model defined in Swagger
