...
class GetCampaignOffersRequest(Model):
    ...
    def __init__(self, offer_ids: List[str]=None, statuses: List[OfferCampaignStatusType]=None, category_ids: List[int]=None, vendor_names: List[str]=None, tags: List[str]=None):  # noqa: E501
        """GetCampaignOffersRequest - a model defined in Swagger
