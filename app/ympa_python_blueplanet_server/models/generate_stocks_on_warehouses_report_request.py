...
class GenerateStocksOnWarehousesReportRequest(Model):
    ...
    def __init__(self, campaign_id: int=None, warehouse_ids: List[int]=None, report_date: date=None, category_ids: List[int]=None, has_stocks: bool=None):  # noqa: E501
        """GenerateStocksOnWarehousesReportRequest - a model defined in Swagger
