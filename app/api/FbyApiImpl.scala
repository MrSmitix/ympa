...
/**
  * Provides a default implementation for [[FbyApi]].
  */
@javax.annotation.Generated(value = Array("org.openapitools.codegen.languages.ScalaPlayFrameworkServerCodegen"), date = "2024-09-09T22:33:09.055496365Z[Etc/UTC]", comments = "Generator version: 7.8.0")
class FbyApiImpl extends FbyApi {
  /**
    * @inheritdoc
    */
  ...
  /**
    * @inheritdoc
    */
  override def generateGoodsMovementReport(generateGoodsMovementReportRequest: GenerateGoodsMovementReportRequest, format: Option[ReportFormatType]): GenerateReportResponse = {
    // TODO: Implement better logic
  ...
  /**
    * @inheritdoc
    */
  override def generateGoodsRealizationReport(generateGoodsRealizationReportRequest: GenerateGoodsRealizationReportRequest, format: Option[ReportFormatType]): GenerateReportResponse = {
    // TODO: Implement better logic
  ...
  /**
    * @inheritdoc
    */
  override def generateGoodsTurnoverReport(generateGoodsTurnoverRequest: GenerateGoodsTurnoverRequest, format: Option[ReportFormatType]): GenerateReportResponse = {
    // TODO: Implement better logic
