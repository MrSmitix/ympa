...
trait FbsApi {
  ...
  /**
    ...
    */
  def confirmShipment(campaignId: Long, shipmentId: Long, confirmShipmentRequest: Option[ConfirmShipmentRequest]): EmptyApiResponse
  ...
  /**
    ...
    * @param shipmentId Идентификатор отгрузки.
    */
  def downloadShipmentAct(campaignId: Long, shipmentId: Long): TemporaryFile
  ...
  /**
    ...
    * @param shipmentId Идентификатор отгрузки.
    */
  def downloadShipmentDiscrepancyAct(campaignId: Long, shipmentId: Long): TemporaryFile
  ...
  /**
    ...
    * @param shipmentId Идентификатор отгрузки.
    */
  def downloadShipmentInboundAct(campaignId: Long, shipmentId: Long): TemporaryFile
  ...
  /**
    ...
    */
  def downloadShipmentPalletLabels(campaignId: Long, shipmentId: Long, format: Option[ShipmentPalletLabelPageFormatType]): TemporaryFile
  ...
  /**
    ...
    */
  def downloadShipmentReceptionTransferAct(campaignId: Long, warehouseId: Option[Int]): TemporaryFile
  ...
  /**
    ...
    * @param shipmentId Идентификатор отгрузки.
    */
  def downloadShipmentTransportationWaybill(campaignId: Long, shipmentId: Long): TemporaryFile
  ...
  /**
    ...
    */
  def getShipment(campaignId: Long, shipmentId: Long, cancelledOrders: Option[Boolean]): GetShipmentResponse
  ...
  /**
    ...
    * @param shipmentId Идентификатор отгрузки.
    */
  def getShipmentOrdersInfo(campaignId: Long, shipmentId: Long): GetShipmentOrdersInfoResponse
  ...
  /**
    ...
    * @param limit Количество значений на одной странице. 
    */
  def searchShipments(campaignId: Long, searchShipmentsRequest: SearchShipmentsRequest, pageToken: Option[String], limit: Option[Int]): SearchShipmentsResponse
  ...
  /**
    ...
    * @param shipmentId Идентификатор отгрузки.
    */
  def setShipmentPalletsCount(campaignId: Long, shipmentId: Long, setShipmentPalletsCountRequest: SetShipmentPalletsCountRequest): EmptyApiResponse
  ...
  /**
    ...
    * @param shipmentId Идентификатор отгрузки.
    */
  def transferOrdersFromShipment(campaignId: Long, shipmentId: Long, transferOrdersFromShipmentRequest: TransferOrdersFromShipmentRequest): EmptyApiResponse
