...
public class ExpressApiController extends Controller {
    private final ExpressApiControllerImpInterface imp;
    private final ObjectMapper mapper;
    private final Config configuration;

    @Inject
    private ExpressApiController(Config configuration, ExpressApiControllerImpInterface imp) {
        this.imp = imp;
