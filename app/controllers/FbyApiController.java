...
public class FbyApiController extends Controller {
    private final FbyApiControllerImpInterface imp;
    private final ObjectMapper mapper;
    private final Config configuration;

    @Inject
    private FbyApiController(Config configuration, FbyApiControllerImpInterface imp) {
        this.imp = imp;
