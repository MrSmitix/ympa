...
@interface OAIPricesApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation OAIPricesApi

NSString* kOAIPricesApiErrorDomain = @"OAIPricesApiErrorDomain";
NSInteger kOAIPricesApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) getPricesWithCampaignId: (NSNumber*) campaignId
    ...
    if (campaignId == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kOAIPricesApiErrorDomain code:kOAIPricesApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
