...
@interface OAIGoodsFeedbackApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation OAIGoodsFeedbackApi

NSString* kOAIGoodsFeedbackApiErrorDomain = @"OAIGoodsFeedbackApiErrorDomain";
NSInteger kOAIGoodsFeedbackApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) deleteGoodsFeedbackCommentWithBusinessId: (NSNumber*) businessId
    ...
    if (businessId == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kOAIGoodsFeedbackApiErrorDomain code:kOAIGoodsFeedbackApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
