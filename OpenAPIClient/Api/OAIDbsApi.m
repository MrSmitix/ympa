...
@implementation OAIDbsApi

NSString* kOAIDbsApiErrorDomain = @"OAIDbsApiErrorDomain";
NSInteger kOAIDbsApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) acceptOrderCancellationWithCampaignId: (NSNumber*) campaignId
    ...
    if (campaignId == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kOAIDbsApiErrorDomain code:kOAIDbsApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
...
///
///  @returns OAICreateOutletResponse*
///
-(NSURLSessionTask*) createOutletWithCampaignId: (NSNumber*) campaignId
    ...
    if (changeOutletRequest == nil) {
        NSParameterAssert(changeOutletRequest);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"changeOutletRequest"] };
            NSError* error = [NSError errorWithDomain:kOAIDbsApiErrorDomain code:kOAIDbsApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/campaigns/{campaignId}/outlets"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"OAICreateOutletResponse*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((OAICreateOutletResponse*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) deleteOutletWithCampaignId: (NSNumber*) campaignId
    ...
    if (outletId == nil) {
        NSParameterAssert(outletId);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"outletId"] };
            NSError* error = [NSError errorWithDomain:kOAIDbsApiErrorDomain code:kOAIDbsApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/campaigns/{campaignId}/outlets/{outletId}"];
...
-(NSURLSessionTask*) deleteOutletLicensesWithCampaignId: (NSNumber*) campaignId
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/campaigns/{campaignId}/outlets/licenses"];
...
///  @param orderId Идентификатор заказа. 
///
///  @returns OAIGetOrderBuyerInfoResponse*
///
-(NSURLSessionTask*) getOrderBuyerInfoWithCampaignId: (NSNumber*) campaignId
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/campaigns/{campaignId}/orders/{orderId}/buyer"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"OAIGetOrderBuyerInfoResponse*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((OAIGetOrderBuyerInfoResponse*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) getOutletWithCampaignId: (NSNumber*) campaignId
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"OAIGetOutletResponse*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((OAIGetOutletResponse*)data, error);
                                }
                            }];
}
...
///  @param ids Список идентификаторов лицензий. (optional)
///
///  @returns OAIGetOutletLicensesResponse*
///
-(NSURLSessionTask*) getOutletLicensesWithCampaignId: (NSNumber*) campaignId
    ...
    NSMutableDictionary* queryParams = [[NSMutableDictionary alloc] init];
    if (outletIds != nil) {
        queryParams[@"outletIds"] = [[OAIQueryParamCollection alloc] initWithValuesAndFormat: outletIds format: @"csv"];
    }
    if (ids != nil) {
        queryParams[@"ids"] = [[OAIQueryParamCollection alloc] initWithValuesAndFormat: ids format: @"csv"];
    }
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"OAIGetOutletLicensesResponse*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((OAIGetOutletLicensesResponse*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) getOutletsWithCampaignId: (NSNumber*) campaignId
    ...
    if (shopOutletCode != nil) {
        queryParams[@"shop_outlet_code"] = shopOutletCode;
    }
    if (regionId2 != nil) {
        queryParams[@"regionId"] = regionId2;
    }
    NSMutableDictionary* headerParams = [NSMutableDictionary dictionaryWithDictionary:self.apiClient.configuration.defaultHeaders];
    [headerParams addEntriesFromDictionary:self.defaultHeaders];
    // HTTP header `Accept`
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"OAIGetOutletsResponse*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((OAIGetOutletsResponse*)data, error);
                                }
                            }];
}
...
///  @param campaignId Идентификатор кампании в API и магазина в кабинете. Каждая кампания в API соответствует магазину в кабинете.  Чтобы узнать идентификаторы своих магазинов, воспользуйтесь запросом [GET campaigns](../../reference/campaigns/getCampaigns.md).  ℹ️ [Что такое кабинет и магазин на Маркете](https://yandex.ru/support/marketplace/account/introduction.html)  
///
///  @returns OAIGetQualityRatingDetailsResponse*
///
-(NSURLSessionTask*) getQualityRatingDetailsWithCampaignId: (NSNumber*) campaignId
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/campaigns/{campaignId}/ratings/quality/details"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"OAIGetQualityRatingDetailsResponse*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((OAIGetQualityRatingDetailsResponse*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) setOrderDeliveryDateWithCampaignId: (NSNumber*) campaignId
    ...
    if (setOrderDeliveryDateRequest == nil) {
        NSParameterAssert(setOrderDeliveryDateRequest);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"setOrderDeliveryDateRequest"] };
            NSError* error = [NSError errorWithDomain:kOAIDbsApiErrorDomain code:kOAIDbsApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/campaigns/{campaignId}/orders/{orderId}/delivery/date"];
    ...
    NSMutableDictionary *formParams = [[NSMutableDictionary alloc] init];
    NSMutableDictionary *localVarFiles = [[NSMutableDictionary alloc] init];
    bodyParam = setOrderDeliveryDateRequest;
...
-(NSURLSessionTask*) setOrderDeliveryTrackCodeWithCampaignId: (NSNumber*) campaignId
    ...
    if (setOrderDeliveryTrackCodeRequest == nil) {
        NSParameterAssert(setOrderDeliveryTrackCodeRequest);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"setOrderDeliveryTrackCodeRequest"] };
            NSError* error = [NSError errorWithDomain:kOAIDbsApiErrorDomain code:kOAIDbsApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/campaigns/{campaignId}/orders/{orderId}/delivery/track"];
    ...
    NSMutableDictionary *formParams = [[NSMutableDictionary alloc] init];
    NSMutableDictionary *localVarFiles = [[NSMutableDictionary alloc] init];
    bodyParam = setOrderDeliveryTrackCodeRequest;
...
-(NSURLSessionTask*) updateOrderStorageLimitWithCampaignId: (NSNumber*) campaignId
    ...
    if (updateOrderStorageLimitRequest == nil) {
        NSParameterAssert(updateOrderStorageLimitRequest);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"updateOrderStorageLimitRequest"] };
            NSError* error = [NSError errorWithDomain:kOAIDbsApiErrorDomain code:kOAIDbsApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/campaigns/{campaignId}/orders/{orderId}/delivery/storage-limit"];
    ...
    NSMutableDictionary *formParams = [[NSMutableDictionary alloc] init];
    NSMutableDictionary *localVarFiles = [[NSMutableDictionary alloc] init];
    bodyParam = updateOrderStorageLimitRequest;
...
-(NSURLSessionTask*) updateOutletLicensesWithCampaignId: (NSNumber*) campaignId
    ...
    if (updateOutletLicenseRequest == nil) {
        NSParameterAssert(updateOutletLicenseRequest);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"updateOutletLicenseRequest"] };
            NSError* error = [NSError errorWithDomain:kOAIDbsApiErrorDomain code:kOAIDbsApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    ...
    NSMutableDictionary *formParams = [[NSMutableDictionary alloc] init];
    NSMutableDictionary *localVarFiles = [[NSMutableDictionary alloc] init];
    bodyParam = updateOutletLicenseRequest;
...
-(NSURLSessionTask*) updateStocksWithCampaignId: (NSNumber*) campaignId
    ...
    if (updateStocksRequest == nil) {
        NSParameterAssert(updateStocksRequest);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"updateStocksRequest"] };
            NSError* error = [NSError errorWithDomain:kOAIDbsApiErrorDomain code:kOAIDbsApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
