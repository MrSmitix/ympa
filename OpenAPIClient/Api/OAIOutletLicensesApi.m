...
@interface OAIOutletLicensesApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation OAIOutletLicensesApi

NSString* kOAIOutletLicensesApiErrorDomain = @"OAIOutletLicensesApiErrorDomain";
NSInteger kOAIOutletLicensesApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) deleteOutletLicensesWithCampaignId: (NSNumber*) campaignId
    ...
    if (campaignId == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kOAIOutletLicensesApiErrorDomain code:kOAIOutletLicensesApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
