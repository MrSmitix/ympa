...
@interface OAIRegionsApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation OAIRegionsApi

NSString* kOAIRegionsApiErrorDomain = @"OAIRegionsApiErrorDomain";
NSInteger kOAIRegionsApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) searchRegionChildrenWithRegionId: (NSNumber*) regionId
    ...
    if (regionId == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kOAIRegionsApiErrorDomain code:kOAIRegionsApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
