...
@interface OAIHiddenOffersApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation OAIHiddenOffersApi

NSString* kOAIHiddenOffersApiErrorDomain = @"OAIHiddenOffersApiErrorDomain";
NSInteger kOAIHiddenOffersApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) addHiddenOffersWithCampaignId: (NSNumber*) campaignId
    ...
    if (campaignId == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kOAIHiddenOffersApiErrorDomain code:kOAIHiddenOffersApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
