...
@interface OAIBusinessesApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation OAIBusinessesApi

NSString* kOAIBusinessesApiErrorDomain = @"OAIBusinessesApiErrorDomain";
NSInteger kOAIBusinessesApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) getBusinessSettingsWithBusinessId: (NSNumber*) businessId
    ...
    if (businessId == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kOAIBusinessesApiErrorDomain code:kOAIBusinessesApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
