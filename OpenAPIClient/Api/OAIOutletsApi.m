...
@interface OAIOutletsApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation OAIOutletsApi

NSString* kOAIOutletsApiErrorDomain = @"OAIOutletsApiErrorDomain";
NSInteger kOAIOutletsApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) createOutletWithCampaignId: (NSNumber*) campaignId
    ...
    if (campaignId == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kOAIOutletsApiErrorDomain code:kOAIOutletsApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
