...
@implementation OAIFbsApi

NSString* kOAIFbsApiErrorDomain = @"OAIFbsApiErrorDomain";
NSInteger kOAIFbsApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) addHiddenOffersWithCampaignId: (NSNumber*) campaignId
    ...
    if (campaignId == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kOAIFbsApiErrorDomain code:kOAIFbsApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
...
-(NSURLSessionTask*) confirmShipmentWithCampaignId: (NSNumber*) campaignId
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/campaigns/{campaignId}/first-mile/shipments/{shipmentId}/confirm"];
    ...
    NSMutableDictionary *formParams = [[NSMutableDictionary alloc] init];
    NSMutableDictionary *localVarFiles = [[NSMutableDictionary alloc] init];
    bodyParam = confirmShipmentRequest;
...
-(NSURLSessionTask*) downloadShipmentActWithCampaignId: (NSNumber*) campaignId
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/campaigns/{campaignId}/first-mile/shipments/{shipmentId}/act"];
...
-(NSURLSessionTask*) downloadShipmentDiscrepancyActWithCampaignId: (NSNumber*) campaignId
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/campaigns/{campaignId}/first-mile/shipments/{shipmentId}/discrepancy-act"];
    ...
    [headerParams addEntriesFromDictionary:self.defaultHeaders];
    // HTTP header `Accept`
    NSString *acceptHeader = [self.apiClient.sanitizer selectHeaderAccept:@[@"application/vnd.ms-excel", @"application/json"]];
    if(acceptHeader.length > 0) {
        headerParams[@"Accept"] = acceptHeader;
    }
...
-(NSURLSessionTask*) downloadShipmentInboundActWithCampaignId: (NSNumber*) campaignId
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/campaigns/{campaignId}/first-mile/shipments/{shipmentId}/inbound-act"];
...
-(NSURLSessionTask*) downloadShipmentPalletLabelsWithCampaignId: (NSNumber*) campaignId
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/campaigns/{campaignId}/first-mile/shipments/{shipmentId}/pallet/labels"];
...
-(NSURLSessionTask*) downloadShipmentReceptionTransferActWithCampaignId: (NSNumber*) campaignId
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/campaigns/{campaignId}/shipments/reception-transfer-act"];
...
-(NSURLSessionTask*) downloadShipmentTransportationWaybillWithCampaignId: (NSNumber*) campaignId
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/campaigns/{campaignId}/first-mile/shipments/{shipmentId}/transportation-waybill"];
...
///
///  @returns OAIGetShipmentResponse*
///
-(NSURLSessionTask*) getShipmentWithCampaignId: (NSNumber*) campaignId
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/campaigns/{campaignId}/first-mile/shipments/{shipmentId}"];
    ...
    if (cancelledOrders != nil) {
        queryParams[@"cancelledOrders"] = [cancelledOrders isEqual:@(YES)] ? @"true" : @"false";
    }
    NSMutableDictionary* headerParams = [NSMutableDictionary dictionaryWithDictionary:self.apiClient.configuration.defaultHeaders];
    [headerParams addEntriesFromDictionary:self.defaultHeaders];
    // HTTP header `Accept`
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"OAIGetShipmentResponse*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((OAIGetShipmentResponse*)data, error);
                                }
                            }];
}
...
///  @param shipmentId Идентификатор отгрузки. 
///
///  @returns OAIGetShipmentOrdersInfoResponse*
///
-(NSURLSessionTask*) getShipmentOrdersInfoWithCampaignId: (NSNumber*) campaignId
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/campaigns/{campaignId}/first-mile/shipments/{shipmentId}/orders/info"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"OAIGetShipmentOrdersInfoResponse*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((OAIGetShipmentOrdersInfoResponse*)data, error);
                                }
                            }];
}
...
///  @param limit Количество значений на одной странице.  (optional)
///
///  @returns OAISearchShipmentsResponse*
///
-(NSURLSessionTask*) searchShipmentsWithCampaignId: (NSNumber*) campaignId
    ...
    if (searchShipmentsRequest == nil) {
        NSParameterAssert(searchShipmentsRequest);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"searchShipmentsRequest"] };
            NSError* error = [NSError errorWithDomain:kOAIFbsApiErrorDomain code:kOAIFbsApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/campaigns/{campaignId}/first-mile/shipments"];
    ...
    NSMutableDictionary *formParams = [[NSMutableDictionary alloc] init];
    NSMutableDictionary *localVarFiles = [[NSMutableDictionary alloc] init];
    bodyParam = searchShipmentsRequest;
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"OAISearchShipmentsResponse*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((OAISearchShipmentsResponse*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) setShipmentPalletsCountWithCampaignId: (NSNumber*) campaignId
    ...
    if (setShipmentPalletsCountRequest == nil) {
        NSParameterAssert(setShipmentPalletsCountRequest);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"setShipmentPalletsCountRequest"] };
            NSError* error = [NSError errorWithDomain:kOAIFbsApiErrorDomain code:kOAIFbsApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/campaigns/{campaignId}/first-mile/shipments/{shipmentId}/pallets"];
    ...
    NSMutableDictionary *formParams = [[NSMutableDictionary alloc] init];
    NSMutableDictionary *localVarFiles = [[NSMutableDictionary alloc] init];
    bodyParam = setShipmentPalletsCountRequest;
...
-(NSURLSessionTask*) transferOrdersFromShipmentWithCampaignId: (NSNumber*) campaignId
    ...
    if (transferOrdersFromShipmentRequest == nil) {
        NSParameterAssert(transferOrdersFromShipmentRequest);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"transferOrdersFromShipmentRequest"] };
            NSError* error = [NSError errorWithDomain:kOAIFbsApiErrorDomain code:kOAIFbsApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/campaigns/{campaignId}/first-mile/shipments/{shipmentId}/orders/transfer"];
    ...
    NSMutableDictionary *formParams = [[NSMutableDictionary alloc] init];
    NSMutableDictionary *localVarFiles = [[NSMutableDictionary alloc] init];
    bodyParam = transferOrdersFromShipmentRequest;
