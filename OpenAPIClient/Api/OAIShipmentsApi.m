...
@interface OAIShipmentsApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation OAIShipmentsApi

NSString* kOAIShipmentsApiErrorDomain = @"OAIShipmentsApiErrorDomain";
NSInteger kOAIShipmentsApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) confirmShipmentWithCampaignId: (NSNumber*) campaignId
    ...
    if (campaignId == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kOAIShipmentsApiErrorDomain code:kOAIShipmentsApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
