...
@interface OAIOffersApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation OAIOffersApi

NSString* kOAIOffersApiErrorDomain = @"OAIOffersApiErrorDomain";
NSInteger kOAIOffersApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) deleteCampaignOffersWithCampaignId: (NSNumber*) campaignId
    ...
    if (campaignId == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kOAIOffersApiErrorDomain code:kOAIOffersApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
