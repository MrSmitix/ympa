...
@interface OAIRatingsApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation OAIRatingsApi

NSString* kOAIRatingsApiErrorDomain = @"OAIRatingsApiErrorDomain";
NSInteger kOAIRatingsApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) getQualityRatingDetailsWithCampaignId: (NSNumber*) campaignId
    ...
    if (campaignId == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kOAIRatingsApiErrorDomain code:kOAIRatingsApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
