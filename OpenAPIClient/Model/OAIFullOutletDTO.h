...
@protocol OAIOutletStatusType;
@class OAIOutletStatusType;
...
@interface OAIFullOutletDTO : OAIObject
...
/* Идентификатор точки продаж, присвоенный Маркетом. [optional]
 */
@property(nonatomic) NSNumber* _id;

@property(nonatomic) OAIOutletStatusType* status;

@property(nonatomic) OAIRegionDTO* region;
/* Идентификатор точки продаж, заданный магазином. [optional]
 */
@property(nonatomic) NSString* shopOutletId;
/* Рабочее время. [optional]
 */
@property(nonatomic) NSString* workingTime;
/* Статус модерации. [optional]
 */
@property(nonatomic) NSString* moderationReason;
