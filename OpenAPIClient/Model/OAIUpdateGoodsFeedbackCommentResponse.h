...
@protocol OAIUpdateGoodsFeedbackCommentResponse
@end

@interface OAIUpdateGoodsFeedbackCommentResponse : OAIObject


@property(nonatomic) OAIApiResponseStatusType* status;

@property(nonatomic) OAIGoodsFeedbackCommentDTO* result;
