...
@implementation OAIMappingsOfferDTO
...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"name", @"shopSku", @"category", @"vendor", @"vendorCode", @"_description", @"_id", @"feedId", @"barcodes", @"urls", @"pictures", @"manufacturer", @"manufacturerCountries", @"minShipment", @"transportUnitSize", @"quantumOfSupply", @"deliveryDurationDays", @"boxCount", @"customsCommodityCodes", @"weightDimensions", @"supplyScheduleDays", @"shelfLifeDays", @"lifeTimeDays", @"guaranteePeriodDays", @"processingState", @"availability", @"shelfLife", @"lifeTime", @"guaranteePeriod", @"certificate", @"price"];
