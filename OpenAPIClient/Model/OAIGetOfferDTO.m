#import "OAIGetOfferDTO.h"

@implementation OAIGetOfferDTO
...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"name", @"marketCategoryId", @"category", @"pictures", @"videos", @"manuals", @"vendor", @"barcodes", @"_description", @"manufacturerCountries", @"weightDimensions", @"vendorCode", @"tags", @"shelfLife", @"lifeTime", @"guaranteePeriod", @"customsCommodityCode", @"certificates", @"boxCount", @"condition", @"type", @"downloadable", @"adult", @"age", @"params", @"basicPrice", @"purchasePrice", @"additionalExpenses", @"cofinancePrice", @"cardStatus", @"campaigns", @"sellingPrograms", @"archived"];
