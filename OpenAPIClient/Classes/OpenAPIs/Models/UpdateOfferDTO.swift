...
/** Параметры товара. */
public struct UpdateOfferDTO: Codable, JSONEncodable, Hashable {
    ...
    static let parameterValuesRule = ArrayRule(minItems: nil, maxItems: 300, uniqueItems: false)
