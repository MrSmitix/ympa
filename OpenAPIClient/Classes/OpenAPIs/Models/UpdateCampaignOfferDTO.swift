...
public struct UpdateCampaignOfferDTO: Codable, JSONEncodable, Hashable {
    ...
    public init(offerId: String, quantum: QuantumDTO? = nil, available: Bool? = nil, vat: Int? = nil) {
