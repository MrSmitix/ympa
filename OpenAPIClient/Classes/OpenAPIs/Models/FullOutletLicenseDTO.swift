...
public struct FullOutletLicenseDTO: Codable, JSONEncodable, Hashable {
    ...
    public var checkStatus: LicenseCheckStatusType?
    ...
    public var checkComment: String?

    public init(id: Int64? = nil, outletId: Int64? = nil, licenseType: LicenseType? = nil, number: String? = nil, dateOfIssue: Date? = nil, dateOfExpiry: Date? = nil, checkStatus: LicenseCheckStatusType? = nil, checkComment: String? = nil) {
        self.id = id
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(dateOfExpiry, forKey: .dateOfExpiry)
        try container.encodeIfPresent(checkStatus, forKey: .checkStatus)
        try container.encodeIfPresent(checkComment, forKey: .checkComment)
    }
}
