//
// OrderStatusChangeDeliveryDatesDTO.swift
//
...
public struct OrderStatusChangeDeliveryDatesDTO: Codable, JSONEncodable, Hashable {
    ...
    public var realDeliveryDate: Date?

    public init(realDeliveryDate: Date? = nil) {
