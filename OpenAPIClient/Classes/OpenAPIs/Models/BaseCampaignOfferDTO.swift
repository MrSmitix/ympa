...
public struct BaseCampaignOfferDTO: Codable, JSONEncodable, Hashable {
    ...
    public init(offerId: String, quantum: QuantumDTO? = nil, available: Bool? = nil) {
