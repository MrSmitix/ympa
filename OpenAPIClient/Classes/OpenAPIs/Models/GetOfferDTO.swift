...
/** Параметры товара. */
public struct GetOfferDTO: Codable, JSONEncodable, Hashable {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(additionalExpenses, forKey: .additionalExpenses)
        ...
        try container.encodeIfPresent(sellingPrograms, forKey: .sellingPrograms)
