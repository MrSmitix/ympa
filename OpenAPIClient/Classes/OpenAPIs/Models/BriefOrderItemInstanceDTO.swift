//
// BriefOrderItemInstanceDTO.swift
//
...
public struct BriefOrderItemInstanceDTO: Codable, JSONEncodable, Hashable {
    ...
    public init(cis: String? = nil, uin: String? = nil, rnpt: String? = nil, gtd: String? = nil) {
        self.cis = cis
        self.uin = uin
        self.rnpt = rnpt
        self.gtd = gtd
