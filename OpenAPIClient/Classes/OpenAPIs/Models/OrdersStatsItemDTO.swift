...
public struct OrdersStatsItemDTO: Codable, JSONEncodable, Hashable {

    static let shopSkuRule = StringRule(minLength: 1, maxLength: 255, pattern: "/^[^\\x00-\\x08\\x0A-\\x1f\\x7f]{1,255}$/")
    static let bidFeeRule = NumericRule<Int>(minimum: 0, exclusiveMinimum: false, maximum: 10000, exclusiveMaximum: false, multipleOf: nil)
    /** Название товара. */
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(cisList, forKey: .cisList)
        try container.encodeIfPresent(initialCount, forKey: .initialCount)
        try container.encodeIfPresent(bidFee, forKey: .bidFee)
        try container.encodeIfPresent(cofinanceThreshold, forKey: .cofinanceThreshold)
        try container.encodeIfPresent(cofinanceValue, forKey: .cofinanceValue)
    }
}
