#tag Class
Protected Class DeliveryServicesApi
	#tag Method, Flags = &h0
		Sub GetDeliveryServices()
		  ...
		  // - 
		  //
		  // Invokes DeliveryServicesApiCallbackHandler.GetDeliveryServicesCallback(GetDeliveryServicesResponse) on completion. 
		  //
	...
	#tag Property, Flags = &h0
		CallbackHandler As OpenAPIClient.APIs.DeliveryServicesApiCallbackHandler
	#tag EndProperty
