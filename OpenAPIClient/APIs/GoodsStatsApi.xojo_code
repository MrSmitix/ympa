...
Protected Class GoodsStatsApi
	#tag Method, Flags = &h0
		Sub GetGoodsStats(, campaignId As Int64, getGoodsStatsRequest As OpenAPIClient.Models.GetGoodsStatsRequest)
		  ...
		  //
		  // Invokes GoodsStatsApiCallbackHandler.GetGoodsStatsCallback(GetGoodsStatsResponse) on completion. 
		  //
	...
	#tag Property, Flags = &h0
		CallbackHandler As OpenAPIClient.APIs.GoodsStatsApiCallbackHandler
	#tag EndProperty
