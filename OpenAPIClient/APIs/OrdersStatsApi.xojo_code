#tag Class
Protected Class OrdersStatsApi
	#tag Method, Flags = &h0
		Sub GetOrdersStats(, campaignId As Int64, Optional pageToken As Xoson.O.OptionalString, Optional limit As Xoson.O.OptionalInteger, Optional getOrdersStatsRequest As OpenAPIClient.Models.GetOrdersStatsRequest)
		  ...
		  //
		  // Invokes OrdersStatsApiCallbackHandler.GetOrdersStatsCallback(GetOrdersStatsResponse) on completion. 
		  //
	...
	#tag Property, Flags = &h0
		CallbackHandler As OpenAPIClient.APIs.OrdersStatsApiCallbackHandler
	#tag EndProperty
