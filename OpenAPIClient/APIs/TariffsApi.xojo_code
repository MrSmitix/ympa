...
Protected Class TariffsApi
	#tag Method, Flags = &h0
		Sub CalculateTariffs(, calculateTariffsRequest As OpenAPIClient.Models.CalculateTariffsRequest)
		  ...
		  //
		  // Invokes TariffsApiCallbackHandler.CalculateTariffsCallback(CalculateTariffsResponse) on completion. 
		  //
	...
	#tag Property, Flags = &h0
		CallbackHandler As OpenAPIClient.APIs.TariffsApiCallbackHandler
	#tag EndProperty
