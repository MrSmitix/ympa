...
Protected Class BusinessesApi
	#tag Method, Flags = &h0
		Sub GetBusinessSettings(, businessId As Int64)
		  ...
		  //
		  // Invokes BusinessesApiCallbackHandler.GetBusinessSettingsCallback(GetBusinessSettingsResponse) on completion. 
		  //
	...
	#tag Property, Flags = &h0
		CallbackHandler As OpenAPIClient.APIs.BusinessesApiCallbackHandler
	#tag EndProperty
