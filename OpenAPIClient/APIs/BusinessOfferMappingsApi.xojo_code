#tag Class
Protected Class BusinessOfferMappingsApi
	#tag Method, Flags = &h0
		Sub AddOffersToArchive(, businessId As Int64, addOffersToArchiveRequest As OpenAPIClient.Models.AddOffersToArchiveRequest)
		  ...
		  //
		  // Invokes BusinessOfferMappingsApiCallbackHandler.AddOffersToArchiveCallback(AddOffersToArchiveResponse) on completion. 
		  //
	...
	#tag Method, Flags = &h0
		Sub DeleteOffers(, businessId As Int64, deleteOffersRequest As OpenAPIClient.Models.DeleteOffersRequest)
		  ...
		  //
		  // Invokes BusinessOfferMappingsApiCallbackHandler.DeleteOffersCallback(DeleteOffersResponse) on completion. 
		  //
	...
	#tag Method, Flags = &h0
		Sub DeleteOffersFromArchive(, businessId As Int64, deleteOffersFromArchiveRequest As OpenAPIClient.Models.DeleteOffersFromArchiveRequest)
		  ...
		  //
		  // Invokes BusinessOfferMappingsApiCallbackHandler.DeleteOffersFromArchiveCallback(DeleteOffersFromArchiveResponse) on completion. 
		  //
	...
	#tag Method, Flags = &h0
		Sub GetOfferMappings(, businessId As Int64, Optional pageToken As Xoson.O.OptionalString, Optional limit As Xoson.O.OptionalInteger, Optional getOfferMappingsRequest As OpenAPIClient.Models.GetOfferMappingsRequest)
		  ...
		  //
		  // Invokes BusinessOfferMappingsApiCallbackHandler.GetOfferMappingsCallback(GetOfferMappingsResponse) on completion. 
		  //
	...
	#tag Method, Flags = &h0
		Sub GetSuggestedOfferMappings(, businessId As Int64, Optional getSuggestedOfferMappingsRequest As OpenAPIClient.Models.GetSuggestedOfferMappingsRequest)
		  ...
		  //
		  // Invokes BusinessOfferMappingsApiCallbackHandler.GetSuggestedOfferMappingsCallback(GetSuggestedOfferMappingsResponse) on completion. 
		  //
	...
	#tag Method, Flags = &h0
		Sub UpdateOfferMappings(, businessId As Int64, updateOfferMappingsRequest As OpenAPIClient.Models.UpdateOfferMappingsRequest)
		  ...
		  //
		  // Invokes BusinessOfferMappingsApiCallbackHandler.UpdateOfferMappingsCallback(UpdateOfferMappingsResponse) on completion. 
		  //
	...
	#tag Property, Flags = &h0
		CallbackHandler As OpenAPIClient.APIs.BusinessOfferMappingsApiCallbackHandler
	#tag EndProperty
