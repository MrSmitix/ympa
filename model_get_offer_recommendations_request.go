...
// GetRecommendedCofinancePriceFilter returns the RecommendedCofinancePriceFilter field value if set, zero value otherwise.
func (o *GetOfferRecommendationsRequest) GetRecommendedCofinancePriceFilter() FieldStateType {
	if o == nil || IsNil(o.RecommendedCofinancePriceFilter) {
		var ret FieldStateType
		return ret
	}
	return *o.RecommendedCofinancePriceFilter
}

// GetRecommendedCofinancePriceFilterOk returns a tuple with the RecommendedCofinancePriceFilter field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *GetOfferRecommendationsRequest) GetRecommendedCofinancePriceFilterOk() (*FieldStateType, bool) {
	if o == nil || IsNil(o.RecommendedCofinancePriceFilter) {
		return nil, false
	}
	return o.RecommendedCofinancePriceFilter, true
}
...
// SetRecommendedCofinancePriceFilter gets a reference to the given FieldStateType and assigns it to the RecommendedCofinancePriceFilter field.
func (o *GetOfferRecommendationsRequest) SetRecommendedCofinancePriceFilter(v FieldStateType) {
	o.RecommendedCofinancePriceFilter = &v
}
...
func (o GetOfferRecommendationsRequest) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.RecommendedCofinancePriceFilter) {
		toSerialize["recommendedCofinancePriceFilter"] = o.RecommendedCofinancePriceFilter
	}
