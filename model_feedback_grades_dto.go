...
type _FeedbackGradesDTO FeedbackGradesDTO
...
func (o *FeedbackGradesDTO) UnmarshalJSON(data []byte) (err error) {
	...
	varFeedbackGradesDTO := _FeedbackGradesDTO{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varFeedbackGradesDTO)

	if err != nil {
		return err
	}

	*o = FeedbackGradesDTO(varFeedbackGradesDTO)
