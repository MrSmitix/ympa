...
void OAIWarehouseGroupDTO::fromJsonObject(QJsonObject json) {
    ...
    m_main_warehouse_isValid = ::OpenAPI::fromJsonValue(m_main_warehouse, json[QString("mainWarehouse")]);
...
QJsonObject OAIWarehouseGroupDTO::asJsonObject() const {
    ...
    if (m_main_warehouse.isSet()) {
        obj.insert(QString("mainWarehouse"), ::OpenAPI::toJsonValue(m_main_warehouse));
    }
...
OAIWarehouseDTO OAIWarehouseGroupDTO::getMainWarehouse() const {
    return m_main_warehouse;
}
void OAIWarehouseGroupDTO::setMainWarehouse(const OAIWarehouseDTO &main_warehouse) {
    m_main_warehouse = main_warehouse;
    m_main_warehouse_isSet = true;
}
