...
#ifndef OAI_OAIFbyApi_H
#define OAI_OAIFbyApi_H
...
class OAIFbyApi : public QObject {
    Q_OBJECT

public:
    OAIFbyApi(const int timeOut = 0);
    ~OAIFbyApi();
...
private:
    ...
    void getFulfillmentWarehousesCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void getFulfillmentWarehousesSignal(OAIGetFulfillmentWarehousesResponse summary);
    ...
    void getFulfillmentWarehousesSignalFull(OAIHttpRequestWorker *worker, OAIGetFulfillmentWarehousesResponse summary);
    ...
    Q_DECL_DEPRECATED_X("Use getFulfillmentWarehousesSignalError() instead")
    void getFulfillmentWarehousesSignalE(OAIGetFulfillmentWarehousesResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getFulfillmentWarehousesSignalError(OAIGetFulfillmentWarehousesResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use getFulfillmentWarehousesSignalErrorFull() instead")
    void getFulfillmentWarehousesSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getFulfillmentWarehousesSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
