...
#ifndef OAIGetOfferDTO_H
#define OAIGetOfferDTO_H
...
class OAIGetOfferDTO : public OAIObject {
public:
    OAIGetOfferDTO();
    OAIGetOfferDTO(QString json);
    ~OAIGetOfferDTO() override;
    ...
    OAIGetPriceDTO getPurchasePrice() const;
    void setPurchasePrice(const OAIGetPriceDTO &purchase_price);
    bool is_purchase_price_Set() const;
    bool is_purchase_price_Valid() const;

    OAIGetPriceDTO getAdditionalExpenses() const;
    void setAdditionalExpenses(const OAIGetPriceDTO &additional_expenses);
    bool is_additional_expenses_Set() const;
    bool is_additional_expenses_Valid() const;
    ...
    QList<OAIOfferCampaignStatusDTO> getCampaigns() const;
    void setCampaigns(const QList<OAIOfferCampaignStatusDTO> &campaigns);
    bool is_campaigns_Set() const;
    bool is_campaigns_Valid() const;

    QList<OAIOfferSellingProgramDTO> getSellingPrograms() const;
    void setSellingPrograms(const QList<OAIOfferSellingProgramDTO> &selling_programs);
    bool is_selling_programs_Set() const;
    bool is_selling_programs_Valid() const;
...
private:
    ...
    OAIGetPriceWithDiscountDTO m_basic_price;
    bool m_basic_price_isSet;
    bool m_basic_price_isValid;

    OAIGetPriceDTO m_purchase_price;
    bool m_purchase_price_isSet;
    bool m_purchase_price_isValid;

    OAIGetPriceDTO m_additional_expenses;
    bool m_additional_expenses_isSet;
    bool m_additional_expenses_isValid;
    ...
    QList<OAIOfferCampaignStatusDTO> m_campaigns;
    bool m_campaigns_isSet;
    bool m_campaigns_isValid;

    QList<OAIOfferSellingProgramDTO> m_selling_programs;
    bool m_selling_programs_isSet;
    bool m_selling_programs_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetOfferDTO)

#endif // OAIGetOfferDTO_H
