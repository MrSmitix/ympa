...
void OAIGetCampaignOfferDTO::fromJsonObject(QJsonObject json) {
    ...
    m_campaign_price_isValid = ::OpenAPI::fromJsonValue(m_campaign_price, json[QString("campaignPrice")]);
...
QJsonObject OAIGetCampaignOfferDTO::asJsonObject() const {
    ...
    if (m_campaign_price.isSet()) {
        obj.insert(QString("campaignPrice"), ::OpenAPI::toJsonValue(m_campaign_price));
    }
    if (m_status.isSet()) {
