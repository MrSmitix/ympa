...
void OAIBidRecommendationItemDTO::fromJsonObject(QJsonObject json) {
    ...
    m_show_percent_isValid = ::OpenAPI::fromJsonValue(m_show_percent, json[QString("showPercent")]);
...
QJsonObject OAIBidRecommendationItemDTO::asJsonObject() const {
    ...
    if (m_show_percent_isSet) {
        obj.insert(QString("showPercent"), ::OpenAPI::toJsonValue(m_show_percent));
    }
    return obj;
}
