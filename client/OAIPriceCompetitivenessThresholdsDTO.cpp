...
void OAIPriceCompetitivenessThresholdsDTO::fromJsonObject(QJsonObject json) {
    ...
    m_optimal_price_isValid = ::OpenAPI::fromJsonValue(m_optimal_price, json[QString("optimalPrice")]);
    m_optimal_price_isSet = !json[QString("optimalPrice")].isNull() && m_optimal_price_isValid;

    m_average_price_isValid = ::OpenAPI::fromJsonValue(m_average_price, json[QString("averagePrice")]);
...
QJsonObject OAIPriceCompetitivenessThresholdsDTO::asJsonObject() const {
    QJsonObject obj;
    if (m_optimal_price.isSet()) {
        obj.insert(QString("optimalPrice"), ::OpenAPI::toJsonValue(m_optimal_price));
    }
    if (m_average_price.isSet()) {
        obj.insert(QString("averagePrice"), ::OpenAPI::toJsonValue(m_average_price));
    }
    return obj;
}

OAIBasePriceDTO OAIPriceCompetitivenessThresholdsDTO::getOptimalPrice() const {
    return m_optimal_price;
}
void OAIPriceCompetitivenessThresholdsDTO::setOptimalPrice(const OAIBasePriceDTO &optimal_price) {
    m_optimal_price = optimal_price;
    m_optimal_price_isSet = true;
}
