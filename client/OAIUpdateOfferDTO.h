...
#ifndef OAIUpdateOfferDTO_H
#define OAIUpdateOfferDTO_H
...
class OAIUpdateOfferDTO : public OAIObject {
public:
    OAIUpdateOfferDTO();
    OAIUpdateOfferDTO(QString json);
    ~OAIUpdateOfferDTO() override;
    ...
    OAIUpdatePriceWithDiscountDTO getBasicPrice() const;
    void setBasicPrice(const OAIUpdatePriceWithDiscountDTO &basic_price);
    bool is_basic_price_Set() const;
    bool is_basic_price_Valid() const;

    OAIBasePriceDTO getPurchasePrice() const;
    void setPurchasePrice(const OAIBasePriceDTO &purchase_price);
    bool is_purchase_price_Set() const;
    bool is_purchase_price_Valid() const;

    OAIBasePriceDTO getAdditionalExpenses() const;
    void setAdditionalExpenses(const OAIBasePriceDTO &additional_expenses);
    bool is_additional_expenses_Set() const;
    bool is_additional_expenses_Valid() const;

    OAIBasePriceDTO getCofinancePrice() const;
    void setCofinancePrice(const OAIBasePriceDTO &cofinance_price);
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateOfferDTO)

#endif // OAIUpdateOfferDTO_H
