...
void OAIGoodsFeedbackDescriptionDTO::fromJsonObject(QJsonObject json) {
    ...
    m_advantages_isValid = ::OpenAPI::fromJsonValue(m_advantages, json[QString("advantages")]);
    m_advantages_isSet = !json[QString("advantages")].isNull() && m_advantages_isValid;

    m_disadvantages_isValid = ::OpenAPI::fromJsonValue(m_disadvantages, json[QString("disadvantages")]);
...
QJsonObject OAIGoodsFeedbackDescriptionDTO::asJsonObject() const {
    ...
    if (m_advantages_isSet) {
        obj.insert(QString("advantages"), ::OpenAPI::toJsonValue(m_advantages));
    }
    if (m_disadvantages_isSet) {
        obj.insert(QString("disadvantages"), ::OpenAPI::toJsonValue(m_disadvantages));
    }
    if (m_comment_isSet) {
...
void OAIGoodsFeedbackDescriptionDTO::setDisadvantages(const QString &disadvantages) {
    m_disadvantages = disadvantages;
    m_disadvantages_isSet = true;
}
