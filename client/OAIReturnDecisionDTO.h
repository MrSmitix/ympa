...
private:
    ...
    OAIReturnDecisionReasonType m_reason_type;
    bool m_reason_type_isSet;
    bool m_reason_type_isValid;

    OAIReturnDecisionSubreasonType m_subreason_type;
    bool m_subreason_type_isSet;
    bool m_subreason_type_isValid;

    OAIReturnDecisionType m_decision_type;
