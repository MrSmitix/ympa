...
#ifndef OAIOrderSubstatusType_H
#define OAIOrderSubstatusType_H
...
class OAIOrderSubstatusType : public OAIEnum {
public:
    OAIOrderSubstatusType();
    OAIOrderSubstatusType(QString json);
    ~OAIOrderSubstatusType() override;
    ...
    enum class eOAIOrderSubstatusType {
    ...
    OAIOrderSubstatusType::eOAIOrderSubstatusType getValue() const;
    void setValue(const OAIOrderSubstatusType::eOAIOrderSubstatusType& value);
...
private:
    ...
    eOAIOrderSubstatusType m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOrderSubstatusType)

#endif // OAIOrderSubstatusType_H
