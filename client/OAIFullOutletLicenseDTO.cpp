...
void OAIFullOutletLicenseDTO::fromJsonObject(QJsonObject json) {
    ...
    m_check_comment_isValid = ::OpenAPI::fromJsonValue(m_check_comment, json[QString("checkComment")]);
...
QJsonObject OAIFullOutletLicenseDTO::asJsonObject() const {
    ...
    if (m_check_status.isSet()) {
        obj.insert(QString("checkStatus"), ::OpenAPI::toJsonValue(m_check_status));
    }
    if (m_check_comment_isSet) {
        obj.insert(QString("checkComment"), ::OpenAPI::toJsonValue(m_check_comment));
    }
    return obj;
}
...
QString OAIFullOutletLicenseDTO::getCheckComment() const {
    return m_check_comment;
}
void OAIFullOutletLicenseDTO::setCheckComment(const QString &check_comment) {
    m_check_comment = check_comment;
    m_check_comment_isSet = true;
}
