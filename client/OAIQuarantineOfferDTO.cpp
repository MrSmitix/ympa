...
void OAIQuarantineOfferDTO::fromJsonObject(QJsonObject json) {
    ...
    m_last_valid_price_isValid = ::OpenAPI::fromJsonValue(m_last_valid_price, json[QString("lastValidPrice")]);
    m_last_valid_price_isSet = !json[QString("lastValidPrice")].isNull() && m_last_valid_price_isValid;

    m_verdicts_isValid = ::OpenAPI::fromJsonValue(m_verdicts, json[QString("verdicts")]);
...
QJsonObject OAIQuarantineOfferDTO::asJsonObject() const {
    ...
    if (m_last_valid_price.isSet()) {
        obj.insert(QString("lastValidPrice"), ::OpenAPI::toJsonValue(m_last_valid_price));
    }
    if (m_verdicts.size() > 0) {
        obj.insert(QString("verdicts"), ::OpenAPI::toJsonValue(m_verdicts));
    }
    return obj;
}
...
OAIBasePriceDTO OAIQuarantineOfferDTO::getLastValidPrice() const {
    return m_last_valid_price;
}
void OAIQuarantineOfferDTO::setLastValidPrice(const OAIBasePriceDTO &last_valid_price) {
    m_last_valid_price = last_valid_price;
    m_last_valid_price_isSet = true;
}
