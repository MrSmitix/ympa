...
private:
    ...
    OAICategoryParameterUnitDTO m_unit;
    bool m_unit_isSet;
    bool m_unit_isValid;
    ...
    QList<OAIOfferCardRecommendationType> m_recommendation_types;
    ...
    bool m_allow_custom_values;
    bool m_allow_custom_values_isSet;
    bool m_allow_custom_values_isValid;

    QList<OAIParameterValueOptionDTO> m_values;
    bool m_values_isSet;
    bool m_values_isValid;

    OAIParameterValueConstraintsDTO m_constraints;
    bool m_constraints_isSet;
    bool m_constraints_isValid;

    QList<OAIValueRestrictionDTO> m_value_restrictions;
