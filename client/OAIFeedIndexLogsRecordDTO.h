...
private:
    ...
    qint64 m_generation_id;
    bool m_generation_id_isSet;
    bool m_generation_id_isValid;

    OAIFeedIndexLogsIndexType m_index_type;
    ...
    OAIFeedIndexLogsStatusType m_status;
    bool m_status_isSet;
    bool m_status_isValid;

    OAIFeedIndexLogsErrorDTO m_error;
    bool m_error_isSet;
    bool m_error_isValid;

    OAIFeedIndexLogsOffersDTO m_offers;
    bool m_offers_isSet;
