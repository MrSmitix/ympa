...
/*
 * OAIOfferMappingDTO.h
 *
 * Информация о текущей карточке товара на Маркете.
 */

#ifndef OAIOfferMappingDTO_H
#define OAIOfferMappingDTO_H
...
class OAIOfferMappingDTO : public OAIObject {
public:
    OAIOfferMappingDTO();
    OAIOfferMappingDTO(QString json);
    ~OAIOfferMappingDTO() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOfferMappingDTO)

#endif // OAIOfferMappingDTO_H
