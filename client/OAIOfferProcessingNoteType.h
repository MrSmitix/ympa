...
#ifndef OAIOfferProcessingNoteType_H
#define OAIOfferProcessingNoteType_H
...
class OAIOfferProcessingNoteType : public OAIEnum {
public:
    OAIOfferProcessingNoteType();
    OAIOfferProcessingNoteType(QString json);
    ~OAIOfferProcessingNoteType() override;
    ...
    enum class eOAIOfferProcessingNoteType {
    ...
    OAIOfferProcessingNoteType::eOAIOfferProcessingNoteType getValue() const;
    void setValue(const OAIOfferProcessingNoteType::eOAIOfferProcessingNoteType& value);
...
private:
    ...
    eOAIOfferProcessingNoteType m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOfferProcessingNoteType)

#endif // OAIOfferProcessingNoteType_H
