...
/*
 * OAIEnrichedMappingsOfferDTO.h
 *
 * Информация о рекомендованных карточках товаров.
 */

#ifndef OAIEnrichedMappingsOfferDTO_H
#define OAIEnrichedMappingsOfferDTO_H
...
class OAIEnrichedMappingsOfferDTO : public OAIObject {
public:
    OAIEnrichedMappingsOfferDTO();
    OAIEnrichedMappingsOfferDTO(QString json);
    ~OAIEnrichedMappingsOfferDTO() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEnrichedMappingsOfferDTO)

#endif // OAIEnrichedMappingsOfferDTO_H
