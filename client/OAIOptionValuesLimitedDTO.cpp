...
void OAIOptionValuesLimitedDTO::fromJsonObject(QJsonObject json) {
    ...
    m_limiting_option_value_id_isValid = ::OpenAPI::fromJsonValue(m_limiting_option_value_id, json[QString("limitingOptionValueId")]);
    m_limiting_option_value_id_isSet = !json[QString("limitingOptionValueId")].isNull() && m_limiting_option_value_id_isValid;

    m_option_value_ids_isValid = ::OpenAPI::fromJsonValue(m_option_value_ids, json[QString("optionValueIds")]);
...
QJsonObject OAIOptionValuesLimitedDTO::asJsonObject() const {
    ...
    if (m_limiting_option_value_id_isSet) {
        obj.insert(QString("limitingOptionValueId"), ::OpenAPI::toJsonValue(m_limiting_option_value_id));
    }
    if (m_option_value_ids.size() > 0) {
        obj.insert(QString("optionValueIds"), ::OpenAPI::toJsonValue(m_option_value_ids));
    }
    return obj;
}

qint64 OAIOptionValuesLimitedDTO::getLimitingOptionValueId() const {
    return m_limiting_option_value_id;
}
void OAIOptionValuesLimitedDTO::setLimitingOptionValueId(const qint64 &limiting_option_value_id) {
    m_limiting_option_value_id = limiting_option_value_id;
    m_limiting_option_value_id_isSet = true;
}
...
QList<qint64> OAIOptionValuesLimitedDTO::getOptionValueIds() const {
    return m_option_value_ids;
}
void OAIOptionValuesLimitedDTO::setOptionValueIds(const QList<qint64> &option_value_ids) {
    m_option_value_ids = option_value_ids;
    m_option_value_ids_isSet = true;
}
