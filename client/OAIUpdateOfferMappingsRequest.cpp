...
void OAIUpdateOfferMappingsRequest::fromJsonObject(QJsonObject json) {
    ...
    m_only_partner_media_content_isValid = ::OpenAPI::fromJsonValue(m_only_partner_media_content, json[QString("onlyPartnerMediaContent")]);
...
QJsonObject OAIUpdateOfferMappingsRequest::asJsonObject() const {
    ...
    if (m_only_partner_media_content_isSet) {
        obj.insert(QString("onlyPartnerMediaContent"), ::OpenAPI::toJsonValue(m_only_partner_media_content));
    }
    return obj;
}
...
bool OAIUpdateOfferMappingsRequest::isOnlyPartnerMediaContent() const {
    return m_only_partner_media_content;
}
void OAIUpdateOfferMappingsRequest::setOnlyPartnerMediaContent(const bool &only_partner_media_content) {
    m_only_partner_media_content = only_partner_media_content;
    m_only_partner_media_content_isSet = true;
}
