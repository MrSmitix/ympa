...
void OAIOutletDeliveryRuleDTO::fromJsonObject(QJsonObject json) {
    ...
    m_min_delivery_days_isValid = ::OpenAPI::fromJsonValue(m_min_delivery_days, json[QString("minDeliveryDays")]);
    m_min_delivery_days_isSet = !json[QString("minDeliveryDays")].isNull() && m_min_delivery_days_isValid;

    m_max_delivery_days_isValid = ::OpenAPI::fromJsonValue(m_max_delivery_days, json[QString("maxDeliveryDays")]);
    ...
    m_order_before_isValid = ::OpenAPI::fromJsonValue(m_order_before, json[QString("orderBefore")]);
    m_order_before_isSet = !json[QString("orderBefore")].isNull() && m_order_before_isValid;

    m_price_free_pickup_isValid = ::OpenAPI::fromJsonValue(m_price_free_pickup, json[QString("priceFreePickup")]);
    m_price_free_pickup_isSet = !json[QString("priceFreePickup")].isNull() && m_price_free_pickup_isValid;

    m_unspecified_delivery_interval_isValid = ::OpenAPI::fromJsonValue(m_unspecified_delivery_interval, json[QString("unspecifiedDeliveryInterval")]);
...
QJsonObject OAIOutletDeliveryRuleDTO::asJsonObject() const {
    ...
    if (m_min_delivery_days_isSet) {
        obj.insert(QString("minDeliveryDays"), ::OpenAPI::toJsonValue(m_min_delivery_days));
    }
    if (m_max_delivery_days_isSet) {
        obj.insert(QString("maxDeliveryDays"), ::OpenAPI::toJsonValue(m_max_delivery_days));
    }
    ...
    if (m_order_before_isSet) {
        obj.insert(QString("orderBefore"), ::OpenAPI::toJsonValue(m_order_before));
    }
    if (m_price_free_pickup_isSet) {
        obj.insert(QString("priceFreePickup"), ::OpenAPI::toJsonValue(m_price_free_pickup));
    }
    if (m_unspecified_delivery_interval_isSet) {
        obj.insert(QString("unspecifiedDeliveryInterval"), ::OpenAPI::toJsonValue(m_unspecified_delivery_interval));
    }
    return obj;
}

qint32 OAIOutletDeliveryRuleDTO::getMinDeliveryDays() const {
    return m_min_delivery_days;
}
void OAIOutletDeliveryRuleDTO::setMinDeliveryDays(const qint32 &min_delivery_days) {
    m_min_delivery_days = min_delivery_days;
    m_min_delivery_days_isSet = true;
}
...
qint32 OAIOutletDeliveryRuleDTO::getMaxDeliveryDays() const {
    return m_max_delivery_days;
}
void OAIOutletDeliveryRuleDTO::setMaxDeliveryDays(const qint32 &max_delivery_days) {
    m_max_delivery_days = max_delivery_days;
    m_max_delivery_days_isSet = true;
}
...
qint32 OAIOutletDeliveryRuleDTO::getOrderBefore() const {
    return m_order_before;
}
void OAIOutletDeliveryRuleDTO::setOrderBefore(const qint32 &order_before) {
    m_order_before = order_before;
    m_order_before_isSet = true;
}
...
double OAIOutletDeliveryRuleDTO::getPriceFreePickup() const {
    return m_price_free_pickup;
}
void OAIOutletDeliveryRuleDTO::setPriceFreePickup(const double &price_free_pickup) {
    m_price_free_pickup = price_free_pickup;
    m_price_free_pickup_isSet = true;
}
...
bool OAIOutletDeliveryRuleDTO::isUnspecifiedDeliveryInterval() const {
    return m_unspecified_delivery_interval;
}
void OAIOutletDeliveryRuleDTO::setUnspecifiedDeliveryInterval(const bool &unspecified_delivery_interval) {
    m_unspecified_delivery_interval = unspecified_delivery_interval;
    m_unspecified_delivery_interval_isSet = true;
}
