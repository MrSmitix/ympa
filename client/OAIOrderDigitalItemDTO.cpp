...
void OAIOrderDigitalItemDTO::fromJsonObject(QJsonObject json) {
    ...
    m_slip_isValid = ::OpenAPI::fromJsonValue(m_slip, json[QString("slip")]);
    m_slip_isSet = !json[QString("slip")].isNull() && m_slip_isValid;

    m_activate_till_isValid = ::OpenAPI::fromJsonValue(m_activate_till, json[QString("activate_till")]);
...
QJsonObject OAIOrderDigitalItemDTO::asJsonObject() const {
    ...
    if (m_slip_isSet) {
        obj.insert(QString("slip"), ::OpenAPI::toJsonValue(m_slip));
    }
    if (m_activate_till_isSet) {
        obj.insert(QString("activate_till"), ::OpenAPI::toJsonValue(m_activate_till));
    }
    return obj;
}
...
void OAIOrderDigitalItemDTO::setActivateTill(const QDate &activate_till) {
    m_activate_till = activate_till;
    m_activate_till_isSet = true;
}
