...
void OAICategoryParameterUnitDTO::fromJsonObject(QJsonObject json) {
    ...
    m_default_unit_id_isValid = ::OpenAPI::fromJsonValue(m_default_unit_id, json[QString("defaultUnitId")]);
...
QJsonObject OAICategoryParameterUnitDTO::asJsonObject() const {
    ...
    if (m_default_unit_id_isSet) {
        obj.insert(QString("defaultUnitId"), ::OpenAPI::toJsonValue(m_default_unit_id));
    }
    if (m_units.size() > 0) {
...
void OAICategoryParameterUnitDTO::setDefaultUnitId(const qint64 &default_unit_id) {
    m_default_unit_id = default_unit_id;
    m_default_unit_id_isSet = true;
}
