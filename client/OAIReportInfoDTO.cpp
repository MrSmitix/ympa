...
void OAIReportInfoDTO::fromJsonObject(QJsonObject json) {
    ...
    m_generation_requested_at_isValid = ::OpenAPI::fromJsonValue(m_generation_requested_at, json[QString("generationRequestedAt")]);
    m_generation_requested_at_isSet = !json[QString("generationRequestedAt")].isNull() && m_generation_requested_at_isValid;

    m_generation_finished_at_isValid = ::OpenAPI::fromJsonValue(m_generation_finished_at, json[QString("generationFinishedAt")]);
...
QJsonObject OAIReportInfoDTO::asJsonObject() const {
    ...
    if (m_generation_requested_at_isSet) {
        obj.insert(QString("generationRequestedAt"), ::OpenAPI::toJsonValue(m_generation_requested_at));
    }
    if (m_generation_finished_at_isSet) {
        obj.insert(QString("generationFinishedAt"), ::OpenAPI::toJsonValue(m_generation_finished_at));
    }
    if (m_file_isSet) {
...
QDateTime OAIReportInfoDTO::getGenerationRequestedAt() const {
    return m_generation_requested_at;
}
void OAIReportInfoDTO::setGenerationRequestedAt(const QDateTime &generation_requested_at) {
    m_generation_requested_at = generation_requested_at;
    m_generation_requested_at_isSet = true;
}
...
QDateTime OAIReportInfoDTO::getGenerationFinishedAt() const {
    return m_generation_finished_at;
}
void OAIReportInfoDTO::setGenerationFinishedAt(const QDateTime &generation_finished_at) {
    m_generation_finished_at = generation_finished_at;
    m_generation_finished_at_isSet = true;
}
