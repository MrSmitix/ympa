...
void OAIShipmentInfoDTO::fromJsonObject(QJsonObject json) {
    ...
    m_status_update_time_isValid = ::OpenAPI::fromJsonValue(m_status_update_time, json[QString("statusUpdateTime")]);
...
QJsonObject OAIShipmentInfoDTO::asJsonObject() const {
    ...
    if (m_status_update_time_isSet) {
        obj.insert(QString("statusUpdateTime"), ::OpenAPI::toJsonValue(m_status_update_time));
    }
    return obj;
}
...
void OAIShipmentInfoDTO::setStatusUpdateTime(const QDateTime &status_update_time) {
    m_status_update_time = status_update_time;
    m_status_update_time_isSet = true;
}
