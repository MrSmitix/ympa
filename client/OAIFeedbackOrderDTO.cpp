...
void OAIFeedbackOrderDTO::fromJsonObject(QJsonObject json) {
    ...
    m_shop_order_id_isValid = ::OpenAPI::fromJsonValue(m_shop_order_id, json[QString("shopOrderId")]);
...
QJsonObject OAIFeedbackOrderDTO::asJsonObject() const {
    ...
    if (m_shop_order_id_isSet) {
        obj.insert(QString("shopOrderId"), ::OpenAPI::toJsonValue(m_shop_order_id));
    }
    if (m_delivery.isSet()) {
...
QString OAIFeedbackOrderDTO::getShopOrderId() const {
    return m_shop_order_id;
}
void OAIFeedbackOrderDTO::setShopOrderId(const QString &shop_order_id) {
    m_shop_order_id = shop_order_id;
    m_shop_order_id_isSet = true;
}
