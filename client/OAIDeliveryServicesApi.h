...
#ifndef OAI_OAIDeliveryServicesApi_H
#define OAI_OAIDeliveryServicesApi_H
...
class OAIDeliveryServicesApi : public QObject {
    Q_OBJECT

public:
    OAIDeliveryServicesApi(const int timeOut = 0);
