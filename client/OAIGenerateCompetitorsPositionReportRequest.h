...
/*
 * OAIGenerateCompetitorsPositionReportRequest.h
 *
 * Данные, необходимые для генерации отчета.
 */

#ifndef OAIGenerateCompetitorsPositionReportRequest_H
#define OAIGenerateCompetitorsPositionReportRequest_H
...
class OAIGenerateCompetitorsPositionReportRequest : public OAIObject {
public:
    OAIGenerateCompetitorsPositionReportRequest();
    OAIGenerateCompetitorsPositionReportRequest(QString json);
    ~OAIGenerateCompetitorsPositionReportRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGenerateCompetitorsPositionReportRequest)

#endif // OAIGenerateCompetitorsPositionReportRequest_H
