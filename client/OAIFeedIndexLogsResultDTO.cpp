...
void OAIFeedIndexLogsResultDTO::fromJsonObject(QJsonObject json) {
    ...
    m_index_log_records_isValid = ::OpenAPI::fromJsonValue(m_index_log_records, json[QString("indexLogRecords")]);
...
QJsonObject OAIFeedIndexLogsResultDTO::asJsonObject() const {
    ...
    if (m_index_log_records.size() > 0) {
        obj.insert(QString("indexLogRecords"), ::OpenAPI::toJsonValue(m_index_log_records));
    }
    if (m_total_isSet) {
