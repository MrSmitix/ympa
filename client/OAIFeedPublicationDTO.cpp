...
void OAIFeedPublicationDTO::fromJsonObject(QJsonObject json) {
    ...
    m_price_and_stock_update_isValid = ::OpenAPI::fromJsonValue(m_price_and_stock_update, json[QString("priceAndStockUpdate")]);
...
QJsonObject OAIFeedPublicationDTO::asJsonObject() const {
    ...
    if (m_price_and_stock_update.isSet()) {
        obj.insert(QString("priceAndStockUpdate"), ::OpenAPI::toJsonValue(m_price_and_stock_update));
    }
    return obj;
}
