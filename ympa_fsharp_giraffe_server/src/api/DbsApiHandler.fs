...
module DbsApiHandler =
    ...
    let AcceptOrderCancellation (pathParams:AcceptOrderCancellationPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.AcceptOrderCancellation ctx serviceArgs
    ...
    let AddHiddenOffers (pathParams:AddHiddenOffersPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.AddHiddenOffers ctx serviceArgs
          return! (match result with
    ...
    let AddOffersToArchive (pathParams:AddOffersToArchivePathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.AddOffersToArchive ctx serviceArgs
          return! (match result with
    ...
    let CalculateTariffs  : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.CalculateTariffs ctx serviceArgs
          return! (match result with
    ...
    let ConfirmBusinessPrices (pathParams:ConfirmBusinessPricesPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.ConfirmBusinessPrices ctx serviceArgs
          return! (match result with
    ...
    let ConfirmCampaignPrices (pathParams:ConfirmCampaignPricesPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.ConfirmCampaignPrices ctx serviceArgs
          return! (match result with
    ...
    let CreateChat (pathParams:CreateChatPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.CreateChat ctx serviceArgs
          return! (match result with
    ...
    let CreateOutlet (pathParams:CreateOutletPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.CreateOutlet ctx serviceArgs
          return! (match result with
    ...
    let DeleteCampaignOffers (pathParams:DeleteCampaignOffersPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.DeleteCampaignOffers ctx serviceArgs
          return! (match result with
    ...
    let DeleteGoodsFeedbackComment (pathParams:DeleteGoodsFeedbackCommentPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.DeleteGoodsFeedbackComment ctx serviceArgs
          return! (match result with
    ...
    let DeleteHiddenOffers (pathParams:DeleteHiddenOffersPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.DeleteHiddenOffers ctx serviceArgs
          return! (match result with
    ...
    let DeleteOffers (pathParams:DeleteOffersPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.DeleteOffers ctx serviceArgs
          return! (match result with
    ...
    let DeleteOffersFromArchive (pathParams:DeleteOffersFromArchivePathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.DeleteOffersFromArchive ctx serviceArgs
          return! (match result with
    ...
    let DeleteOutlet (pathParams:DeleteOutletPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.DeleteOutlet ctx serviceArgs
          return! (match result with
    ...
    let DeleteOutletLicenses (pathParams:DeleteOutletLicensesPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.DeleteOutletLicenses ctx serviceArgs
          return! (match result with
    ...
    let DeletePromoOffers (pathParams:DeletePromoOffersPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.DeletePromoOffers ctx serviceArgs
          return! (match result with
    ...
    let GenerateBoostConsolidatedReport  : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.GenerateBoostConsolidatedReport ctx serviceArgs
          return! (match result with
    ...
    let GenerateCompetitorsPositionReport  : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.GenerateCompetitorsPositionReport ctx serviceArgs
          return! (match result with
    ...
    let GenerateGoodsFeedbackReport  : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.GenerateGoodsFeedbackReport ctx serviceArgs
          return! (match result with
    ...
    let GenerateMassOrderLabelsReport  : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.GenerateMassOrderLabelsReport ctx serviceArgs
          return! (match result with
    ...
    let GenerateOrderLabel (pathParams:GenerateOrderLabelPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.GenerateOrderLabel ctx serviceArgs
          return! (match result with
    ...
    let GenerateOrderLabels (pathParams:GenerateOrderLabelsPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.GenerateOrderLabels ctx serviceArgs
          return! (match result with
    ...
    let GeneratePricesReport  : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.GeneratePricesReport ctx serviceArgs
          return! (match result with
    ...
    let GenerateShelfsStatisticsReport  : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.GenerateShelfsStatisticsReport ctx serviceArgs
          return! (match result with
    ...
    let GenerateShowsSalesReport  : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.GenerateShowsSalesReport ctx serviceArgs
          return! (match result with
    ...
    let GenerateStocksOnWarehousesReport  : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.GenerateStocksOnWarehousesReport ctx serviceArgs
          return! (match result with
    ...
    let GenerateUnitedMarketplaceServicesReport  : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.GenerateUnitedMarketplaceServicesReport ctx serviceArgs
          return! (match result with
    ...
    let GenerateUnitedNettingReport  : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.GenerateUnitedNettingReport ctx serviceArgs
          return! (match result with
    ...
    let GenerateUnitedOrdersReport  : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.GenerateUnitedOrdersReport ctx serviceArgs
          return! (match result with
    ...
    let GetAllOffers (pathParams:GetAllOffersPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.GetAllOffers ctx serviceArgs
          return! (match result with
    ...
    let GetBidsInfoForBusiness (pathParams:GetBidsInfoForBusinessPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.GetBidsInfoForBusiness ctx serviceArgs
          return! (match result with
    ...
    let GetBidsRecommendations (pathParams:GetBidsRecommendationsPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.GetBidsRecommendations ctx serviceArgs
          return! (match result with
    ...
    let GetBusinessQuarantineOffers (pathParams:GetBusinessQuarantineOffersPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.GetBusinessQuarantineOffers ctx serviceArgs
          return! (match result with
    ...
    let GetBusinessSettings (pathParams:GetBusinessSettingsPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.GetBusinessSettings ctx serviceArgs
          return! (match result with
    ...
    let GetCampaign (pathParams:GetCampaignPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.GetCampaign ctx serviceArgs
          return! (match result with
    ...
    let GetCampaignLogins (pathParams:GetCampaignLoginsPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.GetCampaignLogins ctx serviceArgs
          return! (match result with
    ...
    let GetCampaignOffers (pathParams:GetCampaignOffersPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.GetCampaignOffers ctx serviceArgs
          return! (match result with
    ...
    let GetCampaignQuarantineOffers (pathParams:GetCampaignQuarantineOffersPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.GetCampaignQuarantineOffers ctx serviceArgs
          return! (match result with
    ...
    let GetCampaignRegion (pathParams:GetCampaignRegionPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.GetCampaignRegion ctx serviceArgs
          return! (match result with
    ...
    let GetCampaignSettings (pathParams:GetCampaignSettingsPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.GetCampaignSettings ctx serviceArgs
          return! (match result with
    ...
    let GetCampaigns  : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.GetCampaigns ctx serviceArgs
          return! (match result with
    ...
    let GetCampaignsByLogin (pathParams:GetCampaignsByLoginPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.GetCampaignsByLogin ctx serviceArgs
          return! (match result with
    ...
    let GetCategoriesMaxSaleQuantum  : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.GetCategoriesMaxSaleQuantum ctx serviceArgs
          return! (match result with
    ...
    let GetCategoriesTree  : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.GetCategoriesTree ctx serviceArgs
          return! (match result with
    ...
    let GetCategoryContentParameters (pathParams:GetCategoryContentParametersPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.GetCategoryContentParameters ctx serviceArgs
          return! (match result with
    ...
    let GetChatHistory (pathParams:GetChatHistoryPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.GetChatHistory ctx serviceArgs
          return! (match result with
    ...
    let GetChats (pathParams:GetChatsPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.GetChats ctx serviceArgs
          return! (match result with
    ...
    let GetDeliveryServices  : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          let result = DbsApiService.GetDeliveryServices ctx 
          return! (match result with
    ...
    let GetFeed (pathParams:GetFeedPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.GetFeed ctx serviceArgs
          return! (match result with
    ...
    let GetFeedIndexLogs (pathParams:GetFeedIndexLogsPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.GetFeedIndexLogs ctx serviceArgs
          return! (match result with
    ...
    let GetFeedbackAndCommentUpdates (pathParams:GetFeedbackAndCommentUpdatesPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.GetFeedbackAndCommentUpdates ctx serviceArgs
          return! (match result with
    ...
    let GetFeeds (pathParams:GetFeedsPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.GetFeeds ctx serviceArgs
          return! (match result with
    ...
    let GetGoodsFeedbackComments (pathParams:GetGoodsFeedbackCommentsPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.GetGoodsFeedbackComments ctx serviceArgs
          return! (match result with
    ...
    let GetGoodsFeedbacks (pathParams:GetGoodsFeedbacksPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.GetGoodsFeedbacks ctx serviceArgs
          return! (match result with
    ...
    let GetGoodsStats (pathParams:GetGoodsStatsPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.GetGoodsStats ctx serviceArgs
          return! (match result with
    ...
    let GetHiddenOffers (pathParams:GetHiddenOffersPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.GetHiddenOffers ctx serviceArgs
          return! (match result with
    ...
    let GetModel (pathParams:GetModelPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.GetModel ctx serviceArgs
          return! (match result with
    ...
    let GetModelOffers (pathParams:GetModelOffersPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.GetModelOffers ctx serviceArgs
          return! (match result with
    ...
    let GetModels  : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.GetModels ctx serviceArgs
          return! (match result with
    ...
    let GetModelsOffers  : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.GetModelsOffers ctx serviceArgs
          return! (match result with
    ...
    let GetOfferCardsContentStatus (pathParams:GetOfferCardsContentStatusPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.GetOfferCardsContentStatus ctx serviceArgs
          return! (match result with
    ...
    let GetOfferMappingEntries (pathParams:GetOfferMappingEntriesPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.GetOfferMappingEntries ctx serviceArgs
          return! (match result with
    ...
    let GetOfferMappings (pathParams:GetOfferMappingsPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.GetOfferMappings ctx serviceArgs
          return! (match result with
    ...
    let GetOfferRecommendations (pathParams:GetOfferRecommendationsPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.GetOfferRecommendations ctx serviceArgs
          return! (match result with
    ...
    let GetOffers (pathParams:GetOffersPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.GetOffers ctx serviceArgs
          return! (match result with
    ...
    let GetOrder (pathParams:GetOrderPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.GetOrder ctx serviceArgs
          return! (match result with
    ...
    let GetOrderBusinessBuyerInfo (pathParams:GetOrderBusinessBuyerInfoPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.GetOrderBusinessBuyerInfo ctx serviceArgs
          return! (match result with
    ...
    let GetOrderBusinessDocumentsInfo (pathParams:GetOrderBusinessDocumentsInfoPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.GetOrderBusinessDocumentsInfo ctx serviceArgs
          return! (match result with
    ...
    let GetOrderBuyerInfo (pathParams:GetOrderBuyerInfoPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.GetOrderBuyerInfo ctx serviceArgs
          return! (match result with
    ...
    let GetOrderLabelsData (pathParams:GetOrderLabelsDataPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.GetOrderLabelsData ctx serviceArgs
          return! (match result with
    ...
    let GetOrders (pathParams:GetOrdersPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.GetOrders ctx serviceArgs
          return! (match result with
    ...
    let GetOrdersStats (pathParams:GetOrdersStatsPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.GetOrdersStats ctx serviceArgs
          return! (match result with
    ...
    let GetOutlet (pathParams:GetOutletPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.GetOutlet ctx serviceArgs
          return! (match result with
    ...
    let GetOutletLicenses (pathParams:GetOutletLicensesPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.GetOutletLicenses ctx serviceArgs
          return! (match result with
    ...
    let GetOutlets (pathParams:GetOutletsPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.GetOutlets ctx serviceArgs
          return! (match result with
    ...
    let GetPrices (pathParams:GetPricesPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.GetPrices ctx serviceArgs
          return! (match result with
    ...
    let GetPricesByOfferIds (pathParams:GetPricesByOfferIdsPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.GetPricesByOfferIds ctx serviceArgs
          return! (match result with
    ...
    let GetPromoOffers (pathParams:GetPromoOffersPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.GetPromoOffers ctx serviceArgs
          return! (match result with
    ...
    let GetPromos (pathParams:GetPromosPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.GetPromos ctx serviceArgs
          return! (match result with
    ...
    let GetQualityRatingDetails (pathParams:GetQualityRatingDetailsPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.GetQualityRatingDetails ctx serviceArgs
          return! (match result with
    ...
    let GetQualityRatings (pathParams:GetQualityRatingsPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.GetQualityRatings ctx serviceArgs
          return! (match result with
    ...
    let GetReportInfo (pathParams:GetReportInfoPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.GetReportInfo ctx serviceArgs
          return! (match result with
    ...
    let GetReturn (pathParams:GetReturnPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.GetReturn ctx serviceArgs
          return! (match result with
    ...
    let GetReturnApplication (pathParams:GetReturnApplicationPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.GetReturnApplication ctx serviceArgs
          return! (match result with
    ...
    let GetReturnPhoto (pathParams:GetReturnPhotoPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.GetReturnPhoto ctx serviceArgs
          return! (match result with
    ...
    let GetReturns (pathParams:GetReturnsPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.GetReturns ctx serviceArgs
          return! (match result with
    ...
    let GetStocks (pathParams:GetStocksPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.GetStocks ctx serviceArgs
          return! (match result with
    ...
    let GetSuggestedOfferMappingEntries (pathParams:GetSuggestedOfferMappingEntriesPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.GetSuggestedOfferMappingEntries ctx serviceArgs
          return! (match result with
    ...
    let GetSuggestedOfferMappings (pathParams:GetSuggestedOfferMappingsPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.GetSuggestedOfferMappings ctx serviceArgs
          return! (match result with
    ...
    let GetSuggestedPrices (pathParams:GetSuggestedPricesPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.GetSuggestedPrices ctx serviceArgs
          return! (match result with
    ...
    let GetWarehouses (pathParams:GetWarehousesPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.GetWarehouses ctx serviceArgs
          return! (match result with
    ...
    let ProvideOrderDigitalCodes (pathParams:ProvideOrderDigitalCodesPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.ProvideOrderDigitalCodes ctx serviceArgs
          return! (match result with
    ...
    let ProvideOrderItemIdentifiers (pathParams:ProvideOrderItemIdentifiersPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.ProvideOrderItemIdentifiers ctx serviceArgs
          return! (match result with
    ...
    let PutBidsForBusiness (pathParams:PutBidsForBusinessPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.PutBidsForBusiness ctx serviceArgs
          return! (match result with
    ...
    let PutBidsForCampaign (pathParams:PutBidsForCampaignPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.PutBidsForCampaign ctx serviceArgs
          return! (match result with
    ...
    let RefreshFeed (pathParams:RefreshFeedPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.RefreshFeed ctx serviceArgs
          return! (match result with
    ...
    let SearchModels  : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.SearchModels ctx serviceArgs
          return! (match result with
    ...
    let SearchRegionChildren (pathParams:SearchRegionChildrenPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.SearchRegionChildren ctx serviceArgs
          return! (match result with
    ...
    let SearchRegionsById (pathParams:SearchRegionsByIdPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.SearchRegionsById ctx serviceArgs
          return! (match result with
    ...
    let SearchRegionsByName  : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.SearchRegionsByName ctx serviceArgs
          return! (match result with
    ...
    let SendFileToChat (pathParams:SendFileToChatPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.SendFileToChat ctx serviceArgs
          return! (match result with
    ...
    let SendMessageToChat (pathParams:SendMessageToChatPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.SendMessageToChat ctx serviceArgs
          return! (match result with
    ...
    let SetFeedParams (pathParams:SetFeedParamsPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.SetFeedParams ctx serviceArgs
          return! (match result with
    ...
    let SetOrderBoxLayout (pathParams:SetOrderBoxLayoutPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.SetOrderBoxLayout ctx serviceArgs
          return! (match result with
    ...
    let SetOrderDeliveryDate (pathParams:SetOrderDeliveryDatePathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.SetOrderDeliveryDate ctx serviceArgs
          return! (match result with
    ...
    let SetOrderDeliveryTrackCode (pathParams:SetOrderDeliveryTrackCodePathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.SetOrderDeliveryTrackCode ctx serviceArgs
          return! (match result with
    ...
    let SetOrderShipmentBoxes (pathParams:SetOrderShipmentBoxesPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.SetOrderShipmentBoxes ctx serviceArgs
          return! (match result with
    ...
    let SetReturnDecision (pathParams:SetReturnDecisionPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.SetReturnDecision ctx serviceArgs
          return! (match result with
    ...
    let SkipGoodsFeedbacksReaction (pathParams:SkipGoodsFeedbacksReactionPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.SkipGoodsFeedbacksReaction ctx serviceArgs
          return! (match result with
    ...
    let SubmitReturnDecision (pathParams:SubmitReturnDecisionPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.SubmitReturnDecision ctx serviceArgs
          return! (match result with
    ...
    let UpdateBusinessPrices (pathParams:UpdateBusinessPricesPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.UpdateBusinessPrices ctx serviceArgs
          return! (match result with
    ...
    let UpdateCampaignOffers (pathParams:UpdateCampaignOffersPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.UpdateCampaignOffers ctx serviceArgs
          return! (match result with
    ...
    let UpdateGoodsFeedbackComment (pathParams:UpdateGoodsFeedbackCommentPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.UpdateGoodsFeedbackComment ctx serviceArgs
          return! (match result with
    ...
    let UpdateOfferContent (pathParams:UpdateOfferContentPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.UpdateOfferContent ctx serviceArgs
          return! (match result with
    ...
    let UpdateOfferMappingEntries (pathParams:UpdateOfferMappingEntriesPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.UpdateOfferMappingEntries ctx serviceArgs
          return! (match result with
    ...
    let UpdateOfferMappings (pathParams:UpdateOfferMappingsPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.UpdateOfferMappings ctx serviceArgs
          return! (match result with
    ...
    let UpdateOrderItems (pathParams:UpdateOrderItemsPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.UpdateOrderItems ctx serviceArgs
          return! (match result with
    ...
    let UpdateOrderStatus (pathParams:UpdateOrderStatusPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.UpdateOrderStatus ctx serviceArgs
          return! (match result with
    ...
    let UpdateOrderStatuses (pathParams:UpdateOrderStatusesPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.UpdateOrderStatuses ctx serviceArgs
          return! (match result with
    ...
    let UpdateOrderStorageLimit (pathParams:UpdateOrderStorageLimitPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.UpdateOrderStorageLimit ctx serviceArgs
          return! (match result with
    ...
    let UpdateOutlet (pathParams:UpdateOutletPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.UpdateOutlet ctx serviceArgs
          return! (match result with
    ...
    let UpdateOutletLicenses (pathParams:UpdateOutletLicensesPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.UpdateOutletLicenses ctx serviceArgs
          return! (match result with
    ...
    let UpdatePrices (pathParams:UpdatePricesPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.UpdatePrices ctx serviceArgs
          return! (match result with
    ...
    let UpdatePromoOffers (pathParams:UpdatePromoOffersPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.UpdatePromoOffers ctx serviceArgs
          return! (match result with
    ...
    let UpdateStocks (pathParams:UpdateStocksPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = DbsApiService.UpdateStocks ctx serviceArgs
          return! (match result with
