...
open FbsApiServiceImplementation
...
module FbsApiHandler =
    ...
    let AddHiddenOffers (pathParams:AddHiddenOffersPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.AddHiddenOffers ctx serviceArgs
    ...
    let AddOffersToArchive (pathParams:AddOffersToArchivePathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.AddOffersToArchive ctx serviceArgs
          return! (match result with
    ...
    let CalculateTariffs  : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.CalculateTariffs ctx serviceArgs
          return! (match result with
    ...
    let ConfirmBusinessPrices (pathParams:ConfirmBusinessPricesPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.ConfirmBusinessPrices ctx serviceArgs
          return! (match result with
    ...
    let ConfirmCampaignPrices (pathParams:ConfirmCampaignPricesPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.ConfirmCampaignPrices ctx serviceArgs
          return! (match result with
    ...
    let ConfirmShipment (pathParams:ConfirmShipmentPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.ConfirmShipment ctx serviceArgs
          return! (match result with
    ...
    let CreateChat (pathParams:CreateChatPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.CreateChat ctx serviceArgs
          return! (match result with
    ...
    let DeleteCampaignOffers (pathParams:DeleteCampaignOffersPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.DeleteCampaignOffers ctx serviceArgs
          return! (match result with
    ...
    let DeleteGoodsFeedbackComment (pathParams:DeleteGoodsFeedbackCommentPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.DeleteGoodsFeedbackComment ctx serviceArgs
          return! (match result with
    ...
    let DeleteHiddenOffers (pathParams:DeleteHiddenOffersPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.DeleteHiddenOffers ctx serviceArgs
          return! (match result with
    ...
    let DeleteOffers (pathParams:DeleteOffersPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.DeleteOffers ctx serviceArgs
          return! (match result with
    ...
    let DeleteOffersFromArchive (pathParams:DeleteOffersFromArchivePathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.DeleteOffersFromArchive ctx serviceArgs
          return! (match result with
    ...
    let DeletePromoOffers (pathParams:DeletePromoOffersPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.DeletePromoOffers ctx serviceArgs
          return! (match result with
    ...
    let DownloadShipmentAct (pathParams:DownloadShipmentActPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.DownloadShipmentAct ctx serviceArgs
          return! (match result with
    ...
    let DownloadShipmentDiscrepancyAct (pathParams:DownloadShipmentDiscrepancyActPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.DownloadShipmentDiscrepancyAct ctx serviceArgs
          return! (match result with
    ...
    let DownloadShipmentInboundAct (pathParams:DownloadShipmentInboundActPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.DownloadShipmentInboundAct ctx serviceArgs
          return! (match result with
    ...
    let DownloadShipmentPalletLabels (pathParams:DownloadShipmentPalletLabelsPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.DownloadShipmentPalletLabels ctx serviceArgs
          return! (match result with
    ...
    let DownloadShipmentReceptionTransferAct (pathParams:DownloadShipmentReceptionTransferActPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.DownloadShipmentReceptionTransferAct ctx serviceArgs
          return! (match result with
    ...
    let DownloadShipmentTransportationWaybill (pathParams:DownloadShipmentTransportationWaybillPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.DownloadShipmentTransportationWaybill ctx serviceArgs
          return! (match result with
    ...
    let GenerateBoostConsolidatedReport  : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.GenerateBoostConsolidatedReport ctx serviceArgs
          return! (match result with
    ...
    let GenerateCompetitorsPositionReport  : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.GenerateCompetitorsPositionReport ctx serviceArgs
          return! (match result with
    ...
    let GenerateGoodsFeedbackReport  : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.GenerateGoodsFeedbackReport ctx serviceArgs
          return! (match result with
    ...
    let GenerateGoodsRealizationReport  : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.GenerateGoodsRealizationReport ctx serviceArgs
          return! (match result with
    ...
    let GenerateMassOrderLabelsReport  : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.GenerateMassOrderLabelsReport ctx serviceArgs
          return! (match result with
    ...
    let GenerateOrderLabel (pathParams:GenerateOrderLabelPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.GenerateOrderLabel ctx serviceArgs
          return! (match result with
    ...
    let GenerateOrderLabels (pathParams:GenerateOrderLabelsPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.GenerateOrderLabels ctx serviceArgs
          return! (match result with
    ...
    let GeneratePricesReport  : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.GeneratePricesReport ctx serviceArgs
          return! (match result with
    ...
    let GenerateShelfsStatisticsReport  : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.GenerateShelfsStatisticsReport ctx serviceArgs
          return! (match result with
    ...
    let GenerateShipmentListDocumentReport  : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.GenerateShipmentListDocumentReport ctx serviceArgs
          return! (match result with
    ...
    let GenerateShowsSalesReport  : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.GenerateShowsSalesReport ctx serviceArgs
          return! (match result with
    ...
    let GenerateStocksOnWarehousesReport  : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.GenerateStocksOnWarehousesReport ctx serviceArgs
          return! (match result with
    ...
    let GenerateUnitedMarketplaceServicesReport  : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.GenerateUnitedMarketplaceServicesReport ctx serviceArgs
          return! (match result with
    ...
    let GenerateUnitedNettingReport  : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.GenerateUnitedNettingReport ctx serviceArgs
          return! (match result with
    ...
    let GenerateUnitedOrdersReport  : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.GenerateUnitedOrdersReport ctx serviceArgs
          return! (match result with
    ...
    let GetAllOffers (pathParams:GetAllOffersPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.GetAllOffers ctx serviceArgs
          return! (match result with
    ...
    let GetBidsInfoForBusiness (pathParams:GetBidsInfoForBusinessPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.GetBidsInfoForBusiness ctx serviceArgs
          return! (match result with
    ...
    let GetBidsRecommendations (pathParams:GetBidsRecommendationsPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.GetBidsRecommendations ctx serviceArgs
          return! (match result with
    ...
    let GetBusinessQuarantineOffers (pathParams:GetBusinessQuarantineOffersPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.GetBusinessQuarantineOffers ctx serviceArgs
          return! (match result with
    ...
    let GetBusinessSettings (pathParams:GetBusinessSettingsPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.GetBusinessSettings ctx serviceArgs
          return! (match result with
    ...
    let GetCampaign (pathParams:GetCampaignPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.GetCampaign ctx serviceArgs
          return! (match result with
    ...
    let GetCampaignLogins (pathParams:GetCampaignLoginsPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.GetCampaignLogins ctx serviceArgs
          return! (match result with
    ...
    let GetCampaignOffers (pathParams:GetCampaignOffersPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.GetCampaignOffers ctx serviceArgs
          return! (match result with
    ...
    let GetCampaignQuarantineOffers (pathParams:GetCampaignQuarantineOffersPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.GetCampaignQuarantineOffers ctx serviceArgs
          return! (match result with
    ...
    let GetCampaignRegion (pathParams:GetCampaignRegionPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.GetCampaignRegion ctx serviceArgs
          return! (match result with
    ...
    let GetCampaignSettings (pathParams:GetCampaignSettingsPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.GetCampaignSettings ctx serviceArgs
          return! (match result with
    ...
    let GetCampaigns  : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.GetCampaigns ctx serviceArgs
          return! (match result with
    ...
    let GetCampaignsByLogin (pathParams:GetCampaignsByLoginPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.GetCampaignsByLogin ctx serviceArgs
          return! (match result with
    ...
    let GetCategoriesMaxSaleQuantum  : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.GetCategoriesMaxSaleQuantum ctx serviceArgs
          return! (match result with
    ...
    let GetCategoriesTree  : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.GetCategoriesTree ctx serviceArgs
          return! (match result with
    ...
    let GetCategoryContentParameters (pathParams:GetCategoryContentParametersPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.GetCategoryContentParameters ctx serviceArgs
          return! (match result with
    ...
    let GetChatHistory (pathParams:GetChatHistoryPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.GetChatHistory ctx serviceArgs
          return! (match result with
    ...
    let GetChats (pathParams:GetChatsPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.GetChats ctx serviceArgs
          return! (match result with
    ...
    let GetDeliveryServices  : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          let result = FbsApiService.GetDeliveryServices ctx 
          return! (match result with
    ...
    let GetFeed (pathParams:GetFeedPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.GetFeed ctx serviceArgs
          return! (match result with
    ...
    let GetFeedIndexLogs (pathParams:GetFeedIndexLogsPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.GetFeedIndexLogs ctx serviceArgs
          return! (match result with
    ...
    let GetFeedbackAndCommentUpdates (pathParams:GetFeedbackAndCommentUpdatesPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.GetFeedbackAndCommentUpdates ctx serviceArgs
          return! (match result with
    ...
    let GetFeeds (pathParams:GetFeedsPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.GetFeeds ctx serviceArgs
          return! (match result with
    ...
    let GetGoodsFeedbackComments (pathParams:GetGoodsFeedbackCommentsPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.GetGoodsFeedbackComments ctx serviceArgs
          return! (match result with
    ...
    let GetGoodsFeedbacks (pathParams:GetGoodsFeedbacksPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.GetGoodsFeedbacks ctx serviceArgs
          return! (match result with
    ...
    let GetGoodsStats (pathParams:GetGoodsStatsPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.GetGoodsStats ctx serviceArgs
          return! (match result with
    ...
    let GetHiddenOffers (pathParams:GetHiddenOffersPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.GetHiddenOffers ctx serviceArgs
          return! (match result with
    ...
    let GetOfferCardsContentStatus (pathParams:GetOfferCardsContentStatusPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.GetOfferCardsContentStatus ctx serviceArgs
          return! (match result with
    ...
    let GetOfferMappingEntries (pathParams:GetOfferMappingEntriesPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.GetOfferMappingEntries ctx serviceArgs
          return! (match result with
    ...
    let GetOfferMappings (pathParams:GetOfferMappingsPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.GetOfferMappings ctx serviceArgs
          return! (match result with
    ...
    let GetOfferRecommendations (pathParams:GetOfferRecommendationsPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.GetOfferRecommendations ctx serviceArgs
          return! (match result with
    ...
    let GetOffers (pathParams:GetOffersPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.GetOffers ctx serviceArgs
          return! (match result with
    ...
    let GetOrder (pathParams:GetOrderPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.GetOrder ctx serviceArgs
          return! (match result with
    ...
    let GetOrderBusinessBuyerInfo (pathParams:GetOrderBusinessBuyerInfoPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.GetOrderBusinessBuyerInfo ctx serviceArgs
          return! (match result with
    ...
    let GetOrderBusinessDocumentsInfo (pathParams:GetOrderBusinessDocumentsInfoPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.GetOrderBusinessDocumentsInfo ctx serviceArgs
          return! (match result with
    ...
    let GetOrderLabelsData (pathParams:GetOrderLabelsDataPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.GetOrderLabelsData ctx serviceArgs
          return! (match result with
    ...
    let GetOrders (pathParams:GetOrdersPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.GetOrders ctx serviceArgs
          return! (match result with
    ...
    let GetOrdersStats (pathParams:GetOrdersStatsPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.GetOrdersStats ctx serviceArgs
          return! (match result with
    ...
    let GetPrices (pathParams:GetPricesPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.GetPrices ctx serviceArgs
          return! (match result with
    ...
    let GetPricesByOfferIds (pathParams:GetPricesByOfferIdsPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.GetPricesByOfferIds ctx serviceArgs
          return! (match result with
    ...
    let GetPromoOffers (pathParams:GetPromoOffersPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.GetPromoOffers ctx serviceArgs
          return! (match result with
    ...
    let GetPromos (pathParams:GetPromosPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.GetPromos ctx serviceArgs
          return! (match result with
    ...
    let GetQualityRatingDetails (pathParams:GetQualityRatingDetailsPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.GetQualityRatingDetails ctx serviceArgs
          return! (match result with
    ...
    let GetQualityRatings (pathParams:GetQualityRatingsPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.GetQualityRatings ctx serviceArgs
          return! (match result with
    ...
    let GetReportInfo (pathParams:GetReportInfoPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.GetReportInfo ctx serviceArgs
          return! (match result with
    ...
    let GetReturn (pathParams:GetReturnPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.GetReturn ctx serviceArgs
          return! (match result with
    ...
    let GetReturnApplication (pathParams:GetReturnApplicationPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.GetReturnApplication ctx serviceArgs
          return! (match result with
    ...
    let GetReturnPhoto (pathParams:GetReturnPhotoPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.GetReturnPhoto ctx serviceArgs
          return! (match result with
    ...
    let GetReturns (pathParams:GetReturnsPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.GetReturns ctx serviceArgs
          return! (match result with
    ...
    let GetShipment (pathParams:GetShipmentPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.GetShipment ctx serviceArgs
          return! (match result with
    ...
    let GetShipmentOrdersInfo (pathParams:GetShipmentOrdersInfoPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.GetShipmentOrdersInfo ctx serviceArgs
          return! (match result with
    ...
    let GetStocks (pathParams:GetStocksPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.GetStocks ctx serviceArgs
          return! (match result with
    ...
    let GetSuggestedOfferMappingEntries (pathParams:GetSuggestedOfferMappingEntriesPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.GetSuggestedOfferMappingEntries ctx serviceArgs
          return! (match result with
    ...
    let GetSuggestedOfferMappings (pathParams:GetSuggestedOfferMappingsPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.GetSuggestedOfferMappings ctx serviceArgs
          return! (match result with
    ...
    let GetSuggestedPrices (pathParams:GetSuggestedPricesPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.GetSuggestedPrices ctx serviceArgs
          return! (match result with
    ...
    let GetWarehouses (pathParams:GetWarehousesPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.GetWarehouses ctx serviceArgs
          return! (match result with
    ...
    let ProvideOrderItemIdentifiers (pathParams:ProvideOrderItemIdentifiersPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.ProvideOrderItemIdentifiers ctx serviceArgs
          return! (match result with
    ...
    let PutBidsForBusiness (pathParams:PutBidsForBusinessPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.PutBidsForBusiness ctx serviceArgs
          return! (match result with
    ...
    let PutBidsForCampaign (pathParams:PutBidsForCampaignPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.PutBidsForCampaign ctx serviceArgs
          return! (match result with
    ...
    let RefreshFeed (pathParams:RefreshFeedPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.RefreshFeed ctx serviceArgs
          return! (match result with
    ...
    let SearchRegionChildren (pathParams:SearchRegionChildrenPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.SearchRegionChildren ctx serviceArgs
          return! (match result with
    ...
    let SearchRegionsById (pathParams:SearchRegionsByIdPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.SearchRegionsById ctx serviceArgs
          return! (match result with
    ...
    let SearchRegionsByName  : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.SearchRegionsByName ctx serviceArgs
          return! (match result with
    ...
    let SearchShipments (pathParams:SearchShipmentsPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.SearchShipments ctx serviceArgs
          return! (match result with
    ...
    let SendFileToChat (pathParams:SendFileToChatPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.SendFileToChat ctx serviceArgs
          return! (match result with
    ...
    let SendMessageToChat (pathParams:SendMessageToChatPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.SendMessageToChat ctx serviceArgs
          return! (match result with
    ...
    let SetFeedParams (pathParams:SetFeedParamsPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.SetFeedParams ctx serviceArgs
          return! (match result with
    ...
    let SetOrderBoxLayout (pathParams:SetOrderBoxLayoutPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.SetOrderBoxLayout ctx serviceArgs
          return! (match result with
    ...
    let SetOrderShipmentBoxes (pathParams:SetOrderShipmentBoxesPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.SetOrderShipmentBoxes ctx serviceArgs
          return! (match result with
    ...
    let SetShipmentPalletsCount (pathParams:SetShipmentPalletsCountPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.SetShipmentPalletsCount ctx serviceArgs
          return! (match result with
    ...
    let SkipGoodsFeedbacksReaction (pathParams:SkipGoodsFeedbacksReactionPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.SkipGoodsFeedbacksReaction ctx serviceArgs
          return! (match result with
    ...
    let TransferOrdersFromShipment (pathParams:TransferOrdersFromShipmentPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.TransferOrdersFromShipment ctx serviceArgs
          return! (match result with
    ...
    let UpdateBusinessPrices (pathParams:UpdateBusinessPricesPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.UpdateBusinessPrices ctx serviceArgs
          return! (match result with
    ...
    let UpdateCampaignOffers (pathParams:UpdateCampaignOffersPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.UpdateCampaignOffers ctx serviceArgs
          return! (match result with
    ...
    let UpdateGoodsFeedbackComment (pathParams:UpdateGoodsFeedbackCommentPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.UpdateGoodsFeedbackComment ctx serviceArgs
          return! (match result with
    ...
    let UpdateOfferContent (pathParams:UpdateOfferContentPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.UpdateOfferContent ctx serviceArgs
          return! (match result with
    ...
    let UpdateOfferMappingEntries (pathParams:UpdateOfferMappingEntriesPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.UpdateOfferMappingEntries ctx serviceArgs
          return! (match result with
    ...
    let UpdateOfferMappings (pathParams:UpdateOfferMappingsPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.UpdateOfferMappings ctx serviceArgs
          return! (match result with
    ...
    let UpdateOrderItems (pathParams:UpdateOrderItemsPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.UpdateOrderItems ctx serviceArgs
          return! (match result with
    ...
    let UpdateOrderStatus (pathParams:UpdateOrderStatusPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.UpdateOrderStatus ctx serviceArgs
          return! (match result with
    ...
    let UpdateOrderStatuses (pathParams:UpdateOrderStatusesPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.UpdateOrderStatuses ctx serviceArgs
          return! (match result with
    ...
    let UpdatePrices (pathParams:UpdatePricesPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.UpdatePrices ctx serviceArgs
          return! (match result with
    ...
    let UpdatePromoOffers (pathParams:UpdatePromoOffersPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.UpdatePromoOffers ctx serviceArgs
          return! (match result with
    ...
    let UpdateStocks (pathParams:UpdateStocksPathParams) : HttpHandler =
      fun (next : HttpFunc) (ctx : HttpContext) ->
        task {
          ...
          let result = FbsApiService.UpdateStocks ctx serviceArgs
          return! (match result with
