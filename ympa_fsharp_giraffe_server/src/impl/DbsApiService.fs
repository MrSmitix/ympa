...
module DbsApiServiceImplementation =
    ...
    type DbsApiServiceImpl() =
      interface IDbsApiService with
        ...
        member this.AcceptOrderCancellation ctx args =
          if true then
        ...
        member this.GetModelOffers ctx args =
          if true then
        ...
        member this.GetModels ctx args =
          if true then
        ...
        member this.GetModelsOffers ctx args =
          if true then
        ...
        member this.GetOrderBuyerInfo ctx args =
          if true then
        ...
        member this.ProvideOrderDigitalCodes ctx args =
          if true then
            let content = "Пустой ответ." :> obj :?> EmptyApiResponse // this cast is obviously wrong, and is only intended to allow generated project to compile   
        ...
        member this.SearchModels ctx args =
          if true then
        ...
        member this.SetOrderDeliveryDate ctx args =
          if true then
        ...
        member this.SetOrderDeliveryTrackCode ctx args =
          if true then
        ...
        member this.SetReturnDecision ctx args =
          if true then
        ...
        member this.SubmitReturnDecision ctx args =
          if true then
            let content = "Статус выполнения операции." :> obj :?> EmptyApiResponse // this cast is obviously wrong, and is only intended to allow generated project to compile   
        ...
        member this.UpdateOrderStorageLimit ctx args =
          if true then
            let content = "Пустой ответ." :> obj :?> EmptyApiResponse // this cast is obviously wrong, and is only intended to allow generated project to compile   
