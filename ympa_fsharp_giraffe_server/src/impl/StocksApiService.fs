...
module StocksApiServiceImplementation =

    //#region Service implementation
    type StocksApiServiceImpl() =
      interface IStocksApiService with
    ...
    let StocksApiService = StocksApiServiceImpl() :> IStocksApiService