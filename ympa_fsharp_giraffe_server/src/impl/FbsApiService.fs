...
module FbsApiServiceImplementation =
    ...
    type FbsApiServiceImpl() =
      interface IFbsApiService with
        ...
        member this.AddHiddenOffers ctx args =
          if true then
        ...
        member this.CalculateTariffs ctx args =
          if true then
        ...
        member this.ConfirmBusinessPrices ctx args =
          if true then
        ...
        member this.ConfirmCampaignPrices ctx args =
          if true then
            let content = "Ответ 200 обозначает, что цены подтверждены." :> obj :?> EmptyApiResponse // this cast is obviously wrong, and is only intended to allow generated project to compile   
        ...
        member this.ConfirmShipment ctx args =
          if true then
        ...
        member this.CreateChat ctx args =
          if true then
        ...
        member this.DeleteGoodsFeedbackComment ctx args =
          if true then
            let content = "Пустой ответ." :> obj :?> EmptyApiResponse // this cast is obviously wrong, and is only intended to allow generated project to compile   
        ...
        member this.DeleteHiddenOffers ctx args =
          if true then
        ...
        member this.DeletePromoOffers ctx args =
          if true then
        ...
        member this.DownloadShipmentAct ctx args =
          if true then
        ...
        member this.DownloadShipmentDiscrepancyAct ctx args =
          if true then
        ...
        member this.DownloadShipmentInboundAct ctx args =
          if true then
        ...
        member this.DownloadShipmentPalletLabels ctx args =
          if true then
        ...
        member this.DownloadShipmentReceptionTransferAct ctx args =
          if true then
        ...
        member this.DownloadShipmentTransportationWaybill ctx args =
          if true then
        ...
        member this.GenerateBoostConsolidatedReport ctx args =
          if true then
        ...
        member this.GenerateCompetitorsPositionReport ctx args =
          if true then
            let content = "В ответ приходит идентификатор, который позволяет узнавать статус генерации и скачать готовый отчет." :> obj :?> GenerateReportResponse // this cast is obviously wrong, and is only intended to allow generated project to compile   
        ...
        member this.GenerateGoodsFeedbackReport ctx args =
          if true then
            let content = "В ответ приходит идентификатор, который позволяет узнавать статус генерации и скачать готовый отчет." :> obj :?> GenerateReportResponse // this cast is obviously wrong, and is only intended to allow generated project to compile   
        ...
        member this.GenerateGoodsRealizationReport ctx args =
          if true then
            let content = "В ответ приходит идентификатор, который позволяет узнавать статус генерации и скачать готовый отчет." :> obj :?> GenerateReportResponse // this cast is obviously wrong, and is only intended to allow generated project to compile   
        ...
        member this.GenerateMassOrderLabelsReport ctx args =
          if true then
        ...
        member this.GenerateOrderLabel ctx args =
          if true then
        ...
        member this.GenerateOrderLabels ctx args =
          if true then
        ...
        member this.GeneratePricesReport ctx args =
          if true then
            let content = "В ответ приходит идентификатор, который позволяет узнавать статус генерации и скачать готовый отчет." :> obj :?> GenerateReportResponse // this cast is obviously wrong, and is only intended to allow generated project to compile   
        ...
        member this.GenerateShelfsStatisticsReport ctx args =
          if true then
            let content = "В ответ приходит идентификатор, который позволяет узнавать статус генерации и скачать готовый отчет." :> obj :?> GenerateReportResponse // this cast is obviously wrong, and is only intended to allow generated project to compile   
        ...
        member this.GenerateShipmentListDocumentReport ctx args =
          if true then
        ...
        member this.GenerateShowsSalesReport ctx args =
          if true then
            let content = "В ответ приходит идентификатор, который позволяет узнавать статус генерации и скачать готовый отчет." :> obj :?> GenerateReportResponse // this cast is obviously wrong, and is only intended to allow generated project to compile   
        ...
        member this.GenerateStocksOnWarehousesReport ctx args =
          if true then
            let content = "В ответ приходит идентификатор, который позволяет узнавать статус генерации и скачать готовый отчет." :> obj :?> GenerateReportResponse // this cast is obviously wrong, and is only intended to allow generated project to compile   
        ...
        member this.GenerateUnitedMarketplaceServicesReport ctx args =
          if true then
            let content = "В ответ приходит идентификатор, который позволяет узнавать статус генерации и скачать готовый отчет." :> obj :?> GenerateReportResponse // this cast is obviously wrong, and is only intended to allow generated project to compile   
        ...
        member this.GenerateUnitedNettingReport ctx args =
          if true then
            let content = "В ответ приходит идентификатор, который позволяет узнавать статус генерации и скачать готовый отчет." :> obj :?> GenerateReportResponse // this cast is obviously wrong, and is only intended to allow generated project to compile   
        ...
        member this.GenerateUnitedOrdersReport ctx args =
          if true then
            let content = "В ответ приходит идентификатор, который позволяет узнавать статус генерации и скачать готовый отчет." :> obj :?> GenerateReportResponse // this cast is obviously wrong, and is only intended to allow generated project to compile   
        ...
        member this.GetBidsInfoForBusiness ctx args =
          if true then
        ...
        member this.GetBidsRecommendations ctx args =
          if true then
        ...
        member this.GetBusinessQuarantineOffers ctx args =
          if true then
        ...
        member this.GetCampaign ctx args =
          if true then
        ...
        member this.GetCampaignLogins ctx args =
          if true then
        ...
        member this.GetCampaignQuarantineOffers ctx args =
          if true then
            let content = "Список товаров в карантине." :> obj :?> GetQuarantineOffersResponse // this cast is obviously wrong, and is only intended to allow generated project to compile   
        ...
        member this.GetCampaignRegion ctx args =
          if true then
        ...
        member this.GetCampaignSettings ctx args =
          if true then
        ...
        member this.GetCampaigns ctx args =
          if true then
        ...
        member this.GetCampaignsByLogin ctx args =
          if true then
        ...
        member this.GetChatHistory ctx args =
          if true then
        ...
        member this.GetFeedIndexLogs ctx args =
          if true then
        ...
        member this.GetFeedbackAndCommentUpdates ctx args =
          if true then
        ...
        member this.GetGoodsFeedbackComments ctx args =
          if true then
        ...
        member this.GetGoodsFeedbacks ctx args =
          if true then
        ...
        member this.GetHiddenOffers ctx args =
          if true then
        ...
        member this.GetOfferMappingEntries ctx args =
          if true then
        ...
        member this.GetOrderBusinessBuyerInfo ctx args =
          if true then
        ...
        member this.GetOrderBusinessDocumentsInfo ctx args =
          if true then
        ...
        member this.GetOrderLabelsData ctx args =
          if true then
        ...
        member this.GetOrders ctx args =
          if true then
        ...
        member this.GetOrdersStats ctx args =
          if true then
        ...
        member this.GetPrices ctx args =
          if true then
        ...
        member this.GetPricesByOfferIds ctx args =
          if true then
        ...
        member this.GetPromoOffers ctx args =
          if true then
        ...
        member this.GetPromos ctx args =
          if true then
        ...
        member this.GetQualityRatingDetails ctx args =
          if true then
        ...
        member this.GetQualityRatings ctx args =
          if true then
        ...
        member this.GetReportInfo ctx args =
          if true then
        ...
        member this.GetReturn ctx args =
          if true then
        ...
        member this.GetReturnApplication ctx args =
          if true then
        ...
        member this.GetReturnPhoto ctx args =
          if true then
        ...
        member this.GetReturns ctx args =
          if true then
        ...
        member this.GetShipment ctx args =
          if true then
        ...
        member this.GetShipmentOrdersInfo ctx args =
          if true then
        ...
        member this.GetStocks ctx args =
          if true then
        ...
        member this.GetSuggestedOfferMappingEntries ctx args =
          if true then
        ...
        member this.GetSuggestedPrices ctx args =
          if true then
        ...
        member this.GetWarehouses ctx args =
          if true then
        ...
        member this.ProvideOrderItemIdentifiers ctx args =
          if true then
        ...
        member this.PutBidsForBusiness ctx args =
          if true then
        ...
        member this.PutBidsForCampaign ctx args =
          if true then
            let content = "Пустой ответ." :> obj :?> EmptyApiResponse // this cast is obviously wrong, and is only intended to allow generated project to compile   
        ...
        member this.RefreshFeed ctx args =
          if true then
            let content = "Пустой ответ." :> obj :?> EmptyApiResponse // this cast is obviously wrong, and is only intended to allow generated project to compile   
        ...
        member this.SearchRegionChildren ctx args =
          if true then
        ...
        member this.SearchRegionsById ctx args =
          if true then
        ...
        member this.SearchRegionsByName ctx args =
          if true then
        ...
        member this.SearchShipments ctx args =
          if true then
        ...
        member this.SendFileToChat ctx args =
          if true then
        ...
        member this.SendMessageToChat ctx args =
          if true then
        ...
        member this.SetFeedParams ctx args =
          if true then
        ...
        member this.SetOrderBoxLayout ctx args =
          if true then
        ...
        member this.SetOrderShipmentBoxes ctx args =
          if true then
        ...
        member this.SetShipmentPalletsCount ctx args =
          if true then
        ...
        member this.SkipGoodsFeedbacksReaction ctx args =
          if true then
            let content = "Пустой ответ." :> obj :?> EmptyApiResponse // this cast is obviously wrong, and is only intended to allow generated project to compile   
        ...
        member this.TransferOrdersFromShipment ctx args =
          if true then
        ...
        member this.UpdateBusinessPrices ctx args =
          if true then
        ...
        member this.UpdateGoodsFeedbackComment ctx args =
          if true then
        ...
        member this.UpdateOfferMappingEntries ctx args =
          if true then
            let content = "Статус выполнения операции." :> obj :?> EmptyApiResponse // this cast is obviously wrong, and is only intended to allow generated project to compile   
        ...
        member this.UpdateOrderItems ctx args =
          if true then
        ...
        member this.UpdateOrderStatus ctx args =
          if true then
        ...
        member this.UpdateOrderStatuses ctx args =
          if true then
        ...
        member this.UpdatePrices ctx args =
          if true then
            let content = "Маркет принял информацию о новых ценах." :> obj :?> EmptyApiResponse // this cast is obviously wrong, and is only intended to allow generated project to compile   
        ...
        member this.UpdatePromoOffers ctx args =
          if true then
        ...
        member this.UpdateStocks ctx args =
          if true then
            let content = "Пустой ответ." :> obj :?> EmptyApiResponse // this cast is obviously wrong, and is only intended to allow generated project to compile   
