# ympa_r_client::PromoOfferAutoParticipatingDetailsDTO
...
------------ | ------------- | ------------- | -------------
**campaignIds** | **array[integer]** | Магазины, в которых товар добавлен в акцию автоматически.  Возвращается, если статус товара в акции — &#x60;PARTIALLY_AUTO&#x60;.  | [optional] 
