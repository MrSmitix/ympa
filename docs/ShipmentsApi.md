...
# **confirm_shipment**
> confirm_shipment(req::HTTP.Request, campaign_id::Int64, shipment_id::Int64; confirm_shipment_request=nothing,) -> EmptyApiResponse
...
> download_shipment_act(req::HTTP.Request, campaign_id::Int64, shipment_id::Int64;) -> String
...
> download_shipment_discrepancy_act(req::HTTP.Request, campaign_id::Int64, shipment_id::Int64;) -> String
...
> download_shipment_inbound_act(req::HTTP.Request, campaign_id::Int64, shipment_id::Int64;) -> String
...
> download_shipment_pallet_labels(req::HTTP.Request, campaign_id::Int64, shipment_id::Int64; format=nothing,) -> String
...
> download_shipment_reception_transfer_act(req::HTTP.Request, campaign_id::Int64; warehouse_id=nothing,) -> String
...
> download_shipment_transportation_waybill(req::HTTP.Request, campaign_id::Int64, shipment_id::Int64;) -> String
...
# **get_shipment**
> get_shipment(req::HTTP.Request, campaign_id::Int64, shipment_id::Int64; cancelled_orders=nothing,) -> GetShipmentResponse
...
> get_shipment_orders_info(req::HTTP.Request, campaign_id::Int64, shipment_id::Int64;) -> GetShipmentOrdersInfoResponse
...
# **search_shipments**
> search_shipments(req::HTTP.Request, campaign_id::Int64, search_shipments_request::SearchShipmentsRequest; page_token=nothing, limit=nothing,) -> SearchShipmentsResponse
...
> set_shipment_pallets_count(req::HTTP.Request, campaign_id::Int64, shipment_id::Int64, set_shipment_pallets_count_request::SetShipmentPalletsCountRequest;) -> EmptyApiResponse
...
> transfer_orders_from_shipment(req::HTTP.Request, campaign_id::Int64, shipment_id::Int64, transfer_orders_from_shipment_request::TransferOrdersFromShipmentRequest;) -> EmptyApiResponse
