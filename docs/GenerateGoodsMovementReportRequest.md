...
```powershell
$GenerateGoodsMovementReportRequest = Initialize-ympa_powershell_clientGenerateGoodsMovementReportRequest  -CampaignId null `
 -DateFrom null `
 -DateTo null `
 -ShopSku null
```
...
```powershell
$GenerateGoodsMovementReportRequest | ConvertTo-JSON
```
