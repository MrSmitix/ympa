...
// Скрытие товаров и настройки скрытия
FbsAPI.addHiddenOffers(campaignId: campaignId, addHiddenOffersRequest: addHiddenOffersRequest) { (response, error) in
...
// Добавление товаров в архив
FbsAPI.addOffersToArchive(businessId: businessId, addOffersToArchiveRequest: addOffersToArchiveRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Калькулятор стоимости услуг
FbsAPI.calculateTariffs(calculateTariffsRequest: calculateTariffsRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Удаление товара из карантина по цене в кабинете
FbsAPI.confirmBusinessPrices(businessId: businessId, confirmPricesRequest: confirmPricesRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Удаление товара из карантина по цене в магазине
FbsAPI.confirmCampaignPrices(campaignId: campaignId, confirmPricesRequest: confirmPricesRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Подтверждение отгрузки
FbsAPI.confirmShipment(campaignId: campaignId, shipmentId: shipmentId, confirmShipmentRequest: confirmShipmentRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Создание нового чата с покупателем
FbsAPI.createChat(businessId: businessId, createChatRequest: createChatRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Удаление товаров из ассортимента магазина
FbsAPI.deleteCampaignOffers(campaignId: campaignId, deleteCampaignOffersRequest: deleteCampaignOffersRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Удаление комментария к отзыву
FbsAPI.deleteGoodsFeedbackComment(businessId: businessId, deleteGoodsFeedbackCommentRequest: deleteGoodsFeedbackCommentRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Возобновление показа товаров
FbsAPI.deleteHiddenOffers(campaignId: campaignId, deleteHiddenOffersRequest: deleteHiddenOffersRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Удаление товаров из каталога
FbsAPI.deleteOffers(businessId: businessId, deleteOffersRequest: deleteOffersRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Удаление товаров из архива
FbsAPI.deleteOffersFromArchive(businessId: businessId, deleteOffersFromArchiveRequest: deleteOffersFromArchiveRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Удаление товаров из акции
FbsAPI.deletePromoOffers(businessId: businessId, deletePromoOffersRequest: deletePromoOffersRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Получение акта приема-передачи
FbsAPI.downloadShipmentAct(campaignId: campaignId, shipmentId: shipmentId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Получение акта расхождений
FbsAPI.downloadShipmentDiscrepancyAct(campaignId: campaignId, shipmentId: shipmentId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Получение фактического акта приема-передачи
FbsAPI.downloadShipmentInboundAct(campaignId: campaignId, shipmentId: shipmentId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Ярлыки для доверительной приемки (FBS)
FbsAPI.downloadShipmentPalletLabels(campaignId: campaignId, shipmentId: shipmentId, format: format) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Подтверждение ближайшей отгрузки и получение акта приема-передачи для нее
FbsAPI.downloadShipmentReceptionTransferAct(campaignId: campaignId, warehouseId: warehouseId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Получение транспортной накладной
FbsAPI.downloadShipmentTransportationWaybill(campaignId: campaignId, shipmentId: shipmentId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Отчет по бусту продаж
FbsAPI.generateBoostConsolidatedReport(generateBoostConsolidatedRequest: generateBoostConsolidatedRequest, format: format) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Отчет «Конкурентная позиция»
FbsAPI.generateCompetitorsPositionReport(generateCompetitorsPositionReportRequest: generateCompetitorsPositionReportRequest, format: format) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Отчет по отзывам о товарах
FbsAPI.generateGoodsFeedbackReport(generateGoodsFeedbackRequest: generateGoodsFeedbackRequest, format: format) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Отчет по реализации
FbsAPI.generateGoodsRealizationReport(generateGoodsRealizationReportRequest: generateGoodsRealizationReportRequest, format: format) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Готовые ярлыки‑наклейки на все коробки в нескольких заказах
FbsAPI.generateMassOrderLabelsReport(generateMassOrderLabelsRequest: generateMassOrderLabelsRequest, format: format) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Готовый ярлык‑наклейка для коробки в заказе
FbsAPI.generateOrderLabel(campaignId: campaignId, orderId: orderId, shipmentId: shipmentId, boxId: boxId, format: format) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Готовые ярлыки‑наклейки на все коробки в одном заказе
FbsAPI.generateOrderLabels(campaignId: campaignId, orderId: orderId, format: format) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Отчет «Цены на рынке»
FbsAPI.generatePricesReport(generatePricesReportRequest: generatePricesReportRequest, format: format) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Отчет по полкам
FbsAPI.generateShelfsStatisticsReport(generateShelfsStatisticsRequest: generateShelfsStatisticsRequest, format: format) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Получение листа сборки
FbsAPI.generateShipmentListDocumentReport(generateShipmentListDocumentReportRequest: generateShipmentListDocumentReportRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Отчет «Аналитика продаж»
FbsAPI.generateShowsSalesReport(generateShowsSalesReportRequest: generateShowsSalesReportRequest, format: format) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Отчет по остаткам на складах
FbsAPI.generateStocksOnWarehousesReport(generateStocksOnWarehousesReportRequest: generateStocksOnWarehousesReportRequest, format: format) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Отчет по стоимости услуг
FbsAPI.generateUnitedMarketplaceServicesReport(generateUnitedMarketplaceServicesReportRequest: generateUnitedMarketplaceServicesReportRequest, format: format) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Отчет по платежам
FbsAPI.generateUnitedNettingReport(generateUnitedNettingReportRequest: generateUnitedNettingReportRequest, format: format) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Отчет по заказам
FbsAPI.generateUnitedOrdersReport(generateUnitedOrdersRequest: generateUnitedOrdersRequest, format: format) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Все предложения магазина
FbsAPI.getAllOffers(campaignId: campaignId, feedId: feedId, chunk: chunk) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Информация об установленных ставках
FbsAPI.getBidsInfoForBusiness(businessId: businessId, pageToken: pageToken, limit: limit, getBidsInfoRequest: getBidsInfoRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Рекомендованные ставки для заданных товаров
FbsAPI.getBidsRecommendations(businessId: businessId, getBidsRecommendationsRequest: getBidsRecommendationsRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Список товаров, находящихся в карантине по цене в кабинете
FbsAPI.getBusinessQuarantineOffers(businessId: businessId, getQuarantineOffersRequest: getQuarantineOffersRequest, pageToken: pageToken, limit: limit) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Настройки кабинета
FbsAPI.getBusinessSettings(businessId: businessId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Информация о магазине
FbsAPI.getCampaign(campaignId: campaignId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Логины, связанные с магазином
FbsAPI.getCampaignLogins(campaignId: campaignId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Информация о товарах, которые размещены в заданном магазине
FbsAPI.getCampaignOffers(campaignId: campaignId, getCampaignOffersRequest: getCampaignOffersRequest, pageToken: pageToken, limit: limit) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Список товаров, находящихся в карантине по цене в магазине
FbsAPI.getCampaignQuarantineOffers(campaignId: campaignId, getQuarantineOffersRequest: getQuarantineOffersRequest, pageToken: pageToken, limit: limit) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Регион магазина
FbsAPI.getCampaignRegion(campaignId: campaignId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Настройки магазина
FbsAPI.getCampaignSettings(campaignId: campaignId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Список магазинов пользователя
FbsAPI.getCampaigns(page: page, pageSize: pageSize) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Магазины, доступные логину
FbsAPI.getCampaignsByLogin(login: login, page: page, pageSize: pageSize) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Лимит на установку кванта продажи и минимального количества товаров в заказе
FbsAPI.getCategoriesMaxSaleQuantum(getCategoriesMaxSaleQuantumRequest: getCategoriesMaxSaleQuantumRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Дерево категорий
FbsAPI.getCategoriesTree(getCategoriesRequest: getCategoriesRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Списки характеристик товаров по категориям
FbsAPI.getCategoryContentParameters(categoryId: categoryId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Получение истории сообщений в чате
FbsAPI.getChatHistory(businessId: businessId, chatId: chatId, getChatHistoryRequest: getChatHistoryRequest, pageToken: pageToken, limit: limit) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Получение доступных чатов
FbsAPI.getChats(businessId: businessId, getChatsRequest: getChatsRequest, pageToken: pageToken, limit: limit) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Справочник служб доставки
FbsAPI.getDeliveryServices() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Информация о прайс-листе
FbsAPI.getFeed(campaignId: campaignId, feedId: feedId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Отчет по индексации прайс-листа
FbsAPI.getFeedIndexLogs(campaignId: campaignId, feedId: feedId, limit: limit, publishedTimeFrom: publishedTimeFrom, publishedTimeTo: publishedTimeTo, status: status) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Новые и обновленные отзывы о магазине
FbsAPI.getFeedbackAndCommentUpdates(campaignId: campaignId, pageToken: pageToken, limit: limit, fromDate: fromDate) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Список прайс-листов магазина
FbsAPI.getFeeds(campaignId: campaignId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Получение комментариев к отзыву
FbsAPI.getGoodsFeedbackComments(businessId: businessId, getGoodsFeedbackCommentsRequest: getGoodsFeedbackCommentsRequest, pageToken: pageToken, limit: limit) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Получение отзывов о товарах продавца
FbsAPI.getGoodsFeedbacks(businessId: businessId, pageToken: pageToken, limit: limit, getGoodsFeedbackRequest: getGoodsFeedbackRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Отчет по товарам
FbsAPI.getGoodsStats(campaignId: campaignId, getGoodsStatsRequest: getGoodsStatsRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Информация о скрытых вами товарах
FbsAPI.getHiddenOffers(campaignId: campaignId, offerId: offerId, pageToken: pageToken, limit: limit, offset: offset, page: page, pageSize: pageSize) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Получение информации о заполненности карточек магазина
FbsAPI.getOfferCardsContentStatus(businessId: businessId, pageToken: pageToken, limit: limit, getOfferCardsContentStatusRequest: getOfferCardsContentStatusRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Список товаров в каталоге
FbsAPI.getOfferMappingEntries(campaignId: campaignId, offerId: offerId, shopSku: shopSku, mappingKind: mappingKind, status: status, availability: availability, categoryId: categoryId, vendor: vendor, pageToken: pageToken, limit: limit) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Информация о товарах в каталоге
FbsAPI.getOfferMappings(businessId: businessId, pageToken: pageToken, limit: limit, getOfferMappingsRequest: getOfferMappingsRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Рекомендации Маркета, касающиеся цен
FbsAPI.getOfferRecommendations(businessId: businessId, getOfferRecommendationsRequest: getOfferRecommendationsRequest, pageToken: pageToken, limit: limit) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Предложения магазина
FbsAPI.getOffers(campaignId: campaignId, query: query, feedId: feedId, shopCategoryId: shopCategoryId, currency: currency, matched: matched, page: page, pageSize: pageSize) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Информация об одном заказе
FbsAPI.getOrder(campaignId: campaignId, orderId: orderId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Информация о покупателе — юридическом лице
FbsAPI.getOrderBusinessBuyerInfo(campaignId: campaignId, orderId: orderId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Информация о документах
FbsAPI.getOrderBusinessDocumentsInfo(campaignId: campaignId, orderId: orderId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Данные для самостоятельного изготовления ярлыков
FbsAPI.getOrderLabelsData(campaignId: campaignId, orderId: orderId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Детальная информация по заказам
FbsAPI.getOrdersStats(campaignId: campaignId, pageToken: pageToken, limit: limit, getOrdersStatsRequest: getOrdersStatsRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Список цен
FbsAPI.getPrices(campaignId: campaignId, pageToken: pageToken, limit: limit, archived: archived) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Просмотр цен на указанные товары в магазине
FbsAPI.getPricesByOfferIds(campaignId: campaignId, pageToken: pageToken, limit: limit, getPricesByOfferIdsRequest: getPricesByOfferIdsRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Получение списка товаров, которые участвуют или могут участвовать в акции
FbsAPI.getPromoOffers(businessId: businessId, getPromoOffersRequest: getPromoOffersRequest, pageToken: pageToken, limit: limit) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Получение списка акций
FbsAPI.getPromos(businessId: businessId, getPromosRequest: getPromosRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Заказы, которые повлияли на индекс качества
FbsAPI.getQualityRatingDetails(campaignId: campaignId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Индекс качества магазинов
FbsAPI.getQualityRatings(businessId: businessId, getQualityRatingRequest: getQualityRatingRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Получение заданного отчета
FbsAPI.getReportInfo(reportId: reportId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Информация о невыкупе или возврате
FbsAPI.getReturn(campaignId: campaignId, orderId: orderId, returnId: returnId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Получение заявления на возврат
FbsAPI.getReturnApplication(campaignId: campaignId, orderId: orderId, returnId: returnId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Получение фотографии возврата
FbsAPI.getReturnPhoto(campaignId: campaignId, orderId: orderId, returnId: returnId, itemId: itemId, imageHash: imageHash) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Список невыкупов и возвратов
FbsAPI.getReturns(campaignId: campaignId, pageToken: pageToken, limit: limit, orderIds: orderIds, statuses: statuses, type: type, fromDate: fromDate, toDate: toDate, fromDate2: fromDate2, toDate2: toDate2) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Получение информации об одной отгрузке
FbsAPI.getShipment(campaignId: campaignId, shipmentId: shipmentId, cancelledOrders: cancelledOrders) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Получение информации о возможности печати ярлыков (FBS)
FbsAPI.getShipmentOrdersInfo(campaignId: campaignId, shipmentId: shipmentId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Информация об остатках и оборачиваемости
FbsAPI.getStocks(campaignId: campaignId, pageToken: pageToken, limit: limit, getWarehouseStocksRequest: getWarehouseStocksRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Рекомендованные карточки для товаров
FbsAPI.getSuggestedOfferMappingEntries(campaignId: campaignId, getSuggestedOfferMappingEntriesRequest: getSuggestedOfferMappingEntriesRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Просмотр карточек на Маркете, которые подходят вашим товарам
FbsAPI.getSuggestedOfferMappings(businessId: businessId, getSuggestedOfferMappingsRequest: getSuggestedOfferMappingsRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Цены для продвижения товаров
FbsAPI.getSuggestedPrices(campaignId: campaignId, suggestPricesRequest: suggestPricesRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Список складов и групп складов
FbsAPI.getWarehouses(businessId: businessId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Передача кодов маркировки единиц товара
FbsAPI.provideOrderItemIdentifiers(campaignId: campaignId, orderId: orderId, provideOrderItemIdentifiersRequest: provideOrderItemIdentifiersRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Включение буста продаж и установка ставок
FbsAPI.putBidsForBusiness(businessId: businessId, putSkuBidsRequest: putSkuBidsRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Включение буста продаж и установка ставок для магазина
FbsAPI.putBidsForCampaign(campaignId: campaignId, putSkuBidsRequest: putSkuBidsRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Сообщить, что прайс-лист обновился
FbsAPI.refreshFeed(campaignId: campaignId, feedId: feedId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Информация о дочерних регионах
FbsAPI.searchRegionChildren(regionId: regionId, page: page, pageSize: pageSize) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Информация о регионе
FbsAPI.searchRegionsById(regionId: regionId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Поиск регионов по их имени
FbsAPI.searchRegionsByName(name: name, pageToken: pageToken, limit: limit) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Получение информации о нескольких отгрузках
FbsAPI.searchShipments(campaignId: campaignId, searchShipmentsRequest: searchShipmentsRequest, pageToken: pageToken, limit: limit) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Отправка файла в чат
FbsAPI.sendFileToChat(businessId: businessId, chatId: chatId, file: file) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Отправка сообщения в чат
FbsAPI.sendMessageToChat(businessId: businessId, chatId: chatId, sendMessageToChatRequest: sendMessageToChatRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Изменение параметров прайс-листа
FbsAPI.setFeedParams(campaignId: campaignId, feedId: feedId, setFeedParamsRequest: setFeedParamsRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Подготовка заказа
FbsAPI.setOrderBoxLayout(campaignId: campaignId, orderId: orderId, setOrderBoxLayoutRequest: setOrderBoxLayoutRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Передача количества грузовых мест в заказе
FbsAPI.setOrderShipmentBoxes(campaignId: campaignId, orderId: orderId, shipmentId: shipmentId, setOrderShipmentBoxesRequest: setOrderShipmentBoxesRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Передача количества упаковок в отгрузке
FbsAPI.setShipmentPalletsCount(campaignId: campaignId, shipmentId: shipmentId, setShipmentPalletsCountRequest: setShipmentPalletsCountRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Отказ от ответа на отзывы
FbsAPI.skipGoodsFeedbacksReaction(businessId: businessId, skipGoodsFeedbackReactionRequest: skipGoodsFeedbackReactionRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Перенос заказов в следующую отгрузку
FbsAPI.transferOrdersFromShipment(campaignId: campaignId, shipmentId: shipmentId, transferOrdersFromShipmentRequest: transferOrdersFromShipmentRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Установка цен на товары во всех магазинах
FbsAPI.updateBusinessPrices(businessId: businessId, updateBusinessPricesRequest: updateBusinessPricesRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Изменение условий продажи товаров в магазине
FbsAPI.updateCampaignOffers(campaignId: campaignId, updateCampaignOffersRequest: updateCampaignOffersRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Добавление нового или изменение созданного комментария
FbsAPI.updateGoodsFeedbackComment(businessId: businessId, updateGoodsFeedbackCommentRequest: updateGoodsFeedbackCommentRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Редактирование категорийных характеристик товара
FbsAPI.updateOfferContent(businessId: businessId, updateOfferContentRequest: updateOfferContentRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Добавление и редактирование товаров в каталоге
FbsAPI.updateOfferMappingEntries(campaignId: campaignId, updateOfferMappingEntryRequest: updateOfferMappingEntryRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Добавление товаров в каталог и изменение информации о них
FbsAPI.updateOfferMappings(businessId: businessId, updateOfferMappingsRequest: updateOfferMappingsRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Удаление товара из заказа или уменьшение числа единиц
FbsAPI.updateOrderItems(campaignId: campaignId, orderId: orderId, updateOrderItemRequest: updateOrderItemRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Изменение статуса одного заказа
FbsAPI.updateOrderStatus(campaignId: campaignId, orderId: orderId, updateOrderStatusRequest: updateOrderStatusRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Изменение статусов нескольких заказов
FbsAPI.updateOrderStatuses(campaignId: campaignId, updateOrderStatusesRequest: updateOrderStatusesRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Установка цен на товары в конкретном магазине
FbsAPI.updatePrices(campaignId: campaignId, updatePricesRequest: updatePricesRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Добавление товаров в акцию или изменение их цен
FbsAPI.updatePromoOffers(businessId: businessId, updatePromoOffersRequest: updatePromoOffersRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Передача информации об остатках
FbsAPI.updateStocks(campaignId: campaignId, updateStocksRequest: updateStocksRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
