...
------------- | ------------- | -------------
[**deleteCampaignOffers**](OAIOffersApi.md#deletecampaignoffers) | **POST** /campaigns/{campaignId}/offers/delete | Удаление товаров из ассортимента магазина
[**getAllOffers**](OAIOffersApi.md#getalloffers) | **GET** /campaigns/{campaignId}/offers/all | Все предложения магазина
[**getCampaignOffers**](OAIOffersApi.md#getcampaignoffers) | **POST** /campaigns/{campaignId}/offers | Информация о товарах, которые размещены в заданном магазине
[**getOfferRecommendations**](OAIOffersApi.md#getofferrecommendations) | **POST** /businesses/{businessId}/offers/recommendations | Рекомендации Маркета, касающиеся цен
[**getOffers**](OAIOffersApi.md#getoffers) | **GET** /campaigns/{campaignId}/offers | Предложения магазина
[**updateCampaignOffers**](OAIOffersApi.md#updatecampaignoffers) | **POST** /campaigns/{campaignId}/offers/update | Изменение условий продажи товаров в магазине
...
OAIOffersApi*apiInstance = [[OAIOffersApi alloc] init];
...
[apiInstance deleteCampaignOffersWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIDeleteCampaignOffersResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIOffersApi->deleteCampaignOffers: %@", error);
                        }
                    }];
```
...
[apiInstance getAllOffersWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIGetAllOffersResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIOffersApi->getAllOffers: %@", error);
                        }
                    }];
```
...
[apiInstance getCampaignOffersWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIGetCampaignOffersResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIOffersApi->getCampaignOffers: %@", error);
                        }
                    }];
```
...
[apiInstance getOfferRecommendationsWithBusinessId:businessId
          ...
          completionHandler: ^(OAIGetOfferRecommendationsResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIOffersApi->getOfferRecommendations: %@", error);
                        }
                    }];
```
...
[apiInstance getOffersWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIGetOffersResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIOffersApi->getOffers: %@", error);
                        }
                    }];
```
...
[apiInstance updateCampaignOffersWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIEmptyApiResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIOffersApi->updateCampaignOffers: %@", error);
                        }
                    }];
```
