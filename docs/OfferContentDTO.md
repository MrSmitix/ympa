...
# Table `OfferContentDTO`
(mapped from: OfferContentDTO)
...
# **Table `OfferContentDTOParameterValueDTO`**
(mapped from: OfferContentDTOParameterValueDTO)

## Properties
Name | Mapping | SQL Type | Default | Type | Description | Notes
---- | ------- | -------- | ------- | ---- | ----------- | -----
offerContentDTO | offerContentDTO | long | | kotlin.Long | Primary Key | *one*
