# WWW::OpenAPIClient::OfferMappingsApi

## Load the API package
```perl
use WWW::OpenAPIClient::Object::OfferMappingsApi;
```
...
if ($@) {
    warn "Exception when calling OfferMappingsApi->get_offer_mapping_entries: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling OfferMappingsApi->get_suggested_offer_mapping_entries: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling OfferMappingsApi->update_offer_mapping_entries: $@\n";
}
```
