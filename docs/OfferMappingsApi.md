# ympa_python_pydantic_v1_client.OfferMappingsApi
...
with ympa_python_pydantic_v1_client.ApiClient(configuration) as api_client:
    ...
    api_instance = ympa_python_pydantic_v1_client.OfferMappingsApi(api_client)
    ...
    try:
        ...
        print("The response of OfferMappingsApi->get_offer_mapping_entries:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling OfferMappingsApi->get_offer_mapping_entries: %s\n" % e)
```
...
with ympa_python_pydantic_v1_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of OfferMappingsApi->get_suggested_offer_mapping_entries:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling OfferMappingsApi->get_suggested_offer_mapping_entries: %s\n" % e)
```
...
with ympa_python_pydantic_v1_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of OfferMappingsApi->update_offer_mapping_entries:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling OfferMappingsApi->update_offer_mapping_entries: %s\n" % e)
```
