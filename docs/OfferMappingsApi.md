...
try {
    ...
    println("4xx response calling OfferMappingsApi#getOfferMappingEntries")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling OfferMappingsApi#getOfferMappingEntries")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling OfferMappingsApi#getSuggestedOfferMappingEntries")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling OfferMappingsApi#getSuggestedOfferMappingEntries")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling OfferMappingsApi#updateOfferMappingEntries")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling OfferMappingsApi#updateOfferMappingEntries")
    e.printStackTrace()
}
```
