# OpenapiClient::OfferMappingsApi
...
begin
  ...
  puts "Error when calling OfferMappingsApi->get_offer_mapping_entries: #{e}"
end
```
...
begin
  ...
  puts "Error when calling OfferMappingsApi->get_offer_mapping_entries_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling OfferMappingsApi->get_suggested_offer_mapping_entries: #{e}"
end
```
...
begin
  ...
  puts "Error when calling OfferMappingsApi->get_suggested_offer_mapping_entries_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling OfferMappingsApi->update_offer_mapping_entries: #{e}"
end
```
...
begin
  ...
  puts "Error when calling OfferMappingsApi->update_offer_mapping_entries_with_http_info: #{e}"
end
```
