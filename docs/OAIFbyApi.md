...
------------- | ------------- | -------------
[**addHiddenOffers**](OAIFbyApi.md#addhiddenoffers) | **POST** /campaigns/{campaignId}/hidden-offers | Скрытие товаров и настройки скрытия
[**addOffersToArchive**](OAIFbyApi.md#addofferstoarchive) | **POST** /businesses/{businessId}/offer-mappings/archive | Добавление товаров в архив
[**calculateTariffs**](OAIFbyApi.md#calculatetariffs) | **POST** /tariffs/calculate | Калькулятор стоимости услуг
[**confirmBusinessPrices**](OAIFbyApi.md#confirmbusinessprices) | **POST** /businesses/{businessId}/price-quarantine/confirm | Удаление товара из карантина по цене в кабинете
[**confirmCampaignPrices**](OAIFbyApi.md#confirmcampaignprices) | **POST** /campaigns/{campaignId}/price-quarantine/confirm | Удаление товара из карантина по цене в магазине
[**createChat**](OAIFbyApi.md#createchat) | **POST** /businesses/{businessId}/chats/new | Создание нового чата с покупателем
[**deleteCampaignOffers**](OAIFbyApi.md#deletecampaignoffers) | **POST** /campaigns/{campaignId}/offers/delete | Удаление товаров из ассортимента магазина
[**deleteGoodsFeedbackComment**](OAIFbyApi.md#deletegoodsfeedbackcomment) | **POST** /businesses/{businessId}/goods-feedback/comments/delete | Удаление комментария к отзыву
[**deleteHiddenOffers**](OAIFbyApi.md#deletehiddenoffers) | **POST** /campaigns/{campaignId}/hidden-offers/delete | Возобновление показа товаров
[**deleteOffers**](OAIFbyApi.md#deleteoffers) | **POST** /businesses/{businessId}/offer-mappings/delete | Удаление товаров из каталога
[**deleteOffersFromArchive**](OAIFbyApi.md#deleteoffersfromarchive) | **POST** /businesses/{businessId}/offer-mappings/unarchive | Удаление товаров из архива
[**deletePromoOffers**](OAIFbyApi.md#deletepromooffers) | **POST** /businesses/{businessId}/promos/offers/delete | Удаление товаров из акции
[**generateBoostConsolidatedReport**](OAIFbyApi.md#generateboostconsolidatedreport) | **POST** /reports/boost-consolidated/generate | Отчет по бусту продаж
[**generateCompetitorsPositionReport**](OAIFbyApi.md#generatecompetitorspositionreport) | **POST** /reports/competitors-position/generate | Отчет «Конкурентная позиция»
[**generateGoodsFeedbackReport**](OAIFbyApi.md#generategoodsfeedbackreport) | **POST** /reports/goods-feedback/generate | Отчет по отзывам о товарах
[**generateGoodsMovementReport**](OAIFbyApi.md#generategoodsmovementreport) | **POST** /reports/goods-movement/generate | Отчет по движению товаров
[**generateGoodsRealizationReport**](OAIFbyApi.md#generategoodsrealizationreport) | **POST** /reports/goods-realization/generate | Отчет по реализации
[**generateGoodsTurnoverReport**](OAIFbyApi.md#generategoodsturnoverreport) | **POST** /reports/goods-turnover/generate | Отчет по оборачиваемости
[**generatePricesReport**](OAIFbyApi.md#generatepricesreport) | **POST** /reports/prices/generate | Отчет «Цены на рынке»
[**generateShelfsStatisticsReport**](OAIFbyApi.md#generateshelfsstatisticsreport) | **POST** /reports/shelf-statistics/generate | Отчет по полкам
[**generateShowsSalesReport**](OAIFbyApi.md#generateshowssalesreport) | **POST** /reports/shows-sales/generate | Отчет «Аналитика продаж»
[**generateStocksOnWarehousesReport**](OAIFbyApi.md#generatestocksonwarehousesreport) | **POST** /reports/stocks-on-warehouses/generate | Отчет по остаткам на складах
[**generateUnitedMarketplaceServicesReport**](OAIFbyApi.md#generateunitedmarketplaceservicesreport) | **POST** /reports/united-marketplace-services/generate | Отчет по стоимости услуг
[**generateUnitedNettingReport**](OAIFbyApi.md#generateunitednettingreport) | **POST** /reports/united-netting/generate | Отчет по платежам
[**generateUnitedOrdersReport**](OAIFbyApi.md#generateunitedordersreport) | **POST** /reports/united-orders/generate | Отчет по заказам
[**getAllOffers**](OAIFbyApi.md#getalloffers) | **GET** /campaigns/{campaignId}/offers/all | Все предложения магазина
[**getBidsInfoForBusiness**](OAIFbyApi.md#getbidsinfoforbusiness) | **POST** /businesses/{businessId}/bids/info | Информация об установленных ставках
[**getBidsRecommendations**](OAIFbyApi.md#getbidsrecommendations) | **POST** /businesses/{businessId}/bids/recommendations | Рекомендованные ставки для заданных товаров
[**getBusinessQuarantineOffers**](OAIFbyApi.md#getbusinessquarantineoffers) | **POST** /businesses/{businessId}/price-quarantine | Список товаров, находящихся в карантине по цене в кабинете
[**getBusinessSettings**](OAIFbyApi.md#getbusinesssettings) | **POST** /businesses/{businessId}/settings | Настройки кабинета
[**getCampaign**](OAIFbyApi.md#getcampaign) | **GET** /campaigns/{campaignId} | Информация о магазине
[**getCampaignLogins**](OAIFbyApi.md#getcampaignlogins) | **GET** /campaigns/{campaignId}/logins | Логины, связанные с магазином
[**getCampaignOffers**](OAIFbyApi.md#getcampaignoffers) | **POST** /campaigns/{campaignId}/offers | Информация о товарах, которые размещены в заданном магазине
[**getCampaignQuarantineOffers**](OAIFbyApi.md#getcampaignquarantineoffers) | **POST** /campaigns/{campaignId}/price-quarantine | Список товаров, находящихся в карантине по цене в магазине
[**getCampaignRegion**](OAIFbyApi.md#getcampaignregion) | **GET** /campaigns/{campaignId}/region | Регион магазина
[**getCampaignSettings**](OAIFbyApi.md#getcampaignsettings) | **GET** /campaigns/{campaignId}/settings | Настройки магазина
[**getCampaigns**](OAIFbyApi.md#getcampaigns) | **GET** /campaigns | Список магазинов пользователя
[**getCampaignsByLogin**](OAIFbyApi.md#getcampaignsbylogin) | **GET** /campaigns/by_login/{login} | Магазины, доступные логину
[**getCategoriesMaxSaleQuantum**](OAIFbyApi.md#getcategoriesmaxsalequantum) | **POST** /categories/max-sale-quantum | Лимит на установку кванта продажи и минимального количества товаров в заказе
[**getCategoriesTree**](OAIFbyApi.md#getcategoriestree) | **POST** /categories/tree | Дерево категорий
[**getCategoryContentParameters**](OAIFbyApi.md#getcategorycontentparameters) | **POST** /category/{categoryId}/parameters | Списки характеристик товаров по категориям
[**getChatHistory**](OAIFbyApi.md#getchathistory) | **POST** /businesses/{businessId}/chats/history | Получение истории сообщений в чате
[**getChats**](OAIFbyApi.md#getchats) | **POST** /businesses/{businessId}/chats | Получение доступных чатов
[**getFeed**](OAIFbyApi.md#getfeed) | **GET** /campaigns/{campaignId}/feeds/{feedId} | Информация о прайс-листе
[**getFeedIndexLogs**](OAIFbyApi.md#getfeedindexlogs) | **GET** /campaigns/{campaignId}/feeds/{feedId}/index-logs | Отчет по индексации прайс-листа
[**getFeedbackAndCommentUpdates**](OAIFbyApi.md#getfeedbackandcommentupdates) | **GET** /campaigns/{campaignId}/feedback/updates | Новые и обновленные отзывы о магазине
[**getFeeds**](OAIFbyApi.md#getfeeds) | **GET** /campaigns/{campaignId}/feeds | Список прайс-листов магазина
[**getFulfillmentWarehouses**](OAIFbyApi.md#getfulfillmentwarehouses) | **GET** /warehouses | Идентификаторы складов Маркета (FBY)
[**getGoodsFeedbackComments**](OAIFbyApi.md#getgoodsfeedbackcomments) | **POST** /businesses/{businessId}/goods-feedback/comments | Получение комментариев к отзыву
[**getGoodsFeedbacks**](OAIFbyApi.md#getgoodsfeedbacks) | **POST** /businesses/{businessId}/goods-feedback | Получение отзывов о товарах продавца
[**getGoodsStats**](OAIFbyApi.md#getgoodsstats) | **POST** /campaigns/{campaignId}/stats/skus | Отчет по товарам
[**getHiddenOffers**](OAIFbyApi.md#gethiddenoffers) | **GET** /campaigns/{campaignId}/hidden-offers | Информация о скрытых вами товарах
[**getOfferCardsContentStatus**](OAIFbyApi.md#getoffercardscontentstatus) | **POST** /businesses/{businessId}/offer-cards | Получение информации о заполненности карточек магазина
[**getOfferMappingEntries**](OAIFbyApi.md#getoffermappingentries) | **GET** /campaigns/{campaignId}/offer-mapping-entries | Список товаров в каталоге
[**getOfferMappings**](OAIFbyApi.md#getoffermappings) | **POST** /businesses/{businessId}/offer-mappings | Информация о товарах в каталоге
[**getOfferRecommendations**](OAIFbyApi.md#getofferrecommendations) | **POST** /businesses/{businessId}/offers/recommendations | Рекомендации Маркета, касающиеся цен
[**getOffers**](OAIFbyApi.md#getoffers) | **GET** /campaigns/{campaignId}/offers | Предложения магазина
[**getOrder**](OAIFbyApi.md#getorder) | **GET** /campaigns/{campaignId}/orders/{orderId} | Информация об одном заказе
[**getOrderBusinessBuyerInfo**](OAIFbyApi.md#getorderbusinessbuyerinfo) | **POST** /campaigns/{campaignId}/orders/{orderId}/business-buyer | Информация о покупателе — юридическом лице
[**getOrderBusinessDocumentsInfo**](OAIFbyApi.md#getorderbusinessdocumentsinfo) | **POST** /campaigns/{campaignId}/orders/{orderId}/documents | Информация о документах
[**getOrders**](OAIFbyApi.md#getorders) | **GET** /campaigns/{campaignId}/orders | Информация о нескольких заказах
[**getOrdersStats**](OAIFbyApi.md#getordersstats) | **POST** /campaigns/{campaignId}/stats/orders | Детальная информация по заказам
[**getPrices**](OAIFbyApi.md#getprices) | **GET** /campaigns/{campaignId}/offer-prices | Список цен
[**getPricesByOfferIds**](OAIFbyApi.md#getpricesbyofferids) | **POST** /campaigns/{campaignId}/offer-prices | Просмотр цен на указанные товары в магазине
[**getPromoOffers**](OAIFbyApi.md#getpromooffers) | **POST** /businesses/{businessId}/promos/offers | Получение списка товаров, которые участвуют или могут участвовать в акции
[**getPromos**](OAIFbyApi.md#getpromos) | **POST** /businesses/{businessId}/promos | Получение списка акций
[**getQualityRatings**](OAIFbyApi.md#getqualityratings) | **POST** /businesses/{businessId}/ratings/quality | Индекс качества магазинов
[**getReportInfo**](OAIFbyApi.md#getreportinfo) | **GET** /reports/info/{reportId} | Получение заданного отчета
[**getReturn**](OAIFbyApi.md#getreturn) | **GET** /campaigns/{campaignId}/orders/{orderId}/returns/{returnId} | Информация о невыкупе или возврате
[**getReturnPhoto**](OAIFbyApi.md#getreturnphoto) | **GET** /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}/decision/{itemId}/image/{imageHash} | Получение фотографии возврата
[**getReturns**](OAIFbyApi.md#getreturns) | **GET** /campaigns/{campaignId}/returns | Список невыкупов и возвратов
[**getStocks**](OAIFbyApi.md#getstocks) | **POST** /campaigns/{campaignId}/offers/stocks | Информация об остатках и оборачиваемости
[**getSuggestedOfferMappingEntries**](OAIFbyApi.md#getsuggestedoffermappingentries) | **POST** /campaigns/{campaignId}/offer-mapping-entries/suggestions | Рекомендованные карточки для товаров
[**getSuggestedOfferMappings**](OAIFbyApi.md#getsuggestedoffermappings) | **POST** /businesses/{businessId}/offer-mappings/suggestions | Просмотр карточек на Маркете, которые подходят вашим товарам
[**getSuggestedPrices**](OAIFbyApi.md#getsuggestedprices) | **POST** /campaigns/{campaignId}/offer-prices/suggestions | Цены для продвижения товаров
[**putBidsForBusiness**](OAIFbyApi.md#putbidsforbusiness) | **PUT** /businesses/{businessId}/bids | Включение буста продаж и установка ставок
[**putBidsForCampaign**](OAIFbyApi.md#putbidsforcampaign) | **PUT** /campaigns/{campaignId}/bids | Включение буста продаж и установка ставок для магазина
[**refreshFeed**](OAIFbyApi.md#refreshfeed) | **POST** /campaigns/{campaignId}/feeds/{feedId}/refresh | Сообщить, что прайс-лист обновился
[**searchRegionChildren**](OAIFbyApi.md#searchregionchildren) | **GET** /regions/{regionId}/children | Информация о дочерних регионах
[**searchRegionsById**](OAIFbyApi.md#searchregionsbyid) | **GET** /regions/{regionId} | Информация о регионе
[**searchRegionsByName**](OAIFbyApi.md#searchregionsbyname) | **GET** /regions | Поиск регионов по их имени
[**sendFileToChat**](OAIFbyApi.md#sendfiletochat) | **POST** /businesses/{businessId}/chats/file/send | Отправка файла в чат
[**sendMessageToChat**](OAIFbyApi.md#sendmessagetochat) | **POST** /businesses/{businessId}/chats/message | Отправка сообщения в чат
[**setFeedParams**](OAIFbyApi.md#setfeedparams) | **POST** /campaigns/{campaignId}/feeds/{feedId}/params | Изменение параметров прайс-листа
[**skipGoodsFeedbacksReaction**](OAIFbyApi.md#skipgoodsfeedbacksreaction) | **POST** /businesses/{businessId}/goods-feedback/skip-reaction | Отказ от ответа на отзывы
[**updateBusinessPrices**](OAIFbyApi.md#updatebusinessprices) | **POST** /businesses/{businessId}/offer-prices/updates | Установка цен на товары во всех магазинах
[**updateCampaignOffers**](OAIFbyApi.md#updatecampaignoffers) | **POST** /campaigns/{campaignId}/offers/update | Изменение условий продажи товаров в магазине
[**updateGoodsFeedbackComment**](OAIFbyApi.md#updategoodsfeedbackcomment) | **POST** /businesses/{businessId}/goods-feedback/comments/update | Добавление нового или изменение созданного комментария
[**updateOfferContent**](OAIFbyApi.md#updateoffercontent) | **POST** /businesses/{businessId}/offer-cards/update | Редактирование категорийных характеристик товара
[**updateOfferMappingEntries**](OAIFbyApi.md#updateoffermappingentries) | **POST** /campaigns/{campaignId}/offer-mapping-entries/updates | Добавление и редактирование товаров в каталоге
[**updateOfferMappings**](OAIFbyApi.md#updateoffermappings) | **POST** /businesses/{businessId}/offer-mappings/update | Добавление товаров в каталог и изменение информации о них
[**updatePrices**](OAIFbyApi.md#updateprices) | **POST** /campaigns/{campaignId}/offer-prices/updates | Установка цен на товары в конкретном магазине
[**updatePromoOffers**](OAIFbyApi.md#updatepromooffers) | **POST** /businesses/{businessId}/promos/offers/update | Добавление товаров в акцию или изменение их цен
...
OAIFbyApi*apiInstance = [[OAIFbyApi alloc] init];
...
[apiInstance addHiddenOffersWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIEmptyApiResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->addHiddenOffers: %@", error);
                        }
                    }];
```
...
[apiInstance addOffersToArchiveWithBusinessId:businessId
          ...
          completionHandler: ^(OAIAddOffersToArchiveResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->addOffersToArchive: %@", error);
                        }
                    }];
```
...
[apiInstance calculateTariffsWithCalculateTariffsRequest:calculateTariffsRequest
          completionHandler: ^(OAICalculateTariffsResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->calculateTariffs: %@", error);
                        }
                    }];
```
...
[apiInstance confirmBusinessPricesWithBusinessId:businessId
          ...
          completionHandler: ^(OAIEmptyApiResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->confirmBusinessPrices: %@", error);
                        }
                    }];
```
...
[apiInstance confirmCampaignPricesWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIEmptyApiResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->confirmCampaignPrices: %@", error);
                        }
                    }];
```
...
[apiInstance createChatWithBusinessId:businessId
          ...
          completionHandler: ^(OAICreateChatResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->createChat: %@", error);
                        }
                    }];
```
...
[apiInstance deleteCampaignOffersWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIDeleteCampaignOffersResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->deleteCampaignOffers: %@", error);
                        }
                    }];
```
...
[apiInstance deleteGoodsFeedbackCommentWithBusinessId:businessId
          ...
          completionHandler: ^(OAIEmptyApiResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->deleteGoodsFeedbackComment: %@", error);
                        }
                    }];
```
...
[apiInstance deleteHiddenOffersWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIEmptyApiResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->deleteHiddenOffers: %@", error);
                        }
                    }];
```
...
[apiInstance deleteOffersWithBusinessId:businessId
          ...
          completionHandler: ^(OAIDeleteOffersResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->deleteOffers: %@", error);
                        }
                    }];
```
...
[apiInstance deleteOffersFromArchiveWithBusinessId:businessId
          ...
          completionHandler: ^(OAIDeleteOffersFromArchiveResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->deleteOffersFromArchive: %@", error);
                        }
                    }];
```
...
[apiInstance deletePromoOffersWithBusinessId:businessId
          ...
          completionHandler: ^(OAIDeletePromoOffersResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->deletePromoOffers: %@", error);
                        }
                    }];
```
...
[apiInstance generateBoostConsolidatedReportWithGenerateBoostConsolidatedRequest:generateBoostConsolidatedRequest
          ...
          completionHandler: ^(OAIGenerateReportResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->generateBoostConsolidatedReport: %@", error);
                        }
                    }];
```
...
[apiInstance generateCompetitorsPositionReportWithGenerateCompetitorsPositionReportRequest:generateCompetitorsPositionReportRequest
          ...
          completionHandler: ^(OAIGenerateReportResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->generateCompetitorsPositionReport: %@", error);
                        }
                    }];
```
...
[apiInstance generateGoodsFeedbackReportWithGenerateGoodsFeedbackRequest:generateGoodsFeedbackRequest
          ...
          completionHandler: ^(OAIGenerateReportResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->generateGoodsFeedbackReport: %@", error);
                        }
                    }];
```
...
[apiInstance generateGoodsMovementReportWithGenerateGoodsMovementReportRequest:generateGoodsMovementReportRequest
          ...
          completionHandler: ^(OAIGenerateReportResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->generateGoodsMovementReport: %@", error);
                        }
                    }];
```
...
[apiInstance generateGoodsRealizationReportWithGenerateGoodsRealizationReportRequest:generateGoodsRealizationReportRequest
          ...
          completionHandler: ^(OAIGenerateReportResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->generateGoodsRealizationReport: %@", error);
                        }
                    }];
```
...
[apiInstance generateGoodsTurnoverReportWithGenerateGoodsTurnoverRequest:generateGoodsTurnoverRequest
          ...
          completionHandler: ^(OAIGenerateReportResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->generateGoodsTurnoverReport: %@", error);
                        }
                    }];
```
...
[apiInstance generatePricesReportWithGeneratePricesReportRequest:generatePricesReportRequest
          ...
          completionHandler: ^(OAIGenerateReportResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->generatePricesReport: %@", error);
                        }
                    }];
```
...
[apiInstance generateShelfsStatisticsReportWithGenerateShelfsStatisticsRequest:generateShelfsStatisticsRequest
          ...
          completionHandler: ^(OAIGenerateReportResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->generateShelfsStatisticsReport: %@", error);
                        }
                    }];
```
...
[apiInstance generateShowsSalesReportWithGenerateShowsSalesReportRequest:generateShowsSalesReportRequest
          ...
          completionHandler: ^(OAIGenerateReportResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->generateShowsSalesReport: %@", error);
                        }
                    }];
```
...
[apiInstance generateStocksOnWarehousesReportWithGenerateStocksOnWarehousesReportRequest:generateStocksOnWarehousesReportRequest
          ...
          completionHandler: ^(OAIGenerateReportResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->generateStocksOnWarehousesReport: %@", error);
                        }
                    }];
```
...
[apiInstance generateUnitedMarketplaceServicesReportWithGenerateUnitedMarketplaceServicesReportRequest:generateUnitedMarketplaceServicesReportRequest
          ...
          completionHandler: ^(OAIGenerateReportResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->generateUnitedMarketplaceServicesReport: %@", error);
                        }
                    }];
```
...
[apiInstance generateUnitedNettingReportWithGenerateUnitedNettingReportRequest:generateUnitedNettingReportRequest
          ...
          completionHandler: ^(OAIGenerateReportResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->generateUnitedNettingReport: %@", error);
                        }
                    }];
```
...
[apiInstance generateUnitedOrdersReportWithGenerateUnitedOrdersRequest:generateUnitedOrdersRequest
          ...
          completionHandler: ^(OAIGenerateReportResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->generateUnitedOrdersReport: %@", error);
                        }
                    }];
```
...
[apiInstance getAllOffersWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIGetAllOffersResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->getAllOffers: %@", error);
                        }
                    }];
```
...
[apiInstance getBidsInfoForBusinessWithBusinessId:businessId
          ...
          completionHandler: ^(OAIGetBidsInfoResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->getBidsInfoForBusiness: %@", error);
                        }
                    }];
```
...
[apiInstance getBidsRecommendationsWithBusinessId:businessId
          ...
          completionHandler: ^(OAIGetBidsRecommendationsResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->getBidsRecommendations: %@", error);
                        }
                    }];
```
...
[apiInstance getBusinessQuarantineOffersWithBusinessId:businessId
          ...
          completionHandler: ^(OAIGetQuarantineOffersResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->getBusinessQuarantineOffers: %@", error);
                        }
                    }];
```
...
[apiInstance getBusinessSettingsWithBusinessId:businessId
          completionHandler: ^(OAIGetBusinessSettingsResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->getBusinessSettings: %@", error);
                        }
                    }];
```
...
[apiInstance getCampaignWithCampaignId:campaignId
          completionHandler: ^(OAIGetCampaignResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->getCampaign: %@", error);
                        }
                    }];
```
...
[apiInstance getCampaignLoginsWithCampaignId:campaignId
          completionHandler: ^(OAIGetCampaignLoginsResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->getCampaignLogins: %@", error);
                        }
                    }];
```
...
[apiInstance getCampaignOffersWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIGetCampaignOffersResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->getCampaignOffers: %@", error);
                        }
                    }];
```
...
[apiInstance getCampaignQuarantineOffersWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIGetQuarantineOffersResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->getCampaignQuarantineOffers: %@", error);
                        }
                    }];
```
...
[apiInstance getCampaignRegionWithCampaignId:campaignId
          completionHandler: ^(OAIGetCampaignRegionResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->getCampaignRegion: %@", error);
                        }
                    }];
```
...
[apiInstance getCampaignSettingsWithCampaignId:campaignId
          completionHandler: ^(OAIGetCampaignSettingsResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->getCampaignSettings: %@", error);
                        }
                    }];
```
...
[apiInstance getCampaignsWithPage:page
          ...
          completionHandler: ^(OAIGetCampaignsResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->getCampaigns: %@", error);
                        }
                    }];
```
...
[apiInstance getCampaignsByLoginWithLogin:login
          ...
          completionHandler: ^(OAIGetCampaignsResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->getCampaignsByLogin: %@", error);
                        }
                    }];
```
...
[apiInstance getCategoriesMaxSaleQuantumWithGetCategoriesMaxSaleQuantumRequest:getCategoriesMaxSaleQuantumRequest
          completionHandler: ^(OAIGetCategoriesMaxSaleQuantumResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->getCategoriesMaxSaleQuantum: %@", error);
                        }
                    }];
```
...
[apiInstance getCategoriesTreeWithGetCategoriesRequest:getCategoriesRequest
          completionHandler: ^(OAIGetCategoriesResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->getCategoriesTree: %@", error);
                        }
                    }];
```
...
[apiInstance getCategoryContentParametersWithCategoryId:categoryId
          completionHandler: ^(OAIGetCategoryContentParametersResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->getCategoryContentParameters: %@", error);
                        }
                    }];
```
...
[apiInstance getChatHistoryWithBusinessId:businessId
          ...
          completionHandler: ^(OAIGetChatHistoryResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->getChatHistory: %@", error);
                        }
                    }];
```
...
[apiInstance getChatsWithBusinessId:businessId
          ...
          completionHandler: ^(OAIGetChatsResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->getChats: %@", error);
                        }
                    }];
```
...
[apiInstance getFeedWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIGetFeedResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->getFeed: %@", error);
                        }
                    }];
```
...
[apiInstance getFeedIndexLogsWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIGetFeedIndexLogsResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->getFeedIndexLogs: %@", error);
                        }
                    }];
```
...
[apiInstance getFeedbackAndCommentUpdatesWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIGetFeedbackListResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->getFeedbackAndCommentUpdates: %@", error);
                        }
                    }];
```
...
[apiInstance getFeedsWithCampaignId:campaignId
          completionHandler: ^(OAIGetFeedsResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->getFeeds: %@", error);
                        }
                    }];
```
...
[apiInstance getFulfillmentWarehousesWithCompletionHandler: 
          ^(OAIGetFulfillmentWarehousesResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->getFulfillmentWarehouses: %@", error);
                        }
                    }];
```
...
[apiInstance getGoodsFeedbackCommentsWithBusinessId:businessId
          ...
          completionHandler: ^(OAIGetGoodsFeedbackCommentsResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->getGoodsFeedbackComments: %@", error);
                        }
                    }];
```
...
[apiInstance getGoodsFeedbacksWithBusinessId:businessId
          ...
          completionHandler: ^(OAIGetGoodsFeedbackResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->getGoodsFeedbacks: %@", error);
                        }
                    }];
```
...
[apiInstance getGoodsStatsWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIGetGoodsStatsResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->getGoodsStats: %@", error);
                        }
                    }];
```
...
[apiInstance getHiddenOffersWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIGetHiddenOffersResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->getHiddenOffers: %@", error);
                        }
                    }];
```
...
[apiInstance getOfferCardsContentStatusWithBusinessId:businessId
          ...
          completionHandler: ^(OAIGetOfferCardsContentStatusResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->getOfferCardsContentStatus: %@", error);
                        }
                    }];
```
...
[apiInstance getOfferMappingEntriesWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIGetOfferMappingEntriesResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->getOfferMappingEntries: %@", error);
                        }
                    }];
```
...
[apiInstance getOfferMappingsWithBusinessId:businessId
          ...
          completionHandler: ^(OAIGetOfferMappingsResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->getOfferMappings: %@", error);
                        }
                    }];
```
...
[apiInstance getOfferRecommendationsWithBusinessId:businessId
          ...
          completionHandler: ^(OAIGetOfferRecommendationsResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->getOfferRecommendations: %@", error);
                        }
                    }];
```
...
[apiInstance getOffersWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIGetOffersResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->getOffers: %@", error);
                        }
                    }];
```
...
[apiInstance getOrderWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIGetOrderResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->getOrder: %@", error);
                        }
                    }];
```
...
[apiInstance getOrderBusinessBuyerInfoWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIGetBusinessBuyerInfoResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->getOrderBusinessBuyerInfo: %@", error);
                        }
                    }];
```
...
[apiInstance getOrderBusinessDocumentsInfoWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIGetBusinessDocumentsInfoResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->getOrderBusinessDocumentsInfo: %@", error);
                        }
                    }];
```
...
[apiInstance getOrdersWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIGetOrdersResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->getOrders: %@", error);
                        }
                    }];
```
...
[apiInstance getOrdersStatsWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIGetOrdersStatsResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->getOrdersStats: %@", error);
                        }
                    }];
```
...
[apiInstance getPricesWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIGetPricesResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->getPrices: %@", error);
                        }
                    }];
```
...
[apiInstance getPricesByOfferIdsWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIGetPricesByOfferIdsResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->getPricesByOfferIds: %@", error);
                        }
                    }];
```
...
[apiInstance getPromoOffersWithBusinessId:businessId
          ...
          completionHandler: ^(OAIGetPromoOffersResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->getPromoOffers: %@", error);
                        }
                    }];
```
...
[apiInstance getPromosWithBusinessId:businessId
          ...
          completionHandler: ^(OAIGetPromosResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->getPromos: %@", error);
                        }
                    }];
```
...
[apiInstance getQualityRatingsWithBusinessId:businessId
          ...
          completionHandler: ^(OAIGetQualityRatingResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->getQualityRatings: %@", error);
                        }
                    }];
```
...
[apiInstance getReportInfoWithReportId:reportId
          completionHandler: ^(OAIGetReportInfoResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->getReportInfo: %@", error);
                        }
                    }];
```
...
[apiInstance getReturnWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIGetReturnResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->getReturn: %@", error);
                        }
                    }];
```
...
[apiInstance getReturnPhotoWithCampaignId:campaignId
          ...
          completionHandler: ^(NSURL* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->getReturnPhoto: %@", error);
                        }
                    }];
```
...
[apiInstance getReturnsWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIGetReturnsResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->getReturns: %@", error);
                        }
                    }];
```
...
[apiInstance getStocksWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIGetWarehouseStocksResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->getStocks: %@", error);
                        }
                    }];
```
...
[apiInstance getSuggestedOfferMappingEntriesWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIGetSuggestedOfferMappingEntriesResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->getSuggestedOfferMappingEntries: %@", error);
                        }
                    }];
```
...
[apiInstance getSuggestedOfferMappingsWithBusinessId:businessId
          ...
          completionHandler: ^(OAIGetSuggestedOfferMappingsResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->getSuggestedOfferMappings: %@", error);
                        }
                    }];
```
...
[apiInstance getSuggestedPricesWithCampaignId:campaignId
          ...
          completionHandler: ^(OAISuggestPricesResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->getSuggestedPrices: %@", error);
                        }
                    }];
```
...
[apiInstance putBidsForBusinessWithBusinessId:businessId
          ...
          completionHandler: ^(OAIEmptyApiResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->putBidsForBusiness: %@", error);
                        }
                    }];
```
...
[apiInstance putBidsForCampaignWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIEmptyApiResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->putBidsForCampaign: %@", error);
                        }
                    }];
```
...
[apiInstance refreshFeedWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIEmptyApiResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->refreshFeed: %@", error);
                        }
                    }];
```
...
[apiInstance searchRegionChildrenWithRegionId:regionId
          ...
          completionHandler: ^(OAIGetRegionWithChildrenResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->searchRegionChildren: %@", error);
                        }
                    }];
```
...
[apiInstance searchRegionsByIdWithRegionId:regionId
          completionHandler: ^(OAIGetRegionsResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->searchRegionsById: %@", error);
                        }
                    }];
```
...
[apiInstance searchRegionsByNameWithName:name
          ...
          completionHandler: ^(OAIGetRegionsResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->searchRegionsByName: %@", error);
                        }
                    }];
```
...
[apiInstance sendFileToChatWithBusinessId:businessId
          ...
          completionHandler: ^(OAIEmptyApiResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->sendFileToChat: %@", error);
                        }
                    }];
```
...
[apiInstance sendMessageToChatWithBusinessId:businessId
          ...
          completionHandler: ^(OAIEmptyApiResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->sendMessageToChat: %@", error);
                        }
                    }];
```
...
[apiInstance setFeedParamsWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIEmptyApiResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->setFeedParams: %@", error);
                        }
                    }];
```
...
[apiInstance skipGoodsFeedbacksReactionWithBusinessId:businessId
          ...
          completionHandler: ^(OAIEmptyApiResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->skipGoodsFeedbacksReaction: %@", error);
                        }
                    }];
```
...
[apiInstance updateBusinessPricesWithBusinessId:businessId
          ...
          completionHandler: ^(OAIEmptyApiResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->updateBusinessPrices: %@", error);
                        }
                    }];
```
...
[apiInstance updateCampaignOffersWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIEmptyApiResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->updateCampaignOffers: %@", error);
                        }
                    }];
```
...
[apiInstance updateGoodsFeedbackCommentWithBusinessId:businessId
          ...
          completionHandler: ^(OAIUpdateGoodsFeedbackCommentResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->updateGoodsFeedbackComment: %@", error);
                        }
                    }];
```
...
[apiInstance updateOfferContentWithBusinessId:businessId
          ...
          completionHandler: ^(OAIUpdateOfferContentResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->updateOfferContent: %@", error);
                        }
                    }];
```
...
[apiInstance updateOfferMappingEntriesWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIEmptyApiResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->updateOfferMappingEntries: %@", error);
                        }
                    }];
```
...
[apiInstance updateOfferMappingsWithBusinessId:businessId
          ...
          completionHandler: ^(OAIUpdateOfferMappingsResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->updateOfferMappings: %@", error);
                        }
                    }];
```
...
[apiInstance updatePricesWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIEmptyApiResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->updatePrices: %@", error);
                        }
                    }];
```
...
[apiInstance updatePromoOffersWithBusinessId:businessId
          ...
          completionHandler: ^(OAIUpdatePromoOffersResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbyApi->updatePromoOffers: %@", error);
                        }
                    }];
```
