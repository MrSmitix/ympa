...
// Готовый ярлык‑наклейка для коробки в заказе
OrderLabelsAPI.generateOrderLabel(campaignId: campaignId, orderId: orderId, shipmentId: shipmentId, boxId: boxId, format: format) { (response, error) in
...
// Готовые ярлыки‑наклейки на все коробки в одном заказе
OrderLabelsAPI.generateOrderLabels(campaignId: campaignId, orderId: orderId, format: format) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Данные для самостоятельного изготовления ярлыков
OrderLabelsAPI.getOrderLabelsData(campaignId: campaignId, orderId: orderId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
