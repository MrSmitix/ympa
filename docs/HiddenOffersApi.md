# ympa_python_pydantic_v1_client.HiddenOffersApi
...
with ympa_python_pydantic_v1_client.ApiClient(configuration) as api_client:
    ...
    api_instance = ympa_python_pydantic_v1_client.HiddenOffersApi(api_client)
    ...
    try:
        ...
        print("The response of HiddenOffersApi->add_hidden_offers:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling HiddenOffersApi->add_hidden_offers: %s\n" % e)
```
...
with ympa_python_pydantic_v1_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of HiddenOffersApi->delete_hidden_offers:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling HiddenOffersApi->delete_hidden_offers: %s\n" % e)
```
...
with ympa_python_pydantic_v1_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of HiddenOffersApi->get_hidden_offers:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling HiddenOffersApi->get_hidden_offers: %s\n" % e)
```
