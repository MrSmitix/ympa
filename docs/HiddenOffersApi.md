...
[**addHiddenOffersWithHttpInfo**](HiddenOffersApi.md#addHiddenOffersWithHttpInfo) | **POST** /campaigns/{campaignId}/hidden-offers | Скрытие товаров и настройки скрытия
...
[**deleteHiddenOffersWithHttpInfo**](HiddenOffersApi.md#deleteHiddenOffersWithHttpInfo) | **POST** /campaigns/{campaignId}/hidden-offers/delete | Возобновление показа товаров
...
[**getHiddenOffersWithHttpInfo**](HiddenOffersApi.md#getHiddenOffersWithHttpInfo) | **GET** /campaigns/{campaignId}/hidden-offers | Информация о скрытых вами товарах
...
object Example extends App {
    ...
    val apiInstance = HiddenOffersApi("https://api.partner.market.yandex.ru")
