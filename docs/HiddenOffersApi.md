# ympa_powershell_client.ympa_powershell_client\Api.HiddenOffersApi

All URIs are relative to *https://api.partner.market.yandex.ru*

Method | HTTP request | Description
------------- | ------------- | -------------
[**Add-HiddenOffers**](HiddenOffersApi.md#Add-HiddenOffers) | **POST** /campaigns/{campaignId}/hidden-offers | Скрытие товаров и настройки скрытия
[**Invoke-DeleteHiddenOffers**](HiddenOffersApi.md#Invoke-DeleteHiddenOffers) | **POST** /campaigns/{campaignId}/hidden-offers/delete | Возобновление показа товаров
[**Get-HiddenOffers**](HiddenOffersApi.md#Get-HiddenOffers) | **GET** /campaigns/{campaignId}/hidden-offers | Информация о скрытых вами товарах
