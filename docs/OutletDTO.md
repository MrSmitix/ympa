...
```python
from ympa_python_pydantic_v1_client.models.outlet_dto import OutletDTO

# TODO update the JSON string below
json = "{}"
# create an instance of OutletDTO from a JSON string
outlet_dto_instance = OutletDTO.from_json(json)
# print the JSON string representation of the object
print OutletDTO.to_json()

# convert the object into a dict
outlet_dto_dict = outlet_dto_instance.to_dict()
# create an instance of OutletDTO from a dict
outlet_dto_from_dict = OutletDTO.from_dict(outlet_dto_dict)
```
