...
------------- | ------------- | -------------
[**deleteOutletLicenses**](OAIOutletLicensesApi.md#deleteoutletlicenses) | **DELETE** /campaigns/{campaignId}/outlets/licenses | Удаление лицензий для точек продаж
[**getOutletLicenses**](OAIOutletLicensesApi.md#getoutletlicenses) | **GET** /campaigns/{campaignId}/outlets/licenses | Информация о лицензиях для точек продаж
[**updateOutletLicenses**](OAIOutletLicensesApi.md#updateoutletlicenses) | **POST** /campaigns/{campaignId}/outlets/licenses | Создание и изменение лицензий для точек продаж
...
OAIOutletLicensesApi*apiInstance = [[OAIOutletLicensesApi alloc] init];
...
[apiInstance deleteOutletLicensesWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIEmptyApiResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIOutletLicensesApi->deleteOutletLicenses: %@", error);
                        }
                    }];
```
...
[apiInstance getOutletLicensesWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIGetOutletLicensesResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIOutletLicensesApi->getOutletLicenses: %@", error);
                        }
                    }];
```
...
[apiInstance updateOutletLicensesWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIEmptyApiResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIOutletLicensesApi->updateOutletLicenses: %@", error);
                        }
                    }];
```
