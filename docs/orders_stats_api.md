...
------------- | ------------- | -------------
**getOrdersStats**](orders_stats_api.md#getOrdersStats) | **POST** /campaigns/{campaignId}/stats/orders | Детальная информация по заказам


# **getOrdersStats**
> models::GetOrdersStatsResponse getOrdersStats(ctx, campaign_id, optional)
