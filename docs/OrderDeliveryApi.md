...
> get_order_buyer_info(_api::OrderDeliveryApi, campaign_id::Int64, order_id::Int64; _mediaType=nothing) -> GetOrderBuyerInfoResponse, OpenAPI.Clients.ApiResponse <br/>
> get_order_buyer_info(_api::OrderDeliveryApi, response_stream::Channel, campaign_id::Int64, order_id::Int64; _mediaType=nothing) -> Channel{ GetOrderBuyerInfoResponse }, OpenAPI.Clients.ApiResponse
...
------------- | ------------- | ------------- | -------------
 **_api** | **OrderDeliveryApi** | API context | 
...
> set_order_delivery_date(_api::OrderDeliveryApi, campaign_id::Int64, order_id::Int64, set_order_delivery_date_request::SetOrderDeliveryDateRequest; _mediaType=nothing) -> EmptyApiResponse, OpenAPI.Clients.ApiResponse <br/>
> set_order_delivery_date(_api::OrderDeliveryApi, response_stream::Channel, campaign_id::Int64, order_id::Int64, set_order_delivery_date_request::SetOrderDeliveryDateRequest; _mediaType=nothing) -> Channel{ EmptyApiResponse }, OpenAPI.Clients.ApiResponse
...
> set_order_delivery_track_code(_api::OrderDeliveryApi, campaign_id::Int64, order_id::Int64, set_order_delivery_track_code_request::SetOrderDeliveryTrackCodeRequest; _mediaType=nothing) -> EmptyApiResponse, OpenAPI.Clients.ApiResponse <br/>
> set_order_delivery_track_code(_api::OrderDeliveryApi, response_stream::Channel, campaign_id::Int64, order_id::Int64, set_order_delivery_track_code_request::SetOrderDeliveryTrackCodeRequest; _mediaType=nothing) -> Channel{ EmptyApiResponse }, OpenAPI.Clients.ApiResponse
...
> update_order_storage_limit(_api::OrderDeliveryApi, campaign_id::Int64, order_id::Int64, update_order_storage_limit_request::UpdateOrderStorageLimitRequest; _mediaType=nothing) -> EmptyApiResponse, OpenAPI.Clients.ApiResponse <br/>
> update_order_storage_limit(_api::OrderDeliveryApi, response_stream::Channel, campaign_id::Int64, order_id::Int64, update_order_storage_limit_request::UpdateOrderStorageLimitRequest; _mediaType=nothing) -> Channel{ EmptyApiResponse }, OpenAPI.Clients.ApiResponse
...
# **verify_order_eac**
> verify_order_eac(_api::OrderDeliveryApi, campaign_id::Int64, order_id::Int64, verify_order_eac_request::VerifyOrderEacRequest; _mediaType=nothing) -> VerifyOrderEacResponse, OpenAPI.Clients.ApiResponse <br/>
> verify_order_eac(_api::OrderDeliveryApi, response_stream::Channel, campaign_id::Int64, order_id::Int64, verify_order_eac_request::VerifyOrderEacRequest; _mediaType=nothing) -> Channel{ VerifyOrderEacResponse }, OpenAPI.Clients.ApiResponse
