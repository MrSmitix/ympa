# ympa_csharp_client.Api.OrderDeliveryApi
...
namespace Example
{
    public class GetOrderBuyerInfoExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new OrderDeliveryApi(config);
...
{
    Debug.Print("Exception when calling OrderDeliveryApi.GetOrderBuyerInfoWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
{
    Debug.Print("Exception when calling OrderDeliveryApi.SetOrderDeliveryDateWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
{
    Debug.Print("Exception when calling OrderDeliveryApi.SetOrderDeliveryTrackCodeWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
{
    Debug.Print("Exception when calling OrderDeliveryApi.UpdateOrderStorageLimitWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
{
    Debug.Print("Exception when calling OrderDeliveryApi.VerifyOrderEacWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
