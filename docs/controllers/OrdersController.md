...
The controller class is defined in **[OrdersController.java](../../src/main/java/org/openapitools/controller/OrdersController.java)**

Method | HTTP request | Description
------------- | ------------- | -------------
[**acceptOrderCancellation**](#acceptOrderCancellation) | **PUT** /campaigns/{campaignId}/orders/{orderId}/cancellation/accept | Отмена заказа покупателем
[**getOrder**](#getOrder) | **GET** /campaigns/{campaignId}/orders/{orderId} | Информация об одном заказе
[**getOrders**](#getOrders) | **GET** /campaigns/{campaignId}/orders | Информация о нескольких заказах
[**provideOrderDigitalCodes**](#provideOrderDigitalCodes) | **POST** /campaigns/{campaignId}/orders/{orderId}/deliverDigitalGoods | Передача ключей цифровых товаров
[**provideOrderItemIdentifiers**](#provideOrderItemIdentifiers) | **PUT** /campaigns/{campaignId}/orders/{orderId}/identifiers | Передача кодов маркировки единиц товара
[**setOrderBoxLayout**](#setOrderBoxLayout) | **PUT** /campaigns/{campaignId}/orders/{orderId}/boxes | Подготовка заказа
[**setOrderShipmentBoxes**](#setOrderShipmentBoxes) | **PUT** /campaigns/{campaignId}/orders/{orderId}/delivery/shipments/{shipmentId}/boxes | Передача количества грузовых мест в заказе
[**updateOrderItems**](#updateOrderItems) | **PUT** /campaigns/{campaignId}/orders/{orderId}/items | Удаление товара из заказа или уменьшение числа единиц
[**updateOrderStatus**](#updateOrderStatus) | **PUT** /campaigns/{campaignId}/orders/{orderId}/status | Изменение статуса одного заказа
[**updateOrderStatuses**](#updateOrderStatuses) | **POST** /campaigns/{campaignId}/orders/status-update | Изменение статусов нескольких заказов

<a id="acceptOrderCancellation"></a>
# **acceptOrderCancellation**
```java
Mono<EmptyApiResponse> OrdersController.acceptOrderCancellation(campaignIdorderIdacceptOrderCancellationRequest)
```
...
**acceptOrderCancellationRequest** | [**AcceptOrderCancellationRequest**](../../docs/models/AcceptOrderCancellationRequest.md) |  |
...
# **getOrder**
```java
Mono<GetOrderResponse> OrdersController.getOrder(campaignIdorderId)
```
...
# **getOrders**
```java
Mono<GetOrdersResponse> OrdersController.getOrders(campaignIdorderIdsstatussubstatusfromDatetoDatesupplierShipmentDateFromsupplierShipmentDateToupdatedAtFromupdatedAtTodispatchTypefakehasCisonlyWaitingForCancellationApproveonlyEstimatedDeliverybuyerTypepagepageSizepageTokenlimit)
```
...
**dispatchType** | [**OrderDeliveryDispatchType**](../../docs/models/.md) | Способ отгрузки | [optional parameter] [enum: `UNKNOWN`, `BUYER`, `MARKET_PARTNER_OUTLET`, `MARKET_BRANDED_OUTLET`, `SHOP_OUTLET`, `DROPOFF`]
...
**buyerType** | [**OrderBuyerType**](../../docs/models/.md) | Фильтрация заказов по типу покупателя.  | [optional parameter] [enum: `PERSON`, `BUSINESS`]
...
```java
Mono<EmptyApiResponse> OrdersController.provideOrderDigitalCodes(campaignIdorderIdprovideOrderDigitalCodesRequest)
```
...
**campaignId** | `Long` | Идентификатор кампании в API и магазина в кабинете. Каждая кампания в API соответствует магазину в кабинете.  Чтобы узнать идентификаторы своих магазинов, воспользуйтесь запросом [GET campaigns](../../reference/campaigns/getCampaigns.md).  ℹ️ [Что такое кабинет и магазин на Маркете](https://yandex.ru/support/marketplace/account/introduction.html)  |
**orderId** | `Long` | Идентификатор заказа. |
**provideOrderDigitalCodesRequest** | [**ProvideOrderDigitalCodesRequest**](../../docs/models/ProvideOrderDigitalCodesRequest.md) |  |
...
```java
Mono<ProvideOrderItemIdentifiersResponse> OrdersController.provideOrderItemIdentifiers(campaignIdorderIdprovideOrderItemIdentifiersRequest)
```
...
**campaignId** | `Long` | Идентификатор кампании в API и магазина в кабинете. Каждая кампания в API соответствует магазину в кабинете.  Чтобы узнать идентификаторы своих магазинов, воспользуйтесь запросом [GET campaigns](../../reference/campaigns/getCampaigns.md).  ℹ️ [Что такое кабинет и магазин на Маркете](https://yandex.ru/support/marketplace/account/introduction.html)  |
**orderId** | `Long` | Идентификатор заказа. |
**provideOrderItemIdentifiersRequest** | [**ProvideOrderItemIdentifiersRequest**](../../docs/models/ProvideOrderItemIdentifiersRequest.md) |  |

### Return type
[**ProvideOrderItemIdentifiersResponse**](../../docs/models/ProvideOrderItemIdentifiersResponse.md)
...
# **setOrderBoxLayout**
```java
Mono<SetOrderBoxLayoutResponse> OrdersController.setOrderBoxLayout(campaignIdorderIdsetOrderBoxLayoutRequest)
```
...
**campaignId** | `Long` | Идентификатор кампании в API и магазина в кабинете. Каждая кампания в API соответствует магазину в кабинете.  Чтобы узнать идентификаторы своих магазинов, воспользуйтесь запросом [GET campaigns](../../reference/campaigns/getCampaigns.md).  ℹ️ [Что такое кабинет и магазин на Маркете](https://yandex.ru/support/marketplace/account/introduction.html)  |
**orderId** | `Long` | Идентификатор заказа. |
**setOrderBoxLayoutRequest** | [**SetOrderBoxLayoutRequest**](../../docs/models/SetOrderBoxLayoutRequest.md) |  |

### Return type
[**SetOrderBoxLayoutResponse**](../../docs/models/SetOrderBoxLayoutResponse.md)
...
```java
Mono<SetOrderShipmentBoxesResponse> OrdersController.setOrderShipmentBoxes(campaignIdorderIdshipmentIdsetOrderShipmentBoxesRequest)
```
...
**setOrderShipmentBoxesRequest** | [**SetOrderShipmentBoxesRequest**](../../docs/models/SetOrderShipmentBoxesRequest.md) |  |

### Return type
[**SetOrderShipmentBoxesResponse**](../../docs/models/SetOrderShipmentBoxesResponse.md)
...
# **updateOrderItems**
```java
Mono<Object> OrdersController.updateOrderItems(campaignIdorderIdupdateOrderItemRequest)
```
...
**campaignId** | `Long` | Идентификатор кампании в API и магазина в кабинете. Каждая кампания в API соответствует магазину в кабинете.  Чтобы узнать идентификаторы своих магазинов, воспользуйтесь запросом [GET campaigns](../../reference/campaigns/getCampaigns.md).  ℹ️ [Что такое кабинет и магазин на Маркете](https://yandex.ru/support/marketplace/account/introduction.html)  |
**orderId** | `Long` | Идентификатор заказа. |
**updateOrderItemRequest** | [**UpdateOrderItemRequest**](../../docs/models/UpdateOrderItemRequest.md) |  |
...
# **updateOrderStatus**
```java
Mono<UpdateOrderStatusResponse> OrdersController.updateOrderStatus(campaignIdorderIdupdateOrderStatusRequest)
```
...
**campaignId** | `Long` | Идентификатор кампании в API и магазина в кабинете. Каждая кампания в API соответствует магазину в кабинете.  Чтобы узнать идентификаторы своих магазинов, воспользуйтесь запросом [GET campaigns](../../reference/campaigns/getCampaigns.md).  ℹ️ [Что такое кабинет и магазин на Маркете](https://yandex.ru/support/marketplace/account/introduction.html)  |
**orderId** | `Long` | Идентификатор заказа. |
**updateOrderStatusRequest** | [**UpdateOrderStatusRequest**](../../docs/models/UpdateOrderStatusRequest.md) |  |

### Return type
[**UpdateOrderStatusResponse**](../../docs/models/UpdateOrderStatusResponse.md)
...
# **updateOrderStatuses**
```java
Mono<UpdateOrderStatusesResponse> OrdersController.updateOrderStatuses(campaignIdupdateOrderStatusesRequest)
```
...
------------- | ------------- | ------------- | -------------
**campaignId** | `Long` | Идентификатор кампании в API и магазина в кабинете. Каждая кампания в API соответствует магазину в кабинете.  Чтобы узнать идентификаторы своих магазинов, воспользуйтесь запросом [GET campaigns](../../reference/campaigns/getCampaigns.md).  ℹ️ [Что такое кабинет и магазин на Маркете](https://yandex.ru/support/marketplace/account/introduction.html)  |
**updateOrderStatusesRequest** | [**UpdateOrderStatusesRequest**](../../docs/models/UpdateOrderStatusesRequest.md) |  |

### Return type
[**UpdateOrderStatusesResponse**](../../docs/models/UpdateOrderStatusesResponse.md)
