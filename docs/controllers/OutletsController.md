...
The controller class is defined in **[OutletsController.java](../../src/main/java/org/openapitools/controller/OutletsController.java)**

Method | HTTP request | Description
------------- | ------------- | -------------
[**createOutlet**](#createOutlet) | **POST** /campaigns/{campaignId}/outlets | Создание точки продаж
[**deleteOutlet**](#deleteOutlet) | **DELETE** /campaigns/{campaignId}/outlets/{outletId} | Удаление точки продаж
[**getOutlet**](#getOutlet) | **GET** /campaigns/{campaignId}/outlets/{outletId} | Информация об одной точке продаж
[**getOutlets**](#getOutlets) | **GET** /campaigns/{campaignId}/outlets | Информация о нескольких точках продаж
[**updateOutlet**](#updateOutlet) | **PUT** /campaigns/{campaignId}/outlets/{outletId} | Изменение информации о точке продаж

<a id="createOutlet"></a>
# **createOutlet**
```java
Mono<CreateOutletResponse> OutletsController.createOutlet(campaignIdchangeOutletRequest)
```
...
**changeOutletRequest** | [**ChangeOutletRequest**](../../docs/models/ChangeOutletRequest.md) |  |

### Return type
[**CreateOutletResponse**](../../docs/models/CreateOutletResponse.md)
...
# **deleteOutlet**
```java
Mono<EmptyApiResponse> OutletsController.deleteOutlet(campaignIdoutletId)
```
...
# **getOutlet**
```java
Mono<GetOutletResponse> OutletsController.getOutlet(campaignIdoutletId)
```
...
### Return type
[**GetOutletResponse**](../../docs/models/GetOutletResponse.md)
...
# **getOutlets**
```java
Mono<GetOutletsResponse> OutletsController.getOutlets(campaignIdpageTokenregionIdshopOutletCoderegionId2)
```
...
### Return type
[**GetOutletsResponse**](../../docs/models/GetOutletsResponse.md)
...
# **updateOutlet**
```java
Mono<EmptyApiResponse> OutletsController.updateOutlet(campaignIdoutletIdchangeOutletRequest)
```
