...
The controller class is defined in **[OffersController.java](../../src/main/java/org/openapitools/controller/OffersController.java)**

Method | HTTP request | Description
------------- | ------------- | -------------
[**deleteCampaignOffers**](#deleteCampaignOffers) | **POST** /campaigns/{campaignId}/offers/delete | Удаление товаров из ассортимента магазина
[**getAllOffers**](#getAllOffers) | **GET** /campaigns/{campaignId}/offers/all | Все предложения магазина
[**getCampaignOffers**](#getCampaignOffers) | **POST** /campaigns/{campaignId}/offers | Информация о товарах, которые размещены в заданном магазине
[**getOfferRecommendations**](#getOfferRecommendations) | **POST** /businesses/{businessId}/offers/recommendations | Рекомендации Маркета, касающиеся цен
[**getOffers**](#getOffers) | **GET** /campaigns/{campaignId}/offers | Предложения магазина
[**updateCampaignOffers**](#updateCampaignOffers) | **POST** /campaigns/{campaignId}/offers/update | Изменение условий продажи товаров в магазине

<a id="deleteCampaignOffers"></a>
# **deleteCampaignOffers**
```java
Mono<DeleteCampaignOffersResponse> OffersController.deleteCampaignOffers(campaignIddeleteCampaignOffersRequest)
```
...
**deleteCampaignOffersRequest** | [**DeleteCampaignOffersRequest**](../../docs/models/DeleteCampaignOffersRequest.md) |  |

### Return type
[**DeleteCampaignOffersResponse**](../../docs/models/DeleteCampaignOffersResponse.md)
...
# **getAllOffers**
```java
Mono<GetAllOffersResponse> OffersController.getAllOffers(campaignIdfeedIdchunk)
```
...
### Return type
[**GetAllOffersResponse**](../../docs/models/GetAllOffersResponse.md)
...
# **getCampaignOffers**
```java
Mono<GetCampaignOffersResponse> OffersController.getCampaignOffers(campaignIdgetCampaignOffersRequestpageTokenlimit)
```
...
------------- | ------------- | ------------- | -------------
**campaignId** | `Long` | Идентификатор кампании в API и магазина в кабинете. Каждая кампания в API соответствует магазину в кабинете.  Чтобы узнать идентификаторы своих магазинов, воспользуйтесь запросом [GET campaigns](../../reference/campaigns/getCampaigns.md).  ℹ️ [Что такое кабинет и магазин на Маркете](https://yandex.ru/support/marketplace/account/introduction.html)  |
**getCampaignOffersRequest** | [**GetCampaignOffersRequest**](../../docs/models/GetCampaignOffersRequest.md) |  |
...
### Return type
[**GetCampaignOffersResponse**](../../docs/models/GetCampaignOffersResponse.md)
...
```java
Mono<GetOfferRecommendationsResponse> OffersController.getOfferRecommendations(businessIdgetOfferRecommendationsRequestpageTokenlimit)
```
...
**getOfferRecommendationsRequest** | [**GetOfferRecommendationsRequest**](../../docs/models/GetOfferRecommendationsRequest.md) |  |
**pageToken** | `String` | Идентификатор страницы c результатами.  Если параметр не указан, возвращается первая страница.  Рекомендуется передавать значение выходного параметра &#x60;nextPageToken&#x60;, полученное при последнем запросе.  Если задан &#x60;page_token&#x60; и в запросе есть параметры &#x60;offset&#x60;, &#x60;page_number&#x60; и &#x60;page_size&#x60;, они игнорируются.  | [optional parameter]
**limit** | `Integer` | Количество значений на одной странице.  | [optional parameter]

### Return type
[**GetOfferRecommendationsResponse**](../../docs/models/GetOfferRecommendationsResponse.md)
...
# **getOffers**
```java
Mono<GetOffersResponse> OffersController.getOffers(campaignIdqueryfeedIdshopCategoryIdcurrencymatchedpagepageSize)
```
...
### Return type
[**GetOffersResponse**](../../docs/models/GetOffersResponse.md)
...
```java
Mono<EmptyApiResponse> OffersController.updateCampaignOffers(campaignIdupdateCampaignOffersRequest)
```
...
------------- | ------------- | ------------- | -------------
**campaignId** | `Long` | Идентификатор кампании в API и магазина в кабинете. Каждая кампания в API соответствует магазину в кабинете.  Чтобы узнать идентификаторы своих магазинов, воспользуйтесь запросом [GET campaigns](../../reference/campaigns/getCampaigns.md).  ℹ️ [Что такое кабинет и магазин на Маркете](https://yandex.ru/support/marketplace/account/introduction.html)  |
**updateCampaignOffersRequest** | [**UpdateCampaignOffersRequest**](../../docs/models/UpdateCampaignOffersRequest.md) |  |
