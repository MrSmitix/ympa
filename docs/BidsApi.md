# ympa_python_pydantic_v1_client.BidsApi
...
with ympa_python_pydantic_v1_client.ApiClient(configuration) as api_client:
    ...
    api_instance = ympa_python_pydantic_v1_client.BidsApi(api_client)
...
with ympa_python_pydantic_v1_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of BidsApi->get_bids_recommendations:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BidsApi->get_bids_recommendations: %s\n" % e)
```
...
with ympa_python_pydantic_v1_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of BidsApi->put_bids_for_business:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BidsApi->put_bids_for_business: %s\n" % e)
```
...
with ympa_python_pydantic_v1_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of BidsApi->put_bids_for_campaign:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BidsApi->put_bids_for_campaign: %s\n" % e)
```
