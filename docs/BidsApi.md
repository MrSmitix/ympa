...
[**getBidsInfoForBusinessWithHttpInfo**](BidsApi.md#getBidsInfoForBusinessWithHttpInfo) | **POST** /businesses/{businessId}/bids/info | Информация об установленных ставках
...
[**getBidsRecommendationsWithHttpInfo**](BidsApi.md#getBidsRecommendationsWithHttpInfo) | **POST** /businesses/{businessId}/bids/recommendations | Рекомендованные ставки для заданных товаров
...
[**putBidsForBusinessWithHttpInfo**](BidsApi.md#putBidsForBusinessWithHttpInfo) | **PUT** /businesses/{businessId}/bids | Включение буста продаж и установка ставок
...
[**putBidsForCampaignWithHttpInfo**](BidsApi.md#putBidsForCampaignWithHttpInfo) | **PUT** /campaigns/{campaignId}/bids | Включение буста продаж и установка ставок для магазина
...
object Example extends App {
    ...
    val apiInstance = BidsApi("https://api.partner.market.yandex.ru")
