# ympa_csharp_client.Api.BidsApi
...
namespace Example
{
    public class GetBidsInfoForBusinessExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new BidsApi(config);
...
{
    Debug.Print("Exception when calling BidsApi.GetBidsInfoForBusinessWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
{
    Debug.Print("Exception when calling BidsApi.GetBidsRecommendationsWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
{
    Debug.Print("Exception when calling BidsApi.PutBidsForBusinessWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
{
    Debug.Print("Exception when calling BidsApi.PutBidsForCampaignWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
