...
------------- | ------------- | -------------
[**acceptOrderCancellation**](OAIOrdersApi.md#acceptordercancellation) | **PUT** /campaigns/{campaignId}/orders/{orderId}/cancellation/accept | Отмена заказа покупателем
[**getOrder**](OAIOrdersApi.md#getorder) | **GET** /campaigns/{campaignId}/orders/{orderId} | Информация об одном заказе
[**getOrders**](OAIOrdersApi.md#getorders) | **GET** /campaigns/{campaignId}/orders | Информация о нескольких заказах
[**provideOrderDigitalCodes**](OAIOrdersApi.md#provideorderdigitalcodes) | **POST** /campaigns/{campaignId}/orders/{orderId}/deliverDigitalGoods | Передача ключей цифровых товаров
[**provideOrderItemIdentifiers**](OAIOrdersApi.md#provideorderitemidentifiers) | **PUT** /campaigns/{campaignId}/orders/{orderId}/identifiers | Передача кодов маркировки единиц товара
[**setOrderBoxLayout**](OAIOrdersApi.md#setorderboxlayout) | **PUT** /campaigns/{campaignId}/orders/{orderId}/boxes | Подготовка заказа
[**setOrderShipmentBoxes**](OAIOrdersApi.md#setordershipmentboxes) | **PUT** /campaigns/{campaignId}/orders/{orderId}/delivery/shipments/{shipmentId}/boxes | Передача количества грузовых мест в заказе
[**updateOrderItems**](OAIOrdersApi.md#updateorderitems) | **PUT** /campaigns/{campaignId}/orders/{orderId}/items | Удаление товара из заказа или уменьшение числа единиц
[**updateOrderStatus**](OAIOrdersApi.md#updateorderstatus) | **PUT** /campaigns/{campaignId}/orders/{orderId}/status | Изменение статуса одного заказа
[**updateOrderStatuses**](OAIOrdersApi.md#updateorderstatuses) | **POST** /campaigns/{campaignId}/orders/status-update | Изменение статусов нескольких заказов
...
OAIOrdersApi*apiInstance = [[OAIOrdersApi alloc] init];
...
[apiInstance acceptOrderCancellationWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIEmptyApiResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIOrdersApi->acceptOrderCancellation: %@", error);
                        }
                    }];
```
...
[apiInstance getOrderWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIGetOrderResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIOrdersApi->getOrder: %@", error);
                        }
                    }];
```
...
[apiInstance getOrdersWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIGetOrdersResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIOrdersApi->getOrders: %@", error);
                        }
                    }];
```
...
[apiInstance provideOrderDigitalCodesWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIEmptyApiResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIOrdersApi->provideOrderDigitalCodes: %@", error);
                        }
                    }];
```
...
[apiInstance provideOrderItemIdentifiersWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIProvideOrderItemIdentifiersResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIOrdersApi->provideOrderItemIdentifiers: %@", error);
                        }
                    }];
```
...
[apiInstance setOrderBoxLayoutWithCampaignId:campaignId
          ...
          completionHandler: ^(OAISetOrderBoxLayoutResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIOrdersApi->setOrderBoxLayout: %@", error);
                        }
                    }];
```
...
[apiInstance setOrderShipmentBoxesWithCampaignId:campaignId
          ...
          completionHandler: ^(OAISetOrderShipmentBoxesResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIOrdersApi->setOrderShipmentBoxes: %@", error);
                        }
                    }];
```
...
[apiInstance updateOrderItemsWithCampaignId:campaignId
          ...
          completionHandler: ^(NSError* error) {
                        if (error) {
                            NSLog(@"Error calling OAIOrdersApi->updateOrderItems: %@", error);
                        }
                    }];
```
...
[apiInstance updateOrderStatusWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIUpdateOrderStatusResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIOrdersApi->updateOrderStatus: %@", error);
                        }
                    }];
```
...
[apiInstance updateOrderStatusesWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIUpdateOrderStatusesResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIOrdersApi->updateOrderStatuses: %@", error);
                        }
                    }];
```
