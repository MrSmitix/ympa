# ORDER_ITEM_INSTANCE_MODIFICATION_DTO
...
**instances** | [**LIST [BRIEF_ORDER_ITEM_INSTANCE_DTO]**](BriefOrderItemInstanceDTO.md) | Список кодов маркировки единиц товара.  | [default to null]
