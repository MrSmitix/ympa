...
// Скрытие товаров и настройки скрытия
ExpressAPI.addHiddenOffers(campaignId: campaignId, addHiddenOffersRequest: addHiddenOffersRequest) { (response, error) in
...
// Добавление товаров в архив
ExpressAPI.addOffersToArchive(businessId: businessId, addOffersToArchiveRequest: addOffersToArchiveRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Калькулятор стоимости услуг
ExpressAPI.calculateTariffs(calculateTariffsRequest: calculateTariffsRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Удаление товара из карантина по цене в кабинете
ExpressAPI.confirmBusinessPrices(businessId: businessId, confirmPricesRequest: confirmPricesRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Удаление товара из карантина по цене в магазине
ExpressAPI.confirmCampaignPrices(campaignId: campaignId, confirmPricesRequest: confirmPricesRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Создание нового чата с покупателем
ExpressAPI.createChat(businessId: businessId, createChatRequest: createChatRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Удаление товаров из ассортимента магазина
ExpressAPI.deleteCampaignOffers(campaignId: campaignId, deleteCampaignOffersRequest: deleteCampaignOffersRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Удаление комментария к отзыву
ExpressAPI.deleteGoodsFeedbackComment(businessId: businessId, deleteGoodsFeedbackCommentRequest: deleteGoodsFeedbackCommentRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Возобновление показа товаров
ExpressAPI.deleteHiddenOffers(campaignId: campaignId, deleteHiddenOffersRequest: deleteHiddenOffersRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Удаление товаров из каталога
ExpressAPI.deleteOffers(businessId: businessId, deleteOffersRequest: deleteOffersRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Удаление товаров из архива
ExpressAPI.deleteOffersFromArchive(businessId: businessId, deleteOffersFromArchiveRequest: deleteOffersFromArchiveRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Удаление товаров из акции
ExpressAPI.deletePromoOffers(businessId: businessId, deletePromoOffersRequest: deletePromoOffersRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Отчет по бусту продаж
ExpressAPI.generateBoostConsolidatedReport(generateBoostConsolidatedRequest: generateBoostConsolidatedRequest, format: format) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Отчет «Конкурентная позиция»
ExpressAPI.generateCompetitorsPositionReport(generateCompetitorsPositionReportRequest: generateCompetitorsPositionReportRequest, format: format) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Отчет по отзывам о товарах
ExpressAPI.generateGoodsFeedbackReport(generateGoodsFeedbackRequest: generateGoodsFeedbackRequest, format: format) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Отчет по реализации
ExpressAPI.generateGoodsRealizationReport(generateGoodsRealizationReportRequest: generateGoodsRealizationReportRequest, format: format) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Готовые ярлыки‑наклейки на все коробки в нескольких заказах
ExpressAPI.generateMassOrderLabelsReport(generateMassOrderLabelsRequest: generateMassOrderLabelsRequest, format: format) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Готовый ярлык‑наклейка для коробки в заказе
ExpressAPI.generateOrderLabel(campaignId: campaignId, orderId: orderId, shipmentId: shipmentId, boxId: boxId, format: format) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Готовые ярлыки‑наклейки на все коробки в одном заказе
ExpressAPI.generateOrderLabels(campaignId: campaignId, orderId: orderId, format: format) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Отчет «Цены на рынке»
ExpressAPI.generatePricesReport(generatePricesReportRequest: generatePricesReportRequest, format: format) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Отчет по полкам
ExpressAPI.generateShelfsStatisticsReport(generateShelfsStatisticsRequest: generateShelfsStatisticsRequest, format: format) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Отчет «Аналитика продаж»
ExpressAPI.generateShowsSalesReport(generateShowsSalesReportRequest: generateShowsSalesReportRequest, format: format) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Отчет по остаткам на складах
ExpressAPI.generateStocksOnWarehousesReport(generateStocksOnWarehousesReportRequest: generateStocksOnWarehousesReportRequest, format: format) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Отчет по стоимости услуг
ExpressAPI.generateUnitedMarketplaceServicesReport(generateUnitedMarketplaceServicesReportRequest: generateUnitedMarketplaceServicesReportRequest, format: format) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Отчет по платежам
ExpressAPI.generateUnitedNettingReport(generateUnitedNettingReportRequest: generateUnitedNettingReportRequest, format: format) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Отчет по заказам
ExpressAPI.generateUnitedOrdersReport(generateUnitedOrdersRequest: generateUnitedOrdersRequest, format: format) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Все предложения магазина
ExpressAPI.getAllOffers(campaignId: campaignId, feedId: feedId, chunk: chunk) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Информация об установленных ставках
ExpressAPI.getBidsInfoForBusiness(businessId: businessId, pageToken: pageToken, limit: limit, getBidsInfoRequest: getBidsInfoRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Рекомендованные ставки для заданных товаров
ExpressAPI.getBidsRecommendations(businessId: businessId, getBidsRecommendationsRequest: getBidsRecommendationsRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Список товаров, находящихся в карантине по цене в кабинете
ExpressAPI.getBusinessQuarantineOffers(businessId: businessId, getQuarantineOffersRequest: getQuarantineOffersRequest, pageToken: pageToken, limit: limit) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Настройки кабинета
ExpressAPI.getBusinessSettings(businessId: businessId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Информация о магазине
ExpressAPI.getCampaign(campaignId: campaignId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Логины, связанные с магазином
ExpressAPI.getCampaignLogins(campaignId: campaignId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Информация о товарах, которые размещены в заданном магазине
ExpressAPI.getCampaignOffers(campaignId: campaignId, getCampaignOffersRequest: getCampaignOffersRequest, pageToken: pageToken, limit: limit) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Список товаров, находящихся в карантине по цене в магазине
ExpressAPI.getCampaignQuarantineOffers(campaignId: campaignId, getQuarantineOffersRequest: getQuarantineOffersRequest, pageToken: pageToken, limit: limit) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Регион магазина
ExpressAPI.getCampaignRegion(campaignId: campaignId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Настройки магазина
ExpressAPI.getCampaignSettings(campaignId: campaignId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Список магазинов пользователя
ExpressAPI.getCampaigns(page: page, pageSize: pageSize) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Магазины, доступные логину
ExpressAPI.getCampaignsByLogin(login: login, page: page, pageSize: pageSize) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Лимит на установку кванта продажи и минимального количества товаров в заказе
ExpressAPI.getCategoriesMaxSaleQuantum(getCategoriesMaxSaleQuantumRequest: getCategoriesMaxSaleQuantumRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Дерево категорий
ExpressAPI.getCategoriesTree(getCategoriesRequest: getCategoriesRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Списки характеристик товаров по категориям
ExpressAPI.getCategoryContentParameters(categoryId: categoryId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Получение истории сообщений в чате
ExpressAPI.getChatHistory(businessId: businessId, chatId: chatId, getChatHistoryRequest: getChatHistoryRequest, pageToken: pageToken, limit: limit) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Получение доступных чатов
ExpressAPI.getChats(businessId: businessId, getChatsRequest: getChatsRequest, pageToken: pageToken, limit: limit) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Справочник служб доставки
ExpressAPI.getDeliveryServices() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Информация о прайс-листе
ExpressAPI.getFeed(campaignId: campaignId, feedId: feedId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Отчет по индексации прайс-листа
ExpressAPI.getFeedIndexLogs(campaignId: campaignId, feedId: feedId, limit: limit, publishedTimeFrom: publishedTimeFrom, publishedTimeTo: publishedTimeTo, status: status) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Новые и обновленные отзывы о магазине
ExpressAPI.getFeedbackAndCommentUpdates(campaignId: campaignId, pageToken: pageToken, limit: limit, fromDate: fromDate) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Список прайс-листов магазина
ExpressAPI.getFeeds(campaignId: campaignId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Получение комментариев к отзыву
ExpressAPI.getGoodsFeedbackComments(businessId: businessId, getGoodsFeedbackCommentsRequest: getGoodsFeedbackCommentsRequest, pageToken: pageToken, limit: limit) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Получение отзывов о товарах продавца
ExpressAPI.getGoodsFeedbacks(businessId: businessId, pageToken: pageToken, limit: limit, getGoodsFeedbackRequest: getGoodsFeedbackRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Отчет по товарам
ExpressAPI.getGoodsStats(campaignId: campaignId, getGoodsStatsRequest: getGoodsStatsRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Информация о скрытых вами товарах
ExpressAPI.getHiddenOffers(campaignId: campaignId, offerId: offerId, pageToken: pageToken, limit: limit, offset: offset, page: page, pageSize: pageSize) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Получение информации о заполненности карточек магазина
ExpressAPI.getOfferCardsContentStatus(businessId: businessId, pageToken: pageToken, limit: limit, getOfferCardsContentStatusRequest: getOfferCardsContentStatusRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Список товаров в каталоге
ExpressAPI.getOfferMappingEntries(campaignId: campaignId, offerId: offerId, shopSku: shopSku, mappingKind: mappingKind, status: status, availability: availability, categoryId: categoryId, vendor: vendor, pageToken: pageToken, limit: limit) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Информация о товарах в каталоге
ExpressAPI.getOfferMappings(businessId: businessId, pageToken: pageToken, limit: limit, getOfferMappingsRequest: getOfferMappingsRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Рекомендации Маркета, касающиеся цен
ExpressAPI.getOfferRecommendations(businessId: businessId, getOfferRecommendationsRequest: getOfferRecommendationsRequest, pageToken: pageToken, limit: limit) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Предложения магазина
ExpressAPI.getOffers(campaignId: campaignId, query: query, feedId: feedId, shopCategoryId: shopCategoryId, currency: currency, matched: matched, page: page, pageSize: pageSize) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Информация об одном заказе
ExpressAPI.getOrder(campaignId: campaignId, orderId: orderId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Информация о покупателе — юридическом лице
ExpressAPI.getOrderBusinessBuyerInfo(campaignId: campaignId, orderId: orderId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Информация о документах
ExpressAPI.getOrderBusinessDocumentsInfo(campaignId: campaignId, orderId: orderId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Данные для самостоятельного изготовления ярлыков
ExpressAPI.getOrderLabelsData(campaignId: campaignId, orderId: orderId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Детальная информация по заказам
ExpressAPI.getOrdersStats(campaignId: campaignId, pageToken: pageToken, limit: limit, getOrdersStatsRequest: getOrdersStatsRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Список цен
ExpressAPI.getPrices(campaignId: campaignId, pageToken: pageToken, limit: limit, archived: archived) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Просмотр цен на указанные товары в магазине
ExpressAPI.getPricesByOfferIds(campaignId: campaignId, pageToken: pageToken, limit: limit, getPricesByOfferIdsRequest: getPricesByOfferIdsRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Получение списка товаров, которые участвуют или могут участвовать в акции
ExpressAPI.getPromoOffers(businessId: businessId, getPromoOffersRequest: getPromoOffersRequest, pageToken: pageToken, limit: limit) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Получение списка акций
ExpressAPI.getPromos(businessId: businessId, getPromosRequest: getPromosRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Заказы, которые повлияли на индекс качества
ExpressAPI.getQualityRatingDetails(campaignId: campaignId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Индекс качества магазинов
ExpressAPI.getQualityRatings(businessId: businessId, getQualityRatingRequest: getQualityRatingRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Получение заданного отчета
ExpressAPI.getReportInfo(reportId: reportId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Информация о невыкупе или возврате
ExpressAPI.getReturn(campaignId: campaignId, orderId: orderId, returnId: returnId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Получение заявления на возврат
ExpressAPI.getReturnApplication(campaignId: campaignId, orderId: orderId, returnId: returnId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Получение фотографии возврата
ExpressAPI.getReturnPhoto(campaignId: campaignId, orderId: orderId, returnId: returnId, itemId: itemId, imageHash: imageHash) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Список невыкупов и возвратов
ExpressAPI.getReturns(campaignId: campaignId, pageToken: pageToken, limit: limit, orderIds: orderIds, statuses: statuses, type: type, fromDate: fromDate, toDate: toDate, fromDate2: fromDate2, toDate2: toDate2) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Информация об остатках и оборачиваемости
ExpressAPI.getStocks(campaignId: campaignId, pageToken: pageToken, limit: limit, getWarehouseStocksRequest: getWarehouseStocksRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Рекомендованные карточки для товаров
ExpressAPI.getSuggestedOfferMappingEntries(campaignId: campaignId, getSuggestedOfferMappingEntriesRequest: getSuggestedOfferMappingEntriesRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Просмотр карточек на Маркете, которые подходят вашим товарам
ExpressAPI.getSuggestedOfferMappings(businessId: businessId, getSuggestedOfferMappingsRequest: getSuggestedOfferMappingsRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Цены для продвижения товаров
ExpressAPI.getSuggestedPrices(campaignId: campaignId, suggestPricesRequest: suggestPricesRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Список складов и групп складов
ExpressAPI.getWarehouses(businessId: businessId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Передача кодов маркировки единиц товара
ExpressAPI.provideOrderItemIdentifiers(campaignId: campaignId, orderId: orderId, provideOrderItemIdentifiersRequest: provideOrderItemIdentifiersRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Включение буста продаж и установка ставок
ExpressAPI.putBidsForBusiness(businessId: businessId, putSkuBidsRequest: putSkuBidsRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Включение буста продаж и установка ставок для магазина
ExpressAPI.putBidsForCampaign(campaignId: campaignId, putSkuBidsRequest: putSkuBidsRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Сообщить, что прайс-лист обновился
ExpressAPI.refreshFeed(campaignId: campaignId, feedId: feedId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Информация о дочерних регионах
ExpressAPI.searchRegionChildren(regionId: regionId, page: page, pageSize: pageSize) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Информация о регионе
ExpressAPI.searchRegionsById(regionId: regionId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Поиск регионов по их имени
ExpressAPI.searchRegionsByName(name: name, pageToken: pageToken, limit: limit) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Отправка файла в чат
ExpressAPI.sendFileToChat(businessId: businessId, chatId: chatId, file: file) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Отправка сообщения в чат
ExpressAPI.sendMessageToChat(businessId: businessId, chatId: chatId, sendMessageToChatRequest: sendMessageToChatRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Изменение параметров прайс-листа
ExpressAPI.setFeedParams(campaignId: campaignId, feedId: feedId, setFeedParamsRequest: setFeedParamsRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Подготовка заказа
ExpressAPI.setOrderBoxLayout(campaignId: campaignId, orderId: orderId, setOrderBoxLayoutRequest: setOrderBoxLayoutRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Передача количества грузовых мест в заказе
ExpressAPI.setOrderShipmentBoxes(campaignId: campaignId, orderId: orderId, shipmentId: shipmentId, setOrderShipmentBoxesRequest: setOrderShipmentBoxesRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Отказ от ответа на отзывы
ExpressAPI.skipGoodsFeedbacksReaction(businessId: businessId, skipGoodsFeedbackReactionRequest: skipGoodsFeedbackReactionRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Установка цен на товары во всех магазинах
ExpressAPI.updateBusinessPrices(businessId: businessId, updateBusinessPricesRequest: updateBusinessPricesRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Изменение условий продажи товаров в магазине
ExpressAPI.updateCampaignOffers(campaignId: campaignId, updateCampaignOffersRequest: updateCampaignOffersRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Добавление нового или изменение созданного комментария
ExpressAPI.updateGoodsFeedbackComment(businessId: businessId, updateGoodsFeedbackCommentRequest: updateGoodsFeedbackCommentRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Редактирование категорийных характеристик товара
ExpressAPI.updateOfferContent(businessId: businessId, updateOfferContentRequest: updateOfferContentRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Добавление и редактирование товаров в каталоге
ExpressAPI.updateOfferMappingEntries(campaignId: campaignId, updateOfferMappingEntryRequest: updateOfferMappingEntryRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Добавление товаров в каталог и изменение информации о них
ExpressAPI.updateOfferMappings(businessId: businessId, updateOfferMappingsRequest: updateOfferMappingsRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Удаление товара из заказа или уменьшение числа единиц
ExpressAPI.updateOrderItems(campaignId: campaignId, orderId: orderId, updateOrderItemRequest: updateOrderItemRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Изменение статуса одного заказа
ExpressAPI.updateOrderStatus(campaignId: campaignId, orderId: orderId, updateOrderStatusRequest: updateOrderStatusRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Изменение статусов нескольких заказов
ExpressAPI.updateOrderStatuses(campaignId: campaignId, updateOrderStatusesRequest: updateOrderStatusesRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Установка цен на товары в конкретном магазине
ExpressAPI.updatePrices(campaignId: campaignId, updatePricesRequest: updatePricesRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Добавление товаров в акцию или изменение их цен
ExpressAPI.updatePromoOffers(businessId: businessId, updatePromoOffersRequest: updatePromoOffersRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Передача информации об остатках
ExpressAPI.updateStocks(campaignId: campaignId, updateStocksRequest: updateStocksRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **verifyOrderEac**
```swift
    open class func verifyOrderEac(campaignId: Int64, orderId: Int64, verifyOrderEacRequest: VerifyOrderEacRequest, completion: @escaping (_ data: VerifyOrderEacResponse?, _ error: Error?) -> Void)
```
...
let campaignId = 987 // Int64 | Идентификатор кампании в API и магазина в кабинете. Каждая кампания в API соответствует магазину в кабинете.  Чтобы узнать идентификаторы своих магазинов, воспользуйтесь запросом [GET campaigns](../../reference/campaigns/getCampaigns.md).  ℹ️ [Что такое кабинет и магазин на Маркете](https://yandex.ru/support/marketplace/account/introduction.html) 
let orderId = 987 // Int64 | Идентификатор заказа.
let verifyOrderEacRequest = VerifyOrderEacRequest(code: "code_example") // VerifyOrderEacRequest | 

// Передача кода подтверждения
ExpressAPI.verifyOrderEac(campaignId: campaignId, orderId: orderId, verifyOrderEacRequest: verifyOrderEacRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
