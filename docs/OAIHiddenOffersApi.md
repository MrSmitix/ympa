...
------------- | ------------- | -------------
[**addHiddenOffers**](OAIHiddenOffersApi.md#addhiddenoffers) | **POST** /campaigns/{campaignId}/hidden-offers | Скрытие товаров и настройки скрытия
[**deleteHiddenOffers**](OAIHiddenOffersApi.md#deletehiddenoffers) | **POST** /campaigns/{campaignId}/hidden-offers/delete | Возобновление показа товаров
[**getHiddenOffers**](OAIHiddenOffersApi.md#gethiddenoffers) | **GET** /campaigns/{campaignId}/hidden-offers | Информация о скрытых вами товарах
...
OAIHiddenOffersApi*apiInstance = [[OAIHiddenOffersApi alloc] init];
...
[apiInstance addHiddenOffersWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIEmptyApiResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIHiddenOffersApi->addHiddenOffers: %@", error);
                        }
                    }];
```
...
[apiInstance deleteHiddenOffersWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIEmptyApiResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIHiddenOffersApi->deleteHiddenOffers: %@", error);
                        }
                    }];
```
...
[apiInstance getHiddenOffersWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIGetHiddenOffersResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIHiddenOffersApi->getHiddenOffers: %@", error);
                        }
                    }];
```
