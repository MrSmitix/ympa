...
[**getQualityRatingDetailsWithHttpInfo**](RatingsApi.md#getQualityRatingDetailsWithHttpInfo) | **POST** /campaigns/{campaignId}/ratings/quality/details | Заказы, которые повлияли на индекс качества
[**getQualityRatings**](RatingsApi.md#getQualityRatings) | **POST** /businesses/{businessId}/ratings/quality | Индекс качества магазинов
[**getQualityRatingsWithHttpInfo**](RatingsApi.md#getQualityRatingsWithHttpInfo) | **POST** /businesses/{businessId}/ratings/quality | Индекс качества магазинов
...
object Example extends App {
    ...
    val apiInstance = RatingsApi("https://api.partner.market.yandex.ru")
