...
# Table `UpdateMappingsOfferDTO`
(mapped from: UpdateMappingsOfferDTO)
...
# **Table `UpdateMappingsOfferDTOBarcodes`**
(mapped from: UpdateMappingsOfferDTOBarcodes)

## Properties
Name | Mapping | SQL Type | Default | Type | Description | Notes
---- | ------- | -------- | ------- | ---- | ----------- | -----
updateMappingsOfferDTO | updateMappingsOfferDTO | long | | kotlin.Long | Primary Key | *one*
barcodes | barcodes | text | | kotlin.String | Foreign Key | *many*



# **Table `UpdateMappingsOfferDTOUrls`**
(mapped from: UpdateMappingsOfferDTOUrls)
...
# **Table `UpdateMappingsOfferDTOPictures`**
(mapped from: UpdateMappingsOfferDTOPictures)
...
# **Table `UpdateMappingsOfferDTOManufacturerCountries`**
(mapped from: UpdateMappingsOfferDTOManufacturerCountries)
...
# **Table `UpdateMappingsOfferDTOCustomsCommodityCodes`**
(mapped from: UpdateMappingsOfferDTOCustomsCommodityCodes)
...
# **Table `UpdateMappingsOfferDTODayOfWeekType`**
(mapped from: UpdateMappingsOfferDTODayOfWeekType)
