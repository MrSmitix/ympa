...
------------- | ------------- | -------------
[**getBidsInfoForBusiness**](OAIBidsApi.md#getbidsinfoforbusiness) | **POST** /businesses/{businessId}/bids/info | Информация об установленных ставках
[**getBidsRecommendations**](OAIBidsApi.md#getbidsrecommendations) | **POST** /businesses/{businessId}/bids/recommendations | Рекомендованные ставки для заданных товаров
[**putBidsForBusiness**](OAIBidsApi.md#putbidsforbusiness) | **PUT** /businesses/{businessId}/bids | Включение буста продаж и установка ставок
[**putBidsForCampaign**](OAIBidsApi.md#putbidsforcampaign) | **PUT** /campaigns/{campaignId}/bids | Включение буста продаж и установка ставок для магазина
...
[apiInstance getBidsInfoForBusinessWithBusinessId:businessId
          ...
          completionHandler: ^(OAIGetBidsInfoResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIBidsApi->getBidsInfoForBusiness: %@", error);
                        }
                    }];
```
...
[apiInstance getBidsRecommendationsWithBusinessId:businessId
          ...
          completionHandler: ^(OAIGetBidsRecommendationsResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIBidsApi->getBidsRecommendations: %@", error);
                        }
                    }];
```
...
[apiInstance putBidsForBusinessWithBusinessId:businessId
          ...
          completionHandler: ^(OAIEmptyApiResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIBidsApi->putBidsForBusiness: %@", error);
                        }
                    }];
```
...
[apiInstance putBidsForCampaignWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIEmptyApiResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIBidsApi->putBidsForCampaign: %@", error);
                        }
                    }];
```
