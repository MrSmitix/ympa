...
> models::GetCategoryContentParametersResponse getCategoryContentParameters(ctx, category_id)
 ...
 **ctx** | **context.Context** | context containing the authentication | nil if no authentication
  **category_id** | **i64**| Идентификатор категории на Маркете.  Чтобы узнать идентификатор категории, к которой относится интересующий вас товар, воспользуйтесь запросом [POST categories/tree](../../reference/categories/getCategoriesTree.md).  | 
...
> models::GetOfferCardsContentStatusResponse getOfferCardsContentStatus(ctx, business_id, optional)
...
# **updateOfferContent**
> models::UpdateOfferContentResponse updateOfferContent(ctx, business_id, update_offer_content_request)
