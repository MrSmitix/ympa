...
[**getBusinessSettingsWithHttpInfo**](BusinessesApi.md#getBusinessSettingsWithHttpInfo) | **POST** /businesses/{businessId}/settings | Настройки кабинета
...
object Example extends App {
    ...
    val apiInstance = BusinessesApi("https://api.partner.market.yandex.ru")
