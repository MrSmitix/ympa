# ympa_python_pydantic_v1_client.BusinessesApi
...
with ympa_python_pydantic_v1_client.ApiClient(configuration) as api_client:
    ...
    api_instance = ympa_python_pydantic_v1_client.BusinessesApi(api_client)
    ...
    try:
        ...
        print("The response of BusinessesApi->get_business_settings:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BusinessesApi->get_business_settings: %s\n" % e)
```
