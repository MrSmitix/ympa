...
> generate_goods_movement_report(req::HTTP.Request, generate_goods_movement_report_request::GenerateGoodsMovementReportRequest; format=nothing,) -> GenerateReportResponse
...
> generate_goods_turnover_report(req::HTTP.Request, generate_goods_turnover_request::GenerateGoodsTurnoverRequest; format=nothing,) -> GenerateReportResponse
...
> get_fulfillment_warehouses(req::HTTP.Request;) -> GetFulfillmentWarehousesResponse
