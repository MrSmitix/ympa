# WWW::OpenAPIClient::FbyApi

## Load the API package
```perl
use WWW::OpenAPIClient::Object::FbyApi;
```
...
if ($@) {
    warn "Exception when calling FbyApi->add_hidden_offers: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->add_offers_to_archive: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->calculate_tariffs: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->confirm_business_prices: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->confirm_campaign_prices: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->create_chat: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->delete_campaign_offers: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->delete_goods_feedback_comment: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->delete_hidden_offers: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->delete_offers: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->delete_offers_from_archive: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->delete_promo_offers: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->generate_boost_consolidated_report: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->generate_competitors_position_report: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->generate_goods_feedback_report: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->generate_goods_movement_report: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->generate_goods_realization_report: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->generate_goods_turnover_report: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->generate_prices_report: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->generate_shelfs_statistics_report: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->generate_shows_sales_report: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->generate_stocks_on_warehouses_report: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->generate_united_marketplace_services_report: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->generate_united_netting_report: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->generate_united_orders_report: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->get_all_offers: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->get_bids_info_for_business: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->get_bids_recommendations: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->get_business_quarantine_offers: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->get_business_settings: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->get_campaign: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->get_campaign_logins: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->get_campaign_offers: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->get_campaign_quarantine_offers: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->get_campaign_region: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->get_campaign_settings: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->get_campaigns: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->get_campaigns_by_login: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->get_categories_max_sale_quantum: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->get_categories_tree: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->get_category_content_parameters: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->get_chat_history: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->get_chats: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->get_feed: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->get_feed_index_logs: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->get_feedback_and_comment_updates: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->get_feeds: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->get_fulfillment_warehouses: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->get_goods_feedback_comments: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->get_goods_feedbacks: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->get_goods_stats: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->get_hidden_offers: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->get_offer_cards_content_status: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->get_offer_mapping_entries: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->get_offer_mappings: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->get_offer_recommendations: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->get_offers: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->get_order: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->get_order_business_buyer_info: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->get_order_business_documents_info: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->get_orders: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->get_orders_stats: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->get_prices: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->get_prices_by_offer_ids: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->get_promo_offers: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->get_promos: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->get_quality_ratings: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->get_report_info: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->get_return: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->get_return_photo: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->get_returns: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->get_stocks: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->get_suggested_offer_mapping_entries: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->get_suggested_offer_mappings: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->get_suggested_prices: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->put_bids_for_business: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->put_bids_for_campaign: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->refresh_feed: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->search_region_children: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->search_regions_by_id: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->search_regions_by_name: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->send_file_to_chat: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->send_message_to_chat: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->set_feed_params: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->skip_goods_feedbacks_reaction: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->update_business_prices: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->update_campaign_offers: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->update_goods_feedback_comment: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->update_offer_content: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->update_offer_mapping_entries: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->update_offer_mappings: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->update_prices: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling FbyApi->update_promo_offers: $@\n";
}
```
