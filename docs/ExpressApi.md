...
> generate_goods_realization_report(req::HTTP.Request, generate_goods_realization_report_request::GenerateGoodsRealizationReportRequest; format=nothing,) -> GenerateReportResponse
...
# **verify_order_eac**
> verify_order_eac(req::HTTP.Request, campaign_id::Int64, order_id::Int64, verify_order_eac_request::VerifyOrderEacRequest;) -> VerifyOrderEacResponse
