# WWW::OpenAPIClient::ExpressApi

## Load the API package
```perl
use WWW::OpenAPIClient::Object::ExpressApi;
```
...
if ($@) {
    warn "Exception when calling ExpressApi->add_hidden_offers: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->add_offers_to_archive: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->calculate_tariffs: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->confirm_business_prices: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->confirm_campaign_prices: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->create_chat: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->delete_campaign_offers: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->delete_goods_feedback_comment: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->delete_hidden_offers: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->delete_offers: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->delete_offers_from_archive: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->delete_promo_offers: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->generate_boost_consolidated_report: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->generate_competitors_position_report: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->generate_goods_feedback_report: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->generate_goods_realization_report: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->generate_mass_order_labels_report: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->generate_order_label: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->generate_order_labels: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->generate_prices_report: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->generate_shelfs_statistics_report: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->generate_shows_sales_report: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->generate_stocks_on_warehouses_report: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->generate_united_marketplace_services_report: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->generate_united_netting_report: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->generate_united_orders_report: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->get_all_offers: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->get_bids_info_for_business: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->get_bids_recommendations: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->get_business_quarantine_offers: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->get_business_settings: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->get_campaign: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->get_campaign_logins: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->get_campaign_offers: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->get_campaign_quarantine_offers: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->get_campaign_region: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->get_campaign_settings: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->get_campaigns: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->get_campaigns_by_login: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->get_categories_max_sale_quantum: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->get_categories_tree: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->get_category_content_parameters: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->get_chat_history: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->get_chats: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->get_delivery_services: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->get_feed: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->get_feed_index_logs: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->get_feedback_and_comment_updates: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->get_feeds: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->get_goods_feedback_comments: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->get_goods_feedbacks: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->get_goods_stats: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->get_hidden_offers: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->get_offer_cards_content_status: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->get_offer_mapping_entries: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->get_offer_mappings: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->get_offer_recommendations: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->get_offers: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->get_order: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->get_order_business_buyer_info: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->get_order_business_documents_info: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->get_order_labels_data: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->get_orders: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->get_orders_stats: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->get_prices: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->get_prices_by_offer_ids: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->get_promo_offers: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->get_promos: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->get_quality_rating_details: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->get_quality_ratings: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->get_report_info: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->get_return: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->get_return_application: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->get_return_photo: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->get_returns: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->get_stocks: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->get_suggested_offer_mapping_entries: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->get_suggested_offer_mappings: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->get_suggested_prices: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->get_warehouses: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->provide_order_item_identifiers: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->put_bids_for_business: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->put_bids_for_campaign: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->refresh_feed: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->search_region_children: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->search_regions_by_id: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->search_regions_by_name: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->send_file_to_chat: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->send_message_to_chat: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->set_feed_params: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->set_order_box_layout: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->set_order_shipment_boxes: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->skip_goods_feedbacks_reaction: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->update_business_prices: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->update_campaign_offers: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->update_goods_feedback_comment: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->update_offer_content: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->update_offer_mapping_entries: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->update_offer_mappings: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->update_order_items: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->update_order_status: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->update_order_statuses: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->update_prices: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->update_promo_offers: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->update_stocks: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ExpressApi->verify_order_eac: $@\n";
}
```
