...
# Table `OfferPriceByOfferIdsResponseDTO`
(mapped from: OfferPriceByOfferIdsResponseDTO)
...
**updatedAt** | updatedAt | datetime |  | [**java.time.LocalDateTime**](java.time.LocalDateTime.md) | Дата и время последнего обновления цены. |  [optional]
