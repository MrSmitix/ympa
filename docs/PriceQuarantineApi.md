...
[**confirmBusinessPricesWithHttpInfo**](PriceQuarantineApi.md#confirmBusinessPricesWithHttpInfo) | **POST** /businesses/{businessId}/price-quarantine/confirm | Удаление товара из карантина по цене в кабинете
...
[**confirmCampaignPricesWithHttpInfo**](PriceQuarantineApi.md#confirmCampaignPricesWithHttpInfo) | **POST** /campaigns/{campaignId}/price-quarantine/confirm | Удаление товара из карантина по цене в магазине
...
[**getBusinessQuarantineOffersWithHttpInfo**](PriceQuarantineApi.md#getBusinessQuarantineOffersWithHttpInfo) | **POST** /businesses/{businessId}/price-quarantine | Список товаров, находящихся в карантине по цене в кабинете
...
[**getCampaignQuarantineOffersWithHttpInfo**](PriceQuarantineApi.md#getCampaignQuarantineOffersWithHttpInfo) | **POST** /campaigns/{campaignId}/price-quarantine | Список товаров, находящихся в карантине по цене в магазине
