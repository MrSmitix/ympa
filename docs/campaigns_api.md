...
# **getCampaigns**
> models::GetCampaignsResponse getCampaigns(ctx, optional)
...
# **getCampaign**
> models::GetCampaignResponse getCampaign(ctx, campaign_id)
...
# **getCampaignLogins**
> models::GetCampaignLoginsResponse getCampaignLogins(ctx, campaign_id)
...
# **getCampaignRegion**
> models::GetCampaignRegionResponse getCampaignRegion(ctx, campaign_id)
Регион магазина
...
# **getCampaignSettings**
> models::GetCampaignSettingsResponse getCampaignSettings(ctx, campaign_id)
Настройки магазина
...
# **getCampaignsByLogin**
> models::GetCampaignsResponse getCampaignsByLogin(ctx, login, optional)
