...
[**deleteOutletLicensesWithHttpInfo**](OutletLicensesApi.md#deleteOutletLicensesWithHttpInfo) | **DELETE** /campaigns/{campaignId}/outlets/licenses | Удаление лицензий для точек продаж
...
[**getOutletLicensesWithHttpInfo**](OutletLicensesApi.md#getOutletLicensesWithHttpInfo) | **GET** /campaigns/{campaignId}/outlets/licenses | Информация о лицензиях для точек продаж
...
[**updateOutletLicensesWithHttpInfo**](OutletLicensesApi.md#updateOutletLicensesWithHttpInfo) | **POST** /campaigns/{campaignId}/outlets/licenses | Создание и изменение лицензий для точек продаж
...
object Example extends App {
    ...
    val apiInstance = OutletLicensesApi("https://api.partner.market.yandex.ru")
