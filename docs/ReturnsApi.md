...
# **get_return**
> get_return(_api::ReturnsApi, campaign_id::Int64, order_id::Int64, return_id::Int64; _mediaType=nothing) -> GetReturnResponse, OpenAPI.Clients.ApiResponse <br/>
> get_return(_api::ReturnsApi, response_stream::Channel, campaign_id::Int64, order_id::Int64, return_id::Int64; _mediaType=nothing) -> Channel{ GetReturnResponse }, OpenAPI.Clients.ApiResponse
...
> get_return_application(_api::ReturnsApi, campaign_id::Int64, order_id::Int64, return_id::Int64; _mediaType=nothing) -> String, OpenAPI.Clients.ApiResponse <br/>
> get_return_application(_api::ReturnsApi, response_stream::Channel, campaign_id::Int64, order_id::Int64, return_id::Int64; _mediaType=nothing) -> Channel{ String }, OpenAPI.Clients.ApiResponse
...
# **get_return_photo**
> get_return_photo(_api::ReturnsApi, campaign_id::Int64, order_id::Int64, return_id::Int64, item_id::Int64, image_hash::String; _mediaType=nothing) -> String, OpenAPI.Clients.ApiResponse <br/>
> get_return_photo(_api::ReturnsApi, response_stream::Channel, campaign_id::Int64, order_id::Int64, return_id::Int64, item_id::Int64, image_hash::String; _mediaType=nothing) -> Channel{ String }, OpenAPI.Clients.ApiResponse
...
# **get_returns**
> get_returns(_api::ReturnsApi, campaign_id::Int64; page_token=nothing, limit=nothing, order_ids=nothing, statuses=nothing, type=nothing, from_date=nothing, to_date=nothing, from_date2=nothing, to_date2=nothing, _mediaType=nothing) -> GetReturnsResponse, OpenAPI.Clients.ApiResponse <br/>
> get_returns(_api::ReturnsApi, response_stream::Channel, campaign_id::Int64; page_token=nothing, limit=nothing, order_ids=nothing, statuses=nothing, type=nothing, from_date=nothing, to_date=nothing, from_date2=nothing, to_date2=nothing, _mediaType=nothing) -> Channel{ GetReturnsResponse }, OpenAPI.Clients.ApiResponse
...
# **set_return_decision**
> set_return_decision(_api::ReturnsApi, campaign_id::Int64, order_id::Int64, return_id::Int64, set_return_decision_request::SetReturnDecisionRequest; _mediaType=nothing) -> EmptyApiResponse, OpenAPI.Clients.ApiResponse <br/>
> set_return_decision(_api::ReturnsApi, response_stream::Channel, campaign_id::Int64, order_id::Int64, return_id::Int64, set_return_decision_request::SetReturnDecisionRequest; _mediaType=nothing) -> Channel{ EmptyApiResponse }, OpenAPI.Clients.ApiResponse
...
> submit_return_decision(_api::ReturnsApi, campaign_id::Int64, order_id::Int64, return_id::Int64; _mediaType=nothing) -> EmptyApiResponse, OpenAPI.Clients.ApiResponse <br/>
> submit_return_decision(_api::ReturnsApi, response_stream::Channel, campaign_id::Int64, order_id::Int64, return_id::Int64; _mediaType=nothing) -> Channel{ EmptyApiResponse }, OpenAPI.Clients.ApiResponse
