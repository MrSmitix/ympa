...
> models::EmptyApiResponse deleteGoodsFeedbackComment(ctx, business_id, delete_goods_feedback_comment_request)
...
> models::GetGoodsFeedbackCommentsResponse getGoodsFeedbackComments(ctx, business_id, get_goods_feedback_comments_request, optional)
...
# **getGoodsFeedbacks**
> models::GetGoodsFeedbackResponse getGoodsFeedbacks(ctx, business_id, optional)
...
> models::EmptyApiResponse skipGoodsFeedbacksReaction(ctx, business_id, skip_goods_feedback_reaction_request)
...
> models::UpdateGoodsFeedbackCommentResponse updateGoodsFeedbackComment(ctx, business_id, update_goods_feedback_comment_request)
