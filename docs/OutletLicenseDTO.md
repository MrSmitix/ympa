...
```python
from ympa_python_pydantic_v1_client.models.outlet_license_dto import OutletLicenseDTO

# TODO update the JSON string below
json = "{}"
# create an instance of OutletLicenseDTO from a JSON string
outlet_license_dto_instance = OutletLicenseDTO.from_json(json)
# print the JSON string representation of the object
print OutletLicenseDTO.to_json()

# convert the object into a dict
outlet_license_dto_dict = outlet_license_dto_instance.to_dict()
# create an instance of OutletLicenseDTO from a dict
outlet_license_dto_from_dict = OutletLicenseDTO.from_dict(outlet_license_dto_dict)
```
