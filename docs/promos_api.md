...
# **deletePromoOffers**
> models::DeletePromoOffersResponse deletePromoOffers(ctx, business_id, delete_promo_offers_request)
...
# **getPromoOffers**
> models::GetPromoOffersResponse getPromoOffers(ctx, business_id, get_promo_offers_request, optional)
...
# **getPromos**
> models::GetPromosResponse getPromos(ctx, business_id, optional)
...
# **updatePromoOffers**
> models::UpdatePromoOffersResponse updatePromoOffers(ctx, business_id, update_promo_offers_request)
