...
[**generateOrderLabelWithHttpInfo**](OrderLabelsApi.md#generateOrderLabelWithHttpInfo) | **GET** /campaigns/{campaignId}/orders/{orderId}/delivery/shipments/{shipmentId}/boxes/{boxId}/label | Готовый ярлык‑наклейка для коробки в заказе
...
[**generateOrderLabelsWithHttpInfo**](OrderLabelsApi.md#generateOrderLabelsWithHttpInfo) | **GET** /campaigns/{campaignId}/orders/{orderId}/delivery/labels | Готовые ярлыки‑наклейки на все коробки в одном заказе
...
[**getOrderLabelsDataWithHttpInfo**](OrderLabelsApi.md#getOrderLabelsDataWithHttpInfo) | **GET** /campaigns/{campaignId}/orders/{orderId}/delivery/labels/data | Данные для самостоятельного изготовления ярлыков
...
object Example extends App {
    ...
    val apiInstance = OrderLabelsApi("https://api.partner.market.yandex.ru")
