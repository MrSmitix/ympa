...
**tracks** | [**OpenAPI\Server\Model\OrderTrackDTO**](OrderTrackDTO.md) | **Только для модели DBS**  Информация для отслеживания перемещений посылки. | [optional] 
**boxes** | [**OpenAPI\Server\Model\OrderParcelBoxDTO**](OrderParcelBoxDTO.md) | Список грузовых мест. | [optional] 
