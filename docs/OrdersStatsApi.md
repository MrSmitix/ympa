# ympa_python_pydantic_v1_client.OrdersStatsApi
...
with ympa_python_pydantic_v1_client.ApiClient(configuration) as api_client:
    ...
    api_instance = ympa_python_pydantic_v1_client.OrdersStatsApi(api_client)
    ...
    try:
        ...
        print("The response of OrdersStatsApi->get_orders_stats:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling OrdersStatsApi->get_orders_stats: %s\n" % e)
```
