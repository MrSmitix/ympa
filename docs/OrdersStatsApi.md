# ympa_powershell_client.ympa_powershell_client\Api.OrdersStatsApi

All URIs are relative to *https://api.partner.market.yandex.ru*

Method | HTTP request | Description
------------- | ------------- | -------------
[**Get-OrdersStats**](OrdersStatsApi.md#Get-OrdersStats) | **POST** /campaigns/{campaignId}/stats/orders | Детальная информация по заказам
