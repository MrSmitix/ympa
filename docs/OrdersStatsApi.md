...
[**getOrdersStatsWithHttpInfo**](OrdersStatsApi.md#getOrdersStatsWithHttpInfo) | **POST** /campaigns/{campaignId}/stats/orders | Детальная информация по заказам
...
object Example extends App {
    ...
    val apiInstance = OrdersStatsApi("https://api.partner.market.yandex.ru")
