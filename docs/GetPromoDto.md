...
**channels** | Option<[**Vec<models::ChannelType>**](ChannelType.md)> | Список каналов продвижения товаров. | [optional]
**constraints** | Option<[**models::GetPromoConstraintsDto**](GetPromoConstraintsDTO.md)> |  | [optional]
