...
// Список товаров в каталоге
OfferMappingsAPI.getOfferMappingEntries(campaignId: campaignId, offerId: offerId, shopSku: shopSku, mappingKind: mappingKind, status: status, availability: availability, categoryId: categoryId, vendor: vendor, pageToken: pageToken, limit: limit) { (response, error) in
...
// Рекомендованные карточки для товаров
OfferMappingsAPI.getSuggestedOfferMappingEntries(campaignId: campaignId, getSuggestedOfferMappingEntriesRequest: getSuggestedOfferMappingEntriesRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Добавление и редактирование товаров в каталоге
OfferMappingsAPI.updateOfferMappingEntries(campaignId: campaignId, updateOfferMappingEntryRequest: updateOfferMappingEntryRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
