...
------------- | ------------- | -------------
[**OfferMappingsAPI_getOfferMappingEntries**](OfferMappingsAPI.md#OfferMappingsAPI_getOfferMappingEntries) | **GET** /campaigns/{campaignId}/offer-mapping-entries | Список товаров в каталоге
[**OfferMappingsAPI_getSuggestedOfferMappingEntries**](OfferMappingsAPI.md#OfferMappingsAPI_getSuggestedOfferMappingEntries) | **POST** /campaigns/{campaignId}/offer-mapping-entries/suggestions | Рекомендованные карточки для товаров
[**OfferMappingsAPI_updateOfferMappingEntries**](OfferMappingsAPI.md#OfferMappingsAPI_updateOfferMappingEntries) | **POST** /campaigns/{campaignId}/offer-mapping-entries/updates | Добавление и редактирование товаров в каталоге


# **OfferMappingsAPI_getOfferMappingEntries**
```c
...
//
get_offer_mapping_entries_response_t* OfferMappingsAPI_getOfferMappingEntries(apiClient_t *apiClient, long campaignId, list_t *offer_id, list_t *shop_sku, offer_mapping_kind_type_e mapping_kind, list_t *status, list_t *availability, list_t *category_id, list_t *vendor, char *page_token, int *limit);
```
...
# **OfferMappingsAPI_getSuggestedOfferMappingEntries**
```c
...
//
get_suggested_offer_mapping_entries_response_t* OfferMappingsAPI_getSuggestedOfferMappingEntries(apiClient_t *apiClient, long campaignId, get_suggested_offer_mapping_entries_request_t *get_suggested_offer_mapping_entries_request);
```
...
# **OfferMappingsAPI_updateOfferMappingEntries**
```c
...
//
empty_api_response_t* OfferMappingsAPI_updateOfferMappingEntries(apiClient_t *apiClient, long campaignId, update_offer_mapping_entry_request_t *update_offer_mapping_entry_request);
```
