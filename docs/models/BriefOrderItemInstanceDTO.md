...
The class is defined in **[BriefOrderItemInstanceDTO.java](../../src/main/java/org/openapitools/model/BriefOrderItemInstanceDTO.java)**
...
**uin** | `String` | Уникальный идентификационный номер ювелирного изделия.  Представляет собой число из 16 цифр.  |  [optional property]
