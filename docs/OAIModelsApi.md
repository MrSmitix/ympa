...
------------- | ------------- | -------------
[**getModel**](OAIModelsApi.md#getmodel) | **GET** /models/{modelId} | Информация об одной модели
[**getModelOffers**](OAIModelsApi.md#getmodeloffers) | **GET** /models/{modelId}/offers | Список предложений для одной модели
[**getModels**](OAIModelsApi.md#getmodels) | **POST** /models | Информация о нескольких моделях
[**getModelsOffers**](OAIModelsApi.md#getmodelsoffers) | **POST** /models/offers | Список предложений для нескольких моделей
[**searchModels**](OAIModelsApi.md#searchmodels) | **GET** /models | Поиск модели товара
...
[apiInstance getModelWithModelId:modelId
          ...
          completionHandler: ^(OAIGetModelsResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIModelsApi->getModel: %@", error);
                        }
                    }];
```
...
[apiInstance getModelOffersWithModelId:modelId
          ...
          completionHandler: ^(OAIGetModelsOffersResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIModelsApi->getModelOffers: %@", error);
                        }
                    }];
```
...
[apiInstance getModelsWithRegionId:regionId
          ...
          completionHandler: ^(OAIGetModelsResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIModelsApi->getModels: %@", error);
                        }
                    }];
```
...
[apiInstance getModelsOffersWithRegionId:regionId
          ...
          completionHandler: ^(OAIGetModelsOffersResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIModelsApi->getModelsOffers: %@", error);
                        }
                    }];
```
...
[apiInstance searchModelsWithQuery:query
          ...
          completionHandler: ^(OAISearchModelsResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIModelsApi->searchModels: %@", error);
                        }
                    }];
```
