...
// Логины, связанные с магазином
CampaignsAPI.getCampaignLogins(campaignId: campaignId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Регион магазина
CampaignsAPI.getCampaignRegion(campaignId: campaignId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Настройки магазина
CampaignsAPI.getCampaignSettings(campaignId: campaignId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Список магазинов пользователя
CampaignsAPI.getCampaigns(page: page, pageSize: pageSize) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Магазины, доступные логину
CampaignsAPI.getCampaignsByLogin(login: login, page: page, pageSize: pageSize) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
