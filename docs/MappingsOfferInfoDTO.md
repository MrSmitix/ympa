...
# Table `MappingsOfferInfoDTO`
(mapped from: MappingsOfferInfoDTO)
...
# **Table `MappingsOfferInfoDTOBarcodes`**
(mapped from: MappingsOfferInfoDTOBarcodes)

## Properties
Name | Mapping | SQL Type | Default | Type | Description | Notes
---- | ------- | -------- | ------- | ---- | ----------- | -----
mappingsOfferInfoDTO | mappingsOfferInfoDTO | long | | kotlin.Long | Primary Key | *one*
barcodes | barcodes | text | | kotlin.String | Foreign Key | *many*



# **Table `MappingsOfferInfoDTOUrls`**
(mapped from: MappingsOfferInfoDTOUrls)
...
# **Table `MappingsOfferInfoDTOPictures`**
(mapped from: MappingsOfferInfoDTOPictures)
...
# **Table `MappingsOfferInfoDTOManufacturerCountries`**
(mapped from: MappingsOfferInfoDTOManufacturerCountries)
...
# **Table `MappingsOfferInfoDTOCustomsCommodityCodes`**
(mapped from: MappingsOfferInfoDTOCustomsCommodityCodes)
...
# **Table `MappingsOfferInfoDTODayOfWeekType`**
(mapped from: MappingsOfferInfoDTODayOfWeekType)
