...
[**getGoodsStatsWithHttpInfo**](GoodsStatsApi.md#getGoodsStatsWithHttpInfo) | **POST** /campaigns/{campaignId}/stats/skus | Отчет по товарам
...
object Example extends App {
    ...
    val apiInstance = GoodsStatsApi("https://api.partner.market.yandex.ru")
