# ympa_python_pydantic_v1_client.GoodsStatsApi
...
with ympa_python_pydantic_v1_client.ApiClient(configuration) as api_client:
    ...
    api_instance = ympa_python_pydantic_v1_client.GoodsStatsApi(api_client)
    ...
    try:
        ...
        print("The response of GoodsStatsApi->get_goods_stats:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling GoodsStatsApi->get_goods_stats: %s\n" % e)
```
