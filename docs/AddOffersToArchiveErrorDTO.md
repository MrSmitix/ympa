...
# Table `AddOffersToArchiveErrorDTO`
(mapped from: AddOffersToArchiveErrorDTO)
...
**error** | error | long NOT NULL |  | [**AddOffersToArchiveErrorType**](AddOffersToArchiveErrorType.md) |  |  [foreignkey]
