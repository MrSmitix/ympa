...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    api_instance = ympa_python_client.DbsApi(api_client)
    ...
    accept_order_cancellation_request = ympa_python_client.AcceptOrderCancellationRequest() # AcceptOrderCancellationRequest | 

    try:
        # Отмена заказа покупателем
        api_response = api_instance.accept_order_cancellation(campaign_id, order_id, accept_order_cancellation_request)
        print("The response of DbsApi->accept_order_cancellation:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->accept_order_cancellation: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->add_hidden_offers:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->add_hidden_offers: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->add_offers_to_archive:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->add_offers_to_archive: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->calculate_tariffs:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->calculate_tariffs: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->confirm_business_prices:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->confirm_business_prices: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->confirm_campaign_prices:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->confirm_campaign_prices: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->create_chat:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->create_chat: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    api_instance = ympa_python_client.DbsApi(api_client)
    campaign_id = 56 # int | Идентификатор кампании в API и магазина в кабинете. Каждая кампания в API соответствует магазину в кабинете.  Чтобы узнать идентификаторы своих магазинов, воспользуйтесь запросом [GET campaigns](../../reference/campaigns/getCampaigns.md).  ℹ️ [Что такое кабинет и магазин на Маркете](https://yandex.ru/support/marketplace/account/introduction.html) 
    change_outlet_request = ympa_python_client.ChangeOutletRequest() # ChangeOutletRequest | 

    try:
        # Создание точки продаж
        api_response = api_instance.create_outlet(campaign_id, change_outlet_request)
        print("The response of DbsApi->create_outlet:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->create_outlet: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->delete_campaign_offers:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->delete_campaign_offers: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->delete_goods_feedback_comment:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->delete_goods_feedback_comment: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->delete_hidden_offers:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->delete_hidden_offers: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->delete_offers:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->delete_offers: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->delete_offers_from_archive:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->delete_offers_from_archive: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->delete_outlet:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->delete_outlet: %s\n" % e)
```
...
> EmptyApiResponse delete_outlet_licenses(campaign_id, ids=ids)
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    api_instance = ympa_python_client.DbsApi(api_client)
    campaign_id = 56 # int | Идентификатор кампании в API и магазина в кабинете. Каждая кампания в API соответствует магазину в кабинете.  Чтобы узнать идентификаторы своих магазинов, воспользуйтесь запросом [GET campaigns](../../reference/campaigns/getCampaigns.md).  ℹ️ [Что такое кабинет и магазин на Маркете](https://yandex.ru/support/marketplace/account/introduction.html) 
    ids = [56] # List[int] | Список идентификаторов лицензий. (optional)

    try:
        # Удаление лицензий для точек продаж
        api_response = api_instance.delete_outlet_licenses(campaign_id, ids=ids)
        print("The response of DbsApi->delete_outlet_licenses:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->delete_outlet_licenses: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **campaign_id** | **int**| Идентификатор кампании в API и магазина в кабинете. Каждая кампания в API соответствует магазину в кабинете.  Чтобы узнать идентификаторы своих магазинов, воспользуйтесь запросом [GET campaigns](../../reference/campaigns/getCampaigns.md).  ℹ️ [Что такое кабинет и магазин на Маркете](https://yandex.ru/support/marketplace/account/introduction.html)  | 
 **ids** | [**List[int]**](int.md)| Список идентификаторов лицензий. | [optional] 
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->delete_promo_offers:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->delete_promo_offers: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->generate_boost_consolidated_report:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->generate_boost_consolidated_report: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->generate_competitors_position_report:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->generate_competitors_position_report: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->generate_goods_feedback_report:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->generate_goods_feedback_report: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->generate_mass_order_labels_report:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->generate_mass_order_labels_report: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->generate_order_label:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->generate_order_label: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->generate_order_labels:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->generate_order_labels: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->generate_prices_report:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->generate_prices_report: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->generate_shelfs_statistics_report:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->generate_shelfs_statistics_report: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->generate_shows_sales_report:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->generate_shows_sales_report: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->generate_stocks_on_warehouses_report:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->generate_stocks_on_warehouses_report: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->generate_united_marketplace_services_report:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->generate_united_marketplace_services_report: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->generate_united_netting_report:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->generate_united_netting_report: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->generate_united_orders_report:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->generate_united_orders_report: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->get_all_offers:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->get_all_offers: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->get_bids_info_for_business:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->get_bids_info_for_business: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->get_bids_recommendations:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->get_bids_recommendations: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->get_business_quarantine_offers:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->get_business_quarantine_offers: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->get_business_settings:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->get_business_settings: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->get_campaign:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->get_campaign: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->get_campaign_logins:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->get_campaign_logins: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->get_campaign_offers:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->get_campaign_offers: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->get_campaign_quarantine_offers:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->get_campaign_quarantine_offers: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->get_campaign_region:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->get_campaign_region: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->get_campaign_settings:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->get_campaign_settings: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->get_campaigns:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->get_campaigns: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->get_campaigns_by_login:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->get_campaigns_by_login: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->get_categories_max_sale_quantum:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->get_categories_max_sale_quantum: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->get_categories_tree:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->get_categories_tree: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->get_category_content_parameters:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->get_category_content_parameters: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->get_chat_history:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->get_chat_history: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->get_chats:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->get_chats: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->get_delivery_services:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->get_delivery_services: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->get_feed:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->get_feed: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->get_feed_index_logs:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->get_feed_index_logs: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->get_feedback_and_comment_updates:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->get_feedback_and_comment_updates: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->get_feeds:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->get_feeds: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->get_goods_feedback_comments:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->get_goods_feedback_comments: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->get_goods_feedbacks:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->get_goods_feedbacks: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->get_goods_stats:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->get_goods_stats: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->get_hidden_offers:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->get_hidden_offers: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    currency = ympa_python_client.CurrencyType() # CurrencyType | Валюта, в которой отображаются цены предложений на страницах с результатами поиска.  Возможные значения:  * `BYN` — белорусский рубль.  * `KZT` — казахстанский тенге.  * `RUR` — российский рубль.  * `UAH` — украинская гривна.  Значение по умолчанию: используется национальная валюта магазина (национальная валюта страны происхождения магазина).  (optional)

    try:
        # Информация об одной модели
        api_response = api_instance.get_model(model_id, region_id, currency=currency)
        print("The response of DbsApi->get_model:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->get_model: %s\n" % e)
```
...
from ympa_python_client.models.sort_order_type import SortOrderType
from ympa_python_client.rest import ApiException
from pprint import pprint
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    region_id = 56 # int | Идентификатор региона.  Идентификатор региона можно получить c помощью запроса [GET regions](../../reference/regions/searchRegionsByName.md). 
    currency = ympa_python_client.CurrencyType() # CurrencyType | Валюта, в которой отображаются цены предложений на страницах с результатами поиска.  Возможные значения:  * `BYN` — белорусский рубль.  * `KZT` — казахстанский тенге.  * `RUR` — российский рубль.  * `UAH` — украинская гривна.  Значение по умолчанию: используется национальная валюта магазина (национальная валюта страны происхождения магазина).  (optional)
    order_by_price = ympa_python_client.SortOrderType() # SortOrderType | Направление сортировки по цене.  Возможные значения: * `ASC` — сортировка по возрастанию. * `DESC` — сортировка по убыванию.  Значение по умолчанию: предложения выводятся в произвольном порядке.  (optional)
    ...
    try:
        ...
        print("The response of DbsApi->get_model_offers:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->get_model_offers: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    api_instance = ympa_python_client.DbsApi(api_client)
    region_id = 56 # int | Идентификатор региона.  Идентификатор региона можно получить c помощью запроса [GET regions](../../reference/regions/searchRegionsByName.md). 
    get_models_request = ympa_python_client.GetModelsRequest() # GetModelsRequest | 
    currency = ympa_python_client.CurrencyType() # CurrencyType | Валюта, в которой отображаются цены предложений на страницах с результатами поиска.  Возможные значения:  * `BYN` — белорусский рубль.  * `KZT` — казахстанский тенге.  * `RUR` — российский рубль.  * `UAH` — украинская гривна.  Значение по умолчанию: используется национальная валюта магазина (национальная валюта страны происхождения магазина).  (optional)

    try:
        # Информация о нескольких моделях
        api_response = api_instance.get_models(region_id, get_models_request, currency=currency)
        print("The response of DbsApi->get_models:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->get_models: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->get_models_offers:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->get_models_offers: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->get_offer_cards_content_status:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->get_offer_cards_content_status: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->get_offer_mapping_entries:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->get_offer_mapping_entries: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->get_offer_mappings:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->get_offer_mappings: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->get_offer_recommendations:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->get_offer_recommendations: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->get_offers:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->get_offers: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->get_order:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->get_order: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->get_order_business_buyer_info:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->get_order_business_buyer_info: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->get_order_business_documents_info:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->get_order_business_documents_info: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->get_order_buyer_info:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->get_order_buyer_info: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->get_order_labels_data:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->get_order_labels_data: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->get_orders:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->get_orders: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->get_orders_stats:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->get_orders_stats: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->get_outlet:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->get_outlet: %s\n" % e)
```
...
# **get_outlet_licenses**
> GetOutletLicensesResponse get_outlet_licenses(campaign_id, outlet_ids=outlet_ids, ids=ids)
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    api_instance = ympa_python_client.DbsApi(api_client)
    campaign_id = 56 # int | Идентификатор кампании в API и магазина в кабинете. Каждая кампания в API соответствует магазину в кабинете.  Чтобы узнать идентификаторы своих магазинов, воспользуйтесь запросом [GET campaigns](../../reference/campaigns/getCampaigns.md).  ℹ️ [Что такое кабинет и магазин на Маркете](https://yandex.ru/support/marketplace/account/introduction.html) 
    outlet_ids = [56] # List[int] | Список идентификаторов точек продаж, для которых нужно получить информацию о лицензиях. Идентификаторы указываются через запятую.  В запросе должен быть либо параметр `outletIds`, либо параметр `ids`. Запрос с обоими параметрами или без них приведет к ошибке.  (optional)
    ids = [56] # List[int] | Список идентификаторов лицензий. (optional)

    try:
        # Информация о лицензиях для точек продаж
        api_response = api_instance.get_outlet_licenses(campaign_id, outlet_ids=outlet_ids, ids=ids)
        print("The response of DbsApi->get_outlet_licenses:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->get_outlet_licenses: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **campaign_id** | **int**| Идентификатор кампании в API и магазина в кабинете. Каждая кампания в API соответствует магазину в кабинете.  Чтобы узнать идентификаторы своих магазинов, воспользуйтесь запросом [GET campaigns](../../reference/campaigns/getCampaigns.md).  ℹ️ [Что такое кабинет и магазин на Маркете](https://yandex.ru/support/marketplace/account/introduction.html)  | 
 **outlet_ids** | [**List[int]**](int.md)| Список идентификаторов точек продаж, для которых нужно получить информацию о лицензиях. Идентификаторы указываются через запятую.  В запросе должен быть либо параметр &#x60;outletIds&#x60;, либо параметр &#x60;ids&#x60;. Запрос с обоими параметрами или без них приведет к ошибке.  | [optional] 
 **ids** | [**List[int]**](int.md)| Список идентификаторов лицензий. | [optional] 
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->get_outlets:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->get_outlets: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->get_prices:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->get_prices: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->get_prices_by_offer_ids:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->get_prices_by_offer_ids: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->get_promo_offers:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->get_promo_offers: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->get_promos:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->get_promos: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->get_quality_rating_details:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->get_quality_rating_details: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->get_quality_ratings:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->get_quality_ratings: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->get_report_info:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->get_report_info: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->get_return:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->get_return: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->get_return_application:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->get_return_application: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->get_return_photo:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->get_return_photo: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->get_returns:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->get_returns: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->get_stocks:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->get_stocks: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->get_suggested_offer_mapping_entries:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->get_suggested_offer_mapping_entries: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->get_suggested_offer_mappings:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->get_suggested_offer_mappings: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->get_suggested_prices:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->get_suggested_prices: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->get_warehouses:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->get_warehouses: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    campaign_id = 56 # int | Идентификатор кампании в API и магазина в кабинете. Каждая кампания в API соответствует магазину в кабинете.  Чтобы узнать идентификаторы своих магазинов, воспользуйтесь запросом [GET campaigns](../../reference/campaigns/getCampaigns.md).  ℹ️ [Что такое кабинет и магазин на Маркете](https://yandex.ru/support/marketplace/account/introduction.html) 
    order_id = 56 # int | Идентификатор заказа.
    provide_order_digital_codes_request = ympa_python_client.ProvideOrderDigitalCodesRequest() # ProvideOrderDigitalCodesRequest | 

    try:
        # Передача ключей цифровых товаров
        api_response = api_instance.provide_order_digital_codes(campaign_id, order_id, provide_order_digital_codes_request)
        print("The response of DbsApi->provide_order_digital_codes:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->provide_order_digital_codes: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->provide_order_item_identifiers:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->provide_order_item_identifiers: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->put_bids_for_business:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->put_bids_for_business: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->put_bids_for_campaign:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->put_bids_for_campaign: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->refresh_feed:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->refresh_feed: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->search_models:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->search_models: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->search_region_children:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->search_region_children: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->search_regions_by_id:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->search_regions_by_id: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->search_regions_by_name:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->search_regions_by_name: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->send_file_to_chat:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->send_file_to_chat: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->send_message_to_chat:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->send_message_to_chat: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->set_feed_params:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->set_feed_params: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->set_order_box_layout:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->set_order_box_layout: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    campaign_id = 56 # int | Идентификатор кампании в API и магазина в кабинете. Каждая кампания в API соответствует магазину в кабинете.  Чтобы узнать идентификаторы своих магазинов, воспользуйтесь запросом [GET campaigns](../../reference/campaigns/getCampaigns.md).  ℹ️ [Что такое кабинет и магазин на Маркете](https://yandex.ru/support/marketplace/account/introduction.html) 
    order_id = 56 # int | Идентификатор заказа.
    set_order_delivery_date_request = ympa_python_client.SetOrderDeliveryDateRequest() # SetOrderDeliveryDateRequest | 

    try:
        # Изменение даты доставки заказа
        api_response = api_instance.set_order_delivery_date(campaign_id, order_id, set_order_delivery_date_request)
        print("The response of DbsApi->set_order_delivery_date:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->set_order_delivery_date: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    campaign_id = 56 # int | Идентификатор кампании в API и магазина в кабинете. Каждая кампания в API соответствует магазину в кабинете.  Чтобы узнать идентификаторы своих магазинов, воспользуйтесь запросом [GET campaigns](../../reference/campaigns/getCampaigns.md).  ℹ️ [Что такое кабинет и магазин на Маркете](https://yandex.ru/support/marketplace/account/introduction.html) 
    order_id = 56 # int | Идентификатор заказа.
    set_order_delivery_track_code_request = ympa_python_client.SetOrderDeliveryTrackCodeRequest() # SetOrderDeliveryTrackCodeRequest | 

    try:
        # Передача трек‑номера посылки
        api_response = api_instance.set_order_delivery_track_code(campaign_id, order_id, set_order_delivery_track_code_request)
        print("The response of DbsApi->set_order_delivery_track_code:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->set_order_delivery_track_code: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->set_order_shipment_boxes:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->set_order_shipment_boxes: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    order_id = 56 # int | Идентификатор заказа.
    return_id = 56 # int | Идентификатор возврата.
    set_return_decision_request = ympa_python_client.SetReturnDecisionRequest() # SetReturnDecisionRequest | 

    try:
        # Принятие или изменение решения по возврату
        api_response = api_instance.set_return_decision(campaign_id, order_id, return_id, set_return_decision_request)
        print("The response of DbsApi->set_return_decision:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->set_return_decision: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->skip_goods_feedbacks_reaction:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->skip_goods_feedbacks_reaction: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Подтверждение решения по возврату
        api_response = api_instance.submit_return_decision(campaign_id, order_id, return_id)
        print("The response of DbsApi->submit_return_decision:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->submit_return_decision: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->update_business_prices:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->update_business_prices: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->update_campaign_offers:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->update_campaign_offers: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->update_goods_feedback_comment:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->update_goods_feedback_comment: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->update_offer_content:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->update_offer_content: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->update_offer_mapping_entries:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->update_offer_mapping_entries: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->update_offer_mappings:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->update_offer_mappings: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling DbsApi->update_order_items: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->update_order_status:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->update_order_status: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->update_order_statuses:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->update_order_statuses: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    campaign_id = 56 # int | Идентификатор кампании в API и магазина в кабинете. Каждая кампания в API соответствует магазину в кабинете.  Чтобы узнать идентификаторы своих магазинов, воспользуйтесь запросом [GET campaigns](../../reference/campaigns/getCampaigns.md).  ℹ️ [Что такое кабинет и магазин на Маркете](https://yandex.ru/support/marketplace/account/introduction.html) 
    order_id = 56 # int | Идентификатор заказа.
    update_order_storage_limit_request = ympa_python_client.UpdateOrderStorageLimitRequest() # UpdateOrderStorageLimitRequest | 

    try:
        # Продление срока хранения заказа
        api_response = api_instance.update_order_storage_limit(campaign_id, order_id, update_order_storage_limit_request)
        print("The response of DbsApi->update_order_storage_limit:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->update_order_storage_limit: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->update_outlet:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->update_outlet: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    api_instance = ympa_python_client.DbsApi(api_client)
    campaign_id = 56 # int | Идентификатор кампании в API и магазина в кабинете. Каждая кампания в API соответствует магазину в кабинете.  Чтобы узнать идентификаторы своих магазинов, воспользуйтесь запросом [GET campaigns](../../reference/campaigns/getCampaigns.md).  ℹ️ [Что такое кабинет и магазин на Маркете](https://yandex.ru/support/marketplace/account/introduction.html) 
    update_outlet_license_request = ympa_python_client.UpdateOutletLicenseRequest() # UpdateOutletLicenseRequest | 

    try:
        # Создание и изменение лицензий для точек продаж
        api_response = api_instance.update_outlet_licenses(campaign_id, update_outlet_license_request)
        print("The response of DbsApi->update_outlet_licenses:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->update_outlet_licenses: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->update_prices:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->update_prices: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->update_promo_offers:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->update_promo_offers: %s\n" % e)
```
...
with ympa_python_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DbsApi->update_stocks:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DbsApi->update_stocks: %s\n" % e)
```
