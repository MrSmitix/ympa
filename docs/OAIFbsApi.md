...
------------- | ------------- | -------------
[**addHiddenOffers**](OAIFbsApi.md#addhiddenoffers) | **POST** /campaigns/{campaignId}/hidden-offers | Скрытие товаров и настройки скрытия
[**addOffersToArchive**](OAIFbsApi.md#addofferstoarchive) | **POST** /businesses/{businessId}/offer-mappings/archive | Добавление товаров в архив
[**calculateTariffs**](OAIFbsApi.md#calculatetariffs) | **POST** /tariffs/calculate | Калькулятор стоимости услуг
[**confirmBusinessPrices**](OAIFbsApi.md#confirmbusinessprices) | **POST** /businesses/{businessId}/price-quarantine/confirm | Удаление товара из карантина по цене в кабинете
[**confirmCampaignPrices**](OAIFbsApi.md#confirmcampaignprices) | **POST** /campaigns/{campaignId}/price-quarantine/confirm | Удаление товара из карантина по цене в магазине
[**confirmShipment**](OAIFbsApi.md#confirmshipment) | **POST** /campaigns/{campaignId}/first-mile/shipments/{shipmentId}/confirm | Подтверждение отгрузки
[**createChat**](OAIFbsApi.md#createchat) | **POST** /businesses/{businessId}/chats/new | Создание нового чата с покупателем
[**deleteCampaignOffers**](OAIFbsApi.md#deletecampaignoffers) | **POST** /campaigns/{campaignId}/offers/delete | Удаление товаров из ассортимента магазина
[**deleteGoodsFeedbackComment**](OAIFbsApi.md#deletegoodsfeedbackcomment) | **POST** /businesses/{businessId}/goods-feedback/comments/delete | Удаление комментария к отзыву
[**deleteHiddenOffers**](OAIFbsApi.md#deletehiddenoffers) | **POST** /campaigns/{campaignId}/hidden-offers/delete | Возобновление показа товаров
[**deleteOffers**](OAIFbsApi.md#deleteoffers) | **POST** /businesses/{businessId}/offer-mappings/delete | Удаление товаров из каталога
[**deleteOffersFromArchive**](OAIFbsApi.md#deleteoffersfromarchive) | **POST** /businesses/{businessId}/offer-mappings/unarchive | Удаление товаров из архива
[**deletePromoOffers**](OAIFbsApi.md#deletepromooffers) | **POST** /businesses/{businessId}/promos/offers/delete | Удаление товаров из акции
[**downloadShipmentAct**](OAIFbsApi.md#downloadshipmentact) | **GET** /campaigns/{campaignId}/first-mile/shipments/{shipmentId}/act | Получение акта приема-передачи
[**downloadShipmentDiscrepancyAct**](OAIFbsApi.md#downloadshipmentdiscrepancyact) | **GET** /campaigns/{campaignId}/first-mile/shipments/{shipmentId}/discrepancy-act | Получение акта расхождений
[**downloadShipmentInboundAct**](OAIFbsApi.md#downloadshipmentinboundact) | **GET** /campaigns/{campaignId}/first-mile/shipments/{shipmentId}/inbound-act | Получение фактического акта приема-передачи
[**downloadShipmentPalletLabels**](OAIFbsApi.md#downloadshipmentpalletlabels) | **GET** /campaigns/{campaignId}/first-mile/shipments/{shipmentId}/pallet/labels | Ярлыки для доверительной приемки (FBS)
[**downloadShipmentReceptionTransferAct**](OAIFbsApi.md#downloadshipmentreceptiontransferact) | **GET** /campaigns/{campaignId}/shipments/reception-transfer-act | Подтверждение ближайшей отгрузки и получение акта приема-передачи для нее
[**downloadShipmentTransportationWaybill**](OAIFbsApi.md#downloadshipmenttransportationwaybill) | **GET** /campaigns/{campaignId}/first-mile/shipments/{shipmentId}/transportation-waybill | Получение транспортной накладной
[**generateBoostConsolidatedReport**](OAIFbsApi.md#generateboostconsolidatedreport) | **POST** /reports/boost-consolidated/generate | Отчет по бусту продаж
[**generateCompetitorsPositionReport**](OAIFbsApi.md#generatecompetitorspositionreport) | **POST** /reports/competitors-position/generate | Отчет «Конкурентная позиция»
[**generateGoodsFeedbackReport**](OAIFbsApi.md#generategoodsfeedbackreport) | **POST** /reports/goods-feedback/generate | Отчет по отзывам о товарах
[**generateGoodsRealizationReport**](OAIFbsApi.md#generategoodsrealizationreport) | **POST** /reports/goods-realization/generate | Отчет по реализации
[**generateMassOrderLabelsReport**](OAIFbsApi.md#generatemassorderlabelsreport) | **POST** /reports/documents/labels/generate | Готовые ярлыки‑наклейки на все коробки в нескольких заказах
[**generateOrderLabel**](OAIFbsApi.md#generateorderlabel) | **GET** /campaigns/{campaignId}/orders/{orderId}/delivery/shipments/{shipmentId}/boxes/{boxId}/label | Готовый ярлык‑наклейка для коробки в заказе
[**generateOrderLabels**](OAIFbsApi.md#generateorderlabels) | **GET** /campaigns/{campaignId}/orders/{orderId}/delivery/labels | Готовые ярлыки‑наклейки на все коробки в одном заказе
[**generatePricesReport**](OAIFbsApi.md#generatepricesreport) | **POST** /reports/prices/generate | Отчет «Цены на рынке»
[**generateShelfsStatisticsReport**](OAIFbsApi.md#generateshelfsstatisticsreport) | **POST** /reports/shelf-statistics/generate | Отчет по полкам
[**generateShipmentListDocumentReport**](OAIFbsApi.md#generateshipmentlistdocumentreport) | **POST** /reports/documents/shipment-list/generate | Получение листа сборки
[**generateShowsSalesReport**](OAIFbsApi.md#generateshowssalesreport) | **POST** /reports/shows-sales/generate | Отчет «Аналитика продаж»
[**generateStocksOnWarehousesReport**](OAIFbsApi.md#generatestocksonwarehousesreport) | **POST** /reports/stocks-on-warehouses/generate | Отчет по остаткам на складах
[**generateUnitedMarketplaceServicesReport**](OAIFbsApi.md#generateunitedmarketplaceservicesreport) | **POST** /reports/united-marketplace-services/generate | Отчет по стоимости услуг
[**generateUnitedNettingReport**](OAIFbsApi.md#generateunitednettingreport) | **POST** /reports/united-netting/generate | Отчет по платежам
[**generateUnitedOrdersReport**](OAIFbsApi.md#generateunitedordersreport) | **POST** /reports/united-orders/generate | Отчет по заказам
[**getAllOffers**](OAIFbsApi.md#getalloffers) | **GET** /campaigns/{campaignId}/offers/all | Все предложения магазина
[**getBidsInfoForBusiness**](OAIFbsApi.md#getbidsinfoforbusiness) | **POST** /businesses/{businessId}/bids/info | Информация об установленных ставках
[**getBidsRecommendations**](OAIFbsApi.md#getbidsrecommendations) | **POST** /businesses/{businessId}/bids/recommendations | Рекомендованные ставки для заданных товаров
[**getBusinessQuarantineOffers**](OAIFbsApi.md#getbusinessquarantineoffers) | **POST** /businesses/{businessId}/price-quarantine | Список товаров, находящихся в карантине по цене в кабинете
[**getBusinessSettings**](OAIFbsApi.md#getbusinesssettings) | **POST** /businesses/{businessId}/settings | Настройки кабинета
[**getCampaign**](OAIFbsApi.md#getcampaign) | **GET** /campaigns/{campaignId} | Информация о магазине
[**getCampaignLogins**](OAIFbsApi.md#getcampaignlogins) | **GET** /campaigns/{campaignId}/logins | Логины, связанные с магазином
[**getCampaignOffers**](OAIFbsApi.md#getcampaignoffers) | **POST** /campaigns/{campaignId}/offers | Информация о товарах, которые размещены в заданном магазине
[**getCampaignQuarantineOffers**](OAIFbsApi.md#getcampaignquarantineoffers) | **POST** /campaigns/{campaignId}/price-quarantine | Список товаров, находящихся в карантине по цене в магазине
[**getCampaignRegion**](OAIFbsApi.md#getcampaignregion) | **GET** /campaigns/{campaignId}/region | Регион магазина
[**getCampaignSettings**](OAIFbsApi.md#getcampaignsettings) | **GET** /campaigns/{campaignId}/settings | Настройки магазина
[**getCampaigns**](OAIFbsApi.md#getcampaigns) | **GET** /campaigns | Список магазинов пользователя
[**getCampaignsByLogin**](OAIFbsApi.md#getcampaignsbylogin) | **GET** /campaigns/by_login/{login} | Магазины, доступные логину
[**getCategoriesMaxSaleQuantum**](OAIFbsApi.md#getcategoriesmaxsalequantum) | **POST** /categories/max-sale-quantum | Лимит на установку кванта продажи и минимального количества товаров в заказе
[**getCategoriesTree**](OAIFbsApi.md#getcategoriestree) | **POST** /categories/tree | Дерево категорий
[**getCategoryContentParameters**](OAIFbsApi.md#getcategorycontentparameters) | **POST** /category/{categoryId}/parameters | Списки характеристик товаров по категориям
[**getChatHistory**](OAIFbsApi.md#getchathistory) | **POST** /businesses/{businessId}/chats/history | Получение истории сообщений в чате
[**getChats**](OAIFbsApi.md#getchats) | **POST** /businesses/{businessId}/chats | Получение доступных чатов
[**getDeliveryServices**](OAIFbsApi.md#getdeliveryservices) | **GET** /delivery/services | Справочник служб доставки
[**getFeed**](OAIFbsApi.md#getfeed) | **GET** /campaigns/{campaignId}/feeds/{feedId} | Информация о прайс-листе
[**getFeedIndexLogs**](OAIFbsApi.md#getfeedindexlogs) | **GET** /campaigns/{campaignId}/feeds/{feedId}/index-logs | Отчет по индексации прайс-листа
[**getFeedbackAndCommentUpdates**](OAIFbsApi.md#getfeedbackandcommentupdates) | **GET** /campaigns/{campaignId}/feedback/updates | Новые и обновленные отзывы о магазине
[**getFeeds**](OAIFbsApi.md#getfeeds) | **GET** /campaigns/{campaignId}/feeds | Список прайс-листов магазина
[**getGoodsFeedbackComments**](OAIFbsApi.md#getgoodsfeedbackcomments) | **POST** /businesses/{businessId}/goods-feedback/comments | Получение комментариев к отзыву
[**getGoodsFeedbacks**](OAIFbsApi.md#getgoodsfeedbacks) | **POST** /businesses/{businessId}/goods-feedback | Получение отзывов о товарах продавца
[**getGoodsStats**](OAIFbsApi.md#getgoodsstats) | **POST** /campaigns/{campaignId}/stats/skus | Отчет по товарам
[**getHiddenOffers**](OAIFbsApi.md#gethiddenoffers) | **GET** /campaigns/{campaignId}/hidden-offers | Информация о скрытых вами товарах
[**getOfferCardsContentStatus**](OAIFbsApi.md#getoffercardscontentstatus) | **POST** /businesses/{businessId}/offer-cards | Получение информации о заполненности карточек магазина
[**getOfferMappingEntries**](OAIFbsApi.md#getoffermappingentries) | **GET** /campaigns/{campaignId}/offer-mapping-entries | Список товаров в каталоге
[**getOfferMappings**](OAIFbsApi.md#getoffermappings) | **POST** /businesses/{businessId}/offer-mappings | Информация о товарах в каталоге
[**getOfferRecommendations**](OAIFbsApi.md#getofferrecommendations) | **POST** /businesses/{businessId}/offers/recommendations | Рекомендации Маркета, касающиеся цен
[**getOffers**](OAIFbsApi.md#getoffers) | **GET** /campaigns/{campaignId}/offers | Предложения магазина
[**getOrder**](OAIFbsApi.md#getorder) | **GET** /campaigns/{campaignId}/orders/{orderId} | Информация об одном заказе
[**getOrderBusinessBuyerInfo**](OAIFbsApi.md#getorderbusinessbuyerinfo) | **POST** /campaigns/{campaignId}/orders/{orderId}/business-buyer | Информация о покупателе — юридическом лице
[**getOrderBusinessDocumentsInfo**](OAIFbsApi.md#getorderbusinessdocumentsinfo) | **POST** /campaigns/{campaignId}/orders/{orderId}/documents | Информация о документах
[**getOrderLabelsData**](OAIFbsApi.md#getorderlabelsdata) | **GET** /campaigns/{campaignId}/orders/{orderId}/delivery/labels/data | Данные для самостоятельного изготовления ярлыков
[**getOrders**](OAIFbsApi.md#getorders) | **GET** /campaigns/{campaignId}/orders | Информация о нескольких заказах
[**getOrdersStats**](OAIFbsApi.md#getordersstats) | **POST** /campaigns/{campaignId}/stats/orders | Детальная информация по заказам
[**getPrices**](OAIFbsApi.md#getprices) | **GET** /campaigns/{campaignId}/offer-prices | Список цен
[**getPricesByOfferIds**](OAIFbsApi.md#getpricesbyofferids) | **POST** /campaigns/{campaignId}/offer-prices | Просмотр цен на указанные товары в магазине
[**getPromoOffers**](OAIFbsApi.md#getpromooffers) | **POST** /businesses/{businessId}/promos/offers | Получение списка товаров, которые участвуют или могут участвовать в акции
[**getPromos**](OAIFbsApi.md#getpromos) | **POST** /businesses/{businessId}/promos | Получение списка акций
[**getQualityRatingDetails**](OAIFbsApi.md#getqualityratingdetails) | **POST** /campaigns/{campaignId}/ratings/quality/details | Заказы, которые повлияли на индекс качества
[**getQualityRatings**](OAIFbsApi.md#getqualityratings) | **POST** /businesses/{businessId}/ratings/quality | Индекс качества магазинов
[**getReportInfo**](OAIFbsApi.md#getreportinfo) | **GET** /reports/info/{reportId} | Получение заданного отчета
[**getReturn**](OAIFbsApi.md#getreturn) | **GET** /campaigns/{campaignId}/orders/{orderId}/returns/{returnId} | Информация о невыкупе или возврате
[**getReturnApplication**](OAIFbsApi.md#getreturnapplication) | **GET** /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}/application | Получение заявления на возврат
[**getReturnPhoto**](OAIFbsApi.md#getreturnphoto) | **GET** /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}/decision/{itemId}/image/{imageHash} | Получение фотографии возврата
[**getReturns**](OAIFbsApi.md#getreturns) | **GET** /campaigns/{campaignId}/returns | Список невыкупов и возвратов
[**getShipment**](OAIFbsApi.md#getshipment) | **GET** /campaigns/{campaignId}/first-mile/shipments/{shipmentId} | Получение информации об одной отгрузке
[**getShipmentOrdersInfo**](OAIFbsApi.md#getshipmentordersinfo) | **GET** /campaigns/{campaignId}/first-mile/shipments/{shipmentId}/orders/info | Получение информации о возможности печати ярлыков (FBS)
[**getStocks**](OAIFbsApi.md#getstocks) | **POST** /campaigns/{campaignId}/offers/stocks | Информация об остатках и оборачиваемости
[**getSuggestedOfferMappingEntries**](OAIFbsApi.md#getsuggestedoffermappingentries) | **POST** /campaigns/{campaignId}/offer-mapping-entries/suggestions | Рекомендованные карточки для товаров
[**getSuggestedOfferMappings**](OAIFbsApi.md#getsuggestedoffermappings) | **POST** /businesses/{businessId}/offer-mappings/suggestions | Просмотр карточек на Маркете, которые подходят вашим товарам
[**getSuggestedPrices**](OAIFbsApi.md#getsuggestedprices) | **POST** /campaigns/{campaignId}/offer-prices/suggestions | Цены для продвижения товаров
[**getWarehouses**](OAIFbsApi.md#getwarehouses) | **GET** /businesses/{businessId}/warehouses | Список складов и групп складов
[**provideOrderItemIdentifiers**](OAIFbsApi.md#provideorderitemidentifiers) | **PUT** /campaigns/{campaignId}/orders/{orderId}/identifiers | Передача кодов маркировки единиц товара
[**putBidsForBusiness**](OAIFbsApi.md#putbidsforbusiness) | **PUT** /businesses/{businessId}/bids | Включение буста продаж и установка ставок
[**putBidsForCampaign**](OAIFbsApi.md#putbidsforcampaign) | **PUT** /campaigns/{campaignId}/bids | Включение буста продаж и установка ставок для магазина
[**refreshFeed**](OAIFbsApi.md#refreshfeed) | **POST** /campaigns/{campaignId}/feeds/{feedId}/refresh | Сообщить, что прайс-лист обновился
[**searchRegionChildren**](OAIFbsApi.md#searchregionchildren) | **GET** /regions/{regionId}/children | Информация о дочерних регионах
[**searchRegionsById**](OAIFbsApi.md#searchregionsbyid) | **GET** /regions/{regionId} | Информация о регионе
[**searchRegionsByName**](OAIFbsApi.md#searchregionsbyname) | **GET** /regions | Поиск регионов по их имени
[**searchShipments**](OAIFbsApi.md#searchshipments) | **PUT** /campaigns/{campaignId}/first-mile/shipments | Получение информации о нескольких отгрузках
[**sendFileToChat**](OAIFbsApi.md#sendfiletochat) | **POST** /businesses/{businessId}/chats/file/send | Отправка файла в чат
[**sendMessageToChat**](OAIFbsApi.md#sendmessagetochat) | **POST** /businesses/{businessId}/chats/message | Отправка сообщения в чат
[**setFeedParams**](OAIFbsApi.md#setfeedparams) | **POST** /campaigns/{campaignId}/feeds/{feedId}/params | Изменение параметров прайс-листа
[**setOrderBoxLayout**](OAIFbsApi.md#setorderboxlayout) | **PUT** /campaigns/{campaignId}/orders/{orderId}/boxes | Подготовка заказа
[**setOrderShipmentBoxes**](OAIFbsApi.md#setordershipmentboxes) | **PUT** /campaigns/{campaignId}/orders/{orderId}/delivery/shipments/{shipmentId}/boxes | Передача количества грузовых мест в заказе
[**setShipmentPalletsCount**](OAIFbsApi.md#setshipmentpalletscount) | **PUT** /campaigns/{campaignId}/first-mile/shipments/{shipmentId}/pallets | Передача количества упаковок в отгрузке
[**skipGoodsFeedbacksReaction**](OAIFbsApi.md#skipgoodsfeedbacksreaction) | **POST** /businesses/{businessId}/goods-feedback/skip-reaction | Отказ от ответа на отзывы
[**transferOrdersFromShipment**](OAIFbsApi.md#transferordersfromshipment) | **POST** /campaigns/{campaignId}/first-mile/shipments/{shipmentId}/orders/transfer | Перенос заказов в следующую отгрузку
[**updateBusinessPrices**](OAIFbsApi.md#updatebusinessprices) | **POST** /businesses/{businessId}/offer-prices/updates | Установка цен на товары во всех магазинах
[**updateCampaignOffers**](OAIFbsApi.md#updatecampaignoffers) | **POST** /campaigns/{campaignId}/offers/update | Изменение условий продажи товаров в магазине
[**updateGoodsFeedbackComment**](OAIFbsApi.md#updategoodsfeedbackcomment) | **POST** /businesses/{businessId}/goods-feedback/comments/update | Добавление нового или изменение созданного комментария
[**updateOfferContent**](OAIFbsApi.md#updateoffercontent) | **POST** /businesses/{businessId}/offer-cards/update | Редактирование категорийных характеристик товара
[**updateOfferMappingEntries**](OAIFbsApi.md#updateoffermappingentries) | **POST** /campaigns/{campaignId}/offer-mapping-entries/updates | Добавление и редактирование товаров в каталоге
[**updateOfferMappings**](OAIFbsApi.md#updateoffermappings) | **POST** /businesses/{businessId}/offer-mappings/update | Добавление товаров в каталог и изменение информации о них
[**updateOrderItems**](OAIFbsApi.md#updateorderitems) | **PUT** /campaigns/{campaignId}/orders/{orderId}/items | Удаление товара из заказа или уменьшение числа единиц
[**updateOrderStatus**](OAIFbsApi.md#updateorderstatus) | **PUT** /campaigns/{campaignId}/orders/{orderId}/status | Изменение статуса одного заказа
[**updateOrderStatuses**](OAIFbsApi.md#updateorderstatuses) | **POST** /campaigns/{campaignId}/orders/status-update | Изменение статусов нескольких заказов
[**updatePrices**](OAIFbsApi.md#updateprices) | **POST** /campaigns/{campaignId}/offer-prices/updates | Установка цен на товары в конкретном магазине
[**updatePromoOffers**](OAIFbsApi.md#updatepromooffers) | **POST** /businesses/{businessId}/promos/offers/update | Добавление товаров в акцию или изменение их цен
[**updateStocks**](OAIFbsApi.md#updatestocks) | **PUT** /campaigns/{campaignId}/offers/stocks | Передача информации об остатках
...
OAIFbsApi*apiInstance = [[OAIFbsApi alloc] init];
...
[apiInstance addHiddenOffersWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIEmptyApiResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->addHiddenOffers: %@", error);
                        }
                    }];
```
...
[apiInstance addOffersToArchiveWithBusinessId:businessId
          ...
          completionHandler: ^(OAIAddOffersToArchiveResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->addOffersToArchive: %@", error);
                        }
                    }];
```
...
[apiInstance calculateTariffsWithCalculateTariffsRequest:calculateTariffsRequest
          completionHandler: ^(OAICalculateTariffsResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->calculateTariffs: %@", error);
                        }
                    }];
```
...
[apiInstance confirmBusinessPricesWithBusinessId:businessId
          ...
          completionHandler: ^(OAIEmptyApiResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->confirmBusinessPrices: %@", error);
                        }
                    }];
```
...
[apiInstance confirmCampaignPricesWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIEmptyApiResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->confirmCampaignPrices: %@", error);
                        }
                    }];
```
...
[apiInstance confirmShipmentWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIEmptyApiResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->confirmShipment: %@", error);
                        }
                    }];
```
...
[apiInstance createChatWithBusinessId:businessId
          ...
          completionHandler: ^(OAICreateChatResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->createChat: %@", error);
                        }
                    }];
```
...
[apiInstance deleteCampaignOffersWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIDeleteCampaignOffersResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->deleteCampaignOffers: %@", error);
                        }
                    }];
```
...
[apiInstance deleteGoodsFeedbackCommentWithBusinessId:businessId
          ...
          completionHandler: ^(OAIEmptyApiResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->deleteGoodsFeedbackComment: %@", error);
                        }
                    }];
```
...
[apiInstance deleteHiddenOffersWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIEmptyApiResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->deleteHiddenOffers: %@", error);
                        }
                    }];
```
...
[apiInstance deleteOffersWithBusinessId:businessId
          ...
          completionHandler: ^(OAIDeleteOffersResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->deleteOffers: %@", error);
                        }
                    }];
```
...
[apiInstance deleteOffersFromArchiveWithBusinessId:businessId
          ...
          completionHandler: ^(OAIDeleteOffersFromArchiveResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->deleteOffersFromArchive: %@", error);
                        }
                    }];
```
...
[apiInstance deletePromoOffersWithBusinessId:businessId
          ...
          completionHandler: ^(OAIDeletePromoOffersResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->deletePromoOffers: %@", error);
                        }
                    }];
```
...
[apiInstance downloadShipmentActWithCampaignId:campaignId
          ...
          completionHandler: ^(NSURL* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->downloadShipmentAct: %@", error);
                        }
                    }];
```
...
[apiInstance downloadShipmentDiscrepancyActWithCampaignId:campaignId
          ...
          completionHandler: ^(NSURL* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->downloadShipmentDiscrepancyAct: %@", error);
                        }
                    }];
```
...
[apiInstance downloadShipmentInboundActWithCampaignId:campaignId
          ...
          completionHandler: ^(NSURL* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->downloadShipmentInboundAct: %@", error);
                        }
                    }];
```
...
[apiInstance downloadShipmentPalletLabelsWithCampaignId:campaignId
          ...
          completionHandler: ^(NSURL* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->downloadShipmentPalletLabels: %@", error);
                        }
                    }];
```
...
[apiInstance downloadShipmentReceptionTransferActWithCampaignId:campaignId
          ...
          completionHandler: ^(NSURL* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->downloadShipmentReceptionTransferAct: %@", error);
                        }
                    }];
```
...
[apiInstance downloadShipmentTransportationWaybillWithCampaignId:campaignId
          ...
          completionHandler: ^(NSURL* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->downloadShipmentTransportationWaybill: %@", error);
                        }
                    }];
```
...
[apiInstance generateBoostConsolidatedReportWithGenerateBoostConsolidatedRequest:generateBoostConsolidatedRequest
          ...
          completionHandler: ^(OAIGenerateReportResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->generateBoostConsolidatedReport: %@", error);
                        }
                    }];
```
...
[apiInstance generateCompetitorsPositionReportWithGenerateCompetitorsPositionReportRequest:generateCompetitorsPositionReportRequest
          ...
          completionHandler: ^(OAIGenerateReportResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->generateCompetitorsPositionReport: %@", error);
                        }
                    }];
```
...
[apiInstance generateGoodsFeedbackReportWithGenerateGoodsFeedbackRequest:generateGoodsFeedbackRequest
          ...
          completionHandler: ^(OAIGenerateReportResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->generateGoodsFeedbackReport: %@", error);
                        }
                    }];
```
...
[apiInstance generateGoodsRealizationReportWithGenerateGoodsRealizationReportRequest:generateGoodsRealizationReportRequest
          ...
          completionHandler: ^(OAIGenerateReportResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->generateGoodsRealizationReport: %@", error);
                        }
                    }];
```
...
[apiInstance generateMassOrderLabelsReportWithGenerateMassOrderLabelsRequest:generateMassOrderLabelsRequest
          ...
          completionHandler: ^(OAIGenerateReportResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->generateMassOrderLabelsReport: %@", error);
                        }
                    }];
```
...
[apiInstance generateOrderLabelWithCampaignId:campaignId
          ...
          completionHandler: ^(NSURL* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->generateOrderLabel: %@", error);
                        }
                    }];
```
...
[apiInstance generateOrderLabelsWithCampaignId:campaignId
          ...
          completionHandler: ^(NSURL* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->generateOrderLabels: %@", error);
                        }
                    }];
```
...
[apiInstance generatePricesReportWithGeneratePricesReportRequest:generatePricesReportRequest
          ...
          completionHandler: ^(OAIGenerateReportResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->generatePricesReport: %@", error);
                        }
                    }];
```
...
[apiInstance generateShelfsStatisticsReportWithGenerateShelfsStatisticsRequest:generateShelfsStatisticsRequest
          ...
          completionHandler: ^(OAIGenerateReportResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->generateShelfsStatisticsReport: %@", error);
                        }
                    }];
```
...
[apiInstance generateShipmentListDocumentReportWithGenerateShipmentListDocumentReportRequest:generateShipmentListDocumentReportRequest
          completionHandler: ^(OAIGenerateReportResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->generateShipmentListDocumentReport: %@", error);
                        }
                    }];
```
...
[apiInstance generateShowsSalesReportWithGenerateShowsSalesReportRequest:generateShowsSalesReportRequest
          ...
          completionHandler: ^(OAIGenerateReportResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->generateShowsSalesReport: %@", error);
                        }
                    }];
```
...
[apiInstance generateStocksOnWarehousesReportWithGenerateStocksOnWarehousesReportRequest:generateStocksOnWarehousesReportRequest
          ...
          completionHandler: ^(OAIGenerateReportResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->generateStocksOnWarehousesReport: %@", error);
                        }
                    }];
```
...
[apiInstance generateUnitedMarketplaceServicesReportWithGenerateUnitedMarketplaceServicesReportRequest:generateUnitedMarketplaceServicesReportRequest
          ...
          completionHandler: ^(OAIGenerateReportResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->generateUnitedMarketplaceServicesReport: %@", error);
                        }
                    }];
```
...
[apiInstance generateUnitedNettingReportWithGenerateUnitedNettingReportRequest:generateUnitedNettingReportRequest
          ...
          completionHandler: ^(OAIGenerateReportResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->generateUnitedNettingReport: %@", error);
                        }
                    }];
```
...
[apiInstance generateUnitedOrdersReportWithGenerateUnitedOrdersRequest:generateUnitedOrdersRequest
          ...
          completionHandler: ^(OAIGenerateReportResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->generateUnitedOrdersReport: %@", error);
                        }
                    }];
```
...
[apiInstance getAllOffersWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIGetAllOffersResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->getAllOffers: %@", error);
                        }
                    }];
```
...
[apiInstance getBidsInfoForBusinessWithBusinessId:businessId
          ...
          completionHandler: ^(OAIGetBidsInfoResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->getBidsInfoForBusiness: %@", error);
                        }
                    }];
```
...
[apiInstance getBidsRecommendationsWithBusinessId:businessId
          ...
          completionHandler: ^(OAIGetBidsRecommendationsResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->getBidsRecommendations: %@", error);
                        }
                    }];
```
...
[apiInstance getBusinessQuarantineOffersWithBusinessId:businessId
          ...
          completionHandler: ^(OAIGetQuarantineOffersResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->getBusinessQuarantineOffers: %@", error);
                        }
                    }];
```
...
[apiInstance getBusinessSettingsWithBusinessId:businessId
          completionHandler: ^(OAIGetBusinessSettingsResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->getBusinessSettings: %@", error);
                        }
                    }];
```
...
[apiInstance getCampaignWithCampaignId:campaignId
          completionHandler: ^(OAIGetCampaignResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->getCampaign: %@", error);
                        }
                    }];
```
...
[apiInstance getCampaignLoginsWithCampaignId:campaignId
          completionHandler: ^(OAIGetCampaignLoginsResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->getCampaignLogins: %@", error);
                        }
                    }];
```
...
[apiInstance getCampaignOffersWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIGetCampaignOffersResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->getCampaignOffers: %@", error);
                        }
                    }];
```
...
[apiInstance getCampaignQuarantineOffersWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIGetQuarantineOffersResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->getCampaignQuarantineOffers: %@", error);
                        }
                    }];
```
...
[apiInstance getCampaignRegionWithCampaignId:campaignId
          completionHandler: ^(OAIGetCampaignRegionResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->getCampaignRegion: %@", error);
                        }
                    }];
```
...
[apiInstance getCampaignSettingsWithCampaignId:campaignId
          completionHandler: ^(OAIGetCampaignSettingsResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->getCampaignSettings: %@", error);
                        }
                    }];
```
...
[apiInstance getCampaignsWithPage:page
          ...
          completionHandler: ^(OAIGetCampaignsResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->getCampaigns: %@", error);
                        }
                    }];
```
...
[apiInstance getCampaignsByLoginWithLogin:login
          ...
          completionHandler: ^(OAIGetCampaignsResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->getCampaignsByLogin: %@", error);
                        }
                    }];
```
...
[apiInstance getCategoriesMaxSaleQuantumWithGetCategoriesMaxSaleQuantumRequest:getCategoriesMaxSaleQuantumRequest
          completionHandler: ^(OAIGetCategoriesMaxSaleQuantumResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->getCategoriesMaxSaleQuantum: %@", error);
                        }
                    }];
```
...
[apiInstance getCategoriesTreeWithGetCategoriesRequest:getCategoriesRequest
          completionHandler: ^(OAIGetCategoriesResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->getCategoriesTree: %@", error);
                        }
                    }];
```
...
[apiInstance getCategoryContentParametersWithCategoryId:categoryId
          completionHandler: ^(OAIGetCategoryContentParametersResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->getCategoryContentParameters: %@", error);
                        }
                    }];
```
...
[apiInstance getChatHistoryWithBusinessId:businessId
          ...
          completionHandler: ^(OAIGetChatHistoryResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->getChatHistory: %@", error);
                        }
                    }];
```
...
[apiInstance getChatsWithBusinessId:businessId
          ...
          completionHandler: ^(OAIGetChatsResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->getChats: %@", error);
                        }
                    }];
```
...
[apiInstance getDeliveryServicesWithCompletionHandler: 
          ^(OAIGetDeliveryServicesResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->getDeliveryServices: %@", error);
                        }
                    }];
```
...
[apiInstance getFeedWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIGetFeedResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->getFeed: %@", error);
                        }
                    }];
```
...
[apiInstance getFeedIndexLogsWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIGetFeedIndexLogsResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->getFeedIndexLogs: %@", error);
                        }
                    }];
```
...
[apiInstance getFeedbackAndCommentUpdatesWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIGetFeedbackListResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->getFeedbackAndCommentUpdates: %@", error);
                        }
                    }];
```
...
[apiInstance getFeedsWithCampaignId:campaignId
          completionHandler: ^(OAIGetFeedsResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->getFeeds: %@", error);
                        }
                    }];
```
...
[apiInstance getGoodsFeedbackCommentsWithBusinessId:businessId
          ...
          completionHandler: ^(OAIGetGoodsFeedbackCommentsResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->getGoodsFeedbackComments: %@", error);
                        }
                    }];
```
...
[apiInstance getGoodsFeedbacksWithBusinessId:businessId
          ...
          completionHandler: ^(OAIGetGoodsFeedbackResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->getGoodsFeedbacks: %@", error);
                        }
                    }];
```
...
[apiInstance getGoodsStatsWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIGetGoodsStatsResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->getGoodsStats: %@", error);
                        }
                    }];
```
...
[apiInstance getHiddenOffersWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIGetHiddenOffersResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->getHiddenOffers: %@", error);
                        }
                    }];
```
...
[apiInstance getOfferCardsContentStatusWithBusinessId:businessId
          ...
          completionHandler: ^(OAIGetOfferCardsContentStatusResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->getOfferCardsContentStatus: %@", error);
                        }
                    }];
```
...
[apiInstance getOfferMappingEntriesWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIGetOfferMappingEntriesResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->getOfferMappingEntries: %@", error);
                        }
                    }];
```
...
[apiInstance getOfferMappingsWithBusinessId:businessId
          ...
          completionHandler: ^(OAIGetOfferMappingsResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->getOfferMappings: %@", error);
                        }
                    }];
```
...
[apiInstance getOfferRecommendationsWithBusinessId:businessId
          ...
          completionHandler: ^(OAIGetOfferRecommendationsResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->getOfferRecommendations: %@", error);
                        }
                    }];
```
...
[apiInstance getOffersWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIGetOffersResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->getOffers: %@", error);
                        }
                    }];
```
...
[apiInstance getOrderWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIGetOrderResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->getOrder: %@", error);
                        }
                    }];
```
...
[apiInstance getOrderBusinessBuyerInfoWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIGetBusinessBuyerInfoResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->getOrderBusinessBuyerInfo: %@", error);
                        }
                    }];
```
...
[apiInstance getOrderBusinessDocumentsInfoWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIGetBusinessDocumentsInfoResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->getOrderBusinessDocumentsInfo: %@", error);
                        }
                    }];
```
...
[apiInstance getOrderLabelsDataWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIGetOrderLabelsDataResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->getOrderLabelsData: %@", error);
                        }
                    }];
```
...
[apiInstance getOrdersWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIGetOrdersResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->getOrders: %@", error);
                        }
                    }];
```
...
[apiInstance getOrdersStatsWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIGetOrdersStatsResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->getOrdersStats: %@", error);
                        }
                    }];
```
...
[apiInstance getPricesWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIGetPricesResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->getPrices: %@", error);
                        }
                    }];
```
...
[apiInstance getPricesByOfferIdsWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIGetPricesByOfferIdsResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->getPricesByOfferIds: %@", error);
                        }
                    }];
```
...
[apiInstance getPromoOffersWithBusinessId:businessId
          ...
          completionHandler: ^(OAIGetPromoOffersResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->getPromoOffers: %@", error);
                        }
                    }];
```
...
[apiInstance getPromosWithBusinessId:businessId
          ...
          completionHandler: ^(OAIGetPromosResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->getPromos: %@", error);
                        }
                    }];
```
...
[apiInstance getQualityRatingDetailsWithCampaignId:campaignId
          completionHandler: ^(OAIGetQualityRatingDetailsResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->getQualityRatingDetails: %@", error);
                        }
                    }];
```
...
[apiInstance getQualityRatingsWithBusinessId:businessId
          ...
          completionHandler: ^(OAIGetQualityRatingResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->getQualityRatings: %@", error);
                        }
                    }];
```
...
[apiInstance getReportInfoWithReportId:reportId
          completionHandler: ^(OAIGetReportInfoResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->getReportInfo: %@", error);
                        }
                    }];
```
...
[apiInstance getReturnWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIGetReturnResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->getReturn: %@", error);
                        }
                    }];
```
...
[apiInstance getReturnApplicationWithCampaignId:campaignId
          ...
          completionHandler: ^(NSURL* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->getReturnApplication: %@", error);
                        }
                    }];
```
...
[apiInstance getReturnPhotoWithCampaignId:campaignId
          ...
          completionHandler: ^(NSURL* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->getReturnPhoto: %@", error);
                        }
                    }];
```
...
[apiInstance getReturnsWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIGetReturnsResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->getReturns: %@", error);
                        }
                    }];
```
...
[apiInstance getShipmentWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIGetShipmentResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->getShipment: %@", error);
                        }
                    }];
```
...
[apiInstance getShipmentOrdersInfoWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIGetShipmentOrdersInfoResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->getShipmentOrdersInfo: %@", error);
                        }
                    }];
```
...
[apiInstance getStocksWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIGetWarehouseStocksResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->getStocks: %@", error);
                        }
                    }];
```
...
[apiInstance getSuggestedOfferMappingEntriesWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIGetSuggestedOfferMappingEntriesResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->getSuggestedOfferMappingEntries: %@", error);
                        }
                    }];
```
...
[apiInstance getSuggestedOfferMappingsWithBusinessId:businessId
          ...
          completionHandler: ^(OAIGetSuggestedOfferMappingsResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->getSuggestedOfferMappings: %@", error);
                        }
                    }];
```
...
[apiInstance getSuggestedPricesWithCampaignId:campaignId
          ...
          completionHandler: ^(OAISuggestPricesResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->getSuggestedPrices: %@", error);
                        }
                    }];
```
...
[apiInstance getWarehousesWithBusinessId:businessId
          completionHandler: ^(OAIGetWarehousesResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->getWarehouses: %@", error);
                        }
                    }];
```
...
[apiInstance provideOrderItemIdentifiersWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIProvideOrderItemIdentifiersResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->provideOrderItemIdentifiers: %@", error);
                        }
                    }];
```
...
[apiInstance putBidsForBusinessWithBusinessId:businessId
          ...
          completionHandler: ^(OAIEmptyApiResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->putBidsForBusiness: %@", error);
                        }
                    }];
```
...
[apiInstance putBidsForCampaignWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIEmptyApiResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->putBidsForCampaign: %@", error);
                        }
                    }];
```
...
[apiInstance refreshFeedWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIEmptyApiResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->refreshFeed: %@", error);
                        }
                    }];
```
...
[apiInstance searchRegionChildrenWithRegionId:regionId
          ...
          completionHandler: ^(OAIGetRegionWithChildrenResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->searchRegionChildren: %@", error);
                        }
                    }];
```
...
[apiInstance searchRegionsByIdWithRegionId:regionId
          completionHandler: ^(OAIGetRegionsResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->searchRegionsById: %@", error);
                        }
                    }];
```
...
[apiInstance searchRegionsByNameWithName:name
          ...
          completionHandler: ^(OAIGetRegionsResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->searchRegionsByName: %@", error);
                        }
                    }];
```
...
[apiInstance searchShipmentsWithCampaignId:campaignId
          ...
          completionHandler: ^(OAISearchShipmentsResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->searchShipments: %@", error);
                        }
                    }];
```
...
[apiInstance sendFileToChatWithBusinessId:businessId
          ...
          completionHandler: ^(OAIEmptyApiResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->sendFileToChat: %@", error);
                        }
                    }];
```
...
[apiInstance sendMessageToChatWithBusinessId:businessId
          ...
          completionHandler: ^(OAIEmptyApiResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->sendMessageToChat: %@", error);
                        }
                    }];
```
...
[apiInstance setFeedParamsWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIEmptyApiResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->setFeedParams: %@", error);
                        }
                    }];
```
...
[apiInstance setOrderBoxLayoutWithCampaignId:campaignId
          ...
          completionHandler: ^(OAISetOrderBoxLayoutResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->setOrderBoxLayout: %@", error);
                        }
                    }];
```
...
[apiInstance setOrderShipmentBoxesWithCampaignId:campaignId
          ...
          completionHandler: ^(OAISetOrderShipmentBoxesResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->setOrderShipmentBoxes: %@", error);
                        }
                    }];
```
...
[apiInstance setShipmentPalletsCountWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIEmptyApiResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->setShipmentPalletsCount: %@", error);
                        }
                    }];
```
...
[apiInstance skipGoodsFeedbacksReactionWithBusinessId:businessId
          ...
          completionHandler: ^(OAIEmptyApiResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->skipGoodsFeedbacksReaction: %@", error);
                        }
                    }];
```
...
[apiInstance transferOrdersFromShipmentWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIEmptyApiResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->transferOrdersFromShipment: %@", error);
                        }
                    }];
```
...
[apiInstance updateBusinessPricesWithBusinessId:businessId
          ...
          completionHandler: ^(OAIEmptyApiResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->updateBusinessPrices: %@", error);
                        }
                    }];
```
...
[apiInstance updateCampaignOffersWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIEmptyApiResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->updateCampaignOffers: %@", error);
                        }
                    }];
```
...
[apiInstance updateGoodsFeedbackCommentWithBusinessId:businessId
          ...
          completionHandler: ^(OAIUpdateGoodsFeedbackCommentResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->updateGoodsFeedbackComment: %@", error);
                        }
                    }];
```
...
[apiInstance updateOfferContentWithBusinessId:businessId
          ...
          completionHandler: ^(OAIUpdateOfferContentResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->updateOfferContent: %@", error);
                        }
                    }];
```
...
[apiInstance updateOfferMappingEntriesWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIEmptyApiResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->updateOfferMappingEntries: %@", error);
                        }
                    }];
```
...
[apiInstance updateOfferMappingsWithBusinessId:businessId
          ...
          completionHandler: ^(OAIUpdateOfferMappingsResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->updateOfferMappings: %@", error);
                        }
                    }];
```
...
[apiInstance updateOrderItemsWithCampaignId:campaignId
          ...
          completionHandler: ^(NSError* error) {
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->updateOrderItems: %@", error);
                        }
                    }];
```
...
[apiInstance updateOrderStatusWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIUpdateOrderStatusResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->updateOrderStatus: %@", error);
                        }
                    }];
```
...
[apiInstance updateOrderStatusesWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIUpdateOrderStatusesResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->updateOrderStatuses: %@", error);
                        }
                    }];
```
...
[apiInstance updatePricesWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIEmptyApiResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->updatePrices: %@", error);
                        }
                    }];
```
...
[apiInstance updatePromoOffersWithBusinessId:businessId
          ...
          completionHandler: ^(OAIUpdatePromoOffersResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->updatePromoOffers: %@", error);
                        }
                    }];
```
...
[apiInstance updateStocksWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIEmptyApiResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIFbsApi->updateStocks: %@", error);
                        }
                    }];
```
