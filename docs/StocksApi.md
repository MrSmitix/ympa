# ympa_python_pydantic_v1_client.StocksApi
...
with ympa_python_pydantic_v1_client.ApiClient(configuration) as api_client:
    ...
    api_instance = ympa_python_pydantic_v1_client.StocksApi(api_client)
    ...
    try:
        ...
        print("The response of StocksApi->get_stocks:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling StocksApi->get_stocks: %s\n" % e)
```
...
with ympa_python_pydantic_v1_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of StocksApi->update_stocks:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling StocksApi->update_stocks: %s\n" % e)
```
