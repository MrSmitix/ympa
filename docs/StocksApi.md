# WWW::OpenAPIClient::StocksApi

## Load the API package
```perl
use WWW::OpenAPIClient::Object::StocksApi;
```
...
if ($@) {
    warn "Exception when calling StocksApi->get_stocks: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling StocksApi->update_stocks: $@\n";
}
```
