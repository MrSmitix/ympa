...
------------- | ------------- | -------------
[**createOutlet**](OAIOutletsApi.md#createoutlet) | **POST** /campaigns/{campaignId}/outlets | Создание точки продаж
[**deleteOutlet**](OAIOutletsApi.md#deleteoutlet) | **DELETE** /campaigns/{campaignId}/outlets/{outletId} | Удаление точки продаж
[**getOutlet**](OAIOutletsApi.md#getoutlet) | **GET** /campaigns/{campaignId}/outlets/{outletId} | Информация об одной точке продаж
[**getOutlets**](OAIOutletsApi.md#getoutlets) | **GET** /campaigns/{campaignId}/outlets | Информация о нескольких точках продаж
[**updateOutlet**](OAIOutletsApi.md#updateoutlet) | **PUT** /campaigns/{campaignId}/outlets/{outletId} | Изменение информации о точке продаж
...
OAIOutletsApi*apiInstance = [[OAIOutletsApi alloc] init];
...
[apiInstance createOutletWithCampaignId:campaignId
          ...
          completionHandler: ^(OAICreateOutletResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIOutletsApi->createOutlet: %@", error);
                        }
                    }];
```
...
[apiInstance deleteOutletWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIEmptyApiResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIOutletsApi->deleteOutlet: %@", error);
                        }
                    }];
```
...
[apiInstance getOutletWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIGetOutletResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIOutletsApi->getOutlet: %@", error);
                        }
                    }];
```
...
[apiInstance getOutletsWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIGetOutletsResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIOutletsApi->getOutlets: %@", error);
                        }
                    }];
```
...
[apiInstance updateOutletWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIEmptyApiResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIOutletsApi->updateOutlet: %@", error);
                        }
                    }];
```
