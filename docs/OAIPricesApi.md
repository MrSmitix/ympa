...
------------- | ------------- | -------------
[**getPrices**](OAIPricesApi.md#getprices) | **GET** /campaigns/{campaignId}/offer-prices | Список цен
[**getPricesByOfferIds**](OAIPricesApi.md#getpricesbyofferids) | **POST** /campaigns/{campaignId}/offer-prices | Просмотр цен на указанные товары в магазине
[**getSuggestedPrices**](OAIPricesApi.md#getsuggestedprices) | **POST** /campaigns/{campaignId}/offer-prices/suggestions | Цены для продвижения товаров
[**updateBusinessPrices**](OAIPricesApi.md#updatebusinessprices) | **POST** /businesses/{businessId}/offer-prices/updates | Установка цен на товары во всех магазинах
[**updatePrices**](OAIPricesApi.md#updateprices) | **POST** /campaigns/{campaignId}/offer-prices/updates | Установка цен на товары в конкретном магазине
...
OAIPricesApi*apiInstance = [[OAIPricesApi alloc] init];
...
[apiInstance getPricesWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIGetPricesResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIPricesApi->getPrices: %@", error);
                        }
                    }];
```
...
[apiInstance getPricesByOfferIdsWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIGetPricesByOfferIdsResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIPricesApi->getPricesByOfferIds: %@", error);
                        }
                    }];
```
...
[apiInstance getSuggestedPricesWithCampaignId:campaignId
          ...
          completionHandler: ^(OAISuggestPricesResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIPricesApi->getSuggestedPrices: %@", error);
                        }
                    }];
```
...
[apiInstance updateBusinessPricesWithBusinessId:businessId
          ...
          completionHandler: ^(OAIEmptyApiResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIPricesApi->updateBusinessPrices: %@", error);
                        }
                    }];
```
...
[apiInstance updatePricesWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIEmptyApiResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIPricesApi->updatePrices: %@", error);
                        }
                    }];
```
