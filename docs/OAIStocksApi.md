...
------------- | ------------- | -------------
[**getStocks**](OAIStocksApi.md#getstocks) | **POST** /campaigns/{campaignId}/offers/stocks | Информация об остатках и оборачиваемости
[**updateStocks**](OAIStocksApi.md#updatestocks) | **PUT** /campaigns/{campaignId}/offers/stocks | Передача информации об остатках
...
OAIStocksApi*apiInstance = [[OAIStocksApi alloc] init];
...
[apiInstance getStocksWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIGetWarehouseStocksResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIStocksApi->getStocks: %@", error);
                        }
                    }];
```
...
[apiInstance updateStocksWithCampaignId:campaignId
          ...
          completionHandler: ^(OAIEmptyApiResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling OAIStocksApi->updateStocks: %@", error);
                        }
                    }];
```
