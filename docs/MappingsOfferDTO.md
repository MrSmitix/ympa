...
# Table `MappingsOfferDTO`
(mapped from: MappingsOfferDTO)
...
# **Table `MappingsOfferDTOBarcodes`**
(mapped from: MappingsOfferDTOBarcodes)

## Properties
Name | Mapping | SQL Type | Default | Type | Description | Notes
---- | ------- | -------- | ------- | ---- | ----------- | -----
mappingsOfferDTO | mappingsOfferDTO | long | | kotlin.Long | Primary Key | *one*
barcodes | barcodes | text | | kotlin.String | Foreign Key | *many*



# **Table `MappingsOfferDTOUrls`**
(mapped from: MappingsOfferDTOUrls)
...
# **Table `MappingsOfferDTOPictures`**
(mapped from: MappingsOfferDTOPictures)
...
# **Table `MappingsOfferDTOManufacturerCountries`**
(mapped from: MappingsOfferDTOManufacturerCountries)
...
# **Table `MappingsOfferDTOCustomsCommodityCodes`**
(mapped from: MappingsOfferDTOCustomsCommodityCodes)
...
# **Table `MappingsOfferDTODayOfWeekType`**
(mapped from: MappingsOfferDTODayOfWeekType)
