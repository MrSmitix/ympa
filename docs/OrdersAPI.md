...
// Отмена заказа покупателем
OrdersAPI.acceptOrderCancellation(campaignId: campaignId, orderId: orderId, acceptOrderCancellationRequest: acceptOrderCancellationRequest) { (response, error) in
...
// Информация об одном заказе
OrdersAPI.getOrder(campaignId: campaignId, orderId: orderId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Передача ключей цифровых товаров
OrdersAPI.provideOrderDigitalCodes(campaignId: campaignId, orderId: orderId, provideOrderDigitalCodesRequest: provideOrderDigitalCodesRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Передача кодов маркировки единиц товара
OrdersAPI.provideOrderItemIdentifiers(campaignId: campaignId, orderId: orderId, provideOrderItemIdentifiersRequest: provideOrderItemIdentifiersRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Подготовка заказа
OrdersAPI.setOrderBoxLayout(campaignId: campaignId, orderId: orderId, setOrderBoxLayoutRequest: setOrderBoxLayoutRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Передача количества грузовых мест в заказе
OrdersAPI.setOrderShipmentBoxes(campaignId: campaignId, orderId: orderId, shipmentId: shipmentId, setOrderShipmentBoxesRequest: setOrderShipmentBoxesRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Удаление товара из заказа или уменьшение числа единиц
OrdersAPI.updateOrderItems(campaignId: campaignId, orderId: orderId, updateOrderItemRequest: updateOrderItemRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Изменение статуса одного заказа
OrdersAPI.updateOrderStatus(campaignId: campaignId, orderId: orderId, updateOrderStatusRequest: updateOrderStatusRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Изменение статусов нескольких заказов
OrdersAPI.updateOrderStatuses(campaignId: campaignId, updateOrderStatusesRequest: updateOrderStatusesRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
