# ympa_python_pydantic_v1_client.ReportsApi
...
with ympa_python_pydantic_v1_client.ApiClient(configuration) as api_client:
    ...
    api_instance = ympa_python_pydantic_v1_client.ReportsApi(api_client)
...
with ympa_python_pydantic_v1_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = ympa_python_pydantic_v1_client.ReportsApi(api_client)
    generate_goods_movement_report_request = ympa_python_pydantic_v1_client.GenerateGoodsMovementReportRequest() # GenerateGoodsMovementReportRequest | 
    format = ympa_python_pydantic_v1_client.ReportFormatType() # ReportFormatType | Формат отчета. (optional)
...
with ympa_python_pydantic_v1_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = ympa_python_pydantic_v1_client.ReportsApi(api_client)
    generate_goods_turnover_request = ympa_python_pydantic_v1_client.GenerateGoodsTurnoverRequest() # GenerateGoodsTurnoverRequest | 
    format = ympa_python_pydantic_v1_client.ReportFormatType() # ReportFormatType | Формат отчета. (optional)
