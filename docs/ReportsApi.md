...
[**generateBoostConsolidatedReportWithHttpInfo**](ReportsApi.md#generateBoostConsolidatedReportWithHttpInfo) | **POST** /reports/boost-consolidated/generate | Отчет по бусту продаж
...
[**generateCompetitorsPositionReportWithHttpInfo**](ReportsApi.md#generateCompetitorsPositionReportWithHttpInfo) | **POST** /reports/competitors-position/generate | Отчет «Конкурентная позиция»
...
[**generateGoodsFeedbackReportWithHttpInfo**](ReportsApi.md#generateGoodsFeedbackReportWithHttpInfo) | **POST** /reports/goods-feedback/generate | Отчет по отзывам о товарах
...
[**generateGoodsMovementReportWithHttpInfo**](ReportsApi.md#generateGoodsMovementReportWithHttpInfo) | **POST** /reports/goods-movement/generate | Отчет по движению товаров
...
[**generateGoodsRealizationReportWithHttpInfo**](ReportsApi.md#generateGoodsRealizationReportWithHttpInfo) | **POST** /reports/goods-realization/generate | Отчет по реализации
...
[**generateGoodsTurnoverReportWithHttpInfo**](ReportsApi.md#generateGoodsTurnoverReportWithHttpInfo) | **POST** /reports/goods-turnover/generate | Отчет по оборачиваемости
...
[**generateMassOrderLabelsReportWithHttpInfo**](ReportsApi.md#generateMassOrderLabelsReportWithHttpInfo) | **POST** /reports/documents/labels/generate | Готовые ярлыки‑наклейки на все коробки в нескольких заказах
[**generatePricesReport**](ReportsApi.md#generatePricesReport) | **POST** /reports/prices/generate | Отчет «Цены на рынке»
[**generatePricesReportWithHttpInfo**](ReportsApi.md#generatePricesReportWithHttpInfo) | **POST** /reports/prices/generate | Отчет «Цены на рынке»
...
[**generateShelfsStatisticsReportWithHttpInfo**](ReportsApi.md#generateShelfsStatisticsReportWithHttpInfo) | **POST** /reports/shelf-statistics/generate | Отчет по полкам
...
[**generateShipmentListDocumentReportWithHttpInfo**](ReportsApi.md#generateShipmentListDocumentReportWithHttpInfo) | **POST** /reports/documents/shipment-list/generate | Получение листа сборки
[**generateShowsSalesReport**](ReportsApi.md#generateShowsSalesReport) | **POST** /reports/shows-sales/generate | Отчет «Аналитика продаж»
[**generateShowsSalesReportWithHttpInfo**](ReportsApi.md#generateShowsSalesReportWithHttpInfo) | **POST** /reports/shows-sales/generate | Отчет «Аналитика продаж»
...
[**generateStocksOnWarehousesReportWithHttpInfo**](ReportsApi.md#generateStocksOnWarehousesReportWithHttpInfo) | **POST** /reports/stocks-on-warehouses/generate | Отчет по остаткам на складах
...
[**generateUnitedMarketplaceServicesReportWithHttpInfo**](ReportsApi.md#generateUnitedMarketplaceServicesReportWithHttpInfo) | **POST** /reports/united-marketplace-services/generate | Отчет по стоимости услуг
...
[**generateUnitedNettingReportWithHttpInfo**](ReportsApi.md#generateUnitedNettingReportWithHttpInfo) | **POST** /reports/united-netting/generate | Отчет по платежам
[**generateUnitedOrdersReport**](ReportsApi.md#generateUnitedOrdersReport) | **POST** /reports/united-orders/generate | Отчет по заказам
[**generateUnitedOrdersReportWithHttpInfo**](ReportsApi.md#generateUnitedOrdersReportWithHttpInfo) | **POST** /reports/united-orders/generate | Отчет по заказам
[**getReportInfo**](ReportsApi.md#getReportInfo) | **GET** /reports/info/{reportId} | Получение заданного отчета
[**getReportInfoWithHttpInfo**](ReportsApi.md#getReportInfoWithHttpInfo) | **GET** /reports/info/{reportId} | Получение заданного отчета
...
object Example extends App {
    ...
    val apiInstance = ReportsApi("https://api.partner.market.yandex.ru")
