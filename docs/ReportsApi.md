...
> generate_shipment_list_document_report(req::HTTP.Request, generate_shipment_list_document_report_request::GenerateShipmentListDocumentReportRequest;) -> GenerateReportResponse
