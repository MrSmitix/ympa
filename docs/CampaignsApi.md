...
if ($@) {
    warn "Exception when calling CampaignsApi->get_campaign_logins: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling CampaignsApi->get_campaign_region: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling CampaignsApi->get_campaign_settings: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling CampaignsApi->get_campaigns_by_login: $@\n";
}
```
