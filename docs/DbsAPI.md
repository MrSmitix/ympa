...
```swift
    open class func acceptOrderCancellation(campaignId: Int64, orderId: Int64, acceptOrderCancellationRequest: AcceptOrderCancellationRequest, completion: @escaping (_ data: EmptyApiResponse?, _ error: Error?) -> Void)
```
...
let acceptOrderCancellationRequest = AcceptOrderCancellationRequest(accepted: false, reason: OrderCancellationReasonType()) // AcceptOrderCancellationRequest | 

// Отмена заказа покупателем
DbsAPI.acceptOrderCancellation(campaignId: campaignId, orderId: orderId, acceptOrderCancellationRequest: acceptOrderCancellationRequest) { (response, error) in
...
// Скрытие товаров и настройки скрытия
DbsAPI.addHiddenOffers(campaignId: campaignId, addHiddenOffersRequest: addHiddenOffersRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Добавление товаров в архив
DbsAPI.addOffersToArchive(businessId: businessId, addOffersToArchiveRequest: addOffersToArchiveRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Калькулятор стоимости услуг
DbsAPI.calculateTariffs(calculateTariffsRequest: calculateTariffsRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Удаление товара из карантина по цене в кабинете
DbsAPI.confirmBusinessPrices(businessId: businessId, confirmPricesRequest: confirmPricesRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Удаление товара из карантина по цене в магазине
DbsAPI.confirmCampaignPrices(campaignId: campaignId, confirmPricesRequest: confirmPricesRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Создание нового чата с покупателем
DbsAPI.createChat(businessId: businessId, createChatRequest: createChatRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Создание точки продаж
DbsAPI.createOutlet(campaignId: campaignId, changeOutletRequest: changeOutletRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Удаление товаров из ассортимента магазина
DbsAPI.deleteCampaignOffers(campaignId: campaignId, deleteCampaignOffersRequest: deleteCampaignOffersRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Удаление комментария к отзыву
DbsAPI.deleteGoodsFeedbackComment(businessId: businessId, deleteGoodsFeedbackCommentRequest: deleteGoodsFeedbackCommentRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Возобновление показа товаров
DbsAPI.deleteHiddenOffers(campaignId: campaignId, deleteHiddenOffersRequest: deleteHiddenOffersRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Удаление товаров из каталога
DbsAPI.deleteOffers(businessId: businessId, deleteOffersRequest: deleteOffersRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Удаление товаров из архива
DbsAPI.deleteOffersFromArchive(businessId: businessId, deleteOffersFromArchiveRequest: deleteOffersFromArchiveRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Удаление точки продаж
DbsAPI.deleteOutlet(campaignId: campaignId, outletId: outletId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Удаление лицензий для точек продаж
DbsAPI.deleteOutletLicenses(campaignId: campaignId, ids: ids) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Удаление товаров из акции
DbsAPI.deletePromoOffers(businessId: businessId, deletePromoOffersRequest: deletePromoOffersRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Отчет по бусту продаж
DbsAPI.generateBoostConsolidatedReport(generateBoostConsolidatedRequest: generateBoostConsolidatedRequest, format: format) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Отчет «Конкурентная позиция»
DbsAPI.generateCompetitorsPositionReport(generateCompetitorsPositionReportRequest: generateCompetitorsPositionReportRequest, format: format) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Отчет по отзывам о товарах
DbsAPI.generateGoodsFeedbackReport(generateGoodsFeedbackRequest: generateGoodsFeedbackRequest, format: format) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Готовые ярлыки‑наклейки на все коробки в нескольких заказах
DbsAPI.generateMassOrderLabelsReport(generateMassOrderLabelsRequest: generateMassOrderLabelsRequest, format: format) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **generateOrderLabel**
```swift
    open class func generateOrderLabel(campaignId: Int64, orderId: Int64, shipmentId: Int64, boxId: Int64, format: PageFormatType? = nil, completion: @escaping (_ data: URL?, _ error: Error?) -> Void)
```
...
let campaignId = 987 // Int64 | Идентификатор кампании в API и магазина в кабинете. Каждая кампания в API соответствует магазину в кабинете.  Чтобы узнать идентификаторы своих магазинов, воспользуйтесь запросом [GET campaigns](../../reference/campaigns/getCampaigns.md).  ℹ️ [Что такое кабинет и магазин на Маркете](https://yandex.ru/support/marketplace/account/introduction.html) 
let orderId = 987 // Int64 | Идентификатор заказа.
let shipmentId = 987 // Int64 | Идентификатор грузоместа.
let boxId = 987 // Int64 | Идентификатор коробки.
let format = PageFormatType() // PageFormatType | Настройка размещения ярлыков на странице. Если параметра нет, возвращается PDF с ярлыками формата A6. (optional)

// Готовый ярлык‑наклейка для коробки в заказе
DbsAPI.generateOrderLabel(campaignId: campaignId, orderId: orderId, shipmentId: shipmentId, boxId: boxId, format: format) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **generateOrderLabels**
```swift
    open class func generateOrderLabels(campaignId: Int64, orderId: Int64, format: PageFormatType? = nil, completion: @escaping (_ data: URL?, _ error: Error?) -> Void)
```
...
// Готовые ярлыки‑наклейки на все коробки в одном заказе
DbsAPI.generateOrderLabels(campaignId: campaignId, orderId: orderId, format: format) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Отчет «Цены на рынке»
DbsAPI.generatePricesReport(generatePricesReportRequest: generatePricesReportRequest, format: format) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Отчет по полкам
DbsAPI.generateShelfsStatisticsReport(generateShelfsStatisticsRequest: generateShelfsStatisticsRequest, format: format) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Отчет «Аналитика продаж»
DbsAPI.generateShowsSalesReport(generateShowsSalesReportRequest: generateShowsSalesReportRequest, format: format) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Отчет по остаткам на складах
DbsAPI.generateStocksOnWarehousesReport(generateStocksOnWarehousesReportRequest: generateStocksOnWarehousesReportRequest, format: format) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Отчет по стоимости услуг
DbsAPI.generateUnitedMarketplaceServicesReport(generateUnitedMarketplaceServicesReportRequest: generateUnitedMarketplaceServicesReportRequest, format: format) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Отчет по платежам
DbsAPI.generateUnitedNettingReport(generateUnitedNettingReportRequest: generateUnitedNettingReportRequest, format: format) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Отчет по заказам
DbsAPI.generateUnitedOrdersReport(generateUnitedOrdersRequest: generateUnitedOrdersRequest, format: format) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Все предложения магазина
DbsAPI.getAllOffers(campaignId: campaignId, feedId: feedId, chunk: chunk) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Информация об установленных ставках
DbsAPI.getBidsInfoForBusiness(businessId: businessId, pageToken: pageToken, limit: limit, getBidsInfoRequest: getBidsInfoRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Рекомендованные ставки для заданных товаров
DbsAPI.getBidsRecommendations(businessId: businessId, getBidsRecommendationsRequest: getBidsRecommendationsRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Список товаров, находящихся в карантине по цене в кабинете
DbsAPI.getBusinessQuarantineOffers(businessId: businessId, getQuarantineOffersRequest: getQuarantineOffersRequest, pageToken: pageToken, limit: limit) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Настройки кабинета
DbsAPI.getBusinessSettings(businessId: businessId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Информация о магазине
DbsAPI.getCampaign(campaignId: campaignId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Логины, связанные с магазином
DbsAPI.getCampaignLogins(campaignId: campaignId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Информация о товарах, которые размещены в заданном магазине
DbsAPI.getCampaignOffers(campaignId: campaignId, getCampaignOffersRequest: getCampaignOffersRequest, pageToken: pageToken, limit: limit) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Список товаров, находящихся в карантине по цене в магазине
DbsAPI.getCampaignQuarantineOffers(campaignId: campaignId, getQuarantineOffersRequest: getQuarantineOffersRequest, pageToken: pageToken, limit: limit) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Регион магазина
DbsAPI.getCampaignRegion(campaignId: campaignId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Настройки магазина
DbsAPI.getCampaignSettings(campaignId: campaignId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Список магазинов пользователя
DbsAPI.getCampaigns(page: page, pageSize: pageSize) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Магазины, доступные логину
DbsAPI.getCampaignsByLogin(login: login, page: page, pageSize: pageSize) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Лимит на установку кванта продажи и минимального количества товаров в заказе
DbsAPI.getCategoriesMaxSaleQuantum(getCategoriesMaxSaleQuantumRequest: getCategoriesMaxSaleQuantumRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Дерево категорий
DbsAPI.getCategoriesTree(getCategoriesRequest: getCategoriesRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Списки характеристик товаров по категориям
DbsAPI.getCategoryContentParameters(categoryId: categoryId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Получение истории сообщений в чате
DbsAPI.getChatHistory(businessId: businessId, chatId: chatId, getChatHistoryRequest: getChatHistoryRequest, pageToken: pageToken, limit: limit) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Получение доступных чатов
DbsAPI.getChats(businessId: businessId, getChatsRequest: getChatsRequest, pageToken: pageToken, limit: limit) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Справочник служб доставки
DbsAPI.getDeliveryServices() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Информация о прайс-листе
DbsAPI.getFeed(campaignId: campaignId, feedId: feedId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Отчет по индексации прайс-листа
DbsAPI.getFeedIndexLogs(campaignId: campaignId, feedId: feedId, limit: limit, publishedTimeFrom: publishedTimeFrom, publishedTimeTo: publishedTimeTo, status: status) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Новые и обновленные отзывы о магазине
DbsAPI.getFeedbackAndCommentUpdates(campaignId: campaignId, pageToken: pageToken, limit: limit, fromDate: fromDate) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Список прайс-листов магазина
DbsAPI.getFeeds(campaignId: campaignId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Получение комментариев к отзыву
DbsAPI.getGoodsFeedbackComments(businessId: businessId, getGoodsFeedbackCommentsRequest: getGoodsFeedbackCommentsRequest, pageToken: pageToken, limit: limit) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Получение отзывов о товарах продавца
DbsAPI.getGoodsFeedbacks(businessId: businessId, pageToken: pageToken, limit: limit, getGoodsFeedbackRequest: getGoodsFeedbackRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Отчет по товарам
DbsAPI.getGoodsStats(campaignId: campaignId, getGoodsStatsRequest: getGoodsStatsRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Информация о скрытых вами товарах
DbsAPI.getHiddenOffers(campaignId: campaignId, offerId: offerId, pageToken: pageToken, limit: limit, offset: offset, page: page, pageSize: pageSize) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Информация об одной модели
DbsAPI.getModel(modelId: modelId, regionId: regionId, currency: currency) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Список предложений для одной модели
DbsAPI.getModelOffers(modelId: modelId, regionId: regionId, currency: currency, orderByPrice: orderByPrice, count: count, page: page) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Информация о нескольких моделях
DbsAPI.getModels(regionId: regionId, getModelsRequest: getModelsRequest, currency: currency) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Список предложений для нескольких моделей
DbsAPI.getModelsOffers(regionId: regionId, getModelsRequest: getModelsRequest, currency: currency, orderByPrice: orderByPrice) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Получение информации о заполненности карточек магазина
DbsAPI.getOfferCardsContentStatus(businessId: businessId, pageToken: pageToken, limit: limit, getOfferCardsContentStatusRequest: getOfferCardsContentStatusRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Список товаров в каталоге
DbsAPI.getOfferMappingEntries(campaignId: campaignId, offerId: offerId, shopSku: shopSku, mappingKind: mappingKind, status: status, availability: availability, categoryId: categoryId, vendor: vendor, pageToken: pageToken, limit: limit) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Информация о товарах в каталоге
DbsAPI.getOfferMappings(businessId: businessId, pageToken: pageToken, limit: limit, getOfferMappingsRequest: getOfferMappingsRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Рекомендации Маркета, касающиеся цен
DbsAPI.getOfferRecommendations(businessId: businessId, getOfferRecommendationsRequest: getOfferRecommendationsRequest, pageToken: pageToken, limit: limit) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Предложения магазина
DbsAPI.getOffers(campaignId: campaignId, query: query, feedId: feedId, shopCategoryId: shopCategoryId, currency: currency, matched: matched, page: page, pageSize: pageSize) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Информация об одном заказе
DbsAPI.getOrder(campaignId: campaignId, orderId: orderId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Информация о покупателе — юридическом лице
DbsAPI.getOrderBusinessBuyerInfo(campaignId: campaignId, orderId: orderId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Информация о документах
DbsAPI.getOrderBusinessDocumentsInfo(campaignId: campaignId, orderId: orderId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **getOrderBuyerInfo**
```swift
    open class func getOrderBuyerInfo(campaignId: Int64, orderId: Int64, completion: @escaping (_ data: GetOrderBuyerInfoResponse?, _ error: Error?) -> Void)
```
...
// Информация о покупателе — физическом лице
DbsAPI.getOrderBuyerInfo(campaignId: campaignId, orderId: orderId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **getOrderLabelsData**
```swift
    open class func getOrderLabelsData(campaignId: Int64, orderId: Int64, completion: @escaping (_ data: GetOrderLabelsDataResponse?, _ error: Error?) -> Void)
```
...
// Данные для самостоятельного изготовления ярлыков
DbsAPI.getOrderLabelsData(campaignId: campaignId, orderId: orderId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Детальная информация по заказам
DbsAPI.getOrdersStats(campaignId: campaignId, pageToken: pageToken, limit: limit, getOrdersStatsRequest: getOrdersStatsRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Информация об одной точке продаж
DbsAPI.getOutlet(campaignId: campaignId, outletId: outletId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Информация о лицензиях для точек продаж
DbsAPI.getOutletLicenses(campaignId: campaignId, outletIds: outletIds, ids: ids) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Информация о нескольких точках продаж
DbsAPI.getOutlets(campaignId: campaignId, pageToken: pageToken, regionId: regionId, shopOutletCode: shopOutletCode, regionId2: regionId2) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Список цен
DbsAPI.getPrices(campaignId: campaignId, pageToken: pageToken, limit: limit, archived: archived) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Просмотр цен на указанные товары в магазине
DbsAPI.getPricesByOfferIds(campaignId: campaignId, pageToken: pageToken, limit: limit, getPricesByOfferIdsRequest: getPricesByOfferIdsRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Получение списка товаров, которые участвуют или могут участвовать в акции
DbsAPI.getPromoOffers(businessId: businessId, getPromoOffersRequest: getPromoOffersRequest, pageToken: pageToken, limit: limit) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Получение списка акций
DbsAPI.getPromos(businessId: businessId, getPromosRequest: getPromosRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func getQualityRatingDetails(campaignId: Int64, completion: @escaping (_ data: GetQualityRatingDetailsResponse?, _ error: Error?) -> Void)
```
...
// Заказы, которые повлияли на индекс качества
DbsAPI.getQualityRatingDetails(campaignId: campaignId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Индекс качества магазинов
DbsAPI.getQualityRatings(businessId: businessId, getQualityRatingRequest: getQualityRatingRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Получение заданного отчета
DbsAPI.getReportInfo(reportId: reportId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Информация о невыкупе или возврате
DbsAPI.getReturn(campaignId: campaignId, orderId: orderId, returnId: returnId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Получение заявления на возврат
DbsAPI.getReturnApplication(campaignId: campaignId, orderId: orderId, returnId: returnId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Получение фотографии возврата
DbsAPI.getReturnPhoto(campaignId: campaignId, orderId: orderId, returnId: returnId, itemId: itemId, imageHash: imageHash) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Список невыкупов и возвратов
DbsAPI.getReturns(campaignId: campaignId, pageToken: pageToken, limit: limit, orderIds: orderIds, statuses: statuses, type: type, fromDate: fromDate, toDate: toDate, fromDate2: fromDate2, toDate2: toDate2) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Информация об остатках и оборачиваемости
DbsAPI.getStocks(campaignId: campaignId, pageToken: pageToken, limit: limit, getWarehouseStocksRequest: getWarehouseStocksRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Рекомендованные карточки для товаров
DbsAPI.getSuggestedOfferMappingEntries(campaignId: campaignId, getSuggestedOfferMappingEntriesRequest: getSuggestedOfferMappingEntriesRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Просмотр карточек на Маркете, которые подходят вашим товарам
DbsAPI.getSuggestedOfferMappings(businessId: businessId, getSuggestedOfferMappingsRequest: getSuggestedOfferMappingsRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Цены для продвижения товаров
DbsAPI.getSuggestedPrices(campaignId: campaignId, suggestPricesRequest: suggestPricesRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **getWarehouses**
```swift
    open class func getWarehouses(businessId: Int64, completion: @escaping (_ data: GetWarehousesResponse?, _ error: Error?) -> Void)
```
...
// Список складов и групп складов
DbsAPI.getWarehouses(businessId: businessId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func provideOrderDigitalCodes(campaignId: Int64, orderId: Int64, provideOrderDigitalCodesRequest: ProvideOrderDigitalCodesRequest, completion: @escaping (_ data: EmptyApiResponse?, _ error: Error?) -> Void)
```
...
let campaignId = 987 // Int64 | Идентификатор кампании в API и магазина в кабинете. Каждая кампания в API соответствует магазину в кабинете.  Чтобы узнать идентификаторы своих магазинов, воспользуйтесь запросом [GET campaigns](../../reference/campaigns/getCampaigns.md).  ℹ️ [Что такое кабинет и магазин на Маркете](https://yandex.ru/support/marketplace/account/introduction.html) 
let orderId = 987 // Int64 | Идентификатор заказа.
let provideOrderDigitalCodesRequest = ProvideOrderDigitalCodesRequest(items: [OrderDigitalItemDTO(id: 123, code: "code_example", slip: "slip_example", activateTill: Date())]) // ProvideOrderDigitalCodesRequest | 

// Передача ключей цифровых товаров
DbsAPI.provideOrderDigitalCodes(campaignId: campaignId, orderId: orderId, provideOrderDigitalCodesRequest: provideOrderDigitalCodesRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func provideOrderItemIdentifiers(campaignId: Int64, orderId: Int64, provideOrderItemIdentifiersRequest: ProvideOrderItemIdentifiersRequest, completion: @escaping (_ data: ProvideOrderItemIdentifiersResponse?, _ error: Error?) -> Void)
```
...
let campaignId = 987 // Int64 | Идентификатор кампании в API и магазина в кабинете. Каждая кампания в API соответствует магазину в кабинете.  Чтобы узнать идентификаторы своих магазинов, воспользуйтесь запросом [GET campaigns](../../reference/campaigns/getCampaigns.md).  ℹ️ [Что такое кабинет и магазин на Маркете](https://yandex.ru/support/marketplace/account/introduction.html) 
let orderId = 987 // Int64 | Идентификатор заказа.
let provideOrderItemIdentifiersRequest = ProvideOrderItemIdentifiersRequest(items: [OrderItemInstanceModificationDTO(id: 123, instances: [BriefOrderItemInstanceDTO(cis: "cis_example", uin: "uin_example", rnpt: "rnpt_example", gtd: "gtd_example")])]) // ProvideOrderItemIdentifiersRequest | 

// Передача кодов маркировки единиц товара
DbsAPI.provideOrderItemIdentifiers(campaignId: campaignId, orderId: orderId, provideOrderItemIdentifiersRequest: provideOrderItemIdentifiersRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Включение буста продаж и установка ставок
DbsAPI.putBidsForBusiness(businessId: businessId, putSkuBidsRequest: putSkuBidsRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Включение буста продаж и установка ставок для магазина
DbsAPI.putBidsForCampaign(campaignId: campaignId, putSkuBidsRequest: putSkuBidsRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Сообщить, что прайс-лист обновился
DbsAPI.refreshFeed(campaignId: campaignId, feedId: feedId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Поиск модели товара
DbsAPI.searchModels(query: query, regionId: regionId, currency: currency, page: page, pageSize: pageSize) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Информация о дочерних регионах
DbsAPI.searchRegionChildren(regionId: regionId, page: page, pageSize: pageSize) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Информация о регионе
DbsAPI.searchRegionsById(regionId: regionId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Поиск регионов по их имени
DbsAPI.searchRegionsByName(name: name, pageToken: pageToken, limit: limit) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Отправка файла в чат
DbsAPI.sendFileToChat(businessId: businessId, chatId: chatId, file: file) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Отправка сообщения в чат
DbsAPI.sendMessageToChat(businessId: businessId, chatId: chatId, sendMessageToChatRequest: sendMessageToChatRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Изменение параметров прайс-листа
DbsAPI.setFeedParams(campaignId: campaignId, feedId: feedId, setFeedParamsRequest: setFeedParamsRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **setOrderBoxLayout**
```swift
    open class func setOrderBoxLayout(campaignId: Int64, orderId: Int64, setOrderBoxLayoutRequest: SetOrderBoxLayoutRequest, completion: @escaping (_ data: SetOrderBoxLayoutResponse?, _ error: Error?) -> Void)
```
...
let campaignId = 987 // Int64 | Идентификатор кампании в API и магазина в кабинете. Каждая кампания в API соответствует магазину в кабинете.  Чтобы узнать идентификаторы своих магазинов, воспользуйтесь запросом [GET campaigns](../../reference/campaigns/getCampaigns.md).  ℹ️ [Что такое кабинет и магазин на Маркете](https://yandex.ru/support/marketplace/account/introduction.html) 
let orderId = 987 // Int64 | Идентификатор заказа.
let setOrderBoxLayoutRequest = SetOrderBoxLayoutRequest(boxes: [OrderBoxLayoutDTO(items: [OrderBoxLayoutItemDTO(id: 123, fullCount: 123, partialCount: OrderBoxLayoutPartialCountDTO(current: 123, total: 123), instances: [BriefOrderItemInstanceDTO(cis: "cis_example", uin: "uin_example", rnpt: "rnpt_example", gtd: "gtd_example")])])], allowRemove: false) // SetOrderBoxLayoutRequest | 

// Подготовка заказа
DbsAPI.setOrderBoxLayout(campaignId: campaignId, orderId: orderId, setOrderBoxLayoutRequest: setOrderBoxLayoutRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func setOrderDeliveryDate(campaignId: Int64, orderId: Int64, setOrderDeliveryDateRequest: SetOrderDeliveryDateRequest, completion: @escaping (_ data: EmptyApiResponse?, _ error: Error?) -> Void)
```
...
let campaignId = 987 // Int64 | Идентификатор кампании в API и магазина в кабинете. Каждая кампания в API соответствует магазину в кабинете.  Чтобы узнать идентификаторы своих магазинов, воспользуйтесь запросом [GET campaigns](../../reference/campaigns/getCampaigns.md).  ℹ️ [Что такое кабинет и магазин на Маркете](https://yandex.ru/support/marketplace/account/introduction.html) 
let orderId = 987 // Int64 | Идентификатор заказа.
let setOrderDeliveryDateRequest = SetOrderDeliveryDateRequest(dates: OrderDeliveryDateDTO(toDate: Date()), reason: OrderDeliveryDateReasonType()) // SetOrderDeliveryDateRequest | 

// Изменение даты доставки заказа
DbsAPI.setOrderDeliveryDate(campaignId: campaignId, orderId: orderId, setOrderDeliveryDateRequest: setOrderDeliveryDateRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func setOrderDeliveryTrackCode(campaignId: Int64, orderId: Int64, setOrderDeliveryTrackCodeRequest: SetOrderDeliveryTrackCodeRequest, completion: @escaping (_ data: EmptyApiResponse?, _ error: Error?) -> Void)
```
...
let campaignId = 987 // Int64 | Идентификатор кампании в API и магазина в кабинете. Каждая кампания в API соответствует магазину в кабинете.  Чтобы узнать идентификаторы своих магазинов, воспользуйтесь запросом [GET campaigns](../../reference/campaigns/getCampaigns.md).  ℹ️ [Что такое кабинет и магазин на Маркете](https://yandex.ru/support/marketplace/account/introduction.html) 
let orderId = 987 // Int64 | Идентификатор заказа.
let setOrderDeliveryTrackCodeRequest = SetOrderDeliveryTrackCodeRequest(trackCode: "trackCode_example", deliveryServiceId: 123) // SetOrderDeliveryTrackCodeRequest | 

// Передача трек‑номера посылки
DbsAPI.setOrderDeliveryTrackCode(campaignId: campaignId, orderId: orderId, setOrderDeliveryTrackCodeRequest: setOrderDeliveryTrackCodeRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func setOrderShipmentBoxes(campaignId: Int64, orderId: Int64, shipmentId: Int64, setOrderShipmentBoxesRequest: SetOrderShipmentBoxesRequest, completion: @escaping (_ data: SetOrderShipmentBoxesResponse?, _ error: Error?) -> Void)
```
...
let campaignId = 987 // Int64 | Идентификатор кампании в API и магазина в кабинете. Каждая кампания в API соответствует магазину в кабинете.  Чтобы узнать идентификаторы своих магазинов, воспользуйтесь запросом [GET campaigns](../../reference/campaigns/getCampaigns.md).  ℹ️ [Что такое кабинет и магазин на Маркете](https://yandex.ru/support/marketplace/account/introduction.html) 
let orderId = 987 // Int64 | Идентификатор заказа.
let shipmentId = 987 // Int64 | Параметр больше не используется. Вставьте любое число — просто чтобы получился корректный URL. 
let setOrderShipmentBoxesRequest = SetOrderShipmentBoxesRequest(boxes: [ParcelBoxDTO(id: 123, fulfilmentId: "fulfilmentId_example")]) // SetOrderShipmentBoxesRequest | 

// Передача количества грузовых мест в заказе
DbsAPI.setOrderShipmentBoxes(campaignId: campaignId, orderId: orderId, shipmentId: shipmentId, setOrderShipmentBoxesRequest: setOrderShipmentBoxesRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Принятие или изменение решения по возврату
DbsAPI.setReturnDecision(campaignId: campaignId, orderId: orderId, returnId: returnId, setReturnDecisionRequest: setReturnDecisionRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Отказ от ответа на отзывы
DbsAPI.skipGoodsFeedbacksReaction(businessId: businessId, skipGoodsFeedbackReactionRequest: skipGoodsFeedbackReactionRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Подтверждение решения по возврату
DbsAPI.submitReturnDecision(campaignId: campaignId, orderId: orderId, returnId: returnId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Установка цен на товары во всех магазинах
DbsAPI.updateBusinessPrices(businessId: businessId, updateBusinessPricesRequest: updateBusinessPricesRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Изменение условий продажи товаров в магазине
DbsAPI.updateCampaignOffers(campaignId: campaignId, updateCampaignOffersRequest: updateCampaignOffersRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Добавление нового или изменение созданного комментария
DbsAPI.updateGoodsFeedbackComment(businessId: businessId, updateGoodsFeedbackCommentRequest: updateGoodsFeedbackCommentRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Редактирование категорийных характеристик товара
DbsAPI.updateOfferContent(businessId: businessId, updateOfferContentRequest: updateOfferContentRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Добавление и редактирование товаров в каталоге
DbsAPI.updateOfferMappingEntries(campaignId: campaignId, updateOfferMappingEntryRequest: updateOfferMappingEntryRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Добавление товаров в каталог и изменение информации о них
DbsAPI.updateOfferMappings(businessId: businessId, updateOfferMappingsRequest: updateOfferMappingsRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **updateOrderItems**
```swift
    open class func updateOrderItems(campaignId: Int64, orderId: Int64, updateOrderItemRequest: UpdateOrderItemRequest, completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
...
let campaignId = 987 // Int64 | Идентификатор кампании в API и магазина в кабинете. Каждая кампания в API соответствует магазину в кабинете.  Чтобы узнать идентификаторы своих магазинов, воспользуйтесь запросом [GET campaigns](../../reference/campaigns/getCampaigns.md).  ℹ️ [Что такое кабинет и магазин на Маркете](https://yandex.ru/support/marketplace/account/introduction.html) 
let orderId = 987 // Int64 | Идентификатор заказа.
let updateOrderItemRequest = UpdateOrderItemRequest(items: [OrderItemModificationDTO(id: 123, count: 123, instances: [BriefOrderItemInstanceDTO(cis: "cis_example", uin: "uin_example", rnpt: "rnpt_example", gtd: "gtd_example")])], reason: OrderItemsModificationRequestReasonType()) // UpdateOrderItemRequest | 

// Удаление товара из заказа или уменьшение числа единиц
DbsAPI.updateOrderItems(campaignId: campaignId, orderId: orderId, updateOrderItemRequest: updateOrderItemRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **updateOrderStatus**
```swift
    open class func updateOrderStatus(campaignId: Int64, orderId: Int64, updateOrderStatusRequest: UpdateOrderStatusRequest, completion: @escaping (_ data: UpdateOrderStatusResponse?, _ error: Error?) -> Void)
```
...
let campaignId = 987 // Int64 | Идентификатор кампании в API и магазина в кабинете. Каждая кампания в API соответствует магазину в кабинете.  Чтобы узнать идентификаторы своих магазинов, воспользуйтесь запросом [GET campaigns](../../reference/campaigns/getCampaigns.md).  ℹ️ [Что такое кабинет и магазин на Маркете](https://yandex.ru/support/marketplace/account/introduction.html) 
let orderId = 987 // Int64 | Идентификатор заказа.
let updateOrderStatusRequest = UpdateOrderStatusRequest(order: OrderStatusChangeDTO(status: OrderStatusType(), substatus: OrderSubstatusType(), delivery: OrderStatusChangeDeliveryDTO(dates: OrderStatusChangeDeliveryDatesDTO(realDeliveryDate: Date())))) // UpdateOrderStatusRequest | 

// Изменение статуса одного заказа
DbsAPI.updateOrderStatus(campaignId: campaignId, orderId: orderId, updateOrderStatusRequest: updateOrderStatusRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **updateOrderStatuses**
```swift
    open class func updateOrderStatuses(campaignId: Int64, updateOrderStatusesRequest: UpdateOrderStatusesRequest, completion: @escaping (_ data: UpdateOrderStatusesResponse?, _ error: Error?) -> Void)
```
...
let campaignId = 987 // Int64 | Идентификатор кампании в API и магазина в кабинете. Каждая кампания в API соответствует магазину в кабинете.  Чтобы узнать идентификаторы своих магазинов, воспользуйтесь запросом [GET campaigns](../../reference/campaigns/getCampaigns.md).  ℹ️ [Что такое кабинет и магазин на Маркете](https://yandex.ru/support/marketplace/account/introduction.html) 
let updateOrderStatusesRequest = UpdateOrderStatusesRequest(orders: [OrderStateDTO(id: 123, status: OrderStatusType(), substatus: OrderSubstatusType())]) // UpdateOrderStatusesRequest | 

// Изменение статусов нескольких заказов
DbsAPI.updateOrderStatuses(campaignId: campaignId, updateOrderStatusesRequest: updateOrderStatusesRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func updateOrderStorageLimit(campaignId: Int64, orderId: Int64, updateOrderStorageLimitRequest: UpdateOrderStorageLimitRequest, completion: @escaping (_ data: EmptyApiResponse?, _ error: Error?) -> Void)
```
...
let campaignId = 987 // Int64 | Идентификатор кампании в API и магазина в кабинете. Каждая кампания в API соответствует магазину в кабинете.  Чтобы узнать идентификаторы своих магазинов, воспользуйтесь запросом [GET campaigns](../../reference/campaigns/getCampaigns.md).  ℹ️ [Что такое кабинет и магазин на Маркете](https://yandex.ru/support/marketplace/account/introduction.html) 
let orderId = 987 // Int64 | Идентификатор заказа.
let updateOrderStorageLimitRequest = UpdateOrderStorageLimitRequest(newDate: Date()) // UpdateOrderStorageLimitRequest | 

// Продление срока хранения заказа
DbsAPI.updateOrderStorageLimit(campaignId: campaignId, orderId: orderId, updateOrderStorageLimitRequest: updateOrderStorageLimitRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Изменение информации о точке продаж
DbsAPI.updateOutlet(campaignId: campaignId, outletId: outletId, changeOutletRequest: changeOutletRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Создание и изменение лицензий для точек продаж
DbsAPI.updateOutletLicenses(campaignId: campaignId, updateOutletLicenseRequest: updateOutletLicenseRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Установка цен на товары в конкретном магазине
DbsAPI.updatePrices(campaignId: campaignId, updatePricesRequest: updatePricesRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Добавление товаров в акцию или изменение их цен
DbsAPI.updatePromoOffers(businessId: businessId, updatePromoOffersRequest: updatePromoOffersRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **updateStocks**
```swift
    open class func updateStocks(campaignId: Int64, updateStocksRequest: UpdateStocksRequest, completion: @escaping (_ data: EmptyApiResponse?, _ error: Error?) -> Void)
```
...
let campaignId = 987 // Int64 | Идентификатор кампании в API и магазина в кабинете. Каждая кампания в API соответствует магазину в кабинете.  Чтобы узнать идентификаторы своих магазинов, воспользуйтесь запросом [GET campaigns](../../reference/campaigns/getCampaigns.md).  ℹ️ [Что такое кабинет и магазин на Маркете](https://yandex.ru/support/marketplace/account/introduction.html) 
let updateStocksRequest = UpdateStocksRequest(skus: [UpdateStockDTO(sku: "sku_example", items: [UpdateStockItemDTO(count: 123, updatedAt: Date())])]) // UpdateStocksRequest | 

// Передача информации об остатках
DbsAPI.updateStocks(campaignId: campaignId, updateStocksRequest: updateStocksRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
