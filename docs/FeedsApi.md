...
[**getFeedWithHttpInfo**](FeedsApi.md#getFeedWithHttpInfo) | **GET** /campaigns/{campaignId}/feeds/{feedId} | Информация о прайс-листе
...
[**getFeedIndexLogsWithHttpInfo**](FeedsApi.md#getFeedIndexLogsWithHttpInfo) | **GET** /campaigns/{campaignId}/feeds/{feedId}/index-logs | Отчет по индексации прайс-листа
[**getFeeds**](FeedsApi.md#getFeeds) | **GET** /campaigns/{campaignId}/feeds | Список прайс-листов магазина
[**getFeedsWithHttpInfo**](FeedsApi.md#getFeedsWithHttpInfo) | **GET** /campaigns/{campaignId}/feeds | Список прайс-листов магазина
[**refreshFeed**](FeedsApi.md#refreshFeed) | **POST** /campaigns/{campaignId}/feeds/{feedId}/refresh | Сообщить, что прайс-лист обновился
[**refreshFeedWithHttpInfo**](FeedsApi.md#refreshFeedWithHttpInfo) | **POST** /campaigns/{campaignId}/feeds/{feedId}/refresh | Сообщить, что прайс-лист обновился
[**setFeedParams**](FeedsApi.md#setFeedParams) | **POST** /campaigns/{campaignId}/feeds/{feedId}/params | Изменение параметров прайс-листа
[**setFeedParamsWithHttpInfo**](FeedsApi.md#setFeedParamsWithHttpInfo) | **POST** /campaigns/{campaignId}/feeds/{feedId}/params | Изменение параметров прайс-листа
...
object Example extends App {
    ...
    val apiInstance = FeedsApi("https://api.partner.market.yandex.ru")
