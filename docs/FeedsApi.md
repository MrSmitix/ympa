# ympa_python_pydantic_v1_client.FeedsApi
...
with ympa_python_pydantic_v1_client.ApiClient(configuration) as api_client:
    ...
    api_instance = ympa_python_pydantic_v1_client.FeedsApi(api_client)
...
with ympa_python_pydantic_v1_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FeedsApi->get_feed_index_logs:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FeedsApi->get_feed_index_logs: %s\n" % e)
```
...
with ympa_python_pydantic_v1_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FeedsApi->refresh_feed:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FeedsApi->refresh_feed: %s\n" % e)
```
...
with ympa_python_pydantic_v1_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FeedsApi->set_feed_params:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FeedsApi->set_feed_params: %s\n" % e)
```
