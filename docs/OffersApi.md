...
try {
    ...
    println("4xx response calling OffersApi#deleteCampaignOffers")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling OffersApi#deleteCampaignOffers")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling OffersApi#getAllOffers")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling OffersApi#getAllOffers")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling OffersApi#getCampaignOffers")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling OffersApi#getCampaignOffers")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling OffersApi#getOfferRecommendations")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling OffersApi#getOfferRecommendations")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling OffersApi#getOffers")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling OffersApi#getOffers")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling OffersApi#updateCampaignOffers")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling OffersApi#updateCampaignOffers")
    e.printStackTrace()
}
```
