...
## Creating PriceQuarantineApi

To initiate an instance of `PriceQuarantineApi`, you can use micronaut's `ApplicationContext`:
```java
/* imports
import io.micronaut.runtime.Micronaut;
import io.micronaut.context.ApplicationContext;
import org.openapitools.api.PriceQuarantineApi;
*/

ApplicationContext context = Micronaut.run(/* ... */);
PetApi apiInstance = context.getBean(PriceQuarantineApi.class);
```
...
```java
Mono<EmptyApiResponse> PriceQuarantineApi.confirmBusinessPrices(businessIdconfirmPricesRequest)
```
...
```java
Mono<EmptyApiResponse> PriceQuarantineApi.confirmCampaignPrices(campaignIdconfirmPricesRequest)
```
...
```java
Mono<GetQuarantineOffersResponse> PriceQuarantineApi.getBusinessQuarantineOffers(businessIdgetQuarantineOffersRequestpageTokenlimit)
```
...
```java
Mono<GetQuarantineOffersResponse> PriceQuarantineApi.getCampaignQuarantineOffers(campaignIdgetQuarantineOffersRequestpageTokenlimit)
```
