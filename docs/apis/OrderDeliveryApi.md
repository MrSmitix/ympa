...
## Creating OrderDeliveryApi

To initiate an instance of `OrderDeliveryApi`, you can use micronaut's `ApplicationContext`:
```java
/* imports
import io.micronaut.runtime.Micronaut;
import io.micronaut.context.ApplicationContext;
import org.openapitools.api.OrderDeliveryApi;
*/

ApplicationContext context = Micronaut.run(/* ... */);
PetApi apiInstance = context.getBean(OrderDeliveryApi.class);
```
...
# **getOrderBuyerInfo**
```java
Mono<GetOrderBuyerInfoResponse> OrderDeliveryApi.getOrderBuyerInfo(campaignIdorderId)
```
...
```java
Mono<EmptyApiResponse> OrderDeliveryApi.setOrderDeliveryDate(campaignIdorderIdsetOrderDeliveryDateRequest)
```
...
```java
Mono<EmptyApiResponse> OrderDeliveryApi.setOrderDeliveryTrackCode(campaignIdorderIdsetOrderDeliveryTrackCodeRequest)
```
...
```java
Mono<EmptyApiResponse> OrderDeliveryApi.updateOrderStorageLimit(campaignIdorderIdupdateOrderStorageLimitRequest)
```
...
# **verifyOrderEac**
```java
Mono<VerifyOrderEacResponse> OrderDeliveryApi.verifyOrderEac(campaignIdorderIdverifyOrderEacRequest)
```
