...
# **getModel**
```java
Mono<GetModelsResponse> ModelsApi.getModel(modelIdregionIdcurrency)
```
...
# **getModelOffers**
```java
Mono<GetModelsOffersResponse> ModelsApi.getModelOffers(modelIdregionIdcurrencyorderByPricecountpage)
```
...
# **getModels**
```java
Mono<GetModelsResponse> ModelsApi.getModels(regionIdgetModelsRequestcurrency)
```
...
# **getModelsOffers**
```java
Mono<GetModelsOffersResponse> ModelsApi.getModelsOffers(regionIdgetModelsRequestcurrencyorderByPrice)
```
...
# **searchModels**
```java
Mono<SearchModelsResponse> ModelsApi.searchModels(queryregionIdcurrencypagepageSize)
```
