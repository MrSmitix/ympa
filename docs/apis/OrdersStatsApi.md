...
## Creating OrdersStatsApi

To initiate an instance of `OrdersStatsApi`, you can use micronaut's `ApplicationContext`:
```java
/* imports
import io.micronaut.runtime.Micronaut;
import io.micronaut.context.ApplicationContext;
import org.openapitools.api.OrdersStatsApi;
*/

ApplicationContext context = Micronaut.run(/* ... */);
PetApi apiInstance = context.getBean(OrdersStatsApi.class);
```
...
# **getOrdersStats**
```java
Mono<GetOrdersStatsResponse> OrdersStatsApi.getOrdersStats(campaignIdpageTokenlimitgetOrdersStatsRequest)
```
