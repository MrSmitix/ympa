...
To initiate an instance of `OffersApi`, you can use micronaut's `ApplicationContext`:
```java
/* imports
import io.micronaut.runtime.Micronaut;
import io.micronaut.context.ApplicationContext;
import org.openapitools.api.OffersApi;
*/

ApplicationContext context = Micronaut.run(/* ... */);
PetApi apiInstance = context.getBean(OffersApi.class);
```
...
```java
Mono<DeleteCampaignOffersResponse> OffersApi.deleteCampaignOffers(campaignIddeleteCampaignOffersRequest)
```
...
# **getAllOffers**
```java
Mono<GetAllOffersResponse> OffersApi.getAllOffers(campaignIdfeedIdchunk)
```
...
# **getCampaignOffers**
```java
Mono<GetCampaignOffersResponse> OffersApi.getCampaignOffers(campaignIdgetCampaignOffersRequestpageTokenlimit)
```
...
```java
Mono<GetOfferRecommendationsResponse> OffersApi.getOfferRecommendations(businessIdgetOfferRecommendationsRequestpageTokenlimit)
```
...
# **getOffers**
```java
Mono<GetOffersResponse> OffersApi.getOffers(campaignIdqueryfeedIdshopCategoryIdcurrencymatchedpagepageSize)
```
...
```java
Mono<EmptyApiResponse> OffersApi.updateCampaignOffers(campaignIdupdateCampaignOffersRequest)
```
