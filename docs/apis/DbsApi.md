...
To initiate an instance of `DbsApi`, you can use micronaut's `ApplicationContext`:
```java
/* imports
import io.micronaut.runtime.Micronaut;
import io.micronaut.context.ApplicationContext;
import org.openapitools.api.DbsApi;
*/

ApplicationContext context = Micronaut.run(/* ... */);
PetApi apiInstance = context.getBean(DbsApi.class);
```
...
```java
Mono<EmptyApiResponse> DbsApi.acceptOrderCancellation(campaignIdorderIdacceptOrderCancellationRequest)
```
...
# **addHiddenOffers**
```java
Mono<EmptyApiResponse> DbsApi.addHiddenOffers(campaignIdaddHiddenOffersRequest)
```
...
# **addOffersToArchive**
```java
Mono<AddOffersToArchiveResponse> DbsApi.addOffersToArchive(businessIdaddOffersToArchiveRequest)
```
...
# **calculateTariffs**
```java
Mono<CalculateTariffsResponse> DbsApi.calculateTariffs(calculateTariffsRequest)
```
...
```java
Mono<EmptyApiResponse> DbsApi.confirmBusinessPrices(businessIdconfirmPricesRequest)
```
...
```java
Mono<EmptyApiResponse> DbsApi.confirmCampaignPrices(campaignIdconfirmPricesRequest)
```
...
# **createChat**
```java
Mono<CreateChatResponse> DbsApi.createChat(businessIdcreateChatRequest)
```
...
# **createOutlet**
```java
Mono<CreateOutletResponse> DbsApi.createOutlet(campaignIdchangeOutletRequest)
```
...
```java
Mono<DeleteCampaignOffersResponse> DbsApi.deleteCampaignOffers(campaignIddeleteCampaignOffersRequest)
```
...
```java
Mono<EmptyApiResponse> DbsApi.deleteGoodsFeedbackComment(businessIddeleteGoodsFeedbackCommentRequest)
```
...
# **deleteHiddenOffers**
```java
Mono<EmptyApiResponse> DbsApi.deleteHiddenOffers(campaignIddeleteHiddenOffersRequest)
```
...
# **deleteOffers**
```java
Mono<DeleteOffersResponse> DbsApi.deleteOffers(businessIddeleteOffersRequest)
```
...
```java
Mono<DeleteOffersFromArchiveResponse> DbsApi.deleteOffersFromArchive(businessIddeleteOffersFromArchiveRequest)
```
...
# **deleteOutlet**
```java
Mono<EmptyApiResponse> DbsApi.deleteOutlet(campaignIdoutletId)
```
...
```java
Mono<EmptyApiResponse> DbsApi.deleteOutletLicenses(campaignIdids)
```
...
# **deletePromoOffers**
```java
Mono<DeletePromoOffersResponse> DbsApi.deletePromoOffers(businessIddeletePromoOffersRequest)
```
...
```java
Mono<GenerateReportResponse> DbsApi.generateBoostConsolidatedReport(generateBoostConsolidatedRequest_format)
```
...
```java
Mono<GenerateReportResponse> DbsApi.generateCompetitorsPositionReport(generateCompetitorsPositionReportRequest_format)
```
...
```java
Mono<GenerateReportResponse> DbsApi.generateGoodsFeedbackReport(generateGoodsFeedbackRequest_format)
```
...
```java
Mono<GenerateReportResponse> DbsApi.generateMassOrderLabelsReport(generateMassOrderLabelsRequest_format)
```
...
# **generateOrderLabel**
```java
Mono<File> DbsApi.generateOrderLabel(campaignIdorderIdshipmentIdboxId_format)
```
...
# **generateOrderLabels**
```java
Mono<File> DbsApi.generateOrderLabels(campaignIdorderId_format)
```
...
```java
Mono<GenerateReportResponse> DbsApi.generatePricesReport(generatePricesReportRequest_format)
```
...
```java
Mono<GenerateReportResponse> DbsApi.generateShelfsStatisticsReport(generateShelfsStatisticsRequest_format)
```
...
```java
Mono<GenerateReportResponse> DbsApi.generateShowsSalesReport(generateShowsSalesReportRequest_format)
```
...
```java
Mono<GenerateReportResponse> DbsApi.generateStocksOnWarehousesReport(generateStocksOnWarehousesReportRequest_format)
```
...
```java
Mono<GenerateReportResponse> DbsApi.generateUnitedMarketplaceServicesReport(generateUnitedMarketplaceServicesReportRequest_format)
```
...
```java
Mono<GenerateReportResponse> DbsApi.generateUnitedNettingReport(generateUnitedNettingReportRequest_format)
```
...
```java
Mono<GenerateReportResponse> DbsApi.generateUnitedOrdersReport(generateUnitedOrdersRequest_format)
```
...
# **getAllOffers**
```java
Mono<GetAllOffersResponse> DbsApi.getAllOffers(campaignIdfeedIdchunk)
```
...
```java
Mono<GetBidsInfoResponse> DbsApi.getBidsInfoForBusiness(businessIdpageTokenlimitgetBidsInfoRequest)
```
...
```java
Mono<GetBidsRecommendationsResponse> DbsApi.getBidsRecommendations(businessIdgetBidsRecommendationsRequest)
```
...
```java
Mono<GetQuarantineOffersResponse> DbsApi.getBusinessQuarantineOffers(businessIdgetQuarantineOffersRequestpageTokenlimit)
```
...
# **getBusinessSettings**
```java
Mono<GetBusinessSettingsResponse> DbsApi.getBusinessSettings(businessId)
```
...
# **getCampaign**
```java
Mono<GetCampaignResponse> DbsApi.getCampaign(campaignId)
```
...
# **getCampaignLogins**
```java
Mono<GetCampaignLoginsResponse> DbsApi.getCampaignLogins(campaignId)
```
...
# **getCampaignOffers**
```java
Mono<GetCampaignOffersResponse> DbsApi.getCampaignOffers(campaignIdgetCampaignOffersRequestpageTokenlimit)
```
...
```java
Mono<GetQuarantineOffersResponse> DbsApi.getCampaignQuarantineOffers(campaignIdgetQuarantineOffersRequestpageTokenlimit)
```
...
# **getCampaignRegion**
```java
Mono<GetCampaignRegionResponse> DbsApi.getCampaignRegion(campaignId)
```
...
# **getCampaignSettings**
```java
Mono<GetCampaignSettingsResponse> DbsApi.getCampaignSettings(campaignId)
```
...
# **getCampaigns**
```java
Mono<GetCampaignsResponse> DbsApi.getCampaigns(pagepageSize)
```
...
# **getCampaignsByLogin**
```java
Mono<GetCampaignsResponse> DbsApi.getCampaignsByLogin(loginpagepageSize)
```
...
```java
Mono<GetCategoriesMaxSaleQuantumResponse> DbsApi.getCategoriesMaxSaleQuantum(getCategoriesMaxSaleQuantumRequest)
```
...
# **getCategoriesTree**
```java
Mono<GetCategoriesResponse> DbsApi.getCategoriesTree(getCategoriesRequest)
```
...
```java
Mono<GetCategoryContentParametersResponse> DbsApi.getCategoryContentParameters(categoryId)
```
...
# **getChatHistory**
```java
Mono<GetChatHistoryResponse> DbsApi.getChatHistory(businessIdchatIdgetChatHistoryRequestpageTokenlimit)
```
...
# **getChats**
```java
Mono<GetChatsResponse> DbsApi.getChats(businessIdgetChatsRequestpageTokenlimit)
```
...
# **getDeliveryServices**
```java
Mono<GetDeliveryServicesResponse> DbsApi.getDeliveryServices()
```
...
# **getFeed**
```java
Mono<GetFeedResponse> DbsApi.getFeed(campaignIdfeedId)
```
...
# **getFeedIndexLogs**
```java
Mono<GetFeedIndexLogsResponse> DbsApi.getFeedIndexLogs(campaignIdfeedIdlimitpublishedTimeFrompublishedTimeTostatus)
```
...
```java
Mono<GetFeedbackListResponse> DbsApi.getFeedbackAndCommentUpdates(campaignIdpageTokenlimitfromDate)
```
...
# **getFeeds**
```java
Mono<GetFeedsResponse> DbsApi.getFeeds(campaignId)
```
...
```java
Mono<GetGoodsFeedbackCommentsResponse> DbsApi.getGoodsFeedbackComments(businessIdgetGoodsFeedbackCommentsRequestpageTokenlimit)
```
...
# **getGoodsFeedbacks**
```java
Mono<GetGoodsFeedbackResponse> DbsApi.getGoodsFeedbacks(businessIdpageTokenlimitgetGoodsFeedbackRequest)
```
...
# **getGoodsStats**
```java
Mono<GetGoodsStatsResponse> DbsApi.getGoodsStats(campaignIdgetGoodsStatsRequest)
```
...
# **getHiddenOffers**
```java
Mono<GetHiddenOffersResponse> DbsApi.getHiddenOffers(campaignIdofferIdpageTokenlimitoffsetpagepageSize)
```
...
# **getModel**
```java
Mono<GetModelsResponse> DbsApi.getModel(modelIdregionIdcurrency)
```
...
# **getModelOffers**
```java
Mono<GetModelsOffersResponse> DbsApi.getModelOffers(modelIdregionIdcurrencyorderByPricecountpage)
```
...
| **regionId** | `Long`| Идентификатор региона.  Идентификатор региона можно получить c помощью запроса [GET regions](../../reference/regions/searchRegionsByName.md).  | |
| **currency** | [**CurrencyType**](.md)| Валюта, в которой отображаются цены предложений на страницах с результатами поиска.  Возможные значения:  * &#x60;BYN&#x60; — белорусский рубль.  * &#x60;KZT&#x60; — казахстанский тенге.  * &#x60;RUR&#x60; — российский рубль.  * &#x60;UAH&#x60; — украинская гривна.  Значение по умолчанию: используется национальная валюта магазина (национальная валюта страны происхождения магазина).  | [optional parameter] [enum: `RUR`, `USD`, `EUR`, `UAH`, `AUD`, `GBP`, `BYR`, `BYN`, `DKK`, `ISK`, `KZT`, `CAD`, `CNY`, `NOK`, `XDR`, `SGD`, `TRY`, `SEK`, `CHF`, `JPY`, `AZN`, `ALL`, `DZD`, `AOA`, `ARS`, `AMD`, `AFN`, `BHD`, `BGN`, `BOB`, `BWP`, `BND`, `BRL`, `BIF`, `HUF`, `VEF`, `KPW`, `VND`, `GMD`, `GHS`, `GNF`, `HKD`, `GEL`, `AED`, `EGP`, `ZMK`, `ILS`, `INR`, `IDR`, `JOD`, `IQD`, `IRR`, `YER`, `QAR`, `KES`, `KGS`, `COP`, `CDF`, `CRC`, `KWD`, `CUP`, `LAK`, `LVL`, `SLL`, `LBP`, `LYD`, `SZL`, `LTL`, `MUR`, `MRO`, `MKD`, `MWK`, `MGA`, `MYR`, `MAD`, `MXN`, `MZN`, `MDL`, `MNT`, `NPR`, `NGN`, `NIO`, `NZD`, `OMR`, `PKR`, `PYG`, `PEN`, `PLN`, `KHR`, `SAR`, `RON`, `SCR`, `SYP`, `SKK`, `SOS`, `SDG`, `SRD`, `TJS`, `THB`, `TWD`, `BDT`, `TZS`, `TND`, `TMM`, `UGX`, `UZS`, `UYU`, `PHP`, `DJF`, `XAF`, `XOF`, `HRK`, `CZK`, `CLP`, `LKR`, `EEK`, `ETB`, `RSD`, `ZAR`, `KRW`, `NAD`, `TL`, `UE`] |
| **orderByPrice** | [**SortOrderType**](.md)| Направление сортировки по цене.  Возможные значения: * &#x60;ASC&#x60; — сортировка по возрастанию. * &#x60;DESC&#x60; — сортировка по убыванию.  Значение по умолчанию: предложения выводятся в произвольном порядке.  | [optional parameter] [enum: `ASC`, `DESC`] |
...
# **getModels**
```java
Mono<GetModelsResponse> DbsApi.getModels(regionIdgetModelsRequestcurrency)
```
...
# **getModelsOffers**
```java
Mono<GetModelsOffersResponse> DbsApi.getModelsOffers(regionIdgetModelsRequestcurrencyorderByPrice)
```
...
```java
Mono<GetOfferCardsContentStatusResponse> DbsApi.getOfferCardsContentStatus(businessIdpageTokenlimitgetOfferCardsContentStatusRequest)
```
...
```java
Mono<GetOfferMappingEntriesResponse> DbsApi.getOfferMappingEntries(campaignIdofferIdshopSkumappingKindstatusavailabilitycategoryIdvendorpageTokenlimit)
```
...
# **getOfferMappings**
```java
Mono<GetOfferMappingsResponse> DbsApi.getOfferMappings(businessIdpageTokenlimitgetOfferMappingsRequest)
```
...
```java
Mono<GetOfferRecommendationsResponse> DbsApi.getOfferRecommendations(businessIdgetOfferRecommendationsRequestpageTokenlimit)
```
...
# **getOffers**
```java
Mono<GetOffersResponse> DbsApi.getOffers(campaignIdqueryfeedIdshopCategoryIdcurrencymatchedpagepageSize)
```
...
# **getOrder**
```java
Mono<GetOrderResponse> DbsApi.getOrder(campaignIdorderId)
```
...
```java
Mono<GetBusinessBuyerInfoResponse> DbsApi.getOrderBusinessBuyerInfo(campaignIdorderId)
```
...
```java
Mono<GetBusinessDocumentsInfoResponse> DbsApi.getOrderBusinessDocumentsInfo(campaignIdorderId)
```
...
# **getOrderBuyerInfo**
```java
Mono<GetOrderBuyerInfoResponse> DbsApi.getOrderBuyerInfo(campaignIdorderId)
```
...
# **getOrderLabelsData**
```java
Mono<GetOrderLabelsDataResponse> DbsApi.getOrderLabelsData(campaignIdorderId)
```
...
# **getOrders**
```java
Mono<GetOrdersResponse> DbsApi.getOrders(campaignIdorderIdsstatussubstatusfromDatetoDatesupplierShipmentDateFromsupplierShipmentDateToupdatedAtFromupdatedAtTodispatchTypefakehasCisonlyWaitingForCancellationApproveonlyEstimatedDeliverybuyerTypepagepageSizepageTokenlimit)
```
...
# **getOrdersStats**
```java
Mono<GetOrdersStatsResponse> DbsApi.getOrdersStats(campaignIdpageTokenlimitgetOrdersStatsRequest)
```
...
# **getOutlet**
```java
Mono<GetOutletResponse> DbsApi.getOutlet(campaignIdoutletId)
```
...
# **getOutletLicenses**
```java
Mono<GetOutletLicensesResponse> DbsApi.getOutletLicenses(campaignIdoutletIdsids)
```
...
# **getOutlets**
```java
Mono<GetOutletsResponse> DbsApi.getOutlets(campaignIdpageTokenregionIdshopOutletCoderegionId2)
```
...
# **getPrices**
```java
Mono<GetPricesResponse> DbsApi.getPrices(campaignIdpageTokenlimitarchived)
```
...
# **getPricesByOfferIds**
```java
Mono<GetPricesByOfferIdsResponse> DbsApi.getPricesByOfferIds(campaignIdpageTokenlimitgetPricesByOfferIdsRequest)
```
...
# **getPromoOffers**
```java
Mono<GetPromoOffersResponse> DbsApi.getPromoOffers(businessIdgetPromoOffersRequestpageTokenlimit)
```
...
# **getPromos**
```java
Mono<GetPromosResponse> DbsApi.getPromos(businessIdgetPromosRequest)
```
...
```java
Mono<GetQualityRatingDetailsResponse> DbsApi.getQualityRatingDetails(campaignId)
```
...
# **getQualityRatings**
```java
Mono<GetQualityRatingResponse> DbsApi.getQualityRatings(businessIdgetQualityRatingRequest)
```
...
# **getReportInfo**
```java
Mono<GetReportInfoResponse> DbsApi.getReportInfo(reportId)
```
...
# **getReturn**
```java
Mono<GetReturnResponse> DbsApi.getReturn(campaignIdorderIdreturnId)
```
...
```java
Mono<File> DbsApi.getReturnApplication(campaignIdorderIdreturnId)
```
...
# **getReturnPhoto**
```java
Mono<File> DbsApi.getReturnPhoto(campaignIdorderIdreturnIditemIdimageHash)
```
...
# **getReturns**
```java
Mono<GetReturnsResponse> DbsApi.getReturns(campaignIdpageTokenlimitorderIdsstatusestypefromDatetoDatefromDate2toDate2)
```
...
# **getStocks**
```java
Mono<GetWarehouseStocksResponse> DbsApi.getStocks(campaignIdpageTokenlimitgetWarehouseStocksRequest)
```
...
```java
Mono<GetSuggestedOfferMappingEntriesResponse> DbsApi.getSuggestedOfferMappingEntries(campaignIdgetSuggestedOfferMappingEntriesRequest)
```
...
```java
Mono<GetSuggestedOfferMappingsResponse> DbsApi.getSuggestedOfferMappings(businessIdgetSuggestedOfferMappingsRequest)
```
...
# **getSuggestedPrices**
```java
Mono<SuggestPricesResponse> DbsApi.getSuggestedPrices(campaignIdsuggestPricesRequest)
```
...
# **getWarehouses**
```java
Mono<GetWarehousesResponse> DbsApi.getWarehouses(businessId)
```
...
```java
Mono<EmptyApiResponse> DbsApi.provideOrderDigitalCodes(campaignIdorderIdprovideOrderDigitalCodesRequest)
```
...
```java
Mono<ProvideOrderItemIdentifiersResponse> DbsApi.provideOrderItemIdentifiers(campaignIdorderIdprovideOrderItemIdentifiersRequest)
```
...
# **putBidsForBusiness**
```java
Mono<EmptyApiResponse> DbsApi.putBidsForBusiness(businessIdputSkuBidsRequest)
```
...
# **putBidsForCampaign**
```java
Mono<EmptyApiResponse> DbsApi.putBidsForCampaign(campaignIdputSkuBidsRequest)
```
...
# **refreshFeed**
```java
Mono<EmptyApiResponse> DbsApi.refreshFeed(campaignIdfeedId)
```
...
# **searchModels**
```java
Mono<SearchModelsResponse> DbsApi.searchModels(queryregionIdcurrencypagepageSize)
```
...
```java
Mono<GetRegionWithChildrenResponse> DbsApi.searchRegionChildren(regionIdpagepageSize)
```
...
# **searchRegionsById**
```java
Mono<GetRegionsResponse> DbsApi.searchRegionsById(regionId)
```
...
# **searchRegionsByName**
```java
Mono<GetRegionsResponse> DbsApi.searchRegionsByName(namepageTokenlimit)
```
...
# **sendFileToChat**
```java
Mono<EmptyApiResponse> DbsApi.sendFileToChat(businessIdchatId_file)
```
...
# **sendMessageToChat**
```java
Mono<EmptyApiResponse> DbsApi.sendMessageToChat(businessIdchatIdsendMessageToChatRequest)
```
...
# **setFeedParams**
```java
Mono<EmptyApiResponse> DbsApi.setFeedParams(campaignIdfeedIdsetFeedParamsRequest)
```
...
# **setOrderBoxLayout**
```java
Mono<SetOrderBoxLayoutResponse> DbsApi.setOrderBoxLayout(campaignIdorderIdsetOrderBoxLayoutRequest)
```
...
```java
Mono<EmptyApiResponse> DbsApi.setOrderDeliveryDate(campaignIdorderIdsetOrderDeliveryDateRequest)
```
...
```java
Mono<EmptyApiResponse> DbsApi.setOrderDeliveryTrackCode(campaignIdorderIdsetOrderDeliveryTrackCodeRequest)
```
...
```java
Mono<SetOrderShipmentBoxesResponse> DbsApi.setOrderShipmentBoxes(campaignIdorderIdshipmentIdsetOrderShipmentBoxesRequest)
```
...
# **setReturnDecision**
```java
Mono<EmptyApiResponse> DbsApi.setReturnDecision(campaignIdorderIdreturnIdsetReturnDecisionRequest)
```
...
```java
Mono<EmptyApiResponse> DbsApi.skipGoodsFeedbacksReaction(businessIdskipGoodsFeedbackReactionRequest)
```
...
```java
Mono<EmptyApiResponse> DbsApi.submitReturnDecision(campaignIdorderIdreturnId)
```
...
```java
Mono<EmptyApiResponse> DbsApi.updateBusinessPrices(businessIdupdateBusinessPricesRequest)
```
...
```java
Mono<EmptyApiResponse> DbsApi.updateCampaignOffers(campaignIdupdateCampaignOffersRequest)
```
...
```java
Mono<UpdateGoodsFeedbackCommentResponse> DbsApi.updateGoodsFeedbackComment(businessIdupdateGoodsFeedbackCommentRequest)
```
...
# **updateOfferContent**
```java
Mono<UpdateOfferContentResponse> DbsApi.updateOfferContent(businessIdupdateOfferContentRequest)
```
...
```java
Mono<EmptyApiResponse> DbsApi.updateOfferMappingEntries(campaignIdupdateOfferMappingEntryRequest)
```
...
# **updateOfferMappings**
```java
Mono<UpdateOfferMappingsResponse> DbsApi.updateOfferMappings(businessIdupdateOfferMappingsRequest)
```
...
# **updateOrderItems**
```java
Mono<Void> DbsApi.updateOrderItems(campaignIdorderIdupdateOrderItemRequest)
```
...
# **updateOrderStatus**
```java
Mono<UpdateOrderStatusResponse> DbsApi.updateOrderStatus(campaignIdorderIdupdateOrderStatusRequest)
```
...
# **updateOrderStatuses**
```java
Mono<UpdateOrderStatusesResponse> DbsApi.updateOrderStatuses(campaignIdupdateOrderStatusesRequest)
```
...
```java
Mono<EmptyApiResponse> DbsApi.updateOrderStorageLimit(campaignIdorderIdupdateOrderStorageLimitRequest)
```
...
# **updateOutlet**
```java
Mono<EmptyApiResponse> DbsApi.updateOutlet(campaignIdoutletIdchangeOutletRequest)
```
...
```java
Mono<EmptyApiResponse> DbsApi.updateOutletLicenses(campaignIdupdateOutletLicenseRequest)
```
...
# **updatePrices**
```java
Mono<EmptyApiResponse> DbsApi.updatePrices(campaignIdupdatePricesRequest)
```
...
# **updatePromoOffers**
```java
Mono<UpdatePromoOffersResponse> DbsApi.updatePromoOffers(businessIdupdatePromoOffersRequest)
```
...
# **updateStocks**
```java
Mono<EmptyApiResponse> DbsApi.updateStocks(campaignIdupdateStocksRequest)
```
