...
To initiate an instance of `FbsApi`, you can use micronaut's `ApplicationContext`:
```java
/* imports
import io.micronaut.runtime.Micronaut;
import io.micronaut.context.ApplicationContext;
import org.openapitools.api.FbsApi;
*/

ApplicationContext context = Micronaut.run(/* ... */);
PetApi apiInstance = context.getBean(FbsApi.class);
```
...
# **addHiddenOffers**
```java
Mono<EmptyApiResponse> FbsApi.addHiddenOffers(campaignIdaddHiddenOffersRequest)
```
...
# **addOffersToArchive**
```java
Mono<AddOffersToArchiveResponse> FbsApi.addOffersToArchive(businessIdaddOffersToArchiveRequest)
```
...
# **calculateTariffs**
```java
Mono<CalculateTariffsResponse> FbsApi.calculateTariffs(calculateTariffsRequest)
```
...
```java
Mono<EmptyApiResponse> FbsApi.confirmBusinessPrices(businessIdconfirmPricesRequest)
```
...
```java
Mono<EmptyApiResponse> FbsApi.confirmCampaignPrices(campaignIdconfirmPricesRequest)
```
...
# **confirmShipment**
```java
Mono<EmptyApiResponse> FbsApi.confirmShipment(campaignIdshipmentIdconfirmShipmentRequest)
```
...
# **createChat**
```java
Mono<CreateChatResponse> FbsApi.createChat(businessIdcreateChatRequest)
```
...
```java
Mono<DeleteCampaignOffersResponse> FbsApi.deleteCampaignOffers(campaignIddeleteCampaignOffersRequest)
```
...
```java
Mono<EmptyApiResponse> FbsApi.deleteGoodsFeedbackComment(businessIddeleteGoodsFeedbackCommentRequest)
```
...
# **deleteHiddenOffers**
```java
Mono<EmptyApiResponse> FbsApi.deleteHiddenOffers(campaignIddeleteHiddenOffersRequest)
```
...
# **deleteOffers**
```java
Mono<DeleteOffersResponse> FbsApi.deleteOffers(businessIddeleteOffersRequest)
```
...
```java
Mono<DeleteOffersFromArchiveResponse> FbsApi.deleteOffersFromArchive(businessIddeleteOffersFromArchiveRequest)
```
...
# **deletePromoOffers**
```java
Mono<DeletePromoOffersResponse> FbsApi.deletePromoOffers(businessIddeletePromoOffersRequest)
```
...
# **downloadShipmentAct**
```java
Mono<File> FbsApi.downloadShipmentAct(campaignIdshipmentId)
```
...
```java
Mono<File> FbsApi.downloadShipmentDiscrepancyAct(campaignIdshipmentId)
```
...
```java
Mono<File> FbsApi.downloadShipmentInboundAct(campaignIdshipmentId)
```
...
```java
Mono<File> FbsApi.downloadShipmentPalletLabels(campaignIdshipmentId_format)
```
...
```java
Mono<File> FbsApi.downloadShipmentReceptionTransferAct(campaignIdwarehouseId)
```
...
```java
Mono<File> FbsApi.downloadShipmentTransportationWaybill(campaignIdshipmentId)
```
...
```java
Mono<GenerateReportResponse> FbsApi.generateBoostConsolidatedReport(generateBoostConsolidatedRequest_format)
```
...
```java
Mono<GenerateReportResponse> FbsApi.generateCompetitorsPositionReport(generateCompetitorsPositionReportRequest_format)
```
...
```java
Mono<GenerateReportResponse> FbsApi.generateGoodsFeedbackReport(generateGoodsFeedbackRequest_format)
```
...
```java
Mono<GenerateReportResponse> FbsApi.generateGoodsRealizationReport(generateGoodsRealizationReportRequest_format)
```
...
```java
Mono<GenerateReportResponse> FbsApi.generateMassOrderLabelsReport(generateMassOrderLabelsRequest_format)
```
...
# **generateOrderLabel**
```java
Mono<File> FbsApi.generateOrderLabel(campaignIdorderIdshipmentIdboxId_format)
```
...
# **generateOrderLabels**
```java
Mono<File> FbsApi.generateOrderLabels(campaignIdorderId_format)
```
...
```java
Mono<GenerateReportResponse> FbsApi.generatePricesReport(generatePricesReportRequest_format)
```
...
```java
Mono<GenerateReportResponse> FbsApi.generateShelfsStatisticsReport(generateShelfsStatisticsRequest_format)
```
...
```java
Mono<GenerateReportResponse> FbsApi.generateShipmentListDocumentReport(generateShipmentListDocumentReportRequest)
```
...
```java
Mono<GenerateReportResponse> FbsApi.generateShowsSalesReport(generateShowsSalesReportRequest_format)
```
...
```java
Mono<GenerateReportResponse> FbsApi.generateStocksOnWarehousesReport(generateStocksOnWarehousesReportRequest_format)
```
...
```java
Mono<GenerateReportResponse> FbsApi.generateUnitedMarketplaceServicesReport(generateUnitedMarketplaceServicesReportRequest_format)
```
...
```java
Mono<GenerateReportResponse> FbsApi.generateUnitedNettingReport(generateUnitedNettingReportRequest_format)
```
...
```java
Mono<GenerateReportResponse> FbsApi.generateUnitedOrdersReport(generateUnitedOrdersRequest_format)
```
...
# **getAllOffers**
```java
Mono<GetAllOffersResponse> FbsApi.getAllOffers(campaignIdfeedIdchunk)
```
...
```java
Mono<GetBidsInfoResponse> FbsApi.getBidsInfoForBusiness(businessIdpageTokenlimitgetBidsInfoRequest)
```
...
```java
Mono<GetBidsRecommendationsResponse> FbsApi.getBidsRecommendations(businessIdgetBidsRecommendationsRequest)
```
...
```java
Mono<GetQuarantineOffersResponse> FbsApi.getBusinessQuarantineOffers(businessIdgetQuarantineOffersRequestpageTokenlimit)
```
...
# **getBusinessSettings**
```java
Mono<GetBusinessSettingsResponse> FbsApi.getBusinessSettings(businessId)
```
...
# **getCampaign**
```java
Mono<GetCampaignResponse> FbsApi.getCampaign(campaignId)
```
...
# **getCampaignLogins**
```java
Mono<GetCampaignLoginsResponse> FbsApi.getCampaignLogins(campaignId)
```
...
# **getCampaignOffers**
```java
Mono<GetCampaignOffersResponse> FbsApi.getCampaignOffers(campaignIdgetCampaignOffersRequestpageTokenlimit)
```
...
```java
Mono<GetQuarantineOffersResponse> FbsApi.getCampaignQuarantineOffers(campaignIdgetQuarantineOffersRequestpageTokenlimit)
```
...
# **getCampaignRegion**
```java
Mono<GetCampaignRegionResponse> FbsApi.getCampaignRegion(campaignId)
```
...
# **getCampaignSettings**
```java
Mono<GetCampaignSettingsResponse> FbsApi.getCampaignSettings(campaignId)
```
...
# **getCampaigns**
```java
Mono<GetCampaignsResponse> FbsApi.getCampaigns(pagepageSize)
```
...
# **getCampaignsByLogin**
```java
Mono<GetCampaignsResponse> FbsApi.getCampaignsByLogin(loginpagepageSize)
```
...
```java
Mono<GetCategoriesMaxSaleQuantumResponse> FbsApi.getCategoriesMaxSaleQuantum(getCategoriesMaxSaleQuantumRequest)
```
...
# **getCategoriesTree**
```java
Mono<GetCategoriesResponse> FbsApi.getCategoriesTree(getCategoriesRequest)
```
...
```java
Mono<GetCategoryContentParametersResponse> FbsApi.getCategoryContentParameters(categoryId)
```
...
# **getChatHistory**
```java
Mono<GetChatHistoryResponse> FbsApi.getChatHistory(businessIdchatIdgetChatHistoryRequestpageTokenlimit)
```
...
# **getChats**
```java
Mono<GetChatsResponse> FbsApi.getChats(businessIdgetChatsRequestpageTokenlimit)
```
...
# **getDeliveryServices**
```java
Mono<GetDeliveryServicesResponse> FbsApi.getDeliveryServices()
```
...
# **getFeed**
```java
Mono<GetFeedResponse> FbsApi.getFeed(campaignIdfeedId)
```
...
# **getFeedIndexLogs**
```java
Mono<GetFeedIndexLogsResponse> FbsApi.getFeedIndexLogs(campaignIdfeedIdlimitpublishedTimeFrompublishedTimeTostatus)
```
...
```java
Mono<GetFeedbackListResponse> FbsApi.getFeedbackAndCommentUpdates(campaignIdpageTokenlimitfromDate)
```
...
# **getFeeds**
```java
Mono<GetFeedsResponse> FbsApi.getFeeds(campaignId)
```
...
```java
Mono<GetGoodsFeedbackCommentsResponse> FbsApi.getGoodsFeedbackComments(businessIdgetGoodsFeedbackCommentsRequestpageTokenlimit)
```
...
# **getGoodsFeedbacks**
```java
Mono<GetGoodsFeedbackResponse> FbsApi.getGoodsFeedbacks(businessIdpageTokenlimitgetGoodsFeedbackRequest)
```
...
# **getGoodsStats**
```java
Mono<GetGoodsStatsResponse> FbsApi.getGoodsStats(campaignIdgetGoodsStatsRequest)
```
...
# **getHiddenOffers**
```java
Mono<GetHiddenOffersResponse> FbsApi.getHiddenOffers(campaignIdofferIdpageTokenlimitoffsetpagepageSize)
```
...
```java
Mono<GetOfferCardsContentStatusResponse> FbsApi.getOfferCardsContentStatus(businessIdpageTokenlimitgetOfferCardsContentStatusRequest)
```
...
```java
Mono<GetOfferMappingEntriesResponse> FbsApi.getOfferMappingEntries(campaignIdofferIdshopSkumappingKindstatusavailabilitycategoryIdvendorpageTokenlimit)
```
...
# **getOfferMappings**
```java
Mono<GetOfferMappingsResponse> FbsApi.getOfferMappings(businessIdpageTokenlimitgetOfferMappingsRequest)
```
...
```java
Mono<GetOfferRecommendationsResponse> FbsApi.getOfferRecommendations(businessIdgetOfferRecommendationsRequestpageTokenlimit)
```
...
# **getOffers**
```java
Mono<GetOffersResponse> FbsApi.getOffers(campaignIdqueryfeedIdshopCategoryIdcurrencymatchedpagepageSize)
```
...
# **getOrder**
```java
Mono<GetOrderResponse> FbsApi.getOrder(campaignIdorderId)
```
...
```java
Mono<GetBusinessBuyerInfoResponse> FbsApi.getOrderBusinessBuyerInfo(campaignIdorderId)
```
...
```java
Mono<GetBusinessDocumentsInfoResponse> FbsApi.getOrderBusinessDocumentsInfo(campaignIdorderId)
```
...
# **getOrderLabelsData**
```java
Mono<GetOrderLabelsDataResponse> FbsApi.getOrderLabelsData(campaignIdorderId)
```
...
# **getOrders**
```java
Mono<GetOrdersResponse> FbsApi.getOrders(campaignIdorderIdsstatussubstatusfromDatetoDatesupplierShipmentDateFromsupplierShipmentDateToupdatedAtFromupdatedAtTodispatchTypefakehasCisonlyWaitingForCancellationApproveonlyEstimatedDeliverybuyerTypepagepageSizepageTokenlimit)
```
...
# **getOrdersStats**
```java
Mono<GetOrdersStatsResponse> FbsApi.getOrdersStats(campaignIdpageTokenlimitgetOrdersStatsRequest)
```
...
# **getPrices**
```java
Mono<GetPricesResponse> FbsApi.getPrices(campaignIdpageTokenlimitarchived)
```
...
# **getPricesByOfferIds**
```java
Mono<GetPricesByOfferIdsResponse> FbsApi.getPricesByOfferIds(campaignIdpageTokenlimitgetPricesByOfferIdsRequest)
```
...
# **getPromoOffers**
```java
Mono<GetPromoOffersResponse> FbsApi.getPromoOffers(businessIdgetPromoOffersRequestpageTokenlimit)
```
...
# **getPromos**
```java
Mono<GetPromosResponse> FbsApi.getPromos(businessIdgetPromosRequest)
```
...
```java
Mono<GetQualityRatingDetailsResponse> FbsApi.getQualityRatingDetails(campaignId)
```
...
# **getQualityRatings**
```java
Mono<GetQualityRatingResponse> FbsApi.getQualityRatings(businessIdgetQualityRatingRequest)
```
...
# **getReportInfo**
```java
Mono<GetReportInfoResponse> FbsApi.getReportInfo(reportId)
```
...
# **getReturn**
```java
Mono<GetReturnResponse> FbsApi.getReturn(campaignIdorderIdreturnId)
```
...
```java
Mono<File> FbsApi.getReturnApplication(campaignIdorderIdreturnId)
```
...
# **getReturnPhoto**
```java
Mono<File> FbsApi.getReturnPhoto(campaignIdorderIdreturnIditemIdimageHash)
```
...
# **getReturns**
```java
Mono<GetReturnsResponse> FbsApi.getReturns(campaignIdpageTokenlimitorderIdsstatusestypefromDatetoDatefromDate2toDate2)
```
...
# **getShipment**
```java
Mono<GetShipmentResponse> FbsApi.getShipment(campaignIdshipmentIdcancelledOrders)
```
...
```java
Mono<GetShipmentOrdersInfoResponse> FbsApi.getShipmentOrdersInfo(campaignIdshipmentId)
```
...
# **getStocks**
```java
Mono<GetWarehouseStocksResponse> FbsApi.getStocks(campaignIdpageTokenlimitgetWarehouseStocksRequest)
```
...
```java
Mono<GetSuggestedOfferMappingEntriesResponse> FbsApi.getSuggestedOfferMappingEntries(campaignIdgetSuggestedOfferMappingEntriesRequest)
```
...
```java
Mono<GetSuggestedOfferMappingsResponse> FbsApi.getSuggestedOfferMappings(businessIdgetSuggestedOfferMappingsRequest)
```
...
# **getSuggestedPrices**
```java
Mono<SuggestPricesResponse> FbsApi.getSuggestedPrices(campaignIdsuggestPricesRequest)
```
...
# **getWarehouses**
```java
Mono<GetWarehousesResponse> FbsApi.getWarehouses(businessId)
```
...
```java
Mono<ProvideOrderItemIdentifiersResponse> FbsApi.provideOrderItemIdentifiers(campaignIdorderIdprovideOrderItemIdentifiersRequest)
```
...
# **putBidsForBusiness**
```java
Mono<EmptyApiResponse> FbsApi.putBidsForBusiness(businessIdputSkuBidsRequest)
```
...
# **putBidsForCampaign**
```java
Mono<EmptyApiResponse> FbsApi.putBidsForCampaign(campaignIdputSkuBidsRequest)
```
...
# **refreshFeed**
```java
Mono<EmptyApiResponse> FbsApi.refreshFeed(campaignIdfeedId)
```
...
```java
Mono<GetRegionWithChildrenResponse> FbsApi.searchRegionChildren(regionIdpagepageSize)
```
...
# **searchRegionsById**
```java
Mono<GetRegionsResponse> FbsApi.searchRegionsById(regionId)
```
...
# **searchRegionsByName**
```java
Mono<GetRegionsResponse> FbsApi.searchRegionsByName(namepageTokenlimit)
```
...
# **searchShipments**
```java
Mono<SearchShipmentsResponse> FbsApi.searchShipments(campaignIdsearchShipmentsRequestpageTokenlimit)
```
...
# **sendFileToChat**
```java
Mono<EmptyApiResponse> FbsApi.sendFileToChat(businessIdchatId_file)
```
...
# **sendMessageToChat**
```java
Mono<EmptyApiResponse> FbsApi.sendMessageToChat(businessIdchatIdsendMessageToChatRequest)
```
...
# **setFeedParams**
```java
Mono<EmptyApiResponse> FbsApi.setFeedParams(campaignIdfeedIdsetFeedParamsRequest)
```
...
# **setOrderBoxLayout**
```java
Mono<SetOrderBoxLayoutResponse> FbsApi.setOrderBoxLayout(campaignIdorderIdsetOrderBoxLayoutRequest)
```
...
```java
Mono<SetOrderShipmentBoxesResponse> FbsApi.setOrderShipmentBoxes(campaignIdorderIdshipmentIdsetOrderShipmentBoxesRequest)
```
...
```java
Mono<EmptyApiResponse> FbsApi.setShipmentPalletsCount(campaignIdshipmentIdsetShipmentPalletsCountRequest)
```
...
```java
Mono<EmptyApiResponse> FbsApi.skipGoodsFeedbacksReaction(businessIdskipGoodsFeedbackReactionRequest)
```
...
```java
Mono<EmptyApiResponse> FbsApi.transferOrdersFromShipment(campaignIdshipmentIdtransferOrdersFromShipmentRequest)
```
...
```java
Mono<EmptyApiResponse> FbsApi.updateBusinessPrices(businessIdupdateBusinessPricesRequest)
```
...
```java
Mono<EmptyApiResponse> FbsApi.updateCampaignOffers(campaignIdupdateCampaignOffersRequest)
```
...
```java
Mono<UpdateGoodsFeedbackCommentResponse> FbsApi.updateGoodsFeedbackComment(businessIdupdateGoodsFeedbackCommentRequest)
```
...
# **updateOfferContent**
```java
Mono<UpdateOfferContentResponse> FbsApi.updateOfferContent(businessIdupdateOfferContentRequest)
```
...
```java
Mono<EmptyApiResponse> FbsApi.updateOfferMappingEntries(campaignIdupdateOfferMappingEntryRequest)
```
...
# **updateOfferMappings**
```java
Mono<UpdateOfferMappingsResponse> FbsApi.updateOfferMappings(businessIdupdateOfferMappingsRequest)
```
...
# **updateOrderItems**
```java
Mono<Void> FbsApi.updateOrderItems(campaignIdorderIdupdateOrderItemRequest)
```
...
# **updateOrderStatus**
```java
Mono<UpdateOrderStatusResponse> FbsApi.updateOrderStatus(campaignIdorderIdupdateOrderStatusRequest)
```
...
# **updateOrderStatuses**
```java
Mono<UpdateOrderStatusesResponse> FbsApi.updateOrderStatuses(campaignIdupdateOrderStatusesRequest)
```
...
# **updatePrices**
```java
Mono<EmptyApiResponse> FbsApi.updatePrices(campaignIdupdatePricesRequest)
```
...
# **updatePromoOffers**
```java
Mono<UpdatePromoOffersResponse> FbsApi.updatePromoOffers(businessIdupdatePromoOffersRequest)
```
...
# **updateStocks**
```java
Mono<EmptyApiResponse> FbsApi.updateStocks(campaignIdupdateStocksRequest)
```
