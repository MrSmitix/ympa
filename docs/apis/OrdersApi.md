...
To initiate an instance of `OrdersApi`, you can use micronaut's `ApplicationContext`:
```java
/* imports
...
PetApi apiInstance = context.getBean(OrdersApi.class);
```
...
```java
Mono<EmptyApiResponse> OrdersApi.acceptOrderCancellation(campaignIdorderIdacceptOrderCancellationRequest)
```
...
# **getOrder**
```java
Mono<GetOrderResponse> OrdersApi.getOrder(campaignIdorderId)
```
...
# **getOrders**
```java
Mono<GetOrdersResponse> OrdersApi.getOrders(campaignIdorderIdsstatussubstatusfromDatetoDatesupplierShipmentDateFromsupplierShipmentDateToupdatedAtFromupdatedAtTodispatchTypefakehasCisonlyWaitingForCancellationApproveonlyEstimatedDeliverybuyerTypepagepageSizepageTokenlimit)
```
...
```java
Mono<EmptyApiResponse> OrdersApi.provideOrderDigitalCodes(campaignIdorderIdprovideOrderDigitalCodesRequest)
```
...
```java
Mono<ProvideOrderItemIdentifiersResponse> OrdersApi.provideOrderItemIdentifiers(campaignIdorderIdprovideOrderItemIdentifiersRequest)
```
...
# **setOrderBoxLayout**
```java
Mono<SetOrderBoxLayoutResponse> OrdersApi.setOrderBoxLayout(campaignIdorderIdsetOrderBoxLayoutRequest)
```
...
```java
Mono<SetOrderShipmentBoxesResponse> OrdersApi.setOrderShipmentBoxes(campaignIdorderIdshipmentIdsetOrderShipmentBoxesRequest)
```
...
# **updateOrderItems**
```java
Mono<Void> OrdersApi.updateOrderItems(campaignIdorderIdupdateOrderItemRequest)
```
...
# **updateOrderStatus**
```java
Mono<UpdateOrderStatusResponse> OrdersApi.updateOrderStatus(campaignIdorderIdupdateOrderStatusRequest)
```
...
# **updateOrderStatuses**
```java
Mono<UpdateOrderStatusesResponse> OrdersApi.updateOrderStatuses(campaignIdupdateOrderStatusesRequest)
```
