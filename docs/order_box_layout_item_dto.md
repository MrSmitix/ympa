...
**partial_count** | [**order_box_layout_partial_count_dto_t**](order_box_layout_partial_count_dto.md) \* |  | [optional] 
**instances** | [**list_t**](brief_order_item_instance_dto.md) \* | Переданные вами коды маркировки. | [optional] 
