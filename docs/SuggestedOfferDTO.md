...
# Table `SuggestedOfferDTO`
(mapped from: SuggestedOfferDTO)
...
**basicPrice** | basicPrice | long |  | [**BasePriceDTO**](BasePriceDTO.md) |  |  [optional] [foreignkey]
...
# **Table `SuggestedOfferDTOBarcodes`**
(mapped from: SuggestedOfferDTOBarcodes)

## Properties
Name | Mapping | SQL Type | Default | Type | Description | Notes
---- | ------- | -------- | ------- | ---- | ----------- | -----
suggestedOfferDTO | suggestedOfferDTO | long | | kotlin.Long | Primary Key | *one*
