...
import model_get_price_dto
import model_get_price_with_discount_dto
import model_offer_campaign_status_dto
...
type GetOfferDTO* = object
  ...
  campaigns*: seq[OfferCampaignStatusDTO] ## Список магазинов, в которых размещен товар. 
  sellingPrograms*: seq[OfferSellingProgramDTO] ## Информация о том, какие для товара доступны модели размещения. 
