...
import ../models/model_get_fulfillment_warehouses_response
...
proc getFulfillmentWarehouses*(httpClient: HttpClient): (Option[GetFulfillmentWarehousesResponse], Response) =
  ## Идентификаторы складов Маркета (FBY)

  let response = httpClient.get(basepath & "/warehouses")
  constructResult[GetFulfillmentWarehousesResponse](response)
