...
# Setup prompt
#
RUN echo 'export PS1="[Партнерский API Маркета] \$ "' >> ~/.bashrc
RUN echo 'export PROMPT="[Партнерский API Маркета] \$ "' >> ~/.zshrc
...
line REST client for $(tput setaf 6)Партнерский API Маркета$(tput sgr0).\n\
\n\
