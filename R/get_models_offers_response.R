#' Create a new GetModelsOffersResponse
#'
#' @description
#' Ответ на запрос списка предложений для моделей.
#'
#' @docType class
#' @title GetModelsOffersResponse
#' @description GetModelsOffersResponse Class
...
#' @export
GetModelsOffersResponse <- R6::R6Class(
  "GetModelsOffersResponse",
  public = list(
    `models` = NULL,
    `currency` = NULL,
    `regionId` = NULL,
    #' Initialize a new GetModelsOffersResponse class.
    #'
    #' @description
    #' Initialize a new GetModelsOffersResponse class.
    #'
    ...
    #' To JSON String
    #'
    #' @return GetModelsOffersResponse in JSON format
    #' @export
    toJSON = function() {
      GetModelsOffersResponseObject <- list()
      if (!is.null(self$`models`)) {
        GetModelsOffersResponseObject[["models"]] <-
          lapply(self$`models`, function(x) x$toJSON())
      }
      if (!is.null(self$`currency`)) {
        GetModelsOffersResponseObject[["currency"]] <-
          self$`currency`$toJSON()
      }
      if (!is.null(self$`regionId`)) {
        GetModelsOffersResponseObject[["regionId"]] <-
          self$`regionId`
      }
      GetModelsOffersResponseObject
    },
    #' Deserialize JSON string into an instance of GetModelsOffersResponse
    #'
    #' @description
    #' Deserialize JSON string into an instance of GetModelsOffersResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of GetModelsOffersResponse
    #' @export
...
',
    ...
    #' Validate JSON input with respect to GetModelsOffersResponse
    #'
    #' @description
    #' Validate JSON input with respect to GetModelsOffersResponse and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`models`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for GetModelsOffersResponse: the required field `models` is missing."))
      }
    },
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of GetModelsOffersResponse
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# GetModelsOffersResponse$unlock()
#
## Below is an example to define the print function
# GetModelsOffersResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# GetModelsOffersResponse$lock()
