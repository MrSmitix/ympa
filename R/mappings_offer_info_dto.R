#' Create a new MappingsOfferInfoDTO
#'
#' @description
#' Базовая информация о товарах в каталоге.
#'
#' @docType class
#' @title MappingsOfferInfoDTO
#' @description MappingsOfferInfoDTO Class
...
#' @export
MappingsOfferInfoDTO <- R6::R6Class(
  ...
  public = list(
    ...
    `certificate` = NULL,
    #' Initialize a new MappingsOfferInfoDTO class.
    #'
    #' @description
    #' Initialize a new MappingsOfferInfoDTO class.
    #'
    ...
    #' To JSON String
    #'
    #' @return MappingsOfferInfoDTO in JSON format
    #' @export
    toJSON = function() {
      MappingsOfferInfoDTOObject <- list()
      if (!is.null(self$`name`)) {
        MappingsOfferInfoDTOObject[["name"]] <-
          self$`name`
      }
      if (!is.null(self$`shopSku`)) {
        MappingsOfferInfoDTOObject[["shopSku"]] <-
          self$`shopSku`
      }
      if (!is.null(self$`category`)) {
        MappingsOfferInfoDTOObject[["category"]] <-
          self$`category`
      }
      if (!is.null(self$`vendor`)) {
        MappingsOfferInfoDTOObject[["vendor"]] <-
          self$`vendor`
      }
      if (!is.null(self$`vendorCode`)) {
        MappingsOfferInfoDTOObject[["vendorCode"]] <-
          self$`vendorCode`
      }
      if (!is.null(self$`description`)) {
        MappingsOfferInfoDTOObject[["description"]] <-
          self$`description`
      }
      if (!is.null(self$`id`)) {
        MappingsOfferInfoDTOObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`feedId`)) {
        MappingsOfferInfoDTOObject[["feedId"]] <-
          self$`feedId`
      }
      if (!is.null(self$`barcodes`)) {
        MappingsOfferInfoDTOObject[["barcodes"]] <-
          self$`barcodes`
      }
      if (!is.null(self$`urls`)) {
        MappingsOfferInfoDTOObject[["urls"]] <-
          self$`urls`
      }
      if (!is.null(self$`pictures`)) {
        MappingsOfferInfoDTOObject[["pictures"]] <-
          self$`pictures`
      }
      if (!is.null(self$`manufacturer`)) {
        MappingsOfferInfoDTOObject[["manufacturer"]] <-
          self$`manufacturer`
      }
      if (!is.null(self$`manufacturerCountries`)) {
        MappingsOfferInfoDTOObject[["manufacturerCountries"]] <-
          self$`manufacturerCountries`
      }
      if (!is.null(self$`minShipment`)) {
        MappingsOfferInfoDTOObject[["minShipment"]] <-
          self$`minShipment`
      }
      if (!is.null(self$`transportUnitSize`)) {
        MappingsOfferInfoDTOObject[["transportUnitSize"]] <-
          self$`transportUnitSize`
      }
      if (!is.null(self$`quantumOfSupply`)) {
        MappingsOfferInfoDTOObject[["quantumOfSupply"]] <-
          self$`quantumOfSupply`
      }
      if (!is.null(self$`deliveryDurationDays`)) {
        MappingsOfferInfoDTOObject[["deliveryDurationDays"]] <-
          self$`deliveryDurationDays`
      }
      if (!is.null(self$`boxCount`)) {
        MappingsOfferInfoDTOObject[["boxCount"]] <-
          self$`boxCount`
      }
      if (!is.null(self$`customsCommodityCodes`)) {
        MappingsOfferInfoDTOObject[["customsCommodityCodes"]] <-
          self$`customsCommodityCodes`
      }
      if (!is.null(self$`weightDimensions`)) {
        MappingsOfferInfoDTOObject[["weightDimensions"]] <-
          self$`weightDimensions`$toJSON()
      }
      if (!is.null(self$`supplyScheduleDays`)) {
        MappingsOfferInfoDTOObject[["supplyScheduleDays"]] <-
          lapply(self$`supplyScheduleDays`, function(x) x$toJSON())
      }
      if (!is.null(self$`shelfLifeDays`)) {
        MappingsOfferInfoDTOObject[["shelfLifeDays"]] <-
          self$`shelfLifeDays`
      }
      if (!is.null(self$`lifeTimeDays`)) {
        MappingsOfferInfoDTOObject[["lifeTimeDays"]] <-
          self$`lifeTimeDays`
      }
      if (!is.null(self$`guaranteePeriodDays`)) {
        MappingsOfferInfoDTOObject[["guaranteePeriodDays"]] <-
          self$`guaranteePeriodDays`
      }
      if (!is.null(self$`processingState`)) {
        MappingsOfferInfoDTOObject[["processingState"]] <-
          self$`processingState`$toJSON()
      }
      if (!is.null(self$`availability`)) {
        MappingsOfferInfoDTOObject[["availability"]] <-
          self$`availability`$toJSON()
      }
      if (!is.null(self$`shelfLife`)) {
        MappingsOfferInfoDTOObject[["shelfLife"]] <-
          self$`shelfLife`$toJSON()
      }
      if (!is.null(self$`lifeTime`)) {
        MappingsOfferInfoDTOObject[["lifeTime"]] <-
          self$`lifeTime`$toJSON()
      }
      if (!is.null(self$`guaranteePeriod`)) {
        MappingsOfferInfoDTOObject[["guaranteePeriod"]] <-
          self$`guaranteePeriod`$toJSON()
      }
      if (!is.null(self$`certificate`)) {
        MappingsOfferInfoDTOObject[["certificate"]] <-
          self$`certificate`
      }
      MappingsOfferInfoDTOObject
    },
    #' Deserialize JSON string into an instance of MappingsOfferInfoDTO
    #'
    #' @description
    #' Deserialize JSON string into an instance of MappingsOfferInfoDTO
    #'
    #' @param input_json the JSON input
    #' @return the instance of MappingsOfferInfoDTO
    #' @export
...
',
    ...
    #' Validate JSON input with respect to MappingsOfferInfoDTO
    #'
    #' @description
    #' Validate JSON input with respect to MappingsOfferInfoDTO and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of MappingsOfferInfoDTO
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# MappingsOfferInfoDTO$unlock()
#
## Below is an example to define the print function
# MappingsOfferInfoDTO$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# MappingsOfferInfoDTO$lock()
