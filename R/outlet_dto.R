...
OutletDTO <- R6::R6Class(
  ...
  public = list(
    ...
    `deliveryRules` = NULL,
    `storagePeriod` = NULL,
    #' Initialize a new OutletDTO class.
    #'
    #' @description
    #' Initialize a new OutletDTO class.
    #'
    ...
    #' To JSON String
    #'
    #' @return OutletDTO in JSON format
    #' @export
    toJSON = function() {
      OutletDTOObject <- list()
      if (!is.null(self$`name`)) {
        OutletDTOObject[["name"]] <-
          self$`name`
      }
      if (!is.null(self$`type`)) {
        OutletDTOObject[["type"]] <-
          self$`type`$toJSON()
      }
      if (!is.null(self$`coords`)) {
        OutletDTOObject[["coords"]] <-
          self$`coords`
      }
      if (!is.null(self$`isMain`)) {
        OutletDTOObject[["isMain"]] <-
          self$`isMain`
      }
      if (!is.null(self$`shopOutletCode`)) {
        OutletDTOObject[["shopOutletCode"]] <-
          self$`shopOutletCode`
      }
      if (!is.null(self$`visibility`)) {
        OutletDTOObject[["visibility"]] <-
          self$`visibility`$toJSON()
      }
      if (!is.null(self$`address`)) {
        OutletDTOObject[["address"]] <-
          self$`address`$toJSON()
      }
      if (!is.null(self$`phones`)) {
        OutletDTOObject[["phones"]] <-
          self$`phones`
      }
      if (!is.null(self$`workingSchedule`)) {
        OutletDTOObject[["workingSchedule"]] <-
          self$`workingSchedule`$toJSON()
      }
      if (!is.null(self$`deliveryRules`)) {
        OutletDTOObject[["deliveryRules"]] <-
          lapply(self$`deliveryRules`, function(x) x$toJSON())
      }
      if (!is.null(self$`storagePeriod`)) {
        OutletDTOObject[["storagePeriod"]] <-
          self$`storagePeriod`
      }
      OutletDTOObject
    },
    #' Deserialize JSON string into an instance of OutletDTO
    #'
    #' @description
    #' Deserialize JSON string into an instance of OutletDTO
    #'
    #' @param input_json the JSON input
    #' @return the instance of OutletDTO
    #' @export
...
',
    ...
    #' Validate JSON input with respect to OutletDTO
    #'
    #' @description
    #' Validate JSON input with respect to OutletDTO and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`name`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for OutletDTO: the required field `name` is missing."))
      }
      # check the required field `type`
      if (!is.null(input_json$`type`)) {
        stopifnot(R6::is.R6(input_json$`type`))
      } else {
        stop(paste("The JSON input `", input, "` is invalid for OutletDTO: the required field `type` is missing."))
      }
      # check the required field `address`
      if (!is.null(input_json$`address`)) {
        stopifnot(R6::is.R6(input_json$`address`))
      } else {
        stop(paste("The JSON input `", input, "` is invalid for OutletDTO: the required field `address` is missing."))
      }
      ...
      if (!is.null(input_json$`phones`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for OutletDTO: the required field `phones` is missing."))
      }
      ...
      if (!is.null(input_json$`workingSchedule`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for OutletDTO: the required field `workingSchedule` is missing."))
      }
    },
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of OutletDTO
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# OutletDTO$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
