#' Create a new RejectedPromoOfferUpdateDTO
#'
#' @description
#' Описание отклоненного изменения.
#'
#' @docType class
#' @title RejectedPromoOfferUpdateDTO
#' @description RejectedPromoOfferUpdateDTO Class
...
#' @field reason  \link{RejectedPromoOfferUpdateReasonType}
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
RejectedPromoOfferUpdateDTO <- R6::R6Class(
  "RejectedPromoOfferUpdateDTO",
  public = list(
    `offerId` = NULL,
    `reason` = NULL,
    #' Initialize a new RejectedPromoOfferUpdateDTO class.
    #'
    #' @description
    #' Initialize a new RejectedPromoOfferUpdateDTO class.
    #'
    ...
    #' To JSON String
    #'
    #' @return RejectedPromoOfferUpdateDTO in JSON format
    #' @export
    toJSON = function() {
      RejectedPromoOfferUpdateDTOObject <- list()
      if (!is.null(self$`offerId`)) {
        RejectedPromoOfferUpdateDTOObject[["offerId"]] <-
          self$`offerId`
      }
      if (!is.null(self$`reason`)) {
        RejectedPromoOfferUpdateDTOObject[["reason"]] <-
          self$`reason`$toJSON()
      }
      RejectedPromoOfferUpdateDTOObject
    },
    #' Deserialize JSON string into an instance of RejectedPromoOfferUpdateDTO
    #'
    #' @description
    #' Deserialize JSON string into an instance of RejectedPromoOfferUpdateDTO
    #'
    #' @param input_json the JSON input
    #' @return the instance of RejectedPromoOfferUpdateDTO
    #' @export
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`reason`)) {
        `reason_object` <- RejectedPromoOfferUpdateReasonType$new()
    ...
    fromJSONString = function(input_json) {
      this_object <- jsonlite::fromJSON(input_json)
      self$`offerId` <- this_object$`offerId`
      self$`reason` <- RejectedPromoOfferUpdateReasonType$new()$fromJSON(jsonlite::toJSON(this_object$`reason`, auto_unbox = TRUE, digits = NA))
      self
    },
    #' Validate JSON input with respect to RejectedPromoOfferUpdateDTO
    #'
    #' @description
    #' Validate JSON input with respect to RejectedPromoOfferUpdateDTO and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`offerId`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for RejectedPromoOfferUpdateDTO: the required field `offerId` is missing."))
      }
      # check the required field `reason`
      if (!is.null(input_json$`reason`)) {
        stopifnot(R6::is.R6(input_json$`reason`))
      } else {
        stop(paste("The JSON input `", input, "` is invalid for RejectedPromoOfferUpdateDTO: the required field `reason` is missing."))
      }
    },
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of RejectedPromoOfferUpdateDTO
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# RejectedPromoOfferUpdateDTO$unlock()
#
## Below is an example to define the print function
# RejectedPromoOfferUpdateDTO$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# RejectedPromoOfferUpdateDTO$lock()
