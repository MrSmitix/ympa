#' Create a new OutletLicenseDTO
#'
#' @description
#' Информация о лицензии.
#'
#' @docType class
#' @title OutletLicenseDTO
#' @description OutletLicenseDTO Class
...
OutletLicenseDTO <- R6::R6Class(
  ...
  public = list(
    ...
    `dateOfIssue` = NULL,
    `dateOfExpiry` = NULL,
    #' Initialize a new OutletLicenseDTO class.
    #'
    #' @description
    #' Initialize a new OutletLicenseDTO class.
    #'
    ...
    #' @export
    initialize = function(`id` = NULL, `outletId` = NULL, `licenseType` = NULL, `number` = NULL, `dateOfIssue` = NULL, `dateOfExpiry` = NULL, ...) {
      if (!is.null(`id`)) {
    ...
    #' To JSON String
    #'
    #' @return OutletLicenseDTO in JSON format
    #' @export
    toJSON = function() {
      OutletLicenseDTOObject <- list()
      if (!is.null(self$`id`)) {
        OutletLicenseDTOObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`outletId`)) {
        OutletLicenseDTOObject[["outletId"]] <-
          self$`outletId`
      }
      if (!is.null(self$`licenseType`)) {
        OutletLicenseDTOObject[["licenseType"]] <-
          self$`licenseType`$toJSON()
      }
      if (!is.null(self$`number`)) {
        OutletLicenseDTOObject[["number"]] <-
          self$`number`
      }
      if (!is.null(self$`dateOfIssue`)) {
        OutletLicenseDTOObject[["dateOfIssue"]] <-
          self$`dateOfIssue`
      }
      if (!is.null(self$`dateOfExpiry`)) {
        OutletLicenseDTOObject[["dateOfExpiry"]] <-
          self$`dateOfExpiry`
      }
      OutletLicenseDTOObject
    },
    #' Deserialize JSON string into an instance of OutletLicenseDTO
    #'
    #' @description
    #' Deserialize JSON string into an instance of OutletLicenseDTO
    #'
    #' @param input_json the JSON input
    #' @return the instance of OutletLicenseDTO
    #' @export
    ...
    #' Validate JSON input with respect to OutletLicenseDTO
    #'
    #' @description
    #' Validate JSON input with respect to OutletLicenseDTO and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of OutletLicenseDTO
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# OutletLicenseDTO$unlock()
#
## Below is an example to define the print function
# OutletLicenseDTO$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# OutletLicenseDTO$lock()
