#' Create a new UpdateMappingsOfferDTO
#'
#' @description
#' Информация о товарах в каталоге.
#'
#' @docType class
#' @title UpdateMappingsOfferDTO
#' @description UpdateMappingsOfferDTO Class
...
#' @export
UpdateMappingsOfferDTO <- R6::R6Class(
  ...
  public = list(
    ...
    `certificate` = NULL,
    #' Initialize a new UpdateMappingsOfferDTO class.
    #'
    #' @description
    #' Initialize a new UpdateMappingsOfferDTO class.
    #'
    ...
    #' To JSON String
    #'
    #' @return UpdateMappingsOfferDTO in JSON format
    #' @export
    toJSON = function() {
      UpdateMappingsOfferDTOObject <- list()
      if (!is.null(self$`name`)) {
        UpdateMappingsOfferDTOObject[["name"]] <-
          self$`name`
      }
      if (!is.null(self$`shopSku`)) {
        UpdateMappingsOfferDTOObject[["shopSku"]] <-
          self$`shopSku`
      }
      if (!is.null(self$`category`)) {
        UpdateMappingsOfferDTOObject[["category"]] <-
          self$`category`
      }
      if (!is.null(self$`vendor`)) {
        UpdateMappingsOfferDTOObject[["vendor"]] <-
          self$`vendor`
      }
      if (!is.null(self$`vendorCode`)) {
        UpdateMappingsOfferDTOObject[["vendorCode"]] <-
          self$`vendorCode`
      }
      if (!is.null(self$`description`)) {
        UpdateMappingsOfferDTOObject[["description"]] <-
          self$`description`
      }
      if (!is.null(self$`id`)) {
        UpdateMappingsOfferDTOObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`feedId`)) {
        UpdateMappingsOfferDTOObject[["feedId"]] <-
          self$`feedId`
      }
      if (!is.null(self$`barcodes`)) {
        UpdateMappingsOfferDTOObject[["barcodes"]] <-
          self$`barcodes`
      }
      if (!is.null(self$`urls`)) {
        UpdateMappingsOfferDTOObject[["urls"]] <-
          self$`urls`
      }
      if (!is.null(self$`pictures`)) {
        UpdateMappingsOfferDTOObject[["pictures"]] <-
          self$`pictures`
      }
      if (!is.null(self$`manufacturer`)) {
        UpdateMappingsOfferDTOObject[["manufacturer"]] <-
          self$`manufacturer`
      }
      if (!is.null(self$`manufacturerCountries`)) {
        UpdateMappingsOfferDTOObject[["manufacturerCountries"]] <-
          self$`manufacturerCountries`
      }
      if (!is.null(self$`minShipment`)) {
        UpdateMappingsOfferDTOObject[["minShipment"]] <-
          self$`minShipment`
      }
      if (!is.null(self$`transportUnitSize`)) {
        UpdateMappingsOfferDTOObject[["transportUnitSize"]] <-
          self$`transportUnitSize`
      }
      if (!is.null(self$`quantumOfSupply`)) {
        UpdateMappingsOfferDTOObject[["quantumOfSupply"]] <-
          self$`quantumOfSupply`
      }
      if (!is.null(self$`deliveryDurationDays`)) {
        UpdateMappingsOfferDTOObject[["deliveryDurationDays"]] <-
          self$`deliveryDurationDays`
      }
      if (!is.null(self$`boxCount`)) {
        UpdateMappingsOfferDTOObject[["boxCount"]] <-
          self$`boxCount`
      }
      if (!is.null(self$`customsCommodityCodes`)) {
        UpdateMappingsOfferDTOObject[["customsCommodityCodes"]] <-
          self$`customsCommodityCodes`
      }
      if (!is.null(self$`weightDimensions`)) {
        UpdateMappingsOfferDTOObject[["weightDimensions"]] <-
          self$`weightDimensions`$toJSON()
      }
      if (!is.null(self$`supplyScheduleDays`)) {
        UpdateMappingsOfferDTOObject[["supplyScheduleDays"]] <-
          lapply(self$`supplyScheduleDays`, function(x) x$toJSON())
      }
      if (!is.null(self$`shelfLifeDays`)) {
        UpdateMappingsOfferDTOObject[["shelfLifeDays"]] <-
          self$`shelfLifeDays`
      }
      if (!is.null(self$`lifeTimeDays`)) {
        UpdateMappingsOfferDTOObject[["lifeTimeDays"]] <-
          self$`lifeTimeDays`
      }
      if (!is.null(self$`guaranteePeriodDays`)) {
        UpdateMappingsOfferDTOObject[["guaranteePeriodDays"]] <-
          self$`guaranteePeriodDays`
      }
      if (!is.null(self$`processingState`)) {
        UpdateMappingsOfferDTOObject[["processingState"]] <-
          self$`processingState`$toJSON()
      }
      if (!is.null(self$`availability`)) {
        UpdateMappingsOfferDTOObject[["availability"]] <-
          self$`availability`$toJSON()
      }
      if (!is.null(self$`shelfLife`)) {
        UpdateMappingsOfferDTOObject[["shelfLife"]] <-
          self$`shelfLife`$toJSON()
      }
      if (!is.null(self$`lifeTime`)) {
        UpdateMappingsOfferDTOObject[["lifeTime"]] <-
          self$`lifeTime`$toJSON()
      }
      if (!is.null(self$`guaranteePeriod`)) {
        UpdateMappingsOfferDTOObject[["guaranteePeriod"]] <-
          self$`guaranteePeriod`$toJSON()
      }
      if (!is.null(self$`certificate`)) {
        UpdateMappingsOfferDTOObject[["certificate"]] <-
          self$`certificate`
      }
      UpdateMappingsOfferDTOObject
    },
    #' Deserialize JSON string into an instance of UpdateMappingsOfferDTO
    #'
    #' @description
    #' Deserialize JSON string into an instance of UpdateMappingsOfferDTO
    #'
    #' @param input_json the JSON input
    #' @return the instance of UpdateMappingsOfferDTO
    #' @export
...
',
    ...
    #' Validate JSON input with respect to UpdateMappingsOfferDTO
    #'
    #' @description
    #' Validate JSON input with respect to UpdateMappingsOfferDTO and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of UpdateMappingsOfferDTO
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# UpdateMappingsOfferDTO$unlock()
#
## Below is an example to define the print function
# UpdateMappingsOfferDTO$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# UpdateMappingsOfferDTO$lock()
