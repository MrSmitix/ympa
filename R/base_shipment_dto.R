#' Create a new BaseShipmentDTO
#'
#' @description
#' Информация об отгрузке.
#'
#' @docType class
#' @title BaseShipmentDTO
#' @description BaseShipmentDTO Class
...
BaseShipmentDTO <- R6::R6Class(
  ...
  public = list(
    ...
    `plannedCount` = NULL,
    `factCount` = NULL,
    #' Initialize a new BaseShipmentDTO class.
    #'
    #' @description
    #' Initialize a new BaseShipmentDTO class.
    #'
    ...
    #' @export
    initialize = function(`orderIds`, `id` = NULL, `planIntervalFrom` = NULL, `planIntervalTo` = NULL, `shipmentType` = NULL, `warehouse` = NULL, `warehouseTo` = NULL, `externalId` = NULL, `deliveryService` = NULL, `palletsCount` = NULL, `draftCount` = NULL, `plannedCount` = NULL, `factCount` = NULL, ...) {
      if (!missing(`orderIds`)) {
    ...
    #' To JSON String
    #'
    #' @return BaseShipmentDTO in JSON format
    #' @export
    toJSON = function() {
      BaseShipmentDTOObject <- list()
      if (!is.null(self$`id`)) {
        BaseShipmentDTOObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`planIntervalFrom`)) {
        BaseShipmentDTOObject[["planIntervalFrom"]] <-
          self$`planIntervalFrom`
      }
      if (!is.null(self$`planIntervalTo`)) {
        BaseShipmentDTOObject[["planIntervalTo"]] <-
          self$`planIntervalTo`
      }
      if (!is.null(self$`shipmentType`)) {
        BaseShipmentDTOObject[["shipmentType"]] <-
          self$`shipmentType`$toJSON()
      }
      if (!is.null(self$`warehouse`)) {
        BaseShipmentDTOObject[["warehouse"]] <-
          self$`warehouse`$toJSON()
      }
      if (!is.null(self$`warehouseTo`)) {
        BaseShipmentDTOObject[["warehouseTo"]] <-
          self$`warehouseTo`$toJSON()
      }
      if (!is.null(self$`externalId`)) {
        BaseShipmentDTOObject[["externalId"]] <-
          self$`externalId`
      }
      if (!is.null(self$`deliveryService`)) {
        BaseShipmentDTOObject[["deliveryService"]] <-
          self$`deliveryService`$toJSON()
      }
      if (!is.null(self$`palletsCount`)) {
        BaseShipmentDTOObject[["palletsCount"]] <-
          self$`palletsCount`$toJSON()
      }
      if (!is.null(self$`orderIds`)) {
        BaseShipmentDTOObject[["orderIds"]] <-
          self$`orderIds`
      }
      if (!is.null(self$`draftCount`)) {
        BaseShipmentDTOObject[["draftCount"]] <-
          self$`draftCount`
      }
      if (!is.null(self$`plannedCount`)) {
        BaseShipmentDTOObject[["plannedCount"]] <-
          self$`plannedCount`
      }
      if (!is.null(self$`factCount`)) {
        BaseShipmentDTOObject[["factCount"]] <-
          self$`factCount`
      }
      BaseShipmentDTOObject
    },
    #' Deserialize JSON string into an instance of BaseShipmentDTO
    #'
    #' @description
    #' Deserialize JSON string into an instance of BaseShipmentDTO
    #'
    #' @param input_json the JSON input
    #' @return the instance of BaseShipmentDTO
    #' @export
    ...
    #' Validate JSON input with respect to BaseShipmentDTO
    #'
    #' @description
    #' Validate JSON input with respect to BaseShipmentDTO and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`orderIds`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for BaseShipmentDTO: the required field `orderIds` is missing."))
      }
    },
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of BaseShipmentDTO
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# BaseShipmentDTO$unlock()
#
## Below is an example to define the print function
# BaseShipmentDTO$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# BaseShipmentDTO$lock()
