#' Create a new UpdatePromoOfferDTO
#'
#' @description
#' Описание товаров, которые участвуют в акции.
#'
#' @docType class
#' @title UpdatePromoOfferDTO
#' @description UpdatePromoOfferDTO Class
...
#' @field params  \link{UpdatePromoOfferParamsDTO} [optional]
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
UpdatePromoOfferDTO <- R6::R6Class(
  "UpdatePromoOfferDTO",
  public = list(
    `offerId` = NULL,
    `params` = NULL,
    #' Initialize a new UpdatePromoOfferDTO class.
    #'
    #' @description
    #' Initialize a new UpdatePromoOfferDTO class.
    #'
    ...
    #' @export
    initialize = function(`offerId`, `params` = NULL, ...) {
      if (!missing(`offerId`)) {
    ...
    #' To JSON String
    #'
    #' @return UpdatePromoOfferDTO in JSON format
    #' @export
    toJSON = function() {
      UpdatePromoOfferDTOObject <- list()
      if (!is.null(self$`offerId`)) {
        UpdatePromoOfferDTOObject[["offerId"]] <-
          self$`offerId`
      }
      if (!is.null(self$`params`)) {
        UpdatePromoOfferDTOObject[["params"]] <-
          self$`params`$toJSON()
      }
      UpdatePromoOfferDTOObject
    },
    #' Deserialize JSON string into an instance of UpdatePromoOfferDTO
    #'
    #' @description
    #' Deserialize JSON string into an instance of UpdatePromoOfferDTO
    #'
    #' @param input_json the JSON input
    #' @return the instance of UpdatePromoOfferDTO
    #' @export
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`params`)) {
        `params_object` <- UpdatePromoOfferParamsDTO$new()
    ...
    fromJSONString = function(input_json) {
      this_object <- jsonlite::fromJSON(input_json)
      self$`offerId` <- this_object$`offerId`
      self$`params` <- UpdatePromoOfferParamsDTO$new()$fromJSON(jsonlite::toJSON(this_object$`params`, auto_unbox = TRUE, digits = NA))
      self
    },
    #' Validate JSON input with respect to UpdatePromoOfferDTO
    #'
    #' @description
    #' Validate JSON input with respect to UpdatePromoOfferDTO and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`offerId`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for UpdatePromoOfferDTO: the required field `offerId` is missing."))
      }
    },
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of UpdatePromoOfferDTO
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# UpdatePromoOfferDTO$unlock()
#
## Below is an example to define the print function
# UpdatePromoOfferDTO$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# UpdatePromoOfferDTO$lock()
