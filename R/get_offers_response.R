#' Create a new GetOffersResponse
#'
#' @description
...
#' @description GetOffersResponse Class
...
#' @export
GetOffersResponse <- R6::R6Class(
  "GetOffersResponse",
  public = list(
    `offers` = NULL,
    `pager` = NULL,
    #' Initialize a new GetOffersResponse class.
    #'
    #' @description
    #' Initialize a new GetOffersResponse class.
    #'
    ...
    #' @export
    initialize = function(`offers`, `pager` = NULL, ...) {
      if (!missing(`offers`)) {
    ...
    #' To JSON String
    #'
    #' @return GetOffersResponse in JSON format
    #' @export
    toJSON = function() {
      GetOffersResponseObject <- list()
      if (!is.null(self$`offers`)) {
        GetOffersResponseObject[["offers"]] <-
          lapply(self$`offers`, function(x) x$toJSON())
      }
      if (!is.null(self$`pager`)) {
        GetOffersResponseObject[["pager"]] <-
          self$`pager`$toJSON()
      }
      GetOffersResponseObject
    },
    #' Deserialize JSON string into an instance of GetOffersResponse
    #'
    #' @description
    #' Deserialize JSON string into an instance of GetOffersResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of GetOffersResponse
    #' @export
...
',
    ...
    #' Validate JSON input with respect to GetOffersResponse
    #'
    #' @description
    #' Validate JSON input with respect to GetOffersResponse and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`offers`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for GetOffersResponse: the required field `offers` is missing."))
      }
    },
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of GetOffersResponse
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# GetOffersResponse$unlock()
#
## Below is an example to define the print function
# GetOffersResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# GetOffersResponse$lock()
