...
#' @docType class
#' @title BaseOfferDTO
#' @description BaseOfferDTO Class
...
BaseOfferDTO <- R6::R6Class(
  ...
  public = list(
    ...
    `age` = NULL,
    `params` = NULL,
    #' Initialize a new BaseOfferDTO class.
    #'
    #' @description
    #' Initialize a new BaseOfferDTO class.
    #'
    ...
    #' To JSON String
    #'
    #' @return BaseOfferDTO in JSON format
    #' @export
    toJSON = function() {
      BaseOfferDTOObject <- list()
      if (!is.null(self$`offerId`)) {
        BaseOfferDTOObject[["offerId"]] <-
          self$`offerId`
      }
      if (!is.null(self$`name`)) {
        BaseOfferDTOObject[["name"]] <-
          self$`name`
      }
      if (!is.null(self$`marketCategoryId`)) {
        BaseOfferDTOObject[["marketCategoryId"]] <-
          self$`marketCategoryId`
      }
      if (!is.null(self$`category`)) {
        BaseOfferDTOObject[["category"]] <-
          self$`category`
      }
      if (!is.null(self$`pictures`)) {
        BaseOfferDTOObject[["pictures"]] <-
          self$`pictures`
      }
      if (!is.null(self$`videos`)) {
        BaseOfferDTOObject[["videos"]] <-
          self$`videos`
      }
      if (!is.null(self$`manuals`)) {
        BaseOfferDTOObject[["manuals"]] <-
          lapply(self$`manuals`, function(x) x$toJSON())
      }
      if (!is.null(self$`vendor`)) {
        BaseOfferDTOObject[["vendor"]] <-
          self$`vendor`
      }
      if (!is.null(self$`barcodes`)) {
        BaseOfferDTOObject[["barcodes"]] <-
          self$`barcodes`
      }
      if (!is.null(self$`description`)) {
        BaseOfferDTOObject[["description"]] <-
          self$`description`
      }
      if (!is.null(self$`manufacturerCountries`)) {
        BaseOfferDTOObject[["manufacturerCountries"]] <-
          self$`manufacturerCountries`
      }
      if (!is.null(self$`weightDimensions`)) {
        BaseOfferDTOObject[["weightDimensions"]] <-
          self$`weightDimensions`$toJSON()
      }
      if (!is.null(self$`vendorCode`)) {
        BaseOfferDTOObject[["vendorCode"]] <-
          self$`vendorCode`
      }
      if (!is.null(self$`tags`)) {
        BaseOfferDTOObject[["tags"]] <-
          self$`tags`
      }
      if (!is.null(self$`shelfLife`)) {
        BaseOfferDTOObject[["shelfLife"]] <-
          self$`shelfLife`$toJSON()
      }
      if (!is.null(self$`lifeTime`)) {
        BaseOfferDTOObject[["lifeTime"]] <-
          self$`lifeTime`$toJSON()
      }
      if (!is.null(self$`guaranteePeriod`)) {
        BaseOfferDTOObject[["guaranteePeriod"]] <-
          self$`guaranteePeriod`$toJSON()
      }
      if (!is.null(self$`customsCommodityCode`)) {
        BaseOfferDTOObject[["customsCommodityCode"]] <-
          self$`customsCommodityCode`
      }
      if (!is.null(self$`certificates`)) {
        BaseOfferDTOObject[["certificates"]] <-
          self$`certificates`
      }
      if (!is.null(self$`boxCount`)) {
        BaseOfferDTOObject[["boxCount"]] <-
          self$`boxCount`
      }
      if (!is.null(self$`condition`)) {
        BaseOfferDTOObject[["condition"]] <-
          self$`condition`$toJSON()
      }
      if (!is.null(self$`type`)) {
        BaseOfferDTOObject[["type"]] <-
          self$`type`$toJSON()
      }
      if (!is.null(self$`downloadable`)) {
        BaseOfferDTOObject[["downloadable"]] <-
          self$`downloadable`
      }
      if (!is.null(self$`adult`)) {
        BaseOfferDTOObject[["adult"]] <-
          self$`adult`
      }
      if (!is.null(self$`age`)) {
        BaseOfferDTOObject[["age"]] <-
          self$`age`$toJSON()
      }
      if (!is.null(self$`params`)) {
        BaseOfferDTOObject[["params"]] <-
          lapply(self$`params`, function(x) x$toJSON())
      }
      BaseOfferDTOObject
    },
    #' Deserialize JSON string into an instance of BaseOfferDTO
    #'
    #' @description
    #' Deserialize JSON string into an instance of BaseOfferDTO
    #'
    #' @param input_json the JSON input
    #' @return the instance of BaseOfferDTO
    #' @export
...
',
    ...
    #' Validate JSON input with respect to BaseOfferDTO
    #'
    #' @description
    #' Validate JSON input with respect to BaseOfferDTO and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`offerId`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for BaseOfferDTO: the required field `offerId` is missing."))
      }
    },
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of BaseOfferDTO
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# BaseOfferDTO$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
