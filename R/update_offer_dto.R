#' Create a new UpdateOfferDTO
#'
#' @description
#' Параметры товара.
#'
#' @docType class
#' @title UpdateOfferDTO
#' @description UpdateOfferDTO Class
...
UpdateOfferDTO <- R6::R6Class(
  ...
  public = list(
    ...
    `cofinancePrice` = NULL,
    #' Initialize a new UpdateOfferDTO class.
    #'
    #' @description
    #' Initialize a new UpdateOfferDTO class.
    #'
    ...
    #' To JSON String
    #'
    #' @return UpdateOfferDTO in JSON format
    #' @export
    toJSON = function() {
      UpdateOfferDTOObject <- list()
      if (!is.null(self$`offerId`)) {
        UpdateOfferDTOObject[["offerId"]] <-
          self$`offerId`
      }
      if (!is.null(self$`name`)) {
        UpdateOfferDTOObject[["name"]] <-
          self$`name`
      }
      if (!is.null(self$`marketCategoryId`)) {
        UpdateOfferDTOObject[["marketCategoryId"]] <-
          self$`marketCategoryId`
      }
      if (!is.null(self$`category`)) {
        UpdateOfferDTOObject[["category"]] <-
          self$`category`
      }
      if (!is.null(self$`pictures`)) {
        UpdateOfferDTOObject[["pictures"]] <-
          self$`pictures`
      }
      if (!is.null(self$`videos`)) {
        UpdateOfferDTOObject[["videos"]] <-
          self$`videos`
      }
      if (!is.null(self$`manuals`)) {
        UpdateOfferDTOObject[["manuals"]] <-
          lapply(self$`manuals`, function(x) x$toJSON())
      }
      if (!is.null(self$`vendor`)) {
        UpdateOfferDTOObject[["vendor"]] <-
          self$`vendor`
      }
      if (!is.null(self$`barcodes`)) {
        UpdateOfferDTOObject[["barcodes"]] <-
          self$`barcodes`
      }
      if (!is.null(self$`description`)) {
        UpdateOfferDTOObject[["description"]] <-
          self$`description`
      }
      if (!is.null(self$`manufacturerCountries`)) {
        UpdateOfferDTOObject[["manufacturerCountries"]] <-
          self$`manufacturerCountries`
      }
      if (!is.null(self$`weightDimensions`)) {
        UpdateOfferDTOObject[["weightDimensions"]] <-
          self$`weightDimensions`$toJSON()
      }
      if (!is.null(self$`vendorCode`)) {
        UpdateOfferDTOObject[["vendorCode"]] <-
          self$`vendorCode`
      }
      if (!is.null(self$`tags`)) {
        UpdateOfferDTOObject[["tags"]] <-
          self$`tags`
      }
      if (!is.null(self$`shelfLife`)) {
        UpdateOfferDTOObject[["shelfLife"]] <-
          self$`shelfLife`$toJSON()
      }
      if (!is.null(self$`lifeTime`)) {
        UpdateOfferDTOObject[["lifeTime"]] <-
          self$`lifeTime`$toJSON()
      }
      if (!is.null(self$`guaranteePeriod`)) {
        UpdateOfferDTOObject[["guaranteePeriod"]] <-
          self$`guaranteePeriod`$toJSON()
      }
      if (!is.null(self$`customsCommodityCode`)) {
        UpdateOfferDTOObject[["customsCommodityCode"]] <-
          self$`customsCommodityCode`
      }
      if (!is.null(self$`certificates`)) {
        UpdateOfferDTOObject[["certificates"]] <-
          self$`certificates`
      }
      if (!is.null(self$`boxCount`)) {
        UpdateOfferDTOObject[["boxCount"]] <-
          self$`boxCount`
      }
      if (!is.null(self$`condition`)) {
        UpdateOfferDTOObject[["condition"]] <-
          self$`condition`$toJSON()
      }
      if (!is.null(self$`type`)) {
        UpdateOfferDTOObject[["type"]] <-
          self$`type`$toJSON()
      }
      if (!is.null(self$`downloadable`)) {
        UpdateOfferDTOObject[["downloadable"]] <-
          self$`downloadable`
      }
      if (!is.null(self$`adult`)) {
        UpdateOfferDTOObject[["adult"]] <-
          self$`adult`
      }
      if (!is.null(self$`age`)) {
        UpdateOfferDTOObject[["age"]] <-
          self$`age`$toJSON()
      }
      if (!is.null(self$`params`)) {
        UpdateOfferDTOObject[["params"]] <-
          lapply(self$`params`, function(x) x$toJSON())
      }
      if (!is.null(self$`parameterValues`)) {
        UpdateOfferDTOObject[["parameterValues"]] <-
          lapply(self$`parameterValues`, function(x) x$toJSON())
      }
      if (!is.null(self$`basicPrice`)) {
        UpdateOfferDTOObject[["basicPrice"]] <-
          self$`basicPrice`$toJSON()
      }
      if (!is.null(self$`purchasePrice`)) {
        UpdateOfferDTOObject[["purchasePrice"]] <-
          self$`purchasePrice`$toJSON()
      }
      if (!is.null(self$`additionalExpenses`)) {
        UpdateOfferDTOObject[["additionalExpenses"]] <-
          self$`additionalExpenses`$toJSON()
      }
      if (!is.null(self$`cofinancePrice`)) {
        UpdateOfferDTOObject[["cofinancePrice"]] <-
          self$`cofinancePrice`$toJSON()
      }
      UpdateOfferDTOObject
    },
    #' Deserialize JSON string into an instance of UpdateOfferDTO
    #'
    #' @description
    #' Deserialize JSON string into an instance of UpdateOfferDTO
    #'
    #' @param input_json the JSON input
    #' @return the instance of UpdateOfferDTO
    #' @export
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`basicPrice`)) {
        `basicprice_object` <- UpdatePriceWithDiscountDTO$new()
      ...
      if (!is.null(this_object$`purchasePrice`)) {
        `purchaseprice_object` <- BasePriceDTO$new()
      ...
      if (!is.null(this_object$`additionalExpenses`)) {
        `additionalexpenses_object` <- BasePriceDTO$new()
      ...
      if (!is.null(this_object$`cofinancePrice`)) {
        `cofinanceprice_object` <- BasePriceDTO$new()
...
',
    ...
    fromJSONString = function(input_json) {
      ...
      self$`params` <- ApiClient$new()$deserializeObj(this_object$`params`, "array[OfferParamDTO]", loadNamespace("ympa_r_client"))
      self$`parameterValues` <- ApiClient$new()$deserializeObj(this_object$`parameterValues`, "array[ParameterValueDTO]", loadNamespace("ympa_r_client"))
      self$`basicPrice` <- UpdatePriceWithDiscountDTO$new()$fromJSON(jsonlite::toJSON(this_object$`basicPrice`, auto_unbox = TRUE, digits = NA))
      self$`purchasePrice` <- BasePriceDTO$new()$fromJSON(jsonlite::toJSON(this_object$`purchasePrice`, auto_unbox = TRUE, digits = NA))
      self$`additionalExpenses` <- BasePriceDTO$new()$fromJSON(jsonlite::toJSON(this_object$`additionalExpenses`, auto_unbox = TRUE, digits = NA))
      self$`cofinancePrice` <- BasePriceDTO$new()$fromJSON(jsonlite::toJSON(this_object$`cofinancePrice`, auto_unbox = TRUE, digits = NA))
      self
    },
    #' Validate JSON input with respect to UpdateOfferDTO
    #'
    #' @description
    #' Validate JSON input with respect to UpdateOfferDTO and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`offerId`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for UpdateOfferDTO: the required field `offerId` is missing."))
      }
    },
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of UpdateOfferDTO
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# UpdateOfferDTO$unlock()
#
## Below is an example to define the print function
# UpdateOfferDTO$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
