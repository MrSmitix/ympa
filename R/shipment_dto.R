...
ShipmentDTO <- R6::R6Class(
  ...
  public = list(
    ...
    #' Initialize a new ShipmentDTO class.
    #'
    #' @description
    #' Initialize a new ShipmentDTO class.
    #'
    ...
    #' @export
    initialize = function(`orderIds`, `availableActions`, `id` = NULL, `planIntervalFrom` = NULL, `planIntervalTo` = NULL, `shipmentType` = NULL, `warehouse` = NULL, `warehouseTo` = NULL, `externalId` = NULL, `deliveryService` = NULL, `palletsCount` = NULL, `draftCount` = NULL, `plannedCount` = NULL, `factCount` = NULL, `currentStatus` = NULL, ...) {
      if (!missing(`orderIds`)) {
...
',
    ...
    #' Validate JSON input with respect to ShipmentDTO
    #'
    #' @description
    #' Validate JSON input with respect to ShipmentDTO and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`orderIds`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ShipmentDTO: the required field `orderIds` is missing."))
      }
      ...
      if (!is.null(input_json$`availableActions`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ShipmentDTO: the required field `availableActions` is missing."))
      }
    },
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of ShipmentDTO
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# ShipmentDTO$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
