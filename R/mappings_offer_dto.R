#' Create a new MappingsOfferDTO
#'
#' @description
#' Информация о товарах в каталоге.
#'
#' @docType class
#' @title MappingsOfferDTO
#' @description MappingsOfferDTO Class
...
MappingsOfferDTO <- R6::R6Class(
  ...
  public = list(
    ...
    `certificate` = NULL,
    `price` = NULL,
    #' Initialize a new MappingsOfferDTO class.
    #'
    #' @description
    #' Initialize a new MappingsOfferDTO class.
    #'
    ...
    #' To JSON String
    #'
    #' @return MappingsOfferDTO in JSON format
    #' @export
    toJSON = function() {
      MappingsOfferDTOObject <- list()
      if (!is.null(self$`name`)) {
        MappingsOfferDTOObject[["name"]] <-
          self$`name`
      }
      if (!is.null(self$`shopSku`)) {
        MappingsOfferDTOObject[["shopSku"]] <-
          self$`shopSku`
      }
      if (!is.null(self$`category`)) {
        MappingsOfferDTOObject[["category"]] <-
          self$`category`
      }
      if (!is.null(self$`vendor`)) {
        MappingsOfferDTOObject[["vendor"]] <-
          self$`vendor`
      }
      if (!is.null(self$`vendorCode`)) {
        MappingsOfferDTOObject[["vendorCode"]] <-
          self$`vendorCode`
      }
      if (!is.null(self$`description`)) {
        MappingsOfferDTOObject[["description"]] <-
          self$`description`
      }
      if (!is.null(self$`id`)) {
        MappingsOfferDTOObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`feedId`)) {
        MappingsOfferDTOObject[["feedId"]] <-
          self$`feedId`
      }
      if (!is.null(self$`barcodes`)) {
        MappingsOfferDTOObject[["barcodes"]] <-
          self$`barcodes`
      }
      if (!is.null(self$`urls`)) {
        MappingsOfferDTOObject[["urls"]] <-
          self$`urls`
      }
      if (!is.null(self$`pictures`)) {
        MappingsOfferDTOObject[["pictures"]] <-
          self$`pictures`
      }
      if (!is.null(self$`manufacturer`)) {
        MappingsOfferDTOObject[["manufacturer"]] <-
          self$`manufacturer`
      }
      if (!is.null(self$`manufacturerCountries`)) {
        MappingsOfferDTOObject[["manufacturerCountries"]] <-
          self$`manufacturerCountries`
      }
      if (!is.null(self$`minShipment`)) {
        MappingsOfferDTOObject[["minShipment"]] <-
          self$`minShipment`
      }
      if (!is.null(self$`transportUnitSize`)) {
        MappingsOfferDTOObject[["transportUnitSize"]] <-
          self$`transportUnitSize`
      }
      if (!is.null(self$`quantumOfSupply`)) {
        MappingsOfferDTOObject[["quantumOfSupply"]] <-
          self$`quantumOfSupply`
      }
      if (!is.null(self$`deliveryDurationDays`)) {
        MappingsOfferDTOObject[["deliveryDurationDays"]] <-
          self$`deliveryDurationDays`
      }
      if (!is.null(self$`boxCount`)) {
        MappingsOfferDTOObject[["boxCount"]] <-
          self$`boxCount`
      }
      if (!is.null(self$`customsCommodityCodes`)) {
        MappingsOfferDTOObject[["customsCommodityCodes"]] <-
          self$`customsCommodityCodes`
      }
      if (!is.null(self$`weightDimensions`)) {
        MappingsOfferDTOObject[["weightDimensions"]] <-
          self$`weightDimensions`$toJSON()
      }
      if (!is.null(self$`supplyScheduleDays`)) {
        MappingsOfferDTOObject[["supplyScheduleDays"]] <-
          lapply(self$`supplyScheduleDays`, function(x) x$toJSON())
      }
      if (!is.null(self$`shelfLifeDays`)) {
        MappingsOfferDTOObject[["shelfLifeDays"]] <-
          self$`shelfLifeDays`
      }
      if (!is.null(self$`lifeTimeDays`)) {
        MappingsOfferDTOObject[["lifeTimeDays"]] <-
          self$`lifeTimeDays`
      }
      if (!is.null(self$`guaranteePeriodDays`)) {
        MappingsOfferDTOObject[["guaranteePeriodDays"]] <-
          self$`guaranteePeriodDays`
      }
      if (!is.null(self$`processingState`)) {
        MappingsOfferDTOObject[["processingState"]] <-
          self$`processingState`$toJSON()
      }
      if (!is.null(self$`availability`)) {
        MappingsOfferDTOObject[["availability"]] <-
          self$`availability`$toJSON()
      }
      if (!is.null(self$`shelfLife`)) {
        MappingsOfferDTOObject[["shelfLife"]] <-
          self$`shelfLife`$toJSON()
      }
      if (!is.null(self$`lifeTime`)) {
        MappingsOfferDTOObject[["lifeTime"]] <-
          self$`lifeTime`$toJSON()
      }
      if (!is.null(self$`guaranteePeriod`)) {
        MappingsOfferDTOObject[["guaranteePeriod"]] <-
          self$`guaranteePeriod`$toJSON()
      }
      if (!is.null(self$`certificate`)) {
        MappingsOfferDTOObject[["certificate"]] <-
          self$`certificate`
      }
      if (!is.null(self$`price`)) {
        MappingsOfferDTOObject[["price"]] <-
          self$`price`
      }
      MappingsOfferDTOObject
    },
    #' Deserialize JSON string into an instance of MappingsOfferDTO
    #'
    #' @description
    #' Deserialize JSON string into an instance of MappingsOfferDTO
    #'
    #' @param input_json the JSON input
    #' @return the instance of MappingsOfferDTO
    #' @export
...
',
    ...
    #' Validate JSON input with respect to MappingsOfferDTO
    #'
    #' @description
    #' Validate JSON input with respect to MappingsOfferDTO and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of MappingsOfferDTO
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# MappingsOfferDTO$unlock()
#
## Below is an example to define the print function
# MappingsOfferDTO$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# MappingsOfferDTO$lock()
