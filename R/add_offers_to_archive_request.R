#' Create a new AddOffersToArchiveRequest
#'
#' @description
#' Товары, которые нужно поместить в архив. 
#'
#' @docType class
#' @title AddOffersToArchiveRequest
#' @description AddOffersToArchiveRequest Class
#' @format An \code{R6Class} generator object
#' @field offerIds Список товаров, которые нужно поместить в архив. list(character)
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
AddOffersToArchiveRequest <- R6::R6Class(
  "AddOffersToArchiveRequest",
  public = list(
    `offerIds` = NULL,
    #' Initialize a new AddOffersToArchiveRequest class.
    #'
    #' @description
    #' Initialize a new AddOffersToArchiveRequest class.
    #'
    ...
    #' To JSON String
    #'
    #' @return AddOffersToArchiveRequest in JSON format
    #' @export
    toJSON = function() {
      AddOffersToArchiveRequestObject <- list()
      if (!is.null(self$`offerIds`)) {
        AddOffersToArchiveRequestObject[["offerIds"]] <-
          self$`offerIds`
      }
      AddOffersToArchiveRequestObject
    },
    #' Deserialize JSON string into an instance of AddOffersToArchiveRequest
    #'
    #' @description
    #' Deserialize JSON string into an instance of AddOffersToArchiveRequest
    #'
    #' @param input_json the JSON input
    #' @return the instance of AddOffersToArchiveRequest
    #' @export
    ...
    #' Validate JSON input with respect to AddOffersToArchiveRequest
    #'
    #' @description
    #' Validate JSON input with respect to AddOffersToArchiveRequest and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`offerIds`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for AddOffersToArchiveRequest: the required field `offerIds` is missing."))
      }
    },
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of AddOffersToArchiveRequest
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# AddOffersToArchiveRequest$unlock()
#
## Below is an example to define the print function
# AddOffersToArchiveRequest$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# AddOffersToArchiveRequest$lock()
