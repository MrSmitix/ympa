#' Create a new DeleteOffersRequest
#'
#' @description
...
#' @description DeleteOffersRequest Class
#' @format An \code{R6Class} generator object
#' @field offerIds Список SKU товаров, которые нужно удалить. list(character)
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
DeleteOffersRequest <- R6::R6Class(
  "DeleteOffersRequest",
  public = list(
    `offerIds` = NULL,
    #' Initialize a new DeleteOffersRequest class.
    #'
    #' @description
    #' Initialize a new DeleteOffersRequest class.
    #'
    ...
    #' To JSON String
    #'
    #' @return DeleteOffersRequest in JSON format
    #' @export
    toJSON = function() {
      DeleteOffersRequestObject <- list()
      if (!is.null(self$`offerIds`)) {
        DeleteOffersRequestObject[["offerIds"]] <-
          self$`offerIds`
      }
      DeleteOffersRequestObject
    },
    #' Deserialize JSON string into an instance of DeleteOffersRequest
    #'
    #' @description
    #' Deserialize JSON string into an instance of DeleteOffersRequest
    #'
    #' @param input_json the JSON input
    #' @return the instance of DeleteOffersRequest
    #' @export
    ...
    #' Validate JSON input with respect to DeleteOffersRequest
    #'
    #' @description
    #' Validate JSON input with respect to DeleteOffersRequest and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`offerIds`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for DeleteOffersRequest: the required field `offerIds` is missing."))
      }
    },
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of DeleteOffersRequest
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# DeleteOffersRequest$unlock()
#
## Below is an example to define the print function
# DeleteOffersRequest$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# DeleteOffersRequest$lock()
