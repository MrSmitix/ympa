#' Create a new OrderBuyerBasicInfoDTO
#'
#' @description
#' Информация о покупателе с базовыми полями.
#'
#' @docType class
#' @title OrderBuyerBasicInfoDTO
#' @description OrderBuyerBasicInfoDTO Class
...
#' @export
OrderBuyerBasicInfoDTO <- R6::R6Class(
  ...
  public = list(
    ...
    `middleName` = NULL,
    `type` = NULL,
    #' Initialize a new OrderBuyerBasicInfoDTO class.
    #'
    #' @description
    #' Initialize a new OrderBuyerBasicInfoDTO class.
    #'
    ...
    #' To JSON String
    #'
    #' @return OrderBuyerBasicInfoDTO in JSON format
    #' @export
    toJSON = function() {
      OrderBuyerBasicInfoDTOObject <- list()
      if (!is.null(self$`id`)) {
        OrderBuyerBasicInfoDTOObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`lastName`)) {
        OrderBuyerBasicInfoDTOObject[["lastName"]] <-
          self$`lastName`
      }
      if (!is.null(self$`firstName`)) {
        OrderBuyerBasicInfoDTOObject[["firstName"]] <-
          self$`firstName`
      }
      if (!is.null(self$`middleName`)) {
        OrderBuyerBasicInfoDTOObject[["middleName"]] <-
          self$`middleName`
      }
      if (!is.null(self$`type`)) {
        OrderBuyerBasicInfoDTOObject[["type"]] <-
          self$`type`$toJSON()
      }
      OrderBuyerBasicInfoDTOObject
    },
    #' Deserialize JSON string into an instance of OrderBuyerBasicInfoDTO
    #'
    #' @description
    #' Deserialize JSON string into an instance of OrderBuyerBasicInfoDTO
    #'
    #' @param input_json the JSON input
    #' @return the instance of OrderBuyerBasicInfoDTO
    #' @export
    ...
    #' Validate JSON input with respect to OrderBuyerBasicInfoDTO
    #'
    #' @description
    #' Validate JSON input with respect to OrderBuyerBasicInfoDTO and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of OrderBuyerBasicInfoDTO
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# OrderBuyerBasicInfoDTO$unlock()
#
## Below is an example to define the print function
# OrderBuyerBasicInfoDTO$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# OrderBuyerBasicInfoDTO$lock()
