#' Create a new UpdateOfferMappingResultDTO
#'
#' @description
#' Ошибки и предупреждения, которые появились из-за переданных характеристик.
#'
#' @docType class
#' @title UpdateOfferMappingResultDTO
#' @description UpdateOfferMappingResultDTO Class
...
#' @field errors Ошибки — информация в каталоге не обновится. list(\link{OfferMappingErrorDTO}) [optional]
#' @field warnings Предупреждения — информация в каталоге обновится. list(\link{OfferMappingErrorDTO}) [optional]
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
UpdateOfferMappingResultDTO <- R6::R6Class(
  "UpdateOfferMappingResultDTO",
  public = list(
    `offerId` = NULL,
    `errors` = NULL,
    `warnings` = NULL,
    #' Initialize a new UpdateOfferMappingResultDTO class.
    #'
    #' @description
    #' Initialize a new UpdateOfferMappingResultDTO class.
    #'
    ...
    #' To JSON String
    #'
    #' @return UpdateOfferMappingResultDTO in JSON format
    #' @export
    toJSON = function() {
      UpdateOfferMappingResultDTOObject <- list()
      if (!is.null(self$`offerId`)) {
        UpdateOfferMappingResultDTOObject[["offerId"]] <-
          self$`offerId`
      }
      if (!is.null(self$`errors`)) {
        UpdateOfferMappingResultDTOObject[["errors"]] <-
          lapply(self$`errors`, function(x) x$toJSON())
      }
      if (!is.null(self$`warnings`)) {
        UpdateOfferMappingResultDTOObject[["warnings"]] <-
          lapply(self$`warnings`, function(x) x$toJSON())
      }
      UpdateOfferMappingResultDTOObject
    },
    #' Deserialize JSON string into an instance of UpdateOfferMappingResultDTO
    #'
    #' @description
    #' Deserialize JSON string into an instance of UpdateOfferMappingResultDTO
    #'
    #' @param input_json the JSON input
    #' @return the instance of UpdateOfferMappingResultDTO
    #' @export
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`errors`)) {
        self$`errors` <- ApiClient$new()$deserializeObj(this_object$`errors`, "array[OfferMappingErrorDTO]", loadNamespace("ympa_r_client"))
      }
      if (!is.null(this_object$`warnings`)) {
        self$`warnings` <- ApiClient$new()$deserializeObj(this_object$`warnings`, "array[OfferMappingErrorDTO]", loadNamespace("ympa_r_client"))
      }
      self
    },
    #' To JSON string
...
',
    ...
    #' Validate JSON input with respect to UpdateOfferMappingResultDTO
    #'
    #' @description
    #' Validate JSON input with respect to UpdateOfferMappingResultDTO and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`offerId`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for UpdateOfferMappingResultDTO: the required field `offerId` is missing."))
      }
    },
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of UpdateOfferMappingResultDTO
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# UpdateOfferMappingResultDTO$unlock()
#
## Below is an example to define the print function
# UpdateOfferMappingResultDTO$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# UpdateOfferMappingResultDTO$lock()
