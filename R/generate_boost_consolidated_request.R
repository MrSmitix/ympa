#' Create a new GenerateBoostConsolidatedRequest
#'
#' @description
#' Данные, необходимые для генерации отчета. 
#'
#' @docType class
#' @title GenerateBoostConsolidatedRequest
#' @description GenerateBoostConsolidatedRequest Class
...
#' @export
GenerateBoostConsolidatedRequest <- R6::R6Class(
  "GenerateBoostConsolidatedRequest",
  public = list(
    `businessId` = NULL,
    `dateFrom` = NULL,
    `dateTo` = NULL,
    #' Initialize a new GenerateBoostConsolidatedRequest class.
    #'
    #' @description
    #' Initialize a new GenerateBoostConsolidatedRequest class.
    #'
    ...
    #' @export
    initialize = function(`businessId`, `dateFrom`, `dateTo`, ...) {
    ...
    #' To JSON String
    #'
    #' @return GenerateBoostConsolidatedRequest in JSON format
    #' @export
    toJSON = function() {
      GenerateBoostConsolidatedRequestObject <- list()
      if (!is.null(self$`businessId`)) {
        GenerateBoostConsolidatedRequestObject[["businessId"]] <-
          self$`businessId`
      }
      if (!is.null(self$`dateFrom`)) {
        GenerateBoostConsolidatedRequestObject[["dateFrom"]] <-
          self$`dateFrom`
      }
      if (!is.null(self$`dateTo`)) {
        GenerateBoostConsolidatedRequestObject[["dateTo"]] <-
          self$`dateTo`
      }
      GenerateBoostConsolidatedRequestObject
    },
    #' Deserialize JSON string into an instance of GenerateBoostConsolidatedRequest
    #'
    #' @description
    #' Deserialize JSON string into an instance of GenerateBoostConsolidatedRequest
    #'
    #' @param input_json the JSON input
    #' @return the instance of GenerateBoostConsolidatedRequest
    #' @export
    ...
    #' Validate JSON input with respect to GenerateBoostConsolidatedRequest
    #'
    #' @description
    #' Validate JSON input with respect to GenerateBoostConsolidatedRequest and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`businessId`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for GenerateBoostConsolidatedRequest: the required field `businessId` is missing."))
      }
      ...
      if (!is.null(input_json$`dateFrom`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for GenerateBoostConsolidatedRequest: the required field `dateFrom` is missing."))
      }
      ...
      if (!is.null(input_json$`dateTo`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for GenerateBoostConsolidatedRequest: the required field `dateTo` is missing."))
      }
    },
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of GenerateBoostConsolidatedRequest
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# GenerateBoostConsolidatedRequest$unlock()
#
## Below is an example to define the print function
# GenerateBoostConsolidatedRequest$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# GenerateBoostConsolidatedRequest$lock()
