...
try {
    ...
    print('Exception when calling OrdersApi->acceptOrderCancellation: $e\n');
}
```
...
try {
    ...
    print('Exception when calling OrdersApi->provideOrderDigitalCodes: $e\n');
}
```
...
try {
    ...
    print('Exception when calling OrdersApi->provideOrderItemIdentifiers: $e\n');
}
```
...
try {
    ...
    print('Exception when calling OrdersApi->setOrderBoxLayout: $e\n');
}
```
...
try {
    ...
    print('Exception when calling OrdersApi->setOrderShipmentBoxes: $e\n');
}
```
...
try {
    ...
    print('Exception when calling OrdersApi->updateOrderItems: $e\n');
}
```
...
try {
    ...
    print('Exception when calling OrdersApi->updateOrderStatus: $e\n');
}
```
...
try {
    ...
    print('Exception when calling OrdersApi->updateOrderStatuses: $e\n');
}
```
