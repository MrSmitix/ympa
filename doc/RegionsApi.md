...
try {
    ...
    print('Exception when calling RegionsApi->searchRegionChildren: $e\n');
}
```
...
try {
    ...
    print('Exception when calling RegionsApi->searchRegionsById: $e\n');
}
```
...
try {
    ...
    print('Exception when calling RegionsApi->searchRegionsByName: $e\n');
}
```
