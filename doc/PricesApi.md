...
try {
    ...
    print('Exception when calling PricesApi->getPricesByOfferIds: $e\n');
}
```
...
try {
    ...
    print('Exception when calling PricesApi->getSuggestedPrices: $e\n');
}
```
...
try {
    ...
    print('Exception when calling PricesApi->updateBusinessPrices: $e\n');
}
```
...
try {
    ...
    print('Exception when calling PricesApi->updatePrices: $e\n');
}
```
