...
final api_instance = OrderLabelsApi();
...
try {
    ...
    print('Exception when calling OrderLabelsApi->generateOrderLabel: $e\n');
}
```
...
try {
    ...
    print('Exception when calling OrderLabelsApi->generateOrderLabels: $e\n');
}
```
...
try {
    ...
    print('Exception when calling OrderLabelsApi->getOrderLabelsData: $e\n');
}
```
