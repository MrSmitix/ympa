...
final api_instance = GoodsFeedbackApi();
...
try {
    ...
    print('Exception when calling GoodsFeedbackApi->deleteGoodsFeedbackComment: $e\n');
}
```
...
try {
    ...
    print('Exception when calling GoodsFeedbackApi->getGoodsFeedbackComments: $e\n');
}
```
...
try {
    ...
    print('Exception when calling GoodsFeedbackApi->getGoodsFeedbacks: $e\n');
}
```
...
try {
    ...
    print('Exception when calling GoodsFeedbackApi->skipGoodsFeedbacksReaction: $e\n');
}
```
...
try {
    ...
    print('Exception when calling GoodsFeedbackApi->updateGoodsFeedbackComment: $e\n');
}
```
