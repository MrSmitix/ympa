# openapi.api.PriceQuarantineApi
...
final api_instance = PriceQuarantineApi();
...
try {
    ...
    print('Exception when calling PriceQuarantineApi->confirmBusinessPrices: $e\n');
}
```
...
try {
    ...
    print('Exception when calling PriceQuarantineApi->confirmCampaignPrices: $e\n');
}
```
...
try {
    ...
    print('Exception when calling PriceQuarantineApi->getBusinessQuarantineOffers: $e\n');
}
```
...
try {
    ...
    print('Exception when calling PriceQuarantineApi->getCampaignQuarantineOffers: $e\n');
}
```
