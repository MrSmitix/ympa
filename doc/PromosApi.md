...
try {
    ...
    print('Exception when calling PromosApi->deletePromoOffers: $e\n');
}
```
...
try {
    ...
    print('Exception when calling PromosApi->getPromoOffers: $e\n');
}
```
...
try {
    ...
    print('Exception when calling PromosApi->getPromos: $e\n');
}
```
...
try {
    ...
    print('Exception when calling PromosApi->updatePromoOffers: $e\n');
}
```
