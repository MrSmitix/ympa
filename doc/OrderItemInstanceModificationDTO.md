# openapi.model.OrderItemInstanceModificationDTO
...
**instances** | [**List<BriefOrderItemInstanceDTO>**](BriefOrderItemInstanceDTO.md) | Список кодов маркировки единиц товара.  | [default to const []]
