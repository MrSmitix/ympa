...
try {
    ...
    print('Exception when calling BidsApi->getBidsRecommendations: $e\n');
}
```
...
try {
    ...
    print('Exception when calling BidsApi->putBidsForBusiness: $e\n');
}
```
...
try {
    ...
    print('Exception when calling BidsApi->putBidsForCampaign: $e\n');
}
```
