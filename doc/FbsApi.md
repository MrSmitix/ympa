...
try {
    ...
    print('Exception when calling FbsApi->addHiddenOffers: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->addOffersToArchive: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->calculateTariffs: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->confirmBusinessPrices: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->confirmCampaignPrices: $e\n');
}
```
...
final api_instance = FbsApi();
final campaignId = 789; // int | Идентификатор кампании в API и магазина в кабинете. Каждая кампания в API соответствует магазину в кабинете.  Чтобы узнать идентификаторы своих магазинов, воспользуйтесь запросом [GET campaigns](../../reference/campaigns/getCampaigns.md).  ℹ️ [Что такое кабинет и магазин на Маркете](https://yandex.ru/support/marketplace/account/introduction.html) 
final shipmentId = 789; // int | Идентификатор отгрузки.
final confirmShipmentRequest = ConfirmShipmentRequest(); // ConfirmShipmentRequest | 

try {
    final result = api_instance.confirmShipment(campaignId, shipmentId, confirmShipmentRequest);
    print(result);
} catch (e) {
    print('Exception when calling FbsApi->confirmShipment: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->createChat: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->deleteCampaignOffers: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->deleteGoodsFeedbackComment: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->deleteHiddenOffers: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->deleteOffers: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->deleteOffersFromArchive: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->deletePromoOffers: $e\n');
}
```
...
# **downloadShipmentAct**
> MultipartFile downloadShipmentAct(campaignId, shipmentId)
...
try {
    final result = api_instance.downloadShipmentAct(campaignId, shipmentId);
    print(result);
} catch (e) {
    print('Exception when calling FbsApi->downloadShipmentAct: $e\n');
}
```
...
> MultipartFile downloadShipmentDiscrepancyAct(campaignId, shipmentId)
...
try {
    final result = api_instance.downloadShipmentDiscrepancyAct(campaignId, shipmentId);
    print(result);
} catch (e) {
    print('Exception when calling FbsApi->downloadShipmentDiscrepancyAct: $e\n');
}
```
...
> MultipartFile downloadShipmentInboundAct(campaignId, shipmentId)
...
try {
    final result = api_instance.downloadShipmentInboundAct(campaignId, shipmentId);
    print(result);
} catch (e) {
    print('Exception when calling FbsApi->downloadShipmentInboundAct: $e\n');
}
```
...
> MultipartFile downloadShipmentPalletLabels(campaignId, shipmentId, format)
...
final campaignId = 789; // int | Идентификатор кампании в API и магазина в кабинете. Каждая кампания в API соответствует магазину в кабинете.  Чтобы узнать идентификаторы своих магазинов, воспользуйтесь запросом [GET campaigns](../../reference/campaigns/getCampaigns.md).  ℹ️ [Что такое кабинет и магазин на Маркете](https://yandex.ru/support/marketplace/account/introduction.html) 
final shipmentId = 789; // int | Идентификатор отгрузки.
final format = ; // ShipmentPalletLabelPageFormatType | Формат страниц PDF-файла с ярлыками:  * `A4` — по 16 ярлыков на странице. * `A8` — по одному ярлыку на странице. 

try {
    final result = api_instance.downloadShipmentPalletLabels(campaignId, shipmentId, format);
    print(result);
} catch (e) {
    print('Exception when calling FbsApi->downloadShipmentPalletLabels: $e\n');
}
```
...
> MultipartFile downloadShipmentReceptionTransferAct(campaignId, warehouseId)
...
final api_instance = FbsApi();
final campaignId = 789; // int | Идентификатор кампании в API и магазина в кабинете. Каждая кампания в API соответствует магазину в кабинете.  Чтобы узнать идентификаторы своих магазинов, воспользуйтесь запросом [GET campaigns](../../reference/campaigns/getCampaigns.md).  ℹ️ [Что такое кабинет и магазин на Маркете](https://yandex.ru/support/marketplace/account/introduction.html) 
final warehouseId = 123123; // int | Идентификатор склада.

try {
    final result = api_instance.downloadShipmentReceptionTransferAct(campaignId, warehouseId);
    print(result);
} catch (e) {
    print('Exception when calling FbsApi->downloadShipmentReceptionTransferAct: $e\n');
}
```
...
> MultipartFile downloadShipmentTransportationWaybill(campaignId, shipmentId)
...
try {
    final result = api_instance.downloadShipmentTransportationWaybill(campaignId, shipmentId);
    print(result);
} catch (e) {
    print('Exception when calling FbsApi->downloadShipmentTransportationWaybill: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->generateBoostConsolidatedReport: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->generateCompetitorsPositionReport: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->generateGoodsFeedbackReport: $e\n');
}
```
...
final api_instance = FbsApi();
final generateGoodsRealizationReportRequest = GenerateGoodsRealizationReportRequest(); // GenerateGoodsRealizationReportRequest | 
final format = ; // ReportFormatType | Формат отчета.

try {
    final result = api_instance.generateGoodsRealizationReport(generateGoodsRealizationReportRequest, format);
    print(result);
} catch (e) {
    print('Exception when calling FbsApi->generateGoodsRealizationReport: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->generateMassOrderLabelsReport: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->generateOrderLabel: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->generateOrderLabels: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->generatePricesReport: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->generateShelfsStatisticsReport: $e\n');
}
```
...
final api_instance = FbsApi();
final generateShipmentListDocumentReportRequest = GenerateShipmentListDocumentReportRequest(); // GenerateShipmentListDocumentReportRequest | 

try {
    final result = api_instance.generateShipmentListDocumentReport(generateShipmentListDocumentReportRequest);
    print(result);
} catch (e) {
    print('Exception when calling FbsApi->generateShipmentListDocumentReport: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->generateShowsSalesReport: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->generateStocksOnWarehousesReport: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->generateUnitedMarketplaceServicesReport: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->generateUnitedNettingReport: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->generateUnitedOrdersReport: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->getAllOffers: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->getBidsInfoForBusiness: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->getBidsRecommendations: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->getBusinessQuarantineOffers: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->getBusinessSettings: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->getCampaign: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->getCampaignLogins: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->getCampaignOffers: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->getCampaignQuarantineOffers: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->getCampaignRegion: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->getCampaignSettings: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->getCampaigns: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->getCampaignsByLogin: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->getCategoriesMaxSaleQuantum: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->getCategoriesTree: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->getCategoryContentParameters: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->getChatHistory: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->getChats: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->getDeliveryServices: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->getFeed: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->getFeedIndexLogs: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->getFeedbackAndCommentUpdates: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->getFeeds: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->getGoodsFeedbackComments: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->getGoodsFeedbacks: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->getGoodsStats: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->getHiddenOffers: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->getOfferCardsContentStatus: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->getOfferMappingEntries: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->getOfferMappings: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->getOfferRecommendations: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->getOffers: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->getOrder: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->getOrderBusinessBuyerInfo: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->getOrderBusinessDocumentsInfo: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->getOrderLabelsData: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->getOrders: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->getOrdersStats: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->getPrices: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->getPricesByOfferIds: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->getPromoOffers: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->getPromos: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->getQualityRatingDetails: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->getQualityRatings: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->getReportInfo: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->getReturn: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->getReturnApplication: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->getReturnPhoto: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->getReturns: $e\n');
}
```
...
final campaignId = 789; // int | Идентификатор кампании в API и магазина в кабинете. Каждая кампания в API соответствует магазину в кабинете.  Чтобы узнать идентификаторы своих магазинов, воспользуйтесь запросом [GET campaigns](../../reference/campaigns/getCampaigns.md).  ℹ️ [Что такое кабинет и магазин на Маркете](https://yandex.ru/support/marketplace/account/introduction.html) 
final shipmentId = 789; // int | Идентификатор отгрузки.
final cancelledOrders = true; // bool | Возвращать ли отмененные заказы.  Значение по умолчанию — `true`. Если возвращать отмененные заказы не нужно, передайте значение `false`. 

try {
    final result = api_instance.getShipment(campaignId, shipmentId, cancelledOrders);
    print(result);
} catch (e) {
    print('Exception when calling FbsApi->getShipment: $e\n');
}
```
...
try {
    final result = api_instance.getShipmentOrdersInfo(campaignId, shipmentId);
    print(result);
} catch (e) {
    print('Exception when calling FbsApi->getShipmentOrdersInfo: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->getStocks: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->getSuggestedOfferMappingEntries: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->getSuggestedOfferMappings: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->getSuggestedPrices: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->getWarehouses: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->provideOrderItemIdentifiers: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->putBidsForBusiness: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->putBidsForCampaign: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->refreshFeed: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->searchRegionChildren: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->searchRegionsById: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->searchRegionsByName: $e\n');
}
```
...
final api_instance = FbsApi();
final campaignId = 789; // int | Идентификатор кампании в API и магазина в кабинете. Каждая кампания в API соответствует магазину в кабинете.  Чтобы узнать идентификаторы своих магазинов, воспользуйтесь запросом [GET campaigns](../../reference/campaigns/getCampaigns.md).  ℹ️ [Что такое кабинет и магазин на Маркете](https://yandex.ru/support/marketplace/account/introduction.html) 
final searchShipmentsRequest = SearchShipmentsRequest(); // SearchShipmentsRequest | 
final pageToken = eyBuZXh0SWQ6IDIzNDIgfQ==; // String | Идентификатор страницы c результатами.  Если параметр не указан, возвращается первая страница.  Рекомендуется передавать значение выходного параметра `nextPageToken`, полученное при последнем запросе.  Если задан `page_token` и в запросе есть параметры `offset`, `page_number` и `page_size`, они игнорируются. 
final limit = 20; // int | Количество значений на одной странице. 

try {
    final result = api_instance.searchShipments(campaignId, searchShipmentsRequest, pageToken, limit);
    print(result);
} catch (e) {
    print('Exception when calling FbsApi->searchShipments: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->sendFileToChat: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->sendMessageToChat: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->setFeedParams: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->setOrderBoxLayout: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->setOrderShipmentBoxes: $e\n');
}
```
...
final campaignId = 789; // int | Идентификатор кампании в API и магазина в кабинете. Каждая кампания в API соответствует магазину в кабинете.  Чтобы узнать идентификаторы своих магазинов, воспользуйтесь запросом [GET campaigns](../../reference/campaigns/getCampaigns.md).  ℹ️ [Что такое кабинет и магазин на Маркете](https://yandex.ru/support/marketplace/account/introduction.html) 
final shipmentId = 789; // int | Идентификатор отгрузки.
final setShipmentPalletsCountRequest = SetShipmentPalletsCountRequest(); // SetShipmentPalletsCountRequest | 

try {
    final result = api_instance.setShipmentPalletsCount(campaignId, shipmentId, setShipmentPalletsCountRequest);
    print(result);
} catch (e) {
    print('Exception when calling FbsApi->setShipmentPalletsCount: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->skipGoodsFeedbacksReaction: $e\n');
}
```
...
final campaignId = 789; // int | Идентификатор кампании в API и магазина в кабинете. Каждая кампания в API соответствует магазину в кабинете.  Чтобы узнать идентификаторы своих магазинов, воспользуйтесь запросом [GET campaigns](../../reference/campaigns/getCampaigns.md).  ℹ️ [Что такое кабинет и магазин на Маркете](https://yandex.ru/support/marketplace/account/introduction.html) 
final shipmentId = 789; // int | Идентификатор отгрузки.
final transferOrdersFromShipmentRequest = TransferOrdersFromShipmentRequest(); // TransferOrdersFromShipmentRequest | 

try {
    final result = api_instance.transferOrdersFromShipment(campaignId, shipmentId, transferOrdersFromShipmentRequest);
    print(result);
} catch (e) {
    print('Exception when calling FbsApi->transferOrdersFromShipment: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->updateBusinessPrices: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->updateCampaignOffers: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->updateGoodsFeedbackComment: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->updateOfferContent: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->updateOfferMappingEntries: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->updateOfferMappings: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->updateOrderItems: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->updateOrderStatus: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->updateOrderStatuses: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->updatePrices: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->updatePromoOffers: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FbsApi->updateStocks: $e\n');
}
```
