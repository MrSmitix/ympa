...
try {
    ...
    print('Exception when calling FeedsApi->getFeed: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FeedsApi->getFeedIndexLogs: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FeedsApi->getFeeds: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FeedsApi->setFeedParams: $e\n');
}
```
