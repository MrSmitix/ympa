...
try {
    ...
    print('Exception when calling ModelsApi->getModelOffers: $e\n');
}
```
...
try {
    ...
    print('Exception when calling ModelsApi->getModels: $e\n');
}
```
...
try {
    ...
    print('Exception when calling ModelsApi->getModelsOffers: $e\n');
}
```
...
try {
    ...
    print('Exception when calling ModelsApi->searchModels: $e\n');
}
```
