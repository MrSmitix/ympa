...
try {
    ...
    print('Exception when calling OutletsApi->createOutlet: $e\n');
}
```
...
try {
    ...
    print('Exception when calling OutletsApi->deleteOutlet: $e\n');
}
```
...
try {
    ...
    print('Exception when calling OutletsApi->getOutlet: $e\n');
}
```
...
try {
    ...
    print('Exception when calling OutletsApi->getOutlets: $e\n');
}
```
...
try {
    ...
    print('Exception when calling OutletsApi->updateOutlet: $e\n');
}
```
