...
final api_instance = OfferMappingsApi();
...
try {
    ...
    print('Exception when calling OfferMappingsApi->getOfferMappingEntries: $e\n');
}
```
...
try {
    ...
    print('Exception when calling OfferMappingsApi->getSuggestedOfferMappingEntries: $e\n');
}
```
...
try {
    ...
    print('Exception when calling OfferMappingsApi->updateOfferMappingEntries: $e\n');
}
```
