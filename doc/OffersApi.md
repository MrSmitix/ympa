...
try {
    ...
    print('Exception when calling OffersApi->deleteCampaignOffers: $e\n');
}
```
...
try {
    ...
    print('Exception when calling OffersApi->getAllOffers: $e\n');
}
```
...
try {
    ...
    print('Exception when calling OffersApi->getCampaignOffers: $e\n');
}
```
...
try {
    ...
    print('Exception when calling OffersApi->getOfferRecommendations: $e\n');
}
```
...
try {
    ...
    print('Exception when calling OffersApi->updateCampaignOffers: $e\n');
}
```
