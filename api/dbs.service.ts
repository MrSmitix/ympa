...
export class DbsService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getDeliveryServices(): Observable<AxiosResponse<GetDeliveryServicesResponse>>;
    public getDeliveryServices(): Observable<any> {
        let headers = {...this.defaultHeaders};
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.get<GetDeliveryServicesResponse>(`${this.basePath}/delivery/services`,
                    {
                        withCredentials: this.configuration.withCredentials,
                        headers: headers
                    }
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getWarehouses(businessId: number, ): Observable<AxiosResponse<GetWarehousesResponse>>;
    public getWarehouses(businessId: number, ): Observable<any> {
        if (businessId === null || businessId === undefined) {
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.get<GetWarehousesResponse>(`${this.basePath}/businesses/${encodeURIComponent(String(businessId))}/warehouses`,
                    {
                        withCredentials: this.configuration.withCredentials,
                        headers: headers
                    }
