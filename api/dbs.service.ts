...
export class DbsService {
     ...
     */
    public acceptOrderCancellation(campaignId: number, orderId: number, acceptOrderCancellationRequest: AcceptOrderCancellationRequest, observe?: 'body', headers?: Headers): Observable<EmptyApiResponse>;
    public acceptOrderCancellation(campaignId: number, orderId: number, acceptOrderCancellationRequest: AcceptOrderCancellationRequest, observe?: 'response', headers?: Headers): Observable<HttpResponse<EmptyApiResponse>>;
    public acceptOrderCancellation(campaignId: number, orderId: number, acceptOrderCancellationRequest: AcceptOrderCancellationRequest, observe: any = 'body', headers: Headers = {}): Observable<any> {
        ...
        const response: Observable<HttpResponse<EmptyApiResponse>> = this.httpClient.put(`${this.basePath}/campaigns/${encodeURIComponent(String(campaignId))}/orders/${encodeURIComponent(String(orderId))}/cancellation/accept`, acceptOrderCancellationRequest , headers);
        if (observe === 'body') {
     ...
     */
    public provideOrderDigitalCodes(campaignId: number, orderId: number, provideOrderDigitalCodesRequest: ProvideOrderDigitalCodesRequest, observe?: 'body', headers?: Headers): Observable<EmptyApiResponse>;
    public provideOrderDigitalCodes(campaignId: number, orderId: number, provideOrderDigitalCodesRequest: ProvideOrderDigitalCodesRequest, observe?: 'response', headers?: Headers): Observable<HttpResponse<EmptyApiResponse>>;
    public provideOrderDigitalCodes(campaignId: number, orderId: number, provideOrderDigitalCodesRequest: ProvideOrderDigitalCodesRequest, observe: any = 'body', headers: Headers = {}): Observable<any> {
        if (campaignId === null || campaignId === undefined){
        ...
        const response: Observable<HttpResponse<EmptyApiResponse>> = this.httpClient.post(`${this.basePath}/campaigns/${encodeURIComponent(String(campaignId))}/orders/${encodeURIComponent(String(orderId))}/deliverDigitalGoods`, provideOrderDigitalCodesRequest , headers);
        if (observe === 'body') {
               return response.pipe(
                   map((httpResponse: HttpResponse) => <EmptyApiResponse>(httpResponse.response))
               );
