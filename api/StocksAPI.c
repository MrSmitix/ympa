...
StocksAPI_getStocks(apiClient_t *apiClient, long campaignId, char *page_token, int *limit, get_warehouse_stocks_request_t *get_warehouse_stocks_request)
{
    ...
    cJSON *StocksAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    get_warehouse_stocks_response_t *elementToReturn = get_warehouse_stocks_response_parseFromJSON(StocksAPIlocalVarJSON);
    cJSON_Delete(StocksAPIlocalVarJSON);
...
StocksAPI_updateStocks(apiClient_t *apiClient, long campaignId, update_stocks_request_t *update_stocks_request)
{
    ...
    //nonprimitive not container
    cJSON *StocksAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_api_response_t *elementToReturn = empty_api_response_parseFromJSON(StocksAPIlocalVarJSON);
    cJSON_Delete(StocksAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
