...
class  OfferMappingsApi : public ApiBase {
public:
    explicit OfferMappingsApi(const std::shared_ptr<Pistache::Rest::Router>& rtr);
    ~OfferMappingsApi() override = default;
    void init() override;
...
private:
    ...
    void offer_mappings_api_default_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response);
