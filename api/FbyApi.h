...
class  FbyApi : public ApiBase {
public:
    explicit FbyApi(const std::shared_ptr<Pistache::Rest::Router>& rtr);
    ~FbyApi() override = default;
    void init() override;
...
private:
    ...
    void fby_api_default_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response);
