...
const std::string FbsApi::base = "";

FbsApi::FbsApi(const std::shared_ptr<Pistache::Rest::Router>& rtr)
    : ApiBase(rtr)
{
}
...
void FbsApi::setupRoutes() {
    using namespace Pistache::Rest;

    Routes::Post(*router, base + "/campaigns/:campaignId/hidden-offers", Routes::bind(&FbsApi::add_hidden_offers_handler, this));
    Routes::Post(*router, base + "/businesses/:businessId/offer-mappings/archive", Routes::bind(&FbsApi::add_offers_to_archive_handler, this));
    Routes::Post(*router, base + "/tariffs/calculate", Routes::bind(&FbsApi::calculate_tariffs_handler, this));
    Routes::Post(*router, base + "/businesses/:businessId/price-quarantine/confirm", Routes::bind(&FbsApi::confirm_business_prices_handler, this));
    Routes::Post(*router, base + "/campaigns/:campaignId/price-quarantine/confirm", Routes::bind(&FbsApi::confirm_campaign_prices_handler, this));
    Routes::Post(*router, base + "/campaigns/:campaignId/first-mile/shipments/:shipmentId/confirm", Routes::bind(&FbsApi::confirm_shipment_handler, this));
    Routes::Post(*router, base + "/businesses/:businessId/chats/new", Routes::bind(&FbsApi::create_chat_handler, this));
    Routes::Post(*router, base + "/campaigns/:campaignId/offers/delete", Routes::bind(&FbsApi::delete_campaign_offers_handler, this));
    Routes::Post(*router, base + "/businesses/:businessId/goods-feedback/comments/delete", Routes::bind(&FbsApi::delete_goods_feedback_comment_handler, this));
    Routes::Post(*router, base + "/campaigns/:campaignId/hidden-offers/delete", Routes::bind(&FbsApi::delete_hidden_offers_handler, this));
    Routes::Post(*router, base + "/businesses/:businessId/offer-mappings/delete", Routes::bind(&FbsApi::delete_offers_handler, this));
    Routes::Post(*router, base + "/businesses/:businessId/offer-mappings/unarchive", Routes::bind(&FbsApi::delete_offers_from_archive_handler, this));
    Routes::Post(*router, base + "/businesses/:businessId/promos/offers/delete", Routes::bind(&FbsApi::delete_promo_offers_handler, this));
    Routes::Get(*router, base + "/campaigns/:campaignId/first-mile/shipments/:shipmentId/act", Routes::bind(&FbsApi::download_shipment_act_handler, this));
    Routes::Get(*router, base + "/campaigns/:campaignId/first-mile/shipments/:shipmentId/discrepancy-act", Routes::bind(&FbsApi::download_shipment_discrepancy_act_handler, this));
    Routes::Get(*router, base + "/campaigns/:campaignId/first-mile/shipments/:shipmentId/inbound-act", Routes::bind(&FbsApi::download_shipment_inbound_act_handler, this));
    Routes::Get(*router, base + "/campaigns/:campaignId/first-mile/shipments/:shipmentId/pallet/labels", Routes::bind(&FbsApi::download_shipment_pallet_labels_handler, this));
    Routes::Get(*router, base + "/campaigns/:campaignId/shipments/reception-transfer-act", Routes::bind(&FbsApi::download_shipment_reception_transfer_act_handler, this));
    Routes::Get(*router, base + "/campaigns/:campaignId/first-mile/shipments/:shipmentId/transportation-waybill", Routes::bind(&FbsApi::download_shipment_transportation_waybill_handler, this));
    Routes::Post(*router, base + "/reports/boost-consolidated/generate", Routes::bind(&FbsApi::generate_boost_consolidated_report_handler, this));
    Routes::Post(*router, base + "/reports/competitors-position/generate", Routes::bind(&FbsApi::generate_competitors_position_report_handler, this));
    Routes::Post(*router, base + "/reports/goods-feedback/generate", Routes::bind(&FbsApi::generate_goods_feedback_report_handler, this));
    Routes::Post(*router, base + "/reports/goods-realization/generate", Routes::bind(&FbsApi::generate_goods_realization_report_handler, this));
    Routes::Post(*router, base + "/reports/documents/labels/generate", Routes::bind(&FbsApi::generate_mass_order_labels_report_handler, this));
    Routes::Get(*router, base + "/campaigns/:campaignId/orders/:orderId/delivery/shipments/:shipmentId/boxes/:boxId/label", Routes::bind(&FbsApi::generate_order_label_handler, this));
    Routes::Get(*router, base + "/campaigns/:campaignId/orders/:orderId/delivery/labels", Routes::bind(&FbsApi::generate_order_labels_handler, this));
    Routes::Post(*router, base + "/reports/prices/generate", Routes::bind(&FbsApi::generate_prices_report_handler, this));
    Routes::Post(*router, base + "/reports/shelf-statistics/generate", Routes::bind(&FbsApi::generate_shelfs_statistics_report_handler, this));
    Routes::Post(*router, base + "/reports/documents/shipment-list/generate", Routes::bind(&FbsApi::generate_shipment_list_document_report_handler, this));
    Routes::Post(*router, base + "/reports/shows-sales/generate", Routes::bind(&FbsApi::generate_shows_sales_report_handler, this));
    Routes::Post(*router, base + "/reports/stocks-on-warehouses/generate", Routes::bind(&FbsApi::generate_stocks_on_warehouses_report_handler, this));
    Routes::Post(*router, base + "/reports/united-marketplace-services/generate", Routes::bind(&FbsApi::generate_united_marketplace_services_report_handler, this));
    Routes::Post(*router, base + "/reports/united-netting/generate", Routes::bind(&FbsApi::generate_united_netting_report_handler, this));
    Routes::Post(*router, base + "/reports/united-orders/generate", Routes::bind(&FbsApi::generate_united_orders_report_handler, this));
    Routes::Get(*router, base + "/campaigns/:campaignId/offers/all", Routes::bind(&FbsApi::get_all_offers_handler, this));
    Routes::Post(*router, base + "/businesses/:businessId/bids/info", Routes::bind(&FbsApi::get_bids_info_for_business_handler, this));
    Routes::Post(*router, base + "/businesses/:businessId/bids/recommendations", Routes::bind(&FbsApi::get_bids_recommendations_handler, this));
    Routes::Post(*router, base + "/businesses/:businessId/price-quarantine", Routes::bind(&FbsApi::get_business_quarantine_offers_handler, this));
    Routes::Post(*router, base + "/businesses/:businessId/settings", Routes::bind(&FbsApi::get_business_settings_handler, this));
    Routes::Get(*router, base + "/campaigns/:campaignId", Routes::bind(&FbsApi::get_campaign_handler, this));
    Routes::Get(*router, base + "/campaigns/:campaignId/logins", Routes::bind(&FbsApi::get_campaign_logins_handler, this));
    Routes::Post(*router, base + "/campaigns/:campaignId/offers", Routes::bind(&FbsApi::get_campaign_offers_handler, this));
    Routes::Post(*router, base + "/campaigns/:campaignId/price-quarantine", Routes::bind(&FbsApi::get_campaign_quarantine_offers_handler, this));
    Routes::Get(*router, base + "/campaigns/:campaignId/region", Routes::bind(&FbsApi::get_campaign_region_handler, this));
    Routes::Get(*router, base + "/campaigns/:campaignId/settings", Routes::bind(&FbsApi::get_campaign_settings_handler, this));
    Routes::Get(*router, base + "/campaigns", Routes::bind(&FbsApi::get_campaigns_handler, this));
    Routes::Get(*router, base + "/campaigns/by_login/:login", Routes::bind(&FbsApi::get_campaigns_by_login_handler, this));
    Routes::Post(*router, base + "/categories/max-sale-quantum", Routes::bind(&FbsApi::get_categories_max_sale_quantum_handler, this));
    Routes::Post(*router, base + "/categories/tree", Routes::bind(&FbsApi::get_categories_tree_handler, this));
    Routes::Post(*router, base + "/category/:categoryId/parameters", Routes::bind(&FbsApi::get_category_content_parameters_handler, this));
    Routes::Post(*router, base + "/businesses/:businessId/chats/history", Routes::bind(&FbsApi::get_chat_history_handler, this));
    Routes::Post(*router, base + "/businesses/:businessId/chats", Routes::bind(&FbsApi::get_chats_handler, this));
    Routes::Get(*router, base + "/delivery/services", Routes::bind(&FbsApi::get_delivery_services_handler, this));
    Routes::Get(*router, base + "/campaigns/:campaignId/feeds/:feedId", Routes::bind(&FbsApi::get_feed_handler, this));
    Routes::Get(*router, base + "/campaigns/:campaignId/feeds/:feedId/index-logs", Routes::bind(&FbsApi::get_feed_index_logs_handler, this));
    Routes::Get(*router, base + "/campaigns/:campaignId/feedback/updates", Routes::bind(&FbsApi::get_feedback_and_comment_updates_handler, this));
    Routes::Get(*router, base + "/campaigns/:campaignId/feeds", Routes::bind(&FbsApi::get_feeds_handler, this));
    Routes::Post(*router, base + "/businesses/:businessId/goods-feedback/comments", Routes::bind(&FbsApi::get_goods_feedback_comments_handler, this));
    Routes::Post(*router, base + "/businesses/:businessId/goods-feedback", Routes::bind(&FbsApi::get_goods_feedbacks_handler, this));
    Routes::Post(*router, base + "/campaigns/:campaignId/stats/skus", Routes::bind(&FbsApi::get_goods_stats_handler, this));
    Routes::Get(*router, base + "/campaigns/:campaignId/hidden-offers", Routes::bind(&FbsApi::get_hidden_offers_handler, this));
    Routes::Post(*router, base + "/businesses/:businessId/offer-cards", Routes::bind(&FbsApi::get_offer_cards_content_status_handler, this));
    Routes::Get(*router, base + "/campaigns/:campaignId/offer-mapping-entries", Routes::bind(&FbsApi::get_offer_mapping_entries_handler, this));
    Routes::Post(*router, base + "/businesses/:businessId/offer-mappings", Routes::bind(&FbsApi::get_offer_mappings_handler, this));
    Routes::Post(*router, base + "/businesses/:businessId/offers/recommendations", Routes::bind(&FbsApi::get_offer_recommendations_handler, this));
    Routes::Get(*router, base + "/campaigns/:campaignId/offers", Routes::bind(&FbsApi::get_offers_handler, this));
    Routes::Get(*router, base + "/campaigns/:campaignId/orders/:orderId", Routes::bind(&FbsApi::get_order_handler, this));
    Routes::Post(*router, base + "/campaigns/:campaignId/orders/:orderId/business-buyer", Routes::bind(&FbsApi::get_order_business_buyer_info_handler, this));
    Routes::Post(*router, base + "/campaigns/:campaignId/orders/:orderId/documents", Routes::bind(&FbsApi::get_order_business_documents_info_handler, this));
    Routes::Get(*router, base + "/campaigns/:campaignId/orders/:orderId/delivery/labels/data", Routes::bind(&FbsApi::get_order_labels_data_handler, this));
    Routes::Get(*router, base + "/campaigns/:campaignId/orders", Routes::bind(&FbsApi::get_orders_handler, this));
    Routes::Post(*router, base + "/campaigns/:campaignId/stats/orders", Routes::bind(&FbsApi::get_orders_stats_handler, this));
    Routes::Get(*router, base + "/campaigns/:campaignId/offer-prices", Routes::bind(&FbsApi::get_prices_handler, this));
    Routes::Post(*router, base + "/campaigns/:campaignId/offer-prices", Routes::bind(&FbsApi::get_prices_by_offer_ids_handler, this));
    Routes::Post(*router, base + "/businesses/:businessId/promos/offers", Routes::bind(&FbsApi::get_promo_offers_handler, this));
    Routes::Post(*router, base + "/businesses/:businessId/promos", Routes::bind(&FbsApi::get_promos_handler, this));
    Routes::Post(*router, base + "/campaigns/:campaignId/ratings/quality/details", Routes::bind(&FbsApi::get_quality_rating_details_handler, this));
    Routes::Post(*router, base + "/businesses/:businessId/ratings/quality", Routes::bind(&FbsApi::get_quality_ratings_handler, this));
    Routes::Get(*router, base + "/reports/info/:reportId", Routes::bind(&FbsApi::get_report_info_handler, this));
    Routes::Get(*router, base + "/campaigns/:campaignId/orders/:orderId/returns/:returnId", Routes::bind(&FbsApi::get_return_handler, this));
    Routes::Get(*router, base + "/campaigns/:campaignId/orders/:orderId/returns/:returnId/application", Routes::bind(&FbsApi::get_return_application_handler, this));
    Routes::Get(*router, base + "/campaigns/:campaignId/orders/:orderId/returns/:returnId/decision/:itemId/image/:imageHash", Routes::bind(&FbsApi::get_return_photo_handler, this));
    Routes::Get(*router, base + "/campaigns/:campaignId/returns", Routes::bind(&FbsApi::get_returns_handler, this));
    Routes::Get(*router, base + "/campaigns/:campaignId/first-mile/shipments/:shipmentId", Routes::bind(&FbsApi::get_shipment_handler, this));
    Routes::Get(*router, base + "/campaigns/:campaignId/first-mile/shipments/:shipmentId/orders/info", Routes::bind(&FbsApi::get_shipment_orders_info_handler, this));
    Routes::Post(*router, base + "/campaigns/:campaignId/offers/stocks", Routes::bind(&FbsApi::get_stocks_handler, this));
    Routes::Post(*router, base + "/campaigns/:campaignId/offer-mapping-entries/suggestions", Routes::bind(&FbsApi::get_suggested_offer_mapping_entries_handler, this));
    Routes::Post(*router, base + "/businesses/:businessId/offer-mappings/suggestions", Routes::bind(&FbsApi::get_suggested_offer_mappings_handler, this));
    Routes::Post(*router, base + "/campaigns/:campaignId/offer-prices/suggestions", Routes::bind(&FbsApi::get_suggested_prices_handler, this));
    Routes::Get(*router, base + "/businesses/:businessId/warehouses", Routes::bind(&FbsApi::get_warehouses_handler, this));
    Routes::Put(*router, base + "/campaigns/:campaignId/orders/:orderId/identifiers", Routes::bind(&FbsApi::provide_order_item_identifiers_handler, this));
    Routes::Put(*router, base + "/businesses/:businessId/bids", Routes::bind(&FbsApi::put_bids_for_business_handler, this));
    Routes::Put(*router, base + "/campaigns/:campaignId/bids", Routes::bind(&FbsApi::put_bids_for_campaign_handler, this));
    Routes::Post(*router, base + "/campaigns/:campaignId/feeds/:feedId/refresh", Routes::bind(&FbsApi::refresh_feed_handler, this));
    Routes::Get(*router, base + "/regions/:regionId/children", Routes::bind(&FbsApi::search_region_children_handler, this));
    Routes::Get(*router, base + "/regions/:regionId", Routes::bind(&FbsApi::search_regions_by_id_handler, this));
    Routes::Get(*router, base + "/regions", Routes::bind(&FbsApi::search_regions_by_name_handler, this));
    Routes::Put(*router, base + "/campaigns/:campaignId/first-mile/shipments", Routes::bind(&FbsApi::search_shipments_handler, this));
    Routes::Post(*router, base + "/businesses/:businessId/chats/file/send", Routes::bind(&FbsApi::send_file_to_chat_handler, this));
    Routes::Post(*router, base + "/businesses/:businessId/chats/message", Routes::bind(&FbsApi::send_message_to_chat_handler, this));
    Routes::Post(*router, base + "/campaigns/:campaignId/feeds/:feedId/params", Routes::bind(&FbsApi::set_feed_params_handler, this));
    Routes::Put(*router, base + "/campaigns/:campaignId/orders/:orderId/boxes", Routes::bind(&FbsApi::set_order_box_layout_handler, this));
    Routes::Put(*router, base + "/campaigns/:campaignId/orders/:orderId/delivery/shipments/:shipmentId/boxes", Routes::bind(&FbsApi::set_order_shipment_boxes_handler, this));
    Routes::Put(*router, base + "/campaigns/:campaignId/first-mile/shipments/:shipmentId/pallets", Routes::bind(&FbsApi::set_shipment_pallets_count_handler, this));
    Routes::Post(*router, base + "/businesses/:businessId/goods-feedback/skip-reaction", Routes::bind(&FbsApi::skip_goods_feedbacks_reaction_handler, this));
    Routes::Post(*router, base + "/campaigns/:campaignId/first-mile/shipments/:shipmentId/orders/transfer", Routes::bind(&FbsApi::transfer_orders_from_shipment_handler, this));
    Routes::Post(*router, base + "/businesses/:businessId/offer-prices/updates", Routes::bind(&FbsApi::update_business_prices_handler, this));
    Routes::Post(*router, base + "/campaigns/:campaignId/offers/update", Routes::bind(&FbsApi::update_campaign_offers_handler, this));
    Routes::Post(*router, base + "/businesses/:businessId/goods-feedback/comments/update", Routes::bind(&FbsApi::update_goods_feedback_comment_handler, this));
    Routes::Post(*router, base + "/businesses/:businessId/offer-cards/update", Routes::bind(&FbsApi::update_offer_content_handler, this));
    Routes::Post(*router, base + "/campaigns/:campaignId/offer-mapping-entries/updates", Routes::bind(&FbsApi::update_offer_mapping_entries_handler, this));
    Routes::Post(*router, base + "/businesses/:businessId/offer-mappings/update", Routes::bind(&FbsApi::update_offer_mappings_handler, this));
    Routes::Put(*router, base + "/campaigns/:campaignId/orders/:orderId/items", Routes::bind(&FbsApi::update_order_items_handler, this));
    Routes::Put(*router, base + "/campaigns/:campaignId/orders/:orderId/status", Routes::bind(&FbsApi::update_order_status_handler, this));
    Routes::Post(*router, base + "/campaigns/:campaignId/orders/status-update", Routes::bind(&FbsApi::update_order_statuses_handler, this));
    Routes::Post(*router, base + "/campaigns/:campaignId/offer-prices/updates", Routes::bind(&FbsApi::update_prices_handler, this));
    Routes::Post(*router, base + "/businesses/:businessId/promos/offers/update", Routes::bind(&FbsApi::update_promo_offers_handler, this));
    Routes::Put(*router, base + "/campaigns/:campaignId/offers/stocks", Routes::bind(&FbsApi::update_stocks_handler, this));

    // Default handler, called when a route is not found
    router->addCustomHandler(Routes::bind(&FbsApi::fbs_api_default_handler, this));
}

void FbsApi::handleParsingException(const std::exception& ex, Pistache::Http::ResponseWriter &response) const noexcept
{
    std::pair<Pistache::Http::Code, std::string> codeAndError = handleParsingException(ex);
    response.send(codeAndError.first, codeAndError.second);
}

std::pair<Pistache::Http::Code, std::string> FbsApi::handleParsingException(const std::exception& ex) const noexcept
{
    try {
        throw;
...
void FbsApi::handleOperationException(const std::exception& ex, Pistache::Http::ResponseWriter &response) const noexcept
{
    std::pair<Pistache::Http::Code, std::string> codeAndError = handleOperationException(ex);
    response.send(codeAndError.first, codeAndError.second);
}

std::pair<Pistache::Http::Code, std::string> FbsApi::handleOperationException(const std::exception& ex) const noexcept
{
    return std::make_pair(Pistache::Http::Code::Internal_Server_Error, ex.what());
}

void FbsApi::add_hidden_offers_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::add_offers_to_archive_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::calculate_tariffs_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::confirm_business_prices_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::confirm_campaign_prices_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::confirm_shipment_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::create_chat_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::delete_campaign_offers_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::delete_goods_feedback_comment_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::delete_hidden_offers_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::delete_offers_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::delete_offers_from_archive_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::delete_promo_offers_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::download_shipment_act_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::download_shipment_discrepancy_act_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::download_shipment_inbound_act_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::download_shipment_pallet_labels_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::download_shipment_reception_transfer_act_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::download_shipment_transportation_waybill_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::generate_boost_consolidated_report_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::generate_competitors_position_report_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::generate_goods_feedback_report_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::generate_goods_realization_report_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::generate_mass_order_labels_report_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::generate_order_label_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::generate_order_labels_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::generate_prices_report_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::generate_shelfs_statistics_report_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::generate_shipment_list_document_report_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::generate_shows_sales_report_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::generate_stocks_on_warehouses_report_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::generate_united_marketplace_services_report_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::generate_united_netting_report_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::generate_united_orders_report_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::get_all_offers_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::get_bids_info_for_business_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::get_bids_recommendations_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::get_business_quarantine_offers_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::get_business_settings_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::get_campaign_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::get_campaign_logins_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::get_campaign_offers_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::get_campaign_quarantine_offers_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::get_campaign_region_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::get_campaign_settings_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::get_campaigns_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::get_campaigns_by_login_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::get_categories_max_sale_quantum_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::get_categories_tree_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::get_category_content_parameters_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::get_chat_history_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::get_chats_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::get_delivery_services_handler(const Pistache::Rest::Request &, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::get_feed_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::get_feed_index_logs_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::get_feedback_and_comment_updates_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::get_feeds_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::get_goods_feedback_comments_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::get_goods_feedbacks_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::get_goods_stats_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::get_hidden_offers_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::get_offer_cards_content_status_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::get_offer_mapping_entries_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::get_offer_mappings_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::get_offer_recommendations_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::get_offers_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::get_order_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::get_order_business_buyer_info_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::get_order_business_documents_info_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::get_order_labels_data_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::get_orders_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::get_orders_stats_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::get_prices_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::get_prices_by_offer_ids_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::get_promo_offers_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::get_promos_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::get_quality_rating_details_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::get_quality_ratings_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::get_report_info_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::get_return_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::get_return_application_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::get_return_photo_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::get_returns_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::get_shipment_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::get_shipment_orders_info_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::get_stocks_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::get_suggested_offer_mapping_entries_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::get_suggested_offer_mappings_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::get_suggested_prices_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::get_warehouses_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::provide_order_item_identifiers_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::put_bids_for_business_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::put_bids_for_campaign_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::refresh_feed_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::search_region_children_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::search_regions_by_id_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::search_regions_by_name_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::search_shipments_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::send_file_to_chat_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::send_message_to_chat_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::set_feed_params_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::set_order_box_layout_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::set_order_shipment_boxes_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::set_shipment_pallets_count_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::skip_goods_feedbacks_reaction_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::transfer_orders_from_shipment_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::update_business_prices_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::update_campaign_offers_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::update_goods_feedback_comment_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::update_offer_content_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::update_offer_mapping_entries_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::update_offer_mappings_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::update_order_items_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::update_order_status_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::update_order_statuses_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::update_prices_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::update_promo_offers_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::update_stocks_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void FbsApi::fbs_api_default_handler(const Pistache::Rest::Request &, Pistache::Http::ResponseWriter response) {
