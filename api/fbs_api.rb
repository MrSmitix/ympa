...
MyApp.add_route('POST', '/campaigns/{campaignId}/hidden-offers', {
  "resourcePath" => "/Fbs",
  "summary" => "Скрытие товаров и настройки скрытия",
  "nickname" => "add_hidden_offers",
  "responseClass" => "EmptyApiResponse",
  "endpoint" => "/campaigns/{campaignId}/hidden-offers",
  ...
  "parameters" => [
    ...
    },
    {
      ...
      "dataType" => "AddHiddenOffersRequest",
      "paramType" => "body",
    }
    ]}) do
  cross_origin
...
MyApp.add_route('POST', '/campaigns/{campaignId}/first-mile/shipments/{shipmentId}/confirm', {
  "resourcePath" => "/Fbs",
  "summary" => "Подтверждение отгрузки",
  "nickname" => "confirm_shipment",
  "responseClass" => "EmptyApiResponse",
  "endpoint" => "/campaigns/{campaignId}/first-mile/shipments/{shipmentId}/confirm",
  ...
  "parameters" => [
    ...
    },
    {
      "name" => "body",
      "description" => "",
      "dataType" => "ConfirmShipmentRequest",
      "paramType" => "body",
    }
    ]}) do
  cross_origin
...
MyApp.add_route('POST', '/campaigns/{campaignId}/offers/delete', {
  "resourcePath" => "/Fbs",
  "summary" => "Удаление товаров из ассортимента магазина",
  "nickname" => "delete_campaign_offers",
  "responseClass" => "DeleteCampaignOffersResponse",
  "endpoint" => "/campaigns/{campaignId}/offers/delete",
  ...
  "parameters" => [
    ...
    },
    {
      "name" => "body",
      "description" => "",
      "dataType" => "DeleteCampaignOffersRequest",
      "paramType" => "body",
    }
    ]}) do
  cross_origin
...
MyApp.add_route('POST', '/businesses/{businessId}/goods-feedback/comments/delete', {
  "resourcePath" => "/Fbs",
  "summary" => "Удаление комментария к отзыву",
  "nickname" => "delete_goods_feedback_comment",
  "responseClass" => "EmptyApiResponse",
  "endpoint" => "/businesses/{businessId}/goods-feedback/comments/delete",
  ...
  "parameters" => [
    ...
    },
    {
      "name" => "body",
      "description" => "",
      "dataType" => "DeleteGoodsFeedbackCommentRequest",
      "paramType" => "body",
    }
    ]}) do
  cross_origin
...
MyApp.add_route('POST', '/campaigns/{campaignId}/hidden-offers/delete', {
  "resourcePath" => "/Fbs",
  "summary" => "Возобновление показа товаров",
  "nickname" => "delete_hidden_offers",
  "responseClass" => "EmptyApiResponse",
  "endpoint" => "/campaigns/{campaignId}/hidden-offers/delete",
  ...
  "parameters" => [
    ...
    },
    {
      ...
      "dataType" => "DeleteHiddenOffersRequest",
      "paramType" => "body",
    }
    ]}) do
  cross_origin
...
MyApp.add_route('GET', '/campaigns/{campaignId}/first-mile/shipments/{shipmentId}/act', {
  "resourcePath" => "/Fbs",
  "summary" => "Получение акта приема-передачи",
  "nickname" => "download_shipment_act",
  "responseClass" => "File",
  "endpoint" => "/campaigns/{campaignId}/first-mile/shipments/{shipmentId}/act",
...
MyApp.add_route('GET', '/campaigns/{campaignId}/first-mile/shipments/{shipmentId}/discrepancy-act', {
  "resourcePath" => "/Fbs",
  "summary" => "Получение акта расхождений",
  "nickname" => "download_shipment_discrepancy_act",
  "responseClass" => "File",
  "endpoint" => "/campaigns/{campaignId}/first-mile/shipments/{shipmentId}/discrepancy-act",
...
MyApp.add_route('GET', '/campaigns/{campaignId}/first-mile/shipments/{shipmentId}/inbound-act', {
  "resourcePath" => "/Fbs",
  "summary" => "Получение фактического акта приема-передачи",
  "nickname" => "download_shipment_inbound_act",
  "responseClass" => "File",
  "endpoint" => "/campaigns/{campaignId}/first-mile/shipments/{shipmentId}/inbound-act",
...
MyApp.add_route('GET', '/campaigns/{campaignId}/first-mile/shipments/{shipmentId}/pallet/labels', {
  "resourcePath" => "/Fbs",
  "summary" => "Ярлыки для доверительной приемки (FBS)",
  "nickname" => "download_shipment_pallet_labels",
  "responseClass" => "File",
  "endpoint" => "/campaigns/{campaignId}/first-mile/shipments/{shipmentId}/pallet/labels",
  ...
  "parameters" => [
    {
      ...
      "dataType" => "ShipmentPalletLabelPageFormatType",
      "allowableValues" => "[A4, A8]",
      "defaultValue" => "'A8'",
      "paramType" => "query",
    },
    {
...
MyApp.add_route('GET', '/campaigns/{campaignId}/shipments/reception-transfer-act', {
  "resourcePath" => "/Fbs",
  "summary" => "Подтверждение ближайшей отгрузки и получение акта приема-передачи для нее",
  "nickname" => "download_shipment_reception_transfer_act",
  "responseClass" => "File",
  "endpoint" => "/campaigns/{campaignId}/shipments/reception-transfer-act",
...
MyApp.add_route('GET', '/campaigns/{campaignId}/first-mile/shipments/{shipmentId}/transportation-waybill', {
  "resourcePath" => "/Fbs",
  "summary" => "Получение транспортной накладной",
  "nickname" => "download_shipment_transportation_waybill",
  "responseClass" => "File",
  "endpoint" => "/campaigns/{campaignId}/first-mile/shipments/{shipmentId}/transportation-waybill",
...
MyApp.add_route('GET', '/campaigns/{campaignId}/offers/all', {
  "resourcePath" => "/Fbs",
  "summary" => "Все предложения магазина",
  "nickname" => "get_all_offers",
  "responseClass" => "GetAllOffersResponse",
  "endpoint" => "/campaigns/{campaignId}/offers/all",
...
MyApp.add_route('POST', '/businesses/{businessId}/bids/info', {
  "resourcePath" => "/Fbs",
  "summary" => "Информация об установленных ставках",
  "nickname" => "get_bids_info_for_business",
  "responseClass" => "GetBidsInfoResponse",
  "endpoint" => "/businesses/{businessId}/bids/info",
...
MyApp.add_route('POST', '/businesses/{businessId}/bids/recommendations', {
  "resourcePath" => "/Fbs",
  "summary" => "Рекомендованные ставки для заданных товаров",
  "nickname" => "get_bids_recommendations",
  "responseClass" => "GetBidsRecommendationsResponse",
  "endpoint" => "/businesses/{businessId}/bids/recommendations",
  ...
  "parameters" => [
    ...
    },
    {
      "name" => "body",
      "description" => "description.",
      "dataType" => "GetBidsRecommendationsRequest",
      "paramType" => "body",
    }
    ]}) do
  cross_origin
...
MyApp.add_route('POST', '/businesses/{businessId}/settings', {
  "resourcePath" => "/Fbs",
  "summary" => "Настройки кабинета",
  "nickname" => "get_business_settings",
  "responseClass" => "GetBusinessSettingsResponse",
  "endpoint" => "/businesses/{businessId}/settings",
...
MyApp.add_route('POST', '/campaigns/{campaignId}/offers', {
  "resourcePath" => "/Fbs",
  "summary" => "Информация о товарах, которые размещены в заданном магазине",
  "nickname" => "get_campaign_offers",
  "responseClass" => "GetCampaignOffersResponse",
  "endpoint" => "/campaigns/{campaignId}/offers",
  ...
  "parameters" => [
    ...
    },
    {
      "name" => "body",
      "description" => "",
      "dataType" => "GetCampaignOffersRequest",
      "paramType" => "body",
    }
    ]}) do
  cross_origin
...
MyApp.add_route('GET', '/campaigns/{campaignId}/feeds/{feedId}', {
  "resourcePath" => "/Fbs",
  "summary" => "Информация о прайс-листе",
  "nickname" => "get_feed",
  "responseClass" => "GetFeedResponse",
  "endpoint" => "/campaigns/{campaignId}/feeds/{feedId}",
...
MyApp.add_route('GET', '/campaigns/{campaignId}/feeds/{feedId}/index-logs', {
  "resourcePath" => "/Fbs",
  "summary" => "Отчет по индексации прайс-листа",
  "nickname" => "get_feed_index_logs",
  "responseClass" => "GetFeedIndexLogsResponse",
  "endpoint" => "/campaigns/{campaignId}/feeds/{feedId}/index-logs",
  ...
  "parameters" => [
    ...
    },
    {
      ...
      "dataType" => "FeedIndexLogsStatusType",
      "allowableValues" => "[ERROR, OK, WARNING]",
      "paramType" => "query",
    },
    {
      "name" => "campaign_id",
...
MyApp.add_route('GET', '/campaigns/{campaignId}/feedback/updates', {
  "resourcePath" => "/Fbs",
  "summary" => "Новые и обновленные отзывы о магазине",
  "nickname" => "get_feedback_and_comment_updates",
  "responseClass" => "GetFeedbackListResponse",
  "endpoint" => "/campaigns/{campaignId}/feedback/updates",
...
MyApp.add_route('GET', '/campaigns/{campaignId}/feeds', {
  "resourcePath" => "/Fbs",
  "summary" => "Список прайс-листов магазина",
  "nickname" => "get_feeds",
  "responseClass" => "GetFeedsResponse",
  "endpoint" => "/campaigns/{campaignId}/feeds",
...
MyApp.add_route('POST', '/businesses/{businessId}/goods-feedback/comments', {
  "resourcePath" => "/Fbs",
  "summary" => "Получение комментариев к отзыву",
  "nickname" => "get_goods_feedback_comments",
  "responseClass" => "GetGoodsFeedbackCommentsResponse",
  "endpoint" => "/businesses/{businessId}/goods-feedback/comments",
  ...
  "parameters" => [
    ...
    },
    {
      "name" => "body",
      "description" => "",
      "dataType" => "GetGoodsFeedbackCommentsRequest",
      "paramType" => "body",
    }
    ]}) do
  cross_origin
...
MyApp.add_route('POST', '/businesses/{businessId}/goods-feedback', {
  "resourcePath" => "/Fbs",
  "summary" => "Получение отзывов о товарах продавца",
  "nickname" => "get_goods_feedbacks",
  "responseClass" => "GetGoodsFeedbackResponse",
  "endpoint" => "/businesses/{businessId}/goods-feedback",
  ...
  "parameters" => [
    ...
    },
    {
      "name" => "body",
      "description" => "",
      "dataType" => "GetGoodsFeedbackRequest",
      "paramType" => "body",
    }
    ]}) do
  cross_origin
...
MyApp.add_route('GET', '/campaigns/{campaignId}/hidden-offers', {
  "resourcePath" => "/Fbs",
  "summary" => "Информация о скрытых вами товарах",
  "nickname" => "get_hidden_offers",
  "responseClass" => "GetHiddenOffersResponse",
  "endpoint" => "/campaigns/{campaignId}/hidden-offers",
...
MyApp.add_route('GET', '/campaigns/{campaignId}/offer-mapping-entries', {
  "resourcePath" => "/Fbs",
  "summary" => "Список товаров в каталоге",
  "nickname" => "get_offer_mapping_entries",
  "responseClass" => "GetOfferMappingEntriesResponse",
  "endpoint" => "/campaigns/{campaignId}/offer-mapping-entries",
  ...
  "parameters" => [
    ...
    },
    {
      ...
      "dataType" => "OfferMappingKindType",
      "allowableValues" => "[ACTIVE, ALL]",
      "paramType" => "query",
    },
    {
      "name" => "status",
      ...
      "dataType" => "Array<OfferProcessingStatusType>",
      "collectionFormat" => "csv",
      "paramType" => "query",
    },
    {
      ...
      "dataType" => "Array<OfferAvailabilityStatusType>",
      "collectionFormat" => "csv",
      "paramType" => "query",
    },
    {
...
MyApp.add_route('POST', '/businesses/{businessId}/offers/recommendations', {
  "resourcePath" => "/Fbs",
  "summary" => "Рекомендации Маркета, касающиеся цен",
  "nickname" => "get_offer_recommendations",
  "responseClass" => "GetOfferRecommendationsResponse",
  "endpoint" => "/businesses/{businessId}/offers/recommendations",
  ...
  "parameters" => [
    ...
    },
    {
      "name" => "body",
      "description" => "",
      "dataType" => "GetOfferRecommendationsRequest",
      "paramType" => "body",
    }
    ]}) do
  cross_origin
...
MyApp.add_route('GET', '/campaigns/{campaignId}/offers', {
  "resourcePath" => "/Fbs",
  "summary" => "Предложения магазина",
  "nickname" => "get_offers",
  "responseClass" => "GetOffersResponse",
  "endpoint" => "/campaigns/{campaignId}/offers",
...
MyApp.add_route('GET', '/campaigns/{campaignId}/offer-prices', {
  "resourcePath" => "/Fbs",
  "summary" => "Список цен",
  "nickname" => "get_prices",
  "responseClass" => "GetPricesResponse",
  "endpoint" => "/campaigns/{campaignId}/offer-prices",
...
MyApp.add_route('POST', '/campaigns/{campaignId}/offer-prices', {
  "resourcePath" => "/Fbs",
  "summary" => "Просмотр цен на указанные товары в магазине",
  "nickname" => "get_prices_by_offer_ids",
  "responseClass" => "GetPricesByOfferIdsResponse",
  "endpoint" => "/campaigns/{campaignId}/offer-prices",
  ...
  "parameters" => [
    ...
    },
    {
      "name" => "body",
      "description" => "",
      "dataType" => "GetPricesByOfferIdsRequest",
      "paramType" => "body",
    }
    ]}) do
  cross_origin
...
MyApp.add_route('POST', '/campaigns/{campaignId}/ratings/quality/details', {
  "resourcePath" => "/Fbs",
  "summary" => "Заказы, которые повлияли на индекс качества",
  "nickname" => "get_quality_rating_details",
  "responseClass" => "GetQualityRatingDetailsResponse",
  "endpoint" => "/campaigns/{campaignId}/ratings/quality/details",
...
MyApp.add_route('POST', '/businesses/{businessId}/ratings/quality', {
  "resourcePath" => "/Fbs",
  "summary" => "Индекс качества магазинов",
  "nickname" => "get_quality_ratings",
  "responseClass" => "GetQualityRatingResponse",
  "endpoint" => "/businesses/{businessId}/ratings/quality",
  ...
  "parameters" => [
    ...
    },
    {
      "name" => "body",
      "description" => "",
      "dataType" => "GetQualityRatingRequest",
      "paramType" => "body",
    }
    ]}) do
  cross_origin
...
MyApp.add_route('GET', '/campaigns/{campaignId}/first-mile/shipments/{shipmentId}', {
  "resourcePath" => "/Fbs",
  "summary" => "Получение информации об одной отгрузке",
  "nickname" => "get_shipment",
  "responseClass" => "GetShipmentResponse",
  "endpoint" => "/campaigns/{campaignId}/first-mile/shipments/{shipmentId}",
...
MyApp.add_route('GET', '/campaigns/{campaignId}/first-mile/shipments/{shipmentId}/orders/info', {
  "resourcePath" => "/Fbs",
  "summary" => "Получение информации о возможности печати ярлыков (FBS)",
  "nickname" => "get_shipment_orders_info",
  "responseClass" => "GetShipmentOrdersInfoResponse",
  "endpoint" => "/campaigns/{campaignId}/first-mile/shipments/{shipmentId}/orders/info",
...
MyApp.add_route('POST', '/campaigns/{campaignId}/offer-mapping-entries/suggestions', {
  "resourcePath" => "/Fbs",
  "summary" => "Рекомендованные карточки для товаров",
  "nickname" => "get_suggested_offer_mapping_entries",
  "responseClass" => "GetSuggestedOfferMappingEntriesResponse",
  "endpoint" => "/campaigns/{campaignId}/offer-mapping-entries/suggestions",
  ...
  "parameters" => [
    ...
    },
    {
      "name" => "body",
      "description" => "",
      "dataType" => "GetSuggestedOfferMappingEntriesRequest",
      "paramType" => "body",
    }
    ]}) do
  cross_origin
...
MyApp.add_route('POST', '/campaigns/{campaignId}/offer-prices/suggestions', {
  "resourcePath" => "/Fbs",
  "summary" => "Цены для продвижения товаров",
  "nickname" => "get_suggested_prices",
  "responseClass" => "SuggestPricesResponse",
  "endpoint" => "/campaigns/{campaignId}/offer-prices/suggestions",
...
MyApp.add_route('PUT', '/businesses/{businessId}/bids', {
  "resourcePath" => "/Fbs",
  "summary" => "Включение буста продаж и установка ставок",
  "nickname" => "put_bids_for_business",
  "responseClass" => "EmptyApiResponse",
  "endpoint" => "/businesses/{businessId}/bids",
...
MyApp.add_route('PUT', '/campaigns/{campaignId}/bids', {
  "resourcePath" => "/Fbs",
  "summary" => "Включение буста продаж и установка ставок для магазина",
  "nickname" => "put_bids_for_campaign",
  "responseClass" => "EmptyApiResponse",
  "endpoint" => "/campaigns/{campaignId}/bids",
...
MyApp.add_route('POST', '/campaigns/{campaignId}/feeds/{feedId}/refresh', {
  "resourcePath" => "/Fbs",
  "summary" => "Сообщить, что прайс-лист обновился",
  "nickname" => "refresh_feed",
  "responseClass" => "EmptyApiResponse",
  "endpoint" => "/campaigns/{campaignId}/feeds/{feedId}/refresh",
...
MyApp.add_route('GET', '/regions/{regionId}/children', {
  "resourcePath" => "/Fbs",
  "summary" => "Информация о дочерних регионах",
  "nickname" => "search_region_children",
  "responseClass" => "GetRegionWithChildrenResponse",
  "endpoint" => "/regions/{regionId}/children",
...
MyApp.add_route('GET', '/regions/{regionId}', {
  "resourcePath" => "/Fbs",
  "summary" => "Информация о регионе",
  "nickname" => "search_regions_by_id",
  "responseClass" => "GetRegionsResponse",
...
MyApp.add_route('GET', '/regions', {
  "resourcePath" => "/Fbs",
  "summary" => "Поиск регионов по их имени",
  "nickname" => "search_regions_by_name",
  "responseClass" => "GetRegionsResponse",
  "endpoint" => "/regions",
...
MyApp.add_route('PUT', '/campaigns/{campaignId}/first-mile/shipments', {
  "resourcePath" => "/Fbs",
  "summary" => "Получение информации о нескольких отгрузках",
  "nickname" => "search_shipments",
  "responseClass" => "SearchShipmentsResponse",
  "endpoint" => "/campaigns/{campaignId}/first-mile/shipments",
  ...
  "parameters" => [
    ...
    },
    {
      "name" => "body",
      "description" => "",
      "dataType" => "SearchShipmentsRequest",
      "paramType" => "body",
    }
    ]}) do
  cross_origin
...
MyApp.add_route('POST', '/campaigns/{campaignId}/feeds/{feedId}/params', {
  "resourcePath" => "/Fbs",
  "summary" => "Изменение параметров прайс-листа",
  "nickname" => "set_feed_params",
  "responseClass" => "EmptyApiResponse",
  "endpoint" => "/campaigns/{campaignId}/feeds/{feedId}/params",
...
MyApp.add_route('PUT', '/campaigns/{campaignId}/first-mile/shipments/{shipmentId}/pallets', {
  "resourcePath" => "/Fbs",
  "summary" => "Передача количества упаковок в отгрузке",
  "nickname" => "set_shipment_pallets_count",
  "responseClass" => "EmptyApiResponse",
  "endpoint" => "/campaigns/{campaignId}/first-mile/shipments/{shipmentId}/pallets",
  ...
  "parameters" => [
    ...
    },
    {
      "name" => "body",
      "description" => "",
      "dataType" => "SetShipmentPalletsCountRequest",
      "paramType" => "body",
    }
    ]}) do
  cross_origin
...
MyApp.add_route('POST', '/businesses/{businessId}/goods-feedback/skip-reaction', {
  "resourcePath" => "/Fbs",
  "summary" => "Отказ от ответа на отзывы",
  "nickname" => "skip_goods_feedbacks_reaction",
  "responseClass" => "EmptyApiResponse",
  "endpoint" => "/businesses/{businessId}/goods-feedback/skip-reaction",
  ...
  "parameters" => [
    ...
    },
    {
      "name" => "body",
      "description" => "",
      "dataType" => "SkipGoodsFeedbackReactionRequest",
      "paramType" => "body",
    }
    ]}) do
  cross_origin
...
MyApp.add_route('POST', '/campaigns/{campaignId}/first-mile/shipments/{shipmentId}/orders/transfer', {
  "resourcePath" => "/Fbs",
  "summary" => "Перенос заказов в следующую отгрузку",
  "nickname" => "transfer_orders_from_shipment",
  "responseClass" => "EmptyApiResponse",
  "endpoint" => "/campaigns/{campaignId}/first-mile/shipments/{shipmentId}/orders/transfer",
  ...
  "parameters" => [
    ...
    },
    {
      "name" => "body",
      "description" => "",
      "dataType" => "TransferOrdersFromShipmentRequest",
      "paramType" => "body",
    }
    ]}) do
  cross_origin
...
MyApp.add_route('POST', '/businesses/{businessId}/offer-prices/updates', {
  "resourcePath" => "/Fbs",
  "summary" => "Установка цен на товары во всех магазинах",
  "nickname" => "update_business_prices",
  "responseClass" => "EmptyApiResponse",
  "endpoint" => "/businesses/{businessId}/offer-prices/updates",
  ...
  "parameters" => [
    ...
    },
    {
      "name" => "body",
      "description" => "",
      "dataType" => "UpdateBusinessPricesRequest",
      "paramType" => "body",
    }
    ]}) do
  cross_origin
...
MyApp.add_route('POST', '/campaigns/{campaignId}/offers/update', {
  "resourcePath" => "/Fbs",
  "summary" => "Изменение условий продажи товаров в магазине",
  "nickname" => "update_campaign_offers",
  "responseClass" => "EmptyApiResponse",
  "endpoint" => "/campaigns/{campaignId}/offers/update",
  ...
  "parameters" => [
    ...
    },
    {
      "name" => "body",
      "description" => "",
      "dataType" => "UpdateCampaignOffersRequest",
      "paramType" => "body",
    }
    ]}) do
  cross_origin
...
MyApp.add_route('POST', '/businesses/{businessId}/goods-feedback/comments/update', {
  "resourcePath" => "/Fbs",
  "summary" => "Добавление нового или изменение созданного комментария",
  "nickname" => "update_goods_feedback_comment",
  "responseClass" => "UpdateGoodsFeedbackCommentResponse",
  "endpoint" => "/businesses/{businessId}/goods-feedback/comments/update",
  ...
  "parameters" => [
    ...
    },
    {
      "name" => "body",
      "description" => "",
      "dataType" => "UpdateGoodsFeedbackCommentRequest",
      "paramType" => "body",
    }
    ]}) do
  cross_origin
...
MyApp.add_route('POST', '/campaigns/{campaignId}/offer-mapping-entries/updates', {
  "resourcePath" => "/Fbs",
  "summary" => "Добавление и редактирование товаров в каталоге",
  "nickname" => "update_offer_mapping_entries",
  "responseClass" => "EmptyApiResponse",
  "endpoint" => "/campaigns/{campaignId}/offer-mapping-entries/updates",
  ...
  "parameters" => [
    ...
    },
    {
      "name" => "body",
      "description" => "",
      "dataType" => "UpdateOfferMappingEntryRequest",
      "paramType" => "body",
    }
    ]}) do
  cross_origin
...
MyApp.add_route('POST', '/campaigns/{campaignId}/offer-prices/updates', {
  "resourcePath" => "/Fbs",
  "summary" => "Установка цен на товары в конкретном магазине",
  "nickname" => "update_prices",
  "responseClass" => "EmptyApiResponse",
  "endpoint" => "/campaigns/{campaignId}/offer-prices/updates",
