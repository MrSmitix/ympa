...
GoodsStatsAPI_getGoodsStats(apiClient_t *apiClient, long campaignId, get_goods_stats_request_t *get_goods_stats_request)
{
    ...
    cJSON *GoodsStatsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    get_goods_stats_response_t *elementToReturn = get_goods_stats_response_parseFromJSON(GoodsStatsAPIlocalVarJSON);
    cJSON_Delete(GoodsStatsAPIlocalVarJSON);
