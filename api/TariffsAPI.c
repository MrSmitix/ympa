...
TariffsAPI_calculateTariffs(apiClient_t *apiClient, calculate_tariffs_request_t *calculate_tariffs_request)
{
    ...
    cJSON *TariffsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    calculate_tariffs_response_t *elementToReturn = calculate_tariffs_response_parseFromJSON(TariffsAPIlocalVarJSON);
    cJSON_Delete(TariffsAPIlocalVarJSON);
