...
std::pair<int, std::string> BusinessesBusinessIdSettingsResource::handleBusinessesApiException(const BusinessesApiException& e)
{
...
std::shared_ptr<BusinessesApiResources::BusinessesBusinessIdSettingsResource> BusinessesApi::getBusinessesBusinessIdSettingsResource() {
    if (!m_spBusinessesBusinessIdSettingsResource) {
        setResource(std::make_shared<BusinessesApiResources::BusinessesBusinessIdSettingsResource>());
    }
    return m_spBusinessesBusinessIdSettingsResource;
}
void BusinessesApi::setResource(std::shared_ptr<BusinessesApiResources::BusinessesBusinessIdSettingsResource> resource) {
    m_spBusinessesBusinessIdSettingsResource = resource;
    m_service->publish(m_spBusinessesBusinessIdSettingsResource);
}
void BusinessesApi::setBusinessesApiBusinessesBusinessIdSettingsResource(std::shared_ptr<BusinessesApiResources::BusinessesBusinessIdSettingsResource> spBusinessesBusinessIdSettingsResource) {
