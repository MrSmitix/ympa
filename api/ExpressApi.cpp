...
const std::string ExpressApi::base = "";

ExpressApi::ExpressApi(const std::shared_ptr<Pistache::Rest::Router>& rtr)
    : ApiBase(rtr)
{
}

void ExpressApi::init() {
    setupRoutes();
}

void ExpressApi::setupRoutes() {
    using namespace Pistache::Rest;

    Routes::Post(*router, base + "/campaigns/:campaignId/hidden-offers", Routes::bind(&ExpressApi::add_hidden_offers_handler, this));
    Routes::Post(*router, base + "/businesses/:businessId/offer-mappings/archive", Routes::bind(&ExpressApi::add_offers_to_archive_handler, this));
    Routes::Post(*router, base + "/tariffs/calculate", Routes::bind(&ExpressApi::calculate_tariffs_handler, this));
    Routes::Post(*router, base + "/businesses/:businessId/price-quarantine/confirm", Routes::bind(&ExpressApi::confirm_business_prices_handler, this));
    Routes::Post(*router, base + "/campaigns/:campaignId/price-quarantine/confirm", Routes::bind(&ExpressApi::confirm_campaign_prices_handler, this));
    Routes::Post(*router, base + "/businesses/:businessId/chats/new", Routes::bind(&ExpressApi::create_chat_handler, this));
    Routes::Post(*router, base + "/campaigns/:campaignId/offers/delete", Routes::bind(&ExpressApi::delete_campaign_offers_handler, this));
    Routes::Post(*router, base + "/businesses/:businessId/goods-feedback/comments/delete", Routes::bind(&ExpressApi::delete_goods_feedback_comment_handler, this));
    Routes::Post(*router, base + "/campaigns/:campaignId/hidden-offers/delete", Routes::bind(&ExpressApi::delete_hidden_offers_handler, this));
    Routes::Post(*router, base + "/businesses/:businessId/offer-mappings/delete", Routes::bind(&ExpressApi::delete_offers_handler, this));
    Routes::Post(*router, base + "/businesses/:businessId/offer-mappings/unarchive", Routes::bind(&ExpressApi::delete_offers_from_archive_handler, this));
    Routes::Post(*router, base + "/businesses/:businessId/promos/offers/delete", Routes::bind(&ExpressApi::delete_promo_offers_handler, this));
    Routes::Post(*router, base + "/reports/boost-consolidated/generate", Routes::bind(&ExpressApi::generate_boost_consolidated_report_handler, this));
    Routes::Post(*router, base + "/reports/competitors-position/generate", Routes::bind(&ExpressApi::generate_competitors_position_report_handler, this));
    Routes::Post(*router, base + "/reports/goods-feedback/generate", Routes::bind(&ExpressApi::generate_goods_feedback_report_handler, this));
    Routes::Post(*router, base + "/reports/goods-realization/generate", Routes::bind(&ExpressApi::generate_goods_realization_report_handler, this));
    Routes::Post(*router, base + "/reports/documents/labels/generate", Routes::bind(&ExpressApi::generate_mass_order_labels_report_handler, this));
    Routes::Get(*router, base + "/campaigns/:campaignId/orders/:orderId/delivery/shipments/:shipmentId/boxes/:boxId/label", Routes::bind(&ExpressApi::generate_order_label_handler, this));
    Routes::Get(*router, base + "/campaigns/:campaignId/orders/:orderId/delivery/labels", Routes::bind(&ExpressApi::generate_order_labels_handler, this));
    Routes::Post(*router, base + "/reports/prices/generate", Routes::bind(&ExpressApi::generate_prices_report_handler, this));
    Routes::Post(*router, base + "/reports/shelf-statistics/generate", Routes::bind(&ExpressApi::generate_shelfs_statistics_report_handler, this));
    Routes::Post(*router, base + "/reports/shows-sales/generate", Routes::bind(&ExpressApi::generate_shows_sales_report_handler, this));
    Routes::Post(*router, base + "/reports/stocks-on-warehouses/generate", Routes::bind(&ExpressApi::generate_stocks_on_warehouses_report_handler, this));
    Routes::Post(*router, base + "/reports/united-marketplace-services/generate", Routes::bind(&ExpressApi::generate_united_marketplace_services_report_handler, this));
    Routes::Post(*router, base + "/reports/united-netting/generate", Routes::bind(&ExpressApi::generate_united_netting_report_handler, this));
    Routes::Post(*router, base + "/reports/united-orders/generate", Routes::bind(&ExpressApi::generate_united_orders_report_handler, this));
    Routes::Get(*router, base + "/campaigns/:campaignId/offers/all", Routes::bind(&ExpressApi::get_all_offers_handler, this));
    Routes::Post(*router, base + "/businesses/:businessId/bids/info", Routes::bind(&ExpressApi::get_bids_info_for_business_handler, this));
    Routes::Post(*router, base + "/businesses/:businessId/bids/recommendations", Routes::bind(&ExpressApi::get_bids_recommendations_handler, this));
    Routes::Post(*router, base + "/businesses/:businessId/price-quarantine", Routes::bind(&ExpressApi::get_business_quarantine_offers_handler, this));
    Routes::Post(*router, base + "/businesses/:businessId/settings", Routes::bind(&ExpressApi::get_business_settings_handler, this));
    Routes::Get(*router, base + "/campaigns/:campaignId", Routes::bind(&ExpressApi::get_campaign_handler, this));
    Routes::Get(*router, base + "/campaigns/:campaignId/logins", Routes::bind(&ExpressApi::get_campaign_logins_handler, this));
    Routes::Post(*router, base + "/campaigns/:campaignId/offers", Routes::bind(&ExpressApi::get_campaign_offers_handler, this));
    Routes::Post(*router, base + "/campaigns/:campaignId/price-quarantine", Routes::bind(&ExpressApi::get_campaign_quarantine_offers_handler, this));
    Routes::Get(*router, base + "/campaigns/:campaignId/region", Routes::bind(&ExpressApi::get_campaign_region_handler, this));
    Routes::Get(*router, base + "/campaigns/:campaignId/settings", Routes::bind(&ExpressApi::get_campaign_settings_handler, this));
    Routes::Get(*router, base + "/campaigns", Routes::bind(&ExpressApi::get_campaigns_handler, this));
    Routes::Get(*router, base + "/campaigns/by_login/:login", Routes::bind(&ExpressApi::get_campaigns_by_login_handler, this));
    Routes::Post(*router, base + "/categories/max-sale-quantum", Routes::bind(&ExpressApi::get_categories_max_sale_quantum_handler, this));
    Routes::Post(*router, base + "/categories/tree", Routes::bind(&ExpressApi::get_categories_tree_handler, this));
    Routes::Post(*router, base + "/category/:categoryId/parameters", Routes::bind(&ExpressApi::get_category_content_parameters_handler, this));
    Routes::Post(*router, base + "/businesses/:businessId/chats/history", Routes::bind(&ExpressApi::get_chat_history_handler, this));
    Routes::Post(*router, base + "/businesses/:businessId/chats", Routes::bind(&ExpressApi::get_chats_handler, this));
    Routes::Get(*router, base + "/delivery/services", Routes::bind(&ExpressApi::get_delivery_services_handler, this));
    Routes::Get(*router, base + "/campaigns/:campaignId/feeds/:feedId", Routes::bind(&ExpressApi::get_feed_handler, this));
    Routes::Get(*router, base + "/campaigns/:campaignId/feeds/:feedId/index-logs", Routes::bind(&ExpressApi::get_feed_index_logs_handler, this));
    Routes::Get(*router, base + "/campaigns/:campaignId/feedback/updates", Routes::bind(&ExpressApi::get_feedback_and_comment_updates_handler, this));
    Routes::Get(*router, base + "/campaigns/:campaignId/feeds", Routes::bind(&ExpressApi::get_feeds_handler, this));
    Routes::Post(*router, base + "/businesses/:businessId/goods-feedback/comments", Routes::bind(&ExpressApi::get_goods_feedback_comments_handler, this));
    Routes::Post(*router, base + "/businesses/:businessId/goods-feedback", Routes::bind(&ExpressApi::get_goods_feedbacks_handler, this));
    Routes::Post(*router, base + "/campaigns/:campaignId/stats/skus", Routes::bind(&ExpressApi::get_goods_stats_handler, this));
    Routes::Get(*router, base + "/campaigns/:campaignId/hidden-offers", Routes::bind(&ExpressApi::get_hidden_offers_handler, this));
    Routes::Post(*router, base + "/businesses/:businessId/offer-cards", Routes::bind(&ExpressApi::get_offer_cards_content_status_handler, this));
    Routes::Get(*router, base + "/campaigns/:campaignId/offer-mapping-entries", Routes::bind(&ExpressApi::get_offer_mapping_entries_handler, this));
    Routes::Post(*router, base + "/businesses/:businessId/offer-mappings", Routes::bind(&ExpressApi::get_offer_mappings_handler, this));
    Routes::Post(*router, base + "/businesses/:businessId/offers/recommendations", Routes::bind(&ExpressApi::get_offer_recommendations_handler, this));
    Routes::Get(*router, base + "/campaigns/:campaignId/offers", Routes::bind(&ExpressApi::get_offers_handler, this));
    Routes::Get(*router, base + "/campaigns/:campaignId/orders/:orderId", Routes::bind(&ExpressApi::get_order_handler, this));
    Routes::Post(*router, base + "/campaigns/:campaignId/orders/:orderId/business-buyer", Routes::bind(&ExpressApi::get_order_business_buyer_info_handler, this));
    Routes::Post(*router, base + "/campaigns/:campaignId/orders/:orderId/documents", Routes::bind(&ExpressApi::get_order_business_documents_info_handler, this));
    Routes::Get(*router, base + "/campaigns/:campaignId/orders/:orderId/delivery/labels/data", Routes::bind(&ExpressApi::get_order_labels_data_handler, this));
    Routes::Get(*router, base + "/campaigns/:campaignId/orders", Routes::bind(&ExpressApi::get_orders_handler, this));
    Routes::Post(*router, base + "/campaigns/:campaignId/stats/orders", Routes::bind(&ExpressApi::get_orders_stats_handler, this));
    Routes::Get(*router, base + "/campaigns/:campaignId/offer-prices", Routes::bind(&ExpressApi::get_prices_handler, this));
    Routes::Post(*router, base + "/campaigns/:campaignId/offer-prices", Routes::bind(&ExpressApi::get_prices_by_offer_ids_handler, this));
    Routes::Post(*router, base + "/businesses/:businessId/promos/offers", Routes::bind(&ExpressApi::get_promo_offers_handler, this));
    Routes::Post(*router, base + "/businesses/:businessId/promos", Routes::bind(&ExpressApi::get_promos_handler, this));
    Routes::Post(*router, base + "/campaigns/:campaignId/ratings/quality/details", Routes::bind(&ExpressApi::get_quality_rating_details_handler, this));
    Routes::Post(*router, base + "/businesses/:businessId/ratings/quality", Routes::bind(&ExpressApi::get_quality_ratings_handler, this));
    Routes::Get(*router, base + "/reports/info/:reportId", Routes::bind(&ExpressApi::get_report_info_handler, this));
    Routes::Get(*router, base + "/campaigns/:campaignId/orders/:orderId/returns/:returnId", Routes::bind(&ExpressApi::get_return_handler, this));
    Routes::Get(*router, base + "/campaigns/:campaignId/orders/:orderId/returns/:returnId/application", Routes::bind(&ExpressApi::get_return_application_handler, this));
    Routes::Get(*router, base + "/campaigns/:campaignId/orders/:orderId/returns/:returnId/decision/:itemId/image/:imageHash", Routes::bind(&ExpressApi::get_return_photo_handler, this));
    Routes::Get(*router, base + "/campaigns/:campaignId/returns", Routes::bind(&ExpressApi::get_returns_handler, this));
    Routes::Post(*router, base + "/campaigns/:campaignId/offers/stocks", Routes::bind(&ExpressApi::get_stocks_handler, this));
    Routes::Post(*router, base + "/campaigns/:campaignId/offer-mapping-entries/suggestions", Routes::bind(&ExpressApi::get_suggested_offer_mapping_entries_handler, this));
    Routes::Post(*router, base + "/businesses/:businessId/offer-mappings/suggestions", Routes::bind(&ExpressApi::get_suggested_offer_mappings_handler, this));
    Routes::Post(*router, base + "/campaigns/:campaignId/offer-prices/suggestions", Routes::bind(&ExpressApi::get_suggested_prices_handler, this));
    Routes::Get(*router, base + "/businesses/:businessId/warehouses", Routes::bind(&ExpressApi::get_warehouses_handler, this));
    Routes::Put(*router, base + "/campaigns/:campaignId/orders/:orderId/identifiers", Routes::bind(&ExpressApi::provide_order_item_identifiers_handler, this));
    Routes::Put(*router, base + "/businesses/:businessId/bids", Routes::bind(&ExpressApi::put_bids_for_business_handler, this));
    Routes::Put(*router, base + "/campaigns/:campaignId/bids", Routes::bind(&ExpressApi::put_bids_for_campaign_handler, this));
    Routes::Post(*router, base + "/campaigns/:campaignId/feeds/:feedId/refresh", Routes::bind(&ExpressApi::refresh_feed_handler, this));
    Routes::Get(*router, base + "/regions/:regionId/children", Routes::bind(&ExpressApi::search_region_children_handler, this));
    Routes::Get(*router, base + "/regions/:regionId", Routes::bind(&ExpressApi::search_regions_by_id_handler, this));
    Routes::Get(*router, base + "/regions", Routes::bind(&ExpressApi::search_regions_by_name_handler, this));
    Routes::Post(*router, base + "/businesses/:businessId/chats/file/send", Routes::bind(&ExpressApi::send_file_to_chat_handler, this));
    Routes::Post(*router, base + "/businesses/:businessId/chats/message", Routes::bind(&ExpressApi::send_message_to_chat_handler, this));
    Routes::Post(*router, base + "/campaigns/:campaignId/feeds/:feedId/params", Routes::bind(&ExpressApi::set_feed_params_handler, this));
    Routes::Put(*router, base + "/campaigns/:campaignId/orders/:orderId/boxes", Routes::bind(&ExpressApi::set_order_box_layout_handler, this));
    Routes::Put(*router, base + "/campaigns/:campaignId/orders/:orderId/delivery/shipments/:shipmentId/boxes", Routes::bind(&ExpressApi::set_order_shipment_boxes_handler, this));
    Routes::Post(*router, base + "/businesses/:businessId/goods-feedback/skip-reaction", Routes::bind(&ExpressApi::skip_goods_feedbacks_reaction_handler, this));
    Routes::Post(*router, base + "/businesses/:businessId/offer-prices/updates", Routes::bind(&ExpressApi::update_business_prices_handler, this));
    Routes::Post(*router, base + "/campaigns/:campaignId/offers/update", Routes::bind(&ExpressApi::update_campaign_offers_handler, this));
    Routes::Post(*router, base + "/businesses/:businessId/goods-feedback/comments/update", Routes::bind(&ExpressApi::update_goods_feedback_comment_handler, this));
    Routes::Post(*router, base + "/businesses/:businessId/offer-cards/update", Routes::bind(&ExpressApi::update_offer_content_handler, this));
    Routes::Post(*router, base + "/campaigns/:campaignId/offer-mapping-entries/updates", Routes::bind(&ExpressApi::update_offer_mapping_entries_handler, this));
    Routes::Post(*router, base + "/businesses/:businessId/offer-mappings/update", Routes::bind(&ExpressApi::update_offer_mappings_handler, this));
    Routes::Put(*router, base + "/campaigns/:campaignId/orders/:orderId/items", Routes::bind(&ExpressApi::update_order_items_handler, this));
    Routes::Put(*router, base + "/campaigns/:campaignId/orders/:orderId/status", Routes::bind(&ExpressApi::update_order_status_handler, this));
    Routes::Post(*router, base + "/campaigns/:campaignId/orders/status-update", Routes::bind(&ExpressApi::update_order_statuses_handler, this));
    Routes::Post(*router, base + "/campaigns/:campaignId/offer-prices/updates", Routes::bind(&ExpressApi::update_prices_handler, this));
    Routes::Post(*router, base + "/businesses/:businessId/promos/offers/update", Routes::bind(&ExpressApi::update_promo_offers_handler, this));
    Routes::Put(*router, base + "/campaigns/:campaignId/offers/stocks", Routes::bind(&ExpressApi::update_stocks_handler, this));
    Routes::Put(*router, base + "/campaigns/:campaignId/orders/:orderId/verifyEac", Routes::bind(&ExpressApi::verify_order_eac_handler, this));

    // Default handler, called when a route is not found
    router->addCustomHandler(Routes::bind(&ExpressApi::express_api_default_handler, this));
}

void ExpressApi::handleParsingException(const std::exception& ex, Pistache::Http::ResponseWriter &response) const noexcept
{
    std::pair<Pistache::Http::Code, std::string> codeAndError = handleParsingException(ex);
    response.send(codeAndError.first, codeAndError.second);
}

std::pair<Pistache::Http::Code, std::string> ExpressApi::handleParsingException(const std::exception& ex) const noexcept
{
    try {
        throw;
...
void ExpressApi::handleOperationException(const std::exception& ex, Pistache::Http::ResponseWriter &response) const noexcept
{
    std::pair<Pistache::Http::Code, std::string> codeAndError = handleOperationException(ex);
    response.send(codeAndError.first, codeAndError.second);
}

std::pair<Pistache::Http::Code, std::string> ExpressApi::handleOperationException(const std::exception& ex) const noexcept
{
    return std::make_pair(Pistache::Http::Code::Internal_Server_Error, ex.what());
}

void ExpressApi::add_hidden_offers_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::add_offers_to_archive_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::calculate_tariffs_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::confirm_business_prices_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::confirm_campaign_prices_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::create_chat_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::delete_campaign_offers_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::delete_goods_feedback_comment_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::delete_hidden_offers_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::delete_offers_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::delete_offers_from_archive_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::delete_promo_offers_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::generate_boost_consolidated_report_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::generate_competitors_position_report_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::generate_goods_feedback_report_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::generate_goods_realization_report_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::generate_mass_order_labels_report_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::generate_order_label_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::generate_order_labels_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::generate_prices_report_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::generate_shelfs_statistics_report_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::generate_shows_sales_report_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::generate_stocks_on_warehouses_report_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::generate_united_marketplace_services_report_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::generate_united_netting_report_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::generate_united_orders_report_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::get_all_offers_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::get_bids_info_for_business_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::get_bids_recommendations_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::get_business_quarantine_offers_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::get_business_settings_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::get_campaign_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::get_campaign_logins_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::get_campaign_offers_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::get_campaign_quarantine_offers_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::get_campaign_region_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::get_campaign_settings_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::get_campaigns_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::get_campaigns_by_login_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::get_categories_max_sale_quantum_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::get_categories_tree_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::get_category_content_parameters_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::get_chat_history_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::get_chats_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::get_delivery_services_handler(const Pistache::Rest::Request &, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::get_feed_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::get_feed_index_logs_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::get_feedback_and_comment_updates_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::get_feeds_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::get_goods_feedback_comments_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::get_goods_feedbacks_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::get_goods_stats_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::get_hidden_offers_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::get_offer_cards_content_status_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::get_offer_mapping_entries_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::get_offer_mappings_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::get_offer_recommendations_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::get_offers_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::get_order_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::get_order_business_buyer_info_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::get_order_business_documents_info_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::get_order_labels_data_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::get_orders_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::get_orders_stats_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::get_prices_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::get_prices_by_offer_ids_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::get_promo_offers_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::get_promos_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::get_quality_rating_details_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::get_quality_ratings_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::get_report_info_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::get_return_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::get_return_application_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::get_return_photo_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::get_returns_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::get_stocks_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::get_suggested_offer_mapping_entries_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::get_suggested_offer_mappings_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::get_suggested_prices_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::get_warehouses_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::provide_order_item_identifiers_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::put_bids_for_business_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::put_bids_for_campaign_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::refresh_feed_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::search_region_children_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::search_regions_by_id_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::search_regions_by_name_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::send_file_to_chat_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::send_message_to_chat_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::set_feed_params_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::set_order_box_layout_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::set_order_shipment_boxes_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::skip_goods_feedbacks_reaction_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::update_business_prices_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::update_campaign_offers_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::update_goods_feedback_comment_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::update_offer_content_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::update_offer_mapping_entries_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::update_offer_mappings_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::update_order_items_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::update_order_status_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::update_order_statuses_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::update_prices_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::update_promo_offers_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::update_stocks_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::verify_order_eac_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void ExpressApi::express_api_default_handler(const Pistache::Rest::Request &, Pistache::Http::ResponseWriter response) {
