...
ContentAPI_getCategoryContentParameters(apiClient_t *apiClient, long categoryId)
{
    ...
    get_category_content_parameters_response_t *elementToReturn = get_category_content_parameters_response_parseFromJSON(ContentAPIlocalVarJSON);
...
ContentAPI_getOfferCardsContentStatus(apiClient_t *apiClient, long businessId, char *page_token, int *limit, get_offer_cards_content_status_request_t *get_offer_cards_content_status_request)
{
    ...
    //nonprimitive not container
    cJSON *ContentAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    get_offer_cards_content_status_response_t *elementToReturn = get_offer_cards_content_status_response_parseFromJSON(ContentAPIlocalVarJSON);
    cJSON_Delete(ContentAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ContentAPI_updateOfferContent(apiClient_t *apiClient, long businessId, update_offer_content_request_t *update_offer_content_request)
{
    ...
    //nonprimitive not container
    cJSON *ContentAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    update_offer_content_response_t *elementToReturn = update_offer_content_response_parseFromJSON(ContentAPIlocalVarJSON);
    cJSON_Delete(ContentAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
