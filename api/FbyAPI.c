...
// Functions for enum  for FbyAPI_generateBoostConsolidatedReport
...
// Functions for enum  for FbyAPI_generateCompetitorsPositionReport
...
// Functions for enum  for FbyAPI_generateGoodsFeedbackReport
...
// Functions for enum  for FbyAPI_generateGoodsMovementReport
...
// Functions for enum  for FbyAPI_generateGoodsRealizationReport
...
// Functions for enum  for FbyAPI_generateGoodsTurnoverReport
...
// Functions for enum  for FbyAPI_generatePricesReport
...
// Functions for enum  for FbyAPI_generateShelfsStatisticsReport
...
// Functions for enum  for FbyAPI_generateShowsSalesReport
...
// Functions for enum  for FbyAPI_generateStocksOnWarehousesReport
...
// Functions for enum  for FbyAPI_generateUnitedMarketplaceServicesReport
...
// Functions for enum  for FbyAPI_generateUnitedNettingReport
...
// Functions for enum  for FbyAPI_generateUnitedOrdersReport
...
// Functions for enum  for FbyAPI_getFeedIndexLogs
...
// Functions for enum  for FbyAPI_getOfferMappingEntries
...
// Functions for enum STATUS for FbyAPI_getOfferMappingEntries
...
// Functions for enum AVAILABILITY for FbyAPI_getOfferMappingEntries
...
// Functions for enum  for FbyAPI_getOffers
...
// Functions for enum STATUS for FbyAPI_getOrders
...
// Functions for enum SUBSTATUS for FbyAPI_getOrders
...
// Functions for enum  for FbyAPI_getOrders
...
// Functions for enum STATUSES for FbyAPI_getReturns
...
// Functions for enum  for FbyAPI_getReturns
...
FbyAPI_addHiddenOffers(apiClient_t *apiClient, long campaignId, add_hidden_offers_request_t *add_hidden_offers_request)
{
    ...
    cJSON *FbyAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_api_response_t *elementToReturn = empty_api_response_parseFromJSON(FbyAPIlocalVarJSON);
    cJSON_Delete(FbyAPIlocalVarJSON);
...
FbyAPI_addOffersToArchive(apiClient_t *apiClient, long businessId, add_offers_to_archive_request_t *add_offers_to_archive_request)
{
    ...
    //nonprimitive not container
    cJSON *FbyAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    add_offers_to_archive_response_t *elementToReturn = add_offers_to_archive_response_parseFromJSON(FbyAPIlocalVarJSON);
    cJSON_Delete(FbyAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
FbyAPI_calculateTariffs(apiClient_t *apiClient, calculate_tariffs_request_t *calculate_tariffs_request)
{
    ...
    //nonprimitive not container
    cJSON *FbyAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    calculate_tariffs_response_t *elementToReturn = calculate_tariffs_response_parseFromJSON(FbyAPIlocalVarJSON);
    cJSON_Delete(FbyAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
FbyAPI_createChat(apiClient_t *apiClient, long businessId, create_chat_request_t *create_chat_request)
{
    ...
    //nonprimitive not container
    cJSON *FbyAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    create_chat_response_t *elementToReturn = create_chat_response_parseFromJSON(FbyAPIlocalVarJSON);
    cJSON_Delete(FbyAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
FbyAPI_deleteCampaignOffers(apiClient_t *apiClient, long campaignId, delete_campaign_offers_request_t *delete_campaign_offers_request)
{
    ...
    //nonprimitive not container
    cJSON *FbyAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    delete_campaign_offers_response_t *elementToReturn = delete_campaign_offers_response_parseFromJSON(FbyAPIlocalVarJSON);
    cJSON_Delete(FbyAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
FbyAPI_deleteOffers(apiClient_t *apiClient, long businessId, delete_offers_request_t *delete_offers_request)
{
    ...
    //nonprimitive not container
    cJSON *FbyAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    delete_offers_response_t *elementToReturn = delete_offers_response_parseFromJSON(FbyAPIlocalVarJSON);
    cJSON_Delete(FbyAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
FbyAPI_deleteOffersFromArchive(apiClient_t *apiClient, long businessId, delete_offers_from_archive_request_t *delete_offers_from_archive_request)
{
    ...
    //nonprimitive not container
    cJSON *FbyAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    delete_offers_from_archive_response_t *elementToReturn = delete_offers_from_archive_response_parseFromJSON(FbyAPIlocalVarJSON);
    cJSON_Delete(FbyAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
FbyAPI_deletePromoOffers(apiClient_t *apiClient, long businessId, delete_promo_offers_request_t *delete_promo_offers_request)
{
    ...
    //nonprimitive not container
    cJSON *FbyAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    delete_promo_offers_response_t *elementToReturn = delete_promo_offers_response_parseFromJSON(FbyAPIlocalVarJSON);
    cJSON_Delete(FbyAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
FbyAPI_generateBoostConsolidatedReport(apiClient_t *apiClient, generate_boost_consolidated_request_t *generate_boost_consolidated_request, report_format_type_e format)
{
    ...
    //nonprimitive not container
    cJSON *FbyAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    generate_report_response_t *elementToReturn = generate_report_response_parseFromJSON(FbyAPIlocalVarJSON);
    cJSON_Delete(FbyAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
FbyAPI_getAllOffers(apiClient_t *apiClient, long campaignId, long feedId, int *chunk)
{
    ...
    //nonprimitive not container
    cJSON *FbyAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    get_all_offers_response_t *elementToReturn = get_all_offers_response_parseFromJSON(FbyAPIlocalVarJSON);
    cJSON_Delete(FbyAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
FbyAPI_getBidsInfoForBusiness(apiClient_t *apiClient, long businessId, char *page_token, int *limit, get_bids_info_request_t *get_bids_info_request)
{
    ...
    //nonprimitive not container
    cJSON *FbyAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    get_bids_info_response_t *elementToReturn = get_bids_info_response_parseFromJSON(FbyAPIlocalVarJSON);
    cJSON_Delete(FbyAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
FbyAPI_getBidsRecommendations(apiClient_t *apiClient, long businessId, get_bids_recommendations_request_t *get_bids_recommendations_request)
{
    ...
    //nonprimitive not container
    cJSON *FbyAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    get_bids_recommendations_response_t *elementToReturn = get_bids_recommendations_response_parseFromJSON(FbyAPIlocalVarJSON);
    cJSON_Delete(FbyAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
FbyAPI_getBusinessQuarantineOffers(apiClient_t *apiClient, long businessId, get_quarantine_offers_request_t *get_quarantine_offers_request, char *page_token, int *limit)
{
    ...
    //nonprimitive not container
    cJSON *FbyAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    get_quarantine_offers_response_t *elementToReturn = get_quarantine_offers_response_parseFromJSON(FbyAPIlocalVarJSON);
    cJSON_Delete(FbyAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
FbyAPI_getBusinessSettings(apiClient_t *apiClient, long businessId)
{
    ...
    //nonprimitive not container
    cJSON *FbyAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    get_business_settings_response_t *elementToReturn = get_business_settings_response_parseFromJSON(FbyAPIlocalVarJSON);
    cJSON_Delete(FbyAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
FbyAPI_getCampaign(apiClient_t *apiClient, long campaignId)
{
    ...
    //nonprimitive not container
    cJSON *FbyAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    get_campaign_response_t *elementToReturn = get_campaign_response_parseFromJSON(FbyAPIlocalVarJSON);
    cJSON_Delete(FbyAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
FbyAPI_getCampaignLogins(apiClient_t *apiClient, long campaignId)
{
    ...
    //nonprimitive not container
    cJSON *FbyAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    get_campaign_logins_response_t *elementToReturn = get_campaign_logins_response_parseFromJSON(FbyAPIlocalVarJSON);
    cJSON_Delete(FbyAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
FbyAPI_getCampaignOffers(apiClient_t *apiClient, long campaignId, get_campaign_offers_request_t *get_campaign_offers_request, char *page_token, int *limit)
{
    ...
    //nonprimitive not container
    cJSON *FbyAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    get_campaign_offers_response_t *elementToReturn = get_campaign_offers_response_parseFromJSON(FbyAPIlocalVarJSON);
    cJSON_Delete(FbyAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
FbyAPI_getCampaignRegion(apiClient_t *apiClient, long campaignId)
{
    ...
    //nonprimitive not container
    cJSON *FbyAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    get_campaign_region_response_t *elementToReturn = get_campaign_region_response_parseFromJSON(FbyAPIlocalVarJSON);
    cJSON_Delete(FbyAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
FbyAPI_getCampaignSettings(apiClient_t *apiClient, long campaignId)
{
    ...
    //nonprimitive not container
    cJSON *FbyAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    get_campaign_settings_response_t *elementToReturn = get_campaign_settings_response_parseFromJSON(FbyAPIlocalVarJSON);
    cJSON_Delete(FbyAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
FbyAPI_getCampaigns(apiClient_t *apiClient, int *page, int *pageSize)
{
    ...
    //nonprimitive not container
    cJSON *FbyAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    get_campaigns_response_t *elementToReturn = get_campaigns_response_parseFromJSON(FbyAPIlocalVarJSON);
    cJSON_Delete(FbyAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
FbyAPI_getCategoriesMaxSaleQuantum(apiClient_t *apiClient, get_categories_max_sale_quantum_request_t *get_categories_max_sale_quantum_request)
{
    ...
    //nonprimitive not container
    cJSON *FbyAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    get_categories_max_sale_quantum_response_t *elementToReturn = get_categories_max_sale_quantum_response_parseFromJSON(FbyAPIlocalVarJSON);
    cJSON_Delete(FbyAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
FbyAPI_getCategoriesTree(apiClient_t *apiClient, get_categories_request_t *get_categories_request)
{
    ...
    //nonprimitive not container
    cJSON *FbyAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    get_categories_response_t *elementToReturn = get_categories_response_parseFromJSON(FbyAPIlocalVarJSON);
    cJSON_Delete(FbyAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
FbyAPI_getCategoryContentParameters(apiClient_t *apiClient, long categoryId)
{
    ...
    //nonprimitive not container
    cJSON *FbyAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    get_category_content_parameters_response_t *elementToReturn = get_category_content_parameters_response_parseFromJSON(FbyAPIlocalVarJSON);
    cJSON_Delete(FbyAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
FbyAPI_getChatHistory(apiClient_t *apiClient, long businessId, long chatId, get_chat_history_request_t *get_chat_history_request, char *page_token, int *limit)
{
    ...
    //nonprimitive not container
    cJSON *FbyAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    get_chat_history_response_t *elementToReturn = get_chat_history_response_parseFromJSON(FbyAPIlocalVarJSON);
    cJSON_Delete(FbyAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
FbyAPI_getChats(apiClient_t *apiClient, long businessId, get_chats_request_t *get_chats_request, char *page_token, int *limit)
{
    ...
    //nonprimitive not container
    cJSON *FbyAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    get_chats_response_t *elementToReturn = get_chats_response_parseFromJSON(FbyAPIlocalVarJSON);
    cJSON_Delete(FbyAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
FbyAPI_getFeed(apiClient_t *apiClient, long campaignId, long feedId)
{
    ...
    //nonprimitive not container
    cJSON *FbyAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    get_feed_response_t *elementToReturn = get_feed_response_parseFromJSON(FbyAPIlocalVarJSON);
    cJSON_Delete(FbyAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
FbyAPI_getFeedIndexLogs(apiClient_t *apiClient, long campaignId, long feedId, int *limit, char published_time_from, char published_time_to, feed_index_logs_status_type_e status)
{
    ...
    //nonprimitive not container
    cJSON *FbyAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    get_feed_index_logs_response_t *elementToReturn = get_feed_index_logs_response_parseFromJSON(FbyAPIlocalVarJSON);
    cJSON_Delete(FbyAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
FbyAPI_getFeedbackAndCommentUpdates(apiClient_t *apiClient, long campaignId, char *page_token, int *limit, char from_date)
{
    ...
    //nonprimitive not container
    cJSON *FbyAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    get_feedback_list_response_t *elementToReturn = get_feedback_list_response_parseFromJSON(FbyAPIlocalVarJSON);
    cJSON_Delete(FbyAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
FbyAPI_getFeeds(apiClient_t *apiClient, long campaignId)
{
    ...
    //nonprimitive not container
    cJSON *FbyAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    get_feeds_response_t *elementToReturn = get_feeds_response_parseFromJSON(FbyAPIlocalVarJSON);
    cJSON_Delete(FbyAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
FbyAPI_getFulfillmentWarehouses(apiClient_t *apiClient)
{
    ...
    //nonprimitive not container
    cJSON *FbyAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    get_fulfillment_warehouses_response_t *elementToReturn = get_fulfillment_warehouses_response_parseFromJSON(FbyAPIlocalVarJSON);
    cJSON_Delete(FbyAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
FbyAPI_getGoodsFeedbackComments(apiClient_t *apiClient, long businessId, get_goods_feedback_comments_request_t *get_goods_feedback_comments_request, char *page_token, int *limit)
{
    ...
    //nonprimitive not container
    cJSON *FbyAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    get_goods_feedback_comments_response_t *elementToReturn = get_goods_feedback_comments_response_parseFromJSON(FbyAPIlocalVarJSON);
    cJSON_Delete(FbyAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
FbyAPI_getGoodsFeedbacks(apiClient_t *apiClient, long businessId, char *page_token, int *limit, get_goods_feedback_request_t *get_goods_feedback_request)
{
    ...
    //nonprimitive not container
    cJSON *FbyAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    get_goods_feedback_response_t *elementToReturn = get_goods_feedback_response_parseFromJSON(FbyAPIlocalVarJSON);
    cJSON_Delete(FbyAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
FbyAPI_getGoodsStats(apiClient_t *apiClient, long campaignId, get_goods_stats_request_t *get_goods_stats_request)
{
    ...
    //nonprimitive not container
    cJSON *FbyAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    get_goods_stats_response_t *elementToReturn = get_goods_stats_response_parseFromJSON(FbyAPIlocalVarJSON);
    cJSON_Delete(FbyAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
FbyAPI_getHiddenOffers(apiClient_t *apiClient, long campaignId, list_t *offer_id, char *page_token, int *limit, int *offset, int *page, int *pageSize)
{
    ...
    //nonprimitive not container
    cJSON *FbyAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    get_hidden_offers_response_t *elementToReturn = get_hidden_offers_response_parseFromJSON(FbyAPIlocalVarJSON);
    cJSON_Delete(FbyAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
FbyAPI_getOfferCardsContentStatus(apiClient_t *apiClient, long businessId, char *page_token, int *limit, get_offer_cards_content_status_request_t *get_offer_cards_content_status_request)
{
    ...
    //nonprimitive not container
    cJSON *FbyAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    get_offer_cards_content_status_response_t *elementToReturn = get_offer_cards_content_status_response_parseFromJSON(FbyAPIlocalVarJSON);
    cJSON_Delete(FbyAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
FbyAPI_getOfferMappingEntries(apiClient_t *apiClient, long campaignId, list_t *offer_id, list_t *shop_sku, offer_mapping_kind_type_e mapping_kind, list_t *status, list_t *availability, list_t *category_id, list_t *vendor, char *page_token, int *limit)
{
    ...
    //nonprimitive not container
    cJSON *FbyAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    get_offer_mapping_entries_response_t *elementToReturn = get_offer_mapping_entries_response_parseFromJSON(FbyAPIlocalVarJSON);
    cJSON_Delete(FbyAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
FbyAPI_getOfferMappings(apiClient_t *apiClient, long businessId, char *page_token, int *limit, get_offer_mappings_request_t *get_offer_mappings_request)
{
    ...
    //nonprimitive not container
    cJSON *FbyAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    get_offer_mappings_response_t *elementToReturn = get_offer_mappings_response_parseFromJSON(FbyAPIlocalVarJSON);
    cJSON_Delete(FbyAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
FbyAPI_getOfferRecommendations(apiClient_t *apiClient, long businessId, get_offer_recommendations_request_t *get_offer_recommendations_request, char *page_token, int *limit)
{
    ...
    //nonprimitive not container
    cJSON *FbyAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    get_offer_recommendations_response_t *elementToReturn = get_offer_recommendations_response_parseFromJSON(FbyAPIlocalVarJSON);
    cJSON_Delete(FbyAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
FbyAPI_getOffers(apiClient_t *apiClient, long campaignId, char *query, long feedId, char *shopCategoryId, currency_type_e currency, int *matched, int *page, int *pageSize)
{
    ...
    //nonprimitive not container
    cJSON *FbyAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    get_offers_response_t *elementToReturn = get_offers_response_parseFromJSON(FbyAPIlocalVarJSON);
    cJSON_Delete(FbyAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
FbyAPI_getOrder(apiClient_t *apiClient, long campaignId, long orderId)
{
    ...
    //nonprimitive not container
    cJSON *FbyAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    get_order_response_t *elementToReturn = get_order_response_parseFromJSON(FbyAPIlocalVarJSON);
    cJSON_Delete(FbyAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
FbyAPI_getOrderBusinessBuyerInfo(apiClient_t *apiClient, long campaignId, long orderId)
{
    ...
    //nonprimitive not container
    cJSON *FbyAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    get_business_buyer_info_response_t *elementToReturn = get_business_buyer_info_response_parseFromJSON(FbyAPIlocalVarJSON);
    cJSON_Delete(FbyAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
FbyAPI_getOrderBusinessDocumentsInfo(apiClient_t *apiClient, long campaignId, long orderId)
{
    ...
    //nonprimitive not container
    cJSON *FbyAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    get_business_documents_info_response_t *elementToReturn = get_business_documents_info_response_parseFromJSON(FbyAPIlocalVarJSON);
    cJSON_Delete(FbyAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
FbyAPI_getOrders(apiClient_t *apiClient, long campaignId, list_t *orderIds, list_t *status, list_t *substatus, char fromDate, char toDate, char supplierShipmentDateFrom, char supplierShipmentDateTo, char updatedAtFrom, char updatedAtTo, order_delivery_dispatch_type_e dispatchType, int *fake, int *hasCis, int *onlyWaitingForCancellationApprove, int *onlyEstimatedDelivery, order_buyer_type_e buyerType, int *page, int *pageSize, char *page_token, int *limit)
{
    ...
    //nonprimitive not container
    cJSON *FbyAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    get_orders_response_t *elementToReturn = get_orders_response_parseFromJSON(FbyAPIlocalVarJSON);
    cJSON_Delete(FbyAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
FbyAPI_getOrdersStats(apiClient_t *apiClient, long campaignId, char *page_token, int *limit, get_orders_stats_request_t *get_orders_stats_request)
{
    ...
    //nonprimitive not container
    cJSON *FbyAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    get_orders_stats_response_t *elementToReturn = get_orders_stats_response_parseFromJSON(FbyAPIlocalVarJSON);
    cJSON_Delete(FbyAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
FbyAPI_getPrices(apiClient_t *apiClient, long campaignId, char *page_token, int *limit, int *archived)
{
    ...
    //nonprimitive not container
    cJSON *FbyAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    get_prices_response_t *elementToReturn = get_prices_response_parseFromJSON(FbyAPIlocalVarJSON);
    cJSON_Delete(FbyAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
FbyAPI_getPricesByOfferIds(apiClient_t *apiClient, long campaignId, char *page_token, int *limit, get_prices_by_offer_ids_request_t *get_prices_by_offer_ids_request)
{
    ...
    //nonprimitive not container
    cJSON *FbyAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    get_prices_by_offer_ids_response_t *elementToReturn = get_prices_by_offer_ids_response_parseFromJSON(FbyAPIlocalVarJSON);
    cJSON_Delete(FbyAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
FbyAPI_getPromoOffers(apiClient_t *apiClient, long businessId, get_promo_offers_request_t *get_promo_offers_request, char *page_token, int *limit)
{
    ...
    //nonprimitive not container
    cJSON *FbyAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    get_promo_offers_response_t *elementToReturn = get_promo_offers_response_parseFromJSON(FbyAPIlocalVarJSON);
    cJSON_Delete(FbyAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
FbyAPI_getPromos(apiClient_t *apiClient, long businessId, get_promos_request_t *get_promos_request)
{
    ...
    //nonprimitive not container
    cJSON *FbyAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    get_promos_response_t *elementToReturn = get_promos_response_parseFromJSON(FbyAPIlocalVarJSON);
    cJSON_Delete(FbyAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
FbyAPI_getQualityRatings(apiClient_t *apiClient, long businessId, get_quality_rating_request_t *get_quality_rating_request)
{
    ...
    //nonprimitive not container
    cJSON *FbyAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    get_quality_rating_response_t *elementToReturn = get_quality_rating_response_parseFromJSON(FbyAPIlocalVarJSON);
    cJSON_Delete(FbyAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
FbyAPI_getReportInfo(apiClient_t *apiClient, char *reportId)
{
    ...
    //nonprimitive not container
    cJSON *FbyAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    get_report_info_response_t *elementToReturn = get_report_info_response_parseFromJSON(FbyAPIlocalVarJSON);
    cJSON_Delete(FbyAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
FbyAPI_getReturn(apiClient_t *apiClient, long campaignId, long orderId, long returnId)
{
    ...
    //nonprimitive not container
    cJSON *FbyAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    get_return_response_t *elementToReturn = get_return_response_parseFromJSON(FbyAPIlocalVarJSON);
    cJSON_Delete(FbyAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
FbyAPI_getReturns(apiClient_t *apiClient, long campaignId, char *page_token, int *limit, list_t *orderIds, list_t *statuses, return_type_e type, char fromDate, char toDate, char from_date, char to_date)
{
    ...
    //nonprimitive not container
    cJSON *FbyAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    get_returns_response_t *elementToReturn = get_returns_response_parseFromJSON(FbyAPIlocalVarJSON);
    cJSON_Delete(FbyAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
FbyAPI_getStocks(apiClient_t *apiClient, long campaignId, char *page_token, int *limit, get_warehouse_stocks_request_t *get_warehouse_stocks_request)
{
    ...
    //nonprimitive not container
    cJSON *FbyAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    get_warehouse_stocks_response_t *elementToReturn = get_warehouse_stocks_response_parseFromJSON(FbyAPIlocalVarJSON);
    cJSON_Delete(FbyAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
FbyAPI_getSuggestedOfferMappingEntries(apiClient_t *apiClient, long campaignId, get_suggested_offer_mapping_entries_request_t *get_suggested_offer_mapping_entries_request)
{
    ...
    //nonprimitive not container
    cJSON *FbyAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    get_suggested_offer_mapping_entries_response_t *elementToReturn = get_suggested_offer_mapping_entries_response_parseFromJSON(FbyAPIlocalVarJSON);
    cJSON_Delete(FbyAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
FbyAPI_getSuggestedOfferMappings(apiClient_t *apiClient, long businessId, get_suggested_offer_mappings_request_t *get_suggested_offer_mappings_request)
{
    ...
    //nonprimitive not container
    cJSON *FbyAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    get_suggested_offer_mappings_response_t *elementToReturn = get_suggested_offer_mappings_response_parseFromJSON(FbyAPIlocalVarJSON);
    cJSON_Delete(FbyAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
FbyAPI_getSuggestedPrices(apiClient_t *apiClient, long campaignId, suggest_prices_request_t *suggest_prices_request)
{
    ...
    //nonprimitive not container
    cJSON *FbyAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    suggest_prices_response_t *elementToReturn = suggest_prices_response_parseFromJSON(FbyAPIlocalVarJSON);
    cJSON_Delete(FbyAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
FbyAPI_searchRegionChildren(apiClient_t *apiClient, long regionId, int *page, int *pageSize)
{
    ...
    //nonprimitive not container
    cJSON *FbyAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    get_region_with_children_response_t *elementToReturn = get_region_with_children_response_parseFromJSON(FbyAPIlocalVarJSON);
    cJSON_Delete(FbyAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
FbyAPI_searchRegionsById(apiClient_t *apiClient, long regionId)
{
    ...
    //nonprimitive not container
    cJSON *FbyAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    get_regions_response_t *elementToReturn = get_regions_response_parseFromJSON(FbyAPIlocalVarJSON);
    cJSON_Delete(FbyAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
FbyAPI_updateGoodsFeedbackComment(apiClient_t *apiClient, long businessId, update_goods_feedback_comment_request_t *update_goods_feedback_comment_request)
{
    ...
    //nonprimitive not container
    cJSON *FbyAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    update_goods_feedback_comment_response_t *elementToReturn = update_goods_feedback_comment_response_parseFromJSON(FbyAPIlocalVarJSON);
    cJSON_Delete(FbyAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
FbyAPI_updateOfferContent(apiClient_t *apiClient, long businessId, update_offer_content_request_t *update_offer_content_request)
{
    ...
    //nonprimitive not container
    cJSON *FbyAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    update_offer_content_response_t *elementToReturn = update_offer_content_response_parseFromJSON(FbyAPIlocalVarJSON);
    cJSON_Delete(FbyAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
FbyAPI_updateOfferMappings(apiClient_t *apiClient, long businessId, update_offer_mappings_request_t *update_offer_mappings_request)
{
    ...
    //nonprimitive not container
    cJSON *FbyAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    update_offer_mappings_response_t *elementToReturn = update_offer_mappings_response_parseFromJSON(FbyAPIlocalVarJSON);
    cJSON_Delete(FbyAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
FbyAPI_updatePromoOffers(apiClient_t *apiClient, long businessId, update_promo_offers_request_t *update_promo_offers_request)
{
    ...
    //nonprimitive not container
    cJSON *FbyAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    update_promo_offers_response_t *elementToReturn = update_promo_offers_response_parseFromJSON(FbyAPIlocalVarJSON);
    cJSON_Delete(FbyAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
