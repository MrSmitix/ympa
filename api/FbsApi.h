...
class  FbsApi : public ApiBase {
public:
    explicit FbsApi(const std::shared_ptr<Pistache::Rest::Router>& rtr);
    ~FbsApi() override = default;
    void init() override;
...
private:
    ...
    void fbs_api_default_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response);
