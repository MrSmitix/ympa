...
class  DbsApi : public ApiBase {
public:
    explicit DbsApi(const std::shared_ptr<Pistache::Rest::Router>& rtr);
    ~DbsApi() override = default;
    void init() override;
...
private:
    ...
    void accept_order_cancellation_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response);
    ...
    void provide_order_digital_codes_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response);
    ...
    void dbs_api_default_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response);
    ...
    virtual void accept_order_cancellation(const int64_t &campaignId, const int64_t &orderId, const org::openapitools::server::model::AcceptOrderCancellationRequest &acceptOrderCancellationRequest, Pistache::Http::ResponseWriter &response) = 0;
    /// <summary>
    ...
    virtual void provide_order_digital_codes(const int64_t &campaignId, const int64_t &orderId, const org::openapitools::server::model::ProvideOrderDigitalCodesRequest &provideOrderDigitalCodesRequest, Pistache::Http::ResponseWriter &response) = 0;
    /// <summary>
