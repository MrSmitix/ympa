...
class CampaignSettingsScheduleDTO(Model):
    ...
    def __init__(self, available_on_holidays: bool=None, custom_holidays: List[str]=None, custom_working_days: List[str]=None, period: CampaignSettingsTimePeriodDTO=None, total_holidays: List[str]=None, weekly_holidays: List[int]=None):
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'CampaignSettingsScheduleDTO':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The CampaignSettingsScheduleDTO of this CampaignSettingsScheduleDTO.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def available_on_holidays(self):
    ...
    def available_on_holidays(self, available_on_holidays):
    ...
    def custom_holidays(self, custom_holidays):
        ...
        if custom_holidays is None:
            raise ValueError("Invalid value for `custom_holidays`, must not be `None`")

        self._custom_holidays = custom_holidays

    @property
    def custom_working_days(self):
    ...
    def custom_working_days(self, custom_working_days):
        ...
        if custom_working_days is None:
            raise ValueError("Invalid value for `custom_working_days`, must not be `None`")
    ...
    def total_holidays(self, total_holidays):
        ...
        if total_holidays is None:
            raise ValueError("Invalid value for `total_holidays`, must not be `None`")

        self._total_holidays = total_holidays

    @property
    def weekly_holidays(self):
    ...
    def weekly_holidays(self, weekly_holidays):
        ...
        if weekly_holidays is None:
            raise ValueError("Invalid value for `weekly_holidays`, must not be `None`")
