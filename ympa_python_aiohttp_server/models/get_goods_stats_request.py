...
class GetGoodsStatsRequest(Model):
    ...
    def __init__(self, shop_skus: list[str]=None):
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'GetGoodsStatsRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The GetGoodsStatsRequest of this GetGoodsStatsRequest.
        """
    ...
    def shop_skus(self, shop_skus):
        ...
        if shop_skus is not None and len(shop_skus) > 500:
            raise ValueError("Invalid value for `shop_skus`, number of items must be less than or equal to `500`")
        if shop_skus is not None and len(shop_skus) < 1:
            raise ValueError("Invalid value for `shop_skus`, number of items must be greater than or equal to `1`")
