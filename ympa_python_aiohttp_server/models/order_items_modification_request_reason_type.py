...
class OrderItemsModificationRequestReasonType(Model):
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'OrderItemsModificationRequestReasonType':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The OrderItemsModificationRequestReasonType of this OrderItemsModificationRequestReasonType.
        """
