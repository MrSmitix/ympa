...
class ReturnDecisionDTO(Model):
    ...
    def __init__(self, return_item_id: int=None, count: int=None, comment: str=None, reason_type: ReturnDecisionReasonType=None, subreason_type: ReturnDecisionSubreasonType=None, decision_type: ReturnDecisionType=None, refund_amount: int=None, partner_compensation: int=None, images: List[str]=None):
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'ReturnDecisionDTO':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The ReturnDecisionDTO of this ReturnDecisionDTO.
        """
    ...
    def subreason_type(self, subreason_type):
    ...
    def partner_compensation(self, partner_compensation):
