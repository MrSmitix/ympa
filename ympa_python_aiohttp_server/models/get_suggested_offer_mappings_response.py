...
class GetSuggestedOfferMappingsResponse(Model):
    ...
    def __init__(self, status: ApiResponseStatusType=None, result: GetSuggestedOfferMappingsResultDTO=None):
        """GetSuggestedOfferMappingsResponse - a model defined in OpenAPI
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'GetSuggestedOfferMappingsResponse':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The GetSuggestedOfferMappingsResponse of this GetSuggestedOfferMappingsResponse.
        """
