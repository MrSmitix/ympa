...
class OfferDTO(Model):
    ...
    def __init__(self, price: float=None, feed_id: int=None, id: str=None, shop_category_id: str=None, market_category_id: int=None, pre_discount_price: float=None, discount: int=None, cut_price: bool=None, url: str=None, model_id: int=None, name: str=None, currency: CurrencyType=None, bid: float=None, cbid: float=None, fee: float=None, blocked: bool=None):
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'OfferDTO':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The OfferDTO of this OfferDTO.
        """
    ...
    def shop_category_id(self, shop_category_id):
    ...
    def pre_discount_price(self, pre_discount_price):
