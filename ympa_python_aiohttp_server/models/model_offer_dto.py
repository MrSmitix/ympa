...
class ModelOfferDTO(Model):
    ...
    def __init__(self, discount: int=None, name: str=None, pos: int=None, pre_discount_price: float=None, price: float=None, region_id: int=None, shipping_cost: float=None, shop_name: str=None, shop_rating: int=None, in_stock: int=None):
        """ModelOfferDTO - a model defined in OpenAPI
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'ModelOfferDTO':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The ModelOfferDTO of this ModelOfferDTO.
        """
    ...
    @shop_rating.setter
    def shop_rating(self, shop_rating):
