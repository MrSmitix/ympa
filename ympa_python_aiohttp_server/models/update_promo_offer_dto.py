...
class UpdatePromoOfferDTO(Model):
    ...
    def __init__(self, offer_id: str=None, params: UpdatePromoOfferParamsDTO=None):
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'UpdatePromoOfferDTO':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The UpdatePromoOfferDTO of this UpdatePromoOfferDTO.
        """
