...
class GetWarehousesResponse(Model):
    ...
    def __init__(self, status: ApiResponseStatusType=None, result: WarehousesDTO=None):
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'GetWarehousesResponse':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The GetWarehousesResponse of this GetWarehousesResponse.
        """
