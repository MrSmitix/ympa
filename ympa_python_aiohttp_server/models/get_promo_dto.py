...
class GetPromoDTO(Model):
    ...
    def __init__(self, id: str=None, name: str=None, period: PromoPeriodDTO=None, participating: bool=None, assortment_info: GetPromoAssortmentInfoDTO=None, mechanics_info: GetPromoMechanicsInfoDTO=None, bestseller_info: GetPromoBestsellerInfoDTO=None, channels: List[ChannelType]=None, constraints: GetPromoConstraintsDTO=None):
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'GetPromoDTO':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The GetPromoDTO of this GetPromoDTO.
        """
    ...
    def participating(self, participating):
        ...
        if participating is None:
            raise ValueError("Invalid value for `participating`, must not be `None`")

        self._participating = participating

    @property
    def assortment_info(self):
    ...
    def assortment_info(self, assortment_info):
        ...
        if assortment_info is None:
            raise ValueError("Invalid value for `assortment_info`, must not be `None`")

        self._assortment_info = assortment_info

    @property
    def mechanics_info(self):
    ...
    def mechanics_info(self, mechanics_info):
        ...
        if mechanics_info is None:
            raise ValueError("Invalid value for `mechanics_info`, must not be `None`")

        self._mechanics_info = mechanics_info

    @property
    def bestseller_info(self):
    ...
    def bestseller_info(self, bestseller_info):
        ...
        if bestseller_info is None:
            raise ValueError("Invalid value for `bestseller_info`, must not be `None`")
