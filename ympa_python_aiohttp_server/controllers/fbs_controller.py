...
async def confirm_shipment(request: web.Request, campaign_id, shipment_id, body=None) -> web.Response:
    ...
    """
    body = ConfirmShipmentRequest.from_dict(body)
    return web.Response(status=200)
...
async def download_shipment_act(request: web.Request, campaign_id, shipment_id) -> web.Response:
...
async def download_shipment_discrepancy_act(request: web.Request, campaign_id, shipment_id) -> web.Response:
...
async def download_shipment_inbound_act(request: web.Request, campaign_id, shipment_id) -> web.Response:
...
async def download_shipment_pallet_labels(request: web.Request, campaign_id, shipment_id, format=None) -> web.Response:
...
async def download_shipment_reception_transfer_act(request: web.Request, campaign_id, warehouse_id=None) -> web.Response:
...
async def download_shipment_transportation_waybill(request: web.Request, campaign_id, shipment_id) -> web.Response:
...
async def get_shipment(request: web.Request, campaign_id, shipment_id, cancelled_orders=None) -> web.Response:
...
async def get_shipment_orders_info(request: web.Request, campaign_id, shipment_id) -> web.Response:
...
async def search_shipments(request: web.Request, campaign_id, body, page_token=None, limit=None) -> web.Response:
    ...
    """
    body = SearchShipmentsRequest.from_dict(body)
    return web.Response(status=200)
...
async def set_shipment_pallets_count(request: web.Request, campaign_id, shipment_id, body) -> web.Response:
    ...
    """
    body = SetShipmentPalletsCountRequest.from_dict(body)
    return web.Response(status=200)
...
async def transfer_orders_from_shipment(request: web.Request, campaign_id, shipment_id, body) -> web.Response:
    ...
    """
    body = TransferOrdersFromShipmentRequest.from_dict(body)
    return web.Response(status=200)
