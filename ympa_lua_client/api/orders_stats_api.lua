...
local orders_stats_api = {}
local orders_stats_api_mt = {
	__name = "orders_stats_api";
	__index = orders_stats_api;
}

local function new_orders_stats_api(authority, basePath, schemes)
	local schemes_map = {}
...
function orders_stats_api:get_orders_stats(campaign_id, page_token, limit, get_orders_stats_request)
