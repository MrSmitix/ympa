...
local goods_stats_api = {}
local goods_stats_api_mt = {
	__name = "goods_stats_api";
	__index = goods_stats_api;
}

local function new_goods_stats_api(authority, basePath, schemes)
	local schemes_map = {}
...
function goods_stats_api:get_goods_stats(campaign_id, get_goods_stats_request)
