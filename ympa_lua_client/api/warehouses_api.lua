...
local warehouses_api = {}
local warehouses_api_mt = {
	__name = "warehouses_api";
	__index = warehouses_api;
}

local function new_warehouses_api(authority, basePath, schemes)
	local schemes_map = {}
...
function warehouses_api:get_fulfillment_warehouses()
...
function warehouses_api:get_warehouses(business_id)
	local req = http_request.new_from_uri({
		scheme = self.default_scheme;
		host = self.host;
		port = self.port;
