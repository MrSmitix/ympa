...
local feedbacks_api = {}
local feedbacks_api_mt = {
	__name = "feedbacks_api";
	__index = feedbacks_api;
}

local function new_feedbacks_api(authority, basePath, schemes)
	local schemes_map = {}
...
function feedbacks_api:get_feedback_and_comment_updates(campaign_id, page_token, limit, from_date)
