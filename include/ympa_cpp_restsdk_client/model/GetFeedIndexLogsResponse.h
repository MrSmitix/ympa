...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_GetFeedIndexLogsResponse_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_GetFeedIndexLogsResponse_H_
...
public:
    ...
    void setResult(const std::shared_ptr<FeedIndexLogsResultDTO>& value);
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_GetFeedIndexLogsResponse_H_ */
