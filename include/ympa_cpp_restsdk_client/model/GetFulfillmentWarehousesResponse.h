...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_GetFulfillmentWarehousesResponse_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_GetFulfillmentWarehousesResponse_H_
...
public:
    ...
    /// 
    /// </summary>
    std::shared_ptr<FulfillmentWarehousesDTO> getResult() const;
    bool resultIsSet() const;
    void unsetResult();

    void setResult(const std::shared_ptr<FulfillmentWarehousesDTO>& value);


protected:
    std::shared_ptr<ApiResponseStatusType> m_Status;
    bool m_StatusIsSet;
    std::shared_ptr<FulfillmentWarehousesDTO> m_Result;
    bool m_ResultIsSet;
};
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_GetFulfillmentWarehousesResponse_H_ */
