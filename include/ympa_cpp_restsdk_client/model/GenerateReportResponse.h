...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_GenerateReportResponse_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_GenerateReportResponse_H_
...
public:
    ...
    void setResult(const std::shared_ptr<GenerateReportDTO>& value);
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_GenerateReportResponse_H_ */
