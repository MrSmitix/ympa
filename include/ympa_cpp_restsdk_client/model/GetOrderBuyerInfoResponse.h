...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_GetOrderBuyerInfoResponse_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_GetOrderBuyerInfoResponse_H_
...
public:
    ...
    void setResult(const std::shared_ptr<OrderBuyerInfoDTO>& value);
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_GetOrderBuyerInfoResponse_H_ */
