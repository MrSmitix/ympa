...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_GetWarehousesResponse_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_GetWarehousesResponse_H_
...
public:
    ...
    void setResult(const std::shared_ptr<WarehousesDTO>& value);
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_GetWarehousesResponse_H_ */
