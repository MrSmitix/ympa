...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_GetOfferDTO_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_GetOfferDTO_H_
...
public:
    ...
    void setPurchasePrice(const std::shared_ptr<GetPriceDTO>& value);
    ...
    void setAdditionalExpenses(const std::shared_ptr<GetPriceDTO>& value);
    ...
    /// </summary>
    std::vector<std::shared_ptr<OfferCampaignStatusDTO>>& getCampaigns();
    bool campaignsIsSet() const;
    void unsetCampaigns();

    void setCampaigns(const std::vector<std::shared_ptr<OfferCampaignStatusDTO>>& value);

    /// <summary>
    /// Информация о том, какие для товара доступны модели размещения. 
    /// </summary>
    std::vector<std::shared_ptr<OfferSellingProgramDTO>>& getSellingPrograms();
    bool sellingProgramsIsSet() const;
    void unsetSellingPrograms();

    void setSellingPrograms(const std::vector<std::shared_ptr<OfferSellingProgramDTO>>& value);
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_GetOfferDTO_H_ */
