...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_CreateChatResponse_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_CreateChatResponse_H_
...
public:
    ...
    void setResult(const std::shared_ptr<CreateChatResultDTO>& value);
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_CreateChatResponse_H_ */
