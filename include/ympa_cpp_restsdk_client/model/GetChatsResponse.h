...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_GetChatsResponse_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_GetChatsResponse_H_
...
public:
    ...
    void setResult(const std::shared_ptr<GetChatsInfoDTO>& value);
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_GetChatsResponse_H_ */
