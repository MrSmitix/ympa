...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_FullOutletLicenseDTO_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_FullOutletLicenseDTO_H_
...
public:
    ...
    void setCheckStatus(const std::shared_ptr<LicenseCheckStatusType>& value);
    ...
    /// </summary>
    utility::string_t getCheckComment() const;
    bool checkCommentIsSet() const;
    void unsetCheckComment();

    void setCheckComment(const utility::string_t& value);
...
protected:
    ...
    std::shared_ptr<LicenseCheckStatusType> m_CheckStatus;
    bool m_CheckStatusIsSet;
    utility::string_t m_CheckComment;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_FullOutletLicenseDTO_H_ */
