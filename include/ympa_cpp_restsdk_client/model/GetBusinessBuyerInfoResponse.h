...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_GetBusinessBuyerInfoResponse_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_GetBusinessBuyerInfoResponse_H_
...
public:
    ...
    void setResult(const std::shared_ptr<OrderBusinessBuyerDTO>& value);
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_GetBusinessBuyerInfoResponse_H_ */
