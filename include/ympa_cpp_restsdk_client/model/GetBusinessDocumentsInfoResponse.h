...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_GetBusinessDocumentsInfoResponse_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_GetBusinessDocumentsInfoResponse_H_
...
public:
    ...
    void setResult(const std::shared_ptr<OrderBusinessDocumentsDTO>& value);
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_GetBusinessDocumentsInfoResponse_H_ */
