...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_CreateOutletResponse_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_CreateOutletResponse_H_
...
public:
    ...
    /// 
    /// </summary>
    std::shared_ptr<OutletResponseDTO> getResult() const;
    bool resultIsSet() const;
    void unsetResult();

    void setResult(const std::shared_ptr<OutletResponseDTO>& value);


protected:
    std::shared_ptr<ApiResponseStatusType> m_Status;
    bool m_StatusIsSet;
    std::shared_ptr<OutletResponseDTO> m_Result;
    bool m_ResultIsSet;
};
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_CreateOutletResponse_H_ */
