...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_ShipmentInfoDTO_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_ShipmentInfoDTO_H_
...
public:
    ...
    /// </summary>
    utility::datetime getStatusUpdateTime() const;
    bool statusUpdateTimeIsSet() const;
    void unsetStatusUpdateTime();

    void setStatusUpdateTime(const utility::datetime& value);
...
protected:
    ...
    utility::datetime m_StatusUpdateTime;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_ShipmentInfoDTO_H_ */
