...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_GetOrdersStatsResponse_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_GetOrdersStatsResponse_H_
...
public:
    ...
    /// 
    /// </summary>
    std::shared_ptr<OrdersStatsDTO> getResult() const;
    bool resultIsSet() const;
    void unsetResult();

    void setResult(const std::shared_ptr<OrdersStatsDTO>& value);


protected:
    std::shared_ptr<ApiResponseStatusType> m_Status;
    bool m_StatusIsSet;
    std::shared_ptr<OrdersStatsDTO> m_Result;
    bool m_ResultIsSet;
};
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_GetOrdersStatsResponse_H_ */
