...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_FullOutletDTO_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_FullOutletDTO_H_
...
public:
    ...
    void setStatus(const std::shared_ptr<OutletStatusType>& value);
    ...
    /// </summary>
    utility::string_t getShopOutletId() const;
    bool shopOutletIdIsSet() const;
    void unsetShopOutletId();

    void setShopOutletId(const utility::string_t& value);

    /// <summary>
    /// Рабочее время.
    /// </summary>
    utility::string_t getWorkingTime() const;
    bool workingTimeIsSet() const;
    void unsetWorkingTime();

    void setWorkingTime(const utility::string_t& value);

    /// <summary>
    /// Статус модерации.
    /// </summary>
    utility::string_t getModerationReason() const;
    bool moderationReasonIsSet() const;
    void unsetModerationReason();

    void setModerationReason(const utility::string_t& value);
...
protected:
    ...
    int64_t m_Id;
    bool m_IdIsSet;
    std::shared_ptr<OutletStatusType> m_Status;
    bool m_StatusIsSet;
    std::shared_ptr<RegionDTO> m_Region;
    bool m_RegionIsSet;
    utility::string_t m_ShopOutletId;
    bool m_ShopOutletIdIsSet;
    utility::string_t m_WorkingTime;
    bool m_WorkingTimeIsSet;
    utility::string_t m_ModerationReason;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_FullOutletDTO_H_ */
