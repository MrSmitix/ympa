...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_GetReportInfoResponse_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_GetReportInfoResponse_H_
...
public:
    ...
    void setResult(const std::shared_ptr<ReportInfoDTO>& value);
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_GetReportInfoResponse_H_ */
