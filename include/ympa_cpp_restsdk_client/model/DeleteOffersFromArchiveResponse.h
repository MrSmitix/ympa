...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_DeleteOffersFromArchiveResponse_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_DeleteOffersFromArchiveResponse_H_
...
public:
    ...
    void setResult(const std::shared_ptr<DeleteOffersFromArchiveDTO>& value);
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_DeleteOffersFromArchiveResponse_H_ */
