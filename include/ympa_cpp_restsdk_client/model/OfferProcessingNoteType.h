...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_OfferProcessingNoteType_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_OfferProcessingNoteType_H_
...
public:
    ...
    {
        OfferProcessingNoteType_ASSORTMENT,
        OfferProcessingNoteType_CANCELLED,
        OfferProcessingNoteType_CONFLICTING_INFORMATION,
        OfferProcessingNoteType_OTHER,
        OfferProcessingNoteType_DEPARTMENT_FROZEN,
        OfferProcessingNoteType_INCORRECT_INFORMATION,
        OfferProcessingNoteType_LEGAL_CONFLICT,
        OfferProcessingNoteType_NEED_CLASSIFICATION_INFORMATION,
        OfferProcessingNoteType_NEED_INFORMATION,
        OfferProcessingNoteType_NEED_PICTURES,
        OfferProcessingNoteType_NEED_VENDOR,
        OfferProcessingNoteType_NO_CATEGORY,
        OfferProcessingNoteType_NO_KNOWLEDGE,
        OfferProcessingNoteType_NO_PARAMETERS_IN_SHOP_TITLE,
        OfferProcessingNoteType_NO_SIZE_MEASURE,
        OfferProcessingNoteType_SAMPLE_LINE,
    };

    eOfferProcessingNoteType getValue() const;
    void setValue(eOfferProcessingNoteType const value);

    protected:
        eOfferProcessingNoteType m_value;
};
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_OfferProcessingNoteType_H_ */
