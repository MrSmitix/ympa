...
#ifndef ORG_OPENAPITOOLS_CLIENT_API_ExpressApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_ExpressApi_H_
...
public:
    ...
    explicit ExpressApi( std::shared_ptr<const ApiClient> apiClient );
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_ExpressApi_H_ */
