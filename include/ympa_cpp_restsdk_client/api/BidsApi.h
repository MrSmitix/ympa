...
#ifndef ORG_OPENAPITOOLS_CLIENT_API_BidsApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_BidsApi_H_
...
public:
    ...
    explicit BidsApi( std::shared_ptr<const ApiClient> apiClient );
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_BidsApi_H_ */
