...
#ifndef ORG_OPENAPITOOLS_CLIENT_API_FbsApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_FbsApi_H_
...
public:
    ...
    explicit FbsApi( std::shared_ptr<const ApiClient> apiClient );
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_FbsApi_H_ */
