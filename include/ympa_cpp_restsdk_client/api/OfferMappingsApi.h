...
#ifndef ORG_OPENAPITOOLS_CLIENT_API_OfferMappingsApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_OfferMappingsApi_H_
...
public:
    ...
    explicit OfferMappingsApi( std::shared_ptr<const ApiClient> apiClient );
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_OfferMappingsApi_H_ */
