...
#ifndef ORG_OPENAPITOOLS_CLIENT_API_PriceQuarantineApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_PriceQuarantineApi_H_
...
public:
    ...
    explicit PriceQuarantineApi( std::shared_ptr<const ApiClient> apiClient );
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_PriceQuarantineApi_H_ */
