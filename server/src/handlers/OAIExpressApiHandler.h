...
#ifndef OAI_OAIExpressApiHandler_H
#define OAI_OAIExpressApiHandler_H
...
class OAIExpressApiHandler : public QObject
{
    Q_OBJECT

public:
    OAIExpressApiHandler();
    virtual ~OAIExpressApiHandler();
...
#endif // OAI_OAIExpressApiHandler_H
