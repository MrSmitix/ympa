...
void OAIPalletsCountDTO::fromJsonObject(QJsonObject json) {
    ...
    m_planned_isValid = ::OpenAPI::fromJsonValue(planned, json[QString("planned")]);
    m_planned_isSet = !json[QString("planned")].isNull() && m_planned_isValid;

    m_fact_isValid = ::OpenAPI::fromJsonValue(fact, json[QString("fact")]);
...
QJsonObject OAIPalletsCountDTO::asJsonObject() const {
    QJsonObject obj;
    if (m_planned_isSet) {
        obj.insert(QString("planned"), ::OpenAPI::toJsonValue(planned));
    }
    if (m_fact_isSet) {
        obj.insert(QString("fact"), ::OpenAPI::toJsonValue(fact));
    }
    return obj;
}
