...
public:
    ...
    void setBuyerItemsTotal(const double &buyer_items_total);
    bool is_buyer_items_total_Set() const;
    bool is_buyer_items_total_Valid() const;

    double getBuyerTotal() const;
    void setBuyerTotal(const double &buyer_total);
    bool is_buyer_total_Set() const;
    bool is_buyer_total_Valid() const;
    ...
    void setBuyerTotalBeforeDiscount(const double &buyer_total_before_discount);
    bool is_buyer_total_before_discount_Set() const;
    bool is_buyer_total_before_discount_Valid() const;
...
private:
    ...
    OAIOrderPaymentType payment_type;
    bool m_payment_type_isSet;
    bool m_payment_type_isValid;

    OAIOrderPaymentMethodType payment_method;
    ...
    QList<OAIOrderItemDTO> items;
    bool m_items_isSet;
    bool m_items_isValid;

    QList<OAIOrderSubsidyDTO> subsidies;
    bool m_subsidies_isSet;
    bool m_subsidies_isValid;

    OAIOrderDeliveryDTO delivery;
    bool m_delivery_isSet;
    bool m_delivery_isValid;

    OAIOrderBuyerDTO buyer;
    bool m_buyer_isSet;
    ...
    OAIOrderTaxSystemType tax_system;
