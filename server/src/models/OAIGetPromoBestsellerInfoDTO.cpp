...
void OAIGetPromoBestsellerInfoDTO::fromJsonObject(QJsonObject json) {
    ...
    m_bestseller_isValid = ::OpenAPI::fromJsonValue(bestseller, json[QString("bestseller")]);
    m_bestseller_isSet = !json[QString("bestseller")].isNull() && m_bestseller_isValid;

    m_entry_deadline_isValid = ::OpenAPI::fromJsonValue(entry_deadline, json[QString("entryDeadline")]);
...
QJsonObject OAIGetPromoBestsellerInfoDTO::asJsonObject() const {
    ...
    if (m_bestseller_isSet) {
        obj.insert(QString("bestseller"), ::OpenAPI::toJsonValue(bestseller));
    }
    if (m_entry_deadline_isSet) {
        obj.insert(QString("entryDeadline"), ::OpenAPI::toJsonValue(entry_deadline));
    }
    return obj;
}
...
void OAIGetPromoBestsellerInfoDTO::setEntryDeadline(const QDateTime &entry_deadline) {
    this->entry_deadline = entry_deadline;
    this->m_entry_deadline_isSet = true;
}
