...
/*
 * OAIBaseShipmentDTO.h
 *
 * Информация об отгрузке.
 */

#ifndef OAIBaseShipmentDTO_H
#define OAIBaseShipmentDTO_H
...
class OAIBaseShipmentDTO : public OAIObject {
public:
    OAIBaseShipmentDTO();
    OAIBaseShipmentDTO(QString json);
    ~OAIBaseShipmentDTO() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBaseShipmentDTO)

#endif // OAIBaseShipmentDTO_H
