...
void OAIOrderLabelDTO::fromJsonObject(QJsonObject json) {
    ...
    m_places_number_isValid = ::OpenAPI::fromJsonValue(places_number, json[QString("placesNumber")]);
    ...
    m_parcel_box_labels_isValid = ::OpenAPI::fromJsonValue(parcel_box_labels, json[QString("parcelBoxLabels")]);
...
QJsonObject OAIOrderLabelDTO::asJsonObject() const {
    ...
    if (m_places_number_isSet) {
        obj.insert(QString("placesNumber"), ::OpenAPI::toJsonValue(places_number));
    }
    if (m_url_isSet) {
        obj.insert(QString("url"), ::OpenAPI::toJsonValue(url));
    }
    if (parcel_box_labels.size() > 0) {
        obj.insert(QString("parcelBoxLabels"), ::OpenAPI::toJsonValue(parcel_box_labels));
    }
    return obj;
}
...
void OAIOrderLabelDTO::setPlacesNumber(const qint32 &places_number) {
    ...
    this->m_places_number_isSet = true;
}
...
QList<OAIParcelBoxLabelDTO> OAIOrderLabelDTO::getParcelBoxLabels() const {
    return parcel_box_labels;
}
void OAIOrderLabelDTO::setParcelBoxLabels(const QList<OAIParcelBoxLabelDTO> &parcel_box_labels) {
    this->parcel_box_labels = parcel_box_labels;
    this->m_parcel_box_labels_isSet = true;
}
