...
void OAIModelOfferDTO::fromJsonObject(QJsonObject json) {
    ...
    m_pos_isValid = ::OpenAPI::fromJsonValue(pos, json[QString("pos")]);
    ...
    m_shipping_cost_isValid = ::OpenAPI::fromJsonValue(shipping_cost, json[QString("shippingCost")]);
    ...
    m_shop_rating_isValid = ::OpenAPI::fromJsonValue(shop_rating, json[QString("shopRating")]);
    m_shop_rating_isSet = !json[QString("shopRating")].isNull() && m_shop_rating_isValid;

    m_in_stock_isValid = ::OpenAPI::fromJsonValue(in_stock, json[QString("inStock")]);
...
QJsonObject OAIModelOfferDTO::asJsonObject() const {
    ...
    if (m_pos_isSet) {
        obj.insert(QString("pos"), ::OpenAPI::toJsonValue(pos));
    }
    ...
    if (m_shipping_cost_isSet) {
        obj.insert(QString("shippingCost"), ::OpenAPI::toJsonValue(shipping_cost));
    }
    if (m_shop_name_isSet) {
        obj.insert(QString("shopName"), ::OpenAPI::toJsonValue(shop_name));
    }
    if (m_shop_rating_isSet) {
        obj.insert(QString("shopRating"), ::OpenAPI::toJsonValue(shop_rating));
    }
    if (m_in_stock_isSet) {
        obj.insert(QString("inStock"), ::OpenAPI::toJsonValue(in_stock));
    }
    return obj;
}
...
void OAIModelOfferDTO::setShippingCost(const double &shipping_cost) {
    ...
    this->m_shipping_cost_isSet = true;
}
