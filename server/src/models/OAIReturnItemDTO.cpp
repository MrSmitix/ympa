...
void OAIReturnItemDTO::fromJsonObject(QJsonObject json) {
    ...
    m_decisions_isValid = ::OpenAPI::fromJsonValue(decisions, json[QString("decisions")]);
...
QJsonObject OAIReturnItemDTO::asJsonObject() const {
    ...
    if (decisions.size() > 0) {
        obj.insert(QString("decisions"), ::OpenAPI::toJsonValue(decisions));
    }
    if (instances.size() > 0) {
