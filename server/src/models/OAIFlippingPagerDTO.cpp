...
void OAIFlippingPagerDTO::fromJsonObject(QJsonObject json) {
    ...
    m_current_page_isValid = ::OpenAPI::fromJsonValue(current_page, json[QString("currentPage")]);
    m_current_page_isSet = !json[QString("currentPage")].isNull() && m_current_page_isValid;

    m_pages_count_isValid = ::OpenAPI::fromJsonValue(pages_count, json[QString("pagesCount")]);
...
QJsonObject OAIFlippingPagerDTO::asJsonObject() const {
    ...
    if (m_current_page_isSet) {
        obj.insert(QString("currentPage"), ::OpenAPI::toJsonValue(current_page));
    }
    if (m_pages_count_isSet) {
        obj.insert(QString("pagesCount"), ::OpenAPI::toJsonValue(pages_count));
    }
...
void OAIFlippingPagerDTO::setCurrentPage(const qint32 &current_page) {
    ...
    this->m_current_page_isSet = true;
}
