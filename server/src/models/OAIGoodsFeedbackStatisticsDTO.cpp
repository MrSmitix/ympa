...
void OAIGoodsFeedbackStatisticsDTO::fromJsonObject(QJsonObject json) {
    ...
    m_comments_count_isValid = ::OpenAPI::fromJsonValue(comments_count, json[QString("commentsCount")]);
    m_comments_count_isSet = !json[QString("commentsCount")].isNull() && m_comments_count_isValid;

    m_recommended_isValid = ::OpenAPI::fromJsonValue(recommended, json[QString("recommended")]);
    m_recommended_isSet = !json[QString("recommended")].isNull() && m_recommended_isValid;

    m_paid_amount_isValid = ::OpenAPI::fromJsonValue(paid_amount, json[QString("paidAmount")]);
...
QJsonObject OAIGoodsFeedbackStatisticsDTO::asJsonObject() const {
    ...
    if (m_comments_count_isSet) {
        obj.insert(QString("commentsCount"), ::OpenAPI::toJsonValue(comments_count));
    }
    if (m_recommended_isSet) {
        obj.insert(QString("recommended"), ::OpenAPI::toJsonValue(recommended));
    }
    if (m_paid_amount_isSet) {
        obj.insert(QString("paidAmount"), ::OpenAPI::toJsonValue(paid_amount));
    }
    return obj;
}
...
void OAIGoodsFeedbackStatisticsDTO::setCommentsCount(const qint64 &comments_count) {
    ...
    this->m_comments_count_isSet = true;
}
