...
private:
    ...
    OAIGoodsFeedbackIdentifiersDTO identifiers;
    ...
    OAIGoodsFeedbackDescriptionDTO description;
    bool m_description_isSet;
    bool m_description_isValid;

    OAIGoodsFeedbackMediaDTO media;
    bool m_media_isSet;
    bool m_media_isValid;

    OAIGoodsFeedbackStatisticsDTO statistics;
