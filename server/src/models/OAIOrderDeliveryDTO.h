...
private:
    ...
    OAIOrderDeliveryAddressDTO address;
    ...
    QString outlet_storage_limit_date;
    ...
    QList<OAIOrderShipmentDTO> shipments;
    ...
    OAIOrderDeliveryEacType eac_type;
