...
public:
    ...
    QList<OAIOfferParamDTO> getParams() const;
    void setParams(const QList<OAIOfferParamDTO> &params);
...
private:
    ...
    QList<OAIOfferManualDTO> manuals;
    ...
    OAIOfferConditionDTO condition;
