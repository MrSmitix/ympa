...
void OAIOutletAddressDTO::fromJsonObject(QJsonObject json) {
    ...
    m_estate_isValid = ::OpenAPI::fromJsonValue(estate, json[QString("estate")]);
    ...
    m_additional_isValid = ::OpenAPI::fromJsonValue(additional, json[QString("additional")]);
    m_additional_isSet = !json[QString("additional")].isNull() && m_additional_isValid;

    m_km_isValid = ::OpenAPI::fromJsonValue(km, json[QString("km")]);
...
QJsonObject OAIOutletAddressDTO::asJsonObject() const {
    ...
    if (m_estate_isSet) {
        obj.insert(QString("estate"), ::OpenAPI::toJsonValue(estate));
    }
    if (m_block_isSet) {
        obj.insert(QString("block"), ::OpenAPI::toJsonValue(block));
    }
    if (m_additional_isSet) {
        obj.insert(QString("additional"), ::OpenAPI::toJsonValue(additional));
    }
    if (m_km_isSet) {
        obj.insert(QString("km"), ::OpenAPI::toJsonValue(km));
    }
    if (m_city_isSet) {
