...
/*
 * OAIGenerateGoodsMovementReportRequest.h
 *
 * Данные, необходимые для генерации отчета.
 */

#ifndef OAIGenerateGoodsMovementReportRequest_H
#define OAIGenerateGoodsMovementReportRequest_H
...
class OAIGenerateGoodsMovementReportRequest : public OAIObject {
public:
    OAIGenerateGoodsMovementReportRequest();
    OAIGenerateGoodsMovementReportRequest(QString json);
    ~OAIGenerateGoodsMovementReportRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGenerateGoodsMovementReportRequest)

#endif // OAIGenerateGoodsMovementReportRequest_H
