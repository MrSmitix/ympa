...
void OAIOrdersStatsItemDTO::fromJsonObject(QJsonObject json) {
    ...
    m_cis_list_isValid = ::OpenAPI::fromJsonValue(cis_list, json[QString("cisList")]);
    m_cis_list_isSet = !json[QString("cisList")].isNull() && m_cis_list_isValid;

    m_initial_count_isValid = ::OpenAPI::fromJsonValue(initial_count, json[QString("initialCount")]);
    m_initial_count_isSet = !json[QString("initialCount")].isNull() && m_initial_count_isValid;

    m_bid_fee_isValid = ::OpenAPI::fromJsonValue(bid_fee, json[QString("bidFee")]);
    m_bid_fee_isSet = !json[QString("bidFee")].isNull() && m_bid_fee_isValid;

    m_cofinance_threshold_isValid = ::OpenAPI::fromJsonValue(cofinance_threshold, json[QString("cofinanceThreshold")]);
    m_cofinance_threshold_isSet = !json[QString("cofinanceThreshold")].isNull() && m_cofinance_threshold_isValid;

    m_cofinance_value_isValid = ::OpenAPI::fromJsonValue(cofinance_value, json[QString("cofinanceValue")]);
...
QJsonObject OAIOrdersStatsItemDTO::asJsonObject() const {
    ...
    if (cis_list.size() > 0) {
        obj.insert(QString("cisList"), ::OpenAPI::toJsonValue(cis_list));
    }
    if (m_initial_count_isSet) {
        obj.insert(QString("initialCount"), ::OpenAPI::toJsonValue(initial_count));
    }
    if (m_bid_fee_isSet) {
        obj.insert(QString("bidFee"), ::OpenAPI::toJsonValue(bid_fee));
    }
    if (m_cofinance_threshold_isSet) {
        obj.insert(QString("cofinanceThreshold"), ::OpenAPI::toJsonValue(cofinance_threshold));
    }
    if (m_cofinance_value_isSet) {
        obj.insert(QString("cofinanceValue"), ::OpenAPI::toJsonValue(cofinance_value));
    }
    return obj;
}
...
void OAIOrdersStatsItemDTO::setInitialCount(const qint32 &initial_count) {
    ...
    this->m_initial_count_isSet = true;
}
...
double OAIOrdersStatsItemDTO::getCofinanceThreshold() const {
    return cofinance_threshold;
}
void OAIOrdersStatsItemDTO::setCofinanceThreshold(const double &cofinance_threshold) {
    this->cofinance_threshold = cofinance_threshold;
    this->m_cofinance_threshold_isSet = true;
}
...
double OAIOrdersStatsItemDTO::getCofinanceValue() const {
    return cofinance_value;
}
void OAIOrdersStatsItemDTO::setCofinanceValue(const double &cofinance_value) {
    this->cofinance_value = cofinance_value;
    this->m_cofinance_value_isSet = true;
}
