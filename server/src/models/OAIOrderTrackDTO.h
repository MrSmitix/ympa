...
#ifndef OAIOrderTrackDTO_H
#define OAIOrderTrackDTO_H
...
class OAIOrderTrackDTO : public OAIObject {
public:
    OAIOrderTrackDTO();
    OAIOrderTrackDTO(QString json);
    ~OAIOrderTrackDTO() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOrderTrackDTO)

#endif // OAIOrderTrackDTO_H
