...
private:
    ...
    QList<OAIOrdersStatsPriceDTO> prices;
    bool m_prices_isSet;
    bool m_prices_isValid;

    OAIOrdersStatsWarehouseDTO warehouse;
    bool m_warehouse_isSet;
    bool m_warehouse_isValid;

    QList<OAIOrdersStatsDetailsDTO> details;
    bool m_details_isSet;
    bool m_details_isValid;

    QList<QString> cis_list;
    bool m_cis_list_isSet;
    bool m_cis_list_isValid;

    qint32 initial_count;
