...
/*
 * OAIMappingsOfferInfoDTO.h
 *
 * Базовая информация о товарах в каталоге.
 */

#ifndef OAIMappingsOfferInfoDTO_H
#define OAIMappingsOfferInfoDTO_H
...
class OAIMappingsOfferInfoDTO : public OAIObject {
public:
    OAIMappingsOfferInfoDTO();
    OAIMappingsOfferInfoDTO(QString json);
    ~OAIMappingsOfferInfoDTO() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMappingsOfferInfoDTO)

#endif // OAIMappingsOfferInfoDTO_H
