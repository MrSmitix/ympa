...
void OAIOrderDeliveryAddressDTO::fromJsonObject(QJsonObject json) {
    ...
    m_district_isValid = ::OpenAPI::fromJsonValue(district, json[QString("district")]);
    m_district_isSet = !json[QString("district")].isNull() && m_district_isValid;

    m_subway_isValid = ::OpenAPI::fromJsonValue(subway, json[QString("subway")]);
    ...
    m_house_isValid = ::OpenAPI::fromJsonValue(house, json[QString("house")]);
    ...
    m_entrance_isValid = ::OpenAPI::fromJsonValue(entrance, json[QString("entrance")]);
    m_entrance_isSet = !json[QString("entrance")].isNull() && m_entrance_isValid;

    m_entryphone_isValid = ::OpenAPI::fromJsonValue(entryphone, json[QString("entryphone")]);
    m_entryphone_isSet = !json[QString("entryphone")].isNull() && m_entryphone_isValid;

    m_floor_isValid = ::OpenAPI::fromJsonValue(floor, json[QString("floor")]);
    m_floor_isSet = !json[QString("floor")].isNull() && m_floor_isValid;

    m_apartment_isValid = ::OpenAPI::fromJsonValue(apartment, json[QString("apartment")]);
...
QJsonObject OAIOrderDeliveryAddressDTO::asJsonObject() const {
    ...
    if (m_district_isSet) {
        obj.insert(QString("district"), ::OpenAPI::toJsonValue(district));
    }
    if (m_subway_isSet) {
        obj.insert(QString("subway"), ::OpenAPI::toJsonValue(subway));
    }
    if (m_street_isSet) {
        obj.insert(QString("street"), ::OpenAPI::toJsonValue(street));
    }
    if (m_house_isSet) {
        obj.insert(QString("house"), ::OpenAPI::toJsonValue(house));
    }
    if (m_block_isSet) {
        obj.insert(QString("block"), ::OpenAPI::toJsonValue(block));
    }
    if (m_entrance_isSet) {
        obj.insert(QString("entrance"), ::OpenAPI::toJsonValue(entrance));
    }
    if (m_entryphone_isSet) {
        obj.insert(QString("entryphone"), ::OpenAPI::toJsonValue(entryphone));
    }
    if (m_floor_isSet) {
        obj.insert(QString("floor"), ::OpenAPI::toJsonValue(floor));
    }
    if (m_apartment_isSet) {
        obj.insert(QString("apartment"), ::OpenAPI::toJsonValue(apartment));
    }
    if (m_phone_isSet) {
