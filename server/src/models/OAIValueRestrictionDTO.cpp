...
void OAIValueRestrictionDTO::fromJsonObject(QJsonObject json) {
    ...
    m_limiting_parameter_id_isValid = ::OpenAPI::fromJsonValue(limiting_parameter_id, json[QString("limitingParameterId")]);
    m_limiting_parameter_id_isSet = !json[QString("limitingParameterId")].isNull() && m_limiting_parameter_id_isValid;

    m_limited_values_isValid = ::OpenAPI::fromJsonValue(limited_values, json[QString("limitedValues")]);
...
QJsonObject OAIValueRestrictionDTO::asJsonObject() const {
    ...
    if (m_limiting_parameter_id_isSet) {
        obj.insert(QString("limitingParameterId"), ::OpenAPI::toJsonValue(limiting_parameter_id));
    }
    if (limited_values.size() > 0) {
        obj.insert(QString("limitedValues"), ::OpenAPI::toJsonValue(limited_values));
    }
    return obj;
}

qint64 OAIValueRestrictionDTO::getLimitingParameterId() const {
    return limiting_parameter_id;
}
void OAIValueRestrictionDTO::setLimitingParameterId(const qint64 &limiting_parameter_id) {
    this->limiting_parameter_id = limiting_parameter_id;
    this->m_limiting_parameter_id_isSet = true;
}
...
void OAIValueRestrictionDTO::setLimitedValues(const QList<OAIOptionValuesLimitedDTO> &limited_values) {
    this->limited_values = limited_values;
    this->m_limited_values_isSet = true;
}
