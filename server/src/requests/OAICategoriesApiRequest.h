...
#ifndef OAI_OAICategoriesApiRequest_H
#define OAI_OAICategoriesApiRequest_H
...
class OAICategoriesApiRequest : public QObject
{
    Q_OBJECT

public:
    OAICategoriesApiRequest(QHttpEngine::Socket *s, QSharedPointer<OAICategoriesApiHandler> handler);
    virtual ~OAICategoriesApiRequest();
...
private:
    ...
    QSharedPointer<OAICategoriesApiHandler> handler;
...
#endif // OAI_OAICategoriesApiRequest_H
