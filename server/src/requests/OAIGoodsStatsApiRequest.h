...
#ifndef OAI_OAIGoodsStatsApiRequest_H
#define OAI_OAIGoodsStatsApiRequest_H
...
class OAIGoodsStatsApiRequest : public QObject
{
    Q_OBJECT

public:
    OAIGoodsStatsApiRequest(QHttpEngine::Socket *s, QSharedPointer<OAIGoodsStatsApiHandler> handler);
    virtual ~OAIGoodsStatsApiRequest();
...
private:
    ...
    QSharedPointer<OAIGoodsStatsApiHandler> handler;
...
#endif // OAI_OAIGoodsStatsApiRequest_H
