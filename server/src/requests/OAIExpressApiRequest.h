...
#ifndef OAI_OAIExpressApiRequest_H
#define OAI_OAIExpressApiRequest_H
...
class OAIExpressApiRequest : public QObject
{
    Q_OBJECT

public:
    OAIExpressApiRequest(QHttpEngine::Socket *s, QSharedPointer<OAIExpressApiHandler> handler);
    virtual ~OAIExpressApiRequest();
...
private:
    ...
    QSharedPointer<OAIExpressApiHandler> handler;
...
#endif // OAI_OAIExpressApiRequest_H
