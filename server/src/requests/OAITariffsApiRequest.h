...
#ifndef OAI_OAITariffsApiRequest_H
#define OAI_OAITariffsApiRequest_H
...
class OAITariffsApiRequest : public QObject
{
    Q_OBJECT

public:
    OAITariffsApiRequest(QHttpEngine::Socket *s, QSharedPointer<OAITariffsApiHandler> handler);
    virtual ~OAITariffsApiRequest();
...
private:
    ...
    QSharedPointer<OAITariffsApiHandler> handler;
...
#endif // OAI_OAITariffsApiRequest_H
