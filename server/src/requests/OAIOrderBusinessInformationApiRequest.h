...
#ifndef OAI_OAIOrderBusinessInformationApiRequest_H
#define OAI_OAIOrderBusinessInformationApiRequest_H
...
class OAIOrderBusinessInformationApiRequest : public QObject
{
    Q_OBJECT

public:
    OAIOrderBusinessInformationApiRequest(QHttpEngine::Socket *s, QSharedPointer<OAIOrderBusinessInformationApiHandler> handler);
    virtual ~OAIOrderBusinessInformationApiRequest();
...
private:
    ...
    QSharedPointer<OAIOrderBusinessInformationApiHandler> handler;
...
#endif // OAI_OAIOrderBusinessInformationApiRequest_H
