...
#ifndef OAI_OAIFbsApiRequest_H
#define OAI_OAIFbsApiRequest_H
...
class OAIFbsApiRequest : public QObject
{
    Q_OBJECT

public:
    OAIFbsApiRequest(QHttpEngine::Socket *s, QSharedPointer<OAIFbsApiHandler> handler);
    virtual ~OAIFbsApiRequest();
...
private:
    ...
    QSharedPointer<OAIFbsApiHandler> handler;
