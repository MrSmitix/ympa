...
#ifndef OAI_OAIStocksApiRequest_H
#define OAI_OAIStocksApiRequest_H
...
class OAIStocksApiRequest : public QObject
{
    Q_OBJECT

public:
    OAIStocksApiRequest(QHttpEngine::Socket *s, QSharedPointer<OAIStocksApiHandler> handler);
    virtual ~OAIStocksApiRequest();
...
private:
    ...
    QSharedPointer<OAIStocksApiHandler> handler;
...
#endif // OAI_OAIStocksApiRequest_H
