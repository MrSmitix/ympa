# Julia API server for ympa_julia_server
...
## Installation
Place the Julia files generated under the `src` folder in your Julia project. Include ympa_julia_server.jl in the project code.
It would include the module named ympa_julia_server.

Implement the server methods as listed below. They are also documented with the ympa_julia_server module.
Launch a HTTP server with a router that has all handlers registered. A `register` method is provided in ympa_julia_server module for convenience.
