...
from ympa_python_fastapi_server.models.get_fulfillment_warehouses_response import GetFulfillmentWarehousesResponse  # noqa: F401
...
def test_get_fulfillment_warehouses(client: TestClient):
