...
class OutletLicensesRoutes(service : OutletLicensesService) extends cask.Routes {


        /** Удаление лицензий для точек продаж
         * 
         */
        @cask.delete("/campaigns/:campaignId/outlets/licenses")
         ...
         * 
         */
        @cask.get("/campaigns/:campaignId/outlets/licenses")
         ...
         * 
         */
        @cask.post("/campaigns/:campaignId/outlets/licenses")
