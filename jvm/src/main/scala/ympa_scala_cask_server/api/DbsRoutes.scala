...
import ympa_scala_cask_server.model.GetDeliveryServicesResponse
...
import ympa_scala_cask_server.model.GetOutletLicensesResponse
...
import ympa_scala_cask_server.model.GetWarehousesResponse
...
import ympa_scala_cask_server.model.UpdateOutletLicenseRequest
...
class DbsRoutes(service : DbsService) extends cask.Routes {
    ...
    def routeWorkAroundForPOSTCampaigns(request: cask.Request,pageToken : Option[String] = None,limit : Option[Int] = None,pageToken : Option[String] = None,limit : Option[Int] = None,pageToken : Option[String] = None,limit : Option[Int] = None,pageToken : Option[String] = None,limit : Option[Int] = None,pageToken : Option[String] = None,limit : Option[Int] = None) = {
        request.remainingPathSegments match {
            ...
            case Seq(campaignId,"outlets") => createOutlet(campaignId.toLong,request)
            ...
            case Seq(campaignId,"ratings","quality","details") => getQualityRatingDetails(campaignId.toLong,request)
            ...
            case Seq(campaignId,"outlets","licenses") => updateOutletLicenses(campaignId.toLong,request)
            ...
            case Seq(campaignId,"orders",orderId,"delivery","track") => setOrderDeliveryTrackCode(campaignId.toLong, orderId.toLong,request)
    ...
    def routeWorkAroundForPUTCampaigns(request: cask.Request) = {
        request.remainingPathSegments match {
            case Seq(campaignId,"bids") => putBidsForCampaign(campaignId.toLong,request)
            case Seq(campaignId,"offers","stocks") => updateStocks(campaignId.toLong,request)
            ...
            case Seq(campaignId,"outlets",outletId) => updateOutlet(campaignId.toLong, outletId.toLong,request)
    ...
    def routeWorkAroundForGETCampaigns(request: cask.Request,page : Option[Int] = None,pageSize : Option[Int] = None,feedId : Option[Long] = None,chunk : Option[Int] = None,pageToken : Option[String] = None,limit : Option[Int] = None,fromDate : Option[LocalDate] = None,offerId : Seq[String] = Nil,pageToken : Option[String] = None,limit : Option[Int] = None,offset : Option[Int] = None,page : Option[Int] = None,pageSize : Option[Int] = None,offerId : Seq[String] = Nil,shopSku : Seq[String] = Nil,mappingKind : Option[OfferMappingKindType] = None,status : Seq[OfferProcessingStatusType] = Nil,availability : Seq[OfferAvailabilityStatusType] = Nil,categoryId : Seq[Int] = Nil,vendor : Seq[String] = Nil,pageToken : Option[String] = None,limit : Option[Int] = None,query : Option[String] = None,feedId : Option[Long] = None,shopCategoryId : Option[String] = None,currency : Option[CurrencyType] = None,matched : Option[Boolean] = None,page : Option[Int] = None,pageSize : Option[Int] = None,orderIds : Seq[Long] = Nil,status : Set[OrderStatusType] = Set.empty,substatus : Set[OrderSubstatusType] = Set.empty,fromDate : Option[LocalDate] = None,toDate : Option[LocalDate] = None,supplierShipmentDateFrom : Option[LocalDate] = None,supplierShipmentDateTo : Option[LocalDate] = None,updatedAtFrom : Option[OffsetDateTime] = None,updatedAtTo : Option[OffsetDateTime] = None,dispatchType : Option[OrderDeliveryDispatchType] = None,fake : Option[Boolean] = None,hasCis : Option[Boolean] = None,onlyWaitingForCancellationApprove : Option[Boolean] = None,onlyEstimatedDelivery : Option[Boolean] = None,buyerType : Option[OrderBuyerType] = None,page : Option[Int] = None,pageSize : Option[Int] = None,pageToken : Option[String] = None,limit : Option[Int] = None,outletIds : Set[Long] = Set.empty,ids : Set[Long] = Set.empty,pageToken : Option[String] = None,regionId : Option[Long] = None,shopOutletCode : Option[String] = None,regionId2 : Option[Long] = None,pageToken : Option[String] = None,limit : Option[Int] = None,archived : Option[Boolean] = None,pageToken : Option[String] = None,limit : Option[Int] = None,orderIds : Seq[Long] = Nil,statuses : Seq[RefundStatusType] = Nil,`type` : Option[ReturnType] = None,fromDate : Option[LocalDate] = None,toDate : Option[LocalDate] = None,fromDate2 : Option[LocalDate] = None,toDate2 : Option[LocalDate] = None,page : Option[Int] = None,pageSize : Option[Int] = None,format : Option[PageFormatType] = None,limit : Option[Int] = None,publishedTimeFrom : Option[OffsetDateTime] = None,publishedTimeTo : Option[OffsetDateTime] = None,status : Option[FeedIndexLogsStatusType] = None,format : Option[PageFormatType] = None) = {
        request.remainingPathSegments match {
            ...
            case Seq(campaignId,"outlets","licenses") => getOutletLicenses(campaignId.toLong,request,outletIds, ids)
            ...
            case Seq(campaignId,"orders",orderId,"buyer") => getOrderBuyerInfo(campaignId.toLong, orderId.toLong,request)
    ...
    // route group for routeWorkAroundForDELETECampaigns
    @cask.delete("/campaigns", true)
    def routeWorkAroundForDELETECampaigns(request: cask.Request,ids : Set[Long] = Set.empty) = {
        request.remainingPathSegments match {
            case Seq(campaignId,"outlets","licenses") => deleteOutletLicenses(campaignId.toLong,request,ids)
            case Seq(campaignId,"outlets",outletId) => deleteOutlet(campaignId.toLong, outletId.toLong,request)
            case _          => cask.Response("Not Found", statusCode = 404)
        }
    }
    ...
    def routeWorkAroundForGETModels(request: cask.Request,query : Option[String] = None,regionId : Option[Long] = None,currency : Option[CurrencyType] = None,page : Option[Int] = None,pageSize : Option[Int] = None,regionId : Option[Long] = None,currency : Option[CurrencyType] = None,regionId : Option[Long] = None,currency : Option[CurrencyType] = None,orderByPrice : Option[SortOrderType] = None,count : Option[Int] = None,page : Option[Int] = None) = {
         ...
         * 
         */
        // conflicts with [/campaigns/{campaignId}/orders/{orderId}/cancellation/accept, /campaigns/{campaignId}/orders/{orderId}/identifiers, /campaigns/{campaignId}/bids, /campaigns/{campaignId}/orders/{orderId}/boxes, /campaigns/{campaignId}/orders/{orderId}/delivery/date, /campaigns/{campaignId}/orders/{orderId}/delivery/shipments/{shipmentId}/boxes, /campaigns/{campaignId}/orders/{orderId}/items, /campaigns/{campaignId}/orders/{orderId}/status, /campaigns/{campaignId}/orders/{orderId}/delivery/storage-limit, /campaigns/{campaignId}/outlets/{outletId}, /campaigns/{campaignId}/offers/stocks] after/campaigns, ignoring @cask.put("/campaigns/:campaignId/orders/:orderId/cancellation/accept")
         ...
         * 
         */
        // conflicts with [/campaigns/{campaignId}/hidden-offers, /campaigns/{campaignId}/price-quarantine/confirm, /campaigns/{campaignId}/outlets, /campaigns/{campaignId}/offers/delete, /campaigns/{campaignId}/hidden-offers/delete, /campaigns/{campaignId}/offers, /campaigns/{campaignId}/price-quarantine, /campaigns/{campaignId}/stats/skus, /campaigns/{campaignId}/orders/{orderId}/business-buyer, /campaigns/{campaignId}/orders/{orderId}/documents, /campaigns/{campaignId}/stats/orders, /campaigns/{campaignId}/offer-prices, /campaigns/{campaignId}/ratings/quality/details, /campaigns/{campaignId}/offers/stocks, /campaigns/{campaignId}/offer-mapping-entries/suggestions, /campaigns/{campaignId}/offer-prices/suggestions, /campaigns/{campaignId}/orders/{orderId}/deliverDigitalGoods, /campaigns/{campaignId}/feeds/{feedId}/refresh, /campaigns/{campaignId}/feeds/{feedId}/params, /campaigns/{campaignId}/orders/{orderId}/delivery/track, /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}/decision, /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}/decision/submit, /campaigns/{campaignId}/offers/update, /campaigns/{campaignId}/offer-mapping-entries/updates, /campaigns/{campaignId}/orders/status-update, /campaigns/{campaignId}/outlets/licenses, /campaigns/{campaignId}/offer-prices/updates] after/campaigns, ignoring @cask.post("/campaigns/:campaignId/hidden-offers")
         ...
         * 
         */
        // conflicts with [/campaigns/{campaignId}/hidden-offers, /campaigns/{campaignId}/price-quarantine/confirm, /campaigns/{campaignId}/outlets, /campaigns/{campaignId}/offers/delete, /campaigns/{campaignId}/hidden-offers/delete, /campaigns/{campaignId}/offers, /campaigns/{campaignId}/price-quarantine, /campaigns/{campaignId}/stats/skus, /campaigns/{campaignId}/orders/{orderId}/business-buyer, /campaigns/{campaignId}/orders/{orderId}/documents, /campaigns/{campaignId}/stats/orders, /campaigns/{campaignId}/offer-prices, /campaigns/{campaignId}/ratings/quality/details, /campaigns/{campaignId}/offers/stocks, /campaigns/{campaignId}/offer-mapping-entries/suggestions, /campaigns/{campaignId}/offer-prices/suggestions, /campaigns/{campaignId}/orders/{orderId}/deliverDigitalGoods, /campaigns/{campaignId}/feeds/{feedId}/refresh, /campaigns/{campaignId}/feeds/{feedId}/params, /campaigns/{campaignId}/orders/{orderId}/delivery/track, /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}/decision, /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}/decision/submit, /campaigns/{campaignId}/offers/update, /campaigns/{campaignId}/offer-mapping-entries/updates, /campaigns/{campaignId}/orders/status-update, /campaigns/{campaignId}/outlets/licenses, /campaigns/{campaignId}/offer-prices/updates] after/campaigns, ignoring @cask.post("/campaigns/:campaignId/price-quarantine/confirm")
         ...
         * 
         */
        // conflicts with [/campaigns/{campaignId}/hidden-offers, /campaigns/{campaignId}/price-quarantine/confirm, /campaigns/{campaignId}/outlets, /campaigns/{campaignId}/offers/delete, /campaigns/{campaignId}/hidden-offers/delete, /campaigns/{campaignId}/offers, /campaigns/{campaignId}/price-quarantine, /campaigns/{campaignId}/stats/skus, /campaigns/{campaignId}/orders/{orderId}/business-buyer, /campaigns/{campaignId}/orders/{orderId}/documents, /campaigns/{campaignId}/stats/orders, /campaigns/{campaignId}/offer-prices, /campaigns/{campaignId}/ratings/quality/details, /campaigns/{campaignId}/offers/stocks, /campaigns/{campaignId}/offer-mapping-entries/suggestions, /campaigns/{campaignId}/offer-prices/suggestions, /campaigns/{campaignId}/orders/{orderId}/deliverDigitalGoods, /campaigns/{campaignId}/feeds/{feedId}/refresh, /campaigns/{campaignId}/feeds/{feedId}/params, /campaigns/{campaignId}/orders/{orderId}/delivery/track, /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}/decision, /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}/decision/submit, /campaigns/{campaignId}/offers/update, /campaigns/{campaignId}/offer-mapping-entries/updates, /campaigns/{campaignId}/orders/status-update, /campaigns/{campaignId}/outlets/licenses, /campaigns/{campaignId}/offer-prices/updates] after/campaigns, ignoring @cask.post("/campaigns/:campaignId/outlets")
         ...
         * 
         */
        // conflicts with [/campaigns/{campaignId}/hidden-offers, /campaigns/{campaignId}/price-quarantine/confirm, /campaigns/{campaignId}/outlets, /campaigns/{campaignId}/offers/delete, /campaigns/{campaignId}/hidden-offers/delete, /campaigns/{campaignId}/offers, /campaigns/{campaignId}/price-quarantine, /campaigns/{campaignId}/stats/skus, /campaigns/{campaignId}/orders/{orderId}/business-buyer, /campaigns/{campaignId}/orders/{orderId}/documents, /campaigns/{campaignId}/stats/orders, /campaigns/{campaignId}/offer-prices, /campaigns/{campaignId}/ratings/quality/details, /campaigns/{campaignId}/offers/stocks, /campaigns/{campaignId}/offer-mapping-entries/suggestions, /campaigns/{campaignId}/offer-prices/suggestions, /campaigns/{campaignId}/orders/{orderId}/deliverDigitalGoods, /campaigns/{campaignId}/feeds/{feedId}/refresh, /campaigns/{campaignId}/feeds/{feedId}/params, /campaigns/{campaignId}/orders/{orderId}/delivery/track, /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}/decision, /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}/decision/submit, /campaigns/{campaignId}/offers/update, /campaigns/{campaignId}/offer-mapping-entries/updates, /campaigns/{campaignId}/orders/status-update, /campaigns/{campaignId}/outlets/licenses, /campaigns/{campaignId}/offer-prices/updates] after/campaigns, ignoring @cask.post("/campaigns/:campaignId/offers/delete")
         ...
         * 
         */
        // conflicts with [/campaigns/{campaignId}/hidden-offers, /campaigns/{campaignId}/price-quarantine/confirm, /campaigns/{campaignId}/outlets, /campaigns/{campaignId}/offers/delete, /campaigns/{campaignId}/hidden-offers/delete, /campaigns/{campaignId}/offers, /campaigns/{campaignId}/price-quarantine, /campaigns/{campaignId}/stats/skus, /campaigns/{campaignId}/orders/{orderId}/business-buyer, /campaigns/{campaignId}/orders/{orderId}/documents, /campaigns/{campaignId}/stats/orders, /campaigns/{campaignId}/offer-prices, /campaigns/{campaignId}/ratings/quality/details, /campaigns/{campaignId}/offers/stocks, /campaigns/{campaignId}/offer-mapping-entries/suggestions, /campaigns/{campaignId}/offer-prices/suggestions, /campaigns/{campaignId}/orders/{orderId}/deliverDigitalGoods, /campaigns/{campaignId}/feeds/{feedId}/refresh, /campaigns/{campaignId}/feeds/{feedId}/params, /campaigns/{campaignId}/orders/{orderId}/delivery/track, /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}/decision, /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}/decision/submit, /campaigns/{campaignId}/offers/update, /campaigns/{campaignId}/offer-mapping-entries/updates, /campaigns/{campaignId}/orders/status-update, /campaigns/{campaignId}/outlets/licenses, /campaigns/{campaignId}/offer-prices/updates] after/campaigns, ignoring @cask.post("/campaigns/:campaignId/hidden-offers/delete")
         ...
         * 
         */
        // conflicts with [/campaigns/{campaignId}/outlets/{outletId}, /campaigns/{campaignId}/outlets/licenses] after/campaigns, ignoring @cask.delete("/campaigns/:campaignId/outlets/:outletId")
         ...
         * 
         */
        // conflicts with [/campaigns/{campaignId}/outlets/{outletId}, /campaigns/{campaignId}/outlets/licenses] after/campaigns, ignoring @cask.delete("/campaigns/:campaignId/outlets/licenses")
        def deleteOutletLicenses(campaignId : Long, request: cask.Request, ids : Set[Long]) = {
            // auth method OAuth : oauth2, keyParamName: 
        ...
        val result =         for {
            campaignId <- Parsed(campaignId)
            result <- Parsed.eval(service.deleteOutletLicenses(campaignId, ids))
        } yield result
         ...
         * 
         */
        // conflicts with [/campaigns/{campaignId}/orders/{orderId}/delivery/shipments/{shipmentId}/boxes/{boxId}/label, /campaigns/{campaignId}/orders/{orderId}/delivery/labels, /campaigns/{campaignId}/offers/all, /campaigns/{campaignId}, /campaigns/{campaignId}/logins, /campaigns/{campaignId}/region, /campaigns/{campaignId}/settings, /campaigns/{campaignId}/feeds/{feedId}, /campaigns/{campaignId}/feeds/{feedId}/index-logs, /campaigns/{campaignId}/feedback/updates, /campaigns/{campaignId}/feeds, /campaigns/{campaignId}/hidden-offers, /campaigns/{campaignId}/offer-mapping-entries, /campaigns/{campaignId}/offers, /campaigns/{campaignId}/orders/{orderId}, /campaigns/{campaignId}/orders/{orderId}/buyer, /campaigns/{campaignId}/orders/{orderId}/delivery/labels/data, /campaigns/{campaignId}/orders, /campaigns/{campaignId}/outlets/{outletId}, /campaigns/{campaignId}/outlets/licenses, /campaigns/{campaignId}/outlets, /campaigns/{campaignId}/offer-prices, /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}, /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}/application, /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}/decision/{itemId}/image/{imageHash}, /campaigns/{campaignId}/returns, /campaigns, /campaigns/by_login/{login}] after/campaigns, ignoring @cask.get("/campaigns/:campaignId/orders/:orderId/delivery/shipments/:shipmentId/boxes/:boxId/label")
         ...
         * 
         */
        // conflicts with [/campaigns/{campaignId}/orders/{orderId}/delivery/shipments/{shipmentId}/boxes/{boxId}/label, /campaigns/{campaignId}/orders/{orderId}/delivery/labels, /campaigns/{campaignId}/offers/all, /campaigns/{campaignId}, /campaigns/{campaignId}/logins, /campaigns/{campaignId}/region, /campaigns/{campaignId}/settings, /campaigns/{campaignId}/feeds/{feedId}, /campaigns/{campaignId}/feeds/{feedId}/index-logs, /campaigns/{campaignId}/feedback/updates, /campaigns/{campaignId}/feeds, /campaigns/{campaignId}/hidden-offers, /campaigns/{campaignId}/offer-mapping-entries, /campaigns/{campaignId}/offers, /campaigns/{campaignId}/orders/{orderId}, /campaigns/{campaignId}/orders/{orderId}/buyer, /campaigns/{campaignId}/orders/{orderId}/delivery/labels/data, /campaigns/{campaignId}/orders, /campaigns/{campaignId}/outlets/{outletId}, /campaigns/{campaignId}/outlets/licenses, /campaigns/{campaignId}/outlets, /campaigns/{campaignId}/offer-prices, /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}, /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}/application, /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}/decision/{itemId}/image/{imageHash}, /campaigns/{campaignId}/returns, /campaigns, /campaigns/by_login/{login}] after/campaigns, ignoring @cask.get("/campaigns/:campaignId/orders/:orderId/delivery/labels")
         ...
         * 
         */
        // conflicts with [/campaigns/{campaignId}/hidden-offers, /campaigns/{campaignId}/price-quarantine/confirm, /campaigns/{campaignId}/outlets, /campaigns/{campaignId}/offers/delete, /campaigns/{campaignId}/hidden-offers/delete, /campaigns/{campaignId}/offers, /campaigns/{campaignId}/price-quarantine, /campaigns/{campaignId}/stats/skus, /campaigns/{campaignId}/orders/{orderId}/business-buyer, /campaigns/{campaignId}/orders/{orderId}/documents, /campaigns/{campaignId}/stats/orders, /campaigns/{campaignId}/offer-prices, /campaigns/{campaignId}/ratings/quality/details, /campaigns/{campaignId}/offers/stocks, /campaigns/{campaignId}/offer-mapping-entries/suggestions, /campaigns/{campaignId}/offer-prices/suggestions, /campaigns/{campaignId}/orders/{orderId}/deliverDigitalGoods, /campaigns/{campaignId}/feeds/{feedId}/refresh, /campaigns/{campaignId}/feeds/{feedId}/params, /campaigns/{campaignId}/orders/{orderId}/delivery/track, /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}/decision, /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}/decision/submit, /campaigns/{campaignId}/offers/update, /campaigns/{campaignId}/offer-mapping-entries/updates, /campaigns/{campaignId}/orders/status-update, /campaigns/{campaignId}/outlets/licenses, /campaigns/{campaignId}/offer-prices/updates] after/campaigns, ignoring @cask.post("/campaigns/:campaignId/offers")
         ...
         * 
         */
        // conflicts with [/campaigns/{campaignId}/hidden-offers, /campaigns/{campaignId}/price-quarantine/confirm, /campaigns/{campaignId}/outlets, /campaigns/{campaignId}/offers/delete, /campaigns/{campaignId}/hidden-offers/delete, /campaigns/{campaignId}/offers, /campaigns/{campaignId}/price-quarantine, /campaigns/{campaignId}/stats/skus, /campaigns/{campaignId}/orders/{orderId}/business-buyer, /campaigns/{campaignId}/orders/{orderId}/documents, /campaigns/{campaignId}/stats/orders, /campaigns/{campaignId}/offer-prices, /campaigns/{campaignId}/ratings/quality/details, /campaigns/{campaignId}/offers/stocks, /campaigns/{campaignId}/offer-mapping-entries/suggestions, /campaigns/{campaignId}/offer-prices/suggestions, /campaigns/{campaignId}/orders/{orderId}/deliverDigitalGoods, /campaigns/{campaignId}/feeds/{feedId}/refresh, /campaigns/{campaignId}/feeds/{feedId}/params, /campaigns/{campaignId}/orders/{orderId}/delivery/track, /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}/decision, /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}/decision/submit, /campaigns/{campaignId}/offers/update, /campaigns/{campaignId}/offer-mapping-entries/updates, /campaigns/{campaignId}/orders/status-update, /campaigns/{campaignId}/outlets/licenses, /campaigns/{campaignId}/offer-prices/updates] after/campaigns, ignoring @cask.post("/campaigns/:campaignId/price-quarantine")
         ...
         * 
         */
        @cask.get("/delivery/services")
        def getDeliveryServices(request: cask.Request) = {
            // auth method OAuth : oauth2, keyParamName: 

        def failFast = request.queryParams.keySet.contains("failFast")

        val result =         for {
            result <- Parsed.eval(service.getDeliveryServices())
        } yield result

        result match {
          case Left(error) => cask.Response(error, 500)
          case Right(value : GetDeliveryServicesResponse) => cask.Response(data = write(value), 200, headers = Seq("Content-Type" -> "application/json"))
          case Right(value : ApiClientDataErrorResponse) => cask.Response(data = write(value), 400, headers = Seq("Content-Type" -> "application/json"))
          case Right(value : ApiUnauthorizedErrorResponse) => cask.Response(data = write(value), 401, headers = Seq("Content-Type" -> "application/json"))
          case Right(value : ApiForbiddenErrorResponse) => cask.Response(data = write(value), 403, headers = Seq("Content-Type" -> "application/json"))
          case Right(value : ApiNotFoundErrorResponse) => cask.Response(data = write(value), 404, headers = Seq("Content-Type" -> "application/json"))
         ...
         * 
         */
        // conflicts with [/campaigns/{campaignId}/hidden-offers, /campaigns/{campaignId}/price-quarantine/confirm, /campaigns/{campaignId}/outlets, /campaigns/{campaignId}/offers/delete, /campaigns/{campaignId}/hidden-offers/delete, /campaigns/{campaignId}/offers, /campaigns/{campaignId}/price-quarantine, /campaigns/{campaignId}/stats/skus, /campaigns/{campaignId}/orders/{orderId}/business-buyer, /campaigns/{campaignId}/orders/{orderId}/documents, /campaigns/{campaignId}/stats/orders, /campaigns/{campaignId}/offer-prices, /campaigns/{campaignId}/ratings/quality/details, /campaigns/{campaignId}/offers/stocks, /campaigns/{campaignId}/offer-mapping-entries/suggestions, /campaigns/{campaignId}/offer-prices/suggestions, /campaigns/{campaignId}/orders/{orderId}/deliverDigitalGoods, /campaigns/{campaignId}/feeds/{feedId}/refresh, /campaigns/{campaignId}/feeds/{feedId}/params, /campaigns/{campaignId}/orders/{orderId}/delivery/track, /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}/decision, /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}/decision/submit, /campaigns/{campaignId}/offers/update, /campaigns/{campaignId}/offer-mapping-entries/updates, /campaigns/{campaignId}/orders/status-update, /campaigns/{campaignId}/outlets/licenses, /campaigns/{campaignId}/offer-prices/updates] after/campaigns, ignoring @cask.post("/campaigns/:campaignId/stats/skus")
         ...
         * 
         */
        // conflicts with [/campaigns/{campaignId}/hidden-offers, /campaigns/{campaignId}/price-quarantine/confirm, /campaigns/{campaignId}/outlets, /campaigns/{campaignId}/offers/delete, /campaigns/{campaignId}/hidden-offers/delete, /campaigns/{campaignId}/offers, /campaigns/{campaignId}/price-quarantine, /campaigns/{campaignId}/stats/skus, /campaigns/{campaignId}/orders/{orderId}/business-buyer, /campaigns/{campaignId}/orders/{orderId}/documents, /campaigns/{campaignId}/stats/orders, /campaigns/{campaignId}/offer-prices, /campaigns/{campaignId}/ratings/quality/details, /campaigns/{campaignId}/offers/stocks, /campaigns/{campaignId}/offer-mapping-entries/suggestions, /campaigns/{campaignId}/offer-prices/suggestions, /campaigns/{campaignId}/orders/{orderId}/deliverDigitalGoods, /campaigns/{campaignId}/feeds/{feedId}/refresh, /campaigns/{campaignId}/feeds/{feedId}/params, /campaigns/{campaignId}/orders/{orderId}/delivery/track, /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}/decision, /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}/decision/submit, /campaigns/{campaignId}/offers/update, /campaigns/{campaignId}/offer-mapping-entries/updates, /campaigns/{campaignId}/orders/status-update, /campaigns/{campaignId}/outlets/licenses, /campaigns/{campaignId}/offer-prices/updates] after/campaigns, ignoring @cask.post("/campaigns/:campaignId/orders/:orderId/business-buyer")
         ...
         * 
         */
        // conflicts with [/campaigns/{campaignId}/hidden-offers, /campaigns/{campaignId}/price-quarantine/confirm, /campaigns/{campaignId}/outlets, /campaigns/{campaignId}/offers/delete, /campaigns/{campaignId}/hidden-offers/delete, /campaigns/{campaignId}/offers, /campaigns/{campaignId}/price-quarantine, /campaigns/{campaignId}/stats/skus, /campaigns/{campaignId}/orders/{orderId}/business-buyer, /campaigns/{campaignId}/orders/{orderId}/documents, /campaigns/{campaignId}/stats/orders, /campaigns/{campaignId}/offer-prices, /campaigns/{campaignId}/ratings/quality/details, /campaigns/{campaignId}/offers/stocks, /campaigns/{campaignId}/offer-mapping-entries/suggestions, /campaigns/{campaignId}/offer-prices/suggestions, /campaigns/{campaignId}/orders/{orderId}/deliverDigitalGoods, /campaigns/{campaignId}/feeds/{feedId}/refresh, /campaigns/{campaignId}/feeds/{feedId}/params, /campaigns/{campaignId}/orders/{orderId}/delivery/track, /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}/decision, /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}/decision/submit, /campaigns/{campaignId}/offers/update, /campaigns/{campaignId}/offer-mapping-entries/updates, /campaigns/{campaignId}/orders/status-update, /campaigns/{campaignId}/outlets/licenses, /campaigns/{campaignId}/offer-prices/updates] after/campaigns, ignoring @cask.post("/campaigns/:campaignId/orders/:orderId/documents")
         ...
         * 
         */
        // conflicts with [/campaigns/{campaignId}/orders/{orderId}/delivery/shipments/{shipmentId}/boxes/{boxId}/label, /campaigns/{campaignId}/orders/{orderId}/delivery/labels, /campaigns/{campaignId}/offers/all, /campaigns/{campaignId}, /campaigns/{campaignId}/logins, /campaigns/{campaignId}/region, /campaigns/{campaignId}/settings, /campaigns/{campaignId}/feeds/{feedId}, /campaigns/{campaignId}/feeds/{feedId}/index-logs, /campaigns/{campaignId}/feedback/updates, /campaigns/{campaignId}/feeds, /campaigns/{campaignId}/hidden-offers, /campaigns/{campaignId}/offer-mapping-entries, /campaigns/{campaignId}/offers, /campaigns/{campaignId}/orders/{orderId}, /campaigns/{campaignId}/orders/{orderId}/buyer, /campaigns/{campaignId}/orders/{orderId}/delivery/labels/data, /campaigns/{campaignId}/orders, /campaigns/{campaignId}/outlets/{outletId}, /campaigns/{campaignId}/outlets/licenses, /campaigns/{campaignId}/outlets, /campaigns/{campaignId}/offer-prices, /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}, /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}/application, /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}/decision/{itemId}/image/{imageHash}, /campaigns/{campaignId}/returns, /campaigns, /campaigns/by_login/{login}] after/campaigns, ignoring @cask.get("/campaigns/:campaignId/orders/:orderId/buyer")
         ...
         * 
         */
        // conflicts with [/campaigns/{campaignId}/orders/{orderId}/delivery/shipments/{shipmentId}/boxes/{boxId}/label, /campaigns/{campaignId}/orders/{orderId}/delivery/labels, /campaigns/{campaignId}/offers/all, /campaigns/{campaignId}, /campaigns/{campaignId}/logins, /campaigns/{campaignId}/region, /campaigns/{campaignId}/settings, /campaigns/{campaignId}/feeds/{feedId}, /campaigns/{campaignId}/feeds/{feedId}/index-logs, /campaigns/{campaignId}/feedback/updates, /campaigns/{campaignId}/feeds, /campaigns/{campaignId}/hidden-offers, /campaigns/{campaignId}/offer-mapping-entries, /campaigns/{campaignId}/offers, /campaigns/{campaignId}/orders/{orderId}, /campaigns/{campaignId}/orders/{orderId}/buyer, /campaigns/{campaignId}/orders/{orderId}/delivery/labels/data, /campaigns/{campaignId}/orders, /campaigns/{campaignId}/outlets/{outletId}, /campaigns/{campaignId}/outlets/licenses, /campaigns/{campaignId}/outlets, /campaigns/{campaignId}/offer-prices, /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}, /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}/application, /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}/decision/{itemId}/image/{imageHash}, /campaigns/{campaignId}/returns, /campaigns, /campaigns/by_login/{login}] after/campaigns, ignoring @cask.get("/campaigns/:campaignId/orders/:orderId/delivery/labels/data")
         ...
         * 
         */
        // conflicts with [/campaigns/{campaignId}/hidden-offers, /campaigns/{campaignId}/price-quarantine/confirm, /campaigns/{campaignId}/outlets, /campaigns/{campaignId}/offers/delete, /campaigns/{campaignId}/hidden-offers/delete, /campaigns/{campaignId}/offers, /campaigns/{campaignId}/price-quarantine, /campaigns/{campaignId}/stats/skus, /campaigns/{campaignId}/orders/{orderId}/business-buyer, /campaigns/{campaignId}/orders/{orderId}/documents, /campaigns/{campaignId}/stats/orders, /campaigns/{campaignId}/offer-prices, /campaigns/{campaignId}/ratings/quality/details, /campaigns/{campaignId}/offers/stocks, /campaigns/{campaignId}/offer-mapping-entries/suggestions, /campaigns/{campaignId}/offer-prices/suggestions, /campaigns/{campaignId}/orders/{orderId}/deliverDigitalGoods, /campaigns/{campaignId}/feeds/{feedId}/refresh, /campaigns/{campaignId}/feeds/{feedId}/params, /campaigns/{campaignId}/orders/{orderId}/delivery/track, /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}/decision, /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}/decision/submit, /campaigns/{campaignId}/offers/update, /campaigns/{campaignId}/offer-mapping-entries/updates, /campaigns/{campaignId}/orders/status-update, /campaigns/{campaignId}/outlets/licenses, /campaigns/{campaignId}/offer-prices/updates] after/campaigns, ignoring @cask.post("/campaigns/:campaignId/stats/orders")
         ...
         * 
         */
        // conflicts with [/campaigns/{campaignId}/orders/{orderId}/delivery/shipments/{shipmentId}/boxes/{boxId}/label, /campaigns/{campaignId}/orders/{orderId}/delivery/labels, /campaigns/{campaignId}/offers/all, /campaigns/{campaignId}, /campaigns/{campaignId}/logins, /campaigns/{campaignId}/region, /campaigns/{campaignId}/settings, /campaigns/{campaignId}/feeds/{feedId}, /campaigns/{campaignId}/feeds/{feedId}/index-logs, /campaigns/{campaignId}/feedback/updates, /campaigns/{campaignId}/feeds, /campaigns/{campaignId}/hidden-offers, /campaigns/{campaignId}/offer-mapping-entries, /campaigns/{campaignId}/offers, /campaigns/{campaignId}/orders/{orderId}, /campaigns/{campaignId}/orders/{orderId}/buyer, /campaigns/{campaignId}/orders/{orderId}/delivery/labels/data, /campaigns/{campaignId}/orders, /campaigns/{campaignId}/outlets/{outletId}, /campaigns/{campaignId}/outlets/licenses, /campaigns/{campaignId}/outlets, /campaigns/{campaignId}/offer-prices, /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}, /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}/application, /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}/decision/{itemId}/image/{imageHash}, /campaigns/{campaignId}/returns, /campaigns, /campaigns/by_login/{login}] after/campaigns, ignoring @cask.get("/campaigns/:campaignId/outlets/:outletId")
         ...
         * 
         */
        // conflicts with [/campaigns/{campaignId}/orders/{orderId}/delivery/shipments/{shipmentId}/boxes/{boxId}/label, /campaigns/{campaignId}/orders/{orderId}/delivery/labels, /campaigns/{campaignId}/offers/all, /campaigns/{campaignId}, /campaigns/{campaignId}/logins, /campaigns/{campaignId}/region, /campaigns/{campaignId}/settings, /campaigns/{campaignId}/feeds/{feedId}, /campaigns/{campaignId}/feeds/{feedId}/index-logs, /campaigns/{campaignId}/feedback/updates, /campaigns/{campaignId}/feeds, /campaigns/{campaignId}/hidden-offers, /campaigns/{campaignId}/offer-mapping-entries, /campaigns/{campaignId}/offers, /campaigns/{campaignId}/orders/{orderId}, /campaigns/{campaignId}/orders/{orderId}/buyer, /campaigns/{campaignId}/orders/{orderId}/delivery/labels/data, /campaigns/{campaignId}/orders, /campaigns/{campaignId}/outlets/{outletId}, /campaigns/{campaignId}/outlets/licenses, /campaigns/{campaignId}/outlets, /campaigns/{campaignId}/offer-prices, /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}, /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}/application, /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}/decision/{itemId}/image/{imageHash}, /campaigns/{campaignId}/returns, /campaigns, /campaigns/by_login/{login}] after/campaigns, ignoring @cask.get("/campaigns/:campaignId/outlets/licenses")
        def getOutletLicenses(campaignId : Long, request: cask.Request, outletIds : Set[Long], ids : Set[Long]) = {
            // auth method OAuth : oauth2, keyParamName: 
        ...
        val result =         for {
            campaignId <- Parsed(campaignId)
            result <- Parsed.eval(service.getOutletLicenses(campaignId, outletIds, ids))
        } yield result

        result match {
          case Left(error) => cask.Response(error, 500)
          case Right(value : GetOutletLicensesResponse) => cask.Response(data = write(value), 200, headers = Seq("Content-Type" -> "application/json"))
          case Right(value : ApiClientDataErrorResponse) => cask.Response(data = write(value), 400, headers = Seq("Content-Type" -> "application/json"))
          case Right(value : ApiUnauthorizedErrorResponse) => cask.Response(data = write(value), 401, headers = Seq("Content-Type" -> "application/json"))
          case Right(value : ApiForbiddenErrorResponse) => cask.Response(data = write(value), 403, headers = Seq("Content-Type" -> "application/json"))
          case Right(value : ApiNotFoundErrorResponse) => cask.Response(data = write(value), 404, headers = Seq("Content-Type" -> "application/json"))
         ...
         * 
         */
        // conflicts with [/campaigns/{campaignId}/orders/{orderId}/delivery/shipments/{shipmentId}/boxes/{boxId}/label, /campaigns/{campaignId}/orders/{orderId}/delivery/labels, /campaigns/{campaignId}/offers/all, /campaigns/{campaignId}, /campaigns/{campaignId}/logins, /campaigns/{campaignId}/region, /campaigns/{campaignId}/settings, /campaigns/{campaignId}/feeds/{feedId}, /campaigns/{campaignId}/feeds/{feedId}/index-logs, /campaigns/{campaignId}/feedback/updates, /campaigns/{campaignId}/feeds, /campaigns/{campaignId}/hidden-offers, /campaigns/{campaignId}/offer-mapping-entries, /campaigns/{campaignId}/offers, /campaigns/{campaignId}/orders/{orderId}, /campaigns/{campaignId}/orders/{orderId}/buyer, /campaigns/{campaignId}/orders/{orderId}/delivery/labels/data, /campaigns/{campaignId}/orders, /campaigns/{campaignId}/outlets/{outletId}, /campaigns/{campaignId}/outlets/licenses, /campaigns/{campaignId}/outlets, /campaigns/{campaignId}/offer-prices, /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}, /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}/application, /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}/decision/{itemId}/image/{imageHash}, /campaigns/{campaignId}/returns, /campaigns, /campaigns/by_login/{login}] after/campaigns, ignoring @cask.get("/campaigns/:campaignId/outlets")
         ...
         * 
         */
        // conflicts with [/campaigns/{campaignId}/hidden-offers, /campaigns/{campaignId}/price-quarantine/confirm, /campaigns/{campaignId}/outlets, /campaigns/{campaignId}/offers/delete, /campaigns/{campaignId}/hidden-offers/delete, /campaigns/{campaignId}/offers, /campaigns/{campaignId}/price-quarantine, /campaigns/{campaignId}/stats/skus, /campaigns/{campaignId}/orders/{orderId}/business-buyer, /campaigns/{campaignId}/orders/{orderId}/documents, /campaigns/{campaignId}/stats/orders, /campaigns/{campaignId}/offer-prices, /campaigns/{campaignId}/ratings/quality/details, /campaigns/{campaignId}/offers/stocks, /campaigns/{campaignId}/offer-mapping-entries/suggestions, /campaigns/{campaignId}/offer-prices/suggestions, /campaigns/{campaignId}/orders/{orderId}/deliverDigitalGoods, /campaigns/{campaignId}/feeds/{feedId}/refresh, /campaigns/{campaignId}/feeds/{feedId}/params, /campaigns/{campaignId}/orders/{orderId}/delivery/track, /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}/decision, /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}/decision/submit, /campaigns/{campaignId}/offers/update, /campaigns/{campaignId}/offer-mapping-entries/updates, /campaigns/{campaignId}/orders/status-update, /campaigns/{campaignId}/outlets/licenses, /campaigns/{campaignId}/offer-prices/updates] after/campaigns, ignoring @cask.post("/campaigns/:campaignId/offer-prices")
         ...
         * 
         */
        // conflicts with [/campaigns/{campaignId}/hidden-offers, /campaigns/{campaignId}/price-quarantine/confirm, /campaigns/{campaignId}/outlets, /campaigns/{campaignId}/offers/delete, /campaigns/{campaignId}/hidden-offers/delete, /campaigns/{campaignId}/offers, /campaigns/{campaignId}/price-quarantine, /campaigns/{campaignId}/stats/skus, /campaigns/{campaignId}/orders/{orderId}/business-buyer, /campaigns/{campaignId}/orders/{orderId}/documents, /campaigns/{campaignId}/stats/orders, /campaigns/{campaignId}/offer-prices, /campaigns/{campaignId}/ratings/quality/details, /campaigns/{campaignId}/offers/stocks, /campaigns/{campaignId}/offer-mapping-entries/suggestions, /campaigns/{campaignId}/offer-prices/suggestions, /campaigns/{campaignId}/orders/{orderId}/deliverDigitalGoods, /campaigns/{campaignId}/feeds/{feedId}/refresh, /campaigns/{campaignId}/feeds/{feedId}/params, /campaigns/{campaignId}/orders/{orderId}/delivery/track, /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}/decision, /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}/decision/submit, /campaigns/{campaignId}/offers/update, /campaigns/{campaignId}/offer-mapping-entries/updates, /campaigns/{campaignId}/orders/status-update, /campaigns/{campaignId}/outlets/licenses, /campaigns/{campaignId}/offer-prices/updates] after/campaigns, ignoring @cask.post("/campaigns/:campaignId/ratings/quality/details")
         ...
         * 
         */
        // conflicts with [/campaigns/{campaignId}/orders/{orderId}/delivery/shipments/{shipmentId}/boxes/{boxId}/label, /campaigns/{campaignId}/orders/{orderId}/delivery/labels, /campaigns/{campaignId}/offers/all, /campaigns/{campaignId}, /campaigns/{campaignId}/logins, /campaigns/{campaignId}/region, /campaigns/{campaignId}/settings, /campaigns/{campaignId}/feeds/{feedId}, /campaigns/{campaignId}/feeds/{feedId}/index-logs, /campaigns/{campaignId}/feedback/updates, /campaigns/{campaignId}/feeds, /campaigns/{campaignId}/hidden-offers, /campaigns/{campaignId}/offer-mapping-entries, /campaigns/{campaignId}/offers, /campaigns/{campaignId}/orders/{orderId}, /campaigns/{campaignId}/orders/{orderId}/buyer, /campaigns/{campaignId}/orders/{orderId}/delivery/labels/data, /campaigns/{campaignId}/orders, /campaigns/{campaignId}/outlets/{outletId}, /campaigns/{campaignId}/outlets/licenses, /campaigns/{campaignId}/outlets, /campaigns/{campaignId}/offer-prices, /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}, /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}/application, /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}/decision/{itemId}/image/{imageHash}, /campaigns/{campaignId}/returns, /campaigns, /campaigns/by_login/{login}] after/campaigns, ignoring @cask.get("/campaigns/:campaignId/orders/:orderId/returns/:returnId/application")
         ...
         * 
         */
        // conflicts with [/campaigns/{campaignId}/hidden-offers, /campaigns/{campaignId}/price-quarantine/confirm, /campaigns/{campaignId}/outlets, /campaigns/{campaignId}/offers/delete, /campaigns/{campaignId}/hidden-offers/delete, /campaigns/{campaignId}/offers, /campaigns/{campaignId}/price-quarantine, /campaigns/{campaignId}/stats/skus, /campaigns/{campaignId}/orders/{orderId}/business-buyer, /campaigns/{campaignId}/orders/{orderId}/documents, /campaigns/{campaignId}/stats/orders, /campaigns/{campaignId}/offer-prices, /campaigns/{campaignId}/ratings/quality/details, /campaigns/{campaignId}/offers/stocks, /campaigns/{campaignId}/offer-mapping-entries/suggestions, /campaigns/{campaignId}/offer-prices/suggestions, /campaigns/{campaignId}/orders/{orderId}/deliverDigitalGoods, /campaigns/{campaignId}/feeds/{feedId}/refresh, /campaigns/{campaignId}/feeds/{feedId}/params, /campaigns/{campaignId}/orders/{orderId}/delivery/track, /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}/decision, /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}/decision/submit, /campaigns/{campaignId}/offers/update, /campaigns/{campaignId}/offer-mapping-entries/updates, /campaigns/{campaignId}/orders/status-update, /campaigns/{campaignId}/outlets/licenses, /campaigns/{campaignId}/offer-prices/updates] after/campaigns, ignoring @cask.post("/campaigns/:campaignId/offers/stocks")
         ...
         * 
         */
        // conflicts with [/campaigns/{campaignId}/hidden-offers, /campaigns/{campaignId}/price-quarantine/confirm, /campaigns/{campaignId}/outlets, /campaigns/{campaignId}/offers/delete, /campaigns/{campaignId}/hidden-offers/delete, /campaigns/{campaignId}/offers, /campaigns/{campaignId}/price-quarantine, /campaigns/{campaignId}/stats/skus, /campaigns/{campaignId}/orders/{orderId}/business-buyer, /campaigns/{campaignId}/orders/{orderId}/documents, /campaigns/{campaignId}/stats/orders, /campaigns/{campaignId}/offer-prices, /campaigns/{campaignId}/ratings/quality/details, /campaigns/{campaignId}/offers/stocks, /campaigns/{campaignId}/offer-mapping-entries/suggestions, /campaigns/{campaignId}/offer-prices/suggestions, /campaigns/{campaignId}/orders/{orderId}/deliverDigitalGoods, /campaigns/{campaignId}/feeds/{feedId}/refresh, /campaigns/{campaignId}/feeds/{feedId}/params, /campaigns/{campaignId}/orders/{orderId}/delivery/track, /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}/decision, /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}/decision/submit, /campaigns/{campaignId}/offers/update, /campaigns/{campaignId}/offer-mapping-entries/updates, /campaigns/{campaignId}/orders/status-update, /campaigns/{campaignId}/outlets/licenses, /campaigns/{campaignId}/offer-prices/updates] after/campaigns, ignoring @cask.post("/campaigns/:campaignId/offer-mapping-entries/suggestions")
         ...
         * 
         */
        // conflicts with [/campaigns/{campaignId}/hidden-offers, /campaigns/{campaignId}/price-quarantine/confirm, /campaigns/{campaignId}/outlets, /campaigns/{campaignId}/offers/delete, /campaigns/{campaignId}/hidden-offers/delete, /campaigns/{campaignId}/offers, /campaigns/{campaignId}/price-quarantine, /campaigns/{campaignId}/stats/skus, /campaigns/{campaignId}/orders/{orderId}/business-buyer, /campaigns/{campaignId}/orders/{orderId}/documents, /campaigns/{campaignId}/stats/orders, /campaigns/{campaignId}/offer-prices, /campaigns/{campaignId}/ratings/quality/details, /campaigns/{campaignId}/offers/stocks, /campaigns/{campaignId}/offer-mapping-entries/suggestions, /campaigns/{campaignId}/offer-prices/suggestions, /campaigns/{campaignId}/orders/{orderId}/deliverDigitalGoods, /campaigns/{campaignId}/feeds/{feedId}/refresh, /campaigns/{campaignId}/feeds/{feedId}/params, /campaigns/{campaignId}/orders/{orderId}/delivery/track, /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}/decision, /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}/decision/submit, /campaigns/{campaignId}/offers/update, /campaigns/{campaignId}/offer-mapping-entries/updates, /campaigns/{campaignId}/orders/status-update, /campaigns/{campaignId}/outlets/licenses, /campaigns/{campaignId}/offer-prices/updates] after/campaigns, ignoring @cask.post("/campaigns/:campaignId/offer-prices/suggestions")
         ...
         * 
         */
        @cask.get("/businesses/:businessId/warehouses")
        def getWarehouses(businessId : Long, request: cask.Request) = {
            // auth method OAuth : oauth2, keyParamName: 
        ...
        val result =         for {
            businessId <- Parsed(businessId)
            result <- Parsed.eval(service.getWarehouses(businessId))
        } yield result

        result match {
          case Left(error) => cask.Response(error, 500)
          case Right(value : GetWarehousesResponse) => cask.Response(data = write(value), 200, headers = Seq("Content-Type" -> "application/json"))
          case Right(value : ApiClientDataErrorResponse) => cask.Response(data = write(value), 400, headers = Seq("Content-Type" -> "application/json"))
          case Right(value : ApiUnauthorizedErrorResponse) => cask.Response(data = write(value), 401, headers = Seq("Content-Type" -> "application/json"))
          case Right(value : ApiForbiddenErrorResponse) => cask.Response(data = write(value), 403, headers = Seq("Content-Type" -> "application/json"))
          case Right(value : ApiNotFoundErrorResponse) => cask.Response(data = write(value), 404, headers = Seq("Content-Type" -> "application/json"))
         ...
         * 
         */
        // conflicts with [/campaigns/{campaignId}/hidden-offers, /campaigns/{campaignId}/price-quarantine/confirm, /campaigns/{campaignId}/outlets, /campaigns/{campaignId}/offers/delete, /campaigns/{campaignId}/hidden-offers/delete, /campaigns/{campaignId}/offers, /campaigns/{campaignId}/price-quarantine, /campaigns/{campaignId}/stats/skus, /campaigns/{campaignId}/orders/{orderId}/business-buyer, /campaigns/{campaignId}/orders/{orderId}/documents, /campaigns/{campaignId}/stats/orders, /campaigns/{campaignId}/offer-prices, /campaigns/{campaignId}/ratings/quality/details, /campaigns/{campaignId}/offers/stocks, /campaigns/{campaignId}/offer-mapping-entries/suggestions, /campaigns/{campaignId}/offer-prices/suggestions, /campaigns/{campaignId}/orders/{orderId}/deliverDigitalGoods, /campaigns/{campaignId}/feeds/{feedId}/refresh, /campaigns/{campaignId}/feeds/{feedId}/params, /campaigns/{campaignId}/orders/{orderId}/delivery/track, /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}/decision, /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}/decision/submit, /campaigns/{campaignId}/offers/update, /campaigns/{campaignId}/offer-mapping-entries/updates, /campaigns/{campaignId}/orders/status-update, /campaigns/{campaignId}/outlets/licenses, /campaigns/{campaignId}/offer-prices/updates] after/campaigns, ignoring @cask.post("/campaigns/:campaignId/orders/:orderId/deliverDigitalGoods")
         ...
         * 
         */
        // conflicts with [/campaigns/{campaignId}/orders/{orderId}/cancellation/accept, /campaigns/{campaignId}/orders/{orderId}/identifiers, /campaigns/{campaignId}/bids, /campaigns/{campaignId}/orders/{orderId}/boxes, /campaigns/{campaignId}/orders/{orderId}/delivery/date, /campaigns/{campaignId}/orders/{orderId}/delivery/shipments/{shipmentId}/boxes, /campaigns/{campaignId}/orders/{orderId}/items, /campaigns/{campaignId}/orders/{orderId}/status, /campaigns/{campaignId}/orders/{orderId}/delivery/storage-limit, /campaigns/{campaignId}/outlets/{outletId}, /campaigns/{campaignId}/offers/stocks] after/campaigns, ignoring @cask.put("/campaigns/:campaignId/orders/:orderId/identifiers")
         ...
         * 
         */
        // conflicts with [/campaigns/{campaignId}/orders/{orderId}/cancellation/accept, /campaigns/{campaignId}/orders/{orderId}/identifiers, /campaigns/{campaignId}/bids, /campaigns/{campaignId}/orders/{orderId}/boxes, /campaigns/{campaignId}/orders/{orderId}/delivery/date, /campaigns/{campaignId}/orders/{orderId}/delivery/shipments/{shipmentId}/boxes, /campaigns/{campaignId}/orders/{orderId}/items, /campaigns/{campaignId}/orders/{orderId}/status, /campaigns/{campaignId}/orders/{orderId}/delivery/storage-limit, /campaigns/{campaignId}/outlets/{outletId}, /campaigns/{campaignId}/offers/stocks] after/campaigns, ignoring @cask.put("/campaigns/:campaignId/bids")
         ...
         * 
         */
        // conflicts with [/campaigns/{campaignId}/hidden-offers, /campaigns/{campaignId}/price-quarantine/confirm, /campaigns/{campaignId}/outlets, /campaigns/{campaignId}/offers/delete, /campaigns/{campaignId}/hidden-offers/delete, /campaigns/{campaignId}/offers, /campaigns/{campaignId}/price-quarantine, /campaigns/{campaignId}/stats/skus, /campaigns/{campaignId}/orders/{orderId}/business-buyer, /campaigns/{campaignId}/orders/{orderId}/documents, /campaigns/{campaignId}/stats/orders, /campaigns/{campaignId}/offer-prices, /campaigns/{campaignId}/ratings/quality/details, /campaigns/{campaignId}/offers/stocks, /campaigns/{campaignId}/offer-mapping-entries/suggestions, /campaigns/{campaignId}/offer-prices/suggestions, /campaigns/{campaignId}/orders/{orderId}/deliverDigitalGoods, /campaigns/{campaignId}/feeds/{feedId}/refresh, /campaigns/{campaignId}/feeds/{feedId}/params, /campaigns/{campaignId}/orders/{orderId}/delivery/track, /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}/decision, /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}/decision/submit, /campaigns/{campaignId}/offers/update, /campaigns/{campaignId}/offer-mapping-entries/updates, /campaigns/{campaignId}/orders/status-update, /campaigns/{campaignId}/outlets/licenses, /campaigns/{campaignId}/offer-prices/updates] after/campaigns, ignoring @cask.post("/campaigns/:campaignId/feeds/:feedId/refresh")
         ...
         * 
         */
        // conflicts with [/campaigns/{campaignId}/hidden-offers, /campaigns/{campaignId}/price-quarantine/confirm, /campaigns/{campaignId}/outlets, /campaigns/{campaignId}/offers/delete, /campaigns/{campaignId}/hidden-offers/delete, /campaigns/{campaignId}/offers, /campaigns/{campaignId}/price-quarantine, /campaigns/{campaignId}/stats/skus, /campaigns/{campaignId}/orders/{orderId}/business-buyer, /campaigns/{campaignId}/orders/{orderId}/documents, /campaigns/{campaignId}/stats/orders, /campaigns/{campaignId}/offer-prices, /campaigns/{campaignId}/ratings/quality/details, /campaigns/{campaignId}/offers/stocks, /campaigns/{campaignId}/offer-mapping-entries/suggestions, /campaigns/{campaignId}/offer-prices/suggestions, /campaigns/{campaignId}/orders/{orderId}/deliverDigitalGoods, /campaigns/{campaignId}/feeds/{feedId}/refresh, /campaigns/{campaignId}/feeds/{feedId}/params, /campaigns/{campaignId}/orders/{orderId}/delivery/track, /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}/decision, /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}/decision/submit, /campaigns/{campaignId}/offers/update, /campaigns/{campaignId}/offer-mapping-entries/updates, /campaigns/{campaignId}/orders/status-update, /campaigns/{campaignId}/outlets/licenses, /campaigns/{campaignId}/offer-prices/updates] after/campaigns, ignoring @cask.post("/campaigns/:campaignId/feeds/:feedId/params")
         ...
         * 
         */
        // conflicts with [/campaigns/{campaignId}/orders/{orderId}/cancellation/accept, /campaigns/{campaignId}/orders/{orderId}/identifiers, /campaigns/{campaignId}/bids, /campaigns/{campaignId}/orders/{orderId}/boxes, /campaigns/{campaignId}/orders/{orderId}/delivery/date, /campaigns/{campaignId}/orders/{orderId}/delivery/shipments/{shipmentId}/boxes, /campaigns/{campaignId}/orders/{orderId}/items, /campaigns/{campaignId}/orders/{orderId}/status, /campaigns/{campaignId}/orders/{orderId}/delivery/storage-limit, /campaigns/{campaignId}/outlets/{outletId}, /campaigns/{campaignId}/offers/stocks] after/campaigns, ignoring @cask.put("/campaigns/:campaignId/orders/:orderId/boxes")
         ...
         * 
         */
        // conflicts with [/campaigns/{campaignId}/orders/{orderId}/cancellation/accept, /campaigns/{campaignId}/orders/{orderId}/identifiers, /campaigns/{campaignId}/bids, /campaigns/{campaignId}/orders/{orderId}/boxes, /campaigns/{campaignId}/orders/{orderId}/delivery/date, /campaigns/{campaignId}/orders/{orderId}/delivery/shipments/{shipmentId}/boxes, /campaigns/{campaignId}/orders/{orderId}/items, /campaigns/{campaignId}/orders/{orderId}/status, /campaigns/{campaignId}/orders/{orderId}/delivery/storage-limit, /campaigns/{campaignId}/outlets/{outletId}, /campaigns/{campaignId}/offers/stocks] after/campaigns, ignoring @cask.put("/campaigns/:campaignId/orders/:orderId/delivery/date")
         ...
         * 
         */
        // conflicts with [/campaigns/{campaignId}/hidden-offers, /campaigns/{campaignId}/price-quarantine/confirm, /campaigns/{campaignId}/outlets, /campaigns/{campaignId}/offers/delete, /campaigns/{campaignId}/hidden-offers/delete, /campaigns/{campaignId}/offers, /campaigns/{campaignId}/price-quarantine, /campaigns/{campaignId}/stats/skus, /campaigns/{campaignId}/orders/{orderId}/business-buyer, /campaigns/{campaignId}/orders/{orderId}/documents, /campaigns/{campaignId}/stats/orders, /campaigns/{campaignId}/offer-prices, /campaigns/{campaignId}/ratings/quality/details, /campaigns/{campaignId}/offers/stocks, /campaigns/{campaignId}/offer-mapping-entries/suggestions, /campaigns/{campaignId}/offer-prices/suggestions, /campaigns/{campaignId}/orders/{orderId}/deliverDigitalGoods, /campaigns/{campaignId}/feeds/{feedId}/refresh, /campaigns/{campaignId}/feeds/{feedId}/params, /campaigns/{campaignId}/orders/{orderId}/delivery/track, /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}/decision, /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}/decision/submit, /campaigns/{campaignId}/offers/update, /campaigns/{campaignId}/offer-mapping-entries/updates, /campaigns/{campaignId}/orders/status-update, /campaigns/{campaignId}/outlets/licenses, /campaigns/{campaignId}/offer-prices/updates] after/campaigns, ignoring @cask.post("/campaigns/:campaignId/orders/:orderId/delivery/track")
         ...
         * 
         */
        // conflicts with [/campaigns/{campaignId}/orders/{orderId}/cancellation/accept, /campaigns/{campaignId}/orders/{orderId}/identifiers, /campaigns/{campaignId}/bids, /campaigns/{campaignId}/orders/{orderId}/boxes, /campaigns/{campaignId}/orders/{orderId}/delivery/date, /campaigns/{campaignId}/orders/{orderId}/delivery/shipments/{shipmentId}/boxes, /campaigns/{campaignId}/orders/{orderId}/items, /campaigns/{campaignId}/orders/{orderId}/status, /campaigns/{campaignId}/orders/{orderId}/delivery/storage-limit, /campaigns/{campaignId}/outlets/{outletId}, /campaigns/{campaignId}/offers/stocks] after/campaigns, ignoring @cask.put("/campaigns/:campaignId/orders/:orderId/delivery/shipments/:shipmentId/boxes")
         ...
         * 
         */
        // conflicts with [/campaigns/{campaignId}/hidden-offers, /campaigns/{campaignId}/price-quarantine/confirm, /campaigns/{campaignId}/outlets, /campaigns/{campaignId}/offers/delete, /campaigns/{campaignId}/hidden-offers/delete, /campaigns/{campaignId}/offers, /campaigns/{campaignId}/price-quarantine, /campaigns/{campaignId}/stats/skus, /campaigns/{campaignId}/orders/{orderId}/business-buyer, /campaigns/{campaignId}/orders/{orderId}/documents, /campaigns/{campaignId}/stats/orders, /campaigns/{campaignId}/offer-prices, /campaigns/{campaignId}/ratings/quality/details, /campaigns/{campaignId}/offers/stocks, /campaigns/{campaignId}/offer-mapping-entries/suggestions, /campaigns/{campaignId}/offer-prices/suggestions, /campaigns/{campaignId}/orders/{orderId}/deliverDigitalGoods, /campaigns/{campaignId}/feeds/{feedId}/refresh, /campaigns/{campaignId}/feeds/{feedId}/params, /campaigns/{campaignId}/orders/{orderId}/delivery/track, /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}/decision, /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}/decision/submit, /campaigns/{campaignId}/offers/update, /campaigns/{campaignId}/offer-mapping-entries/updates, /campaigns/{campaignId}/orders/status-update, /campaigns/{campaignId}/outlets/licenses, /campaigns/{campaignId}/offer-prices/updates] after/campaigns, ignoring @cask.post("/campaigns/:campaignId/orders/:orderId/returns/:returnId/decision")
         ...
         * 
         */
        // conflicts with [/campaigns/{campaignId}/hidden-offers, /campaigns/{campaignId}/price-quarantine/confirm, /campaigns/{campaignId}/outlets, /campaigns/{campaignId}/offers/delete, /campaigns/{campaignId}/hidden-offers/delete, /campaigns/{campaignId}/offers, /campaigns/{campaignId}/price-quarantine, /campaigns/{campaignId}/stats/skus, /campaigns/{campaignId}/orders/{orderId}/business-buyer, /campaigns/{campaignId}/orders/{orderId}/documents, /campaigns/{campaignId}/stats/orders, /campaigns/{campaignId}/offer-prices, /campaigns/{campaignId}/ratings/quality/details, /campaigns/{campaignId}/offers/stocks, /campaigns/{campaignId}/offer-mapping-entries/suggestions, /campaigns/{campaignId}/offer-prices/suggestions, /campaigns/{campaignId}/orders/{orderId}/deliverDigitalGoods, /campaigns/{campaignId}/feeds/{feedId}/refresh, /campaigns/{campaignId}/feeds/{feedId}/params, /campaigns/{campaignId}/orders/{orderId}/delivery/track, /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}/decision, /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}/decision/submit, /campaigns/{campaignId}/offers/update, /campaigns/{campaignId}/offer-mapping-entries/updates, /campaigns/{campaignId}/orders/status-update, /campaigns/{campaignId}/outlets/licenses, /campaigns/{campaignId}/offer-prices/updates] after/campaigns, ignoring @cask.post("/campaigns/:campaignId/offers/update")
         ...
         * 
         */
        // conflicts with [/campaigns/{campaignId}/hidden-offers, /campaigns/{campaignId}/price-quarantine/confirm, /campaigns/{campaignId}/outlets, /campaigns/{campaignId}/offers/delete, /campaigns/{campaignId}/hidden-offers/delete, /campaigns/{campaignId}/offers, /campaigns/{campaignId}/price-quarantine, /campaigns/{campaignId}/stats/skus, /campaigns/{campaignId}/orders/{orderId}/business-buyer, /campaigns/{campaignId}/orders/{orderId}/documents, /campaigns/{campaignId}/stats/orders, /campaigns/{campaignId}/offer-prices, /campaigns/{campaignId}/ratings/quality/details, /campaigns/{campaignId}/offers/stocks, /campaigns/{campaignId}/offer-mapping-entries/suggestions, /campaigns/{campaignId}/offer-prices/suggestions, /campaigns/{campaignId}/orders/{orderId}/deliverDigitalGoods, /campaigns/{campaignId}/feeds/{feedId}/refresh, /campaigns/{campaignId}/feeds/{feedId}/params, /campaigns/{campaignId}/orders/{orderId}/delivery/track, /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}/decision, /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}/decision/submit, /campaigns/{campaignId}/offers/update, /campaigns/{campaignId}/offer-mapping-entries/updates, /campaigns/{campaignId}/orders/status-update, /campaigns/{campaignId}/outlets/licenses, /campaigns/{campaignId}/offer-prices/updates] after/campaigns, ignoring @cask.post("/campaigns/:campaignId/offer-mapping-entries/updates")
         ...
         * 
         */
        // conflicts with [/campaigns/{campaignId}/orders/{orderId}/cancellation/accept, /campaigns/{campaignId}/orders/{orderId}/identifiers, /campaigns/{campaignId}/bids, /campaigns/{campaignId}/orders/{orderId}/boxes, /campaigns/{campaignId}/orders/{orderId}/delivery/date, /campaigns/{campaignId}/orders/{orderId}/delivery/shipments/{shipmentId}/boxes, /campaigns/{campaignId}/orders/{orderId}/items, /campaigns/{campaignId}/orders/{orderId}/status, /campaigns/{campaignId}/orders/{orderId}/delivery/storage-limit, /campaigns/{campaignId}/outlets/{outletId}, /campaigns/{campaignId}/offers/stocks] after/campaigns, ignoring @cask.put("/campaigns/:campaignId/orders/:orderId/items")
         ...
         * 
         */
        // conflicts with [/campaigns/{campaignId}/orders/{orderId}/cancellation/accept, /campaigns/{campaignId}/orders/{orderId}/identifiers, /campaigns/{campaignId}/bids, /campaigns/{campaignId}/orders/{orderId}/boxes, /campaigns/{campaignId}/orders/{orderId}/delivery/date, /campaigns/{campaignId}/orders/{orderId}/delivery/shipments/{shipmentId}/boxes, /campaigns/{campaignId}/orders/{orderId}/items, /campaigns/{campaignId}/orders/{orderId}/status, /campaigns/{campaignId}/orders/{orderId}/delivery/storage-limit, /campaigns/{campaignId}/outlets/{outletId}, /campaigns/{campaignId}/offers/stocks] after/campaigns, ignoring @cask.put("/campaigns/:campaignId/orders/:orderId/status")
         ...
         * 
         */
        // conflicts with [/campaigns/{campaignId}/hidden-offers, /campaigns/{campaignId}/price-quarantine/confirm, /campaigns/{campaignId}/outlets, /campaigns/{campaignId}/offers/delete, /campaigns/{campaignId}/hidden-offers/delete, /campaigns/{campaignId}/offers, /campaigns/{campaignId}/price-quarantine, /campaigns/{campaignId}/stats/skus, /campaigns/{campaignId}/orders/{orderId}/business-buyer, /campaigns/{campaignId}/orders/{orderId}/documents, /campaigns/{campaignId}/stats/orders, /campaigns/{campaignId}/offer-prices, /campaigns/{campaignId}/ratings/quality/details, /campaigns/{campaignId}/offers/stocks, /campaigns/{campaignId}/offer-mapping-entries/suggestions, /campaigns/{campaignId}/offer-prices/suggestions, /campaigns/{campaignId}/orders/{orderId}/deliverDigitalGoods, /campaigns/{campaignId}/feeds/{feedId}/refresh, /campaigns/{campaignId}/feeds/{feedId}/params, /campaigns/{campaignId}/orders/{orderId}/delivery/track, /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}/decision, /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}/decision/submit, /campaigns/{campaignId}/offers/update, /campaigns/{campaignId}/offer-mapping-entries/updates, /campaigns/{campaignId}/orders/status-update, /campaigns/{campaignId}/outlets/licenses, /campaigns/{campaignId}/offer-prices/updates] after/campaigns, ignoring @cask.post("/campaigns/:campaignId/orders/status-update")
         ...
         * 
         */
        // conflicts with [/campaigns/{campaignId}/orders/{orderId}/cancellation/accept, /campaigns/{campaignId}/orders/{orderId}/identifiers, /campaigns/{campaignId}/bids, /campaigns/{campaignId}/orders/{orderId}/boxes, /campaigns/{campaignId}/orders/{orderId}/delivery/date, /campaigns/{campaignId}/orders/{orderId}/delivery/shipments/{shipmentId}/boxes, /campaigns/{campaignId}/orders/{orderId}/items, /campaigns/{campaignId}/orders/{orderId}/status, /campaigns/{campaignId}/orders/{orderId}/delivery/storage-limit, /campaigns/{campaignId}/outlets/{outletId}, /campaigns/{campaignId}/offers/stocks] after/campaigns, ignoring @cask.put("/campaigns/:campaignId/orders/:orderId/delivery/storage-limit")
         ...
         * 
         */
        // conflicts with [/campaigns/{campaignId}/orders/{orderId}/cancellation/accept, /campaigns/{campaignId}/orders/{orderId}/identifiers, /campaigns/{campaignId}/bids, /campaigns/{campaignId}/orders/{orderId}/boxes, /campaigns/{campaignId}/orders/{orderId}/delivery/date, /campaigns/{campaignId}/orders/{orderId}/delivery/shipments/{shipmentId}/boxes, /campaigns/{campaignId}/orders/{orderId}/items, /campaigns/{campaignId}/orders/{orderId}/status, /campaigns/{campaignId}/orders/{orderId}/delivery/storage-limit, /campaigns/{campaignId}/outlets/{outletId}, /campaigns/{campaignId}/offers/stocks] after/campaigns, ignoring @cask.put("/campaigns/:campaignId/outlets/:outletId")
         ...
         * 
         */
        // conflicts with [/campaigns/{campaignId}/hidden-offers, /campaigns/{campaignId}/price-quarantine/confirm, /campaigns/{campaignId}/outlets, /campaigns/{campaignId}/offers/delete, /campaigns/{campaignId}/hidden-offers/delete, /campaigns/{campaignId}/offers, /campaigns/{campaignId}/price-quarantine, /campaigns/{campaignId}/stats/skus, /campaigns/{campaignId}/orders/{orderId}/business-buyer, /campaigns/{campaignId}/orders/{orderId}/documents, /campaigns/{campaignId}/stats/orders, /campaigns/{campaignId}/offer-prices, /campaigns/{campaignId}/ratings/quality/details, /campaigns/{campaignId}/offers/stocks, /campaigns/{campaignId}/offer-mapping-entries/suggestions, /campaigns/{campaignId}/offer-prices/suggestions, /campaigns/{campaignId}/orders/{orderId}/deliverDigitalGoods, /campaigns/{campaignId}/feeds/{feedId}/refresh, /campaigns/{campaignId}/feeds/{feedId}/params, /campaigns/{campaignId}/orders/{orderId}/delivery/track, /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}/decision, /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}/decision/submit, /campaigns/{campaignId}/offers/update, /campaigns/{campaignId}/offer-mapping-entries/updates, /campaigns/{campaignId}/orders/status-update, /campaigns/{campaignId}/outlets/licenses, /campaigns/{campaignId}/offer-prices/updates] after/campaigns, ignoring @cask.post("/campaigns/:campaignId/outlets/licenses")
        def updateOutletLicenses(campaignId : Long, request: cask.Request) = {
            // auth method OAuth : oauth2, keyParamName: 
        ...
        val result =         for {
            campaignId <- Parsed(campaignId)
              updateOutletLicenseRequestData <- Parsed.eval(UpdateOutletLicenseRequestData.fromJsonString(request.bodyAsString)).mapError(e => s"Error parsing json as UpdateOutletLicenseRequest from >${request.bodyAsString}< : ${e}") /* not array or map */
              updateOutletLicenseRequest <- Parsed.fromTry(updateOutletLicenseRequestData.validated(failFast))
            result <- Parsed.eval(service.updateOutletLicenses(campaignId, updateOutletLicenseRequest))
        } yield result
         ...
         * 
         */
        // conflicts with [/campaigns/{campaignId}/hidden-offers, /campaigns/{campaignId}/price-quarantine/confirm, /campaigns/{campaignId}/outlets, /campaigns/{campaignId}/offers/delete, /campaigns/{campaignId}/hidden-offers/delete, /campaigns/{campaignId}/offers, /campaigns/{campaignId}/price-quarantine, /campaigns/{campaignId}/stats/skus, /campaigns/{campaignId}/orders/{orderId}/business-buyer, /campaigns/{campaignId}/orders/{orderId}/documents, /campaigns/{campaignId}/stats/orders, /campaigns/{campaignId}/offer-prices, /campaigns/{campaignId}/ratings/quality/details, /campaigns/{campaignId}/offers/stocks, /campaigns/{campaignId}/offer-mapping-entries/suggestions, /campaigns/{campaignId}/offer-prices/suggestions, /campaigns/{campaignId}/orders/{orderId}/deliverDigitalGoods, /campaigns/{campaignId}/feeds/{feedId}/refresh, /campaigns/{campaignId}/feeds/{feedId}/params, /campaigns/{campaignId}/orders/{orderId}/delivery/track, /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}/decision, /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}/decision/submit, /campaigns/{campaignId}/offers/update, /campaigns/{campaignId}/offer-mapping-entries/updates, /campaigns/{campaignId}/orders/status-update, /campaigns/{campaignId}/outlets/licenses, /campaigns/{campaignId}/offer-prices/updates] after/campaigns, ignoring @cask.post("/campaigns/:campaignId/offer-prices/updates")
         ...
         * 
         */
        // conflicts with [/campaigns/{campaignId}/orders/{orderId}/cancellation/accept, /campaigns/{campaignId}/orders/{orderId}/identifiers, /campaigns/{campaignId}/bids, /campaigns/{campaignId}/orders/{orderId}/boxes, /campaigns/{campaignId}/orders/{orderId}/delivery/date, /campaigns/{campaignId}/orders/{orderId}/delivery/shipments/{shipmentId}/boxes, /campaigns/{campaignId}/orders/{orderId}/items, /campaigns/{campaignId}/orders/{orderId}/status, /campaigns/{campaignId}/orders/{orderId}/delivery/storage-limit, /campaigns/{campaignId}/outlets/{outletId}, /campaigns/{campaignId}/offers/stocks] after/campaigns, ignoring @cask.put("/campaigns/:campaignId/offers/stocks")
