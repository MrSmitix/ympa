...
#
package WWW::OpenAPIClient::Object::CalculateTariffsOfferDTO;
...
__PACKAGE__->class_documentation({description => 'Параметры товара, для которого нужно рассчитать стоимость услуг.',
