...
#
package WWW::OpenAPIClient::Object::CampaignSettingsScheduleDTO;
...
__PACKAGE__->class_documentation({description => 'Расписание работы службы доставки в своем регионе.',
                                  class => 'CampaignSettingsScheduleDTO',
                                  required => [], # TODO
}                                 );

__PACKAGE__->method_documentation({
    'available_on_holidays' => {
        datatype => 'boolean',
        base_name => 'availableOnHolidays',
        description => 'Признак работы службы доставки в государственные праздники. Возможные значения. * &#x60;false&#x60; — служба доставки не работает в праздничные дни. * &#x60;true&#x60; — служба доставки работает в праздничные дни. ',
        format => '',
        read_only => '',
            },
    'custom_holidays' => {
        datatype => 'ARRAY[string]',
        base_name => 'customHolidays',
    ...
    'period' => {
        datatype => 'CampaignSettingsTimePeriodDTO',
        base_name => 'period',
        description => '',
        format => '',
        read_only => '',
