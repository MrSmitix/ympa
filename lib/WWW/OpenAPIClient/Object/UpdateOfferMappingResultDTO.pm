...
#
package WWW::OpenAPIClient::Object::UpdateOfferMappingResultDTO;
...
__PACKAGE__->class_documentation({description => 'Ошибки и предупреждения, которые появились из-за переданных характеристик.',
...
__PACKAGE__->method_documentation({
    ...
    'errors' => {
        datatype => 'ARRAY[OfferMappingErrorDTO]',
        base_name => 'errors',
