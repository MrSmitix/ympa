...
#
package WWW::OpenAPIClient::Object::QualityRatingDTO;
...
__PACKAGE__->class_documentation({description => 'Информация об индексе качества.',
...
__PACKAGE__->method_documentation({
    ...
    'calculation_date' => {
        datatype => 'DATE',
        base_name => 'calculationDate',
        description => 'Дата вычисления.  Формат даты: &#x60;ГГГГ‑ММ‑ДД&#x60;. ',
        format => '',
        read_only => '',
            },
    'components' => {
        datatype => 'ARRAY[QualityRatingComponentDTO]',
