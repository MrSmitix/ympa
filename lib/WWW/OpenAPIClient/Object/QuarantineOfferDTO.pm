...
#
package WWW::OpenAPIClient::Object::QuarantineOfferDTO;
...
__PACKAGE__->class_documentation({description => 'Товар в карантине.',
...
__PACKAGE__->method_documentation({
    ...
    'last_valid_price' => {
        datatype => 'BasePriceDTO',
        base_name => 'lastValidPrice',
        description => '',
        format => '',
        read_only => '',
            },
    'verdicts' => {
        datatype => 'ARRAY[PriceQuarantineVerdictDTO]',
        base_name => 'verdicts',
