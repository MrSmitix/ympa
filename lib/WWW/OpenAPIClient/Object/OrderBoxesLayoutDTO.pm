...
#
package WWW::OpenAPIClient::Object::OrderBoxesLayoutDTO;
...
__PACKAGE__->class_documentation({description => 'Распределение товаров по коробкам.',
...
__PACKAGE__->method_documentation({
    'boxes' => {
        datatype => 'ARRAY[EnrichedOrderBoxLayoutDTO]',
        base_name => 'boxes',
