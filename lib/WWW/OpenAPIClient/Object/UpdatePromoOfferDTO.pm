...
#
package WWW::OpenAPIClient::Object::UpdatePromoOfferDTO;
...
__PACKAGE__->class_documentation({description => 'Описание товаров, которые участвуют в акции.',
...
__PACKAGE__->method_documentation({
    ...
    'params' => {
        datatype => 'UpdatePromoOfferParamsDTO',
        base_name => 'params',
        description => '',
        format => '',
        read_only => '',
