...
#
package WWW::OpenAPIClient::Object::OfferCardsContentStatusDTO;
...
__PACKAGE__->class_documentation({description => 'Список товаров с информацией о состоянии карточек.',
...
__PACKAGE__->method_documentation({
    'offer_cards' => {
        datatype => 'ARRAY[OfferCardDTO]',
        base_name => 'offerCards',
        description => 'Страница списка товаров с информацией о состоянии карточек.',
        format => '',
        read_only => '',
            },
    'paging' => {
        datatype => 'ForwardScrollingPagerDTO',
        base_name => 'paging',
        description => '',
        format => '',
        read_only => '',
