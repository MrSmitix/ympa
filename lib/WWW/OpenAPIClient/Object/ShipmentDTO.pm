...
#
package WWW::OpenAPIClient::Object::ShipmentDTO;
...
__PACKAGE__->class_documentation({description => 'Информация об отгрузке.',
                                  class => 'ShipmentDTO',
                                  required => [], # TODO
}                                 );
...
__PACKAGE__->method_documentation({
    ...
    'plan_interval_to' => {
        datatype => 'DATE_TIME',
        base_name => 'planIntervalTo',
        description => 'Конец планового интервала отгрузки.',
        format => '',
        read_only => '',
            },
    'shipment_type' => {
        datatype => 'ShipmentType',
        base_name => 'shipmentType',
        description => '',
        format => '',
        read_only => '',
            },
    'warehouse' => {
        datatype => 'PartnerShipmentWarehouseDTO',
        base_name => 'warehouse',
        description => '',
        format => '',
        read_only => '',
    ...
    'delivery_service' => {
        datatype => 'DeliveryServiceDTO',
        base_name => 'deliveryService',
        description => '',
        format => '',
        read_only => '',
            },
    'pallets_count' => {
        datatype => 'PalletsCountDTO',
        base_name => 'palletsCount',
        description => '',
        format => '',
        read_only => '',
            },
    ...
    'current_status' => {
        datatype => 'ShipmentStatusChangeDTO',
        base_name => 'currentStatus',
        description => '',
        format => '',
        read_only => '',
            },
    'available_actions' => {
        datatype => 'ARRAY[ShipmentActionType]',
        base_name => 'availableActions',
...
__PACKAGE__->openapi_types( {
    'id' => 'int',
    'plan_interval_from' => 'DATE_TIME',
    'plan_interval_to' => 'DATE_TIME',
