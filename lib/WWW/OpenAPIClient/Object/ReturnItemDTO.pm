...
#
package WWW::OpenAPIClient::Object::ReturnItemDTO;
...
__PACKAGE__->class_documentation({description => 'Список товаров в возврате.',
                                  class => 'ReturnItemDTO',
                                  required => [], # TODO
}                                 );
...
__PACKAGE__->method_documentation({
    ...
    'decisions' => {
        datatype => 'ARRAY[ReturnDecisionDTO]',
        base_name => 'decisions',
    ...
    'instances' => {
        datatype => 'ARRAY[ReturnInstanceDTO]',
        base_name => 'instances',
