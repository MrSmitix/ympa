...
#
package WWW::OpenAPIClient::Object::MaxSaleQuantumDTO;
...
__PACKAGE__->class_documentation({description => 'Лимит на установку кванта и минимального количества товаров по категориям. ',
