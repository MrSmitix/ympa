...
#
package WWW::OpenAPIClient::Object::GetChatHistoryRequest;
...
__PACKAGE__->class_documentation({description => 'Историю какого чата нужно получить — и начиная с какого сообщения. ',
