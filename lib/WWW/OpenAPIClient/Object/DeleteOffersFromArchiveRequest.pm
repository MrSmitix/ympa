...
#
package WWW::OpenAPIClient::Object::DeleteOffersFromArchiveRequest;
...
__PACKAGE__->class_documentation({description => 'Товары, которые нужно восстановить из архива. ',
