...
#
package WWW::OpenAPIClient::Object::OptionValuesLimitedDTO;
...
__PACKAGE__->class_documentation({description => 'Значение ограничивающей характеристики и список допустимых значений ограничиваемой характеристики.',
...
__PACKAGE__->method_documentation({
    'limiting_option_value_id' => {
        datatype => 'int',
        base_name => 'limitingOptionValueId',
