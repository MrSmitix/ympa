...
#
package WWW::OpenAPIClient::Object::OrdersShipmentInfoDTO;
...
__PACKAGE__->class_documentation({description => 'Годные/негодные ярлыки по заказам в отгрузке.',
...
__PACKAGE__->method_documentation({
    ...
    'order_ids_without_labels' => {
        datatype => 'ARRAY[int]',
        base_name => 'orderIdsWithoutLabels',
...
__PACKAGE__->openapi_types( {
    'order_ids_with_labels' => 'ARRAY[int]',
    'order_ids_without_labels' => 'ARRAY[int]'
} );
