...
#
package WWW::OpenAPIClient::Object::GetCategoriesMaxSaleQuantumDTO;
...
__PACKAGE__->class_documentation({description => 'Категории и лимит на установку кванта и минимального количества товаров.',
...
__PACKAGE__->method_documentation({
    'results' => {
        datatype => 'ARRAY[MaxSaleQuantumDTO]',
        base_name => 'results',
    ...
    'errors' => {
        datatype => 'ARRAY[CategoryErrorDTO]',
        base_name => 'errors',
