...
#
package WWW::OpenAPIClient::Object::OrderItemDTO;
...
__PACKAGE__->class_documentation({description => 'Список товаров в заказе.',
                                  class => 'OrderItemDTO',
                                  required => [], # TODO
}                                 );
...
__PACKAGE__->method_documentation({
    ...
    'buyer_price_before_discount' => {
        datatype => 'double',
        base_name => 'buyerPriceBeforeDiscount',
    ...
    'promos' => {
        datatype => 'ARRAY[OrderItemPromoDTO]',
        base_name => 'promos',
    ...
    'instances' => {
        datatype => 'ARRAY[OrderItemInstanceDTO]',
        base_name => 'instances',
    ...
    'details' => {
        datatype => 'ARRAY[OrderItemDetailDTO]',
        base_name => 'details',
    ...
    'subsidies' => {
        datatype => 'ARRAY[OrderItemSubsidyDTO]',
        base_name => 'subsidies',
    ...
    'required_instance_types' => {
        datatype => 'ARRAY[OrderItemInstanceType]',
        base_name => 'requiredInstanceTypes',
...
__PACKAGE__->openapi_types( {
    ...
    'price' => 'double',
    'buyer_price' => 'double',
    'buyer_price_before_discount' => 'double',
