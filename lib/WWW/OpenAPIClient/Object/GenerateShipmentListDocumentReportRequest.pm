...
#
package WWW::OpenAPIClient::Object::GenerateShipmentListDocumentReportRequest;
...
__PACKAGE__->class_documentation({description => 'Данные, необходимые для генерации документа. ',
