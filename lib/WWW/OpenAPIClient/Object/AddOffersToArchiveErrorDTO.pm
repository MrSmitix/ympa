...
#
package WWW::OpenAPIClient::Object::AddOffersToArchiveErrorDTO;
...
__PACKAGE__->class_documentation({description => 'Товар, который не удалось поместить в архив.',
...
__PACKAGE__->method_documentation({
    ...
    'error' => {
        datatype => 'AddOffersToArchiveErrorType',
        base_name => 'error',
        description => '',
        format => '',
        read_only => '',
