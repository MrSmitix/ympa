...
#
package WWW::OpenAPIClient::Object::FulfillmentWarehousesDTO;
...
__PACKAGE__->class_documentation({description => 'Список складов Маркета (FBY).',
...
__PACKAGE__->method_documentation({
    'warehouses' => {
        datatype => 'ARRAY[FulfillmentWarehouseDTO]',
