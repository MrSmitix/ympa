...
#
package WWW::OpenAPIClient::Object::WarehouseOfferDTO;
...
__PACKAGE__->method_documentation({
    ...
    'turnover_summary' => {
        datatype => 'TurnoverDTO',
        base_name => 'turnoverSummary',
        description => '',
        format => '',
        read_only => '',
            },
    'stocks' => {
        datatype => 'ARRAY[WarehouseStockDTO]',
        base_name => 'stocks',
    ...
    'updated_at' => {
        datatype => 'DATE_TIME',
        base_name => 'updatedAt',
        description => 'Дата и время последнего обновления информации об остатках.  Формат даты и времени: ISO 8601 со смещением относительно UTC. Например, &#x60;2023-11-21T00:42:42+03:00&#x60;. ',
        format => '',
        read_only => '',
            },
});
