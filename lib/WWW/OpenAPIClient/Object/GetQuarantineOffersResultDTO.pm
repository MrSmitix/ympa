...
#
package WWW::OpenAPIClient::Object::GetQuarantineOffersResultDTO;
...
__PACKAGE__->class_documentation({description => 'Список товаров в карантине.',
...
__PACKAGE__->method_documentation({
    ...
    'offers' => {
        datatype => 'ARRAY[QuarantineOfferDTO]',
        base_name => 'offers',
