...
#
package WWW::OpenAPIClient::Object::FeedPlacementDTO;
...
__PACKAGE__->class_documentation({description => 'Информация о размещении предложений из прайс-листа на Маркете на момент выполнения запроса.',
