...
#
package WWW::OpenAPIClient::Object::SkuBidRecommendationItemDTO;
...
__PACKAGE__->class_documentation({description => 'Список товаров с рекомендованными ставками.',
...
__PACKAGE__->method_documentation({
    ...
    'bid_recommendations' => {
        datatype => 'ARRAY[BidRecommendationItemDTO]',
        base_name => 'bidRecommendations',
    ...
    'price_recommendations' => {
        datatype => 'ARRAY[PriceRecommendationItemDTO]',
        base_name => 'priceRecommendations',
