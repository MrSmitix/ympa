...
#
package WWW::OpenAPIClient::Object::UpdateStockDTO;
...
__PACKAGE__->class_documentation({description => 'Информация об остатках одного товара на одном из складов.',
...
__PACKAGE__->method_documentation({
    ...
    'items' => {
        datatype => 'ARRAY[UpdateStockItemDTO]',
        base_name => 'items',
