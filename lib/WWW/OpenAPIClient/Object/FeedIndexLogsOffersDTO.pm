...
#
package WWW::OpenAPIClient::Object::FeedIndexLogsOffersDTO;
...
__PACKAGE__->class_documentation({description => 'Информация о предложениях прайс-листа.',
