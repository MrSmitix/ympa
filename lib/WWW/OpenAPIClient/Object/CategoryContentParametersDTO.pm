...
#
package WWW::OpenAPIClient::Object::CategoryContentParametersDTO;
...
__PACKAGE__->class_documentation({description => 'Информация о параметрах категории.',
...
__PACKAGE__->method_documentation({
    ...
    'parameters' => {
        datatype => 'ARRAY[CategoryParameterDTO]',
