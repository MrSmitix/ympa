...
#
package WWW::OpenAPIClient::Object::OutletLicensesResponseDTO;
...
__PACKAGE__->class_documentation({description => 'Ответ на запрос информации о лицензиях для точек продаж.',
...
__PACKAGE__->method_documentation({
    'licenses' => {
        datatype => 'ARRAY[FullOutletLicenseDTO]',
        base_name => 'licenses',
