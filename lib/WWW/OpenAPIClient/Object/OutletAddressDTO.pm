...
#
package WWW::OpenAPIClient::Object::OutletAddressDTO;
...
__PACKAGE__->class_documentation({description => 'Адрес точки продаж. ',
...
__PACKAGE__->method_documentation({
    ...
    'city' => {
        datatype => 'string',
        base_name => 'city',
        description => '{% note warning \&quot;\&quot; %}  Этот параметр устарел. Не используйте его. Город или населенный пункт возвращается в параметре &#x60;regionId&#x60;.  {% endnote %} ',
        format => '',
        read_only => '',
            },
});
