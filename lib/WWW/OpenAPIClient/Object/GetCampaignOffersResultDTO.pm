...
#
package WWW::OpenAPIClient::Object::GetCampaignOffersResultDTO;
...
__PACKAGE__->class_documentation({description => 'Список товаров в заданном магазине.',
...
__PACKAGE__->method_documentation({
    ...
    'offers' => {
        datatype => 'ARRAY[GetCampaignOfferDTO]',
        base_name => 'offers',
