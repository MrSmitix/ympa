...
#
package WWW::OpenAPIClient::Object::OrderItemsModificationResultDTO;
...
__PACKAGE__->class_documentation({description => 'Краткие сведения о промаркированных товарах. Параметр возвращается, если ответ &#x60;OK&#x60;. ',
...
__PACKAGE__->method_documentation({
    'items' => {
        datatype => 'ARRAY[BriefOrderItemDTO]',
        base_name => 'items',
