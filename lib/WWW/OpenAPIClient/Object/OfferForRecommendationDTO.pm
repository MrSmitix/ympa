...
#
package WWW::OpenAPIClient::Object::OfferForRecommendationDTO;
...
__PACKAGE__->class_documentation({description => 'Информация о состоянии цены на товар.',
