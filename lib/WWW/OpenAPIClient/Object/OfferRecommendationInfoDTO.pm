...
#
package WWW::OpenAPIClient::Object::OfferRecommendationInfoDTO;
...
__PACKAGE__->class_documentation({description => 'Рекомендации, касающиеся цены на товар.',
...
__PACKAGE__->method_documentation({
    ...
    'recommended_cofinance_price' => {
        datatype => 'BasePriceDTO',
        base_name => 'recommendedCofinancePrice',
        description => '',
        format => '',
        read_only => '',
            },
    'competitiveness_thresholds' => {
        datatype => 'PriceCompetitivenessThresholdsDTO',
        base_name => 'competitivenessThresholds',
        description => '',
        format => '',
        read_only => '',
            },
