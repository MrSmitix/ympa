...
#
package WWW::OpenAPIClient::Object::CategoryParameterUnitDTO;
...
__PACKAGE__->class_documentation({description => 'Единицы измерения характеристики товара.',
...
__PACKAGE__->method_documentation({
    'default_unit_id' => {
        datatype => 'int',
        base_name => 'defaultUnitId',
        description => 'Единица измерения по умолчанию.',
        format => '',
        read_only => '',
            },
    'units' => {
        datatype => 'ARRAY[UnitDTO]',
        base_name => 'units',
