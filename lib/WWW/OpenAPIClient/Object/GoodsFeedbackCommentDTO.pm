...
#
package WWW::OpenAPIClient::Object::GoodsFeedbackCommentDTO;
...
__PACKAGE__->class_documentation({description => 'Комментарий к отзыву.',
...
__PACKAGE__->method_documentation({
    ...
    'author' => {
        datatype => 'GoodsFeedbackCommentAuthorDTO',
        base_name => 'author',
        description => '',
        format => '',
        read_only => '',
    ...
    'status' => {
        datatype => 'GoodsFeedbackCommentStatusType',
        base_name => 'status',
        description => '',
        format => '',
        read_only => '',
