...
#
package WWW::OpenAPIClient::Object::GetOutletsResponse;
...
__PACKAGE__->class_documentation({description => 'Ответ на запрос информации о точках продаж.',
