...
#
package WWW::OpenAPIClient::Object::UpdatePromoOfferParamsDTO;
...
__PACKAGE__->class_documentation({description => 'Параметры товара, который участвует в акции.',
...
__PACKAGE__->method_documentation({
    'discount_params' => {
        datatype => 'UpdatePromoOfferDiscountParamsDTO',
