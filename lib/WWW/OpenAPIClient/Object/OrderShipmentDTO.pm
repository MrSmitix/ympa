...
#
package WWW::OpenAPIClient::Object::OrderShipmentDTO;
...
__PACKAGE__->class_documentation({description => 'Список посылок.  В параметре может указываться несколько посылок. ',
...
__PACKAGE__->method_documentation({
    ...
    'tracks' => {
        ...
        base_name => 'tracks',
        description => '**Только для модели DBS**  Информация для отслеживания перемещений посылки. ',
        format => '',
        read_only => '',
            },
    'boxes' => {
        datatype => 'ARRAY[OrderParcelBoxDTO]',
        base_name => 'boxes',
