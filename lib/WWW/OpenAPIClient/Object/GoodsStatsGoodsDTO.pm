...
#
package WWW::OpenAPIClient::Object::GoodsStatsGoodsDTO;
...
__PACKAGE__->class_documentation({description => 'Информация о товаре.',
...
__PACKAGE__->method_documentation({
    ...
    'weight_dimensions' => {
        datatype => 'GoodsStatsWeightDimensionsDTO',
    ...
    'warehouses' => {
        datatype => 'ARRAY[GoodsStatsWarehouseDTO]',
        base_name => 'warehouses',
        description => 'Информация о складах, на которых хранится товар.  Параметр не приходит, если товара нет ни на одном складе. ',
        format => '',
        read_only => '',
            },
    'tariffs' => {
        datatype => 'ARRAY[TariffDTO]',
        base_name => 'tariffs',
