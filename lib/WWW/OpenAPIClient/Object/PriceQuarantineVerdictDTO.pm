...
#
package WWW::OpenAPIClient::Object::PriceQuarantineVerdictDTO;
...
__PACKAGE__->class_documentation({description => 'Причина попадания товара в карантин.',
...
__PACKAGE__->method_documentation({
    'type' => {
        datatype => 'PriceQuarantineVerdictType',
        base_name => 'type',
        description => '',
        format => '',
        read_only => '',
    ...
    'params' => {
        datatype => 'ARRAY[PriceQuarantineVerdictParameterDTO]',
        base_name => 'params',
