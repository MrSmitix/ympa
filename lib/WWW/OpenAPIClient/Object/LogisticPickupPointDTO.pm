...
#
package WWW::OpenAPIClient::Object::LogisticPickupPointDTO;
...
__PACKAGE__->class_documentation({description => 'Описание пункта вывоза для возврата.',
