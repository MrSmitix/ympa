...
#
package WWW::OpenAPIClient::Object::GetWarehouseStocksDTO;
...
__PACKAGE__->class_documentation({description => 'Список складов с информацией об остатках на каждом из них.',
...
__PACKAGE__->method_documentation({
    ...
    'warehouses' => {
        datatype => 'ARRAY[WarehouseOffersDTO]',
