...
#
package WWW::OpenAPIClient::Object::PriceSuggestOfferDTO;
...
__PACKAGE__->class_documentation({description => 'Товар с ценами для продвижения.',
...
__PACKAGE__->method_documentation({
    ...
    'price_suggestion' => {
        datatype => 'ARRAY[PriceSuggestDTO]',
        base_name => 'priceSuggestion',
