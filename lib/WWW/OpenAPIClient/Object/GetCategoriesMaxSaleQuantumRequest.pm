...
#
package WWW::OpenAPIClient::Object::GetCategoriesMaxSaleQuantumRequest;
...
__PACKAGE__->class_documentation({description => 'Список категорий, для которых нужно вернуть лимит на установку кванта и минимального количества товаров. ',
