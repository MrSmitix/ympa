...
#
package WWW::OpenAPIClient::Object::GenerateReportDTO;
...
__PACKAGE__->class_documentation({description => 'Идентификатор, который понадобится для отслеживания статуса генерации и получения готового отчета.',
