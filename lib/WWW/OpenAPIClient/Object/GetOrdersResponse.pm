...
#
package WWW::OpenAPIClient::Object::GetOrdersResponse;
...
__PACKAGE__->class_documentation({description => 'Модель для ответа API списка информации по заказам.',
