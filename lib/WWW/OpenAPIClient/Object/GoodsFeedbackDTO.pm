...
#
package WWW::OpenAPIClient::Object::GoodsFeedbackDTO;
...
__PACKAGE__->class_documentation({description => 'Отзыв о товаре.',
...
__PACKAGE__->method_documentation({
    ...
    'need_reaction' => {
        datatype => 'boolean',
        base_name => 'needReaction',
        description => 'Нужен ли ответ на отзыв.',
        format => '',
        read_only => '',
            },
    'identifiers' => {
        datatype => 'GoodsFeedbackIdentifiersDTO',
        base_name => 'identifiers',
        description => '',
        format => '',
        read_only => '',
            },
    ...
    'description' => {
        datatype => 'GoodsFeedbackDescriptionDTO',
    ...
    'media' => {
        datatype => 'GoodsFeedbackMediaDTO',
        base_name => 'media',
        description => '',
        format => '',
        read_only => '',
    ...
    'statistics' => {
        datatype => 'GoodsFeedbackStatisticsDTO',
