...
#
package WWW::OpenAPIClient::Object::GetPromoOffersResultDTO;
...
__PACKAGE__->class_documentation({description => 'Список товаров, которые участвуют или могут участвовать в акции.',
...
__PACKAGE__->method_documentation({
    'offers' => {
        datatype => 'ARRAY[GetPromoOfferDTO]',
        base_name => 'offers',
