...
#
package WWW::OpenAPIClient::Object::UpdateOrderItemRequest;
...
__PACKAGE__->class_documentation({description => 'Запрос на обновление состава заказа.',
...
__PACKAGE__->method_documentation({
    'items' => {
        datatype => 'ARRAY[OrderItemModificationDTO]',
        base_name => 'items',
    ...
    'reason' => {
        datatype => 'OrderItemsModificationRequestReasonType',
        base_name => 'reason',
        description => '',
        format => '',
        read_only => '',
