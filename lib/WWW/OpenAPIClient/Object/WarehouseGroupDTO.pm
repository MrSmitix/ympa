...
#
package WWW::OpenAPIClient::Object::WarehouseGroupDTO;
...
__PACKAGE__->class_documentation({description => 'Информация о группе складов.',
...
__PACKAGE__->method_documentation({
    ...
    'main_warehouse' => {
        datatype => 'WarehouseDTO',
        base_name => 'mainWarehouse',
        description => '',
        format => '',
        read_only => '',
            },
