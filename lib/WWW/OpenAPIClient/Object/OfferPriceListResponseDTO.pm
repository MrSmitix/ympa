...
#
package WWW::OpenAPIClient::Object::OfferPriceListResponseDTO;
...
__PACKAGE__->class_documentation({description => 'Список цен на товары.',
...
__PACKAGE__->method_documentation({
    'offers' => {
        datatype => 'ARRAY[OfferPriceResponseDTO]',
        base_name => 'offers',
