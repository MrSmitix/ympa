...
#
package WWW::OpenAPIClient::Object::ParcelBoxLabelDTO;
...
__PACKAGE__->class_documentation({description => 'Информация о ярлыке для коробки.',
