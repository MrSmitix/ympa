...
#
package WWW::OpenAPIClient::Object::GetCampaignOfferDTO;
...
__PACKAGE__->class_documentation({description => 'Параметры размещения товара в магазине.',
...
__PACKAGE__->method_documentation({
    ...
    'campaign_price' => {
        datatype => 'GetPriceWithVatDTO',
        base_name => 'campaignPrice',
        description => '',
        format => '',
        read_only => '',
            },
    'status' => {
        datatype => 'OfferCampaignStatusType',
        base_name => 'status',
        description => '',
        format => '',
        read_only => '',
