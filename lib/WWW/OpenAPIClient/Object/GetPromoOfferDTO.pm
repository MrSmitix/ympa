...
#
package WWW::OpenAPIClient::Object::GetPromoOfferDTO;
...
__PACKAGE__->class_documentation({description => 'Товар, который участвует или может участвовать в акции.',
...
__PACKAGE__->method_documentation({
    ...
    'status' => {
        datatype => 'PromoOfferParticipationStatusType',
        base_name => 'status',
        description => '',
        format => '',
        read_only => '',
    ...
    'params' => {
        datatype => 'PromoOfferParamsDTO',
        base_name => 'params',
        description => '',
        format => '',
        read_only => '',
            },
    'auto_participating_details' => {
        datatype => 'PromoOfferAutoParticipatingDetailsDTO',
        base_name => 'autoParticipatingDetails',
        description => '',
        format => '',
        read_only => '',
            },
