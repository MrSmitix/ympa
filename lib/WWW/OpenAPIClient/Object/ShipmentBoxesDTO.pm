...
#
package WWW::OpenAPIClient::Object::ShipmentBoxesDTO;
...
__PACKAGE__->class_documentation({description => 'В ответе Маркет возвращает переданный вами список грузовых мест. Не обращайте на это поле внимания. ',
