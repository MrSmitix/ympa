...
#
package WWW::OpenAPIClient::Object::CategoryParameterDTO;
...
__PACKAGE__->class_documentation({description => 'Характеристика товара.',
...
__PACKAGE__->method_documentation({
    ...
    'unit' => {
        datatype => 'CategoryParameterUnitDTO',
        base_name => 'unit',
        description => '',
        format => '',
        read_only => '',
    ...
    'recommendation_types' => {
        datatype => 'ARRAY[OfferCardRecommendationType]',
        base_name => 'recommendationTypes',
    ...
    'values' => {
        datatype => 'ARRAY[ParameterValueOptionDTO]',
        base_name => 'values',
    ...
    'constraints' => {
        datatype => 'ParameterValueConstraintsDTO',
    ...
    'value_restrictions' => {
        datatype => 'ARRAY[ValueRestrictionDTO]',
        base_name => 'valueRestrictions',
