...
#
package WWW::OpenAPIClient::Object::SuggestOfferPriceDTO;
...
__PACKAGE__->class_documentation({description => 'Товар, для которого требуется получить цены для продвижения.',
