...
#
package WWW::OpenAPIClient::Object::WarningPromoOfferUpdateDTO;
...
__PACKAGE__->class_documentation({description => 'Описание предупреждения, которое появилось при добавлении товара.',
...
__PACKAGE__->method_documentation({
    ...
    'warnings' => {
        datatype => 'ARRAY[PromoOfferUpdateWarningDTO]',
        base_name => 'warnings',
