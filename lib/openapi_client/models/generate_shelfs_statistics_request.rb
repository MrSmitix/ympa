  ...
  class GenerateShelfsStatisticsRequest
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::GenerateShelfsStatisticsRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::GenerateShelfsStatisticsRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @attribution_type.nil?
        invalid_properties.push('invalid value for "attribution_type", attribution_type cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @attribution_type.nil?
      true
    end
    ...
    def hash
      [business_id, date_from, date_to, attribution_type].hash
    end
