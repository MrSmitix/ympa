...
module OpenapiClient
  ...
  class PriceSuggestOfferDTO
    ...
    attr_accessor :price_suggestion
    ...
    def self.openapi_types
      {
        :'market_sku' => :'Integer',
        :'offer_id' => :'String',
        :'price_suggestion' => :'Array<PriceSuggestDTO>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::PriceSuggestOfferDTO` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::PriceSuggestOfferDTO`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'price_suggestion')
        if (value = attributes[:'price_suggestion']).is_a?(Array)
          self.price_suggestion = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          offer_id == o.offer_id &&
          price_suggestion == o.price_suggestion
    end
    ...
    def hash
      [market_sku, offer_id, price_suggestion].hash
    end
