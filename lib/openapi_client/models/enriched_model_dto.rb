  ...
  class EnrichedModelDTO
    ...
    def self.openapi_types
      {
        ...
        :'offline_offers' => :'Integer',
        :'online_offers' => :'Integer'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::EnrichedModelDTO` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::EnrichedModelDTO`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'offline_offers')
        self.offline_offers = attributes[:'offline_offers']
      end

      if attributes.key?(:'online_offers')
        self.online_offers = attributes[:'online_offers']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          prices == o.prices &&
          offers == o.offers &&
          offline_offers == o.offline_offers &&
          online_offers == o.online_offers
    end
    ...
    def hash
      [id, name, prices, offers, offline_offers, online_offers].hash
    end
