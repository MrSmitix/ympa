  ...
  class OrderItemInstanceDTO
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::OrderItemInstanceDTO` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::OrderItemInstanceDTO`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'cis_full')
        self.cis_full = attributes[:'cis_full']
      end
      ...
      if attributes.key?(:'rnpt')
        self.rnpt = attributes[:'rnpt']
      end

      if attributes.key?(:'gtd')
        self.gtd = attributes[:'gtd']
      end
    end
    ...
    def hash
      [cis, cis_full, uin, rnpt, gtd].hash
    end
