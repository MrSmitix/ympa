...
module OpenapiClient
  ...
  class OfferRecommendationInfoDTO
    ...
    attr_accessor :recommended_cofinance_price

    attr_accessor :competitiveness_thresholds
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::OfferRecommendationInfoDTO` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::OfferRecommendationInfoDTO`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'recommended_cofinance_price')
        self.recommended_cofinance_price = attributes[:'recommended_cofinance_price']
      end

      if attributes.key?(:'competitiveness_thresholds')
        self.competitiveness_thresholds = attributes[:'competitiveness_thresholds']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          offer_id == o.offer_id &&
          recommended_cofinance_price == o.recommended_cofinance_price &&
          competitiveness_thresholds == o.competitiveness_thresholds
    end
    ...
    def hash
      [offer_id, recommended_cofinance_price, competitiveness_thresholds].hash
    end
