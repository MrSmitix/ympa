  ...
  class EnrichedMappingsOfferDTO
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::EnrichedMappingsOfferDTO` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::EnrichedMappingsOfferDTO`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'market_category_name')
        self.market_category_name = attributes[:'market_category_name']
      end

      if attributes.key?(:'market_model_id')
        self.market_model_id = attributes[:'market_model_id']
      end

      if attributes.key?(:'market_model_name')
        self.market_model_name = attributes[:'market_model_name']
      end
      ...
      if attributes.key?(:'market_sku_name')
        self.market_sku_name = attributes[:'market_sku_name']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          market_category_name == o.market_category_name &&
          market_model_id == o.market_model_id &&
          market_model_name == o.market_model_name &&
          market_sku == o.market_sku &&
          market_sku_name == o.market_sku_name
    end
