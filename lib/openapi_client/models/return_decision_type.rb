...
module OpenapiClient
  class ReturnDecisionType
    ...
    def self.all_vars
      @all_vars ||= [REFUND_MONEY, REFUND_MONEY_INCLUDING_SHIPMENT, REPAIR, REPLACE, SEND_TO_EXAMINATION, DECLINE_REFUND, OTHER_DECISION, UNKNOWN].freeze
    end
    ...
    def build_from_hash(value)
      return value if ReturnDecisionType.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #ReturnDecisionType"
    end
  end
end
