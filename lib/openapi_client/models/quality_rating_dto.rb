  ...
  class QualityRatingDTO
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::QualityRatingDTO` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::QualityRatingDTO`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'calculation_date')
        self.calculation_date = attributes[:'calculation_date']
      else
        self.calculation_date = nil
      end
    ...
    def list_invalid_properties
      ...
      if @calculation_date.nil?
        invalid_properties.push('invalid value for "calculation_date", calculation_date cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @calculation_date.nil?
