...
module OpenapiClient
  ...
  class WarehouseOfferDTO
    ...
    attr_accessor :turnover_summary
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::WarehouseOfferDTO` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::WarehouseOfferDTO`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'turnover_summary')
        self.turnover_summary = attributes[:'turnover_summary']
      end
    ...
    def list_invalid_properties
      ...
      if @stocks.nil?
        invalid_properties.push('invalid value for "stocks", stocks cannot be nil.')
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          offer_id == o.offer_id &&
          turnover_summary == o.turnover_summary &&
          stocks == o.stocks &&
    ...
    def hash
      [offer_id, turnover_summary, stocks, updated_at].hash
    end
