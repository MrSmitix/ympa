  ...
  class GetOrdersStatsRequest
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::GetOrdersStatsRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::GetOrdersStatsRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'update_from')
        self.update_from = attributes[:'update_from']
      end

      if attributes.key?(:'update_to')
        self.update_to = attributes[:'update_to']
      end
      ...
      if attributes.key?(:'has_cis')
        self.has_cis = attributes[:'has_cis']
      end
    end
