...
class DbsApi extends Controller
{
    /**
     * Constructor
     */
    ...
    public function getCampaigns()
    {
        ...
        //not path params validation
        if ($input['page'] > 10000) {
            throw new \InvalidArgumentException('invalid value for $page when calling DbsApi.getCampaigns, must be smaller than or equal to 10000.');
        }
        $page = $input['page'];
     ...
     * @return Http response
     */
    public function createOutlet($campaign_id)
    {
        $input = Request::all();
     ...
     * @return Http response
     */
    public function getOutlets($campaign_id)
    {
        $input = Request::all();
     ...
     * @return Http response
     */
    public function deleteOutlet($campaign_id, $outlet_id)
    {
        $input = Request::all();
     ...
     * @return Http response
     */
    public function getOutlet($campaign_id, $outlet_id)
    {
        $input = Request::all();
     ...
     * @return Http response
     */
    public function updateOutlet($campaign_id, $outlet_id)
    {
        $input = Request::all();
    ...
    public function searchModels()
    {
        ...
        if ($input['page'] > 10000) {
            throw new \InvalidArgumentException('invalid value for $page when calling DbsApi.searchModels, must be smaller than or equal to 10000.');
        }
        $page = $input['page'];
    ...
    public function getModel($model_id)
    {
        ...
        //path params validation
        if ($model_id <= 0) {
            throw new \InvalidArgumentException('invalid value for $model_id when calling DbsApi.getModel, must be bigger than 0.');
        }
    ...
    public function getModelOffers($model_id)
    {
        ...
        //path params validation
        if ($model_id <= 0) {
            throw new \InvalidArgumentException('invalid value for $model_id when calling DbsApi.getModelOffers, must be bigger than 0.');
        }
