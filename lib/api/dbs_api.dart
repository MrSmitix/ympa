...
class DbsApi {
  DbsApi([ApiClient? apiClient]) : apiClient = apiClient ?? defaultApiClient;
  ...
  Future<Response> acceptOrderCancellationWithHttpInfo(int campaignId, int orderId, AcceptOrderCancellationRequest acceptOrderCancellationRequest,) async {
    // ignore: prefer_const_declarations
    final path = r'/campaigns/{campaignId}/orders/{orderId}/cancellation/accept'
  ...
  ///
  /// * [AcceptOrderCancellationRequest] acceptOrderCancellationRequest (required):
  Future<EmptyApiResponse?> acceptOrderCancellation(int campaignId, int orderId, AcceptOrderCancellationRequest acceptOrderCancellationRequest,) async {
    final response = await acceptOrderCancellationWithHttpInfo(campaignId, orderId, acceptOrderCancellationRequest,);
  ...
  Future<Response> deleteOutletLicensesWithHttpInfo(int campaignId, { Set<int>? ids, }) async {
    // ignore: prefer_const_declarations
    final path = r'/campaigns/{campaignId}/outlets/licenses'
      .replaceAll('{campaignId}', campaignId.toString());
  ...
  Future<EmptyApiResponse?> deleteOutletLicenses(int campaignId, { Set<int>? ids, }) async {
    final response = await deleteOutletLicensesWithHttpInfo(campaignId,  ids: ids, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  /// * [int] orderId (required):
  ///   Идентификатор заказа.
  Future<Response> getOrderBuyerInfoWithHttpInfo(int campaignId, int orderId,) async {
    // ignore: prefer_const_declarations
    final path = r'/campaigns/{campaignId}/orders/{orderId}/buyer'
      .replaceAll('{campaignId}', campaignId.toString())
      .replaceAll('{orderId}', orderId.toString());
  ...
  Future<GetOrderBuyerInfoResponse?> getOrderBuyerInfo(int campaignId, int orderId,) async {
    final response = await getOrderBuyerInfoWithHttpInfo(campaignId, orderId,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'GetOrderBuyerInfoResponse',) as GetOrderBuyerInfoResponse;
  ...
  /// * [Set<int>] ids:
  ///   Список идентификаторов лицензий.
  Future<Response> getOutletLicensesWithHttpInfo(int campaignId, { Set<int>? outletIds, Set<int>? ids, }) async {
    // ignore: prefer_const_declarations
    final path = r'/campaigns/{campaignId}/outlets/licenses'
      .replaceAll('{campaignId}', campaignId.toString());
    ...
    if (outletIds != null) {
      queryParams.addAll(_queryParams('csv', 'outletIds', outletIds));
    }
    if (ids != null) {
      queryParams.addAll(_queryParams('csv', 'ids', ids));
    }
  ...
  Future<GetOutletLicensesResponse?> getOutletLicenses(int campaignId, { Set<int>? outletIds, Set<int>? ids, }) async {
    final response = await getOutletLicensesWithHttpInfo(campaignId,  outletIds: outletIds, ids: ids, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'GetOutletLicensesResponse',) as GetOutletLicensesResponse;
  ...
  Future<Response> provideOrderDigitalCodesWithHttpInfo(int campaignId, int orderId, ProvideOrderDigitalCodesRequest provideOrderDigitalCodesRequest,) async {
    // ignore: prefer_const_declarations
    final path = r'/campaigns/{campaignId}/orders/{orderId}/deliverDigitalGoods'
      .replaceAll('{campaignId}', campaignId.toString())
      .replaceAll('{orderId}', orderId.toString());
  ...
  ///
  /// * [ProvideOrderDigitalCodesRequest] provideOrderDigitalCodesRequest (required):
  Future<EmptyApiResponse?> provideOrderDigitalCodes(int campaignId, int orderId, ProvideOrderDigitalCodesRequest provideOrderDigitalCodesRequest,) async {
    final response = await provideOrderDigitalCodesWithHttpInfo(campaignId, orderId, provideOrderDigitalCodesRequest,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  Future<Response> setOrderDeliveryDateWithHttpInfo(int campaignId, int orderId, SetOrderDeliveryDateRequest setOrderDeliveryDateRequest,) async {
    // ignore: prefer_const_declarations
    final path = r'/campaigns/{campaignId}/orders/{orderId}/delivery/date'
      .replaceAll('{campaignId}', campaignId.toString())
      .replaceAll('{orderId}', orderId.toString());
  ...
  Future<EmptyApiResponse?> setOrderDeliveryDate(int campaignId, int orderId, SetOrderDeliveryDateRequest setOrderDeliveryDateRequest,) async {
    final response = await setOrderDeliveryDateWithHttpInfo(campaignId, orderId, setOrderDeliveryDateRequest,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  Future<Response> setOrderDeliveryTrackCodeWithHttpInfo(int campaignId, int orderId, SetOrderDeliveryTrackCodeRequest setOrderDeliveryTrackCodeRequest,) async {
    // ignore: prefer_const_declarations
    final path = r'/campaigns/{campaignId}/orders/{orderId}/delivery/track'
      .replaceAll('{campaignId}', campaignId.toString())
      .replaceAll('{orderId}', orderId.toString());
  ...
  Future<EmptyApiResponse?> setOrderDeliveryTrackCode(int campaignId, int orderId, SetOrderDeliveryTrackCodeRequest setOrderDeliveryTrackCodeRequest,) async {
    final response = await setOrderDeliveryTrackCodeWithHttpInfo(campaignId, orderId, setOrderDeliveryTrackCodeRequest,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  Future<Response> updateOrderStorageLimitWithHttpInfo(int campaignId, int orderId, UpdateOrderStorageLimitRequest updateOrderStorageLimitRequest,) async {
    // ignore: prefer_const_declarations
    final path = r'/campaigns/{campaignId}/orders/{orderId}/delivery/storage-limit'
      .replaceAll('{campaignId}', campaignId.toString())
      .replaceAll('{orderId}', orderId.toString());
  ...
  Future<EmptyApiResponse?> updateOrderStorageLimit(int campaignId, int orderId, UpdateOrderStorageLimitRequest updateOrderStorageLimitRequest,) async {
    final response = await updateOrderStorageLimitWithHttpInfo(campaignId, orderId, updateOrderStorageLimitRequest,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  Future<Response> updateOutletLicensesWithHttpInfo(int campaignId, UpdateOutletLicenseRequest updateOutletLicenseRequest,) async {
    // ignore: prefer_const_declarations
    final path = r'/campaigns/{campaignId}/outlets/licenses'
      .replaceAll('{campaignId}', campaignId.toString());
  ...
  Future<EmptyApiResponse?> updateOutletLicenses(int campaignId, UpdateOutletLicenseRequest updateOutletLicenseRequest,) async {
    final response = await updateOutletLicensesWithHttpInfo(campaignId, updateOutletLicenseRequest,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
