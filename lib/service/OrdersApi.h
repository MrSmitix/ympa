#ifndef TINY_CPP_CLIENT_OrdersApi_H_
#define TINY_CPP_CLIENT_OrdersApi_H_
...
class OrdersApi : public Service {
public:
    OrdersApi() = default;

    virtual ~OrdersApi() = default;
...
#endif /* TINY_CPP_CLIENT_OrdersApi_H_ */