#ifndef TINY_CPP_CLIENT_OrderDeliveryApi_H_
#define TINY_CPP_CLIENT_OrderDeliveryApi_H_
...
class OrderDeliveryApi : public Service {
public:
    OrderDeliveryApi() = default;

    virtual ~OrderDeliveryApi() = default;
...
#endif /* TINY_CPP_CLIENT_OrderDeliveryApi_H_ */