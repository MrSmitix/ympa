#ifndef TINY_CPP_CLIENT_OfferMappingsApi_H_
#define TINY_CPP_CLIENT_OfferMappingsApi_H_
...
class OfferMappingsApi : public Service {
public:
    OfferMappingsApi() = default;

    virtual ~OfferMappingsApi() = default;
...
#endif /* TINY_CPP_CLIENT_OfferMappingsApi_H_ */