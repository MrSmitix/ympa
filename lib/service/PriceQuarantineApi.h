#ifndef TINY_CPP_CLIENT_PriceQuarantineApi_H_
#define TINY_CPP_CLIENT_PriceQuarantineApi_H_
...
class PriceQuarantineApi : public Service {
public:
    PriceQuarantineApi() = default;

    virtual ~PriceQuarantineApi() = default;
...
#endif /* TINY_CPP_CLIENT_PriceQuarantineApi_H_ */