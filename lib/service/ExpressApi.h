#ifndef TINY_CPP_CLIENT_ExpressApi_H_
#define TINY_CPP_CLIENT_ExpressApi_H_
...
class ExpressApi : public Service {
public:
    ExpressApi() = default;

    virtual ~ExpressApi() = default;
...
#endif /* TINY_CPP_CLIENT_ExpressApi_H_ */