#ifndef TINY_CPP_CLIENT_FeedsApi_H_
#define TINY_CPP_CLIENT_FeedsApi_H_
...
class FeedsApi : public Service {
public:
    FeedsApi() = default;

    virtual ~FeedsApi() = default;
...
#endif /* TINY_CPP_CLIENT_FeedsApi_H_ */