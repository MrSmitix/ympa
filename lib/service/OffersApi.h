#ifndef TINY_CPP_CLIENT_OffersApi_H_
#define TINY_CPP_CLIENT_OffersApi_H_
...
class OffersApi : public Service {
public:
    OffersApi() = default;

    virtual ~OffersApi() = default;
...
#endif /* TINY_CPP_CLIENT_OffersApi_H_ */