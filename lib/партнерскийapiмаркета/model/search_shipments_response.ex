...
defmodule ПартнерскийAPIМаркета.Model.SearchShipmentsResponse do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :result => ПартнерскийAPIМаркета.Model.SearchShipmentsResponseDto.t | nil
  }
  ...
  def decode(value) do
    value
     ...
     |> Deserializer.deserialize(:result, :struct, ПартнерскийAPIМаркета.Model.SearchShipmentsResponseDto)
  end
end
