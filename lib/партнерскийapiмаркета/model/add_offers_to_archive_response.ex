...
defmodule ПартнерскийAPIМаркета.Model.AddOffersToArchiveResponse do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :result => ПартнерскийAPIМаркета.Model.AddOffersToArchiveDto.t | nil
  }
  ...
  def decode(value) do
    value
     ...
     |> Deserializer.deserialize(:result, :struct, ПартнерскийAPIМаркета.Model.AddOffersToArchiveDto)
  end
end
