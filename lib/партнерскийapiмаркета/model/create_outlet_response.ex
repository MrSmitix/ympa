...
defmodule ПартнерскийAPIМаркета.Model.CreateOutletResponse do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :result => ПартнерскийAPIМаркета.Model.OutletResponseDto.t | nil
  }
  ...
  def decode(value) do
    value
     ...
     |> Deserializer.deserialize(:result, :struct, ПартнерскийAPIМаркета.Model.OutletResponseDto)
  end
end
