...
defmodule ПартнерскийAPIМаркета.Model.GetQuarantineOffersResponse do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :result => ПартнерскийAPIМаркета.Model.GetQuarantineOffersResultDto.t | nil
  }
  ...
  def decode(value) do
    value
     ...
     |> Deserializer.deserialize(:result, :struct, ПартнерскийAPIМаркета.Model.GetQuarantineOffersResultDto)
  end
end
