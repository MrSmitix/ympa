...
defmodule ПартнерскийAPIМаркета.Model.GetCampaignOffersResponse do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :result => ПартнерскийAPIМаркета.Model.GetCampaignOffersResultDto.t | nil
  }
  ...
  def decode(value) do
    value
     ...
     |> Deserializer.deserialize(:result, :struct, ПартнерскийAPIМаркета.Model.GetCampaignOffersResultDto)
  end
end
