...
defmodule ПартнерскийAPIМаркета.Model.GetOfferMappingEntriesResponse do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :result => ПартнерскийAPIМаркета.Model.OfferMappingEntriesDto.t | nil
  }
  ...
  def decode(value) do
    value
     ...
     |> Deserializer.deserialize(:result, :struct, ПартнерскийAPIМаркета.Model.OfferMappingEntriesDto)
  end
end
