...
defmodule ПартнерскийAPIМаркета.Model.GetHiddenOffersResponse do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :result => ПартнерскийAPIМаркета.Model.GetHiddenOffersResultDto.t | nil
  }
  ...
  def decode(value) do
    value
     ...
     |> Deserializer.deserialize(:result, :struct, ПартнерскийAPIМаркета.Model.GetHiddenOffersResultDto)
  end
end
