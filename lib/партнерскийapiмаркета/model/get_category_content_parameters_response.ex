...
defmodule ПартнерскийAPIМаркета.Model.GetCategoryContentParametersResponse do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :result => ПартнерскийAPIМаркета.Model.CategoryContentParametersDto.t | nil
  }
  ...
  def decode(value) do
    value
     ...
     |> Deserializer.deserialize(:result, :struct, ПартнерскийAPIМаркета.Model.CategoryContentParametersDto)
  end
end
