...
defmodule ПартнерскийAPIМаркета.Model.SuggestPricesResponse do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :result => ПартнерскийAPIМаркета.Model.SuggestPricesResultDto.t | nil
  }
  ...
  def decode(value) do
    value
     ...
     |> Deserializer.deserialize(:result, :struct, ПартнерскийAPIМаркета.Model.SuggestPricesResultDto)
  end
end
