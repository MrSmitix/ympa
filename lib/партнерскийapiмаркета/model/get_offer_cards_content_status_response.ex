...
defmodule ПартнерскийAPIМаркета.Model.GetOfferCardsContentStatusResponse do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :result => ПартнерскийAPIМаркета.Model.OfferCardsContentStatusDto.t | nil
  }
  ...
  def decode(value) do
    value
     ...
     |> Deserializer.deserialize(:result, :struct, ПартнерскийAPIМаркета.Model.OfferCardsContentStatusDto)
  end
end
