...
defmodule ПартнерскийAPIМаркета.Connection do
  @moduledoc """
  Handle Tesla connections for ПартнерскийAPIМаркета.

  Additional middleware can be set in the compile-time or runtime configuration:

      config :tesla, ПартнерскийAPIМаркета.Connection,
        base_url: "https://api.partner.market.yandex.ru",
        adapter: Tesla.Adapter.Hackney

  The default base URL can also be set as:

      config :ympa_elixir_client,
        :base_url, "https://api.partner.market.yandex.ru"
  """
  ...
  def middleware(options \\ []) do
    base_url =
      Keyword.get(
        options,
        :base_url,
        Application.get_env(:ympa_elixir_client, :base_url, @default_base_url)
      )
    ...
    user_agent =
      Keyword.get(
        ...
        Keyword.get(
          tesla_options,
          :user_agent,
          "openapi-generator - ПартнерскийAPIМаркета 24.08.29 - elixir"
        )
      )
