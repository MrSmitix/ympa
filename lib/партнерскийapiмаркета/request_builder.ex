...
defmodule ПартнерскийAPIМаркета.RequestBuilder do
  @moduledoc """
  ...
  defp decode(%Tesla.Env{body: body}, %{}) do
    ПартнерскийAPIМаркета.Deserializer.jason_decode(body)
  end

  defp decode(%Tesla.Env{body: body}, module) do
    ПартнерскийAPIМаркета.Deserializer.jason_decode(body, module)
  end
end
