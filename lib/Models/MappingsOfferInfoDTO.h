...
#ifndef TINY_CPP_CLIENT_MappingsOfferInfoDTO_H_
#define TINY_CPP_CLIENT_MappingsOfferInfoDTO_H_
...
/*! \brief Базовая информация о товарах в каталоге.
 *
 *  \ingroup Models
 *
 */
...
public:
    ...
    MappingsOfferInfoDTO(std::string jsonString);


    /*! \brief Destructor.
	 */
    virtual ~MappingsOfferInfoDTO();
...
#endif /* TINY_CPP_CLIENT_MappingsOfferInfoDTO_H_ */
