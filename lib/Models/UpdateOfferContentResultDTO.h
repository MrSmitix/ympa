...
#ifndef TINY_CPP_CLIENT_UpdateOfferContentResultDTO_H_
#define TINY_CPP_CLIENT_UpdateOfferContentResultDTO_H_
...
public:
    ...
    UpdateOfferContentResultDTO(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_UpdateOfferContentResultDTO_H_ */
