...
#ifndef TINY_CPP_CLIENT_OfferProcessingNoteType_H_
#define TINY_CPP_CLIENT_OfferProcessingNoteType_H_
...
public:
    ...
    OfferProcessingNoteType(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_OfferProcessingNoteType_H_ */
