...
#ifndef TINY_CPP_CLIENT_RejectedPromoOfferUpdateDTO_H_
#define TINY_CPP_CLIENT_RejectedPromoOfferUpdateDTO_H_
...
public:
    ...
    RejectedPromoOfferUpdateDTO(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_RejectedPromoOfferUpdateDTO_H_ */
