...
#ifndef TINY_CPP_CLIENT_FullOutletLicenseDTO_H_
#define TINY_CPP_CLIENT_FullOutletLicenseDTO_H_
...
public:
    ...
    FullOutletLicenseDTO(std::string jsonString);


    /*! \brief Destructor.
	 */
    virtual ~FullOutletLicenseDTO();
	...
	/*! \brief Get 
	 */
	LicenseCheckStatusType getCheckStatus();

	/*! \brief Set 
	 */
	void setCheckStatus(LicenseCheckStatusType  checkStatus);
	/*! \brief Get Причина, по которой лицензия не прошла проверку.  Параметр возвращается, только если параметр `checkStatus` имеет значение `FAIL`. 
	 */
	std::string getCheckComment();

	/*! \brief Set Причина, по которой лицензия не прошла проверку.  Параметр возвращается, только если параметр `checkStatus` имеет значение `FAIL`. 
	 */
	void setCheckComment(std::string  checkComment);
    ...
    std::string checkComment{};
};
}

#endif /* TINY_CPP_CLIENT_FullOutletLicenseDTO_H_ */
