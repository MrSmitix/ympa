...
#ifndef TINY_CPP_CLIENT_OrderDeliveryAddressDTO_H_
#define TINY_CPP_CLIENT_OrderDeliveryAddressDTO_H_
...
public:
    ...
    OrderDeliveryAddressDTO(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_OrderDeliveryAddressDTO_H_ */
