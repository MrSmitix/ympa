...
#ifndef TINY_CPP_CLIENT_BaseShipmentDTO_H_
#define TINY_CPP_CLIENT_BaseShipmentDTO_H_
...
public:
	 ...
	 */
    BaseShipmentDTO();
    BaseShipmentDTO(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_BaseShipmentDTO_H_ */
