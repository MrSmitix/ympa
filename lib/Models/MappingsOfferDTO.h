...
#ifndef TINY_CPP_CLIENT_MappingsOfferDTO_H_
#define TINY_CPP_CLIENT_MappingsOfferDTO_H_
...
public:
	 ...
	 */
    MappingsOfferDTO();
    MappingsOfferDTO(std::string jsonString);


    /*! \brief Destructor.
	 */
    virtual ~MappingsOfferDTO();
...
#endif /* TINY_CPP_CLIENT_MappingsOfferDTO_H_ */
