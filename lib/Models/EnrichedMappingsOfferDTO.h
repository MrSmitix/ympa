...
#ifndef TINY_CPP_CLIENT_EnrichedMappingsOfferDTO_H_
#define TINY_CPP_CLIENT_EnrichedMappingsOfferDTO_H_
...
/*! \brief Информация о рекомендованных карточках товаров.
 *
 *  \ingroup Models
 *
 */
...
public:
    ...
    EnrichedMappingsOfferDTO(std::string jsonString);


    /*! \brief Destructor.
	 */
    virtual ~EnrichedMappingsOfferDTO();
	...
	/*! \brief Get Идентификатор категории для рекомендованной карточки товара на Маркете.  Возвращается только вместе с параметром ##marketSku##. 
	 */
	long getMarketCategoryId();

	/*! \brief Set Идентификатор категории для рекомендованной карточки товара на Маркете.  Возвращается только вместе с параметром ##marketSku##. 
	 */
	void setMarketCategoryId(long  marketCategoryId);
	/*! \brief Get Название категории для рекомендованной карточки товара на Маркете.  Может отсутствовать в ответе. 
	 */
	std::string getMarketCategoryName();

	/*! \brief Set Название категории для рекомендованной карточки товара на Маркете.  Может отсутствовать в ответе. 
	 */
	void setMarketCategoryName(std::string  marketCategoryName);
	/*! \brief Get Идентификатор модели для рекомендованной карточки товара на Маркете.  Может отсутствовать в ответе. 
	 */
	long getMarketModelId();

	/*! \brief Set Идентификатор модели для рекомендованной карточки товара на Маркете.  Может отсутствовать в ответе. 
	 */
	void setMarketModelId(long  marketModelId);
	/*! \brief Get Название модели для рекомендованной карточки товара на Маркете.  Возвращается только вместе с параметром ##marketSku##. 
	 */
	std::string getMarketModelName();

	/*! \brief Set Название модели для рекомендованной карточки товара на Маркете.  Возвращается только вместе с параметром ##marketSku##. 
	 */
	...
	/*! \brief Get Название товара с рекомендованной карточки на Маркете.  Может отсутствовать в ответе. 
	 */
	std::string getMarketSkuName();

	/*! \brief Set Название товара с рекомендованной карточки на Маркете.  Может отсутствовать в ответе. 
	 */
...
#endif /* TINY_CPP_CLIENT_EnrichedMappingsOfferDTO_H_ */
