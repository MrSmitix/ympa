...
#ifndef TINY_CPP_CLIENT_OrderDeliveryDispatchType_H_
#define TINY_CPP_CLIENT_OrderDeliveryDispatchType_H_
...
public:
    ...
    OrderDeliveryDispatchType(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_OrderDeliveryDispatchType_H_ */
