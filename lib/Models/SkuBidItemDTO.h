...
#ifndef TINY_CPP_CLIENT_SkuBidItemDTO_H_
#define TINY_CPP_CLIENT_SkuBidItemDTO_H_
...
public:
	 ...
	 */
    SkuBidItemDTO();
    SkuBidItemDTO(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_SkuBidItemDTO_H_ */
