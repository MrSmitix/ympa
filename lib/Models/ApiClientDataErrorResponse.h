...
#ifndef TINY_CPP_CLIENT_ApiClientDataErrorResponse_H_
#define TINY_CPP_CLIENT_ApiClientDataErrorResponse_H_
...
public:
    ...
    ApiClientDataErrorResponse(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_ApiClientDataErrorResponse_H_ */
