...
GetOutletLicensesResponse::GetOutletLicensesResponse(std::string jsonString)
{
...
void
GetOutletLicensesResponse::fromJson(std::string jsonObj)
{
    ...
    if(object.has_key(resultKey))
    {
        ...
        OutletLicensesResponseDTO* obj = &result;
		obj->fromJson(value.dump());
