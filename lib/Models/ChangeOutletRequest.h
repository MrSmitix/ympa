...
#ifndef TINY_CPP_CLIENT_ChangeOutletRequest_H_
#define TINY_CPP_CLIENT_ChangeOutletRequest_H_
...
public:
	 ...
	 */
    ChangeOutletRequest();
    ChangeOutletRequest(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_ChangeOutletRequest_H_ */
