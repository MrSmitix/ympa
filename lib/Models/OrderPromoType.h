...
#ifndef TINY_CPP_CLIENT_OrderPromoType_H_
#define TINY_CPP_CLIENT_OrderPromoType_H_
...
public:
	 ...
	 */
    OrderPromoType();
    OrderPromoType(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_OrderPromoType_H_ */
