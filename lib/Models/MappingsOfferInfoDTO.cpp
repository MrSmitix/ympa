...
MappingsOfferInfoDTO::MappingsOfferInfoDTO(std::string jsonString)
{
...
void
MappingsOfferInfoDTO::fromJson(std::string jsonObj)
{
...
void
MappingsOfferInfoDTO::setFeedId(long  feedId)
{
	this->feedId = feedId;
}
