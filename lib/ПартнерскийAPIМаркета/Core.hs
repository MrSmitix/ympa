...
module ПартнерскийAPIМаркета.Core where
...
-- * ПартнерскийAPIМаркетаConfig

-- |
data ПартнерскийAPIМаркетаConfig = ПартнерскийAPIМаркетаConfig
...
-- | display the config
instance P.Show ПартнерскийAPIМаркетаConfig where
  show c =
    T.printf
...
-- | constructs a default ПартнерскийAPIМаркетаConfig
--
-- configHost:
--
...
-- configUserAgent:
--
-- @"партнерский-api-маркета/0.1.0.0"@
--
newConfig :: IO ПартнерскийAPIМаркетаConfig
newConfig = do
    logCxt <- initLogContext
    return $ ПартнерскийAPIМаркетаConfig
        { configHost = "https://api.partner.market.yandex.ru"
        , configUserAgent = "партнерский-api-маркета/0.1.0.0"
...
addAuthMethod :: AuthMethod auth => ПартнерскийAPIМаркетаConfig -> auth -> ПартнерскийAPIМаркетаConfig
addAuthMethod config@ПартнерскийAPIМаркетаConfig {configAuthMethods = as} a =
  config { configAuthMethods = AnyAuthMethod a : as}

-- | updates the config to use stdout logging
withStdoutLogging :: ПартнерскийAPIМаркетаConfig -> IO ПартнерскийAPIМаркетаConfig
...
withStderrLogging :: ПартнерскийAPIМаркетаConfig -> IO ПартнерскийAPIМаркетаConfig
...
withNoLogging :: ПартнерскийAPIМаркетаConfig -> ПартнерскийAPIМаркетаConfig
withNoLogging p = p { configLogExecWithContext =  runNullLogExec}

-- * ПартнерскийAPIМаркетаRequest
...
data ПартнерскийAPIМаркетаRequest req contentType res accept = ПартнерскийAPIМаркетаRequest
  { rMethod  :: NH.Method   -- ^ Method of ПартнерскийAPIМаркетаRequest
  , rUrlPath :: [BCL.ByteString] -- ^ Endpoint of ПартнерскийAPIМаркетаRequest
  , rParams   :: Params -- ^ params of ПартнерскийAPIМаркетаRequest
  , rAuthTypes :: [P.TypeRep] -- ^ types of auth methods
  }
  deriving (P.Show)

-- | 'rMethod' Lens
rMethodL :: Lens_' (ПартнерскийAPIМаркетаRequest req contentType res accept) NH.Method
rMethodL f ПартнерскийAPIМаркетаRequest{..} = (\rMethod -> ПартнерскийAPIМаркетаRequest { rMethod, ..} ) <$> f rMethod
{-# INLINE rMethodL #-}

-- | 'rUrlPath' Lens
rUrlPathL :: Lens_' (ПартнерскийAPIМаркетаRequest req contentType res accept) [BCL.ByteString]
rUrlPathL f ПартнерскийAPIМаркетаRequest{..} = (\rUrlPath -> ПартнерскийAPIМаркетаRequest { rUrlPath, ..} ) <$> f rUrlPath
{-# INLINE rUrlPathL #-}

-- | 'rParams' Lens
rParamsL :: Lens_' (ПартнерскийAPIМаркетаRequest req contentType res accept) Params
rParamsL f ПартнерскийAPIМаркетаRequest{..} = (\rParams -> ПартнерскийAPIМаркетаRequest { rParams, ..} ) <$> f rParams
{-# INLINE rParamsL #-}

-- | 'rParams' Lens
rAuthTypesL :: Lens_' (ПартнерскийAPIМаркетаRequest req contentType res accept) [P.TypeRep]
rAuthTypesL f ПартнерскийAPIМаркетаRequest{..} = (\rAuthTypes -> ПартнерскийAPIМаркетаRequest { rAuthTypes, ..} ) <$> f rAuthTypes
{-# INLINE rAuthTypesL #-}
...
class HasBodyParam req param where
  setBodyParam :: forall contentType res accept. (Consumes req contentType, MimeRender contentType param) => ПартнерскийAPIМаркетаRequest req contentType res accept -> param -> ПартнерскийAPIМаркетаRequest req contentType res accept
  setBodyParam req xs =
...
class HasOptionalParam req param where
  ...
  applyOptionalParam :: ПартнерскийAPIМаркетаRequest req contentType res accept -> param -> ПартнерскийAPIМаркетаRequest req contentType res accept
  applyOptionalParam = (-&-)
  {-# INLINE applyOptionalParam #-}

  -- | infix operator \/ alias for 'addOptionalParam'
  (-&-) :: ПартнерскийAPIМаркетаRequest req contentType res accept -> param -> ПартнерскийAPIМаркетаRequest req contentType res accept
  (-&-) = applyOptionalParam
  {-# INLINE (-&-) #-}
...
-- ** ПартнерскийAPIМаркетаRequest Utils

_mkRequest :: NH.Method -- ^ Method
          -> [BCL.ByteString] -- ^ Endpoint
          -> ПартнерскийAPIМаркетаRequest req contentType res accept -- ^ req: Request Type, res: Response Type
_mkRequest m u = ПартнерскийAPIМаркетаRequest m u _mkParams []

_mkParams :: Params
_mkParams = Params [] [] ParamBodyNone

setHeader ::
     ПартнерскийAPIМаркетаRequest req contentType res accept
  -> [NH.Header]
  -> ПартнерскийAPIМаркетаRequest req contentType res accept
...
removeHeader :: ПартнерскийAPIМаркетаRequest req contentType res accept -> [NH.HeaderName] -> ПартнерскийAPIМаркетаRequest req contentType res accept
...
_setContentTypeHeader :: forall req contentType res accept. MimeType contentType => ПартнерскийAPIМаркетаRequest req contentType res accept -> ПартнерскийAPIМаркетаRequest req contentType res accept
_setContentTypeHeader req =
    case mimeType (P.Proxy :: P.Proxy contentType) of
        Just m -> req `setHeader` [("content-type", BC.pack $ P.show m)]
        Nothing -> req `removeHeader` ["content-type"]

_setAcceptHeader :: forall req contentType res accept. MimeType accept => ПартнерскийAPIМаркетаRequest req contentType res accept -> ПартнерскийAPIМаркетаRequest req contentType res accept
...
addForm :: ПартнерскийAPIМаркетаRequest req contentType res accept -> WH.Form -> ПартнерскийAPIМаркетаRequest req contentType res accept
addForm req newform =
...
_addMultiFormPart :: ПартнерскийAPIМаркетаRequest req contentType res accept -> NH.Part -> ПартнерскийAPIМаркетаRequest req contentType res accept
...
_setBodyBS :: ПартнерскийAPIМаркетаRequest req contentType res accept -> B.ByteString -> ПартнерскийAPIМаркетаRequest req contentType res accept
_setBodyBS req body =
    req & L.set (rParamsL . paramsBodyL) (ParamBodyB body)

_setBodyLBS :: ПартнерскийAPIМаркетаRequest req contentType res accept -> BL.ByteString -> ПартнерскийAPIМаркетаRequest req contentType res accept
_setBodyLBS req body =
    req & L.set (rParamsL . paramsBodyL) (ParamBodyBL body)

_hasAuthType :: AuthMethod authMethod => ПартнерскийAPIМаркетаRequest req contentType res accept -> P.Proxy authMethod -> ПартнерскийAPIМаркетаRequest req contentType res accept
...
class P.Typeable a =>
  ...
  applyAuthMethod
    ...
    -> a
    -> ПартнерскийAPIМаркетаRequest req contentType res accept
    -> IO (ПартнерскийAPIМаркетаRequest req contentType res accept)
...
_applyAuthMethods
  ...
  -> ПартнерскийAPIМаркетаConfig
  -> IO (ПартнерскийAPIМаркетаRequest req contentType res accept)
_applyAuthMethods req config@(ПартнерскийAPIМаркетаConfig {configAuthMethods = as}) =
  foldlM go req as
  where
