...
module ПартнерскийAPIМаркета.Client where
...
dispatchLbs
  ...
  -> ПартнерскийAPIМаркетаConfig -- ^ config
  -> ПартнерскийAPIМаркетаRequest req contentType res accept -- ^ request
