...
module ПартнерскийAPIМаркета.API.Businesses where
...
getBusinessSettings
  ...
  -> ПартнерскийAPIМаркетаRequest GetBusinessSettings MimeNoContent GetBusinessSettingsResponse MimeJSON
getBusinessSettings (BusinessId businessId) =
  _mkRequest "POST" ["/businesses/",toPath businessId,"/settings"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthOAuthOAuth)

data GetBusinessSettings  
-- | @application/json@
instance Produces GetBusinessSettings MimeJSON
