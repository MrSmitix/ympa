...
module ПартнерскийAPIМаркета.API.GoodsStats where
...
-- 
getGoodsStats
  :: (Consumes GetGoodsStats MimeJSON, MimeRender MimeJSON GetGoodsStatsRequest)
  ...
  -> ПартнерскийAPIМаркетаRequest GetGoodsStats MimeJSON GetGoodsStatsResponse MimeJSON
getGoodsStats getGoodsStatsRequest (CampaignId campaignId) =
...
data GetGoodsStats 
instance HasBodyParam GetGoodsStats GetGoodsStatsRequest 

-- | @application/json@
instance Consumes GetGoodsStats MimeJSON

-- | @application/json@
instance Produces GetGoodsStats MimeJSON
