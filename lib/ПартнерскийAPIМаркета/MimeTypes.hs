...
module ПартнерскийAPIМаркета.MimeTypes where
...
data MimeVndMsExcel = MimeVndMsExcel deriving (P.Typeable)

-- | @application/vnd.ms-excel@
instance MimeType MimeVndMsExcel where
  mimeType _ = Just $ P.fromString "application/vnd.ms-excel"
-- instance MimeRender MimeVndMsExcel T.Text where mimeRender _ = undefined
-- instance MimeUnrender MimeVndMsExcel T.Text where mimeUnrender _ = undefined
