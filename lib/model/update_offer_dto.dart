...
class UpdateOfferDTO {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is UpdateOfferDTO &&
  ...
  /// Returns a new [UpdateOfferDTO] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static UpdateOfferDTO? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "UpdateOfferDTO[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "UpdateOfferDTO[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return UpdateOfferDTO(
        ...
        basicPrice: UpdatePriceWithDiscountDTO.fromJson(json[r'basicPrice']),
        purchasePrice: BasePriceDTO.fromJson(json[r'purchasePrice']),
        additionalExpenses: BasePriceDTO.fromJson(json[r'additionalExpenses']),
        cofinancePrice: BasePriceDTO.fromJson(json[r'cofinancePrice']),
      );
    }
    return null;
  }

  static List<UpdateOfferDTO> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <UpdateOfferDTO>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = UpdateOfferDTO.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, UpdateOfferDTO> mapFromJson(dynamic json) {
    final map = <String, UpdateOfferDTO>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = UpdateOfferDTO.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of UpdateOfferDTO-objects as value to a dart map
  static Map<String, List<UpdateOfferDTO>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<UpdateOfferDTO>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = UpdateOfferDTO.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
