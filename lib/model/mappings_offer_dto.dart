...
class MappingsOfferDTO {
  /// Returns a new [MappingsOfferDTO] instance.
  MappingsOfferDTO({
    this.name,
    this.shopSku,
    this.category,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is MappingsOfferDTO &&
    other.name == name &&
  ...
  /// Returns a new [MappingsOfferDTO] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MappingsOfferDTO? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "MappingsOfferDTO[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "MappingsOfferDTO[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<MappingsOfferDTO> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <MappingsOfferDTO>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MappingsOfferDTO.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MappingsOfferDTO> mapFromJson(dynamic json) {
    final map = <String, MappingsOfferDTO>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MappingsOfferDTO.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of MappingsOfferDTO-objects as value to a dart map
  static Map<String, List<MappingsOfferDTO>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<MappingsOfferDTO>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = MappingsOfferDTO.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
