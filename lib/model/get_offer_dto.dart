...
class GetOfferDTO {
  /// Returns a new [GetOfferDTO] instance.
  GetOfferDTO({
  ...
  List<OfferCampaignStatusDTO>? campaigns;

  /// Информация о том, какие для товара доступны модели размещения. 
  List<OfferSellingProgramDTO>? sellingPrograms;
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is GetOfferDTO &&
    ...
    other.additionalExpenses == additionalExpenses &&
    other.cofinancePrice == cofinancePrice &&
    other.cardStatus == cardStatus &&
    _deepEquality.equals(other.campaigns, campaigns) &&
    _deepEquality.equals(other.sellingPrograms, sellingPrograms) &&
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.additionalExpenses != null) {
      json[r'additionalExpenses'] = this.additionalExpenses;
    } else {
      json[r'additionalExpenses'] = null;
    }
    if (this.cofinancePrice != null) {
      json[r'cofinancePrice'] = this.cofinancePrice;
    } else {
      json[r'cofinancePrice'] = null;
    }
    ...
    if (this.sellingPrograms != null) {
      json[r'sellingPrograms'] = this.sellingPrograms;
    } else {
      json[r'sellingPrograms'] = null;
    }
  ...
  /// Returns a new [GetOfferDTO] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static GetOfferDTO? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "GetOfferDTO[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "GetOfferDTO[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return GetOfferDTO(
        ...
        purchasePrice: GetPriceDTO.fromJson(json[r'purchasePrice']),
        additionalExpenses: GetPriceDTO.fromJson(json[r'additionalExpenses']),
        cofinancePrice: GetPriceDTO.fromJson(json[r'cofinancePrice']),
        cardStatus: OfferCardStatusType.fromJson(json[r'cardStatus']),
        campaigns: OfferCampaignStatusDTO.listFromJson(json[r'campaigns']),
        sellingPrograms: OfferSellingProgramDTO.listFromJson(json[r'sellingPrograms']),
  ...
  static List<GetOfferDTO> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <GetOfferDTO>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = GetOfferDTO.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, GetOfferDTO> mapFromJson(dynamic json) {
    final map = <String, GetOfferDTO>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = GetOfferDTO.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of GetOfferDTO-objects as value to a dart map
  static Map<String, List<GetOfferDTO>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<GetOfferDTO>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = GetOfferDTO.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
