...
class MappingsOfferInfoDTO {
  /// Returns a new [MappingsOfferInfoDTO] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is MappingsOfferInfoDTO &&
    other.name == name &&
  ...
  /// Returns a new [MappingsOfferInfoDTO] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MappingsOfferInfoDTO? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "MappingsOfferInfoDTO[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "MappingsOfferInfoDTO[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return MappingsOfferInfoDTO(
  ...
  static List<MappingsOfferInfoDTO> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <MappingsOfferInfoDTO>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MappingsOfferInfoDTO.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MappingsOfferInfoDTO> mapFromJson(dynamic json) {
    final map = <String, MappingsOfferInfoDTO>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MappingsOfferInfoDTO.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of MappingsOfferInfoDTO-objects as value to a dart map
  static Map<String, List<MappingsOfferInfoDTO>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<MappingsOfferInfoDTO>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = MappingsOfferInfoDTO.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
