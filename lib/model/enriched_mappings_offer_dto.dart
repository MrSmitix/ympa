...
class EnrichedMappingsOfferDTO {
  /// Returns a new [EnrichedMappingsOfferDTO] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is EnrichedMappingsOfferDTO &&
    other.name == name &&
  ...
  /// Returns a new [EnrichedMappingsOfferDTO] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EnrichedMappingsOfferDTO? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "EnrichedMappingsOfferDTO[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "EnrichedMappingsOfferDTO[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return EnrichedMappingsOfferDTO(
  ...
  static List<EnrichedMappingsOfferDTO> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EnrichedMappingsOfferDTO>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EnrichedMappingsOfferDTO.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EnrichedMappingsOfferDTO> mapFromJson(dynamic json) {
    final map = <String, EnrichedMappingsOfferDTO>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EnrichedMappingsOfferDTO.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EnrichedMappingsOfferDTO-objects as value to a dart map
  static Map<String, List<EnrichedMappingsOfferDTO>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EnrichedMappingsOfferDTO>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = EnrichedMappingsOfferDTO.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
