...
class ShipmentInfoDTO {
  /// Returns a new [ShipmentInfoDTO] instance.
  ShipmentInfoDTO({
    this.id,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ShipmentInfoDTO &&
    other.id == id &&
    ...
    other.statusUpdateTime == statusUpdateTime;
  ...
  @override
  String toString() => 'ShipmentInfoDTO[id=$id, planIntervalFrom=$planIntervalFrom, planIntervalTo=$planIntervalTo, shipmentType=$shipmentType, warehouse=$warehouse, warehouseTo=$warehouseTo, externalId=$externalId, deliveryService=$deliveryService, palletsCount=$palletsCount, orderIds=$orderIds, draftCount=$draftCount, plannedCount=$plannedCount, factCount=$factCount, status=$status, statusDescription=$statusDescription, statusUpdateTime=$statusUpdateTime]';
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.statusUpdateTime != null) {
      json[r'statusUpdateTime'] = this.statusUpdateTime!.toUtc().toIso8601String();
    } else {
      json[r'statusUpdateTime'] = null;
    }
    return json;
  }

  /// Returns a new [ShipmentInfoDTO] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ShipmentInfoDTO? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ShipmentInfoDTO[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ShipmentInfoDTO[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return ShipmentInfoDTO(
        ...
        statusUpdateTime: mapDateTime(json, r'statusUpdateTime', r''),
      );
    }
    return null;
  }

  static List<ShipmentInfoDTO> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ShipmentInfoDTO>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ShipmentInfoDTO.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ShipmentInfoDTO> mapFromJson(dynamic json) {
    final map = <String, ShipmentInfoDTO>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ShipmentInfoDTO.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ShipmentInfoDTO-objects as value to a dart map
  static Map<String, List<ShipmentInfoDTO>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ShipmentInfoDTO>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ShipmentInfoDTO.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
