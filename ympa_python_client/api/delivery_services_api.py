...
class DeliveryServicesApi:
    ...
    def get_delivery_services(
        ...
        _param = self._get_delivery_services_serialize(
    ...
    def get_delivery_services_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetDeliveryServicesResponse]:
        """Справочник служб доставки
    ...
    @validate_call
    def get_delivery_services_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_delivery_services_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/delivery/services',
