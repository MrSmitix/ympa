...
class OrderBusinessInformationApi:
    ...
    def get_order_business_buyer_info(
        ...
        _param = self._get_order_business_buyer_info_serialize(
    ...
    @validate_call
    def get_order_business_buyer_info_without_preload_content(
        self,
        campaign_id: Annotated[StrictInt, Field(description="Идентификатор кампании в API и магазина в кабинете. Каждая кампания в API соответствует магазину в кабинете.  Чтобы узнать идентификаторы своих магазинов, воспользуйтесь запросом [GET campaigns](../../reference/campaigns/getCampaigns.md).  ℹ️ [Что такое кабинет и магазин на Маркете](https://yandex.ru/support/marketplace/account/introduction.html) ")],
        order_id: Annotated[StrictInt, Field(description="Идентификатор заказа.")],
        _request_timeout: Union[
    ...
    def _get_order_business_buyer_info_serialize(
        self,
        campaign_id,
        order_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/campaigns/{campaignId}/orders/{orderId}/business-buyer',
    ...
    def get_order_business_documents_info(
        ...
        _param = self._get_order_business_documents_info_serialize(
            campaign_id=campaign_id,
            order_id=order_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_order_business_documents_info_without_preload_content(
        self,
        campaign_id: Annotated[StrictInt, Field(description="Идентификатор кампании в API и магазина в кабинете. Каждая кампания в API соответствует магазину в кабинете.  Чтобы узнать идентификаторы своих магазинов, воспользуйтесь запросом [GET campaigns](../../reference/campaigns/getCampaigns.md).  ℹ️ [Что такое кабинет и магазин на Маркете](https://yandex.ru/support/marketplace/account/introduction.html) ")],
        order_id: Annotated[StrictInt, Field(description="Идентификатор заказа.")],
        _request_timeout: Union[
    ...
    def _get_order_business_documents_info_serialize(
        self,
        campaign_id,
        order_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/campaigns/{campaignId}/orders/{orderId}/documents',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
