...
class WarehouseAddressDTO(BaseModel):
    ...
    Адрес склада.
    """ # noqa: E501
    city: Annotated[str, Field(strict=True, max_length=200)] = Field(description="Город.")
    ...
    gps: GpsDTO
    __properties: ClassVar[List[str]] = ["city", "street", "number", "building", "block", "gps"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "block": obj.get("block"),
            "gps": GpsDTO.from_dict(obj["gps"]) if obj.get("gps") is not None else None
        })
        return _obj
