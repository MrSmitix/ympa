...
class GetOfferDTO(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.selling_programs:
            for _item_selling_programs in self.selling_programs:
                if _item_selling_programs:
                    _items.append(_item_selling_programs.to_dict())
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "basicPrice": GetPriceWithDiscountDTO.from_dict(obj["basicPrice"]) if obj.get("basicPrice") is not None else None,
            "purchasePrice": GetPriceDTO.from_dict(obj["purchasePrice"]) if obj.get("purchasePrice") is not None else None,
            "additionalExpenses": GetPriceDTO.from_dict(obj["additionalExpenses"]) if obj.get("additionalExpenses") is not None else None,
            "cofinancePrice": GetPriceDTO.from_dict(obj["cofinancePrice"]) if obj.get("cofinancePrice") is not None else None,
            "cardStatus": obj.get("cardStatus"),
            "campaigns": [OfferCampaignStatusDTO.from_dict(_item) for _item in obj["campaigns"]] if obj.get("campaigns") is not None else None,
            "sellingPrograms": [OfferSellingProgramDTO.from_dict(_item) for _item in obj["sellingPrograms"]] if obj.get("sellingPrograms") is not None else None,
