...
class UpdateOfferMappingDTO(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "offer": UpdateOfferDTO.from_dict(obj["offer"]) if obj.get("offer") is not None else None,
            "mapping": UpdateMappingDTO.from_dict(obj["mapping"]) if obj.get("mapping") is not None else None
        })
        return _obj
