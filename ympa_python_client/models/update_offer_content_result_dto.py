...
class UpdateOfferContentResultDTO(BaseModel):
    ...
    errors: Optional[List[OfferContentErrorDTO]] = Field(default=None, description="Ошибки — информация в каталоге не обновится.")
    warnings: Optional[List[OfferContentErrorDTO]] = Field(default=None, description="Предупреждения — информация в каталоге обновится.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "errors": [OfferContentErrorDTO.from_dict(_item) for _item in obj["errors"]] if obj.get("errors") is not None else None,
            "warnings": [OfferContentErrorDTO.from_dict(_item) for _item in obj["warnings"]] if obj.get("warnings") is not None else None
        })
        return _obj
