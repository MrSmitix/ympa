...
class ValueRestrictionDTO(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.limited_values:
            for _item_limited_values in self.limited_values:
                if _item_limited_values:
                    _items.append(_item_limited_values.to_dict())
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "limitedValues": [OptionValuesLimitedDTO.from_dict(_item) for _item in obj["limitedValues"]] if obj.get("limitedValues") is not None else None
        })
        return _obj
