...
class GetOfferCardsContentStatusRequest(BaseModel):
    ...
    """ # noqa: E501
    offer_ids: Optional[Annotated[List[Annotated[str, Field(min_length=1, strict=True, max_length=255)]], Field(max_length=200)]] = Field(default=None, description="Идентификаторы товаров, информация о которых нужна. <br><br> ⚠️ Не используйте это поле одновременно с фильтрами по статусам карточек, категориям, брендам или тегам. Если вы хотите воспользоваться фильтрами, оставьте поле пустым. ", alias="offerIds")
    ...
    category_ids: Optional[Annotated[List[StrictInt], Field(max_length=200)]] = Field(default=None, description="Фильтр по категориям на Маркете.", alias="categoryIds")
    __properties: ClassVar[List[str]] = ["offerIds", "cardStatuses", "categoryIds"]
