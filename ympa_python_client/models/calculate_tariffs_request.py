...
class CalculateTariffsRequest(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "parameters": CalculateTariffsParametersDTO.from_dict(obj["parameters"]) if obj.get("parameters") is not None else None,
            "offers": [CalculateTariffsOfferDTO.from_dict(_item) for _item in obj["offers"]] if obj.get("offers") is not None else None
        })
        return _obj
