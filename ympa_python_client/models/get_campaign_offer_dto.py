...
class GetCampaignOfferDTO(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "quantum": QuantumDTO.from_dict(obj["quantum"]) if obj.get("quantum") is not None else None,
            "available": obj.get("available"),
            "basicPrice": GetPriceWithDiscountDTO.from_dict(obj["basicPrice"]) if obj.get("basicPrice") is not None else None,
            "campaignPrice": GetPriceWithVatDTO.from_dict(obj["campaignPrice"]) if obj.get("campaignPrice") is not None else None,
            "status": obj.get("status"),
            "errors": [OfferErrorDTO.from_dict(_item) for _item in obj["errors"]] if obj.get("errors") is not None else None,
            "warnings": [OfferErrorDTO.from_dict(_item) for _item in obj["warnings"]] if obj.get("warnings") is not None else None
        })
        return _obj
