...
class PromoOfferParamsDTO(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "discountParams": PromoOfferDiscountParamsDTO.from_dict(obj["discountParams"]) if obj.get("discountParams") is not None else None,
            "promocodeParams": PromoOfferPromocodeParamsDTO.from_dict(obj["promocodeParams"]) if obj.get("promocodeParams") is not None else None
        })
        return _obj
