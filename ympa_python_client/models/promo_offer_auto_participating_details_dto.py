...
class PromoOfferAutoParticipatingDetailsDTO(BaseModel):
    ...
    """ # noqa: E501
    campaign_ids: Optional[List[StrictInt]] = Field(default=None, description="Магазины, в которых товар добавлен в акцию автоматически.  Возвращается, если статус товара в акции — `PARTIALLY_AUTO`. ", alias="campaignIds")
    __properties: ClassVar[List[str]] = ["campaignIds"]
