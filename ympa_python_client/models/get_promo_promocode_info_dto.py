...
class GetPromoPromocodeInfoDTO(BaseModel):
    ...
    """ # noqa: E501
    promocode: StrictStr = Field(description="Промокод.")
    discount: StrictInt = Field(description="Процент скидки по промокоду.")
    __properties: ClassVar[List[str]] = ["promocode", "discount"]
