...
class ShipmentDTO(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "warehouse": PartnerShipmentWarehouseDTO.from_dict(obj["warehouse"]) if obj.get("warehouse") is not None else None,
            "warehouseTo": PartnerShipmentWarehouseDTO.from_dict(obj["warehouseTo"]) if obj.get("warehouseTo") is not None else None,
            "externalId": obj.get("externalId"),
            "deliveryService": DeliveryServiceDTO.from_dict(obj["deliveryService"]) if obj.get("deliveryService") is not None else None,
            "palletsCount": PalletsCountDTO.from_dict(obj["palletsCount"]) if obj.get("palletsCount") is not None else None,
            "orderIds": obj.get("orderIds"),
            "draftCount": obj.get("draftCount"),
            "plannedCount": obj.get("plannedCount"),
            "factCount": obj.get("factCount"),
            "currentStatus": ShipmentStatusChangeDTO.from_dict(obj["currentStatus"]) if obj.get("currentStatus") is not None else None,
