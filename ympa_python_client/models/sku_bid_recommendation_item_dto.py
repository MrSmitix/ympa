...
class SkuBidRecommendationItemDTO(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.bid_recommendations:
            for _item_bid_recommendations in self.bid_recommendations:
                if _item_bid_recommendations:
                    _items.append(_item_bid_recommendations.to_dict())
        ...
        if self.price_recommendations:
            for _item_price_recommendations in self.price_recommendations:
                if _item_price_recommendations:
                    _items.append(_item_price_recommendations.to_dict())
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "sku": obj.get("sku"),
            "bid": obj.get("bid"),
            "bidRecommendations": [BidRecommendationItemDTO.from_dict(_item) for _item in obj["bidRecommendations"]] if obj.get("bidRecommendations") is not None else None,
            "priceRecommendations": [PriceRecommendationItemDTO.from_dict(_item) for _item in obj["priceRecommendations"]] if obj.get("priceRecommendations") is not None else None
        })
        return _obj
