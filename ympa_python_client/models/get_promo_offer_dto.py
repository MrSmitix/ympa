...
class GetPromoOfferDTO(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "params": PromoOfferParamsDTO.from_dict(obj["params"]) if obj.get("params") is not None else None,
            "autoParticipatingDetails": PromoOfferAutoParticipatingDetailsDTO.from_dict(obj["autoParticipatingDetails"]) if obj.get("autoParticipatingDetails") is not None else None
        })
        return _obj
