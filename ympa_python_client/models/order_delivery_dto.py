...
class OrderDeliveryDTO(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "courier": OrderCourierDTO.from_dict(obj["courier"]) if obj.get("courier") is not None else None,
            "dates": OrderDeliveryDatesDTO.from_dict(obj["dates"]) if obj.get("dates") is not None else None,
            "region": RegionDTO.from_dict(obj["region"]) if obj.get("region") is not None else None,
            "address": OrderDeliveryAddressDTO.from_dict(obj["address"]) if obj.get("address") is not None else None,
            "vat": obj.get("vat"),
            ...
            "shipments": [OrderShipmentDTO.from_dict(_item) for _item in obj["shipments"]] if obj.get("shipments") is not None else None,
