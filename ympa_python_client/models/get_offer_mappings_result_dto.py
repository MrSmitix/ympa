...
class GetOfferMappingsResultDTO(BaseModel):
    """
    Информация о товарах.
    """ # noqa: E501
    paging: Optional[ScrollingPagerDTO] = None
    offer_mappings: List[GetOfferMappingDTO] = Field(description="Информация о товарах.", alias="offerMappings")
    __properties: ClassVar[List[str]] = ["paging", "offerMappings"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "offerMappings": [GetOfferMappingDTO.from_dict(_item) for _item in obj["offerMappings"]] if obj.get("offerMappings") is not None else None
        })
        return _obj
