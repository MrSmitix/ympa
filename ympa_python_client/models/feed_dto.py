...
class FeedDTO(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "url": obj.get("url"),
            "content": FeedContentDTO.from_dict(obj["content"]) if obj.get("content") is not None else None,
            "download": FeedDownloadDTO.from_dict(obj["download"]) if obj.get("download") is not None else None,
            "placement": FeedPlacementDTO.from_dict(obj["placement"]) if obj.get("placement") is not None else None,
            "publication": FeedPublicationDTO.from_dict(obj["publication"]) if obj.get("publication") is not None else None
        })
        return _obj
