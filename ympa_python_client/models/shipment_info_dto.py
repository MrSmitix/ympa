...
class ShipmentInfoDTO(BaseModel):
    ...
    status_update_time: Optional[datetime] = Field(default=None, description="Время последнего изменения статуса отгрузки.", alias="statusUpdateTime")
    __properties: ClassVar[List[str]] = ["id", "planIntervalFrom", "planIntervalTo", "shipmentType", "warehouse", "warehouseTo", "externalId", "deliveryService", "palletsCount", "orderIds", "draftCount", "plannedCount", "factCount", "status", "statusDescription", "statusUpdateTime"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "statusUpdateTime": obj.get("statusUpdateTime")
        })
        return _obj
