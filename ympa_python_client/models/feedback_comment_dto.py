...
class FeedbackCommentDTO(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "author": FeedbackCommentAuthorDTO.from_dict(obj["author"]) if obj.get("author") is not None else None,
            "children": [FeedbackCommentDTO.from_dict(_item) for _item in obj["children"]] if obj.get("children") is not None else None
        })
        return _obj
