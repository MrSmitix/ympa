...
class ReturnItemDTO(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "count": obj.get("count"),
            "decisions": [ReturnDecisionDTO.from_dict(_item) for _item in obj["decisions"]] if obj.get("decisions") is not None else None,
            "instances": [ReturnInstanceDTO.from_dict(_item) for _item in obj["instances"]] if obj.get("instances") is not None else None,
