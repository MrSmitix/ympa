...
class OrdersStatsItemDTO(BaseModel):
    ...
    cis_list: Optional[List[StrictStr]] = Field(default=None, description="Список кодов идентификации товара [в системе «Честный ЗНАК»](https://честныйзнак.рф/).", alias="cisList")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if self.cis_list is None and "cis_list" in self.model_fields_set:
            _dict['cisList'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "count": obj.get("count"),
            "prices": [OrdersStatsPriceDTO.from_dict(_item) for _item in obj["prices"]] if obj.get("prices") is not None else None,
            "warehouse": OrdersStatsWarehouseDTO.from_dict(obj["warehouse"]) if obj.get("warehouse") is not None else None,
            "details": [OrdersStatsDetailsDTO.from_dict(_item) for _item in obj["details"]] if obj.get("details") is not None else None,
