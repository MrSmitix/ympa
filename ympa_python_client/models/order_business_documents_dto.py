...
class OrderBusinessDocumentsDTO(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "upd": DocumentDTO.from_dict(obj["upd"]) if obj.get("upd") is not None else None,
            "ukd": DocumentDTO.from_dict(obj["ukd"]) if obj.get("ukd") is not None else None,
            "torgTwelve": DocumentDTO.from_dict(obj["torgTwelve"]) if obj.get("torgTwelve") is not None else None,
            "sf": DocumentDTO.from_dict(obj["sf"]) if obj.get("sf") is not None else None,
            "ksf": DocumentDTO.from_dict(obj["ksf"]) if obj.get("ksf") is not None else None
        })
        return _obj
