...
class GetWarehouseStocksDTO(BaseModel):
    ...
    warehouses: List[WarehouseOffersDTO] = Field(description="Страница списка складов.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "warehouses": [WarehouseOffersDTO.from_dict(_item) for _item in obj["warehouses"]] if obj.get("warehouses") is not None else None
        })
        return _obj
