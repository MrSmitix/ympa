...
class OfferCardsContentStatusDTO(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        _items = []
        if self.offer_cards:
            for _item_offer_cards in self.offer_cards:
                if _item_offer_cards:
                    _items.append(_item_offer_cards.to_dict())
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "offerCards": [OfferCardDTO.from_dict(_item) for _item in obj["offerCards"]] if obj.get("offerCards") is not None else None,
