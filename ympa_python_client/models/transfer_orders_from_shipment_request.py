...
class TransferOrdersFromShipmentRequest(BaseModel):
    ...
    """ # noqa: E501
    order_ids: Annotated[List[StrictInt], Field(min_length=1, max_length=500)] = Field(description="Список заказов, которые вы не успеваете подготовить.", alias="orderIds")
