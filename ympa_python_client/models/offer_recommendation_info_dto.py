...
class OfferRecommendationInfoDTO(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "recommendedCofinancePrice": BasePriceDTO.from_dict(obj["recommendedCofinancePrice"]) if obj.get("recommendedCofinancePrice") is not None else None,
            "competitivenessThresholds": PriceCompetitivenessThresholdsDTO.from_dict(obj["competitivenessThresholds"]) if obj.get("competitivenessThresholds") is not None else None
        })
        return _obj
