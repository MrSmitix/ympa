...
class GoodsFeedbackMediaDTO(BaseModel):
    ...
    Фото и видео.
    """ # noqa: E501
    photos: Optional[List[StrictStr]] = Field(default=None, description="Ссылки на фото.")
    videos: Optional[List[StrictStr]] = Field(default=None, description="Ссылки на видео.")
    __properties: ClassVar[List[str]] = ["photos", "videos"]
