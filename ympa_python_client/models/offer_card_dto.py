...
class OfferCardDTO(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "mapping": GetMappingDTO.from_dict(obj["mapping"]) if obj.get("mapping") is not None else None,
            ...
            "recommendations": [OfferCardRecommendationDTO.from_dict(_item) for _item in obj["recommendations"]] if obj.get("recommendations") is not None else None,
