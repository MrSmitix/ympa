...
class CalculateTariffsOfferInfoDTO(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "offer": CalculateTariffsOfferDTO.from_dict(obj["offer"]) if obj.get("offer") is not None else None,
            "tariffs": [CalculatedTariffDTO.from_dict(_item) for _item in obj["tariffs"]] if obj.get("tariffs") is not None else None
        })
        return _obj
