...
class GenerateUnitedOrdersRequest(BaseModel):
    ...
    date_to: date = Field(description="Конец периода, включительно. Максимальный период — 1 год.", alias="dateTo")
    ...
    promo_id: Optional[StrictStr] = Field(default=None, description="Идентификатор акции, товары из которой нужны в отчете.", alias="promoId")
    __properties: ClassVar[List[str]] = ["businessId", "dateFrom", "dateTo", "campaignIds", "promoId"]
