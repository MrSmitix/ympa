...
class GetModelsOffersResponse(BaseModel):
    ...
    """ # noqa: E501
    models: List[EnrichedModelDTO] = Field(description="Список моделей товаров.")
    ...
    __properties: ClassVar[List[str]] = ["models", "currency", "regionId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "models": [EnrichedModelDTO.from_dict(_item) for _item in obj["models"]] if obj.get("models") is not None else None,
