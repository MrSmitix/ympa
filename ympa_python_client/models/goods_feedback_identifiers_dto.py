...
class GoodsFeedbackIdentifiersDTO(BaseModel):
    ...
    """ # noqa: E501
    order_id: StrictInt = Field(description="Идентификатор заказа на Маркете.", alias="orderId")
    model_id: StrictInt = Field(description="Идентификатор модели товара.", alias="modelId")
    __properties: ClassVar[List[str]] = ["orderId", "modelId"]
