...
class FullOutletDTO(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.delivery_rules:
            for _item_delivery_rules in self.delivery_rules:
                if _item_delivery_rules:
                    _items.append(_item_delivery_rules.to_dict())
        ...
        if self.delivery_rules is None and "delivery_rules" in self.model_fields_set:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "address": OutletAddressDTO.from_dict(obj["address"]) if obj.get("address") is not None else None,
            "phones": obj.get("phones"),
            "workingSchedule": OutletWorkingScheduleDTO.from_dict(obj["workingSchedule"]) if obj.get("workingSchedule") is not None else None,
            "deliveryRules": [OutletDeliveryRuleDTO.from_dict(_item) for _item in obj["deliveryRules"]] if obj.get("deliveryRules") is not None else None,
