...
class FeedbackDTO(BaseModel):
    ...
    comments: List[FeedbackCommentDTO] = Field(description="Переписка автора отзыва с магазином.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "text": obj.get("text"),
            "state": obj.get("state"),
            "author": FeedbackAuthorDTO.from_dict(obj["author"]) if obj.get("author") is not None else None,
            "pro": obj.get("pro"),
            "contra": obj.get("contra"),
            "comments": [FeedbackCommentDTO.from_dict(_item) for _item in obj["comments"]] if obj.get("comments") is not None else None,
            "shop": FeedbackShopDTO.from_dict(obj["shop"]) if obj.get("shop") is not None else None,
            "resolved": obj.get("resolved"),
            "verified": obj.get("verified"),
            "recommend": obj.get("recommend"),
            "grades": FeedbackGradesDTO.from_dict(obj["grades"]) if obj.get("grades") is not None else None,
            "order": FeedbackOrderDTO.from_dict(obj["order"]) if obj.get("order") is not None else None
        })
        return _obj
