...
class OrderItemDTO(BaseModel):
    ...
    buyer_price: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Цена на товар в валюте покупателя. В цене уже учтены скидки по:  * акциям; * купонам; * промокодам. ", alias="buyerPrice")
    buyer_price_before_discount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Стоимость товара в валюте покупателя до применения скидок по:  * акциям; * купонам; * промокодам. ", alias="buyerPriceBeforeDiscount")
    price_before_discount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="{% note warning \"\" %}  Этот параметр устарел.  {% endnote %}  Стоимость товара в валюте магазина до применения скидок. ", alias="priceBeforeDiscount")
    ...
    partner_warehouse_id: Optional[StrictStr] = Field(default=None, description="{% note warning \"\" %}  Этот параметр устарел. Не используйте его.  {% endnote %}  Идентификатор склада в системе партнера, на который сформирован заказ. ", alias="partnerWarehouseId")
    ...
    __properties: ClassVar[List[str]] = ["id", "offerId", "offerName", "price", "buyerPrice", "buyerPriceBeforeDiscount", "priceBeforeDiscount", "count", "vat", "shopSku", "subsidy", "partnerWarehouseId", "promos", "instances", "details", "subsidies", "requiredInstanceTypes"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if self.required_instance_types is None and "required_instance_types" in self.model_fields_set:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "promos": [OrderItemPromoDTO.from_dict(_item) for _item in obj["promos"]] if obj.get("promos") is not None else None,
            "instances": [OrderItemInstanceDTO.from_dict(_item) for _item in obj["instances"]] if obj.get("instances") is not None else None,
            "details": [OrderItemDetailDTO.from_dict(_item) for _item in obj["details"]] if obj.get("details") is not None else None,
            "subsidies": [OrderItemSubsidyDTO.from_dict(_item) for _item in obj["subsidies"]] if obj.get("subsidies") is not None else None,
