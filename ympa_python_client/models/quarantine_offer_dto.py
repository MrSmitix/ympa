...
class QuarantineOfferDTO(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        _items = []
        if self.verdicts:
            for _item_verdicts in self.verdicts:
                if _item_verdicts:
                    _items.append(_item_verdicts.to_dict())
            _dict['verdicts'] = _items
        # set to None if verdicts (nullable) is None
        # and model_fields_set contains the field
        if self.verdicts is None and "verdicts" in self.model_fields_set:
            _dict['verdicts'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "currentPrice": BasePriceDTO.from_dict(obj["currentPrice"]) if obj.get("currentPrice") is not None else None,
            "lastValidPrice": BasePriceDTO.from_dict(obj["lastValidPrice"]) if obj.get("lastValidPrice") is not None else None,
            "verdicts": [PriceQuarantineVerdictDTO.from_dict(_item) for _item in obj["verdicts"]] if obj.get("verdicts") is not None else None
        })
        return _obj
