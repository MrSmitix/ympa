...
class CampaignDTO(BaseModel):
    ...
    client_id: Optional[StrictInt] = Field(default=None, description="Идентификатор плательщика в Яндекс Балансе.", alias="clientId")
    business: Optional[BusinessDTO] = None
    placement_type: Optional[PlacementType] = Field(default=None, alias="placementType")
    __properties: ClassVar[List[str]] = ["domain", "id", "clientId", "business", "placementType"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "business": BusinessDTO.from_dict(obj["business"]) if obj.get("business") is not None else None,
            "placementType": obj.get("placementType")
        })
        return _obj
