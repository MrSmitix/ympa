...
class BriefOrderItemDTO(BaseModel):
    """
    ...
    price: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Цена на товар. Указана в той валюте, которая была задана в каталоге. Разделитель целой и дробной части — точка. ")
    ...
    instances: Optional[List[OrderItemInstanceDTO]] = Field(default=None, description="Переданные вами коды маркировки.")
    __properties: ClassVar[List[str]] = ["id", "vat", "count", "price", "offerName", "offerId", "instances"]
