...
class OrdersStatsDTO(BaseModel):
    ...
    """ # noqa: E501
    orders: List[OrdersStatsOrderDTO] = Field(description="Список заказов.")
    paging: Optional[ForwardScrollingPagerDTO] = None
    __properties: ClassVar[List[str]] = ["orders", "paging"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "orders": [OrdersStatsOrderDTO.from_dict(_item) for _item in obj["orders"]] if obj.get("orders") is not None else None,
