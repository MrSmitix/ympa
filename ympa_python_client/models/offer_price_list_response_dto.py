...
class OfferPriceListResponseDTO(BaseModel):
    ...
    """ # noqa: E501
    offers: List[OfferPriceResponseDTO] = Field(description="Страница списка.")
    ...
    __properties: ClassVar[List[str]] = ["offers", "paging", "total"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "offers": [OfferPriceResponseDTO.from_dict(_item) for _item in obj["offers"]] if obj.get("offers") is not None else None,
