...
from ympa_python_flask_server.models.get_price_with_vat_dto import GetPriceWithVatDTO  # noqa: E501
...
class GetCampaignOfferDTO(Model):
    ...
    def __init__(self, offer_id=None, quantum=None, available=None, basic_price=None, campaign_price=None, status=None, errors=None, warnings=None):  # noqa: E501
