...
class ModelOfferDTO(Model):
    ...
    def __init__(self, discount=None, name=None, pos=None, pre_discount_price=None, price=None, region_id=None, shipping_cost=None, shop_name=None, shop_rating=None, in_stock=None):  # noqa: E501
