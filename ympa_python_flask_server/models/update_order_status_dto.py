...
from ympa_python_flask_server.models.order_update_status_type import OrderUpdateStatusType  # noqa: E501
...
class UpdateOrderStatusDTO(Model):
    ...
    def __init__(self, id=None, status=None, substatus=None, update_status=None, error_details=None):  # noqa: E501
