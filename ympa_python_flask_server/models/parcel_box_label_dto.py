...
class ParcelBoxLabelDTO(Model):
    ...
    def __init__(self, url=None, supplier_name=None, delivery_service_name=None, order_id=None, order_num=None, recipient_name=None, box_id=None, fulfilment_id=None, place=None, weight=None, delivery_service_id=None, delivery_address=None, shipment_date=None):  # noqa: E501
