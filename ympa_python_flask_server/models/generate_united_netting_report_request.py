...
class GenerateUnitedNettingReportRequest(Model):
    ...
    def __init__(self, business_id=None, date_time_from=None, date_time_to=None, date_from=None, date_to=None, bank_order_id=None, bank_order_date_time=None, placement_programs=None, inns=None, campaign_ids=None):  # noqa: E501
