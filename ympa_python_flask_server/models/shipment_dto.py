...
class ShipmentDTO(Model):
    ...
    def __init__(self, id=None, plan_interval_from=None, plan_interval_to=None, shipment_type=None, warehouse=None, warehouse_to=None, external_id=None, delivery_service=None, pallets_count=None, order_ids=None, draft_count=None, planned_count=None, fact_count=None, current_status=None, available_actions=None):  # noqa: E501
