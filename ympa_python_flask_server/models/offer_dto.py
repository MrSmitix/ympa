...
class OfferDTO(Model):
    ...
    def __init__(self, price=None, feed_id=None, id=None, shop_category_id=None, market_category_id=None, pre_discount_price=None, discount=None, cut_price=None, url=None, model_id=None, name=None, currency=None, bid=None, cbid=None, fee=None, blocked=None):  # noqa: E501
