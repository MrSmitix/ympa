...
std::string GeneratePricesReportRequest::toJsonString(bool prettyJson /* = false */) const
{
	std::stringstream ss;
...
ptree GeneratePricesReportRequest::toPropertyTree() const
{
	ptree pt;
	ptree tmp_node;
...
void GeneratePricesReportRequest::fromPropertyTree(ptree const &pt)
{
	ptree tmp_node;
