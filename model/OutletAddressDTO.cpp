...
std::string OutletAddressDTO::toJsonString(bool prettyJson /* = false */) const
{
	std::stringstream ss;
...
ptree OutletAddressDTO::toPropertyTree() const
{
	ptree pt;
	ptree tmp_node;
...
void OutletAddressDTO::fromPropertyTree(ptree const &pt)
{
	ptree tmp_node;
