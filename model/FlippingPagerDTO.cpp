...
std::string FlippingPagerDTO::toJsonString(bool prettyJson /* = false */)
{
...
boost::property_tree::ptree FlippingPagerDTO::toPropertyTree()
{
    return toPropertyTree_internal();
}

void FlippingPagerDTO::fromPropertyTree(boost::property_tree::ptree const& pt)
{
    fromPropertyTree_internal(pt);
}

std::string FlippingPagerDTO::toJsonString_internal(bool prettyJson)
{
	std::stringstream ss;
...
void FlippingPagerDTO::fromJsonString_internal(std::string const& jsonString)
{
...
ptree FlippingPagerDTO::toPropertyTree_internal()
{
	ptree pt;
	ptree tmp_node;
...
void FlippingPagerDTO::fromPropertyTree_internal(ptree const &pt)
{
	ptree tmp_node;
