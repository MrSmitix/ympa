...
#ifndef _offer_content_error_type_H_
#define _offer_content_error_type_H_
...
typedef struct offer_content_error_type_t offer_content_error_type_t;


// Enum  for offer_content_error_type

typedef enum { _api__offer_content_error_type__NULL = 0, _api__offer_content_error_type__OFFER_NOT_FOUND, _api__offer_content_error_type__UNKNOWN_CATEGORY, _api__offer_content_error_type__CATEGORY_MISMATCH, _api__offer_content_error_type__UNKNOWN_PARAMETER, _api__offer_content_error_type__UNEXPECTED_BOOLEAN_VALUE, _api__offer_content_error_type__NUMBER_FORMAT, _api__offer_content_error_type__VALUE_BLANK, _api__offer_content_error_type__INVALID_UNIT_ID, _api__offer_content_error_type__INVALID_GROUP_ID_LENGTH, _api__offer_content_error_type__INVALID_GROUP_ID_CHARACTERS } _api__offer_content_error_type__e;
...
#endif /* _offer_content_error_type_H_ */
