...
std::string GetBusinessSettingsInfoDTO::toJsonString(bool prettyJson /* = false */) const
{
	std::stringstream ss;
...
ptree GetBusinessSettingsInfoDTO::toPropertyTree() const
{
	ptree pt;
	ptree tmp_node;
...
void GetBusinessSettingsInfoDTO::fromPropertyTree(ptree const &pt)
{
	ptree tmp_node;
	if (pt.get_child_optional("info")) {
        m_Info = fromPt<BusinessDTO>(pt.get_child("info"));
	}
	if (pt.get_child_optional("settings")) {
        m_Settings = fromPt<BusinessSettingsDTO>(pt.get_child("settings"));
	}
}

BusinessDTO GetBusinessSettingsInfoDTO::getInfo() const
{
    return m_Info;
}

void GetBusinessSettingsInfoDTO::setInfo(BusinessDTO value)
{
    m_Info = value;
}


BusinessSettingsDTO GetBusinessSettingsInfoDTO::getSettings() const
{
    return m_Settings;
}

void GetBusinessSettingsInfoDTO::setSettings(BusinessSettingsDTO value)
{
    m_Settings = value;
}
