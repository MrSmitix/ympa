...
public:
    ...
    void setType(std::shared_ptr<GoodsFeedbackCommentAuthorType> value);
...
protected:
    std::shared_ptr<GoodsFeedbackCommentAuthorType> m_Type = std::make_shared<GoodsFeedbackCommentAuthorType>();
    std::string m_Name = "";
};
