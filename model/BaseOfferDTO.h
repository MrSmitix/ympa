...
public:
    ...
    bool operator==(const BaseOfferDTO& rhs) const;
    bool operator!=(const BaseOfferDTO& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const BaseOfferDTO& o);
    friend  void from_json(const nlohmann::json& j, BaseOfferDTO& o);
protected:
