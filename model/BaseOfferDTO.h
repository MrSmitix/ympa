...
#ifndef BaseOfferDTO_H_
#define BaseOfferDTO_H_
...
{
public:
    BaseOfferDTO() = default;
    explicit BaseOfferDTO(boost::property_tree::ptree const& pt);
    virtual ~BaseOfferDTO() = default;

    BaseOfferDTO(const BaseOfferDTO& other) = default; // copy constructor
    BaseOfferDTO(BaseOfferDTO&& other) noexcept = default; // move constructor

    BaseOfferDTO& operator=(const BaseOfferDTO& other) = default; // copy assignment
    BaseOfferDTO& operator=(BaseOfferDTO&& other) noexcept = default; // move assignment
...
template<>
inline boost::property_tree::ptree toPt<BaseOfferDTO>(const BaseOfferDTO& val) {
    return val.toPropertyTree();
}

template<>
inline BaseOfferDTO fromPt<BaseOfferDTO>(const boost::property_tree::ptree& pt) {
    BaseOfferDTO ret;
