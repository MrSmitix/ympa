...
std::string GenerateMassOrderLabelsRequest::toJsonString(bool prettyJson /* = false */) const
{
	std::stringstream ss;
...
ptree GenerateMassOrderLabelsRequest::toPropertyTree() const
{
	ptree pt;
	ptree tmp_node;
...
void GenerateMassOrderLabelsRequest::fromPropertyTree(ptree const &pt)
{
	ptree tmp_node;
