...
std::string GoodsFeedbackCommentAuthorDTO::toJsonString(bool prettyJson /* = false */) const
{
	std::stringstream ss;
...
ptree GoodsFeedbackCommentAuthorDTO::toPropertyTree() const
{
	ptree pt;
	ptree tmp_node;
	pt.put("name", m_Name);
...
void GoodsFeedbackCommentAuthorDTO::fromPropertyTree(ptree const &pt)
{
	ptree tmp_node;
	m_Name = pt.get("name", "");
}

GoodsFeedbackCommentAuthorType GoodsFeedbackCommentAuthorDTO::getType() const
{
    return m_Type;
}

void GoodsFeedbackCommentAuthorDTO::setType(GoodsFeedbackCommentAuthorType value)
{
    m_Type = value;
}
