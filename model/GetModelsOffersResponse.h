...
public:
    ...
    bool operator==(const GetModelsOffersResponse& rhs) const;
    bool operator!=(const GetModelsOffersResponse& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const GetModelsOffersResponse& o);
    friend  void from_json(const nlohmann::json& j, GetModelsOffersResponse& o);
protected:
