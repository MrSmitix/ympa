...
std::string FeedbackShopDTO::toJsonString(bool prettyJson /* = false */) const
{
	std::stringstream ss;
...
ptree FeedbackShopDTO::toPropertyTree() const
{
	ptree pt;
	ptree tmp_node;
	pt.put("name", m_Name);
...
void FeedbackShopDTO::fromPropertyTree(ptree const &pt)
{
	ptree tmp_node;
	m_Name = pt.get("name", "");
}
