/*
 * delete_offers_response.h
 *
 * Результат удаления товаров.
 */

#ifndef _delete_offers_response_H_
#define _delete_offers_response_H_
...
typedef struct delete_offers_response_t delete_offers_response_t;

#include "api_response_status_type.h"
#include "delete_offers_dto.h"

// Enum  for delete_offers_response

typedef enum  { _api__delete_offers_response__NULL = 0, _api__delete_offers_response__OK, _api__delete_offers_response__ERROR } _api__delete_offers_response__e;
...
typedef struct delete_offers_response_t {
    api_response_status_type_t *status; // custom
    struct delete_offers_dto_t *result; //model
...
#endif /* _delete_offers_response_H_ */
