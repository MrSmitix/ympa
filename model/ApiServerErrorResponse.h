...
public:
    ...
    bool operator==(const ApiServerErrorResponse& rhs) const;
    bool operator!=(const ApiServerErrorResponse& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const ApiServerErrorResponse& o);
    friend  void from_json(const nlohmann::json& j, ApiServerErrorResponse& o);
protected:
