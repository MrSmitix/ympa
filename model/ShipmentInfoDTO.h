...
/// Список с информацией об отгрузках.
/// </summary>
class  ShipmentInfoDTO : public BaseShipmentDTO
{
public:
    ShipmentInfoDTO() = default;
    explicit ShipmentInfoDTO(boost::property_tree::ptree const& pt);
    virtual ~ShipmentInfoDTO() = default;

    ShipmentInfoDTO(const ShipmentInfoDTO& other) = default; // copy constructor
    ShipmentInfoDTO(ShipmentInfoDTO&& other) noexcept = default; // move constructor

    ShipmentInfoDTO& operator=(const ShipmentInfoDTO& other) = default; // copy assignment
    ShipmentInfoDTO& operator=(ShipmentInfoDTO&& other) noexcept = default; // move assignment
    ...
    void setStatusDescription(std::string value);

    /// <summary>
    /// Время последнего изменения статуса отгрузки.
    /// </summary>
    std::string getStatusUpdateTime() const;
    void setStatusUpdateTime(std::string value);
...
template<>
inline boost::property_tree::ptree toPt<ShipmentInfoDTO>(const ShipmentInfoDTO& val) {
    return val.toPropertyTree();
}

template<>
inline ShipmentInfoDTO fromPt<ShipmentInfoDTO>(const boost::property_tree::ptree& pt) {
    ShipmentInfoDTO ret;
