...
public:
    ...
    OfferContentDTO(const OfferContentDTO& other) = default; // copy constructor
    OfferContentDTO(OfferContentDTO&& other) noexcept = default; // move constructor

    OfferContentDTO& operator=(const OfferContentDTO& other) = default; // copy assignment
    OfferContentDTO& operator=(OfferContentDTO&& other) noexcept = default; // move assignment
...
template<>
inline boost::property_tree::ptree toPt<OfferContentDTO>(const OfferContentDTO& val) {
    return val.toPropertyTree();
}

template<>
inline OfferContentDTO fromPt<OfferContentDTO>(const boost::property_tree::ptree& pt) {
    OfferContentDTO ret;
