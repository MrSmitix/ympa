...
public:
    ...
    OrderSubstatusType(const OrderSubstatusType& other) = default; // copy constructor
    OrderSubstatusType(OrderSubstatusType&& other) noexcept = default; // move constructor

    OrderSubstatusType& operator=(const OrderSubstatusType& other) = default; // copy assignment
    OrderSubstatusType& operator=(OrderSubstatusType&& other) noexcept = default; // move assignment
...
protected:
    std::string m_OrderSubstatusTypeEnumValue;
};

std::vector<OrderSubstatusType> createOrderSubstatusTypeVectorFromJsonString(const std::string& json);

template<>
inline boost::property_tree::ptree toPt<OrderSubstatusType>(const OrderSubstatusType& val) {
    return val.toPropertyTree();
}

template<>
inline OrderSubstatusType fromPt<OrderSubstatusType>(const boost::property_tree::ptree& pt) {
    OrderSubstatusType ret;
