...
public:
    ...
    OrderPromoType(const OrderPromoType& other) = default; // copy constructor
    OrderPromoType(OrderPromoType&& other) noexcept = default; // move constructor

    OrderPromoType& operator=(const OrderPromoType& other) = default; // copy assignment
    OrderPromoType& operator=(OrderPromoType&& other) noexcept = default; // move assignment
...
protected:
    std::string m_OrderPromoTypeEnumValue;
};

std::vector<OrderPromoType> createOrderPromoTypeVectorFromJsonString(const std::string& json);

template<>
inline boost::property_tree::ptree toPt<OrderPromoType>(const OrderPromoType& val) {
    return val.toPropertyTree();
}

template<>
inline OrderPromoType fromPt<OrderPromoType>(const boost::property_tree::ptree& pt) {
    OrderPromoType ret;
