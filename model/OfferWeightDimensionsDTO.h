...
public:
    ...
    OfferWeightDimensionsDTO(const OfferWeightDimensionsDTO& other) = default; // copy constructor
    OfferWeightDimensionsDTO(OfferWeightDimensionsDTO&& other) noexcept = default; // move constructor

    OfferWeightDimensionsDTO& operator=(const OfferWeightDimensionsDTO& other) = default; // copy assignment
    OfferWeightDimensionsDTO& operator=(OfferWeightDimensionsDTO&& other) noexcept = default; // move assignment
...
template<>
inline boost::property_tree::ptree toPt<OfferWeightDimensionsDTO>(const OfferWeightDimensionsDTO& val) {
    return val.toPropertyTree();
}

template<>
inline OfferWeightDimensionsDTO fromPt<OfferWeightDimensionsDTO>(const boost::property_tree::ptree& pt) {
    OfferWeightDimensionsDTO ret;
