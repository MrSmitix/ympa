...
public:
    ...
    bool operator==(const UpdateMappingsOfferDTO& rhs) const;
    bool operator!=(const UpdateMappingsOfferDTO& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const UpdateMappingsOfferDTO& o);
    friend  void from_json(const nlohmann::json& j, UpdateMappingsOfferDTO& o);
protected:
    std::string m_Name;
    bool m_NameIsSet;
