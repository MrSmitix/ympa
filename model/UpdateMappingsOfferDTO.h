...
#ifndef UpdateMappingsOfferDTO_H_
#define UpdateMappingsOfferDTO_H_
...
/// Информация о товарах в каталоге.
/// </summary>
class  UpdateMappingsOfferDTO : public MappingsOfferInfoDTO
{
public:
    UpdateMappingsOfferDTO() = default;
    explicit UpdateMappingsOfferDTO(boost::property_tree::ptree const& pt);
    virtual ~UpdateMappingsOfferDTO() = default;

    UpdateMappingsOfferDTO(const UpdateMappingsOfferDTO& other) = default; // copy constructor
    UpdateMappingsOfferDTO(UpdateMappingsOfferDTO&& other) noexcept = default; // move constructor

    UpdateMappingsOfferDTO& operator=(const UpdateMappingsOfferDTO& other) = default; // copy assignment
    UpdateMappingsOfferDTO& operator=(UpdateMappingsOfferDTO&& other) noexcept = default; // move assignment
...
template<>
inline boost::property_tree::ptree toPt<UpdateMappingsOfferDTO>(const UpdateMappingsOfferDTO& val) {
    return val.toPropertyTree();
}

template<>
inline UpdateMappingsOfferDTO fromPt<UpdateMappingsOfferDTO>(const boost::property_tree::ptree& pt) {
    UpdateMappingsOfferDTO ret;
...
#endif /* UpdateMappingsOfferDTO_H_ */
