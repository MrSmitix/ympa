...
{
public:
    OutletLicenseDTO() = default;
    explicit OutletLicenseDTO(boost::property_tree::ptree const& pt);
    virtual ~OutletLicenseDTO() = default;

    OutletLicenseDTO(const OutletLicenseDTO& other) = default; // copy constructor
    OutletLicenseDTO(OutletLicenseDTO&& other) noexcept = default; // move constructor

    OutletLicenseDTO& operator=(const OutletLicenseDTO& other) = default; // copy assignment
    OutletLicenseDTO& operator=(OutletLicenseDTO&& other) noexcept = default; // move assignment
...
template<>
inline boost::property_tree::ptree toPt<OutletLicenseDTO>(const OutletLicenseDTO& val) {
    return val.toPropertyTree();
}

template<>
inline OutletLicenseDTO fromPt<OutletLicenseDTO>(const boost::property_tree::ptree& pt) {
    OutletLicenseDTO ret;
