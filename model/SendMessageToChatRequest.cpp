...
std::string SendMessageToChatRequest::toJsonString(bool prettyJson /* = false */) const
{
	std::stringstream ss;
...
ptree SendMessageToChatRequest::toPropertyTree() const
{
	ptree pt;
	ptree tmp_node;
...
void SendMessageToChatRequest::fromPropertyTree(ptree const &pt)
{
	ptree tmp_node;
