...
public:
    ...
    bool operator==(const TariffType& rhs) const;
    bool operator!=(const TariffType& rhs) const;

    /////////////////////////////////////////////
    /// TariffType members

    TariffType::eTariffType getValue() const;
    void setValue(TariffType::eTariffType value);
    
    friend  void to_json(nlohmann::json& j, const TariffType& o);
    friend  void from_json(const nlohmann::json& j, TariffType& o);
protected:
    TariffType::eTariffType m_value = TariffType::eTariffType::INVALID_VALUE_OPENAPI_GENERATED;
};
