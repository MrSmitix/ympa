...
std::string PromoOfferParamsDTO::toJsonString(bool prettyJson /* = false */) const
{
	std::stringstream ss;
...
ptree PromoOfferParamsDTO::toPropertyTree() const
{
	ptree pt;
	ptree tmp_node;
...
void PromoOfferParamsDTO::fromPropertyTree(ptree const &pt)
{
	ptree tmp_node;
	if (pt.get_child_optional("discountParams")) {
        m_DiscountParams = fromPt<PromoOfferDiscountParamsDTO>(pt.get_child("discountParams"));
	}
	if (pt.get_child_optional("promocodeParams")) {
        m_PromocodeParams = fromPt<PromoOfferPromocodeParamsDTO>(pt.get_child("promocodeParams"));
	}
}

PromoOfferDiscountParamsDTO PromoOfferParamsDTO::getDiscountParams() const
{
    return m_DiscountParams;
}

void PromoOfferParamsDTO::setDiscountParams(PromoOfferDiscountParamsDTO value)
{
    m_DiscountParams = value;
}


PromoOfferPromocodeParamsDTO PromoOfferParamsDTO::getPromocodeParams() const
{
    return m_PromocodeParams;
}

void PromoOfferParamsDTO::setPromocodeParams(PromoOfferPromocodeParamsDTO value)
{
