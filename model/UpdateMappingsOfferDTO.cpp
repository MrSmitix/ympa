...
std::string UpdateMappingsOfferDTO::toJsonString(bool prettyJson /* = false */)
{
...
boost::property_tree::ptree UpdateMappingsOfferDTO::toPropertyTree()
{
    return toPropertyTree_internal();
}

void UpdateMappingsOfferDTO::fromPropertyTree(boost::property_tree::ptree const& pt)
{
    fromPropertyTree_internal(pt);
}

std::string UpdateMappingsOfferDTO::toJsonString_internal(bool prettyJson)
{
	std::stringstream ss;
...
void UpdateMappingsOfferDTO::fromJsonString_internal(std::string const& jsonString)
{
...
ptree UpdateMappingsOfferDTO::toPropertyTree_internal()
{
	ptree pt;
	ptree tmp_node;
	pt.put("name", m_Name);
...
void UpdateMappingsOfferDTO::fromPropertyTree_internal(ptree const &pt)
{
	ptree tmp_node;
	m_Name = pt.get("name", "");
...
void UpdateMappingsOfferDTO::setWeightDimensions(std::shared_ptr<OfferWeightDimensionsDTO> value)
{
	m_WeightDimensions = value;
}
std::vector<std::shared_ptr<DayOfWeekType>> UpdateMappingsOfferDTO::getSupplyScheduleDays() const
{
    return m_SupplyScheduleDays;
}

void UpdateMappingsOfferDTO::setSupplyScheduleDays(std::vector<std::shared_ptr<DayOfWeekType>> value)
{
...
void UpdateMappingsOfferDTO::setProcessingState(std::shared_ptr<OfferProcessingStateDTO> value)
{
...
void UpdateMappingsOfferDTO::setAvailability(std::shared_ptr<OfferAvailabilityStatusType> value)
{
...
void UpdateMappingsOfferDTO::setShelfLife(std::shared_ptr<TimePeriodDTO> value)
{
	m_ShelfLife = value;
}
...
void UpdateMappingsOfferDTO::setLifeTime(std::shared_ptr<TimePeriodDTO> value)
{
	m_LifeTime = value;
}
...
void UpdateMappingsOfferDTO::setGuaranteePeriod(std::shared_ptr<TimePeriodDTO> value)
{
