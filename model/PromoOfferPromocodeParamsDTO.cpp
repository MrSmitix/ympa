...
std::string PromoOfferPromocodeParamsDTO::toJsonString(bool prettyJson /* = false */) const
{
	std::stringstream ss;
...
ptree PromoOfferPromocodeParamsDTO::toPropertyTree() const
{
	ptree pt;
	ptree tmp_node;
...
void PromoOfferPromocodeParamsDTO::fromPropertyTree(ptree const &pt)
{
	ptree tmp_node;
