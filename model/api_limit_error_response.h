/*
 * api_limit_error_response.h
 *
 * Превышено ограничение на доступ к ресурсу.
 */

#ifndef _api_limit_error_response_H_
#define _api_limit_error_response_H_
...
typedef struct api_limit_error_response_t api_limit_error_response_t;

#include "api_error_dto.h"
#include "api_response_status_type.h"

// Enum  for api_limit_error_response

typedef enum  { _api__api_limit_error_response__NULL = 0, _api__api_limit_error_response__OK, _api__api_limit_error_response__ERROR } _api__api_limit_error_response__e;
...
typedef struct api_limit_error_response_t {
    api_response_status_type_t *status; // custom
    list_t *errors; //nonprimitive container

} api_limit_error_response_t;
...
#endif /* _api_limit_error_response_H_ */
