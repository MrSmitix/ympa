...
public:
    ...
    bool operator==(const OfferPriceByOfferIdsResponseDTO& rhs) const;
    bool operator!=(const OfferPriceByOfferIdsResponseDTO& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const OfferPriceByOfferIdsResponseDTO& o);
    friend  void from_json(const nlohmann::json& j, OfferPriceByOfferIdsResponseDTO& o);
protected:
