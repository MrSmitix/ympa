...
public:
    ...
    bool operator==(const MappingsOfferDTO& rhs) const;
    bool operator!=(const MappingsOfferDTO& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const MappingsOfferDTO& o);
    friend  void from_json(const nlohmann::json& j, MappingsOfferDTO& o);
protected:
    std::string m_Name;
    bool m_NameIsSet;
