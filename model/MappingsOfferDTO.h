...
public:
    ...
    MappingsOfferDTO(const MappingsOfferDTO& other) = default; // copy constructor
    MappingsOfferDTO(MappingsOfferDTO&& other) noexcept = default; // move constructor

    MappingsOfferDTO& operator=(const MappingsOfferDTO& other) = default; // copy assignment
    MappingsOfferDTO& operator=(MappingsOfferDTO&& other) noexcept = default; // move assignment
...
template<>
inline boost::property_tree::ptree toPt<MappingsOfferDTO>(const MappingsOfferDTO& val) {
    return val.toPropertyTree();
}

template<>
inline MappingsOfferDTO fromPt<MappingsOfferDTO>(const boost::property_tree::ptree& pt) {
    MappingsOfferDTO ret;
