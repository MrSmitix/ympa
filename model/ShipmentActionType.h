...
public:
    ...
    bool operator==(const ShipmentActionType& rhs) const;
    bool operator!=(const ShipmentActionType& rhs) const;

    /////////////////////////////////////////////
    /// ShipmentActionType members

    ShipmentActionType::eShipmentActionType getValue() const;
    void setValue(ShipmentActionType::eShipmentActionType value);
    
    friend  void to_json(nlohmann::json& j, const ShipmentActionType& o);
    friend  void from_json(const nlohmann::json& j, ShipmentActionType& o);
protected:
    ShipmentActionType::eShipmentActionType m_value = ShipmentActionType::eShipmentActionType::INVALID_VALUE_OPENAPI_GENERATED;
};
