...
export const OfferContentErrorType = {
    OfferNotFound: 'OFFER_NOT_FOUND' as OfferContentErrorType,
    UnknownCategory: 'UNKNOWN_CATEGORY' as OfferContentErrorType,
    CategoryMismatch: 'CATEGORY_MISMATCH' as OfferContentErrorType,
    UnknownParameter: 'UNKNOWN_PARAMETER' as OfferContentErrorType,
    UnexpectedBooleanValue: 'UNEXPECTED_BOOLEAN_VALUE' as OfferContentErrorType,
    NumberFormat: 'NUMBER_FORMAT' as OfferContentErrorType,
    ValueBlank: 'VALUE_BLANK' as OfferContentErrorType,
    InvalidUnitId: 'INVALID_UNIT_ID' as OfferContentErrorType,
    InvalidGroupIdLength: 'INVALID_GROUP_ID_LENGTH' as OfferContentErrorType,
    InvalidGroupIdCharacters: 'INVALID_GROUP_ID_CHARACTERS' as OfferContentErrorType
};
