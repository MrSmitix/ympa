...
public:
    ...
    OrderItemInstanceDTO(const OrderItemInstanceDTO& other) = default; // copy constructor
    OrderItemInstanceDTO(OrderItemInstanceDTO&& other) noexcept = default; // move constructor

    OrderItemInstanceDTO& operator=(const OrderItemInstanceDTO& other) = default; // copy assignment
    OrderItemInstanceDTO& operator=(OrderItemInstanceDTO&& other) noexcept = default; // move assignment
...
template<>
inline boost::property_tree::ptree toPt<OrderItemInstanceDTO>(const OrderItemInstanceDTO& val) {
    return val.toPropertyTree();
}

template<>
inline OrderItemInstanceDTO fromPt<OrderItemInstanceDTO>(const boost::property_tree::ptree& pt) {
    OrderItemInstanceDTO ret;
