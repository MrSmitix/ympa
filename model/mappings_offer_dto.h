/*
 * mappings_offer_dto.h
 *
 * Информация о товарах в каталоге.
 */

#ifndef _mappings_offer_dto_H_
#define _mappings_offer_dto_H_
...
typedef struct mappings_offer_dto_t mappings_offer_dto_t;
...
// Enum  for mappings_offer_dto

typedef enum  { _api__mappings_offer_dto__NULL = 0, _api__mappings_offer_dto__MONDAY, _api__mappings_offer_dto__TUESDAY, _api__mappings_offer_dto__WEDNESDAY, _api__mappings_offer_dto__THURSDAY, _api__mappings_offer_dto__FRIDAY, _api__mappings_offer_dto__SATURDAY, _api__mappings_offer_dto__SUNDAY } _api__mappings_offer_dto__e;
...
typedef enum  { _api__mappings_offer_dto__NULL = 0, _api__mappings_offer_dto__ACTIVE, _api__mappings_offer_dto__INACTIVE, _api__mappings_offer_dto__DELISTED } _api__mappings_offer_dto__e;
...
typedef struct mappings_offer_dto_t {
    char *name; // string
