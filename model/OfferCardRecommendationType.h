...
public:
    ...
    OfferCardRecommendationType(const OfferCardRecommendationType& other) = default; // copy constructor
    OfferCardRecommendationType(OfferCardRecommendationType&& other) noexcept = default; // move constructor

    OfferCardRecommendationType& operator=(const OfferCardRecommendationType& other) = default; // copy assignment
    OfferCardRecommendationType& operator=(OfferCardRecommendationType&& other) noexcept = default; // move assignment
...
protected:
    std::string m_OfferCardRecommendationTypeEnumValue;
};

std::vector<OfferCardRecommendationType> createOfferCardRecommendationTypeVectorFromJsonString(const std::string& json);

template<>
inline boost::property_tree::ptree toPt<OfferCardRecommendationType>(const OfferCardRecommendationType& val) {
    return val.toPropertyTree();
}

template<>
inline OfferCardRecommendationType fromPt<OfferCardRecommendationType>(const boost::property_tree::ptree& pt) {
    OfferCardRecommendationType ret;
