...
std::string GetMappingDTO::toJsonString(bool prettyJson /* = false */) const
{
	std::stringstream ss;
...
ptree GetMappingDTO::toPropertyTree() const
{
	ptree pt;
	ptree tmp_node;
...
void GetMappingDTO::fromPropertyTree(ptree const &pt)
{
	ptree tmp_node;
