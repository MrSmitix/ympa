...
std::string FeedbackCommentAuthorDTO::toJsonString(bool prettyJson /* = false */) const
{
	std::stringstream ss;
...
ptree FeedbackCommentAuthorDTO::toPropertyTree() const
{
	ptree pt;
	ptree tmp_node;
	pt.put("name", m_Name);
...
void FeedbackCommentAuthorDTO::fromPropertyTree(ptree const &pt)
{
	ptree tmp_node;
	m_Name = pt.get("name", "");
}

FeedbackCommentAuthorType FeedbackCommentAuthorDTO::getType() const
{
    return m_Type;
}

void FeedbackCommentAuthorDTO::setType(FeedbackCommentAuthorType value)
{
    m_Type = value;
}
