...
std::string GetPromoOffersResultDTO::toJsonString(bool prettyJson /* = false */) const
{
	std::stringstream ss;
...
ptree GetPromoOffersResultDTO::toPropertyTree() const
{
	ptree pt;
	ptree tmp_node;
...
void GetPromoOffersResultDTO::fromPropertyTree(ptree const &pt)
{
	ptree tmp_node;
	// push all items of Offers into member
	if (pt.get_child_optional("offers")) {
        m_Offers = fromPt<std::vector<GetPromoOfferDTO>>(pt.get_child("offers"));
	}
...
std::vector<GetPromoOfferDTO> GetPromoOffersResultDTO::getOffers() const
{
    return m_Offers;
}

void GetPromoOffersResultDTO::setOffers(std::vector<GetPromoOfferDTO> value)
{
    m_Offers = value;
}


ForwardScrollingPagerDTO GetPromoOffersResultDTO::getPaging() const
{
    return m_Paging;
}

void GetPromoOffersResultDTO::setPaging(ForwardScrollingPagerDTO value)
{
    m_Paging = value;
}
