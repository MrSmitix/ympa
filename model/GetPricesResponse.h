...
public:
    ...
    bool operator==(const GetPricesResponse& rhs) const;
    bool operator!=(const GetPricesResponse& rhs) const;
    ...
    /// 
    /// </summary>
    org::openapitools::server::model::OfferPriceListResponseDTO getResult() const;
    void setResult(org::openapitools::server::model::OfferPriceListResponseDTO const& value);
    bool resultIsSet() const;
    void unsetResult();

    friend  void to_json(nlohmann::json& j, const GetPricesResponse& o);
    friend  void from_json(const nlohmann::json& j, GetPricesResponse& o);
protected:
    org::openapitools::server::model::ApiResponseStatusType m_Status;
    bool m_StatusIsSet;
    org::openapitools::server::model::OfferPriceListResponseDTO m_Result;
    bool m_ResultIsSet;
