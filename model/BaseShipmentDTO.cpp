...
std::string BaseShipmentDTO::toJsonString(bool prettyJson /* = false */) const
{
	std::stringstream ss;
...
ptree BaseShipmentDTO::toPropertyTree() const
{
	ptree pt;
	ptree tmp_node;
	pt.put("id", m_Id);
...
void BaseShipmentDTO::fromPropertyTree(ptree const &pt)
{
	ptree tmp_node;
	m_Id = pt.get("id", 0L);
...
ShipmentType BaseShipmentDTO::getShipmentType() const
{
    return m_ShipmentType;
}

void BaseShipmentDTO::setShipmentType(ShipmentType value)
{
    m_ShipmentType = value;
}


PartnerShipmentWarehouseDTO BaseShipmentDTO::getWarehouse() const
{
    return m_Warehouse;
}

void BaseShipmentDTO::setWarehouse(PartnerShipmentWarehouseDTO value)
{
    m_Warehouse = value;
}


PartnerShipmentWarehouseDTO BaseShipmentDTO::getWarehouseTo() const
{
    return m_WarehouseTo;
}

void BaseShipmentDTO::setWarehouseTo(PartnerShipmentWarehouseDTO value)
{
    m_WarehouseTo = value;
}
...
DeliveryServiceDTO BaseShipmentDTO::getDeliveryService() const
{
    return m_DeliveryService;
}

void BaseShipmentDTO::setDeliveryService(DeliveryServiceDTO value)
{
    m_DeliveryService = value;
}


PalletsCountDTO BaseShipmentDTO::getPalletsCount() const
{
    return m_PalletsCount;
}

void BaseShipmentDTO::setPalletsCount(PalletsCountDTO value)
{
