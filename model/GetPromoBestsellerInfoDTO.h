...
public:
    ...
    bool operator==(const GetPromoBestsellerInfoDTO& rhs) const;
    bool operator!=(const GetPromoBestsellerInfoDTO& rhs) const;
    ...
    void setBestseller(bool const value);
    /// <summary>
    ...
    void setEntryDeadline(std::string const& value);
    bool entryDeadlineIsSet() const;
    void unsetEntryDeadline();

    friend  void to_json(nlohmann::json& j, const GetPromoBestsellerInfoDTO& o);
    friend  void from_json(const nlohmann::json& j, GetPromoBestsellerInfoDTO& o);
protected:
    bool m_Bestseller;
