...
public:
    ...
    bool operator==(const BaseCampaignOfferDTO& rhs) const;
    bool operator!=(const BaseCampaignOfferDTO& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const BaseCampaignOfferDTO& o);
    friend  void from_json(const nlohmann::json& j, BaseCampaignOfferDTO& o);
protected:
