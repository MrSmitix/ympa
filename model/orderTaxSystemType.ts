...
export const OrderTaxSystemType = {
    Osn: 'OSN' as OrderTaxSystemType,
    Usn: 'USN' as OrderTaxSystemType,
    UsnMinusCost: 'USN_MINUS_COST' as OrderTaxSystemType,
    Envd: 'ENVD' as OrderTaxSystemType,
    Echn: 'ECHN' as OrderTaxSystemType,
    Psn: 'PSN' as OrderTaxSystemType,
    Npd: 'NPD' as OrderTaxSystemType,
    UnknownValue: 'UNKNOWN_VALUE' as OrderTaxSystemType
}
