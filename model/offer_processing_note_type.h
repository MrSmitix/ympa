...
#ifndef _offer_processing_note_type_H_
#define _offer_processing_note_type_H_
...
typedef struct offer_processing_note_type_t offer_processing_note_type_t;


// Enum  for offer_processing_note_type

typedef enum { _api__offer_processing_note_type__NULL = 0, _api__offer_processing_note_type__ASSORTMENT, _api__offer_processing_note_type__CANCELLED, _api__offer_processing_note_type__CONFLICTING_INFORMATION, _api__offer_processing_note_type__OTHER, _api__offer_processing_note_type__DEPARTMENT_FROZEN, _api__offer_processing_note_type__INCORRECT_INFORMATION, _api__offer_processing_note_type__LEGAL_CONFLICT, _api__offer_processing_note_type__NEED_CLASSIFICATION_INFORMATION, _api__offer_processing_note_type__NEED_INFORMATION, _api__offer_processing_note_type__NEED_PICTURES, _api__offer_processing_note_type__NEED_VENDOR, _api__offer_processing_note_type__NO_CATEGORY, _api__offer_processing_note_type__NO_KNOWLEDGE, _api__offer_processing_note_type__NO_PARAMETERS_IN_SHOP_TITLE, _api__offer_processing_note_type__NO_SIZE_MEASURE, _api__offer_processing_note_type__SAMPLE_LINE } _api__offer_processing_note_type__e;
...
#endif /* _offer_processing_note_type_H_ */
