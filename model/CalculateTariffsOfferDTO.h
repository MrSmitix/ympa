...
public:
    ...
    CalculateTariffsOfferDTO(const CalculateTariffsOfferDTO& other) = default; // copy constructor
    CalculateTariffsOfferDTO(CalculateTariffsOfferDTO&& other) noexcept = default; // move constructor

    CalculateTariffsOfferDTO& operator=(const CalculateTariffsOfferDTO& other) = default; // copy assignment
    CalculateTariffsOfferDTO& operator=(CalculateTariffsOfferDTO&& other) noexcept = default; // move assignment
...
template<>
inline boost::property_tree::ptree toPt<CalculateTariffsOfferDTO>(const CalculateTariffsOfferDTO& val) {
    return val.toPropertyTree();
}

template<>
inline CalculateTariffsOfferDTO fromPt<CalculateTariffsOfferDTO>(const boost::property_tree::ptree& pt) {
    CalculateTariffsOfferDTO ret;
