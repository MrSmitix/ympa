...
public:
    ...
    bool operator==(const ShipmentDTO& rhs) const;
    bool operator!=(const ShipmentDTO& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const ShipmentDTO& o);
    friend  void from_json(const nlohmann::json& j, ShipmentDTO& o);
protected:
    int64_t m_Id;
    bool m_IdIsSet;
