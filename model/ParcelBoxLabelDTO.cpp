...
std::string ParcelBoxLabelDTO::toJsonString(bool prettyJson /* = false */)
{
...
boost::property_tree::ptree ParcelBoxLabelDTO::toPropertyTree()
{
    return toPropertyTree_internal();
}

void ParcelBoxLabelDTO::fromPropertyTree(boost::property_tree::ptree const& pt)
{
    fromPropertyTree_internal(pt);
}

std::string ParcelBoxLabelDTO::toJsonString_internal(bool prettyJson)
{
	std::stringstream ss;
...
void ParcelBoxLabelDTO::fromJsonString_internal(std::string const& jsonString)
{
...
ptree ParcelBoxLabelDTO::toPropertyTree_internal()
{
	ptree pt;
	ptree tmp_node;
	pt.put("url", m_Url);
...
void ParcelBoxLabelDTO::fromPropertyTree_internal(ptree const &pt)
{
	ptree tmp_node;
	m_Url = pt.get("url", "");
