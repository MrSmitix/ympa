...
std::string ChangeOutletRequest::toJsonString(bool prettyJson /* = false */)
{
...
boost::property_tree::ptree ChangeOutletRequest::toPropertyTree()
{
    return toPropertyTree_internal();
}

void ChangeOutletRequest::fromPropertyTree(boost::property_tree::ptree const& pt)
{
    fromPropertyTree_internal(pt);
}

std::string ChangeOutletRequest::toJsonString_internal(bool prettyJson)
{
	std::stringstream ss;
...
void ChangeOutletRequest::fromJsonString_internal(std::string const& jsonString)
{
...
ptree ChangeOutletRequest::toPropertyTree_internal()
{
	ptree pt;
	ptree tmp_node;
	pt.put("name", m_Name);
...
void ChangeOutletRequest::fromPropertyTree_internal(ptree const &pt)
{
	ptree tmp_node;
	m_Name = pt.get("name", "");
...
void ChangeOutletRequest::setType(std::shared_ptr<OutletType> value)
{
	m_Type = value;
}
...
void ChangeOutletRequest::setVisibility(std::shared_ptr<OutletVisibilityType> value)
{
	m_Visibility = value;
}
...
void ChangeOutletRequest::setAddress(std::shared_ptr<OutletAddressDTO> value)
{
	m_Address = value;
}
...
void ChangeOutletRequest::setWorkingSchedule(std::shared_ptr<OutletWorkingScheduleDTO> value)
{
	m_WorkingSchedule = value;
}
std::vector<std::shared_ptr<OutletDeliveryRuleDTO>> ChangeOutletRequest::getDeliveryRules() const
{
    return m_DeliveryRules;
}

void ChangeOutletRequest::setDeliveryRules(std::vector<std::shared_ptr<OutletDeliveryRuleDTO>> value)
{
