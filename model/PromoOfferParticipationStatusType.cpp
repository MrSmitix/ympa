...
std::string PromoOfferParticipationStatusType::toJsonString(bool prettyJson /* = false */) const
{
	std::stringstream ss;
...
ptree PromoOfferParticipationStatusType::toPropertyTree() const
{
	ptree pt;
	ptree tmp_node;
	return pt;
...
void PromoOfferParticipationStatusType::fromPropertyTree(ptree const &pt)
{
	ptree tmp_node;
}

std::string PromoOfferParticipationStatusType::toString() const {
    return boost::lexical_cast<std::string>(getEnumValue());
}

void PromoOfferParticipationStatusType::fromString(const std::string& str) {
    setEnumValue(boost::lexical_cast<std::string>(str));
}

std::string PromoOfferParticipationStatusType::getEnumValue() const {
    return m_PromoOfferParticipationStatusTypeEnumValue;
}

void PromoOfferParticipationStatusType::setEnumValue(const std::string& val) {
    ...
    if (std::find(allowedValues.begin(), allowedValues.end(), val) != allowedValues.end()) {
        m_PromoOfferParticipationStatusTypeEnumValue = val;
    } else {
