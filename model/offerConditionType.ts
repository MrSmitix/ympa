...
export const OfferConditionType = {
    Preowned: 'PREOWNED' as OfferConditionType,
    Showcasesample: 'SHOWCASESAMPLE' as OfferConditionType,
    Refurbished: 'REFURBISHED' as OfferConditionType,
    Reduction: 'REDUCTION' as OfferConditionType,
    Renovated: 'RENOVATED' as OfferConditionType,
    NotSpecified: 'NOT_SPECIFIED' as OfferConditionType
}
