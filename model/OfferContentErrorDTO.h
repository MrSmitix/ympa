...
public:
    ...
    bool operator==(const OfferContentErrorDTO& rhs) const;
    bool operator!=(const OfferContentErrorDTO& rhs) const;
    ...
    /// 
    /// </summary>
    org::openapitools::server::model::OfferContentErrorType getType() const;
    void setType(org::openapitools::server::model::OfferContentErrorType const& value);
    /// <summary>
    ...
    friend  void to_json(nlohmann::json& j, const OfferContentErrorDTO& o);
    friend  void from_json(const nlohmann::json& j, OfferContentErrorDTO& o);
protected:
    org::openapitools::server::model::OfferContentErrorType m_Type;
