...
std::string PickupAddressDTO::toJsonString(bool prettyJson /* = false */) const
{
	std::stringstream ss;
...
ptree PickupAddressDTO::toPropertyTree() const
{
	ptree pt;
	ptree tmp_node;
...
void PickupAddressDTO::fromPropertyTree(ptree const &pt)
{
	ptree tmp_node;
