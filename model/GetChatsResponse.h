...
public:
    ...
    /// 
    /// </summary>
    org::openapitools::server::model::GetChatsInfoDTO getResult() const;
    void setResult(org::openapitools::server::model::GetChatsInfoDTO const& value);
    bool resultIsSet() const;
    void unsetResult();

    friend  void to_json(nlohmann::json& j, const GetChatsResponse& o);
    friend  void from_json(const nlohmann::json& j, GetChatsResponse& o);
protected:
    org::openapitools::server::model::ApiResponseStatusType m_Status;
    bool m_StatusIsSet;
    org::openapitools::server::model::GetChatsInfoDTO m_Result;
    bool m_ResultIsSet;
