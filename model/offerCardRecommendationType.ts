...
export const OfferCardRecommendationType = {
    HasVideo: 'HAS_VIDEO' as OfferCardRecommendationType,
    RecognizedVendor: 'RECOGNIZED_VENDOR' as OfferCardRecommendationType,
    Main: 'MAIN' as OfferCardRecommendationType,
    Additional: 'ADDITIONAL' as OfferCardRecommendationType,
    Distinctive: 'DISTINCTIVE' as OfferCardRecommendationType,
    Filterable: 'FILTERABLE' as OfferCardRecommendationType,
    PictureCount: 'PICTURE_COUNT' as OfferCardRecommendationType,
    HasDescription: 'HAS_DESCRIPTION' as OfferCardRecommendationType,
    HasBarcode: 'HAS_BARCODE' as OfferCardRecommendationType,
    FirstPictureSize: 'FIRST_PICTURE_SIZE' as OfferCardRecommendationType,
    TitleLength: 'TITLE_LENGTH' as OfferCardRecommendationType,
    DescriptionLength: 'DESCRIPTION_LENGTH' as OfferCardRecommendationType,
    AveragePictureSize: 'AVERAGE_PICTURE_SIZE' as OfferCardRecommendationType,
    FirstVideoSize: 'FIRST_VIDEO_SIZE' as OfferCardRecommendationType,
    FirstVideoLength: 'FIRST_VIDEO_LENGTH' as OfferCardRecommendationType,
    AverageVideoSize: 'AVERAGE_VIDEO_SIZE' as OfferCardRecommendationType,
    VideoCount: 'VIDEO_COUNT' as OfferCardRecommendationType
}
