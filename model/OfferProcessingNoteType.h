...
{
public:
    OfferProcessingNoteType() = default;
    explicit OfferProcessingNoteType(boost::property_tree::ptree const& pt);
    virtual ~OfferProcessingNoteType() = default;

    OfferProcessingNoteType(const OfferProcessingNoteType& other) = default; // copy constructor
    OfferProcessingNoteType(OfferProcessingNoteType&& other) noexcept = default; // move constructor

    OfferProcessingNoteType& operator=(const OfferProcessingNoteType& other) = default; // copy assignment
    OfferProcessingNoteType& operator=(OfferProcessingNoteType&& other) noexcept = default; // move assignment
...
protected:
    std::string m_OfferProcessingNoteTypeEnumValue;
};

std::vector<OfferProcessingNoteType> createOfferProcessingNoteTypeVectorFromJsonString(const std::string& json);

template<>
inline boost::property_tree::ptree toPt<OfferProcessingNoteType>(const OfferProcessingNoteType& val) {
    return val.toPropertyTree();
}

template<>
inline OfferProcessingNoteType fromPt<OfferProcessingNoteType>(const boost::property_tree::ptree& pt) {
    OfferProcessingNoteType ret;
