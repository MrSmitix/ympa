...
public:
    ...
    OrderItemDTO(const OrderItemDTO& other) = default; // copy constructor
    OrderItemDTO(OrderItemDTO&& other) noexcept = default; // move constructor

    OrderItemDTO& operator=(const OrderItemDTO& other) = default; // copy assignment
    OrderItemDTO& operator=(OrderItemDTO&& other) noexcept = default; // move assignment
    ...
    /// </summary>
    std::vector<OrderItemPromoDTO> getPromos() const;
    void setPromos(std::vector<OrderItemPromoDTO> value);
    ...
    /// </summary>
    std::vector<OrderItemDetailDTO> getDetails() const;
    void setDetails(std::vector<OrderItemDetailDTO> value);

    /// <summary>
    /// Список субсидий по типам.
    /// </summary>
    std::vector<OrderItemSubsidyDTO> getSubsidies() const;
    void setSubsidies(std::vector<OrderItemSubsidyDTO> value);

    /// <summary>
    /// Список необходимых маркировок товара.
    /// </summary>
    std::vector<OrderItemInstanceType> getRequiredInstanceTypes() const;
    void setRequiredInstanceTypes(std::vector<OrderItemInstanceType> value);
...
protected:
    ...
    std::vector<OrderItemPromoDTO> m_Promos;
    std::vector<OrderItemInstanceDTO> m_Instances;
    std::vector<OrderItemDetailDTO> m_Details;
    std::vector<OrderItemSubsidyDTO> m_Subsidies;
    std::vector<OrderItemInstanceType> m_RequiredInstanceTypes;
};

std::vector<OrderItemDTO> createOrderItemDTOVectorFromJsonString(const std::string& json);

template<>
inline boost::property_tree::ptree toPt<OrderItemDTO>(const OrderItemDTO& val) {
    return val.toPropertyTree();
}

template<>
inline OrderItemDTO fromPt<OrderItemDTO>(const boost::property_tree::ptree& pt) {
    OrderItemDTO ret;
