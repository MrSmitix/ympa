...
std::string ConfirmPricesRequest::toJsonString(bool prettyJson /* = false */)
{
...
boost::property_tree::ptree ConfirmPricesRequest::toPropertyTree()
{
    return toPropertyTree_internal();
}

void ConfirmPricesRequest::fromPropertyTree(boost::property_tree::ptree const& pt)
{
    fromPropertyTree_internal(pt);
}

std::string ConfirmPricesRequest::toJsonString_internal(bool prettyJson)
{
	std::stringstream ss;
...
void ConfirmPricesRequest::fromJsonString_internal(std::string const& jsonString)
{
...
ptree ConfirmPricesRequest::toPropertyTree_internal()
{
	ptree pt;
	ptree tmp_node;
...
void ConfirmPricesRequest::fromPropertyTree_internal(ptree const &pt)
{
	ptree tmp_node;
...
std::vector<std::shared_ptr<std::string>> ConfirmPricesRequest::getOfferIds() const
{
    return m_OfferIds;
}

void ConfirmPricesRequest::setOfferIds(std::vector<std::shared_ptr<std::string>> value)
{
	m_OfferIds = value;
}
