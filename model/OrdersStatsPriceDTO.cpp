...
std::string OrdersStatsPriceDTO::toJsonString(bool prettyJson /* = false */) const
{
	std::stringstream ss;
...
ptree OrdersStatsPriceDTO::toPropertyTree() const
{
	ptree pt;
	ptree tmp_node;
...
void OrdersStatsPriceDTO::fromPropertyTree(ptree const &pt)
{
	ptree tmp_node;
...
OrdersStatsPriceType OrdersStatsPriceDTO::getType() const
{
    return m_Type;
}

void OrdersStatsPriceDTO::setType(OrdersStatsPriceType value)
{
    m_Type = value;
}
