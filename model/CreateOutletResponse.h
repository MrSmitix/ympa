...
public:
    ...
    bool operator==(const CreateOutletResponse& rhs) const;
    bool operator!=(const CreateOutletResponse& rhs) const;
    ...
    /// 
    /// </summary>
    org::openapitools::server::model::OutletResponseDTO getResult() const;
    void setResult(org::openapitools::server::model::OutletResponseDTO const& value);
    bool resultIsSet() const;
    void unsetResult();

    friend  void to_json(nlohmann::json& j, const CreateOutletResponse& o);
    friend  void from_json(const nlohmann::json& j, CreateOutletResponse& o);
protected:
    org::openapitools::server::model::ApiResponseStatusType m_Status;
    bool m_StatusIsSet;
    org::openapitools::server::model::OutletResponseDTO m_Result;
    bool m_ResultIsSet;
