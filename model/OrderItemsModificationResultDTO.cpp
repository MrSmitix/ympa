...
std::string OrderItemsModificationResultDTO::toJsonString(bool prettyJson /* = false */) const
{
	std::stringstream ss;
...
ptree OrderItemsModificationResultDTO::toPropertyTree() const
{
	ptree pt;
	ptree tmp_node;
...
void OrderItemsModificationResultDTO::fromPropertyTree(ptree const &pt)
{
	ptree tmp_node;
	// push all items of Items into member
	if (pt.get_child_optional("items")) {
        m_Items = fromPt<std::vector<BriefOrderItemDTO>>(pt.get_child("items"));
	}
}

std::vector<BriefOrderItemDTO> OrderItemsModificationResultDTO::getItems() const
{
    return m_Items;
}

void OrderItemsModificationResultDTO::setItems(std::vector<BriefOrderItemDTO> value)
{
    m_Items = value;
}
