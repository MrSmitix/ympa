...
public:
    ...
    GetOfferDTO(const GetOfferDTO& other) = default; // copy constructor
    GetOfferDTO(GetOfferDTO&& other) noexcept = default; // move constructor

    GetOfferDTO& operator=(const GetOfferDTO& other) = default; // copy assignment
    GetOfferDTO& operator=(GetOfferDTO&& other) noexcept = default; // move assignment
    ...
    /// 
    /// </summary>
    GetPriceDTO getPurchasePrice() const;
    void setPurchasePrice(GetPriceDTO value);

    /// <summary>
    /// 
    /// </summary>
    GetPriceDTO getAdditionalExpenses() const;
    void setAdditionalExpenses(GetPriceDTO value);
    ...
    /// </summary>
    std::vector<OfferCampaignStatusDTO> getCampaigns() const;
    void setCampaigns(std::vector<OfferCampaignStatusDTO> value);

    /// <summary>
    /// Информация о том, какие для товара доступны модели размещения. 
    /// </summary>
    std::vector<OfferSellingProgramDTO> getSellingPrograms() const;
    void setSellingPrograms(std::vector<OfferSellingProgramDTO> value);
...
protected:
    ...
    GetPriceDTO m_PurchasePrice;
    GetPriceDTO m_AdditionalExpenses;
    GetPriceDTO m_CofinancePrice;
    OfferCardStatusType m_CardStatus = OfferCardStatusType{};
    std::vector<OfferCampaignStatusDTO> m_Campaigns;
    std::vector<OfferSellingProgramDTO> m_SellingPrograms;
...
template<>
inline boost::property_tree::ptree toPt<GetOfferDTO>(const GetOfferDTO& val) {
    return val.toPropertyTree();
}

template<>
inline GetOfferDTO fromPt<GetOfferDTO>(const boost::property_tree::ptree& pt) {
    GetOfferDTO ret;
