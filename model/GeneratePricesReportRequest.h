...
public:
    ...
    GeneratePricesReportRequest(const GeneratePricesReportRequest& other) = default; // copy constructor
    GeneratePricesReportRequest(GeneratePricesReportRequest&& other) noexcept = default; // move constructor

    GeneratePricesReportRequest& operator=(const GeneratePricesReportRequest& other) = default; // copy assignment
    GeneratePricesReportRequest& operator=(GeneratePricesReportRequest&& other) noexcept = default; // move assignment
...
template<>
inline boost::property_tree::ptree toPt<GeneratePricesReportRequest>(const GeneratePricesReportRequest& val) {
    return val.toPropertyTree();
}

template<>
inline GeneratePricesReportRequest fromPt<GeneratePricesReportRequest>(const boost::property_tree::ptree& pt) {
    GeneratePricesReportRequest ret;
