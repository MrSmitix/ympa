...
public:
    ...
    bool operator==(const GetWarehousesResponse& rhs) const;
    bool operator!=(const GetWarehousesResponse& rhs) const;
    ...
    /// 
    /// </summary>
    org::openapitools::server::model::WarehousesDTO getResult() const;
    void setResult(org::openapitools::server::model::WarehousesDTO const& value);
    bool resultIsSet() const;
    void unsetResult();

    friend  void to_json(nlohmann::json& j, const GetWarehousesResponse& o);
    friend  void from_json(const nlohmann::json& j, GetWarehousesResponse& o);
protected:
    org::openapitools::server::model::ApiResponseStatusType m_Status;
    bool m_StatusIsSet;
    org::openapitools::server::model::WarehousesDTO m_Result;
    bool m_ResultIsSet;
