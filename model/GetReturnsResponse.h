...
public:
    ...
    bool operator==(const GetReturnsResponse& rhs) const;
    bool operator!=(const GetReturnsResponse& rhs) const;
    ...
    /// 
    /// </summary>
    org::openapitools::server::model::PagedReturnsDTO getResult() const;
    void setResult(org::openapitools::server::model::PagedReturnsDTO const& value);
    bool resultIsSet() const;
    void unsetResult();

    friend  void to_json(nlohmann::json& j, const GetReturnsResponse& o);
    friend  void from_json(const nlohmann::json& j, GetReturnsResponse& o);
protected:
    org::openapitools::server::model::ApiResponseStatusType m_Status;
    bool m_StatusIsSet;
    org::openapitools::server::model::PagedReturnsDTO m_Result;
    bool m_ResultIsSet;
