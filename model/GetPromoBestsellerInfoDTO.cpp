...
std::string GetPromoBestsellerInfoDTO::toJsonString(bool prettyJson /* = false */)
{
...
boost::property_tree::ptree GetPromoBestsellerInfoDTO::toPropertyTree()
{
    return toPropertyTree_internal();
}

void GetPromoBestsellerInfoDTO::fromPropertyTree(boost::property_tree::ptree const& pt)
{
    fromPropertyTree_internal(pt);
}

std::string GetPromoBestsellerInfoDTO::toJsonString_internal(bool prettyJson)
{
	std::stringstream ss;
...
void GetPromoBestsellerInfoDTO::fromJsonString_internal(std::string const& jsonString)
{
...
ptree GetPromoBestsellerInfoDTO::toPropertyTree_internal()
{
	ptree pt;
	ptree tmp_node;
...
void GetPromoBestsellerInfoDTO::fromPropertyTree_internal(ptree const &pt)
{
	ptree tmp_node;
