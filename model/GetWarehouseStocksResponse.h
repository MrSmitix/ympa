...
public:
    ...
    bool operator==(const GetWarehouseStocksResponse& rhs) const;
    bool operator!=(const GetWarehouseStocksResponse& rhs) const;
    ...
    /// 
    /// </summary>
    org::openapitools::server::model::GetWarehouseStocksDTO getResult() const;
    void setResult(org::openapitools::server::model::GetWarehouseStocksDTO const& value);
    bool resultIsSet() const;
    void unsetResult();

    friend  void to_json(nlohmann::json& j, const GetWarehouseStocksResponse& o);
    friend  void from_json(const nlohmann::json& j, GetWarehouseStocksResponse& o);
protected:
    org::openapitools::server::model::ApiResponseStatusType m_Status;
    bool m_StatusIsSet;
    org::openapitools::server::model::GetWarehouseStocksDTO m_Result;
    bool m_ResultIsSet;
