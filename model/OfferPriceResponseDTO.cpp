...
std::string OfferPriceResponseDTO::toJsonString(bool prettyJson /* = false */) const
{
	std::stringstream ss;
...
ptree OfferPriceResponseDTO::toPropertyTree() const
{
	ptree pt;
	ptree tmp_node;
	pt.put("id", m_Id);
...
void OfferPriceResponseDTO::fromPropertyTree(ptree const &pt)
{
	ptree tmp_node;
	m_Id = pt.get("id", "");
...
PriceDTO OfferPriceResponseDTO::getPrice() const
{
    return m_Price;
}

void OfferPriceResponseDTO::setPrice(PriceDTO value)
{
    m_Price = value;
}
