...
public:
    ...
    void setBasicPrice(std::shared_ptr<UpdatePriceWithDiscountDTO> value);

    /// <summary>
    /// 
    /// </summary>
    std::shared_ptr<BasePriceDTO> getPurchasePrice() const;
    void setPurchasePrice(std::shared_ptr<BasePriceDTO> value);

    /// <summary>
    /// 
    /// </summary>
    std::shared_ptr<BasePriceDTO> getAdditionalExpenses() const;
    void setAdditionalExpenses(std::shared_ptr<BasePriceDTO> value);

    /// <summary>
    /// 
    /// </summary>
    std::shared_ptr<BasePriceDTO> getCofinancePrice() const;
    void setCofinancePrice(std::shared_ptr<BasePriceDTO> value);
