...
public:
    ...
    bool operator==(const UpdateOfferDTO& rhs) const;
    bool operator!=(const UpdateOfferDTO& rhs) const;
    ...
    /// 
    /// </summary>
    org::openapitools::server::model::UpdatePriceWithDiscountDTO getBasicPrice() const;
    void setBasicPrice(org::openapitools::server::model::UpdatePriceWithDiscountDTO const& value);
    bool basicPriceIsSet() const;
    void unsetBasicPrice();
    /// <summary>
    /// 
    /// </summary>
    org::openapitools::server::model::BasePriceDTO getPurchasePrice() const;
    void setPurchasePrice(org::openapitools::server::model::BasePriceDTO const& value);
    bool purchasePriceIsSet() const;
    void unsetPurchasePrice();
    /// <summary>
    /// 
    /// </summary>
    org::openapitools::server::model::BasePriceDTO getAdditionalExpenses() const;
    void setAdditionalExpenses(org::openapitools::server::model::BasePriceDTO const& value);
    bool additionalExpensesIsSet() const;
    void unsetAdditionalExpenses();
    /// <summary>
    /// 
    /// </summary>
    org::openapitools::server::model::BasePriceDTO getCofinancePrice() const;
    void setCofinancePrice(org::openapitools::server::model::BasePriceDTO const& value);
    bool cofinancePriceIsSet() const;
    void unsetCofinancePrice();

    friend  void to_json(nlohmann::json& j, const UpdateOfferDTO& o);
    friend  void from_json(const nlohmann::json& j, UpdateOfferDTO& o);
protected:
    ...
    org::openapitools::server::model::UpdatePriceWithDiscountDTO m_BasicPrice;
    bool m_BasicPriceIsSet;
    org::openapitools::server::model::BasePriceDTO m_PurchasePrice;
    bool m_PurchasePriceIsSet;
    org::openapitools::server::model::BasePriceDTO m_AdditionalExpenses;
    bool m_AdditionalExpensesIsSet;
    org::openapitools::server::model::BasePriceDTO m_CofinancePrice;
