...
std::string OfferCampaignStatusDTO::toJsonString(bool prettyJson /* = false */) const
{
	std::stringstream ss;
...
ptree OfferCampaignStatusDTO::toPropertyTree() const
{
	ptree pt;
	ptree tmp_node;
...
void OfferCampaignStatusDTO::fromPropertyTree(ptree const &pt)
{
	ptree tmp_node;
...
OfferCampaignStatusType OfferCampaignStatusDTO::getStatus() const
{
    return m_Status;
}

void OfferCampaignStatusDTO::setStatus(OfferCampaignStatusType value)
{
    m_Status = value;
}
