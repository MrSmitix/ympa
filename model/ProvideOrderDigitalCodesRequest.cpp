...
std::string ProvideOrderDigitalCodesRequest::toJsonString(bool prettyJson /* = false */) const
{
	std::stringstream ss;
...
ptree ProvideOrderDigitalCodesRequest::toPropertyTree() const
{
	ptree pt;
	ptree tmp_node;
...
void ProvideOrderDigitalCodesRequest::fromPropertyTree(ptree const &pt)
{
	ptree tmp_node;
	// push all items of Items into member
	if (pt.get_child_optional("items")) {
        m_Items = fromPt<std::vector<OrderDigitalItemDTO>>(pt.get_child("items"));
	}
}

std::vector<OrderDigitalItemDTO> ProvideOrderDigitalCodesRequest::getItems() const
{
    return m_Items;
}

void ProvideOrderDigitalCodesRequest::setItems(std::vector<OrderDigitalItemDTO> value)
{
    m_Items = value;
}
