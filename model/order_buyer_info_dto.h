/*
 * order_buyer_info_dto.h
 *
 * Информация о покупателе и его номере телефона.
 */

#ifndef _order_buyer_info_dto_H_
#define _order_buyer_info_dto_H_
...
typedef struct order_buyer_info_dto_t order_buyer_info_dto_t;

#include "order_buyer_type.h"

// Enum  for order_buyer_info_dto

typedef enum  { _api__order_buyer_info_dto__NULL = 0, _api__order_buyer_info_dto__PERSON, _api__order_buyer_info_dto__BUSINESS } _api__order_buyer_info_dto__e;
...
typedef struct order_buyer_info_dto_t {
    char *id; // string
...
#endif /* _order_buyer_info_dto_H_ */
