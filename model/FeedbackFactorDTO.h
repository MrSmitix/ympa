...
public:
    ...
    FeedbackFactorDTO(const FeedbackFactorDTO& other) = default; // copy constructor
    FeedbackFactorDTO(FeedbackFactorDTO&& other) noexcept = default; // move constructor

    FeedbackFactorDTO& operator=(const FeedbackFactorDTO& other) = default; // copy assignment
    FeedbackFactorDTO& operator=(FeedbackFactorDTO&& other) noexcept = default; // move assignment
...
template<>
inline boost::property_tree::ptree toPt<FeedbackFactorDTO>(const FeedbackFactorDTO& val) {
    return val.toPropertyTree();
}

template<>
inline FeedbackFactorDTO fromPt<FeedbackFactorDTO>(const boost::property_tree::ptree& pt) {
    FeedbackFactorDTO ret;
