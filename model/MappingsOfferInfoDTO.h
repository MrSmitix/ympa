...
{
public:
    MappingsOfferInfoDTO() = default;
    explicit MappingsOfferInfoDTO(boost::property_tree::ptree const& pt);
    virtual ~MappingsOfferInfoDTO() = default;

    MappingsOfferInfoDTO(const MappingsOfferInfoDTO& other) = default; // copy constructor
    MappingsOfferInfoDTO(MappingsOfferInfoDTO&& other) noexcept = default; // move constructor

    MappingsOfferInfoDTO& operator=(const MappingsOfferInfoDTO& other) = default; // copy assignment
    MappingsOfferInfoDTO& operator=(MappingsOfferInfoDTO&& other) noexcept = default; // move assignment
...
template<>
inline boost::property_tree::ptree toPt<MappingsOfferInfoDTO>(const MappingsOfferInfoDTO& val) {
    return val.toPropertyTree();
}

template<>
inline MappingsOfferInfoDTO fromPt<MappingsOfferInfoDTO>(const boost::property_tree::ptree& pt) {
    MappingsOfferInfoDTO ret;
