...
public:
    ...
    GoodsStatsGoodsDTO(const GoodsStatsGoodsDTO& other) = default; // copy constructor
    GoodsStatsGoodsDTO(GoodsStatsGoodsDTO&& other) noexcept = default; // move constructor

    GoodsStatsGoodsDTO& operator=(const GoodsStatsGoodsDTO& other) = default; // copy assignment
    GoodsStatsGoodsDTO& operator=(GoodsStatsGoodsDTO&& other) noexcept = default; // move assignment
    ...
    /// 
    /// </summary>
    GoodsStatsWeightDimensionsDTO getWeightDimensions() const;
    void setWeightDimensions(GoodsStatsWeightDimensionsDTO value);

    /// <summary>
    /// Информация о складах, на которых хранится товар.  Параметр не приходит, если товара нет ни на одном складе. 
    /// </summary>
    std::vector<GoodsStatsWarehouseDTO> getWarehouses() const;
    void setWarehouses(std::vector<GoodsStatsWarehouseDTO> value);
    ...
    /// </summary>
    std::vector<TariffDTO> getTariffs() const;
    void setTariffs(std::vector<TariffDTO> value);
...
protected:
    ...
    GoodsStatsWeightDimensionsDTO m_WeightDimensions;
    std::vector<GoodsStatsWarehouseDTO> m_Warehouses;
    std::vector<TariffDTO> m_Tariffs;
...
template<>
inline boost::property_tree::ptree toPt<GoodsStatsGoodsDTO>(const GoodsStatsGoodsDTO& val) {
    return val.toPropertyTree();
}

template<>
inline GoodsStatsGoodsDTO fromPt<GoodsStatsGoodsDTO>(const boost::property_tree::ptree& pt) {
    GoodsStatsGoodsDTO ret;
