...
public:
    ...
    bool operator==(const SuggestOfferPriceDTO& rhs) const;
    bool operator!=(const SuggestOfferPriceDTO& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const SuggestOfferPriceDTO& o);
    friend  void from_json(const nlohmann::json& j, SuggestOfferPriceDTO& o);
protected:
