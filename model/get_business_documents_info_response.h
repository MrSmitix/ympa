/*
 * get_business_documents_info_response.h
 *
 * 
 */

#ifndef _get_business_documents_info_response_H_
#define _get_business_documents_info_response_H_
...
typedef struct get_business_documents_info_response_t get_business_documents_info_response_t;

#include "api_response_status_type.h"
#include "order_business_documents_dto.h"

// Enum  for get_business_documents_info_response

typedef enum  { _api__get_business_documents_info_response__NULL = 0, _api__get_business_documents_info_response__OK, _api__get_business_documents_info_response__ERROR } _api__get_business_documents_info_response__e;
...
typedef struct get_business_documents_info_response_t {
    api_response_status_type_t *status; // custom
    struct order_business_documents_dto_t *result; //model
...
#endif /* _get_business_documents_info_response_H_ */
