...
std::string ModelOfferDTO::toJsonString(bool prettyJson /* = false */)
{
...
boost::property_tree::ptree ModelOfferDTO::toPropertyTree()
{
    return toPropertyTree_internal();
}

void ModelOfferDTO::fromPropertyTree(boost::property_tree::ptree const& pt)
{
    fromPropertyTree_internal(pt);
}

std::string ModelOfferDTO::toJsonString_internal(bool prettyJson)
{
	std::stringstream ss;
...
void ModelOfferDTO::fromJsonString_internal(std::string const& jsonString)
{
...
ptree ModelOfferDTO::toPropertyTree_internal()
{
	ptree pt;
	ptree tmp_node;
...
void ModelOfferDTO::fromPropertyTree_internal(ptree const &pt)
{
	ptree tmp_node;
