...
std::string WarehouseOffersDTO::toJsonString(bool prettyJson /* = false */)
{
...
boost::property_tree::ptree WarehouseOffersDTO::toPropertyTree()
{
    return toPropertyTree_internal();
}

void WarehouseOffersDTO::fromPropertyTree(boost::property_tree::ptree const& pt)
{
    fromPropertyTree_internal(pt);
}

std::string WarehouseOffersDTO::toJsonString_internal(bool prettyJson)
{
	std::stringstream ss;
...
void WarehouseOffersDTO::fromJsonString_internal(std::string const& jsonString)
{
...
ptree WarehouseOffersDTO::toPropertyTree_internal()
{
	ptree pt;
	ptree tmp_node;
...
void WarehouseOffersDTO::fromPropertyTree_internal(ptree const &pt)
{
	ptree tmp_node;
	...
	if (pt.get_child_optional("offers")) {
		for (const auto &childTree : pt.get_child("offers")) {
            std::shared_ptr<WarehouseOfferDTO> val =
                std::make_shared<WarehouseOfferDTO>(childTree.second);
...
std::vector<std::shared_ptr<WarehouseOfferDTO>> WarehouseOffersDTO::getOffers() const
{
    return m_Offers;
}

void WarehouseOffersDTO::setOffers(std::vector<std::shared_ptr<WarehouseOfferDTO>> value)
{
	m_Offers = value;
}
