...
public:
    ...
    bool operator==(const GetBidsInfoRequest& rhs) const;
    bool operator!=(const GetBidsInfoRequest& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const GetBidsInfoRequest& o);
    friend  void from_json(const nlohmann::json& j, GetBidsInfoRequest& o);
protected:
