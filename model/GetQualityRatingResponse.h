...
public:
    ...
    bool operator==(const GetQualityRatingResponse& rhs) const;
    bool operator!=(const GetQualityRatingResponse& rhs) const;
    ...
    /// 
    /// </summary>
    org::openapitools::server::model::CampaignsQualityRatingDTO getResult() const;
    void setResult(org::openapitools::server::model::CampaignsQualityRatingDTO const& value);
    bool resultIsSet() const;
    void unsetResult();

    friend  void to_json(nlohmann::json& j, const GetQualityRatingResponse& o);
    friend  void from_json(const nlohmann::json& j, GetQualityRatingResponse& o);
protected:
    org::openapitools::server::model::ApiResponseStatusType m_Status;
    bool m_StatusIsSet;
    org::openapitools::server::model::CampaignsQualityRatingDTO m_Result;
    bool m_ResultIsSet;
