...
std::string ParameterValueConstraintsDTO::toJsonString(bool prettyJson /* = false */) const
{
	std::stringstream ss;
...
ptree ParameterValueConstraintsDTO::toPropertyTree() const
{
	ptree pt;
	ptree tmp_node;
...
void ParameterValueConstraintsDTO::fromPropertyTree(ptree const &pt)
{
	ptree tmp_node;
