...
std::string AddOffersToArchiveErrorDTO::toJsonString(bool prettyJson /* = false */) const
{
	std::stringstream ss;
...
ptree AddOffersToArchiveErrorDTO::toPropertyTree() const
{
	ptree pt;
	ptree tmp_node;
...
void AddOffersToArchiveErrorDTO::fromPropertyTree(ptree const &pt)
{
	ptree tmp_node;
...
AddOffersToArchiveErrorType AddOffersToArchiveErrorDTO::getError() const
{
    return m_Error;
}

void AddOffersToArchiveErrorDTO::setError(AddOffersToArchiveErrorType value)
{
    m_Error = value;
}
