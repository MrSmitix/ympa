/*
 * delete_campaign_offers_request.h
 *
 * Фильтрации удаляемых товаров по offerIds. 
 */

#ifndef _delete_campaign_offers_request_H_
#define _delete_campaign_offers_request_H_
...
typedef struct delete_campaign_offers_request_t delete_campaign_offers_request_t;




typedef struct delete_campaign_offers_request_t {
    list_t *offer_ids; //primitive container

} delete_campaign_offers_request_t;
...
#endif /* _delete_campaign_offers_request_H_ */
