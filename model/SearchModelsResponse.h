...
public:
    ...
    bool operator==(const SearchModelsResponse& rhs) const;
    bool operator!=(const SearchModelsResponse& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const SearchModelsResponse& o);
    friend  void from_json(const nlohmann::json& j, SearchModelsResponse& o);
protected:
