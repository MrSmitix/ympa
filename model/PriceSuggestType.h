...
public:
    ...
    PriceSuggestType(const PriceSuggestType& other) = default; // copy constructor
    PriceSuggestType(PriceSuggestType&& other) noexcept = default; // move constructor

    PriceSuggestType& operator=(const PriceSuggestType& other) = default; // copy assignment
    PriceSuggestType& operator=(PriceSuggestType&& other) noexcept = default; // move assignment
...
protected:
    std::string m_PriceSuggestTypeEnumValue;
};

std::vector<PriceSuggestType> createPriceSuggestTypeVectorFromJsonString(const std::string& json);

template<>
inline boost::property_tree::ptree toPt<PriceSuggestType>(const PriceSuggestType& val) {
    return val.toPropertyTree();
}

template<>
inline PriceSuggestType fromPt<PriceSuggestType>(const boost::property_tree::ptree& pt) {
    PriceSuggestType ret;
