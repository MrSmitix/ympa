...
std::string OrdersStatsItemDTO::toJsonString(bool prettyJson /* = false */) const
{
	std::stringstream ss;
...
ptree OrdersStatsItemDTO::toPropertyTree() const
{
	ptree pt;
	ptree tmp_node;
...
void OrdersStatsItemDTO::fromPropertyTree(ptree const &pt)
{
	ptree tmp_node;
	...
	// push all items of Prices into member
	if (pt.get_child_optional("prices")) {
        m_Prices = fromPt<std::vector<OrdersStatsPriceDTO>>(pt.get_child("prices"));
	}
	if (pt.get_child_optional("warehouse")) {
        m_Warehouse = fromPt<OrdersStatsWarehouseDTO>(pt.get_child("warehouse"));
	}
	// push all items of Details into member
	if (pt.get_child_optional("details")) {
        m_Details = fromPt<std::vector<OrdersStatsDetailsDTO>>(pt.get_child("details"));
	}
	// push all items of CisList into member
	if (pt.get_child_optional("cisList")) {
        m_CisList = fromPt<std::vector<std::string>>(pt.get_child("cisList"));
	}
...
std::vector<OrdersStatsPriceDTO> OrdersStatsItemDTO::getPrices() const
{
    return m_Prices;
}

void OrdersStatsItemDTO::setPrices(std::vector<OrdersStatsPriceDTO> value)
{
    m_Prices = value;
}


OrdersStatsWarehouseDTO OrdersStatsItemDTO::getWarehouse() const
{
    return m_Warehouse;
}

void OrdersStatsItemDTO::setWarehouse(OrdersStatsWarehouseDTO value)
{
    m_Warehouse = value;
}


std::vector<OrdersStatsDetailsDTO> OrdersStatsItemDTO::getDetails() const
{
    return m_Details;
}

void OrdersStatsItemDTO::setDetails(std::vector<OrdersStatsDetailsDTO> value)
{
    m_Details = value;
}
