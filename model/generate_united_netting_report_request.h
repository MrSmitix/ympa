/*
 * generate_united_netting_report_request.h
 *
 * Данные, необходимые для генерации отчета: идентификатор магазина, период, за который нужен отчет, а также фильтры. 
 */

#ifndef _generate_united_netting_report_request_H_
#define _generate_united_netting_report_request_H_
...
typedef struct generate_united_netting_report_request_t generate_united_netting_report_request_t;

#include "placement_type.h"

// Enum  for generate_united_netting_report_request

typedef enum  { _api__generate_united_netting_report_request__NULL = 0, _api__generate_united_netting_report_request__FBS, _api__generate_united_netting_report_request__FBY, _api__generate_united_netting_report_request__DBS } _api__generate_united_netting_report_request__e;
...
typedef struct generate_united_netting_report_request_t {
    long business_id; //numeric
    char *date_time_from; //date time
    char *date_time_to; //date time
    char *date_from; //date
    char *date_to; //date
    long bank_order_id; //numeric
    char *bank_order_date_time; //date time
...
#endif /* _generate_united_netting_report_request_H_ */
