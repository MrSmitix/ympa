...
std::string GenerateGoodsRealizationReportRequest::toJsonString(bool prettyJson /* = false */) const
{
	std::stringstream ss;
...
ptree GenerateGoodsRealizationReportRequest::toPropertyTree() const
{
	ptree pt;
	ptree tmp_node;
...
void GenerateGoodsRealizationReportRequest::fromPropertyTree(ptree const &pt)
{
	ptree tmp_node;
