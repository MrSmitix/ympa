...
void OpenAPIFeedPublicationPriceAndStockUpdateDTO::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIFeedPublicationPriceAndStockUpdateDTO::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
