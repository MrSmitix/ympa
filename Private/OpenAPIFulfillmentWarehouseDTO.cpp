...
void OpenAPIFulfillmentWarehouseDTO::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIFulfillmentWarehouseDTO::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
