...
void OpenAPIGetQualityRatingRequest::WriteJson(JsonWriter& Writer) const
{
	...
	Writer->WriteIdentifierPrefix(TEXT("campaignIds")); WriteJsonValue(Writer, CampaignIds);
	Writer->WriteObjectEnd();
}

bool OpenAPIGetQualityRatingRequest::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
