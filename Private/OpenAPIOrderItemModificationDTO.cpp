...
void OpenAPIOrderItemModificationDTO::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIOrderItemModificationDTO::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
