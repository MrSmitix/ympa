...
#include "OpenAPIMappingsOfferInfoDTO.h"
...
void OpenAPIMappingsOfferInfoDTO::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIMappingsOfferInfoDTO::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
