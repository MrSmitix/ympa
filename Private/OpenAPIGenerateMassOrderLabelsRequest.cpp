...
void OpenAPIGenerateMassOrderLabelsRequest::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIGenerateMassOrderLabelsRequest::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
