...
void OpenAPIGetSuggestedOfferMappingsRequest::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIGetSuggestedOfferMappingsRequest::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
