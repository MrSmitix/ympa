...
void OpenAPIFullOutletLicenseDTO::WriteJson(JsonWriter& Writer) const
{
	...
	if (CheckStatus.IsSet())
	{
		Writer->WriteIdentifierPrefix(TEXT("checkStatus")); WriteJsonValue(Writer, CheckStatus.GetValue());
	}
	if (CheckComment.IsSet())
	{
		Writer->WriteIdentifierPrefix(TEXT("checkComment")); WriteJsonValue(Writer, CheckComment.GetValue());
	}
	Writer->WriteObjectEnd();
}

bool OpenAPIFullOutletLicenseDTO::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
	...
	ParseSuccess &= TryGetJsonValue(*Object, TEXT("checkStatus"), CheckStatus);
	ParseSuccess &= TryGetJsonValue(*Object, TEXT("checkComment"), CheckComment);
