...
void OpenAPIGetPromoOffersResultDTO::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIGetPromoOffersResultDTO::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
