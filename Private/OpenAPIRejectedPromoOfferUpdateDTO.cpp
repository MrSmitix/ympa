...
void OpenAPIRejectedPromoOfferUpdateDTO::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIRejectedPromoOfferUpdateDTO::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
