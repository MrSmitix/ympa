...
FString OpenAPITariffsApi::CalculateTariffsRequest::ComputePath() const
{
	FString Path(TEXT("/tariffs/calculate"));
	return Path;
}

void OpenAPITariffsApi::CalculateTariffsRequest::SetupHttpRequest(const FHttpRequestRef& HttpRequest) const
{
...
void OpenAPITariffsApi::CalculateTariffsResponse::SetHttpResponseCode(EHttpResponseCodes::Type InHttpResponseCode)
{
...
bool OpenAPITariffsApi::CalculateTariffsResponse::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
