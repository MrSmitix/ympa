...
void OpenAPIGetCampaignOffersResultDTO::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIGetCampaignOffersResultDTO::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
