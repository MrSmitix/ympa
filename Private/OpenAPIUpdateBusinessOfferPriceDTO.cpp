...
void OpenAPIUpdateBusinessOfferPriceDTO::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIUpdateBusinessOfferPriceDTO::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
