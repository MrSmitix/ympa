...
void OpenAPIGetOfferMappingsResponse::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIGetOfferMappingsResponse::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
