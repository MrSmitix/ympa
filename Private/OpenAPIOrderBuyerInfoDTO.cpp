...
#include "OpenAPIOrderBuyerInfoDTO.h"
...
void OpenAPIOrderBuyerInfoDTO::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIOrderBuyerInfoDTO::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
