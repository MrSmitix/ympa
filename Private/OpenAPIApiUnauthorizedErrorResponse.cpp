...
void OpenAPIApiUnauthorizedErrorResponse::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIApiUnauthorizedErrorResponse::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
