...
void OpenAPIGetSuggestedOfferMappingsResponse::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIGetSuggestedOfferMappingsResponse::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
