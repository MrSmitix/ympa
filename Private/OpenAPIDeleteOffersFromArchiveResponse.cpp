...
void OpenAPIDeleteOffersFromArchiveResponse::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIDeleteOffersFromArchiveResponse::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
