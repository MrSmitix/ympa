...
void OpenAPIEnrichedMappingsOfferDTO::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIEnrichedMappingsOfferDTO::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
