...
void OpenAPIGetCampaignRegionResponse::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIGetCampaignRegionResponse::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
