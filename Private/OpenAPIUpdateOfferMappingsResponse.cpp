...
void OpenAPIUpdateOfferMappingsResponse::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIUpdateOfferMappingsResponse::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
