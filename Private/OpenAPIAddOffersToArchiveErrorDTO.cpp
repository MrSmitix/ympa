...
void OpenAPIAddOffersToArchiveErrorDTO::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIAddOffersToArchiveErrorDTO::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
