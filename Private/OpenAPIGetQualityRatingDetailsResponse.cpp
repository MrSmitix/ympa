...
void OpenAPIGetQualityRatingDetailsResponse::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIGetQualityRatingDetailsResponse::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
