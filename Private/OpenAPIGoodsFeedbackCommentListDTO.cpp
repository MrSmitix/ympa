...
void OpenAPIGoodsFeedbackCommentListDTO::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIGoodsFeedbackCommentListDTO::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
