...
void OpenAPIApiNotFoundErrorResponse::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIApiNotFoundErrorResponse::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
