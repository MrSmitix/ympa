...
FString OpenAPIOrdersStatsApi::GetOrdersStatsRequest::ComputePath() const
{
...
void OpenAPIOrdersStatsApi::GetOrdersStatsRequest::SetupHttpRequest(const FHttpRequestRef& HttpRequest) const
{
...
void OpenAPIOrdersStatsApi::GetOrdersStatsResponse::SetHttpResponseCode(EHttpResponseCodes::Type InHttpResponseCode)
{
...
bool OpenAPIOrdersStatsApi::GetOrdersStatsResponse::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
