...
void OpenAPIAddOffersToArchiveResponse::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIAddOffersToArchiveResponse::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
