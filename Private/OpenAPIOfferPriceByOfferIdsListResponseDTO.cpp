...
void OpenAPIOfferPriceByOfferIdsListResponseDTO::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIOfferPriceByOfferIdsListResponseDTO::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
