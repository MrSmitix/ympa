...
void OpenAPIGenerateGoodsTurnoverRequest::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIGenerateGoodsTurnoverRequest::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
