...
void OpenAPIGetModelsOffersResponse::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIGetModelsOffersResponse::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
