...
void OpenAPIGetOrderBuyerInfoResponse::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIGetOrderBuyerInfoResponse::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
