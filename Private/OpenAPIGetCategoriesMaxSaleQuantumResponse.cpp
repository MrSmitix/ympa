...
void OpenAPIGetCategoriesMaxSaleQuantumResponse::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIGetCategoriesMaxSaleQuantumResponse::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
