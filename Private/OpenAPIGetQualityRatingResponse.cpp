...
void OpenAPIGetQualityRatingResponse::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIGetQualityRatingResponse::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
