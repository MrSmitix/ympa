...
void OpenAPIPromoOfferUpdateWarningDTO::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIPromoOfferUpdateWarningDTO::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
