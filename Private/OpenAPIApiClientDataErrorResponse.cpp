...
void OpenAPIApiClientDataErrorResponse::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIApiClientDataErrorResponse::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
