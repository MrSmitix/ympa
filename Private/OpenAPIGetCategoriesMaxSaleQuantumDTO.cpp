...
#include "OpenAPIGetCategoriesMaxSaleQuantumDTO.h"
...
void OpenAPIGetCategoriesMaxSaleQuantumDTO::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIGetCategoriesMaxSaleQuantumDTO::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
