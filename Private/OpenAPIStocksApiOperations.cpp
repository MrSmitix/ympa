...
FString OpenAPIStocksApi::GetStocksRequest::ComputePath() const
{
...
void OpenAPIStocksApi::GetStocksRequest::SetupHttpRequest(const FHttpRequestRef& HttpRequest) const
{
...
void OpenAPIStocksApi::GetStocksResponse::SetHttpResponseCode(EHttpResponseCodes::Type InHttpResponseCode)
{
...
bool OpenAPIStocksApi::GetStocksResponse::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
	return TryGetJsonValue(JsonValue, Content);
}

FString OpenAPIStocksApi::UpdateStocksRequest::ComputePath() const
{
	TMap<FString, FStringFormatArg> PathParams = { 
	{ TEXT("campaignId"), FStringFormatArg(ToUrlString(CampaignId)) } };
...
void OpenAPIStocksApi::UpdateStocksRequest::SetupHttpRequest(const FHttpRequestRef& HttpRequest) const
{
	static const TArray<FString> Consumes = { TEXT("application/json") };
	//static const TArray<FString> Produces = { TEXT("application/json") };
...
void OpenAPIStocksApi::UpdateStocksResponse::SetHttpResponseCode(EHttpResponseCodes::Type InHttpResponseCode)
{
	Response::SetHttpResponseCode(InHttpResponseCode);
	switch ((int)InHttpResponseCode)
	{
...
bool OpenAPIStocksApi::UpdateStocksResponse::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
	return TryGetJsonValue(JsonValue, Content);
}
