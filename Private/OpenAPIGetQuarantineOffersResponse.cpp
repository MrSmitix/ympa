...
void OpenAPIGetQuarantineOffersResponse::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIGetQuarantineOffersResponse::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
