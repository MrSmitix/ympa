...
#include "OpenAPIBaseShipmentDTO.h"
...
void OpenAPIBaseShipmentDTO::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIBaseShipmentDTO::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
