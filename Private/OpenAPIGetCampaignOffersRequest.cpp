...
void OpenAPIGetCampaignOffersRequest::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIGetCampaignOffersRequest::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
