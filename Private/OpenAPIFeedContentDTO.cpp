...
void OpenAPIFeedContentDTO::WriteJson(JsonWriter& Writer) const
{
	Writer->WriteObjectStart();
	if (RejectedOffersCount.IsSet())
	{
		Writer->WriteIdentifierPrefix(TEXT("rejectedOffersCount")); WriteJsonValue(Writer, RejectedOffersCount.GetValue());
	}
	if (Status.IsSet())
	{
...
bool OpenAPIFeedContentDTO::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
	...
	ParseSuccess &= TryGetJsonValue(*Object, TEXT("rejectedOffersCount"), RejectedOffersCount);
