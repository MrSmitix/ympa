...
void OpenAPICalculateTariffsResponse::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPICalculateTariffsResponse::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
