...
void OpenAPIGenerateGoodsMovementReportRequest::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIGenerateGoodsMovementReportRequest::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
