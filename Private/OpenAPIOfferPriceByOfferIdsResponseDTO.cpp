...
void OpenAPIOfferPriceByOfferIdsResponseDTO::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIOfferPriceByOfferIdsResponseDTO::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
