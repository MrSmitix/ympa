...
void OpenAPIApiForbiddenErrorResponse::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIApiForbiddenErrorResponse::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
