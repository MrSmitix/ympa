...
class SuggestedOfferMappingDTO(BaseModel):
    """
    Товар с соответствующей карточкой на Маркете.  # noqa: E501
    """
    offer: Optional[SuggestedOfferDTO] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SuggestedOfferMappingDTO:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SuggestedOfferMappingDTO:
        """Create an instance of SuggestedOfferMappingDTO from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SuggestedOfferMappingDTO.parse_obj(obj)

        _obj = SuggestedOfferMappingDTO.parse_obj({
            "offer": SuggestedOfferDTO.from_dict(obj.get("offer")) if obj.get("offer") is not None else None,
