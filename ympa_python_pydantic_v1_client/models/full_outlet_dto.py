...
class FullOutletDTO(BaseModel):
    """
    Информация о точке продаж.  # noqa: E501
    """
    ...
    id: Optional[StrictInt] = Field(default=None, description="Идентификатор точки продаж, присвоенный Маркетом.")
    status: Optional[OutletStatusType] = None
    region: Optional[RegionDTO] = None
    shop_outlet_id: Optional[StrictStr] = Field(default=None, alias="shopOutletId", description="Идентификатор точки продаж, заданный магазином.")
    working_time: Optional[StrictStr] = Field(default=None, alias="workingTime", description="Рабочее время.")
    moderation_reason: Optional[StrictStr] = Field(default=None, alias="moderationReason", description="Статус модерации.")
    __properties = ["name", "type", "coords", "isMain", "shopOutletCode", "visibility", "address", "phones", "workingSchedule", "deliveryRules", "storagePeriod", "id", "status", "region", "shopOutletId", "workingTime", "moderationReason"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FullOutletDTO:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FullOutletDTO:
        """Create an instance of FullOutletDTO from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FullOutletDTO.parse_obj(obj)

        _obj = FullOutletDTO.parse_obj({
            "name": obj.get("name"),
            "type": obj.get("type"),
            ...
            "shop_outlet_id": obj.get("shopOutletId"),
            "working_time": obj.get("workingTime"),
            "moderation_reason": obj.get("moderationReason")
        })
        return _obj
