...
class GetBusinessDocumentsInfoResponse(BaseModel):
    """
    GetBusinessDocumentsInfoResponse
    """
    status: Optional[ApiResponseStatusType] = None
    result: Optional[OrderBusinessDocumentsDTO] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetBusinessDocumentsInfoResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetBusinessDocumentsInfoResponse:
        """Create an instance of GetBusinessDocumentsInfoResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetBusinessDocumentsInfoResponse.parse_obj(obj)

        _obj = GetBusinessDocumentsInfoResponse.parse_obj({
            "status": obj.get("status"),
            "result": OrderBusinessDocumentsDTO.from_dict(obj.get("result")) if obj.get("result") is not None else None
        })
        return _obj
