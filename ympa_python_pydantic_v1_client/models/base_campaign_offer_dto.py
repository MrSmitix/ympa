...
class BaseCampaignOfferDTO(BaseModel):
    """
    Информация о новой цене на товар.  # noqa: E501
    """
    ...
    __properties = ["offerId", "quantum", "available"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BaseCampaignOfferDTO:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BaseCampaignOfferDTO:
        """Create an instance of BaseCampaignOfferDTO from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BaseCampaignOfferDTO.parse_obj(obj)

        _obj = BaseCampaignOfferDTO.parse_obj({
