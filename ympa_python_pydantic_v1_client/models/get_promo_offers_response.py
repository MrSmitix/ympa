...
class GetPromoOffersResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetPromoOffersResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetPromoOffersResponse:
        """Create an instance of GetPromoOffersResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetPromoOffersResponse.parse_obj(obj)

        _obj = GetPromoOffersResponse.parse_obj({
