...
class GetShipmentOrdersInfoResponse(BaseModel):
    """
    GetShipmentOrdersInfoResponse
    """
    status: Optional[ApiResponseStatusType] = None
    result: Optional[OrdersShipmentInfoDTO] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetShipmentOrdersInfoResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetShipmentOrdersInfoResponse:
        """Create an instance of GetShipmentOrdersInfoResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetShipmentOrdersInfoResponse.parse_obj(obj)

        _obj = GetShipmentOrdersInfoResponse.parse_obj({
            "status": obj.get("status"),
            "result": OrdersShipmentInfoDTO.from_dict(obj.get("result")) if obj.get("result") is not None else None
        })
        return _obj
