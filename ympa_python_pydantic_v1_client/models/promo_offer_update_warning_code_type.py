...
class PromoOfferUpdateWarningCodeType(str, Enum):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PromoOfferUpdateWarningCodeType:
        """Create an instance of PromoOfferUpdateWarningCodeType from a JSON string"""
        return PromoOfferUpdateWarningCodeType(json.loads(json_str))
