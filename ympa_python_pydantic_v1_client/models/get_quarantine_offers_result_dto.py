...
class GetQuarantineOffersResultDTO(BaseModel):
    """
    Список товаров в карантине.  # noqa: E501
    """
    paging: Optional[ScrollingPagerDTO] = None
    offers: conlist(QuarantineOfferDTO) = Field(default=..., description="Страница списка товаров в карантине.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetQuarantineOffersResultDTO:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetQuarantineOffersResultDTO:
        """Create an instance of GetQuarantineOffersResultDTO from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetQuarantineOffersResultDTO.parse_obj(obj)

        _obj = GetQuarantineOffersResultDTO.parse_obj({
            "paging": ScrollingPagerDTO.from_dict(obj.get("paging")) if obj.get("paging") is not None else None,
            "offers": [QuarantineOfferDTO.from_dict(_item) for _item in obj.get("offers")] if obj.get("offers") is not None else None
        })
        return _obj
