...
class FeedIndexLogsFeedDTO(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FeedIndexLogsFeedDTO:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FeedIndexLogsFeedDTO:
        """Create an instance of FeedIndexLogsFeedDTO from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FeedIndexLogsFeedDTO.parse_obj(obj)

        _obj = FeedIndexLogsFeedDTO.parse_obj({
            "id": obj.get("id")
        })
        return _obj
