...
class GenerateReportResponse(BaseModel):
    """
    Ответ на запрос генерации отчета.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GenerateReportResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GenerateReportResponse:
        """Create an instance of GenerateReportResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GenerateReportResponse.parse_obj(obj)

        _obj = GenerateReportResponse.parse_obj({
            "status": obj.get("status"),
            "result": GenerateReportDTO.from_dict(obj.get("result")) if obj.get("result") is not None else None
        })
        return _obj
