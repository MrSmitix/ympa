...
class OfferContentErrorDTO(BaseModel):
    ...
    """
    type: OfferContentErrorType = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OfferContentErrorDTO:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OfferContentErrorDTO:
        """Create an instance of OfferContentErrorDTO from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OfferContentErrorDTO.parse_obj(obj)

        _obj = OfferContentErrorDTO.parse_obj({
            "type": obj.get("type"),
