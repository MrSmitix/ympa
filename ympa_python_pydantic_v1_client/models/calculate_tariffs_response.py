...
class CalculateTariffsResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CalculateTariffsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CalculateTariffsResponse:
        """Create an instance of CalculateTariffsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CalculateTariffsResponse.parse_obj(obj)

        _obj = CalculateTariffsResponse.parse_obj({
