...
class SetOrderShipmentBoxesResponse(BaseModel):
    """
    SetOrderShipmentBoxesResponse
    """
    status: Optional[ApiResponseStatusType] = None
    result: Optional[ShipmentBoxesDTO] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SetOrderShipmentBoxesResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SetOrderShipmentBoxesResponse:
        """Create an instance of SetOrderShipmentBoxesResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SetOrderShipmentBoxesResponse.parse_obj(obj)

        _obj = SetOrderShipmentBoxesResponse.parse_obj({
            "status": obj.get("status"),
            "result": ShipmentBoxesDTO.from_dict(obj.get("result")) if obj.get("result") is not None else None
        })
        return _obj
