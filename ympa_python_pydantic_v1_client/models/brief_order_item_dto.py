...
class BriefOrderItemDTO(BaseModel):
    """
    Информация о маркированном товаре.  # noqa: E501
    """
    ...
    instances: Optional[conlist(OrderItemInstanceDTO)] = Field(default=None, description="Переданные вами коды маркировки.")
    __properties = ["id", "vat", "count", "price", "offerName", "offerId", "instances"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BriefOrderItemDTO:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BriefOrderItemDTO:
        """Create an instance of BriefOrderItemDTO from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BriefOrderItemDTO.parse_obj(obj)

        _obj = BriefOrderItemDTO.parse_obj({
            "id": obj.get("id"),
            "vat": obj.get("vat"),
            "count": obj.get("count"),
            "price": obj.get("price"),
