...
class MappingsOfferDTO(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MappingsOfferDTO:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MappingsOfferDTO:
        """Create an instance of MappingsOfferDTO from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MappingsOfferDTO.parse_obj(obj)

        _obj = MappingsOfferDTO.parse_obj({
            "name": obj.get("name"),
