...
class GetFulfillmentWarehousesResponse(BaseModel):
    """
    GetFulfillmentWarehousesResponse
    """
    status: Optional[ApiResponseStatusType] = None
    result: Optional[FulfillmentWarehousesDTO] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetFulfillmentWarehousesResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetFulfillmentWarehousesResponse:
        """Create an instance of GetFulfillmentWarehousesResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetFulfillmentWarehousesResponse.parse_obj(obj)

        _obj = GetFulfillmentWarehousesResponse.parse_obj({
            "status": obj.get("status"),
            "result": FulfillmentWarehousesDTO.from_dict(obj.get("result")) if obj.get("result") is not None else None
        })
        return _obj
