...
class FeedContentErrorType(str, Enum):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FeedContentErrorType:
        """Create an instance of FeedContentErrorType from a JSON string"""
        return FeedContentErrorType(json.loads(json_str))
