...
class GetPromosResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetPromosResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetPromosResponse:
        """Create an instance of GetPromosResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetPromosResponse.parse_obj(obj)

        _obj = GetPromosResponse.parse_obj({
