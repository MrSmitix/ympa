...
class RejectedPromoOfferUpdateDTO(BaseModel):
    """
    Описание отклоненного изменения.  # noqa: E501
    """
    ...
    reason: RejectedPromoOfferUpdateReasonType = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RejectedPromoOfferUpdateDTO:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RejectedPromoOfferUpdateDTO:
        """Create an instance of RejectedPromoOfferUpdateDTO from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RejectedPromoOfferUpdateDTO.parse_obj(obj)

        _obj = RejectedPromoOfferUpdateDTO.parse_obj({
