...
class GetPricesResponse(BaseModel):
    ...
    result: Optional[OfferPriceListResponseDTO] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetPricesResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetPricesResponse:
        """Create an instance of GetPricesResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetPricesResponse.parse_obj(obj)

        _obj = GetPricesResponse.parse_obj({
            "status": obj.get("status"),
            "result": OfferPriceListResponseDTO.from_dict(obj.get("result")) if obj.get("result") is not None else None
        })
        return _obj
