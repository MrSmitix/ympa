...
class GetShipmentResponse(BaseModel):
    ...
    result: Optional[ShipmentDTO] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetShipmentResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetShipmentResponse:
        """Create an instance of GetShipmentResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetShipmentResponse.parse_obj(obj)

        _obj = GetShipmentResponse.parse_obj({
            "status": obj.get("status"),
            "result": ShipmentDTO.from_dict(obj.get("result")) if obj.get("result") is not None else None
        })
        return _obj
