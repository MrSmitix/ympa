...
class GetBidsInfoResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetBidsInfoResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetBidsInfoResponse:
        """Create an instance of GetBidsInfoResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetBidsInfoResponse.parse_obj(obj)

        _obj = GetBidsInfoResponse.parse_obj({
