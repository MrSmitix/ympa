...
class GetCampaignResponse(BaseModel):
    """
    Информация о магазине к данным идентификатора кампании.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetCampaignResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetCampaignResponse:
        """Create an instance of GetCampaignResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetCampaignResponse.parse_obj(obj)

        _obj = GetCampaignResponse.parse_obj({
            "campaign": CampaignDTO.from_dict(obj.get("campaign")) if obj.get("campaign") is not None else None
        })
        return _obj
