...
class UpdateTimeDTO(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateTimeDTO:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateTimeDTO:
        """Create an instance of UpdateTimeDTO from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateTimeDTO.parse_obj(obj)

        _obj = UpdateTimeDTO.parse_obj({
