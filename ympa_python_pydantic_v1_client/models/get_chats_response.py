...
class GetChatsResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetChatsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetChatsResponse:
        """Create an instance of GetChatsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetChatsResponse.parse_obj(obj)

        _obj = GetChatsResponse.parse_obj({
