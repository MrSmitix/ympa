...
class GetPromoOffersResultDTO(BaseModel):
    """
    Список товаров, которые участвуют или могут участвовать в акции.  # noqa: E501
    """
    offers: conlist(GetPromoOfferDTO) = Field(default=..., description="Товары, которые участвуют или могут участвовать в акции.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetPromoOffersResultDTO:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetPromoOffersResultDTO:
        """Create an instance of GetPromoOffersResultDTO from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetPromoOffersResultDTO.parse_obj(obj)

        _obj = GetPromoOffersResultDTO.parse_obj({
            "offers": [GetPromoOfferDTO.from_dict(_item) for _item in obj.get("offers")] if obj.get("offers") is not None else None,
