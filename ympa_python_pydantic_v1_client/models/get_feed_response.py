...
class GetFeedResponse(BaseModel):
    """
    Ответ на запрос информации о прайс-листе.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetFeedResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetFeedResponse:
        """Create an instance of GetFeedResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetFeedResponse.parse_obj(obj)

        _obj = GetFeedResponse.parse_obj({
            "feed": FeedDTO.from_dict(obj.get("feed")) if obj.get("feed") is not None else None
        })
        return _obj
