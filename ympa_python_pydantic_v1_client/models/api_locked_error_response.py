...
class ApiLockedErrorResponse(BaseModel):
    """
    Ресурс из запроса заблокирован от применения к нему указанного метода.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiLockedErrorResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiLockedErrorResponse:
        """Create an instance of ApiLockedErrorResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiLockedErrorResponse.parse_obj(obj)

        _obj = ApiLockedErrorResponse.parse_obj({
