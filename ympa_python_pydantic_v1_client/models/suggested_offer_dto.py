...
class SuggestedOfferDTO(BaseModel):
    ...
    __properties = ["offerId", "name", "category", "vendor", "barcodes", "description", "vendorCode", "basicPrice"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SuggestedOfferDTO:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SuggestedOfferDTO:
        """Create an instance of SuggestedOfferDTO from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SuggestedOfferDTO.parse_obj(obj)

        _obj = SuggestedOfferDTO.parse_obj({
            ...
            "basic_price": BasePriceDTO.from_dict(obj.get("basicPrice")) if obj.get("basicPrice") is not None else None
        })
        return _obj
