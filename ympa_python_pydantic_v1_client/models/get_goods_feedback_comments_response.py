...
class GetGoodsFeedbackCommentsResponse(BaseModel):
    """
    GetGoodsFeedbackCommentsResponse
    """
    status: Optional[ApiResponseStatusType] = None
    result: Optional[GoodsFeedbackCommentListDTO] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetGoodsFeedbackCommentsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetGoodsFeedbackCommentsResponse:
        """Create an instance of GetGoodsFeedbackCommentsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetGoodsFeedbackCommentsResponse.parse_obj(obj)

        _obj = GetGoodsFeedbackCommentsResponse.parse_obj({
            "status": obj.get("status"),
            "result": GoodsFeedbackCommentListDTO.from_dict(obj.get("result")) if obj.get("result") is not None else None
        })
        return _obj
