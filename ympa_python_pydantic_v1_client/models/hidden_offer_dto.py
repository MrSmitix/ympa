...
class HiddenOfferDTO(BaseModel):
    """
    Информация о скрытии.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> HiddenOfferDTO:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> HiddenOfferDTO:
        """Create an instance of HiddenOfferDTO from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return HiddenOfferDTO.parse_obj(obj)

        _obj = HiddenOfferDTO.parse_obj({
