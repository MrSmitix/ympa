...
class GetCategoriesResponse(BaseModel):
    ...
    result: Optional[CategoryDTO] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetCategoriesResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetCategoriesResponse:
        """Create an instance of GetCategoriesResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetCategoriesResponse.parse_obj(obj)

        _obj = GetCategoriesResponse.parse_obj({
            "status": obj.get("status"),
            "result": CategoryDTO.from_dict(obj.get("result")) if obj.get("result") is not None else None
        })
        return _obj
