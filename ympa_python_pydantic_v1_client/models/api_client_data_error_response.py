...
class ApiClientDataErrorResponse(BaseModel):
    """
    Ошибка в данных переданных от клиента.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiClientDataErrorResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiClientDataErrorResponse:
        """Create an instance of ApiClientDataErrorResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiClientDataErrorResponse.parse_obj(obj)

        _obj = ApiClientDataErrorResponse.parse_obj({
