...
class GetOfferMappingsResultDTO(BaseModel):
    ...
    offer_mappings: conlist(GetOfferMappingDTO) = Field(default=..., alias="offerMappings", description="Информация о товарах.")
    __properties = ["paging", "offerMappings"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetOfferMappingsResultDTO:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetOfferMappingsResultDTO:
        """Create an instance of GetOfferMappingsResultDTO from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetOfferMappingsResultDTO.parse_obj(obj)

        _obj = GetOfferMappingsResultDTO.parse_obj({
            "paging": ScrollingPagerDTO.from_dict(obj.get("paging")) if obj.get("paging") is not None else None,
            "offer_mappings": [GetOfferMappingDTO.from_dict(_item) for _item in obj.get("offerMappings")] if obj.get("offerMappings") is not None else None
        })
        return _obj
