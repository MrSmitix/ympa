...
class AddOffersToArchiveErrorDTO(BaseModel):
    """
    Товар, который не удалось поместить в архив.  # noqa: E501
    """
    ...
    error: AddOffersToArchiveErrorType = Field(...)
    __properties = ["offerId", "error"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AddOffersToArchiveErrorDTO:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AddOffersToArchiveErrorDTO:
        """Create an instance of AddOffersToArchiveErrorDTO from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AddOffersToArchiveErrorDTO.parse_obj(obj)

        _obj = AddOffersToArchiveErrorDTO.parse_obj({
