...
class UpdatePromoOfferDTO(BaseModel):
    """
    Описание товаров, которые участвуют в акции.  # noqa: E501
    """
    ...
    params: Optional[UpdatePromoOfferParamsDTO] = None
    __properties = ["offerId", "params"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdatePromoOfferDTO:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdatePromoOfferDTO:
        """Create an instance of UpdatePromoOfferDTO from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdatePromoOfferDTO.parse_obj(obj)

        _obj = UpdatePromoOfferDTO.parse_obj({
            "offer_id": obj.get("offerId"),
            "params": UpdatePromoOfferParamsDTO.from_dict(obj.get("params")) if obj.get("params") is not None else None
        })
        return _obj
