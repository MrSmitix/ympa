...
class EnrichedMappingsOfferDTO(BaseModel):
    """
    Информация о рекомендованных карточках товаров.  # noqa: E501
    """
    ...
    market_category_id: Optional[StrictInt] = Field(default=None, alias="marketCategoryId", description="Идентификатор категории для рекомендованной карточки товара на Маркете.  Возвращается только вместе с параметром ##marketSku##. ")
    market_category_name: Optional[StrictStr] = Field(default=None, alias="marketCategoryName", description="Название категории для рекомендованной карточки товара на Маркете.  Может отсутствовать в ответе. ")
    market_model_id: Optional[StrictInt] = Field(default=None, alias="marketModelId", description="Идентификатор модели для рекомендованной карточки товара на Маркете.  Может отсутствовать в ответе. ")
    market_model_name: Optional[StrictStr] = Field(default=None, alias="marketModelName", description="Название модели для рекомендованной карточки товара на Маркете.  Возвращается только вместе с параметром ##marketSku##. ")
    market_sku: Optional[StrictInt] = Field(default=None, alias="marketSku", description="SKU на Маркете.")
    market_sku_name: Optional[StrictStr] = Field(default=None, alias="marketSkuName", description="Название товара с рекомендованной карточки на Маркете.  Может отсутствовать в ответе. ")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EnrichedMappingsOfferDTO:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EnrichedMappingsOfferDTO:
        """Create an instance of EnrichedMappingsOfferDTO from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EnrichedMappingsOfferDTO.parse_obj(obj)

        _obj = EnrichedMappingsOfferDTO.parse_obj({
            "name": obj.get("name"),
