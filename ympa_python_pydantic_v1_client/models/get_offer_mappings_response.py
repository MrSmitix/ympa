...
class GetOfferMappingsResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetOfferMappingsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetOfferMappingsResponse:
        """Create an instance of GetOfferMappingsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetOfferMappingsResponse.parse_obj(obj)

        _obj = GetOfferMappingsResponse.parse_obj({
