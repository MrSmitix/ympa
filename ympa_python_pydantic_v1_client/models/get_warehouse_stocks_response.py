...
class GetWarehouseStocksResponse(BaseModel):
    """
    GetWarehouseStocksResponse
    """
    status: Optional[ApiResponseStatusType] = None
    result: Optional[GetWarehouseStocksDTO] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetWarehouseStocksResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetWarehouseStocksResponse:
        """Create an instance of GetWarehouseStocksResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetWarehouseStocksResponse.parse_obj(obj)

        _obj = GetWarehouseStocksResponse.parse_obj({
            "status": obj.get("status"),
            "result": GetWarehouseStocksDTO.from_dict(obj.get("result")) if obj.get("result") is not None else None
        })
        return _obj
