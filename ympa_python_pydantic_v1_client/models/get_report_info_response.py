...
class GetReportInfoResponse(BaseModel):
    """
    Ответ на запрос информации об отчете.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetReportInfoResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetReportInfoResponse:
        """Create an instance of GetReportInfoResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetReportInfoResponse.parse_obj(obj)

        _obj = GetReportInfoResponse.parse_obj({
            "status": obj.get("status"),
            "result": ReportInfoDTO.from_dict(obj.get("result")) if obj.get("result") is not None else None
        })
        return _obj
