...
class UpdateMappingsOfferDTO(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateMappingsOfferDTO:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateMappingsOfferDTO:
        """Create an instance of UpdateMappingsOfferDTO from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateMappingsOfferDTO.parse_obj(obj)

        _obj = UpdateMappingsOfferDTO.parse_obj({
            "name": obj.get("name"),
