...
class PromoOfferParticipationStatusFilterType(str, Enum):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PromoOfferParticipationStatusFilterType:
        """Create an instance of PromoOfferParticipationStatusFilterType from a JSON string"""
        return PromoOfferParticipationStatusFilterType(json.loads(json_str))
