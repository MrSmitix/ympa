...
class GetModelsOffersResponse(BaseModel):
    """
    Ответ на запрос списка предложений для моделей.  # noqa: E501
    """
    ...
    __properties = ["models", "currency", "regionId"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetModelsOffersResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetModelsOffersResponse:
        """Create an instance of GetModelsOffersResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetModelsOffersResponse.parse_obj(obj)

        _obj = GetModelsOffersResponse.parse_obj({
