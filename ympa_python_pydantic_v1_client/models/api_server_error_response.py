...
class ApiServerErrorResponse(BaseModel):
    """
    Внутренняя ошибка сервера.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiServerErrorResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiServerErrorResponse:
        """Create an instance of ApiServerErrorResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiServerErrorResponse.parse_obj(obj)

        _obj = ApiServerErrorResponse.parse_obj({
