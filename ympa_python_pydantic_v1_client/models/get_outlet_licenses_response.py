...
class GetOutletLicensesResponse(BaseModel):
    """
    GetOutletLicensesResponse
    """
    status: Optional[ApiResponseStatusType] = None
    result: Optional[OutletLicensesResponseDTO] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetOutletLicensesResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetOutletLicensesResponse:
        """Create an instance of GetOutletLicensesResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetOutletLicensesResponse.parse_obj(obj)

        _obj = GetOutletLicensesResponse.parse_obj({
            "status": obj.get("status"),
            "result": OutletLicensesResponseDTO.from_dict(obj.get("result")) if obj.get("result") is not None else None
        })
        return _obj
