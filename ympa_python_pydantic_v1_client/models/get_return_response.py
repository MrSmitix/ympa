...
class GetReturnResponse(BaseModel):
    ...
    result: Optional[ReturnDTO] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetReturnResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetReturnResponse:
        """Create an instance of GetReturnResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetReturnResponse.parse_obj(obj)

        _obj = GetReturnResponse.parse_obj({
            "status": obj.get("status"),
            "result": ReturnDTO.from_dict(obj.get("result")) if obj.get("result") is not None else None
        })
        return _obj
