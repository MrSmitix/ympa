...
class ApiLimitErrorResponse(BaseModel):
    """
    Превышено ограничение на доступ к ресурсу.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiLimitErrorResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiLimitErrorResponse:
        """Create an instance of ApiLimitErrorResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiLimitErrorResponse.parse_obj(obj)

        _obj = ApiLimitErrorResponse.parse_obj({
