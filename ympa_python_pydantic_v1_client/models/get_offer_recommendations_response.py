...
class GetOfferRecommendationsResponse(BaseModel):
    """
    GetOfferRecommendationsResponse
    """
    status: Optional[ApiResponseStatusType] = None
    result: Optional[OfferRecommendationsResultDTO] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetOfferRecommendationsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetOfferRecommendationsResponse:
        """Create an instance of GetOfferRecommendationsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetOfferRecommendationsResponse.parse_obj(obj)

        _obj = GetOfferRecommendationsResponse.parse_obj({
            "status": obj.get("status"),
            "result": OfferRecommendationsResultDTO.from_dict(obj.get("result")) if obj.get("result") is not None else None
        })
        return _obj
