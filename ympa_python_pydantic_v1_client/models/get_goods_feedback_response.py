...
class GetGoodsFeedbackResponse(BaseModel):
    """
    GetGoodsFeedbackResponse
    """
    status: Optional[ApiResponseStatusType] = None
    result: Optional[GoodsFeedbackListDTO] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetGoodsFeedbackResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetGoodsFeedbackResponse:
        """Create an instance of GetGoodsFeedbackResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetGoodsFeedbackResponse.parse_obj(obj)

        _obj = GetGoodsFeedbackResponse.parse_obj({
            "status": obj.get("status"),
            "result": GoodsFeedbackListDTO.from_dict(obj.get("result")) if obj.get("result") is not None else None
        })
        return _obj
