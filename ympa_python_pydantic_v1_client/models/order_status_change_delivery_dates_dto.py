...
class OrderStatusChangeDeliveryDatesDTO(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OrderStatusChangeDeliveryDatesDTO:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OrderStatusChangeDeliveryDatesDTO:
        """Create an instance of OrderStatusChangeDeliveryDatesDTO from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OrderStatusChangeDeliveryDatesDTO.parse_obj(obj)

        _obj = OrderStatusChangeDeliveryDatesDTO.parse_obj({
