...
class EmptyApiResponse(BaseModel):
    """
    Пустой ответ сервера.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EmptyApiResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EmptyApiResponse:
        """Create an instance of EmptyApiResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EmptyApiResponse.parse_obj(obj)

        _obj = EmptyApiResponse.parse_obj({
