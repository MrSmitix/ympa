...
class UpdateBusinessOfferPriceDTO(BaseModel):
    """
    Товар с новой ценой.  # noqa: E501
    """
    ...
    price: UpdatePriceWithDiscountDTO = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateBusinessOfferPriceDTO:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateBusinessOfferPriceDTO:
        """Create an instance of UpdateBusinessOfferPriceDTO from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateBusinessOfferPriceDTO.parse_obj(obj)

        _obj = UpdateBusinessOfferPriceDTO.parse_obj({
            "offer_id": obj.get("offerId"),
            "price": UpdatePriceWithDiscountDTO.from_dict(obj.get("price")) if obj.get("price") is not None else None
        })
        return _obj
