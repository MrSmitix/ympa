...
class GetChatHistoryResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetChatHistoryResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetChatHistoryResponse:
        """Create an instance of GetChatHistoryResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetChatHistoryResponse.parse_obj(obj)

        _obj = GetChatHistoryResponse.parse_obj({
