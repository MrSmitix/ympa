...
class GetFeedIndexLogsResponse(BaseModel):
    """
    GetFeedIndexLogsResponse
    """
    status: Optional[ApiResponseStatusType] = None
    result: Optional[FeedIndexLogsResultDTO] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetFeedIndexLogsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetFeedIndexLogsResponse:
        """Create an instance of GetFeedIndexLogsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetFeedIndexLogsResponse.parse_obj(obj)

        _obj = GetFeedIndexLogsResponse.parse_obj({
            "status": obj.get("status"),
            "result": FeedIndexLogsResultDTO.from_dict(obj.get("result")) if obj.get("result") is not None else None
        })
        return _obj
