...
class UpdateOfferMappingEntryDTO(BaseModel):
    """
    Список товаров.  В теле запроса можно передать от одного до 500 товаров.  Обязательный параметр.   # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateOfferMappingEntryDTO:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateOfferMappingEntryDTO:
        """Create an instance of UpdateOfferMappingEntryDTO from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateOfferMappingEntryDTO.parse_obj(obj)

        _obj = UpdateOfferMappingEntryDTO.parse_obj({
