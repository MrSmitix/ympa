...
class VerifyOrderEacResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VerifyOrderEacResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VerifyOrderEacResponse:
        """Create an instance of VerifyOrderEacResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VerifyOrderEacResponse.parse_obj(obj)

        _obj = VerifyOrderEacResponse.parse_obj({
