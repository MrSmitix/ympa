...
class FeedPublicationFullDTO(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FeedPublicationFullDTO:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FeedPublicationFullDTO:
        """Create an instance of FeedPublicationFullDTO from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FeedPublicationFullDTO.parse_obj(obj)

        _obj = FeedPublicationFullDTO.parse_obj({
