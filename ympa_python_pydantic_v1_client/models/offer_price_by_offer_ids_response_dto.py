...
class OfferPriceByOfferIdsResponseDTO(BaseModel):
    """
    Информация об установленной цене.  # noqa: E501
    """
    ...
    updated_at: Optional[datetime] = Field(default=None, alias="updatedAt", description="Дата и время последнего обновления цены.")
    __properties = ["offerId", "price", "updatedAt"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OfferPriceByOfferIdsResponseDTO:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OfferPriceByOfferIdsResponseDTO:
        """Create an instance of OfferPriceByOfferIdsResponseDTO from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OfferPriceByOfferIdsResponseDTO.parse_obj(obj)

        _obj = OfferPriceByOfferIdsResponseDTO.parse_obj({
