...
class GetBusinessBuyerInfoResponse(BaseModel):
    """
    GetBusinessBuyerInfoResponse
    """
    status: Optional[ApiResponseStatusType] = None
    result: Optional[OrderBusinessBuyerDTO] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetBusinessBuyerInfoResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetBusinessBuyerInfoResponse:
        """Create an instance of GetBusinessBuyerInfoResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetBusinessBuyerInfoResponse.parse_obj(obj)

        _obj = GetBusinessBuyerInfoResponse.parse_obj({
            "status": obj.get("status"),
            "result": OrderBusinessBuyerDTO.from_dict(obj.get("result")) if obj.get("result") is not None else None
        })
        return _obj
