...
class GetBidsRecommendationsResponse(BaseModel):
    """
    description.  # noqa: E501
    """
    status: Optional[ApiResponseStatusType] = None
    result: Optional[GetBidsRecommendationsResponseDTO] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetBidsRecommendationsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetBidsRecommendationsResponse:
        """Create an instance of GetBidsRecommendationsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetBidsRecommendationsResponse.parse_obj(obj)

        _obj = GetBidsRecommendationsResponse.parse_obj({
            "status": obj.get("status"),
            "result": GetBidsRecommendationsResponseDTO.from_dict(obj.get("result")) if obj.get("result") is not None else None
        })
        return _obj
