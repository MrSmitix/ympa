...
class ProvideOrderItemIdentifiersResponse(BaseModel):
    """
    ProvideOrderItemIdentifiersResponse
    """
    status: Optional[ApiResponseStatusType] = None
    result: Optional[OrderItemsModificationResultDTO] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProvideOrderItemIdentifiersResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProvideOrderItemIdentifiersResponse:
        """Create an instance of ProvideOrderItemIdentifiersResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ProvideOrderItemIdentifiersResponse.parse_obj(obj)

        _obj = ProvideOrderItemIdentifiersResponse.parse_obj({
            "status": obj.get("status"),
            "result": OrderItemsModificationResultDTO.from_dict(obj.get("result")) if obj.get("result") is not None else None
        })
        return _obj
