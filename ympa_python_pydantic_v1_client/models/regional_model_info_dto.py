...
class RegionalModelInfoDTO(BaseModel):
    """
    Региональная информация.  # noqa: E501
    """
    ...
    __properties = ["currency", "regionId"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RegionalModelInfoDTO:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RegionalModelInfoDTO:
        """Create an instance of RegionalModelInfoDTO from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RegionalModelInfoDTO.parse_obj(obj)

        _obj = RegionalModelInfoDTO.parse_obj({
