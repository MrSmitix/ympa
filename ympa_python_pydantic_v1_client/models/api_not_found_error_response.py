...
class ApiNotFoundErrorResponse(BaseModel):
    """
    Запрашиваемый ресурс не найден.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiNotFoundErrorResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiNotFoundErrorResponse:
        """Create an instance of ApiNotFoundErrorResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiNotFoundErrorResponse.parse_obj(obj)

        _obj = ApiNotFoundErrorResponse.parse_obj({
