...
class ShipmentDTO(BaseModel):
    ...
    __properties = ["id", "planIntervalFrom", "planIntervalTo", "shipmentType", "warehouse", "warehouseTo", "externalId", "deliveryService", "palletsCount", "orderIds", "draftCount", "plannedCount", "factCount", "currentStatus", "availableActions"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ShipmentDTO:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ShipmentDTO:
        """Create an instance of ShipmentDTO from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ShipmentDTO.parse_obj(obj)

        _obj = ShipmentDTO.parse_obj({
            "id": obj.get("id"),
