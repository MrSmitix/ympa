...
class GetOfferMappingDTO(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetOfferMappingDTO:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetOfferMappingDTO:
        """Create an instance of GetOfferMappingDTO from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetOfferMappingDTO.parse_obj(obj)

        _obj = GetOfferMappingDTO.parse_obj({
            "offer": GetOfferDTO.from_dict(obj.get("offer")) if obj.get("offer") is not None else None,
