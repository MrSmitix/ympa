...
class DeleteOffersResponse(BaseModel):
    ...
    result: Optional[DeleteOffersDTO] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DeleteOffersResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DeleteOffersResponse:
        """Create an instance of DeleteOffersResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DeleteOffersResponse.parse_obj(obj)

        _obj = DeleteOffersResponse.parse_obj({
            "status": obj.get("status"),
            "result": DeleteOffersDTO.from_dict(obj.get("result")) if obj.get("result") is not None else None
        })
        return _obj
