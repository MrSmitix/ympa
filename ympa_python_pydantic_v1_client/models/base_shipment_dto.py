...
class BaseShipmentDTO(BaseModel):
    ...
    __properties = ["id", "planIntervalFrom", "planIntervalTo", "shipmentType", "warehouse", "warehouseTo", "externalId", "deliveryService", "palletsCount", "orderIds", "draftCount", "plannedCount", "factCount"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BaseShipmentDTO:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BaseShipmentDTO:
        """Create an instance of BaseShipmentDTO from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BaseShipmentDTO.parse_obj(obj)

        _obj = BaseShipmentDTO.parse_obj({
            "id": obj.get("id"),
