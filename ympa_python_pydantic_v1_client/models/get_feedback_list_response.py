...
class GetFeedbackListResponse(BaseModel):
    ...
    result: Optional[FeedbackListDTO] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetFeedbackListResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetFeedbackListResponse:
        """Create an instance of GetFeedbackListResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetFeedbackListResponse.parse_obj(obj)

        _obj = GetFeedbackListResponse.parse_obj({
            "status": obj.get("status"),
            "result": FeedbackListDTO.from_dict(obj.get("result")) if obj.get("result") is not None else None
        })
        return _obj
