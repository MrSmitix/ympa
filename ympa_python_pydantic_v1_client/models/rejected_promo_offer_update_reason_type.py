...
class RejectedPromoOfferUpdateReasonType(str, Enum):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RejectedPromoOfferUpdateReasonType:
        """Create an instance of RejectedPromoOfferUpdateReasonType from a JSON string"""
        return RejectedPromoOfferUpdateReasonType(json.loads(json_str))
