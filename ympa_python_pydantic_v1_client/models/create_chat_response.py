...
class CreateChatResponse(BaseModel):
    """
    Результат создания чата.  # noqa: E501
    """
    status: Optional[ApiResponseStatusType] = None
    result: Optional[CreateChatResultDTO] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateChatResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateChatResponse:
        """Create an instance of CreateChatResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateChatResponse.parse_obj(obj)

        _obj = CreateChatResponse.parse_obj({
            "status": obj.get("status"),
            "result": CreateChatResultDTO.from_dict(obj.get("result")) if obj.get("result") is not None else None
        })
        return _obj
