...
class CampaignSettingsTimePeriodDTO(BaseModel):
    """
    Период, за который рассчитывается итоговый список нерабочих дней службы доставки.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CampaignSettingsTimePeriodDTO:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CampaignSettingsTimePeriodDTO:
        """Create an instance of CampaignSettingsTimePeriodDTO from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CampaignSettingsTimePeriodDTO.parse_obj(obj)

        _obj = CampaignSettingsTimePeriodDTO.parse_obj({
