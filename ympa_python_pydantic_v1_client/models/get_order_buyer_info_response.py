...
class GetOrderBuyerInfoResponse(BaseModel):
    ...
    result: Optional[OrderBuyerInfoDTO] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetOrderBuyerInfoResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetOrderBuyerInfoResponse:
        """Create an instance of GetOrderBuyerInfoResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetOrderBuyerInfoResponse.parse_obj(obj)

        _obj = GetOrderBuyerInfoResponse.parse_obj({
            "status": obj.get("status"),
            "result": OrderBuyerInfoDTO.from_dict(obj.get("result")) if obj.get("result") is not None else None
        })
        return _obj
