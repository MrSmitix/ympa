...
class GetQualityRatingDetailsResponse(BaseModel):
    """
    GetQualityRatingDetailsResponse
    """
    status: Optional[ApiResponseStatusType] = None
    result: Optional[QualityRatingDetailsDTO] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetQualityRatingDetailsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetQualityRatingDetailsResponse:
        """Create an instance of GetQualityRatingDetailsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetQualityRatingDetailsResponse.parse_obj(obj)

        _obj = GetQualityRatingDetailsResponse.parse_obj({
            "status": obj.get("status"),
            "result": QualityRatingDetailsDTO.from_dict(obj.get("result")) if obj.get("result") is not None else None
        })
        return _obj
