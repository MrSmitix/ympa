...
class GetCampaignRegionResponse(BaseModel):
    """
    Ответ на запрос региона магазина.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetCampaignRegionResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetCampaignRegionResponse:
        """Create an instance of GetCampaignRegionResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetCampaignRegionResponse.parse_obj(obj)

        _obj = GetCampaignRegionResponse.parse_obj({
