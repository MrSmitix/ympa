...
class UpdateGoodsFeedbackCommentResponse(BaseModel):
    """
    UpdateGoodsFeedbackCommentResponse
    """
    status: Optional[ApiResponseStatusType] = None
    result: Optional[GoodsFeedbackCommentDTO] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateGoodsFeedbackCommentResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateGoodsFeedbackCommentResponse:
        """Create an instance of UpdateGoodsFeedbackCommentResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateGoodsFeedbackCommentResponse.parse_obj(obj)

        _obj = UpdateGoodsFeedbackCommentResponse.parse_obj({
            "status": obj.get("status"),
            "result": GoodsFeedbackCommentDTO.from_dict(obj.get("result")) if obj.get("result") is not None else None
        })
        return _obj
