...
class FeedbackAuthorDTO(BaseModel):
    """
    Информация об авторе отзыва.  Если отзыв оставлен анонимно, параметр не возвращается.   # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FeedbackAuthorDTO:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FeedbackAuthorDTO:
        """Create an instance of FeedbackAuthorDTO from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FeedbackAuthorDTO.parse_obj(obj)

        _obj = FeedbackAuthorDTO.parse_obj({
            "name": obj.get("name"),
