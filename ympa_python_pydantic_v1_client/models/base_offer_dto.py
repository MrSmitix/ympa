...
class BaseOfferDTO(BaseModel):
    """
    Основные параметры товара.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BaseOfferDTO:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BaseOfferDTO:
        """Create an instance of BaseOfferDTO from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BaseOfferDTO.parse_obj(obj)

        _obj = BaseOfferDTO.parse_obj({
