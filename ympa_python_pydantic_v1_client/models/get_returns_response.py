...
class GetReturnsResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetReturnsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetReturnsResponse:
        """Create an instance of GetReturnsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetReturnsResponse.parse_obj(obj)

        _obj = GetReturnsResponse.parse_obj({
