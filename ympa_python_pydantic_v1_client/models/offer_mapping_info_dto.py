...
class OfferMappingInfoDTO(BaseModel):
    """
    Информация о карточке товара.  # noqa: E501
    """
    ...
    __properties = ["mapping", "awaitingModerationMapping", "rejectedMapping"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OfferMappingInfoDTO:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OfferMappingInfoDTO:
        """Create an instance of OfferMappingInfoDTO from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OfferMappingInfoDTO.parse_obj(obj)

        _obj = OfferMappingInfoDTO.parse_obj({
