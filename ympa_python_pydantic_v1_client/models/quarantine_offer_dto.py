...
class QuarantineOfferDTO(BaseModel):
    ...
    verdicts: Optional[conlist(PriceQuarantineVerdictDTO)] = Field(default=None, description="Причины попадания товара в карантин.")
    __properties = ["offerId", "currentPrice", "lastValidPrice", "verdicts"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> QuarantineOfferDTO:
    ...
    def to_dict(self):
        ...
        # set to None if verdicts (nullable) is None
        # and __fields_set__ contains the field
        if self.verdicts is None and "verdicts" in self.__fields_set__:
            _dict['verdicts'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> QuarantineOfferDTO:
        """Create an instance of QuarantineOfferDTO from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return QuarantineOfferDTO.parse_obj(obj)

        _obj = QuarantineOfferDTO.parse_obj({
            "offer_id": obj.get("offerId"),
            "current_price": BasePriceDTO.from_dict(obj.get("currentPrice")) if obj.get("currentPrice") is not None else None,
            "last_valid_price": BasePriceDTO.from_dict(obj.get("lastValidPrice")) if obj.get("lastValidPrice") is not None else None,
