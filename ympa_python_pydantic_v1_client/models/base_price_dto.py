...
class BasePriceDTO(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BasePriceDTO:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BasePriceDTO:
        """Create an instance of BasePriceDTO from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BasePriceDTO.parse_obj(obj)

        _obj = BasePriceDTO.parse_obj({
            "value": obj.get("value"),
