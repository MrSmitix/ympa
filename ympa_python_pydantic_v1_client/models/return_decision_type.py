...
class ReturnDecisionType(str, Enum):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ReturnDecisionType:
        """Create an instance of ReturnDecisionType from a JSON string"""
        return ReturnDecisionType(json.loads(json_str))
