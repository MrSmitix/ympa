...
class GetWarehouseStocksDTO(BaseModel):
    """
    Список складов с информацией об остатках на каждом из них.  # noqa: E501
    """
    paging: Optional[ScrollingPagerDTO] = None
    warehouses: conlist(WarehouseOffersDTO) = Field(default=..., description="Страница списка складов.")
    __properties = ["paging", "warehouses"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetWarehouseStocksDTO:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetWarehouseStocksDTO:
        """Create an instance of GetWarehouseStocksDTO from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetWarehouseStocksDTO.parse_obj(obj)

        _obj = GetWarehouseStocksDTO.parse_obj({
