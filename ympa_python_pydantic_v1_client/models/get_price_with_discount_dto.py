...
class GetPriceWithDiscountDTO(BaseModel):
    """
    Цена с указанием скидки и времени последнего обновления.  # noqa: E501
    """
    ...
    __properties = ["value", "currencyId", "discountBase", "updatedAt"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetPriceWithDiscountDTO:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetPriceWithDiscountDTO:
        """Create an instance of GetPriceWithDiscountDTO from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetPriceWithDiscountDTO.parse_obj(obj)

        _obj = GetPriceWithDiscountDTO.parse_obj({
            "value": obj.get("value"),
