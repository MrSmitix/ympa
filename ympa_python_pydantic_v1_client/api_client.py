...
import ympa_python_pydantic_v1_client.models
from ympa_python_pydantic_v1_client import rest
from ympa_python_pydantic_v1_client.exceptions import ApiValueError, ApiException
...
class ApiClient:
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'OpenAPI-Generator/24.08.29/python'
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(ympa_python_pydantic_v1_client.models, klass)
