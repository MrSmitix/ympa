...
class GetCategoryContentParametersResponse 
{
    ...
    */
     ...
     * @Type("OpenAPI\Server\Model\CategoryContentParametersDTO")
    */
    #[Assert\Type("OpenAPI\Server\Model\CategoryContentParametersDTO")]
    protected ?CategoryContentParametersDTO $result = null;
    ...
    */
     ...
     * Gets result.
     *
     * @return CategoryContentParametersDTO|null
     */
    public function getResult(): ?CategoryContentParametersDTO
    {
        return $this->result;
    }
    ...
    * @return $this
    */
    public function setResult(?CategoryContentParametersDTO $result = null): self
    {
        $this->result = $result;
