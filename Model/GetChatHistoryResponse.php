...
class GetChatHistoryResponse 
{
    ...
    */
     ...
     * @Type("OpenAPI\Server\Model\ChatMessagesResultDTO")
    */
    #[Assert\Type("OpenAPI\Server\Model\ChatMessagesResultDTO")]
    protected ?ChatMessagesResultDTO $result = null;
    ...
    */
     ...
     * Gets result.
     *
     * @return ChatMessagesResultDTO|null
     */
    public function getResult(): ?ChatMessagesResultDTO
    {
        return $this->result;
    }
    ...
    * @return $this
    */
    public function setResult(?ChatMessagesResultDTO $result = null): self
    {
        $this->result = $result;
