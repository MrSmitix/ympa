...
class GetChatsResponse 
{
    ...
    */
     ...
     * @Type("OpenAPI\Server\Model\GetChatsInfoDTO")
    */
    #[Assert\Type("OpenAPI\Server\Model\GetChatsInfoDTO")]
    protected ?GetChatsInfoDTO $result = null;
    ...
    */
     ...
     * Gets result.
     *
     * @return GetChatsInfoDTO|null
     */
    public function getResult(): ?GetChatsInfoDTO
    {
        return $this->result;
    }
    ...
    * @return $this
    */
    public function setResult(?GetChatsInfoDTO $result = null): self
    {
        $this->result = $result;
