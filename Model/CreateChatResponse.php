...
/**
 * Class representing the CreateChatResponse model.
 *
...
class CreateChatResponse 
{
    ...
    */
    ...
    /**
     * @var CreateChatResultDTO|null
     * @SerializedName("result")
     * @Type("OpenAPI\Server\Model\CreateChatResultDTO")
    */
    #[Assert\Type("OpenAPI\Server\Model\CreateChatResultDTO")]
    protected ?CreateChatResultDTO $result = null;
    ...
    */
     ...
     * Gets result.
     *
     * @return CreateChatResultDTO|null
     */
    public function getResult(): ?CreateChatResultDTO
    {
        return $this->result;
    }
    ...
    * Sets result.
    *
    * @param CreateChatResultDTO|null $result
    *
    * @return $this
    */
    public function setResult(?CreateChatResultDTO $result = null): self
    {
        $this->result = $result;
