...
class GetPromosResponse 
{
    ...
    */
     ...
     * @Type("OpenAPI\Server\Model\GetPromosResultDTO")
    */
    #[Assert\Type("OpenAPI\Server\Model\GetPromosResultDTO")]
    protected ?GetPromosResultDTO $result = null;
    ...
    */
     ...
     * Gets result.
     *
     * @return GetPromosResultDTO|null
     */
    public function getResult(): ?GetPromosResultDTO
    {
        return $this->result;
    }
    ...
    * @return $this
    */
    public function setResult(?GetPromosResultDTO $result = null): self
    {
        $this->result = $result;
