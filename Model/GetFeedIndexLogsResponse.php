...
class GetFeedIndexLogsResponse 
{
    ...
    */
     ...
     * @Type("OpenAPI\Server\Model\FeedIndexLogsResultDTO")
    */
    #[Assert\Type("OpenAPI\Server\Model\FeedIndexLogsResultDTO")]
    protected ?FeedIndexLogsResultDTO $result = null;
    ...
    */
     ...
     * Gets result.
     *
     * @return FeedIndexLogsResultDTO|null
     */
    public function getResult(): ?FeedIndexLogsResultDTO
    {
        return $this->result;
    }
    ...
    * @return $this
    */
    public function setResult(?FeedIndexLogsResultDTO $result = null): self
    {
        $this->result = $result;
