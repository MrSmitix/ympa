...
class GetCampaignOffersResponse 
{
    ...
    */
     ...
     * @Type("OpenAPI\Server\Model\GetCampaignOffersResultDTO")
    */
    #[Assert\Type("OpenAPI\Server\Model\GetCampaignOffersResultDTO")]
    protected ?GetCampaignOffersResultDTO $result = null;
    ...
    */
     ...
     * Gets result.
     *
     * @return GetCampaignOffersResultDTO|null
     */
    public function getResult(): ?GetCampaignOffersResultDTO
    {
        return $this->result;
    }
    ...
    * @return $this
    */
    public function setResult(?GetCampaignOffersResultDTO $result = null): self
    {
        $this->result = $result;
