...
class GetOrderBuyerInfoResponse 
{
    ...
    */
     ...
     * @Type("OpenAPI\Server\Model\OrderBuyerInfoDTO")
    */
    #[Assert\Type("OpenAPI\Server\Model\OrderBuyerInfoDTO")]
    protected ?OrderBuyerInfoDTO $result = null;
    ...
    */
     ...
     * Gets result.
     *
     * @return OrderBuyerInfoDTO|null
     */
    public function getResult(): ?OrderBuyerInfoDTO
    {
        return $this->result;
    }
    ...
    * @return $this
    */
    public function setResult(?OrderBuyerInfoDTO $result = null): self
    {
        $this->result = $result;
