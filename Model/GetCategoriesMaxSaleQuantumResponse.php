...
class GetCategoriesMaxSaleQuantumResponse  implements \JsonSerializable
{
        /**
     ...
     */
    public function __construct(?ApiResponseStatusType $status, array $results, ?array $errors)
    {
        $this->status = $status;
