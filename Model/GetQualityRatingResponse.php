...
class GetQualityRatingResponse 
{
    ...
    */
     ...
     * @Type("OpenAPI\Server\Model\CampaignsQualityRatingDTO")
    */
    #[Assert\Type("OpenAPI\Server\Model\CampaignsQualityRatingDTO")]
    protected ?CampaignsQualityRatingDTO $result = null;
    ...
    */
     ...
     * Gets result.
     *
     * @return CampaignsQualityRatingDTO|null
     */
    public function getResult(): ?CampaignsQualityRatingDTO
    {
        return $this->result;
    }
    ...
    * @return $this
    */
    public function setResult(?CampaignsQualityRatingDTO $result = null): self
    {
        $this->result = $result;
