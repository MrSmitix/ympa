...
class FullOutletLicenseDTO  implements \JsonSerializable
{
        /**
     ...
     * @SerializedName("checkStatus")
        * @Accessor(getter="getSerializedCheckStatus")
        * @Type("string")
     */
     ...
     * @param string|null $checkComment
     */
    public function __construct(?int $id, ?int $outletId, ?LicenseType $licenseType, ?string $number, ?\DateTime $dateOfIssue, ?\DateTime $dateOfExpiry, ?LicenseCheckStatusType $checkStatus, ?string $checkComment)
    {
        $this->id = $id;
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            isset($data['checkStatus']) ? LicenseCheckStatusType::tryFrom($data['checkStatus']) : null, 
            $data['checkComment'] ?? null, 
        );
    }
