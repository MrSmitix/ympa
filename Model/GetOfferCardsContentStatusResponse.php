...
class GetOfferCardsContentStatusResponse 
{
    ...
    */
     ...
     * @Type("OpenAPI\Server\Model\OfferCardsContentStatusDTO")
    */
    #[Assert\Type("OpenAPI\Server\Model\OfferCardsContentStatusDTO")]
    protected ?OfferCardsContentStatusDTO $result = null;
    ...
    */
     ...
     * Gets result.
     *
     * @return OfferCardsContentStatusDTO|null
     */
    public function getResult(): ?OfferCardsContentStatusDTO
    {
        return $this->result;
    }
    ...
    * @return $this
    */
    public function setResult(?OfferCardsContentStatusDTO $result = null): self
    {
        $this->result = $result;
