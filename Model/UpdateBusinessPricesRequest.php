...
class UpdateBusinessPricesRequest 
{
     ...
     *
     * @var UpdateBusinessOfferPriceDTO[]|null
     * @SerializedName("offers")
     * @Type("array<OpenAPI\Server\Model\UpdateBusinessOfferPriceDTO>")
    */
    #[Assert\NotNull]
    #[Assert\Valid]
    #[Assert\All([
        new Assert\Type("OpenAPI\Server\Model\UpdateBusinessOfferPriceDTO"),
    ])]
     ...
     * Gets offers.
     *
     * @return UpdateBusinessOfferPriceDTO[]|null
     */
    ...
    * Sets offers.
    *
    * @param UpdateBusinessOfferPriceDTO[]|null $offers  Список товаров с ценами.
    *
    * @return $this
    */
