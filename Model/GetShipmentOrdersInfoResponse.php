...
class GetShipmentOrdersInfoResponse 
{
    ...
    */
     ...
     * @Type("OpenAPI\Server\Model\OrdersShipmentInfoDTO")
    */
    #[Assert\Type("OpenAPI\Server\Model\OrdersShipmentInfoDTO")]
    protected ?OrdersShipmentInfoDTO $result = null;
    ...
    */
     ...
     * Gets result.
     *
     * @return OrdersShipmentInfoDTO|null
     */
    public function getResult(): ?OrdersShipmentInfoDTO
    {
        return $this->result;
    }
    ...
    * @return $this
    */
    public function setResult(?OrdersShipmentInfoDTO $result = null): self
    {
        $this->result = $result;
