...
class FeedIndexLogsErrorDTO 
{
    ...
    * @Type("string")
    */
    protected ?FeedIndexLogsErrorType $type = null;
    ...
    */
     ...
     * Gets type.
     *
     * @return FeedIndexLogsErrorType|null
     */
    public function getType(): ?FeedIndexLogsErrorType
    {
        return $this->type;
    }
    ...
    * @return $this
    */
    public function setType(?FeedIndexLogsErrorType $type = null): self
    {
        $this->type = $type;
    ...
    * Sets type.
    *
    * @param string|FeedIndexLogsErrorType|null $type
    *
    * @return $this
    */
    public function setDeserializedType(string|FeedIndexLogsErrorType|null $type = null): self
    {
        if (is_string($type)) {
            $type = FeedIndexLogsErrorType::tryFrom($type);
        }
