...
class VerifyOrderEacResponse 
{
    ...
    */
     ...
     * @Type("OpenAPI\Server\Model\EacVerificationResultDTO")
    */
    #[Assert\Type("OpenAPI\Server\Model\EacVerificationResultDTO")]
    protected ?EacVerificationResultDTO $result = null;
    ...
    */
     ...
     * Gets result.
     *
     * @return EacVerificationResultDTO|null
     */
    public function getResult(): ?EacVerificationResultDTO
    {
        return $this->result;
    }
    ...
    * @return $this
    */
    public function setResult(?EacVerificationResultDTO $result = null): self
    {
        $this->result = $result;
