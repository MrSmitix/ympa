...
class RejectedPromoOfferUpdateDTO 
{
    ...
    */
    ...
    /**
     * @var RejectedPromoOfferUpdateReasonType|null
    ...
    */
    #[Assert\NotNull]
    #[Assert\Valid]
    protected ?RejectedPromoOfferUpdateReasonType $reason = null;
    ...
    */
     ...
     * Gets reason.
     *
     * @return RejectedPromoOfferUpdateReasonType|null
     */
    public function getReason(): ?RejectedPromoOfferUpdateReasonType
    {
        return $this->reason;
    }
    ...
    * Sets reason.
    *
    * @param RejectedPromoOfferUpdateReasonType|null $reason
    *
    * @return $this
    */
    public function setReason(?RejectedPromoOfferUpdateReasonType $reason): self
    {
        $this->reason = $reason;
    ...
    * Sets reason.
    *
    * @param string|RejectedPromoOfferUpdateReasonType|null $reason
    *
    * @return $this
    */
    public function setDeserializedReason(string|RejectedPromoOfferUpdateReasonType|null $reason): self
    {
        if (is_string($reason)) {
            $reason = RejectedPromoOfferUpdateReasonType::tryFrom($reason);
        }
