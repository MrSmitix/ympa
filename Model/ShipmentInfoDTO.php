...
class ShipmentInfoDTO 
{
    ...
    */
    #[Assert\Type("\DateTime")]
    protected ?\DateTime $statusUpdateTime = null;
    ...
    public function __construct(array $data = null)
    {
        if (is_array($data)) {
            ...
            $this->statusDescription = array_key_exists('statusDescription', $data) ? $data['statusDescription'] : $this->statusDescription;
            $this->statusUpdateTime = array_key_exists('statusUpdateTime', $data) ? $data['statusUpdateTime'] : $this->statusUpdateTime;
        }
    }
    ...
    *
    * @param string|null $statusDescription  Описание статуса отгрузки.
    *
    * @return $this
    */
    ...
    *
    * @param \DateTime|null $statusUpdateTime  Время последнего изменения статуса отгрузки.
    *
    * @return $this
    */
    public function setStatusUpdateTime(?\DateTime $statusUpdateTime = null): self
    {
