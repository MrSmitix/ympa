...
class SetOrderShipmentBoxesResponse 
{
    ...
    */
     ...
     * @Type("OpenAPI\Server\Model\ShipmentBoxesDTO")
    */
    #[Assert\Type("OpenAPI\Server\Model\ShipmentBoxesDTO")]
    protected ?ShipmentBoxesDTO $result = null;
    ...
    */
     ...
     * Gets result.
     *
     * @return ShipmentBoxesDTO|null
     */
    public function getResult(): ?ShipmentBoxesDTO
    {
        return $this->result;
    }
    ...
    * @return $this
    */
    public function setResult(?ShipmentBoxesDTO $result = null): self
    {
        $this->result = $result;
