...
class DeleteOffersResponse 
{
    ...
    */
     ...
     * @Type("OpenAPI\Server\Model\DeleteOffersDTO")
    */
    #[Assert\Type("OpenAPI\Server\Model\DeleteOffersDTO")]
    protected ?DeleteOffersDTO $result = null;
    ...
    */
     ...
     * Gets result.
     *
     * @return DeleteOffersDTO|null
     */
    public function getResult(): ?DeleteOffersDTO
    {
        return $this->result;
    }
    ...
    * @return $this
    */
    public function setResult(?DeleteOffersDTO $result = null): self
    {
        $this->result = $result;
