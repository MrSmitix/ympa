...
class GetFeedbackListResponse 
{
    ...
    */
     ...
     * @Type("OpenAPI\Server\Model\FeedbackListDTO")
    */
    #[Assert\Type("OpenAPI\Server\Model\FeedbackListDTO")]
    protected ?FeedbackListDTO $result = null;
    ...
    */
     ...
     * Gets result.
     *
     * @return FeedbackListDTO|null
     */
    public function getResult(): ?FeedbackListDTO
    {
        return $this->result;
    }
    ...
    * @return $this
    */
    public function setResult(?FeedbackListDTO $result = null): self
    {
        $this->result = $result;
