...
class CalculateTariffsResponse 
{
    ...
    */
     ...
     * @Type("OpenAPI\Server\Model\CalculateTariffsResponseDTO")
    */
    #[Assert\Type("OpenAPI\Server\Model\CalculateTariffsResponseDTO")]
    protected ?CalculateTariffsResponseDTO $result = null;
    ...
    */
     ...
     * Gets result.
     *
     * @return CalculateTariffsResponseDTO|null
     */
    public function getResult(): ?CalculateTariffsResponseDTO
    {
        return $this->result;
    }
    ...
    * @return $this
    */
    public function setResult(?CalculateTariffsResponseDTO $result = null): self
    {
        $this->result = $result;
