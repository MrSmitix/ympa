...
class BaseShipmentDTO  implements \JsonSerializable
{
        /**
     ...
     */
    public function __construct(?int $id, ?\DateTime $planIntervalFrom, ?\DateTime $planIntervalTo, ?ShipmentType $shipmentType, ?PartnerShipmentWarehouseDTO $warehouse, ?PartnerShipmentWarehouseDTO $warehouseTo, ?string $externalId, ?DeliveryServiceDTO $deliveryService, ?PalletsCountDTO $palletsCount, array $orderIds, ?int $draftCount, ?int $plannedCount, ?int $factCount)
    {
        $this->id = $id;
