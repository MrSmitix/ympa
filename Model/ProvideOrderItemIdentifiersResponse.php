...
class ProvideOrderItemIdentifiersResponse 
{
    ...
    */
     ...
     * @Type("OpenAPI\Server\Model\OrderItemsModificationResultDTO")
    */
    #[Assert\Type("OpenAPI\Server\Model\OrderItemsModificationResultDTO")]
    protected ?OrderItemsModificationResultDTO $result = null;
    ...
    */
     ...
     * Gets result.
     *
     * @return OrderItemsModificationResultDTO|null
     */
    public function getResult(): ?OrderItemsModificationResultDTO
    {
        return $this->result;
    }
    ...
    * @return $this
    */
    public function setResult(?OrderItemsModificationResultDTO $result = null): self
    {
        $this->result = $result;
