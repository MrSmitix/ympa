...
class GetBusinessDocumentsInfoResponse 
{
    ...
    */
     ...
     * @Type("OpenAPI\Server\Model\OrderBusinessDocumentsDTO")
    */
    #[Assert\Type("OpenAPI\Server\Model\OrderBusinessDocumentsDTO")]
    protected ?OrderBusinessDocumentsDTO $result = null;
    ...
    */
     ...
     * Gets result.
     *
     * @return OrderBusinessDocumentsDTO|null
     */
    public function getResult(): ?OrderBusinessDocumentsDTO
    {
        return $this->result;
    }
    ...
    * @return $this
    */
    public function setResult(?OrderBusinessDocumentsDTO $result = null): self
    {
        $this->result = $result;
