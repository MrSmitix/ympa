...
class UpdateOfferContentResultDTO 
{
    ...
    */
     ...
     * @Type("array<OpenAPI\Server\Model\OfferContentErrorDTO>")
    */
    #[Assert\All([
        new Assert\Type("OpenAPI\Server\Model\OfferContentErrorDTO"),
    ])]
    ...
    */
     ...
     * Gets errors.
     *
     * @return OfferContentErrorDTO[]|null
     */
    ...
    * Sets errors.
    *
    * @param OfferContentErrorDTO[]|null $errors  Ошибки — информация в каталоге не обновится.
    *
    * @return $this
    */
    ...
    * Sets warnings.
    *
    * @param OfferContentErrorDTO[]|null $warnings  Предупреждения — информация в каталоге обновится.
    *
    * @return $this
    */
