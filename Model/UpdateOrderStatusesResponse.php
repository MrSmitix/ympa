...
class UpdateOrderStatusesResponse 
{
    ...
    */
     ...
     * @Type("OpenAPI\Server\Model\UpdateOrderStatusesDTO")
    */
    #[Assert\Type("OpenAPI\Server\Model\UpdateOrderStatusesDTO")]
    protected ?UpdateOrderStatusesDTO $result = null;
    ...
    */
     ...
     * Gets result.
     *
     * @return UpdateOrderStatusesDTO|null
     */
    public function getResult(): ?UpdateOrderStatusesDTO
    {
        return $this->result;
    }
    ...
    * @return $this
    */
    public function setResult(?UpdateOrderStatusesDTO $result = null): self
    {
        $this->result = $result;
