...
class GetOrderLabelsDataResponse 
{
    ...
    */
     ...
     * @Type("OpenAPI\Server\Model\OrderLabelDTO")
    */
    #[Assert\Type("OpenAPI\Server\Model\OrderLabelDTO")]
    protected ?OrderLabelDTO $result = null;
    ...
    */
     ...
     * Gets result.
     *
     * @return OrderLabelDTO|null
     */
    public function getResult(): ?OrderLabelDTO
    {
        return $this->result;
    }
    ...
    * @return $this
    */
    public function setResult(?OrderLabelDTO $result = null): self
    {
        $this->result = $result;
