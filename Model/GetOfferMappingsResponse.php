...
class GetOfferMappingsResponse 
{
    ...
    */
     ...
     * @Type("OpenAPI\Server\Model\GetOfferMappingsResultDTO")
    */
    #[Assert\Type("OpenAPI\Server\Model\GetOfferMappingsResultDTO")]
    protected ?GetOfferMappingsResultDTO $result = null;
    ...
    */
     ...
     * Gets result.
     *
     * @return GetOfferMappingsResultDTO|null
     */
    public function getResult(): ?GetOfferMappingsResultDTO
    {
        return $this->result;
    }
    ...
    * @return $this
    */
    public function setResult(?GetOfferMappingsResultDTO $result = null): self
    {
        $this->result = $result;
