...
class GetOrdersStatsResponse 
{
    ...
    */
     ...
     * @Type("OpenAPI\Server\Model\OrdersStatsDTO")
    */
    #[Assert\Type("OpenAPI\Server\Model\OrdersStatsDTO")]
    protected ?OrdersStatsDTO $result = null;
    ...
    */
     ...
     * Gets result.
     *
     * @return OrdersStatsDTO|null
     */
    public function getResult(): ?OrdersStatsDTO
    {
        return $this->result;
    }
    ...
    * @return $this
    */
    public function setResult(?OrdersStatsDTO $result = null): self
    {
        $this->result = $result;
