...
class GetOfferRecommendationsResponse 
{
    ...
    */
     ...
     * @Type("OpenAPI\Server\Model\OfferRecommendationsResultDTO")
    */
    #[Assert\Type("OpenAPI\Server\Model\OfferRecommendationsResultDTO")]
    protected ?OfferRecommendationsResultDTO $result = null;
    ...
    */
     ...
     * Gets result.
     *
     * @return OfferRecommendationsResultDTO|null
     */
    public function getResult(): ?OfferRecommendationsResultDTO
    {
        return $this->result;
    }
    ...
    * @return $this
    */
    public function setResult(?OfferRecommendationsResultDTO $result = null): self
    {
        $this->result = $result;
