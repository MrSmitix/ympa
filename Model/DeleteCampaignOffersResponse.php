...
class DeleteCampaignOffersResponse 
{
    ...
    */
     ...
     * @Type("OpenAPI\Server\Model\DeleteCampaignOffersDTO")
    */
    #[Assert\Type("OpenAPI\Server\Model\DeleteCampaignOffersDTO")]
    protected ?DeleteCampaignOffersDTO $result = null;
    ...
    */
     ...
     * Gets result.
     *
     * @return DeleteCampaignOffersDTO|null
     */
    public function getResult(): ?DeleteCampaignOffersDTO
    {
        return $this->result;
    }
    ...
    * @return $this
    */
    public function setResult(?DeleteCampaignOffersDTO $result = null): self
    {
        $this->result = $result;
