...
class GetOutletLicensesResponse 
{
    ...
    */
     ...
     * @Type("OpenAPI\Server\Model\OutletLicensesResponseDTO")
    */
    #[Assert\Type("OpenAPI\Server\Model\OutletLicensesResponseDTO")]
    protected ?OutletLicensesResponseDTO $result = null;
    ...
    */
     ...
     * Gets result.
     *
     * @return OutletLicensesResponseDTO|null
     */
    public function getResult(): ?OutletLicensesResponseDTO
    {
        return $this->result;
    }
    ...
    * @return $this
    */
    public function setResult(?OutletLicensesResponseDTO $result = null): self
    {
        $this->result = $result;
