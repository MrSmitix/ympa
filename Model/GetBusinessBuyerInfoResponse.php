...
class GetBusinessBuyerInfoResponse 
{
    ...
    */
     ...
     * @Type("OpenAPI\Server\Model\OrderBusinessBuyerDTO")
    */
    #[Assert\Type("OpenAPI\Server\Model\OrderBusinessBuyerDTO")]
    protected ?OrderBusinessBuyerDTO $result = null;
    ...
    */
     ...
     * Gets result.
     *
     * @return OrderBusinessBuyerDTO|null
     */
    public function getResult(): ?OrderBusinessBuyerDTO
    {
        return $this->result;
    }
    ...
    * @return $this
    */
    public function setResult(?OrderBusinessBuyerDTO $result = null): self
    {
        $this->result = $result;
