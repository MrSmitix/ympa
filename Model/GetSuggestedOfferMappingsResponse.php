...
class GetSuggestedOfferMappingsResponse 
{
    ...
    */
     ...
     * @Type("OpenAPI\Server\Model\GetSuggestedOfferMappingsResultDTO")
    */
    #[Assert\Type("OpenAPI\Server\Model\GetSuggestedOfferMappingsResultDTO")]
    protected ?GetSuggestedOfferMappingsResultDTO $result = null;
    ...
    */
     ...
     * Gets result.
     *
     * @return GetSuggestedOfferMappingsResultDTO|null
     */
    public function getResult(): ?GetSuggestedOfferMappingsResultDTO
    {
        return $this->result;
    }
    ...
    * @return $this
    */
    public function setResult(?GetSuggestedOfferMappingsResultDTO $result = null): self
    {
        $this->result = $result;
