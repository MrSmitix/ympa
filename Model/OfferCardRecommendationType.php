...
/**
 * Class representing the OfferCardRecommendationType model.
 *
 ...
 * @author  OpenAPI Generator team
 */
enum OfferCardRecommendationType: string
{
        case HAS_VIDEO = 'HAS_VIDEO';
        case RECOGNIZED_VENDOR = 'RECOGNIZED_VENDOR';
        case MAIN = 'MAIN';
        case ADDITIONAL = 'ADDITIONAL';
        case DISTINCTIVE = 'DISTINCTIVE';
        case FILTERABLE = 'FILTERABLE';
        case PICTURE_COUNT = 'PICTURE_COUNT';
        case HAS_DESCRIPTION = 'HAS_DESCRIPTION';
        case HAS_BARCODE = 'HAS_BARCODE';
        case FIRST_PICTURE_SIZE = 'FIRST_PICTURE_SIZE';
        case TITLE_LENGTH = 'TITLE_LENGTH';
        case DESCRIPTION_LENGTH = 'DESCRIPTION_LENGTH';
        case AVERAGE_PICTURE_SIZE = 'AVERAGE_PICTURE_SIZE';
        case FIRST_VIDEO_SIZE = 'FIRST_VIDEO_SIZE';
        case FIRST_VIDEO_LENGTH = 'FIRST_VIDEO_LENGTH';
        case AVERAGE_VIDEO_SIZE = 'AVERAGE_VIDEO_SIZE';
