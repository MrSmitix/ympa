...
class GetQualityRatingDetailsResponse 
{
    ...
    */
     ...
     * @Type("OpenAPI\Server\Model\QualityRatingDetailsDTO")
    */
    #[Assert\Type("OpenAPI\Server\Model\QualityRatingDetailsDTO")]
    protected ?QualityRatingDetailsDTO $result = null;
    ...
    */
     ...
     * Gets result.
     *
     * @return QualityRatingDetailsDTO|null
     */
    public function getResult(): ?QualityRatingDetailsDTO
    {
        return $this->result;
    }
    ...
    * @return $this
    */
    public function setResult(?QualityRatingDetailsDTO $result = null): self
    {
        $this->result = $result;
