...
class GetReportInfoResponse 
{
    ...
    */
     ...
     * @Type("OpenAPI\Server\Model\ReportInfoDTO")
    */
    #[Assert\Type("OpenAPI\Server\Model\ReportInfoDTO")]
    protected ?ReportInfoDTO $result = null;
    ...
    */
     ...
     * Gets result.
     *
     * @return ReportInfoDTO|null
     */
    public function getResult(): ?ReportInfoDTO
    {
        return $this->result;
    }
    ...
    * @return $this
    */
    public function setResult(?ReportInfoDTO $result = null): self
    {
        $this->result = $result;
