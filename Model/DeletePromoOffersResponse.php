...
class DeletePromoOffersResponse 
{
    ...
    */
     ...
     * @Type("OpenAPI\Server\Model\DeletePromoOffersResultDTO")
    */
    #[Assert\Type("OpenAPI\Server\Model\DeletePromoOffersResultDTO")]
    protected ?DeletePromoOffersResultDTO $result = null;
    ...
    */
     ...
     * Gets result.
     *
     * @return DeletePromoOffersResultDTO|null
     */
    public function getResult(): ?DeletePromoOffersResultDTO
    {
        return $this->result;
    }
    ...
    * @return $this
    */
    public function setResult(?DeletePromoOffersResultDTO $result = null): self
    {
        $this->result = $result;
