...
class GetQuarantineOffersResponse 
{
    ...
    */
     ...
     * @Type("OpenAPI\Server\Model\GetQuarantineOffersResultDTO")
    */
    #[Assert\Type("OpenAPI\Server\Model\GetQuarantineOffersResultDTO")]
    protected ?GetQuarantineOffersResultDTO $result = null;
    ...
    */
     ...
     * Gets result.
     *
     * @return GetQuarantineOffersResultDTO|null
     */
    public function getResult(): ?GetQuarantineOffersResultDTO
    {
        return $this->result;
    }
    ...
    * @return $this
    */
    public function setResult(?GetQuarantineOffersResultDTO $result = null): self
    {
        $this->result = $result;
