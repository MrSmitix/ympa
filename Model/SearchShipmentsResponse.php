...
class SearchShipmentsResponse 
{
    ...
    */
     ...
     * @Type("OpenAPI\Server\Model\SearchShipmentsResponseDTO")
    */
    #[Assert\Type("OpenAPI\Server\Model\SearchShipmentsResponseDTO")]
    protected ?SearchShipmentsResponseDTO $result = null;
    ...
    */
     ...
     * Gets result.
     *
     * @return SearchShipmentsResponseDTO|null
     */
    public function getResult(): ?SearchShipmentsResponseDTO
    {
        return $this->result;
    }
    ...
    * @return $this
    */
    public function setResult(?SearchShipmentsResponseDTO $result = null): self
    {
        $this->result = $result;
