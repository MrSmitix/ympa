...
class GetWarehouseStocksResponse 
{
    ...
    */
     ...
     * @Type("OpenAPI\Server\Model\GetWarehouseStocksDTO")
    */
    #[Assert\Type("OpenAPI\Server\Model\GetWarehouseStocksDTO")]
    protected ?GetWarehouseStocksDTO $result = null;
    ...
    */
     ...
     * Gets result.
     *
     * @return GetWarehouseStocksDTO|null
     */
    public function getResult(): ?GetWarehouseStocksDTO
    {
        return $this->result;
    }
    ...
    * @return $this
    */
    public function setResult(?GetWarehouseStocksDTO $result = null): self
    {
        $this->result = $result;
