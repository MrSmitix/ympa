...
class GetGoodsFeedbackResponse 
{
    ...
    */
     ...
     * @Type("OpenAPI\Server\Model\GoodsFeedbackListDTO")
    */
    #[Assert\Type("OpenAPI\Server\Model\GoodsFeedbackListDTO")]
    protected ?GoodsFeedbackListDTO $result = null;
    ...
    */
     ...
     * Gets result.
     *
     * @return GoodsFeedbackListDTO|null
     */
    public function getResult(): ?GoodsFeedbackListDTO
    {
        return $this->result;
    }
    ...
    * @return $this
    */
    public function setResult(?GoodsFeedbackListDTO $result = null): self
    {
        $this->result = $result;
