...
class UpdatePromoOffersResponse 
{
    ...
    */
     ...
     * @Type("OpenAPI\Server\Model\UpdatePromoOffersResultDTO")
    */
    #[Assert\Type("OpenAPI\Server\Model\UpdatePromoOffersResultDTO")]
    protected ?UpdatePromoOffersResultDTO $result = null;
    ...
    */
     ...
     * Gets result.
     *
     * @return UpdatePromoOffersResultDTO|null
     */
    public function getResult(): ?UpdatePromoOffersResultDTO
    {
        return $this->result;
    }
    ...
    * @return $this
    */
    public function setResult(?UpdatePromoOffersResultDTO $result = null): self
    {
        $this->result = $result;
