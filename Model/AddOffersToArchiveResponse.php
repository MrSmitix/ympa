...
class AddOffersToArchiveResponse 
{
    ...
    */
     ...
     * @Type("OpenAPI\Server\Model\AddOffersToArchiveDTO")
    */
    #[Assert\Type("OpenAPI\Server\Model\AddOffersToArchiveDTO")]
    protected ?AddOffersToArchiveDTO $result = null;
    ...
    */
     ...
     * Gets result.
     *
     * @return AddOffersToArchiveDTO|null
     */
    public function getResult(): ?AddOffersToArchiveDTO
    {
        return $this->result;
    }
    ...
    * @return $this
    */
    public function setResult(?AddOffersToArchiveDTO $result = null): self
    {
        $this->result = $result;
