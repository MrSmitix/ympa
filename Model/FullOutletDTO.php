...
class FullOutletDTO 
{
    ...
    * @Type("string")
    */
    protected ?OutletStatusType $status = null;
    ...
    */
    #[Assert\Type("string")]
    protected ?string $shopOutletId = null;
    ...
    */
    #[Assert\Type("string")]
    protected ?string $workingTime = null;
    ...
    */
    #[Assert\Type("string")]
    protected ?string $moderationReason = null;
    ...
    public function __construct(array $data = null)
    {
        if (is_array($data)) {
            ...
            $this->shopOutletId = array_key_exists('shopOutletId', $data) ? $data['shopOutletId'] : $this->shopOutletId;
            $this->workingTime = array_key_exists('workingTime', $data) ? $data['workingTime'] : $this->workingTime;
            $this->moderationReason = array_key_exists('moderationReason', $data) ? $data['moderationReason'] : $this->moderationReason;
        }
    }
    ...
    */
     ...
     * Gets status.
     *
     * @return OutletStatusType|null
     */
    public function getStatus(): ?OutletStatusType
    {
        return $this->status;
    }
    ...
    * @return $this
    */
    public function setStatus(?OutletStatusType $status = null): self
    {
        $this->status = $status;
    ...
    * Sets status.
    *
    * @param string|OutletStatusType|null $status
    *
    * @return $this
    */
    public function setDeserializedStatus(string|OutletStatusType|null $status = null): self
    {
        if (is_string($status)) {
            $status = OutletStatusType::tryFrom($status);
        }
    ...
    */
     ...
     * @return string|null
     */
    public function getShopOutletId(): ?string
    {
    ...
    * Sets shopOutletId.
    *
    * @param string|null $shopOutletId  Идентификатор точки продаж, заданный магазином.
    *
    * @return $this
    */
    public function setShopOutletId(?string $shopOutletId = null): self
    {
    ...
    * Sets workingTime.
    *
    * @param string|null $workingTime  Рабочее время.
    *
    * @return $this
    */
    public function setWorkingTime(?string $workingTime = null): self
    {
    ...
    /**
    * Sets moderationReason.
    *
    * @param string|null $moderationReason  Статус модерации.
    *
    * @return $this
    */
    public function setModerationReason(?string $moderationReason = null): self
    {
