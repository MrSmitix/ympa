...
class OrderSubsidyDTO 
{
    ...
    * @Type("string")
    */
    protected ?OrderSubsidyType $type = null;
    ...
    */
     ...
     * Gets type.
     *
     * @return OrderSubsidyType|null
     */
    public function getType(): ?OrderSubsidyType
    {
        return $this->type;
    }
    ...
    * @return $this
    */
    public function setType(?OrderSubsidyType $type = null): self
    {
        $this->type = $type;
    ...
    * Sets type.
    *
    * @param string|OrderSubsidyType|null $type
    *
    * @return $this
    */
    public function setDeserializedType(string|OrderSubsidyType|null $type = null): self
    {
        if (is_string($type)) {
            $type = OrderSubsidyType::tryFrom($type);
        }
