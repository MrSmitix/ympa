...
class GetSuggestedOfferMappingEntriesResponse 
{
    ...
    */
     ...
     * @Type("OpenAPI\Server\Model\OfferMappingSuggestionsListDTO")
    */
    #[Assert\Type("OpenAPI\Server\Model\OfferMappingSuggestionsListDTO")]
    protected ?OfferMappingSuggestionsListDTO $result = null;
    ...
    */
     ...
     * Gets result.
     *
     * @return OfferMappingSuggestionsListDTO|null
     */
    public function getResult(): ?OfferMappingSuggestionsListDTO
    {
        return $this->result;
    }
    ...
    * @return $this
    */
    public function setResult(?OfferMappingSuggestionsListDTO $result = null): self
    {
        $this->result = $result;
