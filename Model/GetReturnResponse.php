...
class GetReturnResponse 
{
    ...
    */
     ...
     * @Type("OpenAPI\Server\Model\ReturnDTO")
    */
    #[Assert\Type("OpenAPI\Server\Model\ReturnDTO")]
    protected ?ReturnDTO $result = null;
    ...
    */
     ...
     */
    public function getResult(): ?ReturnDTO
    {
        return $this->result;
    }
    ...
    * @return $this
    */
    public function setResult(?ReturnDTO $result = null): self
    {
        $this->result = $result;
