...
class GenerateReportResponse 
{
    ...
    */
     ...
     * @Type("OpenAPI\Server\Model\GenerateReportDTO")
    */
    #[Assert\Type("OpenAPI\Server\Model\GenerateReportDTO")]
    protected ?GenerateReportDTO $result = null;
    ...
    */
     ...
     * Gets result.
     *
     * @return GenerateReportDTO|null
     */
    public function getResult(): ?GenerateReportDTO
    {
        return $this->result;
    }
    ...
    * @return $this
    */
    public function setResult(?GenerateReportDTO $result = null): self
    {
        $this->result = $result;
