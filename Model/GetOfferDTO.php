...
class GetOfferDTO  implements \JsonSerializable
{
        /**
     ...
     * @Assert\All({
     *   @Assert\Type("\OpenAPIServer\Model\OfferCampaignStatusDTO")
     * })
     * @Type("array<\OpenAPIServer\Model\OfferCampaignStatusDTO>")
     */
     ...
     * @Assert\All({
     *   @Assert\Type("\OpenAPIServer\Model\OfferSellingProgramDTO")
     * })
     * @Type("array<\OpenAPIServer\Model\OfferSellingProgramDTO>")
     */
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            isset($data['purchasePrice']) ? GetPriceDTO::fromArray($data['purchasePrice']) : null, 
            isset($data['additionalExpenses']) ? GetPriceDTO::fromArray($data['additionalExpenses']) : null, 
            ...
            isset($data['campaigns']) ? array_map(fn($item) => OfferCampaignStatusDTO::fromArray($item), $data['campaigns']) : null, 
            isset($data['sellingPrograms']) ? array_map(fn($item) => OfferSellingProgramDTO::fromArray($item), $data['sellingPrograms']) : null, 
            $data['archived'] ?? null, 
        );
    }
    ...
    public function jsonSerialize(): mixed {
        return [
            ...
            'sellingPrograms' => $this->sellingPrograms, 
