...
/**
 * Class representing the GetOfferDTO model.
 *
 * Параметры товара.
 *
 * @package OpenAPI\Server\Model
...
class GetOfferDTO 
{
    ...
    */
    ...
    protected ?GetPriceDTO $purchasePrice = null;
    ...
    */
    #[Assert\Type("OpenAPI\Server\Model\GetPriceDTO")]
    protected ?GetPriceDTO $additionalExpenses = null;
    ...
    */
     ...
     *
     * @var OfferCampaignStatusDTO[]|null
     * @SerializedName("campaigns")
     * @Type("array<OpenAPI\Server\Model\OfferCampaignStatusDTO>")
    */
    #[Assert\All([
        new Assert\Type("OpenAPI\Server\Model\OfferCampaignStatusDTO"),
    ])]
     ...
     *
     * @var OfferSellingProgramDTO[]|null
     * @SerializedName("sellingPrograms")
     * @Type("array<OpenAPI\Server\Model\OfferSellingProgramDTO>")
    */
    #[Assert\All([
        new Assert\Type("OpenAPI\Server\Model\OfferSellingProgramDTO"),
    ])]
    protected ?array $sellingPrograms = null;
    ...
    */
    ...
    public function __construct(array $data = null)
    {
        if (is_array($data)) {
            ...
            $this->sellingPrograms = array_key_exists('sellingPrograms', $data) ? $data['sellingPrograms'] : $this->sellingPrograms;
    ...
    */
     ...
     */
    public function getPurchasePrice(): ?GetPriceDTO
    {
    ...
    * Sets purchasePrice.
    *
    * @param GetPriceDTO|null $purchasePrice
    *
    * @return $this
    */
    public function setPurchasePrice(?GetPriceDTO $purchasePrice = null): self
    {
     ...
     * @return GetPriceDTO|null
     */
    public function getAdditionalExpenses(): ?GetPriceDTO
    {
    ...
    *
    * @param GetPriceDTO|null $additionalExpenses
    *
    * @return $this
    */
    public function setAdditionalExpenses(?GetPriceDTO $additionalExpenses = null): self
    {
    ...
    */
     ...
     * Gets campaigns.
     *
     * @return OfferCampaignStatusDTO[]|null
     */
    ...
    * Sets campaigns.
    *
    * @param OfferCampaignStatusDTO[]|null $campaigns  Список магазинов, в которых размещен товар.
    *
    * @return $this
    */
    ...
    /**
     * Gets sellingPrograms.
     *
     * @return OfferSellingProgramDTO[]|null
     */
    public function getSellingPrograms(): ?array
    {
        return $this->sellingPrograms;
    }

    /**
    * Sets sellingPrograms.
    *
    * @param OfferSellingProgramDTO[]|null $sellingPrograms  Информация о том, какие для товара доступны модели размещения.
    *
    * @return $this
    */
    public function setSellingPrograms(?array $sellingPrograms = null): self
    {
