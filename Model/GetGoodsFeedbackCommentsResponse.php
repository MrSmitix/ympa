...
class GetGoodsFeedbackCommentsResponse 
{
    ...
    */
     ...
     * @Type("OpenAPI\Server\Model\GoodsFeedbackCommentListDTO")
    */
    #[Assert\Type("OpenAPI\Server\Model\GoodsFeedbackCommentListDTO")]
    protected ?GoodsFeedbackCommentListDTO $result = null;
    ...
    */
     ...
     * Gets result.
     *
     * @return GoodsFeedbackCommentListDTO|null
     */
    public function getResult(): ?GoodsFeedbackCommentListDTO
    {
        return $this->result;
    }
    ...
    * @return $this
    */
    public function setResult(?GoodsFeedbackCommentListDTO $result = null): self
    {
        $this->result = $result;
