...
class GetFulfillmentWarehousesResponse 
{
    ...
    */
     ...
     * @Type("OpenAPI\Server\Model\FulfillmentWarehousesDTO")
    */
    #[Assert\Type("OpenAPI\Server\Model\FulfillmentWarehousesDTO")]
    protected ?FulfillmentWarehousesDTO $result = null;
    ...
    */
     ...
     * Gets result.
     *
     * @return FulfillmentWarehousesDTO|null
     */
    public function getResult(): ?FulfillmentWarehousesDTO
    {
        return $this->result;
    }
    ...
    * @return $this
    */
    public function setResult(?FulfillmentWarehousesDTO $result = null): self
    {
        $this->result = $result;
