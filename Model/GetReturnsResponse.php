...
class GetReturnsResponse 
{
    ...
    */
     ...
     * @Type("OpenAPI\Server\Model\PagedReturnsDTO")
    */
    #[Assert\Type("OpenAPI\Server\Model\PagedReturnsDTO")]
    protected ?PagedReturnsDTO $result = null;
    ...
    */
     ...
     * Gets result.
     *
     * @return PagedReturnsDTO|null
     */
    public function getResult(): ?PagedReturnsDTO
    {
        return $this->result;
    }
    ...
    * @return $this
    */
    public function setResult(?PagedReturnsDTO $result = null): self
    {
        $this->result = $result;
