...
class CreateOutletResponse 
{
    ...
    */
     ...
     * @Type("OpenAPI\Server\Model\OutletResponseDTO")
    */
    #[Assert\Type("OpenAPI\Server\Model\OutletResponseDTO")]
    protected ?OutletResponseDTO $result = null;
    ...
    */
     ...
     * Gets result.
     *
     * @return OutletResponseDTO|null
     */
    public function getResult(): ?OutletResponseDTO
    {
        return $this->result;
    }
    ...
    * @return $this
    */
    public function setResult(?OutletResponseDTO $result = null): self
    {
        $this->result = $result;
