...
class GetOfferMappingEntriesResponse 
{
    ...
    */
     ...
     * @Type("OpenAPI\Server\Model\OfferMappingEntriesDTO")
    */
    #[Assert\Type("OpenAPI\Server\Model\OfferMappingEntriesDTO")]
    protected ?OfferMappingEntriesDTO $result = null;
    ...
    */
     ...
     * Gets result.
     *
     * @return OfferMappingEntriesDTO|null
     */
    public function getResult(): ?OfferMappingEntriesDTO
    {
        return $this->result;
    }
    ...
    * @return $this
    */
    public function setResult(?OfferMappingEntriesDTO $result = null): self
    {
        $this->result = $result;
