...
class GetPromoOffersResponse 
{
    ...
    */
     ...
     * @Type("OpenAPI\Server\Model\GetPromoOffersResultDTO")
    */
    #[Assert\Type("OpenAPI\Server\Model\GetPromoOffersResultDTO")]
    protected ?GetPromoOffersResultDTO $result = null;
    ...
    */
     ...
     * Gets result.
     *
     * @return GetPromoOffersResultDTO|null
     */
    public function getResult(): ?GetPromoOffersResultDTO
    {
        return $this->result;
    }
    ...
    * @return $this
    */
    public function setResult(?GetPromoOffersResultDTO $result = null): self
    {
        $this->result = $result;
