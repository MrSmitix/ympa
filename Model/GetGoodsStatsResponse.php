...
class GetGoodsStatsResponse 
{
    ...
    */
     ...
     * @Type("OpenAPI\Server\Model\GoodsStatsDTO")
    */
    #[Assert\Type("OpenAPI\Server\Model\GoodsStatsDTO")]
    protected ?GoodsStatsDTO $result = null;
    ...
    */
     ...
     * Gets result.
     *
     * @return GoodsStatsDTO|null
     */
    public function getResult(): ?GoodsStatsDTO
    {
        return $this->result;
    }
    ...
    * @return $this
    */
    public function setResult(?GoodsStatsDTO $result = null): self
    {
        $this->result = $result;
