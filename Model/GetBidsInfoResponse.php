...
class GetBidsInfoResponse 
{
    ...
    */
     ...
     * @Type("OpenAPI\Server\Model\GetBidsInfoResponseDTO")
    */
    #[Assert\Type("OpenAPI\Server\Model\GetBidsInfoResponseDTO")]
    protected ?GetBidsInfoResponseDTO $result = null;
    ...
    */
     ...
     * Gets result.
     *
     * @return GetBidsInfoResponseDTO|null
     */
    public function getResult(): ?GetBidsInfoResponseDTO
    {
        return $this->result;
    }
    ...
    * @return $this
    */
    public function setResult(?GetBidsInfoResponseDTO $result = null): self
    {
        $this->result = $result;
