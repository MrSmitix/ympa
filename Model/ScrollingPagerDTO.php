...
class ScrollingPagerDTO 
{
    ...
    */
    #[Assert\Type("string")]
    protected ?string $prevPageToken = null;
    ...
    public function __construct(array $data = null)
    {
        if (is_array($data)) {
            ...
            $this->prevPageToken = array_key_exists('prevPageToken', $data) ? $data['prevPageToken'] : $this->prevPageToken;
        }
    }
    ...
    * Sets prevPageToken.
    *
    * @param string|null $prevPageToken  Идентификатор предыдущей страницы результатов.
    *
    * @return $this
    */
    public function setPrevPageToken(?string $prevPageToken = null): self
    {
