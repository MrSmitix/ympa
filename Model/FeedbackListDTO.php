...
class FeedbackListDTO 
{
    ...
    */
     ...
     *
     * @var FeedbackDTO[]|null
     * @SerializedName("feedbackList")
     * @Type("array<OpenAPI\Server\Model\FeedbackDTO>")
    */
    #[Assert\NotNull]
    #[Assert\Valid]
    #[Assert\All([
        new Assert\Type("OpenAPI\Server\Model\FeedbackDTO"),
    ])]
    protected ?array $feedbackList = null;
    ...
    public function __construct(array $data = null)
    {
        if (is_array($data)) {
            ...
            $this->feedbackList = array_key_exists('feedbackList', $data) ? $data['feedbackList'] : $this->feedbackList;
        }
    }
    ...
    * Sets feedbackList.
    *
    * @param FeedbackDTO[]|null $feedbackList  Список отзывов.  Содержит не более 20 отзывов.
    *
    * @return $this
    */
    public function setFeedbackList(?array $feedbackList): self
    {
