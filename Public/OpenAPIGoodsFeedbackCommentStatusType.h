...
/*
 * OpenAPIGoodsFeedbackCommentStatusType
 *
 * Статус комментария:  * &#x60;PUBLISHED&#x60; — опубликован. * &#x60;UNMODERATED&#x60; — не проверен. * &#x60;BANNED&#x60; — заблокирован. * &#x60;DELETED&#x60; — удален. 
 */
class OPENAPI_API OpenAPIGoodsFeedbackCommentStatusType : public Model
{
public:
    virtual ~OpenAPIGoodsFeedbackCommentStatusType() {}
