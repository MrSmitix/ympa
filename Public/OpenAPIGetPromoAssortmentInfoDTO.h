...
/*
 * OpenAPIGetPromoAssortmentInfoDTO
 *
 * Информация о товарах в акции.
 */
class OPENAPI_API OpenAPIGetPromoAssortmentInfoDTO : public Model
{
public:
    virtual ~OpenAPIGetPromoAssortmentInfoDTO() {}
