...
#include "OpenAPIOfferCampaignStatusDTO.h"
...
#include "OpenAPIOfferSellingProgramDTO.h"
 ...
 * Параметры товара.
 */
class OPENAPI_API OpenAPIGetOfferDTO : public Model
{
public:
    virtual ~OpenAPIGetOfferDTO() {}
	...
	TOptional<OpenAPIGetPriceWithDiscountDTO> BasicPrice;
	TOptional<OpenAPIGetPriceDTO> PurchasePrice;
	TOptional<OpenAPIGetPriceDTO> AdditionalExpenses;
	TOptional<OpenAPIGetPriceDTO> CofinancePrice;
	TOptional<OpenAPIOfferCardStatusType> CardStatus;
	/* Список магазинов, в которых размещен товар.  */
	TOptional<TArray<OpenAPIOfferCampaignStatusDTO>> Campaigns;
	/* Информация о том, какие для товара доступны модели размещения.  */
	TOptional<TArray<OpenAPIOfferSellingProgramDTO>> SellingPrograms;
