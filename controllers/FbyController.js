/**
 * The FbyController file is a very simple one, which does not need to be changed manually,
...
const service = require('../services/FbyService');
...
const getFulfillmentWarehouses = async (request, response) => {
  await Controller.handleRequest(request, response, service.getFulfillmentWarehouses);
};
