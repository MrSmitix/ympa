...
#ifndef EXPRESS_API_IMPL_H_
#define EXPRESS_API_IMPL_H_
...
class  ExpressApiImpl : public org::openapitools::server::api::ExpressApi {
public:
    explicit ExpressApiImpl(const std::shared_ptr<Pistache::Rest::Router>& rtr);
    ~ExpressApiImpl() override = default;
