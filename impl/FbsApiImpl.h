...
#ifndef FBS_API_IMPL_H_
#define FBS_API_IMPL_H_
...
class  FbsApiImpl : public org::openapitools::server::api::FbsApi {
public:
    explicit FbsApiImpl(const std::shared_ptr<Pistache::Rest::Router>& rtr);
    ~FbsApiImpl() override = default;
