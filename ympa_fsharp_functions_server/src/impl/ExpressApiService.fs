...
module ExpressApiServiceImplementation =

    //#region Service implementation
    type ExpressApiServiceImpl() =
      interface IExpressApiService with
    ...
    let ExpressApiService = ExpressApiServiceImpl() :> IExpressApiService