...
module BusinessOfferMappingsApiHandlers =
   ...
   [<FunctionName("AddOffersToArchive")>]
    let AddOffersToArchive
      ...
      let result = BusinessOfferMappingsApiService.AddOffersToArchive bodyParams
      match result with
   ...
   [<FunctionName("DeleteOffers")>]
    let DeleteOffers
      ...
      let bodyParams = reader.ReadToEnd() |> bind req.ContentType
      let result = BusinessOfferMappingsApiService.DeleteOffers bodyParams
      match result with
   ...
   [<FunctionName("DeleteOffersFromArchive")>]
    let DeleteOffersFromArchive
      ...
      let bodyParams = reader.ReadToEnd() |> bind req.ContentType
      let result = BusinessOfferMappingsApiService.DeleteOffersFromArchive bodyParams
      match result with
   ...
   [<FunctionName("GetOfferMappings")>]
    let GetOfferMappings
      ...
      let bodyParams = reader.ReadToEnd() |> bind req.ContentType
      let result = BusinessOfferMappingsApiService.GetOfferMappings bodyParams
      match result with
   ...
   [<FunctionName("GetSuggestedOfferMappings")>]
    let GetSuggestedOfferMappings
      ...
      let bodyParams = reader.ReadToEnd() |> bind req.ContentType
      let result = BusinessOfferMappingsApiService.GetSuggestedOfferMappings bodyParams
      match result with
   ...
   [<FunctionName("UpdateOfferMappings")>]
    let UpdateOfferMappings
      ...
      let bodyParams = reader.ReadToEnd() |> bind req.ContentType
      let result = BusinessOfferMappingsApiService.UpdateOfferMappings bodyParams
      match result with
