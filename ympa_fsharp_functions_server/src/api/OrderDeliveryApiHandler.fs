...
module OrderDeliveryApiHandlers =
   ...
   [<FunctionName("GetOrderBuyerInfo")>]
    let GetOrderBuyerInfo
      ...
      let result = OrderDeliveryApiService.GetOrderBuyerInfo ()
      match result with
   ...
   [<FunctionName("SetOrderDeliveryDate")>]
    let SetOrderDeliveryDate
      ...
      let result = OrderDeliveryApiService.SetOrderDeliveryDate bodyParams
      match result with
   ...
   [<FunctionName("SetOrderDeliveryTrackCode")>]
    let SetOrderDeliveryTrackCode
      ...
      let bodyParams = reader.ReadToEnd() |> bind req.ContentType
      let result = OrderDeliveryApiService.SetOrderDeliveryTrackCode bodyParams
      match result with
   ...
   [<FunctionName("UpdateOrderStorageLimit")>]
    let UpdateOrderStorageLimit
      ...
      let bodyParams = reader.ReadToEnd() |> bind req.ContentType
      let result = OrderDeliveryApiService.UpdateOrderStorageLimit bodyParams
      match result with
   ...
   [<FunctionName("VerifyOrderEac")>]
    let VerifyOrderEac
      ...
      let bodyParams = reader.ReadToEnd() |> bind req.ContentType
      let result = OrderDeliveryApiService.VerifyOrderEac bodyParams
      match result with
