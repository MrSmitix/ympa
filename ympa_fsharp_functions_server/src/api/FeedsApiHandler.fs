...
module FeedsApiHandlers =
   ...
   [<FunctionName("GetFeed")>]
    let GetFeed
      ...
      let result = FeedsApiService.GetFeed ()
      match result with
   ...
   [<FunctionName("GetFeedIndexLogs")>]
    let GetFeedIndexLogs
      ...
      let result = FeedsApiService.GetFeedIndexLogs ()
      match result with
   ...
   [<FunctionName("GetFeeds")>]
    let GetFeeds
      ...
      let result = FeedsApiService.GetFeeds ()
      match result with
   ...
   [<FunctionName("RefreshFeed")>]
    let RefreshFeed
      ...
      let result = FeedsApiService.RefreshFeed ()
      match result with
   ...
   [<FunctionName("SetFeedParams")>]
    let SetFeedParams
      ...
      let result = FeedsApiService.SetFeedParams bodyParams
      match result with
