...
module ContentApiHandlers =
   ...
   [<FunctionName("GetCategoryContentParameters")>]
    let GetCategoryContentParameters
      ...
      let result = ContentApiService.GetCategoryContentParameters ()
      match result with
   ...
   [<FunctionName("GetOfferCardsContentStatus")>]
    let GetOfferCardsContentStatus
      ...
      let result = ContentApiService.GetOfferCardsContentStatus bodyParams
      match result with
   ...
   [<FunctionName("UpdateOfferContent")>]
    let UpdateOfferContent
      ...
      let bodyParams = reader.ReadToEnd() |> bind req.ContentType
      let result = ContentApiService.UpdateOfferContent bodyParams
      match result with
