...
module OutletsApiHandlers =
   ...
   [<FunctionName("CreateOutlet")>]
    let CreateOutlet
      ...
      let result = OutletsApiService.CreateOutlet bodyParams
      match result with
   ...
   [<FunctionName("DeleteOutlet")>]
    let DeleteOutlet
      ...
      let result = OutletsApiService.DeleteOutlet ()
      match result with
   ...
   [<FunctionName("GetOutlet")>]
    let GetOutlet
      ...
      let result = OutletsApiService.GetOutlet ()
      match result with
   ...
   [<FunctionName("GetOutlets")>]
    let GetOutlets
      ...
      let result = OutletsApiService.GetOutlets ()
      match result with
   ...
   [<FunctionName("UpdateOutlet")>]
    let UpdateOutlet
      ...
      let bodyParams = reader.ReadToEnd() |> bind req.ContentType
      let result = OutletsApiService.UpdateOutlet bodyParams
      match result with
