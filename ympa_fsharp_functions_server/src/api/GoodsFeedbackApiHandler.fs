...
module GoodsFeedbackApiHandlers =
   ...
   [<FunctionName("DeleteGoodsFeedbackComment")>]
    let DeleteGoodsFeedbackComment
      ...
      let result = GoodsFeedbackApiService.DeleteGoodsFeedbackComment bodyParams
      match result with
   ...
   [<FunctionName("GetGoodsFeedbackComments")>]
    let GetGoodsFeedbackComments
      ...
      let bodyParams = reader.ReadToEnd() |> bind req.ContentType
      let result = GoodsFeedbackApiService.GetGoodsFeedbackComments bodyParams
      match result with
   ...
   [<FunctionName("GetGoodsFeedbacks")>]
    let GetGoodsFeedbacks
      ...
      let bodyParams = reader.ReadToEnd() |> bind req.ContentType
      let result = GoodsFeedbackApiService.GetGoodsFeedbacks bodyParams
      match result with
   ...
   [<FunctionName("SkipGoodsFeedbacksReaction")>]
    let SkipGoodsFeedbacksReaction
      ...
      let bodyParams = reader.ReadToEnd() |> bind req.ContentType
      let result = GoodsFeedbackApiService.SkipGoodsFeedbacksReaction bodyParams
      match result with
   ...
   [<FunctionName("UpdateGoodsFeedbackComment")>]
    let UpdateGoodsFeedbackComment
      ...
      let bodyParams = reader.ReadToEnd() |> bind req.ContentType
      let result = GoodsFeedbackApiService.UpdateGoodsFeedbackComment bodyParams
      match result with
