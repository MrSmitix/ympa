...
module BidsApiHandlers =
   ...
   [<FunctionName("GetBidsInfoForBusiness")>]
    let GetBidsInfoForBusiness
      ...
      let result = BidsApiService.GetBidsInfoForBusiness bodyParams
      match result with
   ...
   [<FunctionName("GetBidsRecommendations")>]
    let GetBidsRecommendations
      ...
      let bodyParams = reader.ReadToEnd() |> bind req.ContentType
      let result = BidsApiService.GetBidsRecommendations bodyParams
      match result with
   ...
   [<FunctionName("PutBidsForBusiness")>]
    let PutBidsForBusiness
      ...
      let bodyParams = reader.ReadToEnd() |> bind req.ContentType
      let result = BidsApiService.PutBidsForBusiness bodyParams
      match result with
   ...
   [<FunctionName("PutBidsForCampaign")>]
    let PutBidsForCampaign
      ...
      let bodyParams = reader.ReadToEnd() |> bind req.ContentType
      let result = BidsApiService.PutBidsForCampaign bodyParams
      match result with
