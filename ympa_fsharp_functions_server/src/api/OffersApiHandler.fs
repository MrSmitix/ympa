...
module OffersApiHandlers =
   ...
   [<FunctionName("DeleteCampaignOffers")>]
    let DeleteCampaignOffers
      ...
      let result = OffersApiService.DeleteCampaignOffers bodyParams
      match result with
   ...
   [<FunctionName("GetAllOffers")>]
    let GetAllOffers
      ...
      let result = OffersApiService.GetAllOffers ()
      match result with
   ...
   [<FunctionName("GetCampaignOffers")>]
    let GetCampaignOffers
      ...
      let bodyParams = reader.ReadToEnd() |> bind req.ContentType
      let result = OffersApiService.GetCampaignOffers bodyParams
      match result with
   ...
   [<FunctionName("GetOfferRecommendations")>]
    let GetOfferRecommendations
      ...
      let bodyParams = reader.ReadToEnd() |> bind req.ContentType
      let result = OffersApiService.GetOfferRecommendations bodyParams
      match result with
   ...
   [<FunctionName("GetOffers")>]
    let GetOffers
      ...
      let result = OffersApiService.GetOffers ()
      match result with
   ...
   [<FunctionName("UpdateCampaignOffers")>]
    let UpdateCampaignOffers
      ...
      let bodyParams = reader.ReadToEnd() |> bind req.ContentType
      let result = OffersApiService.UpdateCampaignOffers bodyParams
      match result with
