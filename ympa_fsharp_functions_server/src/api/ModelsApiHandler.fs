...
module ModelsApiHandlers =
   ...
   [<FunctionName("GetModel")>]
    let GetModel
      ...
      let result = ModelsApiService.GetModel ()
      match result with
   ...
   [<FunctionName("GetModelOffers")>]
    let GetModelOffers
      ...
      let result = ModelsApiService.GetModelOffers ()
      match result with
   ...
   [<FunctionName("GetModels")>]
    let GetModels
      ...
      let result = ModelsApiService.GetModels bodyParams
      match result with
   ...
   [<FunctionName("GetModelsOffers")>]
    let GetModelsOffers
      ...
      let bodyParams = reader.ReadToEnd() |> bind req.ContentType
      let result = ModelsApiService.GetModelsOffers bodyParams
      match result with
   ...
   [<FunctionName("SearchModels")>]
    let SearchModels
      ...
      let result = ModelsApiService.SearchModels ()
      match result with
