...
module ReturnsApiHandlers =
   ...
   [<FunctionName("GetReturn")>]
    let GetReturn
      ...
      let result = ReturnsApiService.GetReturn ()
      match result with
   ...
   [<FunctionName("GetReturnApplication")>]
    let GetReturnApplication
      ...
      let result = ReturnsApiService.GetReturnApplication ()
      match result with
   ...
   [<FunctionName("GetReturnPhoto")>]
    let GetReturnPhoto
      ...
      let result = ReturnsApiService.GetReturnPhoto ()
      match result with
   ...
   [<FunctionName("GetReturns")>]
    let GetReturns
      ...
      let result = ReturnsApiService.GetReturns ()
      match result with
   ...
   [<FunctionName("SetReturnDecision")>]
    let SetReturnDecision
      ...
      let result = ReturnsApiService.SetReturnDecision bodyParams
      match result with
   ...
   [<FunctionName("SubmitReturnDecision")>]
    let SubmitReturnDecision
      ...
      let result = ReturnsApiService.SubmitReturnDecision ()
      match result with
