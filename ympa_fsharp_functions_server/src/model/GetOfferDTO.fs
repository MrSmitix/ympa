...
open ympa_fsharp_functions_server.Model.OfferCampaignStatusDTO
...
open ympa_fsharp_functions_server.Model.OfferSellingProgramDTO
...
module GetOfferDTO =
  ...
  type GetOfferDTO = {
    ...
    [<JsonProperty(PropertyName = "sellingPrograms")>]
