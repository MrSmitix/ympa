...
// AssertGetOfferDtoRequired checks if the required fields are not zero-ed
func AssertGetOfferDtoRequired(obj GetOfferDto) error {
	...
	if err := AssertGetPriceDtoRequired(obj.PurchasePrice); err != nil {
		return err
	}
	if err := AssertGetPriceDtoRequired(obj.AdditionalExpenses); err != nil {
		return err
	}
	if err := AssertGetPriceDtoRequired(obj.CofinancePrice); err != nil {
		return err
	}
	if obj.Campaigns != nil {
		for _, el := range *obj.Campaigns {
			if err := AssertOfferCampaignStatusDtoRequired(el); err != nil {
				return err
			}
		}
	}
	if obj.SellingPrograms != nil {
		for _, el := range *obj.SellingPrograms {
			if err := AssertOfferSellingProgramDtoRequired(el); err != nil {
				return err
			}
		}
	}
...
// AssertGetOfferDtoConstraints checks if the values respects the defined constraints
func AssertGetOfferDtoConstraints(obj GetOfferDto) error {
    if obj.Manuals != nil {
     	for _, el := range *obj.Manuals {
	...
	if err := AssertGetPriceDtoConstraints(obj.PurchasePrice); err != nil {
		return err
	}
	if err := AssertGetPriceDtoConstraints(obj.AdditionalExpenses); err != nil {
		return err
	}
	if err := AssertGetPriceDtoConstraints(obj.CofinancePrice); err != nil {
		return err
	}
    if obj.Campaigns != nil {
     	for _, el := range *obj.Campaigns {
     		if err := AssertOfferCampaignStatusDtoConstraints(el); err != nil {
     			return err
     		}
     	}
    }
    if obj.SellingPrograms != nil {
     	for _, el := range *obj.SellingPrograms {
     		if err := AssertOfferSellingProgramDtoConstraints(el); err != nil {
     			return err
     		}
     	}
    }
