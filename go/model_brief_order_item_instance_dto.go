...
// AssertBriefOrderItemInstanceDtoRequired checks if the required fields are not zero-ed
func AssertBriefOrderItemInstanceDtoRequired(obj BriefOrderItemInstanceDto) error {
	return nil
}

// AssertBriefOrderItemInstanceDtoConstraints checks if the values respects the defined constraints
func AssertBriefOrderItemInstanceDtoConstraints(obj BriefOrderItemInstanceDto) error {
	return nil
}
