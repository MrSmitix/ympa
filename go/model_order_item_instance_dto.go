...
// AssertOrderItemInstanceDtoRequired checks if the required fields are not zero-ed
func AssertOrderItemInstanceDtoRequired(obj OrderItemInstanceDto) error {
	return nil
}

// AssertOrderItemInstanceDtoConstraints checks if the values respects the defined constraints
func AssertOrderItemInstanceDtoConstraints(obj OrderItemInstanceDto) error {
	return nil
}
