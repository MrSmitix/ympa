...
// AssertMappingsOfferInfoDtoRequired checks if the required fields are not zero-ed
func AssertMappingsOfferInfoDtoRequired(obj MappingsOfferInfoDto) error {
...
// AssertMappingsOfferInfoDtoConstraints checks if the values respects the defined constraints
func AssertMappingsOfferInfoDtoConstraints(obj MappingsOfferInfoDto) error {
