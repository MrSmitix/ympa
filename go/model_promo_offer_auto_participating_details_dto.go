...
// AssertPromoOfferAutoParticipatingDetailsDtoRequired checks if the required fields are not zero-ed
func AssertPromoOfferAutoParticipatingDetailsDtoRequired(obj PromoOfferAutoParticipatingDetailsDto) error {
	return nil
}

// AssertPromoOfferAutoParticipatingDetailsDtoConstraints checks if the values respects the defined constraints
func AssertPromoOfferAutoParticipatingDetailsDtoConstraints(obj PromoOfferAutoParticipatingDetailsDto) error {
	return nil
}
