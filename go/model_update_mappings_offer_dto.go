...
// AssertUpdateMappingsOfferDtoRequired checks if the required fields are not zero-ed
func AssertUpdateMappingsOfferDtoRequired(obj UpdateMappingsOfferDto) error {
...
// AssertUpdateMappingsOfferDtoConstraints checks if the values respects the defined constraints
func AssertUpdateMappingsOfferDtoConstraints(obj UpdateMappingsOfferDto) error {
