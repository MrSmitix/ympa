...
// AssertOrderStatusChangeDeliveryDatesDtoRequired checks if the required fields are not zero-ed
func AssertOrderStatusChangeDeliveryDatesDtoRequired(obj OrderStatusChangeDeliveryDatesDto) error {
	return nil
}

// AssertOrderStatusChangeDeliveryDatesDtoConstraints checks if the values respects the defined constraints
func AssertOrderStatusChangeDeliveryDatesDtoConstraints(obj OrderStatusChangeDeliveryDatesDto) error {
	return nil
}
