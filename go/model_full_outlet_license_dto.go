...
// AssertFullOutletLicenseDtoRequired checks if the required fields are not zero-ed
func AssertFullOutletLicenseDtoRequired(obj FullOutletLicenseDto) error {
	return nil
}

// AssertFullOutletLicenseDtoConstraints checks if the values respects the defined constraints
func AssertFullOutletLicenseDtoConstraints(obj FullOutletLicenseDto) error {
	return nil
}
