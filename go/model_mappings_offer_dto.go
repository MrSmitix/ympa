...
// AssertMappingsOfferDtoRequired checks if the required fields are not zero-ed
func AssertMappingsOfferDtoRequired(obj MappingsOfferDto) error {
...
// AssertMappingsOfferDtoConstraints checks if the values respects the defined constraints
func AssertMappingsOfferDtoConstraints(obj MappingsOfferDto) error {
