...
// AssertFeedPublicationPriceAndStockUpdateDtoRequired checks if the required fields are not zero-ed
func AssertFeedPublicationPriceAndStockUpdateDtoRequired(obj FeedPublicationPriceAndStockUpdateDto) error {
	return nil
}

// AssertFeedPublicationPriceAndStockUpdateDtoConstraints checks if the values respects the defined constraints
func AssertFeedPublicationPriceAndStockUpdateDtoConstraints(obj FeedPublicationPriceAndStockUpdateDto) error {
	return nil
}
