...
// AssertEnrichedMappingsOfferDtoRequired checks if the required fields are not zero-ed
func AssertEnrichedMappingsOfferDtoRequired(obj EnrichedMappingsOfferDto) error {
	if err := AssertOfferWeightDimensionsDtoRequired(obj.WeightDimensions); err != nil {
		return err
	}
	if err := AssertOfferProcessingStateDtoRequired(obj.ProcessingState); err != nil {
		return err
	}
...
// AssertEnrichedMappingsOfferDtoConstraints checks if the values respects the defined constraints
func AssertEnrichedMappingsOfferDtoConstraints(obj EnrichedMappingsOfferDto) error {
	if err := AssertOfferWeightDimensionsDtoConstraints(obj.WeightDimensions); err != nil {
		return err
	}
	if err := AssertOfferProcessingStateDtoConstraints(obj.ProcessingState); err != nil {
		return err
	}
