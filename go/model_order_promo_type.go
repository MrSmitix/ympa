...
// AllowedOrderPromoTypeEnumValues is all the allowed values of OrderPromoType enum
...
// validOrderPromoTypeEnumValue provides a map of OrderPromoTypes for fast verification of use input
var validOrderPromoTypeEnumValues = map[OrderPromoType]struct{}{
	"DIRECT_DISCOUNT": {},
	"BLUE_SET": {},
	"BLUE_FLASH": {},
	"GENERIC_BUNDLE": {},
...
func (v OrderPromoType) IsValid() bool {
	_, ok := validOrderPromoTypeEnumValues[v]
	return ok
}
...
func NewOrderPromoTypeFromValue(v string) (OrderPromoType, error) {
	...
	return "", fmt.Errorf("invalid value '%v' for OrderPromoType: valid values are %v", v, AllowedOrderPromoTypeEnumValues)
}



// AssertOrderPromoTypeRequired checks if the required fields are not zero-ed
func AssertOrderPromoTypeRequired(obj OrderPromoType) error {
	return nil
}

// AssertOrderPromoTypeConstraints checks if the values respects the defined constraints
func AssertOrderPromoTypeConstraints(obj OrderPromoType) error {
	return nil
}
