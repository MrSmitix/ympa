...
// OrdersStatsAPIService is a service that implements the logic for the OrdersStatsAPIServicer
// This service should implement the business logic for every endpoint for the OrdersStatsAPI API.
// Include any external packages or services that will be required by this service.
type OrdersStatsAPIService struct {
}

// NewOrdersStatsAPIService creates a default api service
func NewOrdersStatsAPIService() *OrdersStatsAPIService {
	return &OrdersStatsAPIService{}
}

// GetOrdersStats - Детальная информация по заказам
func (s *OrdersStatsAPIService) GetOrdersStats(ctx context.Context, campaignId int64, pageToken string, limit int32, getOrdersStatsRequest GetOrdersStatsRequest) (ImplResponse, error) {
	// TODO - update GetOrdersStats with the required logic for this service method.
	// Add api_orders_stats_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.
