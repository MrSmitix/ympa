...
// AssertBaseShipmentDtoRequired checks if the required fields are not zero-ed
func AssertBaseShipmentDtoRequired(obj BaseShipmentDto) error {
...
// AssertBaseShipmentDtoConstraints checks if the values respects the defined constraints
func AssertBaseShipmentDtoConstraints(obj BaseShipmentDto) error {
