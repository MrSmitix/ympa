...
// AssertGetGoodsFeedbackRequestRequired checks if the required fields are not zero-ed
func AssertGetGoodsFeedbackRequestRequired(obj GetGoodsFeedbackRequest) error {
	return nil
}

// AssertGetGoodsFeedbackRequestConstraints checks if the values respects the defined constraints
func AssertGetGoodsFeedbackRequestConstraints(obj GetGoodsFeedbackRequest) error {
	return nil
}
