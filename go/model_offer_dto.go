...
// AssertOfferDtoRequired checks if the required fields are not zero-ed
func AssertOfferDtoRequired(obj OfferDto) error {
...
// AssertOfferDtoConstraints checks if the values respects the defined constraints
func AssertOfferDtoConstraints(obj OfferDto) error {
	return nil
}
