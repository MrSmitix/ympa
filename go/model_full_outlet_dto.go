...
// AssertFullOutletDtoRequired checks if the required fields are not zero-ed
func AssertFullOutletDtoRequired(obj FullOutletDto) error {
...
// AssertFullOutletDtoConstraints checks if the values respects the defined constraints
func AssertFullOutletDtoConstraints(obj FullOutletDto) error {
