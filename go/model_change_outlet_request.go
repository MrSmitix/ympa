...
// AssertChangeOutletRequestRequired checks if the required fields are not zero-ed
func AssertChangeOutletRequestRequired(obj ChangeOutletRequest) error {
...
// AssertChangeOutletRequestConstraints checks if the values respects the defined constraints
func AssertChangeOutletRequestConstraints(obj ChangeOutletRequest) error {
