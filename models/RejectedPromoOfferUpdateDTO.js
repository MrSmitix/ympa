...
const RejectedPromoOfferUpdateReasonType = require('../models/RejectedPromoOfferUpdateReasonType');
    ...
    fields: (prefix = '', isInput = true, isArrayChild = false) => {
        ...
        return [
            ...
            },
            {
                ...
                ...RejectedPromoOfferUpdateReasonType.fields(`${keyPrefix}reason`, isInput),
            },
        ]
    },
