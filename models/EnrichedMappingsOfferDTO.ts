...
/**
 * Check if a given object implements the EnrichedMappingsOfferDTO interface.
 */
export function instanceOfEnrichedMappingsOfferDTO(value: object): value is EnrichedMappingsOfferDTO {
    return true;
}

export function EnrichedMappingsOfferDTOFromJSON(json: any): EnrichedMappingsOfferDTO {
    return EnrichedMappingsOfferDTOFromJSONTyped(json, false);
}

export function EnrichedMappingsOfferDTOFromJSONTyped(json: any, ignoreDiscriminator: boolean): EnrichedMappingsOfferDTO {
    if (json == null) {
        return json;
    }
    return {
...
export function EnrichedMappingsOfferDTOToJSON(value?: EnrichedMappingsOfferDTO | null): any {
    if (value == null) {
        return value;
    }
    return {
