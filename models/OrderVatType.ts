...
export function instanceOfOrderVatType(value: any): boolean {
    for (const key in OrderVatType) {
        if (Object.prototype.hasOwnProperty.call(OrderVatType, key)) {
            if (OrderVatType[key as keyof typeof OrderVatType] === value) {
                return true;
            }
        }
    }
...
export function OrderVatTypeFromJSON(json: any): OrderVatType {
    return OrderVatTypeFromJSONTyped(json, false);
}

export function OrderVatTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): OrderVatType {
    return json as OrderVatType;
}

export function OrderVatTypeToJSON(value?: OrderVatType | null): any {
    return value as any;
}
