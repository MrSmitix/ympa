...
const OutletStatusType = require('../models/OutletStatusType');
...
module.exports = {
    fields: (prefix = '', isInput = true, isArrayChild = false) => {
        ...
        return [
            ...
            {
                key: `${keyPrefix}id`,
                label: `Идентификатор точки продаж, присвоенный Маркетом. - [${labelPrefix}id]`,
                type: 'number',
            },
            {
                key: `${keyPrefix}status`,
                ...OutletStatusType.fields(`${keyPrefix}status`, isInput),
            },
            ...RegionDTO.fields(`${keyPrefix}region`, isInput),
            {
                key: `${keyPrefix}shopOutletId`,
                label: `Идентификатор точки продаж, заданный магазином. - [${labelPrefix}shopOutletId]`,
                type: 'string',
            },
            {
                key: `${keyPrefix}workingTime`,
                label: `Рабочее время. - [${labelPrefix}workingTime]`,
                type: 'string',
            },
            {
                key: `${keyPrefix}moderationReason`,
                label: `Статус модерации. - [${labelPrefix}moderationReason]`,
                type: 'string',
            },
        ]
    },
    mapping: (bundle, prefix = '') => {
        ...
        return {
            ...
            'shopOutletId': bundle.inputData?.[`${keyPrefix}shopOutletId`],
            'workingTime': bundle.inputData?.[`${keyPrefix}workingTime`],
            'moderationReason': bundle.inputData?.[`${keyPrefix}moderationReason`],
        }
    },
}
