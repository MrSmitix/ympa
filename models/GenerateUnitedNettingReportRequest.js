...
module.exports = {
    fields: (prefix = '', isInput = true, isArrayChild = false) => {
        ...
        return [
            ...
            {
                key: `${keyPrefix}bankOrderId`,
                label: `Номер платежного поручения. - [${labelPrefix}bankOrderId]`,
                type: 'number',
            },
            {
                key: `${keyPrefix}bankOrderDateTime`,
                label: `Дата платежного поручения. - [${labelPrefix}bankOrderDateTime]`,
                type: 'string',
            },
            {
    ...
    mapping: (bundle, prefix = '') => {
        ...
        return {
            ...
            'bankOrderId': bundle.inputData?.[`${keyPrefix}bankOrderId`],
            'bankOrderDateTime': bundle.inputData?.[`${keyPrefix}bankOrderDateTime`],
