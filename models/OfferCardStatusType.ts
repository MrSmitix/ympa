...
export type OfferCardStatusType = typeof OfferCardStatusType[keyof typeof OfferCardStatusType];


export function instanceOfOfferCardStatusType(value: any): boolean {
    for (const key in OfferCardStatusType) {
        if (Object.prototype.hasOwnProperty.call(OfferCardStatusType, key)) {
            if (OfferCardStatusType[key as keyof typeof OfferCardStatusType] === value) {
                return true;
            }
        }
    }
...
export function OfferCardStatusTypeFromJSON(json: any): OfferCardStatusType {
    return OfferCardStatusTypeFromJSONTyped(json, false);
}

export function OfferCardStatusTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): OfferCardStatusType {
    return json as OfferCardStatusType;
}

export function OfferCardStatusTypeToJSON(value?: OfferCardStatusType | null): any {
    return value as any;
}
