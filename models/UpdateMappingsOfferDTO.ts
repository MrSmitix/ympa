...
/**
 * Check if a given object implements the UpdateMappingsOfferDTO interface.
 */
export function instanceOfUpdateMappingsOfferDTO(value: object): value is UpdateMappingsOfferDTO {
    return true;
}

export function UpdateMappingsOfferDTOFromJSON(json: any): UpdateMappingsOfferDTO {
    return UpdateMappingsOfferDTOFromJSONTyped(json, false);
}

export function UpdateMappingsOfferDTOFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateMappingsOfferDTO {
    if (json == null) {
        return json;
    }
    return {
...
export function UpdateMappingsOfferDTOToJSON(value?: UpdateMappingsOfferDTO | null): any {
    if (value == null) {
        return value;
    }
    return {
