...
export type OfferMappingErrorType = typeof OfferMappingErrorType[keyof typeof OfferMappingErrorType];


export function instanceOfOfferMappingErrorType(value: any): boolean {
    for (const key in OfferMappingErrorType) {
        if (Object.prototype.hasOwnProperty.call(OfferMappingErrorType, key)) {
            if (OfferMappingErrorType[key as keyof typeof OfferMappingErrorType] === value) {
                return true;
            }
        }
    }
...
export function OfferMappingErrorTypeFromJSON(json: any): OfferMappingErrorType {
    return OfferMappingErrorTypeFromJSONTyped(json, false);
}

export function OfferMappingErrorTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): OfferMappingErrorType {
    return json as OfferMappingErrorType;
}

export function OfferMappingErrorTypeToJSON(value?: OfferMappingErrorType | null): any {
    return value as any;
}
