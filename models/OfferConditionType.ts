...
export type OfferConditionType = typeof OfferConditionType[keyof typeof OfferConditionType];


export function instanceOfOfferConditionType(value: any): boolean {
    for (const key in OfferConditionType) {
        if (Object.prototype.hasOwnProperty.call(OfferConditionType, key)) {
            if (OfferConditionType[key as keyof typeof OfferConditionType] === value) {
                return true;
            }
        }
    }
...
export function OfferConditionTypeFromJSON(json: any): OfferConditionType {
    return OfferConditionTypeFromJSONTyped(json, false);
}

export function OfferConditionTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): OfferConditionType {
    return json as OfferConditionType;
}

export function OfferConditionTypeToJSON(value?: OfferConditionType | null): any {
    return value as any;
}
