...
export type OfferProcessingNoteType = typeof OfferProcessingNoteType[keyof typeof OfferProcessingNoteType];


export function instanceOfOfferProcessingNoteType(value: any): boolean {
    for (const key in OfferProcessingNoteType) {
        if (Object.prototype.hasOwnProperty.call(OfferProcessingNoteType, key)) {
            if (OfferProcessingNoteType[key as keyof typeof OfferProcessingNoteType] === value) {
                return true;
            }
        }
    }
...
export function OfferProcessingNoteTypeFromJSON(json: any): OfferProcessingNoteType {
    return OfferProcessingNoteTypeFromJSONTyped(json, false);
}

export function OfferProcessingNoteTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): OfferProcessingNoteType {
    return json as OfferProcessingNoteType;
}

export function OfferProcessingNoteTypeToJSON(value?: OfferProcessingNoteType | null): any {
    return value as any;
}
