...
/**
 * Check if a given object implements the OutletLicenseDTO interface.
 */
export function instanceOfOutletLicenseDTO(value: object): value is OutletLicenseDTO {
    return true;
}

export function OutletLicenseDTOFromJSON(json: any): OutletLicenseDTO {
    return OutletLicenseDTOFromJSONTyped(json, false);
}

export function OutletLicenseDTOFromJSONTyped(json: any, ignoreDiscriminator: boolean): OutletLicenseDTO {
    if (json == null) {
        return json;
    }
    return {
...
export function OutletLicenseDTOToJSON(value?: OutletLicenseDTO | null): any {
    if (value == null) {
        return value;
    }
    return {
