...
module.exports = {
    fields: (prefix = '', isInput = true, isArrayChild = false) => {
        ...
        return [
            ...
            ...UpdatePriceWithDiscountDTO.fields(`${keyPrefix}basicPrice`, isInput),
            ...BasePriceDTO.fields(`${keyPrefix}purchasePrice`, isInput),
            ...BasePriceDTO.fields(`${keyPrefix}additionalExpenses`, isInput),
            ...BasePriceDTO.fields(`${keyPrefix}cofinancePrice`, isInput),
        ]
    },
    mapping: (bundle, prefix = '') => {
        ...
        return {
            ...
            'basicPrice': utils.removeIfEmpty(UpdatePriceWithDiscountDTO.mapping(bundle, `${keyPrefix}basicPrice`)),
            'purchasePrice': utils.removeIfEmpty(BasePriceDTO.mapping(bundle, `${keyPrefix}purchasePrice`)),
            'additionalExpenses': utils.removeIfEmpty(BasePriceDTO.mapping(bundle, `${keyPrefix}additionalExpenses`)),
            'cofinancePrice': utils.removeIfEmpty(BasePriceDTO.mapping(bundle, `${keyPrefix}cofinancePrice`)),
        }
    },
}
