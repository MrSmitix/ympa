...
const UpdatePromoOfferParamsDTO = require('../models/UpdatePromoOfferParamsDTO');
...
module.exports = {
    fields: (prefix = '', isInput = true, isArrayChild = false) => {
        ...
        return [
            ...
            ...UpdatePromoOfferParamsDTO.fields(`${keyPrefix}params`, isInput),
        ]
    },
    mapping: (bundle, prefix = '') => {
        ...
        return {
            ...
            'params': utils.removeIfEmpty(UpdatePromoOfferParamsDTO.mapping(bundle, `${keyPrefix}params`)),
        }
    },
}
