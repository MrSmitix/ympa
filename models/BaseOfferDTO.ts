...
/**
 * Check if a given object implements the BaseOfferDTO interface.
 */
export function instanceOfBaseOfferDTO(value: object): value is BaseOfferDTO {
    if (!('offerId' in value) || value['offerId'] === undefined) return false;
    return true;
}

export function BaseOfferDTOFromJSON(json: any): BaseOfferDTO {
    return BaseOfferDTOFromJSONTyped(json, false);
}

export function BaseOfferDTOFromJSONTyped(json: any, ignoreDiscriminator: boolean): BaseOfferDTO {
    if (json == null) {
        return json;
    }
    return {
...
export function BaseOfferDTOToJSON(value?: BaseOfferDTO | null): any {
    if (value == null) {
        return value;
    }
    return {
