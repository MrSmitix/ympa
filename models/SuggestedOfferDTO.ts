...
/**
 * Check if a given object implements the SuggestedOfferDTO interface.
 */
export function instanceOfSuggestedOfferDTO(value: object): value is SuggestedOfferDTO {
    return true;
}

export function SuggestedOfferDTOFromJSON(json: any): SuggestedOfferDTO {
    return SuggestedOfferDTOFromJSONTyped(json, false);
}

export function SuggestedOfferDTOFromJSONTyped(json: any, ignoreDiscriminator: boolean): SuggestedOfferDTO {
    if (json == null) {
        return json;
    }
    return {
        ...
        'basicPrice': json['basicPrice'] == null ? undefined : BasePriceDTOFromJSON(json['basicPrice']),
    };
}

export function SuggestedOfferDTOToJSON(value?: SuggestedOfferDTO | null): any {
    if (value == null) {
        return value;
    }
    return {
        ...
        'basicPrice': BasePriceDTOToJSON(value['basicPrice']),
    };
}
