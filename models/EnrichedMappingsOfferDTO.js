    ...
    fields: (prefix = '', isInput = true, isArrayChild = false) => {
        ...
        return [
            ...
            },
            {
                ...
                label: `Идентификатор категории для рекомендованной карточки товара на Маркете.  Возвращается только вместе с параметром ##marketSku##.  - [${labelPrefix}marketCategoryId]`,
                type: 'number',
            },
            {
                key: `${keyPrefix}marketCategoryName`,
                label: `Название категории для рекомендованной карточки товара на Маркете.  Может отсутствовать в ответе.  - [${labelPrefix}marketCategoryName]`,
                type: 'string',
            },
            {
                key: `${keyPrefix}marketModelId`,
                label: `Идентификатор модели для рекомендованной карточки товара на Маркете.  Может отсутствовать в ответе.  - [${labelPrefix}marketModelId]`,
                type: 'number',
            },
            {
                key: `${keyPrefix}marketModelName`,
                label: `Название модели для рекомендованной карточки товара на Маркете.  Возвращается только вместе с параметром ##marketSku##.  - [${labelPrefix}marketModelName]`,
                type: 'string',
            },
            {
            ...
            },
            {
                ...
                label: `Название товара с рекомендованной карточки на Маркете.  Может отсутствовать в ответе.  - [${labelPrefix}marketSkuName]`,
                type: 'string',
            },
        ]
    },
