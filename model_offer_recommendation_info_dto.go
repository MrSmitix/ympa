...
// GetRecommendedCofinancePrice returns the RecommendedCofinancePrice field value if set, zero value otherwise.
func (o *OfferRecommendationInfoDTO) GetRecommendedCofinancePrice() BasePriceDTO {
	if o == nil || IsNil(o.RecommendedCofinancePrice) {
		var ret BasePriceDTO
		return ret
	}
	return *o.RecommendedCofinancePrice
}

// GetRecommendedCofinancePriceOk returns a tuple with the RecommendedCofinancePrice field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *OfferRecommendationInfoDTO) GetRecommendedCofinancePriceOk() (*BasePriceDTO, bool) {
	if o == nil || IsNil(o.RecommendedCofinancePrice) {
		return nil, false
	}
	return o.RecommendedCofinancePrice, true
}
...
// SetRecommendedCofinancePrice gets a reference to the given BasePriceDTO and assigns it to the RecommendedCofinancePrice field.
func (o *OfferRecommendationInfoDTO) SetRecommendedCofinancePrice(v BasePriceDTO) {
	o.RecommendedCofinancePrice = &v
}
...
func (o OfferRecommendationInfoDTO) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.RecommendedCofinancePrice) {
		toSerialize["recommendedCofinancePrice"] = o.RecommendedCofinancePrice
	}
