...
from ympa_python_fastapi_server.apis.delivery_services_api_base import BaseDeliveryServicesApi
...
async def get_delivery_services(
    ...
    if not BaseDeliveryServicesApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDeliveryServicesApi.subclasses[0]().get_delivery_services()
