...
from ympa_python_fastapi_server.apis.fbs_api_base import BaseFbsApi
...
async def add_hidden_offers(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().add_hidden_offers(campaignId, add_hidden_offers_request)
...
async def add_offers_to_archive(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().add_offers_to_archive(businessId, add_offers_to_archive_request)
...
async def calculate_tariffs(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().calculate_tariffs(calculate_tariffs_request)
...
async def confirm_business_prices(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().confirm_business_prices(businessId, confirm_prices_request)
...
async def confirm_campaign_prices(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().confirm_campaign_prices(campaignId, confirm_prices_request)
...
async def confirm_shipment(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().confirm_shipment(campaignId, shipmentId, confirm_shipment_request)
...
async def create_chat(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().create_chat(businessId, create_chat_request)
...
async def delete_campaign_offers(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().delete_campaign_offers(campaignId, delete_campaign_offers_request)
...
async def delete_goods_feedback_comment(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().delete_goods_feedback_comment(businessId, delete_goods_feedback_comment_request)
...
async def delete_hidden_offers(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().delete_hidden_offers(campaignId, delete_hidden_offers_request)
...
async def delete_offers(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().delete_offers(businessId, delete_offers_request)
...
async def delete_offers_from_archive(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().delete_offers_from_archive(businessId, delete_offers_from_archive_request)
...
async def delete_promo_offers(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().delete_promo_offers(businessId, delete_promo_offers_request)
...
async def download_shipment_act(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().download_shipment_act(campaignId, shipmentId)
...
async def download_shipment_discrepancy_act(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().download_shipment_discrepancy_act(campaignId, shipmentId)
...
async def download_shipment_inbound_act(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().download_shipment_inbound_act(campaignId, shipmentId)
...
async def download_shipment_pallet_labels(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().download_shipment_pallet_labels(campaignId, shipmentId, format)
...
async def download_shipment_reception_transfer_act(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().download_shipment_reception_transfer_act(campaignId, warehouse_id)
...
async def download_shipment_transportation_waybill(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().download_shipment_transportation_waybill(campaignId, shipmentId)
...
async def generate_boost_consolidated_report(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().generate_boost_consolidated_report(generate_boost_consolidated_request, format)
...
async def generate_competitors_position_report(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().generate_competitors_position_report(generate_competitors_position_report_request, format)
...
async def generate_goods_feedback_report(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().generate_goods_feedback_report(generate_goods_feedback_request, format)
...
async def generate_goods_realization_report(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().generate_goods_realization_report(generate_goods_realization_report_request, format)
...
async def generate_mass_order_labels_report(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().generate_mass_order_labels_report(generate_mass_order_labels_request, format)
...
async def generate_order_label(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().generate_order_label(campaignId, orderId, shipmentId, boxId, format)
...
async def generate_order_labels(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().generate_order_labels(campaignId, orderId, format)
...
async def generate_prices_report(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().generate_prices_report(generate_prices_report_request, format)
...
async def generate_shelfs_statistics_report(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().generate_shelfs_statistics_report(generate_shelfs_statistics_request, format)
...
async def generate_shipment_list_document_report(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().generate_shipment_list_document_report(generate_shipment_list_document_report_request)
...
async def generate_shows_sales_report(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().generate_shows_sales_report(generate_shows_sales_report_request, format)
...
async def generate_stocks_on_warehouses_report(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().generate_stocks_on_warehouses_report(generate_stocks_on_warehouses_report_request, format)
...
async def generate_united_marketplace_services_report(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().generate_united_marketplace_services_report(generate_united_marketplace_services_report_request, format)
...
async def generate_united_netting_report(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().generate_united_netting_report(generate_united_netting_report_request, format)
...
async def generate_united_orders_report(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().generate_united_orders_report(generate_united_orders_request, format)
...
async def get_all_offers(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().get_all_offers(campaignId, feed_id, chunk)
...
async def get_bids_info_for_business(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().get_bids_info_for_business(businessId, page_token, limit, get_bids_info_request)
...
async def get_bids_recommendations(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().get_bids_recommendations(businessId, get_bids_recommendations_request)
...
async def get_business_quarantine_offers(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().get_business_quarantine_offers(businessId, get_quarantine_offers_request, page_token, limit)
...
async def get_business_settings(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().get_business_settings(businessId)
...
async def get_campaign(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().get_campaign(campaignId)
...
async def get_campaign_logins(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().get_campaign_logins(campaignId)
...
async def get_campaign_offers(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().get_campaign_offers(campaignId, get_campaign_offers_request, page_token, limit)
...
async def get_campaign_quarantine_offers(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().get_campaign_quarantine_offers(campaignId, get_quarantine_offers_request, page_token, limit)
...
async def get_campaign_region(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().get_campaign_region(campaignId)
...
async def get_campaign_settings(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().get_campaign_settings(campaignId)
...
async def get_campaigns(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().get_campaigns(page, page_size)
...
async def get_campaigns_by_login(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().get_campaigns_by_login(login, page, page_size)
...
async def get_categories_max_sale_quantum(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().get_categories_max_sale_quantum(get_categories_max_sale_quantum_request)
...
async def get_categories_tree(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().get_categories_tree(get_categories_request)
...
async def get_category_content_parameters(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().get_category_content_parameters(categoryId)
...
async def get_chat_history(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().get_chat_history(businessId, chat_id, get_chat_history_request, page_token, limit)
...
async def get_chats(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().get_chats(businessId, get_chats_request, page_token, limit)
...
async def get_delivery_services(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().get_delivery_services()
...
async def get_feed(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().get_feed(campaignId, feedId)
...
async def get_feed_index_logs(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().get_feed_index_logs(campaignId, feedId, limit, published_time_from, published_time_to, status)
...
async def get_feedback_and_comment_updates(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().get_feedback_and_comment_updates(campaignId, page_token, limit, from_date)
...
async def get_feeds(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().get_feeds(campaignId)
...
async def get_goods_feedback_comments(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().get_goods_feedback_comments(businessId, get_goods_feedback_comments_request, page_token, limit)
...
async def get_goods_feedbacks(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().get_goods_feedbacks(businessId, page_token, limit, get_goods_feedback_request)
...
async def get_goods_stats(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().get_goods_stats(campaignId, get_goods_stats_request)
...
async def get_hidden_offers(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().get_hidden_offers(campaignId, offer_id, page_token, limit, offset, page, page_size)
...
async def get_offer_cards_content_status(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().get_offer_cards_content_status(businessId, page_token, limit, get_offer_cards_content_status_request)
...
async def get_offer_mapping_entries(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().get_offer_mapping_entries(campaignId, offer_id, shop_sku, mapping_kind, status, availability, category_id, vendor, page_token, limit)
...
async def get_offer_mappings(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().get_offer_mappings(businessId, page_token, limit, get_offer_mappings_request)
...
async def get_offer_recommendations(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().get_offer_recommendations(businessId, get_offer_recommendations_request, page_token, limit)
...
async def get_offers(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().get_offers(campaignId, query, feed_id, shop_category_id, currency, matched, page, page_size)
...
async def get_order(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().get_order(campaignId, orderId)
...
async def get_order_business_buyer_info(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().get_order_business_buyer_info(campaignId, orderId)
...
async def get_order_business_documents_info(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().get_order_business_documents_info(campaignId, orderId)
...
async def get_order_labels_data(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().get_order_labels_data(campaignId, orderId)
...
async def get_orders_stats(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().get_orders_stats(campaignId, page_token, limit, get_orders_stats_request)
...
async def get_prices(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().get_prices(campaignId, page_token, limit, archived)
...
async def get_prices_by_offer_ids(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().get_prices_by_offer_ids(campaignId, page_token, limit, get_prices_by_offer_ids_request)
...
async def get_promo_offers(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().get_promo_offers(businessId, get_promo_offers_request, page_token, limit)
...
async def get_promos(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().get_promos(businessId, get_promos_request)
...
async def get_quality_rating_details(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().get_quality_rating_details(campaignId)
...
async def get_quality_ratings(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().get_quality_ratings(businessId, get_quality_rating_request)
...
async def get_report_info(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().get_report_info(reportId)
...
async def get_return(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().get_return(campaignId, orderId, returnId)
...
async def get_return_application(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().get_return_application(campaignId, orderId, returnId)
...
async def get_return_photo(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().get_return_photo(campaignId, orderId, returnId, itemId, imageHash)
...
async def get_returns(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().get_returns(campaignId, page_token, limit, order_ids, statuses, type, from_date, to_date, from_date2, to_date2)
...
async def get_shipment(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().get_shipment(campaignId, shipmentId, cancelled_orders)
...
async def get_shipment_orders_info(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().get_shipment_orders_info(campaignId, shipmentId)
...
async def get_stocks(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().get_stocks(campaignId, page_token, limit, get_warehouse_stocks_request)
...
async def get_suggested_offer_mapping_entries(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().get_suggested_offer_mapping_entries(campaignId, get_suggested_offer_mapping_entries_request)
...
async def get_suggested_offer_mappings(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().get_suggested_offer_mappings(businessId, get_suggested_offer_mappings_request)
...
async def get_suggested_prices(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().get_suggested_prices(campaignId, suggest_prices_request)
...
async def get_warehouses(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().get_warehouses(businessId)
...
async def provide_order_item_identifiers(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().provide_order_item_identifiers(campaignId, orderId, provide_order_item_identifiers_request)
...
async def put_bids_for_business(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().put_bids_for_business(businessId, put_sku_bids_request)
...
async def put_bids_for_campaign(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().put_bids_for_campaign(campaignId, put_sku_bids_request)
...
async def refresh_feed(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().refresh_feed(campaignId, feedId)
...
async def search_region_children(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().search_region_children(regionId, page, page_size)
...
async def search_regions_by_id(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().search_regions_by_id(regionId)
...
async def search_regions_by_name(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().search_regions_by_name(name, page_token, limit)
...
async def search_shipments(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().search_shipments(campaignId, search_shipments_request, page_token, limit)
...
async def send_file_to_chat(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().send_file_to_chat(businessId, chat_id, file)
...
async def send_message_to_chat(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().send_message_to_chat(businessId, chat_id, send_message_to_chat_request)
...
async def set_feed_params(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().set_feed_params(campaignId, feedId, set_feed_params_request)
...
async def set_order_box_layout(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().set_order_box_layout(campaignId, orderId, set_order_box_layout_request)
...
async def set_order_shipment_boxes(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().set_order_shipment_boxes(campaignId, orderId, shipmentId, set_order_shipment_boxes_request)
...
async def set_shipment_pallets_count(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().set_shipment_pallets_count(campaignId, shipmentId, set_shipment_pallets_count_request)
...
async def skip_goods_feedbacks_reaction(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().skip_goods_feedbacks_reaction(businessId, skip_goods_feedback_reaction_request)
...
async def transfer_orders_from_shipment(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().transfer_orders_from_shipment(campaignId, shipmentId, transfer_orders_from_shipment_request)
...
async def update_business_prices(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().update_business_prices(businessId, update_business_prices_request)
...
async def update_campaign_offers(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().update_campaign_offers(campaignId, update_campaign_offers_request)
...
async def update_goods_feedback_comment(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().update_goods_feedback_comment(businessId, update_goods_feedback_comment_request)
...
async def update_offer_content(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().update_offer_content(businessId, update_offer_content_request)
...
async def update_offer_mapping_entries(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().update_offer_mapping_entries(campaignId, update_offer_mapping_entry_request)
...
async def update_offer_mappings(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().update_offer_mappings(businessId, update_offer_mappings_request)
...
async def update_order_items(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().update_order_items(campaignId, orderId, update_order_item_request)
...
async def update_order_status(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().update_order_status(campaignId, orderId, update_order_status_request)
...
async def update_order_statuses(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().update_order_statuses(campaignId, update_order_statuses_request)
...
async def update_prices(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().update_prices(campaignId, update_prices_request)
...
async def update_promo_offers(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().update_promo_offers(businessId, update_promo_offers_request)
...
async def update_stocks(
    ...
    if not BaseFbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFbsApi.subclasses[0]().update_stocks(campaignId, update_stocks_request)
