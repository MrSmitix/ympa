...
from ympa_python_fastapi_server.apis.goods_stats_api_base import BaseGoodsStatsApi
...
async def get_goods_stats(
    ...
    if not BaseGoodsStatsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseGoodsStatsApi.subclasses[0]().get_goods_stats(campaignId, get_goods_stats_request)
