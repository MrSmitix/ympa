...
from ympa_python_fastapi_server.apis.hidden_offers_api_base import BaseHiddenOffersApi
...
async def add_hidden_offers(
    ...
    if not BaseHiddenOffersApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseHiddenOffersApi.subclasses[0]().add_hidden_offers(campaignId, add_hidden_offers_request)
...
async def delete_hidden_offers(
    ...
    if not BaseHiddenOffersApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseHiddenOffersApi.subclasses[0]().delete_hidden_offers(campaignId, delete_hidden_offers_request)
...
async def get_hidden_offers(
    ...
    if not BaseHiddenOffersApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseHiddenOffersApi.subclasses[0]().get_hidden_offers(campaignId, offer_id, page_token, limit, offset, page, page_size)
