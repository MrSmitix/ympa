...
from ympa_python_fastapi_server.apis.dbs_api_base import BaseDbsApi
...
@router.put(
    ...
    responses={
        200: {"model": EmptyApiResponse, "description": "Ответ на отмену заказа был успешно передан."},
...
async def accept_order_cancellation(
    ...
    accept_order_cancellation_request: AcceptOrderCancellationRequest = Body(None, description=""),
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().accept_order_cancellation(campaignId, orderId, accept_order_cancellation_request)
...
async def add_hidden_offers(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().add_hidden_offers(campaignId, add_hidden_offers_request)
...
async def add_offers_to_archive(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().add_offers_to_archive(businessId, add_offers_to_archive_request)
...
async def calculate_tariffs(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().calculate_tariffs(calculate_tariffs_request)
...
async def confirm_business_prices(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().confirm_business_prices(businessId, confirm_prices_request)
...
async def confirm_campaign_prices(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().confirm_campaign_prices(campaignId, confirm_prices_request)
...
async def create_chat(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().create_chat(businessId, create_chat_request)
...
async def create_outlet(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().create_outlet(campaignId, change_outlet_request)
...
async def delete_campaign_offers(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().delete_campaign_offers(campaignId, delete_campaign_offers_request)
...
async def delete_goods_feedback_comment(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().delete_goods_feedback_comment(businessId, delete_goods_feedback_comment_request)
...
async def delete_hidden_offers(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().delete_hidden_offers(campaignId, delete_hidden_offers_request)
...
async def delete_offers(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().delete_offers(businessId, delete_offers_request)
...
async def delete_offers_from_archive(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().delete_offers_from_archive(businessId, delete_offers_from_archive_request)
...
async def delete_outlet(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().delete_outlet(campaignId, outletId)
...
async def delete_outlet_licenses(
    campaignId: int = Path(..., description="Идентификатор кампании в API и магазина в кабинете. Каждая кампания в API соответствует магазину в кабинете.  Чтобы узнать идентификаторы своих магазинов, воспользуйтесь запросом [GET campaigns](../../reference/campaigns/getCampaigns.md).  ℹ️ [Что такое кабинет и магазин на Маркете](https://yandex.ru/support/marketplace/account/introduction.html) "),
    ids: list[int] = Query(None, description="Список идентификаторов лицензий.", alias="ids"),
    token_OAuth: TokenModel = Security(
        get_token_OAuth, scopes=["market:partner-api"]
    ),
) -> EmptyApiResponse:
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().delete_outlet_licenses(campaignId, ids)
...
async def delete_promo_offers(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().delete_promo_offers(businessId, delete_promo_offers_request)
...
async def generate_boost_consolidated_report(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().generate_boost_consolidated_report(generate_boost_consolidated_request, format)
...
async def generate_competitors_position_report(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().generate_competitors_position_report(generate_competitors_position_report_request, format)
...
async def generate_goods_feedback_report(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().generate_goods_feedback_report(generate_goods_feedback_request, format)
...
async def generate_mass_order_labels_report(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().generate_mass_order_labels_report(generate_mass_order_labels_request, format)
...
async def generate_order_label(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().generate_order_label(campaignId, orderId, shipmentId, boxId, format)
...
async def generate_order_labels(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().generate_order_labels(campaignId, orderId, format)
...
async def generate_prices_report(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().generate_prices_report(generate_prices_report_request, format)
...
async def generate_shelfs_statistics_report(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().generate_shelfs_statistics_report(generate_shelfs_statistics_request, format)
...
async def generate_shows_sales_report(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().generate_shows_sales_report(generate_shows_sales_report_request, format)
...
async def generate_stocks_on_warehouses_report(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().generate_stocks_on_warehouses_report(generate_stocks_on_warehouses_report_request, format)
...
async def generate_united_marketplace_services_report(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().generate_united_marketplace_services_report(generate_united_marketplace_services_report_request, format)
...
async def generate_united_netting_report(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().generate_united_netting_report(generate_united_netting_report_request, format)
...
async def generate_united_orders_report(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().generate_united_orders_report(generate_united_orders_request, format)
...
async def get_all_offers(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().get_all_offers(campaignId, feed_id, chunk)
...
async def get_bids_info_for_business(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().get_bids_info_for_business(businessId, page_token, limit, get_bids_info_request)
...
async def get_bids_recommendations(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().get_bids_recommendations(businessId, get_bids_recommendations_request)
...
async def get_business_quarantine_offers(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().get_business_quarantine_offers(businessId, get_quarantine_offers_request, page_token, limit)
...
async def get_business_settings(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().get_business_settings(businessId)
...
async def get_campaign(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().get_campaign(campaignId)
...
async def get_campaign_logins(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().get_campaign_logins(campaignId)
...
async def get_campaign_offers(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().get_campaign_offers(campaignId, get_campaign_offers_request, page_token, limit)
...
async def get_campaign_quarantine_offers(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().get_campaign_quarantine_offers(campaignId, get_quarantine_offers_request, page_token, limit)
...
async def get_campaign_region(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().get_campaign_region(campaignId)
...
async def get_campaign_settings(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().get_campaign_settings(campaignId)
...
async def get_campaigns(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().get_campaigns(page, page_size)
...
async def get_campaigns_by_login(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().get_campaigns_by_login(login, page, page_size)
...
async def get_categories_max_sale_quantum(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().get_categories_max_sale_quantum(get_categories_max_sale_quantum_request)
...
async def get_categories_tree(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().get_categories_tree(get_categories_request)
...
async def get_category_content_parameters(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().get_category_content_parameters(categoryId)
...
async def get_chat_history(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().get_chat_history(businessId, chat_id, get_chat_history_request, page_token, limit)
...
async def get_chats(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().get_chats(businessId, get_chats_request, page_token, limit)


@router.get(
    "/delivery/services",
    responses={
        200: {"model": GetDeliveryServicesResponse, "description": "Информация о службах доставки."},
        400: {"model": ApiClientDataErrorResponse, "description": "Запрос содержит неправильные данные."},
        401: {"model": ApiUnauthorizedErrorResponse, "description": "В запросе не указаны данные для авторизации."},
        403: {"model": ApiForbiddenErrorResponse, "description": "Данные для авторизации неверны или доступ к ресурсу запрещен."},
        404: {"model": ApiNotFoundErrorResponse, "description": "Запрашиваемый ресурс не найден."},
...
async def get_delivery_services(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().get_delivery_services()
...
async def get_feed(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().get_feed(campaignId, feedId)
...
async def get_feed_index_logs(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().get_feed_index_logs(campaignId, feedId, limit, published_time_from, published_time_to, status)
...
async def get_feedback_and_comment_updates(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().get_feedback_and_comment_updates(campaignId, page_token, limit, from_date)
...
async def get_feeds(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().get_feeds(campaignId)
...
async def get_goods_feedback_comments(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().get_goods_feedback_comments(businessId, get_goods_feedback_comments_request, page_token, limit)
...
async def get_goods_feedbacks(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().get_goods_feedbacks(businessId, page_token, limit, get_goods_feedback_request)
...
async def get_goods_stats(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().get_goods_stats(campaignId, get_goods_stats_request)
...
async def get_hidden_offers(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().get_hidden_offers(campaignId, offer_id, page_token, limit, offset, page, page_size)
...
async def get_model(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().get_model(modelId, region_id, currency)
...
async def get_model_offers(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().get_model_offers(modelId, region_id, currency, order_by_price, count, page)
...
async def get_models(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().get_models(region_id, get_models_request, currency)
...
async def get_models_offers(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().get_models_offers(region_id, get_models_request, currency, order_by_price)
...
async def get_offer_cards_content_status(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().get_offer_cards_content_status(businessId, page_token, limit, get_offer_cards_content_status_request)
...
async def get_offer_mapping_entries(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().get_offer_mapping_entries(campaignId, offer_id, shop_sku, mapping_kind, status, availability, category_id, vendor, page_token, limit)
...
async def get_offer_mappings(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().get_offer_mappings(businessId, page_token, limit, get_offer_mappings_request)
...
async def get_offer_recommendations(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().get_offer_recommendations(businessId, get_offer_recommendations_request, page_token, limit)
...
async def get_offers(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().get_offers(campaignId, query, feed_id, shop_category_id, currency, matched, page, page_size)
...
async def get_order(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().get_order(campaignId, orderId)
...
async def get_order_business_buyer_info(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().get_order_business_buyer_info(campaignId, orderId)
...
async def get_order_business_documents_info(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().get_order_business_documents_info(campaignId, orderId)
...
async def get_order_buyer_info(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().get_order_buyer_info(campaignId, orderId)
...
async def get_order_labels_data(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().get_order_labels_data(campaignId, orderId)
...
async def get_orders_stats(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().get_orders_stats(campaignId, page_token, limit, get_orders_stats_request)
...
async def get_outlet(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().get_outlet(campaignId, outletId)


@router.get(
    "/campaigns/{campaignId}/outlets/licenses",
    responses={
        200: {"model": GetOutletLicensesResponse, "description": "Найденные лицензии собственных точек продаж."},
        400: {"model": ApiClientDataErrorResponse, "description": "Запрос содержит неправильные данные."},
        401: {"model": ApiUnauthorizedErrorResponse, "description": "В запросе не указаны данные для авторизации."},
        403: {"model": ApiForbiddenErrorResponse, "description": "Данные для авторизации неверны или доступ к ресурсу запрещен."},
        404: {"model": ApiNotFoundErrorResponse, "description": "Запрашиваемый ресурс не найден."},
...
async def get_outlet_licenses(
    campaignId: int = Path(..., description="Идентификатор кампании в API и магазина в кабинете. Каждая кампания в API соответствует магазину в кабинете.  Чтобы узнать идентификаторы своих магазинов, воспользуйтесь запросом [GET campaigns](../../reference/campaigns/getCampaigns.md).  ℹ️ [Что такое кабинет и магазин на Маркете](https://yandex.ru/support/marketplace/account/introduction.html) "),
    outlet_ids: list[int] = Query(None, description="Список идентификаторов точек продаж, для которых нужно получить информацию о лицензиях. Идентификаторы указываются через запятую.  В запросе должен быть либо параметр &#x60;outletIds&#x60;, либо параметр &#x60;ids&#x60;. Запрос с обоими параметрами или без них приведет к ошибке. ", alias="outletIds"),
    ids: list[int] = Query(None, description="Список идентификаторов лицензий.", alias="ids"),
    token_OAuth: TokenModel = Security(
        get_token_OAuth, scopes=["market:partner-api"]
    ),
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().get_outlet_licenses(campaignId, outlet_ids, ids)
...
async def get_outlets(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().get_outlets(campaignId, page_token, region_id, shop_outlet_code, region_id2)
...
async def get_prices(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().get_prices(campaignId, page_token, limit, archived)
...
async def get_prices_by_offer_ids(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().get_prices_by_offer_ids(campaignId, page_token, limit, get_prices_by_offer_ids_request)
...
async def get_promo_offers(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().get_promo_offers(businessId, get_promo_offers_request, page_token, limit)
...
async def get_promos(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().get_promos(businessId, get_promos_request)
...
async def get_quality_rating_details(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().get_quality_rating_details(campaignId)
...
async def get_quality_ratings(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().get_quality_ratings(businessId, get_quality_rating_request)
...
async def get_report_info(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().get_report_info(reportId)
...
async def get_return(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().get_return(campaignId, orderId, returnId)
...
async def get_return_application(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().get_return_application(campaignId, orderId, returnId)
...
async def get_return_photo(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().get_return_photo(campaignId, orderId, returnId, itemId, imageHash)
...
async def get_returns(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().get_returns(campaignId, page_token, limit, order_ids, statuses, type, from_date, to_date, from_date2, to_date2)
...
async def get_stocks(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().get_stocks(campaignId, page_token, limit, get_warehouse_stocks_request)
...
async def get_suggested_offer_mapping_entries(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().get_suggested_offer_mapping_entries(campaignId, get_suggested_offer_mapping_entries_request)
...
async def get_suggested_offer_mappings(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().get_suggested_offer_mappings(businessId, get_suggested_offer_mappings_request)
...
async def get_suggested_prices(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().get_suggested_prices(campaignId, suggest_prices_request)
...
async def get_warehouses(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().get_warehouses(businessId)
...
async def provide_order_digital_codes(
    campaignId: int = Path(..., description="Идентификатор кампании в API и магазина в кабинете. Каждая кампания в API соответствует магазину в кабинете.  Чтобы узнать идентификаторы своих магазинов, воспользуйтесь запросом [GET campaigns](../../reference/campaigns/getCampaigns.md).  ℹ️ [Что такое кабинет и магазин на Маркете](https://yandex.ru/support/marketplace/account/introduction.html) "),
    orderId: int = Path(..., description="Идентификатор заказа."),
    provide_order_digital_codes_request: ProvideOrderDigitalCodesRequest = Body(None, description=""),
    token_OAuth: TokenModel = Security(
        get_token_OAuth, scopes=["market:partner-api"]
    ),
) -> EmptyApiResponse:
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().provide_order_digital_codes(campaignId, orderId, provide_order_digital_codes_request)


@router.put(
    "/campaigns/{campaignId}/orders/{orderId}/identifiers",
    responses={
        200: {"model": ProvideOrderItemIdentifiersResponse, "description": "Ответ 200 обозначает, что коды успешно записались. Ответ содержит краткие сведения о промаркированных товарах."},
        400: {"model": ApiClientDataErrorResponse, "description": "Запрос содержит неправильные данные."},
        401: {"model": ApiUnauthorizedErrorResponse, "description": "В запросе не указаны данные для авторизации."},
        403: {"model": ApiForbiddenErrorResponse, "description": "Данные для авторизации неверны или доступ к ресурсу запрещен."},
        404: {"model": ApiNotFoundErrorResponse, "description": "Запрашиваемый ресурс не найден."},
...
async def provide_order_item_identifiers(
    campaignId: int = Path(..., description="Идентификатор кампании в API и магазина в кабинете. Каждая кампания в API соответствует магазину в кабинете.  Чтобы узнать идентификаторы своих магазинов, воспользуйтесь запросом [GET campaigns](../../reference/campaigns/getCampaigns.md).  ℹ️ [Что такое кабинет и магазин на Маркете](https://yandex.ru/support/marketplace/account/introduction.html) "),
    orderId: int = Path(..., description="Идентификатор заказа."),
    provide_order_item_identifiers_request: ProvideOrderItemIdentifiersRequest = Body(None, description=""),
    token_OAuth: TokenModel = Security(
        get_token_OAuth, scopes=["market:partner-api"]
    ),
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().provide_order_item_identifiers(campaignId, orderId, provide_order_item_identifiers_request)
...
async def put_bids_for_business(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().put_bids_for_business(businessId, put_sku_bids_request)
...
async def put_bids_for_campaign(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().put_bids_for_campaign(campaignId, put_sku_bids_request)
...
async def refresh_feed(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().refresh_feed(campaignId, feedId)
...
async def search_models(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().search_models(query, region_id, currency, page, page_size)
...
async def search_region_children(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().search_region_children(regionId, page, page_size)
...
async def search_regions_by_id(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().search_regions_by_id(regionId)
...
async def search_regions_by_name(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().search_regions_by_name(name, page_token, limit)
...
async def send_file_to_chat(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().send_file_to_chat(businessId, chat_id, file)
...
async def send_message_to_chat(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().send_message_to_chat(businessId, chat_id, send_message_to_chat_request)
...
async def set_feed_params(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().set_feed_params(campaignId, feedId, set_feed_params_request)


@router.put(
    "/campaigns/{campaignId}/orders/{orderId}/boxes",
    responses={
        200: {"model": SetOrderBoxLayoutResponse, "description": "В ответ придет переданная раскладка с идентификаторами коробок — они понадобятся для запроса ярлыков. "},
        400: {"model": ApiClientDataErrorResponse, "description": "Запрос содержит неправильные данные."},
        401: {"model": ApiUnauthorizedErrorResponse, "description": "В запросе не указаны данные для авторизации."},
        403: {"model": ApiForbiddenErrorResponse, "description": "Данные для авторизации неверны или доступ к ресурсу запрещен."},
        404: {"model": ApiNotFoundErrorResponse, "description": "Запрашиваемый ресурс не найден."},
...
async def set_order_box_layout(
    campaignId: int = Path(..., description="Идентификатор кампании в API и магазина в кабинете. Каждая кампания в API соответствует магазину в кабинете.  Чтобы узнать идентификаторы своих магазинов, воспользуйтесь запросом [GET campaigns](../../reference/campaigns/getCampaigns.md).  ℹ️ [Что такое кабинет и магазин на Маркете](https://yandex.ru/support/marketplace/account/introduction.html) "),
    orderId: int = Path(..., description="Идентификатор заказа."),
    set_order_box_layout_request: SetOrderBoxLayoutRequest = Body(None, description=""),
    token_OAuth: TokenModel = Security(
        get_token_OAuth, scopes=["market:partner-api"]
    ),
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().set_order_box_layout(campaignId, orderId, set_order_box_layout_request)
...
async def set_order_delivery_date(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().set_order_delivery_date(campaignId, orderId, set_order_delivery_date_request)
...
async def set_order_delivery_track_code(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().set_order_delivery_track_code(campaignId, orderId, set_order_delivery_track_code_request)


@router.put(
    "/campaigns/{campaignId}/orders/{orderId}/delivery/shipments/{shipmentId}/boxes",
    responses={
        200: {"model": SetOrderShipmentBoxesResponse, "description": "Имеет значение только тип ответа. Если ответ &#x60;ОК&#x60;, количество грузомест записано."},
        400: {"model": ApiClientDataErrorResponse, "description": "Запрос содержит неправильные данные."},
        401: {"model": ApiUnauthorizedErrorResponse, "description": "В запросе не указаны данные для авторизации."},
        403: {"model": ApiForbiddenErrorResponse, "description": "Данные для авторизации неверны или доступ к ресурсу запрещен."},
        404: {"model": ApiNotFoundErrorResponse, "description": "Запрашиваемый ресурс не найден."},
...
async def set_order_shipment_boxes(
    campaignId: int = Path(..., description="Идентификатор кампании в API и магазина в кабинете. Каждая кампания в API соответствует магазину в кабинете.  Чтобы узнать идентификаторы своих магазинов, воспользуйтесь запросом [GET campaigns](../../reference/campaigns/getCampaigns.md).  ℹ️ [Что такое кабинет и магазин на Маркете](https://yandex.ru/support/marketplace/account/introduction.html) "),
    orderId: int = Path(..., description="Идентификатор заказа."),
    shipmentId: int = Path(..., description="Параметр больше не используется. Вставьте любое число — просто чтобы получился корректный URL. "),
    set_order_shipment_boxes_request: SetOrderShipmentBoxesRequest = Body(None, description=""),
    token_OAuth: TokenModel = Security(
        get_token_OAuth, scopes=["market:partner-api"]
    ),
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().set_order_shipment_boxes(campaignId, orderId, shipmentId, set_order_shipment_boxes_request)
...
async def set_return_decision(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().set_return_decision(campaignId, orderId, returnId, set_return_decision_request)
...
async def skip_goods_feedbacks_reaction(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().skip_goods_feedbacks_reaction(businessId, skip_goods_feedback_reaction_request)
...
async def submit_return_decision(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().submit_return_decision(campaignId, orderId, returnId)
...
async def update_business_prices(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().update_business_prices(businessId, update_business_prices_request)
...
async def update_campaign_offers(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().update_campaign_offers(campaignId, update_campaign_offers_request)
...
async def update_goods_feedback_comment(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().update_goods_feedback_comment(businessId, update_goods_feedback_comment_request)
...
async def update_offer_content(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().update_offer_content(businessId, update_offer_content_request)
...
async def update_offer_mapping_entries(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().update_offer_mapping_entries(campaignId, update_offer_mapping_entry_request)
...
async def update_offer_mappings(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().update_offer_mappings(businessId, update_offer_mappings_request)


@router.put(
    "/campaigns/{campaignId}/orders/{orderId}/items",
    responses={
        200: {"description": "Маркет успешно обработал ваш запрос. Выходные данные не ожидаются."},
        400: {"model": ApiClientDataErrorResponse, "description": "Запрос содержит неправильные данные."},
        401: {"model": ApiUnauthorizedErrorResponse, "description": "В запросе не указаны данные для авторизации."},
        403: {"model": ApiForbiddenErrorResponse, "description": "Данные для авторизации неверны или доступ к ресурсу запрещен."},
        404: {"model": ApiNotFoundErrorResponse, "description": "Запрашиваемый ресурс не найден."},
...
async def update_order_items(
    campaignId: int = Path(..., description="Идентификатор кампании в API и магазина в кабинете. Каждая кампания в API соответствует магазину в кабинете.  Чтобы узнать идентификаторы своих магазинов, воспользуйтесь запросом [GET campaigns](../../reference/campaigns/getCampaigns.md).  ℹ️ [Что такое кабинет и магазин на Маркете](https://yandex.ru/support/marketplace/account/introduction.html) "),
    orderId: int = Path(..., description="Идентификатор заказа."),
    update_order_item_request: UpdateOrderItemRequest = Body(None, description=""),
    token_OAuth: TokenModel = Security(
        get_token_OAuth, scopes=["market:partner-api"]
    ),
) -> None:
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().update_order_items(campaignId, orderId, update_order_item_request)


@router.put(
    "/campaigns/{campaignId}/orders/{orderId}/status",
    responses={
        200: {"model": UpdateOrderStatusResponse, "description": "В случае успешного изменения статуса заказа возвращается обновленная информация о заказе."},
        400: {"model": ApiClientDataErrorResponse, "description": "Запрос содержит неправильные данные."},
        401: {"model": ApiUnauthorizedErrorResponse, "description": "В запросе не указаны данные для авторизации."},
        403: {"model": ApiForbiddenErrorResponse, "description": "Данные для авторизации неверны или доступ к ресурсу запрещен."},
        404: {"model": ApiNotFoundErrorResponse, "description": "Запрашиваемый ресурс не найден."},
...
async def update_order_status(
    campaignId: int = Path(..., description="Идентификатор кампании в API и магазина в кабинете. Каждая кампания в API соответствует магазину в кабинете.  Чтобы узнать идентификаторы своих магазинов, воспользуйтесь запросом [GET campaigns](../../reference/campaigns/getCampaigns.md).  ℹ️ [Что такое кабинет и магазин на Маркете](https://yandex.ru/support/marketplace/account/introduction.html) "),
    orderId: int = Path(..., description="Идентификатор заказа."),
    update_order_status_request: UpdateOrderStatusRequest = Body(None, description=""),
    token_OAuth: TokenModel = Security(
        get_token_OAuth, scopes=["market:partner-api"]
    ),
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().update_order_status(campaignId, orderId, update_order_status_request)


@router.post(
    "/campaigns/{campaignId}/orders/status-update",
    responses={
        200: {"model": UpdateOrderStatusesResponse, "description": "Возвращается информация об обновленных статусах заказов."},
        400: {"model": ApiClientDataErrorResponse, "description": "Запрос содержит неправильные данные."},
        401: {"model": ApiUnauthorizedErrorResponse, "description": "В запросе не указаны данные для авторизации."},
        403: {"model": ApiForbiddenErrorResponse, "description": "Данные для авторизации неверны или доступ к ресурсу запрещен."},
        404: {"model": ApiNotFoundErrorResponse, "description": "Запрашиваемый ресурс не найден."},
...
async def update_order_statuses(
    campaignId: int = Path(..., description="Идентификатор кампании в API и магазина в кабинете. Каждая кампания в API соответствует магазину в кабинете.  Чтобы узнать идентификаторы своих магазинов, воспользуйтесь запросом [GET campaigns](../../reference/campaigns/getCampaigns.md).  ℹ️ [Что такое кабинет и магазин на Маркете](https://yandex.ru/support/marketplace/account/introduction.html) "),
    update_order_statuses_request: UpdateOrderStatusesRequest = Body(None, description=""),
    token_OAuth: TokenModel = Security(
        get_token_OAuth, scopes=["market:partner-api"]
    ),
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().update_order_statuses(campaignId, update_order_statuses_request)
...
async def update_order_storage_limit(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().update_order_storage_limit(campaignId, orderId, update_order_storage_limit_request)
...
async def update_outlet(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().update_outlet(campaignId, outletId, change_outlet_request)
...
async def update_outlet_licenses(
    campaignId: int = Path(..., description="Идентификатор кампании в API и магазина в кабинете. Каждая кампания в API соответствует магазину в кабинете.  Чтобы узнать идентификаторы своих магазинов, воспользуйтесь запросом [GET campaigns](../../reference/campaigns/getCampaigns.md).  ℹ️ [Что такое кабинет и магазин на Маркете](https://yandex.ru/support/marketplace/account/introduction.html) "),
    update_outlet_license_request: UpdateOutletLicenseRequest = Body(None, description=""),
    token_OAuth: TokenModel = Security(
        get_token_OAuth, scopes=["market:partner-api"]
    ),
) -> EmptyApiResponse:
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().update_outlet_licenses(campaignId, update_outlet_license_request)
...
async def update_prices(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().update_prices(campaignId, update_prices_request)
...
async def update_promo_offers(
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().update_promo_offers(businessId, update_promo_offers_request)
...
async def update_stocks(
    campaignId: int = Path(..., description="Идентификатор кампании в API и магазина в кабинете. Каждая кампания в API соответствует магазину в кабинете.  Чтобы узнать идентификаторы своих магазинов, воспользуйтесь запросом [GET campaigns](../../reference/campaigns/getCampaigns.md).  ℹ️ [Что такое кабинет и магазин на Маркете](https://yandex.ru/support/marketplace/account/introduction.html) "),
    update_stocks_request: UpdateStocksRequest = Body(None, description=""),
    token_OAuth: TokenModel = Security(
        get_token_OAuth, scopes=["market:partner-api"]
    ),
) -> EmptyApiResponse:
    ...
    if not BaseDbsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDbsApi.subclasses[0]().update_stocks(campaignId, update_stocks_request)
