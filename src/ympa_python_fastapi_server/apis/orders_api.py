...
from ympa_python_fastapi_server.apis.orders_api_base import BaseOrdersApi
...
async def accept_order_cancellation(
    ...
    return await BaseOrdersApi.subclasses[0]().accept_order_cancellation(campaignId, orderId, accept_order_cancellation_request)
...
async def get_order(
    ...
    if not BaseOrdersApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseOrdersApi.subclasses[0]().get_order(campaignId, orderId)
...
async def provide_order_digital_codes(
    ...
    if not BaseOrdersApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseOrdersApi.subclasses[0]().provide_order_digital_codes(campaignId, orderId, provide_order_digital_codes_request)
...
async def provide_order_item_identifiers(
    ...
    if not BaseOrdersApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseOrdersApi.subclasses[0]().provide_order_item_identifiers(campaignId, orderId, provide_order_item_identifiers_request)
...
async def set_order_box_layout(
    ...
    if not BaseOrdersApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseOrdersApi.subclasses[0]().set_order_box_layout(campaignId, orderId, set_order_box_layout_request)
...
async def set_order_shipment_boxes(
    ...
    if not BaseOrdersApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseOrdersApi.subclasses[0]().set_order_shipment_boxes(campaignId, orderId, shipmentId, set_order_shipment_boxes_request)
...
async def update_order_items(
    ...
    if not BaseOrdersApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseOrdersApi.subclasses[0]().update_order_items(campaignId, orderId, update_order_item_request)
...
async def update_order_status(
    ...
    if not BaseOrdersApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseOrdersApi.subclasses[0]().update_order_status(campaignId, orderId, update_order_status_request)
...
async def update_order_statuses(
    ...
    if not BaseOrdersApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseOrdersApi.subclasses[0]().update_order_statuses(campaignId, update_order_statuses_request)
