...
from ympa_python_fastapi_server.apis.prices_api_base import BasePricesApi
...
async def get_prices(
    ...
    if not BasePricesApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BasePricesApi.subclasses[0]().get_prices(campaignId, page_token, limit, archived)
...
async def get_prices_by_offer_ids(
    ...
    if not BasePricesApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BasePricesApi.subclasses[0]().get_prices_by_offer_ids(campaignId, page_token, limit, get_prices_by_offer_ids_request)
...
async def get_suggested_prices(
    ...
    if not BasePricesApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BasePricesApi.subclasses[0]().get_suggested_prices(campaignId, suggest_prices_request)
...
async def update_business_prices(
    ...
    if not BasePricesApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BasePricesApi.subclasses[0]().update_business_prices(businessId, update_business_prices_request)
...
async def update_prices(
    ...
    if not BasePricesApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BasePricesApi.subclasses[0]().update_prices(campaignId, update_prices_request)
