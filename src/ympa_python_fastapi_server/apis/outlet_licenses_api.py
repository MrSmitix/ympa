...
from ympa_python_fastapi_server.apis.outlet_licenses_api_base import BaseOutletLicensesApi
...
async def delete_outlet_licenses(
    ...
    if not BaseOutletLicensesApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseOutletLicensesApi.subclasses[0]().delete_outlet_licenses(campaignId, ids)
...
async def get_outlet_licenses(
    ...
    if not BaseOutletLicensesApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseOutletLicensesApi.subclasses[0]().get_outlet_licenses(campaignId, outlet_ids, ids)
...
async def update_outlet_licenses(
    ...
    if not BaseOutletLicensesApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseOutletLicensesApi.subclasses[0]().update_outlet_licenses(campaignId, update_outlet_license_request)
