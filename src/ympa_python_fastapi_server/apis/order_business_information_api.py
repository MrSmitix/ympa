...
from ympa_python_fastapi_server.apis.order_business_information_api_base import BaseOrderBusinessInformationApi
...
async def get_order_business_buyer_info(
    ...
    if not BaseOrderBusinessInformationApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseOrderBusinessInformationApi.subclasses[0]().get_order_business_buyer_info(campaignId, orderId)
...
async def get_order_business_documents_info(
    ...
    if not BaseOrderBusinessInformationApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseOrderBusinessInformationApi.subclasses[0]().get_order_business_documents_info(campaignId, orderId)
