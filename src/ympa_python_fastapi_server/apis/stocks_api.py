...
from ympa_python_fastapi_server.apis.stocks_api_base import BaseStocksApi
...
async def get_stocks(
    ...
    if not BaseStocksApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseStocksApi.subclasses[0]().get_stocks(campaignId, page_token, limit, get_warehouse_stocks_request)
...
async def update_stocks(
    ...
    if not BaseStocksApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseStocksApi.subclasses[0]().update_stocks(campaignId, update_stocks_request)
