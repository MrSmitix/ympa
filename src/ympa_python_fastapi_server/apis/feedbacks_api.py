...
from ympa_python_fastapi_server.apis.feedbacks_api_base import BaseFeedbacksApi
...
async def get_feedback_and_comment_updates(
    ...
    if not BaseFeedbacksApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFeedbacksApi.subclasses[0]().get_feedback_and_comment_updates(campaignId, page_token, limit, from_date)
