...
from ympa_python_fastapi_server.models.suggested_offer_dto import SuggestedOfferDTO
try:
...
class GetSuggestedOfferMappingsRequest(BaseModel):
    ...
    """ # noqa: E501
    offers: Optional[Annotated[List[SuggestedOfferDTO], Field(min_length=1, max_length=500)]] = Field(default=None, description="Список товаров.")
