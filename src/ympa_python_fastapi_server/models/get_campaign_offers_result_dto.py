...
from ympa_python_fastapi_server.models.get_campaign_offer_dto import GetCampaignOfferDTO
...
class GetCampaignOffersResultDTO(BaseModel):
    ...
    offers: List[GetCampaignOfferDTO] = Field(description="Страница списка товаров.")
