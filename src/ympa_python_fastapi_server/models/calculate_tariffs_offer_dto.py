...
class CalculateTariffsOfferDTO(BaseModel):
    ...
    price: Union[Annotated[float, Field(strict=True, gt=0)], Annotated[int, Field(strict=True, gt=0)]] = Field(description="Цена на товар в рублях.")
    ...
    quantity: Optional[Annotated[int, Field(strict=True, ge=1)]] = Field(default=1, description="Квант продажи — количество единиц товара в одном товарном предложении.")
    __properties: ClassVar[List[str]] = ["categoryId", "price", "length", "width", "height", "weight", "quantity"]
