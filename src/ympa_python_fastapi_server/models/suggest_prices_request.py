...
from ympa_python_fastapi_server.models.suggest_offer_price_dto import SuggestOfferPriceDTO
try:
...
class SuggestPricesRequest(BaseModel):
    ...
    """ # noqa: E501
    offers: Annotated[List[SuggestOfferPriceDTO], Field(max_length=1000)] = Field(description="Список товаров.")
