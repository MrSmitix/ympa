...
class BidRecommendationItemDTO(BaseModel):
    ...
    show_percent: Annotated[int, Field(le=100, strict=True, ge=0)] = Field(description="Доля показов. ", alias="showPercent")
    __properties: ClassVar[List[str]] = ["bid", "showPercent"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "bid": obj.get("bid"),
            "showPercent": obj.get("showPercent")
        })
        return _obj
