...
from ympa_python_fastapi_server.models.price_competitiveness_thresholds_dto import PriceCompetitivenessThresholdsDTO
try:
...
class OfferRecommendationInfoDTO(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["offerId", "recommendedCofinancePrice", "competitivenessThresholds"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "recommendedCofinancePrice": BasePriceDTO.from_dict(obj.get("recommendedCofinancePrice")) if obj.get("recommendedCofinancePrice") is not None else None,
            "competitivenessThresholds": PriceCompetitivenessThresholdsDTO.from_dict(obj.get("competitivenessThresholds")) if obj.get("competitivenessThresholds") is not None else None
        })
        return _obj
