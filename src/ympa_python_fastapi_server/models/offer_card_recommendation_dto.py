...
class OfferCardRecommendationDTO(BaseModel):
    ...
    percent: Optional[Annotated[int, Field(lt=100, strict=True, ge=0)]] = Field(default=None, description="Процент выполнения рекомендации. Указывается для рекомендаций некоторых типов.")
