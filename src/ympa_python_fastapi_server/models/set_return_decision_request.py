...
from ympa_python_fastapi_server.models.return_request_decision_type import ReturnRequestDecisionType
try:
...
class SetReturnDecisionRequest(BaseModel):
    ...
    """ # noqa: E501
    return_item_id: StrictInt = Field(description="Идентификатор товара в возврате.", alias="returnItemId")
    decision_type: ReturnRequestDecisionType = Field(alias="decisionType")
    ...
    __properties: ClassVar[List[str]] = ["returnItemId", "decisionType", "comment"]
