...
from ympa_python_fastapi_server.models.order_status_change_delivery_dto import OrderStatusChangeDeliveryDTO
...
class OrderStatusChangeDTO(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["status", "substatus", "delivery"]
