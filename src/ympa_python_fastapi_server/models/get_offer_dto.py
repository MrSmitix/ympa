...
from ympa_python_fastapi_server.models.age_dto import AgeDTO
from ympa_python_fastapi_server.models.get_price_dto import GetPriceDTO
from ympa_python_fastapi_server.models.get_price_with_discount_dto import GetPriceWithDiscountDTO
from ympa_python_fastapi_server.models.offer_campaign_status_dto import OfferCampaignStatusDTO
from ympa_python_fastapi_server.models.offer_card_status_type import OfferCardStatusType
from ympa_python_fastapi_server.models.offer_condition_dto import OfferConditionDTO
from ympa_python_fastapi_server.models.offer_manual_dto import OfferManualDTO
from ympa_python_fastapi_server.models.offer_param_dto import OfferParamDTO
from ympa_python_fastapi_server.models.offer_selling_program_dto import OfferSellingProgramDTO
from ympa_python_fastapi_server.models.offer_type import OfferType
from ympa_python_fastapi_server.models.offer_weight_dimensions_dto import OfferWeightDimensionsDTO
from ympa_python_fastapi_server.models.time_period_dto import TimePeriodDTO
try:
...
class GetOfferDTO(BaseModel):
    ...
    campaigns: Optional[List[OfferCampaignStatusDTO]] = Field(default=None, description="Список магазинов, в которых размещен товар. ")
    selling_programs: Optional[List[OfferSellingProgramDTO]] = Field(default=None, description="Информация о том, какие для товара доступны модели размещения. ", alias="sellingPrograms")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if self.selling_programs is None and "selling_programs" in self.model_fields_set:
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "purchasePrice": GetPriceDTO.from_dict(obj.get("purchasePrice")) if obj.get("purchasePrice") is not None else None,
            "additionalExpenses": GetPriceDTO.from_dict(obj.get("additionalExpenses")) if obj.get("additionalExpenses") is not None else None,
            "cofinancePrice": GetPriceDTO.from_dict(obj.get("cofinancePrice")) if obj.get("cofinancePrice") is not None else None,
            ...
            "sellingPrograms": [OfferSellingProgramDTO.from_dict(_item) for _item in obj.get("sellingPrograms")] if obj.get("sellingPrograms") is not None else None,
