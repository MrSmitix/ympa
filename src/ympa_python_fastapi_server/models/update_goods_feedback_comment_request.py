...
from ympa_python_fastapi_server.models.update_goods_feedback_comment_dto import UpdateGoodsFeedbackCommentDTO
try:
...
class UpdateGoodsFeedbackCommentRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["feedbackId", "comment"]
