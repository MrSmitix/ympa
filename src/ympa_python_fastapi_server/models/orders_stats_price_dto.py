...
from ympa_python_fastapi_server.models.orders_stats_price_type import OrdersStatsPriceType
try:
...
class OrdersStatsPriceDTO(BaseModel):
    ...
    cost_per_item: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Цена или скидка на единицу товара в заказе. Указана в рублях. Точность — два знака после запятой. ", alias="costPerItem")
    ...
    __properties: ClassVar[List[str]] = ["type", "costPerItem", "total"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "costPerItem": obj.get("costPerItem"),
            "total": obj.get("total")
        })
        return _obj
