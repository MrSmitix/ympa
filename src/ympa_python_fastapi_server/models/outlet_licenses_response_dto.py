...
from ympa_python_fastapi_server.models.full_outlet_license_dto import FullOutletLicenseDTO
try:
...
class OutletLicensesResponseDTO(BaseModel):
    ...
    """ # noqa: E501
    licenses: List[FullOutletLicenseDTO] = Field(description="Список лицензий.")
