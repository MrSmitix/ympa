...
from ympa_python_fastapi_server.models.offer_dto import OfferDTO
try:
...
class GetOffersResponse(BaseModel):
    ...
    """ # noqa: E501
    offers: List[OfferDTO] = Field(description="Список предложений магазина.")
    pager: Optional[FlippingPagerDTO] = None
    __properties: ClassVar[List[str]] = ["offers", "pager"]
