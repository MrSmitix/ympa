...
from ympa_python_fastapi_server.models.offer_mapping_dto import OfferMappingDTO
from ympa_python_fastapi_server.models.update_mappings_offer_dto import UpdateMappingsOfferDTO
try:
    from typing import Self
except ImportError:
    from typing_extensions import Self

class UpdateOfferMappingEntryDTO(BaseModel):
    """
    ...
    offer: Optional[UpdateMappingsOfferDTO] = None
    __properties: ClassVar[List[str]] = ["mapping", "awaitingModerationMapping", "rejectedMapping", "offer"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "awaitingModerationMapping": OfferMappingDTO.from_dict(obj.get("awaitingModerationMapping")) if obj.get("awaitingModerationMapping") is not None else None,
            "rejectedMapping": OfferMappingDTO.from_dict(obj.get("rejectedMapping")) if obj.get("rejectedMapping") is not None else None,
            "offer": UpdateMappingsOfferDTO.from_dict(obj.get("offer")) if obj.get("offer") is not None else None
        })
        return _obj
