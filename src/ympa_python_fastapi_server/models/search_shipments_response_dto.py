...
from ympa_python_fastapi_server.models.shipment_info_dto import ShipmentInfoDTO
try:
...
class SearchShipmentsResponseDTO(BaseModel):
    ...
    """ # noqa: E501
    shipments: List[ShipmentInfoDTO] = Field(description="Список с информацией об отгрузках.")
    paging: Optional[ForwardScrollingPagerDTO] = None
    __properties: ClassVar[List[str]] = ["shipments", "paging"]
