...
from ympa_python_fastapi_server.models.get_offer_mapping_dto import GetOfferMappingDTO
...
class GetOfferMappingsResultDTO(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "offerMappings": [GetOfferMappingDTO.from_dict(_item) for _item in obj.get("offerMappings")] if obj.get("offerMappings") is not None else None
        })
        return _obj
