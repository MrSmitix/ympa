...
from ympa_python_fastapi_server.models.model_dto import ModelDTO
try:
...
class SearchModelsResponse(BaseModel):
    ...
    """ # noqa: E501
    models: List[ModelDTO] = Field(description="Список моделей товаров.")
    ...
    __properties: ClassVar[List[str]] = ["models", "currency", "regionId", "pager"]
