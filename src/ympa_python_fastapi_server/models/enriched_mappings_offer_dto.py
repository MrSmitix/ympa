...
from ympa_python_fastapi_server.models.day_of_week_type import DayOfWeekType
from ympa_python_fastapi_server.models.offer_availability_status_type import OfferAvailabilityStatusType
from ympa_python_fastapi_server.models.offer_processing_state_dto import OfferProcessingStateDTO
...
class EnrichedMappingsOfferDTO(BaseModel):
    """
    ...
    shelf_life_days: Optional[StrictInt] = Field(default=None, description="{% note warning \"\" %}  Этот параметр устарел. Вместо него используйте `shelfLife`. Совместное использование обоих параметров приведет к ошибке.  {% endnote %}  Срок годности: через сколько дней товар станет непригоден для использования. ", alias="shelfLifeDays")
    ...
    price: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Цена на товар в рублях.")
    market_category_id: Optional[StrictInt] = Field(default=None, description="Идентификатор категории для рекомендованной карточки товара на Маркете.  Возвращается только вместе с параметром ##marketSku##. ", alias="marketCategoryId")
    market_category_name: Optional[StrictStr] = Field(default=None, description="Название категории для рекомендованной карточки товара на Маркете.  Может отсутствовать в ответе. ", alias="marketCategoryName")
    market_model_id: Optional[StrictInt] = Field(default=None, description="Идентификатор модели для рекомендованной карточки товара на Маркете.  Может отсутствовать в ответе. ", alias="marketModelId")
    market_model_name: Optional[StrictStr] = Field(default=None, description="Название модели для рекомендованной карточки товара на Маркете.  Возвращается только вместе с параметром ##marketSku##. ", alias="marketModelName")
    market_sku: Optional[StrictInt] = Field(default=None, description="SKU на Маркете.", alias="marketSku")
    market_sku_name: Optional[StrictStr] = Field(default=None, description="Название товара с рекомендованной карточки на Маркете.  Может отсутствовать в ответе. ", alias="marketSkuName")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if self.customs_commodity_codes is None and "customs_commodity_codes" in self.model_fields_set:
            _dict['customsCommodityCodes'] = None

        # set to None if supply_schedule_days (nullable) is None
        # and model_fields_set contains the field
        if self.supply_schedule_days is None and "supply_schedule_days" in self.model_fields_set:
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "marketCategoryName": obj.get("marketCategoryName"),
            "marketModelId": obj.get("marketModelId"),
            "marketModelName": obj.get("marketModelName"),
            "marketSku": obj.get("marketSku"),
            "marketSkuName": obj.get("marketSkuName")
        })
        return _obj
