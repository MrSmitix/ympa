...
from ympa_python_fastapi_server.models.promo_offer_update_warning_dto import PromoOfferUpdateWarningDTO
try:
...
class WarningPromoOfferUpdateDTO(BaseModel):
    ...
    warnings: List[PromoOfferUpdateWarningDTO] = Field(description="Предупреждения, которые появились при добавлении товара в акцию или изменении его цен.")
    __properties: ClassVar[List[str]] = ["offerId", "warnings"]
