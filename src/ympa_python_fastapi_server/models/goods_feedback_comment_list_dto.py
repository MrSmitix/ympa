...
from ympa_python_fastapi_server.models.goods_feedback_comment_dto import GoodsFeedbackCommentDTO
try:
...
class GoodsFeedbackCommentListDTO(BaseModel):
    ...
    """ # noqa: E501
    comments: List[GoodsFeedbackCommentDTO] = Field(description="Список комментариев.")
    paging: Optional[ForwardScrollingPagerDTO] = None
    __properties: ClassVar[List[str]] = ["comments", "paging"]
