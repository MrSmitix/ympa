...
from ympa_python_fastapi_server.models.base_price_dto import BasePriceDTO
...
from ympa_python_fastapi_server.models.update_price_with_discount_dto import UpdatePriceWithDiscountDTO
try:
...
class UpdateOfferDTO(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "basicPrice": UpdatePriceWithDiscountDTO.from_dict(obj.get("basicPrice")) if obj.get("basicPrice") is not None else None,
            "purchasePrice": BasePriceDTO.from_dict(obj.get("purchasePrice")) if obj.get("purchasePrice") is not None else None,
            "additionalExpenses": BasePriceDTO.from_dict(obj.get("additionalExpenses")) if obj.get("additionalExpenses") is not None else None,
            "cofinancePrice": BasePriceDTO.from_dict(obj.get("cofinancePrice")) if obj.get("cofinancePrice") is not None else None
        })
        return _obj
