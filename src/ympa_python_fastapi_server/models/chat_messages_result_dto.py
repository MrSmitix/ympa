...
from ympa_python_fastapi_server.models.chat_message_dto import ChatMessageDTO
...
class ChatMessagesResultDTO(BaseModel):
    ...
    messages: List[ChatMessageDTO] = Field(description="Информация о сообщениях.")
    paging: Optional[ForwardScrollingPagerDTO] = None
    __properties: ClassVar[List[str]] = ["orderId", "messages", "paging"]
