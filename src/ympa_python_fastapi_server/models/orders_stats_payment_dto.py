...
from ympa_python_fastapi_server.models.orders_stats_payment_order_dto import OrdersStatsPaymentOrderDTO
from ympa_python_fastapi_server.models.orders_stats_payment_source_type import OrdersStatsPaymentSourceType
from ympa_python_fastapi_server.models.orders_stats_payment_type import OrdersStatsPaymentType
try:
...
class OrdersStatsPaymentDTO(BaseModel):
    ...
    _date: Optional[date] = Field(default=None, description="Дата денежного перевода.  Формат даты: `ГГГГ-ММ-ДД`. ", alias="date")
