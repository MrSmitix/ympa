...
from ympa_python_fastapi_server.models.report_status_type import ReportStatusType
from ympa_python_fastapi_server.models.report_sub_status_type import ReportSubStatusType
try:
