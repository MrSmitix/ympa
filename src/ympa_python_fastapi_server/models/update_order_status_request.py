...
from ympa_python_fastapi_server.models.order_status_change_dto import OrderStatusChangeDTO
try:
...
class UpdateOrderStatusRequest(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "order": OrderStatusChangeDTO.from_dict(obj.get("order")) if obj.get("order") is not None else None
        })
        return _obj
