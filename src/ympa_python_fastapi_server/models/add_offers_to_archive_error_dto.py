...
from ympa_python_fastapi_server.models.add_offers_to_archive_error_type import AddOffersToArchiveErrorType
try:
...
class AddOffersToArchiveErrorDTO(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["offerId", "error"]
