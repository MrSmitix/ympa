...
from ympa_python_fastapi_server.models.category_parameter_dto import CategoryParameterDTO
try:
...
class CategoryContentParametersDTO(BaseModel):
    ...
    parameters: Optional[List[CategoryParameterDTO]] = Field(default=None, description="Список характеристик.")
    __properties: ClassVar[List[str]] = ["categoryId", "parameters"]
