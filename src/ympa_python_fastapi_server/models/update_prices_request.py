...
from ympa_python_fastapi_server.models.offer_price_dto import OfferPriceDTO
try:
...
class UpdatePricesRequest(BaseModel):
    ...
    """ # noqa: E501
    offers: Annotated[List[OfferPriceDTO], Field(min_length=1, max_length=2000)] = Field(description="Список товаров.")
