...
from ympa_python_fastapi_server.models.campaign_dto import CampaignDTO
...
class GetCampaignsResponse(BaseModel):
    ...
    """ # noqa: E501
    campaigns: List[CampaignDTO] = Field(description="Список с информацией по каждому магазину.")
    pager: Optional[FlippingPagerDTO] = None
    __properties: ClassVar[List[str]] = ["campaigns", "pager"]
