...
from ympa_python_fastapi_server.models.update_stock_item_dto import UpdateStockItemDTO
try:
...
class UpdateStockDTO(BaseModel):
    ...
    items: Annotated[List[UpdateStockItemDTO], Field(min_length=1, max_length=1)] = Field(description="Информация об остатках товара. ")
    __properties: ClassVar[List[str]] = ["sku", "items"]
