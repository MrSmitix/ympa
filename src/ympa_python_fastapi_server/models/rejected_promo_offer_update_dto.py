...
from ympa_python_fastapi_server.models.rejected_promo_offer_update_reason_type import RejectedPromoOfferUpdateReasonType
try:
...
class RejectedPromoOfferUpdateDTO(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["offerId", "reason"]
