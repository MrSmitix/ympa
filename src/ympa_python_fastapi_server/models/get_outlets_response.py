...
from ympa_python_fastapi_server.models.flipping_pager_dto import FlippingPagerDTO
from ympa_python_fastapi_server.models.full_outlet_dto import FullOutletDTO
...
class GetOutletsResponse(BaseModel):
    ...
    """ # noqa: E501
    outlets: List[FullOutletDTO] = Field(description="Информация о точках продаж.")
    paging: Optional[ScrollingPagerDTO] = None
    pager: Optional[FlippingPagerDTO] = None
    __properties: ClassVar[List[str]] = ["outlets", "paging", "pager"]
