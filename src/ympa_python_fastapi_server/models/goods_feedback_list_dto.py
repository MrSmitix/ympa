...
from ympa_python_fastapi_server.models.goods_feedback_dto import GoodsFeedbackDTO
try:
...
class GoodsFeedbackListDTO(BaseModel):
    ...
    """ # noqa: E501
    feedbacks: List[GoodsFeedbackDTO] = Field(description="Список отзывов.")
    paging: Optional[ForwardScrollingPagerDTO] = None
    __properties: ClassVar[List[str]] = ["feedbacks", "paging"]
