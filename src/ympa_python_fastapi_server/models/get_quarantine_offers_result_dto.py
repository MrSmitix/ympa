...
from ympa_python_fastapi_server.models.quarantine_offer_dto import QuarantineOfferDTO
...
class GetQuarantineOffersResultDTO(BaseModel):
    ...
    offers: List[QuarantineOfferDTO] = Field(description="Страница списка товаров в карантине.")
    __properties: ClassVar[List[str]] = ["paging", "offers"]
