...
from ympa_python_fastapi_server.models.get_promo_offer_dto import GetPromoOfferDTO
try:
...
class GetPromoOffersResultDTO(BaseModel):
    ...
    """ # noqa: E501
    offers: List[GetPromoOfferDTO] = Field(description="Товары, которые участвуют или могут участвовать в акции.")
