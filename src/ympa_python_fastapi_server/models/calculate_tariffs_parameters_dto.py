...
from ympa_python_fastapi_server.models.payment_frequency_type import PaymentFrequencyType
...
class CalculateTariffsParametersDTO(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["campaignId", "sellingProgram", "frequency"]
