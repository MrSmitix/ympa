...
from ympa_python_fastapi_server.models.get_chat_info_dto import GetChatInfoDTO
try:
...
class GetChatsInfoDTO(BaseModel):
    ...
    Список чатов.
    """ # noqa: E501
    chats: List[GetChatInfoDTO] = Field(description="Информация о чатах.")
    paging: Optional[ForwardScrollingPagerDTO] = None
    __properties: ClassVar[List[str]] = ["chats", "paging"]
