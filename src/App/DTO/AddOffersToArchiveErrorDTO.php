...
class AddOffersToArchiveErrorDTO
{
     ...
     * @DTA\Strategy(name="Object", options={"type":\App\DTO\AddOffersToArchiveErrorType::class})
     * @DTA\Validator(name="TypeCompliant", options={"type":\App\DTO\AddOffersToArchiveErrorType::class})
     */
    public ?\App\DTO\AddOffersToArchiveErrorType $error = null;
