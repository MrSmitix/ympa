...
/**
 * Parameters for downloadShipmentReceptionTransferAct
 */
class DownloadShipmentReceptionTransferActParameterData
{
    /**
     ...
     * @DTA\Data(subset="query", field="warehouse_id", nullable=true)
