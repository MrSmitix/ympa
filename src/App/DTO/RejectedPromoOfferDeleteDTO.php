...
class RejectedPromoOfferDeleteDTO
{
     ...
     * @DTA\Strategy(name="Object", options={"type":\App\DTO\RejectedPromoOfferDeleteReasonType::class})
     * @DTA\Validator(name="TypeCompliant", options={"type":\App\DTO\RejectedPromoOfferDeleteReasonType::class})
     */
    public ?\App\DTO\RejectedPromoOfferDeleteReasonType $reason = null;
