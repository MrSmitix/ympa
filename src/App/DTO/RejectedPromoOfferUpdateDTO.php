...
class RejectedPromoOfferUpdateDTO
{
     ...
     * @DTA\Strategy(name="Object", options={"type":\App\DTO\RejectedPromoOfferUpdateReasonType::class})
     * @DTA\Validator(name="TypeCompliant", options={"type":\App\DTO\RejectedPromoOfferUpdateReasonType::class})
     */
    public ?\App\DTO\RejectedPromoOfferUpdateReasonType $reason = null;
