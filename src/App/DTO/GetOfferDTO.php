...
class GetOfferDTO
{
     ...
     * @DTA\Strategy(name="Object", options={"type":::class})
     * @DTA\Validator(name="TypeCompliant", options={"type":::class})
     * @var \App\DTO\OfferManualDTO[]|null
     */
    public $manuals;
     ...
     * @var \App\DTO\OfferConditionDTO|null
     */
    public $condition;
     ...
     * @DTA\Strategy(name="Object", options={"type":::class})
     * @DTA\Validator(name="TypeCompliant", options={"type":::class})
     * @var \App\DTO\OfferParamDTO[]|null
     */
    public $params;
     ...
     * @DTA\Strategy(name="Object", options={"type":::class})
     * @DTA\Validator(name="TypeCompliant", options={"type":::class})
     * @var \App\DTO\OfferCampaignStatusDTO[]|null
     */
    public $campaigns;
     ...
     * @DTA\Strategy(name="Object", options={"type":::class})
     * @DTA\Validator(name="TypeCompliant", options={"type":::class})
     * @var \App\DTO\OfferSellingProgramDTO[]|null
     */
    public $selling_programs;
