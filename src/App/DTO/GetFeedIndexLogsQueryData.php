...
/**
 * Query parameters for getFeedIndexLogs
 */
class GetFeedIndexLogsQueryData
{
    /**
     ...
     * @DTA\Data(field="published_time_from", nullable=true)
     * @DTA\Strategy(name="QueryStringScalar", options={"type":"string"})
     * @DTA\Validator(name="QueryStringScalar", options={"type":"string"})
     * @var string|null
     */
    public $published_time_from;
     ...
     * @DTA\Data(field="published_time_to", nullable=true)
     * @DTA\Strategy(name="QueryStringScalar", options={"type":"string"})
     * @DTA\Validator(name="QueryStringScalar", options={"type":"string"})
     * @var string|null
     */
    public $published_time_to;
