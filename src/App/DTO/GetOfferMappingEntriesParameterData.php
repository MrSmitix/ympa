...
/**
 * Parameters for getOfferMappingEntries
 */
class GetOfferMappingEntriesParameterData
{
    /**
     * Тип маппинга.
     * @DTA\Data(subset="query", field="mapping_kind", nullable=true)
     * @DTA\Strategy(subset="query", name="QueryStringScalar", options={"type":"string"})
     * @DTA\Validator(subset="query", name="QueryStringScalar", options={"type":"string"})
     */
    public ?string $mapping_kind = null;
     ...
     * @DTA\Data(subset="query", field="shop_sku", nullable=true)
     ...
     * @DTA\Data(subset="query", field="category_id", nullable=true)
     ...
     * @DTA\Data(subset="query", field="vendor", nullable=true)
     * @DTA\Strategy(subset="query", name="QueryStringScalarArray", options={"type":"string", "format":"csv"})
     * @DTA\Validator(subset="query", name="QueryStringScalarArray", options={"type":"string", "format":"csv"})
     */
     ...
     * @DTA\Data(subset="query", field="availability", nullable=true)
     ...
     * @DTA\Data(subset="query", field="offer_id", nullable=true)
     * @DTA\Strategy(subset="query", name="QueryStringScalarArray", options={"type":"string", "format":"csv"})
     * @DTA\Validator(subset="query", name="QueryStringScalarArray", options={"type":"string", "format":"csv"})
     */
