 ...
 */
class GetOrdersParameterData
{
    /**
     * Способ отгрузки
     * @DTA\Data(subset="query", field="dispatchType", nullable=true)
     * @DTA\Strategy(subset="query", name="QueryStringScalar", options={"type":"string"})
     * @DTA\Validator(subset="query", name="QueryStringScalar", options={"type":"string"})
     */
    public ?string $dispatch_type = null;
     ...
     * @DTA\Data(subset="query", field="supplierShipmentDateFrom", nullable=true)
     * @DTA\Strategy(subset="query", name="QueryStringScalar", options={"type":"string"})
     * @DTA\Validator(subset="query", name="QueryStringScalar", options={"type":"string"})
     */
    public ?string $supplier_shipment_date_from = null;
     ...
     * @DTA\Data(subset="query", field="updatedAtFrom", nullable=true)
     * @DTA\Strategy(subset="query", name="QueryStringScalar", options={"type":"string"})
     * @DTA\Validator(subset="query", name="QueryStringScalar", options={"type":"string"})
     */
     ...
     * @DTA\Data(subset="query", field="substatus", nullable=true)
     * TODO add validator(s) and strategy for list of \App\DTO\OrderSubstatusType::class and collection format csv inside query string
     */
    public ?array $substatus = null;
     ...
     * @DTA\Data(subset="query", field="supplierShipmentDateTo", nullable=true)
     * @DTA\Strategy(subset="query", name="QueryStringScalar", options={"type":"string"})
     * @DTA\Validator(subset="query", name="QueryStringScalar", options={"type":"string"})
     */
    public ?string $supplier_shipment_date_to = null;
     ...
     * @DTA\Data(subset="query", field="onlyEstimatedDelivery", nullable=true)
     ...
     */
    public ?bool $only_estimated_delivery = null;
     ...
     * @DTA\Data(subset="query", field="updatedAtTo", nullable=true)
     * @DTA\Strategy(subset="query", name="QueryStringScalar", options={"type":"string"})
     * @DTA\Validator(subset="query", name="QueryStringScalar", options={"type":"string"})
     */
     ...
     * @DTA\Data(subset="query", field="onlyWaitingForCancellationApprove", nullable=true)
     * @DTA\Strategy(subset="query", name="QueryStringScalar", options={"type":"bool"})
     * @DTA\Validator(subset="query", name="QueryStringScalar", options={"type":"bool"})
     */
    public ?bool $only_waiting_for_cancellation_approve = null;
     ...
     * @DTA\Data(subset="query", field="hasCis", nullable=true)
     * @DTA\Strategy(subset="query", name="QueryStringScalar", options={"type":"bool"})
     * @DTA\Validator(subset="query", name="QueryStringScalar", options={"type":"bool"})
     */
     ...
     * @DTA\Data(subset="query", field="buyerType", nullable=true)
     * @DTA\Strategy(subset="query", name="QueryStringScalar", options={"type":"string"})
     * @DTA\Validator(subset="query", name="QueryStringScalar", options={"type":"string"})
     */
     ...
     * @DTA\Data(subset="query", field="fake", nullable=true)
     * @DTA\Strategy(subset="query", name="QueryStringScalar", options={"type":"bool"})
     * @DTA\Validator(subset="query", name="QueryStringScalar", options={"type":"bool"})
     */
     ...
     * TODO add validator(s) and strategy for list of \App\DTO\OrderStatusType::class and collection format csv inside query string
     */
