...
/**
 * Query parameters for getOfferMappingEntries
 */
class GetOfferMappingEntriesQueryData
{
    /**
     * Тип маппинга.
     * @DTA\Data(field="mapping_kind", nullable=true)
     ...
     * @DTA\Data(field="shop_sku", nullable=true)
     ...
     * TODO add validator(s) and strategy for list of \App\DTO\OfferAvailabilityStatusType::class and collection format csv inside query string
     ...
     * @DTA\Data(field="offer_id", nullable=true)
     * @DTA\Strategy(name="QueryStringScalarArray", options={"type":"string", "format":"csv"})
     * @DTA\Validator(name="QueryStringScalarArray", options={"type":"string", "format":"csv"})
     * @var string[]|null
     */
     ...
     * TODO add validator(s) and strategy for list of \App\DTO\OfferProcessingStatusType::class and collection format csv inside query string
