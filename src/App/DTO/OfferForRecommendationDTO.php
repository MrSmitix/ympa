...
class OfferForRecommendationDTO
{
     ...
     */
    public ?\App\DTO\BasePriceDTO $price = null;
    ...
    /**
     * @DTA\Data(field="competitiveness", nullable=true)
     ...
     */
    public ?\App\DTO\PriceCompetitivenessType $competitiveness = null;

    /**
     * Количество показов карточки товара за последние 7 дней.
     * @DTA\Data(field="shows", nullable=true)
     * @DTA\Validator(name="Scalar", options={"type":"int"})
     */
    public ?int $shows = null;
