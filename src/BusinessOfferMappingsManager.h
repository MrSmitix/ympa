#ifndef _BusinessOfferMappingsManager_H_
#define _BusinessOfferMappingsManager_H_
...
/** \addtogroup BusinessOfferMappings BusinessOfferMappings
 * \ingroup Operations
 *  @{
 */
class BusinessOfferMappingsManager {
public:
	BusinessOfferMappingsManager();
	virtual ~BusinessOfferMappingsManager();
...
#endif /* BusinessOfferMappingsManager_H_ */
