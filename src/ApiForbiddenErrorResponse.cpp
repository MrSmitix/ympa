...
void
ApiForbiddenErrorResponse::__init()
{
...
void
ApiForbiddenErrorResponse::__cleanup()
{
	//if(status != NULL) {
	//
	//delete status;
...
void
ApiForbiddenErrorResponse::fromJson(char* jsonStr)
{
...
ApiForbiddenErrorResponse::ApiForbiddenErrorResponse(char* json)
{
	this->fromJson(json);
}
