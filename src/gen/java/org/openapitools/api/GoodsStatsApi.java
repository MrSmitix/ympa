...
public interface GoodsStatsApi  {
    ...
    @ApiOperation(value = "Отчет по товарам", tags={ "goods-stats", "fby", "fbs", "express", "dbs" })
    @ApiResponses(value = { 
    ...
    public GetGoodsStatsResponse getGoodsStats(@PathParam("campaignId") Long campaignId, @Valid @NotNull GetGoodsStatsRequest getGoodsStatsRequest);
}
