...
public interface ExpressApi  {
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Передача кода подтверждения", tags={  })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 420, message = "Превышено ограничение на доступ к ресурсу.", response = ApiLimitErrorResponse.class),
        @ApiResponse(code = 500, message = "Внутренняя ошибка сервера.", response = ApiServerErrorResponse.class) })
    public VerifyOrderEacResponse verifyOrderEac(@PathParam("campaignId") Long campaignId, @PathParam("orderId") Long orderId, VerifyOrderEacRequest verifyOrderEacRequest);
}
