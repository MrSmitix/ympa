...
public interface CampaignsApiService {
      ...
      @Deprecated public Response getAllOffers(Long campaignId, Long feedId, Integer chunk, SecurityContext securityContext);
      ...
      @Deprecated public Response getCampaignRegion(Long campaignId, SecurityContext securityContext);
      ...
      @Deprecated public Response getFeed(Long campaignId, Long feedId, SecurityContext securityContext);
      @Deprecated public Response getFeedIndexLogs(Long campaignId, Long feedId, Integer limit, java.util.Date publishedTimeFrom, java.util.Date publishedTimeTo, FeedIndexLogsStatusType status, SecurityContext securityContext);
      @Deprecated public Response getFeedbackAndCommentUpdates(Long campaignId, String pageToken, Integer limit, LocalDate fromDate, SecurityContext securityContext);
      @Deprecated public Response getFeeds(Long campaignId, SecurityContext securityContext);
      ...
      @Deprecated public Response getOfferMappingEntries(Long campaignId, List<String> offerId, List<@Pattern(regexp = "^[^\\x00-\\x08\\x0A-\\x1f\\x7f]{1,255}$")@Size(min = 1, max = 255)String> shopSku, OfferMappingKindType mappingKind, List<OfferProcessingStatusType> status, List<OfferAvailabilityStatusType> availability, List<Integer> categoryId, List<String> vendor, String pageToken, Integer limit, SecurityContext securityContext);
      @Deprecated public Response getOffers(Long campaignId, String query, Long feedId, String shopCategoryId, CurrencyType currency, Boolean matched, Integer page, Integer pageSize, SecurityContext securityContext);
      ...
      @Deprecated public Response getPrices(Long campaignId, String pageToken, Integer limit, Boolean archived, SecurityContext securityContext);
      ...
      @Deprecated public Response getSuggestedOfferMappingEntries(Long campaignId, GetSuggestedOfferMappingEntriesRequest getSuggestedOfferMappingEntriesRequest, SecurityContext securityContext);
      @Deprecated public Response getSuggestedPrices(Long campaignId, SuggestPricesRequest suggestPricesRequest, SecurityContext securityContext);
      ...
      @Deprecated public Response refreshFeed(Long campaignId, Long feedId, SecurityContext securityContext);
      ...
      @Deprecated public Response setFeedParams(Long campaignId, Long feedId, SetFeedParamsRequest setFeedParamsRequest, SecurityContext securityContext);
      ...
      @Deprecated public Response updateOfferMappingEntries(Long campaignId, UpdateOfferMappingEntryRequest updateOfferMappingEntryRequest, SecurityContext securityContext);
