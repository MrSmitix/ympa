...
public interface PromosApi  {
    ...
    public DeletePromoOffersResponse deletePromoOffers(@PathParam("businessId") Long businessId, @Valid @NotNull DeletePromoOffersRequest deletePromoOffersRequest);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 420, message = "Превышено ограничение на доступ к ресурсу.", response = ApiLimitErrorResponse.class),
        @ApiResponse(code = 500, message = "Внутренняя ошибка сервера.", response = ApiServerErrorResponse.class) })
    public GetPromoOffersResponse getPromoOffers(@PathParam("businessId") Long businessId, @Valid @NotNull GetPromoOffersRequest getPromoOffersRequest, @QueryParam("page_token") String pageToken, @QueryParam("limit") Integer limit);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 420, message = "Превышено ограничение на доступ к ресурсу.", response = ApiLimitErrorResponse.class),
        @ApiResponse(code = 500, message = "Внутренняя ошибка сервера.", response = ApiServerErrorResponse.class) })
    public UpdatePromoOffersResponse updatePromoOffers(@PathParam("businessId") Long businessId, @Valid @NotNull UpdatePromoOffersRequest updatePromoOffersRequest);
}
