...
public interface TariffsApi  {
    ...
    @ApiOperation(value = "Калькулятор стоимости услуг", tags={ "tariffs", "fbs", "fby", "dbs", "express" })
    @ApiResponses(value = { 
    ...
    public CalculateTariffsResponse calculateTariffs(@Valid CalculateTariffsRequest calculateTariffsRequest);
}
