...
public interface OffersApi  {
    ...
    public DeleteCampaignOffersResponse deleteCampaignOffers(@PathParam("campaignId") Long campaignId, @Valid DeleteCampaignOffersRequest deleteCampaignOffersRequest);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 420, message = "Превышено ограничение на доступ к ресурсу.", response = ApiLimitErrorResponse.class),
        @ApiResponse(code = 500, message = "Внутренняя ошибка сервера.", response = ApiServerErrorResponse.class) })
    public GetCampaignOffersResponse getCampaignOffers(@PathParam("campaignId") Long campaignId, @Valid GetCampaignOffersRequest getCampaignOffersRequest, @QueryParam("page_token") String pageToken, @QueryParam("limit") Integer limit);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 420, message = "Превышено ограничение на доступ к ресурсу.", response = ApiLimitErrorResponse.class),
        @ApiResponse(code = 500, message = "Внутренняя ошибка сервера.", response = ApiServerErrorResponse.class) })
    public GetOfferRecommendationsResponse getOfferRecommendations(@PathParam("businessId") Long businessId, @Valid GetOfferRecommendationsRequest getOfferRecommendationsRequest, @QueryParam("page_token") String pageToken, @QueryParam("limit") Integer limit);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 423, message = "К ресурсу нельзя применить указанный метод.", response = ApiLockedErrorResponse.class),
        @ApiResponse(code = 500, message = "Внутренняя ошибка сервера.", response = ApiServerErrorResponse.class) })
    public EmptyApiResponse updateCampaignOffers(@PathParam("campaignId") Long campaignId, @Valid UpdateCampaignOffersRequest updateCampaignOffersRequest);
}
