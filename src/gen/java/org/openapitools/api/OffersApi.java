...
public interface OffersApi  {
    ...
    @ApiOperation(value = "Удаление товаров из ассортимента магазина", tags={ "offers", "dbs", "fby", "fbs", "express" })
    @ApiResponses(value = { 
    ...
    public DeleteCampaignOffersResponse deleteCampaignOffers(@PathParam("campaignId") Long campaignId, @Valid @NotNull DeleteCampaignOffersRequest deleteCampaignOffersRequest);
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Все предложения магазина", tags={ "offers", "dbs", "fbs", "express", "fby" })
    @ApiResponses(value = { 
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Информация о товарах, которые размещены в заданном магазине", tags={ "offers", "dbs", "fby", "fbs", "express" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 420, message = "Превышено ограничение на доступ к ресурсу.", response = ApiLimitErrorResponse.class),
        @ApiResponse(code = 500, message = "Внутренняя ошибка сервера.", response = ApiServerErrorResponse.class) })
    public GetCampaignOffersResponse getCampaignOffers(@PathParam("campaignId") Long campaignId, @Valid @NotNull GetCampaignOffersRequest getCampaignOffersRequest, @QueryParam("page_token") String pageToken, @QueryParam("limit") Integer limit);
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Рекомендации Маркета, касающиеся цен", tags={ "offers", "dbs", "fby", "fbs", "express" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 420, message = "Превышено ограничение на доступ к ресурсу.", response = ApiLimitErrorResponse.class),
        @ApiResponse(code = 500, message = "Внутренняя ошибка сервера.", response = ApiServerErrorResponse.class) })
    public GetOfferRecommendationsResponse getOfferRecommendations(@PathParam("businessId") Long businessId, @Valid @NotNull GetOfferRecommendationsRequest getOfferRecommendationsRequest, @QueryParam("page_token") String pageToken, @QueryParam("limit") Integer limit);
    ...
    @Path("/campaigns/{campaignId}/offers")
    @Produces({ "application/json" })
    @ApiOperation(value = "Предложения магазина", tags={ "offers", "dbs", "fbs", "express", "fby" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 420, message = "Превышено ограничение на доступ к ресурсу.", response = ApiLimitErrorResponse.class),
        @ApiResponse(code = 500, message = "Внутренняя ошибка сервера.", response = ApiServerErrorResponse.class) })
    public GetOffersResponse getOffers(@PathParam("campaignId") Long campaignId, @QueryParam("query") String query, @QueryParam("feedId") Long feedId, @QueryParam("shopCategoryId") String shopCategoryId, @QueryParam("currency") CurrencyType currency, @QueryParam("matched") Boolean matched, @QueryParam("page") @Max(10000) @DefaultValue("1")Integer page, @QueryParam("pageSize") Integer pageSize);
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Изменение условий продажи товаров в магазине", tags={ "offers", "dbs", "fby", "fbs", "express" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 423, message = "К ресурсу нельзя применить указанный метод.", response = ApiLockedErrorResponse.class),
        @ApiResponse(code = 500, message = "Внутренняя ошибка сервера.", response = ApiServerErrorResponse.class) })
    public EmptyApiResponse updateCampaignOffers(@PathParam("campaignId") Long campaignId, @Valid @NotNull UpdateCampaignOffersRequest updateCampaignOffersRequest);
}
