...
public interface OrderBusinessInformationApi  {
    ...
    @ApiOperation(value = "Информация о покупателе — юридическом лице", tags={ "order-business-information", "fbs", "fby", "dbs", "express" })
    @ApiResponses(value = { 
    ...
    @Path("/documents")
    @Produces({ "application/json" })
    @ApiOperation(value = "Информация о документах", tags={ "order-business-information", "fbs", "fby", "dbs", "express" })
    @ApiResponses(value = { 
