...
public interface OrderDeliveryApi  {
    ...
    @ApiOperation(value = "Информация о покупателе — физическом лице", tags={ "order-delivery", "dbs" })
    @ApiResponses(value = { 
    ...
    public GetOrderBuyerInfoResponse getOrderBuyerInfo(@PathParam("campaignId") Long campaignId, @PathParam("orderId") Long orderId);
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Изменение даты доставки заказа", tags={ "order-delivery", "dbs" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 420, message = "Превышено ограничение на доступ к ресурсу.", response = ApiLimitErrorResponse.class),
        @ApiResponse(code = 500, message = "Внутренняя ошибка сервера.", response = ApiServerErrorResponse.class) })
    public EmptyApiResponse setOrderDeliveryDate(@PathParam("campaignId") Long campaignId, @PathParam("orderId") Long orderId, @Valid SetOrderDeliveryDateRequest setOrderDeliveryDateRequest);
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Передача трек‑номера посылки", tags={ "order-delivery", "dbs" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 420, message = "Превышено ограничение на доступ к ресурсу.", response = ApiLimitErrorResponse.class),
        @ApiResponse(code = 500, message = "Внутренняя ошибка сервера.", response = ApiServerErrorResponse.class) })
    public EmptyApiResponse setOrderDeliveryTrackCode(@PathParam("campaignId") Long campaignId, @PathParam("orderId") Long orderId, @Valid SetOrderDeliveryTrackCodeRequest setOrderDeliveryTrackCodeRequest);
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Продление срока хранения заказа", tags={ "order-delivery", "dbs" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 420, message = "Превышено ограничение на доступ к ресурсу.", response = ApiLimitErrorResponse.class),
        @ApiResponse(code = 500, message = "Внутренняя ошибка сервера.", response = ApiServerErrorResponse.class) })
    public EmptyApiResponse updateOrderStorageLimit(@PathParam("campaignId") Long campaignId, @PathParam("orderId") Long orderId, @Valid UpdateOrderStorageLimitRequest updateOrderStorageLimitRequest);
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Передача кода подтверждения", tags={ "order-delivery", "express" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 420, message = "Превышено ограничение на доступ к ресурсу.", response = ApiLimitErrorResponse.class),
        @ApiResponse(code = 500, message = "Внутренняя ошибка сервера.", response = ApiServerErrorResponse.class) })
    public VerifyOrderEacResponse verifyOrderEac(@PathParam("campaignId") Long campaignId, @PathParam("orderId") Long orderId, @Valid VerifyOrderEacRequest verifyOrderEacRequest);
}
