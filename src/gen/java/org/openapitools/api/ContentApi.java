...
public interface ContentApi  {
    ...
    @ApiOperation(value = "Списки характеристик товаров по категориям", tags={ "content", "dbs", "fby", "fbs", "express" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Получение информации о заполненности карточек магазина", tags={ "content", "dbs", "fby", "fbs", "express" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 420, message = "Превышено ограничение на доступ к ресурсу.", response = ApiLimitErrorResponse.class),
        @ApiResponse(code = 500, message = "Внутренняя ошибка сервера.", response = ApiServerErrorResponse.class) })
    public GetOfferCardsContentStatusResponse getOfferCardsContentStatus(@PathParam("businessId") Long businessId, @QueryParam("page_token") String pageToken, @QueryParam("limit") Integer limit, @Valid GetOfferCardsContentStatusRequest getOfferCardsContentStatusRequest);
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Редактирование категорийных характеристик товара", tags={ "content", "dbs", "fby", "fbs", "express" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 500, message = "Внутренняя ошибка сервера.", response = ApiServerErrorResponse.class) })
    public UpdateOfferContentResponse updateOfferContent(@PathParam("businessId") Long businessId, @Valid @NotNull UpdateOfferContentRequest updateOfferContentRequest);
}
