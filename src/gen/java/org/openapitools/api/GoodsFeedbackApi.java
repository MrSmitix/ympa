...
public interface GoodsFeedbackApi  {
    ...
    public EmptyApiResponse deleteGoodsFeedbackComment(@PathParam("businessId") Long businessId, @Valid DeleteGoodsFeedbackCommentRequest deleteGoodsFeedbackCommentRequest);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 420, message = "Превышено ограничение на доступ к ресурсу.", response = ApiLimitErrorResponse.class),
        @ApiResponse(code = 500, message = "Внутренняя ошибка сервера.", response = ApiServerErrorResponse.class) })
    public GetGoodsFeedbackCommentsResponse getGoodsFeedbackComments(@PathParam("businessId") Long businessId, @Valid GetGoodsFeedbackCommentsRequest getGoodsFeedbackCommentsRequest, @QueryParam("page_token") String pageToken, @QueryParam("limit") Integer limit);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 420, message = "Превышено ограничение на доступ к ресурсу.", response = ApiLimitErrorResponse.class),
        @ApiResponse(code = 500, message = "Внутренняя ошибка сервера.", response = ApiServerErrorResponse.class) })
    public EmptyApiResponse skipGoodsFeedbacksReaction(@PathParam("businessId") Long businessId, @Valid SkipGoodsFeedbackReactionRequest skipGoodsFeedbackReactionRequest);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 420, message = "Превышено ограничение на доступ к ресурсу.", response = ApiLimitErrorResponse.class),
        @ApiResponse(code = 500, message = "Внутренняя ошибка сервера.", response = ApiServerErrorResponse.class) })
    public UpdateGoodsFeedbackCommentResponse updateGoodsFeedbackComment(@PathParam("businessId") Long businessId, @Valid UpdateGoodsFeedbackCommentRequest updateGoodsFeedbackCommentRequest);
}
