...
public interface GoodsFeedbackApi  {
    ...
    @ApiOperation(value = "Удаление комментария к отзыву", tags={ "goods-feedback", "fby", "fbs", "dbs", "express" })
    @ApiResponses(value = { 
    ...
    public EmptyApiResponse deleteGoodsFeedbackComment(@PathParam("businessId") Long businessId, @Valid @NotNull DeleteGoodsFeedbackCommentRequest deleteGoodsFeedbackCommentRequest);
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Получение комментариев к отзыву", tags={ "goods-feedback", "fby", "fbs", "dbs", "express" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 420, message = "Превышено ограничение на доступ к ресурсу.", response = ApiLimitErrorResponse.class),
        @ApiResponse(code = 500, message = "Внутренняя ошибка сервера.", response = ApiServerErrorResponse.class) })
    public GetGoodsFeedbackCommentsResponse getGoodsFeedbackComments(@PathParam("businessId") Long businessId, @Valid @NotNull GetGoodsFeedbackCommentsRequest getGoodsFeedbackCommentsRequest, @QueryParam("page_token") String pageToken, @QueryParam("limit") Integer limit);
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Получение отзывов о товарах продавца", tags={ "goods-feedback", "fby", "fbs", "dbs", "express" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 420, message = "Превышено ограничение на доступ к ресурсу.", response = ApiLimitErrorResponse.class),
        @ApiResponse(code = 500, message = "Внутренняя ошибка сервера.", response = ApiServerErrorResponse.class) })
    public GetGoodsFeedbackResponse getGoodsFeedbacks(@PathParam("businessId") Long businessId, @QueryParam("page_token") String pageToken, @QueryParam("limit") Integer limit, @Valid GetGoodsFeedbackRequest getGoodsFeedbackRequest);
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Отказ от ответа на отзывы", tags={ "goods-feedback", "fby", "fbs", "dbs", "express" })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Пустой ответ.", response = EmptyApiResponse.class),
        @ApiResponse(code = 400, message = "Запрос содержит неправильные данные.", response = ApiClientDataErrorResponse.class),
        @ApiResponse(code = 401, message = "В запросе не указаны данные для авторизации.", response = ApiUnauthorizedErrorResponse.class),
        ...
        @ApiResponse(code = 420, message = "Превышено ограничение на доступ к ресурсу.", response = ApiLimitErrorResponse.class),
        @ApiResponse(code = 500, message = "Внутренняя ошибка сервера.", response = ApiServerErrorResponse.class) })
    public EmptyApiResponse skipGoodsFeedbacksReaction(@PathParam("businessId") Long businessId, @Valid @NotNull SkipGoodsFeedbackReactionRequest skipGoodsFeedbackReactionRequest);
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Добавление нового или изменение созданного комментария", tags={ "goods-feedback", "fby", "fbs", "dbs", "express" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 420, message = "Превышено ограничение на доступ к ресурсу.", response = ApiLimitErrorResponse.class),
        @ApiResponse(code = 500, message = "Внутренняя ошибка сервера.", response = ApiServerErrorResponse.class) })
    public UpdateGoodsFeedbackCommentResponse updateGoodsFeedbackComment(@PathParam("businessId") Long businessId, @Valid @NotNull UpdateGoodsFeedbackCommentRequest updateGoodsFeedbackCommentRequest);
}
