...
public interface OrdersStatsApi  {
    ...
    @ApiOperation(value = "Детальная информация по заказам", tags={ "orders-stats", "fby", "fbs", "dbs", "express" })
    @ApiResponses(value = { 
    ...
    public GetOrdersStatsResponse getOrdersStats(@PathParam("campaignId") Long campaignId, @QueryParam("page_token") String pageToken, @QueryParam("limit") Integer limit, @Valid GetOrdersStatsRequest getOrdersStatsRequest);
}
