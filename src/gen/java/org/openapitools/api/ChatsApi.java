...
public interface ChatsApi  {
    ...
    @ApiOperation(value = "Создание нового чата с покупателем", tags={ "chats", "dbs", "fbs", "fby", "express" })
    @ApiResponses(value = { 
    ...
    public CreateChatResponse createChat(@PathParam("businessId") Long businessId, @Valid @NotNull CreateChatRequest createChatRequest);
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Получение истории сообщений в чате", tags={ "chats", "dbs", "fbs", "fby", "express" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 420, message = "Превышено ограничение на доступ к ресурсу.", response = ApiLimitErrorResponse.class),
        @ApiResponse(code = 500, message = "Внутренняя ошибка сервера.", response = ApiServerErrorResponse.class) })
    public GetChatHistoryResponse getChatHistory(@PathParam("businessId") Long businessId, @QueryParam("chatId") @NotNull Long chatId, @Valid @NotNull GetChatHistoryRequest getChatHistoryRequest, @QueryParam("page_token") String pageToken, @QueryParam("limit") Integer limit);
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Получение доступных чатов", tags={ "chats", "dbs", "fbs", "fby", "express" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 420, message = "Превышено ограничение на доступ к ресурсу.", response = ApiLimitErrorResponse.class),
        @ApiResponse(code = 500, message = "Внутренняя ошибка сервера.", response = ApiServerErrorResponse.class) })
    public GetChatsResponse getChats(@PathParam("businessId") Long businessId, @Valid @NotNull GetChatsRequest getChatsRequest, @QueryParam("page_token") String pageToken, @QueryParam("limit") Integer limit);
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Отправка файла в чат", tags={ "chats", "dbs", "fbs", "fby", "express" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 420, message = "Превышено ограничение на доступ к ресурсу.", response = ApiLimitErrorResponse.class),
        @ApiResponse(code = 500, message = "Внутренняя ошибка сервера.", response = ApiServerErrorResponse.class) })
    public EmptyApiResponse sendFileToChat(@PathParam("businessId") Long businessId, @QueryParam("chatId") @NotNull Long chatId,  @Multipart(value = "file" ) Attachment _fileDetail);
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Отправка сообщения в чат", tags={ "chats", "dbs", "fbs", "fby", "express" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 420, message = "Превышено ограничение на доступ к ресурсу.", response = ApiLimitErrorResponse.class),
        @ApiResponse(code = 500, message = "Внутренняя ошибка сервера.", response = ApiServerErrorResponse.class) })
    public EmptyApiResponse sendMessageToChat(@PathParam("businessId") Long businessId, @QueryParam("chatId") @NotNull Long chatId, @Valid @NotNull SendMessageToChatRequest sendMessageToChatRequest);
}
