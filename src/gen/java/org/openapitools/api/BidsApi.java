...
public interface BidsApi  {
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 420, message = "Превышено ограничение на доступ к ресурсу.", response = ApiLimitErrorResponse.class),
        @ApiResponse(code = 500, message = "Внутренняя ошибка сервера.", response = ApiServerErrorResponse.class) })
    public GetBidsRecommendationsResponse getBidsRecommendations(@PathParam("businessId") Long businessId, @Valid @NotNull GetBidsRecommendationsRequest getBidsRecommendationsRequest);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 420, message = "Превышено ограничение на доступ к ресурсу.", response = ApiLimitErrorResponse.class),
        @ApiResponse(code = 500, message = "Внутренняя ошибка сервера.", response = ApiServerErrorResponse.class) })
    public EmptyApiResponse putBidsForBusiness(@PathParam("businessId") Long businessId, @Valid @NotNull PutSkuBidsRequest putSkuBidsRequest);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 420, message = "Превышено ограничение на доступ к ресурсу.", response = ApiLimitErrorResponse.class),
        @ApiResponse(code = 500, message = "Внутренняя ошибка сервера.", response = ApiServerErrorResponse.class) })
    public EmptyApiResponse putBidsForCampaign(@PathParam("campaignId") Long campaignId, @Valid @NotNull PutSkuBidsRequest putSkuBidsRequest);
}
