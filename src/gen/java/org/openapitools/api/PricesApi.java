...
public interface PricesApi  {
    ...
    @ApiOperation(value = "Список цен", tags={ "prices", "fby", "fbs", "dbs", "express" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Просмотр цен на указанные товары в магазине", tags={ "prices", "fby", "fbs", "dbs", "express" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 420, message = "Превышено ограничение на доступ к ресурсу.", response = ApiLimitErrorResponse.class),
        @ApiResponse(code = 500, message = "Внутренняя ошибка сервера.", response = ApiServerErrorResponse.class) })
    public GetPricesByOfferIdsResponse getPricesByOfferIds(@PathParam("campaignId") Long campaignId, @QueryParam("page_token") String pageToken, @QueryParam("limit") Integer limit, @Valid GetPricesByOfferIdsRequest getPricesByOfferIdsRequest);
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Цены для продвижения товаров", tags={ "prices", "fby", "fbs", "express", "dbs" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 420, message = "Превышено ограничение на доступ к ресурсу.", response = ApiLimitErrorResponse.class),
        @ApiResponse(code = 500, message = "Внутренняя ошибка сервера.", response = ApiServerErrorResponse.class) })
    public SuggestPricesResponse getSuggestedPrices(@PathParam("campaignId") Long campaignId, @Valid @NotNull SuggestPricesRequest suggestPricesRequest);
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Установка цен на товары во всех магазинах", tags={ "prices", "fby", "fbs", "dbs", "express" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 500, message = "Внутренняя ошибка сервера.", response = ApiServerErrorResponse.class) })
    public EmptyApiResponse updateBusinessPrices(@PathParam("businessId") Long businessId, @Valid @NotNull UpdateBusinessPricesRequest updateBusinessPricesRequest);
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Установка цен на товары в конкретном магазине", tags={ "prices", "fby", "fbs", "dbs", "express" })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Маркет принял информацию о новых ценах.", response = EmptyApiResponse.class),
        @ApiResponse(code = 400, message = "Запрос содержит неправильные данные.", response = ApiClientDataErrorResponse.class),
        @ApiResponse(code = 401, message = "В запросе не указаны данные для авторизации.", response = ApiUnauthorizedErrorResponse.class),
        ...
        @ApiResponse(code = 423, message = "К ресурсу нельзя применить указанный метод.", response = ApiLockedErrorResponse.class),
        @ApiResponse(code = 500, message = "Внутренняя ошибка сервера.", response = ApiServerErrorResponse.class) })
    public EmptyApiResponse updatePrices(@PathParam("campaignId") Long campaignId, @Valid @NotNull UpdatePricesRequest updatePricesRequest);
}
