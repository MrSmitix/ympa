...
public interface PricesApi  {
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 420, message = "Превышено ограничение на доступ к ресурсу.", response = ApiLimitErrorResponse.class),
        @ApiResponse(code = 500, message = "Внутренняя ошибка сервера.", response = ApiServerErrorResponse.class) })
    public SuggestPricesResponse getSuggestedPrices(@PathParam("campaignId") Long campaignId, @Valid SuggestPricesRequest suggestPricesRequest);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 500, message = "Внутренняя ошибка сервера.", response = ApiServerErrorResponse.class) })
    public EmptyApiResponse updateBusinessPrices(@PathParam("businessId") Long businessId, @Valid UpdateBusinessPricesRequest updateBusinessPricesRequest);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 423, message = "К ресурсу нельзя применить указанный метод.", response = ApiLockedErrorResponse.class),
        @ApiResponse(code = 500, message = "Внутренняя ошибка сервера.", response = ApiServerErrorResponse.class) })
    public EmptyApiResponse updatePrices(@PathParam("campaignId") Long campaignId, @Valid UpdatePricesRequest updatePricesRequest);
}
