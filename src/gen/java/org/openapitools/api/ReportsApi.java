...
public interface ReportsApi  {
    ...
    public GenerateReportResponse generateBoostConsolidatedReport(@Valid GenerateBoostConsolidatedRequest generateBoostConsolidatedRequest, @QueryParam("format") ReportFormatType format);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 420, message = "Превышено ограничение на доступ к ресурсу.", response = ApiLimitErrorResponse.class),
        @ApiResponse(code = 500, message = "Внутренняя ошибка сервера.", response = ApiServerErrorResponse.class) })
    public GenerateReportResponse generateCompetitorsPositionReport(@Valid GenerateCompetitorsPositionReportRequest generateCompetitorsPositionReportRequest, @QueryParam("format") ReportFormatType format);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 420, message = "Превышено ограничение на доступ к ресурсу.", response = ApiLimitErrorResponse.class),
        @ApiResponse(code = 500, message = "Внутренняя ошибка сервера.", response = ApiServerErrorResponse.class) })
    public GenerateReportResponse generateGoodsFeedbackReport(@Valid GenerateGoodsFeedbackRequest generateGoodsFeedbackRequest, @QueryParam("format") ReportFormatType format);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 420, message = "Превышено ограничение на доступ к ресурсу.", response = ApiLimitErrorResponse.class),
        @ApiResponse(code = 500, message = "Внутренняя ошибка сервера.", response = ApiServerErrorResponse.class) })
    public GenerateReportResponse generateGoodsMovementReport(@Valid GenerateGoodsMovementReportRequest generateGoodsMovementReportRequest, @QueryParam("format") ReportFormatType format);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 420, message = "Превышено ограничение на доступ к ресурсу.", response = ApiLimitErrorResponse.class),
        @ApiResponse(code = 500, message = "Внутренняя ошибка сервера.", response = ApiServerErrorResponse.class) })
    public GenerateReportResponse generateGoodsRealizationReport(@Valid GenerateGoodsRealizationReportRequest generateGoodsRealizationReportRequest, @QueryParam("format") ReportFormatType format);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 420, message = "Превышено ограничение на доступ к ресурсу.", response = ApiLimitErrorResponse.class),
        @ApiResponse(code = 500, message = "Внутренняя ошибка сервера.", response = ApiServerErrorResponse.class) })
    public GenerateReportResponse generateGoodsTurnoverReport(@Valid GenerateGoodsTurnoverRequest generateGoodsTurnoverRequest, @QueryParam("format") ReportFormatType format);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 420, message = "Превышено ограничение на доступ к ресурсу.", response = ApiLimitErrorResponse.class),
        @ApiResponse(code = 500, message = "Внутренняя ошибка сервера.", response = ApiServerErrorResponse.class) })
    public GenerateReportResponse generateMassOrderLabelsReport(@Valid GenerateMassOrderLabelsRequest generateMassOrderLabelsRequest, @QueryParam("format") PageFormatType format);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 420, message = "Превышено ограничение на доступ к ресурсу.", response = ApiLimitErrorResponse.class),
        @ApiResponse(code = 500, message = "Внутренняя ошибка сервера.", response = ApiServerErrorResponse.class) })
    public GenerateReportResponse generatePricesReport(@Valid GeneratePricesReportRequest generatePricesReportRequest, @QueryParam("format") ReportFormatType format);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 420, message = "Превышено ограничение на доступ к ресурсу.", response = ApiLimitErrorResponse.class),
        @ApiResponse(code = 500, message = "Внутренняя ошибка сервера.", response = ApiServerErrorResponse.class) })
    public GenerateReportResponse generateShelfsStatisticsReport(@Valid GenerateShelfsStatisticsRequest generateShelfsStatisticsRequest, @QueryParam("format") ReportFormatType format);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 420, message = "Превышено ограничение на доступ к ресурсу.", response = ApiLimitErrorResponse.class),
        @ApiResponse(code = 500, message = "Внутренняя ошибка сервера.", response = ApiServerErrorResponse.class) })
    public GenerateReportResponse generateShipmentListDocumentReport(@Valid GenerateShipmentListDocumentReportRequest generateShipmentListDocumentReportRequest);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 420, message = "Превышено ограничение на доступ к ресурсу.", response = ApiLimitErrorResponse.class),
        @ApiResponse(code = 500, message = "Внутренняя ошибка сервера.", response = ApiServerErrorResponse.class) })
    public GenerateReportResponse generateShowsSalesReport(@Valid GenerateShowsSalesReportRequest generateShowsSalesReportRequest, @QueryParam("format") ReportFormatType format);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 420, message = "Превышено ограничение на доступ к ресурсу.", response = ApiLimitErrorResponse.class),
        @ApiResponse(code = 500, message = "Внутренняя ошибка сервера.", response = ApiServerErrorResponse.class) })
    public GenerateReportResponse generateStocksOnWarehousesReport(@Valid GenerateStocksOnWarehousesReportRequest generateStocksOnWarehousesReportRequest, @QueryParam("format") ReportFormatType format);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 420, message = "Превышено ограничение на доступ к ресурсу.", response = ApiLimitErrorResponse.class),
        @ApiResponse(code = 500, message = "Внутренняя ошибка сервера.", response = ApiServerErrorResponse.class) })
    public GenerateReportResponse generateUnitedMarketplaceServicesReport(@Valid GenerateUnitedMarketplaceServicesReportRequest generateUnitedMarketplaceServicesReportRequest, @QueryParam("format") ReportFormatType format);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 420, message = "Превышено ограничение на доступ к ресурсу.", response = ApiLimitErrorResponse.class),
        @ApiResponse(code = 500, message = "Внутренняя ошибка сервера.", response = ApiServerErrorResponse.class) })
    public GenerateReportResponse generateUnitedNettingReport(@Valid GenerateUnitedNettingReportRequest generateUnitedNettingReportRequest, @QueryParam("format") ReportFormatType format);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 420, message = "Превышено ограничение на доступ к ресурсу.", response = ApiLimitErrorResponse.class),
        @ApiResponse(code = 500, message = "Внутренняя ошибка сервера.", response = ApiServerErrorResponse.class) })
    public GenerateReportResponse generateUnitedOrdersReport(@Valid GenerateUnitedOrdersRequest generateUnitedOrdersRequest, @QueryParam("format") ReportFormatType format);
