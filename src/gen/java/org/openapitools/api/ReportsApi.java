   ...
   public ReportsApi(@Context ServletConfig servletContext) {
      ...
      if (servletContext != null) {
         ...
         if (implClass != null && !"".equals(implClass.trim())) {
            try {
               delegate = (ReportsApiService) Class.forName(implClass).getDeclaredConstructor().newInstance();
            } catch (Exception e) {
    ...
    public Response generateBoostConsolidatedReport(@ApiParam(value = "", required = true) @NotNull @Valid  GenerateBoostConsolidatedRequest generateBoostConsolidatedRequest,@ApiParam(value = "Формат отчета.", allowableValues="FILE, CSV") @QueryParam("format")  ReportFormatType format,@Context SecurityContext securityContext)
    ...
    public Response generateCompetitorsPositionReport(@ApiParam(value = "", required = true) @NotNull @Valid  GenerateCompetitorsPositionReportRequest generateCompetitorsPositionReportRequest,@ApiParam(value = "Формат отчета.", allowableValues="FILE, CSV") @QueryParam("format")  ReportFormatType format,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response generateGoodsFeedbackReport(@ApiParam(value = "", required = true) @NotNull @Valid  GenerateGoodsFeedbackRequest generateGoodsFeedbackRequest,@ApiParam(value = "Формат отчета.", allowableValues="FILE, CSV") @QueryParam("format")  ReportFormatType format,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response generateGoodsMovementReport(@ApiParam(value = "", required = true) @NotNull @Valid  GenerateGoodsMovementReportRequest generateGoodsMovementReportRequest,@ApiParam(value = "Формат отчета.", allowableValues="FILE, CSV") @QueryParam("format")  ReportFormatType format,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response generateGoodsRealizationReport(@ApiParam(value = "", required = true) @NotNull @Valid  GenerateGoodsRealizationReportRequest generateGoodsRealizationReportRequest,@ApiParam(value = "Формат отчета.", allowableValues="FILE, CSV") @QueryParam("format")  ReportFormatType format,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response generateGoodsTurnoverReport(@ApiParam(value = "", required = true) @NotNull @Valid  GenerateGoodsTurnoverRequest generateGoodsTurnoverRequest,@ApiParam(value = "Формат отчета.", allowableValues="FILE, CSV") @QueryParam("format")  ReportFormatType format,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response generatePricesReport(@ApiParam(value = "", required = true) @NotNull @Valid  GeneratePricesReportRequest generatePricesReportRequest,@ApiParam(value = "Формат отчета.", allowableValues="FILE, CSV") @QueryParam("format")  ReportFormatType format,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response generateShelfsStatisticsReport(@ApiParam(value = "", required = true) @NotNull @Valid  GenerateShelfsStatisticsRequest generateShelfsStatisticsRequest,@ApiParam(value = "Формат отчета.", allowableValues="FILE, CSV") @QueryParam("format")  ReportFormatType format,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response generateShowsSalesReport(@ApiParam(value = "", required = true) @NotNull @Valid  GenerateShowsSalesReportRequest generateShowsSalesReportRequest,@ApiParam(value = "Формат отчета.", allowableValues="FILE, CSV") @QueryParam("format")  ReportFormatType format,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response generateStocksOnWarehousesReport(@ApiParam(value = "", required = true) @NotNull @Valid  GenerateStocksOnWarehousesReportRequest generateStocksOnWarehousesReportRequest,@ApiParam(value = "Формат отчета.", allowableValues="FILE, CSV") @QueryParam("format")  ReportFormatType format,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response generateUnitedMarketplaceServicesReport(@ApiParam(value = "", required = true) @NotNull @Valid  GenerateUnitedMarketplaceServicesReportRequest generateUnitedMarketplaceServicesReportRequest,@ApiParam(value = "Формат отчета.", allowableValues="FILE, CSV") @QueryParam("format")  ReportFormatType format,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response generateUnitedNettingReport(@ApiParam(value = "", required = true) @NotNull @Valid  GenerateUnitedNettingReportRequest generateUnitedNettingReportRequest,@ApiParam(value = "Формат отчета.", allowableValues="FILE, CSV") @QueryParam("format")  ReportFormatType format,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response generateUnitedOrdersReport(@ApiParam(value = "", required = true) @NotNull @Valid  GenerateUnitedOrdersRequest generateUnitedOrdersRequest,@ApiParam(value = "Формат отчета.", allowableValues="FILE, CSV") @QueryParam("format")  ReportFormatType format,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response getReportInfo(@ApiParam(value = "Идентификатор отчета, который вы получили после запуска генерации. ", required = true) @PathParam("reportId") @NotNull  String reportId,@Context SecurityContext securityContext)
    throws NotFoundException {
