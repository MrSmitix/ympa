...
public interface RegionsApi  {
    ...
    @ApiOperation(value = "Информация о дочерних регионах", tags={ "regions", "fby", "fbs", "dbs", "express" })
    @ApiResponses(value = { 
    ...
    public GetRegionWithChildrenResponse searchRegionChildren(@PathParam("regionId") Long regionId, @QueryParam("page") @Max(10000) @DefaultValue("1") Integer page, @QueryParam("pageSize") Integer pageSize);
    ...
    @Path("/{regionId}")
    @Produces({ "application/json" })
    @ApiOperation(value = "Информация о регионе", tags={ "regions", "fby", "fbs", "dbs", "express" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Поиск регионов по их имени", tags={ "regions", "fby", "fbs", "dbs", "express" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 420, message = "Превышено ограничение на доступ к ресурсу.", response = ApiLimitErrorResponse.class),
        @ApiResponse(code = 500, message = "Внутренняя ошибка сервера.", response = ApiServerErrorResponse.class) })
    public GetRegionsResponse searchRegionsByName(@QueryParam("name") @NotNull String name, @QueryParam("page_token") String pageToken, @QueryParam("limit") Integer limit);
}
