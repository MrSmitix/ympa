...
public class RegionsApi  {
    ...
    @Inject RegionsApiService service;
    ...
    throws NotFoundException {
        return service.searchRegionChildren(regionId,page,pageSize,securityContext);
    }
    @GET
    @Path("/{regionId}")
    ...
    throws NotFoundException {
        return service.searchRegionsById(regionId,securityContext);
    }
    @GET
    ...
    throws NotFoundException {
        return service.searchRegionsByName(name,pageToken,limit,securityContext);
    }
}
