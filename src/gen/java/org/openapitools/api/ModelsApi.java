...
public interface ModelsApi  {
    ...
    @ApiOperation(value = "Информация об одной модели", tags={ "models", "dbs" })
    @ApiResponses(value = { 
    ...
    public GetModelsResponse getModel(@PathParam("modelId") @Min(0L) Long modelId, @QueryParam("regionId") @NotNull Long regionId, @QueryParam("currency") CurrencyType currency);
    ...
    @Path("/{modelId}/offers")
    @Produces({ "application/json" })
    @ApiOperation(value = "Список предложений для одной модели", tags={ "models", "dbs" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 420, message = "Превышено ограничение на доступ к ресурсу.", response = ApiLimitErrorResponse.class),
        @ApiResponse(code = 500, message = "Внутренняя ошибка сервера.", response = ApiServerErrorResponse.class) })
    public GetModelsOffersResponse getModelOffers(@PathParam("modelId") @Min(0L) Long modelId, @QueryParam("regionId") @NotNull Long regionId, @QueryParam("currency") CurrencyType currency, @QueryParam("orderByPrice") SortOrderType orderByPrice, @QueryParam("count") @DefaultValue("10")Integer count, @QueryParam("page") @Max(10000) @DefaultValue("1")Integer page);
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Информация о нескольких моделях", tags={ "models", "dbs" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 420, message = "Превышено ограничение на доступ к ресурсу.", response = ApiLimitErrorResponse.class),
        @ApiResponse(code = 500, message = "Внутренняя ошибка сервера.", response = ApiServerErrorResponse.class) })
    public GetModelsResponse getModels(@QueryParam("regionId") @NotNull Long regionId, @Valid @NotNull GetModelsRequest getModelsRequest, @QueryParam("currency") CurrencyType currency);
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Список предложений для нескольких моделей", tags={ "models", "dbs" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 420, message = "Превышено ограничение на доступ к ресурсу.", response = ApiLimitErrorResponse.class),
        @ApiResponse(code = 500, message = "Внутренняя ошибка сервера.", response = ApiServerErrorResponse.class) })
    public GetModelsOffersResponse getModelsOffers(@QueryParam("regionId") @NotNull Long regionId, @Valid @NotNull GetModelsRequest getModelsRequest, @QueryParam("currency") CurrencyType currency, @QueryParam("orderByPrice") SortOrderType orderByPrice);
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Поиск модели товара", tags={ "models", "dbs" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 420, message = "Превышено ограничение на доступ к ресурсу.", response = ApiLimitErrorResponse.class),
        @ApiResponse(code = 500, message = "Внутренняя ошибка сервера.", response = ApiServerErrorResponse.class) })
    public SearchModelsResponse searchModels(@QueryParam("query") @NotNull String query, @QueryParam("regionId") @NotNull Long regionId, @QueryParam("currency") CurrencyType currency, @QueryParam("page") @Max(10000) @DefaultValue("1")Integer page, @QueryParam("pageSize") Integer pageSize);
}
