...
public interface ModelsApi  {
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 420, message = "Превышено ограничение на доступ к ресурсу.", response = ApiLimitErrorResponse.class),
        @ApiResponse(code = 500, message = "Внутренняя ошибка сервера.", response = ApiServerErrorResponse.class) })
    public GetModelsResponse getModels(@QueryParam("regionId") @NotNull Long regionId, @Valid GetModelsRequest getModelsRequest, @QueryParam("currency") CurrencyType currency);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 420, message = "Превышено ограничение на доступ к ресурсу.", response = ApiLimitErrorResponse.class),
        @ApiResponse(code = 500, message = "Внутренняя ошибка сервера.", response = ApiServerErrorResponse.class) })
    public GetModelsOffersResponse getModelsOffers(@QueryParam("regionId") @NotNull Long regionId, @Valid GetModelsRequest getModelsRequest, @QueryParam("currency") CurrencyType currency, @QueryParam("orderByPrice") SortOrderType orderByPrice);
