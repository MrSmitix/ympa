...
public interface OfferMappingsApi  {
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 420, message = "Превышено ограничение на доступ к ресурсу.", response = ApiLimitErrorResponse.class),
        @ApiResponse(code = 500, message = "Внутренняя ошибка сервера.", response = ApiServerErrorResponse.class) })
    public GetSuggestedOfferMappingEntriesResponse getSuggestedOfferMappingEntries(@PathParam("campaignId") Long campaignId, @Valid GetSuggestedOfferMappingEntriesRequest getSuggestedOfferMappingEntriesRequest);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 500, message = "Внутренняя ошибка сервера.", response = ApiServerErrorResponse.class) })
    public EmptyApiResponse updateOfferMappingEntries(@PathParam("campaignId") Long campaignId, @Valid UpdateOfferMappingEntryRequest updateOfferMappingEntryRequest);
}
