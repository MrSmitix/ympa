...
public interface OfferMappingsApi  {
    ...
    @ApiOperation(value = "Список товаров в каталоге", tags={ "offer-mappings", "fby", "fbs", "express", "dbs" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Рекомендованные карточки для товаров", tags={ "offer-mappings", "fby", "fbs", "express", "dbs" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 420, message = "Превышено ограничение на доступ к ресурсу.", response = ApiLimitErrorResponse.class),
        @ApiResponse(code = 500, message = "Внутренняя ошибка сервера.", response = ApiServerErrorResponse.class) })
    public GetSuggestedOfferMappingEntriesResponse getSuggestedOfferMappingEntries(@PathParam("campaignId") Long campaignId, @Valid @NotNull GetSuggestedOfferMappingEntriesRequest getSuggestedOfferMappingEntriesRequest);
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Добавление и редактирование товаров в каталоге", tags={ "offer-mappings", "fby", "fbs", "express", "dbs" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 500, message = "Внутренняя ошибка сервера.", response = ApiServerErrorResponse.class) })
    public EmptyApiResponse updateOfferMappingEntries(@PathParam("campaignId") Long campaignId, @Valid @NotNull UpdateOfferMappingEntryRequest updateOfferMappingEntryRequest);
}
