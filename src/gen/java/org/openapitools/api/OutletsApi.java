...
public interface OutletsApi  {
    ...
    public CreateOutletResponse createOutlet(@PathParam("campaignId") Long campaignId, @Valid ChangeOutletRequest changeOutletRequest);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 420, message = "Превышено ограничение на доступ к ресурсу.", response = ApiLimitErrorResponse.class),
        @ApiResponse(code = 500, message = "Внутренняя ошибка сервера.", response = ApiServerErrorResponse.class) })
    public EmptyApiResponse updateOutlet(@PathParam("campaignId") Long campaignId, @PathParam("outletId") Long outletId, @Valid ChangeOutletRequest changeOutletRequest);
}
