...
public interface HiddenOffersApi  {
    ...
    public EmptyApiResponse addHiddenOffers(@PathParam("campaignId") Long campaignId, @Valid AddHiddenOffersRequest addHiddenOffersRequest);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 423, message = "К ресурсу нельзя применить указанный метод.", response = ApiLockedErrorResponse.class),
        @ApiResponse(code = 500, message = "Внутренняя ошибка сервера.", response = ApiServerErrorResponse.class) })
    public EmptyApiResponse deleteHiddenOffers(@PathParam("campaignId") Long campaignId, @Valid DeleteHiddenOffersRequest deleteHiddenOffersRequest);
