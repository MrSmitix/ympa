...
public class CategoriesApi {
    ...
    public Response getCategoriesMaxSaleQuantum(@Valid @NotNull GetCategoriesMaxSaleQuantumRequest getCategoriesMaxSaleQuantumRequest) {
    ...
    public Response getCategoriesTree(@Valid GetCategoriesRequest getCategoriesRequest) {
        return Response.ok().entity("magic!").build();
    }
}
