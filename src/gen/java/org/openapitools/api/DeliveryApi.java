...
@Api(description = "the delivery API")
...
public class DeliveryApi  {
  ...
  @Inject DeliveryApiService delegate;
    ...
    @ApiOperation(value = "Справочник служб доставки", notes = "Возвращает справочник служб доставки: идентификаторы и наименования. |**⚙️ Лимит:** 5 000 запросов в час| |-| ", response = GetDeliveryServicesResponse.class, authorizations = {
    ...
    public Response getDeliveryServices() {
        return delegate.getDeliveryServices(securityContext);
    }
}
