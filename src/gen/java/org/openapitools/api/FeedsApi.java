...
public interface FeedsApi  {
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 500, message = "Внутренняя ошибка сервера.", response = ApiServerErrorResponse.class) })
    public EmptyApiResponse setFeedParams(@PathParam("campaignId") Long campaignId, @PathParam("feedId") Long feedId, @Valid SetFeedParamsRequest setFeedParamsRequest);
}
