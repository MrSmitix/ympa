...
public interface BusinessOfferMappingsApi  {
    ...
    @ApiOperation(value = "Добавление товаров в архив", tags={ "business-offer-mappings", "dbs", "fby", "fbs", "express" })
    @ApiResponses(value = { 
    ...
    public AddOffersToArchiveResponse addOffersToArchive(@PathParam("businessId") Long businessId, @Valid @NotNull AddOffersToArchiveRequest addOffersToArchiveRequest);
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Удаление товаров из каталога", tags={ "business-offer-mappings", "dbs", "fby", "fbs", "express" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 423, message = "К ресурсу нельзя применить указанный метод.", response = ApiLockedErrorResponse.class),
        @ApiResponse(code = 500, message = "Внутренняя ошибка сервера.", response = ApiServerErrorResponse.class) })
    public DeleteOffersResponse deleteOffers(@PathParam("businessId") Long businessId, @Valid @NotNull DeleteOffersRequest deleteOffersRequest);
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Удаление товаров из архива", tags={ "business-offer-mappings", "dbs", "fby", "fbs", "express" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 423, message = "К ресурсу нельзя применить указанный метод.", response = ApiLockedErrorResponse.class),
        @ApiResponse(code = 500, message = "Внутренняя ошибка сервера.", response = ApiServerErrorResponse.class) })
    public DeleteOffersFromArchiveResponse deleteOffersFromArchive(@PathParam("businessId") Long businessId, @Valid @NotNull DeleteOffersFromArchiveRequest deleteOffersFromArchiveRequest);
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Информация о товарах в каталоге", tags={ "business-offer-mappings", "dbs", "fby", "fbs", "express" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 420, message = "Превышено ограничение на доступ к ресурсу.", response = ApiLimitErrorResponse.class),
        @ApiResponse(code = 500, message = "Внутренняя ошибка сервера.", response = ApiServerErrorResponse.class) })
    public GetOfferMappingsResponse getOfferMappings(@PathParam("businessId") Long businessId, @QueryParam("page_token") String pageToken, @QueryParam("limit") Integer limit, @Valid GetOfferMappingsRequest getOfferMappingsRequest);
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Просмотр карточек на Маркете, которые подходят вашим товарам", tags={ "business-offer-mappings", "dbs", "fby", "fbs", "express" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 420, message = "Превышено ограничение на доступ к ресурсу.", response = ApiLimitErrorResponse.class),
        @ApiResponse(code = 500, message = "Внутренняя ошибка сервера.", response = ApiServerErrorResponse.class) })
    public GetSuggestedOfferMappingsResponse getSuggestedOfferMappings(@PathParam("businessId") Long businessId, @Valid GetSuggestedOfferMappingsRequest getSuggestedOfferMappingsRequest);
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Добавление товаров в каталог и изменение информации о них", tags={ "business-offer-mappings", "dbs", "fby", "fbs", "express" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 423, message = "К ресурсу нельзя применить указанный метод.", response = ApiLockedErrorResponse.class),
        @ApiResponse(code = 500, message = "Внутренняя ошибка сервера.", response = ApiServerErrorResponse.class) })
    public UpdateOfferMappingsResponse updateOfferMappings(@PathParam("businessId") Long businessId, @Valid @NotNull UpdateOfferMappingsRequest updateOfferMappingsRequest);
}
