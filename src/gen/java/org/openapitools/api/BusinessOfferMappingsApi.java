...
public interface BusinessOfferMappingsApi  {
    ...
    public AddOffersToArchiveResponse addOffersToArchive(@PathParam("businessId") Long businessId, @Valid AddOffersToArchiveRequest addOffersToArchiveRequest);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 423, message = "К ресурсу нельзя применить указанный метод.", response = ApiLockedErrorResponse.class),
        @ApiResponse(code = 500, message = "Внутренняя ошибка сервера.", response = ApiServerErrorResponse.class) })
    public DeleteOffersResponse deleteOffers(@PathParam("businessId") Long businessId, @Valid DeleteOffersRequest deleteOffersRequest);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 423, message = "К ресурсу нельзя применить указанный метод.", response = ApiLockedErrorResponse.class),
        @ApiResponse(code = 500, message = "Внутренняя ошибка сервера.", response = ApiServerErrorResponse.class) })
    public DeleteOffersFromArchiveResponse deleteOffersFromArchive(@PathParam("businessId") Long businessId, @Valid DeleteOffersFromArchiveRequest deleteOffersFromArchiveRequest);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 423, message = "К ресурсу нельзя применить указанный метод.", response = ApiLockedErrorResponse.class),
        @ApiResponse(code = 500, message = "Внутренняя ошибка сервера.", response = ApiServerErrorResponse.class) })
    public UpdateOfferMappingsResponse updateOfferMappings(@PathParam("businessId") Long businessId, @Valid UpdateOfferMappingsRequest updateOfferMappingsRequest);
}
