...
public interface ShipmentsApi  {
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 420, message = "Превышено ограничение на доступ к ресурсу.", response = ApiLimitErrorResponse.class),
        @ApiResponse(code = 500, message = "Внутренняя ошибка сервера.", response = ApiServerErrorResponse.class) })
    public SearchShipmentsResponse searchShipments(@PathParam("campaignId") Long campaignId, @Valid SearchShipmentsRequest searchShipmentsRequest, @QueryParam("page_token") String pageToken, @QueryParam("limit") Integer limit);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 420, message = "Превышено ограничение на доступ к ресурсу.", response = ApiLimitErrorResponse.class),
        @ApiResponse(code = 500, message = "Внутренняя ошибка сервера.", response = ApiServerErrorResponse.class) })
    public EmptyApiResponse setShipmentPalletsCount(@PathParam("campaignId") Long campaignId, @PathParam("shipmentId") Long shipmentId, @Valid SetShipmentPalletsCountRequest setShipmentPalletsCountRequest);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 420, message = "Превышено ограничение на доступ к ресурсу.", response = ApiLimitErrorResponse.class),
        @ApiResponse(code = 500, message = "Внутренняя ошибка сервера.", response = ApiServerErrorResponse.class) })
    public EmptyApiResponse transferOrdersFromShipment(@PathParam("campaignId") Long campaignId, @PathParam("shipmentId") Long shipmentId, @Valid TransferOrdersFromShipmentRequest transferOrdersFromShipmentRequest);
}
