...
public interface ShipmentsApi  {
    ...
    @ApiOperation(value = "Подтверждение отгрузки", tags={ "shipments", "fbs" })
    @ApiResponses(value = { 
    ...
    public EmptyApiResponse confirmShipment(@PathParam("campaignId") Long campaignId, @PathParam("shipmentId") Long shipmentId, @Valid ConfirmShipmentRequest confirmShipmentRequest);
    ...
    @ApiOperation(value = "Получение акта приема-передачи", tags={ "shipments", "fbs" })
    @ApiResponses(value = { 
    ...
    @ApiOperation(value = "Получение акта расхождений", tags={ "shipments", "fbs" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/pdf", "application/json" })
    @ApiOperation(value = "Получение фактического акта приема-передачи", tags={ "shipments", "fbs" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/pdf", "application/json" })
    @ApiOperation(value = "Ярлыки для доверительной приемки (FBS)", tags={ "shipments", "fbs" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/pdf", "application/json" })
    @ApiOperation(value = "Подтверждение ближайшей отгрузки и получение акта приема-передачи для нее", tags={ "shipments", "fbs" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/vnd.ms-excel", "application/json" })
    @ApiOperation(value = "Получение транспортной накладной", tags={ "shipments", "fbs" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Получение информации об одной отгрузке", tags={ "shipments", "fbs" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Получение информации о возможности печати ярлыков (FBS)", tags={ "shipments", "fbs" })
    @ApiResponses(value = { 
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Получение информации о нескольких отгрузках", tags={ "shipments", "fbs" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 420, message = "Превышено ограничение на доступ к ресурсу.", response = ApiLimitErrorResponse.class),
        @ApiResponse(code = 500, message = "Внутренняя ошибка сервера.", response = ApiServerErrorResponse.class) })
    public SearchShipmentsResponse searchShipments(@PathParam("campaignId") Long campaignId, @Valid @NotNull SearchShipmentsRequest searchShipmentsRequest, @QueryParam("page_token") String pageToken, @QueryParam("limit") Integer limit);
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Передача количества упаковок в отгрузке", tags={ "shipments", "fbs" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 420, message = "Превышено ограничение на доступ к ресурсу.", response = ApiLimitErrorResponse.class),
        @ApiResponse(code = 500, message = "Внутренняя ошибка сервера.", response = ApiServerErrorResponse.class) })
    public EmptyApiResponse setShipmentPalletsCount(@PathParam("campaignId") Long campaignId, @PathParam("shipmentId") Long shipmentId, @Valid @NotNull SetShipmentPalletsCountRequest setShipmentPalletsCountRequest);
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Перенос заказов в следующую отгрузку", tags={ "shipments", "fbs" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 420, message = "Превышено ограничение на доступ к ресурсу.", response = ApiLimitErrorResponse.class),
        @ApiResponse(code = 500, message = "Внутренняя ошибка сервера.", response = ApiServerErrorResponse.class) })
    public EmptyApiResponse transferOrdersFromShipment(@PathParam("campaignId") Long campaignId, @PathParam("shipmentId") Long shipmentId, @Valid @NotNull TransferOrdersFromShipmentRequest transferOrdersFromShipmentRequest);
}
