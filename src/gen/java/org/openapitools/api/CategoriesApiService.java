...
public interface CategoriesApiService {
      Response getCategoriesMaxSaleQuantum(GetCategoriesMaxSaleQuantumRequest getCategoriesMaxSaleQuantumRequest,SecurityContext securityContext)
      throws NotFoundException;
      Response getCategoriesTree(GetCategoriesRequest getCategoriesRequest,SecurityContext securityContext)
      throws NotFoundException;
}
