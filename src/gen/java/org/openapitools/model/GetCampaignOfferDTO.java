...
public class GetCampaignOfferDTO   {
  ...
  @Valid public QuantumDTO getQuantum() {
    return quantum;
  }
  ...
  @Valid public GetPriceWithVatDTO getCampaignPrice() {
  ...
  public GetCampaignOfferDTO removeErrorsItem(OfferErrorDTO errorsItem) {
  ...
  public GetCampaignOfferDTO removeWarningsItem(OfferErrorDTO warningsItem) {
