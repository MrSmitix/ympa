...
public class OrderItemInstanceModificationDTO   {
  private Long id;
  private @Valid List<@Valid BriefOrderItemInstanceDTO> instances = new ArrayList<>();
  ...
  @NotNull @Valid public List<@Valid BriefOrderItemInstanceDTO> getInstances() {
    return instances;
  }
  ...
  public OrderItemInstanceModificationDTO removeInstancesItem(BriefOrderItemInstanceDTO instancesItem) {
