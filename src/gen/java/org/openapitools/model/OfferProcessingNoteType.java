...
public enum OfferProcessingNoteType {
    ...
    @JsonProperty("ASSORTMENT") ASSORTMENT(String.valueOf("ASSORTMENT")), @JsonProperty("CANCELLED") CANCELLED(String.valueOf("CANCELLED")), @JsonProperty("CONFLICTING_INFORMATION") CONFLICTING_INFORMATION(String.valueOf("CONFLICTING_INFORMATION")), @JsonProperty("OTHER") OTHER(String.valueOf("OTHER")), @JsonProperty("DEPARTMENT_FROZEN") DEPARTMENT_FROZEN(String.valueOf("DEPARTMENT_FROZEN")), @JsonProperty("INCORRECT_INFORMATION") INCORRECT_INFORMATION(String.valueOf("INCORRECT_INFORMATION")), @JsonProperty("LEGAL_CONFLICT") LEGAL_CONFLICT(String.valueOf("LEGAL_CONFLICT")), @JsonProperty("NEED_CLASSIFICATION_INFORMATION") NEED_CLASSIFICATION_INFORMATION(String.valueOf("NEED_CLASSIFICATION_INFORMATION")), @JsonProperty("NEED_INFORMATION") NEED_INFORMATION(String.valueOf("NEED_INFORMATION")), @JsonProperty("NEED_PICTURES") NEED_PICTURES(String.valueOf("NEED_PICTURES")), @JsonProperty("NEED_VENDOR") NEED_VENDOR(String.valueOf("NEED_VENDOR")), @JsonProperty("NO_CATEGORY") NO_CATEGORY(String.valueOf("NO_CATEGORY")), @JsonProperty("NO_KNOWLEDGE") NO_KNOWLEDGE(String.valueOf("NO_KNOWLEDGE")), @JsonProperty("NO_PARAMETERS_IN_SHOP_TITLE") NO_PARAMETERS_IN_SHOP_TITLE(String.valueOf("NO_PARAMETERS_IN_SHOP_TITLE")), @JsonProperty("NO_SIZE_MEASURE") NO_SIZE_MEASURE(String.valueOf("NO_SIZE_MEASURE")), @JsonProperty("SAMPLE_LINE") SAMPLE_LINE(String.valueOf("SAMPLE_LINE"));


    private String value;

    OfferProcessingNoteType(String v) {
        value = v;
    }
