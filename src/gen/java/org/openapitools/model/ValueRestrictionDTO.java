...
@JsonTypeName("ValueRestrictionDTO")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaJAXRSSpecServerCodegen", date = "2024-09-09T22:25:08.792192529Z[Etc/UTC]", comments = "Generator version: 7.8.0")
public class ValueRestrictionDTO   {
  private Long limitingParameterId;
  private @Valid List<@Valid OptionValuesLimitedDTO> limitedValues = new ArrayList<>();
  ...
  @NotNull public Long getLimitingParameterId() {
  ...
  @NotNull @Valid public List<@Valid OptionValuesLimitedDTO> getLimitedValues() {
  ...
  public ValueRestrictionDTO removeLimitedValuesItem(OptionValuesLimitedDTO limitedValuesItem) {
    if (limitedValuesItem != null && this.limitedValues != null) {
      this.limitedValues.remove(limitedValuesItem);
    }
