...
public class UpdateCampaignOffersRequest   {
  private @Valid List<@Valid UpdateCampaignOfferDTO> offers = new ArrayList<>();
  ...
  @JsonProperty("offers")
  @NotNull @Valid  @Size(min=1,max=500)public List<@Valid UpdateCampaignOfferDTO> getOffers() {
    return offers;
  }
  ...
  public UpdateCampaignOffersRequest removeOffersItem(UpdateCampaignOfferDTO offersItem) {
