...
public class GetOfferMappingsRequest   {
  ...
  public GetOfferMappingsRequest removeOfferIdsItem(String offerIdsItem) {
  ...
  public GetOfferMappingsRequest removeCardStatusesItem(OfferCardStatusType cardStatusesItem) {
  ...
  public GetOfferMappingsRequest removeCategoryIdsItem(Integer categoryIdsItem) {
  ...
  public GetOfferMappingsRequest removeVendorNamesItem(String vendorNamesItem) {
  ...
  public GetOfferMappingsRequest removeTagsItem(String tagsItem) {
