...
public class WarningPromoOfferUpdateDTO   {
  ...
  private @Valid List<@Valid PromoOfferUpdateWarningDTO> warnings = new ArrayList<>();
  ...
  @NotNull @Valid public List<@Valid PromoOfferUpdateWarningDTO> getWarnings() {
    return warnings;
  }
  ...
  public WarningPromoOfferUpdateDTO removeWarningsItem(PromoOfferUpdateWarningDTO warningsItem) {
