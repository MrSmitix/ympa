...
public class GetQualityRatingRequest   {
  ...
  private @Valid Set<Long> campaignIds = new LinkedHashSet<>();
  ...
  @NotNull  @Size(min=1,max=50)public Set<Long> getCampaignIds() {
    return campaignIds;
  }
  ...
  public GetQualityRatingRequest removeCampaignIdsItem(Long campaignIdsItem) {
