...
public class OfferContentDTO   {
  ...
  private @Valid List<@Valid ParameterValueDTO> parameterValues = new ArrayList<>();
  ...
  @NotNull @Valid  @Size(min=1,max=300)public List<@Valid ParameterValueDTO> getParameterValues() {
  ...
  public OfferContentDTO removeParameterValuesItem(ParameterValueDTO parameterValuesItem) {
