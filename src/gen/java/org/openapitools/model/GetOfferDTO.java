...
public class GetOfferDTO   {
   ...
   **/
  @JsonProperty(value = "customsCommodityCode")
   ...
   **/
  @JsonProperty(value = "additionalExpenses")
  @ApiModelProperty(value = "")
  @Valid 
   ...
   **/
  @JsonProperty(value = "cofinancePrice")
  @ApiModelProperty(value = "")
  @Valid 
   ...
   **/
  @JsonProperty(value = "sellingPrograms")
