...
public class OutletLicensesResponseDTO   {
  private @Valid List<@Valid FullOutletLicenseDTO> licenses = new ArrayList<>();
  ...
  @NotNull @Valid public List<@Valid FullOutletLicenseDTO> getLicenses() {
    return licenses;
  }
  ...
  public OutletLicensesResponseDTO removeLicensesItem(FullOutletLicenseDTO licensesItem) {
