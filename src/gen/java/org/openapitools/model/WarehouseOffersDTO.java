...
public class WarehouseOffersDTO   {
  ...
  private @Valid List<@Valid WarehouseOfferDTO> offers = new ArrayList<>();
  ...
  @NotNull public Long getWarehouseId() {
    return warehouseId;
  }
  ...
  @JsonProperty("offers")
  @NotNull @Valid public List<@Valid WarehouseOfferDTO> getOffers() {
    return offers;
  }
  ...
  public WarehouseOffersDTO removeOffersItem(WarehouseOfferDTO offersItem) {
