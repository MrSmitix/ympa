...
public class OrdersShipmentInfoDTO  {
  ...
  */
  ...
  /**
   * Sets the <code>orderIdsWithLabels</code> property.
   */
 ...
 public void setOrderIdsWithLabels(Set<Long> orderIdsWithLabels) {
  ...
  /**
   * Adds a new item to the <code>orderIdsWithLabels</code> list.
   */
  ...
  */
  ...
  /**
   * Sets the <code>orderIdsWithoutLabels</code> property.
   */
 @JsonDeserialize(as = LinkedHashSet.class)
 public void setOrderIdsWithoutLabels(Set<Long> orderIdsWithoutLabels) {
  ...
  /**
   * Adds a new item to the <code>orderIdsWithoutLabels</code> list.
   */
