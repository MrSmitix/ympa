...
public class EnrichedModelDTO   {
  ...
  private @Valid List<@Valid ModelOfferDTO> offers;
  ...
  @JsonProperty("prices")
  @Valid public ModelPriceDTO getPrices() {
    return prices;
  }
  ...
  @JsonProperty("offers")
  @Valid public List<@Valid ModelOfferDTO> getOffers() {
    return offers;
  }
  ...
  public EnrichedModelDTO removeOffersItem(ModelOfferDTO offersItem) {
