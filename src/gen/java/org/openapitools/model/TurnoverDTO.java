...
@JsonPropertyOrder({
  TurnoverDTO.JSON_PROPERTY_TURNOVER,
  TurnoverDTO.JSON_PROPERTY_TURNOVER_DAYS
})
...
public class TurnoverDTO   {
  ...
  public static final String JSON_PROPERTY_TURNOVER_DAYS = "turnoverDays";
  @JsonProperty(JSON_PROPERTY_TURNOVER_DAYS)
   ...
   * @return turnoverDays
   **/
  @JsonProperty(value = "turnoverDays")
