...
public class UpdateOfferContentResponse   {
  ...
  private @Valid List<@Valid UpdateOfferContentResultDTO> results;
  ...
  @Valid public List<@Valid UpdateOfferContentResultDTO> getResults() {
    return results;
  }
  ...
  public UpdateOfferContentResponse removeResultsItem(UpdateOfferContentResultDTO resultsItem) {
