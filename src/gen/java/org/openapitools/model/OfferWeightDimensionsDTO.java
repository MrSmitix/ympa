...
public class OfferWeightDimensionsDTO   {
  ...
  @JsonProperty("length")
  @NotNull @Valid public BigDecimal getLength() {
    return length;
  }
  ...
  @JsonProperty("width")
  @NotNull @Valid public BigDecimal getWidth() {
    return width;
  }
  ...
  @JsonProperty("height")
  @NotNull @Valid public BigDecimal getHeight() {
    return height;
  }
  ...
  @JsonProperty("weight")
  @NotNull @Valid public BigDecimal getWeight() {
    return weight;
  }
