...
public class OfferCardDTO   {
  ...
  private @Valid List<@Valid OfferCardRecommendationDTO> recommendations;
  private @Valid List<@Valid OfferErrorDTO> errors;
  private @Valid List<@Valid OfferErrorDTO> warnings;
  ...
  @Valid public GetMappingDTO getMapping() {
    return mapping;
  }
  ...
  @Valid public List<@Valid ParameterValueDTO> getParameterValues() {
  ...
  public OfferCardDTO removeParameterValuesItem(ParameterValueDTO parameterValuesItem) {
  ...
  @Valid public List<@Valid OfferCardRecommendationDTO> getRecommendations() {
  ...
  public OfferCardDTO removeRecommendationsItem(OfferCardRecommendationDTO recommendationsItem) {
  ...
  @JsonProperty("errors")
  @Valid public List<@Valid OfferErrorDTO> getErrors() {
    return errors;
  }
  ...
  public OfferCardDTO removeErrorsItem(OfferErrorDTO errorsItem) {
  ...
  @Valid public List<@Valid OfferErrorDTO> getWarnings() {
    return warnings;
  }
  ...
  public OfferCardDTO removeWarningsItem(OfferErrorDTO warningsItem) {
