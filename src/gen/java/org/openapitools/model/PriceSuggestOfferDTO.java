...
public class PriceSuggestOfferDTO   {
  ...
  private @Valid List<@Valid PriceSuggestDTO> priceSuggestion;
  ...
  @Valid public List<@Valid PriceSuggestDTO> getPriceSuggestion() {
  ...
  public PriceSuggestOfferDTO removePriceSuggestionItem(PriceSuggestDTO priceSuggestionItem) {
    if (priceSuggestionItem != null && this.priceSuggestion != null) {
      this.priceSuggestion.remove(priceSuggestionItem);
    }
