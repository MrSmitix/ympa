...
public class UpdateOrderItemRequest   {
  private @Valid List<@Valid OrderItemModificationDTO> items = new ArrayList<>();
  ...
  @JsonProperty("items")
  @NotNull @Valid  @Size(min=1)public List<@Valid OrderItemModificationDTO> getItems() {
    return items;
  }
  ...
  public UpdateOrderItemRequest removeItemsItem(OrderItemModificationDTO itemsItem) {
