...
public enum OrderItemSubsidyType {
    ...
    @JsonProperty("YANDEX_CASHBACK") YANDEX_CASHBACK(String.valueOf("YANDEX_CASHBACK")), @JsonProperty("SUBSIDY") SUBSIDY(String.valueOf("SUBSIDY"));


    private String value;

    OrderItemSubsidyType(String v) {
        value = v;
    }
