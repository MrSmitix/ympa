...
public class ReportInfoDTO   {
  ...
  private java.util.Date generationRequestedAt;

  private java.util.Date generationFinishedAt;
   ...
   **/
  public ReportInfoDTO generationRequestedAt(java.util.Date generationRequestedAt) {
  ...
  @NotNull
  public java.util.Date getGenerationRequestedAt() {
    return generationRequestedAt;
  }
  public void setGenerationRequestedAt(java.util.Date generationRequestedAt) {
    this.generationRequestedAt = generationRequestedAt;
  }
   ...
   **/
  public ReportInfoDTO generationFinishedAt(java.util.Date generationFinishedAt) {
  ...
  public java.util.Date getGenerationFinishedAt() {
    return generationFinishedAt;
  }
  public void setGenerationFinishedAt(java.util.Date generationFinishedAt) {
    this.generationFinishedAt = generationFinishedAt;
  }
