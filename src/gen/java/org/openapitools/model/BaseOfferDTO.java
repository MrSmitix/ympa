...
public class BaseOfferDTO   {
  ...
  public BaseOfferDTO removePicturesItem(String picturesItem) {
  ...
  public BaseOfferDTO removeVideosItem(String videosItem) {
  ...
  public BaseOfferDTO removeManualsItem(OfferManualDTO manualsItem) {
  ...
  public BaseOfferDTO removeBarcodesItem(String barcodesItem) {
  ...
  public BaseOfferDTO removeManufacturerCountriesItem(String manufacturerCountriesItem) {
  ...
  public BaseOfferDTO removeTagsItem(String tagsItem) {
  ...
  public BaseOfferDTO removeCertificatesItem(String certificatesItem) {
  ...
  public BaseOfferDTO removeParamsItem(OfferParamDTO paramsItem) {
