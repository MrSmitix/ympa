...
public class QuarantineOfferDTO   {
  ...
  private @Valid List<@Valid PriceQuarantineVerdictDTO> verdicts;
  ...
  @Valid public BasePriceDTO getCurrentPrice() {
    return currentPrice;
  }
  ...
  @Valid public BasePriceDTO getLastValidPrice() {
  ...
  @Valid public List<@Valid PriceQuarantineVerdictDTO> getVerdicts() {
    return verdicts;
  }
  ...
  public QuarantineOfferDTO removeVerdictsItem(PriceQuarantineVerdictDTO verdictsItem) {
    if (verdictsItem != null && this.verdicts != null) {
      this.verdicts.remove(verdictsItem);
    }
