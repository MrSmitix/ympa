...
public enum OfferAvailabilityStatusType {
    ...
    @JsonProperty("ACTIVE") ACTIVE(String.valueOf("ACTIVE")), @JsonProperty("INACTIVE") INACTIVE(String.valueOf("INACTIVE")), @JsonProperty("DELISTED") DELISTED(String.valueOf("DELISTED"));


    private String value;

    OfferAvailabilityStatusType(String v) {
        value = v;
    }
