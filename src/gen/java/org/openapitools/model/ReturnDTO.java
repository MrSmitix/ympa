...
public class ReturnDTO   {
  ...
  private @Valid List<@Valid ReturnItemDTO> items = new ArrayList<>();
  ...
  @Valid public LogisticPickupPointDTO getLogisticPickupPoint() {
  ...
  @JsonProperty("items")
  @NotNull @Valid public List<@Valid ReturnItemDTO> getItems() {
    return items;
  }
  ...
  public ReturnDTO removeItemsItem(ReturnItemDTO itemsItem) {
