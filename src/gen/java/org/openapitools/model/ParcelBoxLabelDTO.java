...
public class ParcelBoxLabelDTO   {
  ...
  @NotNull public String getSupplierName() {
    return supplierName;
  }
  ...
  @NotNull public String getDeliveryServiceName() {
  ...
  @NotNull public String getOrderNum() {
    return orderNum;
  }
  ...
  @NotNull public String getRecipientName() {
  ...
  @NotNull public String getFulfilmentId() {
    return fulfilmentId;
  }
  ...
  @JsonProperty("place")
  @NotNull public String getPlace() {
    return place;
  }
  ...
  @JsonProperty("weight")
  @NotNull public String getWeight() {
    return weight;
  }
  ...
  @NotNull public String getDeliveryServiceId() {
