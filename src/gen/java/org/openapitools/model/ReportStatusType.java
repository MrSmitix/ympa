...
public enum ReportStatusType {
    ...
    @JsonProperty("PENDING") PENDING(String.valueOf("PENDING")), @JsonProperty("PROCESSING") PROCESSING(String.valueOf("PROCESSING")), @JsonProperty("FAILED") FAILED(String.valueOf("FAILED")), @JsonProperty("DONE") DONE(String.valueOf("DONE"));


    private String value;

    ReportStatusType(String v) {
        value = v;
    }
