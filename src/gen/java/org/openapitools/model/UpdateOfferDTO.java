...
public class UpdateOfferDTO   {
  ...
  private @Valid List<@Valid ParameterValueDTO> parameterValues;
  ...
  public UpdateOfferDTO removePicturesItem(String picturesItem) {
  ...
  public UpdateOfferDTO removeVideosItem(String videosItem) {
  ...
  public UpdateOfferDTO removeManualsItem(OfferManualDTO manualsItem) {
  ...
  public UpdateOfferDTO removeBarcodesItem(String barcodesItem) {
  ...
  public UpdateOfferDTO removeManufacturerCountriesItem(String manufacturerCountriesItem) {
  ...
  public UpdateOfferDTO removeTagsItem(String tagsItem) {
  ...
  public UpdateOfferDTO removeCertificatesItem(String certificatesItem) {
  ...
  public UpdateOfferDTO removeParamsItem(OfferParamDTO paramsItem) {
  ...
  @Valid  @Size(max=300)public List<@Valid ParameterValueDTO> getParameterValues() {
  ...
  public UpdateOfferDTO removeParameterValuesItem(ParameterValueDTO parameterValuesItem) {
    if (parameterValuesItem != null && this.parameterValues != null) {
      this.parameterValues.remove(parameterValuesItem);
    }
  ...
  @Valid public UpdatePriceWithDiscountDTO getBasicPrice() {
    return basicPrice;
  }
  ...
  @Valid public BasePriceDTO getPurchasePrice() {
  ...
  @Valid public BasePriceDTO getAdditionalExpenses() {
  ...
  @Valid public BasePriceDTO getCofinancePrice() {
