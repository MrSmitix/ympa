...
public class UpdateStockDTO   {
  private String sku;
  private @Valid List<@Valid UpdateStockItemDTO> items = new ArrayList<>();
  ...
  @JsonProperty("items")
  @NotNull @Valid  @Size(min=1,max=1)public List<@Valid UpdateStockItemDTO> getItems() {
    return items;
  }
  ...
  public UpdateStockDTO removeItemsItem(UpdateStockItemDTO itemsItem) {
