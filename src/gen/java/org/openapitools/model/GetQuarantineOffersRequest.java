...
public class GetQuarantineOffersRequest   {
  ...
  private @Valid List<OfferCardStatusType> cardStatuses;
  ...
  public GetQuarantineOffersRequest removeOfferIdsItem(String offerIdsItem) {
  ...
  public GetQuarantineOffersRequest removeCardStatusesItem(OfferCardStatusType cardStatusesItem) {
  ...
  public GetQuarantineOffersRequest removeCategoryIdsItem(Integer categoryIdsItem) {
  ...
  public GetQuarantineOffersRequest removeVendorNamesItem(String vendorNamesItem) {
  ...
  public GetQuarantineOffersRequest removeTagsItem(String tagsItem) {
