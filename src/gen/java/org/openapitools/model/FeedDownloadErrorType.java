...
public enum FeedDownloadErrorType {
    ...
    @JsonProperty("DOWNLOAD_ERROR") ERROR(String.valueOf("DOWNLOAD_ERROR")), @JsonProperty("DOWNLOAD_HTTP_ERROR") HTTP_ERROR(String.valueOf("DOWNLOAD_HTTP_ERROR"));


    private String value;

    FeedDownloadErrorType(String v) {
        value = v;
    }
