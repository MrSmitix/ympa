...
public class CampaignSettingsScheduleDTO   {
   ...
   **/
  @JsonProperty(value = "availableOnHolidays")
   ...
   **/
  @JsonProperty(value = "customHolidays")
   ...
   **/
  @JsonProperty(value = "customWorkingDays")
   ...
   **/
  @JsonProperty(value = "totalHolidays")
   ...
   **/
  @JsonProperty(value = "weeklyHolidays")
