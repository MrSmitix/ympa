...
@JsonTypeName("UpdateMappingsOfferDTO")
...
public class UpdateMappingsOfferDTO   {
  ...
  public UpdateMappingsOfferDTO removeBarcodesItem(String barcodesItem) {
  ...
  public UpdateMappingsOfferDTO removeUrlsItem(String urlsItem) {
  ...
  public UpdateMappingsOfferDTO removePicturesItem(String picturesItem) {
  ...
  public UpdateMappingsOfferDTO removeManufacturerCountriesItem(String manufacturerCountriesItem) {
  ...
  public UpdateMappingsOfferDTO removeCustomsCommodityCodesItem(String customsCommodityCodesItem) {
  ...
  public UpdateMappingsOfferDTO removeSupplyScheduleDaysItem(DayOfWeekType supplyScheduleDaysItem) {
