...
public class ProvideOrderItemIdentifiersRequest   {
  private @Valid List<@Valid OrderItemInstanceModificationDTO> items = new ArrayList<>();
  ...
  @JsonProperty("items")
  @NotNull @Valid public List<@Valid OrderItemInstanceModificationDTO> getItems() {
    return items;
  }
  ...
  public ProvideOrderItemIdentifiersRequest removeItemsItem(OrderItemInstanceModificationDTO itemsItem) {
