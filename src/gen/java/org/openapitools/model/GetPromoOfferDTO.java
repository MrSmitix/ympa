...
public class GetPromoOfferDTO   {
  ...
  @JsonProperty("status")
  @NotNull public PromoOfferParticipationStatusType getStatus() {
    return status;
  }
  ...
  @ApiModelProperty(required = true, value = "")
  @JsonProperty("params")
  @NotNull @Valid public PromoOfferParamsDTO getParams() {
    return params;
  }
  ...
  @Valid public PromoOfferAutoParticipatingDetailsDTO getAutoParticipatingDetails() {
