...
public enum QualityRatingComponentType {
    ...
    @JsonProperty("DBS_CANCELLATION_RATE") DBS_CANCELLATION_RATE(String.valueOf("DBS_CANCELLATION_RATE")), @JsonProperty("DBS_LATE_DELIVERY_RATE") DBS_LATE_DELIVERY_RATE(String.valueOf("DBS_LATE_DELIVERY_RATE")), @JsonProperty("FBS_CANCELLATION_RATE") FBS_CANCELLATION_RATE(String.valueOf("FBS_CANCELLATION_RATE")), @JsonProperty("FBS_LATE_SHIP_RATE") FBS_LATE_SHIP_RATE(String.valueOf("FBS_LATE_SHIP_RATE")), @JsonProperty("FBY_LATE_DELIVERY_RATE") FBY_LATE_DELIVERY_RATE(String.valueOf("FBY_LATE_DELIVERY_RATE")), @JsonProperty("FBY_CANCELLATION_RATE") FBY_CANCELLATION_RATE(String.valueOf("FBY_CANCELLATION_RATE")), @JsonProperty("FBY_DELIVERY_DIFF_RATE") FBY_DELIVERY_DIFF_RATE(String.valueOf("FBY_DELIVERY_DIFF_RATE")), @JsonProperty("FBY_LATE_EDITING_RATE") FBY_LATE_EDITING_RATE(String.valueOf("FBY_LATE_EDITING_RATE"));


    private String value;

    QualityRatingComponentType(String v) {
        value = v;
    }
