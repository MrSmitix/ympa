...
public enum OfferCardRecommendationType {
    ...
    @JsonProperty("HAS_VIDEO") HAS_VIDEO(String.valueOf("HAS_VIDEO")), @JsonProperty("RECOGNIZED_VENDOR") RECOGNIZED_VENDOR(String.valueOf("RECOGNIZED_VENDOR")), @JsonProperty("MAIN") MAIN(String.valueOf("MAIN")), @JsonProperty("ADDITIONAL") ADDITIONAL(String.valueOf("ADDITIONAL")), @JsonProperty("DISTINCTIVE") DISTINCTIVE(String.valueOf("DISTINCTIVE")), @JsonProperty("FILTERABLE") FILTERABLE(String.valueOf("FILTERABLE")), @JsonProperty("PICTURE_COUNT") PICTURE_COUNT(String.valueOf("PICTURE_COUNT")), @JsonProperty("HAS_DESCRIPTION") HAS_DESCRIPTION(String.valueOf("HAS_DESCRIPTION")), @JsonProperty("HAS_BARCODE") HAS_BARCODE(String.valueOf("HAS_BARCODE")), @JsonProperty("FIRST_PICTURE_SIZE") FIRST_PICTURE_SIZE(String.valueOf("FIRST_PICTURE_SIZE")), @JsonProperty("TITLE_LENGTH") TITLE_LENGTH(String.valueOf("TITLE_LENGTH")), @JsonProperty("DESCRIPTION_LENGTH") DESCRIPTION_LENGTH(String.valueOf("DESCRIPTION_LENGTH")), @JsonProperty("AVERAGE_PICTURE_SIZE") AVERAGE_PICTURE_SIZE(String.valueOf("AVERAGE_PICTURE_SIZE")), @JsonProperty("FIRST_VIDEO_SIZE") FIRST_VIDEO_SIZE(String.valueOf("FIRST_VIDEO_SIZE")), @JsonProperty("FIRST_VIDEO_LENGTH") FIRST_VIDEO_LENGTH(String.valueOf("FIRST_VIDEO_LENGTH")), @JsonProperty("AVERAGE_VIDEO_SIZE") AVERAGE_VIDEO_SIZE(String.valueOf("AVERAGE_VIDEO_SIZE")), @JsonProperty("VIDEO_COUNT") VIDEO_COUNT(String.valueOf("VIDEO_COUNT"));


    private String value;

    OfferCardRecommendationType(String v) {
        value = v;
    }
