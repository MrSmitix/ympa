(ns партнерский-api-маркета.api.fby
...
(defn-spec get-fulfillment-warehouses-with-http-info any?
...
(defn-spec get-fulfillment-warehouses get-fulfillment-warehouses-response-spec
  "Идентификаторы складов Маркета (FBY)
  Возвращает список складов Маркета с их идентификаторами.
...
|-|"
  []
  (let [res (:data (get-fulfillment-warehouses-with-http-info))]
    (if (:decode-models *api-context*)
       (st/decode get-fulfillment-warehouses-response-spec res st/string-transformer)
       res)))
