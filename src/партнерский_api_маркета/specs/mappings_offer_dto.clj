(ns партнерский-api-маркета.specs.mappings-offer-dto
...
(def mappings-offer-dto-spec
  (ds/spec
    {:name ::mappings-offer-dto
     :spec mappings-offer-dto-data}))
