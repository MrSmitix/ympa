(ns партнерский-api-маркета.specs.update-mappings-offer-dto
...
(def update-mappings-offer-dto-data
  {
   (ds/opt :name) string?
...
(def update-mappings-offer-dto-spec
  (ds/spec
    {:name ::update-mappings-offer-dto
     :spec update-mappings-offer-dto-data}))
