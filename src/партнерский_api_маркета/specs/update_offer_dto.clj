(ns партнерский-api-маркета.specs.update-offer-dto
...
(def update-offer-dto-data
  {
   ...
   (ds/opt :basicPrice) update-price-with-discount-dto-spec
   (ds/opt :purchasePrice) base-price-dto-spec
   (ds/opt :additionalExpenses) base-price-dto-spec
   (ds/opt :cofinancePrice) base-price-dto-spec
   })

(def update-offer-dto-spec
  (ds/spec
    {:name ::update-offer-dto
     :spec update-offer-dto-data}))
