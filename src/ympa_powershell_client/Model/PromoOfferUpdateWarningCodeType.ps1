...
enum PromoOfferUpdateWarningCodeType {
    # enum value: "DEEP_DISCOUNT_OFFER"
    DEEP_DISCOUNT_OFFER
    # enum value: "CATALOG_PRICE_IS_LOWER_THAN_PROMO"
    CATALOG_PRICE_IS_LOWER_THAN_PROMO
    # enum value: "SHOP_PRICES_ARE_LOWER_THAN_PROMO"
    SHOP_PRICES_ARE_LOWER_THAN_PROMO
    # enum value: "PROMOCODE_PRICE_MORE_THAN_MAX_FAIR_PRICE"
    PROMOCODE_PRICE_MORE_THAN_MAX_FAIR_PRICE
    # enum value: "SHOP_OFFER_NOT_ELIGIBLE_FOR_PROMO"
