...
PriceDTO<PSCustomObject>
#>

function Initialize-PriceDTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: ympa_powershell_client => PriceDTO' | Write-Debug
...
Convert from JSON to PriceDTO<PSCustomObject>
...
PriceDTO<PSCustomObject>
#>
function ConvertFrom-JsonToPriceDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: ympa_powershell_client => PriceDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PriceDTO
        $AllProperties = ("value", "discountBase", "currencyId", "vat")
