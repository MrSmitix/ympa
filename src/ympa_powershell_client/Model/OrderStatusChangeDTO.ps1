...
OrderStatusChangeDTO<PSCustomObject>
#>

function Initialize-OrderStatusChangeDTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: ympa_powershell_client => OrderStatusChangeDTO' | Write-Debug
...
Convert from JSON to OrderStatusChangeDTO<PSCustomObject>
...
OrderStatusChangeDTO<PSCustomObject>
#>
function ConvertFrom-JsonToOrderStatusChangeDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: ympa_powershell_client => OrderStatusChangeDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in OrderStatusChangeDTO
        $AllProperties = ("status", "substatus", "delivery")
