...
enum OfferCardRecommendationType {
    # enum value: "HAS_VIDEO"
    HAS_VIDEO
    # enum value: "RECOGNIZED_VENDOR"
    RECOGNIZED_VENDOR
    # enum value: "MAIN"
    MAIN
    # enum value: "ADDITIONAL"
    ADDITIONAL
    # enum value: "DISTINCTIVE"
    DISTINCTIVE
    # enum value: "FILTERABLE"
    FILTERABLE
    # enum value: "PICTURE_COUNT"
    PICTURE_COUNT
    # enum value: "HAS_DESCRIPTION"
    HAS_DESCRIPTION
    # enum value: "HAS_BARCODE"
    HAS_BARCODE
    # enum value: "FIRST_PICTURE_SIZE"
    FIRST_PICTURE_SIZE
    # enum value: "TITLE_LENGTH"
    TITLE_LENGTH
    # enum value: "DESCRIPTION_LENGTH"
    DESCRIPTION_LENGTH
    # enum value: "AVERAGE_PICTURE_SIZE"
    AVERAGE_PICTURE_SIZE
    # enum value: "FIRST_VIDEO_SIZE"
    FIRST_VIDEO_SIZE
    # enum value: "FIRST_VIDEO_LENGTH"
    FIRST_VIDEO_LENGTH
    # enum value: "AVERAGE_VIDEO_SIZE"
    AVERAGE_VIDEO_SIZE
    # enum value: "VIDEO_COUNT"
    VIDEO_COUNT
}
