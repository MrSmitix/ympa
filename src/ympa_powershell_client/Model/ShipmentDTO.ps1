...
function Initialize-ShipmentDTO {
    ...
    Process {
        'Creating PSCustomObject: ympa_powershell_client => ShipmentDTO' | Write-Debug
...
function ConvertFrom-JsonToShipmentDTO {
    ...
    Process {
        'Converting JSON to PSCustomObject: ympa_powershell_client => ShipmentDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ShipmentDTO
        $AllProperties = ("id", "planIntervalFrom", "planIntervalTo", "shipmentType", "warehouse", "warehouseTo", "externalId", "deliveryService", "palletsCount", "orderIds", "draftCount", "plannedCount", "factCount", "currentStatus", "availableActions")
