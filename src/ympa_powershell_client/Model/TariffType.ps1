...
enum TariffType {
    ...
    # enum value: "CROSSREGIONAL_DELIVERY_RETURN"
    CROSSREGIONAL_DELIVERY_RETURN
    # enum value: "DISPOSAL"
    DISPOSAL
    # enum value: "SORTING_CENTER_STORAGE"
    SORTING_CENTER_STORAGE
    # enum value: "EXPRESS_DELIVERY"
    EXPRESS_DELIVERY
    # enum value: "FF_XDOC_SUPPLY_BOX"
    FF_XDOC_SUPPLY_BOX
    # enum value: "FF_XDOC_SUPPLY_PALLET"
    ...
    RETURN_PROCESSING
    # enum value: "EXPRESS_CANCELLED_BY_PARTNER"
    EXPRESS_CANCELLED_BY_PARTNER
    # enum value: "DELIVERY_TO_CUSTOMER_RETURN"
    DELIVERY_TO_CUSTOMER_RETURN
    # enum value: "CROSSBORDER_DELIVERY"
    CROSSBORDER_DELIVERY
    # enum value: "INTAKE_SORTING_BULKY_CARGO"
    INTAKE_SORTING_BULKY_CARGO
    # enum value: "INTAKE_SORTING_SMALL_GOODS"
    INTAKE_SORTING_SMALL_GOODS
    # enum value: "INTAKE_SORTING_DAILY"
    INTAKE_SORTING_DAILY
    # enum value: "FF_STORAGE_BILLING"
    FF_STORAGE_BILLING
    # enum value: "CANCELLED_ORDER_FEE_QI"
    CANCELLED_ORDER_FEE_QI
    # enum value: "LATE_ORDER_EXECUTION_FEE_QI"
