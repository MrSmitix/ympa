...
UpdateMappingsOfferDTO<PSCustomObject>
#>

function Initialize-UpdateMappingsOfferDTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: ympa_powershell_client => UpdateMappingsOfferDTO' | Write-Debug
...
Convert from JSON to UpdateMappingsOfferDTO<PSCustomObject>
...
UpdateMappingsOfferDTO<PSCustomObject>
#>
function ConvertFrom-JsonToUpdateMappingsOfferDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: ympa_powershell_client => UpdateMappingsOfferDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in UpdateMappingsOfferDTO
