...
OrderBoxLayoutDTO<PSCustomObject>
#>

function Initialize-OrderBoxLayoutDTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: ympa_powershell_client => OrderBoxLayoutDTO' | Write-Debug
...
Convert from JSON to OrderBoxLayoutDTO<PSCustomObject>
...
OrderBoxLayoutDTO<PSCustomObject>
#>
function ConvertFrom-JsonToOrderBoxLayoutDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: ympa_powershell_client => OrderBoxLayoutDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in OrderBoxLayoutDTO
        $AllProperties = ("items")
