...
EnrichedMappingsOfferDTO<PSCustomObject>
#>

function Initialize-EnrichedMappingsOfferDTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: ympa_powershell_client => EnrichedMappingsOfferDTO' | Write-Debug
...
Convert from JSON to EnrichedMappingsOfferDTO<PSCustomObject>
...
EnrichedMappingsOfferDTO<PSCustomObject>
#>
function ConvertFrom-JsonToEnrichedMappingsOfferDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: ympa_powershell_client => EnrichedMappingsOfferDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in EnrichedMappingsOfferDTO
