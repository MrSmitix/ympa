...
SuggestPricesResultDTO<PSCustomObject>
#>

function Initialize-SuggestPricesResultDTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: ympa_powershell_client => SuggestPricesResultDTO' | Write-Debug
...
Convert from JSON to SuggestPricesResultDTO<PSCustomObject>
...
SuggestPricesResultDTO<PSCustomObject>
#>
function ConvertFrom-JsonToSuggestPricesResultDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: ympa_powershell_client => SuggestPricesResultDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SuggestPricesResultDTO
