...
GetCampaignOffersResultDTO<PSCustomObject>
#>

function Initialize-GetCampaignOffersResultDTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: ympa_powershell_client => GetCampaignOffersResultDTO' | Write-Debug
...
Convert from JSON to GetCampaignOffersResultDTO<PSCustomObject>
...
GetCampaignOffersResultDTO<PSCustomObject>
#>
function ConvertFrom-JsonToGetCampaignOffersResultDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: ympa_powershell_client => GetCampaignOffersResultDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in GetCampaignOffersResultDTO
