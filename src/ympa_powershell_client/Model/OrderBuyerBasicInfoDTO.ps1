...
OrderBuyerBasicInfoDTO<PSCustomObject>
#>

function Initialize-OrderBuyerBasicInfoDTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: ympa_powershell_client => OrderBuyerBasicInfoDTO' | Write-Debug
...
Convert from JSON to OrderBuyerBasicInfoDTO<PSCustomObject>
...
OrderBuyerBasicInfoDTO<PSCustomObject>
#>
function ConvertFrom-JsonToOrderBuyerBasicInfoDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: ympa_powershell_client => OrderBuyerBasicInfoDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in OrderBuyerBasicInfoDTO
