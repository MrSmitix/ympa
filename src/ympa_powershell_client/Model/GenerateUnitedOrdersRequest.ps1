...
GenerateUnitedOrdersRequest<PSCustomObject>
#>

function Initialize-GenerateUnitedOrdersRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: ympa_powershell_client => GenerateUnitedOrdersRequest' | Write-Debug
...
Convert from JSON to GenerateUnitedOrdersRequest<PSCustomObject>
...
GenerateUnitedOrdersRequest<PSCustomObject>
#>
function ConvertFrom-JsonToGenerateUnitedOrdersRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: ympa_powershell_client => GenerateUnitedOrdersRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in GenerateUnitedOrdersRequest
        $AllProperties = ("businessId", "dateFrom", "dateTo", "campaignIds", "promoId")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "promoId"))) { #optional property not found
            $PromoId = $null
        } else {
