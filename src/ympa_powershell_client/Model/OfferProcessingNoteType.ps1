...
enum OfferProcessingNoteType {
    # enum value: "ASSORTMENT"
    ASSORTMENT
    # enum value: "CANCELLED"
    CANCELLED
    # enum value: "CONFLICTING_INFORMATION"
    CONFLICTING_INFORMATION
    # enum value: "OTHER"
    OTHER
    # enum value: "DEPARTMENT_FROZEN"
    DEPARTMENT_FROZEN
    # enum value: "INCORRECT_INFORMATION"
    INCORRECT_INFORMATION
    # enum value: "LEGAL_CONFLICT"
    LEGAL_CONFLICT
    # enum value: "NEED_CLASSIFICATION_INFORMATION"
    NEED_CLASSIFICATION_INFORMATION
    # enum value: "NEED_INFORMATION"
    NEED_INFORMATION
    # enum value: "NEED_PICTURES"
    NEED_PICTURES
    # enum value: "NEED_VENDOR"
    NEED_VENDOR
    # enum value: "NO_CATEGORY"
    NO_CATEGORY
    # enum value: "NO_KNOWLEDGE"
    NO_KNOWLEDGE
    # enum value: "NO_PARAMETERS_IN_SHOP_TITLE"
    NO_PARAMETERS_IN_SHOP_TITLE
    # enum value: "NO_SIZE_MEASURE"
    NO_SIZE_MEASURE
    # enum value: "SAMPLE_LINE"
    SAMPLE_LINE
}
