...
.PARAMETER StatusUpdateTime
Время последнего изменения статуса отгрузки.
.OUTPUTS

ShipmentInfoDTO<PSCustomObject>
#>

function Initialize-ShipmentInfoDTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: ympa_powershell_client => ShipmentInfoDTO' | Write-Debug
...
Convert from JSON to ShipmentInfoDTO<PSCustomObject>
...
ShipmentInfoDTO<PSCustomObject>
#>
function ConvertFrom-JsonToShipmentInfoDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: ympa_powershell_client => ShipmentInfoDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ShipmentInfoDTO
        $AllProperties = ("id", "planIntervalFrom", "planIntervalTo", "shipmentType", "warehouse", "warehouseTo", "externalId", "deliveryService", "palletsCount", "orderIds", "draftCount", "plannedCount", "factCount", "status", "statusDescription", "statusUpdateTime")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "statusUpdateTime"))) { #optional property not found
            $StatusUpdateTime = $null
        } else {
            $StatusUpdateTime = $JsonParameters.PSobject.Properties["statusUpdateTime"].value
        }
