...
AddOffersToArchiveErrorDTO<PSCustomObject>
#>

function Initialize-AddOffersToArchiveErrorDTO {
    [CmdletBinding()]
    Param (
        ...
        [ValidateSet("OFFER_HAS_STOCKS", "UNKNOWN")]
        [PSCustomObject]
        ${VarError}
    )

    Process {
        'Creating PSCustomObject: ympa_powershell_client => AddOffersToArchiveErrorDTO' | Write-Debug
...
Convert from JSON to AddOffersToArchiveErrorDTO<PSCustomObject>
...
AddOffersToArchiveErrorDTO<PSCustomObject>
#>
function ConvertFrom-JsonToAddOffersToArchiveErrorDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: ympa_powershell_client => AddOffersToArchiveErrorDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AddOffersToArchiveErrorDTO
        $AllProperties = ("offerId", "error")
