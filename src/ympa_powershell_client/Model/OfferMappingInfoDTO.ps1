...
OfferMappingInfoDTO<PSCustomObject>
#>

function Initialize-OfferMappingInfoDTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: ympa_powershell_client => OfferMappingInfoDTO' | Write-Debug
...
Convert from JSON to OfferMappingInfoDTO<PSCustomObject>
...
OfferMappingInfoDTO<PSCustomObject>
#>
function ConvertFrom-JsonToOfferMappingInfoDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: ympa_powershell_client => OfferMappingInfoDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in OfferMappingInfoDTO
        $AllProperties = ("mapping", "awaitingModerationMapping", "rejectedMapping")
