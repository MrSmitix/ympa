...
MappingsOfferInfoDTO<PSCustomObject>
#>

function Initialize-MappingsOfferInfoDTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: ympa_powershell_client => MappingsOfferInfoDTO' | Write-Debug
...
Convert from JSON to MappingsOfferInfoDTO<PSCustomObject>
...
MappingsOfferInfoDTO<PSCustomObject>
#>
function ConvertFrom-JsonToMappingsOfferInfoDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: ympa_powershell_client => MappingsOfferInfoDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in MappingsOfferInfoDTO
