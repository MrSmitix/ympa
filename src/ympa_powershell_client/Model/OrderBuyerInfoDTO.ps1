...
OrderBuyerInfoDTO<PSCustomObject>
#>

function Initialize-OrderBuyerInfoDTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: ympa_powershell_client => OrderBuyerInfoDTO' | Write-Debug
...
Convert from JSON to OrderBuyerInfoDTO<PSCustomObject>
...
OrderBuyerInfoDTO<PSCustomObject>
#>
function ConvertFrom-JsonToOrderBuyerInfoDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: ympa_powershell_client => OrderBuyerInfoDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in OrderBuyerInfoDTO
        $AllProperties = ("id", "lastName", "firstName", "middleName", "type", "phone")
