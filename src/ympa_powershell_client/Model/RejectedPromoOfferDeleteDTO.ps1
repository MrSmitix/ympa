...
RejectedPromoOfferDeleteDTO<PSCustomObject>
#>

function Initialize-RejectedPromoOfferDeleteDTO {
    [CmdletBinding()]
    Param (
        ...
        [ValidateSet("OFFER_DOES_NOT_EXIST")]
        [PSCustomObject]
        ${Reason}
    )

    Process {
        'Creating PSCustomObject: ympa_powershell_client => RejectedPromoOfferDeleteDTO' | Write-Debug
...
Convert from JSON to RejectedPromoOfferDeleteDTO<PSCustomObject>
...
RejectedPromoOfferDeleteDTO<PSCustomObject>
#>
function ConvertFrom-JsonToRejectedPromoOfferDeleteDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: ympa_powershell_client => RejectedPromoOfferDeleteDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in RejectedPromoOfferDeleteDTO
