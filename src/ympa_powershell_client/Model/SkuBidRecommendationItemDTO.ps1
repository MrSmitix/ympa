...
.PARAMETER PriceRecommendations
Рекомендованные цены.
.OUTPUTS

SkuBidRecommendationItemDTO<PSCustomObject>
#>

function Initialize-SkuBidRecommendationItemDTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: ympa_powershell_client => SkuBidRecommendationItemDTO' | Write-Debug
...
Convert from JSON to SkuBidRecommendationItemDTO<PSCustomObject>
...
SkuBidRecommendationItemDTO<PSCustomObject>
#>
function ConvertFrom-JsonToSkuBidRecommendationItemDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: ympa_powershell_client => SkuBidRecommendationItemDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SkuBidRecommendationItemDTO
        $AllProperties = ("sku", "bid", "bidRecommendations", "priceRecommendations")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "bidRecommendations"))) { #optional property not found
            $BidRecommendations = $null
        } else {
            $BidRecommendations = $JsonParameters.PSobject.Properties["bidRecommendations"].value
        }

        if (!([bool]($JsonParameters.PSobject.Properties.name -match "priceRecommendations"))) { #optional property not found
            $PriceRecommendations = $null
        } else {
            $PriceRecommendations = $JsonParameters.PSobject.Properties["priceRecommendations"].value
        }
