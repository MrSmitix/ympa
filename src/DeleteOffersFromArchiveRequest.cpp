...
void
DeleteOffersFromArchiveRequest::__init()
{
	//new std::list()std::list> offerIds;
}

void
DeleteOffersFromArchiveRequest::__cleanup()
{
	//if(offerIds != NULL) {
...
void
DeleteOffersFromArchiveRequest::fromJson(char* jsonStr)
{
...
DeleteOffersFromArchiveRequest::DeleteOffersFromArchiveRequest(char* json)
{
	this->fromJson(json);
}
