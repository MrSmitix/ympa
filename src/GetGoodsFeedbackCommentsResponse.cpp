...
void
GetGoodsFeedbackCommentsResponse::__init()
{
	//status = new ApiResponseStatusType();
	//result = new GoodsFeedbackCommentListDTO();
}

void
GetGoodsFeedbackCommentsResponse::__cleanup()
{
	//if(status != NULL) {
	//
	//delete status;
...
void
GetGoodsFeedbackCommentsResponse::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
		...
		if (isprimitive("GoodsFeedbackCommentListDTO")) {
			jsonToValue(&result, node, "GoodsFeedbackCommentListDTO", "GoodsFeedbackCommentListDTO");
		} else {
			
			GoodsFeedbackCommentListDTO* obj = static_cast<GoodsFeedbackCommentListDTO*> (&result);
			obj->fromJson(json_to_string(node, false));
...
GetGoodsFeedbackCommentsResponse::GetGoodsFeedbackCommentsResponse(char* json)
{
	this->fromJson(json);
}
...
GetGoodsFeedbackCommentsResponse::toJson()
{
	...
	if (isprimitive("GoodsFeedbackCommentListDTO")) {
		GoodsFeedbackCommentListDTO obj = getResult();
		node = converttoJson(&obj, "GoodsFeedbackCommentListDTO", "");
	}
	else {
		
		GoodsFeedbackCommentListDTO obj = static_cast<GoodsFeedbackCommentListDTO> (getResult());
		GError *mygerror;
		mygerror = NULL;
		node = json_from_string(obj.toJson(), &mygerror);
