  ...
  class ExpressApi
    ...
    def add_hidden_offers_with_http_info(campaign_id : Int64, add_hidden_offers_request : AddHiddenOffersRequest)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.add_hidden_offers ..."}
      end
      # verify the required parameter "campaign_id" is set
      if @api_client.config.client_side_validation && campaign_id.nil?
        raise ArgumentError.new("Missing the required parameter 'campaign_id' when calling ExpressApi.add_hidden_offers")
      end
      ...
      if @api_client.config.client_side_validation && add_hidden_offers_request.nil?
        raise ArgumentError.new("Missing the required parameter 'add_hidden_offers_request' when calling ExpressApi.add_hidden_offers")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#add_hidden_offers\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    def add_offers_to_archive_with_http_info(business_id : Int64, add_offers_to_archive_request : AddOffersToArchiveRequest)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.add_offers_to_archive ..."}
      end
      # verify the required parameter "business_id" is set
      if @api_client.config.client_side_validation && business_id.nil?
        raise ArgumentError.new("Missing the required parameter 'business_id' when calling ExpressApi.add_offers_to_archive")
      end
      ...
      if @api_client.config.client_side_validation && add_offers_to_archive_request.nil?
        raise ArgumentError.new("Missing the required parameter 'add_offers_to_archive_request' when calling ExpressApi.add_offers_to_archive")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"ExpressApi.add_offers_to_archive",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#add_offers_to_archive\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    def calculate_tariffs_with_http_info(calculate_tariffs_request : CalculateTariffsRequest)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.calculate_tariffs ..."}
      end
      ...
      if @api_client.config.client_side_validation && calculate_tariffs_request.nil?
        raise ArgumentError.new("Missing the required parameter 'calculate_tariffs_request' when calling ExpressApi.calculate_tariffs")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#calculate_tariffs\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    def confirm_business_prices_with_http_info(business_id : Int64, confirm_prices_request : ConfirmPricesRequest)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.confirm_business_prices ..."}
      end
      # verify the required parameter "business_id" is set
      if @api_client.config.client_side_validation && business_id.nil?
        raise ArgumentError.new("Missing the required parameter 'business_id' when calling ExpressApi.confirm_business_prices")
      end
      ...
      if @api_client.config.client_side_validation && confirm_prices_request.nil?
        raise ArgumentError.new("Missing the required parameter 'confirm_prices_request' when calling ExpressApi.confirm_business_prices")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"ExpressApi.confirm_business_prices",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#confirm_business_prices\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return EmptyApiResponse.from_json(data), status_code, headers
    end
    ...
    def confirm_campaign_prices_with_http_info(campaign_id : Int64, confirm_prices_request : ConfirmPricesRequest)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.confirm_campaign_prices ..."}
      end
      # verify the required parameter "campaign_id" is set
      if @api_client.config.client_side_validation && campaign_id.nil?
        raise ArgumentError.new("Missing the required parameter 'campaign_id' when calling ExpressApi.confirm_campaign_prices")
      end
      # verify the required parameter "confirm_prices_request" is set
      if @api_client.config.client_side_validation && confirm_prices_request.nil?
        raise ArgumentError.new("Missing the required parameter 'confirm_prices_request' when calling ExpressApi.confirm_campaign_prices")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"ExpressApi.confirm_campaign_prices",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#confirm_campaign_prices\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return EmptyApiResponse.from_json(data), status_code, headers
    end
    ...
    def create_chat_with_http_info(business_id : Int64, create_chat_request : CreateChatRequest)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.create_chat ..."}
      end
      # verify the required parameter "business_id" is set
      if @api_client.config.client_side_validation && business_id.nil?
        raise ArgumentError.new("Missing the required parameter 'business_id' when calling ExpressApi.create_chat")
      end
      ...
      if @api_client.config.client_side_validation && create_chat_request.nil?
        raise ArgumentError.new("Missing the required parameter 'create_chat_request' when calling ExpressApi.create_chat")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#create_chat\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    def delete_campaign_offers_with_http_info(campaign_id : Int64, delete_campaign_offers_request : DeleteCampaignOffersRequest)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.delete_campaign_offers ..."}
      end
      # verify the required parameter "campaign_id" is set
      if @api_client.config.client_side_validation && campaign_id.nil?
        raise ArgumentError.new("Missing the required parameter 'campaign_id' when calling ExpressApi.delete_campaign_offers")
      end
      ...
      if @api_client.config.client_side_validation && delete_campaign_offers_request.nil?
        raise ArgumentError.new("Missing the required parameter 'delete_campaign_offers_request' when calling ExpressApi.delete_campaign_offers")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"ExpressApi.delete_campaign_offers",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#delete_campaign_offers\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    def delete_goods_feedback_comment_with_http_info(business_id : Int64, delete_goods_feedback_comment_request : DeleteGoodsFeedbackCommentRequest)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.delete_goods_feedback_comment ..."}
      end
      # verify the required parameter "business_id" is set
      if @api_client.config.client_side_validation && business_id.nil?
        raise ArgumentError.new("Missing the required parameter 'business_id' when calling ExpressApi.delete_goods_feedback_comment")
      end
      ...
      if @api_client.config.client_side_validation && delete_goods_feedback_comment_request.nil?
        raise ArgumentError.new("Missing the required parameter 'delete_goods_feedback_comment_request' when calling ExpressApi.delete_goods_feedback_comment")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"ExpressApi.delete_goods_feedback_comment",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#delete_goods_feedback_comment\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return EmptyApiResponse.from_json(data), status_code, headers
    end
    ...
    def delete_hidden_offers_with_http_info(campaign_id : Int64, delete_hidden_offers_request : DeleteHiddenOffersRequest)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.delete_hidden_offers ..."}
      end
      # verify the required parameter "campaign_id" is set
      if @api_client.config.client_side_validation && campaign_id.nil?
        raise ArgumentError.new("Missing the required parameter 'campaign_id' when calling ExpressApi.delete_hidden_offers")
      end
      ...
      if @api_client.config.client_side_validation && delete_hidden_offers_request.nil?
        raise ArgumentError.new("Missing the required parameter 'delete_hidden_offers_request' when calling ExpressApi.delete_hidden_offers")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"ExpressApi.delete_hidden_offers",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#delete_hidden_offers\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return EmptyApiResponse.from_json(data), status_code, headers
    end
    ...
    def delete_offers_with_http_info(business_id : Int64, delete_offers_request : DeleteOffersRequest)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.delete_offers ..."}
      end
      # verify the required parameter "business_id" is set
      if @api_client.config.client_side_validation && business_id.nil?
        raise ArgumentError.new("Missing the required parameter 'business_id' when calling ExpressApi.delete_offers")
      end
      ...
      if @api_client.config.client_side_validation && delete_offers_request.nil?
        raise ArgumentError.new("Missing the required parameter 'delete_offers_request' when calling ExpressApi.delete_offers")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#delete_offers\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    def delete_offers_from_archive_with_http_info(business_id : Int64, delete_offers_from_archive_request : DeleteOffersFromArchiveRequest)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.delete_offers_from_archive ..."}
      end
      # verify the required parameter "business_id" is set
      if @api_client.config.client_side_validation && business_id.nil?
        raise ArgumentError.new("Missing the required parameter 'business_id' when calling ExpressApi.delete_offers_from_archive")
      end
      ...
      if @api_client.config.client_side_validation && delete_offers_from_archive_request.nil?
        raise ArgumentError.new("Missing the required parameter 'delete_offers_from_archive_request' when calling ExpressApi.delete_offers_from_archive")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"ExpressApi.delete_offers_from_archive",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#delete_offers_from_archive\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    def delete_promo_offers_with_http_info(business_id : Int64, delete_promo_offers_request : DeletePromoOffersRequest)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.delete_promo_offers ..."}
      end
      # verify the required parameter "business_id" is set
      if @api_client.config.client_side_validation && business_id.nil?
        raise ArgumentError.new("Missing the required parameter 'business_id' when calling ExpressApi.delete_promo_offers")
      end
      ...
      if @api_client.config.client_side_validation && delete_promo_offers_request.nil?
        raise ArgumentError.new("Missing the required parameter 'delete_promo_offers_request' when calling ExpressApi.delete_promo_offers")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"ExpressApi.delete_promo_offers",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#delete_promo_offers\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    def generate_boost_consolidated_report_with_http_info(generate_boost_consolidated_request : GenerateBoostConsolidatedRequest, format : ReportFormatType?)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.generate_boost_consolidated_report ..."}
      end
      ...
      if @api_client.config.client_side_validation && generate_boost_consolidated_request.nil?
        raise ArgumentError.new("Missing the required parameter 'generate_boost_consolidated_request' when calling ExpressApi.generate_boost_consolidated_report")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"ExpressApi.generate_boost_consolidated_report",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#generate_boost_consolidated_report\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    def generate_competitors_position_report_with_http_info(generate_competitors_position_report_request : GenerateCompetitorsPositionReportRequest, format : ReportFormatType?)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.generate_competitors_position_report ..."}
      end
      ...
      if @api_client.config.client_side_validation && generate_competitors_position_report_request.nil?
        raise ArgumentError.new("Missing the required parameter 'generate_competitors_position_report_request' when calling ExpressApi.generate_competitors_position_report")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"ExpressApi.generate_competitors_position_report",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#generate_competitors_position_report\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return GenerateReportResponse.from_json(data), status_code, headers
    end
    ...
    def generate_goods_feedback_report_with_http_info(generate_goods_feedback_request : GenerateGoodsFeedbackRequest, format : ReportFormatType?)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.generate_goods_feedback_report ..."}
      end
      ...
      if @api_client.config.client_side_validation && generate_goods_feedback_request.nil?
        raise ArgumentError.new("Missing the required parameter 'generate_goods_feedback_request' when calling ExpressApi.generate_goods_feedback_report")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"ExpressApi.generate_goods_feedback_report",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#generate_goods_feedback_report\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return GenerateReportResponse.from_json(data), status_code, headers
    end
    ...
    def generate_goods_realization_report_with_http_info(generate_goods_realization_report_request : GenerateGoodsRealizationReportRequest, format : ReportFormatType?)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.generate_goods_realization_report ..."}
      end
      ...
      if @api_client.config.client_side_validation && generate_goods_realization_report_request.nil?
        raise ArgumentError.new("Missing the required parameter 'generate_goods_realization_report_request' when calling ExpressApi.generate_goods_realization_report")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"ExpressApi.generate_goods_realization_report",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#generate_goods_realization_report\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return GenerateReportResponse.from_json(data), status_code, headers
    end
    ...
    def generate_mass_order_labels_report_with_http_info(generate_mass_order_labels_request : GenerateMassOrderLabelsRequest, format : PageFormatType?)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.generate_mass_order_labels_report ..."}
      end
      ...
      if @api_client.config.client_side_validation && generate_mass_order_labels_request.nil?
        raise ArgumentError.new("Missing the required parameter 'generate_mass_order_labels_request' when calling ExpressApi.generate_mass_order_labels_report")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"ExpressApi.generate_mass_order_labels_report",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#generate_mass_order_labels_report\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return GenerateReportResponse.from_json(data), status_code, headers
    end
    ...
    def generate_order_label_with_http_info(campaign_id : Int64, order_id : Int64, shipment_id : Int64, box_id : Int64, format : PageFormatType?)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.generate_order_label ..."}
      end
      # verify the required parameter "campaign_id" is set
      if @api_client.config.client_side_validation && campaign_id.nil?
        raise ArgumentError.new("Missing the required parameter 'campaign_id' when calling ExpressApi.generate_order_label")
      end
      # verify the required parameter "order_id" is set
      if @api_client.config.client_side_validation && order_id.nil?
        raise ArgumentError.new("Missing the required parameter 'order_id' when calling ExpressApi.generate_order_label")
      end
      # verify the required parameter "shipment_id" is set
      if @api_client.config.client_side_validation && shipment_id.nil?
        raise ArgumentError.new("Missing the required parameter 'shipment_id' when calling ExpressApi.generate_order_label")
      end
      # verify the required parameter "box_id" is set
      if @api_client.config.client_side_validation && box_id.nil?
        raise ArgumentError.new("Missing the required parameter 'box_id' when calling ExpressApi.generate_order_label")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        local_var_path,
                                                        :"ExpressApi.generate_order_label",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#generate_order_label\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    def generate_order_labels_with_http_info(campaign_id : Int64, order_id : Int64, format : PageFormatType?)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.generate_order_labels ..."}
      end
      # verify the required parameter "campaign_id" is set
      if @api_client.config.client_side_validation && campaign_id.nil?
        raise ArgumentError.new("Missing the required parameter 'campaign_id' when calling ExpressApi.generate_order_labels")
      end
      # verify the required parameter "order_id" is set
      if @api_client.config.client_side_validation && order_id.nil?
        raise ArgumentError.new("Missing the required parameter 'order_id' when calling ExpressApi.generate_order_labels")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        local_var_path,
                                                        :"ExpressApi.generate_order_labels",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#generate_order_labels\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return ::File.from_json(data), status_code, headers
    end
    ...
    def generate_prices_report_with_http_info(generate_prices_report_request : GeneratePricesReportRequest, format : ReportFormatType?)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.generate_prices_report ..."}
      end
      ...
      if @api_client.config.client_side_validation && generate_prices_report_request.nil?
        raise ArgumentError.new("Missing the required parameter 'generate_prices_report_request' when calling ExpressApi.generate_prices_report")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"ExpressApi.generate_prices_report",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#generate_prices_report\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return GenerateReportResponse.from_json(data), status_code, headers
    end
    ...
    def generate_shelfs_statistics_report_with_http_info(generate_shelfs_statistics_request : GenerateShelfsStatisticsRequest, format : ReportFormatType?)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.generate_shelfs_statistics_report ..."}
      end
      ...
      if @api_client.config.client_side_validation && generate_shelfs_statistics_request.nil?
        raise ArgumentError.new("Missing the required parameter 'generate_shelfs_statistics_request' when calling ExpressApi.generate_shelfs_statistics_report")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"ExpressApi.generate_shelfs_statistics_report",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#generate_shelfs_statistics_report\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return GenerateReportResponse.from_json(data), status_code, headers
    end
    ...
    def generate_shows_sales_report_with_http_info(generate_shows_sales_report_request : GenerateShowsSalesReportRequest, format : ReportFormatType?)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.generate_shows_sales_report ..."}
      end
      ...
      if @api_client.config.client_side_validation && generate_shows_sales_report_request.nil?
        raise ArgumentError.new("Missing the required parameter 'generate_shows_sales_report_request' when calling ExpressApi.generate_shows_sales_report")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"ExpressApi.generate_shows_sales_report",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#generate_shows_sales_report\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return GenerateReportResponse.from_json(data), status_code, headers
    end
    ...
    def generate_stocks_on_warehouses_report_with_http_info(generate_stocks_on_warehouses_report_request : GenerateStocksOnWarehousesReportRequest, format : ReportFormatType?)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.generate_stocks_on_warehouses_report ..."}
      end
      ...
      if @api_client.config.client_side_validation && generate_stocks_on_warehouses_report_request.nil?
        raise ArgumentError.new("Missing the required parameter 'generate_stocks_on_warehouses_report_request' when calling ExpressApi.generate_stocks_on_warehouses_report")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"ExpressApi.generate_stocks_on_warehouses_report",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#generate_stocks_on_warehouses_report\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return GenerateReportResponse.from_json(data), status_code, headers
    end
    ...
    def generate_united_marketplace_services_report_with_http_info(generate_united_marketplace_services_report_request : GenerateUnitedMarketplaceServicesReportRequest, format : ReportFormatType?)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.generate_united_marketplace_services_report ..."}
      end
      ...
      if @api_client.config.client_side_validation && generate_united_marketplace_services_report_request.nil?
        raise ArgumentError.new("Missing the required parameter 'generate_united_marketplace_services_report_request' when calling ExpressApi.generate_united_marketplace_services_report")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"ExpressApi.generate_united_marketplace_services_report",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#generate_united_marketplace_services_report\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return GenerateReportResponse.from_json(data), status_code, headers
    end
    ...
    def generate_united_netting_report_with_http_info(generate_united_netting_report_request : GenerateUnitedNettingReportRequest, format : ReportFormatType?)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.generate_united_netting_report ..."}
      end
      ...
      if @api_client.config.client_side_validation && generate_united_netting_report_request.nil?
        raise ArgumentError.new("Missing the required parameter 'generate_united_netting_report_request' when calling ExpressApi.generate_united_netting_report")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"ExpressApi.generate_united_netting_report",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#generate_united_netting_report\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return GenerateReportResponse.from_json(data), status_code, headers
    end
    ...
    def generate_united_orders_report_with_http_info(generate_united_orders_request : GenerateUnitedOrdersRequest, format : ReportFormatType?)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.generate_united_orders_report ..."}
      end
      ...
      if @api_client.config.client_side_validation && generate_united_orders_request.nil?
        raise ArgumentError.new("Missing the required parameter 'generate_united_orders_request' when calling ExpressApi.generate_united_orders_report")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"ExpressApi.generate_united_orders_report",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#generate_united_orders_report\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return GenerateReportResponse.from_json(data), status_code, headers
    end
    ...
    def get_all_offers_with_http_info(campaign_id : Int64, feed_id : Int64?, chunk : Int32?)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.get_all_offers ..."}
      end
      # verify the required parameter "campaign_id" is set
      if @api_client.config.client_side_validation && campaign_id.nil?
        raise ArgumentError.new("Missing the required parameter 'campaign_id' when calling ExpressApi.get_all_offers")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#get_all_offers\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    def get_bids_info_for_business_with_http_info(business_id : Int64, page_token : String?, limit : Int32?, get_bids_info_request : GetBidsInfoRequest?)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.get_bids_info_for_business ..."}
      end
      # verify the required parameter "business_id" is set
      if @api_client.config.client_side_validation && business_id.nil?
        raise ArgumentError.new("Missing the required parameter 'business_id' when calling ExpressApi.get_bids_info_for_business")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"ExpressApi.get_bids_info_for_business",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#get_bids_info_for_business\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    def get_bids_recommendations_with_http_info(business_id : Int64, get_bids_recommendations_request : GetBidsRecommendationsRequest)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.get_bids_recommendations ..."}
      end
      # verify the required parameter "business_id" is set
      if @api_client.config.client_side_validation && business_id.nil?
        raise ArgumentError.new("Missing the required parameter 'business_id' when calling ExpressApi.get_bids_recommendations")
      end
      ...
      if @api_client.config.client_side_validation && get_bids_recommendations_request.nil?
        raise ArgumentError.new("Missing the required parameter 'get_bids_recommendations_request' when calling ExpressApi.get_bids_recommendations")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"ExpressApi.get_bids_recommendations",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#get_bids_recommendations\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    def get_business_quarantine_offers_with_http_info(business_id : Int64, get_quarantine_offers_request : GetQuarantineOffersRequest, page_token : String?, limit : Int32?)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.get_business_quarantine_offers ..."}
      end
      # verify the required parameter "business_id" is set
      if @api_client.config.client_side_validation && business_id.nil?
        raise ArgumentError.new("Missing the required parameter 'business_id' when calling ExpressApi.get_business_quarantine_offers")
      end
      ...
      if @api_client.config.client_side_validation && get_quarantine_offers_request.nil?
        raise ArgumentError.new("Missing the required parameter 'get_quarantine_offers_request' when calling ExpressApi.get_business_quarantine_offers")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"ExpressApi.get_business_quarantine_offers",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#get_business_quarantine_offers\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    def get_business_settings_with_http_info(business_id : Int64)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.get_business_settings ..."}
      end
      # verify the required parameter "business_id" is set
      if @api_client.config.client_side_validation && business_id.nil?
        raise ArgumentError.new("Missing the required parameter 'business_id' when calling ExpressApi.get_business_settings")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"ExpressApi.get_business_settings",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#get_business_settings\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    def get_campaign_with_http_info(campaign_id : Int64)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.get_campaign ..."}
      end
      # verify the required parameter "campaign_id" is set
      if @api_client.config.client_side_validation && campaign_id.nil?
        raise ArgumentError.new("Missing the required parameter 'campaign_id' when calling ExpressApi.get_campaign")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#get_campaign\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    def get_campaign_logins_with_http_info(campaign_id : Int64)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.get_campaign_logins ..."}
      end
      # verify the required parameter "campaign_id" is set
      if @api_client.config.client_side_validation && campaign_id.nil?
        raise ArgumentError.new("Missing the required parameter 'campaign_id' when calling ExpressApi.get_campaign_logins")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        local_var_path,
                                                        :"ExpressApi.get_campaign_logins",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#get_campaign_logins\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    def get_campaign_offers_with_http_info(campaign_id : Int64, get_campaign_offers_request : GetCampaignOffersRequest, page_token : String?, limit : Int32?)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.get_campaign_offers ..."}
      end
      # verify the required parameter "campaign_id" is set
      if @api_client.config.client_side_validation && campaign_id.nil?
        raise ArgumentError.new("Missing the required parameter 'campaign_id' when calling ExpressApi.get_campaign_offers")
      end
      ...
      if @api_client.config.client_side_validation && get_campaign_offers_request.nil?
        raise ArgumentError.new("Missing the required parameter 'get_campaign_offers_request' when calling ExpressApi.get_campaign_offers")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"ExpressApi.get_campaign_offers",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#get_campaign_offers\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    def get_campaign_quarantine_offers_with_http_info(campaign_id : Int64, get_quarantine_offers_request : GetQuarantineOffersRequest, page_token : String?, limit : Int32?)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.get_campaign_quarantine_offers ..."}
      end
      # verify the required parameter "campaign_id" is set
      if @api_client.config.client_side_validation && campaign_id.nil?
        raise ArgumentError.new("Missing the required parameter 'campaign_id' when calling ExpressApi.get_campaign_quarantine_offers")
      end
      # verify the required parameter "get_quarantine_offers_request" is set
      if @api_client.config.client_side_validation && get_quarantine_offers_request.nil?
        raise ArgumentError.new("Missing the required parameter 'get_quarantine_offers_request' when calling ExpressApi.get_campaign_quarantine_offers")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"ExpressApi.get_campaign_quarantine_offers",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#get_campaign_quarantine_offers\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return GetQuarantineOffersResponse.from_json(data), status_code, headers
    end
    ...
    def get_campaign_region_with_http_info(campaign_id : Int64)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.get_campaign_region ..."}
      end
      # verify the required parameter "campaign_id" is set
      if @api_client.config.client_side_validation && campaign_id.nil?
        raise ArgumentError.new("Missing the required parameter 'campaign_id' when calling ExpressApi.get_campaign_region")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        local_var_path,
                                                        :"ExpressApi.get_campaign_region",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#get_campaign_region\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    def get_campaign_settings_with_http_info(campaign_id : Int64)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.get_campaign_settings ..."}
      end
      # verify the required parameter "campaign_id" is set
      if @api_client.config.client_side_validation && campaign_id.nil?
        raise ArgumentError.new("Missing the required parameter 'campaign_id' when calling ExpressApi.get_campaign_settings")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        local_var_path,
                                                        :"ExpressApi.get_campaign_settings",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#get_campaign_settings\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    def get_campaigns_with_http_info(page : Int32?, page_size : Int32?)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.get_campaigns ..."}
      end
      if @api_client.config.client_side_validation && !page.nil? && page > 10000
        raise ArgumentError.new("invalid value for \"page\" when calling ExpressApi.get_campaigns, must be smaller than or equal to 10000.")
      end
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#get_campaigns\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    def get_campaigns_by_login_with_http_info(login : String, page : Int32?, page_size : Int32?)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.get_campaigns_by_login ..."}
      end
      # verify the required parameter "login" is set
      if @api_client.config.client_side_validation && login.nil?
        raise ArgumentError.new("Missing the required parameter 'login' when calling ExpressApi.get_campaigns_by_login")
      end
      if @api_client.config.client_side_validation && !page.nil? && page > 10000
        raise ArgumentError.new("invalid value for \"page\" when calling ExpressApi.get_campaigns_by_login, must be smaller than or equal to 10000.")
      end
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        local_var_path,
                                                        :"ExpressApi.get_campaigns_by_login",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#get_campaigns_by_login\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return GetCampaignsResponse.from_json(data), status_code, headers
    end
    ...
    def get_categories_max_sale_quantum_with_http_info(get_categories_max_sale_quantum_request : GetCategoriesMaxSaleQuantumRequest)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.get_categories_max_sale_quantum ..."}
      end
      ...
      if @api_client.config.client_side_validation && get_categories_max_sale_quantum_request.nil?
        raise ArgumentError.new("Missing the required parameter 'get_categories_max_sale_quantum_request' when calling ExpressApi.get_categories_max_sale_quantum")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"ExpressApi.get_categories_max_sale_quantum",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#get_categories_max_sale_quantum\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    def get_categories_tree_with_http_info(get_categories_request : GetCategoriesRequest?)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.get_categories_tree ..."}
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"ExpressApi.get_categories_tree",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#get_categories_tree\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    def get_category_content_parameters_with_http_info(category_id : Int64)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.get_category_content_parameters ..."}
      end
      # verify the required parameter "category_id" is set
      if @api_client.config.client_side_validation && category_id.nil?
        raise ArgumentError.new("Missing the required parameter 'category_id' when calling ExpressApi.get_category_content_parameters")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"ExpressApi.get_category_content_parameters",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#get_category_content_parameters\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    def get_chat_history_with_http_info(business_id : Int64, chat_id : Int64, get_chat_history_request : GetChatHistoryRequest, page_token : String?, limit : Int32?)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.get_chat_history ..."}
      end
      # verify the required parameter "business_id" is set
      if @api_client.config.client_side_validation && business_id.nil?
        raise ArgumentError.new("Missing the required parameter 'business_id' when calling ExpressApi.get_chat_history")
      end
      # verify the required parameter "chat_id" is set
      if @api_client.config.client_side_validation && chat_id.nil?
        raise ArgumentError.new("Missing the required parameter 'chat_id' when calling ExpressApi.get_chat_history")
      end
      ...
      if @api_client.config.client_side_validation && get_chat_history_request.nil?
        raise ArgumentError.new("Missing the required parameter 'get_chat_history_request' when calling ExpressApi.get_chat_history")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#get_chat_history\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    def get_chats_with_http_info(business_id : Int64, get_chats_request : GetChatsRequest, page_token : String?, limit : Int32?)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.get_chats ..."}
      end
      # verify the required parameter "business_id" is set
      if @api_client.config.client_side_validation && business_id.nil?
        raise ArgumentError.new("Missing the required parameter 'business_id' when calling ExpressApi.get_chats")
      end
      # verify the required parameter "get_chats_request" is set
      if @api_client.config.client_side_validation && get_chats_request.nil?
        raise ArgumentError.new("Missing the required parameter 'get_chats_request' when calling ExpressApi.get_chats")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#get_chats\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    def get_delivery_services_with_http_info()
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.get_delivery_services ..."}
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        local_var_path,
                                                        :"ExpressApi.get_delivery_services",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#get_delivery_services\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    def get_feed_with_http_info(campaign_id : Int64, feed_id : Int64)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.get_feed ..."}
      end
      # verify the required parameter "campaign_id" is set
      if @api_client.config.client_side_validation && campaign_id.nil?
        raise ArgumentError.new("Missing the required parameter 'campaign_id' when calling ExpressApi.get_feed")
      end
      # verify the required parameter "feed_id" is set
      if @api_client.config.client_side_validation && feed_id.nil?
        raise ArgumentError.new("Missing the required parameter 'feed_id' when calling ExpressApi.get_feed")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#get_feed\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    def get_feed_index_logs_with_http_info(campaign_id : Int64, feed_id : Int64, limit : Int32?, published_time_from : Time?, published_time_to : Time?, status : FeedIndexLogsStatusType?)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.get_feed_index_logs ..."}
      end
      # verify the required parameter "campaign_id" is set
      if @api_client.config.client_side_validation && campaign_id.nil?
        raise ArgumentError.new("Missing the required parameter 'campaign_id' when calling ExpressApi.get_feed_index_logs")
      end
      # verify the required parameter "feed_id" is set
      if @api_client.config.client_side_validation && feed_id.nil?
        raise ArgumentError.new("Missing the required parameter 'feed_id' when calling ExpressApi.get_feed_index_logs")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        local_var_path,
                                                        :"ExpressApi.get_feed_index_logs",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#get_feed_index_logs\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    def get_feedback_and_comment_updates_with_http_info(campaign_id : Int64, page_token : String?, limit : Int32?, from_date : Time?)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.get_feedback_and_comment_updates ..."}
      end
      # verify the required parameter "campaign_id" is set
      if @api_client.config.client_side_validation && campaign_id.nil?
        raise ArgumentError.new("Missing the required parameter 'campaign_id' when calling ExpressApi.get_feedback_and_comment_updates")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        local_var_path,
                                                        :"ExpressApi.get_feedback_and_comment_updates",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#get_feedback_and_comment_updates\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    def get_feeds_with_http_info(campaign_id : Int64)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.get_feeds ..."}
      end
      # verify the required parameter "campaign_id" is set
      if @api_client.config.client_side_validation && campaign_id.nil?
        raise ArgumentError.new("Missing the required parameter 'campaign_id' when calling ExpressApi.get_feeds")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#get_feeds\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    def get_goods_feedback_comments_with_http_info(business_id : Int64, get_goods_feedback_comments_request : GetGoodsFeedbackCommentsRequest, page_token : String?, limit : Int32?)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.get_goods_feedback_comments ..."}
      end
      # verify the required parameter "business_id" is set
      if @api_client.config.client_side_validation && business_id.nil?
        raise ArgumentError.new("Missing the required parameter 'business_id' when calling ExpressApi.get_goods_feedback_comments")
      end
      ...
      if @api_client.config.client_side_validation && get_goods_feedback_comments_request.nil?
        raise ArgumentError.new("Missing the required parameter 'get_goods_feedback_comments_request' when calling ExpressApi.get_goods_feedback_comments")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"ExpressApi.get_goods_feedback_comments",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#get_goods_feedback_comments\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    def get_goods_feedbacks_with_http_info(business_id : Int64, page_token : String?, limit : Int32?, get_goods_feedback_request : GetGoodsFeedbackRequest?)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.get_goods_feedbacks ..."}
      end
      # verify the required parameter "business_id" is set
      if @api_client.config.client_side_validation && business_id.nil?
        raise ArgumentError.new("Missing the required parameter 'business_id' when calling ExpressApi.get_goods_feedbacks")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"ExpressApi.get_goods_feedbacks",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#get_goods_feedbacks\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    def get_goods_stats_with_http_info(campaign_id : Int64, get_goods_stats_request : GetGoodsStatsRequest)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.get_goods_stats ..."}
      end
      # verify the required parameter "campaign_id" is set
      if @api_client.config.client_side_validation && campaign_id.nil?
        raise ArgumentError.new("Missing the required parameter 'campaign_id' when calling ExpressApi.get_goods_stats")
      end
      ...
      if @api_client.config.client_side_validation && get_goods_stats_request.nil?
        raise ArgumentError.new("Missing the required parameter 'get_goods_stats_request' when calling ExpressApi.get_goods_stats")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#get_goods_stats\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    def get_hidden_offers_with_http_info(campaign_id : Int64, offer_id : Array(String)?, page_token : String?, limit : Int32?, offset : Int32?, page : Int32?, page_size : Int32?)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.get_hidden_offers ..."}
      end
      # verify the required parameter "campaign_id" is set
      if @api_client.config.client_side_validation && campaign_id.nil?
        raise ArgumentError.new("Missing the required parameter 'campaign_id' when calling ExpressApi.get_hidden_offers")
      end
      if @api_client.config.client_side_validation && !page.nil? && page > 10000
        raise ArgumentError.new("invalid value for \"page\" when calling ExpressApi.get_hidden_offers, must be smaller than or equal to 10000.")
      end
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#get_hidden_offers\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    def get_offer_cards_content_status_with_http_info(business_id : Int64, page_token : String?, limit : Int32?, get_offer_cards_content_status_request : GetOfferCardsContentStatusRequest?)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.get_offer_cards_content_status ..."}
      end
      # verify the required parameter "business_id" is set
      if @api_client.config.client_side_validation && business_id.nil?
        raise ArgumentError.new("Missing the required parameter 'business_id' when calling ExpressApi.get_offer_cards_content_status")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"ExpressApi.get_offer_cards_content_status",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#get_offer_cards_content_status\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    def get_offer_mapping_entries_with_http_info(campaign_id : Int64, offer_id : Array(String)?, shop_sku : Array(String)?, mapping_kind : OfferMappingKindType?, status : Array(OfferProcessingStatusType)?, availability : Array(OfferAvailabilityStatusType)?, category_id : Array(Int32)?, vendor : Array(String)?, page_token : String?, limit : Int32?)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.get_offer_mapping_entries ..."}
      end
      # verify the required parameter "campaign_id" is set
      if @api_client.config.client_side_validation && campaign_id.nil?
        raise ArgumentError.new("Missing the required parameter 'campaign_id' when calling ExpressApi.get_offer_mapping_entries")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        local_var_path,
                                                        :"ExpressApi.get_offer_mapping_entries",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#get_offer_mapping_entries\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    def get_offer_mappings_with_http_info(business_id : Int64, page_token : String?, limit : Int32?, get_offer_mappings_request : GetOfferMappingsRequest?)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.get_offer_mappings ..."}
      end
      # verify the required parameter "business_id" is set
      if @api_client.config.client_side_validation && business_id.nil?
        raise ArgumentError.new("Missing the required parameter 'business_id' when calling ExpressApi.get_offer_mappings")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#get_offer_mappings\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    def get_offer_recommendations_with_http_info(business_id : Int64, get_offer_recommendations_request : GetOfferRecommendationsRequest, page_token : String?, limit : Int32?)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.get_offer_recommendations ..."}
      end
      # verify the required parameter "business_id" is set
      if @api_client.config.client_side_validation && business_id.nil?
        raise ArgumentError.new("Missing the required parameter 'business_id' when calling ExpressApi.get_offer_recommendations")
      end
      ...
      if @api_client.config.client_side_validation && get_offer_recommendations_request.nil?
        raise ArgumentError.new("Missing the required parameter 'get_offer_recommendations_request' when calling ExpressApi.get_offer_recommendations")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"ExpressApi.get_offer_recommendations",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#get_offer_recommendations\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    def get_offers_with_http_info(campaign_id : Int64, query : String?, feed_id : Int64?, shop_category_id : String?, currency : CurrencyType?, matched : Bool?, page : Int32?, page_size : Int32?)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.get_offers ..."}
      end
      # verify the required parameter "campaign_id" is set
      if @api_client.config.client_side_validation && campaign_id.nil?
        raise ArgumentError.new("Missing the required parameter 'campaign_id' when calling ExpressApi.get_offers")
      end
      if @api_client.config.client_side_validation && !page.nil? && page > 10000
        raise ArgumentError.new("invalid value for \"page\" when calling ExpressApi.get_offers, must be smaller than or equal to 10000.")
      end
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#get_offers\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    def get_order_with_http_info(campaign_id : Int64, order_id : Int64)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.get_order ..."}
      end
      # verify the required parameter "campaign_id" is set
      if @api_client.config.client_side_validation && campaign_id.nil?
        raise ArgumentError.new("Missing the required parameter 'campaign_id' when calling ExpressApi.get_order")
      end
      # verify the required parameter "order_id" is set
      if @api_client.config.client_side_validation && order_id.nil?
        raise ArgumentError.new("Missing the required parameter 'order_id' when calling ExpressApi.get_order")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#get_order\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    def get_order_business_buyer_info_with_http_info(campaign_id : Int64, order_id : Int64)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.get_order_business_buyer_info ..."}
      end
      # verify the required parameter "campaign_id" is set
      if @api_client.config.client_side_validation && campaign_id.nil?
        raise ArgumentError.new("Missing the required parameter 'campaign_id' when calling ExpressApi.get_order_business_buyer_info")
      end
      # verify the required parameter "order_id" is set
      if @api_client.config.client_side_validation && order_id.nil?
        raise ArgumentError.new("Missing the required parameter 'order_id' when calling ExpressApi.get_order_business_buyer_info")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"ExpressApi.get_order_business_buyer_info",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#get_order_business_buyer_info\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    def get_order_business_documents_info_with_http_info(campaign_id : Int64, order_id : Int64)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.get_order_business_documents_info ..."}
      end
      # verify the required parameter "campaign_id" is set
      if @api_client.config.client_side_validation && campaign_id.nil?
        raise ArgumentError.new("Missing the required parameter 'campaign_id' when calling ExpressApi.get_order_business_documents_info")
      end
      # verify the required parameter "order_id" is set
      if @api_client.config.client_side_validation && order_id.nil?
        raise ArgumentError.new("Missing the required parameter 'order_id' when calling ExpressApi.get_order_business_documents_info")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"ExpressApi.get_order_business_documents_info",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#get_order_business_documents_info\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    def get_order_labels_data_with_http_info(campaign_id : Int64, order_id : Int64)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.get_order_labels_data ..."}
      end
      # verify the required parameter "campaign_id" is set
      if @api_client.config.client_side_validation && campaign_id.nil?
        raise ArgumentError.new("Missing the required parameter 'campaign_id' when calling ExpressApi.get_order_labels_data")
      end
      # verify the required parameter "order_id" is set
      if @api_client.config.client_side_validation && order_id.nil?
        raise ArgumentError.new("Missing the required parameter 'order_id' when calling ExpressApi.get_order_labels_data")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        local_var_path,
                                                        :"ExpressApi.get_order_labels_data",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#get_order_labels_data\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    def get_orders_with_http_info(campaign_id : Int64, order_ids : Array(Int64)?, status : Set(OrderStatusType)?, substatus : Set(OrderSubstatusType)?, from_date : Time?, to_date : Time?, supplier_shipment_date_from : Time?, supplier_shipment_date_to : Time?, updated_at_from : Time?, updated_at_to : Time?, dispatch_type : OrderDeliveryDispatchType?, fake : Bool?, has_cis : Bool?, only_waiting_for_cancellation_approve : Bool?, only_estimated_delivery : Bool?, buyer_type : OrderBuyerType?, page : Int32?, page_size : Int32?, page_token : String?, limit : Int32?)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.get_orders ..."}
      end
      # verify the required parameter "campaign_id" is set
      if @api_client.config.client_side_validation && campaign_id.nil?
        raise ArgumentError.new("Missing the required parameter 'campaign_id' when calling ExpressApi.get_orders")
      end
      if @api_client.config.client_side_validation && !page.nil? && page > 10000
        raise ArgumentError.new("invalid value for \"page\" when calling ExpressApi.get_orders, must be smaller than or equal to 10000.")
      end
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#get_orders\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    def get_orders_stats_with_http_info(campaign_id : Int64, page_token : String?, limit : Int32?, get_orders_stats_request : GetOrdersStatsRequest?)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.get_orders_stats ..."}
      end
      # verify the required parameter "campaign_id" is set
      if @api_client.config.client_side_validation && campaign_id.nil?
        raise ArgumentError.new("Missing the required parameter 'campaign_id' when calling ExpressApi.get_orders_stats")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#get_orders_stats\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    def get_prices_with_http_info(campaign_id : Int64, page_token : String?, limit : Int32?, archived : Bool?)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.get_prices ..."}
      end
      # verify the required parameter "campaign_id" is set
      if @api_client.config.client_side_validation && campaign_id.nil?
        raise ArgumentError.new("Missing the required parameter 'campaign_id' when calling ExpressApi.get_prices")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#get_prices\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    def get_prices_by_offer_ids_with_http_info(campaign_id : Int64, page_token : String?, limit : Int32?, get_prices_by_offer_ids_request : GetPricesByOfferIdsRequest?)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.get_prices_by_offer_ids ..."}
      end
      # verify the required parameter "campaign_id" is set
      if @api_client.config.client_side_validation && campaign_id.nil?
        raise ArgumentError.new("Missing the required parameter 'campaign_id' when calling ExpressApi.get_prices_by_offer_ids")
      end
      # resource path
      local_var_path = "/campaigns/{campaignId}/offer-prices".sub("{" + "campaignId" + "}", URI.encode_path(campaign_id.to_s))
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"ExpressApi.get_prices_by_offer_ids",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#get_prices_by_offer_ids\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    def get_promo_offers_with_http_info(business_id : Int64, get_promo_offers_request : GetPromoOffersRequest, page_token : String?, limit : Int32?)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.get_promo_offers ..."}
      end
      # verify the required parameter "business_id" is set
      if @api_client.config.client_side_validation && business_id.nil?
        raise ArgumentError.new("Missing the required parameter 'business_id' when calling ExpressApi.get_promo_offers")
      end
      ...
      if @api_client.config.client_side_validation && get_promo_offers_request.nil?
        raise ArgumentError.new("Missing the required parameter 'get_promo_offers_request' when calling ExpressApi.get_promo_offers")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#get_promo_offers\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    def get_promos_with_http_info(business_id : Int64, get_promos_request : GetPromosRequest?)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.get_promos ..."}
      end
      # verify the required parameter "business_id" is set
      if @api_client.config.client_side_validation && business_id.nil?
        raise ArgumentError.new("Missing the required parameter 'business_id' when calling ExpressApi.get_promos")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#get_promos\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    def get_quality_rating_details_with_http_info(campaign_id : Int64)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.get_quality_rating_details ..."}
      end
      # verify the required parameter "campaign_id" is set
      if @api_client.config.client_side_validation && campaign_id.nil?
        raise ArgumentError.new("Missing the required parameter 'campaign_id' when calling ExpressApi.get_quality_rating_details")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"ExpressApi.get_quality_rating_details",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#get_quality_rating_details\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    def get_quality_ratings_with_http_info(business_id : Int64, get_quality_rating_request : GetQualityRatingRequest)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.get_quality_ratings ..."}
      end
      # verify the required parameter "business_id" is set
      if @api_client.config.client_side_validation && business_id.nil?
        raise ArgumentError.new("Missing the required parameter 'business_id' when calling ExpressApi.get_quality_ratings")
      end
      ...
      if @api_client.config.client_side_validation && get_quality_rating_request.nil?
        raise ArgumentError.new("Missing the required parameter 'get_quality_rating_request' when calling ExpressApi.get_quality_ratings")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"ExpressApi.get_quality_ratings",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#get_quality_ratings\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    def get_report_info_with_http_info(report_id : String)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.get_report_info ..."}
      end
      # verify the required parameter "report_id" is set
      if @api_client.config.client_side_validation && report_id.nil?
        raise ArgumentError.new("Missing the required parameter 'report_id' when calling ExpressApi.get_report_info")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#get_report_info\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    def get_return_with_http_info(campaign_id : Int64, order_id : Int64, return_id : Int64)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.get_return ..."}
      end
      # verify the required parameter "campaign_id" is set
      if @api_client.config.client_side_validation && campaign_id.nil?
        raise ArgumentError.new("Missing the required parameter 'campaign_id' when calling ExpressApi.get_return")
      end
      # verify the required parameter "order_id" is set
      if @api_client.config.client_side_validation && order_id.nil?
        raise ArgumentError.new("Missing the required parameter 'order_id' when calling ExpressApi.get_return")
      end
      # verify the required parameter "return_id" is set
      if @api_client.config.client_side_validation && return_id.nil?
        raise ArgumentError.new("Missing the required parameter 'return_id' when calling ExpressApi.get_return")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#get_return\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    def get_return_application_with_http_info(campaign_id : Int64, order_id : Int64, return_id : Int64)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.get_return_application ..."}
      end
      # verify the required parameter "campaign_id" is set
      if @api_client.config.client_side_validation && campaign_id.nil?
        raise ArgumentError.new("Missing the required parameter 'campaign_id' when calling ExpressApi.get_return_application")
      end
      # verify the required parameter "order_id" is set
      if @api_client.config.client_side_validation && order_id.nil?
        raise ArgumentError.new("Missing the required parameter 'order_id' when calling ExpressApi.get_return_application")
      end
      # verify the required parameter "return_id" is set
      if @api_client.config.client_side_validation && return_id.nil?
        raise ArgumentError.new("Missing the required parameter 'return_id' when calling ExpressApi.get_return_application")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        local_var_path,
                                                        :"ExpressApi.get_return_application",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#get_return_application\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return ::File.from_json(data), status_code, headers
    end
    ...
    def get_return_photo_with_http_info(campaign_id : Int64, order_id : Int64, return_id : Int64, item_id : Int64, image_hash : String)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.get_return_photo ..."}
      end
      # verify the required parameter "campaign_id" is set
      if @api_client.config.client_side_validation && campaign_id.nil?
        raise ArgumentError.new("Missing the required parameter 'campaign_id' when calling ExpressApi.get_return_photo")
      end
      # verify the required parameter "order_id" is set
      if @api_client.config.client_side_validation && order_id.nil?
        raise ArgumentError.new("Missing the required parameter 'order_id' when calling ExpressApi.get_return_photo")
      end
      # verify the required parameter "return_id" is set
      if @api_client.config.client_side_validation && return_id.nil?
        raise ArgumentError.new("Missing the required parameter 'return_id' when calling ExpressApi.get_return_photo")
      end
      # verify the required parameter "item_id" is set
      if @api_client.config.client_side_validation && item_id.nil?
        raise ArgumentError.new("Missing the required parameter 'item_id' when calling ExpressApi.get_return_photo")
      end
      # verify the required parameter "image_hash" is set
      if @api_client.config.client_side_validation && image_hash.nil?
        raise ArgumentError.new("Missing the required parameter 'image_hash' when calling ExpressApi.get_return_photo")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#get_return_photo\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return ::File.from_json(data), status_code, headers
    end
    ...
    def get_returns_with_http_info(campaign_id : Int64, page_token : String?, limit : Int32?, order_ids : Array(Int64)?, statuses : Array(RefundStatusType)?, _type : ReturnType?, from_date : Time?, to_date : Time?, from_date2 : Time?, to_date2 : Time?)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.get_returns ..."}
      end
      # verify the required parameter "campaign_id" is set
      if @api_client.config.client_side_validation && campaign_id.nil?
        raise ArgumentError.new("Missing the required parameter 'campaign_id' when calling ExpressApi.get_returns")
      end
      if @api_client.config.client_side_validation && order_ids.nil? && order_ids.size > 50
        raise ArgumentError.new("invalid value for \"order_ids\" when calling ExpressApi.get_returns, number of items must be less than or equal to 50.")
      end
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#get_returns\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    def get_stocks_with_http_info(campaign_id : Int64, page_token : String?, limit : Int32?, get_warehouse_stocks_request : GetWarehouseStocksRequest?)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.get_stocks ..."}
      end
      # verify the required parameter "campaign_id" is set
      if @api_client.config.client_side_validation && campaign_id.nil?
        raise ArgumentError.new("Missing the required parameter 'campaign_id' when calling ExpressApi.get_stocks")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#get_stocks\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    def get_suggested_offer_mapping_entries_with_http_info(campaign_id : Int64, get_suggested_offer_mapping_entries_request : GetSuggestedOfferMappingEntriesRequest)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.get_suggested_offer_mapping_entries ..."}
      end
      # verify the required parameter "campaign_id" is set
      if @api_client.config.client_side_validation && campaign_id.nil?
        raise ArgumentError.new("Missing the required parameter 'campaign_id' when calling ExpressApi.get_suggested_offer_mapping_entries")
      end
      ...
      if @api_client.config.client_side_validation && get_suggested_offer_mapping_entries_request.nil?
        raise ArgumentError.new("Missing the required parameter 'get_suggested_offer_mapping_entries_request' when calling ExpressApi.get_suggested_offer_mapping_entries")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"ExpressApi.get_suggested_offer_mapping_entries",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#get_suggested_offer_mapping_entries\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    def get_suggested_offer_mappings_with_http_info(business_id : Int64, get_suggested_offer_mappings_request : GetSuggestedOfferMappingsRequest?)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.get_suggested_offer_mappings ..."}
      end
      # verify the required parameter "business_id" is set
      if @api_client.config.client_side_validation && business_id.nil?
        raise ArgumentError.new("Missing the required parameter 'business_id' when calling ExpressApi.get_suggested_offer_mappings")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"ExpressApi.get_suggested_offer_mappings",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#get_suggested_offer_mappings\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    def get_suggested_prices_with_http_info(campaign_id : Int64, suggest_prices_request : SuggestPricesRequest)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.get_suggested_prices ..."}
      end
      # verify the required parameter "campaign_id" is set
      if @api_client.config.client_side_validation && campaign_id.nil?
        raise ArgumentError.new("Missing the required parameter 'campaign_id' when calling ExpressApi.get_suggested_prices")
      end
      ...
      if @api_client.config.client_side_validation && suggest_prices_request.nil?
        raise ArgumentError.new("Missing the required parameter 'suggest_prices_request' when calling ExpressApi.get_suggested_prices")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"ExpressApi.get_suggested_prices",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#get_suggested_prices\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    def get_warehouses_with_http_info(business_id : Int64)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.get_warehouses ..."}
      end
      # verify the required parameter "business_id" is set
      if @api_client.config.client_side_validation && business_id.nil?
        raise ArgumentError.new("Missing the required parameter 'business_id' when calling ExpressApi.get_warehouses")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#get_warehouses\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    def provide_order_item_identifiers_with_http_info(campaign_id : Int64, order_id : Int64, provide_order_item_identifiers_request : ProvideOrderItemIdentifiersRequest)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.provide_order_item_identifiers ..."}
      end
      # verify the required parameter "campaign_id" is set
      if @api_client.config.client_side_validation && campaign_id.nil?
        raise ArgumentError.new("Missing the required parameter 'campaign_id' when calling ExpressApi.provide_order_item_identifiers")
      end
      # verify the required parameter "order_id" is set
      if @api_client.config.client_side_validation && order_id.nil?
        raise ArgumentError.new("Missing the required parameter 'order_id' when calling ExpressApi.provide_order_item_identifiers")
      end
      ...
      if @api_client.config.client_side_validation && provide_order_item_identifiers_request.nil?
        raise ArgumentError.new("Missing the required parameter 'provide_order_item_identifiers_request' when calling ExpressApi.provide_order_item_identifiers")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:PUT,
                                                        local_var_path,
                                                        :"ExpressApi.provide_order_item_identifiers",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#provide_order_item_identifiers\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    def put_bids_for_business_with_http_info(business_id : Int64, put_sku_bids_request : PutSkuBidsRequest)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.put_bids_for_business ..."}
      end
      # verify the required parameter "business_id" is set
      if @api_client.config.client_side_validation && business_id.nil?
        raise ArgumentError.new("Missing the required parameter 'business_id' when calling ExpressApi.put_bids_for_business")
      end
      ...
      if @api_client.config.client_side_validation && put_sku_bids_request.nil?
        raise ArgumentError.new("Missing the required parameter 'put_sku_bids_request' when calling ExpressApi.put_bids_for_business")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:PUT,
                                                        local_var_path,
                                                        :"ExpressApi.put_bids_for_business",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#put_bids_for_business\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return EmptyApiResponse.from_json(data), status_code, headers
    end
    ...
    def put_bids_for_campaign_with_http_info(campaign_id : Int64, put_sku_bids_request : PutSkuBidsRequest)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.put_bids_for_campaign ..."}
      end
      # verify the required parameter "campaign_id" is set
      if @api_client.config.client_side_validation && campaign_id.nil?
        raise ArgumentError.new("Missing the required parameter 'campaign_id' when calling ExpressApi.put_bids_for_campaign")
      end
      # verify the required parameter "put_sku_bids_request" is set
      if @api_client.config.client_side_validation && put_sku_bids_request.nil?
        raise ArgumentError.new("Missing the required parameter 'put_sku_bids_request' when calling ExpressApi.put_bids_for_campaign")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:PUT,
                                                        local_var_path,
                                                        :"ExpressApi.put_bids_for_campaign",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#put_bids_for_campaign\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return EmptyApiResponse.from_json(data), status_code, headers
    end
    ...
    def refresh_feed_with_http_info(campaign_id : Int64, feed_id : Int64)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.refresh_feed ..."}
      end
      # verify the required parameter "campaign_id" is set
      if @api_client.config.client_side_validation && campaign_id.nil?
        raise ArgumentError.new("Missing the required parameter 'campaign_id' when calling ExpressApi.refresh_feed")
      end
      # verify the required parameter "feed_id" is set
      if @api_client.config.client_side_validation && feed_id.nil?
        raise ArgumentError.new("Missing the required parameter 'feed_id' when calling ExpressApi.refresh_feed")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#refresh_feed\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return EmptyApiResponse.from_json(data), status_code, headers
    end
    ...
    def search_region_children_with_http_info(region_id : Int64, page : Int32?, page_size : Int32?)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.search_region_children ..."}
      end
      # verify the required parameter "region_id" is set
      if @api_client.config.client_side_validation && region_id.nil?
        raise ArgumentError.new("Missing the required parameter 'region_id' when calling ExpressApi.search_region_children")
      end
      if @api_client.config.client_side_validation && !page.nil? && page > 10000
        raise ArgumentError.new("invalid value for \"page\" when calling ExpressApi.search_region_children, must be smaller than or equal to 10000.")
      end
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        local_var_path,
                                                        :"ExpressApi.search_region_children",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#search_region_children\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    def search_regions_by_id_with_http_info(region_id : Int64)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.search_regions_by_id ..."}
      end
      # verify the required parameter "region_id" is set
      if @api_client.config.client_side_validation && region_id.nil?
        raise ArgumentError.new("Missing the required parameter 'region_id' when calling ExpressApi.search_regions_by_id")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        local_var_path,
                                                        :"ExpressApi.search_regions_by_id",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#search_regions_by_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    def search_regions_by_name_with_http_info(name : String, page_token : String?, limit : Int32?)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.search_regions_by_name ..."}
      end
      # verify the required parameter "name" is set
      if @api_client.config.client_side_validation && name.nil?
        raise ArgumentError.new("Missing the required parameter 'name' when calling ExpressApi.search_regions_by_name")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:GET,
                                                        local_var_path,
                                                        :"ExpressApi.search_regions_by_name",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#search_regions_by_name\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return GetRegionsResponse.from_json(data), status_code, headers
    end
    ...
    def send_file_to_chat_with_http_info(business_id : Int64, chat_id : Int64, file : ::File)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.send_file_to_chat ..."}
      end
      # verify the required parameter "business_id" is set
      if @api_client.config.client_side_validation && business_id.nil?
        raise ArgumentError.new("Missing the required parameter 'business_id' when calling ExpressApi.send_file_to_chat")
      end
      # verify the required parameter "chat_id" is set
      if @api_client.config.client_side_validation && chat_id.nil?
        raise ArgumentError.new("Missing the required parameter 'chat_id' when calling ExpressApi.send_file_to_chat")
      end
      # verify the required parameter "file" is set
      if @api_client.config.client_side_validation && file.nil?
        raise ArgumentError.new("Missing the required parameter 'file' when calling ExpressApi.send_file_to_chat")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#send_file_to_chat\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return EmptyApiResponse.from_json(data), status_code, headers
    end
    ...
    def send_message_to_chat_with_http_info(business_id : Int64, chat_id : Int64, send_message_to_chat_request : SendMessageToChatRequest)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.send_message_to_chat ..."}
      end
      # verify the required parameter "business_id" is set
      if @api_client.config.client_side_validation && business_id.nil?
        raise ArgumentError.new("Missing the required parameter 'business_id' when calling ExpressApi.send_message_to_chat")
      end
      # verify the required parameter "chat_id" is set
      if @api_client.config.client_side_validation && chat_id.nil?
        raise ArgumentError.new("Missing the required parameter 'chat_id' when calling ExpressApi.send_message_to_chat")
      end
      ...
      if @api_client.config.client_side_validation && send_message_to_chat_request.nil?
        raise ArgumentError.new("Missing the required parameter 'send_message_to_chat_request' when calling ExpressApi.send_message_to_chat")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"ExpressApi.send_message_to_chat",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#send_message_to_chat\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return EmptyApiResponse.from_json(data), status_code, headers
    end
    ...
    def set_feed_params_with_http_info(campaign_id : Int64, feed_id : Int64, set_feed_params_request : SetFeedParamsRequest)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.set_feed_params ..."}
      end
      # verify the required parameter "campaign_id" is set
      if @api_client.config.client_side_validation && campaign_id.nil?
        raise ArgumentError.new("Missing the required parameter 'campaign_id' when calling ExpressApi.set_feed_params")
      end
      # verify the required parameter "feed_id" is set
      if @api_client.config.client_side_validation && feed_id.nil?
        raise ArgumentError.new("Missing the required parameter 'feed_id' when calling ExpressApi.set_feed_params")
      end
      ...
      if @api_client.config.client_side_validation && set_feed_params_request.nil?
        raise ArgumentError.new("Missing the required parameter 'set_feed_params_request' when calling ExpressApi.set_feed_params")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#set_feed_params\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return EmptyApiResponse.from_json(data), status_code, headers
    end
    ...
    def set_order_box_layout_with_http_info(campaign_id : Int64, order_id : Int64, set_order_box_layout_request : SetOrderBoxLayoutRequest)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.set_order_box_layout ..."}
      end
      # verify the required parameter "campaign_id" is set
      if @api_client.config.client_side_validation && campaign_id.nil?
        raise ArgumentError.new("Missing the required parameter 'campaign_id' when calling ExpressApi.set_order_box_layout")
      end
      # verify the required parameter "order_id" is set
      if @api_client.config.client_side_validation && order_id.nil?
        raise ArgumentError.new("Missing the required parameter 'order_id' when calling ExpressApi.set_order_box_layout")
      end
      ...
      if @api_client.config.client_side_validation && set_order_box_layout_request.nil?
        raise ArgumentError.new("Missing the required parameter 'set_order_box_layout_request' when calling ExpressApi.set_order_box_layout")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:PUT,
                                                        local_var_path,
                                                        :"ExpressApi.set_order_box_layout",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#set_order_box_layout\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    def set_order_shipment_boxes_with_http_info(campaign_id : Int64, order_id : Int64, shipment_id : Int64, set_order_shipment_boxes_request : SetOrderShipmentBoxesRequest)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.set_order_shipment_boxes ..."}
      end
      # verify the required parameter "campaign_id" is set
      if @api_client.config.client_side_validation && campaign_id.nil?
        raise ArgumentError.new("Missing the required parameter 'campaign_id' when calling ExpressApi.set_order_shipment_boxes")
      end
      # verify the required parameter "order_id" is set
      if @api_client.config.client_side_validation && order_id.nil?
        raise ArgumentError.new("Missing the required parameter 'order_id' when calling ExpressApi.set_order_shipment_boxes")
      end
      # verify the required parameter "shipment_id" is set
      if @api_client.config.client_side_validation && shipment_id.nil?
        raise ArgumentError.new("Missing the required parameter 'shipment_id' when calling ExpressApi.set_order_shipment_boxes")
      end
      ...
      if @api_client.config.client_side_validation && set_order_shipment_boxes_request.nil?
        raise ArgumentError.new("Missing the required parameter 'set_order_shipment_boxes_request' when calling ExpressApi.set_order_shipment_boxes")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:PUT,
                                                        local_var_path,
                                                        :"ExpressApi.set_order_shipment_boxes",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#set_order_shipment_boxes\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    def skip_goods_feedbacks_reaction_with_http_info(business_id : Int64, skip_goods_feedback_reaction_request : SkipGoodsFeedbackReactionRequest)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.skip_goods_feedbacks_reaction ..."}
      end
      # verify the required parameter "business_id" is set
      if @api_client.config.client_side_validation && business_id.nil?
        raise ArgumentError.new("Missing the required parameter 'business_id' when calling ExpressApi.skip_goods_feedbacks_reaction")
      end
      ...
      if @api_client.config.client_side_validation && skip_goods_feedback_reaction_request.nil?
        raise ArgumentError.new("Missing the required parameter 'skip_goods_feedback_reaction_request' when calling ExpressApi.skip_goods_feedbacks_reaction")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"ExpressApi.skip_goods_feedbacks_reaction",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#skip_goods_feedbacks_reaction\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return EmptyApiResponse.from_json(data), status_code, headers
    end
    ...
    def update_business_prices_with_http_info(business_id : Int64, update_business_prices_request : UpdateBusinessPricesRequest)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.update_business_prices ..."}
      end
      # verify the required parameter "business_id" is set
      if @api_client.config.client_side_validation && business_id.nil?
        raise ArgumentError.new("Missing the required parameter 'business_id' when calling ExpressApi.update_business_prices")
      end
      ...
      if @api_client.config.client_side_validation && update_business_prices_request.nil?
        raise ArgumentError.new("Missing the required parameter 'update_business_prices_request' when calling ExpressApi.update_business_prices")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"ExpressApi.update_business_prices",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#update_business_prices\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return EmptyApiResponse.from_json(data), status_code, headers
    end
    ...
    def update_campaign_offers_with_http_info(campaign_id : Int64, update_campaign_offers_request : UpdateCampaignOffersRequest)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.update_campaign_offers ..."}
      end
      # verify the required parameter "campaign_id" is set
      if @api_client.config.client_side_validation && campaign_id.nil?
        raise ArgumentError.new("Missing the required parameter 'campaign_id' when calling ExpressApi.update_campaign_offers")
      end
      ...
      if @api_client.config.client_side_validation && update_campaign_offers_request.nil?
        raise ArgumentError.new("Missing the required parameter 'update_campaign_offers_request' when calling ExpressApi.update_campaign_offers")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"ExpressApi.update_campaign_offers",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#update_campaign_offers\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return EmptyApiResponse.from_json(data), status_code, headers
    end
    ...
    def update_goods_feedback_comment_with_http_info(business_id : Int64, update_goods_feedback_comment_request : UpdateGoodsFeedbackCommentRequest)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.update_goods_feedback_comment ..."}
      end
      # verify the required parameter "business_id" is set
      if @api_client.config.client_side_validation && business_id.nil?
        raise ArgumentError.new("Missing the required parameter 'business_id' when calling ExpressApi.update_goods_feedback_comment")
      end
      ...
      if @api_client.config.client_side_validation && update_goods_feedback_comment_request.nil?
        raise ArgumentError.new("Missing the required parameter 'update_goods_feedback_comment_request' when calling ExpressApi.update_goods_feedback_comment")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"ExpressApi.update_goods_feedback_comment",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#update_goods_feedback_comment\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    def update_offer_content_with_http_info(business_id : Int64, update_offer_content_request : UpdateOfferContentRequest)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.update_offer_content ..."}
      end
      # verify the required parameter "business_id" is set
      if @api_client.config.client_side_validation && business_id.nil?
        raise ArgumentError.new("Missing the required parameter 'business_id' when calling ExpressApi.update_offer_content")
      end
      ...
      if @api_client.config.client_side_validation && update_offer_content_request.nil?
        raise ArgumentError.new("Missing the required parameter 'update_offer_content_request' when calling ExpressApi.update_offer_content")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"ExpressApi.update_offer_content",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#update_offer_content\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    def update_offer_mapping_entries_with_http_info(campaign_id : Int64, update_offer_mapping_entry_request : UpdateOfferMappingEntryRequest)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.update_offer_mapping_entries ..."}
      end
      # verify the required parameter "campaign_id" is set
      if @api_client.config.client_side_validation && campaign_id.nil?
        raise ArgumentError.new("Missing the required parameter 'campaign_id' when calling ExpressApi.update_offer_mapping_entries")
      end
      ...
      if @api_client.config.client_side_validation && update_offer_mapping_entry_request.nil?
        raise ArgumentError.new("Missing the required parameter 'update_offer_mapping_entry_request' when calling ExpressApi.update_offer_mapping_entries")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"ExpressApi.update_offer_mapping_entries",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#update_offer_mapping_entries\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return EmptyApiResponse.from_json(data), status_code, headers
    end
    ...
    def update_offer_mappings_with_http_info(business_id : Int64, update_offer_mappings_request : UpdateOfferMappingsRequest)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.update_offer_mappings ..."}
      end
      # verify the required parameter "business_id" is set
      if @api_client.config.client_side_validation && business_id.nil?
        raise ArgumentError.new("Missing the required parameter 'business_id' when calling ExpressApi.update_offer_mappings")
      end
      ...
      if @api_client.config.client_side_validation && update_offer_mappings_request.nil?
        raise ArgumentError.new("Missing the required parameter 'update_offer_mappings_request' when calling ExpressApi.update_offer_mappings")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"ExpressApi.update_offer_mappings",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#update_offer_mappings\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    def update_order_items_with_http_info(campaign_id : Int64, order_id : Int64, update_order_item_request : UpdateOrderItemRequest)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.update_order_items ..."}
      end
      # verify the required parameter "campaign_id" is set
      if @api_client.config.client_side_validation && campaign_id.nil?
        raise ArgumentError.new("Missing the required parameter 'campaign_id' when calling ExpressApi.update_order_items")
      end
      # verify the required parameter "order_id" is set
      if @api_client.config.client_side_validation && order_id.nil?
        raise ArgumentError.new("Missing the required parameter 'order_id' when calling ExpressApi.update_order_items")
      end
      ...
      if @api_client.config.client_side_validation && update_order_item_request.nil?
        raise ArgumentError.new("Missing the required parameter 'update_order_item_request' when calling ExpressApi.update_order_items")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:PUT,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#update_order_items\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    def update_order_status_with_http_info(campaign_id : Int64, order_id : Int64, update_order_status_request : UpdateOrderStatusRequest)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.update_order_status ..."}
      end
      # verify the required parameter "campaign_id" is set
      if @api_client.config.client_side_validation && campaign_id.nil?
        raise ArgumentError.new("Missing the required parameter 'campaign_id' when calling ExpressApi.update_order_status")
      end
      # verify the required parameter "order_id" is set
      if @api_client.config.client_side_validation && order_id.nil?
        raise ArgumentError.new("Missing the required parameter 'order_id' when calling ExpressApi.update_order_status")
      end
      ...
      if @api_client.config.client_side_validation && update_order_status_request.nil?
        raise ArgumentError.new("Missing the required parameter 'update_order_status_request' when calling ExpressApi.update_order_status")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:PUT,
                                                        local_var_path,
                                                        :"ExpressApi.update_order_status",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#update_order_status\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    def update_order_statuses_with_http_info(campaign_id : Int64, update_order_statuses_request : UpdateOrderStatusesRequest)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.update_order_statuses ..."}
      end
      # verify the required parameter "campaign_id" is set
      if @api_client.config.client_side_validation && campaign_id.nil?
        raise ArgumentError.new("Missing the required parameter 'campaign_id' when calling ExpressApi.update_order_statuses")
      end
      ...
      if @api_client.config.client_side_validation && update_order_statuses_request.nil?
        raise ArgumentError.new("Missing the required parameter 'update_order_statuses_request' when calling ExpressApi.update_order_statuses")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"ExpressApi.update_order_statuses",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#update_order_statuses\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    def update_prices_with_http_info(campaign_id : Int64, update_prices_request : UpdatePricesRequest)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.update_prices ..."}
      end
      # verify the required parameter "campaign_id" is set
      if @api_client.config.client_side_validation && campaign_id.nil?
        raise ArgumentError.new("Missing the required parameter 'campaign_id' when calling ExpressApi.update_prices")
      end
      ...
      if @api_client.config.client_side_validation && update_prices_request.nil?
        raise ArgumentError.new("Missing the required parameter 'update_prices_request' when calling ExpressApi.update_prices")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#update_prices\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return EmptyApiResponse.from_json(data), status_code, headers
    end
    ...
    def update_promo_offers_with_http_info(business_id : Int64, update_promo_offers_request : UpdatePromoOffersRequest)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.update_promo_offers ..."}
      end
      # verify the required parameter "business_id" is set
      if @api_client.config.client_side_validation && business_id.nil?
        raise ArgumentError.new("Missing the required parameter 'business_id' when calling ExpressApi.update_promo_offers")
      end
      ...
      if @api_client.config.client_side_validation && update_promo_offers_request.nil?
        raise ArgumentError.new("Missing the required parameter 'update_promo_offers_request' when calling ExpressApi.update_promo_offers")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"ExpressApi.update_promo_offers",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#update_promo_offers\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    def update_stocks_with_http_info(campaign_id : Int64, update_stocks_request : UpdateStocksRequest)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.update_stocks ..."}
      end
      # verify the required parameter "campaign_id" is set
      if @api_client.config.client_side_validation && campaign_id.nil?
        raise ArgumentError.new("Missing the required parameter 'campaign_id' when calling ExpressApi.update_stocks")
      end
      ...
      if @api_client.config.client_side_validation && update_stocks_request.nil?
        raise ArgumentError.new("Missing the required parameter 'update_stocks_request' when calling ExpressApi.update_stocks")
      end
      # resource path
      local_var_path = "/campaigns/{campaignId}/offers/stocks".sub("{" + "campaignId" + "}", URI.encode_path(campaign_id.to_s))
      ...
      data, status_code, headers = @api_client.call_api(:PUT,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#update_stocks\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
      return EmptyApiResponse.from_json(data), status_code, headers
    end
    ...
    def verify_order_eac_with_http_info(campaign_id : Int64, order_id : Int64, verify_order_eac_request : VerifyOrderEacRequest)
      if @api_client.config.debugging
        Log.debug {"Calling API: ExpressApi.verify_order_eac ..."}
      end
      # verify the required parameter "campaign_id" is set
      if @api_client.config.client_side_validation && campaign_id.nil?
        raise ArgumentError.new("Missing the required parameter 'campaign_id' when calling ExpressApi.verify_order_eac")
      end
      # verify the required parameter "order_id" is set
      if @api_client.config.client_side_validation && order_id.nil?
        raise ArgumentError.new("Missing the required parameter 'order_id' when calling ExpressApi.verify_order_eac")
      end
      ...
      if @api_client.config.client_side_validation && verify_order_eac_request.nil?
        raise ArgumentError.new("Missing the required parameter 'verify_order_eac_request' when calling ExpressApi.verify_order_eac")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:PUT,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: ExpressApi#verify_order_eac\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
