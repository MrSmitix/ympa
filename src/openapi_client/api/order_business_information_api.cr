  ...
  class OrderBusinessInformationApi
    ...
    def get_order_business_buyer_info_with_http_info(campaign_id : Int64, order_id : Int64)
      if @api_client.config.debugging
        Log.debug {"Calling API: OrderBusinessInformationApi.get_order_business_buyer_info ..."}
      end
      # verify the required parameter "campaign_id" is set
      if @api_client.config.client_side_validation && campaign_id.nil?
        raise ArgumentError.new("Missing the required parameter 'campaign_id' when calling OrderBusinessInformationApi.get_order_business_buyer_info")
      end
      # verify the required parameter "order_id" is set
      if @api_client.config.client_side_validation && order_id.nil?
        raise ArgumentError.new("Missing the required parameter 'order_id' when calling OrderBusinessInformationApi.get_order_business_buyer_info")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"OrderBusinessInformationApi.get_order_business_buyer_info",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: OrderBusinessInformationApi#get_order_business_buyer_info\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
    ...
    def get_order_business_documents_info_with_http_info(campaign_id : Int64, order_id : Int64)
      if @api_client.config.debugging
        Log.debug {"Calling API: OrderBusinessInformationApi.get_order_business_documents_info ..."}
      end
      # verify the required parameter "campaign_id" is set
      if @api_client.config.client_side_validation && campaign_id.nil?
        raise ArgumentError.new("Missing the required parameter 'campaign_id' when calling OrderBusinessInformationApi.get_order_business_documents_info")
      end
      # verify the required parameter "order_id" is set
      if @api_client.config.client_side_validation && order_id.nil?
        raise ArgumentError.new("Missing the required parameter 'order_id' when calling OrderBusinessInformationApi.get_order_business_documents_info")
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST,
                                                        local_var_path,
                                                        :"OrderBusinessInformationApi.get_order_business_documents_info",
                                                        return_type,
                                                        post_body,
                                                        auth_names,
                                                        header_params,
                                                        ...
                                                        form_params)
      if @api_client.config.debugging
        Log.debug {"API called: OrderBusinessInformationApi#get_order_business_documents_info\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"}
      end
