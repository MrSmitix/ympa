...
module OpenAPIClient
  ...
  class OfferRecommendationInfoDTO
    ...
    @[JSON::Field(key: "recommendedCofinancePrice", type: BasePriceDTO?, nillable: true, emit_null: false)]
    property recommended_cofinance_price : BasePriceDTO?

    @[JSON::Field(key: "competitivenessThresholds", type: PriceCompetitivenessThresholdsDTO?, nillable: true, emit_null: false)]
    property competitiveness_thresholds : PriceCompetitivenessThresholdsDTO?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@offer_id : String?, @recommended_cofinance_price : BasePriceDTO?, @competitiveness_thresholds : PriceCompetitivenessThresholdsDTO?)
    end
