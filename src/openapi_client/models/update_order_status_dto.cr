...
module OpenAPIClient
  ...
  class UpdateOrderStatusDTO
    ...
    @[JSON::Field(key: "updateStatus", type: OrderUpdateStatusType?, nillable: true, emit_null: false)]
    property update_status : OrderUpdateStatusType?
    ...
    @[JSON::Field(key: "errorDetails", type: String?, nillable: true, emit_null: false)]
    ...
    def initialize(@id : Int64?, @status : OrderStatusType?, @substatus : OrderSubstatusType?, @update_status : OrderUpdateStatusType?, @error_details : String?)
    end
