...
module OpenAPIClient
  ...
  class ModelPriceDTO
    ...
    @[JSON::Field(key: "avg", type: Float64?, nillable: true, emit_null: false)]
    property avg : Float64?

    # Максимальная цена предложения для модели в регионе.
    @[JSON::Field(key: "max", type: Float64?, nillable: true, emit_null: false)]
    property max : Float64?

    # Минимальная цена предложения для модели в регионе.
    @[JSON::Field(key: "min", type: Float64?, nillable: true, emit_null: false)]
    property min : Float64?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@avg : Float64?, @max : Float64?, @min : Float64?)
    end
