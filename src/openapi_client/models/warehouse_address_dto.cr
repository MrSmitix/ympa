...
module OpenAPIClient
  ...
  class WarehouseAddressDTO
    ...
    @[JSON::Field(key: "gps", type: GpsDTO, nillable: false, emit_null: false)]
    property gps : GpsDTO
    ...
    def initialize(@city : String, @gps : GpsDTO, @street : String?, @number : String?, @building : String?, @block : String?)
    end
    ...
    def valid?
      return false if @city.to_s.size > 200
