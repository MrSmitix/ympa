...
module OpenAPIClient
  ...
  class ModelOfferDTO
    ...
    @[JSON::Field(key: "pos", type: Int32?, nillable: true, emit_null: false)]
    property pos : Int32?
    ...
    @[JSON::Field(key: "regionId", type: Int64?, nillable: true, emit_null: false)]
    ...
    @[JSON::Field(key: "shippingCost", type: Float64?, nillable: true, emit_null: false)]
    property shipping_cost : Float64?
    ...
    @[JSON::Field(key: "shopRating", type: Int32?, nillable: true, emit_null: false)]
    property shop_rating : Int32?

    # {% note warning \"\" %}  Этот параметр устарел. Не используйте его.  {% endnote %} 
    @[JSON::Field(key: "inStock", type: Int32?, nillable: true, emit_null: false)]
    property in_stock : Int32?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@discount : Int32?, @name : String?, @pos : Int32?, @pre_discount_price : Float64?, @price : Float64?, @region_id : Int64?, @shipping_cost : Float64?, @shop_name : String?, @shop_rating : Int32?, @in_stock : Int32?)
    end
