...
module OpenAPIClient
  ...
  class UpdateOfferDTO
    ...
    @[JSON::Field(key: "parameterValues", type: Array(ParameterValueDTO)?, nillable: true, emit_null: false)]
    property parameter_values : Array(ParameterValueDTO)?

    @[JSON::Field(key: "basicPrice", type: UpdatePriceWithDiscountDTO?, nillable: true, emit_null: false)]
    property basic_price : UpdatePriceWithDiscountDTO?

    @[JSON::Field(key: "purchasePrice", type: BasePriceDTO?, nillable: true, emit_null: false)]
    property purchase_price : BasePriceDTO?

    @[JSON::Field(key: "additionalExpenses", type: BasePriceDTO?, nillable: true, emit_null: false)]
    property additional_expenses : BasePriceDTO?

    @[JSON::Field(key: "cofinancePrice", type: BasePriceDTO?, nillable: true, emit_null: false)]
    property cofinance_price : BasePriceDTO?
    ...
    def initialize(@offer_id : String, @name : String?, @market_category_id : Int64?, @category : String?, @pictures : Array(String)?, @videos : Array(String)?, @manuals : Array(OfferManualDTO)?, @vendor : String?, @barcodes : Array(String)?, @description : String?, @manufacturer_countries : Array(String)?, @weight_dimensions : OfferWeightDimensionsDTO?, @vendor_code : String?, @tags : Array(String)?, @shelf_life : TimePeriodDTO?, @life_time : TimePeriodDTO?, @guarantee_period : TimePeriodDTO?, @customs_commodity_code : String?, @certificates : Array(String)?, @box_count : Int32?, @condition : OfferConditionDTO?, @_type : OfferType?, @downloadable : Bool?, @adult : Bool?, @age : AgeDTO?, @params : Array(OfferParamDTO)?, @parameter_values : Array(ParameterValueDTO)?, @basic_price : UpdatePriceWithDiscountDTO?, @purchase_price : BasePriceDTO?, @additional_expenses : BasePriceDTO?, @cofinance_price : BasePriceDTO?)
    end
    ...
    def list_invalid_properties
      ...
      if !@parameter_values.nil? && @parameter_values.size > 300
    ...
    def valid?
      ...
      return false if !@parameter_values.nil? && @parameter_values.size > 300
      true
    end
    ...
    def parameter_values=(parameter_values)
      if !parameter_values.nil? && parameter_values.size > 300
        raise ArgumentError.new("invalid value for \"parameter_values\", number of items must be less than or equal to 300.")
      end
