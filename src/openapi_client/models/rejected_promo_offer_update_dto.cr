...
module OpenAPIClient
  ...
  class RejectedPromoOfferUpdateDTO
    ...
    @[JSON::Field(key: "reason", type: RejectedPromoOfferUpdateReasonType, nillable: false, emit_null: false)]
    property reason : RejectedPromoOfferUpdateReasonType
    ...
    def initialize(@offer_id : String, @reason : RejectedPromoOfferUpdateReasonType)
    end
