...
module OpenAPIClient
  ...
  class OfferPriceResponseDTO
    ...
    @[JSON::Field(key: "price", type: PriceDTO?, nillable: true, emit_null: false)]
    property price : PriceDTO?
    ...
    def initialize(@id : String?, @price : PriceDTO?, @market_sku : Int64?, @updated_at : Time?)
    end
