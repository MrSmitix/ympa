...
module OpenAPIClient
  ...
  class DeletePromoOffersRequest
    ...
    @[JSON::Field(key: "deleteAllOffers", type: Bool?, nillable: true, emit_null: false)]
    property delete_all_offers : Bool?
    ...
    def initialize(@promo_id : String, @delete_all_offers : Bool?, @offer_ids : Array(String)?)
    end
    ...
    def list_invalid_properties
      ...
      if !@offer_ids.nil? && @offer_ids.size > 500
    ...
    def valid?
      return false if !@offer_ids.nil? && @offer_ids.size > 500
    ...
    def offer_ids=(offer_ids)
      if !offer_ids.nil? && offer_ids.size > 500
        raise ArgumentError.new("invalid value for \"offer_ids\", number of items must be less than or equal to 500.")
      end
