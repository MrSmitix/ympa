...
module OpenAPIClient
  ...
  class OrderDigitalItemDTO
    ...
    @[JSON::Field(key: "slip", type: String, nillable: false, emit_null: false)]
    property slip : String
    ...
    @[JSON::Field(key: "activate_till", type: Time, nillable: false, emit_null: false)]
    property activate_till : Time

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@id : Int64, @code : String, @slip : String, @activate_till : Time)
    end
