...
module OpenAPIClient
  ...
  class ParameterValueDTO
    ...
    @[JSON::Field(key: "parameterId", type: Int64, nillable: false, emit_null: false)]
    property parameter_id : Int64

    # Optional properties
    # Идентификатор единицы измерения. Если вы не передали параметр `unitId`, используется единица измерения по умолчанию.
    @[JSON::Field(key: "unitId", type: Int64?, nillable: true, emit_null: false)]
    property unit_id : Int64?
    ...
    @[JSON::Field(key: "valueId", type: Int64?, nillable: true, emit_null: false)]
    property value_id : Int64?
    ...
    def initialize(@parameter_id : Int64, @unit_id : Int64?, @value_id : Int64?, @value : String?)
    end
