...
module OpenAPIClient
  ...
  class OrderItemInstanceModificationDTO
    ...
    @[JSON::Field(key: "instances", type: Array(BriefOrderItemInstanceDTO), nillable: false, emit_null: false)]
    property instances : Array(BriefOrderItemInstanceDTO)

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@id : Int64, @instances : Array(BriefOrderItemInstanceDTO))
    end
