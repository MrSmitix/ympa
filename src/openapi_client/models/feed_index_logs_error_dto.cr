...
module OpenAPIClient
  ...
  class FeedIndexLogsErrorDTO
    ...
    @[JSON::Field(key: "httpStatusCode", type: Int32?, nillable: true, emit_null: false)]
    property http_status_code : Int32?

    @[JSON::Field(key: "type", type: FeedIndexLogsErrorType?, nillable: true, emit_null: false)]
    property _type : FeedIndexLogsErrorType?
    ...
    def initialize(@http_status_code : Int32?, @_type : FeedIndexLogsErrorType?, @description : String?)
    end
    ...
    def hash
      [http_status_code, _type, description].hash
    end
