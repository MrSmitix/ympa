...
module OpenAPIClient
  ...
  class OfferCardDTO
    ...
    # Optional properties
    @[JSON::Field(key: "mapping", type: GetMappingDTO?, nillable: true, emit_null: false)]
    property mapping : GetMappingDTO?
    ...
    @[JSON::Field(key: "contentRating", type: Int32?, nillable: true, emit_null: false)]
    property content_rating : Int32?
    ...
    @[JSON::Field(key: "recommendations", type: Array(OfferCardRecommendationDTO)?, nillable: true, emit_null: false)]
    property recommendations : Array(OfferCardRecommendationDTO)?

    # Ошибки в контенте, препятствующие размещению товара на витрине.
    @[JSON::Field(key: "errors", type: Array(OfferErrorDTO)?, nillable: true, emit_null: false)]
    property errors : Array(OfferErrorDTO)?

    # Связанные с контентом предупреждения, не препятствующие размещению товара на витрине.
    @[JSON::Field(key: "warnings", type: Array(OfferErrorDTO)?, nillable: true, emit_null: false)]
    property warnings : Array(OfferErrorDTO)?
    ...
    def initialize(@offer_id : String, @mapping : GetMappingDTO?, @parameter_values : Array(ParameterValueDTO)?, @card_status : OfferCardStatusType?, @content_rating : Int32?, @recommendations : Array(OfferCardRecommendationDTO)?, @errors : Array(OfferErrorDTO)?, @warnings : Array(OfferErrorDTO)?)
    end
    ...
    def hash
      [offer_id, mapping, parameter_values, card_status, content_rating, recommendations, errors, warnings].hash
    end
