...
module OpenAPIClient
  ...
  class GetWarehouseStocksRequest
    ...
    @[JSON::Field(key: "withTurnover", type: Bool?, default: false, nillable: true, emit_null: false)]
    property with_turnover : Bool?
    ...
    def initialize(@with_turnover : Bool?, @archived : Bool?, @offer_ids : Set(String)?)
    end
