...
module OpenAPIClient
  ...
  class UpdateStockDTO
    ...
    @[JSON::Field(key: "items", type: Array(UpdateStockItemDTO), nillable: false, emit_null: false)]
    property items : Array(UpdateStockItemDTO)

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@sku : String, @items : Array(UpdateStockItemDTO))
    end
    ...
    def items=(items)
      if items.size > 1
        raise ArgumentError.new("invalid value for \"items\", number of items must be less than or equal to 1.")
      end
