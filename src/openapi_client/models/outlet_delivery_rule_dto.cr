...
module OpenAPIClient
  ...
  class OutletDeliveryRuleDTO
    ...
    @[JSON::Field(key: "minDeliveryDays", type: Int32?, nillable: true, emit_null: false)]
    property min_delivery_days : Int32?
    ...
    @[JSON::Field(key: "maxDeliveryDays", type: Int32?, nillable: true, emit_null: false)]
    property max_delivery_days : Int32?
    ...
    @[JSON::Field(key: "orderBefore", type: Int32?, nillable: true, emit_null: false)]
    property order_before : Int32?

    # Цена на товар, начиная с которой действует бесплатный самовывоз товара из точки продаж.
    @[JSON::Field(key: "priceFreePickup", type: Float64?, nillable: true, emit_null: false)]
    property price_free_pickup : Float64?
    ...
    @[JSON::Field(key: "unspecifiedDeliveryInterval", type: Bool?, nillable: true, emit_null: false)]
    property unspecified_delivery_interval : Bool?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@min_delivery_days : Int32?, @max_delivery_days : Int32?, @delivery_service_id : Int64?, @order_before : Int32?, @price_free_pickup : Float64?, @unspecified_delivery_interval : Bool?)
    end
    ...
    def order_before=(order_before)
      if !order_before.nil? && order_before > 24
        raise ArgumentError.new("invalid value for \"order_before\", must be smaller than or equal to 24.")
      end

      if !order_before.nil? && order_before < 0
        raise ArgumentError.new("invalid value for \"order_before\", must be greater than or equal to 0.")
      end
