...
module OpenAPIClient
  ...
  class UpdatePromoOfferDTO
    ...
    # Optional properties
    @[JSON::Field(key: "params", type: UpdatePromoOfferParamsDTO?, nillable: true, emit_null: false)]
    property params : UpdatePromoOfferParamsDTO?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@offer_id : String, @params : UpdatePromoOfferParamsDTO?)
    end
