...
module OpenAPIClient
  ...
  class ProvideOrderDigitalCodesRequest
    ...
    @[JSON::Field(key: "items", type: Array(OrderDigitalItemDTO), nillable: false, emit_null: false)]
    property items : Array(OrderDigitalItemDTO)

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@items : Array(OrderDigitalItemDTO))
    end
