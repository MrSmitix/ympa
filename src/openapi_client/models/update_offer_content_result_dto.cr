...
module OpenAPIClient
  ...
  class UpdateOfferContentResultDTO
    ...
    @[JSON::Field(key: "errors", type: Array(OfferContentErrorDTO)?, nillable: true, emit_null: false)]
    property errors : Array(OfferContentErrorDTO)?

    # Предупреждения — информация в каталоге обновится.
    @[JSON::Field(key: "warnings", type: Array(OfferContentErrorDTO)?, nillable: true, emit_null: false)]
    property warnings : Array(OfferContentErrorDTO)?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@offer_id : String, @errors : Array(OfferContentErrorDTO)?, @warnings : Array(OfferContentErrorDTO)?)
    end
