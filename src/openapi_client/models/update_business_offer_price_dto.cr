...
module OpenAPIClient
  ...
  class UpdateBusinessOfferPriceDTO
    ...
    @[JSON::Field(key: "price", type: UpdatePriceWithDiscountDTO, nillable: false, emit_null: false)]
    property price : UpdatePriceWithDiscountDTO

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@offer_id : String, @price : UpdatePriceWithDiscountDTO)
    end
