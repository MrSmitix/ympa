...
module OpenAPIClient
  ...
  class OfferForRecommendationDTO
    ...
    @[JSON::Field(key: "price", type: BasePriceDTO?, nillable: true, emit_null: false)]
    property price : BasePriceDTO?

    @[JSON::Field(key: "cofinancePrice", type: GetPriceDTO?, nillable: true, emit_null: false)]
    property cofinance_price : GetPriceDTO?

    @[JSON::Field(key: "competitiveness", type: PriceCompetitivenessType?, nillable: true, emit_null: false)]
    property competitiveness : PriceCompetitivenessType?

    # Количество показов карточки товара за последние 7 дней.
    @[JSON::Field(key: "shows", type: Int64?, nillable: true, emit_null: false)]
    property shows : Int64?
    ...
    def initialize(@offer_id : String?, @price : BasePriceDTO?, @cofinance_price : GetPriceDTO?, @competitiveness : PriceCompetitivenessType?, @shows : Int64?)
    end
    ...
    def hash
      [offer_id, price, cofinance_price, competitiveness, shows].hash
    end
