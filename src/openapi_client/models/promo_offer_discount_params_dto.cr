...
module OpenAPIClient
  ...
  class PromoOfferDiscountParamsDTO
    ...
    @[JSON::Field(key: "maxPromoPrice", type: Int64, nillable: false, emit_null: false)]
    property max_promo_price : Int64
    ...
    def initialize(@max_promo_price : Int64, @price : Int64?, @promo_price : Int64?)
    end
