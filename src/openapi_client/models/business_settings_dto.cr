...
module OpenAPIClient
  ...
  class BusinessSettingsDTO
    ...
    @[JSON::Field(key: "onlyDefaultPrice", type: Bool?, nillable: true, emit_null: false)]
    property only_default_price : Bool?
    ...
    def initialize(@only_default_price : Bool?, @currency : CurrencyType?)
    end
