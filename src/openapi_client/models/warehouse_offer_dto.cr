...
module OpenAPIClient
  ...
  class WarehouseOfferDTO
    ...
    @[JSON::Field(key: "stocks", type: Array(WarehouseStockDTO), nillable: false, emit_null: false)]
    property stocks : Array(WarehouseStockDTO)

    # Optional properties
    @[JSON::Field(key: "turnoverSummary", type: TurnoverDTO?, nillable: true, emit_null: false)]
    property turnover_summary : TurnoverDTO?
    ...
    def initialize(@offer_id : String, @stocks : Array(WarehouseStockDTO), @turnover_summary : TurnoverDTO?, @updated_at : Time?)
    end
