...
module OpenAPIClient
  ...
  class WarningPromoOfferUpdateDTO
    ...
    @[JSON::Field(key: "warnings", type: Array(PromoOfferUpdateWarningDTO), nillable: false, emit_null: false)]
    property warnings : Array(PromoOfferUpdateWarningDTO)

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@offer_id : String, @warnings : Array(PromoOfferUpdateWarningDTO))
    end
