...
module OpenAPIClient
  ...
  class GetOrdersStatsRequest
    ...
    @[JSON::Field(key: "updateFrom", type: Time?, nillable: true, emit_null: false)]
    property update_from : Time?
    ...
    @[JSON::Field(key: "updateTo", type: Time?, nillable: true, emit_null: false)]
    property update_to : Time?

    # Список идентификаторов заказов.
    @[JSON::Field(key: "orders", type: Array(Int64)?, nillable: true, emit_null: false)]
    property orders : Array(Int64)?

    # Список статусов заказов.
    @[JSON::Field(key: "statuses", type: Array(OrderStatsStatusType)?, nillable: true, emit_null: false)]
    property statuses : Array(OrderStatsStatusType)?
    ...
    @[JSON::Field(key: "hasCis", type: Bool?, nillable: true, emit_null: false)]
    property has_cis : Bool?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@date_from : Time?, @date_to : Time?, @update_from : Time?, @update_to : Time?, @orders : Array(Int64)?, @statuses : Array(OrderStatsStatusType)?, @has_cis : Bool?)
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          date_to == o.date_to &&
          update_from == o.update_from &&
          update_to == o.update_to &&
          orders == o.orders &&
          statuses == o.statuses &&
          has_cis == o.has_cis
    end
    ...
    def hash
      [date_from, date_to, update_from, update_to, orders, statuses, has_cis].hash
    end
