...
module OpenAPIClient
  ...
  class GetPromoBestsellerInfoDTO
    ...
    @[JSON::Field(key: "bestseller", type: Bool, nillable: false, emit_null: false)]
    property bestseller : Bool
    ...
    @[JSON::Field(key: "entryDeadline", type: Time?, nillable: true, emit_null: false)]
    property entry_deadline : Time?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@bestseller : Bool, @entry_deadline : Time?)
    end
