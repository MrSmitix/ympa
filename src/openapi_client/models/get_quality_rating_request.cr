...
module OpenAPIClient
  ...
  class GetQualityRatingRequest
    ...
    @[JSON::Field(key: "campaignIds", type: Set(Int64), nillable: false, emit_null: false)]
    property campaign_ids : Set(Int64)
    ...
    def initialize(@campaign_ids : Set(Int64), @date_from : Time?, @date_to : Time?)
    end
    ...
    def valid?
      return false if @campaign_ids.size > 50
      return false if @campaign_ids.size < 1
      true
    end
    ...
    def campaign_ids=(campaign_ids)
      if campaign_ids.size > 50
        raise ArgumentError.new("invalid value for \"campaign_ids\", number of items must be less than or equal to 50.")
      end
    ...
    def hash
      [date_from, date_to, campaign_ids].hash
    end
