...
module OpenAPIClient
  ...
  class CampaignSettingsScheduleDTO
    ...
    @[JSON::Field(key: "customHolidays", type: Array(String), nillable: false, emit_null: false)]
    property custom_holidays : Array(String)

    # Список выходных и праздничных дней, в которые служба доставки работает. Дни магазин указал в кабинете продавца на Маркете.
    @[JSON::Field(key: "customWorkingDays", type: Array(String), nillable: false, emit_null: false)]
    property custom_working_days : Array(String)
    ...
    @[JSON::Field(key: "totalHolidays", type: Array(String), nillable: false, emit_null: false)]
    property total_holidays : Array(String)

    # Список выходных дней недели и государственных праздников.
    @[JSON::Field(key: "weeklyHolidays", type: Array(Int32), nillable: false, emit_null: false)]
    property weekly_holidays : Array(Int32)
    ...
    @[JSON::Field(key: "availableOnHolidays", type: Bool?, nillable: true, emit_null: false)]
    property available_on_holidays : Bool?

    @[JSON::Field(key: "period", type: CampaignSettingsTimePeriodDTO?, nillable: true, emit_null: false)]
    property period : CampaignSettingsTimePeriodDTO?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@custom_holidays : Array(String), @custom_working_days : Array(String), @total_holidays : Array(String), @weekly_holidays : Array(Int32), @available_on_holidays : Bool?, @period : CampaignSettingsTimePeriodDTO?)
    end
