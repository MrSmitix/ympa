...
module OpenAPIClient
  ...
  class PriceSuggestOfferDTO
    ...
    @[JSON::Field(key: "priceSuggestion", type: Array(PriceSuggestDTO)?, nillable: true, emit_null: false)]
    property price_suggestion : Array(PriceSuggestDTO)?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@market_sku : Int64?, @offer_id : String?, @price_suggestion : Array(PriceSuggestDTO)?)
    end
