...
module OpenAPIClient
  ...
  class AddOffersToArchiveErrorDTO
    ...
    @[JSON::Field(key: "error", type: AddOffersToArchiveErrorType, nillable: false, emit_null: false)]
    property error : AddOffersToArchiveErrorType
    ...
    def initialize(@offer_id : String, @error : AddOffersToArchiveErrorType)
    end
