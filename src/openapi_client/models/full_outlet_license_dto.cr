...
module OpenAPIClient
  ...
  class FullOutletLicenseDTO
    ...
    @[JSON::Field(key: "outletId", type: Int64?, nillable: true, emit_null: false)]
    property outlet_id : Int64?

    @[JSON::Field(key: "licenseType", type: LicenseType?, nillable: true, emit_null: false)]
    property license_type : LicenseType?
    ...
    @[JSON::Field(key: "dateOfIssue", type: Time?, nillable: true, emit_null: false)]
    property date_of_issue : Time?

    # Дата окончания действия лицензии.  Формат даты: ISO 8601 со смещением относительно UTC. Нужно передать дату, указанную на лицензии, время `00:00:00` и часовой пояс, соответствующий региону точки продаж. Например, если действие лицензии для точки продаж в Москве заканчивается 20 ноября 2022 года, то параметр должен иметь значение `2022-11-20T00:00:00+03:00`.  Обязательный параметр.  Не может быть раньше даты выдачи, указанной в параметре `dateOfIssue`. 
    @[JSON::Field(key: "dateOfExpiry", type: Time?, nillable: true, emit_null: false)]
    property date_of_expiry : Time?

    @[JSON::Field(key: "checkStatus", type: LicenseCheckStatusType?, nillable: true, emit_null: false)]
    property check_status : LicenseCheckStatusType?
    ...
    @[JSON::Field(key: "checkComment", type: String?, nillable: true, emit_null: false)]
    property check_comment : String?
    ...
    def initialize(@id : Int64?, @outlet_id : Int64?, @license_type : LicenseType?, @number : String?, @date_of_issue : Time?, @date_of_expiry : Time?, @check_status : LicenseCheckStatusType?, @check_comment : String?)
    end
