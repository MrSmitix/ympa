...
module OpenAPIClient
  ...
  class FeedDownloadErrorDTO
    ...
    @[JSON::Field(key: "type", type: FeedDownloadErrorType?, nillable: true, emit_null: false)]
    property _type : FeedDownloadErrorType?
    ...
    def initialize(@http_status_code : Int32?, @_type : FeedDownloadErrorType?, @description : String?)
    end
