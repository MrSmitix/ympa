...
module OpenAPIClient
  ...
  class GetOfferDTO
    ...
    @[JSON::Field(key: "basicPrice", type: GetPriceWithDiscountDTO?, nillable: true, emit_null: false)]
    property basic_price : GetPriceWithDiscountDTO?

    @[JSON::Field(key: "purchasePrice", type: GetPriceDTO?, nillable: true, emit_null: false)]
    property purchase_price : GetPriceDTO?

    @[JSON::Field(key: "additionalExpenses", type: GetPriceDTO?, nillable: true, emit_null: false)]
    property additional_expenses : GetPriceDTO?

    @[JSON::Field(key: "cofinancePrice", type: GetPriceDTO?, nillable: true, emit_null: false)]
    property cofinance_price : GetPriceDTO?

    @[JSON::Field(key: "cardStatus", type: OfferCardStatusType?, nillable: true, emit_null: false)]
    property card_status : OfferCardStatusType?

    # Список магазинов, в которых размещен товар. 
    @[JSON::Field(key: "campaigns", type: Array(OfferCampaignStatusDTO)?, nillable: true, emit_null: false)]
    property campaigns : Array(OfferCampaignStatusDTO)?

    # Информация о том, какие для товара доступны модели размещения. 
    @[JSON::Field(key: "sellingPrograms", type: Array(OfferSellingProgramDTO)?, nillable: true, emit_null: false)]
    property selling_programs : Array(OfferSellingProgramDTO)?
    ...
    def initialize(@offer_id : String, @name : String?, @market_category_id : Int64?, @category : String?, @pictures : Array(String)?, @videos : Array(String)?, @manuals : Array(OfferManualDTO)?, @vendor : String?, @barcodes : Array(String)?, @description : String?, @manufacturer_countries : Array(String)?, @weight_dimensions : OfferWeightDimensionsDTO?, @vendor_code : String?, @tags : Array(String)?, @shelf_life : TimePeriodDTO?, @life_time : TimePeriodDTO?, @guarantee_period : TimePeriodDTO?, @customs_commodity_code : String?, @certificates : Array(String)?, @box_count : Int32?, @condition : OfferConditionDTO?, @_type : OfferType?, @downloadable : Bool?, @adult : Bool?, @age : AgeDTO?, @params : Array(OfferParamDTO)?, @basic_price : GetPriceWithDiscountDTO?, @purchase_price : GetPriceDTO?, @additional_expenses : GetPriceDTO?, @cofinance_price : GetPriceDTO?, @card_status : OfferCardStatusType?, @campaigns : Array(OfferCampaignStatusDTO)?, @selling_programs : Array(OfferSellingProgramDTO)?, @archived : Bool?)
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          selling_programs == o.selling_programs &&
          archived == o.archived
    end
