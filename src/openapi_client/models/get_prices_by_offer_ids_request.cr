...
module OpenAPIClient
  ...
  class GetPricesByOfferIdsRequest
    ...
    def list_invalid_properties
      ...
      if !@offer_ids.nil? && @offer_ids.size > 2000
    ...
    def valid?
      return false if !@offer_ids.nil? && @offer_ids.size > 2000
    ...
    def offer_ids=(offer_ids)
      if !offer_ids.nil? && offer_ids.size > 2000
        raise ArgumentError.new("invalid value for \"offer_ids\", number of items must be less than or equal to 2000.")
      end
