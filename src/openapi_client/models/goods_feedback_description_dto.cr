...
module OpenAPIClient
  ...
  class GoodsFeedbackDescriptionDTO
    ...
    @[JSON::Field(key: "advantages", type: String?, nillable: true, emit_null: false)]
    property advantages : String?

    # Описание минусов товара в отзыве.
    @[JSON::Field(key: "disadvantages", type: String?, nillable: true, emit_null: false)]
    ...
    def initialize(@advantages : String?, @disadvantages : String?, @comment : String?)
    end
