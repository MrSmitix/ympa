...
module OpenAPIClient
  ...
  class GetPromoAssortmentInfoDTO
    ...
    @[JSON::Field(key: "activeOffers", type: Int32, nillable: false, emit_null: false)]
    property active_offers : Int32

    # Optional properties
    # Количество доступных товаров в акции.  Параметр возвращается только для текущих и будущих акций. 
    @[JSON::Field(key: "potentialOffers", type: Int32?, nillable: true, emit_null: false)]
    property potential_offers : Int32?
    ...
    @[JSON::Field(key: "processing", type: Bool?, nillable: true, emit_null: false)]
    property processing : Bool?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@active_offers : Int32, @potential_offers : Int32?, @processing : Bool?)
    end
