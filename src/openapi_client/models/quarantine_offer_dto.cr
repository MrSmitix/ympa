...
module OpenAPIClient
  ...
  class QuarantineOfferDTO
    ...
    @[JSON::Field(key: "currentPrice", type: BasePriceDTO?, nillable: true, emit_null: false)]
    property current_price : BasePriceDTO?

    @[JSON::Field(key: "lastValidPrice", type: BasePriceDTO?, nillable: true, emit_null: false)]
    property last_valid_price : BasePriceDTO?

    # Причины попадания товара в карантин.
    @[JSON::Field(key: "verdicts", type: Array(PriceQuarantineVerdictDTO)?, nillable: true, emit_null: false)]
    property verdicts : Array(PriceQuarantineVerdictDTO)?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@offer_id : String?, @current_price : BasePriceDTO?, @last_valid_price : BasePriceDTO?, @verdicts : Array(PriceQuarantineVerdictDTO)?)
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          last_valid_price == o.last_valid_price &&
          verdicts == o.verdicts
    end
    ...
    def hash
      [offer_id, current_price, last_valid_price, verdicts].hash
    end
