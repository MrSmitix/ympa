...
module OpenAPIClient
  class GetOfferCardsContentStatusRequest
    ...
    @[JSON::Field(key: "offerIds", type: Set(String)?, nillable: true, emit_null: false)]
    property offer_ids : Set(String)?

    # Фильтр по статусам карточек.  [Что такое карточка товара](https://yandex.ru/support/marketplace/assortment/content/index.html) 
    @[JSON::Field(key: "cardStatuses", type: Set(OfferCardStatusType)?, nillable: true, emit_null: false)]
    property card_statuses : Set(OfferCardStatusType)?

    # Фильтр по категориям на Маркете.
    @[JSON::Field(key: "categoryIds", type: Set(Int32)?, nillable: true, emit_null: false)]
    property category_ids : Set(Int32)?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@offer_ids : Set(String)?, @card_statuses : Set(OfferCardStatusType)?, @category_ids : Set(Int32)?)
    end
    ...
    def list_invalid_properties
      ...
      if !@category_ids.nil? && @category_ids.size > 200
    ...
    def valid?
      ...
      return false if !@category_ids.nil? && @category_ids.size > 200
      true
    end
    ...
    def category_ids=(category_ids)
      if !category_ids.nil? && category_ids.size > 200
        raise ArgumentError.new("invalid value for \"category_ids\", number of items must be less than or equal to 200.")
      end
