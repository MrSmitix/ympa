...
module OpenAPIClient
  ...
  class OfferContentDTO
    ...
    @[JSON::Field(key: "categoryId", type: Int32, nillable: false, emit_null: false)]
    ...
    @[JSON::Field(key: "parameterValues", type: Array(ParameterValueDTO), nillable: false, emit_null: false)]
    property parameter_values : Array(ParameterValueDTO)

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@offer_id : String, @category_id : Int32, @parameter_values : Array(ParameterValueDTO))
    end
    ...
    def valid?
      ...
      return false if @parameter_values.size > 300
      return false if @parameter_values.size < 1
      true
    end
    ...
    def parameter_values=(parameter_values)
      ...
      if parameter_values.size < 1
        raise ArgumentError.new("invalid value for \"parameter_values\", number of items must be greater than or equal to 1.")
      end
