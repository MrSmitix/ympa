...
module OpenAPIClient
  ...
  class GetCampaignOffersRequest
    ...
    @[JSON::Field(key: "statuses", type: Array(OfferCampaignStatusType)?, nillable: true, emit_null: false)]
    property statuses : Array(OfferCampaignStatusType)?
    ...
    def initialize(@offer_ids : Array(String)?, @statuses : Array(OfferCampaignStatusType)?, @category_ids : Array(Int32)?, @vendor_names : Array(String)?, @tags : Array(String)?)
    end
