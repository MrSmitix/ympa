...
module OpenAPIClient
  ...
  class GetPromoOfferDTO
    ...
    @[JSON::Field(key: "status", type: PromoOfferParticipationStatusType, nillable: false, emit_null: false)]
    property status : PromoOfferParticipationStatusType

    @[JSON::Field(key: "params", type: PromoOfferParamsDTO, nillable: false, emit_null: false)]
    property params : PromoOfferParamsDTO

    # Optional properties
    @[JSON::Field(key: "autoParticipatingDetails", type: PromoOfferAutoParticipatingDetailsDTO?, nillable: true, emit_null: false)]
    property auto_participating_details : PromoOfferAutoParticipatingDetailsDTO?
    ...
    def initialize(@offer_id : String, @status : PromoOfferParticipationStatusType, @params : PromoOfferParamsDTO, @auto_participating_details : PromoOfferAutoParticipatingDetailsDTO?)
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          status == o.status &&
          params == o.params &&
          auto_participating_details == o.auto_participating_details
    end
    ...
    def hash
      [offer_id, status, params, auto_participating_details].hash
    end
