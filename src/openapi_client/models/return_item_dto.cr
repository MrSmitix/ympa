...
module OpenAPIClient
  ...
  class ReturnItemDTO
    ...
    @[JSON::Field(key: "shopSku", type: String, nillable: false, emit_null: false)]
    property shop_sku : String

    # Количество единиц товара.
    @[JSON::Field(key: "count", type: Int64, nillable: false, emit_null: false)]
    ...
    @[JSON::Field(key: "decisions", type: Array(ReturnDecisionDTO)?, nillable: true, emit_null: false)]
    property decisions : Array(ReturnDecisionDTO)?

    # Список логистических позиций возврата.
    @[JSON::Field(key: "instances", type: Array(ReturnInstanceDTO)?, nillable: true, emit_null: false)]
    property instances : Array(ReturnInstanceDTO)?

    # Список трек-кодов для почтовых отправлений.
    @[JSON::Field(key: "tracks", type: Array(TrackDTO)?, nillable: true, emit_null: false)]
    property tracks : Array(TrackDTO)?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@shop_sku : String, @count : Int64, @market_sku : Int64?, @decisions : Array(ReturnDecisionDTO)?, @instances : Array(ReturnInstanceDTO)?, @tracks : Array(TrackDTO)?)
    end
    ...
    def valid?
      return false if @shop_sku.to_s.size > 255
      return false if @shop_sku.to_s.size < 1
      return false if @shop_sku !~ Regexp.new(/^[^\x00-\x08\x0A-\x1f\x7f]{1,255}$/)
      true
    end
    ...
    def hash
      [market_sku, shop_sku, count, decisions, instances, tracks].hash
    end
