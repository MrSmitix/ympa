...
module OpenAPIClient
  ...
  class OrderShipmentDTO
    ...
    @[JSON::Field(key: "shipmentTime", type: String?, nillable: true, emit_null: false)]
    property shipment_time : String?
    ...
    @[JSON::Field(key: "boxes", type: Array(OrderParcelBoxDTO)?, nillable: true, emit_null: false)]
    property boxes : Array(OrderParcelBoxDTO)?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@id : Int64?, @shipment_date : String?, @shipment_time : String?, @tracks : Array(OrderTrackDTO)?, @boxes : Array(OrderParcelBoxDTO)?)
    end
