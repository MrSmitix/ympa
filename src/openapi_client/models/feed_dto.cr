...
module OpenAPIClient
  ...
  class FeedDTO
    ...
    @[JSON::Field(key: "uploadDate", type: Time?, nillable: true, emit_null: false)]
    ...
    @[JSON::Field(key: "content", type: FeedContentDTO?, nillable: true, emit_null: false)]
    property content : FeedContentDTO?

    @[JSON::Field(key: "download", type: FeedDownloadDTO?, nillable: true, emit_null: false)]
    property download : FeedDownloadDTO?

    @[JSON::Field(key: "placement", type: FeedPlacementDTO?, nillable: true, emit_null: false)]
    property placement : FeedPlacementDTO?

    @[JSON::Field(key: "publication", type: FeedPublicationDTO?, nillable: true, emit_null: false)]
    property publication : FeedPublicationDTO?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@id : Int64?, @login : String?, @name : String?, @password : String?, @upload_date : Time?, @url : String?, @content : FeedContentDTO?, @download : FeedDownloadDTO?, @placement : FeedPlacementDTO?, @publication : FeedPublicationDTO?)
    end
