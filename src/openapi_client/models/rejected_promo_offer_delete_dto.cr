...
module OpenAPIClient
  ...
  class RejectedPromoOfferDeleteDTO
    ...
    @[JSON::Field(key: "reason", type: RejectedPromoOfferDeleteReasonType, nillable: false, emit_null: false)]
    property reason : RejectedPromoOfferDeleteReasonType
    ...
    def initialize(@offer_id : String, @reason : RejectedPromoOfferDeleteReasonType)
    end
