...
module OpenAPIClient
  ...
  class UpdateOfferMappingResultDTO
    ...
    @[JSON::Field(key: "errors", type: Array(OfferMappingErrorDTO)?, nillable: true, emit_null: false)]
    property errors : Array(OfferMappingErrorDTO)?

    # Предупреждения — информация в каталоге обновится.
    @[JSON::Field(key: "warnings", type: Array(OfferMappingErrorDTO)?, nillable: true, emit_null: false)]
    property warnings : Array(OfferMappingErrorDTO)?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@offer_id : String, @errors : Array(OfferMappingErrorDTO)?, @warnings : Array(OfferMappingErrorDTO)?)
    end
