...
module OpenAPIClient
  ...
  class OrderBuyerInfoDTO
    ...
    # Отчество покупателя.
    @[JSON::Field(key: "middleName", type: String?, nillable: true, emit_null: false)]
    property middle_name : String?

    @[JSON::Field(key: "type", type: OrderBuyerType?, nillable: true, emit_null: false)]
    property _type : OrderBuyerType?
    ...
    def initialize(@id : String?, @last_name : String?, @first_name : String?, @middle_name : String?, @_type : OrderBuyerType?, @phone : String?)
    end
    ...
    def hash
      [id, last_name, first_name, middle_name, _type, phone].hash
    end
