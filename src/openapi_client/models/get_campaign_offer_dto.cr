...
module OpenAPIClient
  ...
  class GetCampaignOfferDTO
    ...
    # Optional properties
    @[JSON::Field(key: "quantum", type: QuantumDTO?, nillable: true, emit_null: false)]
    property quantum : QuantumDTO?
    ...
    @[JSON::Field(key: "campaignPrice", type: GetPriceWithVatDTO?, nillable: true, emit_null: false)]
    property campaign_price : GetPriceWithVatDTO?

    @[JSON::Field(key: "status", type: OfferCampaignStatusType?, nillable: true, emit_null: false)]
    property status : OfferCampaignStatusType?
    ...
    def initialize(@offer_id : String, @quantum : QuantumDTO?, @available : Bool?, @basic_price : GetPriceWithDiscountDTO?, @campaign_price : GetPriceWithVatDTO?, @status : OfferCampaignStatusType?, @errors : Array(OfferErrorDTO)?, @warnings : Array(OfferErrorDTO)?)
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          campaign_price == o.campaign_price &&
          status == o.status &&
          errors == o.errors &&
          warnings == o.warnings
    end
    ...
    def hash
      [offer_id, quantum, available, basic_price, campaign_price, status, errors, warnings].hash
    end
