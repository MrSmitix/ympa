...
module OpenAPIClient
  ...
  class OrderDeliveryDatesDTO
    ...
    @[JSON::Field(key: "fromDate", type: String?, nillable: true, emit_null: false)]
    property from_date : String?

    # Формат даты: `ДД-ММ-ГГГГ`. 
    @[JSON::Field(key: "toDate", type: String?, nillable: true, emit_null: false)]
    ...
    @[JSON::Field(key: "fromTime", type: String?, nillable: true, emit_null: false)]
    ...
    @[JSON::Field(key: "toTime", type: String?, nillable: true, emit_null: false)]
    property to_time : String?

    # Формат даты: `ДД-ММ-ГГГГ`. 
    @[JSON::Field(key: "realDeliveryDate", type: String?, nillable: true, emit_null: false)]
    property real_delivery_date : String?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@from_date : String?, @to_date : String?, @from_time : String?, @to_time : String?, @real_delivery_date : String?)
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          to_time == o.to_time &&
          real_delivery_date == o.real_delivery_date
    end
    ...
    def hash
      [from_date, to_date, from_time, to_time, real_delivery_date].hash
    end
