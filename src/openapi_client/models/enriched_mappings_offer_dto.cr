...
module OpenAPIClient
  ...
  class EnrichedMappingsOfferDTO
    ...
    @[JSON::Field(key: "marketCategoryName", type: String?, nillable: true, emit_null: false)]
    property market_category_name : String?

    # Идентификатор модели для рекомендованной карточки товара на Маркете.  Может отсутствовать в ответе. 
    @[JSON::Field(key: "marketModelId", type: Int64?, nillable: true, emit_null: false)]
    property market_model_id : Int64?

    # Название модели для рекомендованной карточки товара на Маркете.  Возвращается только вместе с параметром ##marketSku##. 
    @[JSON::Field(key: "marketModelName", type: String?, nillable: true, emit_null: false)]
    property market_model_name : String?
    ...
    @[JSON::Field(key: "marketSkuName", type: String?, nillable: true, emit_null: false)]
    property market_sku_name : String?
