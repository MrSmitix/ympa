...
public class DbsApiTest {
    ...
    public void acceptOrderCancellationTest() throws Exception {
        //EmptyApiResponse response = client.acceptOrderCancellation(campaignId, orderId, acceptOrderCancellationRequest);
    ...
    public void provideOrderDigitalCodesTest() throws Exception {
        //EmptyApiResponse response = client.provideOrderDigitalCodes(campaignId, orderId, provideOrderDigitalCodesRequest);
        //assertNotNull(response);
    }
