...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class OfferRecommendationInfoDTO : IEquatable<OfferRecommendationInfoDTO>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((OfferRecommendationInfoDTO)obj);
        }

        /// <summary>
        /// Returns true if OfferRecommendationInfoDTO instances are equal
        /// </summary>
        /// <param name="other">Instance of OfferRecommendationInfoDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OfferRecommendationInfoDTO other)
        {
            ...
            return 
                ...
                (
                    RecommendedCofinancePrice == other.RecommendedCofinancePrice ||
                    RecommendedCofinancePrice != null &&
                    RecommendedCofinancePrice.Equals(other.RecommendedCofinancePrice)
                ) && 
                (
                    CompetitivenessThresholds == other.CompetitivenessThresholds ||
                    CompetitivenessThresholds != null &&
                    CompetitivenessThresholds.Equals(other.CompetitivenessThresholds)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + RecommendedCofinancePrice.GetHashCode();
                    if (CompetitivenessThresholds != null)
                    hashCode = hashCode * 59 + CompetitivenessThresholds.GetHashCode();
                return hashCode;
            }
        }
        ...
        public static bool operator ==(OfferRecommendationInfoDTO left, OfferRecommendationInfoDTO right)
        {
