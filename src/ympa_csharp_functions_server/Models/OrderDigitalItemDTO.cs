...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class OrderDigitalItemDTO : IEquatable<OrderDigitalItemDTO>
    {
        /// <summary>
        ...
        [Required]
        [DataMember(Name="activate_till", EmitDefaultValue=false)]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((OrderDigitalItemDTO)obj);
        }

        /// <summary>
        /// Returns true if OrderDigitalItemDTO instances are equal
        /// </summary>
        /// <param name="other">Instance of OrderDigitalItemDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrderDigitalItemDTO other)
        {
            ...
            return 
                ...
                (
                    Slip == other.Slip ||
                    Slip != null &&
                    Slip.Equals(other.Slip)
                ) && 
                (
                    ActivateTill == other.ActivateTill ||
                    ActivateTill != null &&
                    ActivateTill.Equals(other.ActivateTill)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (Slip != null)
                    hashCode = hashCode * 59 + Slip.GetHashCode();
                    if (ActivateTill != null)
                    hashCode = hashCode * 59 + ActivateTill.GetHashCode();
                return hashCode;
            }
        }
        ...
        public static bool operator ==(OrderDigitalItemDTO left, OrderDigitalItemDTO right)
        {
