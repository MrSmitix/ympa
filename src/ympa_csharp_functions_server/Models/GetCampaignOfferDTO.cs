...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class GetCampaignOfferDTO : IEquatable<GetCampaignOfferDTO>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((GetCampaignOfferDTO)obj);
        }

        /// <summary>
        /// Returns true if GetCampaignOfferDTO instances are equal
        /// </summary>
        /// <param name="other">Instance of GetCampaignOfferDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetCampaignOfferDTO other)
        {
            ...
            return 
                ...
                (
                    ...
                    CampaignPrice != null &&
                    CampaignPrice.Equals(other.CampaignPrice)
                ) && 
                (
                    Status == other.Status ||
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + CampaignPrice.GetHashCode();
        ...
        public static bool operator ==(GetCampaignOfferDTO left, GetCampaignOfferDTO right)
        {
