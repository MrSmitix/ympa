...
feature --Access
    ...
    basic_price: detachable UPDATE_PRICE_WITH_DISCOUNT_DTO
      
    purchase_price: detachable BASE_PRICE_DTO
      
    additional_expenses: detachable BASE_PRICE_DTO
      
    cofinance_price: detachable BASE_PRICE_DTO
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass UPDATE_OFFER_DTO%N")
