...
feature --Access
    ...
    status_description: detachable STRING_32
      -- Описание статуса отгрузки.
    status_update_time: detachable DATE_TIME
...
feature -- Change Element
    ...
    set_status_description (a_name: like status_description)
        -- Set 'status_description' with 'a_name'.
      do
        status_description := a_name
      ensure
        status_description_set: status_description = a_name
      end

    set_status_update_time (a_name: like status_update_time)
        -- Set 'status_update_time' with 'a_name'.
      do
        status_update_time := a_name
      ensure
        status_update_time_set: status_update_time = a_name
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass SHIPMENT_INFO_DTO%N")
        ...
        if attached status_description as l_status_description then
          Result.append ("%Nstatus_description:")
          Result.append (l_status_description.out)
          Result.append ("%N")
        end
        if attached status_update_time as l_status_update_time then
          Result.append ("%Nstatus_update_time:")
          Result.append (l_status_update_time.out)
          Result.append ("%N")
        end
      end
end
