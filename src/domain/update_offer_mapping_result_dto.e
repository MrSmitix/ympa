...
class UPDATE_OFFER_MAPPING_RESULT_DTO
...
feature --Access
    ...
    errors: detachable LIST [OFFER_MAPPING_ERROR_DTO]
      -- Ошибки — информация в каталоге не обновится.
    warnings: detachable LIST [OFFER_MAPPING_ERROR_DTO]
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass UPDATE_OFFER_MAPPING_RESULT_DTO%N")
