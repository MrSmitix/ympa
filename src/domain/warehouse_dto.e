...
feature --Access
    ...
    address: detachable WAREHOUSE_ADDRESS_DTO
...
feature -- Change Element
    ...
    set_express (a_name: like express)
        -- Set 'express' with 'a_name'.
      do
        express := a_name
      ensure
        express_set: express = a_name
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass WAREHOUSE_DTO%N")
        ...
        if attached express as l_express then
          Result.append ("%Nexpress:")
          Result.append (l_express.out)
          Result.append ("%N")
        end
