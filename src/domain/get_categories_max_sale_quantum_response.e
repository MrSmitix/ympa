...
class GET_CATEGORIES_MAX_SALE_QUANTUM_RESPONSE
...
feature --Access
    ...
    results: detachable LIST [MAX_SALE_QUANTUM_DTO]
      -- Категории и лимит на установку кванта и минимального количества товаров.
    errors: detachable LIST [CATEGORY_ERROR_DTO]
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass GET_CATEGORIES_MAX_SALE_QUANTUM_RESPONSE%N")
