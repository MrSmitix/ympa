...
void
ApiLockedErrorResponse::__cleanup()
{
	//if(status != NULL) {
	//
	//delete status;
...
void
ApiLockedErrorResponse::fromJson(char* jsonStr)
{
...
ApiLockedErrorResponse::ApiLockedErrorResponse(char* json)
{
	this->fromJson(json);
}
