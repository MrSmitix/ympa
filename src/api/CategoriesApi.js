...
export default class CategoriesApi {
    ...
    */
     ...
     * @callback module:api/CategoriesApi~getCategoriesMaxSaleQuantumCallback
     ...
     * @param {module:api/CategoriesApi~getCategoriesMaxSaleQuantumCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/CategoriesApi~getCategoriesTreeCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/CategoriesApi~getCategoriesTreeCallback} callback The callback function, accepting three arguments: error, data, response
