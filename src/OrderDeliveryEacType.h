...
#ifndef _OrderDeliveryEacType_H_
#define _OrderDeliveryEacType_H_
...
class OrderDeliveryEacType : public Object {
public:
	/*! \brief Constructor.
	 */
	OrderDeliveryEacType();
	OrderDeliveryEacType(char* str);
...
#endif /* _OrderDeliveryEacType_H_ */
