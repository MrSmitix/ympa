...
void
MappingsOfferDTO::fromJson(char* jsonStr)
{
...
MappingsOfferDTO::MappingsOfferDTO(char* json)
{
	this->fromJson(json);
}
...
void
MappingsOfferDTO::setFeedId(long long  feedId)
{
	this->feedId = feedId;
}
...
void
MappingsOfferDTO::setPrice(long long  price)
{
	this->price = price;
}
