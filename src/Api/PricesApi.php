...
class PricesApi
{
    ...
    public function getPrices(
        ...
        ?int $limit = null,
        ?bool $archived = false,
        string $contentType = self::contentTypes['getPrices'][0]
    ...
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\OpenAPI\Client\Model\GetPricesResponse', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
    ...
    public function getPricesByOfferIds(
        ...
        ?string $page_token = null,
        ?int $limit = null,
        ?\OpenAPI\Client\Model\GetPricesByOfferIdsRequest $get_prices_by_offer_ids_request = null,
        string $contentType = self::contentTypes['getPricesByOfferIds'][0]
     ...
     * @return array of \OpenAPI\Client\Model\GetPricesByOfferIdsResponse|\OpenAPI\Client\Model\ApiClientDataErrorResponse|\OpenAPI\Client\Model\ApiUnauthorizedErrorResponse|\OpenAPI\Client\Model\ApiForbiddenErrorResponse|\OpenAPI\Client\Model\ApiNotFoundErrorResponse|\OpenAPI\Client\Model\ApiLimitErrorResponse|\OpenAPI\Client\Model\ApiServerErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPricesByOfferIdsWithHttpInfo(
        int $campaign_id,
        ?string $page_token = null,
        ?int $limit = null,
        ?\OpenAPI\Client\Model\GetPricesByOfferIdsRequest $get_prices_by_offer_ids_request = null,
    ...
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\OpenAPI\Client\Model\GetPricesByOfferIdsResponse', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
     ...
     * @return PromiseInterface
     */
    public function getPricesByOfferIdsAsync(
        int $campaign_id,
        ?string $page_token = null,
        ?int $limit = null,
        ?\OpenAPI\Client\Model\GetPricesByOfferIdsRequest $get_prices_by_offer_ids_request = null,
     ...
     * @return PromiseInterface
     */
    public function getPricesByOfferIdsAsyncWithHttpInfo(
        $campaign_id,
        $page_token = null,
        $limit = null,
        $get_prices_by_offer_ids_request = null,
        string $contentType = self::contentTypes['getPricesByOfferIds'][0]
    ): PromiseInterface
    {
        $returnType = '\OpenAPI\Client\Model\GetPricesByOfferIdsResponse';
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getPricesByOfferIdsRequest(
        $campaign_id,
        $page_token = null,
        $limit = null,
        $get_prices_by_offer_ids_request = null,
    ...
    public function getSuggestedPrices(
        int $campaign_id,
        \OpenAPI\Client\Model\SuggestPricesRequest $suggest_prices_request,
        string $contentType = self::contentTypes['getSuggestedPrices'][0]
     ...
     * @deprecated
     */
    public function getSuggestedPricesWithHttpInfo(
        int $campaign_id,
        \OpenAPI\Client\Model\SuggestPricesRequest $suggest_prices_request,
        string $contentType = self::contentTypes['getSuggestedPrices'][0]
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\OpenAPI\Client\Model\SuggestPricesResponse', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
     ...
     * @deprecated
     */
    public function getSuggestedPricesAsync(
        int $campaign_id,
        \OpenAPI\Client\Model\SuggestPricesRequest $suggest_prices_request,
        string $contentType = self::contentTypes['getSuggestedPrices'][0]
    ): PromiseInterface
     ...
     * @deprecated
     */
    public function getSuggestedPricesAsyncWithHttpInfo(
        $campaign_id,
     ...
     * @deprecated
     */
    public function getSuggestedPricesRequest(
        $campaign_id,
        $suggest_prices_request,
        string $contentType = self::contentTypes['getSuggestedPrices'][0]
    ): Request
    ...
    public function updateBusinessPrices(
        int $business_id,
        \OpenAPI\Client\Model\UpdateBusinessPricesRequest $update_business_prices_request,
        string $contentType = self::contentTypes['updateBusinessPrices'][0]
     ...
     * @return array of \OpenAPI\Client\Model\EmptyApiResponse|\OpenAPI\Client\Model\ApiClientDataErrorResponse|\OpenAPI\Client\Model\ApiUnauthorizedErrorResponse|\OpenAPI\Client\Model\ApiForbiddenErrorResponse|\OpenAPI\Client\Model\ApiNotFoundErrorResponse|\OpenAPI\Client\Model\ApiLimitErrorResponse|\OpenAPI\Client\Model\ApiLockedErrorResponse|\OpenAPI\Client\Model\ApiServerErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateBusinessPricesWithHttpInfo(
        int $business_id,
        \OpenAPI\Client\Model\UpdateBusinessPricesRequest $update_business_prices_request,
        string $contentType = self::contentTypes['updateBusinessPrices'][0]
    ): array
     ...
     * @return PromiseInterface
     */
    public function updateBusinessPricesAsync(
        int $business_id,
        \OpenAPI\Client\Model\UpdateBusinessPricesRequest $update_business_prices_request,
        string $contentType = self::contentTypes['updateBusinessPrices'][0]
    ): PromiseInterface
     ...
     * @return PromiseInterface
     */
    public function updateBusinessPricesAsyncWithHttpInfo(
        $business_id,
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateBusinessPricesRequest(
        $business_id,
        $update_business_prices_request,
        string $contentType = self::contentTypes['updateBusinessPrices'][0]
    ): Request
    ...
    public function updatePrices(
        int $campaign_id,
        \OpenAPI\Client\Model\UpdatePricesRequest $update_prices_request,
        string $contentType = self::contentTypes['updatePrices'][0]
    ): \OpenAPI\Client\Model\EmptyApiResponse
    {
     ...
     * @return array of \OpenAPI\Client\Model\EmptyApiResponse|\OpenAPI\Client\Model\ApiClientDataErrorResponse|\OpenAPI\Client\Model\ApiUnauthorizedErrorResponse|\OpenAPI\Client\Model\ApiForbiddenErrorResponse|\OpenAPI\Client\Model\ApiNotFoundErrorResponse|\OpenAPI\Client\Model\ApiLimitErrorResponse|\OpenAPI\Client\Model\ApiLockedErrorResponse|\OpenAPI\Client\Model\ApiServerErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function updatePricesWithHttpInfo(
        int $campaign_id,
        \OpenAPI\Client\Model\UpdatePricesRequest $update_prices_request,
        string $contentType = self::contentTypes['updatePrices'][0]
    ): array
     ...
     * @return PromiseInterface
     */
    public function updatePricesAsync(
        int $campaign_id,
        \OpenAPI\Client\Model\UpdatePricesRequest $update_prices_request,
        string $contentType = self::contentTypes['updatePrices'][0]
    ): PromiseInterface
     ...
     * @return PromiseInterface
     */
    public function updatePricesAsyncWithHttpInfo(
        $campaign_id,
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updatePricesRequest(
        $campaign_id,
        $update_prices_request,
        string $contentType = self::contentTypes['updatePrices'][0]
    ): Request
