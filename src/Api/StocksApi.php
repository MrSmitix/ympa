...
class StocksApi
{
    ...
    public function getStocks(
        ...
        ?int $limit = null,
        ?\OpenAPI\Client\Model\GetWarehouseStocksRequest $get_warehouse_stocks_request = null,
        string $contentType = self::contentTypes['getStocks'][0]
     ...
     */
    public function getStocksWithHttpInfo(
        int $campaign_id,
        ?string $page_token = null,
        ?int $limit = null,
        ?\OpenAPI\Client\Model\GetWarehouseStocksRequest $get_warehouse_stocks_request = null,
    ...
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\OpenAPI\Client\Model\GetWarehouseStocksResponse', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
     ...
     */
    public function getStocksAsync(
        int $campaign_id,
        ?string $page_token = null,
        ?int $limit = null,
        ?\OpenAPI\Client\Model\GetWarehouseStocksRequest $get_warehouse_stocks_request = null,
     ...
     * @return PromiseInterface
     */
    public function getStocksAsyncWithHttpInfo(
        $campaign_id,
        $page_token = null,
        $limit = null,
        $get_warehouse_stocks_request = null,
        string $contentType = self::contentTypes['getStocks'][0]
    ): PromiseInterface
    {
        $returnType = '\OpenAPI\Client\Model\GetWarehouseStocksResponse';
     ...
     */
    public function getStocksRequest(
        $campaign_id,
        $page_token = null,
        $limit = null,
        $get_warehouse_stocks_request = null,
    ...
    public function updateStocks(
        int $campaign_id,
        \OpenAPI\Client\Model\UpdateStocksRequest $update_stocks_request,
        string $contentType = self::contentTypes['updateStocks'][0]
     ...
     * @return array of \OpenAPI\Client\Model\EmptyApiResponse|\OpenAPI\Client\Model\ApiClientDataErrorResponse|\OpenAPI\Client\Model\ApiUnauthorizedErrorResponse|\OpenAPI\Client\Model\ApiForbiddenErrorResponse|\OpenAPI\Client\Model\ApiNotFoundErrorResponse|\OpenAPI\Client\Model\ApiLimitErrorResponse|\OpenAPI\Client\Model\ApiServerErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateStocksWithHttpInfo(
        int $campaign_id,
        \OpenAPI\Client\Model\UpdateStocksRequest $update_stocks_request,
        string $contentType = self::contentTypes['updateStocks'][0]
    ): array
     ...
     * @return PromiseInterface
     */
    public function updateStocksAsync(
        int $campaign_id,
        \OpenAPI\Client\Model\UpdateStocksRequest $update_stocks_request,
        string $contentType = self::contentTypes['updateStocks'][0]
    ): PromiseInterface
     ...
     * @return PromiseInterface
     */
    public function updateStocksAsyncWithHttpInfo(
        $campaign_id,
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateStocksRequest(
        $campaign_id,
        $update_stocks_request,
        string $contentType = self::contentTypes['updateStocks'][0]
    ): Request
