...
class RatingsApi
{
    ...
    public function getQualityRatingDetails(
        int $campaign_id,
        string $contentType = self::contentTypes['getQualityRatingDetails'][0]
     ...
     */
    public function getQualityRatingDetailsWithHttpInfo(
        int $campaign_id,
        string $contentType = self::contentTypes['getQualityRatingDetails'][0]
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\OpenAPI\Client\Model\GetQualityRatingDetailsResponse', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
     ...
     */
    public function getQualityRatingDetailsAsync(
        int $campaign_id,
        string $contentType = self::contentTypes['getQualityRatingDetails'][0]
    ): PromiseInterface
    {
     ...
     * @return PromiseInterface
     */
    public function getQualityRatingDetailsAsyncWithHttpInfo(
        $campaign_id,
        string $contentType = self::contentTypes['getQualityRatingDetails'][0]
    ): PromiseInterface
    {
     ...
     */
    public function getQualityRatingDetailsRequest(
        $campaign_id,
        string $contentType = self::contentTypes['getQualityRatingDetails'][0]
    ): Request
    {
    ...
    public function getQualityRatings(
        int $business_id,
        \OpenAPI\Client\Model\GetQualityRatingRequest $get_quality_rating_request,
        string $contentType = self::contentTypes['getQualityRatings'][0]
     ...
     * @return array of \OpenAPI\Client\Model\GetQualityRatingResponse|\OpenAPI\Client\Model\ApiClientDataErrorResponse|\OpenAPI\Client\Model\ApiUnauthorizedErrorResponse|\OpenAPI\Client\Model\ApiForbiddenErrorResponse|\OpenAPI\Client\Model\ApiNotFoundErrorResponse|\OpenAPI\Client\Model\ApiLimitErrorResponse|\OpenAPI\Client\Model\ApiServerErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getQualityRatingsWithHttpInfo(
        int $business_id,
        \OpenAPI\Client\Model\GetQualityRatingRequest $get_quality_rating_request,
        string $contentType = self::contentTypes['getQualityRatings'][0]
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\OpenAPI\Client\Model\GetQualityRatingResponse', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
     ...
     * @return PromiseInterface
     */
    public function getQualityRatingsAsync(
        int $business_id,
        \OpenAPI\Client\Model\GetQualityRatingRequest $get_quality_rating_request,
        string $contentType = self::contentTypes['getQualityRatings'][0]
    ): PromiseInterface
     ...
     * @return PromiseInterface
     */
    public function getQualityRatingsAsyncWithHttpInfo(
        $business_id,
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getQualityRatingsRequest(
        $business_id,
        $get_quality_rating_request,
        string $contentType = self::contentTypes['getQualityRatings'][0]
    ): Request
