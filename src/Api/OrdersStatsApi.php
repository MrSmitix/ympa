...
class OrdersStatsApi
{
    ...
    public function getOrdersStats(
        ...
        ?int $limit = null,
        ?\OpenAPI\Client\Model\GetOrdersStatsRequest $get_orders_stats_request = null,
        string $contentType = self::contentTypes['getOrdersStats'][0]
     ...
     */
    public function getOrdersStatsWithHttpInfo(
        int $campaign_id,
        ?string $page_token = null,
        ?int $limit = null,
        ?\OpenAPI\Client\Model\GetOrdersStatsRequest $get_orders_stats_request = null,
    ...
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\OpenAPI\Client\Model\GetOrdersStatsResponse', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
     ...
     */
    public function getOrdersStatsAsync(
        int $campaign_id,
        ?string $page_token = null,
        ?int $limit = null,
        ?\OpenAPI\Client\Model\GetOrdersStatsRequest $get_orders_stats_request = null,
     ...
     * @return PromiseInterface
     */
    public function getOrdersStatsAsyncWithHttpInfo(
        $campaign_id,
        $page_token = null,
        $limit = null,
        $get_orders_stats_request = null,
        string $contentType = self::contentTypes['getOrdersStats'][0]
    ): PromiseInterface
    {
        $returnType = '\OpenAPI\Client\Model\GetOrdersStatsResponse';
     ...
     */
    public function getOrdersStatsRequest(
        $campaign_id,
        $page_token = null,
        $limit = null,
        $get_orders_stats_request = null,
