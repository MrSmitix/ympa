...
class OrdersApi
{
    ...
    public function acceptOrderCancellation(
        int $campaign_id,
        int $order_id,
        \OpenAPI\Client\Model\AcceptOrderCancellationRequest $accept_order_cancellation_request,
        string $contentType = self::contentTypes['acceptOrderCancellation'][0]
     ...
     */
    public function acceptOrderCancellationWithHttpInfo(
        int $campaign_id,
        int $order_id,
        \OpenAPI\Client\Model\AcceptOrderCancellationRequest $accept_order_cancellation_request,
        string $contentType = self::contentTypes['acceptOrderCancellation'][0]
     ...
     */
    public function acceptOrderCancellationAsync(
        int $campaign_id,
        int $order_id,
        \OpenAPI\Client\Model\AcceptOrderCancellationRequest $accept_order_cancellation_request,
        string $contentType = self::contentTypes['acceptOrderCancellation'][0]
     ...
     * @return PromiseInterface
     */
    public function acceptOrderCancellationAsyncWithHttpInfo(
        $campaign_id,
        $order_id,
     ...
     */
    public function acceptOrderCancellationRequest(
        $campaign_id,
        $order_id,
        $accept_order_cancellation_request,
        string $contentType = self::contentTypes['acceptOrderCancellation'][0]
    ...
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\OpenAPI\Client\Model\GetOrderResponse', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
     ...
     * @param  \DateTime|null $to_date Конечная дата для фильтрации заказов по дате оформления.  Показываются заказы, созданные до 00:00 указанного дня.  Формат даты: &#x60;ДД-ММ-ГГГГ&#x60;.  Между начальной (параметр &#x60;fromDate&#x60;) и конечной датой должно быть не больше 30 дней.  Значение по умолчанию: текущая дата. (optional)
     ...
     * @param  OrderDeliveryDispatchType|null $dispatch_type Способ отгрузки (optional)
     * @param  bool|null $fake Фильтрация заказов по типам:  * &#x60;false&#x60; — настоящий заказ покупателя.  * &#x60;true&#x60; — [тестовый](../../pushapi/concepts/sandbox.md) заказ Маркета. (optional, default to false)
     * @param  bool|null $has_cis Нужно ли вернуть только те заказы, в составе которых есть хотя бы один товар с кодом идентификации [в системе «Честный ЗНАК»](https://честныйзнак.рф/):  * &#x60;true&#x60; — да.  * &#x60;false&#x60; — нет.  Такие коды присваиваются товарам, которые подлежат маркировке и относятся к определенным категориям. (optional, default to false)
     ...
     * @param  OrderBuyerType|null $buyer_type Фильтрация заказов по типу покупателя. (optional)
     * @param  int|null $page Номер страницы результатов.  Значение по умолчанию: 1.  Используется вместе с параметром &#x60;page_size&#x60;.  &#x60;page_number&#x60; игнорируется, если задан &#x60;page_token&#x60;, &#x60;limit&#x60; или &#x60;offset&#x60;. (optional, default to 1)
     * @param  int|null $page_size Размер страницы.  Используется вместе с параметром &#x60;page_number&#x60;.  &#x60;page_size&#x60; игнорируется, если задан &#x60;page_token&#x60;, &#x60;limit&#x60; или &#x60;offset&#x60;. (optional)
    ...
    public function getOrders(
        int $campaign_id,
        ?array $order_ids = null,
        ?array $status = null,
        ?array $substatus = null,
        ?\DateTime $from_date = null,
        ?\DateTime $to_date = null,
        ?\DateTime $supplier_shipment_date_from = null,
        ?\DateTime $supplier_shipment_date_to = null,
        ?\DateTime $updated_at_from = null,
        ?\DateTime $updated_at_to = null,
        ?OrderDeliveryDispatchType $dispatch_type = null,
        ?bool $fake = false,
        ?bool $has_cis = false,
        ?bool $only_waiting_for_cancellation_approve = false,
        ?bool $only_estimated_delivery = false,
        ?OrderBuyerType $buyer_type = null,
        ?int $page = 1,
        ?int $page_size = null,
    ...
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\OpenAPI\Client\Model\GetOrdersResponse', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
    ...
    public function getOrdersAsyncWithHttpInfo(
        ...
        $from_date = null,
        $to_date = null,
        $supplier_shipment_date_from = null,
        $supplier_shipment_date_to = null,
    ...
    public function provideOrderDigitalCodes(
        int $campaign_id,
        int $order_id,
        \OpenAPI\Client\Model\ProvideOrderDigitalCodesRequest $provide_order_digital_codes_request,
        string $contentType = self::contentTypes['provideOrderDigitalCodes'][0]
    ): \OpenAPI\Client\Model\EmptyApiResponse
    {
     ...
     * @return array of \OpenAPI\Client\Model\EmptyApiResponse|\OpenAPI\Client\Model\ApiClientDataErrorResponse|\OpenAPI\Client\Model\ApiUnauthorizedErrorResponse|\OpenAPI\Client\Model\ApiForbiddenErrorResponse|\OpenAPI\Client\Model\ApiNotFoundErrorResponse|\OpenAPI\Client\Model\ApiLimitErrorResponse|\OpenAPI\Client\Model\ApiServerErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function provideOrderDigitalCodesWithHttpInfo(
        int $campaign_id,
        int $order_id,
        \OpenAPI\Client\Model\ProvideOrderDigitalCodesRequest $provide_order_digital_codes_request,
        string $contentType = self::contentTypes['provideOrderDigitalCodes'][0]
     ...
     * @return PromiseInterface
     */
    public function provideOrderDigitalCodesAsync(
        int $campaign_id,
        int $order_id,
        \OpenAPI\Client\Model\ProvideOrderDigitalCodesRequest $provide_order_digital_codes_request,
        string $contentType = self::contentTypes['provideOrderDigitalCodes'][0]
     ...
     * @return PromiseInterface
     */
    public function provideOrderDigitalCodesAsyncWithHttpInfo(
        $campaign_id,
        $order_id,
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function provideOrderDigitalCodesRequest(
        $campaign_id,
        $order_id,
        $provide_order_digital_codes_request,
        string $contentType = self::contentTypes['provideOrderDigitalCodes'][0]
    ...
    public function provideOrderItemIdentifiers(
        int $campaign_id,
        int $order_id,
        \OpenAPI\Client\Model\ProvideOrderItemIdentifiersRequest $provide_order_item_identifiers_request,
        string $contentType = self::contentTypes['provideOrderItemIdentifiers'][0]
    ...
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\OpenAPI\Client\Model\ProvideOrderItemIdentifiersResponse', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
     ...
     * @return PromiseInterface
     */
    public function provideOrderItemIdentifiersAsyncWithHttpInfo(
        $campaign_id,
        $order_id,
    ...
    public function setOrderBoxLayout(
        int $campaign_id,
        int $order_id,
        \OpenAPI\Client\Model\SetOrderBoxLayoutRequest $set_order_box_layout_request,
        string $contentType = self::contentTypes['setOrderBoxLayout'][0]
     ...
     * @return array of \OpenAPI\Client\Model\SetOrderBoxLayoutResponse|\OpenAPI\Client\Model\ApiClientDataErrorResponse|\OpenAPI\Client\Model\ApiUnauthorizedErrorResponse|\OpenAPI\Client\Model\ApiForbiddenErrorResponse|\OpenAPI\Client\Model\ApiNotFoundErrorResponse|\OpenAPI\Client\Model\ApiLimitErrorResponse|\OpenAPI\Client\Model\ApiServerErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function setOrderBoxLayoutWithHttpInfo(
        int $campaign_id,
        int $order_id,
        \OpenAPI\Client\Model\SetOrderBoxLayoutRequest $set_order_box_layout_request,
        string $contentType = self::contentTypes['setOrderBoxLayout'][0]
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\OpenAPI\Client\Model\SetOrderBoxLayoutResponse', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
     ...
     * @return PromiseInterface
     */
    public function setOrderBoxLayoutAsync(
        int $campaign_id,
        int $order_id,
        \OpenAPI\Client\Model\SetOrderBoxLayoutRequest $set_order_box_layout_request,
        string $contentType = self::contentTypes['setOrderBoxLayout'][0]
     ...
     * @return PromiseInterface
     */
    public function setOrderBoxLayoutAsyncWithHttpInfo(
        $campaign_id,
        $order_id,
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function setOrderBoxLayoutRequest(
        $campaign_id,
        $order_id,
        $set_order_box_layout_request,
        string $contentType = self::contentTypes['setOrderBoxLayout'][0]
    ...
    public function setOrderShipmentBoxes(
        ...
        int $order_id,
        int $shipment_id,
        \OpenAPI\Client\Model\SetOrderShipmentBoxesRequest $set_order_shipment_boxes_request,
        string $contentType = self::contentTypes['setOrderShipmentBoxes'][0]
     ...
     * @return array of \OpenAPI\Client\Model\SetOrderShipmentBoxesResponse|\OpenAPI\Client\Model\ApiClientDataErrorResponse|\OpenAPI\Client\Model\ApiUnauthorizedErrorResponse|\OpenAPI\Client\Model\ApiForbiddenErrorResponse|\OpenAPI\Client\Model\ApiNotFoundErrorResponse|\OpenAPI\Client\Model\ApiLimitErrorResponse|\OpenAPI\Client\Model\ApiServerErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function setOrderShipmentBoxesWithHttpInfo(
        int $campaign_id,
        int $order_id,
        int $shipment_id,
        \OpenAPI\Client\Model\SetOrderShipmentBoxesRequest $set_order_shipment_boxes_request,
    ...
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\OpenAPI\Client\Model\SetOrderShipmentBoxesResponse', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
     ...
     * @return PromiseInterface
     */
    public function setOrderShipmentBoxesAsync(
        int $campaign_id,
        int $order_id,
        int $shipment_id,
        \OpenAPI\Client\Model\SetOrderShipmentBoxesRequest $set_order_shipment_boxes_request,
     ...
     * @return PromiseInterface
     */
    public function setOrderShipmentBoxesAsyncWithHttpInfo(
        $campaign_id,
        $order_id,
        $shipment_id,
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function setOrderShipmentBoxesRequest(
        $campaign_id,
        $order_id,
        $shipment_id,
        $set_order_shipment_boxes_request,
    ...
    public function updateOrderItems(
        int $campaign_id,
        int $order_id,
        \OpenAPI\Client\Model\UpdateOrderItemRequest $update_order_item_request,
        string $contentType = self::contentTypes['updateOrderItems'][0]
    ): void
    {
     ...
     */
    public function updateOrderItemsWithHttpInfo(
        int $campaign_id,
        int $order_id,
        \OpenAPI\Client\Model\UpdateOrderItemRequest $update_order_item_request,
        string $contentType = self::contentTypes['updateOrderItems'][0]
     ...
     * @return PromiseInterface
     */
    public function updateOrderItemsAsync(
        int $campaign_id,
        int $order_id,
        \OpenAPI\Client\Model\UpdateOrderItemRequest $update_order_item_request,
        string $contentType = self::contentTypes['updateOrderItems'][0]
     ...
     * @return PromiseInterface
     */
    public function updateOrderItemsAsyncWithHttpInfo(
        $campaign_id,
        $order_id,
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateOrderItemsRequest(
        $campaign_id,
        $order_id,
        $update_order_item_request,
        string $contentType = self::contentTypes['updateOrderItems'][0]
    ...
    public function updateOrderStatus(
        int $campaign_id,
        int $order_id,
        \OpenAPI\Client\Model\UpdateOrderStatusRequest $update_order_status_request,
        string $contentType = self::contentTypes['updateOrderStatus'][0]
    ...
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\OpenAPI\Client\Model\UpdateOrderStatusResponse', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
    ...
    public function updateOrderStatuses(
        int $campaign_id,
        \OpenAPI\Client\Model\UpdateOrderStatusesRequest $update_order_statuses_request,
        string $contentType = self::contentTypes['updateOrderStatuses'][0]
     ...
     * @return array of \OpenAPI\Client\Model\UpdateOrderStatusesResponse|\OpenAPI\Client\Model\ApiClientDataErrorResponse|\OpenAPI\Client\Model\ApiUnauthorizedErrorResponse|\OpenAPI\Client\Model\ApiForbiddenErrorResponse|\OpenAPI\Client\Model\ApiNotFoundErrorResponse|\OpenAPI\Client\Model\ApiLimitErrorResponse|\OpenAPI\Client\Model\ApiServerErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateOrderStatusesWithHttpInfo(
        int $campaign_id,
        \OpenAPI\Client\Model\UpdateOrderStatusesRequest $update_order_statuses_request,
        string $contentType = self::contentTypes['updateOrderStatuses'][0]
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\OpenAPI\Client\Model\UpdateOrderStatusesResponse', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
     ...
     * @return PromiseInterface
     */
    public function updateOrderStatusesAsync(
        int $campaign_id,
        \OpenAPI\Client\Model\UpdateOrderStatusesRequest $update_order_statuses_request,
        string $contentType = self::contentTypes['updateOrderStatuses'][0]
    ): PromiseInterface
     ...
     * @return PromiseInterface
     */
    public function updateOrderStatusesAsyncWithHttpInfo(
        $campaign_id,
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateOrderStatusesRequest(
        $campaign_id,
        $update_order_statuses_request,
        string $contentType = self::contentTypes['updateOrderStatuses'][0]
    ): Request
