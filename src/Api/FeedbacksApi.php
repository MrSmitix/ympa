...
class FeedbacksApi
{
     ...
     * @param  \DateTime|null $from_date Начальная дата обновления отзывов.  Если параметр указан, возвращаются отзывы, которые были написаны или обновлены с этой даты.  Формат даты: &#x60;ГГГГ-ММ-ДД&#x60;. (optional)
    ...
    public function getFeedbackAndCommentUpdates(
        ...
        string $contentType = self::contentTypes['getFeedbackAndCommentUpdates'][0]
     ...
     * @deprecated
     */
    public function getFeedbackAndCommentUpdatesWithHttpInfo(
        int $campaign_id,
        ?string $page_token = null,
        ?int $limit = null,
        ?\DateTime $from_date = null,
    ...
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\OpenAPI\Client\Model\GetFeedbackListResponse', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
     ...
     * @deprecated
     */
    public function getFeedbackAndCommentUpdatesAsync(
        int $campaign_id,
        ?string $page_token = null,
        ?int $limit = null,
        ?\DateTime $from_date = null,
     ...
     * @deprecated
     */
    public function getFeedbackAndCommentUpdatesAsyncWithHttpInfo(
        $campaign_id,
        $page_token = null,
        $limit = null,
        $from_date = null,
     ...
     * @deprecated
     */
    public function getFeedbackAndCommentUpdatesRequest(
        $campaign_id,
        $page_token = null,
        $limit = null,
        $from_date = null,
