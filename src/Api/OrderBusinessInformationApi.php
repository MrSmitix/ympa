...
class OrderBusinessInformationApi
{
    ...
    public function getOrderBusinessBuyerInfo(
        int $campaign_id,
        int $order_id,
        string $contentType = self::contentTypes['getOrderBusinessBuyerInfo'][0]
     ...
     */
    public function getOrderBusinessBuyerInfoWithHttpInfo(
        int $campaign_id,
        int $order_id,
        string $contentType = self::contentTypes['getOrderBusinessBuyerInfo'][0]
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\OpenAPI\Client\Model\GetBusinessBuyerInfoResponse', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
     ...
     */
    public function getOrderBusinessBuyerInfoAsync(
        int $campaign_id,
        int $order_id,
        string $contentType = self::contentTypes['getOrderBusinessBuyerInfo'][0]
    ): PromiseInterface
     ...
     * @return PromiseInterface
     */
    public function getOrderBusinessBuyerInfoAsyncWithHttpInfo(
        $campaign_id,
        $order_id,
        string $contentType = self::contentTypes['getOrderBusinessBuyerInfo'][0]
    ): PromiseInterface
     ...
     */
    public function getOrderBusinessBuyerInfoRequest(
        $campaign_id,
        $order_id,
        string $contentType = self::contentTypes['getOrderBusinessBuyerInfo'][0]
    ): Request
    ...
    public function getOrderBusinessDocumentsInfo(
        int $campaign_id,
        int $order_id,
        string $contentType = self::contentTypes['getOrderBusinessDocumentsInfo'][0]
     ...
     * @return array of \OpenAPI\Client\Model\GetBusinessDocumentsInfoResponse|\OpenAPI\Client\Model\ApiClientDataErrorResponse|\OpenAPI\Client\Model\ApiUnauthorizedErrorResponse|\OpenAPI\Client\Model\ApiForbiddenErrorResponse|\OpenAPI\Client\Model\ApiNotFoundErrorResponse|\OpenAPI\Client\Model\ApiLimitErrorResponse|\OpenAPI\Client\Model\ApiServerErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getOrderBusinessDocumentsInfoWithHttpInfo(
        int $campaign_id,
        int $order_id,
        string $contentType = self::contentTypes['getOrderBusinessDocumentsInfo'][0]
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\OpenAPI\Client\Model\GetBusinessDocumentsInfoResponse', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
     ...
     * @return PromiseInterface
     */
    public function getOrderBusinessDocumentsInfoAsync(
        int $campaign_id,
        int $order_id,
        string $contentType = self::contentTypes['getOrderBusinessDocumentsInfo'][0]
    ): PromiseInterface
     ...
     * @return PromiseInterface
     */
    public function getOrderBusinessDocumentsInfoAsyncWithHttpInfo(
        $campaign_id,
        $order_id,
        string $contentType = self::contentTypes['getOrderBusinessDocumentsInfo'][0]
    ): PromiseInterface
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getOrderBusinessDocumentsInfoRequest(
        $campaign_id,
        $order_id,
        string $contentType = self::contentTypes['getOrderBusinessDocumentsInfo'][0]
    ): Request
