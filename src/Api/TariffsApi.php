...
class TariffsApi
{
    ...
    public function calculateTariffs(
        \OpenAPI\Client\Model\CalculateTariffsRequest $calculate_tariffs_request,
        string $contentType = self::contentTypes['calculateTariffs'][0]
     ...
     */
    public function calculateTariffsWithHttpInfo(
        \OpenAPI\Client\Model\CalculateTariffsRequest $calculate_tariffs_request,
        string $contentType = self::contentTypes['calculateTariffs'][0]
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\OpenAPI\Client\Model\CalculateTariffsResponse', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
     ...
     */
    public function calculateTariffsAsync(
        \OpenAPI\Client\Model\CalculateTariffsRequest $calculate_tariffs_request,
        string $contentType = self::contentTypes['calculateTariffs'][0]
    ): PromiseInterface
    {
     ...
     * @return PromiseInterface
     */
    public function calculateTariffsAsyncWithHttpInfo(
     ...
     */
    public function calculateTariffsRequest(
        $calculate_tariffs_request,
        string $contentType = self::contentTypes['calculateTariffs'][0]
    ): Request
    {
