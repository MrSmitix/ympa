...
class BusinessesApi
{
    ...
    public function getBusinessSettings(
        int $business_id,
        string $contentType = self::contentTypes['getBusinessSettings'][0]
     ...
     */
    public function getBusinessSettingsWithHttpInfo(
        int $business_id,
        string $contentType = self::contentTypes['getBusinessSettings'][0]
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\OpenAPI\Client\Model\GetBusinessSettingsResponse', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
     ...
     */
    public function getBusinessSettingsAsync(
        int $business_id,
        string $contentType = self::contentTypes['getBusinessSettings'][0]
    ): PromiseInterface
    {
     ...
     * @return PromiseInterface
     */
    public function getBusinessSettingsAsyncWithHttpInfo(
        $business_id,
        string $contentType = self::contentTypes['getBusinessSettings'][0]
    ): PromiseInterface
    {
     ...
     */
    public function getBusinessSettingsRequest(
        $business_id,
        string $contentType = self::contentTypes['getBusinessSettings'][0]
    ): Request
    {
