...
class CampaignsApi
{
    ...
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\OpenAPI\Client\Model\GetCampaignResponse', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
    ...
    public function getCampaignLogins(
        int $campaign_id,
        string $contentType = self::contentTypes['getCampaignLogins'][0]
     ...
     * @return array of \OpenAPI\Client\Model\GetCampaignLoginsResponse|\OpenAPI\Client\Model\ApiClientDataErrorResponse|\OpenAPI\Client\Model\ApiUnauthorizedErrorResponse|\OpenAPI\Client\Model\ApiForbiddenErrorResponse|\OpenAPI\Client\Model\ApiNotFoundErrorResponse|\OpenAPI\Client\Model\ApiLimitErrorResponse|\OpenAPI\Client\Model\ApiServerErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCampaignLoginsWithHttpInfo(
        int $campaign_id,
        string $contentType = self::contentTypes['getCampaignLogins'][0]
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\OpenAPI\Client\Model\GetCampaignLoginsResponse', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
     ...
     * @return PromiseInterface
     */
    public function getCampaignLoginsAsync(
        int $campaign_id,
        string $contentType = self::contentTypes['getCampaignLogins'][0]
    ): PromiseInterface
    {
     ...
     * @return PromiseInterface
     */
    public function getCampaignLoginsAsyncWithHttpInfo(
        $campaign_id,
        string $contentType = self::contentTypes['getCampaignLogins'][0]
    ): PromiseInterface
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getCampaignLoginsRequest(
        $campaign_id,
        string $contentType = self::contentTypes['getCampaignLogins'][0]
    ): Request
    {
    ...
    public function getCampaignRegion(
        int $campaign_id,
        string $contentType = self::contentTypes['getCampaignRegion'][0]
     ...
     * @deprecated
     */
    public function getCampaignRegionWithHttpInfo(
        int $campaign_id,
        string $contentType = self::contentTypes['getCampaignRegion'][0]
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\OpenAPI\Client\Model\GetCampaignRegionResponse', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
     ...
     * @deprecated
     */
    public function getCampaignRegionAsync(
        int $campaign_id,
        string $contentType = self::contentTypes['getCampaignRegion'][0]
    ): PromiseInterface
    {
     ...
     * @deprecated
     */
    public function getCampaignRegionAsyncWithHttpInfo(
        $campaign_id,
        string $contentType = self::contentTypes['getCampaignRegion'][0]
    ): PromiseInterface
    {
     ...
     * @deprecated
     */
    public function getCampaignRegionRequest(
        $campaign_id,
        string $contentType = self::contentTypes['getCampaignRegion'][0]
    ): Request
    {
    ...
    public function getCampaignSettings(
        int $campaign_id,
        string $contentType = self::contentTypes['getCampaignSettings'][0]
     ...
     * @return array of \OpenAPI\Client\Model\GetCampaignSettingsResponse|\OpenAPI\Client\Model\ApiClientDataErrorResponse|\OpenAPI\Client\Model\ApiUnauthorizedErrorResponse|\OpenAPI\Client\Model\ApiForbiddenErrorResponse|\OpenAPI\Client\Model\ApiNotFoundErrorResponse|\OpenAPI\Client\Model\ApiLimitErrorResponse|\OpenAPI\Client\Model\ApiServerErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCampaignSettingsWithHttpInfo(
        int $campaign_id,
        string $contentType = self::contentTypes['getCampaignSettings'][0]
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\OpenAPI\Client\Model\GetCampaignSettingsResponse', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
     ...
     * @return PromiseInterface
     */
    public function getCampaignSettingsAsync(
        int $campaign_id,
        string $contentType = self::contentTypes['getCampaignSettings'][0]
    ): PromiseInterface
    {
     ...
     * @return PromiseInterface
     */
    public function getCampaignSettingsAsyncWithHttpInfo(
        $campaign_id,
        string $contentType = self::contentTypes['getCampaignSettings'][0]
    ): PromiseInterface
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getCampaignSettingsRequest(
        $campaign_id,
        string $contentType = self::contentTypes['getCampaignSettings'][0]
    ): Request
    {
    ...
    public function getCampaigns(
        ?int $page = 1,
        ?int $page_size = null,
        string $contentType = self::contentTypes['getCampaigns'][0]
    ...
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\OpenAPI\Client\Model\GetCampaignsResponse', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
     ...
     * @return PromiseInterface
     */
    public function getCampaignsAsync(
        ?int $page = 1,
        ?int $page_size = null,
        string $contentType = self::contentTypes['getCampaigns'][0]
    ): PromiseInterface
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getCampaignsRequest(
        $page = 1,
        $page_size = null,
        string $contentType = self::contentTypes['getCampaigns'][0]
    ): Request
    ...
    public function getCampaignsByLogin(
        ...
        ?int $page = 1,
        ?int $page_size = null,
        string $contentType = self::contentTypes['getCampaignsByLogin'][0]
    ): \OpenAPI\Client\Model\GetCampaignsResponse
    {
     ...
     * @return array of \OpenAPI\Client\Model\GetCampaignsResponse|\OpenAPI\Client\Model\ApiClientDataErrorResponse|\OpenAPI\Client\Model\ApiUnauthorizedErrorResponse|\OpenAPI\Client\Model\ApiForbiddenErrorResponse|\OpenAPI\Client\Model\ApiNotFoundErrorResponse|\OpenAPI\Client\Model\ApiLimitErrorResponse|\OpenAPI\Client\Model\ApiServerErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCampaignsByLoginWithHttpInfo(
        string $login,
        ?int $page = 1,
        ?int $page_size = null,
        string $contentType = self::contentTypes['getCampaignsByLogin'][0]
     ...
     * @return PromiseInterface
     */
    public function getCampaignsByLoginAsync(
        string $login,
        ?int $page = 1,
        ?int $page_size = null,
        string $contentType = self::contentTypes['getCampaignsByLogin'][0]
     ...
     * @return PromiseInterface
     */
    public function getCampaignsByLoginAsyncWithHttpInfo(
        $login,
        $page = 1,
        $page_size = null,
        string $contentType = self::contentTypes['getCampaignsByLogin'][0]
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getCampaignsByLoginRequest(
        $login,
        $page = 1,
        $page_size = null,
        string $contentType = self::contentTypes['getCampaignsByLogin'][0]
