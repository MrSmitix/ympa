...
class ReturnsApi
{
    ...
    public function getReturn(
        ...
        int $order_id,
        int $return_id,
        string $contentType = self::contentTypes['getReturn'][0]
    ...
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\OpenAPI\Client\Model\GetReturnResponse', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
    ...
    public function getReturnApplication(
        ...
        int $order_id,
        int $return_id,
        string $contentType = self::contentTypes['getReturnApplication'][0]
    ): \SplFileObject
    {
     ...
     */
    public function getReturnApplicationWithHttpInfo(
        int $campaign_id,
        int $order_id,
        int $return_id,
        string $contentType = self::contentTypes['getReturnApplication'][0]
     ...
     * @return PromiseInterface
     */
    public function getReturnApplicationAsync(
        int $campaign_id,
        int $order_id,
        int $return_id,
        string $contentType = self::contentTypes['getReturnApplication'][0]
     ...
     * @return PromiseInterface
     */
    public function getReturnApplicationAsyncWithHttpInfo(
        $campaign_id,
        $order_id,
        $return_id,
        string $contentType = self::contentTypes['getReturnApplication'][0]
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getReturnApplicationRequest(
        $campaign_id,
        $order_id,
        $return_id,
        string $contentType = self::contentTypes['getReturnApplication'][0]
    ...
    public function getReturnPhoto(
        ...
        int $item_id,
        string $image_hash,
        string $contentType = self::contentTypes['getReturnPhoto'][0]
    ): \SplFileObject
    {
     ...
     * @return array of \SplFileObject|\OpenAPI\Client\Model\ApiClientDataErrorResponse|\OpenAPI\Client\Model\ApiUnauthorizedErrorResponse|\OpenAPI\Client\Model\ApiForbiddenErrorResponse|\OpenAPI\Client\Model\ApiNotFoundErrorResponse|\OpenAPI\Client\Model\ApiLimitErrorResponse|\OpenAPI\Client\Model\ApiServerErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getReturnPhotoWithHttpInfo(
        int $campaign_id,
        int $order_id,
        int $return_id,
        int $item_id,
     ...
     * @return PromiseInterface
     */
    public function getReturnPhotoAsync(
        int $campaign_id,
        int $order_id,
        int $return_id,
        int $item_id,
     ...
     * @return PromiseInterface
     */
    public function getReturnPhotoAsyncWithHttpInfo(
        $campaign_id,
        $order_id,
        $return_id,
        $item_id,
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getReturnPhotoRequest(
        $campaign_id,
        $order_id,
        $return_id,
        $item_id,
     ...
     * @param  int[]|null $order_ids Идентификаторы заказов — для фильтрации результатов.  Несколько идентификаторов перечисляются через запятую без пробела. Максимальное количество идентификаторов — 50. (optional)
     * @param  \OpenAPI\Client\Model\RefundStatusType[]|null $statuses Статусы возвратов или невыкупов — для фильтрации результатов.  Несколько статусов перечисляются через запятую. (optional)
     * @param  ReturnType|null $type Тип заказа для фильтрации:  * &#x60;RETURN&#x60; — возврат.  * &#x60;UNREDEEMED&#x60; — невыкуп.  Если не указывать, в ответе будут и возвраты, и невыкупы. (optional)
     * @param  \DateTime|null $from_date Начальная дата для фильтрации возвратов или невыкупов по дате обновления.  Формат: &#x60;ГГГГ-ММ-ДД&#x60;. (optional)
     * @param  \DateTime|null $to_date Конечная дата для фильтрации возвратов или невыкупов по дате обновления.  Формат: &#x60;ГГГГ-ММ-ДД&#x60;. (optional)
     * @param  \DateTime|null $from_date2 {% note warning \&quot;\&quot; %}  Этот параметр устарел. Вместо него используйте &#x60;fromDate&#x60;.  {% endnote %}  Начальная дата для фильтрации возвратов или невыкупов по дате обновления. (optional) (deprecated)
     * @param  \DateTime|null $to_date2 {% note warning \&quot;\&quot; %}  Этот параметр устарел. Вместо него используйте &#x60;toDate&#x60;.  {% endnote %}  Конечная дата для фильтрации возвратов или невыкупов по дате обновления. (optional) (deprecated)
    ...
    public function getReturns(
        ...
        ?\DateTime $from_date2 = null,
        ?\DateTime $to_date2 = null,
        string $contentType = self::contentTypes['getReturns'][0]
    ...
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\OpenAPI\Client\Model\GetReturnsResponse', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
    ...
    public function setReturnDecision(
        ...
        int $order_id,
        int $return_id,
        \OpenAPI\Client\Model\SetReturnDecisionRequest $set_return_decision_request,
        string $contentType = self::contentTypes['setReturnDecision'][0]
     ...
     * @return array of \OpenAPI\Client\Model\EmptyApiResponse|\OpenAPI\Client\Model\ApiClientDataErrorResponse|\OpenAPI\Client\Model\ApiUnauthorizedErrorResponse|\OpenAPI\Client\Model\ApiForbiddenErrorResponse|\OpenAPI\Client\Model\ApiNotFoundErrorResponse|\OpenAPI\Client\Model\ApiLimitErrorResponse|\OpenAPI\Client\Model\ApiServerErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function setReturnDecisionWithHttpInfo(
        int $campaign_id,
        int $order_id,
        int $return_id,
        \OpenAPI\Client\Model\SetReturnDecisionRequest $set_return_decision_request,
     ...
     * @return PromiseInterface
     */
    public function setReturnDecisionAsync(
        int $campaign_id,
        int $order_id,
        int $return_id,
        \OpenAPI\Client\Model\SetReturnDecisionRequest $set_return_decision_request,
     ...
     * @return PromiseInterface
     */
    public function setReturnDecisionAsyncWithHttpInfo(
        $campaign_id,
        $order_id,
        $return_id,
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function setReturnDecisionRequest(
        $campaign_id,
        $order_id,
        $return_id,
        $set_return_decision_request,
    ...
    public function submitReturnDecision(
        ...
        int $order_id,
        int $return_id,
        string $contentType = self::contentTypes['submitReturnDecision'][0]
    ): \OpenAPI\Client\Model\EmptyApiResponse
    {
     ...
     * @return array of \OpenAPI\Client\Model\EmptyApiResponse|\OpenAPI\Client\Model\ApiClientDataErrorResponse|\OpenAPI\Client\Model\ApiUnauthorizedErrorResponse|\OpenAPI\Client\Model\ApiForbiddenErrorResponse|\OpenAPI\Client\Model\ApiNotFoundErrorResponse|\OpenAPI\Client\Model\ApiLimitErrorResponse|\OpenAPI\Client\Model\ApiServerErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function submitReturnDecisionWithHttpInfo(
        int $campaign_id,
        int $order_id,
        int $return_id,
        string $contentType = self::contentTypes['submitReturnDecision'][0]
     ...
     * @return PromiseInterface
     */
    public function submitReturnDecisionAsync(
        int $campaign_id,
        int $order_id,
        int $return_id,
        string $contentType = self::contentTypes['submitReturnDecision'][0]
     ...
     * @return PromiseInterface
     */
    public function submitReturnDecisionAsyncWithHttpInfo(
        $campaign_id,
        $order_id,
        $return_id,
        string $contentType = self::contentTypes['submitReturnDecision'][0]
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function submitReturnDecisionRequest(
        $campaign_id,
        $order_id,
        $return_id,
        string $contentType = self::contentTypes['submitReturnDecision'][0]
