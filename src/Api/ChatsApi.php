...
class ChatsApi
{
    ...
    public function createChat(
        int $business_id,
        \OpenAPI\Client\Model\CreateChatRequest $create_chat_request,
        string $contentType = self::contentTypes['createChat'][0]
     ...
     */
    public function createChatWithHttpInfo(
        int $business_id,
        \OpenAPI\Client\Model\CreateChatRequest $create_chat_request,
        string $contentType = self::contentTypes['createChat'][0]
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\OpenAPI\Client\Model\CreateChatResponse', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
     ...
     */
    public function createChatAsync(
        int $business_id,
        \OpenAPI\Client\Model\CreateChatRequest $create_chat_request,
        string $contentType = self::contentTypes['createChat'][0]
    ): PromiseInterface
     ...
     * @return PromiseInterface
     */
    public function createChatAsyncWithHttpInfo(
        $business_id,
        $create_chat_request,
        string $contentType = self::contentTypes['createChat'][0]
    ): PromiseInterface
    ...
    public function getChatHistory(
        int $business_id,
        int $chat_id,
        \OpenAPI\Client\Model\GetChatHistoryRequest $get_chat_history_request,
        ?string $page_token = null,
        ?int $limit = null,
        string $contentType = self::contentTypes['getChatHistory'][0]
    ...
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\OpenAPI\Client\Model\GetChatHistoryResponse', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
     ...
     * @return PromiseInterface
     */
    public function getChatHistoryAsync(
        int $business_id,
        int $chat_id,
        \OpenAPI\Client\Model\GetChatHistoryRequest $get_chat_history_request,
        ?string $page_token = null,
     ...
     * @return PromiseInterface
     */
    public function getChatHistoryAsyncWithHttpInfo(
        $business_id,
        $chat_id,
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getChatHistoryRequest(
        $business_id,
        $chat_id,
        $get_chat_history_request,
        $page_token = null,
    ...
    public function getChats(
        int $business_id,
        \OpenAPI\Client\Model\GetChatsRequest $get_chats_request,
        ?string $page_token = null,
        ?int $limit = null,
        string $contentType = self::contentTypes['getChats'][0]
    ...
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\OpenAPI\Client\Model\GetChatsResponse', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
    ...
    public function sendFileToChat(
        ...
        int $chat_id,
        \SplFileObject $file,
        string $contentType = self::contentTypes['sendFileToChat'][0]
     ...
     * @return array of \OpenAPI\Client\Model\EmptyApiResponse|\OpenAPI\Client\Model\ApiClientDataErrorResponse|\OpenAPI\Client\Model\ApiUnauthorizedErrorResponse|\OpenAPI\Client\Model\ApiForbiddenErrorResponse|\OpenAPI\Client\Model\ApiNotFoundErrorResponse|\OpenAPI\Client\Model\ApiLimitErrorResponse|\OpenAPI\Client\Model\ApiServerErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function sendFileToChatWithHttpInfo(
        int $business_id,
        int $chat_id,
        \SplFileObject $file,
        string $contentType = self::contentTypes['sendFileToChat'][0]
     ...
     * @return PromiseInterface
     */
    public function sendFileToChatAsync(
        int $business_id,
        int $chat_id,
        \SplFileObject $file,
        string $contentType = self::contentTypes['sendFileToChat'][0]
     ...
     * @return PromiseInterface
     */
    public function sendFileToChatAsyncWithHttpInfo(
        $business_id,
        $chat_id,
        $file,
        string $contentType = self::contentTypes['sendFileToChat'][0]
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function sendFileToChatRequest(
        $business_id,
        $chat_id,
        $file,
        string $contentType = self::contentTypes['sendFileToChat'][0]
    ...
    public function sendMessageToChat(
        int $business_id,
        int $chat_id,
        \OpenAPI\Client\Model\SendMessageToChatRequest $send_message_to_chat_request,
        string $contentType = self::contentTypes['sendMessageToChat'][0]
    ): \OpenAPI\Client\Model\EmptyApiResponse
    {
     ...
     * @return array of \OpenAPI\Client\Model\EmptyApiResponse|\OpenAPI\Client\Model\ApiClientDataErrorResponse|\OpenAPI\Client\Model\ApiUnauthorizedErrorResponse|\OpenAPI\Client\Model\ApiForbiddenErrorResponse|\OpenAPI\Client\Model\ApiNotFoundErrorResponse|\OpenAPI\Client\Model\ApiLimitErrorResponse|\OpenAPI\Client\Model\ApiServerErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function sendMessageToChatWithHttpInfo(
        int $business_id,
        int $chat_id,
        \OpenAPI\Client\Model\SendMessageToChatRequest $send_message_to_chat_request,
        string $contentType = self::contentTypes['sendMessageToChat'][0]
     ...
     * @return PromiseInterface
     */
    public function sendMessageToChatAsync(
        int $business_id,
        int $chat_id,
        \OpenAPI\Client\Model\SendMessageToChatRequest $send_message_to_chat_request,
        string $contentType = self::contentTypes['sendMessageToChat'][0]
     ...
     * @return PromiseInterface
     */
    public function sendMessageToChatAsyncWithHttpInfo(
        $business_id,
        $chat_id,
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function sendMessageToChatRequest(
        $business_id,
        $chat_id,
        $send_message_to_chat_request,
        string $contentType = self::contentTypes['sendMessageToChat'][0]
