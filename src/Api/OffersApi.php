...
class OffersApi
{
    ...
    public function deleteCampaignOffers(
        int $campaign_id,
        \OpenAPI\Client\Model\DeleteCampaignOffersRequest $delete_campaign_offers_request,
        string $contentType = self::contentTypes['deleteCampaignOffers'][0]
     ...
     */
    public function deleteCampaignOffersWithHttpInfo(
        int $campaign_id,
        \OpenAPI\Client\Model\DeleteCampaignOffersRequest $delete_campaign_offers_request,
        string $contentType = self::contentTypes['deleteCampaignOffers'][0]
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\OpenAPI\Client\Model\DeleteCampaignOffersResponse', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
     ...
     */
    public function deleteCampaignOffersAsync(
        int $campaign_id,
        \OpenAPI\Client\Model\DeleteCampaignOffersRequest $delete_campaign_offers_request,
        string $contentType = self::contentTypes['deleteCampaignOffers'][0]
    ): PromiseInterface
     ...
     * @return PromiseInterface
     */
    public function deleteCampaignOffersAsyncWithHttpInfo(
        $campaign_id,
     ...
     */
    public function deleteCampaignOffersRequest(
        $campaign_id,
        $delete_campaign_offers_request,
        string $contentType = self::contentTypes['deleteCampaignOffers'][0]
    ): Request
     ...
     *
     * @param  int $campaign_id Идентификатор кампании в API и магазина в кабинете. Каждая кампания в API соответствует магазину в кабинете.  Чтобы узнать идентификаторы своих магазинов, воспользуйтесь запросом [GET campaigns](../../reference/campaigns/getCampaigns.md).  ℹ️ [Что такое кабинет и магазин на Маркете](https://yandex.ru/support/marketplace/account/introduction.html) (required)
     * @param  int|null $feed_id Идентификатор прайс-листа. (optional)
    ...
    public function getAllOffers(
        ...
        ?int $feed_id = null,
        ?int $chunk = null,
        string $contentType = self::contentTypes['getAllOffers'][0]
     ...
     * @deprecated
     */
    public function getAllOffersWithHttpInfo(
        int $campaign_id,
        ?int $feed_id = null,
        ?int $chunk = null,
        string $contentType = self::contentTypes['getAllOffers'][0]
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\OpenAPI\Client\Model\GetAllOffersResponse', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
     ...
     * @deprecated
     */
    public function getAllOffersAsync(
        int $campaign_id,
        ?int $feed_id = null,
        ?int $chunk = null,
        string $contentType = self::contentTypes['getAllOffers'][0]
     ...
     * @deprecated
     */
    public function getAllOffersAsyncWithHttpInfo(
        $campaign_id,
        $feed_id = null,
        $chunk = null,
        string $contentType = self::contentTypes['getAllOffers'][0]
     ...
     * @deprecated
     */
    public function getAllOffersRequest(
        $campaign_id,
        $feed_id = null,
        $chunk = null,
        string $contentType = self::contentTypes['getAllOffers'][0]
    ...
    public function getCampaignOffers(
        int $campaign_id,
        \OpenAPI\Client\Model\GetCampaignOffersRequest $get_campaign_offers_request,
        ?string $page_token = null,
        ?int $limit = null,
        string $contentType = self::contentTypes['getCampaignOffers'][0]
     ...
     * @return array of \OpenAPI\Client\Model\GetCampaignOffersResponse|\OpenAPI\Client\Model\ApiClientDataErrorResponse|\OpenAPI\Client\Model\ApiUnauthorizedErrorResponse|\OpenAPI\Client\Model\ApiForbiddenErrorResponse|\OpenAPI\Client\Model\ApiNotFoundErrorResponse|\OpenAPI\Client\Model\ApiLimitErrorResponse|\OpenAPI\Client\Model\ApiServerErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCampaignOffersWithHttpInfo(
        int $campaign_id,
        \OpenAPI\Client\Model\GetCampaignOffersRequest $get_campaign_offers_request,
        ?string $page_token = null,
        ?int $limit = null,
    ...
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\OpenAPI\Client\Model\GetCampaignOffersResponse', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
     ...
     * @return PromiseInterface
     */
    public function getCampaignOffersAsync(
        int $campaign_id,
        \OpenAPI\Client\Model\GetCampaignOffersRequest $get_campaign_offers_request,
        ?string $page_token = null,
        ?int $limit = null,
     ...
     * @return PromiseInterface
     */
    public function getCampaignOffersAsyncWithHttpInfo(
        $campaign_id,
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getCampaignOffersRequest(
        $campaign_id,
        $get_campaign_offers_request,
        $page_token = null,
        $limit = null,
    ...
    public function getOfferRecommendations(
        int $business_id,
        \OpenAPI\Client\Model\GetOfferRecommendationsRequest $get_offer_recommendations_request,
        ?string $page_token = null,
        ?int $limit = null,
        string $contentType = self::contentTypes['getOfferRecommendations'][0]
     ...
     * @return array of \OpenAPI\Client\Model\GetOfferRecommendationsResponse|\OpenAPI\Client\Model\ApiClientDataErrorResponse|\OpenAPI\Client\Model\ApiUnauthorizedErrorResponse|\OpenAPI\Client\Model\ApiForbiddenErrorResponse|\OpenAPI\Client\Model\ApiNotFoundErrorResponse|\OpenAPI\Client\Model\ApiLimitErrorResponse|\OpenAPI\Client\Model\ApiServerErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getOfferRecommendationsWithHttpInfo(
        int $business_id,
        \OpenAPI\Client\Model\GetOfferRecommendationsRequest $get_offer_recommendations_request,
        ?string $page_token = null,
        ?int $limit = null,
    ...
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\OpenAPI\Client\Model\GetOfferRecommendationsResponse', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
     ...
     * @return PromiseInterface
     */
    public function getOfferRecommendationsAsync(
        int $business_id,
        \OpenAPI\Client\Model\GetOfferRecommendationsRequest $get_offer_recommendations_request,
        ?string $page_token = null,
        ?int $limit = null,
     ...
     * @return PromiseInterface
     */
    public function getOfferRecommendationsAsyncWithHttpInfo(
        $business_id,
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getOfferRecommendationsRequest(
        $business_id,
        $get_offer_recommendations_request,
        $page_token = null,
        $limit = null,
     ...
     * @param  int|null $feed_id Идентификатор прайс-листа. (optional)
     * @param  string|null $shop_category_id Идентификатор категории предложения, указанный магазином в прайс-листе.  Параметр выводится только для предложений, у которых указана категория в прайс-листе.  Параметр доступен начиная с версии 2.0 партнерского API. (optional)
     * @param  CurrencyType|null $currency Валюта, в которой указана цена предложения.  Возможные значения:  * &#x60;BYN&#x60; — белорусский рубль.  * &#x60;KZT&#x60; — казахстанский тенге.  * &#x60;RUR&#x60; — российский рубль.  * &#x60;UAH&#x60; — украинская гривна. (optional)
    ...
    public function getOffers(
        ...
        ?int $page = 1,
        ?int $page_size = null,
        string $contentType = self::contentTypes['getOffers'][0]
    ...
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\OpenAPI\Client\Model\GetOffersResponse', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
    ...
    public function updateCampaignOffers(
        int $campaign_id,
        \OpenAPI\Client\Model\UpdateCampaignOffersRequest $update_campaign_offers_request,
        string $contentType = self::contentTypes['updateCampaignOffers'][0]
     ...
     * @return array of \OpenAPI\Client\Model\EmptyApiResponse|\OpenAPI\Client\Model\ApiClientDataErrorResponse|\OpenAPI\Client\Model\ApiUnauthorizedErrorResponse|\OpenAPI\Client\Model\ApiForbiddenErrorResponse|\OpenAPI\Client\Model\ApiNotFoundErrorResponse|\OpenAPI\Client\Model\ApiLimitErrorResponse|\OpenAPI\Client\Model\ApiLockedErrorResponse|\OpenAPI\Client\Model\ApiServerErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateCampaignOffersWithHttpInfo(
        int $campaign_id,
        \OpenAPI\Client\Model\UpdateCampaignOffersRequest $update_campaign_offers_request,
        string $contentType = self::contentTypes['updateCampaignOffers'][0]
    ): array
     ...
     * @return PromiseInterface
     */
    public function updateCampaignOffersAsync(
        int $campaign_id,
        \OpenAPI\Client\Model\UpdateCampaignOffersRequest $update_campaign_offers_request,
        string $contentType = self::contentTypes['updateCampaignOffers'][0]
    ): PromiseInterface
     ...
     * @return PromiseInterface
     */
    public function updateCampaignOffersAsyncWithHttpInfo(
        $campaign_id,
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateCampaignOffersRequest(
        $campaign_id,
        $update_campaign_offers_request,
        string $contentType = self::contentTypes['updateCampaignOffers'][0]
    ): Request
