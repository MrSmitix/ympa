...
class CategoriesApi
{
    ...
    public function getCategoriesMaxSaleQuantum(
        \OpenAPI\Client\Model\GetCategoriesMaxSaleQuantumRequest $get_categories_max_sale_quantum_request,
        string $contentType = self::contentTypes['getCategoriesMaxSaleQuantum'][0]
     ...
     */
    public function getCategoriesMaxSaleQuantumWithHttpInfo(
        \OpenAPI\Client\Model\GetCategoriesMaxSaleQuantumRequest $get_categories_max_sale_quantum_request,
        string $contentType = self::contentTypes['getCategoriesMaxSaleQuantum'][0]
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\OpenAPI\Client\Model\GetCategoriesMaxSaleQuantumResponse', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
     ...
     */
    public function getCategoriesMaxSaleQuantumAsync(
        \OpenAPI\Client\Model\GetCategoriesMaxSaleQuantumRequest $get_categories_max_sale_quantum_request,
        string $contentType = self::contentTypes['getCategoriesMaxSaleQuantum'][0]
    ): PromiseInterface
    {
     ...
     * @return PromiseInterface
     */
    public function getCategoriesMaxSaleQuantumAsyncWithHttpInfo(
     ...
     */
    public function getCategoriesMaxSaleQuantumRequest(
        $get_categories_max_sale_quantum_request,
        string $contentType = self::contentTypes['getCategoriesMaxSaleQuantum'][0]
    ): Request
    {
    ...
    public function getCategoriesTree(
        ?\OpenAPI\Client\Model\GetCategoriesRequest $get_categories_request = null,
        string $contentType = self::contentTypes['getCategoriesTree'][0]
     ...
     * @return array of \OpenAPI\Client\Model\GetCategoriesResponse|\OpenAPI\Client\Model\ApiClientDataErrorResponse|\OpenAPI\Client\Model\ApiUnauthorizedErrorResponse|\OpenAPI\Client\Model\ApiForbiddenErrorResponse|\OpenAPI\Client\Model\ApiNotFoundErrorResponse|\OpenAPI\Client\Model\ApiLimitErrorResponse|\OpenAPI\Client\Model\ApiServerErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCategoriesTreeWithHttpInfo(
        ?\OpenAPI\Client\Model\GetCategoriesRequest $get_categories_request = null,
        string $contentType = self::contentTypes['getCategoriesTree'][0]
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\OpenAPI\Client\Model\GetCategoriesResponse', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
     ...
     * @return PromiseInterface
     */
    public function getCategoriesTreeAsync(
        ?\OpenAPI\Client\Model\GetCategoriesRequest $get_categories_request = null,
        string $contentType = self::contentTypes['getCategoriesTree'][0]
    ): PromiseInterface
    {
     ...
     * @return PromiseInterface
     */
    public function getCategoriesTreeAsyncWithHttpInfo(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getCategoriesTreeRequest(
        $get_categories_request = null,
        string $contentType = self::contentTypes['getCategoriesTree'][0]
    ): Request
    {
