...
class FeedsApi
{
    ...
    public function getFeed(
        int $campaign_id,
        int $feed_id,
        string $contentType = self::contentTypes['getFeed'][0]
    ...
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\OpenAPI\Client\Model\GetFeedResponse', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
     ...
     * @param  \DateTime|null $published_time_from Начальная дата. Используется для фильтрации записей — по дате и времени публикации предложений на Яндекс Маркете.  Формат даты: ISO 8601 со смещением относительно UTC. Например, &#x60;2017-11-21T00:42:42+03:00&#x60;.  Значение по умолчанию: последние восемь дней со времени отправки запроса. (optional)
     * @param  \DateTime|null $published_time_to Конечная дата. Используется для фильтрации записей — по дате и времени публикации предложений на Яндекс Маркете.  Формат даты: ISO 8601 со смещением относительно UTC. Например, &#x60;2017-11-31T00:42:42+03:00&#x60;.  Значение по умолчанию: дата и время отправки запроса.  {% note info %}  Если во время переключения между страницами выходных данных на Яндекс Маркете появятся новые результаты индексации прайс-листа, вы не получите часть данных. Чтобы этого не произошло, зафиксируйте выходные данные с помощью входного параметра &#x60;published_time_to&#x60;. Значение параметра не должно быть датой из будущего.  {% endnote %} (optional)
     * @param  FeedIndexLogsStatusType|null $status Статус индексации и проверки прайс-листа на соответствие техническим требованиям.  Возможные значения: * &#x60;ERROR&#x60; — произошли ошибки. * &#x60;OK&#x60; — обработан без ошибок. * &#x60;WARNING&#x60; — наблюдались некритичные проблемы. (optional)
    ...
    public function getFeedIndexLogs(
        ...
        int $feed_id,
        ?int $limit = null,
        ?\DateTime $published_time_from = null,
        ?\DateTime $published_time_to = null,
        ?FeedIndexLogsStatusType $status = null,
        string $contentType = self::contentTypes['getFeedIndexLogs'][0]
     ...
     * @deprecated
     */
    public function getFeedIndexLogsWithHttpInfo(
        int $campaign_id,
        int $feed_id,
        ?int $limit = null,
        ?\DateTime $published_time_from = null,
    ...
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\OpenAPI\Client\Model\GetFeedIndexLogsResponse', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
     ...
     * @deprecated
     */
    public function getFeedIndexLogsAsync(
        int $campaign_id,
        int $feed_id,
        ?int $limit = null,
        ?\DateTime $published_time_from = null,
     ...
     * @deprecated
     */
    public function getFeedIndexLogsAsyncWithHttpInfo(
        $campaign_id,
        $feed_id,
        $limit = null,
        $published_time_from = null,
        $published_time_to = null,
        $status = null,
        string $contentType = self::contentTypes['getFeedIndexLogs'][0]
    ): PromiseInterface
    {
     ...
     * @deprecated
     */
    public function getFeedIndexLogsRequest(
        $campaign_id,
        $feed_id,
        $limit = null,
        $published_time_from = null,
    ...
    public function getFeeds(
        int $campaign_id,
        string $contentType = self::contentTypes['getFeeds'][0]
    ...
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\OpenAPI\Client\Model\GetFeedsResponse', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
    ...
    public function refreshFeed(
        int $campaign_id,
        int $feed_id,
        string $contentType = self::contentTypes['refreshFeed'][0]
     ...
     * @deprecated
     */
    public function refreshFeedWithHttpInfo(
        int $campaign_id,
        int $feed_id,
        string $contentType = self::contentTypes['refreshFeed'][0]
    ): array
     ...
     * @deprecated
     */
    public function refreshFeedAsync(
        int $campaign_id,
        int $feed_id,
        string $contentType = self::contentTypes['refreshFeed'][0]
    ): PromiseInterface
     ...
     * @deprecated
     */
    public function refreshFeedAsyncWithHttpInfo(
        $campaign_id,
        $feed_id,
        string $contentType = self::contentTypes['refreshFeed'][0]
    ): PromiseInterface
     ...
     * @deprecated
     */
    public function refreshFeedRequest(
        $campaign_id,
        $feed_id,
        string $contentType = self::contentTypes['refreshFeed'][0]
    ): Request
    ...
    public function setFeedParams(
        int $campaign_id,
        int $feed_id,
        \OpenAPI\Client\Model\SetFeedParamsRequest $set_feed_params_request,
        string $contentType = self::contentTypes['setFeedParams'][0]
    ): \OpenAPI\Client\Model\EmptyApiResponse
    {
     ...
     * @deprecated
     */
    public function setFeedParamsWithHttpInfo(
        int $campaign_id,
        int $feed_id,
        \OpenAPI\Client\Model\SetFeedParamsRequest $set_feed_params_request,
        string $contentType = self::contentTypes['setFeedParams'][0]
     ...
     * @deprecated
     */
    public function setFeedParamsAsync(
        int $campaign_id,
        int $feed_id,
        \OpenAPI\Client\Model\SetFeedParamsRequest $set_feed_params_request,
        string $contentType = self::contentTypes['setFeedParams'][0]
     ...
     * @deprecated
     */
    public function setFeedParamsAsyncWithHttpInfo(
        $campaign_id,
        $feed_id,
     ...
     * @deprecated
     */
    public function setFeedParamsRequest(
        $campaign_id,
        $feed_id,
        $set_feed_params_request,
        string $contentType = self::contentTypes['setFeedParams'][0]
