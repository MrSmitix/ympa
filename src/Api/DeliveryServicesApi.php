...
class DeliveryServicesApi
{
    ...
    public function getDeliveryServices(
        string $contentType = self::contentTypes['getDeliveryServices'][0]
    ...
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\OpenAPI\Client\Model\GetDeliveryServicesResponse', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
