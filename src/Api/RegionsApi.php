...
class RegionsApi
{
    ...
    public function searchRegionChildren(
        ...
        ?int $page = 1,
        ?int $page_size = null,
        string $contentType = self::contentTypes['searchRegionChildren'][0]
     ...
     */
    public function searchRegionChildrenWithHttpInfo(
        int $region_id,
        ?int $page = 1,
        ?int $page_size = null,
        string $contentType = self::contentTypes['searchRegionChildren'][0]
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\OpenAPI\Client\Model\GetRegionWithChildrenResponse', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
     ...
     */
    public function searchRegionChildrenAsync(
        int $region_id,
        ?int $page = 1,
        ?int $page_size = null,
        string $contentType = self::contentTypes['searchRegionChildren'][0]
     ...
     * @return PromiseInterface
     */
    public function searchRegionChildrenAsyncWithHttpInfo(
        $region_id,
        $page = 1,
        $page_size = null,
        string $contentType = self::contentTypes['searchRegionChildren'][0]
     ...
     */
    public function searchRegionChildrenRequest(
        $region_id,
        $page = 1,
        $page_size = null,
        string $contentType = self::contentTypes['searchRegionChildren'][0]
    ...
    public function searchRegionsById(
        int $region_id,
        string $contentType = self::contentTypes['searchRegionsById'][0]
     ...
     */
    public function searchRegionsByIdWithHttpInfo(
        int $region_id,
        string $contentType = self::contentTypes['searchRegionsById'][0]
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\OpenAPI\Client\Model\GetRegionsResponse', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
     ...
     * @return PromiseInterface
     */
    public function searchRegionsByIdAsync(
        int $region_id,
        string $contentType = self::contentTypes['searchRegionsById'][0]
    ): PromiseInterface
    {
     ...
     * @return PromiseInterface
     */
    public function searchRegionsByIdAsyncWithHttpInfo(
        $region_id,
        string $contentType = self::contentTypes['searchRegionsById'][0]
    ): PromiseInterface
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function searchRegionsByIdRequest(
        $region_id,
        string $contentType = self::contentTypes['searchRegionsById'][0]
    ): Request
    {
    ...
    public function searchRegionsByName(
        ...
        ?int $limit = null,
        string $contentType = self::contentTypes['searchRegionsByName'][0]
    ): \OpenAPI\Client\Model\GetRegionsResponse
    {
     ...
     */
    public function searchRegionsByNameWithHttpInfo(
        string $name,
        ?string $page_token = null,
        ?int $limit = null,
        string $contentType = self::contentTypes['searchRegionsByName'][0]
     ...
     * @return PromiseInterface
     */
    public function searchRegionsByNameAsync(
        string $name,
        ?string $page_token = null,
        ?int $limit = null,
        string $contentType = self::contentTypes['searchRegionsByName'][0]
     ...
     * @return PromiseInterface
     */
    public function searchRegionsByNameAsyncWithHttpInfo(
        $name,
        $page_token = null,
        $limit = null,
        string $contentType = self::contentTypes['searchRegionsByName'][0]
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function searchRegionsByNameRequest(
        $name,
        $page_token = null,
        $limit = null,
        string $contentType = self::contentTypes['searchRegionsByName'][0]
