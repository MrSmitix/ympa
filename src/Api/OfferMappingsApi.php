...
class OfferMappingsApi
{
     ...
     * @param  OfferMappingKindType|null $mapping_kind Тип маппинга. (optional)
     ...
     * @param  string[]|null $vendor Фильтрация по бренду товара.  Можно указать несколько брендов в одном параметре, через запятую, или в нескольких одинаковых параметрах. Например:  &#x60;&#x60;&#x60; ...vendor&#x3D;Aqua%20Minerale,Borjomi... ...vendor&#x3D;Aqua%20Minerale&amp;vendor&#x3D;Borjomi... &#x60;&#x60;&#x60;  Чтобы товар попал в результаты фильтрации, его бренд должен точно совпадать с одним из указанных в запросе. Например, если указан бренд Schwarzkopf, то в результатах не будет товаров Schwarzkopf Professional.  Если в названии бренда есть символы, которые не входят в таблицу ASCII (в том числе кириллические символы), используйте для них URL-кодирование. Например, пробел — %20, апостроф «&#39;» — %27 и т. д. Подробнее см. в разделе [Кодирование URL русскоязычной Википедии](https://ru.wikipedia.org/wiki/URL#Кодирование_URL).  В запросе можно указать либо параметр shopSku, либо любые параметры для фильтрации товаров. Совместное использование параметра shopSku и параметров для фильтрации приведет к ошибке. (optional)
    ...
    public function getOfferMappingEntries(
        ...
        ?array $offer_id = null,
        ?array $shop_sku = null,
        ?OfferMappingKindType $mapping_kind = null,
        ?array $status = null,
        ...
        ?int $limit = null,
        string $contentType = self::contentTypes['getOfferMappingEntries'][0]
     ...
     * @deprecated
     */
    public function getOfferMappingEntriesWithHttpInfo(
        int $campaign_id,
        ?array $offer_id = null,
        ?array $shop_sku = null,
        ?OfferMappingKindType $mapping_kind = null,
    ...
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\OpenAPI\Client\Model\GetOfferMappingEntriesResponse', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
     ...
     * @deprecated
     */
    public function getOfferMappingEntriesAsync(
        int $campaign_id,
        ?array $offer_id = null,
        ?array $shop_sku = null,
        ?OfferMappingKindType $mapping_kind = null,
     ...
     * @deprecated
     */
    public function getOfferMappingEntriesAsyncWithHttpInfo(
        $campaign_id,
        $offer_id = null,
        $shop_sku = null,
        $mapping_kind = null,
     ...
     * @deprecated
     */
    public function getOfferMappingEntriesRequest(
        $campaign_id,
        $offer_id = null,
        $shop_sku = null,
        $mapping_kind = null,
    ...
    public function getSuggestedOfferMappingEntries(
        int $campaign_id,
        \OpenAPI\Client\Model\GetSuggestedOfferMappingEntriesRequest $get_suggested_offer_mapping_entries_request,
        string $contentType = self::contentTypes['getSuggestedOfferMappingEntries'][0]
     ...
     * @deprecated
     */
    public function getSuggestedOfferMappingEntriesWithHttpInfo(
        int $campaign_id,
        \OpenAPI\Client\Model\GetSuggestedOfferMappingEntriesRequest $get_suggested_offer_mapping_entries_request,
        string $contentType = self::contentTypes['getSuggestedOfferMappingEntries'][0]
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\OpenAPI\Client\Model\GetSuggestedOfferMappingEntriesResponse', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
     ...
     * @deprecated
     */
    public function getSuggestedOfferMappingEntriesAsync(
        int $campaign_id,
        \OpenAPI\Client\Model\GetSuggestedOfferMappingEntriesRequest $get_suggested_offer_mapping_entries_request,
        string $contentType = self::contentTypes['getSuggestedOfferMappingEntries'][0]
    ): PromiseInterface
     ...
     * @deprecated
     */
    public function getSuggestedOfferMappingEntriesAsyncWithHttpInfo(
        $campaign_id,
     ...
     * @deprecated
     */
    public function getSuggestedOfferMappingEntriesRequest(
        $campaign_id,
        $get_suggested_offer_mapping_entries_request,
        string $contentType = self::contentTypes['getSuggestedOfferMappingEntries'][0]
    ): Request
    ...
    public function updateOfferMappingEntries(
        int $campaign_id,
        \OpenAPI\Client\Model\UpdateOfferMappingEntryRequest $update_offer_mapping_entry_request,
        string $contentType = self::contentTypes['updateOfferMappingEntries'][0]
     ...
     * @deprecated
     */
    public function updateOfferMappingEntriesWithHttpInfo(
        int $campaign_id,
        \OpenAPI\Client\Model\UpdateOfferMappingEntryRequest $update_offer_mapping_entry_request,
        string $contentType = self::contentTypes['updateOfferMappingEntries'][0]
    ): array
     ...
     * @deprecated
     */
    public function updateOfferMappingEntriesAsync(
        int $campaign_id,
        \OpenAPI\Client\Model\UpdateOfferMappingEntryRequest $update_offer_mapping_entry_request,
        string $contentType = self::contentTypes['updateOfferMappingEntries'][0]
    ): PromiseInterface
     ...
     * @deprecated
     */
    public function updateOfferMappingEntriesAsyncWithHttpInfo(
        $campaign_id,
     ...
     * @deprecated
     */
    public function updateOfferMappingEntriesRequest(
        $campaign_id,
        $update_offer_mapping_entry_request,
        string $contentType = self::contentTypes['updateOfferMappingEntries'][0]
    ): Request
