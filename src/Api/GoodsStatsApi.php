...
class GoodsStatsApi
{
    ...
    public function getGoodsStats(
        int $campaign_id,
        \OpenAPI\Client\Model\GetGoodsStatsRequest $get_goods_stats_request,
        string $contentType = self::contentTypes['getGoodsStats'][0]
     ...
     */
    public function getGoodsStatsWithHttpInfo(
        int $campaign_id,
        \OpenAPI\Client\Model\GetGoodsStatsRequest $get_goods_stats_request,
        string $contentType = self::contentTypes['getGoodsStats'][0]
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\OpenAPI\Client\Model\GetGoodsStatsResponse', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
     ...
     */
    public function getGoodsStatsAsync(
        int $campaign_id,
        \OpenAPI\Client\Model\GetGoodsStatsRequest $get_goods_stats_request,
        string $contentType = self::contentTypes['getGoodsStats'][0]
    ): PromiseInterface
     ...
     * @return PromiseInterface
     */
    public function getGoodsStatsAsyncWithHttpInfo(
        $campaign_id,
     ...
     */
    public function getGoodsStatsRequest(
        $campaign_id,
        $get_goods_stats_request,
        string $contentType = self::contentTypes['getGoodsStats'][0]
    ): Request
