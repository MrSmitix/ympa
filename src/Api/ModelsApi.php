...
class ModelsApi
{
    ...
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\OpenAPI\Client\Model\GetModelsResponse', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
     ...
     * @param  int $region_id Идентификатор региона.  Идентификатор региона можно получить c помощью запроса [GET regions](../../reference/regions/searchRegionsByName.md). (required)
     * @param  CurrencyType|null $currency Валюта, в которой отображаются цены предложений на страницах с результатами поиска.  Возможные значения:  * &#x60;BYN&#x60; — белорусский рубль.  * &#x60;KZT&#x60; — казахстанский тенге.  * &#x60;RUR&#x60; — российский рубль.  * &#x60;UAH&#x60; — украинская гривна.  Значение по умолчанию: используется национальная валюта магазина (национальная валюта страны происхождения магазина). (optional)
     * @param  SortOrderType|null $order_by_price Направление сортировки по цене.  Возможные значения: * &#x60;ASC&#x60; — сортировка по возрастанию. * &#x60;DESC&#x60; — сортировка по убыванию.  Значение по умолчанию: предложения выводятся в произвольном порядке. (optional)
     * @param  int|null $count Количество предложений на странице ответа. (optional, default to 10)
    ...
    public function getModelOffers(
        ...
        int $region_id,
        ?CurrencyType $currency = null,
        ?SortOrderType $order_by_price = null,
        ?int $count = 10,
        ?int $page = 1,
        string $contentType = self::contentTypes['getModelOffers'][0]
     ...
     * @return array of \OpenAPI\Client\Model\GetModelsOffersResponse|\OpenAPI\Client\Model\ApiClientDataErrorResponse|\OpenAPI\Client\Model\ApiUnauthorizedErrorResponse|\OpenAPI\Client\Model\ApiForbiddenErrorResponse|\OpenAPI\Client\Model\ApiNotFoundErrorResponse|\OpenAPI\Client\Model\ApiLimitErrorResponse|\OpenAPI\Client\Model\ApiServerErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getModelOffersWithHttpInfo(
        int $model_id,
        int $region_id,
        ?CurrencyType $currency = null,
        ?SortOrderType $order_by_price = null,
    ...
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\OpenAPI\Client\Model\GetModelsOffersResponse', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
     ...
     * @return PromiseInterface
     */
    public function getModelOffersAsync(
        int $model_id,
        int $region_id,
        ?CurrencyType $currency = null,
        ?SortOrderType $order_by_price = null,
     ...
     * @return PromiseInterface
     */
    public function getModelOffersAsyncWithHttpInfo(
        $model_id,
        $region_id,
        $currency = null,
        $order_by_price = null,
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getModelOffersRequest(
        $model_id,
        $region_id,
        $currency = null,
        $order_by_price = null,
    ...
    public function getModels(
        int $region_id,
        \OpenAPI\Client\Model\GetModelsRequest $get_models_request,
        ?CurrencyType $currency = null,
    ...
    public function getModelsOffers(
        ...
        ?CurrencyType $currency = null,
        ?SortOrderType $order_by_price = null,
        string $contentType = self::contentTypes['getModelsOffers'][0]
    ): \OpenAPI\Client\Model\GetModelsOffersResponse
    {
     ...
     * @return array of \OpenAPI\Client\Model\GetModelsOffersResponse|\OpenAPI\Client\Model\ApiClientDataErrorResponse|\OpenAPI\Client\Model\ApiUnauthorizedErrorResponse|\OpenAPI\Client\Model\ApiForbiddenErrorResponse|\OpenAPI\Client\Model\ApiNotFoundErrorResponse|\OpenAPI\Client\Model\ApiLimitErrorResponse|\OpenAPI\Client\Model\ApiServerErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getModelsOffersWithHttpInfo(
        int $region_id,
        \OpenAPI\Client\Model\GetModelsRequest $get_models_request,
        ?CurrencyType $currency = null,
        ?SortOrderType $order_by_price = null,
     ...
     * @return PromiseInterface
     */
    public function getModelsOffersAsync(
        int $region_id,
        \OpenAPI\Client\Model\GetModelsRequest $get_models_request,
        ?CurrencyType $currency = null,
        ?SortOrderType $order_by_price = null,
     ...
     * @return PromiseInterface
     */
    public function getModelsOffersAsyncWithHttpInfo(
        $region_id,
        $get_models_request,
        $currency = null,
        $order_by_price = null,
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getModelsOffersRequest(
        $region_id,
        $get_models_request,
        $currency = null,
        $order_by_price = null,
    ...
    public function searchModels(
        ...
        ?int $page = 1,
        ?int $page_size = null,
        string $contentType = self::contentTypes['searchModels'][0]
     ...
     * @return array of \OpenAPI\Client\Model\SearchModelsResponse|\OpenAPI\Client\Model\ApiClientDataErrorResponse|\OpenAPI\Client\Model\ApiUnauthorizedErrorResponse|\OpenAPI\Client\Model\ApiForbiddenErrorResponse|\OpenAPI\Client\Model\ApiNotFoundErrorResponse|\OpenAPI\Client\Model\ApiLimitErrorResponse|\OpenAPI\Client\Model\ApiServerErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchModelsWithHttpInfo(
        string $query,
        int $region_id,
        ?CurrencyType $currency = null,
        ?int $page = 1,
    ...
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\OpenAPI\Client\Model\SearchModelsResponse', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
     ...
     * @return PromiseInterface
     */
    public function searchModelsAsync(
        string $query,
        int $region_id,
        ?CurrencyType $currency = null,
        ?int $page = 1,
     ...
     * @return PromiseInterface
     */
    public function searchModelsAsyncWithHttpInfo(
        $query,
        $region_id,
        $currency = null,
        $page = 1,
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function searchModelsRequest(
        $query,
        $region_id,
        $currency = null,
        $page = 1,
