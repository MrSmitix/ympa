...
class ContentApi
{
    ...
    public function getCategoryContentParameters(
        int $category_id,
        string $contentType = self::contentTypes['getCategoryContentParameters'][0]
     ...
     */
    public function getCategoryContentParametersWithHttpInfo(
        int $category_id,
        string $contentType = self::contentTypes['getCategoryContentParameters'][0]
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\OpenAPI\Client\Model\GetCategoryContentParametersResponse', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
     ...
     */
    public function getCategoryContentParametersAsync(
        int $category_id,
        string $contentType = self::contentTypes['getCategoryContentParameters'][0]
    ): PromiseInterface
    {
     ...
     * @return PromiseInterface
     */
    public function getCategoryContentParametersAsyncWithHttpInfo(
        $category_id,
        string $contentType = self::contentTypes['getCategoryContentParameters'][0]
    ): PromiseInterface
    {
     ...
     */
    public function getCategoryContentParametersRequest(
        $category_id,
        string $contentType = self::contentTypes['getCategoryContentParameters'][0]
    ): Request
    {
    ...
    public function getOfferCardsContentStatus(
        ...
        ?int $limit = null,
        ?\OpenAPI\Client\Model\GetOfferCardsContentStatusRequest $get_offer_cards_content_status_request = null,
        string $contentType = self::contentTypes['getOfferCardsContentStatus'][0]
     ...
     * @return array of \OpenAPI\Client\Model\GetOfferCardsContentStatusResponse|\OpenAPI\Client\Model\ApiClientDataErrorResponse|\OpenAPI\Client\Model\ApiUnauthorizedErrorResponse|\OpenAPI\Client\Model\ApiForbiddenErrorResponse|\OpenAPI\Client\Model\ApiNotFoundErrorResponse|\OpenAPI\Client\Model\ApiLimitErrorResponse|\OpenAPI\Client\Model\ApiServerErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getOfferCardsContentStatusWithHttpInfo(
        int $business_id,
        ?string $page_token = null,
        ?int $limit = null,
        ?\OpenAPI\Client\Model\GetOfferCardsContentStatusRequest $get_offer_cards_content_status_request = null,
    ...
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\OpenAPI\Client\Model\GetOfferCardsContentStatusResponse', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
     ...
     * @return PromiseInterface
     */
    public function getOfferCardsContentStatusAsync(
        int $business_id,
        ?string $page_token = null,
        ?int $limit = null,
        ?\OpenAPI\Client\Model\GetOfferCardsContentStatusRequest $get_offer_cards_content_status_request = null,
     ...
     * @return PromiseInterface
     */
    public function getOfferCardsContentStatusAsyncWithHttpInfo(
        $business_id,
        $page_token = null,
        $limit = null,
        $get_offer_cards_content_status_request = null,
        string $contentType = self::contentTypes['getOfferCardsContentStatus'][0]
    ): PromiseInterface
    {
        $returnType = '\OpenAPI\Client\Model\GetOfferCardsContentStatusResponse';
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getOfferCardsContentStatusRequest(
        $business_id,
        $page_token = null,
        $limit = null,
        $get_offer_cards_content_status_request = null,
    ...
    public function updateOfferContent(
        int $business_id,
        \OpenAPI\Client\Model\UpdateOfferContentRequest $update_offer_content_request,
        string $contentType = self::contentTypes['updateOfferContent'][0]
     ...
     * @return array of \OpenAPI\Client\Model\UpdateOfferContentResponse|\OpenAPI\Client\Model\ApiClientDataErrorResponse|\OpenAPI\Client\Model\ApiUnauthorizedErrorResponse|\OpenAPI\Client\Model\ApiForbiddenErrorResponse|\OpenAPI\Client\Model\ApiNotFoundErrorResponse|\OpenAPI\Client\Model\ApiLimitErrorResponse|\OpenAPI\Client\Model\ApiLockedErrorResponse|\OpenAPI\Client\Model\ApiServerErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateOfferContentWithHttpInfo(
        int $business_id,
        \OpenAPI\Client\Model\UpdateOfferContentRequest $update_offer_content_request,
        string $contentType = self::contentTypes['updateOfferContent'][0]
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\OpenAPI\Client\Model\UpdateOfferContentResponse', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
     ...
     * @return PromiseInterface
     */
    public function updateOfferContentAsync(
        int $business_id,
        \OpenAPI\Client\Model\UpdateOfferContentRequest $update_offer_content_request,
        string $contentType = self::contentTypes['updateOfferContent'][0]
    ): PromiseInterface
     ...
     * @return PromiseInterface
     */
    public function updateOfferContentAsyncWithHttpInfo(
        $business_id,
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateOfferContentRequest(
        $business_id,
        $update_offer_content_request,
        string $contentType = self::contentTypes['updateOfferContent'][0]
    ): Request
