...
class HiddenOffersApi
{
    ...
    public function addHiddenOffers(
        int $campaign_id,
        \OpenAPI\Client\Model\AddHiddenOffersRequest $add_hidden_offers_request,
        string $contentType = self::contentTypes['addHiddenOffers'][0]
     ...
     */
    public function addHiddenOffersWithHttpInfo(
        int $campaign_id,
        \OpenAPI\Client\Model\AddHiddenOffersRequest $add_hidden_offers_request,
        string $contentType = self::contentTypes['addHiddenOffers'][0]
    ): array
     ...
     */
    public function addHiddenOffersAsync(
        int $campaign_id,
        \OpenAPI\Client\Model\AddHiddenOffersRequest $add_hidden_offers_request,
        string $contentType = self::contentTypes['addHiddenOffers'][0]
    ): PromiseInterface
     ...
     * @return PromiseInterface
     */
    public function addHiddenOffersAsyncWithHttpInfo(
        $campaign_id,
     ...
     */
    public function addHiddenOffersRequest(
        $campaign_id,
        $add_hidden_offers_request,
        string $contentType = self::contentTypes['addHiddenOffers'][0]
    ): Request
    ...
    public function deleteHiddenOffers(
        int $campaign_id,
        \OpenAPI\Client\Model\DeleteHiddenOffersRequest $delete_hidden_offers_request,
        string $contentType = self::contentTypes['deleteHiddenOffers'][0]
    ): \OpenAPI\Client\Model\EmptyApiResponse
    {
     ...
     * @return array of \OpenAPI\Client\Model\EmptyApiResponse|\OpenAPI\Client\Model\ApiClientDataErrorResponse|\OpenAPI\Client\Model\ApiUnauthorizedErrorResponse|\OpenAPI\Client\Model\ApiForbiddenErrorResponse|\OpenAPI\Client\Model\ApiNotFoundErrorResponse|\OpenAPI\Client\Model\ApiLimitErrorResponse|\OpenAPI\Client\Model\ApiLockedErrorResponse|\OpenAPI\Client\Model\ApiServerErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function deleteHiddenOffersWithHttpInfo(
        int $campaign_id,
        \OpenAPI\Client\Model\DeleteHiddenOffersRequest $delete_hidden_offers_request,
        string $contentType = self::contentTypes['deleteHiddenOffers'][0]
    ): array
     ...
     * @return PromiseInterface
     */
    public function deleteHiddenOffersAsync(
        int $campaign_id,
        \OpenAPI\Client\Model\DeleteHiddenOffersRequest $delete_hidden_offers_request,
        string $contentType = self::contentTypes['deleteHiddenOffers'][0]
    ): PromiseInterface
     ...
     * @return PromiseInterface
     */
    public function deleteHiddenOffersAsyncWithHttpInfo(
        $campaign_id,
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteHiddenOffersRequest(
        $campaign_id,
        $delete_hidden_offers_request,
        string $contentType = self::contentTypes['deleteHiddenOffers'][0]
    ): Request
    ...
    public function getHiddenOffers(
        ...
        ?int $page = 1,
        ?int $page_size = null,
        string $contentType = self::contentTypes['getHiddenOffers'][0]
    ...
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\OpenAPI\Client\Model\GetHiddenOffersResponse', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
     ...
     * @return PromiseInterface
     */
    public function getHiddenOffersAsync(
        int $campaign_id,
        ?array $offer_id = null,
        ?string $page_token = null,
        ?int $limit = null,
     ...
     * @return PromiseInterface
     */
    public function getHiddenOffersAsyncWithHttpInfo(
        $campaign_id,
        $offer_id = null,
        $page_token = null,
        $limit = null,
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getHiddenOffersRequest(
        $campaign_id,
        $offer_id = null,
        $page_token = null,
        $limit = null,
