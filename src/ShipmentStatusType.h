...
#ifndef _ShipmentStatusType_H_
#define _ShipmentStatusType_H_
...
class ShipmentStatusType : public Object {
public:
	/*! \brief Constructor.
	 */
	ShipmentStatusType();
	ShipmentStatusType(char* str);
