...
void
GetCategoryContentParametersResponse::__init()
{
	//status = new ApiResponseStatusType();
	//result = new CategoryContentParametersDTO();
}

void
GetCategoryContentParametersResponse::__cleanup()
{
	//if(status != NULL) {
	//
	//delete status;
...
void
GetCategoryContentParametersResponse::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
		...
		if (isprimitive("CategoryContentParametersDTO")) {
			jsonToValue(&result, node, "CategoryContentParametersDTO", "CategoryContentParametersDTO");
		} else {
			
			CategoryContentParametersDTO* obj = static_cast<CategoryContentParametersDTO*> (&result);
			obj->fromJson(json_to_string(node, false));
...
GetCategoryContentParametersResponse::GetCategoryContentParametersResponse(char* json)
{
	this->fromJson(json);
}
...
GetCategoryContentParametersResponse::toJson()
{
	...
	if (isprimitive("CategoryContentParametersDTO")) {
		CategoryContentParametersDTO obj = getResult();
		node = converttoJson(&obj, "CategoryContentParametersDTO", "");
	}
	else {
		
		CategoryContentParametersDTO obj = static_cast<CategoryContentParametersDTO> (getResult());
		GError *mygerror;
		mygerror = NULL;
		node = json_from_string(obj.toJson(), &mygerror);
