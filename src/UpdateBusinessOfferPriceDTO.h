...
#ifndef _UpdateBusinessOfferPriceDTO_H_
#define _UpdateBusinessOfferPriceDTO_H_
...
class UpdateBusinessOfferPriceDTO : public Object {
public:
	/*! \brief Constructor.
	 */
	UpdateBusinessOfferPriceDTO();
	UpdateBusinessOfferPriceDTO(char* str);
...
#endif /* _UpdateBusinessOfferPriceDTO_H_ */
