...
void
OrderItemModificationDTO::__init()
{
	//id = long(0);
	//count = int(0);
...
void
OrderItemModificationDTO::__cleanup()
{
	//if(id != NULL) {
	//
	//delete id;
...
void
OrderItemModificationDTO::fromJson(char* jsonStr)
{
...
OrderItemModificationDTO::OrderItemModificationDTO(char* json)
{
	this->fromJson(json);
}
...
void
OrderItemModificationDTO::setId(long long  id)
{
	this->id = id;
}
