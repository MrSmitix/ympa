...
public class DbsServiceImpl implements DbsService {
    ...
    @Override
    public void createOutlet(ServerRequest request, ServerResponse response) {
        ValidatorUtils.Validator validator = ValidatorUtils.validator();
    ...
    @Override
    public void deleteOutlet(ServerRequest request, ServerResponse response) {
        ValidatorUtils.Validator validator = ValidatorUtils.validator();
    ...
    @Override
    public void getOutlet(ServerRequest request, ServerResponse response) {
        ValidatorUtils.Validator validator = ValidatorUtils.validator();
    ...
    @Override
    public void getOutlets(ServerRequest request, ServerResponse response) {
        ValidatorUtils.Validator validator = ValidatorUtils.validator();
    ...
    @Override
    public void updateOutlet(ServerRequest request, ServerResponse response) {
        ValidatorUtils.Validator validator = ValidatorUtils.validator();
    ...
    public void afterStop() {
        System.out.println("Service DbsService is down. Goodbye!");
    }
