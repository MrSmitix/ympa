...
public class FbsApiVerticle extends AbstractVerticle {
    static final Logger LOGGER = LoggerFactory.getLogger(FbsApiVerticle.class);
    ...
    final FbsApi service;

    public FbsApiVerticle() {
        try {
            Class serviceImplClass = getClass().getClassLoader().loadClass("org.openapitools.server.api.verticle.FbsApiImpl");
            service = (FbsApi)serviceImplClass.newInstance();
        } catch (Exception e) {
            logUnexpectedError("FbsApiVerticle constructor", e);
