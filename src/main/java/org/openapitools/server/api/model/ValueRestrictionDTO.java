...
import org.openapitools.server.api.model.OptionValuesLimitedDTO;
...
public class ValueRestrictionDTO   {
  ...
  public ValueRestrictionDTO (Long limitingParameterId, List<OptionValuesLimitedDTO> limitedValues) {
