...
import org.openapitools.server.api.model.UpdateOrderStatusesDTO;
...
public class UpdateOrderStatusesResponse   {
  ...
  public UpdateOrderStatusesResponse () {

  }

  public UpdateOrderStatusesResponse (ApiResponseStatusType status, UpdateOrderStatusesDTO result) {
    this.status = status;
    this.result = result;
  }
