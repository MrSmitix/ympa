...
import org.openapitools.server.api.model.OutletResponseDTO;
...
public class CreateOutletResponse   {
  ...
  public CreateOutletResponse (ApiResponseStatusType status, OutletResponseDTO result) {
    this.status = status;
    this.result = result;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(status, createOutletResponse.status) &&
        Objects.equals(result, createOutletResponse.result);
  }
