...
public class ApiServerErrorResponse   {
  ...
  public ApiServerErrorResponse (ApiResponseStatusType status, List<ApiErrorDTO> errors) {
    this.status = status;
    this.errors = errors;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(status, apiServerErrorResponse.status) &&
        Objects.equals(errors, apiServerErrorResponse.errors);
  }
