...
public class ApiLockedErrorResponse   {
  ...
  public ApiLockedErrorResponse (ApiResponseStatusType status, List<ApiErrorDTO> errors) {
    this.status = status;
    this.errors = errors;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(status, apiLockedErrorResponse.status) &&
        Objects.equals(errors, apiLockedErrorResponse.errors);
  }
