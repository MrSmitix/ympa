...
import org.openapitools.server.api.model.GoodsFeedbackCommentDTO;
...
public class UpdateGoodsFeedbackCommentResponse   {
  ...
  public UpdateGoodsFeedbackCommentResponse (ApiResponseStatusType status, GoodsFeedbackCommentDTO result) {
    this.status = status;
    this.result = result;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(status, updateGoodsFeedbackCommentResponse.status) &&
        Objects.equals(result, updateGoodsFeedbackCommentResponse.result);
  }
