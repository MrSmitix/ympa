...
import org.openapitools.server.api.model.OutletAddressDTO;
import org.openapitools.server.api.model.OutletDeliveryRuleDTO;
import org.openapitools.server.api.model.OutletType;
import org.openapitools.server.api.model.OutletVisibilityType;
import org.openapitools.server.api.model.OutletWorkingScheduleDTO;
...
public class ChangeOutletRequest   {
  ...
  public ChangeOutletRequest (String name, OutletType type, String coords, Boolean isMain, String shopOutletCode, OutletVisibilityType visibility, OutletAddressDTO address, List<String> phones, OutletWorkingScheduleDTO workingSchedule, List<OutletDeliveryRuleDTO> deliveryRules, Long storagePeriod) {
    this.name = name;
    this.type = type;
    this.coords = coords;
    this.isMain = isMain;
