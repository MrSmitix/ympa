...
@io.helidon.common.Generated(value = "org.openapitools.codegen.languages.JavaHelidonServerCodegen",
                             trigger = "tag = 'Fby'",
                             version = "7.8.0")
public interface FbyService extends HttpService {
    ...
    default void routing(HttpRules rules) {
        ...
        rules.post("/reports/goods-movement/generate", this::generateGoodsMovementReport);
        rules.post("/reports/goods-realization/generate", this::generateGoodsRealizationReport);
        rules.post("/reports/goods-turnover/generate", this::generateGoodsTurnoverReport);
