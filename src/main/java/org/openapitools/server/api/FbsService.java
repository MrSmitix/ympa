...
@io.helidon.common.Generated(value = "org.openapitools.codegen.languages.JavaHelidonServerCodegen",
                             trigger = "tag = 'Fbs'",
                             version = "7.8.0")
public interface FbsService extends HttpService {
    ...
    default void routing(HttpRules rules) {
        ...
        rules.post("/campaigns/{campaignId}/first-mile/shipments/{shipmentId}/confirm", this::confirmShipment);
        ...
        rules.get("/campaigns/{campaignId}/first-mile/shipments/{shipmentId}/act", this::downloadShipmentAct);
        rules.get("/campaigns/{campaignId}/first-mile/shipments/{shipmentId}/discrepancy-act", this::downloadShipmentDiscrepancyAct);
        rules.get("/campaigns/{campaignId}/first-mile/shipments/{shipmentId}/inbound-act", this::downloadShipmentInboundAct);
        rules.get("/campaigns/{campaignId}/first-mile/shipments/{shipmentId}/pallet/labels", this::downloadShipmentPalletLabels);
        rules.get("/campaigns/{campaignId}/shipments/reception-transfer-act", this::downloadShipmentReceptionTransferAct);
        rules.get("/campaigns/{campaignId}/first-mile/shipments/{shipmentId}/transportation-waybill", this::downloadShipmentTransportationWaybill);
        ...
        rules.post("/reports/goods-realization/generate", this::generateGoodsRealizationReport);
        ...
        rules.post("/reports/documents/shipment-list/generate", this::generateShipmentListDocumentReport);
        ...
        rules.get("/campaigns/{campaignId}/first-mile/shipments/{shipmentId}", this::getShipment);
        rules.get("/campaigns/{campaignId}/first-mile/shipments/{shipmentId}/orders/info", this::getShipmentOrdersInfo);
        ...
        rules.put("/campaigns/{campaignId}/first-mile/shipments", this::searchShipments);
        ...
        rules.put("/campaigns/{campaignId}/first-mile/shipments/{shipmentId}/pallets", this::setShipmentPalletsCount);
        rules.post("/businesses/{businessId}/goods-feedback/skip-reaction", this::skipGoodsFeedbacksReaction);
        rules.post("/campaigns/{campaignId}/first-mile/shipments/{shipmentId}/orders/transfer", this::transferOrdersFromShipment);
