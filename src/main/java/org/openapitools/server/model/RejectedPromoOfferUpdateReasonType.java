 ...
 */
@JsonbTypeSerializer(RejectedPromoOfferUpdateReasonType.Serializer.class)
@JsonbTypeDeserializer(RejectedPromoOfferUpdateReasonType.Deserializer.class)
public enum RejectedPromoOfferUpdateReasonType {
  ...
  public static final class Deserializer implements JsonbDeserializer<RejectedPromoOfferUpdateReasonType> {
    @Override
    public RejectedPromoOfferUpdateReasonType deserialize(JsonParser parser, DeserializationContext ctx, Type rtType) {
      return fromValue(parser.getString());
    }
  }

  public static final class Serializer implements JsonbSerializer<RejectedPromoOfferUpdateReasonType> {
    @Override
    public void serialize(RejectedPromoOfferUpdateReasonType obj, JsonGenerator generator, SerializationContext ctx) {
