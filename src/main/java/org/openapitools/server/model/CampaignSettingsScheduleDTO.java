...
public class CampaignSettingsScheduleDTO  {
  ...
  */
  @JsonbProperty("availableOnHolidays")
  ...
  */
  @JsonbProperty("customWorkingDays")
  private List<String> customWorkingDays = new ArrayList<>();

  @JsonbProperty("period")
