 ...
 */
@JsonbTypeSerializer(OrdersStatsCommissionType.Serializer.class)
@JsonbTypeDeserializer(OrdersStatsCommissionType.Deserializer.class)
public enum OrdersStatsCommissionType {
  ...
  public static final class Deserializer implements JsonbDeserializer<OrdersStatsCommissionType> {
    @Override
    public OrdersStatsCommissionType deserialize(JsonParser parser, DeserializationContext ctx, Type rtType) {
      return fromValue(parser.getString());
    }
  }

  public static final class Serializer implements JsonbSerializer<OrdersStatsCommissionType> {
    @Override
    public void serialize(OrdersStatsCommissionType obj, JsonGenerator generator, SerializationContext ctx) {
