 ...
 */
@JsonbTypeSerializer(OrderSubstatusType.Serializer.class)
@JsonbTypeDeserializer(OrderSubstatusType.Deserializer.class)
public enum OrderSubstatusType {
  ...
  public static final class Deserializer implements JsonbDeserializer<OrderSubstatusType> {
    @Override
    public OrderSubstatusType deserialize(JsonParser parser, DeserializationContext ctx, Type rtType) {
      return fromValue(parser.getString());
    }
  }

  public static final class Serializer implements JsonbSerializer<OrderSubstatusType> {
    @Override
    public void serialize(OrderSubstatusType obj, JsonGenerator generator, SerializationContext ctx) {
