...
import org.openapitools.server.model.OfferCampaignStatusDTO;
...
import org.openapitools.server.model.OfferSellingProgramDTO;
...
public class GetOfferDTO   {
    ...
    public GetOfferDTO(
        ...
        List<@Valid OfferCampaignStatusDTO> campaigns, 
        List<@Valid OfferSellingProgramDTO> sellingPrograms, 
        Boolean archived
    ) {
