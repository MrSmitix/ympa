 ...
 */
@JsonbTypeSerializer(PromoOfferUpdateWarningCodeType.Serializer.class)
@JsonbTypeDeserializer(PromoOfferUpdateWarningCodeType.Deserializer.class)
public enum PromoOfferUpdateWarningCodeType {
  ...
  public static final class Deserializer implements JsonbDeserializer<PromoOfferUpdateWarningCodeType> {
    @Override
    public PromoOfferUpdateWarningCodeType deserialize(JsonParser parser, DeserializationContext ctx, Type rtType) {
      return fromValue(parser.getString());
    }
  }

  public static final class Serializer implements JsonbSerializer<PromoOfferUpdateWarningCodeType> {
    @Override
    public void serialize(PromoOfferUpdateWarningCodeType obj, JsonGenerator generator, SerializationContext ctx) {
