 ...
 */
@JsonbTypeSerializer(TariffType.Serializer.class)
@JsonbTypeDeserializer(TariffType.Deserializer.class)
public enum TariffType {
  ...
  public static final class Deserializer implements JsonbDeserializer<TariffType> {
    @Override
    public TariffType deserialize(JsonParser parser, DeserializationContext ctx, Type rtType) {
      return fromValue(parser.getString());
    }
  }

  public static final class Serializer implements JsonbSerializer<TariffType> {
    @Override
    public void serialize(TariffType obj, JsonGenerator generator, SerializationContext ctx) {
