 ...
 */
@JsonbTypeSerializer(OrderPromoType.Serializer.class)
@JsonbTypeDeserializer(OrderPromoType.Deserializer.class)
public enum OrderPromoType {
  ...
  public static final class Deserializer implements JsonbDeserializer<OrderPromoType> {
    @Override
    public OrderPromoType deserialize(JsonParser parser, DeserializationContext ctx, Type rtType) {
      return fromValue(parser.getString());
    }
  }

  public static final class Serializer implements JsonbSerializer<OrderPromoType> {
    @Override
    public void serialize(OrderPromoType obj, JsonGenerator generator, SerializationContext ctx) {
