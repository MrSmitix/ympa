 ...
 */
@JsonbTypeSerializer(OfferMappingErrorType.Serializer.class)
@JsonbTypeDeserializer(OfferMappingErrorType.Deserializer.class)
public enum OfferMappingErrorType {
  ...
  public static final class Deserializer implements JsonbDeserializer<OfferMappingErrorType> {
    @Override
    public OfferMappingErrorType deserialize(JsonParser parser, DeserializationContext ctx, Type rtType) {
      return fromValue(parser.getString());
    }
  }

  public static final class Serializer implements JsonbSerializer<OfferMappingErrorType> {
    @Override
    public void serialize(OfferMappingErrorType obj, JsonGenerator generator, SerializationContext ctx) {
