 ...
 */
@JsonbTypeSerializer(OfferCardRecommendationType.Serializer.class)
@JsonbTypeDeserializer(OfferCardRecommendationType.Deserializer.class)
public enum OfferCardRecommendationType {
  ...
  public static final class Deserializer implements JsonbDeserializer<OfferCardRecommendationType> {
    @Override
    public OfferCardRecommendationType deserialize(JsonParser parser, DeserializationContext ctx, Type rtType) {
      return fromValue(parser.getString());
    }
  }

  public static final class Serializer implements JsonbSerializer<OfferCardRecommendationType> {
    @Override
    public void serialize(OfferCardRecommendationType obj, JsonGenerator generator, SerializationContext ctx) {
