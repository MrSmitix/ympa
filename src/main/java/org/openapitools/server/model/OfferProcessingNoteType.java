 ...
 */
@JsonbTypeSerializer(OfferProcessingNoteType.Serializer.class)
@JsonbTypeDeserializer(OfferProcessingNoteType.Deserializer.class)
public enum OfferProcessingNoteType {
  ...
  public static final class Deserializer implements JsonbDeserializer<OfferProcessingNoteType> {
    @Override
    public OfferProcessingNoteType deserialize(JsonParser parser, DeserializationContext ctx, Type rtType) {
      return fromValue(parser.getString());
    }
  }

  public static final class Serializer implements JsonbSerializer<OfferProcessingNoteType> {
    @Override
    public void serialize(OfferProcessingNoteType obj, JsonGenerator generator, SerializationContext ctx) {
