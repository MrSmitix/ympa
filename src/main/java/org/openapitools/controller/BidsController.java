...
@Controller
@Tag(name = "Bids", description = "The Bids API")
public class BidsController {
    ...
    @Operation(
        ...
        parameters = {
            ...
            @Parameter(name = "getBidsInfoRequest", description = "description")
        },
        security = {
    ...
    public Mono<GetBidsInfoResponse> getBidsInfoForBusiness(
        ...
        // TODO implement getBidsInfoForBusiness();
    ...
    @Operation(
        ...
        parameters = {
            @Parameter(name = "businessId", description = "Идентификатор кабинета. Чтобы узнать идентификатор, воспользуйтесь запросом [GET campaigns](../../reference/campaigns/getCampaigns.md#businessdto).  ℹ️ [Что такое кабинет и магазин на Маркете](https://yandex.ru/support/marketplace/account/introduction.html) ", required = true),
            @Parameter(name = "getBidsRecommendationsRequest", description = "description.", required = true)
        },
        security = {
            @SecurityRequirement(name = "OAuth", scopes = { "market:partner-api" })
        }
    ...
    @Consumes(value = {"application/json"})
    @Secured({SecurityRule.IS_AUTHENTICATED})
    public Mono<GetBidsRecommendationsResponse> getBidsRecommendations(
        @PathVariable(value="businessId") @NotNull Long businessId, 
        @Body @NotNull @Valid GetBidsRecommendationsRequest getBidsRecommendationsRequest
    ) {
        // TODO implement getBidsRecommendations();
        return Mono.error(new HttpStatusException(HttpStatus.NOT_IMPLEMENTED, null));
    }
    ...
    @Operation(
        ...
        parameters = {
            @Parameter(name = "businessId", description = "Идентификатор кабинета. Чтобы узнать идентификатор, воспользуйтесь запросом [GET campaigns](../../reference/campaigns/getCampaigns.md#businessdto).  ℹ️ [Что такое кабинет и магазин на Маркете](https://yandex.ru/support/marketplace/account/introduction.html) ", required = true),
            @Parameter(name = "putSkuBidsRequest", description = "description", required = true)
        },
        security = {
            @SecurityRequirement(name = "OAuth", scopes = { "market:partner-api" })
        }
    ...
    @Consumes(value = {"application/json"})
    @Secured({SecurityRule.IS_AUTHENTICATED})
    public Mono<EmptyApiResponse> putBidsForBusiness(
        @PathVariable(value="businessId") @NotNull Long businessId, 
        @Body @NotNull @Valid PutSkuBidsRequest putSkuBidsRequest
    ) {
        // TODO implement putBidsForBusiness();
        return Mono.error(new HttpStatusException(HttpStatus.NOT_IMPLEMENTED, null));
    }
    ...
    @Consumes(value = {"application/json"})
    @Secured({SecurityRule.IS_AUTHENTICATED})
    public Mono<EmptyApiResponse> putBidsForCampaign(
        @PathVariable(value="campaignId") @NotNull Long campaignId, 
        @Body @NotNull @Valid PutSkuBidsRequest putSkuBidsRequest
    ) {
        // TODO implement putBidsForCampaign();
        return Mono.error(new HttpStatusException(HttpStatus.NOT_IMPLEMENTED, null));
    }
