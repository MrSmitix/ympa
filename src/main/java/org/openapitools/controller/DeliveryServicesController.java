...
@Controller
@Tag(name = "DeliveryServices", description = "The DeliveryServices API")
public class DeliveryServicesController {
    ...
    public Mono<GetDeliveryServicesResponse> getDeliveryServices() {
        // TODO implement getDeliveryServices();
