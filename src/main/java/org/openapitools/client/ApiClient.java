...
public class ApiClient {
    ...
    private String basePath = "https://api.partner.market.yandex.ru";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/LATEST/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.partner.market.yandex.ru
