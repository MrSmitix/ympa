 ...
 */
@JsonAdapter(OrderVatType.Adapter.class)
public enum OrderVatType {
  ...
  public static class Adapter extends TypeAdapter<OrderVatType> {
    @Override
    public void write(final JsonWriter jsonWriter, final OrderVatType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public OrderVatType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return OrderVatType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    OrderVatType.fromValue(value);
  }
}
