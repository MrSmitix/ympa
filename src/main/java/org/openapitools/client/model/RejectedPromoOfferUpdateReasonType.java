 ...
 */
@JsonAdapter(RejectedPromoOfferUpdateReasonType.Adapter.class)
public enum RejectedPromoOfferUpdateReasonType {
  ...
  public static class Adapter extends TypeAdapter<RejectedPromoOfferUpdateReasonType> {
    @Override
    public void write(final JsonWriter jsonWriter, final RejectedPromoOfferUpdateReasonType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public RejectedPromoOfferUpdateReasonType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return RejectedPromoOfferUpdateReasonType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    RejectedPromoOfferUpdateReasonType.fromValue(value);
  }
}
