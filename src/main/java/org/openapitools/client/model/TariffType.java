 ...
 */
@JsonAdapter(TariffType.Adapter.class)
public enum TariffType {
  ...
  public static class Adapter extends TypeAdapter<TariffType> {
    @Override
    public void write(final JsonWriter jsonWriter, final TariffType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public TariffType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return TariffType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    TariffType.fromValue(value);
  }
}
