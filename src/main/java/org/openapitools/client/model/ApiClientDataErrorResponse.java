...
public class ApiClientDataErrorResponse {
  ...
  public boolean equals(Object o) {
    ...
    return (this.status == null ? apiClientDataErrorResponse.status == null : this.status.equals(apiClientDataErrorResponse.status)) &&
        (this.errors == null ? apiClientDataErrorResponse.errors == null : this.errors.equals(apiClientDataErrorResponse.errors));
  }
