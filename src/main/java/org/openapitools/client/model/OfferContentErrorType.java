 ...
 */
@JsonAdapter(OfferContentErrorType.Adapter.class)
public enum OfferContentErrorType {
  ...
  public static class Adapter extends TypeAdapter<OfferContentErrorType> {
    @Override
    public void write(final JsonWriter jsonWriter, final OfferContentErrorType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public OfferContentErrorType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return OfferContentErrorType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    OfferContentErrorType.fromValue(value);
  }
}
