...
public class GetOfferDTO {
  ...
  private GetPriceDTO purchasePrice = null;
  @SerializedName("additionalExpenses")
  private GetPriceDTO additionalExpenses = null;
  ...
  @SerializedName("sellingPrograms")
  ...
  public boolean equals(Object o) {
    ...
    return (this.offerId == null ? getOfferDTO.offerId == null : this.offerId.equals(getOfferDTO.offerId)) &&
        (this.name == null ? getOfferDTO.name == null : this.name.equals(getOfferDTO.name)) &&
        (this.marketCategoryId == null ? getOfferDTO.marketCategoryId == null : this.marketCategoryId.equals(getOfferDTO.marketCategoryId)) &&
        (this.category == null ? getOfferDTO.category == null : this.category.equals(getOfferDTO.category)) &&
        (this.pictures == null ? getOfferDTO.pictures == null : this.pictures.equals(getOfferDTO.pictures)) &&
        (this.videos == null ? getOfferDTO.videos == null : this.videos.equals(getOfferDTO.videos)) &&
        (this.manuals == null ? getOfferDTO.manuals == null : this.manuals.equals(getOfferDTO.manuals)) &&
        (this.vendor == null ? getOfferDTO.vendor == null : this.vendor.equals(getOfferDTO.vendor)) &&
        (this.barcodes == null ? getOfferDTO.barcodes == null : this.barcodes.equals(getOfferDTO.barcodes)) &&
        (this.description == null ? getOfferDTO.description == null : this.description.equals(getOfferDTO.description)) &&
        (this.manufacturerCountries == null ? getOfferDTO.manufacturerCountries == null : this.manufacturerCountries.equals(getOfferDTO.manufacturerCountries)) &&
        (this.weightDimensions == null ? getOfferDTO.weightDimensions == null : this.weightDimensions.equals(getOfferDTO.weightDimensions)) &&
        (this.vendorCode == null ? getOfferDTO.vendorCode == null : this.vendorCode.equals(getOfferDTO.vendorCode)) &&
        (this.tags == null ? getOfferDTO.tags == null : this.tags.equals(getOfferDTO.tags)) &&
        (this.shelfLife == null ? getOfferDTO.shelfLife == null : this.shelfLife.equals(getOfferDTO.shelfLife)) &&
        (this.lifeTime == null ? getOfferDTO.lifeTime == null : this.lifeTime.equals(getOfferDTO.lifeTime)) &&
        (this.guaranteePeriod == null ? getOfferDTO.guaranteePeriod == null : this.guaranteePeriod.equals(getOfferDTO.guaranteePeriod)) &&
        (this.customsCommodityCode == null ? getOfferDTO.customsCommodityCode == null : this.customsCommodityCode.equals(getOfferDTO.customsCommodityCode)) &&
        (this.certificates == null ? getOfferDTO.certificates == null : this.certificates.equals(getOfferDTO.certificates)) &&
        (this.boxCount == null ? getOfferDTO.boxCount == null : this.boxCount.equals(getOfferDTO.boxCount)) &&
        (this.condition == null ? getOfferDTO.condition == null : this.condition.equals(getOfferDTO.condition)) &&
        (this.type == null ? getOfferDTO.type == null : this.type.equals(getOfferDTO.type)) &&
        (this.downloadable == null ? getOfferDTO.downloadable == null : this.downloadable.equals(getOfferDTO.downloadable)) &&
        (this.adult == null ? getOfferDTO.adult == null : this.adult.equals(getOfferDTO.adult)) &&
        (this.age == null ? getOfferDTO.age == null : this.age.equals(getOfferDTO.age)) &&
        (this.params == null ? getOfferDTO.params == null : this.params.equals(getOfferDTO.params)) &&
        (this.basicPrice == null ? getOfferDTO.basicPrice == null : this.basicPrice.equals(getOfferDTO.basicPrice)) &&
        (this.purchasePrice == null ? getOfferDTO.purchasePrice == null : this.purchasePrice.equals(getOfferDTO.purchasePrice)) &&
        (this.additionalExpenses == null ? getOfferDTO.additionalExpenses == null : this.additionalExpenses.equals(getOfferDTO.additionalExpenses)) &&
        (this.cofinancePrice == null ? getOfferDTO.cofinancePrice == null : this.cofinancePrice.equals(getOfferDTO.cofinancePrice)) &&
        (this.cardStatus == null ? getOfferDTO.cardStatus == null : this.cardStatus.equals(getOfferDTO.cardStatus)) &&
        (this.campaigns == null ? getOfferDTO.campaigns == null : this.campaigns.equals(getOfferDTO.campaigns)) &&
        (this.sellingPrograms == null ? getOfferDTO.sellingPrograms == null : this.sellingPrograms.equals(getOfferDTO.sellingPrograms)) &&
        (this.archived == null ? getOfferDTO.archived == null : this.archived.equals(getOfferDTO.archived));
  }
  ...
  public int hashCode() {
    ...
    result = 31 * result + (this.sellingPrograms == null ? 0: this.sellingPrograms.hashCode());
