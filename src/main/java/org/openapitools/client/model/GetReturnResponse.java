...
public class GetReturnResponse {
  ...
  public boolean equals(Object o) {
    ...
    return (this.status == null ? getReturnResponse.status == null : this.status.equals(getReturnResponse.status)) &&
        (this.result == null ? getReturnResponse.result == null : this.result.equals(getReturnResponse.result));
  }
