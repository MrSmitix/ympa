 ...
 */
@JsonAdapter(ReturnDecisionSubreasonType.Adapter.class)
public enum ReturnDecisionSubreasonType {
  ...
  public static class Adapter extends TypeAdapter<ReturnDecisionSubreasonType> {
    @Override
    public void write(final JsonWriter jsonWriter, final ReturnDecisionSubreasonType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ReturnDecisionSubreasonType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ReturnDecisionSubreasonType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ReturnDecisionSubreasonType.fromValue(value);
  }
}
