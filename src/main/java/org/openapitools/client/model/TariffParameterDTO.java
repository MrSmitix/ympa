...
public class TariffParameterDTO {
  ...
  public boolean equals(Object o) {
    ...
    return (this.name == null ? tariffParameterDTO.name == null : this.name.equals(tariffParameterDTO.name)) &&
        (this.value == null ? tariffParameterDTO.value == null : this.value.equals(tariffParameterDTO.value));
  }
