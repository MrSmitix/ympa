 ...
 */
@JsonAdapter(RefundStatusType.Adapter.class)
public enum RefundStatusType {
  ...
  public static class Adapter extends TypeAdapter<RefundStatusType> {
    @Override
    public void write(final JsonWriter jsonWriter, final RefundStatusType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public RefundStatusType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return RefundStatusType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    RefundStatusType.fromValue(value);
  }
}
