 ...
 */
@JsonAdapter(OfferProcessingNoteType.Adapter.class)
public enum OfferProcessingNoteType {
  ...
  public static class Adapter extends TypeAdapter<OfferProcessingNoteType> {
    @Override
    public void write(final JsonWriter jsonWriter, final OfferProcessingNoteType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public OfferProcessingNoteType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return OfferProcessingNoteType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    OfferProcessingNoteType.fromValue(value);
  }
}
