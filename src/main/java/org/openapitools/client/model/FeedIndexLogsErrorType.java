 ...
 */
@JsonAdapter(FeedIndexLogsErrorType.Adapter.class)
public enum FeedIndexLogsErrorType {
  ...
  public static class Adapter extends TypeAdapter<FeedIndexLogsErrorType> {
    @Override
    public void write(final JsonWriter jsonWriter, final FeedIndexLogsErrorType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FeedIndexLogsErrorType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FeedIndexLogsErrorType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    FeedIndexLogsErrorType.fromValue(value);
  }
}
