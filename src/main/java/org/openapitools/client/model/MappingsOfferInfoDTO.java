...
public class MappingsOfferInfoDTO {
  ...
  public boolean equals(Object o) {
    ...
    return (this.name == null ? mappingsOfferInfoDTO.name == null : this.name.equals(mappingsOfferInfoDTO.name)) &&
        (this.shopSku == null ? mappingsOfferInfoDTO.shopSku == null : this.shopSku.equals(mappingsOfferInfoDTO.shopSku)) &&
        (this.category == null ? mappingsOfferInfoDTO.category == null : this.category.equals(mappingsOfferInfoDTO.category)) &&
        (this.vendor == null ? mappingsOfferInfoDTO.vendor == null : this.vendor.equals(mappingsOfferInfoDTO.vendor)) &&
        (this.vendorCode == null ? mappingsOfferInfoDTO.vendorCode == null : this.vendorCode.equals(mappingsOfferInfoDTO.vendorCode)) &&
        (this.description == null ? mappingsOfferInfoDTO.description == null : this.description.equals(mappingsOfferInfoDTO.description)) &&
        (this.id == null ? mappingsOfferInfoDTO.id == null : this.id.equals(mappingsOfferInfoDTO.id)) &&
        (this.feedId == null ? mappingsOfferInfoDTO.feedId == null : this.feedId.equals(mappingsOfferInfoDTO.feedId)) &&
        (this.barcodes == null ? mappingsOfferInfoDTO.barcodes == null : this.barcodes.equals(mappingsOfferInfoDTO.barcodes)) &&
        (this.urls == null ? mappingsOfferInfoDTO.urls == null : this.urls.equals(mappingsOfferInfoDTO.urls)) &&
        (this.pictures == null ? mappingsOfferInfoDTO.pictures == null : this.pictures.equals(mappingsOfferInfoDTO.pictures)) &&
        (this.manufacturer == null ? mappingsOfferInfoDTO.manufacturer == null : this.manufacturer.equals(mappingsOfferInfoDTO.manufacturer)) &&
        (this.manufacturerCountries == null ? mappingsOfferInfoDTO.manufacturerCountries == null : this.manufacturerCountries.equals(mappingsOfferInfoDTO.manufacturerCountries)) &&
        (this.minShipment == null ? mappingsOfferInfoDTO.minShipment == null : this.minShipment.equals(mappingsOfferInfoDTO.minShipment)) &&
        (this.transportUnitSize == null ? mappingsOfferInfoDTO.transportUnitSize == null : this.transportUnitSize.equals(mappingsOfferInfoDTO.transportUnitSize)) &&
        (this.quantumOfSupply == null ? mappingsOfferInfoDTO.quantumOfSupply == null : this.quantumOfSupply.equals(mappingsOfferInfoDTO.quantumOfSupply)) &&
        (this.deliveryDurationDays == null ? mappingsOfferInfoDTO.deliveryDurationDays == null : this.deliveryDurationDays.equals(mappingsOfferInfoDTO.deliveryDurationDays)) &&
        (this.boxCount == null ? mappingsOfferInfoDTO.boxCount == null : this.boxCount.equals(mappingsOfferInfoDTO.boxCount)) &&
        (this.customsCommodityCodes == null ? mappingsOfferInfoDTO.customsCommodityCodes == null : this.customsCommodityCodes.equals(mappingsOfferInfoDTO.customsCommodityCodes)) &&
        (this.weightDimensions == null ? mappingsOfferInfoDTO.weightDimensions == null : this.weightDimensions.equals(mappingsOfferInfoDTO.weightDimensions)) &&
        (this.supplyScheduleDays == null ? mappingsOfferInfoDTO.supplyScheduleDays == null : this.supplyScheduleDays.equals(mappingsOfferInfoDTO.supplyScheduleDays)) &&
        (this.shelfLifeDays == null ? mappingsOfferInfoDTO.shelfLifeDays == null : this.shelfLifeDays.equals(mappingsOfferInfoDTO.shelfLifeDays)) &&
        (this.lifeTimeDays == null ? mappingsOfferInfoDTO.lifeTimeDays == null : this.lifeTimeDays.equals(mappingsOfferInfoDTO.lifeTimeDays)) &&
        (this.guaranteePeriodDays == null ? mappingsOfferInfoDTO.guaranteePeriodDays == null : this.guaranteePeriodDays.equals(mappingsOfferInfoDTO.guaranteePeriodDays)) &&
        (this.processingState == null ? mappingsOfferInfoDTO.processingState == null : this.processingState.equals(mappingsOfferInfoDTO.processingState)) &&
        (this.availability == null ? mappingsOfferInfoDTO.availability == null : this.availability.equals(mappingsOfferInfoDTO.availability)) &&
        (this.shelfLife == null ? mappingsOfferInfoDTO.shelfLife == null : this.shelfLife.equals(mappingsOfferInfoDTO.shelfLife)) &&
        (this.lifeTime == null ? mappingsOfferInfoDTO.lifeTime == null : this.lifeTime.equals(mappingsOfferInfoDTO.lifeTime)) &&
        (this.guaranteePeriod == null ? mappingsOfferInfoDTO.guaranteePeriod == null : this.guaranteePeriod.equals(mappingsOfferInfoDTO.guaranteePeriod)) &&
        (this.certificate == null ? mappingsOfferInfoDTO.certificate == null : this.certificate.equals(mappingsOfferInfoDTO.certificate));
  }
