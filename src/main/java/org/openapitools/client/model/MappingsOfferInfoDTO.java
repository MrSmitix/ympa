...
public class MappingsOfferInfoDTO {
   ...
   * @throws IOException if the JSON Element is invalid with respect to MappingsOfferInfoDTO
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MappingsOfferInfoDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MappingsOfferInfoDTO is not found in the empty JSON string", MappingsOfferInfoDTO.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MappingsOfferInfoDTO.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MappingsOfferInfoDTO` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MappingsOfferInfoDTO.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MappingsOfferInfoDTO' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MappingsOfferInfoDTO> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MappingsOfferInfoDTO.class));

       return (TypeAdapter<T>) new TypeAdapter<MappingsOfferInfoDTO>() {
           @Override
           public void write(JsonWriter out, MappingsOfferInfoDTO value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MappingsOfferInfoDTO read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MappingsOfferInfoDTO given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MappingsOfferInfoDTO
   * @throws IOException if the JSON string is invalid with respect to MappingsOfferInfoDTO
   */
  public static MappingsOfferInfoDTO fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MappingsOfferInfoDTO.class);
  }

  /**
   * Convert an instance of MappingsOfferInfoDTO to an JSON string
   *
   * @return JSON string
   */
