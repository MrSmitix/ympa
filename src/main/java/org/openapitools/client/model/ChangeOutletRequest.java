...
public class ChangeOutletRequest {
   ...
   * @throws IOException if the JSON Element is invalid with respect to ChangeOutletRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ChangeOutletRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ChangeOutletRequest is not found in the empty JSON string", ChangeOutletRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ChangeOutletRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ChangeOutletRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ChangeOutletRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ChangeOutletRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ChangeOutletRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ChangeOutletRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ChangeOutletRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ChangeOutletRequest>() {
           @Override
           public void write(JsonWriter out, ChangeOutletRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ChangeOutletRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ChangeOutletRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ChangeOutletRequest
   * @throws IOException if the JSON string is invalid with respect to ChangeOutletRequest
   */
  public static ChangeOutletRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ChangeOutletRequest.class);
  }

  /**
   * Convert an instance of ChangeOutletRequest to an JSON string
   *
   * @return JSON string
   */
