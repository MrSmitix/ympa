...
public class ApiLimitErrorResponse {
  ...
  public boolean equals(Object o) {
    ...
    return (this.status == null ? apiLimitErrorResponse.status == null : this.status.equals(apiLimitErrorResponse.status)) &&
        (this.errors == null ? apiLimitErrorResponse.errors == null : this.errors.equals(apiLimitErrorResponse.errors));
  }
