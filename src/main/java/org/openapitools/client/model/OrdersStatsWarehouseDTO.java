...
public class OrdersStatsWarehouseDTO {
  ...
  public boolean equals(Object o) {
    ...
    return (this.id == null ? ordersStatsWarehouseDTO.id == null : this.id.equals(ordersStatsWarehouseDTO.id)) &&
        (this.name == null ? ordersStatsWarehouseDTO.name == null : this.name.equals(ordersStatsWarehouseDTO.name));
  }
