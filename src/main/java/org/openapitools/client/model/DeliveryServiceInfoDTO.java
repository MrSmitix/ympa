...
public class DeliveryServiceInfoDTO {
  ...
  public boolean equals(Object o) {
    ...
    return (this.id == null ? deliveryServiceInfoDTO.id == null : this.id.equals(deliveryServiceInfoDTO.id)) &&
        (this.name == null ? deliveryServiceInfoDTO.name == null : this.name.equals(deliveryServiceInfoDTO.name));
  }
