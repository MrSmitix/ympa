 ...
 */
@JsonAdapter(TurnoverType.Adapter.class)
public enum TurnoverType {
  ...
  public static class Adapter extends TypeAdapter<TurnoverType> {
    @Override
    public void write(final JsonWriter jsonWriter, final TurnoverType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public TurnoverType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return TurnoverType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    TurnoverType.fromValue(value);
  }
}
