...
public class OutletLicenseDTO {
  ...
  public boolean equals(Object o) {
    ...
    return (this.id == null ? outletLicenseDTO.id == null : this.id.equals(outletLicenseDTO.id)) &&
        (this.outletId == null ? outletLicenseDTO.outletId == null : this.outletId.equals(outletLicenseDTO.outletId)) &&
        (this.licenseType == null ? outletLicenseDTO.licenseType == null : this.licenseType.equals(outletLicenseDTO.licenseType)) &&
        (this.number == null ? outletLicenseDTO.number == null : this.number.equals(outletLicenseDTO.number)) &&
        (this.dateOfIssue == null ? outletLicenseDTO.dateOfIssue == null : this.dateOfIssue.equals(outletLicenseDTO.dateOfIssue)) &&
        (this.dateOfExpiry == null ? outletLicenseDTO.dateOfExpiry == null : this.dateOfExpiry.equals(outletLicenseDTO.dateOfExpiry));
  }
