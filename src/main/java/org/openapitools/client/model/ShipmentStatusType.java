 ...
 */
@JsonAdapter(ShipmentStatusType.Adapter.class)
public enum ShipmentStatusType {
  ...
  public static class Adapter extends TypeAdapter<ShipmentStatusType> {
    @Override
    public void write(final JsonWriter jsonWriter, final ShipmentStatusType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ShipmentStatusType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ShipmentStatusType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ShipmentStatusType.fromValue(value);
  }
}
