...
public class ReportInfoDTO {
  ...
  public static final String SERIALIZED_NAME_GENERATION_REQUESTED_AT = "generationRequestedAt";
  @SerializedName(SERIALIZED_NAME_GENERATION_REQUESTED_AT)
  private OffsetDateTime generationRequestedAt;

  public static final String SERIALIZED_NAME_GENERATION_FINISHED_AT = "generationFinishedAt";
  @SerializedName(SERIALIZED_NAME_GENERATION_FINISHED_AT)
  ...
  static {
    ...
    openapiFields.add("generationRequestedAt");
    openapiFields.add("generationFinishedAt");
    ...
    openapiRequiredFields.add("generationRequestedAt");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ReportInfoDTO
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ReportInfoDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReportInfoDTO is not found in the empty JSON string", ReportInfoDTO.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ReportInfoDTO.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReportInfoDTO` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ReportInfoDTO.openapiRequiredFields) {
      ...
      if (jsonObj.get("subStatus") != null && !jsonObj.get("subStatus").isJsonNull()) {
        ReportSubStatusType.validateJsonElement(jsonObj.get("subStatus"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReportInfoDTO.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReportInfoDTO' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReportInfoDTO> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReportInfoDTO.class));

       return (TypeAdapter<T>) new TypeAdapter<ReportInfoDTO>() {
           @Override
           public void write(JsonWriter out, ReportInfoDTO value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ReportInfoDTO read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ReportInfoDTO given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ReportInfoDTO
   * @throws IOException if the JSON string is invalid with respect to ReportInfoDTO
   */
  public static ReportInfoDTO fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReportInfoDTO.class);
  }

  /**
   * Convert an instance of ReportInfoDTO to an JSON string
   *
   * @return JSON string
   */
