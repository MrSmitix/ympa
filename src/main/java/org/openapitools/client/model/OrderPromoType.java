 ...
 */
@JsonAdapter(OrderPromoType.Adapter.class)
public enum OrderPromoType {
  ...
  public static class Adapter extends TypeAdapter<OrderPromoType> {
    @Override
    public void write(final JsonWriter jsonWriter, final OrderPromoType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public OrderPromoType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return OrderPromoType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    OrderPromoType.fromValue(value);
  }
}
