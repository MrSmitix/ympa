...
public class MappingsOfferDTO {
  ...
  public boolean equals(Object o) {
    ...
    return (this.name == null ? mappingsOfferDTO.name == null : this.name.equals(mappingsOfferDTO.name)) &&
        (this.shopSku == null ? mappingsOfferDTO.shopSku == null : this.shopSku.equals(mappingsOfferDTO.shopSku)) &&
        (this.category == null ? mappingsOfferDTO.category == null : this.category.equals(mappingsOfferDTO.category)) &&
        (this.vendor == null ? mappingsOfferDTO.vendor == null : this.vendor.equals(mappingsOfferDTO.vendor)) &&
        (this.vendorCode == null ? mappingsOfferDTO.vendorCode == null : this.vendorCode.equals(mappingsOfferDTO.vendorCode)) &&
        (this.description == null ? mappingsOfferDTO.description == null : this.description.equals(mappingsOfferDTO.description)) &&
        (this.id == null ? mappingsOfferDTO.id == null : this.id.equals(mappingsOfferDTO.id)) &&
        (this.feedId == null ? mappingsOfferDTO.feedId == null : this.feedId.equals(mappingsOfferDTO.feedId)) &&
        (this.barcodes == null ? mappingsOfferDTO.barcodes == null : this.barcodes.equals(mappingsOfferDTO.barcodes)) &&
        (this.urls == null ? mappingsOfferDTO.urls == null : this.urls.equals(mappingsOfferDTO.urls)) &&
        (this.pictures == null ? mappingsOfferDTO.pictures == null : this.pictures.equals(mappingsOfferDTO.pictures)) &&
        (this.manufacturer == null ? mappingsOfferDTO.manufacturer == null : this.manufacturer.equals(mappingsOfferDTO.manufacturer)) &&
        (this.manufacturerCountries == null ? mappingsOfferDTO.manufacturerCountries == null : this.manufacturerCountries.equals(mappingsOfferDTO.manufacturerCountries)) &&
        (this.minShipment == null ? mappingsOfferDTO.minShipment == null : this.minShipment.equals(mappingsOfferDTO.minShipment)) &&
        (this.transportUnitSize == null ? mappingsOfferDTO.transportUnitSize == null : this.transportUnitSize.equals(mappingsOfferDTO.transportUnitSize)) &&
        (this.quantumOfSupply == null ? mappingsOfferDTO.quantumOfSupply == null : this.quantumOfSupply.equals(mappingsOfferDTO.quantumOfSupply)) &&
        (this.deliveryDurationDays == null ? mappingsOfferDTO.deliveryDurationDays == null : this.deliveryDurationDays.equals(mappingsOfferDTO.deliveryDurationDays)) &&
        (this.boxCount == null ? mappingsOfferDTO.boxCount == null : this.boxCount.equals(mappingsOfferDTO.boxCount)) &&
        (this.customsCommodityCodes == null ? mappingsOfferDTO.customsCommodityCodes == null : this.customsCommodityCodes.equals(mappingsOfferDTO.customsCommodityCodes)) &&
        (this.weightDimensions == null ? mappingsOfferDTO.weightDimensions == null : this.weightDimensions.equals(mappingsOfferDTO.weightDimensions)) &&
        (this.supplyScheduleDays == null ? mappingsOfferDTO.supplyScheduleDays == null : this.supplyScheduleDays.equals(mappingsOfferDTO.supplyScheduleDays)) &&
        (this.shelfLifeDays == null ? mappingsOfferDTO.shelfLifeDays == null : this.shelfLifeDays.equals(mappingsOfferDTO.shelfLifeDays)) &&
        (this.lifeTimeDays == null ? mappingsOfferDTO.lifeTimeDays == null : this.lifeTimeDays.equals(mappingsOfferDTO.lifeTimeDays)) &&
        (this.guaranteePeriodDays == null ? mappingsOfferDTO.guaranteePeriodDays == null : this.guaranteePeriodDays.equals(mappingsOfferDTO.guaranteePeriodDays)) &&
        (this.processingState == null ? mappingsOfferDTO.processingState == null : this.processingState.equals(mappingsOfferDTO.processingState)) &&
        (this.availability == null ? mappingsOfferDTO.availability == null : this.availability.equals(mappingsOfferDTO.availability)) &&
        (this.shelfLife == null ? mappingsOfferDTO.shelfLife == null : this.shelfLife.equals(mappingsOfferDTO.shelfLife)) &&
        (this.lifeTime == null ? mappingsOfferDTO.lifeTime == null : this.lifeTime.equals(mappingsOfferDTO.lifeTime)) &&
        (this.guaranteePeriod == null ? mappingsOfferDTO.guaranteePeriod == null : this.guaranteePeriod.equals(mappingsOfferDTO.guaranteePeriod)) &&
        (this.certificate == null ? mappingsOfferDTO.certificate == null : this.certificate.equals(mappingsOfferDTO.certificate)) &&
        (this.price == null ? mappingsOfferDTO.price == null : this.price.equals(mappingsOfferDTO.price));
  }
