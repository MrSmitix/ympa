...
public class OrdersStatsPaymentDTO {
   ...
   * @throws IOException if the JSON Element is invalid with respect to OrdersStatsPaymentDTO
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OrdersStatsPaymentDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrdersStatsPaymentDTO is not found in the empty JSON string", OrdersStatsPaymentDTO.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OrdersStatsPaymentDTO.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OrdersStatsPaymentDTO` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("type") != null && !jsonObj.get("type").isJsonNull()) {
        OrdersStatsPaymentType.validateJsonElement(jsonObj.get("type"));
      }
      // validate the optional field `source`
      if (jsonObj.get("source") != null && !jsonObj.get("source").isJsonNull()) {
        OrdersStatsPaymentSourceType.validateJsonElement(jsonObj.get("source"));
      }
      // validate the optional field `paymentOrder`
      if (jsonObj.get("paymentOrder") != null && !jsonObj.get("paymentOrder").isJsonNull()) {
        OrdersStatsPaymentOrderDTO.validateJsonElement(jsonObj.get("paymentOrder"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrdersStatsPaymentDTO.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrdersStatsPaymentDTO' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrdersStatsPaymentDTO> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrdersStatsPaymentDTO.class));

       return (TypeAdapter<T>) new TypeAdapter<OrdersStatsPaymentDTO>() {
           @Override
           public void write(JsonWriter out, OrdersStatsPaymentDTO value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OrdersStatsPaymentDTO read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OrdersStatsPaymentDTO given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OrdersStatsPaymentDTO
   * @throws IOException if the JSON string is invalid with respect to OrdersStatsPaymentDTO
   */
  public static OrdersStatsPaymentDTO fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrdersStatsPaymentDTO.class);
  }

  /**
   * Convert an instance of OrdersStatsPaymentDTO to an JSON string
   *
   * @return JSON string
   */
