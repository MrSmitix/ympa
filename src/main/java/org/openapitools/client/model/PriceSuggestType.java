 ...
 */
@JsonAdapter(PriceSuggestType.Adapter.class)
public enum PriceSuggestType {
  ...
  public static class Adapter extends TypeAdapter<PriceSuggestType> {
    @Override
    public void write(final JsonWriter jsonWriter, final PriceSuggestType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public PriceSuggestType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return PriceSuggestType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    PriceSuggestType.fromValue(value);
  }
}
