 ...
 */
@JsonAdapter(OrderDeliveryPartnerType.Adapter.class)
public enum OrderDeliveryPartnerType {
  ...
  public static class Adapter extends TypeAdapter<OrderDeliveryPartnerType> {
    @Override
    public void write(final JsonWriter jsonWriter, final OrderDeliveryPartnerType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public OrderDeliveryPartnerType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return OrderDeliveryPartnerType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    OrderDeliveryPartnerType.fromValue(value);
  }
}
