 ...
 */
@JsonAdapter(OfferCardRecommendationType.Adapter.class)
public enum OfferCardRecommendationType {
  ...
  public static class Adapter extends TypeAdapter<OfferCardRecommendationType> {
    @Override
    public void write(final JsonWriter jsonWriter, final OfferCardRecommendationType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public OfferCardRecommendationType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return OfferCardRecommendationType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    OfferCardRecommendationType.fromValue(value);
  }
}
