...
public class ShipmentInfoDTO {
  ...
  public boolean equals(Object o) {
    ...
    return (this.id == null ? shipmentInfoDTO.id == null : this.id.equals(shipmentInfoDTO.id)) &&
        (this.planIntervalFrom == null ? shipmentInfoDTO.planIntervalFrom == null : this.planIntervalFrom.equals(shipmentInfoDTO.planIntervalFrom)) &&
        (this.planIntervalTo == null ? shipmentInfoDTO.planIntervalTo == null : this.planIntervalTo.equals(shipmentInfoDTO.planIntervalTo)) &&
        (this.shipmentType == null ? shipmentInfoDTO.shipmentType == null : this.shipmentType.equals(shipmentInfoDTO.shipmentType)) &&
        (this.warehouse == null ? shipmentInfoDTO.warehouse == null : this.warehouse.equals(shipmentInfoDTO.warehouse)) &&
        (this.warehouseTo == null ? shipmentInfoDTO.warehouseTo == null : this.warehouseTo.equals(shipmentInfoDTO.warehouseTo)) &&
        (this.externalId == null ? shipmentInfoDTO.externalId == null : this.externalId.equals(shipmentInfoDTO.externalId)) &&
        (this.deliveryService == null ? shipmentInfoDTO.deliveryService == null : this.deliveryService.equals(shipmentInfoDTO.deliveryService)) &&
        (this.palletsCount == null ? shipmentInfoDTO.palletsCount == null : this.palletsCount.equals(shipmentInfoDTO.palletsCount)) &&
        (this.orderIds == null ? shipmentInfoDTO.orderIds == null : this.orderIds.equals(shipmentInfoDTO.orderIds)) &&
        (this.draftCount == null ? shipmentInfoDTO.draftCount == null : this.draftCount.equals(shipmentInfoDTO.draftCount)) &&
        (this.plannedCount == null ? shipmentInfoDTO.plannedCount == null : this.plannedCount.equals(shipmentInfoDTO.plannedCount)) &&
        (this.factCount == null ? shipmentInfoDTO.factCount == null : this.factCount.equals(shipmentInfoDTO.factCount)) &&
        (this.status == null ? shipmentInfoDTO.status == null : this.status.equals(shipmentInfoDTO.status)) &&
        (this.statusDescription == null ? shipmentInfoDTO.statusDescription == null : this.statusDescription.equals(shipmentInfoDTO.statusDescription)) &&
        (this.statusUpdateTime == null ? shipmentInfoDTO.statusUpdateTime == null : this.statusUpdateTime.equals(shipmentInfoDTO.statusUpdateTime));
  }
  ...
  public int hashCode() {
    ...
    result = 31 * result + (this.statusUpdateTime == null ? 0: this.statusUpdateTime.hashCode());
    return result;
  }
