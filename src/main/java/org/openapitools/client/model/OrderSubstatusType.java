 ...
 */
@JsonAdapter(OrderSubstatusType.Adapter.class)
public enum OrderSubstatusType {
  ...
  public static class Adapter extends TypeAdapter<OrderSubstatusType> {
    @Override
    public void write(final JsonWriter jsonWriter, final OrderSubstatusType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public OrderSubstatusType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return OrderSubstatusType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    OrderSubstatusType.fromValue(value);
  }
}
