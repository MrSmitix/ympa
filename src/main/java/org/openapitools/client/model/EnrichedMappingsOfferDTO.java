...
public class EnrichedMappingsOfferDTO {
  ...
  public boolean equals(Object o) {
    ...
    return (this.name == null ? enrichedMappingsOfferDTO.name == null : this.name.equals(enrichedMappingsOfferDTO.name)) &&
        (this.shopSku == null ? enrichedMappingsOfferDTO.shopSku == null : this.shopSku.equals(enrichedMappingsOfferDTO.shopSku)) &&
        (this.category == null ? enrichedMappingsOfferDTO.category == null : this.category.equals(enrichedMappingsOfferDTO.category)) &&
        (this.vendor == null ? enrichedMappingsOfferDTO.vendor == null : this.vendor.equals(enrichedMappingsOfferDTO.vendor)) &&
        (this.vendorCode == null ? enrichedMappingsOfferDTO.vendorCode == null : this.vendorCode.equals(enrichedMappingsOfferDTO.vendorCode)) &&
        (this.description == null ? enrichedMappingsOfferDTO.description == null : this.description.equals(enrichedMappingsOfferDTO.description)) &&
        (this.id == null ? enrichedMappingsOfferDTO.id == null : this.id.equals(enrichedMappingsOfferDTO.id)) &&
        (this.feedId == null ? enrichedMappingsOfferDTO.feedId == null : this.feedId.equals(enrichedMappingsOfferDTO.feedId)) &&
        (this.barcodes == null ? enrichedMappingsOfferDTO.barcodes == null : this.barcodes.equals(enrichedMappingsOfferDTO.barcodes)) &&
        (this.urls == null ? enrichedMappingsOfferDTO.urls == null : this.urls.equals(enrichedMappingsOfferDTO.urls)) &&
        (this.pictures == null ? enrichedMappingsOfferDTO.pictures == null : this.pictures.equals(enrichedMappingsOfferDTO.pictures)) &&
        (this.manufacturer == null ? enrichedMappingsOfferDTO.manufacturer == null : this.manufacturer.equals(enrichedMappingsOfferDTO.manufacturer)) &&
        (this.manufacturerCountries == null ? enrichedMappingsOfferDTO.manufacturerCountries == null : this.manufacturerCountries.equals(enrichedMappingsOfferDTO.manufacturerCountries)) &&
        (this.minShipment == null ? enrichedMappingsOfferDTO.minShipment == null : this.minShipment.equals(enrichedMappingsOfferDTO.minShipment)) &&
        (this.transportUnitSize == null ? enrichedMappingsOfferDTO.transportUnitSize == null : this.transportUnitSize.equals(enrichedMappingsOfferDTO.transportUnitSize)) &&
        (this.quantumOfSupply == null ? enrichedMappingsOfferDTO.quantumOfSupply == null : this.quantumOfSupply.equals(enrichedMappingsOfferDTO.quantumOfSupply)) &&
        (this.deliveryDurationDays == null ? enrichedMappingsOfferDTO.deliveryDurationDays == null : this.deliveryDurationDays.equals(enrichedMappingsOfferDTO.deliveryDurationDays)) &&
        (this.boxCount == null ? enrichedMappingsOfferDTO.boxCount == null : this.boxCount.equals(enrichedMappingsOfferDTO.boxCount)) &&
        (this.customsCommodityCodes == null ? enrichedMappingsOfferDTO.customsCommodityCodes == null : this.customsCommodityCodes.equals(enrichedMappingsOfferDTO.customsCommodityCodes)) &&
        (this.weightDimensions == null ? enrichedMappingsOfferDTO.weightDimensions == null : this.weightDimensions.equals(enrichedMappingsOfferDTO.weightDimensions)) &&
        (this.supplyScheduleDays == null ? enrichedMappingsOfferDTO.supplyScheduleDays == null : this.supplyScheduleDays.equals(enrichedMappingsOfferDTO.supplyScheduleDays)) &&
        (this.shelfLifeDays == null ? enrichedMappingsOfferDTO.shelfLifeDays == null : this.shelfLifeDays.equals(enrichedMappingsOfferDTO.shelfLifeDays)) &&
        (this.lifeTimeDays == null ? enrichedMappingsOfferDTO.lifeTimeDays == null : this.lifeTimeDays.equals(enrichedMappingsOfferDTO.lifeTimeDays)) &&
        (this.guaranteePeriodDays == null ? enrichedMappingsOfferDTO.guaranteePeriodDays == null : this.guaranteePeriodDays.equals(enrichedMappingsOfferDTO.guaranteePeriodDays)) &&
        (this.processingState == null ? enrichedMappingsOfferDTO.processingState == null : this.processingState.equals(enrichedMappingsOfferDTO.processingState)) &&
        (this.availability == null ? enrichedMappingsOfferDTO.availability == null : this.availability.equals(enrichedMappingsOfferDTO.availability)) &&
        (this.shelfLife == null ? enrichedMappingsOfferDTO.shelfLife == null : this.shelfLife.equals(enrichedMappingsOfferDTO.shelfLife)) &&
        (this.lifeTime == null ? enrichedMappingsOfferDTO.lifeTime == null : this.lifeTime.equals(enrichedMappingsOfferDTO.lifeTime)) &&
        (this.guaranteePeriod == null ? enrichedMappingsOfferDTO.guaranteePeriod == null : this.guaranteePeriod.equals(enrichedMappingsOfferDTO.guaranteePeriod)) &&
        (this.certificate == null ? enrichedMappingsOfferDTO.certificate == null : this.certificate.equals(enrichedMappingsOfferDTO.certificate)) &&
        (this.price == null ? enrichedMappingsOfferDTO.price == null : this.price.equals(enrichedMappingsOfferDTO.price)) &&
        (this.marketCategoryId == null ? enrichedMappingsOfferDTO.marketCategoryId == null : this.marketCategoryId.equals(enrichedMappingsOfferDTO.marketCategoryId)) &&
        (this.marketCategoryName == null ? enrichedMappingsOfferDTO.marketCategoryName == null : this.marketCategoryName.equals(enrichedMappingsOfferDTO.marketCategoryName)) &&
        (this.marketModelId == null ? enrichedMappingsOfferDTO.marketModelId == null : this.marketModelId.equals(enrichedMappingsOfferDTO.marketModelId)) &&
        (this.marketModelName == null ? enrichedMappingsOfferDTO.marketModelName == null : this.marketModelName.equals(enrichedMappingsOfferDTO.marketModelName)) &&
        (this.marketSku == null ? enrichedMappingsOfferDTO.marketSku == null : this.marketSku.equals(enrichedMappingsOfferDTO.marketSku)) &&
        (this.marketSkuName == null ? enrichedMappingsOfferDTO.marketSkuName == null : this.marketSkuName.equals(enrichedMappingsOfferDTO.marketSkuName));
  }
