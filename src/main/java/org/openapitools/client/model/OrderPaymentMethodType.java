 ...
 */
@JsonAdapter(OrderPaymentMethodType.Adapter.class)
public enum OrderPaymentMethodType {
  ...
  public static class Adapter extends TypeAdapter<OrderPaymentMethodType> {
    @Override
    public void write(final JsonWriter jsonWriter, final OrderPaymentMethodType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public OrderPaymentMethodType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return OrderPaymentMethodType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    OrderPaymentMethodType.fromValue(value);
  }
}
