...
public interface WarehousesApi {
     ...
     *
     * @return Список складов. (status code 200)
    ...
    default ResponseEntity<GetFulfillmentWarehousesResponse> getFulfillmentWarehouses(
        
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"result\" : { \"warehouses\" : [ { \"address\" : { \"number\" : \"number\", \"city\" : \"city\", \"street\" : \"street\", \"block\" : \"block\", \"gps\" : { \"latitude\" : 9.965781217890562, \"longitude\" : 9.369310271410669 }, \"building\" : \"building\" }, \"name\" : \"name\", \"id\" : 0 }, { \"address\" : { \"number\" : \"number\", \"city\" : \"city\", \"street\" : \"street\", \"block\" : \"block\", \"gps\" : { \"latitude\" : 9.965781217890562, \"longitude\" : 9.369310271410669 }, \"building\" : \"building\" }, \"name\" : \"name\", \"id\" : 0 } ] }, \"status\" : \"OK\" }";
