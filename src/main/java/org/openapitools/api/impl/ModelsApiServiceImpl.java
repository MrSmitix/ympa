...
public class ModelsApiServiceImpl extends ModelsApiService {
    @Override
    public Response getModel(Long modelId
, Long regionId
, CurrencyType currency
    ...
    @Override
    public Response getModelOffers(Long modelId
, Long regionId
, CurrencyType currency
...
, Integer page
    ...
    @Override
    public Response getModels(Long regionId
...
, CurrencyType currency
    ...
    @Override
    public Response getModelsOffers(Long regionId
, GetModelsRequest getModelsRequest
, CurrencyType currency
, SortOrderType orderByPrice
 ) throws NotFoundException {
    ...
    @Override
    public Response searchModels(String query
, Long regionId
, CurrencyType currency
, Integer page
, Integer pageSize
