...
public class BusinessesApiServiceImpl extends BusinessesApiService {
    @Override
    public Response addOffersToArchive(Long businessId
, AddOffersToArchiveRequest addOffersToArchiveRequest
    ...
    @Override
    public Response confirmBusinessPrices(Long businessId
, ConfirmPricesRequest confirmPricesRequest
    ...
    @Override
    public Response createChat(Long businessId
, CreateChatRequest createChatRequest
    ...
    @Override
    public Response deleteGoodsFeedbackComment(Long businessId
, DeleteGoodsFeedbackCommentRequest deleteGoodsFeedbackCommentRequest
    ...
    @Override
    public Response deleteOffers(Long businessId
, DeleteOffersRequest deleteOffersRequest
    ...
    @Override
    public Response deleteOffersFromArchive(Long businessId
, DeleteOffersFromArchiveRequest deleteOffersFromArchiveRequest
    ...
    @Override
    public Response deletePromoOffers(Long businessId
, DeletePromoOffersRequest deletePromoOffersRequest
    ...
    @Override
    public Response getBidsInfoForBusiness(Long businessId
, String pageToken
, Integer limit
, GetBidsInfoRequest getBidsInfoRequest
    ...
    @Override
    public Response getBidsRecommendations(Long businessId
, GetBidsRecommendationsRequest getBidsRecommendationsRequest
    ...
    @Override
    public Response getBusinessQuarantineOffers(Long businessId
...
, Integer limit
    ...
    @Override
    public Response getBusinessSettings(Long businessId
 ) throws NotFoundException {
        // do some magic!
        return Response.ok().entity(new ApiResponseMessage(ApiResponseMessage.OK, "magic!")).build();
    }
    @Override
    public Response getChatHistory(Long businessId
, Long chatId
...
, Integer limit
    ...
    @Override
    public Response getChats(Long businessId
...
, Integer limit
    ...
    @Override
    public Response getGoodsFeedbackComments(Long businessId
...
, Integer limit
    ...
    @Override
    public Response getGoodsFeedbacks(Long businessId
, String pageToken
, Integer limit
, GetGoodsFeedbackRequest getGoodsFeedbackRequest
    ...
    @Override
    public Response getOfferCardsContentStatus(Long businessId
, String pageToken
, Integer limit
, GetOfferCardsContentStatusRequest getOfferCardsContentStatusRequest
    ...
    @Override
    public Response getOfferMappings(Long businessId
, String pageToken
, Integer limit
, GetOfferMappingsRequest getOfferMappingsRequest
    ...
    @Override
    public Response getOfferRecommendations(Long businessId
...
, Integer limit
    ...
    @Override
    public Response getPromoOffers(Long businessId
...
, Integer limit
    ...
    @Override
    public Response getPromos(Long businessId
, GetPromosRequest getPromosRequest
    ...
    @Override
    public Response getQualityRatings(Long businessId
, GetQualityRatingRequest getQualityRatingRequest
    ...
    @Override
    public Response getSuggestedOfferMappings(Long businessId
, GetSuggestedOfferMappingsRequest getSuggestedOfferMappingsRequest
    ...
    @Override
    public Response getWarehouses(Long businessId
 ) throws NotFoundException {
        // do some magic!
        return Response.ok().entity(new ApiResponseMessage(ApiResponseMessage.OK, "magic!")).build();
    }
    @Override
    public Response putBidsForBusiness(Long businessId
, PutSkuBidsRequest putSkuBidsRequest
    ...
    @Override
    public Response sendFileToChat(Long businessId
, Long chatId
, InputStream _fileInputStream, FileInfo _fileDetail
    ...
    @Override
    public Response sendMessageToChat(Long businessId
, Long chatId
, SendMessageToChatRequest sendMessageToChatRequest
    ...
    @Override
    public Response skipGoodsFeedbacksReaction(Long businessId
, SkipGoodsFeedbackReactionRequest skipGoodsFeedbackReactionRequest
    ...
    @Override
    public Response updateBusinessPrices(Long businessId
, UpdateBusinessPricesRequest updateBusinessPricesRequest
    ...
    @Override
    public Response updateGoodsFeedbackComment(Long businessId
, UpdateGoodsFeedbackCommentRequest updateGoodsFeedbackCommentRequest
    ...
    @Override
    public Response updateOfferContent(Long businessId
, UpdateOfferContentRequest updateOfferContentRequest
    ...
    @Override
    public Response updateOfferMappings(Long businessId
, UpdateOfferMappingsRequest updateOfferMappingsRequest
    ...
    @Override
    public Response updatePromoOffers(Long businessId
