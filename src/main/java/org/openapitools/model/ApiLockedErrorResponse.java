...
@Schema(name = "ApiLockedErrorResponse", description = "Ресурс из запроса заблокирован от применения к нему указанного метода.")
...
public class ApiLockedErrorResponse {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.status, apiLockedErrorResponse.status) &&
        equalsNullable(this.errors, apiLockedErrorResponse.errors);
  }
