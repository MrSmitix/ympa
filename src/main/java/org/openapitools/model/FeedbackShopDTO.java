...
@Schema(name = "FeedbackShopDTO", description = "Информация о магазине.")
...
public class FeedbackShopDTO {
  ...
  @Schema(name = "name", description = "Название магазина.", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("name")
