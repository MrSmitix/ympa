...
@Schema(name = "OrdersStatsPriceDTO", description = "Цена или скидки на товар.")
...
public class OrdersStatsPriceDTO {
   ...
   */
  @Valid 
  @Schema(name = "costPerItem", description = "Цена или скидка на единицу товара в заказе. Указана в рублях. Точность — два знака после запятой. ", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
   ...
   */
  @Valid 
  @Schema(name = "total", description = "Суммарная цена или скидка на все единицы товара в заказе. Указана в рублях. Точность — два знака после запятой. ", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("total")
