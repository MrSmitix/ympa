...
public class DeletePromoOffersResultDTO {
  ...
  @Valid
  private JsonNullable<List<@Valid RejectedPromoOfferDeleteDTO>> rejectedOffers = JsonNullable.<List<@Valid RejectedPromoOfferDeleteDTO>>undefined();
  ...
  public JsonNullable<List<@Valid RejectedPromoOfferDeleteDTO>> getRejectedOffers() {
    return rejectedOffers;
  }

  public void setRejectedOffers(JsonNullable<List<@Valid RejectedPromoOfferDeleteDTO>> rejectedOffers) {
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.rejectedOffers, deletePromoOffersResultDTO.rejectedOffers);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(rejectedOffers));
  }
