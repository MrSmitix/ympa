...
@JsonPropertyOrder({
  UpdateOfferDTO.JSON_PROPERTY_OFFER_ID,
  UpdateOfferDTO.JSON_PROPERTY_NAME,
  UpdateOfferDTO.JSON_PROPERTY_MARKET_CATEGORY_ID,
  UpdateOfferDTO.JSON_PROPERTY_CATEGORY,
  UpdateOfferDTO.JSON_PROPERTY_PICTURES,
  UpdateOfferDTO.JSON_PROPERTY_VIDEOS,
  UpdateOfferDTO.JSON_PROPERTY_MANUALS,
  UpdateOfferDTO.JSON_PROPERTY_VENDOR,
  UpdateOfferDTO.JSON_PROPERTY_BARCODES,
  UpdateOfferDTO.JSON_PROPERTY_DESCRIPTION,
  UpdateOfferDTO.JSON_PROPERTY_MANUFACTURER_COUNTRIES,
  UpdateOfferDTO.JSON_PROPERTY_WEIGHT_DIMENSIONS,
  UpdateOfferDTO.JSON_PROPERTY_VENDOR_CODE,
  UpdateOfferDTO.JSON_PROPERTY_TAGS,
  UpdateOfferDTO.JSON_PROPERTY_SHELF_LIFE,
  UpdateOfferDTO.JSON_PROPERTY_LIFE_TIME,
  UpdateOfferDTO.JSON_PROPERTY_GUARANTEE_PERIOD,
  UpdateOfferDTO.JSON_PROPERTY_CUSTOMS_COMMODITY_CODE,
  UpdateOfferDTO.JSON_PROPERTY_CERTIFICATES,
  UpdateOfferDTO.JSON_PROPERTY_BOX_COUNT,
  UpdateOfferDTO.JSON_PROPERTY_CONDITION,
  UpdateOfferDTO.JSON_PROPERTY_TYPE,
  UpdateOfferDTO.JSON_PROPERTY_DOWNLOADABLE,
  UpdateOfferDTO.JSON_PROPERTY_ADULT,
  UpdateOfferDTO.JSON_PROPERTY_AGE,
  UpdateOfferDTO.JSON_PROPERTY_PARAMS,
  UpdateOfferDTO.JSON_PROPERTY_PARAMETER_VALUES,
  UpdateOfferDTO.JSON_PROPERTY_BASIC_PRICE,
  UpdateOfferDTO.JSON_PROPERTY_PURCHASE_PRICE,
  UpdateOfferDTO.JSON_PROPERTY_ADDITIONAL_EXPENSES,
  UpdateOfferDTO.JSON_PROPERTY_COFINANCE_PRICE
})
