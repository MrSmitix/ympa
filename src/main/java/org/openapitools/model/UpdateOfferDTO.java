...
@Schema(name = "UpdateOfferDTO", description = "Параметры товара.")
...
public class UpdateOfferDTO {
   ...
   */
  public UpdateOfferDTO(String offerId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.offerId, updateOfferDTO.offerId) &&
        ...
        equalsNullable(this.pictures, updateOfferDTO.pictures) &&
        equalsNullable(this.videos, updateOfferDTO.videos) &&
        equalsNullable(this.manuals, updateOfferDTO.manuals) &&
        Objects.equals(this.vendor, updateOfferDTO.vendor) &&
        equalsNullable(this.barcodes, updateOfferDTO.barcodes) &&
        Objects.equals(this.description, updateOfferDTO.description) &&
        equalsNullable(this.manufacturerCountries, updateOfferDTO.manufacturerCountries) &&
        ...
        equalsNullable(this.tags, updateOfferDTO.tags) &&
        ...
        equalsNullable(this.certificates, updateOfferDTO.certificates) &&
        ...
        equalsNullable(this.params, updateOfferDTO.params) &&
        equalsNullable(this.parameterValues, updateOfferDTO.parameterValues) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(offerId, name, marketCategoryId, category, hashCodeNullable(pictures), hashCodeNullable(videos), hashCodeNullable(manuals), vendor, hashCodeNullable(barcodes), description, hashCodeNullable(manufacturerCountries), weightDimensions, vendorCode, hashCodeNullable(tags), shelfLife, lifeTime, guaranteePeriod, customsCommodityCode, hashCodeNullable(certificates), boxCount, condition, type, downloadable, adult, age, hashCodeNullable(params), hashCodeNullable(parameterValues), basicPrice, purchasePrice, additionalExpenses, cofinancePrice);
  }
