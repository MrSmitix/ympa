...
@Schema(name = "ApiForbiddenErrorResponse", description = "Неверны авторизационные данные, указанные в запросе, или запрещен доступ к запрашиваемому ресурсу.")
...
public class ApiForbiddenErrorResponse {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.status, apiForbiddenErrorResponse.status) &&
        equalsNullable(this.errors, apiForbiddenErrorResponse.errors);
  }
