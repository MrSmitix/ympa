...
@Schema(name = "MappingsOfferInfoDTO", description = "Базовая информация о товарах в каталоге.")
...
public class MappingsOfferInfoDTO {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, mappingsOfferInfoDTO.name) &&
        ...
        equalsNullable(this.barcodes, mappingsOfferInfoDTO.barcodes) &&
        equalsNullable(this.urls, mappingsOfferInfoDTO.urls) &&
        equalsNullable(this.pictures, mappingsOfferInfoDTO.pictures) &&
        Objects.equals(this.manufacturer, mappingsOfferInfoDTO.manufacturer) &&
        equalsNullable(this.manufacturerCountries, mappingsOfferInfoDTO.manufacturerCountries) &&
        ...
        equalsNullable(this.customsCommodityCodes, mappingsOfferInfoDTO.customsCommodityCodes) &&
        Objects.equals(this.weightDimensions, mappingsOfferInfoDTO.weightDimensions) &&
        equalsNullable(this.supplyScheduleDays, mappingsOfferInfoDTO.supplyScheduleDays) &&
