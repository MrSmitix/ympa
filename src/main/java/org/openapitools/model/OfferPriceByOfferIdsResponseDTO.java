 ...
 */
@JsonPropertyOrder({
  OfferPriceByOfferIdsResponseDTO.JSON_PROPERTY_OFFER_ID,
  OfferPriceByOfferIdsResponseDTO.JSON_PROPERTY_PRICE,
  OfferPriceByOfferIdsResponseDTO.JSON_PROPERTY_UPDATED_AT
})
