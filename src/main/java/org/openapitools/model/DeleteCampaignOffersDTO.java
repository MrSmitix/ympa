...
@Schema(name = "DeleteCampaignOffersDTO", description = "Список товаров, которые не удалось удалить, потому что они не найдены или хранятся на складе Маркета.")
...
public class DeleteCampaignOffersDTO {
  ...
  @Schema(name = "notDeletedOfferIds", description = "Список SKU.", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.notDeletedOfferIds, deleteCampaignOffersDTO.notDeletedOfferIds);
  }
