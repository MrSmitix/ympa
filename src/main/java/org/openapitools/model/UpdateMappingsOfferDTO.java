...
@Schema(name = "UpdateMappingsOfferDTO", description = "Информация о товарах в каталоге.")
...
public class UpdateMappingsOfferDTO {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, updateMappingsOfferDTO.name) &&
        ...
        equalsNullable(this.barcodes, updateMappingsOfferDTO.barcodes) &&
        equalsNullable(this.urls, updateMappingsOfferDTO.urls) &&
        equalsNullable(this.pictures, updateMappingsOfferDTO.pictures) &&
        Objects.equals(this.manufacturer, updateMappingsOfferDTO.manufacturer) &&
        equalsNullable(this.manufacturerCountries, updateMappingsOfferDTO.manufacturerCountries) &&
        ...
        equalsNullable(this.customsCommodityCodes, updateMappingsOfferDTO.customsCommodityCodes) &&
        Objects.equals(this.weightDimensions, updateMappingsOfferDTO.weightDimensions) &&
        equalsNullable(this.supplyScheduleDays, updateMappingsOfferDTO.supplyScheduleDays) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, shopSku, category, vendor, vendorCode, description, id, feedId, hashCodeNullable(barcodes), hashCodeNullable(urls), hashCodeNullable(pictures), manufacturer, hashCodeNullable(manufacturerCountries), minShipment, transportUnitSize, quantumOfSupply, deliveryDurationDays, boxCount, hashCodeNullable(customsCommodityCodes), weightDimensions, hashCodeNullable(supplyScheduleDays), shelfLifeDays, lifeTimeDays, guaranteePeriodDays, processingState, availability, shelfLife, lifeTime, guaranteePeriod, certificate);
  }
