...
@Schema(name = "DeliveryServiceDTO", description = "Служба доставки.")
...
public class DeliveryServiceDTO {
  ...
  @Schema(name = "id", description = "Идентификатор службы доставки.", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("id")
  public Long getId() {
    return id;
  }
  ...
  @Schema(name = "name", description = "Наименование службы доставки.", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("name")
