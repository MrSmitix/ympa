...
public class FbsApiHandler {

    private static final Logger logger = LoggerFactory.getLogger(FbsApiHandler.class);

    private final FbsApi api;

    public FbsApiHandler(FbsApi api) {
        this.api = api;
    }

    @Deprecated
    public FbsApiHandler() {
        this(new FbsApiImpl());
    }
