...
public class DbsApiImpl implements DbsApi {
    ...
    public Future<ApiResponse<GetDeliveryServicesResponse>> getDeliveryServices() {
        return Future.failedFuture(new HttpException(501));
    }
    ...
    public Future<ApiResponse<FileUpload>> getReturnApplication(Long campaignId, Long orderId, Long returnId) {
        return Future.failedFuture(new HttpException(501));
    }
    ...
    public Future<ApiResponse<EmptyApiResponse>> setReturnDecision(Long campaignId, Long orderId, Long returnId, SetReturnDecisionRequest setReturnDecisionRequest) {
        return Future.failedFuture(new HttpException(501));
    }
    ...
    public Future<ApiResponse<EmptyApiResponse>> submitReturnDecision(Long campaignId, Long orderId, Long returnId) {
        return Future.failedFuture(new HttpException(501));
    }
