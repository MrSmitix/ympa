...
public class DbsApiHandler {

    private static final Logger logger = LoggerFactory.getLogger(DbsApiHandler.class);

    private final DbsApi api;

    public DbsApiHandler(DbsApi api) {
        this.api = api;
    }

    @Deprecated
    public DbsApiHandler() {
        this(new DbsApiImpl());
    }
