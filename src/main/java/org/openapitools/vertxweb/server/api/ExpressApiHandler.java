...
public class ExpressApiHandler {

    private static final Logger logger = LoggerFactory.getLogger(ExpressApiHandler.class);

    private final ExpressApi api;

    public ExpressApiHandler(ExpressApi api) {
        this.api = api;
    }

    @Deprecated
    public ExpressApiHandler() {
        this(new ExpressApiImpl());
    }
