...
import org.openapitools.vertxweb.server.model.OfferPriceByOfferIdsListResponseDTO;
...
public class GetPricesByOfferIdsResponse   {
  ...
  public GetPricesByOfferIdsResponse () {

  }

  public GetPricesByOfferIdsResponse (ApiResponseStatusType status, OfferPriceByOfferIdsListResponseDTO result) {
    this.status = status;
    this.result = result;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(status, getPricesByOfferIdsResponse.status) &&
        Objects.equals(result, getPricesByOfferIdsResponse.result);
  }
