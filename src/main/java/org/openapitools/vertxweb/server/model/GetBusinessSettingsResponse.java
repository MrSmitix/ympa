...
import org.openapitools.vertxweb.server.model.GetBusinessSettingsInfoDTO;
...
public class GetBusinessSettingsResponse   {
  ...
  public GetBusinessSettingsResponse () {

  }

  public GetBusinessSettingsResponse (ApiResponseStatusType status, GetBusinessSettingsInfoDTO result) {
    this.status = status;
    this.result = result;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(status, getBusinessSettingsResponse.status) &&
        Objects.equals(result, getBusinessSettingsResponse.result);
  }
