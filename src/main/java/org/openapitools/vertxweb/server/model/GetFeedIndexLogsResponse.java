...
import org.openapitools.vertxweb.server.model.FeedIndexLogsResultDTO;
...
public class GetFeedIndexLogsResponse   {
  ...
  public GetFeedIndexLogsResponse (ApiResponseStatusType status, FeedIndexLogsResultDTO result) {
    this.status = status;
    this.result = result;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(status, getFeedIndexLogsResponse.status) &&
        Objects.equals(result, getFeedIndexLogsResponse.result);
  }
