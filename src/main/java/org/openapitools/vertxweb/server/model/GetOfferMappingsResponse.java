...
import org.openapitools.vertxweb.server.model.GetOfferMappingsResultDTO;
...
public class GetOfferMappingsResponse   {
  ...
  public GetOfferMappingsResponse (ApiResponseStatusType status, GetOfferMappingsResultDTO result) {
    this.status = status;
    this.result = result;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(status, getOfferMappingsResponse.status) &&
        Objects.equals(result, getOfferMappingsResponse.result);
  }
