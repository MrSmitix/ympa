...
import org.openapitools.vertxweb.server.model.UpdatePromoOffersResultDTO;
...
public class UpdatePromoOffersResponse   {
  ...
  public UpdatePromoOffersResponse (ApiResponseStatusType status, UpdatePromoOffersResultDTO result) {
    this.status = status;
    this.result = result;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(status, updatePromoOffersResponse.status) &&
        Objects.equals(result, updatePromoOffersResponse.result);
  }
