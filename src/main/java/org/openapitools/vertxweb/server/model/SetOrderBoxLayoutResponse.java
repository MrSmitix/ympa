...
import org.openapitools.vertxweb.server.model.OrderBoxesLayoutDTO;
...
public class SetOrderBoxLayoutResponse   {
  ...
  public SetOrderBoxLayoutResponse () {

  }

  public SetOrderBoxLayoutResponse (ApiResponseStatusType status, OrderBoxesLayoutDTO result) {
    this.status = status;
    this.result = result;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(status, setOrderBoxLayoutResponse.status) &&
        Objects.equals(result, setOrderBoxLayoutResponse.result);
  }
