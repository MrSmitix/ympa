...
import org.openapitools.vertxweb.server.model.SearchShipmentsResponseDTO;
...
public class SearchShipmentsResponse   {
  ...
  public SearchShipmentsResponse () {

  }

  public SearchShipmentsResponse (ApiResponseStatusType status, SearchShipmentsResponseDTO result) {
    this.status = status;
    this.result = result;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(status, searchShipmentsResponse.status) &&
        Objects.equals(result, searchShipmentsResponse.result);
  }
