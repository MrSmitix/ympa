...
import org.openapitools.vertxweb.server.model.OfferCardsContentStatusDTO;
...
public class GetOfferCardsContentStatusResponse   {
  ...
  public GetOfferCardsContentStatusResponse (ApiResponseStatusType status, OfferCardsContentStatusDTO result) {
    this.status = status;
    this.result = result;
  }
