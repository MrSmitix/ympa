...
public class ApiClientDataErrorResponse   {
  ...
  public ApiClientDataErrorResponse (ApiResponseStatusType status, List<ApiErrorDTO> errors) {
    this.status = status;
    this.errors = errors;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(status, apiClientDataErrorResponse.status) &&
        Objects.equals(errors, apiClientDataErrorResponse.errors);
  }
