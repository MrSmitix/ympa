...
import org.openapitools.vertxweb.server.model.GetWarehouseStocksDTO;
...
public class GetWarehouseStocksResponse   {
  ...
  public GetWarehouseStocksResponse (ApiResponseStatusType status, GetWarehouseStocksDTO result) {
    this.status = status;
    this.result = result;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(status, getWarehouseStocksResponse.status) &&
        Objects.equals(result, getWarehouseStocksResponse.result);
  }
