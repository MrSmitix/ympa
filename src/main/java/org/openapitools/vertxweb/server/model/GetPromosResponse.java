...
import org.openapitools.vertxweb.server.model.GetPromosResultDTO;
...
public class GetPromosResponse   {
  ...
  public GetPromosResponse (ApiResponseStatusType status, GetPromosResultDTO result) {
    this.status = status;
    this.result = result;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(status, getPromosResponse.status) &&
        Objects.equals(result, getPromosResponse.result);
  }
