...
import org.openapitools.vertxweb.server.model.WarehousesDTO;
...
public class GetWarehousesResponse   {
  ...
  public GetWarehousesResponse (ApiResponseStatusType status, WarehousesDTO result) {
    this.status = status;
    this.result = result;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(status, getWarehousesResponse.status) &&
        Objects.equals(result, getWarehousesResponse.result);
  }
