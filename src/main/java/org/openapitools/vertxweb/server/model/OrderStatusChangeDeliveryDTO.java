...
import org.openapitools.vertxweb.server.model.OrderStatusChangeDeliveryDatesDTO;
...
public class OrderStatusChangeDeliveryDTO   {
  ...
  public OrderStatusChangeDeliveryDTO (OrderStatusChangeDeliveryDatesDTO dates) {
    this.dates = dates;
  }
