...
import org.openapitools.vertxweb.server.model.GetPromoOffersResultDTO;
...
public class GetPromoOffersResponse   {
  ...
  public GetPromoOffersResponse (ApiResponseStatusType status, GetPromoOffersResultDTO result) {
    this.status = status;
    this.result = result;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(status, getPromoOffersResponse.status) &&
        Objects.equals(result, getPromoOffersResponse.result);
  }
