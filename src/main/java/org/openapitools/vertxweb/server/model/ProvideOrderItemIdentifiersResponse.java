...
import org.openapitools.vertxweb.server.model.OrderItemsModificationResultDTO;
...
public class ProvideOrderItemIdentifiersResponse   {
  ...
  public ProvideOrderItemIdentifiersResponse (ApiResponseStatusType status, OrderItemsModificationResultDTO result) {
    this.status = status;
    this.result = result;
  }
