...
import org.openapitools.vertxweb.server.model.GoodsFeedbackListDTO;
...
public class GetGoodsFeedbackResponse   {
  ...
  public GetGoodsFeedbackResponse (ApiResponseStatusType status, GoodsFeedbackListDTO result) {
    this.status = status;
    this.result = result;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(status, getGoodsFeedbackResponse.status) &&
        Objects.equals(result, getGoodsFeedbackResponse.result);
  }
