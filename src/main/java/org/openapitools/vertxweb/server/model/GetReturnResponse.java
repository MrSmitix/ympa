...
import org.openapitools.vertxweb.server.model.ReturnDTO;
...
public class GetReturnResponse   {
  ...
  public GetReturnResponse (ApiResponseStatusType status, ReturnDTO result) {
    this.status = status;
    this.result = result;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(status, getReturnResponse.status) &&
        Objects.equals(result, getReturnResponse.result);
  }
