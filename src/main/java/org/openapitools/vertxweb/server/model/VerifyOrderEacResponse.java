...
import org.openapitools.vertxweb.server.model.EacVerificationResultDTO;
...
public class VerifyOrderEacResponse   {
  ...
  public VerifyOrderEacResponse (ApiResponseStatusType status, EacVerificationResultDTO result) {
    this.status = status;
    this.result = result;
  }
