...
import org.openapitools.vertxweb.server.model.FeedbackListDTO;
...
public class GetFeedbackListResponse   {
  ...
  public GetFeedbackListResponse (ApiResponseStatusType status, FeedbackListDTO result) {
    this.status = status;
    this.result = result;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(status, getFeedbackListResponse.status) &&
        Objects.equals(result, getFeedbackListResponse.result);
  }
