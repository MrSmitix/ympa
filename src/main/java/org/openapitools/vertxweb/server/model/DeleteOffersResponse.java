...
import org.openapitools.vertxweb.server.model.DeleteOffersDTO;
...
public class DeleteOffersResponse   {
  ...
  public DeleteOffersResponse (ApiResponseStatusType status, DeleteOffersDTO result) {
    this.status = status;
    this.result = result;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(status, deleteOffersResponse.status) &&
        Objects.equals(result, deleteOffersResponse.result);
  }
