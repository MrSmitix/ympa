...
import org.openapitools.vertxweb.server.model.GetBidsInfoResponseDTO;
...
public class GetBidsInfoResponse   {
  ...
  public GetBidsInfoResponse (ApiResponseStatusType status, GetBidsInfoResponseDTO result) {
    this.status = status;
    this.result = result;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(status, getBidsInfoResponse.status) &&
        Objects.equals(result, getBidsInfoResponse.result);
  }
