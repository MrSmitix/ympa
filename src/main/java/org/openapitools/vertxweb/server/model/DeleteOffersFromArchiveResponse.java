...
import org.openapitools.vertxweb.server.model.DeleteOffersFromArchiveDTO;
...
public class DeleteOffersFromArchiveResponse   {
  ...
  public DeleteOffersFromArchiveResponse (ApiResponseStatusType status, DeleteOffersFromArchiveDTO result) {
    this.status = status;
    this.result = result;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(status, deleteOffersFromArchiveResponse.status) &&
        Objects.equals(result, deleteOffersFromArchiveResponse.result);
  }
