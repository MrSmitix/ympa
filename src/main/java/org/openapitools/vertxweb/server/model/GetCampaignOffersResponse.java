...
import org.openapitools.vertxweb.server.model.GetCampaignOffersResultDTO;
...
public class GetCampaignOffersResponse   {
  ...
  public GetCampaignOffersResponse (ApiResponseStatusType status, GetCampaignOffersResultDTO result) {
    this.status = status;
    this.result = result;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(status, getCampaignOffersResponse.status) &&
        Objects.equals(result, getCampaignOffersResponse.result);
  }
