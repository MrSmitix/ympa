...
import org.openapitools.vertxweb.server.model.OfferPriceListResponseDTO;
...
public class GetPricesResponse   {
  ...
  public GetPricesResponse (ApiResponseStatusType status, OfferPriceListResponseDTO result) {
    this.status = status;
    this.result = result;
  }
