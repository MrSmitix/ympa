...
import org.openapitools.vertxweb.server.model.OfferRecommendationsResultDTO;
...
public class GetOfferRecommendationsResponse   {
  ...
  public GetOfferRecommendationsResponse (ApiResponseStatusType status, OfferRecommendationsResultDTO result) {
    this.status = status;
    this.result = result;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(status, getOfferRecommendationsResponse.status) &&
        Objects.equals(result, getOfferRecommendationsResponse.result);
  }
