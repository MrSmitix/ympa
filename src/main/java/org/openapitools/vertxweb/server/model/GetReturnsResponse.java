...
import org.openapitools.vertxweb.server.model.PagedReturnsDTO;
...
public class GetReturnsResponse   {
  ...
  public GetReturnsResponse (ApiResponseStatusType status, PagedReturnsDTO result) {
    this.status = status;
    this.result = result;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(status, getReturnsResponse.status) &&
        Objects.equals(result, getReturnsResponse.result);
  }
