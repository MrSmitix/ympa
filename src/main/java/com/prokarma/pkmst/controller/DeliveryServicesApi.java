...
@Api(value = "DeliveryServices", description = "the DeliveryServices API")
public interface DeliveryServicesApi {
    ...
    ResponseEntity<GetDeliveryServicesResponse> getDeliveryServices( @RequestHeader(value = "Accept", required = false) String accept) throws Exception;
