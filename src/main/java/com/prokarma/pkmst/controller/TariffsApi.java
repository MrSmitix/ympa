...
@Api(value = "Tariffs", description = "the Tariffs API")
public interface TariffsApi {
    ...
    ResponseEntity<CalculateTariffsResponse> calculateTariffs(@ApiParam(value = "" ,required=true )   @RequestBody CalculateTariffsRequest calculateTariffsRequest, @RequestHeader(value = "Accept", required = false) String accept) throws Exception;
