...
object OrderBusinessInformationApi {
    ...
    */
      ...
      def toZonedDateTime: ZonedDateTime = ZonedDateTime.parse(s, datetimeformatter)
        ...
        */
        ...
        post("campaigns" :: long :: "orders" :: long :: "business-buyer") { (campaignId: Long, orderId: Long) =>
          da.OrderBusinessInformation_getOrderBusinessBuyerInfo(campaignId, orderId) match {
        ...
        */
        ...
        post("campaigns" :: long :: "orders" :: long :: "documents") { (campaignId: Long, orderId: Long) =>
          da.OrderBusinessInformation_getOrderBusinessDocumentsInfo(campaignId, orderId) match {
            case Left(error) => checkError(error)
            case Right(data) => Ok(data)
          }
        } handle {
    ...
    private def bytesToFile(input: Array[Byte]): java.io.File = {
      val file = Files.createTempFile("tmpOrderBusinessInformationApi", null).toFile
