...
object OrderDeliveryApi {
    ...
    */
      ...
      def toZonedDateTime: ZonedDateTime = ZonedDateTime.parse(s, datetimeformatter)
        ...
        */
        ...
        get("campaigns" :: long :: "orders" :: long :: "buyer") { (campaignId: Long, orderId: Long) =>
          da.OrderDelivery_getOrderBuyerInfo(campaignId, orderId) match {
        ...
        */
        ...
        put("campaigns" :: long :: "orders" :: long :: "delivery" :: "date" :: jsonBody[SetOrderDeliveryDateRequest]) { (campaignId: Long, orderId: Long, setOrderDeliveryDateRequest: SetOrderDeliveryDateRequest) =>
          da.OrderDelivery_setOrderDeliveryDate(campaignId, orderId, setOrderDeliveryDateRequest) match {
            case Left(error) => checkError(error)
            case Right(data) => Ok(data)
          }
        } handle {
        ...
        */
        ...
        post("campaigns" :: long :: "orders" :: long :: "delivery" :: "track" :: jsonBody[SetOrderDeliveryTrackCodeRequest]) { (campaignId: Long, orderId: Long, setOrderDeliveryTrackCodeRequest: SetOrderDeliveryTrackCodeRequest) =>
          da.OrderDelivery_setOrderDeliveryTrackCode(campaignId, orderId, setOrderDeliveryTrackCodeRequest) match {
            case Left(error) => checkError(error)
            case Right(data) => Ok(data)
          }
        } handle {
        ...
        */
        ...
        put("campaigns" :: long :: "orders" :: long :: "delivery" :: "storage-limit" :: jsonBody[UpdateOrderStorageLimitRequest]) { (campaignId: Long, orderId: Long, updateOrderStorageLimitRequest: UpdateOrderStorageLimitRequest) =>
          da.OrderDelivery_updateOrderStorageLimit(campaignId, orderId, updateOrderStorageLimitRequest) match {
            case Left(error) => checkError(error)
            case Right(data) => Ok(data)
          }
        } handle {
        ...
        */
        ...
        put("campaigns" :: long :: "orders" :: long :: "verifyEac" :: jsonBody[VerifyOrderEacRequest]) { (campaignId: Long, orderId: Long, verifyOrderEacRequest: VerifyOrderEacRequest) =>
          da.OrderDelivery_verifyOrderEac(campaignId, orderId, verifyOrderEacRequest) match {
            case Left(error) => checkError(error)
            case Right(data) => Ok(data)
          }
        } handle {
    ...
    private def bytesToFile(input: Array[Byte]): java.io.File = {
      val file = Files.createTempFile("tmpOrderDeliveryApi", null).toFile
