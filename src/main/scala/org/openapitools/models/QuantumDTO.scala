 ...
 */
case class QuantumDTO(minQuantity: Option[Int],
                stepQuantity: Option[Int]
                )

object QuantumDTO {
    /**
     * Creates the codec for converting QuantumDTO from and to JSON.
     */
    implicit val decoder: Decoder[QuantumDTO] = deriveDecoder
    implicit val encoder: ObjectEncoder[QuantumDTO] = deriveEncoder
}
