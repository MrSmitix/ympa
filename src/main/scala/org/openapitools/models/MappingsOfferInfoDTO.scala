...
import org.openapitools.models.OfferProcessingStateDTO
 ...
 */
case class MappingsOfferInfoDTO(name: Option[String],
                ...
                boxCount: Option[Int],
                customsCommodityCodes: Option[Seq[String]],
                weightDimensions: Option[OfferWeightDimensionsDTO],
                supplyScheduleDays: Option[Seq[DayOfWeekType]],
...
object MappingsOfferInfoDTO {
    /**
     * Creates the codec for converting MappingsOfferInfoDTO from and to JSON.
     */
    implicit val decoder: Decoder[MappingsOfferInfoDTO] = deriveDecoder
    implicit val encoder: ObjectEncoder[MappingsOfferInfoDTO] = deriveEncoder
}
