...
object OrderSubstatusType {
    /**
     * Creates the codec for converting OrderSubstatusType from and to JSON.
     */
    implicit val decoder: Decoder[OrderSubstatusType] = deriveDecoder
    implicit val encoder: ObjectEncoder[OrderSubstatusType] = deriveEncoder
}
