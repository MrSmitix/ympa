...
object WarehouseStockType {
    /**
     * Creates the codec for converting WarehouseStockType from and to JSON.
     */
    implicit val decoder: Decoder[WarehouseStockType] = deriveDecoder
    implicit val encoder: ObjectEncoder[WarehouseStockType] = deriveEncoder
}
