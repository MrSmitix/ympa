...
object OfferContentErrorType {
    /**
     * Creates the codec for converting OfferContentErrorType from and to JSON.
     */
    implicit val decoder: Decoder[OfferContentErrorType] = deriveDecoder
    implicit val encoder: ObjectEncoder[OfferContentErrorType] = deriveEncoder
}
