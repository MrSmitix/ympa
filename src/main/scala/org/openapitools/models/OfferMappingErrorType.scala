...
object OfferMappingErrorType {
    /**
     * Creates the codec for converting OfferMappingErrorType from and to JSON.
     */
    implicit val decoder: Decoder[OfferMappingErrorType] = deriveDecoder
    implicit val encoder: ObjectEncoder[OfferMappingErrorType] = deriveEncoder
}
