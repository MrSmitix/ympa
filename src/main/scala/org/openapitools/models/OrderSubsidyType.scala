...
object OrderSubsidyType {
    /**
     * Creates the codec for converting OrderSubsidyType from and to JSON.
     */
    implicit val decoder: Decoder[OrderSubsidyType] = deriveDecoder
    implicit val encoder: ObjectEncoder[OrderSubsidyType] = deriveEncoder
}
