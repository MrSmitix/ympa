 ...
 */
case class EnrichedMappingsOfferDTO(name: Option[String],
...
object EnrichedMappingsOfferDTO {
    /**
     * Creates the codec for converting EnrichedMappingsOfferDTO from and to JSON.
     */
    implicit val decoder: Decoder[EnrichedMappingsOfferDTO] = deriveDecoder
    implicit val encoder: ObjectEncoder[EnrichedMappingsOfferDTO] = deriveEncoder
}
