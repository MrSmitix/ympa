...
import org.openapitools.models.LicenseCheckStatusType
import org.openapitools.models.LicenseType
 ...
 */
case class FullOutletLicenseDTO(id: Option[Long],
                outletId: Option[Long],
                licenseType: Option[LicenseType],
                number: Option[String],
                dateOfIssue: Option[ZonedDateTime],
                dateOfExpiry: Option[ZonedDateTime],
...
object FullOutletLicenseDTO {
    /**
     * Creates the codec for converting FullOutletLicenseDTO from and to JSON.
     */
    implicit val decoder: Decoder[FullOutletLicenseDTO] = deriveDecoder
    implicit val encoder: ObjectEncoder[FullOutletLicenseDTO] = deriveEncoder
}
