 ...
 */
case class ShipmentDTO(id: Option[Long],
...
object ShipmentDTO {
    /**
     * Creates the codec for converting ShipmentDTO from and to JSON.
     */
    implicit val decoder: Decoder[ShipmentDTO] = deriveDecoder
    implicit val encoder: ObjectEncoder[ShipmentDTO] = deriveEncoder
}
