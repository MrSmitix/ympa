...
object OrderPromoType {
    /**
     * Creates the codec for converting OrderPromoType from and to JSON.
     */
    implicit val decoder: Decoder[OrderPromoType] = deriveDecoder
    implicit val encoder: ObjectEncoder[OrderPromoType] = deriveEncoder
}
