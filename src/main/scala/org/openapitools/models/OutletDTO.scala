 ...
 */
case class OutletDTO(name: String,
                _type: OutletType,
...
object OutletDTO {
    /**
     * Creates the codec for converting OutletDTO from and to JSON.
     */
    implicit val decoder: Decoder[OutletDTO] = deriveDecoder
    implicit val encoder: ObjectEncoder[OutletDTO] = deriveEncoder
}
