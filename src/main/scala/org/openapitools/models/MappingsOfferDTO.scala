 ...
 */
case class MappingsOfferDTO(name: Option[String],
...
object MappingsOfferDTO {
    /**
     * Creates the codec for converting MappingsOfferDTO from and to JSON.
     */
    implicit val decoder: Decoder[MappingsOfferDTO] = deriveDecoder
    implicit val encoder: ObjectEncoder[MappingsOfferDTO] = deriveEncoder
}
