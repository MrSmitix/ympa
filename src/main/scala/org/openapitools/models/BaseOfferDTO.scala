 ...
 */
case class BaseOfferDTO(offerId: String,
                name: Option[String],
...
object BaseOfferDTO {
    /**
     * Creates the codec for converting BaseOfferDTO from and to JSON.
     */
    implicit val decoder: Decoder[BaseOfferDTO] = deriveDecoder
    implicit val encoder: ObjectEncoder[BaseOfferDTO] = deriveEncoder
}
