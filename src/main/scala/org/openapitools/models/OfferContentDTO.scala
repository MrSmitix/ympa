 ...
 */
case class OfferContentDTO(offerId: String,
                categoryId: Int,
...
object OfferContentDTO {
    /**
     * Creates the codec for converting OfferContentDTO from and to JSON.
     */
    implicit val decoder: Decoder[OfferContentDTO] = deriveDecoder
    implicit val encoder: ObjectEncoder[OfferContentDTO] = deriveEncoder
}
