 ...
 */
case class UpdateOfferDTO(offerId: String,
                name: Option[String],
                ...
                basicPrice: Option[UpdatePriceWithDiscountDTO],
                purchasePrice: Option[BasePriceDTO],
                additionalExpenses: Option[BasePriceDTO],
                cofinancePrice: Option[BasePriceDTO]
                )

object UpdateOfferDTO {
    /**
     * Creates the codec for converting UpdateOfferDTO from and to JSON.
     */
    implicit val decoder: Decoder[UpdateOfferDTO] = deriveDecoder
    implicit val encoder: ObjectEncoder[UpdateOfferDTO] = deriveEncoder
}
