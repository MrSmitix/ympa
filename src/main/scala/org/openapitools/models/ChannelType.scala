...
object ChannelType {
    /**
     * Creates the codec for converting ChannelType from and to JSON.
     */
    implicit val decoder: Decoder[ChannelType] = deriveDecoder
    implicit val encoder: ObjectEncoder[ChannelType] = deriveEncoder
}
