...
object PriceSuggestType {
    /**
     * Creates the codec for converting PriceSuggestType from and to JSON.
     */
    implicit val decoder: Decoder[PriceSuggestType] = deriveDecoder
    implicit val encoder: ObjectEncoder[PriceSuggestType] = deriveEncoder
}
