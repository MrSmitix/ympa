 ...
 */
case class UpdateMappingsOfferDTO(name: Option[String],
...
object UpdateMappingsOfferDTO {
    /**
     * Creates the codec for converting UpdateMappingsOfferDTO from and to JSON.
     */
    implicit val decoder: Decoder[UpdateMappingsOfferDTO] = deriveDecoder
    implicit val encoder: ObjectEncoder[UpdateMappingsOfferDTO] = deriveEncoder
}
