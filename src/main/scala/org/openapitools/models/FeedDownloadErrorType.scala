...
object FeedDownloadErrorType {
    /**
     * Creates the codec for converting FeedDownloadErrorType from and to JSON.
     */
    implicit val decoder: Decoder[FeedDownloadErrorType] = deriveDecoder
    implicit val encoder: ObjectEncoder[FeedDownloadErrorType] = deriveEncoder
}
