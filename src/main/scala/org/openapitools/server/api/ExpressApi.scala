...
class ExpressApi(
    ...
    expressMarshaller: ExpressApiMarshaller
)  extends MultipartDirectives with StringDirectives {

  
  import expressMarshaller._

  lazy val route: Route =
    path("campaigns" / LongNumber / "hidden-offers") { (campaignId) => 
      post {  
            entity(as[AddHiddenOffersRequest]){ addHiddenOffersRequest =>
              expressService.addHiddenOffers(campaignId = campaignId, addHiddenOffersRequest = addHiddenOffersRequest)
            }
      }
    } ~
    path("businesses" / LongNumber / "offer-mappings" / "archive") { (businessId) => 
      post {  
            entity(as[AddOffersToArchiveRequest]){ addOffersToArchiveRequest =>
              expressService.addOffersToArchive(businessId = businessId, addOffersToArchiveRequest = addOffersToArchiveRequest)
            }
      }
    } ~
    path("tariffs" / "calculate") { 
      post {  
            entity(as[CalculateTariffsRequest]){ calculateTariffsRequest =>
              expressService.calculateTariffs(calculateTariffsRequest = calculateTariffsRequest)
            }
      }
    } ~
    path("businesses" / LongNumber / "price-quarantine" / "confirm") { (businessId) => 
      post {  
            entity(as[ConfirmPricesRequest]){ confirmPricesRequest =>
              expressService.confirmBusinessPrices(businessId = businessId, confirmPricesRequest = confirmPricesRequest)
            }
      }
    } ~
    path("campaigns" / LongNumber / "price-quarantine" / "confirm") { (campaignId) => 
      post {  
            entity(as[ConfirmPricesRequest]){ confirmPricesRequest =>
              expressService.confirmCampaignPrices(campaignId = campaignId, confirmPricesRequest = confirmPricesRequest)
            }
      }
    } ~
    path("businesses" / LongNumber / "chats" / "new") { (businessId) => 
      post {  
            entity(as[CreateChatRequest]){ createChatRequest =>
              expressService.createChat(businessId = businessId, createChatRequest = createChatRequest)
            }
      }
    } ~
    path("campaigns" / LongNumber / "offers" / "delete") { (campaignId) => 
      post {  
            entity(as[DeleteCampaignOffersRequest]){ deleteCampaignOffersRequest =>
              expressService.deleteCampaignOffers(campaignId = campaignId, deleteCampaignOffersRequest = deleteCampaignOffersRequest)
            }
      }
    } ~
    path("businesses" / LongNumber / "goods-feedback" / "comments" / "delete") { (businessId) => 
      post {  
            entity(as[DeleteGoodsFeedbackCommentRequest]){ deleteGoodsFeedbackCommentRequest =>
              expressService.deleteGoodsFeedbackComment(businessId = businessId, deleteGoodsFeedbackCommentRequest = deleteGoodsFeedbackCommentRequest)
            }
      }
    } ~
    path("campaigns" / LongNumber / "hidden-offers" / "delete") { (campaignId) => 
      post {  
            entity(as[DeleteHiddenOffersRequest]){ deleteHiddenOffersRequest =>
              expressService.deleteHiddenOffers(campaignId = campaignId, deleteHiddenOffersRequest = deleteHiddenOffersRequest)
            }
      }
    } ~
    path("businesses" / LongNumber / "offer-mappings" / "delete") { (businessId) => 
      post {  
            entity(as[DeleteOffersRequest]){ deleteOffersRequest =>
              expressService.deleteOffers(businessId = businessId, deleteOffersRequest = deleteOffersRequest)
            }
      }
    } ~
    path("businesses" / LongNumber / "offer-mappings" / "unarchive") { (businessId) => 
      post {  
            entity(as[DeleteOffersFromArchiveRequest]){ deleteOffersFromArchiveRequest =>
              expressService.deleteOffersFromArchive(businessId = businessId, deleteOffersFromArchiveRequest = deleteOffersFromArchiveRequest)
            }
      }
    } ~
    path("businesses" / LongNumber / "promos" / "offers" / "delete") { (businessId) => 
      post {  
            entity(as[DeletePromoOffersRequest]){ deletePromoOffersRequest =>
              expressService.deletePromoOffers(businessId = businessId, deletePromoOffersRequest = deletePromoOffersRequest)
            }
      }
    } ~
      ...
      post { 
        parameters("format".as[String].?) { (format) => 
            entity(as[GenerateBoostConsolidatedRequest]){ generateBoostConsolidatedRequest =>
              expressService.generateBoostConsolidatedReport(generateBoostConsolidatedRequest = generateBoostConsolidatedRequest, format = format)
            }
        }
      }
    } ~
      ...
      post { 
        parameters("format".as[String].?) { (format) => 
            entity(as[GenerateCompetitorsPositionReportRequest]){ generateCompetitorsPositionReportRequest =>
              expressService.generateCompetitorsPositionReport(generateCompetitorsPositionReportRequest = generateCompetitorsPositionReportRequest, format = format)
            }
        }
      }
    } ~
      ...
      post { 
        parameters("format".as[String].?) { (format) => 
            entity(as[GenerateGoodsFeedbackRequest]){ generateGoodsFeedbackRequest =>
              expressService.generateGoodsFeedbackReport(generateGoodsFeedbackRequest = generateGoodsFeedbackRequest, format = format)
            }
        }
      }
    } ~
      ...
      post { 
        parameters("format".as[String].?) { (format) => 
            entity(as[GenerateGoodsRealizationReportRequest]){ generateGoodsRealizationReportRequest =>
              expressService.generateGoodsRealizationReport(generateGoodsRealizationReportRequest = generateGoodsRealizationReportRequest, format = format)
            }
        }
      }
    } ~
      ...
      post { 
        parameters("format".as[String].?) { (format) => 
            entity(as[GenerateMassOrderLabelsRequest]){ generateMassOrderLabelsRequest =>
              expressService.generateMassOrderLabelsReport(generateMassOrderLabelsRequest = generateMassOrderLabelsRequest, format = format)
            }
        }
      }
    } ~
    path("campaigns" / LongNumber / "orders" / LongNumber / "delivery" / "shipments" / LongNumber / "boxes" / LongNumber / "label") { (campaignId, orderId, shipmentId, boxId) => 
      get { 
        parameters("format".as[String].?) { (format) => 
            expressService.generateOrderLabel(campaignId = campaignId, orderId = orderId, shipmentId = shipmentId, boxId = boxId, format = format)
        }
      }
    } ~
    path("campaigns" / LongNumber / "orders" / LongNumber / "delivery" / "labels") { (campaignId, orderId) => 
      get { 
        parameters("format".as[String].?) { (format) => 
            expressService.generateOrderLabels(campaignId = campaignId, orderId = orderId, format = format)
        }
      }
    } ~
      ...
      post { 
        parameters("format".as[String].?) { (format) => 
            entity(as[GeneratePricesReportRequest]){ generatePricesReportRequest =>
              expressService.generatePricesReport(generatePricesReportRequest = generatePricesReportRequest, format = format)
            }
        }
      }
    } ~
      ...
      post { 
        parameters("format".as[String].?) { (format) => 
            entity(as[GenerateShelfsStatisticsRequest]){ generateShelfsStatisticsRequest =>
              expressService.generateShelfsStatisticsReport(generateShelfsStatisticsRequest = generateShelfsStatisticsRequest, format = format)
            }
        }
      }
    } ~
      ...
      post { 
        parameters("format".as[String].?) { (format) => 
            entity(as[GenerateShowsSalesReportRequest]){ generateShowsSalesReportRequest =>
              expressService.generateShowsSalesReport(generateShowsSalesReportRequest = generateShowsSalesReportRequest, format = format)
            }
        }
      }
    } ~
      ...
      post { 
        parameters("format".as[String].?) { (format) => 
            entity(as[GenerateStocksOnWarehousesReportRequest]){ generateStocksOnWarehousesReportRequest =>
              expressService.generateStocksOnWarehousesReport(generateStocksOnWarehousesReportRequest = generateStocksOnWarehousesReportRequest, format = format)
            }
        }
      }
    } ~
      ...
      post { 
        parameters("format".as[String].?) { (format) => 
            entity(as[GenerateUnitedMarketplaceServicesReportRequest]){ generateUnitedMarketplaceServicesReportRequest =>
              expressService.generateUnitedMarketplaceServicesReport(generateUnitedMarketplaceServicesReportRequest = generateUnitedMarketplaceServicesReportRequest, format = format)
            }
        }
      }
    } ~
      ...
      post { 
        parameters("format".as[String].?) { (format) => 
            entity(as[GenerateUnitedNettingReportRequest]){ generateUnitedNettingReportRequest =>
              expressService.generateUnitedNettingReport(generateUnitedNettingReportRequest = generateUnitedNettingReportRequest, format = format)
            }
        }
      }
    } ~
      ...
      post { 
        parameters("format".as[String].?) { (format) => 
            entity(as[GenerateUnitedOrdersRequest]){ generateUnitedOrdersRequest =>
              expressService.generateUnitedOrdersReport(generateUnitedOrdersRequest = generateUnitedOrdersRequest, format = format)
            }
        }
      }
    } ~
    path("campaigns" / LongNumber / "offers" / "all") { (campaignId) => 
      get { 
        parameters("feedId".as[Long].?, "chunk".as[Int].?) { (feedId, chunk) => 
            expressService.getAllOffers(campaignId = campaignId, feedId = feedId, chunk = chunk)
        }
      }
    } ~
      ...
      post { 
        parameters("page_token".as[String].?, "limit".as[Int].?) { (pageToken, limit) => 
            entity(as[GetBidsInfoRequest]){ getBidsInfoRequest =>
              expressService.getBidsInfoForBusiness(businessId = businessId, pageToken = pageToken, limit = limit, getBidsInfoRequest = getBidsInfoRequest)
            }
        }
      }
    } ~
    path("businesses" / LongNumber / "bids" / "recommendations") { (businessId) => 
      post {  
            entity(as[GetBidsRecommendationsRequest]){ getBidsRecommendationsRequest =>
              expressService.getBidsRecommendations(businessId = businessId, getBidsRecommendationsRequest = getBidsRecommendationsRequest)
            }
      }
    } ~
      ...
      post { 
        parameters("page_token".as[String].?, "limit".as[Int].?) { (pageToken, limit) => 
            entity(as[GetQuarantineOffersRequest]){ getQuarantineOffersRequest =>
              expressService.getBusinessQuarantineOffers(businessId = businessId, getQuarantineOffersRequest = getQuarantineOffersRequest, pageToken = pageToken, limit = limit)
            }
        }
      }
    } ~
    path("businesses" / LongNumber / "settings") { (businessId) => 
      post {  
            expressService.getBusinessSettings(businessId = businessId)
      }
    } ~
    path("campaigns" / LongNumber) { (campaignId) => 
      get {  
            expressService.getCampaign(campaignId = campaignId)
      }
    } ~
    path("campaigns" / LongNumber / "logins") { (campaignId) => 
      get {  
            expressService.getCampaignLogins(campaignId = campaignId)
      }
    } ~
      ...
      post { 
        parameters("page_token".as[String].?, "limit".as[Int].?) { (pageToken, limit) => 
            entity(as[GetCampaignOffersRequest]){ getCampaignOffersRequest =>
              expressService.getCampaignOffers(campaignId = campaignId, getCampaignOffersRequest = getCampaignOffersRequest, pageToken = pageToken, limit = limit)
            }
        }
      }
    } ~
    path("campaigns" / LongNumber / "price-quarantine") { (campaignId) => 
      post { 
        parameters("page_token".as[String].?, "limit".as[Int].?) { (pageToken, limit) => 
            entity(as[GetQuarantineOffersRequest]){ getQuarantineOffersRequest =>
              expressService.getCampaignQuarantineOffers(campaignId = campaignId, getQuarantineOffersRequest = getQuarantineOffersRequest, pageToken = pageToken, limit = limit)
            }
        }
      }
    } ~
    path("campaigns" / LongNumber / "region") { (campaignId) => 
      get {  
            expressService.getCampaignRegion(campaignId = campaignId)
      }
    } ~
    path("campaigns" / LongNumber / "settings") { (campaignId) => 
      get {  
            expressService.getCampaignSettings(campaignId = campaignId)
      }
    } ~
    path("campaigns") { 
      get { 
        parameters("page".as[Int].?(1), "pageSize".as[Int].?) { (page, pageSize) => 
            expressService.getCampaigns(page = page, pageSize = pageSize)
        }
      }
    } ~
    path("campaigns" / "by_login" / Segment) { (login) => 
      get { 
        parameters("page".as[Int].?(1), "pageSize".as[Int].?) { (page, pageSize) => 
            expressService.getCampaignsByLogin(login = login, page = page, pageSize = pageSize)
        }
      }
    } ~
    path("categories" / "max-sale-quantum") { 
      post {  
            entity(as[GetCategoriesMaxSaleQuantumRequest]){ getCategoriesMaxSaleQuantumRequest =>
              expressService.getCategoriesMaxSaleQuantum(getCategoriesMaxSaleQuantumRequest = getCategoriesMaxSaleQuantumRequest)
            }
      }
    } ~
    path("categories" / "tree") { 
      post {  
            entity(as[GetCategoriesRequest]){ getCategoriesRequest =>
              expressService.getCategoriesTree(getCategoriesRequest = getCategoriesRequest)
            }
      }
    } ~
    path("category" / LongNumber / "parameters") { (categoryId) => 
      post {  
            expressService.getCategoryContentParameters(categoryId = categoryId)
      }
    } ~
      ...
      post { 
        parameters("chatId".as[Long], "page_token".as[String].?, "limit".as[Int].?) { (chatId, pageToken, limit) => 
            entity(as[GetChatHistoryRequest]){ getChatHistoryRequest =>
              expressService.getChatHistory(businessId = businessId, chatId = chatId, getChatHistoryRequest = getChatHistoryRequest, pageToken = pageToken, limit = limit)
            }
        }
      }
    } ~
      ...
      post { 
        parameters("page_token".as[String].?, "limit".as[Int].?) { (pageToken, limit) => 
            entity(as[GetChatsRequest]){ getChatsRequest =>
              expressService.getChats(businessId = businessId, getChatsRequest = getChatsRequest, pageToken = pageToken, limit = limit)
            }
        }
      }
    } ~
    path("delivery" / "services") { 
      get {  
            expressService.getDeliveryServices()
      }
    } ~
    path("campaigns" / LongNumber / "feeds" / LongNumber) { (campaignId, feedId) => 
      get {  
            expressService.getFeed(campaignId = campaignId, feedId = feedId)
      }
    } ~
    path("campaigns" / LongNumber / "feeds" / LongNumber / "index-logs") { (campaignId, feedId) => 
      get { 
        parameters("limit".as[Int].?, "published_time_from".as[String].?, "published_time_to".as[String].?, "status".as[String].?) { (limit, publishedTimeFrom, publishedTimeTo, status) => 
            expressService.getFeedIndexLogs(campaignId = campaignId, feedId = feedId, limit = limit, publishedTimeFrom = publishedTimeFrom, publishedTimeTo = publishedTimeTo, status = status)
        }
      }
    } ~
    path("campaigns" / LongNumber / "feedback" / "updates") { (campaignId) => 
      get { 
        parameters("page_token".as[String].?, "limit".as[Int].?, "from_date".as[String].?) { (pageToken, limit, fromDate) => 
            expressService.getFeedbackAndCommentUpdates(campaignId = campaignId, pageToken = pageToken, limit = limit, fromDate = fromDate)
        }
      }
    } ~
    path("campaigns" / LongNumber / "feeds") { (campaignId) => 
      get {  
            expressService.getFeeds(campaignId = campaignId)
      }
    } ~
      ...
      post { 
        parameters("page_token".as[String].?, "limit".as[Int].?) { (pageToken, limit) => 
            entity(as[GetGoodsFeedbackCommentsRequest]){ getGoodsFeedbackCommentsRequest =>
              expressService.getGoodsFeedbackComments(businessId = businessId, getGoodsFeedbackCommentsRequest = getGoodsFeedbackCommentsRequest, pageToken = pageToken, limit = limit)
            }
        }
      }
    } ~
      ...
      post { 
        parameters("page_token".as[String].?, "limit".as[Int].?) { (pageToken, limit) => 
            entity(as[GetGoodsFeedbackRequest]){ getGoodsFeedbackRequest =>
              expressService.getGoodsFeedbacks(businessId = businessId, pageToken = pageToken, limit = limit, getGoodsFeedbackRequest = getGoodsFeedbackRequest)
            }
        }
      }
    } ~
    path("campaigns" / LongNumber / "stats" / "skus") { (campaignId) => 
      post {  
            entity(as[GetGoodsStatsRequest]){ getGoodsStatsRequest =>
              expressService.getGoodsStats(campaignId = campaignId, getGoodsStatsRequest = getGoodsStatsRequest)
            }
      }
    } ~
    path("campaigns" / LongNumber / "hidden-offers") { (campaignId) => 
      get { 
        parameters("offer_id".as[String].?, "page_token".as[String].?, "limit".as[Int].?, "offset".as[Int].?, "page".as[Int].?(1), "pageSize".as[Int].?) { (offerId, pageToken, limit, offset, page, pageSize) => 
            expressService.getHiddenOffers(campaignId = campaignId, offerId = offerId, pageToken = pageToken, limit = limit, offset = offset, page = page, pageSize = pageSize)
        }
      }
    } ~
      ...
      post { 
        parameters("page_token".as[String].?, "limit".as[Int].?) { (pageToken, limit) => 
            entity(as[GetOfferCardsContentStatusRequest]){ getOfferCardsContentStatusRequest =>
              expressService.getOfferCardsContentStatus(businessId = businessId, pageToken = pageToken, limit = limit, getOfferCardsContentStatusRequest = getOfferCardsContentStatusRequest)
            }
        }
      }
    } ~
    path("campaigns" / LongNumber / "offer-mapping-entries") { (campaignId) => 
      get { 
        parameters("offer_id".as[String].?, "shop_sku".as[String].?, "mapping_kind".as[String].?, "status".as[String].?, "availability".as[String].?, "category_id".as[String].?, "vendor".as[String].?, "page_token".as[String].?, "limit".as[Int].?) { (offerId, shopSku, mappingKind, status, availability, categoryId, vendor, pageToken, limit) => 
            expressService.getOfferMappingEntries(campaignId = campaignId, offerId = offerId, shopSku = shopSku, mappingKind = mappingKind, status = status, availability = availability, categoryId = categoryId, vendor = vendor, pageToken = pageToken, limit = limit)
        }
      }
    } ~
      ...
      post { 
        parameters("page_token".as[String].?, "limit".as[Int].?) { (pageToken, limit) => 
            entity(as[GetOfferMappingsRequest]){ getOfferMappingsRequest =>
              expressService.getOfferMappings(businessId = businessId, pageToken = pageToken, limit = limit, getOfferMappingsRequest = getOfferMappingsRequest)
            }
        }
      }
    } ~
      ...
      post { 
        parameters("page_token".as[String].?, "limit".as[Int].?) { (pageToken, limit) => 
            entity(as[GetOfferRecommendationsRequest]){ getOfferRecommendationsRequest =>
              expressService.getOfferRecommendations(businessId = businessId, getOfferRecommendationsRequest = getOfferRecommendationsRequest, pageToken = pageToken, limit = limit)
            }
        }
      }
    } ~
    path("campaigns" / LongNumber / "offers") { (campaignId) => 
      get { 
        parameters("query".as[String].?, "feedId".as[Long].?, "shopCategoryId".as[String].?, "currency".as[String].?, "matched".as[Boolean].?, "page".as[Int].?(1), "pageSize".as[Int].?) { (query, feedId, shopCategoryId, currency, matched, page, pageSize) => 
            expressService.getOffers(campaignId = campaignId, query = query, feedId = feedId, shopCategoryId = shopCategoryId, currency = currency, matched = matched, page = page, pageSize = pageSize)
        }
      }
    } ~
    path("campaigns" / LongNumber / "orders" / LongNumber) { (campaignId, orderId) => 
      get {  
            expressService.getOrder(campaignId = campaignId, orderId = orderId)
      }
    } ~
    path("campaigns" / LongNumber / "orders" / LongNumber / "business-buyer") { (campaignId, orderId) => 
      post {  
            expressService.getOrderBusinessBuyerInfo(campaignId = campaignId, orderId = orderId)
      }
    } ~
    path("campaigns" / LongNumber / "orders" / LongNumber / "documents") { (campaignId, orderId) => 
      post {  
            expressService.getOrderBusinessDocumentsInfo(campaignId = campaignId, orderId = orderId)
      }
    } ~
    path("campaigns" / LongNumber / "orders" / LongNumber / "delivery" / "labels" / "data") { (campaignId, orderId) => 
      get {  
            expressService.getOrderLabelsData(campaignId = campaignId, orderId = orderId)
      }
    } ~
      ...
      post { 
        parameters("page_token".as[String].?, "limit".as[Int].?) { (pageToken, limit) => 
            entity(as[GetOrdersStatsRequest]){ getOrdersStatsRequest =>
              expressService.getOrdersStats(campaignId = campaignId, pageToken = pageToken, limit = limit, getOrdersStatsRequest = getOrdersStatsRequest)
            }
        }
      }
    } ~
    path("campaigns" / LongNumber / "offer-prices") { (campaignId) => 
      get { 
        parameters("page_token".as[String].?, "limit".as[Int].?, "archived".as[Boolean].?(false)) { (pageToken, limit, archived) => 
            expressService.getPrices(campaignId = campaignId, pageToken = pageToken, limit = limit, archived = archived)
        }
      }
    } ~
    path("campaigns" / LongNumber / "offer-prices") { (campaignId) => 
      post { 
        parameters("page_token".as[String].?, "limit".as[Int].?) { (pageToken, limit) => 
            entity(as[GetPricesByOfferIdsRequest]){ getPricesByOfferIdsRequest =>
              expressService.getPricesByOfferIds(campaignId = campaignId, pageToken = pageToken, limit = limit, getPricesByOfferIdsRequest = getPricesByOfferIdsRequest)
            }
        }
      }
    } ~
      ...
      post { 
        parameters("page_token".as[String].?, "limit".as[Int].?) { (pageToken, limit) => 
            entity(as[GetPromoOffersRequest]){ getPromoOffersRequest =>
              expressService.getPromoOffers(businessId = businessId, getPromoOffersRequest = getPromoOffersRequest, pageToken = pageToken, limit = limit)
            }
        }
      }
    } ~
    path("businesses" / LongNumber / "promos") { (businessId) => 
      post {  
            entity(as[GetPromosRequest]){ getPromosRequest =>
              expressService.getPromos(businessId = businessId, getPromosRequest = getPromosRequest)
            }
      }
    } ~
    path("campaigns" / LongNumber / "ratings" / "quality" / "details") { (campaignId) => 
      post {  
            expressService.getQualityRatingDetails(campaignId = campaignId)
      }
    } ~
    path("businesses" / LongNumber / "ratings" / "quality") { (businessId) => 
      post {  
            entity(as[GetQualityRatingRequest]){ getQualityRatingRequest =>
              expressService.getQualityRatings(businessId = businessId, getQualityRatingRequest = getQualityRatingRequest)
            }
      }
    } ~
    path("reports" / "info" / Segment) { (reportId) => 
      get {  
            expressService.getReportInfo(reportId = reportId)
      }
    } ~
    path("campaigns" / LongNumber / "orders" / LongNumber / "returns" / LongNumber) { (campaignId, orderId, returnId) => 
      get {  
            expressService.getReturn(campaignId = campaignId, orderId = orderId, returnId = returnId)
      }
    } ~
    path("campaigns" / LongNumber / "orders" / LongNumber / "returns" / LongNumber / "application") { (campaignId, orderId, returnId) => 
      get {  
            expressService.getReturnApplication(campaignId = campaignId, orderId = orderId, returnId = returnId)
      }
    } ~
    path("campaigns" / LongNumber / "orders" / LongNumber / "returns" / LongNumber / "decision" / LongNumber / "image" / Segment) { (campaignId, orderId, returnId, itemId, imageHash) => 
      get {  
            expressService.getReturnPhoto(campaignId = campaignId, orderId = orderId, returnId = returnId, itemId = itemId, imageHash = imageHash)
      }
    } ~
    path("campaigns" / LongNumber / "returns") { (campaignId) => 
      get { 
        parameters("page_token".as[String].?, "limit".as[Int].?, "orderIds".as[String].?, "statuses".as[String].?, "type".as[String].?, "fromDate".as[String].?, "toDate".as[String].?, "from_date".as[String].?, "to_date".as[String].?) { (pageToken, limit, orderIds, statuses, `type`, fromDate, toDate, fromDate2, toDate2) => 
            expressService.getReturns(campaignId = campaignId, pageToken = pageToken, limit = limit, orderIds = orderIds, statuses = statuses, `type` = `type`, fromDate = fromDate, toDate = toDate, fromDate2 = fromDate2, toDate2 = toDate2)
        }
      }
    } ~
      ...
      post { 
        parameters("page_token".as[String].?, "limit".as[Int].?) { (pageToken, limit) => 
            entity(as[GetWarehouseStocksRequest]){ getWarehouseStocksRequest =>
              expressService.getStocks(campaignId = campaignId, pageToken = pageToken, limit = limit, getWarehouseStocksRequest = getWarehouseStocksRequest)
            }
        }
      }
    } ~
    path("campaigns" / LongNumber / "offer-mapping-entries" / "suggestions") { (campaignId) => 
      post {  
            entity(as[GetSuggestedOfferMappingEntriesRequest]){ getSuggestedOfferMappingEntriesRequest =>
              expressService.getSuggestedOfferMappingEntries(campaignId = campaignId, getSuggestedOfferMappingEntriesRequest = getSuggestedOfferMappingEntriesRequest)
            }
      }
    } ~
    path("businesses" / LongNumber / "offer-mappings" / "suggestions") { (businessId) => 
      post {  
            entity(as[GetSuggestedOfferMappingsRequest]){ getSuggestedOfferMappingsRequest =>
              expressService.getSuggestedOfferMappings(businessId = businessId, getSuggestedOfferMappingsRequest = getSuggestedOfferMappingsRequest)
            }
      }
    } ~
    path("campaigns" / LongNumber / "offer-prices" / "suggestions") { (campaignId) => 
      post {  
            entity(as[SuggestPricesRequest]){ suggestPricesRequest =>
              expressService.getSuggestedPrices(campaignId = campaignId, suggestPricesRequest = suggestPricesRequest)
            }
      }
    } ~
    path("businesses" / LongNumber / "warehouses") { (businessId) => 
      get {  
            expressService.getWarehouses(businessId = businessId)
      }
    } ~
    path("campaigns" / LongNumber / "orders" / LongNumber / "identifiers") { (campaignId, orderId) => 
      put {  
            entity(as[ProvideOrderItemIdentifiersRequest]){ provideOrderItemIdentifiersRequest =>
              expressService.provideOrderItemIdentifiers(campaignId = campaignId, orderId = orderId, provideOrderItemIdentifiersRequest = provideOrderItemIdentifiersRequest)
            }
      }
    } ~
    path("businesses" / LongNumber / "bids") { (businessId) => 
      put {  
            entity(as[PutSkuBidsRequest]){ putSkuBidsRequest =>
              expressService.putBidsForBusiness(businessId = businessId, putSkuBidsRequest = putSkuBidsRequest)
            }
      }
    } ~
    path("campaigns" / LongNumber / "bids") { (campaignId) => 
      put {  
            entity(as[PutSkuBidsRequest]){ putSkuBidsRequest =>
              expressService.putBidsForCampaign(campaignId = campaignId, putSkuBidsRequest = putSkuBidsRequest)
            }
      }
    } ~
    path("campaigns" / LongNumber / "feeds" / LongNumber / "refresh") { (campaignId, feedId) => 
      post {  
            expressService.refreshFeed(campaignId = campaignId, feedId = feedId)
      }
    } ~
    path("regions" / LongNumber / "children") { (regionId) => 
      get { 
        parameters("page".as[Int].?(1), "pageSize".as[Int].?) { (page, pageSize) => 
            expressService.searchRegionChildren(regionId = regionId, page = page, pageSize = pageSize)
        }
      }
    } ~
    path("regions" / LongNumber) { (regionId) => 
      get {  
            expressService.searchRegionsById(regionId = regionId)
      }
    } ~
    path("regions") { 
      get { 
        parameters("name".as[String], "page_token".as[String].?, "limit".as[Int].?) { (name, pageToken, limit) => 
            expressService.searchRegionsByName(name = name, pageToken = pageToken, limit = limit)
        }
      }
    } ~
        ...
        formAndFiles(FileField("file")),  { partsAndFiles => 
          val _____ : Try[Route] = for {
            ...
            implicit val vp: StringValueProvider = partsAndFiles.form
              expressService.sendFileToChat(businessId = businessId, chatId = chatId, file = file)
            }
          }
      ...
      post { 
        parameters("chatId".as[Long]) { (chatId) => 
            entity(as[SendMessageToChatRequest]){ sendMessageToChatRequest =>
              expressService.sendMessageToChat(businessId = businessId, chatId = chatId, sendMessageToChatRequest = sendMessageToChatRequest)
            }
        }
      }
    } ~
    path("campaigns" / LongNumber / "feeds" / LongNumber / "params") { (campaignId, feedId) => 
      post {  
            entity(as[SetFeedParamsRequest]){ setFeedParamsRequest =>
              expressService.setFeedParams(campaignId = campaignId, feedId = feedId, setFeedParamsRequest = setFeedParamsRequest)
            }
      }
    } ~
    path("campaigns" / LongNumber / "orders" / LongNumber / "boxes") { (campaignId, orderId) => 
      put {  
            entity(as[SetOrderBoxLayoutRequest]){ setOrderBoxLayoutRequest =>
              expressService.setOrderBoxLayout(campaignId = campaignId, orderId = orderId, setOrderBoxLayoutRequest = setOrderBoxLayoutRequest)
            }
      }
    } ~
    path("campaigns" / LongNumber / "orders" / LongNumber / "delivery" / "shipments" / LongNumber / "boxes") { (campaignId, orderId, shipmentId) => 
      put {  
            entity(as[SetOrderShipmentBoxesRequest]){ setOrderShipmentBoxesRequest =>
              expressService.setOrderShipmentBoxes(campaignId = campaignId, orderId = orderId, shipmentId = shipmentId, setOrderShipmentBoxesRequest = setOrderShipmentBoxesRequest)
            }
      }
    } ~
    path("businesses" / LongNumber / "goods-feedback" / "skip-reaction") { (businessId) => 
      post {  
            entity(as[SkipGoodsFeedbackReactionRequest]){ skipGoodsFeedbackReactionRequest =>
              expressService.skipGoodsFeedbacksReaction(businessId = businessId, skipGoodsFeedbackReactionRequest = skipGoodsFeedbackReactionRequest)
            }
      }
    } ~
    path("businesses" / LongNumber / "offer-prices" / "updates") { (businessId) => 
      post {  
            entity(as[UpdateBusinessPricesRequest]){ updateBusinessPricesRequest =>
              expressService.updateBusinessPrices(businessId = businessId, updateBusinessPricesRequest = updateBusinessPricesRequest)
            }
      }
    } ~
    path("campaigns" / LongNumber / "offers" / "update") { (campaignId) => 
      post {  
            entity(as[UpdateCampaignOffersRequest]){ updateCampaignOffersRequest =>
              expressService.updateCampaignOffers(campaignId = campaignId, updateCampaignOffersRequest = updateCampaignOffersRequest)
            }
      }
    } ~
    path("businesses" / LongNumber / "goods-feedback" / "comments" / "update") { (businessId) => 
      post {  
            entity(as[UpdateGoodsFeedbackCommentRequest]){ updateGoodsFeedbackCommentRequest =>
              expressService.updateGoodsFeedbackComment(businessId = businessId, updateGoodsFeedbackCommentRequest = updateGoodsFeedbackCommentRequest)
            }
      }
    } ~
    path("businesses" / LongNumber / "offer-cards" / "update") { (businessId) => 
      post {  
            entity(as[UpdateOfferContentRequest]){ updateOfferContentRequest =>
              expressService.updateOfferContent(businessId = businessId, updateOfferContentRequest = updateOfferContentRequest)
            }
      }
    } ~
    path("campaigns" / LongNumber / "offer-mapping-entries" / "updates") { (campaignId) => 
      post {  
            entity(as[UpdateOfferMappingEntryRequest]){ updateOfferMappingEntryRequest =>
              expressService.updateOfferMappingEntries(campaignId = campaignId, updateOfferMappingEntryRequest = updateOfferMappingEntryRequest)
            }
      }
    } ~
    path("businesses" / LongNumber / "offer-mappings" / "update") { (businessId) => 
      post {  
            entity(as[UpdateOfferMappingsRequest]){ updateOfferMappingsRequest =>
              expressService.updateOfferMappings(businessId = businessId, updateOfferMappingsRequest = updateOfferMappingsRequest)
            }
      }
    } ~
    path("campaigns" / LongNumber / "orders" / LongNumber / "items") { (campaignId, orderId) => 
      put {  
            entity(as[UpdateOrderItemRequest]){ updateOrderItemRequest =>
              expressService.updateOrderItems(campaignId = campaignId, orderId = orderId, updateOrderItemRequest = updateOrderItemRequest)
            }
      }
    } ~
    path("campaigns" / LongNumber / "orders" / LongNumber / "status") { (campaignId, orderId) => 
      put {  
            entity(as[UpdateOrderStatusRequest]){ updateOrderStatusRequest =>
              expressService.updateOrderStatus(campaignId = campaignId, orderId = orderId, updateOrderStatusRequest = updateOrderStatusRequest)
            }
      }
    } ~
    path("campaigns" / LongNumber / "orders" / "status-update") { (campaignId) => 
      post {  
            entity(as[UpdateOrderStatusesRequest]){ updateOrderStatusesRequest =>
              expressService.updateOrderStatuses(campaignId = campaignId, updateOrderStatusesRequest = updateOrderStatusesRequest)
            }
      }
    } ~
    path("campaigns" / LongNumber / "offer-prices" / "updates") { (campaignId) => 
      post {  
            entity(as[UpdatePricesRequest]){ updatePricesRequest =>
              expressService.updatePrices(campaignId = campaignId, updatePricesRequest = updatePricesRequest)
            }
      }
    } ~
    path("businesses" / LongNumber / "promos" / "offers" / "update") { (businessId) => 
      post {  
            entity(as[UpdatePromoOffersRequest]){ updatePromoOffersRequest =>
              expressService.updatePromoOffers(businessId = businessId, updatePromoOffersRequest = updatePromoOffersRequest)
            }
      }
    } ~
    path("campaigns" / LongNumber / "offers" / "stocks") { (campaignId) => 
      put {  
            entity(as[UpdateStocksRequest]){ updateStocksRequest =>
              expressService.updateStocks(campaignId = campaignId, updateStocksRequest = updateStocksRequest)
            }
      }
    } ~
    path("campaigns" / LongNumber / "orders" / LongNumber / "verifyEac") { (campaignId, orderId) => 
      put {  
            entity(as[VerifyOrderEacRequest]){ verifyOrderEacRequest =>
              expressService.verifyOrderEac(campaignId = campaignId, orderId = orderId, verifyOrderEacRequest = verifyOrderEacRequest)
            }
      }
    }
}
