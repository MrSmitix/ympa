...
class DbsApi(implicit val swagger: Swagger) extends ScalatraServlet
  with FileUploadSupport
  with JacksonJsonSupport
  with SwaggerSupport {
  protected implicit val jsonFormats: Formats = DefaultFormats

  protected val applicationDescription: String = "DbsApi"
  ...
  val getDeliveryServicesOperation = (apiOperation[GetDeliveryServicesResponse]("getDeliveryServices")
    summary "Справочник служб доставки"
    parameters()
  )

  get("/delivery/services", operation(getDeliveryServicesOperation)) {
  }
  ...
  val getWarehousesOperation = (apiOperation[GetWarehousesResponse]("getWarehouses")
    summary "Список складов и групп складов"
    parameters(pathParam[Long]("businessId").description(""))
  )

  get("/businesses/:businessId/warehouses", operation(getWarehousesOperation)) {
    val businessId = params.getOrElse("businessId", halt(400))
    //println("businessId: " + businessId)
  }
