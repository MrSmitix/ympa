 ...
 * @param campaigns Список магазинов, в которых размещен товар.  for example: ''null''
 * @param sellingPrograms Информация о том, какие для товара доступны модели размещения.  for example: ''null''
 * @param archived Товар помещен в архив.  for example: ''null''
*/
final case class GetOfferDTO (
  offerId: String,
  ...
  purchasePrice: Option[GetPriceDTO] = None,
  additionalExpenses: Option[GetPriceDTO] = None,
  cofinancePrice: Option[GetPriceDTO] = None,
  cardStatus: Option[OfferCardStatusType] = None,
  campaigns: Option[Seq[OfferCampaignStatusDTO]] = None,
  sellingPrograms: Option[Seq[OfferSellingProgramDTO]] = None,
