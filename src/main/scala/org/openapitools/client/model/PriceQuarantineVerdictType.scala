...
object PriceQuarantineVerdictType extends Enumeration {
    type PriceQuarantineVerdictType = PriceQuarantineVerdictType.Value
    val PRICECHANGE = Value("PRICE_CHANGE")
    val LOWPRICE = Value("LOW_PRICE")
    val LOWPRICEPROMO = Value("LOW_PRICE_PROMO")
}
