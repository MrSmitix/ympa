...
object ShelfsStatisticsAttributionType extends Enumeration {
    type ShelfsStatisticsAttributionType = ShelfsStatisticsAttributionType.Value
    val CLICKS = Value("CLICKS")
    val SHOWS = Value("SHOWS")
}
