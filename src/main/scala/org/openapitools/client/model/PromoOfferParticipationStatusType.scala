...
object PromoOfferParticipationStatusType extends Enumeration {
    type PromoOfferParticipationStatusType = PromoOfferParticipationStatusType.Value
    val AUTO = Value("AUTO")
    val PARTIALLYAUTO = Value("PARTIALLY_AUTO")
    val MANUAL = Value("MANUAL")
    val NOTPARTICIPATING = Value("NOT_PARTICIPATING")
}
