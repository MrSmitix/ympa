...
object OfferCardRecommendationType extends Enumeration {
    type OfferCardRecommendationType = OfferCardRecommendationType.Value
    val HASVIDEO = Value("HAS_VIDEO")
    val RECOGNIZEDVENDOR = Value("RECOGNIZED_VENDOR")
    val MAIN = Value("MAIN")
    val ADDITIONAL = Value("ADDITIONAL")
    val DISTINCTIVE = Value("DISTINCTIVE")
    val FILTERABLE = Value("FILTERABLE")
    val PICTURECOUNT = Value("PICTURE_COUNT")
    val HASDESCRIPTION = Value("HAS_DESCRIPTION")
    val HASBARCODE = Value("HAS_BARCODE")
    val FIRSTPICTURESIZE = Value("FIRST_PICTURE_SIZE")
    val TITLELENGTH = Value("TITLE_LENGTH")
    val DESCRIPTIONLENGTH = Value("DESCRIPTION_LENGTH")
    val AVERAGEPICTURESIZE = Value("AVERAGE_PICTURE_SIZE")
    val FIRSTVIDEOSIZE = Value("FIRST_VIDEO_SIZE")
    val FIRSTVIDEOLENGTH = Value("FIRST_VIDEO_LENGTH")
    val AVERAGEVIDEOSIZE = Value("AVERAGE_VIDEO_SIZE")
    val VIDEOCOUNT = Value("VIDEO_COUNT")
}
