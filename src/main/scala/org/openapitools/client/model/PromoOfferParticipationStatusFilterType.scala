...
object PromoOfferParticipationStatusFilterType extends Enumeration {
    type PromoOfferParticipationStatusFilterType = PromoOfferParticipationStatusFilterType.Value
    val MANUALLYADDED = Value("MANUALLY_ADDED")
    val NOTMANUALLYADDED = Value("NOT_MANUALLY_ADDED")
}
