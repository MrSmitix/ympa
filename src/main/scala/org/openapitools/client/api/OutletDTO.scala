...
object OutletDTO {
  ...
  implicit val OutletDTOCodecJson: CodecJson[OutletDTO] = CodecJson.derive[OutletDTO]
  implicit val OutletDTODecoder: EntityDecoder[OutletDTO] = jsonOf[OutletDTO]
  implicit val OutletDTOEncoder: EntityEncoder[OutletDTO] = jsonEncoderOf[OutletDTO]
}
