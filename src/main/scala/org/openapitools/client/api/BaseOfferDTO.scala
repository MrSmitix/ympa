...
object BaseOfferDTO {
  ...
  implicit val BaseOfferDTOCodecJson: CodecJson[BaseOfferDTO] = CodecJson.derive[BaseOfferDTO]
  implicit val BaseOfferDTODecoder: EntityDecoder[BaseOfferDTO] = jsonOf[BaseOfferDTO]
  implicit val BaseOfferDTOEncoder: EntityEncoder[BaseOfferDTO] = jsonEncoderOf[BaseOfferDTO]
}
