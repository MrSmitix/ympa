...
object FullOutletLicenseDTO {
  ...
  implicit val FullOutletLicenseDTOCodecJson: CodecJson[FullOutletLicenseDTO] = CodecJson.derive[FullOutletLicenseDTO]
  implicit val FullOutletLicenseDTODecoder: EntityDecoder[FullOutletLicenseDTO] = jsonOf[FullOutletLicenseDTO]
  implicit val FullOutletLicenseDTOEncoder: EntityEncoder[FullOutletLicenseDTO] = jsonEncoderOf[FullOutletLicenseDTO]
}
