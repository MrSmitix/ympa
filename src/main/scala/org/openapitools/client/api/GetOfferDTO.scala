...
object GetOfferDTO {
  ...
  implicit val GetOfferDTOCodecJson: CodecJson[GetOfferDTO] = CodecJson.derive[GetOfferDTO]
  implicit val GetOfferDTODecoder: EntityDecoder[GetOfferDTO] = jsonOf[GetOfferDTO]
  implicit val GetOfferDTOEncoder: EntityEncoder[GetOfferDTO] = jsonEncoderOf[GetOfferDTO]
}
