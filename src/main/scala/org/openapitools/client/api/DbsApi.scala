...
class DbsApi(baseUrl: String) {
   ...
   */
  def acceptOrderCancellation(campaignId: Long, orderId: Long, acceptOrderCancellationRequest: AcceptOrderCancellationRequest): Request[Either[ResponseException[String, Exception], EmptyApiResponse]] =
    basicRequest
      .method(Method.PUT, uri"$baseUrl/campaigns/${campaignId}/orders/${orderId}/cancellation/accept")
   ...
   */
  def deleteOutletLicenses(campaignId: Long, ids: Set[Long]): Request[Either[ResponseException[String, Exception], EmptyApiResponse]] =
    basicRequest
   ...
   * @param ids Список идентификаторов лицензий.
   */
  def getOutletLicenses(campaignId: Long, outletIds: Set[Long], ids: Set[Long]): Request[Either[ResponseException[String, Exception], GetOutletLicensesResponse]] =
    basicRequest
   ...
   */
  def provideOrderDigitalCodes(campaignId: Long, orderId: Long, provideOrderDigitalCodesRequest: ProvideOrderDigitalCodesRequest): Request[Either[ResponseException[String, Exception], EmptyApiResponse]] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/campaigns/${campaignId}/orders/${orderId}/deliverDigitalGoods")
      .contentType("application/json")
   ...
   */
  def updateOutletLicenses(campaignId: Long, updateOutletLicenseRequest: UpdateOutletLicenseRequest): Request[Either[ResponseException[String, Exception], EmptyApiResponse]] =
    basicRequest
