...
object DbsApi {
  ...
  def apply(baseUrl: String = "https://api.partner.market.yandex.ru") = new DbsApi(baseUrl)
}

class DbsApi(baseUrl: String) {
   ...
   * 
   * Expected answers:
   *   code 200 : EmptyApiResponse (Ответ на отмену заказа был успешно передан.)
   ...
   */
  def acceptOrderCancellation(campaignId: Long, orderId: Long, acceptOrderCancellationRequest: AcceptOrderCancellationRequest): ApiRequest[EmptyApiResponse] =
    ApiRequest[EmptyApiResponse](ApiMethods.PUT, baseUrl, "/campaigns/{campaignId}/orders/{orderId}/cancellation/accept", "application/json")
      .withBody(acceptOrderCancellationRequest)
   ...
   */
  def createOutlet(campaignId: Long, changeOutletRequest: ChangeOutletRequest): ApiRequest[CreateOutletResponse] =
    ApiRequest[CreateOutletResponse](ApiMethods.POST, baseUrl, "/campaigns/{campaignId}/outlets", "application/json")
      .withBody(changeOutletRequest)
      .withPathParam("campaignId", campaignId)
      .withSuccessResponse[CreateOutletResponse](200)
      .withErrorResponse[ApiClientDataErrorResponse](400)
      .withErrorResponse[ApiUnauthorizedErrorResponse](401)
      .withErrorResponse[ApiForbiddenErrorResponse](403)
      .withErrorResponse[ApiNotFoundErrorResponse](404)
   ...
   */
  def deleteOutlet(campaignId: Long, outletId: Long): ApiRequest[EmptyApiResponse] =
    ApiRequest[EmptyApiResponse](ApiMethods.DELETE, baseUrl, "/campaigns/{campaignId}/outlets/{outletId}", "application/json")
      .withPathParam("campaignId", campaignId)
   ...
   */
  def generateMassOrderLabelsReport(generateMassOrderLabelsRequest: GenerateMassOrderLabelsRequest, format: Option[PageFormatType] = None): ApiRequest[GenerateReportResponse] =
    ApiRequest[GenerateReportResponse](ApiMethods.POST, baseUrl, "/reports/documents/labels/generate", "application/json")
      .withBody(generateMassOrderLabelsRequest)
      .withQueryParam("format", format)
      .withSuccessResponse[GenerateReportResponse](200)
      .withErrorResponse[ApiClientDataErrorResponse](400)
      .withErrorResponse[ApiUnauthorizedErrorResponse](401)
   ...
   */
  def generateOrderLabel(campaignId: Long, orderId: Long, shipmentId: Long, boxId: Long, format: Option[PageFormatType] = None): ApiRequest[File] =
    ApiRequest[File](ApiMethods.GET, baseUrl, "/campaigns/{campaignId}/orders/{orderId}/delivery/shipments/{shipmentId}/boxes/{boxId}/label", "application/json")
      .withQueryParam("format", format)
      .withPathParam("campaignId", campaignId)
      .withPathParam("orderId", orderId)
   ...
   * @param format Настройка размещения ярлыков на странице. Если параметра нет, возвращается PDF с ярлыками формата A6.
   */
  def generateOrderLabels(campaignId: Long, orderId: Long, format: Option[PageFormatType] = None): ApiRequest[File] =
    ApiRequest[File](ApiMethods.GET, baseUrl, "/campaigns/{campaignId}/orders/{orderId}/delivery/labels", "application/json")
      .withQueryParam("format", format)
      .withPathParam("campaignId", campaignId)
      .withPathParam("orderId", orderId)
      .withSuccessResponse[File](200)
   ...
   * @param orderId Идентификатор заказа.
   */
  def getOrderLabelsData(campaignId: Long, orderId: Long): ApiRequest[GetOrderLabelsDataResponse] =
    ApiRequest[GetOrderLabelsDataResponse](ApiMethods.GET, baseUrl, "/campaigns/{campaignId}/orders/{orderId}/delivery/labels/data", "application/json")
      .withPathParam("campaignId", campaignId)
      .withPathParam("orderId", orderId)
      .withSuccessResponse[GetOrderLabelsDataResponse](200)
      .withErrorResponse[ApiClientDataErrorResponse](400)
      .withErrorResponse[ApiUnauthorizedErrorResponse](401)
      .withErrorResponse[ApiForbiddenErrorResponse](403)
      .withErrorResponse[ApiNotFoundErrorResponse](404)
   ...
   * @param outletId Идентификатор точки продаж.
   */
  def getOutlet(campaignId: Long, outletId: Long): ApiRequest[GetOutletResponse] =
    ApiRequest[GetOutletResponse](ApiMethods.GET, baseUrl, "/campaigns/{campaignId}/outlets/{outletId}", "application/json")
      .withPathParam("campaignId", campaignId)
      .withPathParam("outletId", outletId)
      .withSuccessResponse[GetOutletResponse](200)
      .withErrorResponse[ApiClientDataErrorResponse](400)
      .withErrorResponse[ApiUnauthorizedErrorResponse](401)
      .withErrorResponse[ApiForbiddenErrorResponse](403)
      .withErrorResponse[ApiNotFoundErrorResponse](404)
   ...
   */
  def getOutlets(campaignId: Long, pageToken: Option[String] = None, regionId: Option[Long] = None, shopOutletCode: Option[String] = None, regionId2: Option[Long] = None): ApiRequest[GetOutletsResponse] =
    ApiRequest[GetOutletsResponse](ApiMethods.GET, baseUrl, "/campaigns/{campaignId}/outlets", "application/json")
      .withQueryParam("page_token", pageToken)
      .withQueryParam("region_id", regionId)
      .withQueryParam("shop_outlet_code", shopOutletCode)
      .withQueryParam("regionId", regionId2)
      .withPathParam("campaignId", campaignId)
      .withSuccessResponse[GetOutletsResponse](200)
      .withErrorResponse[ApiClientDataErrorResponse](400)
      .withErrorResponse[ApiUnauthorizedErrorResponse](401)
      .withErrorResponse[ApiForbiddenErrorResponse](403)
      .withErrorResponse[ApiNotFoundErrorResponse](404)
   ...
   */
  def provideOrderDigitalCodes(campaignId: Long, orderId: Long, provideOrderDigitalCodesRequest: ProvideOrderDigitalCodesRequest): ApiRequest[EmptyApiResponse] =
    ApiRequest[EmptyApiResponse](ApiMethods.POST, baseUrl, "/campaigns/{campaignId}/orders/{orderId}/deliverDigitalGoods", "application/json")
      .withBody(provideOrderDigitalCodesRequest)
      .withPathParam("campaignId", campaignId)
      .withPathParam("orderId", orderId)
      .withSuccessResponse[EmptyApiResponse](200)
      .withErrorResponse[ApiClientDataErrorResponse](400)
   ...
   */
  def provideOrderItemIdentifiers(campaignId: Long, orderId: Long, provideOrderItemIdentifiersRequest: ProvideOrderItemIdentifiersRequest): ApiRequest[ProvideOrderItemIdentifiersResponse] =
    ApiRequest[ProvideOrderItemIdentifiersResponse](ApiMethods.PUT, baseUrl, "/campaigns/{campaignId}/orders/{orderId}/identifiers", "application/json")
      .withBody(provideOrderItemIdentifiersRequest)
      .withPathParam("campaignId", campaignId)
      .withPathParam("orderId", orderId)
      .withSuccessResponse[ProvideOrderItemIdentifiersResponse](200)
      .withErrorResponse[ApiClientDataErrorResponse](400)
      .withErrorResponse[ApiUnauthorizedErrorResponse](401)
      .withErrorResponse[ApiForbiddenErrorResponse](403)
      .withErrorResponse[ApiNotFoundErrorResponse](404)
   ...
   */
  def setOrderBoxLayout(campaignId: Long, orderId: Long, setOrderBoxLayoutRequest: SetOrderBoxLayoutRequest): ApiRequest[SetOrderBoxLayoutResponse] =
    ApiRequest[SetOrderBoxLayoutResponse](ApiMethods.PUT, baseUrl, "/campaigns/{campaignId}/orders/{orderId}/boxes", "application/json")
      .withBody(setOrderBoxLayoutRequest)
      .withPathParam("campaignId", campaignId)
      .withPathParam("orderId", orderId)
      .withSuccessResponse[SetOrderBoxLayoutResponse](200)
      .withErrorResponse[ApiClientDataErrorResponse](400)
      .withErrorResponse[ApiUnauthorizedErrorResponse](401)
      .withErrorResponse[ApiForbiddenErrorResponse](403)
      .withErrorResponse[ApiNotFoundErrorResponse](404)
   ...
   */
  def setOrderShipmentBoxes(campaignId: Long, orderId: Long, shipmentId: Long, setOrderShipmentBoxesRequest: SetOrderShipmentBoxesRequest): ApiRequest[SetOrderShipmentBoxesResponse] =
    ApiRequest[SetOrderShipmentBoxesResponse](ApiMethods.PUT, baseUrl, "/campaigns/{campaignId}/orders/{orderId}/delivery/shipments/{shipmentId}/boxes", "application/json")
      .withBody(setOrderShipmentBoxesRequest)
      .withPathParam("campaignId", campaignId)
      .withPathParam("orderId", orderId)
      .withPathParam("shipmentId", shipmentId)
      .withSuccessResponse[SetOrderShipmentBoxesResponse](200)
      .withErrorResponse[ApiClientDataErrorResponse](400)
      .withErrorResponse[ApiUnauthorizedErrorResponse](401)
      .withErrorResponse[ApiForbiddenErrorResponse](403)
      .withErrorResponse[ApiNotFoundErrorResponse](404)
   ...
   */
  def updateOrderItems(campaignId: Long, orderId: Long, updateOrderItemRequest: UpdateOrderItemRequest): ApiRequest[Unit] =
    ApiRequest[Unit](ApiMethods.PUT, baseUrl, "/campaigns/{campaignId}/orders/{orderId}/items", "application/json")
      .withBody(updateOrderItemRequest)
      .withPathParam("campaignId", campaignId)
      .withPathParam("orderId", orderId)
   ...
   */
  def updateOrderStatus(campaignId: Long, orderId: Long, updateOrderStatusRequest: UpdateOrderStatusRequest): ApiRequest[UpdateOrderStatusResponse] =
    ApiRequest[UpdateOrderStatusResponse](ApiMethods.PUT, baseUrl, "/campaigns/{campaignId}/orders/{orderId}/status", "application/json")
      .withBody(updateOrderStatusRequest)
      .withPathParam("campaignId", campaignId)
      .withPathParam("orderId", orderId)
      .withSuccessResponse[UpdateOrderStatusResponse](200)
      .withErrorResponse[ApiClientDataErrorResponse](400)
      .withErrorResponse[ApiUnauthorizedErrorResponse](401)
      .withErrorResponse[ApiForbiddenErrorResponse](403)
      .withErrorResponse[ApiNotFoundErrorResponse](404)
   ...
   */
  def updateOrderStatuses(campaignId: Long, updateOrderStatusesRequest: UpdateOrderStatusesRequest): ApiRequest[UpdateOrderStatusesResponse] =
    ApiRequest[UpdateOrderStatusesResponse](ApiMethods.POST, baseUrl, "/campaigns/{campaignId}/orders/status-update", "application/json")
      .withBody(updateOrderStatusesRequest)
      .withPathParam("campaignId", campaignId)
      .withSuccessResponse[UpdateOrderStatusesResponse](200)
      .withErrorResponse[ApiClientDataErrorResponse](400)
      .withErrorResponse[ApiUnauthorizedErrorResponse](401)
      .withErrorResponse[ApiForbiddenErrorResponse](403)
      .withErrorResponse[ApiNotFoundErrorResponse](404)
   ...
   * @param changeOutletRequest 
   */
  def updateOutlet(campaignId: Long, outletId: Long, changeOutletRequest: ChangeOutletRequest): ApiRequest[EmptyApiResponse] =
    ApiRequest[EmptyApiResponse](ApiMethods.PUT, baseUrl, "/campaigns/{campaignId}/outlets/{outletId}", "application/json")
      .withBody(changeOutletRequest)
      .withPathParam("campaignId", campaignId)
      .withPathParam("outletId", outletId)
      .withSuccessResponse[EmptyApiResponse](200)
   ...
   */
  def updateStocks(campaignId: Long, updateStocksRequest: UpdateStocksRequest): ApiRequest[EmptyApiResponse] =
    ApiRequest[EmptyApiResponse](ApiMethods.PUT, baseUrl, "/campaigns/{campaignId}/offers/stocks", "application/json")
      .withBody(updateStocksRequest)
      .withPathParam("campaignId", campaignId)
      .withSuccessResponse[EmptyApiResponse](200)
      .withErrorResponse[ApiClientDataErrorResponse](400)
      .withErrorResponse[ApiUnauthorizedErrorResponse](401)
