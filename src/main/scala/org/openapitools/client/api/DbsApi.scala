...
class DbsApi(baseUrl: String) {
...
): Request[Either[ResponseException[String, Exception], CreateOutletResponse], Any] =
    basicRequest
   ...
   */
  def getModel(modelId: Long, regionId: Long, currency: Option[CurrencyType] = None
): Request[Either[ResponseException[String, Exception], GetModelsResponse], Any] =
    basicRequest
   ...
   * @param page Номер страницы результатов.  Значение по умолчанию: 1.  Используется вместе с параметром `page_size`.  `page_number` игнорируется, если задан `page_token`, `limit` или `offset`. 
   */
  def getModelOffers(modelId: Long, regionId: Long, currency: Option[CurrencyType] = None, orderByPrice: Option[SortOrderType] = None, count: Option[Int] = None, page: Option[Int] = None
): Request[Either[ResponseException[String, Exception], GetModelsOffersResponse], Any] =
    basicRequest
   ...
   * @param currency Валюта, в которой отображаются цены предложений на страницах с результатами поиска.  Возможные значения:  * `BYN` — белорусский рубль.  * `KZT` — казахстанский тенге.  * `RUR` — российский рубль.  * `UAH` — украинская гривна.  Значение по умолчанию: используется национальная валюта магазина (национальная валюта страны происхождения магазина). 
   */
  def getModels(regionId: Long, getModelsRequest: GetModelsRequest, currency: Option[CurrencyType] = None
): Request[Either[ResponseException[String, Exception], GetModelsResponse], Any] =
    basicRequest
   ...
   * @param orderByPrice Направление сортировки по цене.  Возможные значения: * `ASC` — сортировка по возрастанию. * `DESC` — сортировка по убыванию.  Значение по умолчанию: предложения выводятся в произвольном порядке. 
   */
  def getModelsOffers(regionId: Long, getModelsRequest: GetModelsRequest, currency: Option[CurrencyType] = None, orderByPrice: Option[SortOrderType] = None
): Request[Either[ResponseException[String, Exception], GetModelsOffersResponse], Any] =
    basicRequest
...
): Request[Either[ResponseException[String, Exception], GetOutletResponse], Any] =
    basicRequest
   ...
   */
  def getOutlets(campaignId: Long, pageToken: Option[String] = None, regionId: Option[Long] = None, shopOutletCode: Option[String] = None, regionId2: Option[Long] = None
): Request[Either[ResponseException[String, Exception], GetOutletsResponse], Any] =
    basicRequest
   ...
   * @param pageSize Размер страницы.  Используется вместе с параметром `page_number`.  `page_size` игнорируется, если задан `page_token`, `limit` или `offset`. 
   */
  def searchModels(query: String, regionId: Long, currency: Option[CurrencyType] = None, page: Option[Int] = None, pageSize: Option[Int] = None
): Request[Either[ResponseException[String, Exception], SearchModelsResponse], Any] =
    basicRequest
