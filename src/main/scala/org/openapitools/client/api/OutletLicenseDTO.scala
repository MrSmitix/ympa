...
object OutletLicenseDTO {
  ...
  implicit val OutletLicenseDTOCodecJson: CodecJson[OutletLicenseDTO] = CodecJson.derive[OutletLicenseDTO]
  implicit val OutletLicenseDTODecoder: EntityDecoder[OutletLicenseDTO] = jsonOf[OutletLicenseDTO]
  implicit val OutletLicenseDTOEncoder: EntityEncoder[OutletLicenseDTO] = jsonEncoderOf[OutletLicenseDTO]
}
