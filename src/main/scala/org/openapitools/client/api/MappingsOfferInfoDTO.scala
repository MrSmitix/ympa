...
object MappingsOfferInfoDTO {
  ...
  implicit val MappingsOfferInfoDTOCodecJson: CodecJson[MappingsOfferInfoDTO] = CodecJson.derive[MappingsOfferInfoDTO]
  implicit val MappingsOfferInfoDTODecoder: EntityDecoder[MappingsOfferInfoDTO] = jsonOf[MappingsOfferInfoDTO]
  implicit val MappingsOfferInfoDTOEncoder: EntityEncoder[MappingsOfferInfoDTO] = jsonEncoderOf[MappingsOfferInfoDTO]
}
