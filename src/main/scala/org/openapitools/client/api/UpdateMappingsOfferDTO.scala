...
import UpdateMappingsOfferDTO._
...
object UpdateMappingsOfferDTO {
  ...
  implicit val UpdateMappingsOfferDTOCodecJson: CodecJson[UpdateMappingsOfferDTO] = CodecJson.derive[UpdateMappingsOfferDTO]
  implicit val UpdateMappingsOfferDTODecoder: EntityDecoder[UpdateMappingsOfferDTO] = jsonOf[UpdateMappingsOfferDTO]
  implicit val UpdateMappingsOfferDTOEncoder: EntityEncoder[UpdateMappingsOfferDTO] = jsonEncoderOf[UpdateMappingsOfferDTO]
}
