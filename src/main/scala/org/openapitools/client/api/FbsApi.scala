...
class FbsApi(baseUrl: String) {
   ...
   */
  def confirmShipment(campaignId: Long, shipmentId: Long, confirmShipmentRequest: Option[ConfirmShipmentRequest] = None): ApiRequest[EmptyApiResponse] =
    ApiRequest[EmptyApiResponse](ApiMethods.POST, baseUrl, "/campaigns/{campaignId}/first-mile/shipments/{shipmentId}/confirm", "application/json")
      .withBody(confirmShipmentRequest)
      .withPathParam("campaignId", campaignId)
   ...
   * @param shipmentId Идентификатор отгрузки.
   */
  def downloadShipmentAct(campaignId: Long, shipmentId: Long): ApiRequest[File] =
    ApiRequest[File](ApiMethods.GET, baseUrl, "/campaigns/{campaignId}/first-mile/shipments/{shipmentId}/act", "application/json")
      .withPathParam("campaignId", campaignId)
      .withPathParam("shipmentId", shipmentId)
   ...
   * @param shipmentId Идентификатор отгрузки.
   */
  def downloadShipmentDiscrepancyAct(campaignId: Long, shipmentId: Long): ApiRequest[File] =
    ApiRequest[File](ApiMethods.GET, baseUrl, "/campaigns/{campaignId}/first-mile/shipments/{shipmentId}/discrepancy-act", "application/json")
      .withPathParam("campaignId", campaignId)
      .withPathParam("shipmentId", shipmentId)
      .withSuccessResponse[File](200)
      .withErrorResponse[ApiClientDataErrorResponse](400)
   ...
   * @param shipmentId Идентификатор отгрузки.
   */
  def downloadShipmentInboundAct(campaignId: Long, shipmentId: Long): ApiRequest[File] =
    ApiRequest[File](ApiMethods.GET, baseUrl, "/campaigns/{campaignId}/first-mile/shipments/{shipmentId}/inbound-act", "application/json")
      .withPathParam("campaignId", campaignId)
      .withPathParam("shipmentId", shipmentId)
      .withSuccessResponse[File](200)
      .withErrorResponse[ApiClientDataErrorResponse](400)
   ...
   */
  def downloadShipmentPalletLabels(campaignId: Long, shipmentId: Long, format: Option[ShipmentPalletLabelPageFormatType] = None): ApiRequest[File] =
    ApiRequest[File](ApiMethods.GET, baseUrl, "/campaigns/{campaignId}/first-mile/shipments/{shipmentId}/pallet/labels", "application/json")
   ...
   */
  def downloadShipmentReceptionTransferAct(campaignId: Long, warehouseId: Option[Int] = None): ApiRequest[File] =
    ApiRequest[File](ApiMethods.GET, baseUrl, "/campaigns/{campaignId}/shipments/reception-transfer-act", "application/json")
   ...
   * @param shipmentId Идентификатор отгрузки.
   */
  def downloadShipmentTransportationWaybill(campaignId: Long, shipmentId: Long): ApiRequest[File] =
    ApiRequest[File](ApiMethods.GET, baseUrl, "/campaigns/{campaignId}/first-mile/shipments/{shipmentId}/transportation-waybill", "application/json")
      .withPathParam("campaignId", campaignId)
      .withPathParam("shipmentId", shipmentId)
      .withSuccessResponse[File](200)
      .withErrorResponse[ApiClientDataErrorResponse](400)
   ...
   */
  def generateShipmentListDocumentReport(generateShipmentListDocumentReportRequest: GenerateShipmentListDocumentReportRequest): ApiRequest[GenerateReportResponse] =
    ApiRequest[GenerateReportResponse](ApiMethods.POST, baseUrl, "/reports/documents/shipment-list/generate", "application/json")
      .withBody(generateShipmentListDocumentReportRequest)
      .withSuccessResponse[GenerateReportResponse](200)
      .withErrorResponse[ApiClientDataErrorResponse](400)
      .withErrorResponse[ApiUnauthorizedErrorResponse](401)
      .withErrorResponse[ApiForbiddenErrorResponse](403)
   ...
   */
  def getShipment(campaignId: Long, shipmentId: Long, cancelledOrders: Option[Boolean] = None): ApiRequest[GetShipmentResponse] =
    ApiRequest[GetShipmentResponse](ApiMethods.GET, baseUrl, "/campaigns/{campaignId}/first-mile/shipments/{shipmentId}", "application/json")
      .withQueryParam("cancelledOrders", cancelledOrders)
      .withPathParam("campaignId", campaignId)
      .withPathParam("shipmentId", shipmentId)
      .withSuccessResponse[GetShipmentResponse](200)
      .withErrorResponse[ApiClientDataErrorResponse](400)
      .withErrorResponse[ApiUnauthorizedErrorResponse](401)
      .withErrorResponse[ApiForbiddenErrorResponse](403)
      .withErrorResponse[ApiNotFoundErrorResponse](404)
   ...
   * @param shipmentId Идентификатор отгрузки.
   */
  def getShipmentOrdersInfo(campaignId: Long, shipmentId: Long): ApiRequest[GetShipmentOrdersInfoResponse] =
    ApiRequest[GetShipmentOrdersInfoResponse](ApiMethods.GET, baseUrl, "/campaigns/{campaignId}/first-mile/shipments/{shipmentId}/orders/info", "application/json")
      .withPathParam("campaignId", campaignId)
      .withPathParam("shipmentId", shipmentId)
      .withSuccessResponse[GetShipmentOrdersInfoResponse](200)
      .withErrorResponse[ApiClientDataErrorResponse](400)
      .withErrorResponse[ApiUnauthorizedErrorResponse](401)
      .withErrorResponse[ApiForbiddenErrorResponse](403)
      .withErrorResponse[ApiNotFoundErrorResponse](404)
   ...
   * @param limit Количество значений на одной странице. 
   */
  def searchShipments(campaignId: Long, searchShipmentsRequest: SearchShipmentsRequest, pageToken: Option[String] = None, limit: Option[Int] = None): ApiRequest[SearchShipmentsResponse] =
    ApiRequest[SearchShipmentsResponse](ApiMethods.PUT, baseUrl, "/campaigns/{campaignId}/first-mile/shipments", "application/json")
      .withBody(searchShipmentsRequest)
      .withQueryParam("page_token", pageToken)
      .withQueryParam("limit", limit)
      .withPathParam("campaignId", campaignId)
      .withSuccessResponse[SearchShipmentsResponse](200)
      .withErrorResponse[ApiClientDataErrorResponse](400)
      .withErrorResponse[ApiUnauthorizedErrorResponse](401)
      .withErrorResponse[ApiForbiddenErrorResponse](403)
      .withErrorResponse[ApiNotFoundErrorResponse](404)
   ...
   */
  def setShipmentPalletsCount(campaignId: Long, shipmentId: Long, setShipmentPalletsCountRequest: SetShipmentPalletsCountRequest): ApiRequest[EmptyApiResponse] =
    ApiRequest[EmptyApiResponse](ApiMethods.PUT, baseUrl, "/campaigns/{campaignId}/first-mile/shipments/{shipmentId}/pallets", "application/json")
      .withBody(setShipmentPalletsCountRequest)
      .withPathParam("campaignId", campaignId)
      .withPathParam("shipmentId", shipmentId)
      .withSuccessResponse[EmptyApiResponse](200)
      .withErrorResponse[ApiClientDataErrorResponse](400)
   ...
   */
  def transferOrdersFromShipment(campaignId: Long, shipmentId: Long, transferOrdersFromShipmentRequest: TransferOrdersFromShipmentRequest): ApiRequest[EmptyApiResponse] =
    ApiRequest[EmptyApiResponse](ApiMethods.POST, baseUrl, "/campaigns/{campaignId}/first-mile/shipments/{shipmentId}/orders/transfer", "application/json")
      .withBody(transferOrdersFromShipmentRequest)
      .withPathParam("campaignId", campaignId)
      .withPathParam("shipmentId", shipmentId)
      .withSuccessResponse[EmptyApiResponse](200)
      .withErrorResponse[ApiClientDataErrorResponse](400)
