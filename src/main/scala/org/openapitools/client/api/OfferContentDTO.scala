...
object OfferContentDTO {
  ...
  implicit val OfferContentDTOCodecJson: CodecJson[OfferContentDTO] = CodecJson.derive[OfferContentDTO]
  implicit val OfferContentDTODecoder: EntityDecoder[OfferContentDTO] = jsonOf[OfferContentDTO]
  implicit val OfferContentDTOEncoder: EntityEncoder[OfferContentDTO] = jsonEncoderOf[OfferContentDTO]
}
