...
object UpdateOfferDTO {
  ...
  implicit val UpdateOfferDTOCodecJson: CodecJson[UpdateOfferDTO] = CodecJson.derive[UpdateOfferDTO]
  implicit val UpdateOfferDTODecoder: EntityDecoder[UpdateOfferDTO] = jsonOf[UpdateOfferDTO]
  implicit val UpdateOfferDTOEncoder: EntityEncoder[UpdateOfferDTO] = jsonEncoderOf[UpdateOfferDTO]
}
