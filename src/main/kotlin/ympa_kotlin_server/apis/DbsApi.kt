...
import ympa_kotlin_server.models.GetOrderBuyerInfoResponse
...
import ympa_kotlin_server.models.SetOrderDeliveryDateRequest
import ympa_kotlin_server.models.SetOrderDeliveryTrackCodeRequest
...
import ympa_kotlin_server.models.UpdateOrderStorageLimitRequest
...
fun Route.DbsApi() {
    ...
    authenticate("OAuth") {
    put<Paths.setOrderDeliveryDate> {
    ...
    authenticate("OAuth") {
    post<Paths.setOrderDeliveryTrackCode> {
    ...
    authenticate("OAuth") {
    put<Paths.updateOrderStorageLimit> {
