...
enum class ReturnDecisionType(val value: kotlin.String) {
    ...
    companion object {
         ...
         */
        fun encode(data: kotlin.Any?): kotlin.String? = if (data is ReturnDecisionType) "$data" else null

        /**
         * Returns a valid [ReturnDecisionType] for [data], null otherwise.
         */
        fun decode(data: kotlin.Any?): ReturnDecisionType? = data?.let {
