...
data class UpdateOfferDTO(
    ...
    val basicPrice: UpdatePriceWithDiscountDTO? = null,

    @field:JsonProperty("purchasePrice")
    val purchasePrice: BasePriceDTO? = null,

    @field:JsonProperty("additionalExpenses")
    val additionalExpenses: BasePriceDTO? = null,

    @field:JsonProperty("cofinancePrice")
    val cofinancePrice: BasePriceDTO? = null,
