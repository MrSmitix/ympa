 ...
 */
object ChannelTypes : BaseTable<ChannelType>("ChannelType") {

    /**
     * Create an entity of type ChannelType from the model
     */
    override fun doCreateEntity(row: QueryRowSet, withReferences: Boolean) = ChannelType(
    )

    /**
    * Assign all the columns from the entity of type ChannelType to the DML expression.
    *
    * Usage:
    *
    * ```kotlin
    * let entity = ChannelType()
    * database.update(ChannelTypes, {
    *     assignFrom(entity)
    * })
    * ```
    * @return the builder with the columns for the update or insert.
    */
    fun AssignmentsBuilder.assignFrom(entity: ChannelType) {
        this.apply {
        }
    }
