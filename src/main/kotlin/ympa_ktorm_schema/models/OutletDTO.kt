 ...
 */
object OutletDTOs : BaseTable<OutletDTO>("OutletDTO") {
    ...
    /**
     * Create an entity of type OutletDTO from the model
     */
    override fun doCreateEntity(row: QueryRowSet, withReferences: Boolean) = OutletDTO(
    ...
    /**
    * Assign all the columns from the entity of type OutletDTO to the DML expression.
    *
    * Usage:
    *
    * ```kotlin
    * let entity = OutletDTO()
    * database.update(OutletDTOs, {
    *     assignFrom(entity)
    * })
    * ```
    * @return the builder with the columns for the update or insert.
    */
    fun AssignmentsBuilder.assignFrom(entity: OutletDTO) {
        this.apply {
            set(OutletDTOs.name, entity.name)
            set(OutletDTOs.type, entity.type)
            set(OutletDTOs.address, entity.address)
            set(OutletDTOs.workingSchedule, entity.workingSchedule)
            set(OutletDTOs.coords, entity.coords)
            set(OutletDTOs.isMain, entity.isMain)
            set(OutletDTOs.shopOutletCode, entity.shopOutletCode)
            set(OutletDTOs.visibility, entity.visibility)
            set(OutletDTOs.storagePeriod, entity.storagePeriod)
        }
    }
...
object OutletDTOPhones : BaseTable<Pair<kotlin.Long, kotlin.String>>("OutletDTOPhones") {
    val outletDTO = long("outletDTO")
    val phones = text("phones")

    override fun doCreateEntity(row: QueryRowSet, withReferences: Boolean): Pair<kotlin.Long, kotlin.String> =
        Pair(row[outletDTO] ?: 0, row[phones] ?: "")

    fun AssignmentsBuilder.assignFrom(entity: Pair<kotlin.Long, kotlin.String>) {
        this.apply {
            set(OutletDTOPhones.outletDTO, entity.first)
            set(OutletDTOPhones.phones, entity.second)
        }
    }

}

object OutletDTOOutletDeliveryRuleDTO : BaseTable<Pair<kotlin.Long, kotlin.Long>>("OutletDTOOutletDeliveryRuleDTO") {
    val outletDTO = long("outletDTO")
    val outletDeliveryRuleDTO = long("outletDeliveryRuleDTO")

    override fun doCreateEntity(row: QueryRowSet, withReferences: Boolean): Pair<kotlin.Long, kotlin.Long> =
        Pair(row[outletDTO] ?: 0, row[outletDeliveryRuleDTO] ?: 0)

    fun AssignmentsBuilder.assignFrom(entity: Pair<kotlin.Long, kotlin.Long>) {
        this.apply {
            set(OutletDTOOutletDeliveryRuleDTO.outletDTO, entity.first)
            set(OutletDTOOutletDeliveryRuleDTO.outletDeliveryRuleDTO, entity.second)
        }
    }
