 ...
 */
object MappingsOfferInfoDTOs : BaseTable<MappingsOfferInfoDTO>("MappingsOfferInfoDTO") {
    ...
    /**
     * Create an entity of type MappingsOfferInfoDTO from the model
     */
    override fun doCreateEntity(row: QueryRowSet, withReferences: Boolean) = MappingsOfferInfoDTO(
    ...
    /**
    * Assign all the columns from the entity of type MappingsOfferInfoDTO to the DML expression.
    *
    * Usage:
    *
    * ```kotlin
    * let entity = MappingsOfferInfoDTO()
    * database.update(MappingsOfferInfoDTOs, {
    *     assignFrom(entity)
    * })
    * ```
    * @return the builder with the columns for the update or insert.
    */
    fun AssignmentsBuilder.assignFrom(entity: MappingsOfferInfoDTO) {
        this.apply {
            set(MappingsOfferInfoDTOs.name, entity.name)
            set(MappingsOfferInfoDTOs.shopSku, entity.shopSku)
            set(MappingsOfferInfoDTOs.category, entity.category)
            set(MappingsOfferInfoDTOs.vendor, entity.vendor)
            set(MappingsOfferInfoDTOs.vendorCode, entity.vendorCode)
            set(MappingsOfferInfoDTOs.description, entity.description)
            set(MappingsOfferInfoDTOs.id, entity.id)
            set(MappingsOfferInfoDTOs.feedId, entity.feedId)
            set(MappingsOfferInfoDTOs.manufacturer, entity.manufacturer)
            set(MappingsOfferInfoDTOs.minShipment, entity.minShipment)
            set(MappingsOfferInfoDTOs.transportUnitSize, entity.transportUnitSize)
            set(MappingsOfferInfoDTOs.quantumOfSupply, entity.quantumOfSupply)
            set(MappingsOfferInfoDTOs.deliveryDurationDays, entity.deliveryDurationDays)
            set(MappingsOfferInfoDTOs.boxCount, entity.boxCount)
            set(MappingsOfferInfoDTOs.weightDimensions, entity.weightDimensions)
            set(MappingsOfferInfoDTOs.shelfLifeDays, entity.shelfLifeDays)
            set(MappingsOfferInfoDTOs.lifeTimeDays, entity.lifeTimeDays)
            set(MappingsOfferInfoDTOs.guaranteePeriodDays, entity.guaranteePeriodDays)
            set(MappingsOfferInfoDTOs.processingState, entity.processingState)
            set(MappingsOfferInfoDTOs.availability, entity.availability)
            set(MappingsOfferInfoDTOs.shelfLife, entity.shelfLife)
            set(MappingsOfferInfoDTOs.lifeTime, entity.lifeTime)
            set(MappingsOfferInfoDTOs.guaranteePeriod, entity.guaranteePeriod)
            set(MappingsOfferInfoDTOs.certificate, entity.certificate)
        }
    }
...
object MappingsOfferInfoDTOBarcodes : BaseTable<Pair<kotlin.Long, kotlin.String>>("MappingsOfferInfoDTOBarcodes") {
    val mappingsOfferInfoDTO = long("mappingsOfferInfoDTO")
    val barcodes = text("barcodes")

    override fun doCreateEntity(row: QueryRowSet, withReferences: Boolean): Pair<kotlin.Long, kotlin.String> =
        Pair(row[mappingsOfferInfoDTO] ?: 0, row[barcodes] ?: "")

    fun AssignmentsBuilder.assignFrom(entity: Pair<kotlin.Long, kotlin.String>) {
        this.apply {
            set(MappingsOfferInfoDTOBarcodes.mappingsOfferInfoDTO, entity.first)
            set(MappingsOfferInfoDTOBarcodes.barcodes, entity.second)
        }
    }

}

object MappingsOfferInfoDTOUrls : BaseTable<Pair<kotlin.Long, kotlin.String>>("MappingsOfferInfoDTOUrls") {
    val mappingsOfferInfoDTO = long("mappingsOfferInfoDTO")
    val urls = text("urls")

    override fun doCreateEntity(row: QueryRowSet, withReferences: Boolean): Pair<kotlin.Long, kotlin.String> =
        Pair(row[mappingsOfferInfoDTO] ?: 0, row[urls] ?: "")

    fun AssignmentsBuilder.assignFrom(entity: Pair<kotlin.Long, kotlin.String>) {
        this.apply {
            set(MappingsOfferInfoDTOUrls.mappingsOfferInfoDTO, entity.first)
            set(MappingsOfferInfoDTOUrls.urls, entity.second)
        }
    }

}

object MappingsOfferInfoDTOPictures : BaseTable<Pair<kotlin.Long, kotlin.String>>("MappingsOfferInfoDTOPictures") {
    val mappingsOfferInfoDTO = long("mappingsOfferInfoDTO")
    val pictures = text("pictures")

    override fun doCreateEntity(row: QueryRowSet, withReferences: Boolean): Pair<kotlin.Long, kotlin.String> =
        Pair(row[mappingsOfferInfoDTO] ?: 0, row[pictures] ?: "")

    fun AssignmentsBuilder.assignFrom(entity: Pair<kotlin.Long, kotlin.String>) {
        this.apply {
            set(MappingsOfferInfoDTOPictures.mappingsOfferInfoDTO, entity.first)
            set(MappingsOfferInfoDTOPictures.pictures, entity.second)
        }
    }

}

object MappingsOfferInfoDTOManufacturerCountries : BaseTable<Pair<kotlin.Long, kotlin.String>>("MappingsOfferInfoDTOManufacturerCountries") {
    val mappingsOfferInfoDTO = long("mappingsOfferInfoDTO")
    val manufacturerCountries = text("manufacturerCountries")

    override fun doCreateEntity(row: QueryRowSet, withReferences: Boolean): Pair<kotlin.Long, kotlin.String> =
        Pair(row[mappingsOfferInfoDTO] ?: 0, row[manufacturerCountries] ?: "")

    fun AssignmentsBuilder.assignFrom(entity: Pair<kotlin.Long, kotlin.String>) {
        this.apply {
            set(MappingsOfferInfoDTOManufacturerCountries.mappingsOfferInfoDTO, entity.first)
            set(MappingsOfferInfoDTOManufacturerCountries.manufacturerCountries, entity.second)
        }
    }

}

object MappingsOfferInfoDTOCustomsCommodityCodes : BaseTable<Pair<kotlin.Long, kotlin.String>>("MappingsOfferInfoDTOCustomsCommodityCodes") {
    val mappingsOfferInfoDTO = long("mappingsOfferInfoDTO")
    val customsCommodityCodes = text("customsCommodityCodes")

    override fun doCreateEntity(row: QueryRowSet, withReferences: Boolean): Pair<kotlin.Long, kotlin.String> =
        Pair(row[mappingsOfferInfoDTO] ?: 0, row[customsCommodityCodes] ?: "")

    fun AssignmentsBuilder.assignFrom(entity: Pair<kotlin.Long, kotlin.String>) {
        this.apply {
            set(MappingsOfferInfoDTOCustomsCommodityCodes.mappingsOfferInfoDTO, entity.first)
            set(MappingsOfferInfoDTOCustomsCommodityCodes.customsCommodityCodes, entity.second)
        }
    }

}

object MappingsOfferInfoDTODayOfWeekType : BaseTable<Pair<kotlin.Long, kotlin.Long>>("MappingsOfferInfoDTODayOfWeekType") {
    val mappingsOfferInfoDTO = long("mappingsOfferInfoDTO")
    val dayOfWeekType = long("dayOfWeekType")

    override fun doCreateEntity(row: QueryRowSet, withReferences: Boolean): Pair<kotlin.Long, kotlin.Long> =
        Pair(row[mappingsOfferInfoDTO] ?: 0, row[dayOfWeekType] ?: 0)

    fun AssignmentsBuilder.assignFrom(entity: Pair<kotlin.Long, kotlin.Long>) {
        this.apply {
            set(MappingsOfferInfoDTODayOfWeekType.mappingsOfferInfoDTO, entity.first)
            set(MappingsOfferInfoDTODayOfWeekType.dayOfWeekType, entity.second)
        }
    }
