...
import ympa_kotlin_vertx_server.models.AgeDTO
import ympa_kotlin_vertx_server.models.GetPriceDTO
import ympa_kotlin_vertx_server.models.GetPriceWithDiscountDTO
import ympa_kotlin_vertx_server.models.OfferCampaignStatusDTO
import ympa_kotlin_vertx_server.models.OfferCardStatusType
import ympa_kotlin_vertx_server.models.OfferConditionDTO
import ympa_kotlin_vertx_server.models.OfferManualDTO
import ympa_kotlin_vertx_server.models.OfferParamDTO
import ympa_kotlin_vertx_server.models.OfferSellingProgramDTO
import ympa_kotlin_vertx_server.models.OfferType
import ympa_kotlin_vertx_server.models.OfferWeightDimensionsDTO
import ympa_kotlin_vertx_server.models.TimePeriodDTO
...
data class GetOfferDTO (
    ...
    val manuals: kotlin.Array<OfferManualDTO>? = null,
    /* Название бренда или производителя. Должно быть записано так, как его пишет сам бренд. */
    val vendor: kotlin.String? = null,
    /* Указывайте в виде последовательности цифр. Подойдут коды EAN-13, EAN-8, UPC-A, UPC-E или Code 128.  Для книг указывайте ISBN.  Для товаров [определенных категорий и торговых марок](https://yastatic.net/s3/doc-binary/src/support/market/ru/yandex-market-list-for-gtin.xlsx) штрихкод должен быть действительным кодом GTIN. Обратите внимание: внутренние штрихкоды, начинающиеся на 2 или 02, и коды формата Code 128 не являются GTIN.  [Что такое GTIN](*gtin)   */
    val barcodes: kotlin.Array<kotlin.String>? = null,
    ...
    val manufacturerCountries: kotlin.Array<kotlin.String>? = null,
    ...
    val certificates: kotlin.Array<kotlin.String>? = null,
    ...
    val params: kotlin.Array<OfferParamDTO>? = null,
    ...
    val campaigns: kotlin.Array<OfferCampaignStatusDTO>? = null,
    /* Информация о том, какие для товара доступны модели размещения.  */
    val sellingPrograms: kotlin.Array<OfferSellingProgramDTO>? = null,
