...
import ympa_kotlin_vertx_server.models.GetChatInfoDTO
...
data class GetChatsInfoDTO (
    /* Информация о чатах. */
    @SerializedName("chats") private val _chats: kotlin.Array<GetChatInfoDTO>?,
    val paging: ForwardScrollingPagerDTO? = null
) {

        val chats get() = _chats ?: throw IllegalArgumentException("chats is required")
