...
import ympa_kotlin_vertx_server.models.OfferProcessingStateDTO
...
data class UpdateMappingsOfferDTO (
    ...
    val urls: kotlin.Array<kotlin.String>? = null,
    ...
    val customsCommodityCodes: kotlin.Array<kotlin.String>? = null,
    val weightDimensions: OfferWeightDimensionsDTO? = null,
    /* Дни недели, в которые продавец поставляет товары на склад. */
    val supplyScheduleDays: kotlin.Array<DayOfWeekType>? = null,
