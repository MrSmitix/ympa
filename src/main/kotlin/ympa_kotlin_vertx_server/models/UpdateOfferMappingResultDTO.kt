...
import ympa_kotlin_vertx_server.models.OfferMappingErrorDTO
...
data class UpdateOfferMappingResultDTO (
    ...
    val errors: kotlin.Array<OfferMappingErrorDTO>? = null,
    /* Предупреждения — информация в каталоге обновится. */
    val warnings: kotlin.Array<OfferMappingErrorDTO>? = null
) {
