...
import ympa_kotlin_vertx_server.models.OfferContentErrorDTO
...
data class UpdateOfferContentResultDTO (
    ...
    val errors: kotlin.Array<OfferContentErrorDTO>? = null,
    /* Предупреждения — информация в каталоге обновится. */
    val warnings: kotlin.Array<OfferContentErrorDTO>? = null
) {
