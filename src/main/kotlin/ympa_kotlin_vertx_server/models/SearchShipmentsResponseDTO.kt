...
import ympa_kotlin_vertx_server.models.ShipmentInfoDTO
...
data class SearchShipmentsResponseDTO (
    ...
    @SerializedName("shipments") private val _shipments: kotlin.Array<ShipmentInfoDTO>?,
    val paging: ForwardScrollingPagerDTO? = null
) {

        val shipments get() = _shipments ?: throw IllegalArgumentException("shipments is required")
