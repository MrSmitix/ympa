...
class TariffsApiVertxProxyHandler(private val vertx: Vertx, private val service: TariffsApi, topLevel: Boolean, private val timeoutSeconds: Long) : ProxyHandler() {
