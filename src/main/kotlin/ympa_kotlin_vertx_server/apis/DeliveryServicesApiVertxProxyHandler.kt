...
class DeliveryServicesApiVertxProxyHandler(private val vertx: Vertx, private val service: DeliveryServicesApi, topLevel: Boolean, private val timeoutSeconds: Long) : ProxyHandler() {
