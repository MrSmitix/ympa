...
class DbsApiVertxProxyHandler(private val vertx: Vertx, private val service: DbsApi, topLevel: Boolean, private val timeoutSeconds: Long) : ProxyHandler() {
        ...
        try {
            ...
            when (action) {
                ...
                "createOutlet" -> {
                    ...
                    val changeOutletRequestParam = ApiHandlerUtils.searchJsonObjectInJson(params,"body")
                    if (changeOutletRequestParam == null) {
                        throw IllegalArgumentException("changeOutletRequest is required")
                    }
                    val changeOutletRequest = Gson().fromJson(changeOutletRequestParam.encode(), ChangeOutletRequest::class.java)
                    GlobalScope.launch(vertx.dispatcher()){
                        val result = service.createOutlet(campaignId,changeOutletRequest,context)
                        val payload = JsonObject(Json.encode(result.payload)).toBuffer()
                        val res = OperationResponse(result.statusCode,result.statusMessage,payload,result.headers)
                        msg.reply(res.toJson())
                    }.invokeOnCompletion{
                ...
                "deleteOutlet" -> {
                    ...
                    val outletId = ApiHandlerUtils.searchLongInJson(params,"outletId")
                    if(outletId == null){
                        throw IllegalArgumentException("outletId is required")
                    }
                    GlobalScope.launch(vertx.dispatcher()){
                        val result = service.deleteOutlet(campaignId,outletId,context)
                        val payload = JsonObject(Json.encode(result.payload)).toBuffer()
                        val res = OperationResponse(result.statusCode,result.statusMessage,payload,result.headers)
                        msg.reply(res.toJson())
                    }.invokeOnCompletion{
                ...
                "generateOrderLabel" -> {
                    ...
                    val boxId = ApiHandlerUtils.searchLongInJson(params,"boxId")
                    if(boxId == null){
                        throw IllegalArgumentException("boxId is required")
                    }
                    val formatParam = ApiHandlerUtils.searchJsonObjectInJson(params,"format")
                    val format = if(formatParam ==null) null else Gson().fromJson(formatParam.encode(), PageFormatType::class.java)
                    GlobalScope.launch(vertx.dispatcher()){
                        val result = service.generateOrderLabel(campaignId,orderId,shipmentId,boxId,format,context)
                        val payload = JsonObject(Json.encode(result.payload)).toBuffer()
                        val res = OperationResponse(result.statusCode,result.statusMessage,payload,result.headers)
                        msg.reply(res.toJson())
                    }.invokeOnCompletion{
                ...
                "generateOrderLabels" -> {
                    ...
                    val format = if(formatParam ==null) null else Gson().fromJson(formatParam.encode(), PageFormatType::class.java)
                    GlobalScope.launch(vertx.dispatcher()){
                        val result = service.generateOrderLabels(campaignId,orderId,format,context)
                        val payload = JsonObject(Json.encode(result.payload)).toBuffer()
                        val res = OperationResponse(result.statusCode,result.statusMessage,payload,result.headers)
                        msg.reply(res.toJson())
                    }.invokeOnCompletion{
                ...
                "getOrderLabelsData" -> {
                    ...
                    GlobalScope.launch(vertx.dispatcher()){
                        val result = service.getOrderLabelsData(campaignId,orderId,context)
                        val payload = JsonObject(Json.encode(result.payload)).toBuffer()
                        val res = OperationResponse(result.statusCode,result.statusMessage,payload,result.headers)
                        msg.reply(res.toJson())
                    }.invokeOnCompletion{
                ...
                "getOutlet" -> {
                    ...
                    GlobalScope.launch(vertx.dispatcher()){
                        val result = service.getOutlet(campaignId,outletId,context)
                        val payload = JsonObject(Json.encode(result.payload)).toBuffer()
                        val res = OperationResponse(result.statusCode,result.statusMessage,payload,result.headers)
                        msg.reply(res.toJson())
                    }.invokeOnCompletion{
                ...
                "getOutlets" -> {
                    ...
                    val pageToken = ApiHandlerUtils.searchStringInJson(params,"page_token")
                    val regionId = ApiHandlerUtils.searchLongInJson(params,"region_id")
                    val shopOutletCode = ApiHandlerUtils.searchStringInJson(params,"shop_outlet_code")
                    val regionId2 = ApiHandlerUtils.searchLongInJson(params,"regionId")
                    GlobalScope.launch(vertx.dispatcher()){
                        val result = service.getOutlets(campaignId,pageToken,regionId,shopOutletCode,regionId2,context)
                        val payload = JsonObject(Json.encode(result.payload)).toBuffer()
                        val res = OperationResponse(result.statusCode,result.statusMessage,payload,result.headers)
                        msg.reply(res.toJson())
                    }.invokeOnCompletion{
                ...
                "getQualityRatingDetails" -> {
                    ...
                    GlobalScope.launch(vertx.dispatcher()){
                        val result = service.getQualityRatingDetails(campaignId,context)
                        val payload = JsonObject(Json.encode(result.payload)).toBuffer()
                        val res = OperationResponse(result.statusCode,result.statusMessage,payload,result.headers)
                        msg.reply(res.toJson())
                    }.invokeOnCompletion{
                ...
                "getWarehouses" -> {
                    ...
                    GlobalScope.launch(vertx.dispatcher()){
                        val result = service.getWarehouses(businessId,context)
                        val payload = JsonObject(Json.encode(result.payload)).toBuffer()
                        val res = OperationResponse(result.statusCode,result.statusMessage,payload,result.headers)
                        msg.reply(res.toJson())
                    }.invokeOnCompletion{
                ...
                "updateOutlet" -> {
                    ...
                    val changeOutletRequest = Gson().fromJson(changeOutletRequestParam.encode(), ChangeOutletRequest::class.java)
                    GlobalScope.launch(vertx.dispatcher()){
                        val result = service.updateOutlet(campaignId,outletId,changeOutletRequest,context)
                        val payload = JsonObject(Json.encode(result.payload)).toBuffer()
                        val res = OperationResponse(result.statusCode,result.statusMessage,payload,result.headers)
                        msg.reply(res.toJson())
                    }.invokeOnCompletion{
                ...
                "updateStocks" -> {
                    ...
                    val updateStocksRequestParam = ApiHandlerUtils.searchJsonObjectInJson(params,"body")
                    if (updateStocksRequestParam == null) {
                        throw IllegalArgumentException("updateStocksRequest is required")
                    }
                    val updateStocksRequest = Gson().fromJson(updateStocksRequestParam.encode(), UpdateStocksRequest::class.java)
                    GlobalScope.launch(vertx.dispatcher()){
                        val result = service.updateStocks(campaignId,updateStocksRequest,context)
                        val payload = JsonObject(Json.encode(result.payload)).toBuffer()
                        val res = OperationResponse(result.statusCode,result.statusMessage,payload,result.headers)
                        msg.reply(res.toJson())
                    }.invokeOnCompletion{
