...
interface DbsApi  {
    ...
    suspend fun deleteOutletLicenses(campaignId:kotlin.Long?,ids:kotlin.collections.Set<kotlin.Long>?,context:OperationRequest):Response<EmptyApiResponse>
    /* deletePromoOffers
    ...
    suspend fun getOrderBuyerInfo(campaignId:kotlin.Long?,orderId:kotlin.Long?,context:OperationRequest):Response<GetOrderBuyerInfoResponse>
    /* getOrderLabelsData
    ...
    suspend fun getOutletLicenses(campaignId:kotlin.Long?,outletIds:kotlin.collections.Set<kotlin.Long>?,ids:kotlin.collections.Set<kotlin.Long>?,context:OperationRequest):Response<GetOutletLicensesResponse>
    /* getOutlets
    ...
    suspend fun setOrderDeliveryDate(campaignId:kotlin.Long?,orderId:kotlin.Long?,setOrderDeliveryDateRequest:SetOrderDeliveryDateRequest?,context:OperationRequest):Response<EmptyApiResponse>
    /* setOrderDeliveryTrackCode
     * Передача трек‑номера посылки */
    suspend fun setOrderDeliveryTrackCode(campaignId:kotlin.Long?,orderId:kotlin.Long?,setOrderDeliveryTrackCodeRequest:SetOrderDeliveryTrackCodeRequest?,context:OperationRequest):Response<EmptyApiResponse>
    ...
    suspend fun updateOrderStorageLimit(campaignId:kotlin.Long?,orderId:kotlin.Long?,updateOrderStorageLimitRequest:UpdateOrderStorageLimitRequest?,context:OperationRequest):Response<EmptyApiResponse>
    /* updateOutlet
    ...
    suspend fun updateOutletLicenses(campaignId:kotlin.Long?,updateOutletLicenseRequest:UpdateOutletLicenseRequest?,context:OperationRequest):Response<EmptyApiResponse>
    /* updatePrices
    ...
    companion object {
        const val address = "DbsApi-service"
        suspend fun createRouterFactory(vertx: Vertx,path:String): io.vertx.ext.web.api.contract.openapi3.OpenAPI3RouterFactory {
            ...
            for (m in DbsApi::class.java.methods) {
            ...
            routerFactory.mountServiceInterface(DbsApi::class.java, address)
