...
class WarehousesApiVertxProxyHandler(private val vertx: Vertx, private val service: WarehousesApi, topLevel: Boolean, private val timeoutSeconds: Long) : ProxyHandler() {
