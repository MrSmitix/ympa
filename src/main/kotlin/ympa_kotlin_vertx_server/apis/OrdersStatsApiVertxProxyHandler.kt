...
class OrdersStatsApiVertxProxyHandler(private val vertx: Vertx, private val service: OrdersStatsApi, topLevel: Boolean, private val timeoutSeconds: Long) : ProxyHandler() {
