...
class CategoriesApiVertxProxyHandler(private val vertx: Vertx, private val service: CategoriesApi, topLevel: Boolean, private val timeoutSeconds: Long) : ProxyHandler() {
