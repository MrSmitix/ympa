...
class GoodsStatsApiVertxProxyHandler(private val vertx: Vertx, private val service: GoodsStatsApi, topLevel: Boolean, private val timeoutSeconds: Long) : ProxyHandler() {
