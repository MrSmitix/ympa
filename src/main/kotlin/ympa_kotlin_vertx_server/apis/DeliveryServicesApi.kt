...
interface DeliveryServicesApi  {
    ...
    companion object {
        ...
        suspend fun createRouterFactory(vertx: Vertx,path:String): io.vertx.ext.web.api.contract.openapi3.OpenAPI3RouterFactory {
            ...
            for (m in DeliveryServicesApi::class.java.methods) {
            ...
            routerFactory.mountServiceInterface(DeliveryServicesApi::class.java, address)
