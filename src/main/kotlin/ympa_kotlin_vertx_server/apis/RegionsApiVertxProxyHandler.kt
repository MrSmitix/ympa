...
class RegionsApiVertxProxyHandler(private val vertx: Vertx, private val service: RegionsApi, topLevel: Boolean, private val timeoutSeconds: Long) : ProxyHandler() {
