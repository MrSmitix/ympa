...
class OrderBusinessInformationApiVertxProxyHandler(private val vertx: Vertx, private val service: OrderBusinessInformationApi, topLevel: Boolean, private val timeoutSeconds: Long) : ProxyHandler() {
