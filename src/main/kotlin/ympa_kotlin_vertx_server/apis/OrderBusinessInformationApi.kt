...
interface OrderBusinessInformationApi  {
    ...
    companion object {
        const val address = "OrderBusinessInformationApi-service"
        suspend fun createRouterFactory(vertx: Vertx,path:String): io.vertx.ext.web.api.contract.openapi3.OpenAPI3RouterFactory {
            ...
            for (m in OrderBusinessInformationApi::class.java.methods) {
            ...
            routerFactory.mountServiceInterface(OrderBusinessInformationApi::class.java, address)
