...
class BusinessesApiVertxProxyHandler(private val vertx: Vertx, private val service: BusinessesApi, topLevel: Boolean, private val timeoutSeconds: Long) : ProxyHandler() {
