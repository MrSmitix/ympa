...
interface GoodsStatsApi  {
    ...
    companion object {
        const val address = "GoodsStatsApi-service"
        suspend fun createRouterFactory(vertx: Vertx,path:String): io.vertx.ext.web.api.contract.openapi3.OpenAPI3RouterFactory {
            ...
            for (m in GoodsStatsApi::class.java.methods) {
            ...
            routerFactory.mountServiceInterface(GoodsStatsApi::class.java, address)
