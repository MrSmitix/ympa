...
class FeedbacksApiVertxProxyHandler(private val vertx: Vertx, private val service: FeedbacksApi, topLevel: Boolean, private val timeoutSeconds: Long) : ProxyHandler() {
