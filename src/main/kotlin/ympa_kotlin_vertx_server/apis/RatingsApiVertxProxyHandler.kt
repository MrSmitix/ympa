...
class RatingsApiVertxProxyHandler(private val vertx: Vertx, private val service: RatingsApi, topLevel: Boolean, private val timeoutSeconds: Long) : ProxyHandler() {
