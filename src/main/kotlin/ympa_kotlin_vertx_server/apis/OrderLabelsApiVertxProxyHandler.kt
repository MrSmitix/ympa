...
class OrderLabelsApiVertxProxyHandler(private val vertx: Vertx, private val service: OrderLabelsApi, topLevel: Boolean, private val timeoutSeconds: Long) : ProxyHandler() {
