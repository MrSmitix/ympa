...
import ympa_kotlin_spring_server.models.SuggestPricesResultDTO
 ...
 * @param result 
 */
data class SuggestPricesResponse(
    ...
    @field:Valid
    @Schema(example = "null", description = "")
    @get:JsonProperty("result") val result: SuggestPricesResultDTO? = null
    ) {
