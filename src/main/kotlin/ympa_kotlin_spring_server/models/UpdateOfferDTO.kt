...
data class UpdateOfferDTO(
    ...
    @field:Valid
    @get:Size(max=300)
    @Schema(example = "null", description = "Список характеристик с их значениями.  С `parameterValues` обязательно передавайте `marketCategoryId` — идентификатор категории на Маркете, к которой относятся указанные характеристики товара.  При **изменении** характеристик передавайте только те, значение которых нужно обновить.  Чтобы **удалить** значение заданной характеристики, передайте ее `parameterId` с пустым `value`.  Максимальное количество характеристик — 300. ")
    @get:JsonProperty("parameterValues") val parameterValues: kotlin.collections.List<ParameterValueDTO>? = null,

    @field:Valid
    @Schema(example = "null", description = "")
    @get:JsonProperty("basicPrice") val basicPrice: UpdatePriceWithDiscountDTO? = null,

    @field:Valid
    @Schema(example = "null", description = "")
    @get:JsonProperty("purchasePrice") val purchasePrice: BasePriceDTO? = null,

    @field:Valid
    @Schema(example = "null", description = "")
    @get:JsonProperty("additionalExpenses") val additionalExpenses: BasePriceDTO? = null,

    @field:Valid
    @Schema(example = "null", description = "")
    @get:JsonProperty("cofinancePrice") val cofinancePrice: BasePriceDTO? = null
    ) {
