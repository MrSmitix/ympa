...
* Values: UNKNOWN_CATEGORY,CATEGORY_MISMATCH,EMPTY_MARKET_CATEGORY,UNKNOWN_PARAMETER,UNEXPECTED_BOOLEAN_VALUE,NUMBER_FORMAT,VALUE_BLANK,INVALID_UNIT_ID,INVALID_GROUP_ID_LENGTH,INVALID_GROUP_ID_CHARACTERS,INVALID_PICKER_URL
*/
enum class OfferMappingErrorType(@get:JsonValue val value: kotlin.String) {
    ...
    companion object {
        @JvmStatic
        @JsonCreator
        fun forValue(value: kotlin.String): OfferMappingErrorType {
