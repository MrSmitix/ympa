...
import ympa_kotlin_spring_server.models.OfferMappingErrorDTO
...
data class UpdateOfferMappingResultDTO(
    ...
    @get:JsonProperty("errors") val errors: kotlin.collections.List<OfferMappingErrorDTO>? = null,

    @field:Valid
    @Schema(example = "null", description = "Предупреждения — информация в каталоге обновится.")
    @get:JsonProperty("warnings") val warnings: kotlin.collections.List<OfferMappingErrorDTO>? = null
    ) {
