...
import ympa_kotlin_spring_server.models.RejectedPromoOfferDeleteReasonType
...
data class RejectedPromoOfferDeleteDTO(
    ...
    @get:JsonProperty("reason", required = true) val reason: RejectedPromoOfferDeleteReasonType
    ) {
