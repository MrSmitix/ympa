...
import ympa_kotlin_spring_server.models.OrdersStatsOrderDTO
...
data class OrdersStatsDTO(
    ...
    @get:JsonProperty("orders", required = true) val orders: kotlin.collections.List<OrdersStatsOrderDTO>,
