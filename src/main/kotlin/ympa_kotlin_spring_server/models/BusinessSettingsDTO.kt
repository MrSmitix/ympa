...
data class BusinessSettingsDTO(
    ...
    @Schema(example = "null", description = "Можно ли установить только [базовую цену](*rule): * `false` — можно задать и базовую цену, и цены в конкретных магазинах. * `true` — можно задать только базовую цену. ")
    @get:JsonProperty("onlyDefaultPrice") val onlyDefaultPrice: kotlin.Boolean? = null,
