...
data class OfferForRecommendationDTO(
    ...
    @get:JsonProperty("price") val price: BasePriceDTO? = null,
    ...
    @field:Valid
    @Schema(example = "null", description = "")
    @get:JsonProperty("competitiveness") val competitiveness: PriceCompetitivenessType? = null,

    @Schema(example = "null", description = "Количество показов карточки товара за последние 7 дней.")
    @get:JsonProperty("shows") val shows: kotlin.Long? = null
    ) {
