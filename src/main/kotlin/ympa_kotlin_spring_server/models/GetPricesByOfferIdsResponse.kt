...
import ympa_kotlin_spring_server.models.OfferPriceByOfferIdsListResponseDTO
...
data class GetPricesByOfferIdsResponse(
    ...
    @field:Valid
    @Schema(example = "null", description = "")
    @get:JsonProperty("result") val result: OfferPriceByOfferIdsListResponseDTO? = null
    ) {
