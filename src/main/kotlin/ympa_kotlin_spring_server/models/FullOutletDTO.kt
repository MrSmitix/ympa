...
import ympa_kotlin_spring_server.models.OutletStatusType
...
data class FullOutletDTO(
    ...
    @field:Valid
    @Schema(example = "null", description = "")
    @get:JsonProperty("status") val status: OutletStatusType? = null,

    @field:Valid
    @Schema(example = "null", description = "")
    @get:JsonProperty("region") val region: RegionDTO? = null,

    @Schema(example = "null", description = "Идентификатор точки продаж, заданный магазином.")
    @get:JsonProperty("shopOutletId") val shopOutletId: kotlin.String? = null,

    @Schema(example = "null", description = "Рабочее время.")
    @get:JsonProperty("workingTime") val workingTime: kotlin.String? = null,

    @Schema(example = "null", description = "Статус модерации.")
    @get:JsonProperty("moderationReason") val moderationReason: kotlin.String? = null
    ) {
