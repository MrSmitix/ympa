...
import ympa_kotlin_spring_server.models.OfferContentErrorDTO
...
data class UpdateOfferContentResultDTO(
    ...
    @field:Valid
    @Schema(example = "null", description = "Ошибки — информация в каталоге не обновится.")
    @get:JsonProperty("errors") val errors: kotlin.collections.List<OfferContentErrorDTO>? = null,

    @field:Valid
    @Schema(example = "null", description = "Предупреждения — информация в каталоге обновится.")
    @get:JsonProperty("warnings") val warnings: kotlin.collections.List<OfferContentErrorDTO>? = null
    ) {
