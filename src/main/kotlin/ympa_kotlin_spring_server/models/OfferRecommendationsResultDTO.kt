...
import ympa_kotlin_spring_server.models.OfferRecommendationDTO
...
data class OfferRecommendationsResultDTO(
    ...
    @get:JsonProperty("offerRecommendations", required = true) val offerRecommendations: kotlin.collections.List<OfferRecommendationDTO>,
