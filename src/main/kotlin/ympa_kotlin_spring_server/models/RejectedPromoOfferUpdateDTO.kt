...
import ympa_kotlin_spring_server.models.RejectedPromoOfferUpdateReasonType
...
data class RejectedPromoOfferUpdateDTO(
    ...
    @get:JsonProperty("reason", required = true) val reason: RejectedPromoOfferUpdateReasonType
    ) {
