...
import ympa_kotlin_spring_server.models.PromoOfferUpdateWarningDTO
...
data class WarningPromoOfferUpdateDTO(
    ...
    @field:Valid
    @Schema(example = "null", required = true, description = "Предупреждения, которые появились при добавлении товара в акцию или изменении его цен.")
    @get:JsonProperty("warnings", required = true) val warnings: kotlin.collections.List<PromoOfferUpdateWarningDTO>
    ) {
