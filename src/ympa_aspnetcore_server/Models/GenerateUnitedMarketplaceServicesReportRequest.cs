...
{ 
    ...
    public partial class GenerateUnitedMarketplaceServicesReportRequest : IEquatable<GenerateUnitedMarketplaceServicesReportRequest>
    {
        ...
        [DataMember(Name="yearFrom", EmitDefaultValue=true)]
        ...
        [Range(1, 12)]
        [DataMember(Name="monthFrom", EmitDefaultValue=true)]
        ...
        [DataMember(Name="yearTo", EmitDefaultValue=true)]
        ...
        [Range(1, 12)]
        [DataMember(Name="monthTo", EmitDefaultValue=true)]
