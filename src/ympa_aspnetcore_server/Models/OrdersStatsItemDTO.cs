...
{ 
    ...
    public partial class OrdersStatsItemDTO : IEquatable<OrdersStatsItemDTO>
    {
        ...
        [DataMember(Name="initialCount", EmitDefaultValue=true)]
        ...
        /// <example>570</example>
        [Range(0, 10000)]
        [DataMember(Name="bidFee", EmitDefaultValue=true)]
        ...
        [DataMember(Name="cofinanceThreshold", EmitDefaultValue=true)]
        ...
        [DataMember(Name="cofinanceValue", EmitDefaultValue=true)]
