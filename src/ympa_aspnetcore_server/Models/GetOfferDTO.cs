...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class GetOfferDTO : IEquatable<GetOfferDTO>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((GetOfferDTO)obj);
        }

        /// <summary>
        /// Returns true if GetOfferDTO instances are equal
        /// </summary>
        /// <param name="other">Instance of GetOfferDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetOfferDTO other)
        {
            ...
            return 
                ...
                (
                    SellingPrograms == other.SellingPrograms ||
                    SellingPrograms != null &&
                    other.SellingPrograms != null &&
                    SellingPrograms.SequenceEqual(other.SellingPrograms)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + SellingPrograms.GetHashCode();
        ...
        public static bool operator ==(GetOfferDTO left, GetOfferDTO right)
        {
