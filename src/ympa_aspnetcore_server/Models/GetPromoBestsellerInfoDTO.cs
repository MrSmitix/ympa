...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class GetPromoBestsellerInfoDTO : IEquatable<GetPromoBestsellerInfoDTO>
    {
        /// <summary>
        ...
        [DataMember(Name="entryDeadline", EmitDefaultValue=true)]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((GetPromoBestsellerInfoDTO)obj);
        }

        /// <summary>
        /// Returns true if GetPromoBestsellerInfoDTO instances are equal
        /// </summary>
        /// <param name="other">Instance of GetPromoBestsellerInfoDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetPromoBestsellerInfoDTO other)
        {
            ...
            return 
                (
                    ...
                    Bestseller.Equals(other.Bestseller)
                ) && 
                (
                    EntryDeadline == other.EntryDeadline ||
                    
                    EntryDeadline.Equals(other.EntryDeadline)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + Bestseller.GetHashCode();
                    
                    hashCode = hashCode * 59 + EntryDeadline.GetHashCode();
                return hashCode;
            }
        }
        ...
        public static bool operator ==(GetPromoBestsellerInfoDTO left, GetPromoBestsellerInfoDTO right)
        {
