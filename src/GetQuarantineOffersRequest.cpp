...
void
GetQuarantineOffersRequest::__init()
{
...
void
GetQuarantineOffersRequest::__cleanup()
{
	//if(offerIds != NULL) {
...
void
GetQuarantineOffersRequest::fromJson(char* jsonStr)
{
...
GetQuarantineOffersRequest::GetQuarantineOffersRequest(char* json)
{
	this->fromJson(json);
}
