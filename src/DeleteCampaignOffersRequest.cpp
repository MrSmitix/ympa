...
void
DeleteCampaignOffersRequest::__init()
{
	//new std::list()std::list> offerIds;
}

void
DeleteCampaignOffersRequest::__cleanup()
{
	//if(offerIds != NULL) {
...
void
DeleteCampaignOffersRequest::fromJson(char* jsonStr)
{
...
DeleteCampaignOffersRequest::DeleteCampaignOffersRequest(char* json)
{
	this->fromJson(json);
}
