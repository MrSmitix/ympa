...
namespace ympa_csharp_client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GenerateBoostConsolidatedRequest")]
    public partial class GenerateBoostConsolidatedRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GenerateBoostConsolidatedRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GenerateBoostConsolidatedRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GenerateBoostConsolidatedRequest" /> class.
        /// </summary>
        ...
        public GenerateBoostConsolidatedRequest(long businessId = default(long), DateOnly dateFrom = default(DateOnly), DateOnly dateTo = default(DateOnly))
        {
            this.BusinessId = businessId;
            // to ensure "dateFrom" is required (not null)
            if (dateFrom == null)
            {
                throw new ArgumentNullException("dateFrom is a required property for GenerateBoostConsolidatedRequest and cannot be null");
            }
            this.DateFrom = dateFrom;
            // to ensure "dateTo" is required (not null)
            if (dateTo == null)
            {
                throw new ArgumentNullException("dateTo is a required property for GenerateBoostConsolidatedRequest and cannot be null");
            }
            this.DateTo = dateTo;
        }
