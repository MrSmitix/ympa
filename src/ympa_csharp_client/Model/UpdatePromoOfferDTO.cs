...
namespace ympa_csharp_client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UpdatePromoOfferDTO")]
    public partial class UpdatePromoOfferDTO : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdatePromoOfferDTO" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpdatePromoOfferDTO() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdatePromoOfferDTO" /> class.
        /// </summary>
        ...
        public UpdatePromoOfferDTO(string offerId = default(string), UpdatePromoOfferParamsDTO varParams = default(UpdatePromoOfferParamsDTO))
        {
            // to ensure "offerId" is required (not null)
            if (offerId == null)
            {
                throw new ArgumentNullException("offerId is a required property for UpdatePromoOfferDTO and cannot be null");
            }
        ...
        public UpdatePromoOfferParamsDTO Params { get; set; }
