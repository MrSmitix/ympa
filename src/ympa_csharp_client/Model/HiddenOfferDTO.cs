...
namespace ympa_csharp_client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "HiddenOfferDTO")]
    public partial class HiddenOfferDTO : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HiddenOfferDTO" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected HiddenOfferDTO() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="HiddenOfferDTO" /> class.
        /// </summary>
        ...
        public HiddenOfferDTO(string offerId = default(string))
        {
            // to ensure "offerId" is required (not null)
            if (offerId == null)
            {
                throw new ArgumentNullException("offerId is a required property for HiddenOfferDTO and cannot be null");
            }
