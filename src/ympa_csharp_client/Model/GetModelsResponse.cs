...
namespace ympa_csharp_client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetModelsResponse")]
    public partial class GetModelsResponse : IValidatableObject
    {
        ...
        public GetModelsResponse(List<ModelDTO> models = default(List<ModelDTO>), CurrencyType? currency = default(CurrencyType?), long regionId = default(long))
        {
            // to ensure "models" is required (not null)
            if (models == null)
            {
                throw new ArgumentNullException("models is a required property for GetModelsResponse and cannot be null");
            }
            this.Models = models;
