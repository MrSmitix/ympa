...
namespace ympa_csharp_client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EnrichedMappingsOfferDTO")]
    public partial class EnrichedMappingsOfferDTO : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EnrichedMappingsOfferDTO" /> class.
        /// </summary>
        ...
        /// <param name="price">Цена на товар в рублях..</param>
        /// <param name="marketCategoryId">Идентификатор категории для рекомендованной карточки товара на Маркете.  Возвращается только вместе с параметром ##marketSku##. .</param>
        /// <param name="marketCategoryName">Название категории для рекомендованной карточки товара на Маркете.  Может отсутствовать в ответе. .</param>
        /// <param name="marketModelId">Идентификатор модели для рекомендованной карточки товара на Маркете.  Может отсутствовать в ответе. .</param>
        /// <param name="marketModelName">Название модели для рекомендованной карточки товара на Маркете.  Возвращается только вместе с параметром ##marketSku##. .</param>
        /// <param name="marketSku">SKU на Маркете..</param>
        /// <param name="marketSkuName">Название товара с рекомендованной карточки на Маркете.  Может отсутствовать в ответе. .</param>
        public EnrichedMappingsOfferDTO(string name = default(string), string shopSku = default(string), string category = default(string), string vendor = default(string), string vendorCode = default(string), string description = default(string), string id = default(string), long feedId = default(long), List<string> barcodes = default(List<string>), List<string> urls = default(List<string>), List<string> pictures = default(List<string>), string manufacturer = default(string), List<string> manufacturerCountries = default(List<string>), int minShipment = default(int), int transportUnitSize = default(int), int quantumOfSupply = default(int), int deliveryDurationDays = default(int), int boxCount = default(int), List<string> customsCommodityCodes = default(List<string>), OfferWeightDimensionsDTO weightDimensions = default(OfferWeightDimensionsDTO), List<DayOfWeekType> supplyScheduleDays = default(List<DayOfWeekType>), int shelfLifeDays = default(int), int lifeTimeDays = default(int), int guaranteePeriodDays = default(int), OfferProcessingStateDTO processingState = default(OfferProcessingStateDTO), OfferAvailabilityStatusType? availability = default(OfferAvailabilityStatusType?), TimePeriodDTO shelfLife = default(TimePeriodDTO), TimePeriodDTO lifeTime = default(TimePeriodDTO), TimePeriodDTO guaranteePeriod = default(TimePeriodDTO), string certificate = default(string), decimal price = default(decimal), long marketCategoryId = default(long), string marketCategoryName = default(string), long marketModelId = default(long), string marketModelName = default(string), long marketSku = default(long), string marketSkuName = default(string))
        {
            this.Name = name;
        ...
        /// </summary>
        /// <value>Идентификатор категории для рекомендованной карточки товара на Маркете.  Возвращается только вместе с параметром ##marketSku##. </value>
        ...
        /// </summary>
        /// <value>Название категории для рекомендованной карточки товара на Маркете.  Может отсутствовать в ответе. </value>
        ...
        /// </summary>
        /// <value>Идентификатор модели для рекомендованной карточки товара на Маркете.  Может отсутствовать в ответе. </value>
        ...
        /// </summary>
        /// <value>Название модели для рекомендованной карточки товара на Маркете.  Возвращается только вместе с параметром ##marketSku##. </value>
        ...
        /// </summary>
        /// <value>Название товара с рекомендованной карточки на Маркете.  Может отсутствовать в ответе. </value>
