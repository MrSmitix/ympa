...
namespace ympa_csharp_client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OutletDTO")]
    public partial class OutletDTO : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OutletDTO" /> class.
        /// </summary>
        ...
        public OutletDTO(string name = default(string), OutletType type = default(OutletType), string coords = default(string), bool isMain = default(bool), string shopOutletCode = default(string), OutletVisibilityType? visibility = default(OutletVisibilityType?), OutletAddressDTO address = default(OutletAddressDTO), List<string> phones = default(List<string>), OutletWorkingScheduleDTO workingSchedule = default(OutletWorkingScheduleDTO), List<OutletDeliveryRuleDTO> deliveryRules = default(List<OutletDeliveryRuleDTO>), long storagePeriod = default(long))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for OutletDTO and cannot be null");
            }
            this.Name = name;
            this.Type = type;
            ...
            if (address == null)
            {
                throw new ArgumentNullException("address is a required property for OutletDTO and cannot be null");
            }
            this.Address = address;
            // to ensure "phones" is required (not null)
            if (phones == null)
            {
                throw new ArgumentNullException("phones is a required property for OutletDTO and cannot be null");
            }
            this.Phones = phones;
            // to ensure "workingSchedule" is required (not null)
            if (workingSchedule == null)
            {
                throw new ArgumentNullException("workingSchedule is a required property for OutletDTO and cannot be null");
            }
