...
namespace ympa_csharp_client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ShipmentInfoDTO")]
    public partial class ShipmentInfoDTO : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ShipmentInfoDTO" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ShipmentInfoDTO() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ShipmentInfoDTO" /> class.
        /// </summary>
        ...
        /// <param name="statusDescription">Описание статуса отгрузки..</param>
        /// <param name="statusUpdateTime">Время последнего изменения статуса отгрузки..</param>
        public ShipmentInfoDTO(long id = default(long), DateTime planIntervalFrom = default(DateTime), DateTime planIntervalTo = default(DateTime), ShipmentType? shipmentType = default(ShipmentType?), PartnerShipmentWarehouseDTO warehouse = default(PartnerShipmentWarehouseDTO), PartnerShipmentWarehouseDTO warehouseTo = default(PartnerShipmentWarehouseDTO), string externalId = default(string), DeliveryServiceDTO deliveryService = default(DeliveryServiceDTO), PalletsCountDTO palletsCount = default(PalletsCountDTO), List<long> orderIds = default(List<long>), int draftCount = default(int), int plannedCount = default(int), int factCount = default(int), ShipmentStatusType? status = default(ShipmentStatusType?), string statusDescription = default(string), DateTime statusUpdateTime = default(DateTime))
        {
            // to ensure "orderIds" is required (not null)
            if (orderIds == null)
            {
                throw new ArgumentNullException("orderIds is a required property for ShipmentInfoDTO and cannot be null");
            }
