...
namespace ympa_csharp_client.Model
{
    ...
    /// Товар в карантине.
    /// </summary>
    [DataContract(Name = "QuarantineOfferDTO")]
    public partial class QuarantineOfferDTO : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QuarantineOfferDTO" /> class.
        /// </summary>
        ...
        /// <param name="lastValidPrice">lastValidPrice.</param>
        /// <param name="verdicts">Причины попадания товара в карантин..</param>
        public QuarantineOfferDTO(string offerId = default(string), BasePriceDTO currentPrice = default(BasePriceDTO), BasePriceDTO lastValidPrice = default(BasePriceDTO), List<PriceQuarantineVerdictDTO> verdicts = default(List<PriceQuarantineVerdictDTO>))
        {
