...
namespace ympa_csharp_client.Model
{
    ...
    /// Параметры товара.
    /// </summary>
    [DataContract(Name = "GetOfferDTO")]
    public partial class GetOfferDTO : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetOfferDTO" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetOfferDTO() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetOfferDTO" /> class.
        /// </summary>
        ...
        /// <param name="additionalExpenses">additionalExpenses.</param>
        /// <param name="cofinancePrice">cofinancePrice.</param>
        /// <param name="cardStatus">cardStatus.</param>
        /// <param name="campaigns">Список магазинов, в которых размещен товар. .</param>
        /// <param name="sellingPrograms">Информация о том, какие для товара доступны модели размещения. .</param>
        /// <param name="archived">Товар помещен в архив. .</param>
        public GetOfferDTO(string offerId = default(string), string name = default(string), long marketCategoryId = default(long), string category = default(string), List<string> pictures = default(List<string>), List<string> videos = default(List<string>), List<OfferManualDTO> manuals = default(List<OfferManualDTO>), string vendor = default(string), List<string> barcodes = default(List<string>), string description = default(string), List<string> manufacturerCountries = default(List<string>), OfferWeightDimensionsDTO weightDimensions = default(OfferWeightDimensionsDTO), string vendorCode = default(string), List<string> tags = default(List<string>), TimePeriodDTO shelfLife = default(TimePeriodDTO), TimePeriodDTO lifeTime = default(TimePeriodDTO), TimePeriodDTO guaranteePeriod = default(TimePeriodDTO), string customsCommodityCode = default(string), List<string> certificates = default(List<string>), int boxCount = default(int), OfferConditionDTO condition = default(OfferConditionDTO), OfferType? type = default(OfferType?), bool downloadable = default(bool), bool adult = default(bool), AgeDTO age = default(AgeDTO), List<OfferParamDTO> varParams = default(List<OfferParamDTO>), GetPriceWithDiscountDTO basicPrice = default(GetPriceWithDiscountDTO), GetPriceDTO purchasePrice = default(GetPriceDTO), GetPriceDTO additionalExpenses = default(GetPriceDTO), GetPriceDTO cofinancePrice = default(GetPriceDTO), OfferCardStatusType? cardStatus = default(OfferCardStatusType?), List<OfferCampaignStatusDTO> campaigns = default(List<OfferCampaignStatusDTO>), List<OfferSellingProgramDTO> sellingPrograms = default(List<OfferSellingProgramDTO>), bool archived = default(bool))
        {
            // to ensure "offerId" is required (not null)
            if (offerId == null)
            {
                throw new ArgumentNullException("offerId is a required property for GetOfferDTO and cannot be null");
            }
        ...
        /// </summary>
        /// <value>Список магазинов, в которых размещен товар. </value>
        [DataMember(Name = "campaigns", EmitDefaultValue = true)]
        public List<OfferCampaignStatusDTO> Campaigns { get; set; }

        /// <summary>
        /// Информация о том, какие для товара доступны модели размещения. 
        /// </summary>
        /// <value>Информация о том, какие для товара доступны модели размещения. </value>
        [DataMember(Name = "sellingPrograms", EmitDefaultValue = true)]
        public List<OfferSellingProgramDTO> SellingPrograms { get; set; }

        /// <summary>
        /// Товар помещен в архив. 
        /// </summary>
        /// <value>Товар помещен в архив. </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  SellingPrograms: ").Append(SellingPrograms).Append("\n");
