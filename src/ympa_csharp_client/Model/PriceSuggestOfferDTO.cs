...
namespace ympa_csharp_client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PriceSuggestOfferDTO")]
    public partial class PriceSuggestOfferDTO : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PriceSuggestOfferDTO" /> class.
        /// </summary>
        ...
        /// <param name="priceSuggestion">Цены для продвижения. .</param>
        public PriceSuggestOfferDTO(long marketSku = default(long), string offerId = default(string), List<PriceSuggestDTO> priceSuggestion = default(List<PriceSuggestDTO>))
        {
