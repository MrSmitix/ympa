...
namespace ympa_csharp_client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ShipmentDTO")]
    public partial class ShipmentDTO : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ShipmentDTO" /> class.
        /// </summary>
        ...
        public ShipmentDTO(long id = default(long), DateTime planIntervalFrom = default(DateTime), DateTime planIntervalTo = default(DateTime), ShipmentType? shipmentType = default(ShipmentType?), PartnerShipmentWarehouseDTO warehouse = default(PartnerShipmentWarehouseDTO), PartnerShipmentWarehouseDTO warehouseTo = default(PartnerShipmentWarehouseDTO), string externalId = default(string), DeliveryServiceDTO deliveryService = default(DeliveryServiceDTO), PalletsCountDTO palletsCount = default(PalletsCountDTO), List<long> orderIds = default(List<long>), int draftCount = default(int), int plannedCount = default(int), int factCount = default(int), ShipmentStatusChangeDTO currentStatus = default(ShipmentStatusChangeDTO), List<ShipmentActionType> availableActions = default(List<ShipmentActionType>))
        {
            // to ensure "orderIds" is required (not null)
            if (orderIds == null)
            {
                throw new ArgumentNullException("orderIds is a required property for ShipmentDTO and cannot be null");
            }
            this.OrderIds = orderIds;
            // to ensure "availableActions" is required (not null)
            if (availableActions == null)
            {
                throw new ArgumentNullException("availableActions is a required property for ShipmentDTO and cannot be null");
            }
