...
namespace ympa_csharp_client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetQuarantineOffersRequest")]
    public partial class GetQuarantineOffersRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetQuarantineOffersRequest" /> class.
        /// </summary>
        ...
        public GetQuarantineOffersRequest(List<string> offerIds = default(List<string>), List<OfferCardStatusType> cardStatuses = default(List<OfferCardStatusType>), List<int> categoryIds = default(List<int>), List<string> vendorNames = default(List<string>), List<string> tags = default(List<string>))
        {
