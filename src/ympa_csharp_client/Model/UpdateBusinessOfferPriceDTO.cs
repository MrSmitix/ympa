...
namespace ympa_csharp_client.Model
{
    ...
    /// Товар с новой ценой.
    /// </summary>
    [DataContract(Name = "UpdateBusinessOfferPriceDTO")]
    public partial class UpdateBusinessOfferPriceDTO : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateBusinessOfferPriceDTO" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpdateBusinessOfferPriceDTO() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateBusinessOfferPriceDTO" /> class.
        /// </summary>
        ...
        public UpdateBusinessOfferPriceDTO(string offerId = default(string), UpdatePriceWithDiscountDTO price = default(UpdatePriceWithDiscountDTO))
        {
            // to ensure "offerId" is required (not null)
            if (offerId == null)
            {
                throw new ArgumentNullException("offerId is a required property for UpdateBusinessOfferPriceDTO and cannot be null");
            }
            this.OfferId = offerId;
            // to ensure "price" is required (not null)
            if (price == null)
            {
                throw new ArgumentNullException("price is a required property for UpdateBusinessOfferPriceDTO and cannot be null");
            }
            this.Price = price;
        }
        ...
        public UpdatePriceWithDiscountDTO Price { get; set; }
