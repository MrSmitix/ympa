...
namespace ympa_csharp_client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FeedIndexLogsErrorDTO")]
    public partial class FeedIndexLogsErrorDTO : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FeedIndexLogsErrorDTO" /> class.
        /// </summary>
        ...
        public FeedIndexLogsErrorDTO(int httpStatusCode = default(int), FeedIndexLogsErrorType? type = default(FeedIndexLogsErrorType?), string description = default(string))
        {
