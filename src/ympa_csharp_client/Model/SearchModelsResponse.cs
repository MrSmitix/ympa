...
namespace ympa_csharp_client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SearchModelsResponse")]
    public partial class SearchModelsResponse : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SearchModelsResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SearchModelsResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SearchModelsResponse" /> class.
        /// </summary>
        ...
        public SearchModelsResponse(List<ModelDTO> models = default(List<ModelDTO>), CurrencyType? currency = default(CurrencyType?), long regionId = default(long), FlippingPagerDTO pager = default(FlippingPagerDTO))
        {
            // to ensure "models" is required (not null)
            if (models == null)
            {
                throw new ArgumentNullException("models is a required property for SearchModelsResponse and cannot be null");
            }
            this.Models = models;
