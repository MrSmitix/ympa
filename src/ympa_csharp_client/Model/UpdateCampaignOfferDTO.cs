...
namespace ympa_csharp_client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UpdateCampaignOfferDTO")]
    public partial class UpdateCampaignOfferDTO : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateCampaignOfferDTO" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpdateCampaignOfferDTO() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateCampaignOfferDTO" /> class.
        /// </summary>
        ...
        /// <param name="vat">Ставка НДС, применяемая для товара. Задается цифрой:  * &#x60;2&#x60; — 10%. * &#x60;5&#x60; — 0%. * &#x60;6&#x60; — не облагается НДС. * &#x60;7&#x60; — 20%.  Если параметр не указан, используется ставка НДС, установленная в кабинете продавца на Маркете. .</param>
        public UpdateCampaignOfferDTO(string offerId = default(string), QuantumDTO quantum = default(QuantumDTO), bool available = default(bool), int vat = default(int))
        {
            // to ensure "offerId" is required (not null)
            if (offerId == null)
            {
                throw new ArgumentNullException("offerId is a required property for UpdateCampaignOfferDTO and cannot be null");
            }
