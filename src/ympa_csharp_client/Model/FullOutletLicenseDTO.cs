...
namespace ympa_csharp_client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FullOutletLicenseDTO")]
    public partial class FullOutletLicenseDTO : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FullOutletLicenseDTO" /> class.
        /// </summary>
        ...
        /// <param name="checkComment">Причина, по которой лицензия не прошла проверку.  Параметр возвращается, только если параметр &#x60;checkStatus&#x60; имеет значение &#x60;FAIL&#x60;. .</param>
        public FullOutletLicenseDTO(long id = default(long), long outletId = default(long), LicenseType? licenseType = default(LicenseType?), string number = default(string), DateTime dateOfIssue = default(DateTime), DateTime dateOfExpiry = default(DateTime), LicenseCheckStatusType? checkStatus = default(LicenseCheckStatusType?), string checkComment = default(string))
        {
            this.Id = id;
