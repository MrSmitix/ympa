...
GoodsStatsManager::GoodsStatsManager()
{
...
static gboolean __GoodsStatsManagerresponseHandler(gpointer data)
{
...
static gpointer __GoodsStatsManagerthreadFunc(gpointer data)
{
	RequestInfo *request = static_cast<RequestInfo*>(data);
	...
	g_idle_add(__GoodsStatsManagerresponseHandler, static_cast<gpointer>(request));
	...
	, void* userData, bool isAsync)
{
	...
	if(!isAsync){
		NetClient::easycurl(GoodsStatsManager::getBasePath(), url, myhttpmethod, queryParams,
		...
		requestInfo = new(nothrow) RequestInfo (GoodsStatsManager::getBasePath(), url, myhttpmethod, queryParams,
			mBody, headerList, p_chunk, &code, errormsg, userData, reinterpret_cast<void(*)()>(handler), getGoodsStatsProcessor);;
		if(requestInfo == NULL)
			return false;

		thread = g_thread_new(NULL, __GoodsStatsManagerthreadFunc, static_cast<gpointer>(requestInfo));
		return true;
	}
}
...
bool GoodsStatsManager::getGoodsStatsAsync(char * accessToken,
	long long campaignId, std::shared_ptr<GetGoodsStatsRequest> getGoodsStatsRequest, 
	void(* handler)(GetGoodsStatsResponse, Error, void* )
	, void* userData)
{
...
bool GoodsStatsManager::getGoodsStatsSync(char * accessToken,
	long long campaignId, std::shared_ptr<GetGoodsStatsRequest> getGoodsStatsRequest, 
	void(* handler)(GetGoodsStatsResponse, Error, void* )
	, void* userData)
{
