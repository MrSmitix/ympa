...
void
DeleteHiddenOffersRequest::__init()
{
	//new std::list()std::list> hiddenOffers;
}

void
DeleteHiddenOffersRequest::__cleanup()
{
...
void
DeleteHiddenOffersRequest::fromJson(char* jsonStr)
{
...
DeleteHiddenOffersRequest::DeleteHiddenOffersRequest(char* json)
{
	this->fromJson(json);
}
