...
#ifndef _PriceQuarantineVerdictType_H_
#define _PriceQuarantineVerdictType_H_
...
class PriceQuarantineVerdictType : public Object {
public:
	/*! \brief Constructor.
	 */
	PriceQuarantineVerdictType();
	PriceQuarantineVerdictType(char* str);
...
#endif /* _PriceQuarantineVerdictType_H_ */
