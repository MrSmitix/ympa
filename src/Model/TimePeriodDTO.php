...
class TimePeriodDTO implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'TimePeriodDTO';
    ...
    */
     ...
     * @return $this
     */
    public function setTimePeriod(int $time_period): static
    {
     ...
     */
    public function getTimeUnit(): \OpenAPI\Client\Model\TimeUnitType
    {
     ...
     * @return $this
     */
    public function setTimeUnit(\OpenAPI\Client\Model\TimeUnitType $time_unit): static
    {
