...
class OrderItemDTO implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'OrderItemDTO';
    ...
    */
     ...
     * @return $this
     */
    public function setOfferName(?string $offer_name): static
    {
     ...
     * @return $this
     */
    public function setBuyerPrice(?float $buyer_price): static
    {
     ...
     *
     * @param float|null $buyer_price_before_discount Стоимость товара в валюте покупателя до применения скидок по:  * акциям; * купонам; * промокодам.
     *
     * @return $this
     */
    public function setBuyerPriceBeforeDiscount(?float $buyer_price_before_discount): static
    {
     ...
     * @deprecated
     */
    public function setPriceBeforeDiscount(?float $price_before_discount): static
    {
     ...
     * @deprecated
     */
    public function setSubsidy(?float $subsidy): static
    {
        if (is_null($subsidy)) {
     ...
     * @deprecated
     */
    public function setPartnerWarehouseId(?string $partner_warehouse_id): static
    {
     ...
     * @return $this
     */
    public function setPromos(?array $promos): static
    {
        if (is_null($promos)) {
     ...
     * @return $this
     */
    public function setRequiredInstanceTypes(?array $required_instance_types): static
    {
