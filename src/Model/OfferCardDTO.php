...
class OfferCardDTO implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'OfferCardDTO';
    ...
    */
     ...
     */
    public function getMapping(): ?\OpenAPI\Client\Model\GetMappingDTO
    {
     ...
     * @return $this
     */
    public function setMapping(?\OpenAPI\Client\Model\GetMappingDTO $mapping): static
    {
        if (is_null($mapping)) {
     ...
     * @return $this
     */
    public function setContentRating(?int $content_rating): static
    {
