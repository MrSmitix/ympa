...
class OrderDeliveryAddressDTO implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'OrderDeliveryAddressDTO';
    ...
    */
     ...
     * @return $this
     */
    public function setSubway(?string $subway): static
    {
        if (is_null($subway)) {
     ...
     * @return $this
     */
    public function setEntryphone(?string $entryphone): static
    {
