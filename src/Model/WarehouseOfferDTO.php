...
class WarehouseOfferDTO implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'WarehouseOfferDTO';
    ...
    */
     ...
     */
    public function getTurnoverSummary(): ?\OpenAPI\Client\Model\TurnoverDTO
    {
     ...
     * @return $this
     */
    public function setTurnoverSummary(?\OpenAPI\Client\Model\TurnoverDTO $turnover_summary): static
    {
