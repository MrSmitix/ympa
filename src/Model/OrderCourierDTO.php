...
class OrderCourierDTO implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'OrderCourierDTO';
    ...
    */
     ...
     * @return $this
     */
    public function setPhoneExtension(?string $phone_extension): static
    {
     ...
     * @return $this
     */
    public function setVehicleNumber(?string $vehicle_number): static
    {
     ...
     * @return $this
     */
    public function setVehicleDescription(?string $vehicle_description): static
    {
