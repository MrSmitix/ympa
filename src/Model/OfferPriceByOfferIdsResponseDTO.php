...
class OfferPriceByOfferIdsResponseDTO implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'OfferPriceByOfferIdsResponseDTO';
    ...
    */
    ...
    public function setOfferId(?string $offer_id): static
    {
        ...
        if ((!preg_match("/^[^\\x00-\\x08\\x0A-\\x1f\\x7f]{1,255}$/", ObjectSerializer::toString($offer_id)))) {
            throw new InvalidArgumentException("invalid value for \$offer_id when calling OfferPriceByOfferIdsResponseDTO., must conform to the pattern /^[^\\x00-\\x08\\x0A-\\x1f\\x7f]{1,255}$/.");
        }
     ...
     */
    public function getPrice(): ?\OpenAPI\Client\Model\PriceDTO
    {
     ...
     * @return $this
     */
    public function setPrice(?\OpenAPI\Client\Model\PriceDTO $price): static
    {
        if (is_null($price)) {
