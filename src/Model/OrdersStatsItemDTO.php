...
class OrdersStatsItemDTO implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'OrdersStatsItemDTO';
    ...
    */
    ...
    public function setShopSku(?string $shop_sku): static
    {
        ...
        if ((!preg_match("/^[^\\x00-\\x08\\x0A-\\x1f\\x7f]{1,255}$/", ObjectSerializer::toString($shop_sku)))) {
            throw new InvalidArgumentException("invalid value for \$shop_sku when calling OrdersStatsItemDTO., must conform to the pattern /^[^\\x00-\\x08\\x0A-\\x1f\\x7f]{1,255}$/.");
        }
     ...
     */
    public function getWarehouse(): ?\OpenAPI\Client\Model\OrdersStatsWarehouseDTO
    {
     ...
     * @return $this
     */
    public function setWarehouse(?\OpenAPI\Client\Model\OrdersStatsWarehouseDTO $warehouse): static
    {
     ...
     * @return $this
     */
    public function setCisList(?array $cis_list): static
    {
        if (is_null($cis_list)) {
     ...
     * @return $this
     */
    public function setBidFee(?int $bid_fee): static
    {
        if (is_null($bid_fee)) {
     ...
     * @return $this
     */
    public function setCofinanceThreshold(?float $cofinance_threshold): static
    {
     ...
     * @return $this
     */
    public function setCofinanceValue(?float $cofinance_value): static
    {
