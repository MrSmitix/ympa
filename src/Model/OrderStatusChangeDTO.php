...
class OrderStatusChangeDTO implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'OrderStatusChangeDTO';
    ...
    */
     ...
     */
    public function getDelivery(): ?\OpenAPI\Client\Model\OrderStatusChangeDeliveryDTO
    {
     ...
     * @return $this
     */
    public function setDelivery(?\OpenAPI\Client\Model\OrderStatusChangeDeliveryDTO $delivery): static
    {
        if (is_null($delivery)) {
