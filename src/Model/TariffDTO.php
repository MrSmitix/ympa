...
class TariffDTO implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'TariffDTO';
    ...
    */
     ...
     */
    public function getType(): \OpenAPI\Client\Model\TariffType
    {
     ...
     * @return $this
     */
    public function setType(\OpenAPI\Client\Model\TariffType $type): static
    {
        if (is_null($type)) {
