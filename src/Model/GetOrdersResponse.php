...
class GetOrdersResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    */
     ...
     */
    public function getPaging(): ?\OpenAPI\Client\Model\ForwardScrollingPagerDTO
    {
     ...
     * @return $this
     */
    public function setPaging(?\OpenAPI\Client\Model\ForwardScrollingPagerDTO $paging): static
    {
        if (is_null($paging)) {
