...
class FullOutletDTO implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'FullOutletDTO';
    ...
    */
     ...
     */
    public function getStatus(): ?\OpenAPI\Client\Model\OutletStatusType
    {
     ...
     * @return $this
     */
    public function setStatus(?\OpenAPI\Client\Model\OutletStatusType $status): static
    {
        if (is_null($status)) {
     ...
     * @return $this
     */
    public function setShopOutletId(?string $shop_outlet_id): static
    {
     ...
     * @return $this
     */
    public function setModerationReason(?string $moderation_reason): static
    {
