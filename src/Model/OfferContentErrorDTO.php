...
class OfferContentErrorDTO implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'OfferContentErrorDTO';
    ...
    */
     ...
     */
    public function getType(): \OpenAPI\Client\Model\OfferContentErrorType
    {
     ...
     * @return $this
     */
    public function setType(\OpenAPI\Client\Model\OfferContentErrorType $type): static
    {
        if (is_null($type)) {
