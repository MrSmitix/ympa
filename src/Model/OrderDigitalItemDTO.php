...
class OrderDigitalItemDTO implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'OrderDigitalItemDTO';
    ...
    */
     ...
     * @return $this
     */
    public function setSlip(string $slip): static
    {
        if (is_null($slip)) {
     ...
     * @return $this
     */
    public function setActivateTill(\DateTime $activate_till): static
    {
