...
class UpdateOfferContentResultDTO implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'UpdateOfferContentResultDTO';
    ...
    */
     ...
     * Sets errors
     *
     * @param \OpenAPI\Client\Model\OfferContentErrorDTO[]|null $errors Ошибки — информация в каталоге не обновится.
     *
     * @return $this
     */
