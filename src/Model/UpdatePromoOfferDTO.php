...
class UpdatePromoOfferDTO implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'UpdatePromoOfferDTO';
    ...
    */
    ...
    public function setOfferId(string $offer_id): static
    {
        ...
        if ((!preg_match("/^[^\\x00-\\x08\\x0A-\\x1f\\x7f]{1,255}$/", ObjectSerializer::toString($offer_id)))) {
            throw new InvalidArgumentException("invalid value for \$offer_id when calling UpdatePromoOfferDTO., must conform to the pattern /^[^\\x00-\\x08\\x0A-\\x1f\\x7f]{1,255}$/.");
        }
     ...
     */
    public function getParams(): ?\OpenAPI\Client\Model\UpdatePromoOfferParamsDTO
    {
     ...
     * @return $this
     */
    public function setParams(?\OpenAPI\Client\Model\UpdatePromoOfferParamsDTO $params): static
    {
        if (is_null($params)) {
