...
class OrderItemDetailDTO implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'OrderItemDetailDTO';
    ...
    */
     ...
     */
    public function getItemStatus(): ?\OpenAPI\Client\Model\OrderItemStatusType
    {
     ...
     * @return $this
     */
    public function setItemStatus(?\OpenAPI\Client\Model\OrderItemStatusType $item_status): static
    {
     ...
     * @return $this
     */
    public function setUpdateDate(?string $update_date): static
    {
