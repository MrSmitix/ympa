...
/**
 * PromoOfferPromocodeParamsDTO Class Doc Comment
 *
 ...
 */
class PromoOfferPromocodeParamsDTO implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'PromoOfferPromocodeParamsDTO';
    ...
    */
     ...
     * Sets max_price
     *
     * @param int $max_price Максимально возможная цена для участия в акции до применения промокода.  Указывается в рублях.  Возвращается для всех товаров.
     *
     * @return $this
     */
