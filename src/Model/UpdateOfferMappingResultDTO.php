...
class UpdateOfferMappingResultDTO implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'UpdateOfferMappingResultDTO';
    ...
    */
     ...
     * Sets errors
     *
     * @param \OpenAPI\Client\Model\OfferMappingErrorDTO[]|null $errors Ошибки — информация в каталоге не обновится.
     *
     * @return $this
     */
