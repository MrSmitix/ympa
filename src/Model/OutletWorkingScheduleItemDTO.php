...
class OutletWorkingScheduleItemDTO implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'OutletWorkingScheduleItemDTO';
    ...
    */
     ...
     */
    public function getStartDay(): \OpenAPI\Client\Model\DayOfWeekType
    {
     ...
     * @return $this
     */
    public function setStartDay(\OpenAPI\Client\Model\DayOfWeekType $start_day): static
    {
     ...
     * @return \OpenAPI\Client\Model\DayOfWeekType
     */
    public function getEndDay(): \OpenAPI\Client\Model\DayOfWeekType
    {
     ...
     * @return $this
     */
    public function setEndDay(\OpenAPI\Client\Model\DayOfWeekType $end_day): static
    {
        if (is_null($end_day)) {
