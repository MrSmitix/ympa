...
class PromoOfferUpdateWarningDTO implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'PromoOfferUpdateWarningDTO';
    ...
    */
     ...
     */
    public function getCode(): \OpenAPI\Client\Model\PromoOfferUpdateWarningCodeType
    {
     ...
     * @return $this
     */
    public function setCode(\OpenAPI\Client\Model\PromoOfferUpdateWarningCodeType $code): static
    {
        if (is_null($code)) {
