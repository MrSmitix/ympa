...
class OfferRecommendationInfoDTO implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'OfferRecommendationInfoDTO';
    ...
    */
    ...
    public function setOfferId(?string $offer_id): static
    {
        ...
        if ((!preg_match("/^[^\\x00-\\x08\\x0A-\\x1f\\x7f]{1,255}$/", ObjectSerializer::toString($offer_id)))) {
            throw new InvalidArgumentException("invalid value for \$offer_id when calling OfferRecommendationInfoDTO., must conform to the pattern /^[^\\x00-\\x08\\x0A-\\x1f\\x7f]{1,255}$/.");
        }
     ...
     */
    public function getRecommendedCofinancePrice(): ?\OpenAPI\Client\Model\BasePriceDTO
    {
     ...
     * @return $this
     */
    public function setRecommendedCofinancePrice(?\OpenAPI\Client\Model\BasePriceDTO $recommended_cofinance_price): static
    {
     ...
     */
    public function getCompetitivenessThresholds(): ?\OpenAPI\Client\Model\PriceCompetitivenessThresholdsDTO
    {
     ...
     * @return $this
     */
    public function setCompetitivenessThresholds(?\OpenAPI\Client\Model\PriceCompetitivenessThresholdsDTO $competitiveness_thresholds): static
    {
