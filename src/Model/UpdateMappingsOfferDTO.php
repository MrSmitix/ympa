...
class UpdateMappingsOfferDTO implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'UpdateMappingsOfferDTO';
    ...
    */
    ...
    public function setShopSku(?string $shop_sku): static
    {
        ...
        if ((mb_strlen($shop_sku) > 255)) {
            throw new InvalidArgumentException('invalid length for $shop_sku when calling UpdateMappingsOfferDTO., must be smaller than or equal to 255.');
        }
    ...
    public function setId(?string $id): static
    {
        ...
        if ((mb_strlen($id) > 255)) {
            throw new InvalidArgumentException('invalid length for $id when calling UpdateMappingsOfferDTO., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($id) < 1)) {
