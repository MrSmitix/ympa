...
class OrderItemPromoDTO implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'OrderItemPromoDTO';
    ...
    */
     ...
     */
    public function getType(): \OpenAPI\Client\Model\OrderPromoType
    {
     ...
     * @return $this
     */
    public function setType(\OpenAPI\Client\Model\OrderPromoType $type): static
    {
        if (is_null($type)) {
     ...
     * @return $this
     */
    public function setShopPromoId(?string $shop_promo_id): static
    {
     ...
     * @return $this
     */
    public function setMarketPromoId(?string $market_promo_id): static
    {
