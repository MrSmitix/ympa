...
class PromoOfferDiscountParamsDTO implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'PromoOfferDiscountParamsDTO';
    ...
    */
     ...
     * @return $this
     */
    public function setPromoPrice(?int $promo_price): static
    {
     ...
     * @return $this
     */
    public function setMaxPromoPrice(int $max_promo_price): static
    {
