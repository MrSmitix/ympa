...
class GetOutletsResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'GetOutletsResponse';
    ...
    */
     ...
     * @return $this
     */
    public function setOutlets(array $outlets): static
    {
        if (is_null($outlets)) {
     ...
     */
    public function getPager(): ?\OpenAPI\Client\Model\FlippingPagerDTO
    {
     ...
     * @return $this
     */
    public function setPager(?\OpenAPI\Client\Model\FlippingPagerDTO $pager): static
    {
        if (is_null($pager)) {
