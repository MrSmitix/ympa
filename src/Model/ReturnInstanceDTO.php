...
class ReturnInstanceDTO implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ReturnInstanceDTO';
    ...
    */
     ...
     */
    public function getStockType(): ?\OpenAPI\Client\Model\ReturnInstanceStockType
    {
     ...
     * @return $this
     */
    public function setStockType(?\OpenAPI\Client\Model\ReturnInstanceStockType $stock_type): static
    {
     ...
     */
    public function getStatus(): ?\OpenAPI\Client\Model\ReturnInstanceStatusType
    {
     ...
     * @return $this
     */
    public function setStatus(?\OpenAPI\Client\Model\ReturnInstanceStatusType $status): static
    {
        if (is_null($status)) {
