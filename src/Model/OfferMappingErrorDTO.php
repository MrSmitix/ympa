...
class OfferMappingErrorDTO implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'OfferMappingErrorDTO';
    ...
    */
     ...
     */
    public function getType(): \OpenAPI\Client\Model\OfferMappingErrorType
    {
     ...
     * @return $this
     */
    public function setType(\OpenAPI\Client\Model\OfferMappingErrorType $type): static
    {
        if (is_null($type)) {
