...
class GetOfferDTO implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'GetOfferDTO';
    ...
    */
    ...
    public function setOfferId(string $offer_id): static
    {
        ...
        if ((!preg_match("/^[^\\x00-\\x08\\x0A-\\x1f\\x7f]{1,255}$/", ObjectSerializer::toString($offer_id)))) {
            throw new InvalidArgumentException("invalid value for \$offer_id when calling GetOfferDTO., must conform to the pattern /^[^\\x00-\\x08\\x0A-\\x1f\\x7f]{1,255}$/.");
        }
     ...
     */
    public function getPurchasePrice(): ?\OpenAPI\Client\Model\GetPriceDTO
    {
     ...
     * @return $this
     */
    public function setPurchasePrice(?\OpenAPI\Client\Model\GetPriceDTO $purchase_price): static
    {
     ...
     * @return \OpenAPI\Client\Model\GetPriceDTO|null
     */
    public function getAdditionalExpenses(): ?\OpenAPI\Client\Model\GetPriceDTO
    {
     ...
     * @return $this
     */
    public function setAdditionalExpenses(?\OpenAPI\Client\Model\GetPriceDTO $additional_expenses): static
    {
     ...
     */
    public function getCardStatus(): ?\OpenAPI\Client\Model\OfferCardStatusType
    {
     ...
     * @return $this
     */
    public function setCardStatus(?\OpenAPI\Client\Model\OfferCardStatusType $card_status): static
    {
     ...
     * @return $this
     */
    public function setSellingPrograms(?array $selling_programs): static
    {
