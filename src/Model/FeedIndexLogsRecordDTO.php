...
class FeedIndexLogsRecordDTO implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'FeedIndexLogsRecordDTO';
    ...
    */
     ...
     * @return $this
     */
    public function setDownloadTime(?\DateTime $download_time): static
    {
     ...
     * @return $this
     */
    public function setGenerationId(?int $generation_id): static
    {
     ...
     */
    public function getIndexType(): ?\OpenAPI\Client\Model\FeedIndexLogsIndexType
    {
     ...
     * @return $this
     */
    public function setIndexType(?\OpenAPI\Client\Model\FeedIndexLogsIndexType $index_type): static
    {
     ...
     */
    public function getStatus(): ?\OpenAPI\Client\Model\FeedIndexLogsStatusType
    {
     ...
     * @return $this
     */
    public function setStatus(?\OpenAPI\Client\Model\FeedIndexLogsStatusType $status): static
    {
        if (is_null($status)) {
     ...
     */
    public function getError(): ?\OpenAPI\Client\Model\FeedIndexLogsErrorDTO
    {
     ...
     * @return $this
     */
    public function setError(?\OpenAPI\Client\Model\FeedIndexLogsErrorDTO $error): static
    {
        if (is_null($error)) {
     ...
     */
    public function getOffers(): ?\OpenAPI\Client\Model\FeedIndexLogsOffersDTO
    {
     ...
     * @return $this
     */
    public function setOffers(?\OpenAPI\Client\Model\FeedIndexLogsOffersDTO $offers): static
    {
        if (is_null($offers)) {
