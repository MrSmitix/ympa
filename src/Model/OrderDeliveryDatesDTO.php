...
class OrderDeliveryDatesDTO implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'OrderDeliveryDatesDTO';
    ...
    */
     ...
     * @return $this
     */
    public function setFromTime(?string $from_time): static
    {
     ...
     * @return $this
     */
    public function setToTime(?string $to_time): static
    {
        if (is_null($to_time)) {
     ...
     * @return $this
     */
    public function setRealDeliveryDate(?string $real_delivery_date): static
    {
