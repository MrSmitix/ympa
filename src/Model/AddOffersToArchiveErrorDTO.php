...
class AddOffersToArchiveErrorDTO implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'AddOffersToArchiveErrorDTO';
    ...
    */
    ...
    public function setOfferId(string $offer_id): static
    {
        ...
        if ((!preg_match("/^[^\\x00-\\x08\\x0A-\\x1f\\x7f]{1,255}$/", ObjectSerializer::toString($offer_id)))) {
            throw new InvalidArgumentException("invalid value for \$offer_id when calling AddOffersToArchiveErrorDTO., must conform to the pattern /^[^\\x00-\\x08\\x0A-\\x1f\\x7f]{1,255}$/.");
        }
     ...
     */
    public function getError(): \OpenAPI\Client\Model\AddOffersToArchiveErrorType
    {
     ...
     * @return $this
     */
    public function setError(\OpenAPI\Client\Model\AddOffersToArchiveErrorType $error): static
    {
        if (is_null($error)) {
