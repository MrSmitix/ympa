...
class MappingsOfferInfoDTO implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'MappingsOfferInfoDTO';
    ...
    */
    ...
    public function setShopSku(?string $shop_sku): static
    {
        ...
        if ((mb_strlen($shop_sku) > 255)) {
            throw new InvalidArgumentException('invalid length for $shop_sku when calling MappingsOfferInfoDTO., must be smaller than or equal to 255.');
        }
        ...
        if ((!preg_match("/^[^\\x00-\\x08\\x0A-\\x1f\\x7f]{1,255}$/", ObjectSerializer::toString($shop_sku)))) {
            throw new InvalidArgumentException("invalid value for \$shop_sku when calling MappingsOfferInfoDTO., must conform to the pattern /^[^\\x00-\\x08\\x0A-\\x1f\\x7f]{1,255}$/.");
        }
    ...
    public function setId(?string $id): static
    {
        ...
        if ((mb_strlen($id) > 255)) {
            throw new InvalidArgumentException('invalid length for $id when calling MappingsOfferInfoDTO., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($id) < 1)) {
        ...
        if ((!preg_match("/^[^\\x00-\\x08\\x0A-\\x1f\\x7f]{1,255}$/", ObjectSerializer::toString($id)))) {
            throw new InvalidArgumentException("invalid value for \$id when calling MappingsOfferInfoDTO., must conform to the pattern /^[^\\x00-\\x08\\x0A-\\x1f\\x7f]{1,255}$/.");
        }
