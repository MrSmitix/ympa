...
class FeedbackListDTO implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'FeedbackListDTO';
    ...
    */
     ...
     * Gets feedback_list
     *
     * @return \OpenAPI\Client\Model\FeedbackDTO[]
     */
     ...
     * Sets feedback_list
     *
     * @param \OpenAPI\Client\Model\FeedbackDTO[] $feedback_list Список отзывов.  Содержит не более 20 отзывов.
     *
     * @return $this
     */
    public function setFeedbackList(array $feedback_list): static
    {
