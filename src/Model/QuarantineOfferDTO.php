...
class QuarantineOfferDTO implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'QuarantineOfferDTO';
    ...
    */
    ...
    public function setOfferId(?string $offer_id): static
    {
        ...
        if ((!preg_match("/^[^\\x00-\\x08\\x0A-\\x1f\\x7f]{1,255}$/", ObjectSerializer::toString($offer_id)))) {
            throw new InvalidArgumentException("invalid value for \$offer_id when calling QuarantineOfferDTO., must conform to the pattern /^[^\\x00-\\x08\\x0A-\\x1f\\x7f]{1,255}$/.");
        }
     ...
     */
    public function getCurrentPrice(): ?\OpenAPI\Client\Model\BasePriceDTO
    {
     ...
     * @return $this
     */
    public function setCurrentPrice(?\OpenAPI\Client\Model\BasePriceDTO $current_price): static
    {
     ...
     * @return \OpenAPI\Client\Model\BasePriceDTO|null
     */
    public function getLastValidPrice(): ?\OpenAPI\Client\Model\BasePriceDTO
    {
     ...
     * @return $this
     */
    public function setLastValidPrice(?\OpenAPI\Client\Model\BasePriceDTO $last_valid_price): static
    {
     ...
     * @return $this
     */
    public function setVerdicts(?array $verdicts): static
    {
        if (is_null($verdicts)) {
