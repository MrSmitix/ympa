...
#ifndef _EnrichedMappingsOfferDTO_H_
#define _EnrichedMappingsOfferDTO_H_
...
class EnrichedMappingsOfferDTO : public Object {
public:
	/*! \brief Constructor.
	 */
	EnrichedMappingsOfferDTO();
	EnrichedMappingsOfferDTO(char* str);
...
#endif /* _EnrichedMappingsOfferDTO_H_ */
