...
void
ConfirmPricesRequest::__init()
{
	//new std::list()std::list> offerIds;
}

void
ConfirmPricesRequest::__cleanup()
{
	//if(offerIds != NULL) {
...
void
ConfirmPricesRequest::fromJson(char* jsonStr)
{
...
ConfirmPricesRequest::ConfirmPricesRequest(char* json)
{
	this->fromJson(json);
}
