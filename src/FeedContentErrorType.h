...
#ifndef _FeedContentErrorType_H_
#define _FeedContentErrorType_H_
...
class FeedContentErrorType : public Object {
public:
	/*! \brief Constructor.
	 */
	FeedContentErrorType();
	FeedContentErrorType(char* str);
...
#endif /* _FeedContentErrorType_H_ */
