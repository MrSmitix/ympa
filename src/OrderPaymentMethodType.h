...
#ifndef _OrderPaymentMethodType_H_
#define _OrderPaymentMethodType_H_
...
class OrderPaymentMethodType : public Object {
public:
	/*! \brief Constructor.
	 */
	OrderPaymentMethodType();
	OrderPaymentMethodType(char* str);
...
#endif /* _OrderPaymentMethodType_H_ */
