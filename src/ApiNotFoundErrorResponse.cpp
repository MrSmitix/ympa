...
void
ApiNotFoundErrorResponse::__init()
{
...
void
ApiNotFoundErrorResponse::__cleanup()
{
	//if(status != NULL) {
	//
	//delete status;
...
void
ApiNotFoundErrorResponse::fromJson(char* jsonStr)
{
...
ApiNotFoundErrorResponse::ApiNotFoundErrorResponse(char* json)
{
	this->fromJson(json);
}
