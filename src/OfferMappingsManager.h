#ifndef _OfferMappingsManager_H_
#define _OfferMappingsManager_H_
...
/** \addtogroup OfferMappings OfferMappings
 * \ingroup Operations
 *  @{
 */
class OfferMappingsManager {
public:
	OfferMappingsManager();
	virtual ~OfferMappingsManager();
