...
#ifndef _MappingsOfferInfoDTO_H_
#define _MappingsOfferInfoDTO_H_
...
class MappingsOfferInfoDTO : public Object {
public:
	/*! \brief Constructor.
	 */
	MappingsOfferInfoDTO();
	MappingsOfferInfoDTO(char* str);
...
#endif /* _MappingsOfferInfoDTO_H_ */
