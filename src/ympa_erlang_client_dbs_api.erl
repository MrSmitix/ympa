-module(ympa_erlang_client_dbs_api).

-export([accept_order_cancellation/4, accept_order_cancellation/5,
         add_hidden_offers/3, add_hidden_offers/4,
         ...
         create_outlet/3, create_outlet/4,
         ...
         delete_outlet_licenses/2, delete_outlet_licenses/3,
         ...
         get_order_buyer_info/3, get_order_buyer_info/4,
