...
void
ApiClientDataErrorResponse::__init()
{
...
void
ApiClientDataErrorResponse::__cleanup()
{
	//if(status != NULL) {
	//
	//delete status;
...
void
ApiClientDataErrorResponse::fromJson(char* jsonStr)
{
...
ApiClientDataErrorResponse::ApiClientDataErrorResponse(char* json)
{
	this->fromJson(json);
}
