...
/**
 * The EnrichedMappingsOfferDTO model module.
 * @module model/EnrichedMappingsOfferDTO
 * @version LATEST
 */
class EnrichedMappingsOfferDTO {
    /**
     * Constructs a new <code>EnrichedMappingsOfferDTO</code>.
     * Информация о рекомендованных карточках товаров.
     * @alias module:model/EnrichedMappingsOfferDTO
     * @implements module:model/MappingsOfferDTO
     */
    constructor() { 
        MappingsOfferDTO.initialize(this);
        EnrichedMappingsOfferDTO.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EnrichedMappingsOfferDTO</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EnrichedMappingsOfferDTO} obj Optional instance to populate.
     * @return {module:model/EnrichedMappingsOfferDTO} The populated <code>EnrichedMappingsOfferDTO</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EnrichedMappingsOfferDTO();
            MappingsOfferDTO.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>EnrichedMappingsOfferDTO</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EnrichedMappingsOfferDTO</code>.
     */
 ...
 * @member {String} name
 */
EnrichedMappingsOfferDTO.prototype['name'] = undefined;
 ...
 */
EnrichedMappingsOfferDTO.prototype['shopSku'] = undefined;

/**
 * Категория товара в вашем магазине. Значение будет использовано для определения категории товара на Маркете в случае, если вы не передали категорию в параметре `marketCategoryId`.  Указывайте конкретные категории — например, набор ножей лучше отнести к категории **Столовые приборы**, а не просто **Посуда**.  Выбирайте категории, которые описывают товар, а не абстрактный признак — например, **Духи**, а не **Подарки**.  Значение будет использовано для определения категории товара на Маркете в случае, если вы не передали категорию в параметре `marketCategoryId`. 
 * @member {String} category
 */
EnrichedMappingsOfferDTO.prototype['category'] = undefined;

/**
 * Название бренда или производителя. Должно быть записано так, как его пишет сам бренд.
 * @member {String} vendor
 */
EnrichedMappingsOfferDTO.prototype['vendor'] = undefined;

/**
 * Артикул товара от производителя.
 * @member {String} vendorCode
 */
EnrichedMappingsOfferDTO.prototype['vendorCode'] = undefined;
 ...
 */
EnrichedMappingsOfferDTO.prototype['description'] = undefined;

/**
 * Ваш SKU — идентификатор товара в вашей системе.  Разрешена любая последовательность длиной до 255 знаков.  Правила использования SKU:  * У каждого товара SKU должен быть свой.  * SKU товара нельзя менять — можно только удалить товар и добавить заново с новым SKU.  * Уже заданный SKU нельзя освободить и использовать заново для другого товара. Каждый товар должен получать новый идентификатор, до того никогда не использовавшийся в вашем каталоге.  [Что такое SKU и как его назначать](https://yandex.ru/support/marketplace/assortment/add/index.html#fields) 
 * @member {String} id
 */
EnrichedMappingsOfferDTO.prototype['id'] = undefined;

/**
 * Идентификатор фида.
 * @member {Number} feedId
 */
EnrichedMappingsOfferDTO.prototype['feedId'] = undefined;

/**
 * Указывайте в виде последовательности цифр. Подойдут коды EAN-13, EAN-8, UPC-A, UPC-E или Code 128.  Для книг указывайте ISBN.  Для товаров [определенных категорий и торговых марок](https://yastatic.net/s3/doc-binary/src/support/market/ru/yandex-market-list-for-gtin.xlsx) штрихкод должен быть действительным кодом GTIN. Обратите внимание: внутренние штрихкоды, начинающиеся на 2 или 02, и коды формата Code 128 не являются GTIN.  [Что такое GTIN](*gtin)  
 * @member {Array.<String>} barcodes
 */
EnrichedMappingsOfferDTO.prototype['barcodes'] = undefined;
 ...
 */
EnrichedMappingsOfferDTO.prototype['manufacturer'] = undefined;
 ...
 */
EnrichedMappingsOfferDTO.prototype['manufacturerCountries'] = undefined;
 ...
 */
EnrichedMappingsOfferDTO.prototype['minShipment'] = undefined;
 ...
 */
EnrichedMappingsOfferDTO.prototype['transportUnitSize'] = undefined;
 ...
 */
EnrichedMappingsOfferDTO.prototype['quantumOfSupply'] = undefined;

/**
 * Срок, за который продавец поставляет товары на склад, в днях.
 * @member {Number} deliveryDurationDays
 */
EnrichedMappingsOfferDTO.prototype['deliveryDurationDays'] = undefined;
 ...
 */
EnrichedMappingsOfferDTO.prototype['boxCount'] = undefined;
 ...
 */
EnrichedMappingsOfferDTO.prototype['customsCommodityCodes'] = undefined;

/**
 * @member {module:model/OfferWeightDimensionsDTO} weightDimensions
 */
EnrichedMappingsOfferDTO.prototype['weightDimensions'] = undefined;

/**
 * Дни недели, в которые продавец поставляет товары на склад.
 * @member {Array.<module:model/DayOfWeekType>} supplyScheduleDays
 */
EnrichedMappingsOfferDTO.prototype['supplyScheduleDays'] = undefined;
 ...
 */
EnrichedMappingsOfferDTO.prototype['shelfLifeDays'] = undefined;
 ...
 */
EnrichedMappingsOfferDTO.prototype['lifeTimeDays'] = undefined;
 ...
 */
EnrichedMappingsOfferDTO.prototype['guaranteePeriodDays'] = undefined;

/**
 * @member {module:model/OfferProcessingStateDTO} processingState
 */
EnrichedMappingsOfferDTO.prototype['processingState'] = undefined;

/**
 * @member {module:model/OfferAvailabilityStatusType} availability
 */
EnrichedMappingsOfferDTO.prototype['availability'] = undefined;

/**
 * @member {module:model/TimePeriodDTO} shelfLife
 */
EnrichedMappingsOfferDTO.prototype['shelfLife'] = undefined;

/**
 * @member {module:model/TimePeriodDTO} lifeTime
 */
EnrichedMappingsOfferDTO.prototype['lifeTime'] = undefined;

/**
 * @member {module:model/TimePeriodDTO} guaranteePeriod
 */
EnrichedMappingsOfferDTO.prototype['guaranteePeriod'] = undefined;
 ...
 */
EnrichedMappingsOfferDTO.prototype['certificate'] = undefined;

/**
 * Цена на товар в рублях.
 * @member {Number} price
 */
EnrichedMappingsOfferDTO.prototype['price'] = undefined;
 ...
 */
EnrichedMappingsOfferDTO.prototype['marketCategoryId'] = undefined;
 ...
 */
EnrichedMappingsOfferDTO.prototype['marketCategoryName'] = undefined;
 ...
 */
EnrichedMappingsOfferDTO.prototype['marketModelId'] = undefined;
 ...
 */
EnrichedMappingsOfferDTO.prototype['marketModelName'] = undefined;

/**
 * SKU на Маркете.
 * @member {Number} marketSku
 */
EnrichedMappingsOfferDTO.prototype['marketSku'] = undefined;

/**
 * Название товара с рекомендованной карточки на Маркете.  Может отсутствовать в ответе. 
 * @member {String} marketSkuName
 */
EnrichedMappingsOfferDTO.prototype['marketSkuName'] = undefined;


// Implement MappingsOfferDTO interface:
/**
 * Составляйте название по схеме: тип + бренд или производитель + модель + особенности, если есть (например, цвет, размер или вес) и количество в упаковке.  Не включайте в название условия продажи (например, «скидка», «бесплатная доставка» и т. д.), эмоциональные характеристики («хит», «супер» и т. д.). Не пишите слова большими буквами — кроме устоявшихся названий брендов и моделей.  Оптимальная длина — 50–60 символов, максимальная — 256.  [Рекомендации и правила](https://yandex.ru/support/marketplace/assortment/fields/title.html) 
 * @member {String} name
 */
MappingsOfferDTO.prototype['name'] = undefined;
/**
 * Ваш SKU — идентификатор товара в вашей системе.  Разрешена любая последовательность длиной до 255 знаков.  Правила использования SKU:  * У каждого товара SKU должен быть свой.  * SKU товара нельзя менять — можно только удалить товар и добавить заново с новым SKU.  * Уже заданный SKU нельзя освободить и использовать заново для другого товара. Каждый товар должен получать новый идентификатор, до того никогда не использовавшийся в вашем каталоге.  [Что такое SKU и как его назначать](https://yandex.ru/support/marketplace/assortment/add/index.html#fields) 
 * @member {String} shopSku
 */
MappingsOfferDTO.prototype['shopSku'] = undefined;
/**
 * Категория товара в вашем магазине. Значение будет использовано для определения категории товара на Маркете в случае, если вы не передали категорию в параметре `marketCategoryId`.  Указывайте конкретные категории — например, набор ножей лучше отнести к категории **Столовые приборы**, а не просто **Посуда**.  Выбирайте категории, которые описывают товар, а не абстрактный признак — например, **Духи**, а не **Подарки**.  Значение будет использовано для определения категории товара на Маркете в случае, если вы не передали категорию в параметре `marketCategoryId`. 
 * @member {String} category
 */
MappingsOfferDTO.prototype['category'] = undefined;
/**
 * Название бренда или производителя. Должно быть записано так, как его пишет сам бренд.
 * @member {String} vendor
 */
MappingsOfferDTO.prototype['vendor'] = undefined;
/**
 * Артикул товара от производителя.
 * @member {String} vendorCode
 */
MappingsOfferDTO.prototype['vendorCode'] = undefined;
/**
 * Подробное описание товара: например, его преимущества и особенности.  Не давайте в описании инструкций по установке и сборке. Не используйте слова «скидка», «распродажа», «дешевый», «подарок» (кроме подарочных категорий), «бесплатно», «акция», «специальная цена», «новинка», «new», «аналог», «заказ», «хит». Не указывайте никакой контактной информации и не давайте ссылок.  Можно использовать теги:  * \\<h>, \\<h1>, \\<h2> и так далее — для заголовков; * \\<br> и \\<p> — для переноса строки; * \\<ol> — для нумерованного списка; * \\<ul> — для маркированного списка; * \\<li> — для создания элементов списка (должен находиться внутри \\<ol> или \\<ul>); * \\<div> — поддерживается, но не влияет на отображение текста.  Оптимальная длина — 400–600 символов, максимальная — 6000.  [Рекомендации и правила](https://yandex.ru/support/marketplace/assortment/fields/description.html) 
 * @member {String} description
 */
MappingsOfferDTO.prototype['description'] = undefined;
/**
 * Ваш SKU — идентификатор товара в вашей системе.  Разрешена любая последовательность длиной до 255 знаков.  Правила использования SKU:  * У каждого товара SKU должен быть свой.  * SKU товара нельзя менять — можно только удалить товар и добавить заново с новым SKU.  * Уже заданный SKU нельзя освободить и использовать заново для другого товара. Каждый товар должен получать новый идентификатор, до того никогда не использовавшийся в вашем каталоге.  [Что такое SKU и как его назначать](https://yandex.ru/support/marketplace/assortment/add/index.html#fields) 
 * @member {String} id
 */
MappingsOfferDTO.prototype['id'] = undefined;
/**
 * Идентификатор фида.
 * @member {Number} feedId
 */
MappingsOfferDTO.prototype['feedId'] = undefined;
/**
 * Указывайте в виде последовательности цифр. Подойдут коды EAN-13, EAN-8, UPC-A, UPC-E или Code 128.  Для книг указывайте ISBN.  Для товаров [определенных категорий и торговых марок](https://yastatic.net/s3/doc-binary/src/support/market/ru/yandex-market-list-for-gtin.xlsx) штрихкод должен быть действительным кодом GTIN. Обратите внимание: внутренние штрихкоды, начинающиеся на 2 или 02, и коды формата Code 128 не являются GTIN.  [Что такое GTIN](*gtin)  
 * @member {Array.<String>} barcodes
 */
MappingsOfferDTO.prototype['barcodes'] = undefined;
/**
 * URL фотографии товара или страницы с описанием на вашем сайте.  Переданные данные не будут отображаться на витрине, но они помогут специалистам Маркета найти карточку для вашего товара.  Должен содержать один вложенный параметр url. 
 * @member {Array.<String>} urls
 */
MappingsOfferDTO.prototype['urls'] = undefined;
/**
 * Ссылки (URL) изображений товара в хорошем качестве.  Можно указать до 30 ссылок. При этом изображение по первой ссылке будет основным. Оно используется в качестве изображения товара в поиске Маркета и на карточке товара. Другие изображения товара доступны в режиме просмотра увеличенных изображений.  Обязательный параметр.  Должен содержать хотя бы один вложенный параметр `picture`. 
 * @member {Array.<String>} pictures
 */
MappingsOfferDTO.prototype['pictures'] = undefined;
/**
 * Изготовитель товара: компания, которая произвела товар, ее адрес и регистрационный номер (если есть).  Необязательный параметр. 
 * @member {String} manufacturer
 */
MappingsOfferDTO.prototype['manufacturer'] = undefined;
/**
 * Список стран, в которых произведен товар.  Обязательный параметр.  Должен содержать хотя бы одну, но не больше 5 стран. 
 * @member {Array.<String>} manufacturerCountries
 */
MappingsOfferDTO.prototype['manufacturerCountries'] = undefined;
/**
 * Минимальное количество единиц товара, которое вы поставляете на склад.  Например, если вы поставляете детское питание партиями минимум по 10 коробок, а в каждой коробке по 6 баночек, укажите значение 60. 
 * @member {Number} minShipment
 */
MappingsOfferDTO.prototype['minShipment'] = undefined;
/**
 * Количество единиц товара в одной упаковке, которую вы поставляете на склад.  Например, если вы поставляете детское питание коробками по 6 баночек, укажите значение 6. 
 * @member {Number} transportUnitSize
 */
MappingsOfferDTO.prototype['transportUnitSize'] = undefined;
/**
 * Добавочная партия: по сколько единиц товара можно добавлять к минимальному количеству minShipment.  Например, если вы поставляете детское питание партиями минимум по 10 коробок и хотите добавлять к минимальной партии по 2 коробки, а в каждой коробке по 6 баночек, укажите значение 12. 
 * @member {Number} quantumOfSupply
 */
MappingsOfferDTO.prototype['quantumOfSupply'] = undefined;
/**
 * Срок, за который продавец поставляет товары на склад, в днях.
 * @member {Number} deliveryDurationDays
 */
MappingsOfferDTO.prototype['deliveryDurationDays'] = undefined;
/**
 * Сколько мест (если больше одного) занимает товар.  Параметр указывается, только если товар занимает больше одного места (например, кондиционер занимает два места: внешний и внутренний блоки в двух коробках). Если товар занимает одно место, не указывайте этот параметр. 
 * @member {Number} boxCount
 */
MappingsOfferDTO.prototype['boxCount'] = undefined;
/**
 * Список кодов товара в единой Товарной номенклатуре внешнеэкономической деятельности (ТН ВЭД).  Обязательный параметр, если товар подлежит особому учету (например, в системе «Меркурий» как продукция животного происхождения или в системе «Честный ЗНАК»).  Может содержать только один вложенный код ТН ВЭД. 
 * @member {Array.<String>} customsCommodityCodes
 */
MappingsOfferDTO.prototype['customsCommodityCodes'] = undefined;
/**
 * @member {module:model/OfferWeightDimensionsDTO} weightDimensions
 */
MappingsOfferDTO.prototype['weightDimensions'] = undefined;
/**
 * Дни недели, в которые продавец поставляет товары на склад.
 * @member {Array.<module:model/DayOfWeekType>} supplyScheduleDays
 */
MappingsOfferDTO.prototype['supplyScheduleDays'] = undefined;
/**
 * {% note warning \"\" %}  Этот параметр устарел. Вместо него используйте `shelfLife`. Совместное использование обоих параметров приведет к ошибке.  {% endnote %}  Срок годности: через сколько дней товар станет непригоден для использования. 
 * @member {Number} shelfLifeDays
 */
MappingsOfferDTO.prototype['shelfLifeDays'] = undefined;
/**
 * {% note warning \"\" %}  Этот параметр устарел. Вместо него используйте `lifeTime`. Совместное использование обоих параметров приведет к ошибке.  {% endnote %}  Срок службы: сколько дней товар будет исправно выполнять свою функцию, а изготовитель — нести ответственность за его существенные недостатки. 
 * @member {Number} lifeTimeDays
 */
MappingsOfferDTO.prototype['lifeTimeDays'] = undefined;
/**
 * Гарантийный срок товара: сколько дней возможно обслуживание и ремонт товара или возврат денег, а изготовитель или продавец будет нести ответственность за недостатки товара. 
 * @member {Number} guaranteePeriodDays
 */
MappingsOfferDTO.prototype['guaranteePeriodDays'] = undefined;
/**
 * @member {module:model/OfferProcessingStateDTO} processingState
 */
MappingsOfferDTO.prototype['processingState'] = undefined;
/**
 * @member {module:model/OfferAvailabilityStatusType} availability
 */
MappingsOfferDTO.prototype['availability'] = undefined;
/**
 * @member {module:model/TimePeriodDTO} shelfLife
 */
MappingsOfferDTO.prototype['shelfLife'] = undefined;
/**
 * @member {module:model/TimePeriodDTO} lifeTime
 */
MappingsOfferDTO.prototype['lifeTime'] = undefined;
/**
 * @member {module:model/TimePeriodDTO} guaranteePeriod
 */
MappingsOfferDTO.prototype['guaranteePeriod'] = undefined;
/**
 * Номер документа на товар.  Перед указанием номера документ нужно загрузить в кабинете продавца на Маркете. [Инструкция](https://yandex.ru/support/marketplace/assortment/restrictions/certificates.html) 
 * @member {String} certificate
 */
MappingsOfferDTO.prototype['certificate'] = undefined;
/**
 * Цена на товар в рублях.
 * @member {Number} price
 */
MappingsOfferDTO.prototype['price'] = undefined;




export default EnrichedMappingsOfferDTO;
