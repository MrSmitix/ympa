...
void DeletePromoOffersResponse::validate()
{
    // TODO: implement validation
}

web::json::value DeletePromoOffersResponse::toJson() const
{
...
bool DeletePromoOffersResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<DeletePromoOffersResultDTO> refVal_setResult;
...
void DeletePromoOffersResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool DeletePromoOffersResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
void DeletePromoOffersResponse::setStatus(const std::shared_ptr<ApiResponseStatusType>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}
...
void DeletePromoOffersResponse::setResult(const std::shared_ptr<DeletePromoOffersResultDTO>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}
