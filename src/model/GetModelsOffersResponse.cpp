...
void GetModelsOffersResponse::validate()
{
    // TODO: implement validation
}

web::json::value GetModelsOffersResponse::toJson() const
{
...
bool GetModelsOffersResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void GetModelsOffersResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GetModelsOffersResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<std::shared_ptr<EnrichedModelDTO>>& GetModelsOffersResponse::getModels()
{
    return m_Models;
}

void GetModelsOffersResponse::setModels(const std::vector<std::shared_ptr<EnrichedModelDTO>>& value)
{
    m_Models = value;
    m_ModelsIsSet = true;
}

bool GetModelsOffersResponse::modelsIsSet() const
{
    return m_ModelsIsSet;
}

void GetModelsOffersResponse::unsetModels()
{
    m_ModelsIsSet = false;
}
...
void GetModelsOffersResponse::setCurrency(const std::shared_ptr<CurrencyType>& value)
{
    m_Currency = value;
