...
void UpdateOfferMappingsResponse::validate()
{
    // TODO: implement validation
}

web::json::value UpdateOfferMappingsResponse::toJson() const
{
...
bool UpdateOfferMappingsResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("results"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<UpdateOfferMappingResultDTO>> refVal_setResults;
...
void UpdateOfferMappingsResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool UpdateOfferMappingsResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
void UpdateOfferMappingsResponse::setStatus(const std::shared_ptr<ApiResponseStatusType>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}
...
std::vector<std::shared_ptr<UpdateOfferMappingResultDTO>>& UpdateOfferMappingsResponse::getResults()
{
    return m_Results;
}

void UpdateOfferMappingsResponse::setResults(const std::vector<std::shared_ptr<UpdateOfferMappingResultDTO>>& value)
{
    m_Results = value;
    m_ResultsIsSet = true;
}
