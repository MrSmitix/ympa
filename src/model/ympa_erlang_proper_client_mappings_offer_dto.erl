-module(ympa_erlang_proper_client_mappings_offer_dto).

-include("ympa_erlang_proper_client.hrl").

-export([ympa_erlang_proper_client_mappings_offer_dto/0]).

-export([ympa_erlang_proper_client_mappings_offer_dto/1]).

-export_type([ympa_erlang_proper_client_mappings_offer_dto/0]).

-type ympa_erlang_proper_client_mappings_offer_dto() ::
  [ {'name', binary() }
  | {'shopSku', binary() }
  | {'category', binary() }
  | {'vendor', binary() }
...
ympa_erlang_proper_client_mappings_offer_dto() ->
    ympa_erlang_proper_client_mappings_offer_dto([]).

ympa_erlang_proper_client_mappings_offer_dto(Fields) ->
  Default = [ {'name', binary() }
