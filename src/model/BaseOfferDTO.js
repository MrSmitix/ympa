...
/**
 * The BaseOfferDTO model module.
 * @module model/BaseOfferDTO
 * @version LATEST
 */
class BaseOfferDTO {
    /**
     * Constructs a new <code>BaseOfferDTO</code>.
     * Основные параметры товара.
     * @alias module:model/BaseOfferDTO
    ...
    /**
     * Constructs a <code>BaseOfferDTO</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BaseOfferDTO} obj Optional instance to populate.
     * @return {module:model/BaseOfferDTO} The populated <code>BaseOfferDTO</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BaseOfferDTO();
    ...
    /**
     * Validates the JSON data with respect to <code>BaseOfferDTO</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BaseOfferDTO</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of BaseOfferDTO.RequiredProperties) {
...
BaseOfferDTO.RequiredProperties = ["offerId"];
