-module(ympa_erlang_proper_client_shipment_dto).

-include("ympa_erlang_proper_client.hrl").

-export([ympa_erlang_proper_client_shipment_dto/0]).

-export([ympa_erlang_proper_client_shipment_dto/1]).

-export_type([ympa_erlang_proper_client_shipment_dto/0]).

-type ympa_erlang_proper_client_shipment_dto() ::
  [ {'id', integer() }
...
ympa_erlang_proper_client_shipment_dto() ->
    ympa_erlang_proper_client_shipment_dto([]).

ympa_erlang_proper_client_shipment_dto(Fields) ->
  Default = [ {'id', integer() }
            , {'planIntervalFrom', datetime() }
            , {'planIntervalTo', datetime() }
            , {'shipmentType', ympa_erlang_proper_client_shipment_type:ympa_erlang_proper_client_shipment_type() }
