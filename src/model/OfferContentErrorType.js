...
* @readonly
*/
export default class OfferContentErrorType {
    ...
    /**
    * Returns a <code>OfferContentErrorType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/OfferContentErrorType} The enum <code>OfferContentErrorType</code> value.
    */
