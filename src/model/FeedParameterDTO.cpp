...
void FeedParameterDTO::validate()
{
    // TODO: implement validation
}

web::json::value FeedParameterDTO::toJson() const
{
...
bool FeedParameterDTO::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void FeedParameterDTO::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool FeedParameterDTO::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t FeedParameterDTO::getName() const
{
    return m_Name;
}

void FeedParameterDTO::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool FeedParameterDTO::nameIsSet() const
{
    return m_NameIsSet;
}

void FeedParameterDTO::unsetName()
{
    m_NameIsSet = false;
}
std::vector<int32_t>& FeedParameterDTO::getValues()
{
    return m_Values;
}
