...
void BriefOrderItemInstanceDTO::validate()
{
    // TODO: implement validation
}

web::json::value BriefOrderItemInstanceDTO::toJson() const
{
...
bool BriefOrderItemInstanceDTO::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void BriefOrderItemInstanceDTO::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BriefOrderItemInstanceDTO::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t BriefOrderItemInstanceDTO::getCis() const
{
    return m_Cis;
}

void BriefOrderItemInstanceDTO::setCis(const utility::string_t& value)
{
    m_Cis = value;
    m_CisIsSet = true;
}
...
utility::string_t BriefOrderItemInstanceDTO::getUin() const
{
    return m_Uin;
}

void BriefOrderItemInstanceDTO::setUin(const utility::string_t& value)
{
    m_Uin = value;
    m_UinIsSet = true;
}
...
utility::string_t BriefOrderItemInstanceDTO::getRnpt() const
{
    return m_Rnpt;
}

void BriefOrderItemInstanceDTO::setRnpt(const utility::string_t& value)
{
    m_Rnpt = value;
    m_RnptIsSet = true;
}
...
utility::string_t BriefOrderItemInstanceDTO::getGtd() const
{
    return m_Gtd;
}

void BriefOrderItemInstanceDTO::setGtd(const utility::string_t& value)
{
    m_Gtd = value;
    m_GtdIsSet = true;
}
