...
#include "ympa_cpp_restsdk_client/model/ApiResponse.h"
...
std::shared_ptr<ApiResponseStatusType> ApiResponse::getStatus() const
{
    return m_Status;
}

void ApiResponse::setStatus(const std::shared_ptr<ApiResponseStatusType>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}
