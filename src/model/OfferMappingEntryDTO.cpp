...
void OfferMappingEntryDTO::validate()
{
    // TODO: implement validation
}

web::json::value OfferMappingEntryDTO::toJson() const
{
...
bool OfferMappingEntryDTO::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("offer"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<MappingsOfferDTO> refVal_setOffer;
...
void OfferMappingEntryDTO::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool OfferMappingEntryDTO::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
void OfferMappingEntryDTO::setMapping(const std::shared_ptr<OfferMappingDTO>& value)
{
    m_Mapping = value;
    m_MappingIsSet = true;
}
...
void OfferMappingEntryDTO::setAwaitingModerationMapping(const std::shared_ptr<OfferMappingDTO>& value)
{
...
void OfferMappingEntryDTO::setRejectedMapping(const std::shared_ptr<OfferMappingDTO>& value)
{
...
void OfferMappingEntryDTO::setOffer(const std::shared_ptr<MappingsOfferDTO>& value)
{
    m_Offer = value;
    m_OfferIsSet = true;
}
