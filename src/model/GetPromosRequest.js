...
class GetPromosRequest {
    ...
    /**
     * Validates the JSON data with respect to <code>GetPromosRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetPromosRequest</code>.
     */
 ...
 */
GetPromosRequest.prototype['participation'] = undefined;

/**
 * @member {module:model/MechanicsType} mechanics
 */
GetPromosRequest.prototype['mechanics'] = undefined;
