...
class GoodsFeedbackDescriptionDTO {
    ...
    /**
     * Validates the JSON data with respect to <code>GoodsFeedbackDescriptionDTO</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GoodsFeedbackDescriptionDTO</code>.
     */
    static validateJSON(data) {
        // ensure the json data is a string
        if (data['advantages'] && !(typeof data['advantages'] === 'string' || data['advantages'] instanceof String)) {
            throw new Error("Expected the field `advantages` to be a primitive type in the JSON string but got " + data['advantages']);
        }
        // ensure the json data is a string
        if (data['disadvantages'] && !(typeof data['disadvantages'] === 'string' || data['disadvantages'] instanceof String)) {
            throw new Error("Expected the field `disadvantages` to be a primitive type in the JSON string but got " + data['disadvantages']);
        }
        // ensure the json data is a string
 ...
 */
GoodsFeedbackDescriptionDTO.prototype['advantages'] = undefined;

/**
 * Описание минусов товара в отзыве.
 * @member {String} disadvantages
 */
GoodsFeedbackDescriptionDTO.prototype['disadvantages'] = undefined;

/**
 * Комментарий в отзыве.
 * @member {String} comment
 */
GoodsFeedbackDescriptionDTO.prototype['comment'] = undefined;
