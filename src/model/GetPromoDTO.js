...
class GetPromoDTO {
    ...
    /**
     * Validates the JSON data with respect to <code>GetPromoDTO</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetPromoDTO</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetPromoDTO.RequiredProperties) {
        ...
        if (data['period']) { // data not null
          PromoPeriodDTO.validateJSON(data['period']);
        }
        // validate the optional field `assortmentInfo`
        if (data['assortmentInfo']) { // data not null
          GetPromoAssortmentInfoDTO.validateJSON(data['assortmentInfo']);
        }
        // validate the optional field `mechanicsInfo`
        if (data['mechanicsInfo']) { // data not null
          GetPromoMechanicsInfoDTO.validateJSON(data['mechanicsInfo']);
        }
        // validate the optional field `bestsellerInfo`
        if (data['bestsellerInfo']) { // data not null
          GetPromoBestsellerInfoDTO.validateJSON(data['bestsellerInfo']);
        }
        if (data['channels']) { // data not null
            ...
            for (const item of data['channels']) {
                ChannelType.validateJSON(item);
            };
        }
        // validate the optional field `constraints`
        if (data['constraints']) { // data not null
          GetPromoConstraintsDTO.validateJSON(data['constraints']);
        }
...
GetPromoDTO.RequiredProperties = ["id", "name", "period", "participating", "assortmentInfo", "mechanicsInfo", "bestsellerInfo"];

/**
 * Идентификатор акции.
 * @member {String} id
 */
GetPromoDTO.prototype['id'] = undefined;

/**
 * Название акции.
 * @member {String} name
 */
GetPromoDTO.prototype['name'] = undefined;

/**
 * @member {module:model/PromoPeriodDTO} period
 */
GetPromoDTO.prototype['period'] = undefined;

/**
 * Участвует или участвовал ли продавец в этой акции.  Для текущих и будущих акций возвращается со значением `true`, если в акции есть товары, которые были добавлены вручную. Если товары не участвуют в акции или добавлены в нее автоматически, параметр возвращается со значением `false`.  Для прошедших акций всегда возвращается со значением `true`.  Об автоматическом и ручном добавлении товаров в акцию читайте [в Справке Маркета для продавцов](https://yandex.ru/support2/marketplace/ru/marketing/promos/market/index). 
 * @member {Boolean} participating
 */
GetPromoDTO.prototype['participating'] = undefined;

/**
 * @member {module:model/GetPromoAssortmentInfoDTO} assortmentInfo
 */
GetPromoDTO.prototype['assortmentInfo'] = undefined;

/**
 * @member {module:model/GetPromoMechanicsInfoDTO} mechanicsInfo
 */
GetPromoDTO.prototype['mechanicsInfo'] = undefined;

/**
 * @member {module:model/GetPromoBestsellerInfoDTO} bestsellerInfo
 */
GetPromoDTO.prototype['bestsellerInfo'] = undefined;

/**
 * Список каналов продвижения товаров.
 * @member {Array.<module:model/ChannelType>} channels
 */
GetPromoDTO.prototype['channels'] = undefined;

/**
 * @member {module:model/GetPromoConstraintsDTO} constraints
 */
GetPromoDTO.prototype['constraints'] = undefined;
