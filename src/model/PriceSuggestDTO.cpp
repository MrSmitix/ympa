...
void PriceSuggestDTO::validate()
{
    // TODO: implement validation
}

web::json::value PriceSuggestDTO::toJson() const
{
...
bool PriceSuggestDTO::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("type"))))
    {
        ...
        {
            std::shared_ptr<PriceSuggestType> refVal_setType;
...
void PriceSuggestDTO::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PriceSuggestDTO::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
void PriceSuggestDTO::setType(const std::shared_ptr<PriceSuggestType>& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}
