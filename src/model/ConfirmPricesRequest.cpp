...
void ConfirmPricesRequest::validate()
{
    // TODO: implement validation
}

web::json::value ConfirmPricesRequest::toJson() const
{
...
bool ConfirmPricesRequest::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void ConfirmPricesRequest::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ConfirmPricesRequest::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<std::shared_ptr<utility::string_t>>& ConfirmPricesRequest::getOfferIds()
{
    return m_OfferIds;
}

void ConfirmPricesRequest::setOfferIds(const std::vector<std::shared_ptr<utility::string_t>>& value)
{
    m_OfferIds = value;
    m_OfferIdsIsSet = true;
}

bool ConfirmPricesRequest::offerIdsIsSet() const
{
    return m_OfferIdsIsSet;
}

void ConfirmPricesRequest::unsetOfferIds()
{
    m_OfferIdsIsSet = false;
}
}
