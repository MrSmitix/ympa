...
void GetCampaignSettingsResponse::validate()
{
    // TODO: implement validation
}

web::json::value GetCampaignSettingsResponse::toJson() const
{
...
bool GetCampaignSettingsResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("settings"))))
    {
        ...
        {
            std::shared_ptr<CampaignSettingsDTO> refVal_setSettings;
...
void GetCampaignSettingsResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GetCampaignSettingsResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
void GetCampaignSettingsResponse::setSettings(const std::shared_ptr<CampaignSettingsDTO>& value)
{
    m_Settings = value;
