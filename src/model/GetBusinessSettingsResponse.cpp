...
void GetBusinessSettingsResponse::validate()
{
    // TODO: implement validation
}

web::json::value GetBusinessSettingsResponse::toJson() const
{
...
bool GetBusinessSettingsResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<GetBusinessSettingsInfoDTO> refVal_setResult;
...
void GetBusinessSettingsResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GetBusinessSettingsResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
void GetBusinessSettingsResponse::setStatus(const std::shared_ptr<ApiResponseStatusType>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}
...
void GetBusinessSettingsResponse::setResult(const std::shared_ptr<GetBusinessSettingsInfoDTO>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}
