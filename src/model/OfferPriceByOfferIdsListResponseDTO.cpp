...
#include "ympa_cpp_restsdk_client/model/OfferPriceByOfferIdsListResponseDTO.h"
...
void OfferPriceByOfferIdsListResponseDTO::validate()
{
    // TODO: implement validation
}

web::json::value OfferPriceByOfferIdsListResponseDTO::toJson() const
{
...
bool OfferPriceByOfferIdsListResponseDTO::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("offers"))))
    {
        ...
        {
            std::vector<std::shared_ptr<OfferPriceByOfferIdsResponseDTO>> refVal_setOffers;
...
void OfferPriceByOfferIdsListResponseDTO::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool OfferPriceByOfferIdsListResponseDTO::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<std::shared_ptr<OfferPriceByOfferIdsResponseDTO>>& OfferPriceByOfferIdsListResponseDTO::getOffers()
{
    return m_Offers;
}

void OfferPriceByOfferIdsListResponseDTO::setOffers(const std::vector<std::shared_ptr<OfferPriceByOfferIdsResponseDTO>>& value)
{
    m_Offers = value;
    m_OffersIsSet = true;
}

bool OfferPriceByOfferIdsListResponseDTO::offersIsSet() const
{
    return m_OffersIsSet;
}

void OfferPriceByOfferIdsListResponseDTO::unsetOffers()
{
    m_OffersIsSet = false;
}
...
void OfferPriceByOfferIdsListResponseDTO::setPaging(const std::shared_ptr<ScrollingPagerDTO>& value)
{
    m_Paging = value;
    m_PagingIsSet = true;
}
