...
void AddOffersToArchiveRequest::validate()
{
    // TODO: implement validation
}

web::json::value AddOffersToArchiveRequest::toJson() const
{
...
bool AddOffersToArchiveRequest::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void AddOffersToArchiveRequest::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AddOffersToArchiveRequest::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<std::shared_ptr<utility::string_t>>& AddOffersToArchiveRequest::getOfferIds()
{
    return m_OfferIds;
}

void AddOffersToArchiveRequest::setOfferIds(const std::vector<std::shared_ptr<utility::string_t>>& value)
{
    m_OfferIds = value;
    m_OfferIdsIsSet = true;
}

bool AddOffersToArchiveRequest::offerIdsIsSet() const
{
    return m_OfferIdsIsSet;
}

void AddOffersToArchiveRequest::unsetOfferIds()
{
    m_OfferIdsIsSet = false;
}
}
