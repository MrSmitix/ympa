...
class OfferSellingProgramDTO {
    ...
    /**
     * Validates the JSON data with respect to <code>OfferSellingProgramDTO</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OfferSellingProgramDTO</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of OfferSellingProgramDTO.RequiredProperties) {
...
OfferSellingProgramDTO.RequiredProperties = ["sellingProgram", "status"];

/**
 * @member {module:model/SellingProgramType} sellingProgram
 */
OfferSellingProgramDTO.prototype['sellingProgram'] = undefined;

/**
 * @member {module:model/OfferSellingProgramStatusType} status
 */
OfferSellingProgramDTO.prototype['status'] = undefined;
