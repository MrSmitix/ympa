...
void DeleteOffersRequest::validate()
{
    // TODO: implement validation
}

web::json::value DeleteOffersRequest::toJson() const
{
...
bool DeleteOffersRequest::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void DeleteOffersRequest::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool DeleteOffersRequest::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<std::shared_ptr<utility::string_t>>& DeleteOffersRequest::getOfferIds()
{
    return m_OfferIds;
}

void DeleteOffersRequest::setOfferIds(const std::vector<std::shared_ptr<utility::string_t>>& value)
{
    m_OfferIds = value;
    m_OfferIdsIsSet = true;
}

bool DeleteOffersRequest::offerIdsIsSet() const
{
    return m_OfferIdsIsSet;
}

void DeleteOffersRequest::unsetOfferIds()
{
    m_OfferIdsIsSet = false;
}
}
