...
void OrderBuyerDTO::validate()
{
    // TODO: implement validation
}

web::json::value OrderBuyerDTO::toJson() const
{
...
bool OrderBuyerDTO::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void OrderBuyerDTO::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool OrderBuyerDTO::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t OrderBuyerDTO::getId() const
{
    return m_Id;
}

void OrderBuyerDTO::setId(const utility::string_t& value)
{
    m_Id = value;
    m_IdIsSet = true;
}
...
utility::string_t OrderBuyerDTO::getLastName() const
{
    return m_LastName;
}

void OrderBuyerDTO::setLastName(const utility::string_t& value)
{
    m_LastName = value;
...
utility::string_t OrderBuyerDTO::getFirstName() const
{
    return m_FirstName;
}

void OrderBuyerDTO::setFirstName(const utility::string_t& value)
{
    m_FirstName = value;
...
utility::string_t OrderBuyerDTO::getMiddleName() const
{
    return m_MiddleName;
}

void OrderBuyerDTO::setMiddleName(const utility::string_t& value)
{
    m_MiddleName = value;
...
void OrderBuyerDTO::setType(const std::shared_ptr<OrderBuyerType>& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}
