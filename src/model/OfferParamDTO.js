...
class OfferParamDTO {
    ...
    /**
     * Validates the JSON data with respect to <code>OfferParamDTO</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OfferParamDTO</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of OfferParamDTO.RequiredProperties) {
...
OfferParamDTO.RequiredProperties = ["name", "value"];
 ...
 * @member {String} name
 */
OfferParamDTO.prototype['name'] = undefined;

/**
 * Значение. 
 * @member {String} value
 */
OfferParamDTO.prototype['value'] = undefined;
