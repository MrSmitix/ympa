...
void DeleteCampaignOffersDTO::validate()
{
    // TODO: implement validation
}

web::json::value DeleteCampaignOffersDTO::toJson() const
{
...
bool DeleteCampaignOffersDTO::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void DeleteCampaignOffersDTO::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool DeleteCampaignOffersDTO::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<std::shared_ptr<utility::string_t>>& DeleteCampaignOffersDTO::getNotDeletedOfferIds()
{
    return m_NotDeletedOfferIds;
}

void DeleteCampaignOffersDTO::setNotDeletedOfferIds(const std::vector<std::shared_ptr<utility::string_t>>& value)
{
