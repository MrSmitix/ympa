...
class GenerateGoodsRealizationReportRequest {
    ...
    /**
     * Validates the JSON data with respect to <code>GenerateGoodsRealizationReportRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GenerateGoodsRealizationReportRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GenerateGoodsRealizationReportRequest.RequiredProperties) {
...
GenerateGoodsRealizationReportRequest.RequiredProperties = ["campaignId", "year", "month"];

/**
 * Идентификатор кампании.
 * @member {Number} campaignId
 */
GenerateGoodsRealizationReportRequest.prototype['campaignId'] = undefined;

/**
 * Год.
 * @member {Number} year
 */
GenerateGoodsRealizationReportRequest.prototype['year'] = undefined;

/**
 * Номер месяца.
 * @member {Number} month
 */
GenerateGoodsRealizationReportRequest.prototype['month'] = undefined;
