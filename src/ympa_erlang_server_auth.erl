-module(ympa_erlang_server_auth).
...
authorize_api_key(LogicHandler, OperationID, From, KeyParam, Req0) ->
    ...
    case ApiKey of
        ...
        _ ->
            Result = ympa_erlang_server_logic_handler:authorize_api_key(
                LogicHandler,
                OperationID,
                ApiKey
            ),
...
get_api_key(header, KeyParam, Req) ->
    ...
    {
        maps:get(
            ympa_erlang_server_utils:to_header(KeyParam),
            Headers,
            undefined
        ),
        Req
...
get_api_key(qs_val, KeyParam, Req) ->
    ...
    { ympa_erlang_server_utils:get_opt(KeyParam, QS), Req}.
