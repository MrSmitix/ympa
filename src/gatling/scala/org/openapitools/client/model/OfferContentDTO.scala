...
case class OfferContentDTO (
    ...
    _parameterValues: List[ParameterValueDTO]
)
object OfferContentDTO {
    def toStringBody(var_offerId: Object, var_categoryId: Object, var_parameterValues: Object) =
        s"""
        | {
        | "offerId":$var_offerId,"categoryId":$var_categoryId,"parameterValues":$var_parameterValues
        | }
        """.stripMargin
}
