...
case class GetOfferDTO (
    ...
    _manuals: Option[List[OfferManualDTO]],
    ...
    _customsCommodityCode: Option[String],
    ...
    _certificates: Option[List[String]],
    /* Количество грузовых мест.  Параметр используется, если товар представляет собой несколько коробок, упаковок и так далее. Например, кондиционер занимает два места — внешний и внутренний блоки в двух коробках.  Для товаров, занимающих одно место, не передавайте этот параметр.  */
    _boxCount: Option[Integer],
    _condition: Option[OfferConditionDTO],
    _type: Option[OfferType],
    ...
    _params: Option[List[OfferParamDTO]],
    _basicPrice: Option[GetPriceWithDiscountDTO],
    _purchasePrice: Option[GetPriceDTO],
    _additionalExpenses: Option[GetPriceDTO],
    _cofinancePrice: Option[GetPriceDTO],
    _cardStatus: Option[OfferCardStatusType],
    /* Список магазинов, в которых размещен товар.  */
    _campaigns: Option[List[OfferCampaignStatusDTO]],
    /* Информация о том, какие для товара доступны модели размещения.  */
    _sellingPrograms: Option[List[OfferSellingProgramDTO]],
    /* Товар помещен в архив.  */
    _archived: Option[Boolean]
)
object GetOfferDTO {
    def toStringBody(var_offerId: Object, var_name: Object, var_marketCategoryId: Object, var_category: Object, var_pictures: Object, var_videos: Object, var_manuals: Object, var_vendor: Object, var_barcodes: Object, var_description: Object, var_manufacturerCountries: Object, var_weightDimensions: Object, var_vendorCode: Object, var_tags: Object, var_shelfLife: Object, var_lifeTime: Object, var_guaranteePeriod: Object, var_customsCommodityCode: Object, var_certificates: Object, var_boxCount: Object, var_condition: Object, var_type: Object, var_downloadable: Object, var_adult: Object, var_age: Object, var_params: Object, var_basicPrice: Object, var_purchasePrice: Object, var_additionalExpenses: Object, var_cofinancePrice: Object, var_cardStatus: Object, var_campaigns: Object, var_sellingPrograms: Object, var_archived: Object) =
        s"""
        | {
        | "offerId":$var_offerId,"name":$var_name,"marketCategoryId":$var_marketCategoryId,"category":$var_category,"pictures":$var_pictures,"videos":$var_videos,"manuals":$var_manuals,"vendor":$var_vendor,"barcodes":$var_barcodes,"description":$var_description,"manufacturerCountries":$var_manufacturerCountries,"weightDimensions":$var_weightDimensions,"vendorCode":$var_vendorCode,"tags":$var_tags,"shelfLife":$var_shelfLife,"lifeTime":$var_lifeTime,"guaranteePeriod":$var_guaranteePeriod,"customsCommodityCode":$var_customsCommodityCode,"certificates":$var_certificates,"boxCount":$var_boxCount,"condition":$var_condition,"type":$var_type,"downloadable":$var_downloadable,"adult":$var_adult,"age":$var_age,"params":$var_params,"basicPrice":$var_basicPrice,"purchasePrice":$var_purchasePrice,"additionalExpenses":$var_additionalExpenses,"cofinancePrice":$var_cofinancePrice,"cardStatus":$var_cardStatus,"campaigns":$var_campaigns,"sellingPrograms":$var_sellingPrograms,"archived":$var_archived
        | }
        """.stripMargin
}
