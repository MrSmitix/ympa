...
object OutletLicenseDTO {
    def toStringBody(var_id: Object, var_outletId: Object, var_licenseType: Object, var_number: Object, var_dateOfIssue: Object, var_dateOfExpiry: Object) =
        s"""
        | {
        | "id":$var_id,"outletId":$var_outletId,"licenseType":$var_licenseType,"number":$var_number,"dateOfIssue":$var_dateOfIssue,"dateOfExpiry":$var_dateOfExpiry
        | }
        """.stripMargin
}
