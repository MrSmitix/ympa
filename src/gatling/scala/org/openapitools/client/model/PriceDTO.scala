...
object PriceDTO {
    def toStringBody(var_value: Object, var_discountBase: Object, var_currencyId: Object, var_vat: Object) =
        s"""
        | {
        | "value":$var_value,"discountBase":$var_discountBase,"currencyId":$var_currencyId,"vat":$var_vat
        | }
        """.stripMargin
}
