...
case class OutletDeliveryRuleDTO (
    ...
    _minDeliveryDays: Option[Integer],
    ...
    _maxDeliveryDays: Option[Integer],
    ...
    _unspecifiedDeliveryInterval: Option[Boolean]
)
object OutletDeliveryRuleDTO {
    def toStringBody(var_minDeliveryDays: Object, var_maxDeliveryDays: Object, var_deliveryServiceId: Object, var_orderBefore: Object, var_priceFreePickup: Object, var_unspecifiedDeliveryInterval: Object) =
        s"""
        | {
        | "minDeliveryDays":$var_minDeliveryDays,"maxDeliveryDays":$var_maxDeliveryDays,"deliveryServiceId":$var_deliveryServiceId,"orderBefore":$var_orderBefore,"priceFreePickup":$var_priceFreePickup,"unspecifiedDeliveryInterval":$var_unspecifiedDeliveryInterval
        | }
        """.stripMargin
}
