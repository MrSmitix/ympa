...
void
OfferWeightDimensionsDTO::__init()
{
	//length = double(0);
	//width = double(0);
	//height = double(0);
...
void
OfferWeightDimensionsDTO::__cleanup()
{
	//if(length != NULL) {
	//
	//delete length;
...
void
OfferWeightDimensionsDTO::fromJson(char* jsonStr)
{
...
OfferWeightDimensionsDTO::OfferWeightDimensionsDTO(char* json)
{
	this->fromJson(json);
}
...
void
OfferWeightDimensionsDTO::setLength(long long  length)
{
	this->length = length;
}
...
void
OfferWeightDimensionsDTO::setWidth(long long  width)
{
	this->width = width;
}
...
void
OfferWeightDimensionsDTO::setHeight(long long  height)
{
	this->height = height;
}
...
void
OfferWeightDimensionsDTO::setWeight(long long  weight)
{
	this->weight = weight;
}
