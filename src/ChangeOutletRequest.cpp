...
void
ChangeOutletRequest::fromJson(char* jsonStr)
{
...
ChangeOutletRequest::ChangeOutletRequest(char* json)
{
	this->fromJson(json);
}
...
void
ChangeOutletRequest::setStoragePeriod(long long  storagePeriod)
{
