...
void
DeliveryServiceDTO::fromJson(char* jsonStr)
{
...
DeliveryServiceDTO::DeliveryServiceDTO(char* json)
{
	this->fromJson(json);
}
...
void
DeliveryServiceDTO::setId(long long  id)
{
	this->id = id;
}
