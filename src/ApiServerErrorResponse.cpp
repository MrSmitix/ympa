...
void
ApiServerErrorResponse::__cleanup()
{
	//if(status != NULL) {
	//
	//delete status;
...
void
ApiServerErrorResponse::fromJson(char* jsonStr)
{
...
ApiServerErrorResponse::ApiServerErrorResponse(char* json)
{
	this->fromJson(json);
}
