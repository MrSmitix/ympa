...
export function OutletDeliveryRuleDTOFromJSON(json: any): OutletDeliveryRuleDTO {
    return {
        'minDeliveryDays': !exists(json, 'minDeliveryDays') ? undefined : json['minDeliveryDays'],
        'maxDeliveryDays': !exists(json, 'maxDeliveryDays') ? undefined : json['maxDeliveryDays'],
        'deliveryServiceId': !exists(json, 'deliveryServiceId') ? undefined : json['deliveryServiceId'],
        'orderBefore': !exists(json, 'orderBefore') ? undefined : json['orderBefore'],
        'priceFreePickup': !exists(json, 'priceFreePickup') ? undefined : json['priceFreePickup'],
        'unspecifiedDeliveryInterval': !exists(json, 'unspecifiedDeliveryInterval') ? undefined : json['unspecifiedDeliveryInterval'],
    };
}

export function OutletDeliveryRuleDTOToJSON(value?: OutletDeliveryRuleDTO): any {
    if (value === undefined) {
        return undefined;
    }
    return {
