...
export function CampaignSettingsScheduleDTOFromJSON(json: any): CampaignSettingsScheduleDTO {
    return {
        'availableOnHolidays': !exists(json, 'availableOnHolidays') ? undefined : json['availableOnHolidays'],
        'customHolidays': json['customHolidays'],
        'customWorkingDays': json['customWorkingDays'],
        'period': !exists(json, 'period') ? undefined : CampaignSettingsTimePeriodDTOFromJSON(json['period']),
        'totalHolidays': json['totalHolidays'],
        'weeklyHolidays': json['weeklyHolidays'],
    };
}

export function CampaignSettingsScheduleDTOToJSON(value?: CampaignSettingsScheduleDTO): any {
    if (value === undefined) {
        return undefined;
    }
    return {
