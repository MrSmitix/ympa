 ...
 * @export
 */
export interface GetBusinessBuyerInfoResponse extends ModelApiResponse {
}
...
export function GetBusinessBuyerInfoResponseToJSON(value?: GetBusinessBuyerInfoResponse): any {
    if (value === undefined) {
        return undefined;
    }
    return {
