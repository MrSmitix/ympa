...
pub struct FeedDto {
    ...
    pub content: Option<Box<models::FeedContentDto>>,
    #[serde(rename = "download", skip_serializing_if = "Option::is_none")]
    pub download: Option<Box<models::FeedDownloadDto>>,
    #[serde(rename = "placement", skip_serializing_if = "Option::is_none")]
    pub placement: Option<Box<models::FeedPlacementDto>>,
    #[serde(rename = "publication", skip_serializing_if = "Option::is_none")]
    pub publication: Option<Box<models::FeedPublicationDto>>,
}
