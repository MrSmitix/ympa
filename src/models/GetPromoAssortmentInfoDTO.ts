...
export function GetPromoAssortmentInfoDTOFromJSON(json: any): GetPromoAssortmentInfoDTO {
    return {
        ...
        'potentialOffers': !exists(json, 'potentialOffers') ? undefined : json['potentialOffers'],
        'processing': !exists(json, 'processing') ? undefined : json['processing'],
    };
}

export function GetPromoAssortmentInfoDTOToJSON(value?: GetPromoAssortmentInfoDTO): any {
    if (value === undefined) {
        return undefined;
    }
    return {
