 ...
 *
 * Schema Full_outlet_license_dto.t : Информация о лицензии.
 *)
...
type t = {
    ...
    check_status: Enums.licensecheckstatustype option [@default None];
    ...
    check_comment: string option [@default None];
