...
pub struct OfferRecommendationInfoDto {
    ...
    #[serde(rename = "recommendedCofinancePrice", skip_serializing_if = "Option::is_none")]
    pub recommended_cofinance_price: Option<Box<models::BasePriceDto>>,
    #[serde(rename = "competitivenessThresholds", skip_serializing_if = "Option::is_none")]
    pub competitiveness_thresholds: Option<Box<models::PriceCompetitivenessThresholdsDto>>,
}
