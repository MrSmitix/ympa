...
"""
Base.@kwdef mutable struct MappingsOfferDTO <: OpenAPI.APIModel
    ...
    function MappingsOfferDTO(name, shopSku, category, vendor, vendorCode, description, id, feedId, barcodes, urls, pictures, manufacturer, manufacturerCountries, minShipment, transportUnitSize, quantumOfSupply, deliveryDurationDays, boxCount, customsCommodityCodes, weightDimensions, supplyScheduleDays, shelfLifeDays, lifeTimeDays, guaranteePeriodDays, processingState, availability, shelfLife, lifeTime, guaranteePeriod, certificate, price, )
        OpenAPI.validate_property(MappingsOfferDTO, Symbol("name"), name)
        OpenAPI.validate_property(MappingsOfferDTO, Symbol("shopSku"), shopSku)
        OpenAPI.validate_property(MappingsOfferDTO, Symbol("category"), category)
        OpenAPI.validate_property(MappingsOfferDTO, Symbol("vendor"), vendor)
        OpenAPI.validate_property(MappingsOfferDTO, Symbol("vendorCode"), vendorCode)
        OpenAPI.validate_property(MappingsOfferDTO, Symbol("description"), description)
        OpenAPI.validate_property(MappingsOfferDTO, Symbol("id"), id)
        OpenAPI.validate_property(MappingsOfferDTO, Symbol("feedId"), feedId)
        OpenAPI.validate_property(MappingsOfferDTO, Symbol("barcodes"), barcodes)
        OpenAPI.validate_property(MappingsOfferDTO, Symbol("urls"), urls)
        OpenAPI.validate_property(MappingsOfferDTO, Symbol("pictures"), pictures)
        OpenAPI.validate_property(MappingsOfferDTO, Symbol("manufacturer"), manufacturer)
        OpenAPI.validate_property(MappingsOfferDTO, Symbol("manufacturerCountries"), manufacturerCountries)
        OpenAPI.validate_property(MappingsOfferDTO, Symbol("minShipment"), minShipment)
        OpenAPI.validate_property(MappingsOfferDTO, Symbol("transportUnitSize"), transportUnitSize)
        OpenAPI.validate_property(MappingsOfferDTO, Symbol("quantumOfSupply"), quantumOfSupply)
        OpenAPI.validate_property(MappingsOfferDTO, Symbol("deliveryDurationDays"), deliveryDurationDays)
        OpenAPI.validate_property(MappingsOfferDTO, Symbol("boxCount"), boxCount)
        OpenAPI.validate_property(MappingsOfferDTO, Symbol("customsCommodityCodes"), customsCommodityCodes)
        OpenAPI.validate_property(MappingsOfferDTO, Symbol("weightDimensions"), weightDimensions)
        OpenAPI.validate_property(MappingsOfferDTO, Symbol("supplyScheduleDays"), supplyScheduleDays)
        OpenAPI.validate_property(MappingsOfferDTO, Symbol("shelfLifeDays"), shelfLifeDays)
        OpenAPI.validate_property(MappingsOfferDTO, Symbol("lifeTimeDays"), lifeTimeDays)
        OpenAPI.validate_property(MappingsOfferDTO, Symbol("guaranteePeriodDays"), guaranteePeriodDays)
        OpenAPI.validate_property(MappingsOfferDTO, Symbol("processingState"), processingState)
        OpenAPI.validate_property(MappingsOfferDTO, Symbol("availability"), availability)
        OpenAPI.validate_property(MappingsOfferDTO, Symbol("shelfLife"), shelfLife)
        OpenAPI.validate_property(MappingsOfferDTO, Symbol("lifeTime"), lifeTime)
        OpenAPI.validate_property(MappingsOfferDTO, Symbol("guaranteePeriod"), guaranteePeriod)
        OpenAPI.validate_property(MappingsOfferDTO, Symbol("certificate"), certificate)
        OpenAPI.validate_property(MappingsOfferDTO, Symbol("price"), price)
        return new(name, shopSku, category, vendor, vendorCode, description, id, feedId, barcodes, urls, pictures, manufacturer, manufacturerCountries, minShipment, transportUnitSize, quantumOfSupply, deliveryDurationDays, boxCount, customsCommodityCodes, weightDimensions, supplyScheduleDays, shelfLifeDays, lifeTimeDays, guaranteePeriodDays, processingState, availability, shelfLife, lifeTime, guaranteePeriod, certificate, price, )
    end
end # type MappingsOfferDTO

const _property_types_MappingsOfferDTO = Dict{Symbol,String}(Symbol("name")=>"String", Symbol("shopSku")=>"String", Symbol("category")=>"String", Symbol("vendor")=>"String", Symbol("vendorCode")=>"String", Symbol("description")=>"String", Symbol("id")=>"String", Symbol("feedId")=>"Int64", Symbol("barcodes")=>"Vector{String}", Symbol("urls")=>"Vector{String}", Symbol("pictures")=>"Vector{String}", Symbol("manufacturer")=>"String", Symbol("manufacturerCountries")=>"Vector{String}", Symbol("minShipment")=>"Int64", Symbol("transportUnitSize")=>"Int64", Symbol("quantumOfSupply")=>"Int64", Symbol("deliveryDurationDays")=>"Int64", Symbol("boxCount")=>"Int64", Symbol("customsCommodityCodes")=>"Vector{String}", Symbol("weightDimensions")=>"OfferWeightDimensionsDTO", Symbol("supplyScheduleDays")=>"Vector{DayOfWeekType}", Symbol("shelfLifeDays")=>"Int64", Symbol("lifeTimeDays")=>"Int64", Symbol("guaranteePeriodDays")=>"Int64", Symbol("processingState")=>"OfferProcessingStateDTO", Symbol("availability")=>"OfferAvailabilityStatusType", Symbol("shelfLife")=>"TimePeriodDTO", Symbol("lifeTime")=>"TimePeriodDTO", Symbol("guaranteePeriod")=>"TimePeriodDTO", Symbol("certificate")=>"String", Symbol("price")=>"Float64", )
OpenAPI.property_type(::Type{ MappingsOfferDTO }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_MappingsOfferDTO[name]))}

function check_required(o::MappingsOfferDTO)
    true
end

function OpenAPI.validate_property(::Type{ MappingsOfferDTO }, name::Symbol, val)
    if name === Symbol("name")
        OpenAPI.validate_param(name, "MappingsOfferDTO", :maxLength, val, 256)
    end
    if name === Symbol("shopSku")
        OpenAPI.validate_param(name, "MappingsOfferDTO", :maxLength, val, 255)
        OpenAPI.validate_param(name, "MappingsOfferDTO", :minLength, val, 1)
        OpenAPI.validate_param(name, "MappingsOfferDTO", :pattern, val, r"^[^\x00-\x08\x0A-\x1f\x7f]{1,255}$")
    end
    if name === Symbol("description")
        OpenAPI.validate_param(name, "MappingsOfferDTO", :maxLength, val, 6000)
    end
    if name === Symbol("id")
        OpenAPI.validate_param(name, "MappingsOfferDTO", :maxLength, val, 255)
        OpenAPI.validate_param(name, "MappingsOfferDTO", :minLength, val, 1)
    ...
    if name === Symbol("feedId")
        OpenAPI.validate_param(name, "MappingsOfferDTO", :format, val, "int64")
    end
    if name === Symbol("minShipment")
        OpenAPI.validate_param(name, "MappingsOfferDTO", :format, val, "int32")
    end
