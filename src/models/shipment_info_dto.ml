 ...
 *
 * Schema Shipment_info_dto.t : Список с информацией об отгрузках.
 *)
...
type t = {
    ...
    status_description: string option [@default None];
    (* Время последнего изменения статуса отгрузки. *)
    status_update_time: string option [@default None];
