...
export function WarehouseOfferDTOFromJSON(json: any): WarehouseOfferDTO {
    return {
        ...
        'turnoverSummary': !exists(json, 'turnoverSummary') ? undefined : TurnoverDTOFromJSON(json['turnoverSummary']),
        'stocks': (json['stocks'] as Array<any>).map(WarehouseStockDTOFromJSON),
        'updatedAt': !exists(json, 'updatedAt') ? undefined : new Date(json['updatedAt']),
    };
}

export function WarehouseOfferDTOToJSON(value?: WarehouseOfferDTO): any {
    if (value === undefined) {
        return undefined;
    }
    return {
