...
pub struct QuarantineOfferDto {
    ...
    pub current_price: Option<Box<models::BasePriceDto>>,
    #[serde(rename = "lastValidPrice", skip_serializing_if = "Option::is_none")]
    pub last_valid_price: Option<Box<models::BasePriceDto>>,
    /// Причины попадания товара в карантин.
    #[serde(rename = "verdicts", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub verdicts: Option<Option<Vec<models::PriceQuarantineVerdictDto>>>,
}
