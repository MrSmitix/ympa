...
pub struct EnrichedModelDto {
    ...
    pub prices: Option<Box<models::ModelPriceDto>>,
    ...
    #[serde(rename = "offers", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub offers: Option<Option<Vec<models::ModelOfferDto>>>,
