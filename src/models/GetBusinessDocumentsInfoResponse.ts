 ...
 * @export
 */
export interface GetBusinessDocumentsInfoResponse extends ModelApiResponse {
}
...
export function GetBusinessDocumentsInfoResponseToJSON(value?: GetBusinessDocumentsInfoResponse): any {
    if (value === undefined) {
        return undefined;
    }
    return {
