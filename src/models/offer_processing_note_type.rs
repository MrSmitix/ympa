...
impl std::fmt::Display for OfferProcessingNoteType {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            Self::Assortment => write!(f, "ASSORTMENT"),
            Self::Cancelled => write!(f, "CANCELLED"),
            Self::ConflictingInformation => write!(f, "CONFLICTING_INFORMATION"),
            Self::Other => write!(f, "OTHER"),
            Self::DepartmentFrozen => write!(f, "DEPARTMENT_FROZEN"),
            Self::IncorrectInformation => write!(f, "INCORRECT_INFORMATION"),
            Self::LegalConflict => write!(f, "LEGAL_CONFLICT"),
            Self::NeedClassificationInformation => write!(f, "NEED_CLASSIFICATION_INFORMATION"),
            Self::NeedInformation => write!(f, "NEED_INFORMATION"),
            Self::NeedPictures => write!(f, "NEED_PICTURES"),
            Self::NeedVendor => write!(f, "NEED_VENDOR"),
            Self::NoCategory => write!(f, "NO_CATEGORY"),
            Self::NoKnowledge => write!(f, "NO_KNOWLEDGE"),
            Self::NoParametersInShopTitle => write!(f, "NO_PARAMETERS_IN_SHOP_TITLE"),
            Self::NoSizeMeasure => write!(f, "NO_SIZE_MEASURE"),
            Self::SampleLine => write!(f, "SAMPLE_LINE"),
        }
    }
}
