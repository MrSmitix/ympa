...
pub struct GetOfferDto {
    ...
    #[serde(rename = "manuals", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub manuals: Option<Option<Vec<models::OfferManualDto>>>,
    /// Название бренда или производителя. Должно быть записано так, как его пишет сам бренд.
    #[serde(rename = "vendor", skip_serializing_if = "Option::is_none")]
    pub vendor: Option<String>,
    /// Указывайте в виде последовательности цифр. Подойдут коды EAN-13, EAN-8, UPC-A, UPC-E или Code 128.  Для книг указывайте ISBN.  Для товаров [определенных категорий и торговых марок](https://yastatic.net/s3/doc-binary/src/support/market/ru/yandex-market-list-for-gtin.xlsx) штрихкод должен быть действительным кодом GTIN. Обратите внимание: внутренние штрихкоды, начинающиеся на 2 или 02, и коды формата Code 128 не являются GTIN.  [Что такое GTIN](*gtin)  
    #[serde(rename = "barcodes", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub barcodes: Option<Option<Vec<String>>>,
    ...
    #[serde(rename = "manufacturerCountries", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub manufacturer_countries: Option<Option<Vec<String>>>,
    #[serde(rename = "weightDimensions", skip_serializing_if = "Option::is_none")]
    pub weight_dimensions: Option<Box<models::OfferWeightDimensionsDto>>,
    ...
    pub shelf_life: Option<Box<models::TimePeriodDto>>,
    #[serde(rename = "lifeTime", skip_serializing_if = "Option::is_none")]
    pub life_time: Option<Box<models::TimePeriodDto>>,
    #[serde(rename = "guaranteePeriod", skip_serializing_if = "Option::is_none")]
    pub guarantee_period: Option<Box<models::TimePeriodDto>>,
    ...
    #[serde(rename = "customsCommodityCode", skip_serializing_if = "Option::is_none")]
    ...
    pub certificates: Option<Option<Vec<String>>>,
    ...
    pub condition: Option<Box<models::OfferConditionDto>>,
    ...
    pub age: Option<Box<models::AgeDto>>,
    ...
    pub params: Option<Option<Vec<models::OfferParamDto>>>,
    #[serde(rename = "basicPrice", skip_serializing_if = "Option::is_none")]
    pub basic_price: Option<Box<models::GetPriceWithDiscountDto>>,
    #[serde(rename = "purchasePrice", skip_serializing_if = "Option::is_none")]
    pub purchase_price: Option<Box<models::GetPriceDto>>,
    #[serde(rename = "additionalExpenses", skip_serializing_if = "Option::is_none")]
    pub additional_expenses: Option<Box<models::GetPriceDto>>,
    #[serde(rename = "cofinancePrice", skip_serializing_if = "Option::is_none")]
    pub cofinance_price: Option<Box<models::GetPriceDto>>,
    ...
    #[serde(rename = "campaigns", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub campaigns: Option<Option<Vec<models::OfferCampaignStatusDto>>>,
    /// Информация о том, какие для товара доступны модели размещения. 
    #[serde(rename = "sellingPrograms", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub selling_programs: Option<Option<Vec<models::OfferSellingProgramDto>>>,
