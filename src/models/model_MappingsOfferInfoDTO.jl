...
"""
Base.@kwdef mutable struct MappingsOfferInfoDTO <: OpenAPI.APIModel
    ...
    function MappingsOfferInfoDTO(name, shopSku, category, vendor, vendorCode, description, id, feedId, barcodes, urls, pictures, manufacturer, manufacturerCountries, minShipment, transportUnitSize, quantumOfSupply, deliveryDurationDays, boxCount, customsCommodityCodes, weightDimensions, supplyScheduleDays, shelfLifeDays, lifeTimeDays, guaranteePeriodDays, processingState, availability, shelfLife, lifeTime, guaranteePeriod, certificate, )
        OpenAPI.validate_property(MappingsOfferInfoDTO, Symbol("name"), name)
        OpenAPI.validate_property(MappingsOfferInfoDTO, Symbol("shopSku"), shopSku)
        OpenAPI.validate_property(MappingsOfferInfoDTO, Symbol("category"), category)
        OpenAPI.validate_property(MappingsOfferInfoDTO, Symbol("vendor"), vendor)
        OpenAPI.validate_property(MappingsOfferInfoDTO, Symbol("vendorCode"), vendorCode)
        OpenAPI.validate_property(MappingsOfferInfoDTO, Symbol("description"), description)
        OpenAPI.validate_property(MappingsOfferInfoDTO, Symbol("id"), id)
        OpenAPI.validate_property(MappingsOfferInfoDTO, Symbol("feedId"), feedId)
        OpenAPI.validate_property(MappingsOfferInfoDTO, Symbol("barcodes"), barcodes)
        OpenAPI.validate_property(MappingsOfferInfoDTO, Symbol("urls"), urls)
        OpenAPI.validate_property(MappingsOfferInfoDTO, Symbol("pictures"), pictures)
        OpenAPI.validate_property(MappingsOfferInfoDTO, Symbol("manufacturer"), manufacturer)
        OpenAPI.validate_property(MappingsOfferInfoDTO, Symbol("manufacturerCountries"), manufacturerCountries)
        OpenAPI.validate_property(MappingsOfferInfoDTO, Symbol("minShipment"), minShipment)
        OpenAPI.validate_property(MappingsOfferInfoDTO, Symbol("transportUnitSize"), transportUnitSize)
        OpenAPI.validate_property(MappingsOfferInfoDTO, Symbol("quantumOfSupply"), quantumOfSupply)
        OpenAPI.validate_property(MappingsOfferInfoDTO, Symbol("deliveryDurationDays"), deliveryDurationDays)
        OpenAPI.validate_property(MappingsOfferInfoDTO, Symbol("boxCount"), boxCount)
        OpenAPI.validate_property(MappingsOfferInfoDTO, Symbol("customsCommodityCodes"), customsCommodityCodes)
        OpenAPI.validate_property(MappingsOfferInfoDTO, Symbol("weightDimensions"), weightDimensions)
        OpenAPI.validate_property(MappingsOfferInfoDTO, Symbol("supplyScheduleDays"), supplyScheduleDays)
        OpenAPI.validate_property(MappingsOfferInfoDTO, Symbol("shelfLifeDays"), shelfLifeDays)
        OpenAPI.validate_property(MappingsOfferInfoDTO, Symbol("lifeTimeDays"), lifeTimeDays)
        OpenAPI.validate_property(MappingsOfferInfoDTO, Symbol("guaranteePeriodDays"), guaranteePeriodDays)
        OpenAPI.validate_property(MappingsOfferInfoDTO, Symbol("processingState"), processingState)
        OpenAPI.validate_property(MappingsOfferInfoDTO, Symbol("availability"), availability)
        OpenAPI.validate_property(MappingsOfferInfoDTO, Symbol("shelfLife"), shelfLife)
        OpenAPI.validate_property(MappingsOfferInfoDTO, Symbol("lifeTime"), lifeTime)
        OpenAPI.validate_property(MappingsOfferInfoDTO, Symbol("guaranteePeriod"), guaranteePeriod)
        OpenAPI.validate_property(MappingsOfferInfoDTO, Symbol("certificate"), certificate)
        return new(name, shopSku, category, vendor, vendorCode, description, id, feedId, barcodes, urls, pictures, manufacturer, manufacturerCountries, minShipment, transportUnitSize, quantumOfSupply, deliveryDurationDays, boxCount, customsCommodityCodes, weightDimensions, supplyScheduleDays, shelfLifeDays, lifeTimeDays, guaranteePeriodDays, processingState, availability, shelfLife, lifeTime, guaranteePeriod, certificate, )
    end
end # type MappingsOfferInfoDTO

const _property_types_MappingsOfferInfoDTO = Dict{Symbol,String}(Symbol("name")=>"String", Symbol("shopSku")=>"String", Symbol("category")=>"String", Symbol("vendor")=>"String", Symbol("vendorCode")=>"String", Symbol("description")=>"String", Symbol("id")=>"String", Symbol("feedId")=>"Int64", Symbol("barcodes")=>"Vector{String}", Symbol("urls")=>"Vector{String}", Symbol("pictures")=>"Vector{String}", Symbol("manufacturer")=>"String", Symbol("manufacturerCountries")=>"Vector{String}", Symbol("minShipment")=>"Int64", Symbol("transportUnitSize")=>"Int64", Symbol("quantumOfSupply")=>"Int64", Symbol("deliveryDurationDays")=>"Int64", Symbol("boxCount")=>"Int64", Symbol("customsCommodityCodes")=>"Vector{String}", Symbol("weightDimensions")=>"OfferWeightDimensionsDTO", Symbol("supplyScheduleDays")=>"Vector{DayOfWeekType}", Symbol("shelfLifeDays")=>"Int64", Symbol("lifeTimeDays")=>"Int64", Symbol("guaranteePeriodDays")=>"Int64", Symbol("processingState")=>"OfferProcessingStateDTO", Symbol("availability")=>"OfferAvailabilityStatusType", Symbol("shelfLife")=>"TimePeriodDTO", Symbol("lifeTime")=>"TimePeriodDTO", Symbol("guaranteePeriod")=>"TimePeriodDTO", Symbol("certificate")=>"String", )
OpenAPI.property_type(::Type{ MappingsOfferInfoDTO }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_MappingsOfferInfoDTO[name]))}

function check_required(o::MappingsOfferInfoDTO)
    true
end

function OpenAPI.validate_property(::Type{ MappingsOfferInfoDTO }, name::Symbol, val)
    if name === Symbol("name")
        OpenAPI.validate_param(name, "MappingsOfferInfoDTO", :maxLength, val, 256)
    end
    if name === Symbol("shopSku")
        OpenAPI.validate_param(name, "MappingsOfferInfoDTO", :maxLength, val, 255)
        OpenAPI.validate_param(name, "MappingsOfferInfoDTO", :minLength, val, 1)
        OpenAPI.validate_param(name, "MappingsOfferInfoDTO", :pattern, val, r"^[^\x00-\x08\x0A-\x1f\x7f]{1,255}$")
    end
    if name === Symbol("description")
        OpenAPI.validate_param(name, "MappingsOfferInfoDTO", :maxLength, val, 6000)
    end
    if name === Symbol("id")
        OpenAPI.validate_param(name, "MappingsOfferInfoDTO", :maxLength, val, 255)
        OpenAPI.validate_param(name, "MappingsOfferInfoDTO", :minLength, val, 1)
    ...
    if name === Symbol("feedId")
        OpenAPI.validate_param(name, "MappingsOfferInfoDTO", :format, val, "int64")
    end
    if name === Symbol("minShipment")
        OpenAPI.validate_param(name, "MappingsOfferInfoDTO", :format, val, "int32")
    end
