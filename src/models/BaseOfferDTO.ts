...
export function BaseOfferDTOFromJSON(json: any): BaseOfferDTO {
    return {
        ...
        'manuals': !exists(json, 'manuals') ? undefined : (json['manuals'] as Array<any>).map(OfferManualDTOFromJSON),
        ...
        'customsCommodityCode': !exists(json, 'customsCommodityCode') ? undefined : json['customsCommodityCode'],
        'certificates': !exists(json, 'certificates') ? undefined : json['certificates'],
        'boxCount': !exists(json, 'boxCount') ? undefined : json['boxCount'],
        'condition': !exists(json, 'condition') ? undefined : OfferConditionDTOFromJSON(json['condition']),
        ...
        'age': !exists(json, 'age') ? undefined : AgeDTOFromJSON(json['age']),
        'params': !exists(json, 'params') ? undefined : (json['params'] as Array<any>).map(OfferParamDTOFromJSON),
    };
}

export function BaseOfferDTOToJSON(value?: BaseOfferDTO): any {
    if (value === undefined) {
        return undefined;
    }
    return {
        ...
        'videos': value.videos,
        'manuals': value.manuals === undefined ? undefined : (value.manuals as Array<any>).map(OfferManualDTOToJSON),
        'vendor': value.vendor,
        ...
        'params': value.params === undefined ? undefined : (value.params as Array<any>).map(OfferParamDTOToJSON),
    };
}
