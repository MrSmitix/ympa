...
pub struct ChatMessageDto {
    ...
    pub payload: Option<Option<Vec<models::ChatMessagePayloadDto>>>,
}

impl ChatMessageDto {
    /// Информация о сообщениях.
    pub fn new(message_id: i64, created_at: String, sender: models::ChatMessageSenderType) -> ChatMessageDto {
        ChatMessageDto {
            message_id,
            created_at,
            sender,
