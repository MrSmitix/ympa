...
pub struct AddOffersToArchiveDto {
    ...
    #[serde(rename = "notArchivedOffers", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub not_archived_offers: Option<Option<Vec<models::AddOffersToArchiveErrorDto>>>,
}
