...
export function QuantumDTOFromJSON(json: any): QuantumDTO {
    return {
        'minQuantity': !exists(json, 'minQuantity') ? undefined : json['minQuantity'],
        'stepQuantity': !exists(json, 'stepQuantity') ? undefined : json['stepQuantity'],
    };
}

export function QuantumDTOToJSON(value?: QuantumDTO): any {
    if (value === undefined) {
        return undefined;
    }
    return {
