 ...
 *
 * Schema Update_offer_dto.t : Параметры товара.
 *)
...
type t = {
    ...
    basic_price: Update_price_with_discount_dto.t option [@default None];
    purchase_price: Base_price_dto.t option [@default None];
    additional_expenses: Base_price_dto.t option [@default None];
    cofinance_price: Base_price_dto.t option [@default None];
