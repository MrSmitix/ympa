...
pub struct MappingsOfferInfoDto {
    ...
    #[serde(rename = "deliveryDurationDays", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "customsCommodityCodes", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub customs_commodity_codes: Option<Option<Vec<String>>>,
    ...
    #[serde(rename = "supplyScheduleDays", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub supply_schedule_days: Option<Option<Vec<models::DayOfWeekType>>>,
    ...
    #[serde(rename = "guaranteePeriodDays", skip_serializing_if = "Option::is_none")]
    pub guarantee_period_days: Option<i32>,
    #[serde(rename = "processingState", skip_serializing_if = "Option::is_none")]
    pub processing_state: Option<Box<models::OfferProcessingStateDto>>,
