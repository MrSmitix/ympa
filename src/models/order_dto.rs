...
pub struct OrderDto {
    ...
    #[serde(rename = "buyerItemsTotalBeforeDiscount", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "buyerTotalBeforeDiscount", skip_serializing_if = "Option::is_none")]
    ...
    pub subsidies: Option<Option<Vec<models::OrderSubsidyDto>>>,
    #[serde(rename = "delivery", skip_serializing_if = "Option::is_none")]
    pub delivery: Option<Box<models::OrderDeliveryDto>>,
    #[serde(rename = "buyer", skip_serializing_if = "Option::is_none")]
    pub buyer: Option<Box<models::OrderBuyerDto>>,
