...
"""
Base.@kwdef mutable struct OutletDTO <: OpenAPI.APIModel
    ...
    function OutletDTO(name, type, coords, isMain, shopOutletCode, visibility, address, phones, workingSchedule, deliveryRules, storagePeriod, )
        OpenAPI.validate_property(OutletDTO, Symbol("name"), name)
        OpenAPI.validate_property(OutletDTO, Symbol("type"), type)
        OpenAPI.validate_property(OutletDTO, Symbol("coords"), coords)
        OpenAPI.validate_property(OutletDTO, Symbol("isMain"), isMain)
        OpenAPI.validate_property(OutletDTO, Symbol("shopOutletCode"), shopOutletCode)
        OpenAPI.validate_property(OutletDTO, Symbol("visibility"), visibility)
        OpenAPI.validate_property(OutletDTO, Symbol("address"), address)
        OpenAPI.validate_property(OutletDTO, Symbol("phones"), phones)
        OpenAPI.validate_property(OutletDTO, Symbol("workingSchedule"), workingSchedule)
        OpenAPI.validate_property(OutletDTO, Symbol("deliveryRules"), deliveryRules)
        OpenAPI.validate_property(OutletDTO, Symbol("storagePeriod"), storagePeriod)
        return new(name, type, coords, isMain, shopOutletCode, visibility, address, phones, workingSchedule, deliveryRules, storagePeriod, )
    end
end # type OutletDTO

const _property_types_OutletDTO = Dict{Symbol,String}(Symbol("name")=>"String", Symbol("type")=>"OutletType", Symbol("coords")=>"String", Symbol("isMain")=>"Bool", Symbol("shopOutletCode")=>"String", Symbol("visibility")=>"OutletVisibilityType", Symbol("address")=>"OutletAddressDTO", Symbol("phones")=>"Vector{String}", Symbol("workingSchedule")=>"OutletWorkingScheduleDTO", Symbol("deliveryRules")=>"Vector{OutletDeliveryRuleDTO}", Symbol("storagePeriod")=>"Int64", )
OpenAPI.property_type(::Type{ OutletDTO }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_OutletDTO[name]))}

function check_required(o::OutletDTO)
...
function OpenAPI.validate_property(::Type{ OutletDTO }, name::Symbol, val)
    if name === Symbol("phones")
        OpenAPI.validate_param(name, "OutletDTO", :minItems, val, 1)
    end
    if name === Symbol("storagePeriod")
        OpenAPI.validate_param(name, "OutletDTO", :format, val, "int64")
    end
end
