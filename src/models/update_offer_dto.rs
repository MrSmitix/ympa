...
pub struct UpdateOfferDto {
    ...
    #[serde(rename = "parameterValues", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub parameter_values: Option<Option<Vec<models::ParameterValueDto>>>,
    #[serde(rename = "basicPrice", skip_serializing_if = "Option::is_none")]
    pub basic_price: Option<Box<models::UpdatePriceWithDiscountDto>>,
    #[serde(rename = "purchasePrice", skip_serializing_if = "Option::is_none")]
    pub purchase_price: Option<Box<models::BasePriceDto>>,
    #[serde(rename = "additionalExpenses", skip_serializing_if = "Option::is_none")]
    pub additional_expenses: Option<Box<models::BasePriceDto>>,
    #[serde(rename = "cofinancePrice", skip_serializing_if = "Option::is_none")]
    pub cofinance_price: Option<Box<models::BasePriceDto>>,
}
