...
pub struct PriceSuggestOfferDto {
    ...
    #[serde(rename = "priceSuggestion", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub price_suggestion: Option<Option<Vec<models::PriceSuggestDto>>>,
}
