...
pub struct OfferCardDto {
    ...
    pub recommendations: Option<Option<Vec<models::OfferCardRecommendationDto>>>,
    ...
    pub errors: Option<Option<Vec<models::OfferErrorDto>>>,
    ...
    pub warnings: Option<Option<Vec<models::OfferErrorDto>>>,
}
