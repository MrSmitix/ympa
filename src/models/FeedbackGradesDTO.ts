...
export function FeedbackGradesDTOFromJSON(json: any): FeedbackGradesDTO {
    return {
        ...
        'agreeCount': !exists(json, 'agreeCount') ? undefined : json['agreeCount'],
        'rejectCount': !exists(json, 'rejectCount') ? undefined : json['rejectCount'],
        'factors': (json['factors'] as Array<any>).map(FeedbackFactorDTOFromJSON),
    };
}

export function FeedbackGradesDTOToJSON(value?: FeedbackGradesDTO): any {
    if (value === undefined) {
        return undefined;
    }
    return {
