...
#ifndef _UpdateMappingsOfferDTO_H_
#define _UpdateMappingsOfferDTO_H_
...
class UpdateMappingsOfferDTO : public Object {
public:
	/*! \brief Constructor.
	 */
	UpdateMappingsOfferDTO();
	UpdateMappingsOfferDTO(char* str);
...
#endif /* _UpdateMappingsOfferDTO_H_ */
