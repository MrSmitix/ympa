...
void
ApiUnauthorizedErrorResponse::__init()
{
...
void
ApiUnauthorizedErrorResponse::__cleanup()
{
	//if(status != NULL) {
	//
	//delete status;
...
void
ApiUnauthorizedErrorResponse::fromJson(char* jsonStr)
{
...
ApiUnauthorizedErrorResponse::ApiUnauthorizedErrorResponse(char* json)
{
	this->fromJson(json);
}
