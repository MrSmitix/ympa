...
#ifndef _DeliveryServiceInfoDTO_H_
#define _DeliveryServiceInfoDTO_H_
...
class DeliveryServiceInfoDTO : public Object {
public:
	/*! \brief Constructor.
	 */
	DeliveryServiceInfoDTO();
	DeliveryServiceInfoDTO(char* str);
...
#endif /* _DeliveryServiceInfoDTO_H_ */
