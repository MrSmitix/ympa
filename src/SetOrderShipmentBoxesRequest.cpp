...
void
SetOrderShipmentBoxesRequest::__init()
{
	//new std::list()std::list> boxes;
}

void
SetOrderShipmentBoxesRequest::__cleanup()
{
	//if(boxes != NULL) {
...
void
SetOrderShipmentBoxesRequest::fromJson(char* jsonStr)
{
...
SetOrderShipmentBoxesRequest::SetOrderShipmentBoxesRequest(char* json)
{
	this->fromJson(json);
}
