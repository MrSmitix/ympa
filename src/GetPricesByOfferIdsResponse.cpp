...
void
GetPricesByOfferIdsResponse::__init()
{
	//status = new ApiResponseStatusType();
	//result = new OfferPriceByOfferIdsListResponseDTO();
}

void
GetPricesByOfferIdsResponse::__cleanup()
{
	//if(status != NULL) {
	//
	//delete status;
...
void
GetPricesByOfferIdsResponse::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
		...
		if (isprimitive("OfferPriceByOfferIdsListResponseDTO")) {
			jsonToValue(&result, node, "OfferPriceByOfferIdsListResponseDTO", "OfferPriceByOfferIdsListResponseDTO");
		} else {
			
			OfferPriceByOfferIdsListResponseDTO* obj = static_cast<OfferPriceByOfferIdsListResponseDTO*> (&result);
			obj->fromJson(json_to_string(node, false));
...
GetPricesByOfferIdsResponse::GetPricesByOfferIdsResponse(char* json)
{
	this->fromJson(json);
}
...
GetPricesByOfferIdsResponse::toJson()
{
	...
	if (isprimitive("OfferPriceByOfferIdsListResponseDTO")) {
		OfferPriceByOfferIdsListResponseDTO obj = getResult();
		node = converttoJson(&obj, "OfferPriceByOfferIdsListResponseDTO", "");
	}
	else {
		
		OfferPriceByOfferIdsListResponseDTO obj = static_cast<OfferPriceByOfferIdsListResponseDTO> (getResult());
		GError *mygerror;
		mygerror = NULL;
		node = json_from_string(obj.toJson(), &mygerror);
