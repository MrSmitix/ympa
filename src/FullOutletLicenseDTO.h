...
#ifndef _FullOutletLicenseDTO_H_
#define _FullOutletLicenseDTO_H_
...
class FullOutletLicenseDTO : public Object {
public:
	/*! \brief Constructor.
	 */
	FullOutletLicenseDTO();
	FullOutletLicenseDTO(char* str);
...
#endif /* _FullOutletLicenseDTO_H_ */
