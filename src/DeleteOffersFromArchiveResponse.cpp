...
void
DeleteOffersFromArchiveResponse::__init()
{
	//status = new ApiResponseStatusType();
	//result = new DeleteOffersFromArchiveDTO();
}

void
DeleteOffersFromArchiveResponse::__cleanup()
{
	//if(status != NULL) {
	//
	//delete status;
...
void
DeleteOffersFromArchiveResponse::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
		...
		if (isprimitive("DeleteOffersFromArchiveDTO")) {
			jsonToValue(&result, node, "DeleteOffersFromArchiveDTO", "DeleteOffersFromArchiveDTO");
		} else {
			
			DeleteOffersFromArchiveDTO* obj = static_cast<DeleteOffersFromArchiveDTO*> (&result);
			obj->fromJson(json_to_string(node, false));
...
DeleteOffersFromArchiveResponse::DeleteOffersFromArchiveResponse(char* json)
{
	this->fromJson(json);
}
...
DeleteOffersFromArchiveResponse::toJson()
{
	...
	if (isprimitive("DeleteOffersFromArchiveDTO")) {
		DeleteOffersFromArchiveDTO obj = getResult();
		node = converttoJson(&obj, "DeleteOffersFromArchiveDTO", "");
	}
	else {
		
		DeleteOffersFromArchiveDTO obj = static_cast<DeleteOffersFromArchiveDTO> (getResult());
		GError *mygerror;
		mygerror = NULL;
		node = json_from_string(obj.toJson(), &mygerror);
