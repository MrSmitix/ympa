...
#ifndef _OfferCardRecommendationType_H_
#define _OfferCardRecommendationType_H_
...
class OfferCardRecommendationType : public Object {
public:
	/*! \brief Constructor.
	 */
	OfferCardRecommendationType();
	OfferCardRecommendationType(char* str);
...
#endif /* _OfferCardRecommendationType_H_ */
