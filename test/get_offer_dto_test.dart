...
// tests for GetOfferDTO
void main() {
  // final instance = GetOfferDTO();

  group('test GetOfferDTO', () {
    ...
    // List<OfferManualDTO> manuals (default value: const [])
    ...
    test('to test the property `customsCommodityCode`', () async {
      // TODO
    });
    ...
    // List<String> certificates (default value: const [])
    ...
    // bool downloadable
    test('to test the property `downloadable`', () async {
      // TODO
    });
    ...
    // List<OfferParamDTO> params (default value: const [])
    ...
    test('to test the property `additionalExpenses`', () async {
      // TODO
    });

    // GetPriceDTO cofinancePrice
    test('to test the property `cofinancePrice`', () async {
      // TODO
    });

    // OfferCardStatusType cardStatus
    test('to test the property `cardStatus`', () async {
      // TODO
    });

    // Список магазинов, в которых размещен товар. 
    // List<OfferCampaignStatusDTO> campaigns (default value: const [])
    test('to test the property `campaigns`', () async {
      // TODO
    });

    // Информация о том, какие для товара доступны модели размещения. 
    // List<OfferSellingProgramDTO> sellingPrograms (default value: const [])
    test('to test the property `sellingPrograms`', () async {
      // TODO
    });
