...
from ympa_python_pydantic_v1_client.models.get_bids_info_response import GetBidsInfoResponse  # noqa: E501
...
class TestGetBidsInfoResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetBidsInfoResponse:
        ...
        """
        model = GetBidsInfoResponse()  # noqa: E501
        if include_optional:
            return GetBidsInfoResponse(
                status = 'OK',
                result = ympa_python_pydantic_v1_client.models.get_bids_info_response_dto.GetBidsInfoResponseDTO(
                    bids = [
