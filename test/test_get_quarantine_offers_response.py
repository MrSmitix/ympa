...
from ympa_python_pydantic_v1_client.models.get_quarantine_offers_response import GetQuarantineOffersResponse  # noqa: E501
...
class TestGetQuarantineOffersResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetQuarantineOffersResponse:
        ...
        """
        model = GetQuarantineOffersResponse()  # noqa: E501
        if include_optional:
            return GetQuarantineOffersResponse(
                status = 'OK',
                result = ympa_python_pydantic_v1_client.models.get_quarantine_offers_result_dto.GetQuarantineOffersResultDTO(
                    paging = ympa_python_pydantic_v1_client.models.scrolling_pager_dto.ScrollingPagerDTO(), 
                    offers = [
                        ympa_python_pydantic_v1_client.models.quarantine_offer_dto.QuarantineOfferDTO(
