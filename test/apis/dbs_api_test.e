note
    description: "API tests for DBS_API"
    date: "$Date$"
    revision: "$Revision$"
...
feature -- Test routines
    ...
    test_accept_order_cancellation
        ...
        local
            ...
            l_accept_order_cancellation_request: ACCEPT_ORDER_CANCELLATION_REQUEST
        do
            -- TODO: Initialize required params.
            -- l_campaign_id
            -- l_order_id
            -- l_accept_order_cancellation_request

            -- l_response := api.accept_order_cancellation(l_campaign_id, l_order_id, l_accept_order_cancellation_request)
    ...
    test_provide_order_digital_codes
        ...
        local
            ...
            l_campaign_id: INTEGER_64
            l_order_id: INTEGER_64
            l_provide_order_digital_codes_request: PROVIDE_ORDER_DIGITAL_CODES_REQUEST
        do
            -- TODO: Initialize required params.
            -- l_campaign_id
            -- l_order_id
            -- l_provide_order_digital_codes_request

            -- l_response := api.provide_order_digital_codes(l_campaign_id, l_order_id, l_provide_order_digital_codes_request)
            assert ("not_implemented", False)
        end

    test_provide_order_item_identifiers
        ...
        local
            l_response: PROVIDE_ORDER_ITEM_IDENTIFIERS_RESPONSE
            l_campaign_id: INTEGER_64
            l_order_id: INTEGER_64
            l_provide_order_item_identifiers_request: PROVIDE_ORDER_ITEM_IDENTIFIERS_REQUEST
        do
            -- TODO: Initialize required params.
            -- l_campaign_id
            -- l_order_id
            -- l_provide_order_item_identifiers_request

            -- l_response := api.provide_order_item_identifiers(l_campaign_id, l_order_id, l_provide_order_item_identifiers_request)
            assert ("not_implemented", False)
        end
    ...
    test_set_order_box_layout
        ...
        local
            l_response: SET_ORDER_BOX_LAYOUT_RESPONSE
            l_campaign_id: INTEGER_64
            l_order_id: INTEGER_64
            l_set_order_box_layout_request: SET_ORDER_BOX_LAYOUT_REQUEST
        do
            -- TODO: Initialize required params.
            -- l_campaign_id
            -- l_order_id
            -- l_set_order_box_layout_request

            -- l_response := api.set_order_box_layout(l_campaign_id, l_order_id, l_set_order_box_layout_request)
            assert ("not_implemented", False)
        end
    ...
    test_set_order_shipment_boxes
        ...
        local
            l_response: SET_ORDER_SHIPMENT_BOXES_RESPONSE
            l_campaign_id: INTEGER_64
            l_order_id: INTEGER_64
            l_shipment_id: INTEGER_64
            l_set_order_shipment_boxes_request: SET_ORDER_SHIPMENT_BOXES_REQUEST
        do
            -- TODO: Initialize required params.
            -- l_campaign_id
            -- l_order_id
            -- l_shipment_id
            -- l_set_order_shipment_boxes_request

            -- l_response := api.set_order_shipment_boxes(l_campaign_id, l_order_id, l_shipment_id, l_set_order_shipment_boxes_request)
            assert ("not_implemented", False)
        end
    ...
    test_update_order_items
        ...
        local
            l_campaign_id: INTEGER_64
            l_order_id: INTEGER_64
            l_update_order_item_request: UPDATE_ORDER_ITEM_REQUEST
        do
            -- TODO: Initialize required params.
            -- l_campaign_id
            -- l_order_id
            -- l_update_order_item_request

            -- api.update_order_items(l_campaign_id, l_order_id, l_update_order_item_request)
            assert ("not_implemented", False)
        end
    ...
    test_update_order_status
        ...
        local
            l_response: UPDATE_ORDER_STATUS_RESPONSE
            l_campaign_id: INTEGER_64
            l_order_id: INTEGER_64
            l_update_order_status_request: UPDATE_ORDER_STATUS_REQUEST
        do
            -- TODO: Initialize required params.
            -- l_campaign_id
            -- l_order_id
            -- l_update_order_status_request

            -- l_response := api.update_order_status(l_campaign_id, l_order_id, l_update_order_status_request)
            assert ("not_implemented", False)
        end
    ...
    test_update_order_statuses
        ...
        local
            l_response: UPDATE_ORDER_STATUSES_RESPONSE
            l_campaign_id: INTEGER_64
            l_update_order_statuses_request: UPDATE_ORDER_STATUSES_REQUEST
        do
            -- TODO: Initialize required params.
            -- l_campaign_id
            -- l_update_order_statuses_request

            -- l_response := api.update_order_statuses(l_campaign_id, l_update_order_statuses_request)
            assert ("not_implemented", False)
        end
...
feature {NONE} -- Implementation
    ...
    api: DBS_API
            -- Create an object instance of `DBS_API'.
        once
            create { DBS_API } Result
        end
