...
from ympa_python_pydantic_v1_client.models.get_warehouses_response import GetWarehousesResponse  # noqa: E501
...
class TestGetWarehousesResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetWarehousesResponse:
        ...
        """
        model = GetWarehousesResponse()  # noqa: E501
        if include_optional:
            return GetWarehousesResponse(
                status = 'OK',
                result = ympa_python_pydantic_v1_client.models.warehouses_dto.WarehousesDTO(
                    warehouses = [
