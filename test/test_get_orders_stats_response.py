...
from ympa_python_pydantic_v1_client.models.get_orders_stats_response import GetOrdersStatsResponse  # noqa: E501
...
class TestGetOrdersStatsResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetOrdersStatsResponse:
        ...
        """
        model = GetOrdersStatsResponse()  # noqa: E501
        if include_optional:
            return GetOrdersStatsResponse(
                status = 'OK',
                result = ympa_python_pydantic_v1_client.models.orders_stats_dto.OrdersStatsDTO(
                    orders = [
