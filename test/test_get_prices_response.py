...
from ympa_python_pydantic_v1_client.models.get_prices_response import GetPricesResponse  # noqa: E501
...
class TestGetPricesResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetPricesResponse:
        ...
        """
        model = GetPricesResponse()  # noqa: E501
        if include_optional:
            return GetPricesResponse(
                status = 'OK',
                result = ympa_python_pydantic_v1_client.models.offer_price_list_response_dto.OfferPriceListResponseDTO(
                    offers = [
