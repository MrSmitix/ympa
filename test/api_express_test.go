...
func Test_ympa_go_client_ExpressAPIService(t *testing.T) {
	...
	t.Run("Test ExpressAPIService GetAllOffers", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var campaignId int64

		resp, httpRes, err := apiClient.ExpressAPI.GetAllOffers(context.Background(), campaignId).Execute()
	...
	t.Run("Test ExpressAPIService GetFeed", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.ExpressAPI.GetFeed(context.Background(), campaignId, feedId).Execute()
	...
	t.Run("Test ExpressAPIService GetFeedIndexLogs", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.ExpressAPI.GetFeedIndexLogs(context.Background(), campaignId, feedId).Execute()
	...
	t.Run("Test ExpressAPIService GetFeedbackAndCommentUpdates", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var campaignId int64

		resp, httpRes, err := apiClient.ExpressAPI.GetFeedbackAndCommentUpdates(context.Background(), campaignId).Execute()
	...
	t.Run("Test ExpressAPIService GetFeeds", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var campaignId int64

		resp, httpRes, err := apiClient.ExpressAPI.GetFeeds(context.Background(), campaignId).Execute()
	...
	t.Run("Test ExpressAPIService GetOffers", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var campaignId int64

		resp, httpRes, err := apiClient.ExpressAPI.GetOffers(context.Background(), campaignId).Execute()
	...
	t.Run("Test ExpressAPIService RefreshFeed", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.ExpressAPI.RefreshFeed(context.Background(), campaignId, feedId).Execute()
	...
	t.Run("Test ExpressAPIService SetFeedParams", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.ExpressAPI.SetFeedParams(context.Background(), campaignId, feedId).Execute()
