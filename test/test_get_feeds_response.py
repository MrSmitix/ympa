...
from ympa_python_pydantic_v1_client.models.get_feeds_response import GetFeedsResponse  # noqa: E501
...
class TestGetFeedsResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetFeedsResponse:
        ...
        """
        model = GetFeedsResponse()  # noqa: E501
        if include_optional:
            return GetFeedsResponse(
                feeds = [
                    ympa_python_pydantic_v1_client.models.feed_dto.FeedDTO(
                        id = 56, 
                        login = '', 
                        name = '', 
                        password = '', 
