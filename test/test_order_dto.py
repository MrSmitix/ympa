...
from ympa_python_pydantic_v1_client.models.order_dto import OrderDTO  # noqa: E501
...
class TestOrderDTO(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> OrderDTO:
        """Test OrderDTO
