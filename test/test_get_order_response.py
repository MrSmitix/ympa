...
from ympa_python_pydantic_v1_client.models.get_order_response import GetOrderResponse  # noqa: E501
...
class TestGetOrderResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetOrderResponse:
