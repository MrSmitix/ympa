...
// tests for GenerateCompetitorsPositionReportRequest
void main() {
  // final instance = GenerateCompetitorsPositionReportRequest();

  group('test GenerateCompetitorsPositionReportRequest', () {
