...
from ympa_python_pydantic_v1_client.models.get_campaign_offers_response import GetCampaignOffersResponse  # noqa: E501
...
class TestGetCampaignOffersResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetCampaignOffersResponse:
        ...
        """
        model = GetCampaignOffersResponse()  # noqa: E501
        if include_optional:
            return GetCampaignOffersResponse(
                status = 'OK',
                result = ympa_python_pydantic_v1_client.models.get_campaign_offers_result_dto.GetCampaignOffersResultDTO(
