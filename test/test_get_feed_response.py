...
from ympa_python_pydantic_v1_client.models.get_feed_response import GetFeedResponse  # noqa: E501
...
class TestGetFeedResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetFeedResponse:
        ...
        """
        model = GetFeedResponse()  # noqa: E501
        if include_optional:
            return GetFeedResponse(
                feed = ympa_python_pydantic_v1_client.models.feed_dto.FeedDTO(
                    id = 56, 
                    login = '', 
                    name = '', 
                    password = '', 
