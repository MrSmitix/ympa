...
from ympa_python_pydantic_v1_client.models.suggest_prices_request import SuggestPricesRequest  # noqa: E501
...
class TestSuggestPricesRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SuggestPricesRequest:
        ...
        """
        model = SuggestPricesRequest()  # noqa: E501
        if include_optional:
            return SuggestPricesRequest(
                offers = [
                    ympa_python_pydantic_v1_client.models.suggest_offer_price_dto.SuggestOfferPriceDTO(
