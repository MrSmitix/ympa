...
from ympa_python_pydantic_v1_client.models.get_goods_feedback_response import GetGoodsFeedbackResponse  # noqa: E501
...
class TestGetGoodsFeedbackResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetGoodsFeedbackResponse:
        ...
        """
        model = GetGoodsFeedbackResponse()  # noqa: E501
        if include_optional:
            return GetGoodsFeedbackResponse(
                status = 'OK',
                result = ympa_python_pydantic_v1_client.models.goods_feedback_list_dto.GoodsFeedbackListDTO(
                    feedbacks = [
