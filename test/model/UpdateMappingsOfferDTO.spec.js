...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api.UpdateMappingsOfferDTO();
  });
  ...
  describe('UpdateMappingsOfferDTO', function() {
    it('should create an instance of UpdateMappingsOfferDTO', function() {
      // uncomment below and update the code to test UpdateMappingsOfferDTO
      //var instance = new Api.UpdateMappingsOfferDTO();
      //expect(instance).to.be.a(Api.UpdateMappingsOfferDTO);
    });
