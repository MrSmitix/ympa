...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api.UpdateOrderStatusDTO();
  });
  ...
  describe('UpdateOrderStatusDTO', function() {
    it('should create an instance of UpdateOrderStatusDTO', function() {
      // uncomment below and update the code to test UpdateOrderStatusDTO
      //var instance = new Api.UpdateOrderStatusDTO();
      //expect(instance).to.be.a(Api.UpdateOrderStatusDTO);
    });
