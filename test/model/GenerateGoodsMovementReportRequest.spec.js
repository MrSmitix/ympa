...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api.GenerateGoodsMovementReportRequest();
  });
  ...
  describe('GenerateGoodsMovementReportRequest', function() {
    it('should create an instance of GenerateGoodsMovementReportRequest', function() {
      // uncomment below and update the code to test GenerateGoodsMovementReportRequest
      //var instance = new Api.GenerateGoodsMovementReportRequest();
      //expect(instance).to.be.a(Api.GenerateGoodsMovementReportRequest);
    });
