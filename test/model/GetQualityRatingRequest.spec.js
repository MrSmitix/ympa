...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api.GetQualityRatingRequest();
  });
  ...
  describe('GetQualityRatingRequest', function() {
    it('should create an instance of GetQualityRatingRequest', function() {
      // uncomment below and update the code to test GetQualityRatingRequest
      //var instance = new Api.GetQualityRatingRequest();
      //expect(instance).to.be.a(Api.GetQualityRatingRequest);
    });
