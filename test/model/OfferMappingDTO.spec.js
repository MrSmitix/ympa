...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api.OfferMappingDTO();
  });
  ...
  describe('OfferMappingDTO', function() {
    it('should create an instance of OfferMappingDTO', function() {
      // uncomment below and update the code to test OfferMappingDTO
      //var instance = new Api.OfferMappingDTO();
      //expect(instance).to.be.a(Api.OfferMappingDTO);
    });
