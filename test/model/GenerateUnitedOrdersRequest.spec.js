...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api.GenerateUnitedOrdersRequest();
  });
  ...
  describe('GenerateUnitedOrdersRequest', function() {
    it('should create an instance of GenerateUnitedOrdersRequest', function() {
      // uncomment below and update the code to test GenerateUnitedOrdersRequest
      //var instance = new Api.GenerateUnitedOrdersRequest();
      //expect(instance).to.be.a(Api.GenerateUnitedOrdersRequest);
    });
