...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api.MappingsOfferDTO();
  });
  ...
  describe('MappingsOfferDTO', function() {
    it('should create an instance of MappingsOfferDTO', function() {
      // uncomment below and update the code to test MappingsOfferDTO
      //var instance = new Api.MappingsOfferDTO();
      //expect(instance).to.be.a(Api.MappingsOfferDTO);
    });
