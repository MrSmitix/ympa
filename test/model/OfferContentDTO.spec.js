...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api.OfferContentDTO();
  });
  ...
  describe('OfferContentDTO', function() {
    it('should create an instance of OfferContentDTO', function() {
      // uncomment below and update the code to test OfferContentDTO
      //var instance = new Api.OfferContentDTO();
      //expect(instance).to.be.a(Api.OfferContentDTO);
    });
