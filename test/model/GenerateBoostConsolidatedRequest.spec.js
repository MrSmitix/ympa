...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api.GenerateBoostConsolidatedRequest();
  });
  ...
  describe('GenerateBoostConsolidatedRequest', function() {
    it('should create an instance of GenerateBoostConsolidatedRequest', function() {
      // uncomment below and update the code to test GenerateBoostConsolidatedRequest
      //var instance = new Api.GenerateBoostConsolidatedRequest();
      //expect(instance).to.be.a(Api.GenerateBoostConsolidatedRequest);
    });
