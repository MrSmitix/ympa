...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api.PromoPeriodDTO();
  });
  ...
  describe('PromoPeriodDTO', function() {
    it('should create an instance of PromoPeriodDTO', function() {
      // uncomment below and update the code to test PromoPeriodDTO
      //var instance = new Api.PromoPeriodDTO();
      //expect(instance).to.be.a(Api.PromoPeriodDTO);
    });
