...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api.OrderItemDetailDTO();
  });
  ...
  describe('OrderItemDetailDTO', function() {
    it('should create an instance of OrderItemDetailDTO', function() {
      // uncomment below and update the code to test OrderItemDetailDTO
      //var instance = new Api.OrderItemDetailDTO();
      //expect(instance).to.be.a(Api.OrderItemDetailDTO);
    });
