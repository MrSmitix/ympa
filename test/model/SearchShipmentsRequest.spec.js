...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api.SearchShipmentsRequest();
  });
  ...
  describe('SearchShipmentsRequest', function() {
    it('should create an instance of SearchShipmentsRequest', function() {
      // uncomment below and update the code to test SearchShipmentsRequest
      //var instance = new Api.SearchShipmentsRequest();
      //expect(instance).to.be.a(Api.SearchShipmentsRequest);
    });
