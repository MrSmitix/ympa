...
(function(root, factory) {
  ...
  describe('GetOfferDTO', function() {
    it('should create an instance of GetOfferDTO', function() {
      // uncomment below and update the code to test GetOfferDTO
      //var instance = new Api.GetOfferDTO();
      //expect(instance).to.be.a(Api.GetOfferDTO);
    });
    ...
    it('should have the property sellingPrograms (base name: "sellingPrograms")', function() {
      // uncomment below and update the code to test the property sellingPrograms
      //var instance = new Api.GetOfferDTO();
      //expect(instance).to.be();
    });
