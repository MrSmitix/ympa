...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api.GetPriceWithVatDTO();
  });
  ...
  describe('GetPriceWithVatDTO', function() {
    it('should create an instance of GetPriceWithVatDTO', function() {
      // uncomment below and update the code to test GetPriceWithVatDTO
      //var instance = new Api.GetPriceWithVatDTO();
      //expect(instance).to.be.a(Api.GetPriceWithVatDTO);
    });
