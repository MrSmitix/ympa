...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api.ParameterValueConstraintsDTO();
  });
  ...
  describe('ParameterValueConstraintsDTO', function() {
    it('should create an instance of ParameterValueConstraintsDTO', function() {
      // uncomment below and update the code to test ParameterValueConstraintsDTO
      //var instance = new Api.ParameterValueConstraintsDTO();
      //expect(instance).to.be.a(Api.ParameterValueConstraintsDTO);
    });
