...
(function(root, factory) {
  ...
  describe('ShipmentDTO', function() {
    it('should create an instance of ShipmentDTO', function() {
      // uncomment below and update the code to test ShipmentDTO
      //var instance = new Api.ShipmentDTO();
      //expect(instance).to.be.a(Api.ShipmentDTO);
    });
