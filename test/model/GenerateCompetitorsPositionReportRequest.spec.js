...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api.GenerateCompetitorsPositionReportRequest();
  });
  ...
  describe('GenerateCompetitorsPositionReportRequest', function() {
    it('should create an instance of GenerateCompetitorsPositionReportRequest', function() {
      // uncomment below and update the code to test GenerateCompetitorsPositionReportRequest
      //var instance = new Api.GenerateCompetitorsPositionReportRequest();
      //expect(instance).to.be.a(Api.GenerateCompetitorsPositionReportRequest);
    });
