...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api.BaseShipmentDTO();
  });
  ...
  describe('BaseShipmentDTO', function() {
    it('should create an instance of BaseShipmentDTO', function() {
      // uncomment below and update the code to test BaseShipmentDTO
      //var instance = new Api.BaseShipmentDTO();
      //expect(instance).to.be.a(Api.BaseShipmentDTO);
    });
