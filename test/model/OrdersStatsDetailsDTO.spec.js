...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api.OrdersStatsDetailsDTO();
  });
  ...
  describe('OrdersStatsDetailsDTO', function() {
    it('should create an instance of OrdersStatsDetailsDTO', function() {
      // uncomment below and update the code to test OrdersStatsDetailsDTO
      //var instance = new Api.OrdersStatsDetailsDTO();
      //expect(instance).to.be.a(Api.OrdersStatsDetailsDTO);
    });
