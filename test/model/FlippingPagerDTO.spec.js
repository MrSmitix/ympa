...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api.FlippingPagerDTO();
  });
  ...
  describe('FlippingPagerDTO', function() {
    it('should create an instance of FlippingPagerDTO', function() {
      // uncomment below and update the code to test FlippingPagerDTO
      //var instance = new Api.FlippingPagerDTO();
      //expect(instance).to.be.a(Api.FlippingPagerDTO);
    });
