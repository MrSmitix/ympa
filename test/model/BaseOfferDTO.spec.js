...
(function(root, factory) {
  ...
  describe('BaseOfferDTO', function() {
    it('should create an instance of BaseOfferDTO', function() {
      // uncomment below and update the code to test BaseOfferDTO
      //var instance = new Api.BaseOfferDTO();
      //expect(instance).to.be.a(Api.BaseOfferDTO);
    });
