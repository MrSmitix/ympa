...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api.ScrollingPagerDTO();
  });
  ...
  describe('ScrollingPagerDTO', function() {
    it('should create an instance of ScrollingPagerDTO', function() {
      // uncomment below and update the code to test ScrollingPagerDTO
      //var instance = new Api.ScrollingPagerDTO();
      //expect(instance).to.be.a(Api.ScrollingPagerDTO);
    });
