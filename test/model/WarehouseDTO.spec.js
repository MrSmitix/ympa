...
(function(root, factory) {
  ...
  describe('WarehouseDTO', function() {
    it('should create an instance of WarehouseDTO', function() {
      // uncomment below and update the code to test WarehouseDTO
      //var instance = new Api.WarehouseDTO();
      //expect(instance).to.be.a(Api.WarehouseDTO);
    });
