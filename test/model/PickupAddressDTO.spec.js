...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api.PickupAddressDTO();
  });
  ...
  describe('PickupAddressDTO', function() {
    it('should create an instance of PickupAddressDTO', function() {
      // uncomment below and update the code to test PickupAddressDTO
      //var instance = new Api.PickupAddressDTO();
      //expect(instance).to.be.a(Api.PickupAddressDTO);
    });
