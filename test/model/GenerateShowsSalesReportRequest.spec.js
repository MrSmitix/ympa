...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api.GenerateShowsSalesReportRequest();
  });
  ...
  describe('GenerateShowsSalesReportRequest', function() {
    it('should create an instance of GenerateShowsSalesReportRequest', function() {
      // uncomment below and update the code to test GenerateShowsSalesReportRequest
      //var instance = new Api.GenerateShowsSalesReportRequest();
      //expect(instance).to.be.a(Api.GenerateShowsSalesReportRequest);
    });
