...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api.ExtensionShipmentDTO();
  });
  ...
  describe('ExtensionShipmentDTO', function() {
    it('should create an instance of ExtensionShipmentDTO', function() {
      // uncomment below and update the code to test ExtensionShipmentDTO
      //var instance = new Api.ExtensionShipmentDTO();
      //expect(instance).to.be.a(Api.ExtensionShipmentDTO);
    });
