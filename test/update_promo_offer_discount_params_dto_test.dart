...
// tests for UpdatePromoOfferDiscountParamsDTO
void main() {
  // final instance = UpdatePromoOfferDiscountParamsDTO();

  group('test UpdatePromoOfferDiscountParamsDTO', () {
    ...
    // int promoPrice
    test('to test the property `promoPrice`', () async {
      // TODO
    });
