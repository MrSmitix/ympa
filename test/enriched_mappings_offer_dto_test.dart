...
// tests for EnrichedMappingsOfferDTO
void main() {
  // final instance = EnrichedMappingsOfferDTO();

  group('test EnrichedMappingsOfferDTO', () {
    ...
    test('to test the property `marketModelName`', () async {
      // TODO
    });
    ...
    test('to test the property `marketSkuName`', () async {
      // TODO
    });
