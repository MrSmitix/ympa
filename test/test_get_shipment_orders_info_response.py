...
from ympa_python_pydantic_v1_client.models.get_shipment_orders_info_response import GetShipmentOrdersInfoResponse  # noqa: E501
...
class TestGetShipmentOrdersInfoResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetShipmentOrdersInfoResponse:
        ...
        """
        model = GetShipmentOrdersInfoResponse()  # noqa: E501
        if include_optional:
            return GetShipmentOrdersInfoResponse(
                status = 'OK',
                result = ympa_python_pydantic_v1_client.models.orders_shipment_info_dto.OrdersShipmentInfoDTO(
