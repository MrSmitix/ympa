...
from ympa_python_pydantic_v1_client.models.get_returns_response import GetReturnsResponse  # noqa: E501
...
class TestGetReturnsResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetReturnsResponse:
        ...
        """
        model = GetReturnsResponse()  # noqa: E501
        if include_optional:
            return GetReturnsResponse(
                status = 'OK',
                result = ympa_python_pydantic_v1_client.models.paged_returns_dto.PagedReturnsDTO(
