...
from ympa_python_pydantic_v1_client.models.get_orders_response import GetOrdersResponse  # noqa: E501
        ...
        if include_optional:
            return GetOrdersResponse(
                pager = ympa_python_pydantic_v1_client.models.flipping_pager_dto.FlippingPagerDTO(
                    ...
                    page_size = 56, ),
                orders = [
                    ympa_python_pydantic_v1_client.models.order_dto.OrderDTO(
                        id = 56, 
                        status = 'PLACING', 
