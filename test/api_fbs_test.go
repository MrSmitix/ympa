...
func Test_ympa_go_client_FbsAPIService(t *testing.T) {
	...
	t.Run("Test FbsAPIService GetAllOffers", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var campaignId int64

		resp, httpRes, err := apiClient.FbsAPI.GetAllOffers(context.Background(), campaignId).Execute()
	...
	t.Run("Test FbsAPIService GetFeed", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.FbsAPI.GetFeed(context.Background(), campaignId, feedId).Execute()
	...
	t.Run("Test FbsAPIService GetFeedIndexLogs", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.FbsAPI.GetFeedIndexLogs(context.Background(), campaignId, feedId).Execute()
	...
	t.Run("Test FbsAPIService GetFeedbackAndCommentUpdates", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var campaignId int64

		resp, httpRes, err := apiClient.FbsAPI.GetFeedbackAndCommentUpdates(context.Background(), campaignId).Execute()
	...
	t.Run("Test FbsAPIService GetFeeds", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var campaignId int64

		resp, httpRes, err := apiClient.FbsAPI.GetFeeds(context.Background(), campaignId).Execute()
	...
	t.Run("Test FbsAPIService GetOffers", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var campaignId int64

		resp, httpRes, err := apiClient.FbsAPI.GetOffers(context.Background(), campaignId).Execute()
	...
	t.Run("Test FbsAPIService RefreshFeed", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.FbsAPI.RefreshFeed(context.Background(), campaignId, feedId).Execute()
	...
	t.Run("Test FbsAPIService SetFeedParams", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.FbsAPI.SetFeedParams(context.Background(), campaignId, feedId).Execute()
