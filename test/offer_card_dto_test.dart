...
// tests for OfferCardDTO
void main() {
  // final instance = OfferCardDTO();

  group('test OfferCardDTO', () {
    ...
    // int contentRating
    test('to test the property `contentRating`', () async {
      // TODO
    });
    ...
    // List<OfferCardRecommendationDTO> recommendations (default value: const [])
