...
// tests for WarehouseOfferDTO
void main() {
  // final instance = WarehouseOfferDTO();

  group('test WarehouseOfferDTO', () {
    ...
    test('to test the property `turnoverSummary`', () async {
      // TODO
    });

    // Информация об остатках.
    // List<WarehouseStockDTO> stocks (default value: const [])
