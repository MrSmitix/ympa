...
// checks if the EnrichedMappingsOfferDTO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EnrichedMappingsOfferDTO{}
...
func (o EnrichedMappingsOfferDTO) MarshalJSON() ([]byte, error) {
...
func (o EnrichedMappingsOfferDTO) ToMap() (map[string]interface{}, error) {
...
type NullableEnrichedMappingsOfferDTO struct {
	value *EnrichedMappingsOfferDTO
	isSet bool
}

func (v NullableEnrichedMappingsOfferDTO) Get() *EnrichedMappingsOfferDTO {
	return v.value
}

func (v *NullableEnrichedMappingsOfferDTO) Set(val *EnrichedMappingsOfferDTO) {
	v.value = val
	v.isSet = true
}

func (v NullableEnrichedMappingsOfferDTO) IsSet() bool {
	return v.isSet
}
...
func NewNullableEnrichedMappingsOfferDTO(val *EnrichedMappingsOfferDTO) *NullableEnrichedMappingsOfferDTO {
	return &NullableEnrichedMappingsOfferDTO{value: val, isSet: true}
}

func (v NullableEnrichedMappingsOfferDTO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEnrichedMappingsOfferDTO) UnmarshalJSON(src []byte) error {
	v.isSet = true
