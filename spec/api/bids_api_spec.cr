...
# Unit tests for OpenAPIClient::BidsApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe "BidsApi" do
  describe "test an instance of BidsApi" do
    it "should create an instance of BidsApi" do
      api_instance = OpenAPIClient::BidsApi.new
      # TODO expect(api_instance).to be_instance_of(OpenAPIClient::BidsApi)
    end
  end
