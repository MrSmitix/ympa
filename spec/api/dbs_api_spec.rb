...
# Unit tests for OpenapiClient::DbsApi
...
describe 'DbsApi' do
  ...
  describe 'test an instance of DbsApi' do
    it 'should create an instance of DbsApi' do
      expect(@api_instance).to be_instance_of(OpenapiClient::DbsApi)
    end
  end
  ...
  describe 'accept_order_cancellation test' do
    it 'should work' do
  ...
  # @option opts [Integer] :count Количество предложений на странице ответа.
  # @option opts [Integer] :page Номер страницы результатов.  Значение по умолчанию: 1.  Используется вместе с параметром &#x60;page_size&#x60;.  &#x60;page_number&#x60; игнорируется, если задан &#x60;page_token&#x60;, &#x60;limit&#x60; или &#x60;offset&#x60;. 
  ...
  # @param [Hash] opts the optional parameters
  # @return [EmptyApiResponse]
  describe 'provide_order_digital_codes test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
